<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SUPDEDUC_Deductibles.aspx.vb" Inherits="Nexus.PB2_SUPDEDUC_Deductibles" %>
...
function onValidate_DEDUC__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DEDUC", "DESCRIPTION", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DEDUC", "DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DEDUC.DESCRIPTION");
        			window.setControlWidth(field, "0.5", "DEDUC", "DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_DEDUC__PERCENTAGE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DEDUC", "PERCENTAGE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DEDUC", "PERCENTAGE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DEDUC.PERCENTAGE");
        			window.setControlWidth(field, "0.5", "DEDUC", "PERCENTAGE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DEDUC".toUpperCase() + "__" + "PERCENTAGE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DEDUC".toUpperCase() + "_" + "PERCENTAGE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("DEDUC.PERCENTAGE > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_DEDUC__MINIMUMAMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DEDUC", "MINIMUMAMT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DEDUC", "MINIMUMAMT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DEDUC.MINIMUMAMT");
        			window.setControlWidth(field, "0.5", "DEDUC", "MINIMUMAMT");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DEDUC".toUpperCase() + "__" + "MINIMUMAMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DEDUC".toUpperCase() + "_" + "MINIMUMAMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("DEDUC.MINIMUMAMT > DEDUC.MAXIMUMAMT");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_DEDUC__MAXIMUMAMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DEDUC", "MAXIMUMAMT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DEDUC", "MAXIMUMAMT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DEDUC.MAXIMUMAMT");
        			window.setControlWidth(field, "0.5", "DEDUC", "MAXIMUMAMT");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Maximum Amount Cannot be less than Maximum Amount")) ? "Maximum Amount Cannot be less than Maximum Amount" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DEDUC".toUpperCase() + "__" + "MAXIMUMAMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DEDUC".toUpperCase() + "_" + "MAXIMUMAMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression(" DEDUC.MAXIMUMAMT <DEDUC.MINIMUMAMT ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_DEDUC__BASISDED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DEDUC", "BASISDED", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DEDUC", "BASISDED");
        		}
        		//window.setProperty(field, "VEM", "DEDUC.PERCENTAGE > 0", "VE", "Please Select Basis of Deductible");
        
            var paramValue = "VEM",
            paramCondition = "DEDUC.PERCENTAGE > 0",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DEDUC.BASISDED");
        			window.setControlWidth(field, "0.5", "DEDUC", "BASISDED");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("ADDDEDUC.PERCENTAGE > 0")) ? new Expression("ADDDEDUC.PERCENTAGE > 0") : null;
...
function DoLogic(isOnLoad) {
    onValidate_DEDUC__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_DEDUC__PERCENTAGE(null, null, null, isOnLoad);
    onValidate_DEDUC__MINIMUMAMT(null, null, null, isOnLoad);
    onValidate_DEDUC__MAXIMUMAMT(null, null, null, isOnLoad);
    onValidate_DEDUC__BASISDED(null, null, null, isOnLoad);
}
</script>
...
<div id="ida89f9eb4d25f421aaa2658bd53379bab" class="general-layout-container">
...
<div id="id282a33ed267a4794b27e87e81ed89843" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Deductibles" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="DEDUC" 
		data-property-name="DESCRIPTION" 
		id="pb-container-comment-DEDUC-DESCRIPTION">
		<asp:Label ID="lblDEDUC_DESCRIPTION" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="DEDUC__DESCRIPTION" 
			Text="Description"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="DEDUC__DESCRIPTION" runat="server" />
		
		<asp:CustomValidator ID="valDEDUC_DESCRIPTION" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Description"
			ClientValidationFunction="onValidate_DEDUC__DESCRIPTION"
			ValidationGroup="" 
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-DEDUC-PERCENTAGE">
		<asp:Label ID="lblDEDUC_PERCENTAGE" runat="server" AssociatedControlID="DEDUC__PERCENTAGE" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="DEDUC__PERCENTAGE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valDEDUC_PERCENTAGE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_DEDUC__PERCENTAGE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-DEDUC-MINIMUMAMT">
		<asp:Label ID="lblDEDUC_MINIMUMAMT" runat="server" AssociatedControlID="DEDUC__MINIMUMAMT" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DEDUC__MINIMUMAMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valDEDUC_MINIMUMAMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_DEDUC__MINIMUMAMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-DEDUC-MAXIMUMAMT">
		<asp:Label ID="lblDEDUC_MAXIMUMAMT" runat="server" AssociatedControlID="DEDUC__MAXIMUMAMT" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DEDUC__MAXIMUMAMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valDEDUC_MAXIMUMAMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_DEDUC__MAXIMUMAMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-DEDUC-BASISDED">
		<asp:Label ID="lblDEDUC_BASISDED" runat="server" AssociatedControlID="DEDUC__BASISDED" 
			Text="Basis of Deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="DEDUC__BASISDED" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_BASISDED" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_DEDUC__BASISDED(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valDEDUC_BASISDED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of Deductible"
			ClientValidationFunction="onValidate_DEDUC__BASISDED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DEDUC" 
		data-property-name="BASISDEDCode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-DEDUC-BASISDEDCode">

		
		
			
		
				<asp:HiddenField ID="DEDUC__BASISDEDCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id282a33ed267a4794b27e87e81ed89843 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id282a33ed267a4794b27e87e81ed89843 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id282a33ed267a4794b27e87e81ed89843 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id282a33ed267a4794b27e87e81ed89843 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id282a33ed267a4794b27e87e81ed89843 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id282a33ed267a4794b27e87e81ed89843 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id282a33ed267a4794b27e87e81ed89843 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id282a33ed267a4794b27e87e81ed89843 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id282a33ed267a4794b27e87e81ed89843 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id282a33ed267a4794b27e87e81ed89843 input{text-align:left;}"; break;
		}
	}
