<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPLEXTNT_Other_Extentions.aspx.vb" Inherits="Nexus.PB2_CPLEXTNT_Other_Extentions" %>
...
<div id="id9a6a1fc0918548788d763c6736b8cfdd" class="general-layout-container">
...
<div id="id3dfafadab8af4a7cac1e138e2e2db9fb" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3dfafadab8af4a7cac1e138e2e2db9fb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3dfafadab8af4a7cac1e138e2e2db9fb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3dfafadab8af4a7cac1e138e2e2db9fb div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3dfafadab8af4a7cac1e138e2e2db9fb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3dfafadab8af4a7cac1e138e2e2db9fb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3dfafadab8af4a7cac1e138e2e2db9fb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3dfafadab8af4a7cac1e138e2e2db9fb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3dfafadab8af4a7cac1e138e2e2db9fb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3dfafadab8af4a7cac1e138e2e2db9fb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3dfafadab8af4a7cac1e138e2e2db9fb input{text-align:left;}"; break;
		}
	}
