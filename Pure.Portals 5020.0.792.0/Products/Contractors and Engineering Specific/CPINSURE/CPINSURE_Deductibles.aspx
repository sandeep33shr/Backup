        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("AGGRE.DEDUCTFUND");
        			window.setControlWidth(field, "0.4", "AGGRE", "DEDUCTFUND");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_AGGRE__DEDUCTFUND');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AGGRE__DEDUCTFUND_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Aggregate Excess Fund can never be less than Stop Loss ")) ? "Aggregate Excess Fund can never be less than Stop Loss " : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AGGRE".toUpperCase() + "__" + "DEDUCTFUND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AGGRE".toUpperCase() + "_" + "DEDUCTFUND");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("AGGRE.DEDUCTFUND > AGGRE.STOPLOSS");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AGGRE__STOPLOSS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("AGGRE.STOPLOSS");
        			window.setControlWidth(field, "0.4", "AGGRE", "STOPLOSS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_AGGRE__STOPLOSS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AGGRE__STOPLOSS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Stopper can never be more than Aggregate Excess Fund")) ? "Stopper can never be more than Aggregate Excess Fund" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AGGRE".toUpperCase() + "__" + "STOPLOSS");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AGGRE".toUpperCase() + "_" + "STOPLOSS");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
...
function onValidate_AGGRE__DTVALUE_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AGGRE", "DTVALUE_CNT", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AGGRE", "DTVALUE_CNT");
        		}
          ...
          * @param AGGRE The Parent (Root) object name.
          * @param DED_BAND.DESCRIPTION The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AGGRE".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "DED_BAND.DESCRIPTION";
...
function onValidate_AGGRE__DTNOVALUE_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AGGRE", "DTNOVALUE_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AGGRE", "DTNOVALUE_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param AGGRE The Parent (Root) object name.
          * @param DED_NON_BAND.DESCRIPTION The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AGGRE".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "DED_NON_BAND.DESCRIPTION";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_AGGRE__DTVALUE_CNT(null, null, null, isOnLoad);
    onValidate_AGGRE__DTNOVALUE(null, null, null, isOnLoad);
    onValidate_AGGRE__DTNOVALUE_CNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id7126aa825f8440eca145860d95df5d9b" class="general-layout-container">
...
<div id="id54736db7e5a94477bc849dc16610cd12" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading52" runat="server" Text="Aggregate Deductibles" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id54736db7e5a94477bc849dc16610cd12 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id54736db7e5a94477bc849dc16610cd12 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id54736db7e5a94477bc849dc16610cd12 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id54736db7e5a94477bc849dc16610cd12 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id54736db7e5a94477bc849dc16610cd12 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54736db7e5a94477bc849dc16610cd12 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54736db7e5a94477bc849dc16610cd12 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id54736db7e5a94477bc849dc16610cd12 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54736db7e5a94477bc849dc16610cd12 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54736db7e5a94477bc849dc16610cd12 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="deductible" class="column-layout-container,no-border  ">
		    ...
		    <legend>Value Band Deductibles</legend>
			        ...
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AGGRE__DED_BAND" runat="server" ScreenCode="DTVALUE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DTVALUE/DTVALUE_Value_Band_Deductibles_Details.aspx" emptydatatext="sac">
							<columns>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="AGGRE" 
		data-property-name="DTVALUE_CNT" 
		id="pb-container-integer-AGGRE-DTVALUE_CNT">
		<asp:Label ID="lblAGGRE_DTVALUE_CNT" runat="server" AssociatedControlID="AGGRE__DTVALUE_CNT" 
			Text="Value Band Deductibles Count" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="AGGRE__DTVALUE_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAGGRE_DTVALUE_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Value Band Deductibles Count"
			ClientValidationFunction="onValidate_AGGRE__DTVALUE_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="nonDeductible" class="column-layout-container,no-border  ">
		    ...
		    <legend>Non Band Deductibles</legend>
			        ...
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AGGRE__DED_NON_BAND" runat="server" ScreenCode="DTNOVALUE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DTNOVALUE/DTNOVALUE_Non_Band_Deductibles_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Description" DataField="DESCRIPTION" DataFormatString=""/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="AGGRE" 
		data-property-name="DTNOVALUE_CNT" 
		id="pb-container-integer-AGGRE-DTNOVALUE_CNT">
		<asp:Label ID="lblAGGRE_DTNOVALUE_CNT" runat="server" AssociatedControlID="AGGRE__DTNOVALUE_CNT" 
			Text="Non Band Deductibles Count" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="AGGRE__DTNOVALUE_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAGGRE_DTNOVALUE_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Non Band Deductibles Count"
			ClientValidationFunction="onValidate_AGGRE__DTNOVALUE_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
