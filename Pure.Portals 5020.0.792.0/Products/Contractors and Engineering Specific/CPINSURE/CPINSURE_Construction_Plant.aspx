<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPINSURE_Construction_Plant.aspx.vb" Inherits="Nexus.PB2_CPINSURE_Construction_Plant" %>
...
function onValidate_GENERAL__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "RISK_ATTACH_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "RISK_ATTACH_DATE");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_RISK_ATTACH_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__RISK_ATTACH_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__RISK_ATTACH_DATE_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.8", "GENERAL", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_GENERAL__IS_VAT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=List&objectName=GENERAL&propertyName=IS_VAT&name={name}");
        		
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("Code(GENERAL.IS_VAT) = '' OR Code(GENERAL.IS_VAT) = null")) ? new Expression("Code(GENERAL.IS_VAT) = '' OR Code(GENERAL.IS_VAT) = null") : null, 
...
function onValidate_GENERAL__DEPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "DEPPREM", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "DEPPREM");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_DEPPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__DEPPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__DEPPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.DEPPREM");
        			window.setControlWidth(field, "0.8", "GENERAL", "DEPPREM");
        		})();
        	}
        })();
        (function(){
...
function onValidate_GENERAL__CPIMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CPIMTA", "ChildScreen");
        })();
}
...
function onValidate_OWNPLANT__PLANTITEM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNPLANT", "PLANTITEM", "ChildScreen");
        })();
}
function onValidate_OWNPLANT__PLANTCOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNPLANT", "PLANTCOUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OWNPLANT", "PLANTCOUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
         ...
         /**
          * @fileoverview GetColumn
          * @param OWNPLANT The Parent (Root) object name.
          * @param PLANTDET.BASIS_INS The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "OWNPLANT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PLANTDET.BASIS_INS";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("At least one Plant item should be entered")) ? "At least one Plant item should be entered" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "OWNPLANT".toUpperCase() + "__" + "PLANTCOUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "OWNPLANT".toUpperCase() + "_" + "PLANTCOUNT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("OWNPLANT.PLANTCOUNT > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_OWNPLANT__TOTALPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNPLANT", "TOTALPREM", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OWNPLANT", "TOTALPREM");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("OWNPLANT", "TOTALIND");
        	var Rate = Field.getInstance("OWNPLANT", "RATE");
        	var Premium = Field.getInstance("OWNPLANT", "TOTALPREM");
          ...
          * @fileoverview GetColumn
          * @param OWNPLANT The Parent (Root) object name.
          * @param PLANTDET.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "OWNPLANT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PLANTDET.PREMIUM";
        		//count, average, total, min, max
...
function onValidate_OWNPLANT__TOTALIND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNPLANT", "TOTALIND", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OWNPLANT", "TOTALIND");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param OWNPLANT The Parent (Root) object name.
          * @param PLANTDET.SUMINSURED The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "OWNPLANT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PLANTDET.SUMINSURED";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_OWNPLANT__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNPLANT", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OWNPLANT", "RATE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param OWNPLANT The Parent (Root) object name.
          * @param PLANTDET.RATE The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "OWNPLANT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PLANTDET.RATE";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_OWNPLANT__TOTALMAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNPLANT", "TOTALMAX", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OWNPLANT", "TOTALMAX");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param OWNPLANT The Parent (Root) object name.
          * @param PLANTDET.MAX_ITEM The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "OWNPLANT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PLANTDET.MAX_ITEM";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_MOBCRANE__CRANE_CHK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBCRANE", "CRANE_CHK", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOBCRANE_CRANE_CHK");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOBCRANE__CRANE_CHK');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOBCRANE__CRANE_CHK_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MOBCRANE__MAX_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBCRANE", "MAX_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOBCRANE", "MAX_LIMIT");
        		}
        		//window.setProperty(field, "VEM", "MOBCRANE.CRANE_CHK = 1", "v", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "MOBCRANE.CRANE_CHK = 1",
            paramElseValue = "v",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MOBCRANE", "MAX_LIMIT");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOBCRANE&propertyName=MAX_LIMIT&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("MOBCRANE.CRANE_CHK==0")) ? new Expression("MOBCRANE.CRANE_CHK==0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_MOBCRANE__HIREFEES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBCRANE", "HIREFEES", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOBCRANE", "HIREFEES");
        		}
        		//window.setProperty(field, "VEM", "MOBCRANE.CRANE_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MOBCRANE", "HIREFEES");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOBCRANE&propertyName=HIREFEES&name={name}");
...
function onValidate_MOBCRANE__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBCRANE", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOBCRANE", "RATE");
        		}
        		//window.setProperty(field, "VE", "MOBCRANE.CRANE_CHK = 1", "v", "{3}");
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("MOBCRANE", "MAX_LIMIT");
        	var Rate = Field.getInstance("MOBCRANE", "RATE");
        	var Premium = Field.getInstance("MOBCRANE", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=MOBCRANE&propertyName=RATE&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('MOBCRANE', 'RATE');
...
function onValidate_MOBCRANE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBCRANE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOBCRANE", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "MOBCRANE.CRANE_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MOBCRANE", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOBCRANE&propertyName=PREMIUM&name={name}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("MOBCRANE.RATE * MOBCRANE.HIREFEES * 0.01"), 
        			condition = (Expression.isValidParameter("MOBCRANE.RATE > 0")) ? new Expression("MOBCRANE.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_MOBPLANT__PLANT_CHK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBPLANT", "PLANT_CHK", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOBPLANT_PLANT_CHK");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOBPLANT__PLANT_CHK');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOBPLANT__PLANT_CHK_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MOBPLANT__MAX_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBPLANT", "MAX_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOBPLANT", "MAX_LIMIT");
        		}
        		//window.setProperty(field, "VEM", "MOBPLANT.PLANT_CHK = 1", "v", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "MOBPLANT.PLANT_CHK = 1",
            paramElseValue = "v",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MOBPLANT", "MAX_LIMIT");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOBPLANT&propertyName=MAX_LIMIT&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("MOBPLANT.PLANT_CHK = 0")) ? new Expression("MOBPLANT.PLANT_CHK = 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_MOBPLANT__HIREFEES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBPLANT", "HIREFEES", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOBPLANT", "HIREFEES");
        		}
        		//window.setProperty(field, "VEM", "MOBPLANT.PLANT_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MOBPLANT", "HIREFEES");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOBPLANT&propertyName=HIREFEES&name={name}");
...
function onValidate_MOBPLANT__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBPLANT", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOBPLANT", "RATE");
        		}
        		//window.setProperty(field, "VE", "MOBPLANT.PLANT_CHK = 1", "v", "{3}");
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("MOBPLANT", "MAX_LIMIT");
        	var Rate = Field.getInstance("MOBPLANT", "RATE");
        	var Premium = Field.getInstance("MOBPLANT", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=MOBPLANT&propertyName=RATE&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('MOBPLANT', 'RATE');
...
function onValidate_MOBPLANT__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOBPLANT", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOBPLANT", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "MOBPLANT.PLANT_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MOBPLANT", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOBPLANT&propertyName=PREMIUM&name={name}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("MOBPLANT.RATE * MOBPLANT.HIREFEES * 0.01"), 
        			condition = (Expression.isValidParameter("MOBPLANT.RATE > 0")) ? new Expression("MOBPLANT.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_NONMOB__NON_CHK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NONMOB", "NON_CHK", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNONMOB_NON_CHK");
        			    var ele = document.getElementById('ctl00_cntMainBody_NONMOB__NON_CHK');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NONMOB__NON_CHK_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_NONMOB__MAX_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NONMOB", "MAX_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NONMOB", "MAX_LIMIT");
        		}
        		//window.setProperty(field, "VEM", "NONMOB.NON_CHK = 1", "v", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "NONMOB.NON_CHK = 1",
            paramElseValue = "v",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("NONMOB", "MAX_LIMIT");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=NONMOB&propertyName=MAX_LIMIT&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("NONMOB.NON_CHK = 0")) ? new Expression("NONMOB.NON_CHK = 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_NONMOB__HIREFEES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NONMOB", "HIREFEES", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NONMOB", "HIREFEES");
        		}
        		//window.setProperty(field, "VEM", "NONMOB.NON_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("NONMOB", "HIREFEES");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=NONMOB&propertyName=HIREFEES&name={name}");
...
function onValidate_NONMOB__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NONMOB", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NONMOB", "RATE");
        		}
        		//window.setProperty(field, "VE", "NONMOB.NON_CHK = 1", "v", "{3}");
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("NONMOB", "MAX_LIMIT");
        	var Rate = Field.getInstance("NONMOB", "RATE");
        	var Premium = Field.getInstance("NONMOB", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('NONMOB', 'RATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=NONMOB&propertyName=RATE&name={name}");
...
function onValidate_NONMOB__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NONMOB", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NONMOB", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "NONMOB.NON_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("NONMOB", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=NONMOB&propertyName=PREMIUM&name={name}");
        		
        		var value = new Expression("NONMOB.RATE * NONMOB.HIREFEES * 0.01"), 
        			condition = (Expression.isValidParameter("NONMOB.RATE > 0")) ? new Expression("NONMOB.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_PLANTENVI__PNE_CHK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTENVI", "PNE_CHK", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPLANTENVI_PNE_CHK");
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTENVI__PNE_CHK');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTENVI__PNE_CHK_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PLANTENVI__MAX_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTENVI", "MAX_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTENVI", "MAX_LIMIT");
        		}
        		//window.setProperty(field, "VEM", "PLANTENVI.PNE_CHK = 1", "v", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "PLANTENVI.PNE_CHK = 1",
            paramElseValue = "v",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PLANTENVI", "MAX_LIMIT");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PLANTENVI&propertyName=MAX_LIMIT&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("PLANTENVI.PNE_CHK = 0")) ? new Expression("PLANTENVI.PNE_CHK = 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_PLANTENVI__HIREFEES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTENVI", "HIREFEES", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTENVI", "HIREFEES");
        		}
        		//window.setProperty(field, "VEM", "PLANTENVI.PNE_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PLANTENVI", "HIREFEES");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PLANTENVI&propertyName=HIREFEES&name={name}");
...
function onValidate_PLANTENVI__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTENVI", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTENVI", "RATE");
        		}
        		//window.setProperty(field, "VE", "PLANTENVI.PNE_CHK = 1", "v", "{3}");
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("PLANTENVI", "MAX_LIMIT");
        	var Rate = Field.getInstance("PLANTENVI", "RATE");
        	var Premium = Field.getInstance("PLANTENVI", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=PLANTENVI&propertyName=RATE&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('PLANTENVI', 'RATE');
...
function onValidate_PLANTENVI__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTENVI", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTENVI", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "PLANTENVI.PNE_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PLANTENVI", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PLANTENVI&propertyName=PREMIUM&name={name}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("PLANTENVI.RATE * PLANTENVI.HIREFEES * 0.01"), 
        			condition = (Expression.isValidParameter("PLANTENVI.RATE > 0")) ? new Expression("PLANTENVI.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_SURVEQUIP__SURV_CHK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SURVEQUIP", "SURV_CHK", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSURVEQUIP_SURV_CHK");
        			    var ele = document.getElementById('ctl00_cntMainBody_SURVEQUIP__SURV_CHK');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SURVEQUIP__SURV_CHK_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SURVEQUIP__MAX_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SURVEQUIP", "MAX_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SURVEQUIP", "MAX_LIMIT");
        		}
        		//window.setProperty(field, "VEM", "SURVEQUIP.SURV_CHK = 1", "v", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "SURVEQUIP.SURV_CHK = 1",
            paramElseValue = "v",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SURVEQUIP", "MAX_LIMIT");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=SURVEQUIP&propertyName=MAX_LIMIT&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("SURVEQUIP.SURV_CHK = 0")) ? new Expression("SURVEQUIP.SURV_CHK = 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_SURVEQUIP__HIREFEES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SURVEQUIP", "HIREFEES", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SURVEQUIP", "HIREFEES");
        		}
        		//window.setProperty(field, "VEM", "SURVEQUIP.SURV_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SURVEQUIP", "HIREFEES");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=SURVEQUIP&propertyName=HIREFEES&name={name}");
...
function onValidate_SURVEQUIP__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SURVEQUIP", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SURVEQUIP", "RATE");
        		}
        		//window.setProperty(field, "VE", "SURVEQUIP.SURV_CHK = 1", "v", "{3}");
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("SURVEQUIP", "MAX_LIMIT");
        	var Rate = Field.getInstance("SURVEQUIP", "RATE");
        	var Premium = Field.getInstance("SURVEQUIP", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=SURVEQUIP&propertyName=RATE&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('SURVEQUIP', 'RATE');
...
function onValidate_SURVEQUIP__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SURVEQUIP", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SURVEQUIP", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "SURVEQUIP.SURV_CHK = 1", "v", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SURVEQUIP", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=SURVEQUIP&propertyName=PREMIUM&name={name}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("SURVEQUIP.RATE * SURVEQUIP.HIREFEES * 0.01"), 
        			condition = (Expression.isValidParameter("SURVEQUIP.RATE > 0")) ? new Expression("SURVEQUIP.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_HIREDPLT__HIREDNOT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "HIREDPLT", "HIREDNOT", "ChildScreen");
        })();
}
function onValidate_HIREDPLT__TOTALPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "HIREDPLT", "TOTALPREM", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("HIREDPLT", "TOTALPREM");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
         ...
         /**
          * @fileoverview GetColumn
          * @param HIREDPLT The Parent (Root) object name.
          * @param ADDHIRE.PREMIUM The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "HIREDPLT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "ADDHIRE.PREMIUM";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_HIREDPLT__TOTALIND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "HIREDPLT", "TOTALIND", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("HIREDPLT", "TOTALIND");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param HIREDPLT The Parent (Root) object name.
          * @param ADDHIRE.MAX_LIMIT The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "HIREDPLT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "ADDHIRE.MAX_LIMIT";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_HIREDPLT__HIREDNOT_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "HIREDPLT", "HIREDNOT_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("HIREDPLT", "HIREDNOT_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param HIREDPLT The Parent (Root) object name.
          * @param ADDHIRE.DESCRIPTION The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "HIREDPLT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "ADDHIRE.DESCRIPTION";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_HIRECHARGE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("HIRECHARGE", "LIMITIND");
        	var Rate = Field.getInstance("HIRECHARGE", "RATE");
        	var Premium = Field.getInstance("HIRECHARGE", "PREMIUM");
...
function onValidate_CREDSHORT__PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("CREDSHORT", "LIMITIND");
        	var Rate = Field.getInstance("CREDSHORT", "RATE");
        	var Premium = Field.getInstance("CREDSHORT", "PREMIUM");
...
function onValidate_DAMAGE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("DAMAGE", "LIMITIND");
        	var Rate = Field.getInstance("DAMAGE", "RATE");
        	var Premium = Field.getInstance("DAMAGE", "PREMIUM");
...
function onValidate_HOLECOVER__PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("HOLECOVER", "LIMITIND");
        	var Rate = Field.getInstance("HOLECOVER", "RATE");
        	var Premium = Field.getInstance("HOLECOVER", "PREMIUM");
...
function onValidate_EXPENSE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("EXPENSE", "LIMITIND");
        	var Rate = Field.getInstance("EXPENSE", "RATE");
        	var Premium = Field.getInstance("EXPENSE", "PREMIUM");
...
function onValidate_CRANELIFT__PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("CRANELIFT", "LIMITIND");
        	var Rate = Field.getInstance("CRANELIFT", "RATE");
        	var Premium = Field.getInstance("CRANELIFT", "PREMIUM");
...
function onValidate_REPLACE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("REPLACE", "LIMITIND");
        	var Rate = Field.getInstance("REPLACE", "RATE");
        	var Premium = Field.getInstance("REPLACE", "PREMIUM");
...
function onValidate_WRECK__IS_WRECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WRECK", "IS_WRECK", "Checkbox");
        })();
}
function onValidate_WRECK__LIMITIND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WRECK", "LIMITIND", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WRECK", "LIMITIND");
        		}
        		//window.setProperty(field, "VEM", "WRECK.IS_WRECK = 1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "WRECK.IS_WRECK = 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("WRECK", "LIMITIND");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=WRECK&propertyName=LIMITIND&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("WRECK.IS_WRECK = 0")) ? new Expression("WRECK.IS_WRECK = 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_WRECK__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WRECK", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WRECK", "RATE");
        		}
        		//window.setProperty(field, "VE", "WRECK.IS_WRECK = 1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('WRECK', 'RATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=WRECK&propertyName=RATE&name={name}");
...
function onValidate_WRECK__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WRECK", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "WRECK.IS_WRECK = 1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("WRECK", "PREMIUM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=WRECK&propertyName=PREMIUM&name={name}");
        		
        		var value = new Expression("WRECK.RATE * WRECK.LIMITIND * 0.01"), 
        			condition = (Expression.isValidParameter("WRECK.RATE > 0")) ? new Expression("WRECK.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("WRECK", "LIMITIND");
        	var Rate = Field.getInstance("WRECK", "RATE");
        	var Premium = Field.getInstance("WRECK", "PREMIUM");
...
function onValidate_WRECK__TOTAL_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WRECK", "TOTAL_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WRECK", "TOTAL_PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('WRECK', 'TOTAL_PREM');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=WRECK&propertyName=TOTAL_PREM&name={name}");
        		
        		var value = new Expression("HIRECHARGE.PREMIUM + CREDSHORT.PREMIUM + EXPENSE.PREMIUM + HOLECOVER.PREMIUM + CRANELIFT.PREMIUM + REPLACE.PREMIUM + REPLACE.PREMIUM + WRECK.PREMIUM + DAMAGE.PREMIUM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_OTHER__CPIADDCLD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTHER", "CPIADDCLD", "ChildScreen");
        })();
}
function onValidate_OTHER__TOTALPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTHER", "TOTALPREM", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param OTHER The Parent (Root) object name.
          * @param OTHERSPEC.PREMIUM The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "OTHER".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "OTHERSPEC.PREMIUM";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
        		...
        		var field = Field.getInstance("OTHER", "TOTALPREM");
        		try {
...
function onValidate_OTHER__TOTALIND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTHER", "TOTALIND", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param OTHER The Parent (Root) object name.
          * @param OTHERSPEC.LIMITIND The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "OTHER".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "OTHERSPEC.LIMITIND";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
        		...
        		var field = Field.getInstance("OTHER", "TOTALIND");
        		try {
...
function onValidate_OTHER__CPIADDCLD_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTHER", "CPIADDCLD_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OTHER", "CPIADDCLD_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
         ...
         /**
          * @fileoverview GetColumn
          * @param CPIRSK The Parent (Root) object name.
          * @param OTHERSPEC.DESCADD The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "CPIRSK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "OTHERSPEC.DESCADD";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_CPIRSK__TOT_ENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "TOT_ENDPREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("CPIRSK", "TOT_ENDPREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPIRSK_TOT_ENDPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPIRSK__TOT_ENDPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPIRSK__TOT_ENDPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPIRSK.TOT_ENDPREM");
        			window.setControlWidth(field, "0.4", "CPIRSK", "TOT_ENDPREM");
        		})();
        	}
        })();
          ...
          * @fileoverview GetColumn
          * @param CPIRSK The Parent (Root) object name.
          * @param CLAUSEPREM.PREMIUM The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "CPIRSK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "CLAUSEPREM.PREMIUM";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_CPIRSK__CPIENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CPIENDPREM", "ChildScreen");
        })();
}
function onValidate_CPIRSK__CPIENDPREM_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CPIENDPREM_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CPIRSK", "CPIENDPREM_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPIRSK_CPIENDPREM_CNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPIRSK__CPIENDPREM_CNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPIRSK__CPIENDPREM_CNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPIRSK.CPIENDPREM_CNT");
        			window.setControlWidth(field, "0.4", "CPIRSK", "CPIENDPREM_CNT");
        		})();
        	}
        })();
...
function onValidate_CPIRSK__CPISNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CPISNOTES", "ChildScreen");
        })();
}
function onValidate_CPIRSK__CPINOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CPINOTES", "ChildScreen");
        })();
}
function onValidate_CPIRSK__CPINOTES_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CPINOTES_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CPIRSK", "CPINOTES_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPIRSK_CPINOTES_CNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPIRSK__CPINOTES_CNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPIRSK__CPINOTES_CNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPIRSK.CPINOTES_CNT");
        			window.setControlWidth(field, "0.4", "CPIRSK", "CPINOTES_CNT");
        		})();
        	}
        })();
          ...
          * @fileoverview GetColumn
          * @param CPIRSK The Parent (Root) object name.
          * @param SNOTE.DATE_CREATED The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "CPIRSK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "SNOTE.DATE_CREATED";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    onValidate_GENERAL__RISK_ATTACH_DATE(null, null, null, isOnLoad);
    onValidate_GENERAL__EFFECTIVEDATE(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_VAT(null, null, null, isOnLoad);
    onValidate_GENERAL__DEPPREM(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__CPIMTA(null, null, null, isOnLoad);
    ...
    onValidate_OWNPLANT__PLANTITEM(null, null, null, isOnLoad);
    onValidate_OWNPLANT__PLANTCOUNT(null, null, null, isOnLoad);
    onValidate_OWNPLANT__TOTALPREM(null, null, null, isOnLoad);
    onValidate_OWNPLANT__TOTALIND(null, null, null, isOnLoad);
    onValidate_OWNPLANT__RATE(null, null, null, isOnLoad);
    onValidate_OWNPLANT__TOTALMAX(null, null, null, isOnLoad);
    onValidate_MOBCRANE__CRANE_CHK(null, null, null, isOnLoad);
    onValidate_MOBCRANE__MAX_LIMIT(null, null, null, isOnLoad);
    onValidate_MOBCRANE__HIREFEES(null, null, null, isOnLoad);
    onValidate_MOBCRANE__RATE(null, null, null, isOnLoad);
    onValidate_MOBCRANE__PREMIUM(null, null, null, isOnLoad);
    onValidate_MOBPLANT__PLANT_CHK(null, null, null, isOnLoad);
    onValidate_MOBPLANT__MAX_LIMIT(null, null, null, isOnLoad);
    onValidate_MOBPLANT__HIREFEES(null, null, null, isOnLoad);
    onValidate_MOBPLANT__RATE(null, null, null, isOnLoad);
    onValidate_MOBPLANT__PREMIUM(null, null, null, isOnLoad);
    onValidate_NONMOB__NON_CHK(null, null, null, isOnLoad);
    onValidate_NONMOB__MAX_LIMIT(null, null, null, isOnLoad);
    onValidate_NONMOB__HIREFEES(null, null, null, isOnLoad);
    onValidate_NONMOB__RATE(null, null, null, isOnLoad);
    onValidate_NONMOB__PREMIUM(null, null, null, isOnLoad);
    onValidate_PLANTENVI__PNE_CHK(null, null, null, isOnLoad);
    onValidate_PLANTENVI__MAX_LIMIT(null, null, null, isOnLoad);
    onValidate_PLANTENVI__HIREFEES(null, null, null, isOnLoad);
    onValidate_PLANTENVI__RATE(null, null, null, isOnLoad);
    onValidate_PLANTENVI__PREMIUM(null, null, null, isOnLoad);
    onValidate_SURVEQUIP__SURV_CHK(null, null, null, isOnLoad);
    onValidate_SURVEQUIP__MAX_LIMIT(null, null, null, isOnLoad);
    onValidate_SURVEQUIP__HIREFEES(null, null, null, isOnLoad);
    onValidate_SURVEQUIP__RATE(null, null, null, isOnLoad);
    onValidate_SURVEQUIP__PREMIUM(null, null, null, isOnLoad);
    onValidate_HIREDPLT__HIREDNOT(null, null, null, isOnLoad);
    onValidate_HIREDPLT__TOTALPREM(null, null, null, isOnLoad);
    onValidate_HIREDPLT__TOTALIND(null, null, null, isOnLoad);
    onValidate_HIREDPLT__HIREDNOT_CNT(null, null, null, isOnLoad);
    ...
    onValidate_WRECK__IS_WRECK(null, null, null, isOnLoad);
    onValidate_WRECK__LIMITIND(null, null, null, isOnLoad);
    onValidate_WRECK__RATE(null, null, null, isOnLoad);
    onValidate_WRECK__PREMIUM(null, null, null, isOnLoad);
    onValidate_WRECK__TOTAL_PREM(null, null, null, isOnLoad);
    onValidate_OTHER__CPIADDCLD(null, null, null, isOnLoad);
    onValidate_OTHER__TOTALPREM(null, null, null, isOnLoad);
    onValidate_OTHER__TOTALIND(null, null, null, isOnLoad);
    onValidate_OTHER__CPIADDCLD_CNT(null, null, null, isOnLoad);
    onValidate_CPIRSK__TOT_ENDPREM(null, null, null, isOnLoad);
    onValidate_CPIRSK__CPIENDPREM(null, null, null, isOnLoad);
    onValidate_CPIRSK__CPIENDPREM_CNT(null, null, null, isOnLoad);
    onValidate_CPIRSK__CPISNOTES(null, null, null, isOnLoad);
    onValidate_CPIRSK__CPINOTES(null, null, null, isOnLoad);
    onValidate_CPIRSK__CPINOTES_CNT(null, null, null, isOnLoad);
}
</script>
...
<div id="idb24e3aa9890343ad83366f66039ee155" class="general-layout-container">
...
<div id="ided6b6238030b47388ca53b9542f6626e" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-GENERAL-RISK_ATTACH_DATE">
		<asp:Label ID="lblGENERAL_RISK_ATTACH_DATE" runat="server" AssociatedControlID="GENERAL__RISK_ATTACH_DATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="GENERAL__RISK_ATTACH_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calGENERAL__RISK_ATTACH_DATE" runat="server" LinkedControl="GENERAL__RISK_ATTACH_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valGENERAL_RISK_ATTACH_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_GENERAL__RISK_ATTACH_DATE" 
			ValidationGroup=""
			Display="None"
...
<!-- /List -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_DEPPREM" for="ctl00_cntMainBody_GENERAL__DEPPREM" class="col-md-4 col-sm-3 control-label">
		Deposit Premium Applicable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="DEPPREM" 
		id="pb-container-checkbox-GENERAL-DEPPREM">	
		
		<asp:TextBox ID="GENERAL__DEPPREM" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_DEPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deposit Premium Applicable"
			ClientValidationFunction="onValidate_GENERAL__DEPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ided6b6238030b47388ca53b9542f6626e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ided6b6238030b47388ca53b9542f6626e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ided6b6238030b47388ca53b9542f6626e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ided6b6238030b47388ca53b9542f6626e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ided6b6238030b47388ca53b9542f6626e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided6b6238030b47388ca53b9542f6626e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided6b6238030b47388ca53b9542f6626e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ided6b6238030b47388ca53b9542f6626e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided6b6238030b47388ca53b9542f6626e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided6b6238030b47388ca53b9542f6626e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2a29b0af0ae140738ab918a85e02eec0" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2a29b0af0ae140738ab918a85e02eec0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2a29b0af0ae140738ab918a85e02eec0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2a29b0af0ae140738ab918a85e02eec0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2a29b0af0ae140738ab918a85e02eec0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2a29b0af0ae140738ab918a85e02eec0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2a29b0af0ae140738ab918a85e02eec0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2a29b0af0ae140738ab918a85e02eec0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2a29b0af0ae140738ab918a85e02eec0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2a29b0af0ae140738ab918a85e02eec0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2a29b0af0ae140738ab918a85e02eec0 input{text-align:left;}"; break;
		}
	}
...
<div id="frmMTAReason" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading34" runat="server" Text="Mid-Term Adjustment Reason" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CPIMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CPIMTA" 
		id="pb-container-childscreen-GENERAL-CPIMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CPIMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPIMTA/CPIMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CPIMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CPIMTA"
						ClientValidationFunction="onValidate_GENERAL__CPIMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ided3bb2b8b47b4923885a13e9797fa5da" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading35" runat="server" Text="Address" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ided3bb2b8b47b4923885a13e9797fa5da div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ided3bb2b8b47b4923885a13e9797fa5da div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ided3bb2b8b47b4923885a13e9797fa5da div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ided3bb2b8b47b4923885a13e9797fa5da label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ided3bb2b8b47b4923885a13e9797fa5da label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided3bb2b8b47b4923885a13e9797fa5da label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided3bb2b8b47b4923885a13e9797fa5da label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ided3bb2b8b47b4923885a13e9797fa5da input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided3bb2b8b47b4923885a13e9797fa5da input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided3bb2b8b47b4923885a13e9797fa5da input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4966af18912243d2baec616e6e630480" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_OWNPLANT__PLANTITEM"
		data-field-type="Child" 
		data-object-name="OWNPLANT" 
		data-property-name="PLANTITEM" 
		id="pb-container-childscreen-OWNPLANT-PLANTITEM">
		
		    <legend>Own Plant Items</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="OWNPLANT__PLANTDET" runat="server" ScreenCode="PLANTITEM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PLANTITEM/PLANTITEM_Own_Plant_Item.aspx" emptydatatext="sac">
							<columns>
						<Nexus:GISLookupField HeaderText="Basis of Insurance" ListType="PMLookup" ListCode="UDL_CP_BOI" DataField="BASIS_INS" DataItemValue="key" />
<Nexus:RiskAttribute HeaderText="Category" DataField="CATEGORY" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Total Item Premium" DataField="TOT_ITEM_PREM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valOWNPLANT_PLANTITEM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Own Plant Items"
						ClientValidationFunction="onValidate_OWNPLANT__PLANTITEM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="OWNPLANT" 
		data-property-name="PLANTCOUNT" 
		id="pb-container-integer-OWNPLANT-PLANTCOUNT">
		<asp:Label ID="lblOWNPLANT_PLANTCOUNT" runat="server" AssociatedControlID="OWNPLANT__PLANTCOUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="OWNPLANT__PLANTCOUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valOWNPLANT_PLANTCOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OWNPLANT.PLANTCOUNT"
			ClientValidationFunction="onValidate_OWNPLANT__PLANTCOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OWNPLANT-TOTALPREM">
		<asp:Label ID="lblOWNPLANT_TOTALPREM" runat="server" AssociatedControlID="OWNPLANT__TOTALPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OWNPLANT__TOTALPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOWNPLANT_TOTALPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OWNPLANT.TOTALPREM"
			ClientValidationFunction="onValidate_OWNPLANT__TOTALPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OWNPLANT" 
		data-property-name="TOTALIND" 
		id="pb-container-currency-OWNPLANT-TOTALIND">
		<asp:Label ID="lblOWNPLANT_TOTALIND" runat="server" AssociatedControlID="OWNPLANT__TOTALIND" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OWNPLANT__TOTALIND" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOWNPLANT_TOTALIND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OWNPLANT.TOTALIND"
			ClientValidationFunction="onValidate_OWNPLANT__TOTALIND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-OWNPLANT-RATE">
		<asp:Label ID="lblOWNPLANT_RATE" runat="server" AssociatedControlID="OWNPLANT__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="OWNPLANT__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valOWNPLANT_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OWNPLANT.RATE"
			ClientValidationFunction="onValidate_OWNPLANT__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OWNPLANT" 
		data-property-name="TOTALMAX" 
		id="pb-container-currency-OWNPLANT-TOTALMAX">
		<asp:Label ID="lblOWNPLANT_TOTALMAX" runat="server" AssociatedControlID="OWNPLANT__TOTALMAX" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OWNPLANT__TOTALMAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOWNPLANT_TOTALMAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OWNPLANT.TOTALMAX"
			ClientValidationFunction="onValidate_OWNPLANT__TOTALMAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4966af18912243d2baec616e6e630480 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4966af18912243d2baec616e6e630480 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4966af18912243d2baec616e6e630480 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4966af18912243d2baec616e6e630480 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4966af18912243d2baec616e6e630480 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4966af18912243d2baec616e6e630480 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4966af18912243d2baec616e6e630480 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4966af18912243d2baec616e6e630480 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4966af18912243d2baec616e6e630480 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4966af18912243d2baec616e6e630480 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id16bd305fe6d04366ab454220563e53ae" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading37" runat="server" Text="Hired In Plant - Maximum Limit Any One Item" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label2">
		<span class="label" id="label2">Max Item Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label3">
		<span class="label" id="label3">Est Annual Hire Fees</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label4">
		<span class="label" id="label4">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label5">
		<span class="label" id="label5">Premium</span>
	</span>
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblMOBCRANE_CRANE_CHK" for="ctl00_cntMainBody_MOBCRANE__CRANE_CHK" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="MOBCRANE" 
		data-property-name="CRANE_CHK" 
		id="pb-container-checkbox-MOBCRANE-CRANE_CHK">	
		
		<asp:TextBox ID="MOBCRANE__CRANE_CHK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valMOBCRANE_CRANE_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBCRANE.CRANE_CHK"
			ClientValidationFunction="onValidate_MOBCRANE__CRANE_CHK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label6">
		<span class="label" id="label6">Mobile Cranes</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="MOBCRANE" 
		data-property-name="MAX_LIMIT" 
		id="pb-container-currency-MOBCRANE-MAX_LIMIT">
		<asp:Label ID="lblMOBCRANE_MAX_LIMIT" runat="server" AssociatedControlID="MOBCRANE__MAX_LIMIT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOBCRANE__MAX_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOBCRANE_MAX_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBCRANE.MAX_LIMIT"
			ClientValidationFunction="onValidate_MOBCRANE__MAX_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="MOBCRANE" 
		data-property-name="HIREFEES" 
		id="pb-container-currency-MOBCRANE-HIREFEES">
		<asp:Label ID="lblMOBCRANE_HIREFEES" runat="server" AssociatedControlID="MOBCRANE__HIREFEES" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOBCRANE__HIREFEES" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOBCRANE_HIREFEES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBCRANE.HIREFEES"
			ClientValidationFunction="onValidate_MOBCRANE__HIREFEES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MOBCRANE" 
		data-property-name="RATE" 
		id="pb-container-percentage-MOBCRANE-RATE">
		<asp:Label ID="lblMOBCRANE_RATE" runat="server" AssociatedControlID="MOBCRANE__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MOBCRANE__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMOBCRANE_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBCRANE.RATE"
			ClientValidationFunction="onValidate_MOBCRANE__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MOBCRANE-PREMIUM">
		<asp:Label ID="lblMOBCRANE_PREMIUM" runat="server" AssociatedControlID="MOBCRANE__PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOBCRANE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOBCRANE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBCRANE.PREMIUM"
			ClientValidationFunction="onValidate_MOBCRANE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblMOBPLANT_PLANT_CHK" for="ctl00_cntMainBody_MOBPLANT__PLANT_CHK" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="MOBPLANT" 
		data-property-name="PLANT_CHK" 
		id="pb-container-checkbox-MOBPLANT-PLANT_CHK">	
		
		<asp:TextBox ID="MOBPLANT__PLANT_CHK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valMOBPLANT_PLANT_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBPLANT.PLANT_CHK"
			ClientValidationFunction="onValidate_MOBPLANT__PLANT_CHK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label7">
		<span class="label" id="label7">Mobile Plant</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MOBPLANT" 
		data-property-name="MAX_LIMIT" 
		id="pb-container-currency-MOBPLANT-MAX_LIMIT">
		<asp:Label ID="lblMOBPLANT_MAX_LIMIT" runat="server" AssociatedControlID="MOBPLANT__MAX_LIMIT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOBPLANT__MAX_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOBPLANT_MAX_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBPLANT.MAX_LIMIT"
			ClientValidationFunction="onValidate_MOBPLANT__MAX_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MOBPLANT" 
		data-property-name="HIREFEES" 
		id="pb-container-currency-MOBPLANT-HIREFEES">
		<asp:Label ID="lblMOBPLANT_HIREFEES" runat="server" AssociatedControlID="MOBPLANT__HIREFEES" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOBPLANT__HIREFEES" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOBPLANT_HIREFEES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBPLANT.HIREFEES"
			ClientValidationFunction="onValidate_MOBPLANT__HIREFEES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MOBPLANT" 
		data-property-name="RATE" 
		id="pb-container-percentage-MOBPLANT-RATE">
		<asp:Label ID="lblMOBPLANT_RATE" runat="server" AssociatedControlID="MOBPLANT__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MOBPLANT__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMOBPLANT_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBPLANT.RATE"
			ClientValidationFunction="onValidate_MOBPLANT__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MOBPLANT" 
		data-property-name="PREMIUM" 
		id="pb-container-currency-MOBPLANT-PREMIUM">
		<asp:Label ID="lblMOBPLANT_PREMIUM" runat="server" AssociatedControlID="MOBPLANT__PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOBPLANT__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOBPLANT_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MOBPLANT.PREMIUM"
			ClientValidationFunction="onValidate_MOBPLANT__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblNONMOB_NON_CHK" for="ctl00_cntMainBody_NONMOB__NON_CHK" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="NONMOB" 
		data-property-name="NON_CHK" 
		id="pb-container-checkbox-NONMOB-NON_CHK">	
		
		<asp:TextBox ID="NONMOB__NON_CHK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valNONMOB_NON_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NONMOB.NON_CHK"
			ClientValidationFunction="onValidate_NONMOB__NON_CHK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label8">
		<span class="label" id="label8">Non- mobile Cranes</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NONMOB" 
		data-property-name="MAX_LIMIT" 
		id="pb-container-currency-NONMOB-MAX_LIMIT">
		<asp:Label ID="lblNONMOB_MAX_LIMIT" runat="server" AssociatedControlID="NONMOB__MAX_LIMIT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="NONMOB__MAX_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valNONMOB_MAX_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NONMOB.MAX_LIMIT"
			ClientValidationFunction="onValidate_NONMOB__MAX_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NONMOB" 
		data-property-name="HIREFEES" 
		id="pb-container-currency-NONMOB-HIREFEES">
		<asp:Label ID="lblNONMOB_HIREFEES" runat="server" AssociatedControlID="NONMOB__HIREFEES" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="NONMOB__HIREFEES" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valNONMOB_HIREFEES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NONMOB.HIREFEES"
			ClientValidationFunction="onValidate_NONMOB__HIREFEES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NONMOB" 
		data-property-name="RATE" 
		id="pb-container-percentage-NONMOB-RATE">
		<asp:Label ID="lblNONMOB_RATE" runat="server" AssociatedControlID="NONMOB__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="NONMOB__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valNONMOB_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NONMOB.RATE"
			ClientValidationFunction="onValidate_NONMOB__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NONMOB" 
		data-property-name="PREMIUM" 
		id="pb-container-currency-NONMOB-PREMIUM">
		<asp:Label ID="lblNONMOB_PREMIUM" runat="server" AssociatedControlID="NONMOB__PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="NONMOB__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valNONMOB_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NONMOB.PREMIUM"
			ClientValidationFunction="onValidate_NONMOB__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblPLANTENVI_PNE_CHK" for="ctl00_cntMainBody_PLANTENVI__PNE_CHK" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="PLANTENVI" 
		data-property-name="PNE_CHK" 
		id="pb-container-checkbox-PLANTENVI-PNE_CHK">	
		
		<asp:TextBox ID="PLANTENVI__PNE_CHK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valPLANTENVI_PNE_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PLANTENVI.PNE_CHK"
			ClientValidationFunction="onValidate_PLANTENVI__PNE_CHK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label9">
		<span class="label" id="label9">Plant and Equipment</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PLANTENVI" 
		data-property-name="MAX_LIMIT" 
		id="pb-container-currency-PLANTENVI-MAX_LIMIT">
		<asp:Label ID="lblPLANTENVI_MAX_LIMIT" runat="server" AssociatedControlID="PLANTENVI__MAX_LIMIT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PLANTENVI__MAX_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPLANTENVI_MAX_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PLANTENVI.MAX_LIMIT"
			ClientValidationFunction="onValidate_PLANTENVI__MAX_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PLANTENVI" 
		data-property-name="HIREFEES" 
		id="pb-container-currency-PLANTENVI-HIREFEES">
		<asp:Label ID="lblPLANTENVI_HIREFEES" runat="server" AssociatedControlID="PLANTENVI__HIREFEES" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PLANTENVI__HIREFEES" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPLANTENVI_HIREFEES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PLANTENVI.HIREFEES"
			ClientValidationFunction="onValidate_PLANTENVI__HIREFEES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PLANTENVI" 
		data-property-name="RATE" 
		id="pb-container-percentage-PLANTENVI-RATE">
		<asp:Label ID="lblPLANTENVI_RATE" runat="server" AssociatedControlID="PLANTENVI__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PLANTENVI__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPLANTENVI_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PLANTENVI.RATE"
			ClientValidationFunction="onValidate_PLANTENVI__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PLANTENVI" 
		data-property-name="PREMIUM" 
		id="pb-container-currency-PLANTENVI-PREMIUM">
		<asp:Label ID="lblPLANTENVI_PREMIUM" runat="server" AssociatedControlID="PLANTENVI__PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PLANTENVI__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPLANTENVI_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PLANTENVI.PREMIUM"
			ClientValidationFunction="onValidate_PLANTENVI__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSURVEQUIP_SURV_CHK" for="ctl00_cntMainBody_SURVEQUIP__SURV_CHK" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="SURVEQUIP" 
		data-property-name="SURV_CHK" 
		id="pb-container-checkbox-SURVEQUIP-SURV_CHK">	
		
		<asp:TextBox ID="SURVEQUIP__SURV_CHK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSURVEQUIP_SURV_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SURVEQUIP.SURV_CHK"
			ClientValidationFunction="onValidate_SURVEQUIP__SURV_CHK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label10">
		<span class="label" id="label10">Survey Equipment</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SURVEQUIP" 
		data-property-name="MAX_LIMIT" 
		id="pb-container-currency-SURVEQUIP-MAX_LIMIT">
		<asp:Label ID="lblSURVEQUIP_MAX_LIMIT" runat="server" AssociatedControlID="SURVEQUIP__MAX_LIMIT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SURVEQUIP__MAX_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSURVEQUIP_MAX_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SURVEQUIP.MAX_LIMIT"
			ClientValidationFunction="onValidate_SURVEQUIP__MAX_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SURVEQUIP" 
		data-property-name="HIREFEES" 
		id="pb-container-currency-SURVEQUIP-HIREFEES">
		<asp:Label ID="lblSURVEQUIP_HIREFEES" runat="server" AssociatedControlID="SURVEQUIP__HIREFEES" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SURVEQUIP__HIREFEES" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSURVEQUIP_HIREFEES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SURVEQUIP.HIREFEES"
			ClientValidationFunction="onValidate_SURVEQUIP__HIREFEES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SURVEQUIP" 
		data-property-name="RATE" 
		id="pb-container-percentage-SURVEQUIP-RATE">
		<asp:Label ID="lblSURVEQUIP_RATE" runat="server" AssociatedControlID="SURVEQUIP__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SURVEQUIP__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSURVEQUIP_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SURVEQUIP.RATE"
			ClientValidationFunction="onValidate_SURVEQUIP__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SURVEQUIP" 
		data-property-name="PREMIUM" 
		id="pb-container-currency-SURVEQUIP-PREMIUM">
		<asp:Label ID="lblSURVEQUIP_PREMIUM" runat="server" AssociatedControlID="SURVEQUIP__PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SURVEQUIP__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSURVEQUIP_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SURVEQUIP.PREMIUM"
			ClientValidationFunction="onValidate_SURVEQUIP__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id16bd305fe6d04366ab454220563e53ae div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id16bd305fe6d04366ab454220563e53ae div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id16bd305fe6d04366ab454220563e53ae div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id16bd305fe6d04366ab454220563e53ae label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id16bd305fe6d04366ab454220563e53ae label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id16bd305fe6d04366ab454220563e53ae label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id16bd305fe6d04366ab454220563e53ae label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id16bd305fe6d04366ab454220563e53ae input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id16bd305fe6d04366ab454220563e53ae input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id16bd305fe6d04366ab454220563e53ae input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id79c701d3d9be4794adb4ae95978a6aa9" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_HIREDPLT__HIREDNOT"
		data-field-type="Child" 
		data-object-name="HIREDPLT" 
		data-property-name="HIREDNOT" 
		id="pb-container-childscreen-HIREDPLT-HIREDNOT">
		
		    <legend>Additional Hired In Plant Items</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="HIREDPLT__ADDHIRE" runat="server" ScreenCode="HIREDNOT" AutoGenerateColumns="false"
							GridLines="None" ChildPage="HIREDNOT/HIREDNOT_Additional_Hired_In_Plant_Item.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Description" DataField="DESCRIPTION" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Maximum Item Limit" DataField="MAX_LIMIT" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Estimated Annual Hire Fees" DataField="ANN_FEES" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Rate" DataField="RATE" DataFormatString="{0:0}%"/>
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valHIREDPLT_HIREDNOT" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Additional Hired In Plant Items"
						ClientValidationFunction="onValidate_HIREDPLT__HIREDNOT" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="HIREDPLT" 
		data-property-name="TOTALPREM" 
		id="pb-container-currency-HIREDPLT-TOTALPREM">
		<asp:Label ID="lblHIREDPLT_TOTALPREM" runat="server" AssociatedControlID="HIREDPLT__TOTALPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="HIREDPLT__TOTALPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valHIREDPLT_TOTALPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for HIREDPLT.TOTALPREM"
			ClientValidationFunction="onValidate_HIREDPLT__TOTALPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="HIREDPLT" 
		data-property-name="TOTALIND" 
		id="pb-container-currency-HIREDPLT-TOTALIND">
		<asp:Label ID="lblHIREDPLT_TOTALIND" runat="server" AssociatedControlID="HIREDPLT__TOTALIND" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="HIREDPLT__TOTALIND" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valHIREDPLT_TOTALIND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for HIREDPLT.TOTALIND"
			ClientValidationFunction="onValidate_HIREDPLT__TOTALIND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="HIREDPLT" 
		data-property-name="HIREDNOT_CNT" 
		id="pb-container-integer-HIREDPLT-HIREDNOT_CNT">
		<asp:Label ID="lblHIREDPLT_HIREDNOT_CNT" runat="server" AssociatedControlID="HIREDPLT__HIREDNOT_CNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="HIREDPLT__HIREDNOT_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valHIREDPLT_HIREDNOT_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for HIREDPLT.HIREDNOT_CNT"
			ClientValidationFunction="onValidate_HIREDPLT__HIREDNOT_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id79c701d3d9be4794adb4ae95978a6aa9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id79c701d3d9be4794adb4ae95978a6aa9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id79c701d3d9be4794adb4ae95978a6aa9 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id79c701d3d9be4794adb4ae95978a6aa9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id79c701d3d9be4794adb4ae95978a6aa9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id79c701d3d9be4794adb4ae95978a6aa9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id79c701d3d9be4794adb4ae95978a6aa9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id79c701d3d9be4794adb4ae95978a6aa9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id79c701d3d9be4794adb4ae95978a6aa9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id79c701d3d9be4794adb4ae95978a6aa9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id24160997c7134f6598f8b4818055c41d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading39" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label13">
		<span class="label" id="label13">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label14">
		<span class="label" id="label14">Time Deductible (Hours)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label15">
		<span class="label" id="label15">Indemnity Period (Months)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label16">
		<span class="label" id="label16">Deductible % of Claim</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label17">
		<span class="label" id="label17">Deductible Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label20">
		<span class="label" id="label20">Automatic Additions Clause</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label27">
		<span class="label" id="label27">Continuing Hire Charges</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label28">
		<span class="label" id="label28">Credit Shortfall</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label33">
		<span class="label" id="label33">Damage to Lifted Goods </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label36">
		<span class="label" id="label36">Down the Hole Cover</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label39">
		<span class="label" id="label39">Expediting Expenses</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label44">
		<span class="label" id="label44">Multi Crane Lifts</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label51">
		<span class="label" id="label51">Replacement Plant Hired In</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblWRECK_IS_WRECK" for="ctl00_cntMainBody_WRECK__IS_WRECK" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-WRECK-IS_WRECK">	
		
		<asp:TextBox ID="WRECK__IS_WRECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valWRECK_IS_WRECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WRECK.IS_WRECK"
			ClientValidationFunction="onValidate_WRECK__IS_WRECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label54">
		<span class="label" id="label54">Wreckage Removal</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="WRECK" 
		data-property-name="LIMITIND" 
		id="pb-container-currency-WRECK-LIMITIND">
		<asp:Label ID="lblWRECK_LIMITIND" runat="server" AssociatedControlID="WRECK__LIMITIND" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WRECK__LIMITIND" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWRECK_LIMITIND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WRECK.LIMITIND"
			ClientValidationFunction="onValidate_WRECK__LIMITIND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="WRECK" 
		data-property-name="RATE" 
		id="pb-container-percentage-WRECK-RATE">
		<asp:Label ID="lblWRECK_RATE" runat="server" AssociatedControlID="WRECK__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="WRECK__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valWRECK_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WRECK.RATE"
			ClientValidationFunction="onValidate_WRECK__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label60">
		<span class="label" id="label60">Total</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-WRECK-TOTAL_PREM">
		<asp:Label ID="lblWRECK_TOTAL_PREM" runat="server" AssociatedControlID="WRECK__TOTAL_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WRECK__TOTAL_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWRECK_TOTAL_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WRECK.TOTAL_PREM"
			ClientValidationFunction="onValidate_WRECK__TOTAL_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id24160997c7134f6598f8b4818055c41d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id24160997c7134f6598f8b4818055c41d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id24160997c7134f6598f8b4818055c41d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id24160997c7134f6598f8b4818055c41d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id24160997c7134f6598f8b4818055c41d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id24160997c7134f6598f8b4818055c41d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id24160997c7134f6598f8b4818055c41d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id24160997c7134f6598f8b4818055c41d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id24160997c7134f6598f8b4818055c41d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id24160997c7134f6598f8b4818055c41d input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_OTHER__CPIADDCLD"
		data-field-type="Child" 
		data-object-name="OTHER" 
		data-property-name="CPIADDCLD" 
		id="pb-container-childscreen-OTHER-CPIADDCLD">
		
		    <legend>Other Extensions </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="OTHER__OTHERSPEC" runat="server" ScreenCode="CPIADDCLD" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPIADDCLD/CPIADDCLD_Other_Extensions.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Deductible % of Claim" DataField="DEDUCTCLM" DataFormatString="{0:0}%"/>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valOTHER_CPIADDCLD" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Other Extensions "
						ClientValidationFunction="onValidate_OTHER__CPIADDCLD" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OTHER" 
		data-property-name="TOTALPREM" 
		id="pb-container-currency-OTHER-TOTALPREM">
		<asp:Label ID="lblOTHER_TOTALPREM" runat="server" AssociatedControlID="OTHER__TOTALPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTHER__TOTALPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTHER_TOTALPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OTHER.TOTALPREM"
			ClientValidationFunction="onValidate_OTHER__TOTALPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OTHER" 
		data-property-name="TOTALIND" 
		id="pb-container-currency-OTHER-TOTALIND">
		<asp:Label ID="lblOTHER_TOTALIND" runat="server" AssociatedControlID="OTHER__TOTALIND" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTHER__TOTALIND" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTHER_TOTALIND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OTHER.TOTALIND"
			ClientValidationFunction="onValidate_OTHER__TOTALIND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="OTHER" 
		data-property-name="CPIADDCLD_CNT" 
		id="pb-container-integer-OTHER-CPIADDCLD_CNT">
		<asp:Label ID="lblOTHER_CPIADDCLD_CNT" runat="server" AssociatedControlID="OTHER__CPIADDCLD_CNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="OTHER__CPIADDCLD_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valOTHER_CPIADDCLD_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OTHER.CPIADDCLD_CNT"
			ClientValidationFunction="onValidate_OTHER__CPIADDCLD_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblCPIRSK_REFERRAL_CLAUSES" runat="server" AssociatedControlID="CPIRSK__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="CPIRSK__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CPIRSK" 
		data-property-name="TOT_ENDPREM" 
		id="pb-container-currency-CPIRSK-TOT_ENDPREM">
		<asp:Label ID="lblCPIRSK_TOT_ENDPREM" runat="server" AssociatedControlID="CPIRSK__TOT_ENDPREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CPIRSK__TOT_ENDPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCPIRSK_TOT_ENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_CPIRSK__TOT_ENDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__CPIENDPREM"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="CPIENDPREM" 
		id="pb-container-childscreen-CPIRSK-CPIENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__CLAUSEPREM" runat="server" ScreenCode="CPIENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPIENDPREM/CPIENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPIRSK_CPIENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CPIRSK.CPIENDPREM"
						ClientValidationFunction="onValidate_CPIRSK__CPIENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="CPIRSK" 
		data-property-name="CPIENDPREM_CNT" 
		id="pb-container-integer-CPIRSK-CPIENDPREM_CNT">
		<asp:Label ID="lblCPIRSK_CPIENDPREM_CNT" runat="server" AssociatedControlID="CPIRSK__CPIENDPREM_CNT" 
			Text="Endorsement Premium Count" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CPIRSK__CPIENDPREM_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCPIRSK_CPIENDPREM_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement Premium Count"
			ClientValidationFunction="onValidate_CPIRSK__CPIENDPREM_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id777f9410a2744012bf328b3a5d92af5e" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__CPISNOTES"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="CPISNOTES" 
		id="pb-container-childscreen-CPIRSK-CPISNOTES">
		
		    <legend>Notes (Not Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__CNOTE" runat="server" ScreenCode="CPISNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPISNOTES/CPISNOTES_Note_Detail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCPIRSK_CPISNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Not Printed on Schedule)"
						ClientValidationFunction="onValidate_CPIRSK__CPISNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id777f9410a2744012bf328b3a5d92af5e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id777f9410a2744012bf328b3a5d92af5e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id777f9410a2744012bf328b3a5d92af5e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id777f9410a2744012bf328b3a5d92af5e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id777f9410a2744012bf328b3a5d92af5e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id777f9410a2744012bf328b3a5d92af5e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id777f9410a2744012bf328b3a5d92af5e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id777f9410a2744012bf328b3a5d92af5e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id777f9410a2744012bf328b3a5d92af5e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id777f9410a2744012bf328b3a5d92af5e input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__CPINOTES"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="CPINOTES" 
		id="pb-container-childscreen-CPIRSK-CPINOTES">
		
		    <legend>Notes (Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__SNOTE" runat="server" ScreenCode="CPINOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPINOTES/CPINOTES_Note_Detail.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCPIRSK_CPINOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Printed on Schedule)"
						ClientValidationFunction="onValidate_CPIRSK__CPINOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="CPIRSK" 
		data-property-name="CPINOTES_CNT" 
		id="pb-container-integer-CPIRSK-CPINOTES_CNT">
		<asp:Label ID="lblCPIRSK_CPINOTES_CNT" runat="server" AssociatedControlID="CPIRSK__CPINOTES_CNT" 
			Text="Notes (Printed on Schedule) Count" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CPIRSK__CPINOTES_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCPIRSK_CPINOTES_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Notes (Printed on Schedule) Count"
			ClientValidationFunction="onValidate_CPIRSK__CPINOTES_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
