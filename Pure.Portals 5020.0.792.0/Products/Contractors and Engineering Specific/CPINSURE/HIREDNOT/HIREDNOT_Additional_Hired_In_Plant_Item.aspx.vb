...
Namespace Nexus
    Partial Class PB2_HIREDNOT_Additional_Hired_In_Plant_Item : Inherits BaseRisk
		...
		Protected Sub onValidate_ADDHIRE__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ADDHIRE__COUNTER_ID()
End Sub

		    
        'HIREDPLT - Parent object
        'ADDHIRE - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "HIREDPLT" & "/" & "ADDHIRE", sXMLDataset)
                            If sChildId <> "0" Then
                                ADDHIRE__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
