<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPINOTES_Note_Detail__(Printed_on_Schedule).aspx.vb" Inherits="Nexus.PB2_CPINOTES_Note_Detail__(Printed_on_Schedule)" %>
...
function onValidate_GPASNOTESS__COVER_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Contraction Plants Insurance'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
<div id="id170edaa7ac2045f99847a39afbae1c56" class="general-layout-container">
...
<div id="id6703ac01a1ef47d99d4a5d9ab7358f7f" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6703ac01a1ef47d99d4a5d9ab7358f7f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6703ac01a1ef47d99d4a5d9ab7358f7f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6703ac01a1ef47d99d4a5d9ab7358f7f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6703ac01a1ef47d99d4a5d9ab7358f7f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6703ac01a1ef47d99d4a5d9ab7358f7f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6703ac01a1ef47d99d4a5d9ab7358f7f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6703ac01a1ef47d99d4a5d9ab7358f7f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6703ac01a1ef47d99d4a5d9ab7358f7f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6703ac01a1ef47d99d4a5d9ab7358f7f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6703ac01a1ef47d99d4a5d9ab7358f7f input{text-align:left;}"; break;
		}
	}
