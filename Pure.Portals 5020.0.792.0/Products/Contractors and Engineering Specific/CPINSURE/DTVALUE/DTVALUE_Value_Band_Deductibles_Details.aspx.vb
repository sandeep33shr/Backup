...
Namespace Nexus
    Partial Class PB2_DTVALUE_Value_Band_Deductibles_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_DED_BAND__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DED_BAND__COUNTER_ID()
End Sub
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "AGGRE" & "/" & "DED_BAND", sXMLDataset)
                            If sChildId <> "0" Then
