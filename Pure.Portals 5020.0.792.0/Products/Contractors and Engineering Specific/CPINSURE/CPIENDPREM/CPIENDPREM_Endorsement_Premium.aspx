<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPIENDPREM_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CPIENDPREM_Endorsement_Premium" %>
...
function onValidate_CLAUSEPREM__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLAUSEPREM", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CLAUSEPREM", "COUNTER_ID");
        		}
...
function onValidate_CLAUSEPREM__ENDORSE_DESC(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLAUSEPREM_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLAUSEPREM__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLAUSEPREM__ENDORSE_DESC_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREM.ENDORSE_DESC");
        			window.setControlWidth(field, "0.7", "CLAUSEPREM", "ENDORSE_DESC");
        		})();
        	}
        })();
...
function onValidate_CLAUSEPREM__ENDORSE_CAP(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLAUSEPREM_ENDORSE_CAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLAUSEPREM__ENDORSE_CAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLAUSEPREM__ENDORSE_CAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREM.ENDORSE_CAP");
        			window.setControlWidth(field, "0.7", "CLAUSEPREM", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
...
function onValidate_CLAUSEPREM__PREMIUM(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLAUSEPREM_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLAUSEPREM__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLAUSEPREM__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREM.PREMIUM");
        			window.setControlWidth(field, "0.7", "CLAUSEPREM", "PREMIUM");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    onValidate_CLAUSEPREM__COUNTER_ID(null, null, null, isOnLoad);
...
<div id="id41b3fbf43129481495876baa404ab831" class="general-layout-container">
...
<div id="ide3879316af5b4eadbb53dcffae863610" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CLAUSEPREM-COUNTER_ID">

		
		<asp:Label ID="lblCLAUSEPREM_COUNTER_ID" runat="server" AssociatedControlID="CLAUSEPREM__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CLAUSEPREM__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCLAUSEPREM_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_CLAUSEPREM__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide3879316af5b4eadbb53dcffae863610 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide3879316af5b4eadbb53dcffae863610 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide3879316af5b4eadbb53dcffae863610 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide3879316af5b4eadbb53dcffae863610 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide3879316af5b4eadbb53dcffae863610 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide3879316af5b4eadbb53dcffae863610 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide3879316af5b4eadbb53dcffae863610 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide3879316af5b4eadbb53dcffae863610 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide3879316af5b4eadbb53dcffae863610 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide3879316af5b4eadbb53dcffae863610 input{text-align:left;}"; break;
		}
	}
