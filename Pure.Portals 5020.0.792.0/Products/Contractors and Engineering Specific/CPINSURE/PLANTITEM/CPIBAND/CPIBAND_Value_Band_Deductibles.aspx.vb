...
Namespace Nexus
    Partial Class PB2_CPIBAND_Value_Band_Deductibles : Inherits BaseRisk
		...
		Protected Sub onValidate_BAND__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BAND__COUNTER_ID()
End Sub
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "PLANTDET" & "/" & "BAND", sXMLDataset)
                            If sChildId <> "0" Then
                                BAND__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
