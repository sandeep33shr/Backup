...
Namespace Nexus
    Partial Class PB2_CPINOTE_Note_Detail : Inherits BaseRisk
		...
		Protected Sub onValidate_PLANT_NOTE_DETAIL__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PLANT_NOTE_DETAIL__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		PLANT_NOTE_DETAIL__NoteCheck.Text = 1
        	End If
        End Sub
