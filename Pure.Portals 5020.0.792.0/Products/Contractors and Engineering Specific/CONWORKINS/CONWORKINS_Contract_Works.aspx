<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKINS_Contract_Works.aspx.vb" Inherits="Nexus.PB2_CONWORKINS_Contract_Works" %>
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.4", "GENERAL", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.IS_VAT");
        			window.setControlWidth(field, "0.4", "GENERAL", "IS_VAT");
        		})();
        	}
        })();
        /**
...
function onValidate_GENERAL__CCAMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CCAMTA", "ChildScreen");
        })();
}
function onValidate_ADDRESS__ADDRESSLIST(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "GENERAL.PRODCODE = 'CBA'", "VEM", "Address Type is mandatory and an option must be selected");
        
            var paramValue = "V",
            paramCondition = "GENERAL.PRODCODE = 'CBA'",
            paramElseValue = "VEM",
            paramValidationMessage = "Address Type is mandatory and an option must be selected";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueWhen = new ValueWhenHelper(new Expression("'3131XSA'"), (Expression.isValidParameter("GENERAL.PRODCODE = 'CBA'")) ? new Expression("GENERAL.PRODCODE = 'CBA'") : null, (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null);
...
function onValidate_CWIRSK__INSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "INSURED", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "INSURED");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWIRSK.INSURED");
        			window.setControlWidth(field, "0.8", "CWIRSK", "INSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_INSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__INSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__INSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__PRINCIPAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "PRINCIPAL", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "PRINCIPAL");
        		}
        		//window.setProperty(field, "VE", "GENERAL.PRODCODE = 'CBA'", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWIRSK.PRINCIPAL");
        			window.setControlWidth(field, "0.8", "CWIRSK", "PRINCIPAL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_PRINCIPAL");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__PRINCIPAL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__PRINCIPAL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__CONTRACTOR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "CONTRACTOR", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "CONTRACTOR");
        		}
        		//window.setProperty(field, "VEM", "GENERAL.PRODCODE = 'CBA'", "R", "Contractor is required and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "GENERAL.PRODCODE = 'CBA'",
            paramElseValue = "R",
            paramValidationMessage = "Contractor is required and must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWIRSK.CONTRACTOR");
        			window.setControlWidth(field, "0.8", "CWIRSK", "CONTRACTOR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_CONTRACTOR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__CONTRACTOR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__CONTRACTOR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__IS_CONTRACT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "IS_CONTRACT", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "IS_CONTRACT");
        		}
        		//window.setProperty(field, "V", "CWIRSK.IS_ERECTION ==1", "VE", "{3}");
        
            var paramValue = "V",
            paramCondition = "CWIRSK.IS_ERECTION ==1",
            paramElseValue = "VE",
            paramValidationMessage = "{3}";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_IS_CONTRACT");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__IS_CONTRACT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__IS_CONTRACT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__IS_ERECTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "IS_ERECTION", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "IS_ERECTION");
        		}
        		//window.setProperty(field, "V", "CWIRSK.IS_CONTRACT ==1", "VE", "{3}");
        
            var paramValue = "V",
            paramCondition = "CWIRSK.IS_CONTRACT ==1",
            paramElseValue = "VE",
            paramValidationMessage = "{3}";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_IS_ERECTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__IS_ERECTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__IS_ERECTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__IS_PUBLIC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "IS_PUBLIC", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "IS_PUBLIC");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_IS_PUBLIC");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__IS_PUBLIC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__IS_PUBLIC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CWIRSK.IS_PUBLIC");
        		var update = function(){
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Contract All Risks or Erection All Risks must be selected when Construction Public Liability is selected")) ? "Contract All Risks or Erection All Risks must be selected when Construction Public Liability is selected" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CWIRSK".toUpperCase() + "__" + "IS_PUBLIC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CWIRSK".toUpperCase() + "_" + "IS_PUBLIC");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(CWIRSK.IS_PUBLIC = 1 AND (CWIRSK.IS_CONTRACT == true OR CWIRSK.IS_ERECTION == true)) OR (CWIRSK.IS_PUBLIC == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CWIRSK__IS_ADVANCE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "IS_ADVANCE", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "IS_ADVANCE");
        		}
        		//window.setProperty(field, "VE", "GENERAL.PRODCODE = 'CBA'", "R", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_IS_ADVANCE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__IS_ADVANCE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__IS_ADVANCE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__IS_RISK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "IS_RISK", "TempCheckbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CWIRSK", "IS_RISK");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=TempCheckbox&objectName=CWIRSK&propertyName=IS_RISK&name={name}");
        		
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("(CWIRSK.IS_CONTRACT = 1 or CWIRSK.IS_ERECTION = 1) OR (GENERAL.PRODCODE == 'CBA')")) ? new Expression("(CWIRSK.IS_CONTRACT = 1 or CWIRSK.IS_ERECTION = 1) OR (GENERAL.PRODCODE == 'CBA')") : null, 
...
function onValidate_CWIRSK__IS_SPECIFIC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "IS_SPECIFIC", "TempCheckbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CWIRSK", "IS_SPECIFIC");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=TempCheckbox&objectName=CWIRSK&propertyName=IS_SPECIFIC&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {
        		...
        		events.listen(Field.getInstance("CWIRSK", "IS_SPECIFIC"), "change", update);
        		update();
        	}
...
function onValidate_CWIRSK__IS_ANNUAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "IS_ANNUAL", "TempCheckbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CWIRSK", "IS_ANNUAL");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=TempCheckbox&objectName=CWIRSK&propertyName=IS_ANNUAL&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {
        		...
        		events.listen(Field.getInstance("CWIRSK", "IS_ANNUAL"), "change", update);
        		update();
        	}
...
function onValidate_CWIRSK__PERIOD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "PERIOD", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "PERIOD");
        		}
        		//window.setProperty(field, "V", "GENERAL.PRODCODE = 'CBA'", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWIRSK.PERIOD");
        			window.setControlWidth(field, "0.8", "CWIRSK", "PERIOD");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_PERIOD");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__PERIOD');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__PERIOD_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__PATDEF(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "PATDEF", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "PATDEF");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWIRSK.PATDEF");
        			window.setControlWidth(field, "0.8", "CWIRSK", "PATDEF");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_PATDEF");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__PATDEF');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__PATDEF_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__CON_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "CON_DESCRIPTION", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CWIRSK", "CON_DESCRIPTION");
        		var errorMessage = "Description of Contracts Insured is mandatory and must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWIRSK.CON_DESCRIPTION");
        			window.setControlWidth(field, "0.8", "CWIRSK", "CON_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_CON_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__CON_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__CON_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        /*		var field = Field.getInstance("CWIRSK", "CON_DESCRIPTION");
        		...
        		var blurHandler = function(e){
        			...
        			var MaxChars = 4000;
        			var TextString = field.getValue()
        
        			if (TextString.length > MaxChars)
        			{
        				field.setValue(TextString.substring(0,MaxChars));
        				alert("Description of Contracts Insured has exceeded maximum character length of 4000 characters");
        			}
        		...
        		goog.array.forEach(inputs, function(input){
        			events.listen(input, "keyup", blurHandler, false, this);
        		}, this);
        }, false, this);*/
        ...
          goog.array.forEach(inputs, function(input) {
            goog.events.listen(input, "keyup", keyupHandler);
          });
        });
}
function onValidate_CWIRSK__BUILD_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "BUILD_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "BUILD_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__DAMS_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "DAMS_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "DAMS_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__FACT_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "FACT_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "FACT_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__MINING_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "MINING_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "MINING_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__PIPE_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "PIPE_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "PIPE_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__SHOP_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "SHOP_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "SHOP_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__CONCR_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "CONCR_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "CONCR_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__DOMEST_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "DOMEST_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "DOMEST_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__MASSH_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "MASSH_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "MASSH_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__OFFBLK_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "OFFBLK_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "OFFBLK_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__ROADS_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "ROADS_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "ROADS_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CWIRSK__STEEL_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "STEEL_IND", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "STEEL_IND");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("At least one of the Business Classification must be selected")) ? "At least one of the Business Classification must be selected" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CWIRSK".toUpperCase() + "__" + "STEEL_IND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CWIRSK".toUpperCase() + "_" + "STEEL_IND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.PRODCODE = 'CBA') OR (GENERAL.PRODCODE <> 'CBA' AND (CWIRSK.BUILD_IND = 1 OR CWIRSK.DAMS_IND = 1 OR CWIRSK.FACT_IND = 1 OR CWIRSK.MINING_IND = 1 OR CWIRSK.PIPE_IND = 1 OR CWIRSK.SHOP_IND = 1 OR CWIRSK.CONCR_IND = 1 OR CWIRSK.DOMEST_IND = 1 OR CWIRSK.MASSH_IND = 1 OR CWIRSK.OFFBLK_IND = 1 OR CWIRSK.ROADS_IND = 1 OR CWIRSK.STEEL_IND = 1))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CWIRSK__CONTESTPER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "CONTESTPER", "ChildScreen");
        })();
}
...
function onValidate_GENERAL__RISK_MIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "RISK_MIN", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "RISK_MIN");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__CCA_MINPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CCA_MINPREM", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "CCA_MINPREM");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__CCAMTA(null, null, null, isOnLoad);
    ...
    onValidate_CWIRSK__INSURED(null, null, null, isOnLoad);
    onValidate_CWIRSK__PRINCIPAL(null, null, null, isOnLoad);
    onValidate_CWIRSK__CONTRACTOR(null, null, null, isOnLoad);
    onValidate_CWIRSK__IS_CONTRACT(null, null, null, isOnLoad);
    onValidate_CWIRSK__IS_ERECTION(null, null, null, isOnLoad);
    onValidate_CWIRSK__IS_PUBLIC(null, null, null, isOnLoad);
    onValidate_CWIRSK__IS_ADVANCE(null, null, null, isOnLoad);
    onValidate_CWIRSK__IS_RISK(null, null, null, isOnLoad);
    onValidate_CWIRSK__IS_SPECIFIC(null, null, null, isOnLoad);
    onValidate_CWIRSK__IS_ANNUAL(null, null, null, isOnLoad);
    onValidate_CWIRSK__PERIOD(null, null, null, isOnLoad);
    onValidate_CWIRSK__PATDEF(null, null, null, isOnLoad);
    onValidate_CWIRSK__CON_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_CWIRSK__BUILD_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__DAMS_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__FACT_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__MINING_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__PIPE_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__SHOP_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__CONCR_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__DOMEST_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__MASSH_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__OFFBLK_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__ROADS_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__STEEL_IND(null, null, null, isOnLoad);
    onValidate_CWIRSK__CONTESTPER(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__RISK_MIN(null, null, null, isOnLoad);
    onValidate_GENERAL__CCA_MINPREM(null, null, null, isOnLoad);
...
<div id="id10283ef0614b4623a44e8d65971828e7" class="general-layout-container">
...
<div id="idb80e69d068694a3baaab1174a774c4c3" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb80e69d068694a3baaab1174a774c4c3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb80e69d068694a3baaab1174a774c4c3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb80e69d068694a3baaab1174a774c4c3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb80e69d068694a3baaab1174a774c4c3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb80e69d068694a3baaab1174a774c4c3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb80e69d068694a3baaab1174a774c4c3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb80e69d068694a3baaab1174a774c4c3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb80e69d068694a3baaab1174a774c4c3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb80e69d068694a3baaab1174a774c4c3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb80e69d068694a3baaab1174a774c4c3 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CCAMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CCAMTA" 
		id="pb-container-childscreen-GENERAL-CCAMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CCAMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CCAMTA/CCAMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CCAMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CCAMTA"
						ClientValidationFunction="onValidate_GENERAL__CCAMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9b6dda45fc9640b0b6473ac0ac3eac37" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9b6dda45fc9640b0b6473ac0ac3eac37 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9b6dda45fc9640b0b6473ac0ac3eac37 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9b6dda45fc9640b0b6473ac0ac3eac37 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9b6dda45fc9640b0b6473ac0ac3eac37 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9b6dda45fc9640b0b6473ac0ac3eac37 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9b6dda45fc9640b0b6473ac0ac3eac37 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9b6dda45fc9640b0b6473ac0ac3eac37 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9b6dda45fc9640b0b6473ac0ac3eac37 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9b6dda45fc9640b0b6473ac0ac3eac37 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9b6dda45fc9640b0b6473ac0ac3eac37 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide60f4a00f0134f2dbca2fa0f50b21a60" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading8" runat="server" Text="Insured Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CWIRSK" 
		data-property-name="INSURED" 
		 
		
		 
		id="pb-container-text-CWIRSK-INSURED">

		
		<asp:Label ID="lblCWIRSK_INSURED" runat="server" AssociatedControlID="CWIRSK__INSURED" 
			Text="Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CWIRSK__INSURED" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCWIRSK_INSURED" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Insured"
					ClientValidationFunction="onValidate_CWIRSK__INSURED"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CWIRSK" 
		data-property-name="PRINCIPAL" 
		 
		
		 
		id="pb-container-text-CWIRSK-PRINCIPAL">

		
		<asp:Label ID="lblCWIRSK_PRINCIPAL" runat="server" AssociatedControlID="CWIRSK__PRINCIPAL" 
			Text="Principal" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CWIRSK__PRINCIPAL" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCWIRSK_PRINCIPAL" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Principal"
					ClientValidationFunction="onValidate_CWIRSK__PRINCIPAL"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CWIRSK" 
		data-property-name="CONTRACTOR" 
		 
		
		 
		id="pb-container-text-CWIRSK-CONTRACTOR">

		
		<asp:Label ID="lblCWIRSK_CONTRACTOR" runat="server" AssociatedControlID="CWIRSK__CONTRACTOR" 
			Text="Contractor" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CWIRSK__CONTRACTOR" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCWIRSK_CONTRACTOR" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Contractor"
					ClientValidationFunction="onValidate_CWIRSK__CONTRACTOR"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide60f4a00f0134f2dbca2fa0f50b21a60 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide60f4a00f0134f2dbca2fa0f50b21a60 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide60f4a00f0134f2dbca2fa0f50b21a60 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide60f4a00f0134f2dbca2fa0f50b21a60 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide60f4a00f0134f2dbca2fa0f50b21a60 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide60f4a00f0134f2dbca2fa0f50b21a60 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide60f4a00f0134f2dbca2fa0f50b21a60 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide60f4a00f0134f2dbca2fa0f50b21a60 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide60f4a00f0134f2dbca2fa0f50b21a60 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide60f4a00f0134f2dbca2fa0f50b21a60 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idac675e634ad84ecf85ba8d0074929012" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Cover Selection" /></legend>
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_IS_CONTRACT" for="ctl00_cntMainBody_CWIRSK__IS_CONTRACT" class="col-md-4 col-sm-3 control-label">
		Contract All Risks</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CWIRSK" 
		data-property-name="IS_CONTRACT" 
		id="pb-container-checkbox-CWIRSK-IS_CONTRACT">	
		
		<asp:TextBox ID="CWIRSK__IS_CONTRACT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_IS_CONTRACT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Contract All Risks"
			ClientValidationFunction="onValidate_CWIRSK__IS_CONTRACT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_IS_ERECTION" for="ctl00_cntMainBody_CWIRSK__IS_ERECTION" class="col-md-4 col-sm-3 control-label">
		Erection All Risks</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CWIRSK" 
		data-property-name="IS_ERECTION" 
		id="pb-container-checkbox-CWIRSK-IS_ERECTION">	
		
		<asp:TextBox ID="CWIRSK__IS_ERECTION" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_IS_ERECTION" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Erection All Risks"
			ClientValidationFunction="onValidate_CWIRSK__IS_ERECTION" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_IS_PUBLIC" for="ctl00_cntMainBody_CWIRSK__IS_PUBLIC" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CWIRSK-IS_PUBLIC">	
		
		<asp:TextBox ID="CWIRSK__IS_PUBLIC" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_IS_PUBLIC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Construction Public Liability"
			ClientValidationFunction="onValidate_CWIRSK__IS_PUBLIC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_IS_ADVANCE" for="ctl00_cntMainBody_CWIRSK__IS_ADVANCE" class="col-md-4 col-sm-3 control-label">
		Advanced Loss of Profits </label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CWIRSK" 
		data-property-name="IS_ADVANCE" 
		id="pb-container-checkbox-CWIRSK-IS_ADVANCE">	
		
		<asp:TextBox ID="CWIRSK__IS_ADVANCE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_IS_ADVANCE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Advanced Loss of Profits "
			ClientValidationFunction="onValidate_CWIRSK__IS_ADVANCE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span class="field-container"
		...
		data-object-name="CWIRSK" 
		data-property-name="IS_RISK" 
		id="pb-container-checkbox-CWIRSK-IS_RISK"
	>
		<label id="ctl00_cntMainBody_lblCWIRSK_IS_RISK" for="ctl00_cntMainBody_CWIRSK_IS_RISK_select">Toggle Risk Tab</label>
		<input id="ctl00_cntMainBody_CWIRSK_IS_RISK" class="field-medium hidden" />
			<asp:CustomValidator ID="valCWIRSK_IS_RISK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Toggle Risk Tab"
			ClientValidationFunction="onValidate_CWIRSK__IS_RISK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"
		/>
...
<!-- /TempCheckbox -->
	...
	<span class="field-container"
		...
		id="pb-container-checkbox-CWIRSK-IS_SPECIFIC"
	>
		<label id="ctl00_cntMainBody_lblCWIRSK_IS_SPECIFIC" for="ctl00_cntMainBody_CWIRSK_IS_SPECIFIC_select">Product Toggle</label>
		<input id="ctl00_cntMainBody_CWIRSK_IS_SPECIFIC" class="field-medium hidden" />
			<asp:CustomValidator ID="valCWIRSK_IS_SPECIFIC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Product Toggle"
			ClientValidationFunction="onValidate_CWIRSK__IS_SPECIFIC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"
		/>
...
<!-- /TempCheckbox -->
	...
	<span class="field-container"
		...
		id="pb-container-checkbox-CWIRSK-IS_ANNUAL"
	>
		<label id="ctl00_cntMainBody_lblCWIRSK_IS_ANNUAL" for="ctl00_cntMainBody_CWIRSK_IS_ANNUAL_select">Product Toggle</label>
		<input id="ctl00_cntMainBody_CWIRSK_IS_ANNUAL" class="field-medium hidden" />
			<asp:CustomValidator ID="valCWIRSK_IS_ANNUAL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Product Toggle"
			ClientValidationFunction="onValidate_CWIRSK__IS_ANNUAL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"
		/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idac675e634ad84ecf85ba8d0074929012 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idac675e634ad84ecf85ba8d0074929012 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idac675e634ad84ecf85ba8d0074929012 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idac675e634ad84ecf85ba8d0074929012 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idac675e634ad84ecf85ba8d0074929012 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idac675e634ad84ecf85ba8d0074929012 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idac675e634ad84ecf85ba8d0074929012 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idac675e634ad84ecf85ba8d0074929012 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idac675e634ad84ecf85ba8d0074929012 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idac675e634ad84ecf85ba8d0074929012 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide6af88d1870043d2977a48f4b0550c9a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="Cover Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-CWIRSK-PERIOD">
		<asp:Label ID="lblCWIRSK_PERIOD" runat="server" AssociatedControlID="CWIRSK__PERIOD" 
			Text="Construction Period" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CWIRSK__PERIOD" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCWIRSK_PERIOD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Construction Period"
			ClientValidationFunction="onValidate_CWIRSK__PERIOD" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-CWIRSK-PATDEF">
		<asp:Label ID="lblCWIRSK_PATDEF" runat="server" AssociatedControlID="CWIRSK__PATDEF" 
			Text="Patent Defect Limitation Period/Maintenance Period (Months)" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CWIRSK__PATDEF" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCWIRSK_PATDEF" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Patent Defect Limitation Period/Maintenance Period (Months)"
			ClientValidationFunction="onValidate_CWIRSK__PATDEF" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-CWIRSK-CON_DESCRIPTION">
		<asp:Label ID="lblCWIRSK_CON_DESCRIPTION" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="CWIRSK__CON_DESCRIPTION" 
			Text="Description of Contracts Insured"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="CWIRSK__CON_DESCRIPTION" runat="server" />
		
		<asp:CustomValidator ID="valCWIRSK_CON_DESCRIPTION" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Description of Contracts Insured"
			ClientValidationFunction="onValidate_CWIRSK__CON_DESCRIPTION"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide6af88d1870043d2977a48f4b0550c9a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide6af88d1870043d2977a48f4b0550c9a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide6af88d1870043d2977a48f4b0550c9a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide6af88d1870043d2977a48f4b0550c9a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide6af88d1870043d2977a48f4b0550c9a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide6af88d1870043d2977a48f4b0550c9a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide6af88d1870043d2977a48f4b0550c9a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide6af88d1870043d2977a48f4b0550c9a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide6af88d1870043d2977a48f4b0550c9a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide6af88d1870043d2977a48f4b0550c9a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmBusClass" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="Main Business Classification" /></legend>
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_BUILD_IND" for="ctl00_cntMainBody_CWIRSK__BUILD_IND" class="col-md-4 col-sm-3 control-label">
		Buildings</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWIRSK-BUILD_IND">	
		
		<asp:TextBox ID="CWIRSK__BUILD_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_BUILD_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Buildings"
			ClientValidationFunction="onValidate_CWIRSK__BUILD_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_DAMS_IND" for="ctl00_cntMainBody_CWIRSK__DAMS_IND" class="col-md-4 col-sm-3 control-label">
		Dams</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWIRSK-DAMS_IND">	
		
		<asp:TextBox ID="CWIRSK__DAMS_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_DAMS_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Dams"
			ClientValidationFunction="onValidate_CWIRSK__DAMS_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_FACT_IND" for="ctl00_cntMainBody_CWIRSK__FACT_IND" class="col-md-4 col-sm-3 control-label">
		Factories</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWIRSK-FACT_IND">	
		
		<asp:TextBox ID="CWIRSK__FACT_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_FACT_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Factories"
			ClientValidationFunction="onValidate_CWIRSK__FACT_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_MINING_IND" for="ctl00_cntMainBody_CWIRSK__MINING_IND" class="col-md-4 col-sm-3 control-label">
		Mining</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWIRSK-MINING_IND">	
		
		<asp:TextBox ID="CWIRSK__MINING_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_MINING_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Mining"
			ClientValidationFunction="onValidate_CWIRSK__MINING_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_PIPE_IND" for="ctl00_cntMainBody_CWIRSK__PIPE_IND" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CWIRSK-PIPE_IND">	
		
		<asp:TextBox ID="CWIRSK__PIPE_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_PIPE_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Pipelines/ Infrastructure"
			ClientValidationFunction="onValidate_CWIRSK__PIPE_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_SHOP_IND" for="ctl00_cntMainBody_CWIRSK__SHOP_IND" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CWIRSK-SHOP_IND">	
		
		<asp:TextBox ID="CWIRSK__SHOP_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_SHOP_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Shopping Complexes"
			ClientValidationFunction="onValidate_CWIRSK__SHOP_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_CONCR_IND" for="ctl00_cntMainBody_CWIRSK__CONCR_IND" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CWIRSK-CONCR_IND">	
		
		<asp:TextBox ID="CWIRSK__CONCR_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_CONCR_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Concrete Structures"
			ClientValidationFunction="onValidate_CWIRSK__CONCR_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_DOMEST_IND" for="ctl00_cntMainBody_CWIRSK__DOMEST_IND" class="col-md-4 col-sm-3 control-label">
		Domestic</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWIRSK-DOMEST_IND">	
		
		<asp:TextBox ID="CWIRSK__DOMEST_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_DOMEST_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Domestic"
			ClientValidationFunction="onValidate_CWIRSK__DOMEST_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_MASSH_IND" for="ctl00_cntMainBody_CWIRSK__MASSH_IND" class="col-md-4 col-sm-3 control-label">
		Mass Housing</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWIRSK-MASSH_IND">	
		
		<asp:TextBox ID="CWIRSK__MASSH_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_MASSH_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Mass Housing"
			ClientValidationFunction="onValidate_CWIRSK__MASSH_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_OFFBLK_IND" for="ctl00_cntMainBody_CWIRSK__OFFBLK_IND" class="col-md-4 col-sm-3 control-label">
		Office Blocks</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWIRSK-OFFBLK_IND">	
		
		<asp:TextBox ID="CWIRSK__OFFBLK_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_OFFBLK_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Office Blocks"
			ClientValidationFunction="onValidate_CWIRSK__OFFBLK_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_ROADS_IND" for="ctl00_cntMainBody_CWIRSK__ROADS_IND" class="col-md-4 col-sm-3 control-label">
		Roads</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWIRSK-ROADS_IND">	
		
		<asp:TextBox ID="CWIRSK__ROADS_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_ROADS_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Roads"
			ClientValidationFunction="onValidate_CWIRSK__ROADS_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_STEEL_IND" for="ctl00_cntMainBody_CWIRSK__STEEL_IND" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CWIRSK-STEEL_IND">	
		
		<asp:TextBox ID="CWIRSK__STEEL_IND" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_STEEL_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Steel Structures"
			ClientValidationFunction="onValidate_CWIRSK__STEEL_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmBusClass div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmBusClass div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmBusClass div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmBusClass label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmBusClass label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmBusClass label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmBusClass label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmBusClass input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmBusClass input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmBusClass input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5b8950274e934898b0b7d5d0fba7fcf5" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Contract Testing Periods" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWIRSK__CONTESTPER"
		data-field-type="Child" 
		data-object-name="CWIRSK" 
		data-property-name="CONTESTPER" 
		id="pb-container-childscreen-CWIRSK-CONTESTPER">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWIRSK__CONTPERIOD" runat="server" ScreenCode="CONTESTPER" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CONTESTPER/CONTESTPER_Testing_Period.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Deductible %" DataField="DEDUCTIBLE" DataFormatString="{0:0}%"/>
...
<Nexus:GISLookupField HeaderText="Basis of Deductible" ListType="PMLookup" ListCode="UDL_CW_BASISDED" DataField="BASIS_DED" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valCWIRSK_CONTESTPER" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CWIRSK.CONTESTPER"
						ClientValidationFunction="onValidate_CWIRSK__CONTESTPER" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5b8950274e934898b0b7d5d0fba7fcf5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5b8950274e934898b0b7d5d0fba7fcf5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5b8950274e934898b0b7d5d0fba7fcf5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5b8950274e934898b0b7d5d0fba7fcf5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5b8950274e934898b0b7d5d0fba7fcf5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5b8950274e934898b0b7d5d0fba7fcf5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5b8950274e934898b0b7d5d0fba7fcf5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5b8950274e934898b0b7d5d0fba7fcf5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5b8950274e934898b0b7d5d0fba7fcf5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5b8950274e934898b0b7d5d0fba7fcf5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf1ed993fed1d425b8f81c648a913c053" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GENERAL" 
		data-property-name="RISK_MIN" 
		id="pb-container-currency-GENERAL-RISK_MIN">
		<asp:Label ID="lblGENERAL_RISK_MIN" runat="server" AssociatedControlID="GENERAL__RISK_MIN" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__RISK_MIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGENERAL_RISK_MIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_GENERAL__RISK_MIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="GENERAL" 
		data-property-name="CCA_MINPREM" 
		id="pb-container-currency-GENERAL-CCA_MINPREM">
		<asp:Label ID="lblGENERAL_CCA_MINPREM" runat="server" AssociatedControlID="GENERAL__CCA_MINPREM" 
			Text="Minimum Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__CCA_MINPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGENERAL_CCA_MINPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Premium"
			ClientValidationFunction="onValidate_GENERAL__CCA_MINPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf1ed993fed1d425b8f81c648a913c053 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf1ed993fed1d425b8f81c648a913c053 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf1ed993fed1d425b8f81c648a913c053 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf1ed993fed1d425b8f81c648a913c053 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf1ed993fed1d425b8f81c648a913c053 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf1ed993fed1d425b8f81c648a913c053 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf1ed993fed1d425b8f81c648a913c053 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf1ed993fed1d425b8f81c648a913c053 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf1ed993fed1d425b8f81c648a913c053 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf1ed993fed1d425b8f81c648a913c053 input{text-align:left;}"; break;
		}
	}
