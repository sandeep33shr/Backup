...
Namespace Nexus
    Partial Class PB2_CONWORKINS_Contract_Works : Inherits BaseRisk
		...
		Protected Sub onValidate_GENERAL__RISK_ATTACH_DATE()
...
End Sub
Protected Sub onValidate_CWIRSK__INSURED()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If GENERAL__RISK_ATTACH_DATE.Text = "" or GENERAL__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			GENERAL__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			GENERAL__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (GENERAL__RISK_ATTACH_DATE.Text <> "" Or GENERAL__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub SetInsuredName(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	Dim oQuote As NexusProvider.Quote = Session(CNQuote)
            CWIRSK__INSURED.Text = oQuote.InsuredName
        End Sub
