...
Namespace Nexus
    Partial Class PB2_COWENDOS_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_CW_ENDORSE__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CW_ENDORSE__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'CW_RISK - Standard Wording Parent Object
        'REFERRAL_CLAUSES - Standard Wording Parent Property
        'CW_ENDORSE - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/CW_RISK/SW.REFERRAL_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("CW_ENDORSE__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/CW_RISK/CW_ENDORSE")
        
        	Dim CurrentSelected As String = CW_ENDORSE__ENDORSE_CAP.Text
