...
<%@ Register Src="~/portal/internal/Controls/DocumentManager.ascx" TagName="DocumentManager" TagPrefix="uc" %>
...
<uc:DocumentManager runat="server" id="docMgr" Autoarchiveselected="true" />
