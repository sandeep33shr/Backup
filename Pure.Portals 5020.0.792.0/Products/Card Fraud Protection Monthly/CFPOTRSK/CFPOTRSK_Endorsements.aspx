<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CFPOTRSK_Endorsements.aspx.vb" Inherits="Nexus.PB2_CFPOTRSK_Endorsements" %>
...
function onValidate_ENDORSCHLD__CFPENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENDORSCHLD", "CFPENDPREM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_ENDORSCHLD__CFPENDPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id76fc02dd923d4d6aa50988e48dbf82fa" class="general-layout-container">
...
<div id="idb26b297a680b43999715db8155fabc98" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="Premium Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENDORSCHLD__CFPENDPREM"
		data-field-type="Child" 
		data-object-name="ENDORSCHLD" 
		data-property-name="CFPENDPREM" 
		id="pb-container-childscreen-ENDORSCHLD-CFPENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENDORSCHLD__PREMENDORS" runat="server" ScreenCode="CFPENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CFPENDPREM/CFPENDPREM_Premium_Endorsements.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valENDORSCHLD_CFPENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ENDORSCHLD.CFPENDPREM"
						ClientValidationFunction="onValidate_ENDORSCHLD__CFPENDPREM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb26b297a680b43999715db8155fabc98 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb26b297a680b43999715db8155fabc98 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb26b297a680b43999715db8155fabc98 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb26b297a680b43999715db8155fabc98 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb26b297a680b43999715db8155fabc98 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb26b297a680b43999715db8155fabc98 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb26b297a680b43999715db8155fabc98 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb26b297a680b43999715db8155fabc98 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb26b297a680b43999715db8155fabc98 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb26b297a680b43999715db8155fabc98 input{text-align:left;}"; break;
		}
	}
