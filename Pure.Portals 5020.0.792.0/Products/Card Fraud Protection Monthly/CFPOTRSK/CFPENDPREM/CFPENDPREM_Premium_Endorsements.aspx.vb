...
Namespace Nexus
    Partial Class PB2_CFPENDPREM_Premium_Endorsements : Inherits BaseRisk
		...
		Protected Sub onValidate_PREMENDORS__CREATED_BY()
                If eLifecycleEvent = LifecycleEvent.Page_Load Then
                        
        					PREMENDORS__CREATED_BY.Text = Session(CNLoginName).ToString
                     
                    End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_PREMENDORS__CREATED_BY()
End Sub
