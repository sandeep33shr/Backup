<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARAENDP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CARAENDP_Endorsement_Premium" %>
...
function onValidate_A_CLAUSEPREM__AENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "A_CLAUSEPREM", "AENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("A_CLAUSEPREM", "AENDORSE_ID");
        		}
...
function onValidate_A_CLAUSEPREM__AENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "A_CLAUSEPREM", "AENDORSE_DESC", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("A_CLAUSEPREM", "AENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("A_CLAUSEPREM.AENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "A_CLAUSEPREM", "AENDORSE_DESC");
        		})();
        	}
        })();
...
function onValidate_A_CLAUSEPREM__AENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "A_CLAUSEPREM", "AENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("A_CLAUSEPREM", "AENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_A_CLAUSEPREM__APREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "A_CLAUSEPREM", "APREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("A_CLAUSEPREM", "APREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("A_CLAUSEPREM.APREMIUM");
        			window.setControlWidth(field, "0.5", "A_CLAUSEPREM", "APREMIUM");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    onValidate_A_CLAUSEPREM__AENDORSE_ID(null, null, null, isOnLoad);
    onValidate_A_CLAUSEPREM__AENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_A_CLAUSEPREM__AENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_A_CLAUSEPREM__APREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idcb77409e5fb24598aec59be0602761a7" class="general-layout-container">
...
<div id="id84b9c0370456406e95be0959243854d2" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="A_CLAUSEPREM" 
		data-property-name="AENDORSE_ID" 
		id="pb-container-integer-A_CLAUSEPREM-AENDORSE_ID">
		<asp:Label ID="lblA_CLAUSEPREM_AENDORSE_ID" runat="server" AssociatedControlID="A_CLAUSEPREM__AENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="A_CLAUSEPREM__AENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valA_CLAUSEPREM_AENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_A_CLAUSEPREM__AENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="A_CLAUSEPREM" 
		data-property-name="AENDORSE_DESC" 
		 
		
		 
		id="pb-container-text-A_CLAUSEPREM-AENDORSE_DESC">

		
		<asp:Label ID="lblA_CLAUSEPREM_AENDORSE_DESC" runat="server" AssociatedControlID="A_CLAUSEPREM__AENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="A_CLAUSEPREM__AENDORSE_DESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valA_CLAUSEPREM_AENDORSE_DESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_A_CLAUSEPREM__AENDORSE_DESC"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="A_CLAUSEPREM" 
		data-property-name="AENDORSE_CAP" 
		 
		
		 
		id="pb-container-text-A_CLAUSEPREM-AENDORSE_CAP">

		
		<asp:Label ID="lblA_CLAUSEPREM_AENDORSE_CAP" runat="server" AssociatedControlID="A_CLAUSEPREM__AENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="A_CLAUSEPREM__AENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valA_CLAUSEPREM_AENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_A_CLAUSEPREM__AENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-A_CLAUSEPREM-APREMIUM">
		<asp:Label ID="lblA_CLAUSEPREM_APREMIUM" runat="server" AssociatedControlID="A_CLAUSEPREM__APREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="A_CLAUSEPREM__APREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valA_CLAUSEPREM_APREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_A_CLAUSEPREM__APREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id84b9c0370456406e95be0959243854d2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id84b9c0370456406e95be0959243854d2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id84b9c0370456406e95be0959243854d2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id84b9c0370456406e95be0959243854d2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id84b9c0370456406e95be0959243854d2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id84b9c0370456406e95be0959243854d2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id84b9c0370456406e95be0959243854d2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id84b9c0370456406e95be0959243854d2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id84b9c0370456406e95be0959243854d2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id84b9c0370456406e95be0959243854d2 input{text-align:left;}"; break;
		}
	}
