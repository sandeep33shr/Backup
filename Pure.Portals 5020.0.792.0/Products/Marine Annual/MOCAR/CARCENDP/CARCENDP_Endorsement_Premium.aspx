<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARCENDP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CARCENDP_Endorsement_Premium" %>
...
function onValidate_C_CLAUSEPREM__CAENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "C_CLAUSEPREM", "CAENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("C_CLAUSEPREM", "CAENDORSE_ID");
        		}
...
function onValidate_C_CLAUSEPREM__CENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "C_CLAUSEPREM", "CENDORSE_DESC", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("C_CLAUSEPREM", "CENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("C_CLAUSEPREM.CENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "C_CLAUSEPREM", "CENDORSE_DESC");
        		})();
        	}
        })();
...
function onValidate_C_CLAUSEPREM__CAENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "C_CLAUSEPREM", "CAENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("C_CLAUSEPREM", "CAENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_C_CLAUSEPREM__CPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "C_CLAUSEPREM", "CPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("C_CLAUSEPREM", "CPREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("C_CLAUSEPREM.CPREMIUM");
        			window.setControlWidth(field, "0.5", "C_CLAUSEPREM", "CPREMIUM");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    onValidate_C_CLAUSEPREM__CAENDORSE_ID(null, null, null, isOnLoad);
    onValidate_C_CLAUSEPREM__CENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_C_CLAUSEPREM__CAENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_C_CLAUSEPREM__CPREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idd48a0dd73dc543d989c8d64fe84307d6" class="general-layout-container">
...
<div id="ide3083c71351243d58eb1c7badac57ebb" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="C_CLAUSEPREM" 
		data-property-name="CAENDORSE_ID" 
		id="pb-container-integer-C_CLAUSEPREM-CAENDORSE_ID">
		<asp:Label ID="lblC_CLAUSEPREM_CAENDORSE_ID" runat="server" AssociatedControlID="C_CLAUSEPREM__CAENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="C_CLAUSEPREM__CAENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valC_CLAUSEPREM_CAENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_C_CLAUSEPREM__CAENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="C_CLAUSEPREM" 
		data-property-name="CENDORSE_DESC" 
		 
		
		 
		id="pb-container-text-C_CLAUSEPREM-CENDORSE_DESC">

		
		<asp:Label ID="lblC_CLAUSEPREM_CENDORSE_DESC" runat="server" AssociatedControlID="C_CLAUSEPREM__CENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="C_CLAUSEPREM__CENDORSE_DESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valC_CLAUSEPREM_CENDORSE_DESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_C_CLAUSEPREM__CENDORSE_DESC"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="C_CLAUSEPREM" 
		data-property-name="CAENDORSE_CAP" 
		 
		
		 
		id="pb-container-text-C_CLAUSEPREM-CAENDORSE_CAP">

		
		<asp:Label ID="lblC_CLAUSEPREM_CAENDORSE_CAP" runat="server" AssociatedControlID="C_CLAUSEPREM__CAENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="C_CLAUSEPREM__CAENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valC_CLAUSEPREM_CAENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_C_CLAUSEPREM__CAENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="C_CLAUSEPREM" 
		data-property-name="CPREMIUM" 
		id="pb-container-currency-C_CLAUSEPREM-CPREMIUM">
		<asp:Label ID="lblC_CLAUSEPREM_CPREMIUM" runat="server" AssociatedControlID="C_CLAUSEPREM__CPREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="C_CLAUSEPREM__CPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valC_CLAUSEPREM_CPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_C_CLAUSEPREM__CPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide3083c71351243d58eb1c7badac57ebb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide3083c71351243d58eb1c7badac57ebb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide3083c71351243d58eb1c7badac57ebb div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide3083c71351243d58eb1c7badac57ebb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide3083c71351243d58eb1c7badac57ebb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide3083c71351243d58eb1c7badac57ebb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide3083c71351243d58eb1c7badac57ebb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide3083c71351243d58eb1c7badac57ebb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide3083c71351243d58eb1c7badac57ebb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide3083c71351243d58eb1c7badac57ebb input{text-align:left;}"; break;
		}
	}
