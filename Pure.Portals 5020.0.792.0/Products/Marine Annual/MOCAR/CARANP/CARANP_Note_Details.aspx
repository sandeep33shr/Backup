<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARANP_Note_Details.aspx.vb" Inherits="Nexus.PB2_CARANP_Note_Details" %>
...
function onValidate_SUBANOTE_DETAILS__ADATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBANOTE_DETAILS", "ADATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBANOTE_DETAILS", "ADATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("SUBANOTE_DETAILS", "ADATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=SUBANOTE_DETAILS&propertyName=ADATE_CREATED&name={name}");
...
function onValidate_SUBANOTE_DETAILS__ACREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBANOTE_DETAILS", "ACREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBANOTE_DETAILS", "ACREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("SUBANOTE_DETAILS", "ACREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_SUBANOTE_DETAILS__ACOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBANOTE_DETAILS", "ACOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBANOTE_DETAILS", "ACOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("SUBANOTE_DETAILS", "ACOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SUBANOTE_DETAILS&propertyName=ACOVER_TYPE&name={name}");
...
function onValidate_SUBANOTE_DETAILS__ANOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBANOTE_DETAILS", "ANOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SUBANOTE_DETAILS", "ANOTE_DESCRIPTION");
...
function onValidate_SUBANOTE_DETAILS__ANOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBANOTE_DETAILS", "ANOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SUBANOTE_DETAILS", "ANOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=SUBANOTE_DETAILS&propertyName=ANOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_SUBANOTE_DETAILS__ANOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_SUBANOTE_DETAILS_ANOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_SUBANOTE_DETAILS__ANOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBANOTE_DETAILS", "ANOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SUBANOTE_DETAILS", "ANOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_SUBANOTE_DETAILS__ADATE_CREATED(null, null, null, isOnLoad);
    onValidate_SUBANOTE_DETAILS__ACREATED_BY(null, null, null, isOnLoad);
    onValidate_SUBANOTE_DETAILS__ACOVER_TYPE(null, null, null, isOnLoad);
    onValidate_SUBANOTE_DETAILS__ANOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SUBANOTE_DETAILS__ANOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_SUBANOTE_DETAILS__ANOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="id89ac12d0fc744f0eb4cecf9847cb0dda" class="general-layout-container">
...
<div id="idc3844d63376c408f905210aa414b35af" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Sub Section A:Imports Note Detail  (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SUBANOTE_DETAILS" 
		data-property-name="ADATE_CREATED" 
		id="pb-container-datejquerycompatible-SUBANOTE_DETAILS-ADATE_CREATED">
		<asp:Label ID="lblSUBANOTE_DETAILS_ADATE_CREATED" runat="server" AssociatedControlID="SUBANOTE_DETAILS__ADATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="SUBANOTE_DETAILS__ADATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calSUBANOTE_DETAILS__ADATE_CREATED" runat="server" LinkedControl="SUBANOTE_DETAILS__ADATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valSUBANOTE_DETAILS_ADATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_SUBANOTE_DETAILS__ADATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SUBANOTE_DETAILS" 
		data-property-name="ACREATED_BY" 
		 
		
		 
		id="pb-container-text-SUBANOTE_DETAILS-ACREATED_BY">

		
		<asp:Label ID="lblSUBANOTE_DETAILS_ACREATED_BY" runat="server" AssociatedControlID="SUBANOTE_DETAILS__ACREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SUBANOTE_DETAILS__ACREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSUBANOTE_DETAILS_ACREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_SUBANOTE_DETAILS__ACREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SUBANOTE_DETAILS" 
		data-property-name="ACOVER_TYPE" 
		 
		
		 
		id="pb-container-text-SUBANOTE_DETAILS-ACOVER_TYPE">

		
		<asp:Label ID="lblSUBANOTE_DETAILS_ACOVER_TYPE" runat="server" AssociatedControlID="SUBANOTE_DETAILS__ACOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SUBANOTE_DETAILS__ACOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSUBANOTE_DETAILS_ACOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_SUBANOTE_DETAILS__ACOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SUBANOTE_DETAILS" 
		data-property-name="ANOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-SUBANOTE_DETAILS-ANOTE_DESCRIPTION">

		
		<asp:Label ID="lblSUBANOTE_DETAILS_ANOTE_DESCRIPTION" runat="server" AssociatedControlID="SUBANOTE_DETAILS__ANOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SUBANOTE_DETAILS__ANOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSUBANOTE_DETAILS_ANOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_SUBANOTE_DETAILS__ANOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SUBANOTE_DETAILS" 
		data-property-name="ANOTE_DETAILS" 
		id="pb-container-comment-SUBANOTE_DETAILS-ANOTE_DETAILS">
		<asp:Label ID="lblSUBANOTE_DETAILS_ANOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="SUBANOTE_DETAILS__ANOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="SUBANOTE_DETAILS__ANOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valSUBANOTE_DETAILS_ANOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_SUBANOTE_DETAILS__ANOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSUBANOTE_DETAILS_ANOTECHECK" for="ctl00_cntMainBody_SUBANOTE_DETAILS__ANOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="SUBANOTE_DETAILS" 
		data-property-name="ANOTECHECK" 
		id="pb-container-checkbox-SUBANOTE_DETAILS-ANOTECHECK">	
		
		<asp:TextBox ID="SUBANOTE_DETAILS__ANOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSUBANOTE_DETAILS_ANOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_SUBANOTE_DETAILS__ANOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc3844d63376c408f905210aa414b35af div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc3844d63376c408f905210aa414b35af div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc3844d63376c408f905210aa414b35af div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc3844d63376c408f905210aa414b35af label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc3844d63376c408f905210aa414b35af label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc3844d63376c408f905210aa414b35af label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc3844d63376c408f905210aa414b35af label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc3844d63376c408f905210aa414b35af input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc3844d63376c408f905210aa414b35af input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc3844d63376c408f905210aa414b35af input{text-align:left;}"; break;
		}
	}
