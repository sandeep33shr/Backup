<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARAPN_Note_Details.aspx.vb" Inherits="Nexus.PB2_CARAPN_Note_Details" %>
...
function onValidate_SUBAPNOTE_DETAILS__APDATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBAPNOTE_DETAILS", "APDATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBAPNOTE_DETAILS", "APDATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("SUBAPNOTE_DETAILS", "APDATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=SUBAPNOTE_DETAILS&propertyName=APDATE_CREATED&name={name}");
...
function onValidate_SUBAPNOTE_DETAILS__APCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBAPNOTE_DETAILS", "APCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBAPNOTE_DETAILS", "APCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("SUBAPNOTE_DETAILS", "APCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_SUBAPNOTE_DETAILS__APCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBAPNOTE_DETAILS", "APCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBAPNOTE_DETAILS", "APCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("SUBAPNOTE_DETAILS", "APCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SUBAPNOTE_DETAILS&propertyName=APCOVER_TYPE&name={name}");
        		
        		var value = new Expression("'Sub Section A:Imports'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_SUBAPNOTE_DETAILS__APNOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBAPNOTE_DETAILS", "APNOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SUBAPNOTE_DETAILS", "APNOTE_DESCRIPTION");
...
function onValidate_SUBAPNOTE_DETAILS__APNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBAPNOTE_DETAILS", "APNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SUBAPNOTE_DETAILS", "APNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=SUBAPNOTE_DETAILS&propertyName=APNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_SUBAPNOTE_DETAILS__APNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_SUBAPNOTE_DETAILS_APNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_SUBAPNOTE_DETAILS__APNOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBAPNOTE_DETAILS", "APNOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SUBAPNOTE_DETAILS", "APNOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_SUBAPNOTE_DETAILS__APDATE_CREATED(null, null, null, isOnLoad);
    onValidate_SUBAPNOTE_DETAILS__APCREATED_BY(null, null, null, isOnLoad);
    onValidate_SUBAPNOTE_DETAILS__APCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_SUBAPNOTE_DETAILS__APNOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SUBAPNOTE_DETAILS__APNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_SUBAPNOTE_DETAILS__APNOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="id140d82f2c5da4cecbe14bbc83e078dd8" class="general-layout-container">
...
<div id="id240cbbb19a1d4e92ad1ecbbe26093c03" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Sub Section A:Imports Note Detail (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SUBAPNOTE_DETAILS" 
		data-property-name="APDATE_CREATED" 
		id="pb-container-datejquerycompatible-SUBAPNOTE_DETAILS-APDATE_CREATED">
		<asp:Label ID="lblSUBAPNOTE_DETAILS_APDATE_CREATED" runat="server" AssociatedControlID="SUBAPNOTE_DETAILS__APDATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="SUBAPNOTE_DETAILS__APDATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calSUBAPNOTE_DETAILS__APDATE_CREATED" runat="server" LinkedControl="SUBAPNOTE_DETAILS__APDATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valSUBAPNOTE_DETAILS_APDATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_SUBAPNOTE_DETAILS__APDATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SUBAPNOTE_DETAILS" 
		data-property-name="APCREATED_BY" 
		 
		
		 
		id="pb-container-text-SUBAPNOTE_DETAILS-APCREATED_BY">

		
		<asp:Label ID="lblSUBAPNOTE_DETAILS_APCREATED_BY" runat="server" AssociatedControlID="SUBAPNOTE_DETAILS__APCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SUBAPNOTE_DETAILS__APCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSUBAPNOTE_DETAILS_APCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_SUBAPNOTE_DETAILS__APCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SUBAPNOTE_DETAILS" 
		data-property-name="APCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-SUBAPNOTE_DETAILS-APCOVER_TYPE">

		
		<asp:Label ID="lblSUBAPNOTE_DETAILS_APCOVER_TYPE" runat="server" AssociatedControlID="SUBAPNOTE_DETAILS__APCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SUBAPNOTE_DETAILS__APCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSUBAPNOTE_DETAILS_APCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_SUBAPNOTE_DETAILS__APCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SUBAPNOTE_DETAILS" 
		data-property-name="APNOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-SUBAPNOTE_DETAILS-APNOTE_DESCRIPTION">

		
		<asp:Label ID="lblSUBAPNOTE_DETAILS_APNOTE_DESCRIPTION" runat="server" AssociatedControlID="SUBAPNOTE_DETAILS__APNOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SUBAPNOTE_DETAILS__APNOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSUBAPNOTE_DETAILS_APNOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_SUBAPNOTE_DETAILS__APNOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SUBAPNOTE_DETAILS" 
		data-property-name="APNOTE_DETAILS" 
		id="pb-container-comment-SUBAPNOTE_DETAILS-APNOTE_DETAILS">
		<asp:Label ID="lblSUBAPNOTE_DETAILS_APNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="SUBAPNOTE_DETAILS__APNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="SUBAPNOTE_DETAILS__APNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valSUBAPNOTE_DETAILS_APNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_SUBAPNOTE_DETAILS__APNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSUBAPNOTE_DETAILS_APNOTECHECK" for="ctl00_cntMainBody_SUBAPNOTE_DETAILS__APNOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="SUBAPNOTE_DETAILS" 
		data-property-name="APNOTECHECK" 
		id="pb-container-checkbox-SUBAPNOTE_DETAILS-APNOTECHECK">	
		
		<asp:TextBox ID="SUBAPNOTE_DETAILS__APNOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSUBAPNOTE_DETAILS_APNOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_SUBAPNOTE_DETAILS__APNOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id240cbbb19a1d4e92ad1ecbbe26093c03 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id240cbbb19a1d4e92ad1ecbbe26093c03 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id240cbbb19a1d4e92ad1ecbbe26093c03 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id240cbbb19a1d4e92ad1ecbbe26093c03 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id240cbbb19a1d4e92ad1ecbbe26093c03 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id240cbbb19a1d4e92ad1ecbbe26093c03 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id240cbbb19a1d4e92ad1ecbbe26093c03 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id240cbbb19a1d4e92ad1ecbbe26093c03 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id240cbbb19a1d4e92ad1ecbbe26093c03 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id240cbbb19a1d4e92ad1ecbbe26093c03 input{text-align:left;}"; break;
		}
	}
