<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOCAR_Sub_Section_C_Inland_Transit.aspx.vb" Inherits="Nexus.PB2_MOCAR_Sub_Section_C_Inland_Transit" %>
...
function onValidate_CANYONELOC(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
        (function(){
        	if (isOnLoad) {	
        		var field
        		if ("CANYONELOC" != "{na" + "me}"){
        			field = Field.getLabel("CANYONELOC");
        		} else { 
        			field = Field.getInstance("", "");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_INLANDTRANSIT__CANYLOCLIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INLANDTRANSIT", "CANYLOCLIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INLANDTRANSIT", "CANYLOCLIMIT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INLANDTRANSIT.CANYLOCLIMIT");
        			window.setControlWidth(field, "0.8", "INLANDTRANSIT", "CANYLOCLIMIT");
        		})();
        	}
        })();
}
function onValidate_INLANDTRANSIT__CARCBMI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INLANDTRANSIT", "CARCBMI", "ChildScreen");
        })();
}
function onValidate_EXPORTS__CGEO_FROM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXPORTS", "CGEO_FROM", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXPORTS", "CGEO_FROM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXPORTS.CGEO_FROM");
        			window.setControlWidth(field, "0.8", "EXPORTS", "CGEO_FROM");
        		})();
        	}
        })();
}
function onValidate_EXPORTS__CGEO_TO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXPORTS", "CGEO_TO", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXPORTS", "CGEO_TO");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXPORTS.CGEO_TO");
        			window.setControlWidth(field, "0.8", "EXPORTS", "CGEO_TO");
        		})();
        	}
        })();
}
function onValidate_INLANDTRANSIT__CARCBV(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INLANDTRANSIT", "CARCBV", "ChildScreen");
        })();
}
...
function onValidate_INLANDTRANSIT__CARCCBV(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INLANDTRANSIT", "CARCCBV", "ChildScreen");
        })();
}
...
function onValidate_INLANDTRANSIT__CARCENDP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INLANDTRANSIT", "CARCENDP", "ChildScreen");
        })();
}
function onValidate_INLANDTRANSIT__CARCNP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INLANDTRANSIT", "CARCNP", "ChildScreen");
        })();
}
function onValidate_INLANDTRANSIT__CARCPN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INLANDTRANSIT", "CARCPN", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_CANYONELOC(null, null, null, isOnLoad);
    onValidate_INLANDTRANSIT__CANYLOCLIMIT(null, null, null, isOnLoad);
    onValidate_INLANDTRANSIT__CARCBMI(null, null, null, isOnLoad);
    onValidate_EXPORTS__CGEO_FROM(null, null, null, isOnLoad);
    onValidate_EXPORTS__CGEO_TO(null, null, null, isOnLoad);
    onValidate_INLANDTRANSIT__CARCBV(null, null, null, isOnLoad);
    ...
    onValidate_INLANDTRANSIT__CARCCBV(null, null, null, isOnLoad);
    ...
    onValidate_INLANDTRANSIT__CARCENDP(null, null, null, isOnLoad);
    onValidate_INLANDTRANSIT__CARCNP(null, null, null, isOnLoad);
    onValidate_INLANDTRANSIT__CARCPN(null, null, null, isOnLoad);
}
</script>
...
<div id="idb6db5101420e45c788e73a5d9ca4789a" class="general-layout-container">
...
<div id="idd457e601fe5f4fd49647c1403285cdbc" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd457e601fe5f4fd49647c1403285cdbc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd457e601fe5f4fd49647c1403285cdbc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd457e601fe5f4fd49647c1403285cdbc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd457e601fe5f4fd49647c1403285cdbc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd457e601fe5f4fd49647c1403285cdbc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd457e601fe5f4fd49647c1403285cdbc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd457e601fe5f4fd49647c1403285cdbc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd457e601fe5f4fd49647c1403285cdbc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd457e601fe5f4fd49647c1403285cdbc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd457e601fe5f4fd49647c1403285cdbc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5be6ff1b118c47ebb09c194c05fd2edf" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading66" runat="server" Text="Limits" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label53">
		<span class="label" id="label53">LOI/RI Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label54">
		<span class="label" id="label54">Sum Insured/Turnover</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:32%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-CANYONELOC">
		<span class="label" id="CANYONELOC">Any one location</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="INLANDTRANSIT" 
		data-property-name="CANYLOCLIMIT" 
		id="pb-container-currency-INLANDTRANSIT-CANYLOCLIMIT">
		<asp:Label ID="lblINLANDTRANSIT_CANYLOCLIMIT" runat="server" AssociatedControlID="INLANDTRANSIT__CANYLOCLIMIT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="INLANDTRANSIT__CANYLOCLIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valINLANDTRANSIT_CANYLOCLIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for INLANDTRANSIT.CANYLOCLIMIT"
			ClientValidationFunction="onValidate_INLANDTRANSIT__CANYLOCLIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5be6ff1b118c47ebb09c194c05fd2edf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5be6ff1b118c47ebb09c194c05fd2edf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5be6ff1b118c47ebb09c194c05fd2edf div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5be6ff1b118c47ebb09c194c05fd2edf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5be6ff1b118c47ebb09c194c05fd2edf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5be6ff1b118c47ebb09c194c05fd2edf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5be6ff1b118c47ebb09c194c05fd2edf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5be6ff1b118c47ebb09c194c05fd2edf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5be6ff1b118c47ebb09c194c05fd2edf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5be6ff1b118c47ebb09c194c05fd2edf input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id17082d4c3b214d55927baea26dc1af9d" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_INLANDTRANSIT__CARCBMI"
		data-field-type="Child" 
		data-object-name="INLANDTRANSIT" 
		data-property-name="CARCBMI" 
		id="pb-container-childscreen-INLANDTRANSIT-CARCBMI">
		
		    <legend>Subject Matter Inclusions</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="INLANDTRANSIT__CSBMATINC" runat="server" ScreenCode="CARCBMI" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARCBMI/CARCBMI_Subject_Matter_Inclusion.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Description" DataField="DESCRPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valINLANDTRANSIT_CARCBMI" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Subject Matter Inclusions"
						ClientValidationFunction="onValidate_INLANDTRANSIT__CARCBMI" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id17082d4c3b214d55927baea26dc1af9d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id17082d4c3b214d55927baea26dc1af9d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id17082d4c3b214d55927baea26dc1af9d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id17082d4c3b214d55927baea26dc1af9d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id17082d4c3b214d55927baea26dc1af9d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id17082d4c3b214d55927baea26dc1af9d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id17082d4c3b214d55927baea26dc1af9d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id17082d4c3b214d55927baea26dc1af9d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id17082d4c3b214d55927baea26dc1af9d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id17082d4c3b214d55927baea26dc1af9d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfeb178bbf6f546639a419c4798252747" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading68" runat="server" Text="Geographical Limits" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-property-name="CGEO_FROM" 
		 
		
		 
		id="pb-container-text-EXPORTS-CGEO_FROM">

		
		<asp:Label ID="lblEXPORTS_CGEO_FROM" runat="server" AssociatedControlID="EXPORTS__CGEO_FROM" 
			Text="Departure (from)" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EXPORTS__CGEO_FROM" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valEXPORTS_CGEO_FROM" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Departure (from)"
					ClientValidationFunction="onValidate_EXPORTS__CGEO_FROM"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="EXPORTS" 
		data-property-name="CGEO_TO" 
		 
		
		 
		id="pb-container-text-EXPORTS-CGEO_TO">

		
		<asp:Label ID="lblEXPORTS_CGEO_TO" runat="server" AssociatedControlID="EXPORTS__CGEO_TO" 
			Text="Arrival (to)" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EXPORTS__CGEO_TO" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valEXPORTS_CGEO_TO" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Arrival (to)"
					ClientValidationFunction="onValidate_EXPORTS__CGEO_TO"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idfeb178bbf6f546639a419c4798252747 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfeb178bbf6f546639a419c4798252747 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfeb178bbf6f546639a419c4798252747 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfeb178bbf6f546639a419c4798252747 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfeb178bbf6f546639a419c4798252747 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfeb178bbf6f546639a419c4798252747 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfeb178bbf6f546639a419c4798252747 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfeb178bbf6f546639a419c4798252747 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfeb178bbf6f546639a419c4798252747 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfeb178bbf6f546639a419c4798252747 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida5b5fda3034746c48e9eff7cbd906917" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_INLANDTRANSIT__CARCBV"
		data-field-type="Child" 
		data-object-name="INLANDTRANSIT" 
		data-property-name="CARCBV" 
		id="pb-container-childscreen-INLANDTRANSIT-CARCBV">
		
		    <legend>Inland Transit - Basis of Valuations</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="INLANDTRANSIT__SCBOV" runat="server" ScreenCode="CARCBV" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARCBV/CARCBV_Basis_of_Valuations.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Name" DataField="ITMNAME" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Selected Item Description" DataField="SIDNAME" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valINLANDTRANSIT_CARCBV" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Inland Transit - Basis of Valuations"
						ClientValidationFunction="onValidate_INLANDTRANSIT__CARCBV" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida5b5fda3034746c48e9eff7cbd906917 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida5b5fda3034746c48e9eff7cbd906917 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida5b5fda3034746c48e9eff7cbd906917 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida5b5fda3034746c48e9eff7cbd906917 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida5b5fda3034746c48e9eff7cbd906917 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5b5fda3034746c48e9eff7cbd906917 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5b5fda3034746c48e9eff7cbd906917 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida5b5fda3034746c48e9eff7cbd906917 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5b5fda3034746c48e9eff7cbd906917 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5b5fda3034746c48e9eff7cbd906917 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id65f8a1dbefc146cca992c7f638f01d2b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading70" runat="server" Text="Coastwise Shipment" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label61">
		<span class="label" id="label61">LOI/RI Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label62">
		<span class="label" id="label62">Sum Insured/Turnover</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label63">
		<span class="label" id="label63">Rate %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label64">
		<span class="label" id="label64">Premium</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id65f8a1dbefc146cca992c7f638f01d2b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id65f8a1dbefc146cca992c7f638f01d2b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id65f8a1dbefc146cca992c7f638f01d2b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id65f8a1dbefc146cca992c7f638f01d2b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id65f8a1dbefc146cca992c7f638f01d2b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65f8a1dbefc146cca992c7f638f01d2b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65f8a1dbefc146cca992c7f638f01d2b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id65f8a1dbefc146cca992c7f638f01d2b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65f8a1dbefc146cca992c7f638f01d2b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65f8a1dbefc146cca992c7f638f01d2b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id01aea3a47683434aa7eca5c6a48e8634" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_INLANDTRANSIT__CARCCBV"
		data-field-type="Child" 
		data-object-name="INLANDTRANSIT" 
		data-property-name="CARCCBV" 
		id="pb-container-childscreen-INLANDTRANSIT-CARCCBV">
		
		    <legend>Coastwise Shipment - Basis of Valuations</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="INLANDTRANSIT__COASTBOV" runat="server" ScreenCode="CARCCBV" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARCCBV/CARCCBV_Basis_of_Valuations.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Selected Item Description" DataField="CSIDNAME" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valINLANDTRANSIT_CARCCBV" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Coastwise Shipment - Basis of Valuations"
						ClientValidationFunction="onValidate_INLANDTRANSIT__CARCCBV" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id01aea3a47683434aa7eca5c6a48e8634 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id01aea3a47683434aa7eca5c6a48e8634 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id01aea3a47683434aa7eca5c6a48e8634 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id01aea3a47683434aa7eca5c6a48e8634 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id01aea3a47683434aa7eca5c6a48e8634 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id01aea3a47683434aa7eca5c6a48e8634 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id01aea3a47683434aa7eca5c6a48e8634 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id01aea3a47683434aa7eca5c6a48e8634 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id01aea3a47683434aa7eca5c6a48e8634 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id01aea3a47683434aa7eca5c6a48e8634 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2bf3e2fac36b4c2bb013b490ea8a5cdc" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading72" runat="server" Text="Excesses" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label68">
		<span class="label" id="label68">Excess %</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label71">
		<span class="label" id="label71">Basis of Excess</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label72">
		<span class="label" id="label72">Description</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label73">
		<span class="label" id="label73">General Excess</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label75">
		<span class="label" id="label75">Theft Excess</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label77">
		<span class="label" id="label77">Hijack Excess</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2bf3e2fac36b4c2bb013b490ea8a5cdc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2bf3e2fac36b4c2bb013b490ea8a5cdc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2bf3e2fac36b4c2bb013b490ea8a5cdc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2bf3e2fac36b4c2bb013b490ea8a5cdc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2bf3e2fac36b4c2bb013b490ea8a5cdc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2bf3e2fac36b4c2bb013b490ea8a5cdc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2bf3e2fac36b4c2bb013b490ea8a5cdc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2bf3e2fac36b4c2bb013b490ea8a5cdc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2bf3e2fac36b4c2bb013b490ea8a5cdc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2bf3e2fac36b4c2bb013b490ea8a5cdc input{text-align:left;}"; break;
		}
	}
...
<div id="frmEndorsement" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading73" runat="server" Text="Endorsements" /></legend>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idefb7dc21149942d5afd2c97ee0d06e84" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idefb7dc21149942d5afd2c97ee0d06e84 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idefb7dc21149942d5afd2c97ee0d06e84 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idefb7dc21149942d5afd2c97ee0d06e84 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idefb7dc21149942d5afd2c97ee0d06e84 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idefb7dc21149942d5afd2c97ee0d06e84 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idefb7dc21149942d5afd2c97ee0d06e84 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idefb7dc21149942d5afd2c97ee0d06e84 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idefb7dc21149942d5afd2c97ee0d06e84 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idefb7dc21149942d5afd2c97ee0d06e84 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idefb7dc21149942d5afd2c97ee0d06e84 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide2b33d31a0944eaa91156e1fb57651fc" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_INLANDTRANSIT__CARCENDP"
		data-field-type="Child" 
		data-object-name="INLANDTRANSIT" 
		data-property-name="CARCENDP" 
		id="pb-container-childscreen-INLANDTRANSIT-CARCENDP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="INLANDTRANSIT__C_CLAUSEPREM" runat="server" ScreenCode="CARCENDP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARCENDP/CARCENDP_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="CPREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valINLANDTRANSIT_CARCENDP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for INLANDTRANSIT.CARCENDP"
						ClientValidationFunction="onValidate_INLANDTRANSIT__CARCENDP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide2b33d31a0944eaa91156e1fb57651fc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide2b33d31a0944eaa91156e1fb57651fc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide2b33d31a0944eaa91156e1fb57651fc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide2b33d31a0944eaa91156e1fb57651fc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide2b33d31a0944eaa91156e1fb57651fc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide2b33d31a0944eaa91156e1fb57651fc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide2b33d31a0944eaa91156e1fb57651fc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide2b33d31a0944eaa91156e1fb57651fc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide2b33d31a0944eaa91156e1fb57651fc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide2b33d31a0944eaa91156e1fb57651fc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida126fca6e0634f70a4b1bc5c2feb2c86" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_INLANDTRANSIT__CARCNP"
		data-field-type="Child" 
		data-object-name="INLANDTRANSIT" 
		data-property-name="CARCNP" 
		id="pb-container-childscreen-INLANDTRANSIT-CARCNP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="INLANDTRANSIT__CACNOTE_DETAILS" runat="server" ScreenCode="CARCNP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARCNP/CARCNP_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="CANOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valINLANDTRANSIT_CARCNP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for INLANDTRANSIT.CARCNP"
						ClientValidationFunction="onValidate_INLANDTRANSIT__CARCNP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida126fca6e0634f70a4b1bc5c2feb2c86 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida126fca6e0634f70a4b1bc5c2feb2c86 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida126fca6e0634f70a4b1bc5c2feb2c86 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida126fca6e0634f70a4b1bc5c2feb2c86 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida126fca6e0634f70a4b1bc5c2feb2c86 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida126fca6e0634f70a4b1bc5c2feb2c86 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida126fca6e0634f70a4b1bc5c2feb2c86 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida126fca6e0634f70a4b1bc5c2feb2c86 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida126fca6e0634f70a4b1bc5c2feb2c86 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida126fca6e0634f70a4b1bc5c2feb2c86 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id996266887b6b40cea576db59fbd3cad2" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_INLANDTRANSIT__CARCPN"
		data-field-type="Child" 
		data-object-name="INLANDTRANSIT" 
		data-property-name="CARCPN" 
		id="pb-container-childscreen-INLANDTRANSIT-CARCPN">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="INLANDTRANSIT__CPCNOTE_DETAILS" runat="server" ScreenCode="CARCPN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARCPN/CARCPN_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="CPNOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valINLANDTRANSIT_CARCPN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for INLANDTRANSIT.CARCPN"
						ClientValidationFunction="onValidate_INLANDTRANSIT__CARCPN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id996266887b6b40cea576db59fbd3cad2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id996266887b6b40cea576db59fbd3cad2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id996266887b6b40cea576db59fbd3cad2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id996266887b6b40cea576db59fbd3cad2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id996266887b6b40cea576db59fbd3cad2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id996266887b6b40cea576db59fbd3cad2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id996266887b6b40cea576db59fbd3cad2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id996266887b6b40cea576db59fbd3cad2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id996266887b6b40cea576db59fbd3cad2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id996266887b6b40cea576db59fbd3cad2 input{text-align:left;}"; break;
		}
	}
