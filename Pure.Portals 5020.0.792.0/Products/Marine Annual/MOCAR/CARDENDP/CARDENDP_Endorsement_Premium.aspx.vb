...
Namespace Nexus
    Partial Class PB2_CARDENDP_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_D_CLAUSEPREM__DENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_D_CLAUSEPREM__DENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'GLASS_REFERRAL_CLAUSES - Standard Wording Parent Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/GLASS_REFERRAL_CLAUSES/SW.REFERRAL_CLAUSES")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/GLASS_REFERRAL_CLAUSES/GLASS_CLAUSEPREM")
        
        	Dim CurrentSelected As String = D_CLAUSEPREM__ENDORSE_CAP.Text
