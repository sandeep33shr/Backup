<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOCM_Cargo_Master.aspx.vb" Inherits="Nexus.PB2_MOCM_Cargo_Master" %>
...
function onValidate_MASTER__AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MASTER", "AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MASTER", "AMOUNT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MASTER.AMOUNT");
        			window.setControlWidth(field, "0.2", "MASTER", "AMOUNT");
        		})();
        	}
        })();
}
function onValidate_MASTER__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MASTER", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("MASTER", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MASTER.TOT_PREM");
        			window.setControlWidth(field, "0.2", "MASTER", "TOT_PREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
          ...
          * @param MASTER The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MASTER".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_MASTER__MOCMENDOP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MASTER", "MOCMENDOP", "ChildScreen");
        })();
}
function onValidate_MASTER__MOCMNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MASTER", "MOCMNOTES", "ChildScreen");
        })();
}
function onValidate_MASTER__MOCMSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MASTER", "MOCMSNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MASTER__AMOUNT(null, null, null, isOnLoad);
    onValidate_MASTER__TOT_PREM(null, null, null, isOnLoad);
    onValidate_MASTER__MOCMENDOP(null, null, null, isOnLoad);
    onValidate_MASTER__MOCMNOTES(null, null, null, isOnLoad);
    onValidate_MASTER__MOCMSNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id76c0ed00763044b599d2847fd3499ad1" class="general-layout-container">
...
<div id="id57b52e2ec7054abfb79f3ea2b4a57f33" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading7" runat="server" Text="Client Policy Limit" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MASTER" 
		data-property-name="AMOUNT" 
		id="pb-container-currency-MASTER-AMOUNT">
		<asp:Label ID="lblMASTER_AMOUNT" runat="server" AssociatedControlID="MASTER__AMOUNT" 
			Text="Maximum Policy Limit Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MASTER__AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMASTER_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Policy Limit Amount"
			ClientValidationFunction="onValidate_MASTER__AMOUNT" 
			ValidationGroup=""
			Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id57b52e2ec7054abfb79f3ea2b4a57f33 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id57b52e2ec7054abfb79f3ea2b4a57f33 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id57b52e2ec7054abfb79f3ea2b4a57f33 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id57b52e2ec7054abfb79f3ea2b4a57f33 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id57b52e2ec7054abfb79f3ea2b4a57f33 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id57b52e2ec7054abfb79f3ea2b4a57f33 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id57b52e2ec7054abfb79f3ea2b4a57f33 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id57b52e2ec7054abfb79f3ea2b4a57f33 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id57b52e2ec7054abfb79f3ea2b4a57f33 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id57b52e2ec7054abfb79f3ea2b4a57f33 input{text-align:left;}"; break;
		}
	}
...
<div id="frmEndorsement" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading8" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblMASTER_REFERRAL_CLAUSES" runat="server" AssociatedControlID="MASTER__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="MASTER__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MASTER-TOT_PREM">
		<asp:Label ID="lblMASTER_TOT_PREM" runat="server" AssociatedControlID="MASTER__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MASTER__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMASTER_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_MASTER__TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MASTER__MOCMENDOP"
		data-field-type="Child" 
		data-object-name="MASTER" 
		data-property-name="MOCMENDOP" 
		id="pb-container-childscreen-MASTER-MOCMENDOP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MASTER__CLAUSEPREM" runat="server" ScreenCode="MOCMENDOP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MOCMENDOP/MOCMENDOP_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMASTER_MOCMENDOP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MASTER.MOCMENDOP"
						ClientValidationFunction="onValidate_MASTER__MOCMENDOP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idbe7e97b0e08544cabfb60aeec9d362e9" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MASTER__MOCMNOTES"
		data-field-type="Child" 
		data-object-name="MASTER" 
		data-property-name="MOCMNOTES" 
		id="pb-container-childscreen-MASTER-MOCMNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MASTER__MCNOTE_DETAILS" runat="server" ScreenCode="MOCMNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MOCMNOTES/MOCMNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="MDATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="MCREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="MCOVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="MNOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMASTER_MOCMNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MASTER.MOCMNOTES"
						ClientValidationFunction="onValidate_MASTER__MOCMNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idbe7e97b0e08544cabfb60aeec9d362e9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbe7e97b0e08544cabfb60aeec9d362e9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbe7e97b0e08544cabfb60aeec9d362e9 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idbe7e97b0e08544cabfb60aeec9d362e9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbe7e97b0e08544cabfb60aeec9d362e9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbe7e97b0e08544cabfb60aeec9d362e9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbe7e97b0e08544cabfb60aeec9d362e9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbe7e97b0e08544cabfb60aeec9d362e9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbe7e97b0e08544cabfb60aeec9d362e9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbe7e97b0e08544cabfb60aeec9d362e9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd030c9f0357b4e31b9dd97350c544e21" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MASTER__MOCMSNOTE"
		data-field-type="Child" 
		data-object-name="MASTER" 
		data-property-name="MOCMSNOTE" 
		id="pb-container-childscreen-MASTER-MOCMSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MASTER__MPCNOTE_DETAILS" runat="server" ScreenCode="MOCMSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MOCMSNOTE/MOCMSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="MPDATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="MPCREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="MPCOVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="MPNOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMASTER_MOCMSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MASTER.MOCMSNOTE"
						ClientValidationFunction="onValidate_MASTER__MOCMSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd030c9f0357b4e31b9dd97350c544e21 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd030c9f0357b4e31b9dd97350c544e21 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd030c9f0357b4e31b9dd97350c544e21 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd030c9f0357b4e31b9dd97350c544e21 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd030c9f0357b4e31b9dd97350c544e21 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd030c9f0357b4e31b9dd97350c544e21 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd030c9f0357b4e31b9dd97350c544e21 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd030c9f0357b4e31b9dd97350c544e21 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd030c9f0357b4e31b9dd97350c544e21 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd030c9f0357b4e31b9dd97350c544e21 input{text-align:left;}"; break;
		}
	}
