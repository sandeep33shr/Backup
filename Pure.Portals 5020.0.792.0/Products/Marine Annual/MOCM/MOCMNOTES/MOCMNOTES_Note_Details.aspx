<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOCMNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_MOCMNOTES_Note_Details" %>
...
function onValidate_MCNOTE_DETAILS__MDATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCNOTE_DETAILS", "MDATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MCNOTE_DETAILS", "MDATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("MCNOTE_DETAILS", "MDATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=MCNOTE_DETAILS&propertyName=MDATE_CREATED&name={name}");
...
function onValidate_MCNOTE_DETAILS__MCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCNOTE_DETAILS", "MCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MCNOTE_DETAILS", "MCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("MCNOTE_DETAILS", "MCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_MCNOTE_DETAILS__MCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCNOTE_DETAILS", "MCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MCNOTE_DETAILS", "MCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("MCNOTE_DETAILS", "MCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MCNOTE_DETAILS&propertyName=MCOVER_TYPE&name={name}");
...
function onValidate_MCNOTE_DETAILS__MNOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCNOTE_DETAILS", "MNOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MCNOTE_DETAILS", "MNOTE_DESCRIPTION");
...
function onValidate_MCNOTE_DETAILS__MNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCNOTE_DETAILS", "MNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MCNOTE_DETAILS", "MNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=MCNOTE_DETAILS&propertyName=MNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_MCNOTE_DETAILS__MNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_MCNOTE_DETAILS_MNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_MCNOTE_DETAILS__MNOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCNOTE_DETAILS", "MNOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MCNOTE_DETAILS", "MNOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_MCNOTE_DETAILS__MDATE_CREATED(null, null, null, isOnLoad);
    onValidate_MCNOTE_DETAILS__MCREATED_BY(null, null, null, isOnLoad);
    onValidate_MCNOTE_DETAILS__MCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_MCNOTE_DETAILS__MNOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_MCNOTE_DETAILS__MNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_MCNOTE_DETAILS__MNOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="id4efe8403f4784a859045d6cb74d20104" class="general-layout-container">
...
<div id="id7a8abc60b077456e8eedb38ad24c2b57" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Note Detail  (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MCNOTE_DETAILS" 
		data-property-name="MDATE_CREATED" 
		id="pb-container-datejquerycompatible-MCNOTE_DETAILS-MDATE_CREATED">
		<asp:Label ID="lblMCNOTE_DETAILS_MDATE_CREATED" runat="server" AssociatedControlID="MCNOTE_DETAILS__MDATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="MCNOTE_DETAILS__MDATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calMCNOTE_DETAILS__MDATE_CREATED" runat="server" LinkedControl="MCNOTE_DETAILS__MDATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valMCNOTE_DETAILS_MDATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_MCNOTE_DETAILS__MDATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MCNOTE_DETAILS" 
		data-property-name="MCREATED_BY" 
		 
		
		 
		id="pb-container-text-MCNOTE_DETAILS-MCREATED_BY">

		
		<asp:Label ID="lblMCNOTE_DETAILS_MCREATED_BY" runat="server" AssociatedControlID="MCNOTE_DETAILS__MCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MCNOTE_DETAILS__MCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMCNOTE_DETAILS_MCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_MCNOTE_DETAILS__MCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MCNOTE_DETAILS" 
		data-property-name="MCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-MCNOTE_DETAILS-MCOVER_TYPE">

		
		<asp:Label ID="lblMCNOTE_DETAILS_MCOVER_TYPE" runat="server" AssociatedControlID="MCNOTE_DETAILS__MCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MCNOTE_DETAILS__MCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMCNOTE_DETAILS_MCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_MCNOTE_DETAILS__MCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MCNOTE_DETAILS" 
		data-property-name="MNOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-MCNOTE_DETAILS-MNOTE_DESCRIPTION">

		
		<asp:Label ID="lblMCNOTE_DETAILS_MNOTE_DESCRIPTION" runat="server" AssociatedControlID="MCNOTE_DETAILS__MNOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MCNOTE_DETAILS__MNOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMCNOTE_DETAILS_MNOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_MCNOTE_DETAILS__MNOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MCNOTE_DETAILS" 
		data-property-name="MNOTE_DETAILS" 
		id="pb-container-comment-MCNOTE_DETAILS-MNOTE_DETAILS">
		<asp:Label ID="lblMCNOTE_DETAILS_MNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="MCNOTE_DETAILS__MNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="MCNOTE_DETAILS__MNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valMCNOTE_DETAILS_MNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_MCNOTE_DETAILS__MNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblMCNOTE_DETAILS_MNOTECHECK" for="ctl00_cntMainBody_MCNOTE_DETAILS__MNOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="MCNOTE_DETAILS" 
		data-property-name="MNOTECHECK" 
		id="pb-container-checkbox-MCNOTE_DETAILS-MNOTECHECK">	
		
		<asp:TextBox ID="MCNOTE_DETAILS__MNOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valMCNOTE_DETAILS_MNOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_MCNOTE_DETAILS__MNOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7a8abc60b077456e8eedb38ad24c2b57 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7a8abc60b077456e8eedb38ad24c2b57 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7a8abc60b077456e8eedb38ad24c2b57 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7a8abc60b077456e8eedb38ad24c2b57 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7a8abc60b077456e8eedb38ad24c2b57 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7a8abc60b077456e8eedb38ad24c2b57 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7a8abc60b077456e8eedb38ad24c2b57 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7a8abc60b077456e8eedb38ad24c2b57 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7a8abc60b077456e8eedb38ad24c2b57 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7a8abc60b077456e8eedb38ad24c2b57 input{text-align:left;}"; break;
		}
	}
