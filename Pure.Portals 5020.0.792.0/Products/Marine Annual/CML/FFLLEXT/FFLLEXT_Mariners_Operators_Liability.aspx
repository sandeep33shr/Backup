<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FFLLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_FFLLEXT_Mariners_Operators_Liability" %>
...
function onValidate_FFLLEXT__FFLLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLLEXT", "FFLLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FFLLEXT.FFLLDES");
        			window.setControlWidth(field, "0.8", "FFLLEXT", "FFLLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLLEXT_FFLLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLLEXT__FFLLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLLEXT__FFLLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLLEXT", "FFLLDES");
        		}
...
function onValidate_FFLLEXT__FFLLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLLEXT", "FFLLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FFLLEXT.FFLLLOI");
        			window.setControlWidth(field, "0.8", "FFLLEXT", "FFLLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLLEXT", "FFLLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLLEXT_FFLLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLLEXT__FFLLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLLEXT__FFLLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_FFLLEXT__FFLLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLLEXT", "FFLLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FFLLEXT.FFLLR");
        			window.setControlWidth(field, "0.8", "FFLLEXT", "FFLLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLLEXT_FFLLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLLEXT__FFLLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLLEXT__FFLLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLLEXT", "FFLLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_FFLLEXT__FFLLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLLEXT", "FFLLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FFLLEXT.FFLLP");
        			window.setControlWidth(field, "0.8", "FFLLEXT", "FFLLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLLEXT_FFLLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLLEXT__FFLLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLLEXT__FFLLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLLEXT", "FFLLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_FFLLEXT__FFLLDES(null, null, null, isOnLoad);
    onValidate_FFLLEXT__FFLLLOI(null, null, null, isOnLoad);
    onValidate_FFLLEXT__FFLLR(null, null, null, isOnLoad);
    onValidate_FFLLEXT__FFLLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id2feab0b053064c96a7c7530f777485f0" class="general-layout-container">
...
<div id="id4b3f8f9de1f64bdaadbc2687a95c01e4" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="FFLLEXT" 
		data-property-name="FFLLDES" 
		 
		
		 
		id="pb-container-text-FFLLEXT-FFLLDES">

		
		<asp:Label ID="lblFFLLEXT_FFLLDES" runat="server" AssociatedControlID="FFLLEXT__FFLLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FFLLEXT__FFLLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFFLLEXT_FFLLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_FFLLEXT__FFLLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FFLLEXT" 
		data-property-name="FFLLLOI" 
		id="pb-container-currency-FFLLEXT-FFLLLOI">
		<asp:Label ID="lblFFLLEXT_FFLLLOI" runat="server" AssociatedControlID="FFLLEXT__FFLLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FFLLEXT__FFLLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFFLLEXT_FFLLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_FFLLEXT__FFLLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FFLLEXT" 
		data-property-name="FFLLR" 
		id="pb-container-percentage-FFLLEXT-FFLLR">
		<asp:Label ID="lblFFLLEXT_FFLLR" runat="server" AssociatedControlID="FFLLEXT__FFLLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FFLLEXT__FFLLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFFLLEXT_FFLLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_FFLLEXT__FFLLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FFLLEXT-FFLLP">
		<asp:Label ID="lblFFLLEXT_FFLLP" runat="server" AssociatedControlID="FFLLEXT__FFLLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FFLLEXT__FFLLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFFLLEXT_FFLLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_FFLLEXT__FFLLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4b3f8f9de1f64bdaadbc2687a95c01e4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4b3f8f9de1f64bdaadbc2687a95c01e4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4b3f8f9de1f64bdaadbc2687a95c01e4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4b3f8f9de1f64bdaadbc2687a95c01e4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4b3f8f9de1f64bdaadbc2687a95c01e4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4b3f8f9de1f64bdaadbc2687a95c01e4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4b3f8f9de1f64bdaadbc2687a95c01e4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4b3f8f9de1f64bdaadbc2687a95c01e4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4b3f8f9de1f64bdaadbc2687a95c01e4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4b3f8f9de1f64bdaadbc2687a95c01e4 input{text-align:left;}"; break;
		}
	}
