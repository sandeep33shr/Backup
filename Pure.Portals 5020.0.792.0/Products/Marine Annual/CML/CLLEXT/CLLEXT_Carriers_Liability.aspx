<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLLEXT_Carriers_Liability.aspx.vb" Inherits="Nexus.PB2_CLLEXT_Carriers_Liability" %>
...
function onValidate_CARLEXT__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARLEXT", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CARLEXT.CLDES");
        			window.setControlWidth(field, "0.8", "CARLEXT", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCARLEXT_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CARLEXT__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CARLEXT__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CARLEXT", "CLDES");
        		}
...
function onValidate_CARLEXT__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARLEXT", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CARLEXT.CLLOI");
        			window.setControlWidth(field, "0.8", "CARLEXT", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CARLEXT", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCARLEXT_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CARLEXT__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CARLEXT__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CARLEXT__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARLEXT", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CARLEXT.CLR");
        			window.setControlWidth(field, "0.8", "CARLEXT", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCARLEXT_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CARLEXT__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CARLEXT__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CARLEXT", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CARLEXT__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARLEXT", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CARLEXT.CLP");
        			window.setControlWidth(field, "0.8", "CARLEXT", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCARLEXT_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CARLEXT__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CARLEXT__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CARLEXT", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_CARLEXT__CLDES(null, null, null, isOnLoad);
    onValidate_CARLEXT__CLLOI(null, null, null, isOnLoad);
    onValidate_CARLEXT__CLR(null, null, null, isOnLoad);
    onValidate_CARLEXT__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id8addda69ffef4faaa53bceb1e3c70e1e" class="general-layout-container">
...
<div id="id538841c213d74cffab06c4ceb50e30e5" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CARLEXT" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-CARLEXT-CLDES">

		
		<asp:Label ID="lblCARLEXT_CLDES" runat="server" AssociatedControlID="CARLEXT__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CARLEXT__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCARLEXT_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CARLEXT__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CARLEXT-CLLOI">
		<asp:Label ID="lblCARLEXT_CLLOI" runat="server" AssociatedControlID="CARLEXT__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CARLEXT__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCARLEXT_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CARLEXT__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CARLEXT-CLR">
		<asp:Label ID="lblCARLEXT_CLR" runat="server" AssociatedControlID="CARLEXT__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CARLEXT__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCARLEXT_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_CARLEXT__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CARLEXT-CLP">
		<asp:Label ID="lblCARLEXT_CLP" runat="server" AssociatedControlID="CARLEXT__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CARLEXT__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCARLEXT_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CARLEXT__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id538841c213d74cffab06c4ceb50e30e5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id538841c213d74cffab06c4ceb50e30e5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id538841c213d74cffab06c4ceb50e30e5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id538841c213d74cffab06c4ceb50e30e5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id538841c213d74cffab06c4ceb50e30e5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id538841c213d74cffab06c4ceb50e30e5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id538841c213d74cffab06c4ceb50e30e5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id538841c213d74cffab06c4ceb50e30e5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id538841c213d74cffab06c4ceb50e30e5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id538841c213d74cffab06c4ceb50e30e5 input{text-align:left;}"; break;
		}
	}
