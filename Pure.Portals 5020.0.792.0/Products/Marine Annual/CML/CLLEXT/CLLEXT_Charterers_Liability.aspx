<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLLEXT_Charterers_Liability.aspx.vb" Inherits="Nexus.PB2_CLLEXT_Charterers_Liability" %>
...
function onValidate_CLLEXT__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLEXT", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLLEXT.CLDES");
        			window.setControlWidth(field, "0.8", "CLLEXT", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLEXT_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLEXT__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLEXT__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLEXT", "CLDES");
        		}
...
function onValidate_CLLEXT__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLEXT", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLLEXT.CLLOI");
        			window.setControlWidth(field, "0.8", "CLLEXT", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLEXT", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLEXT_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLEXT__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLEXT__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CLLEXT__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLEXT", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLLEXT.CLR");
        			window.setControlWidth(field, "0.8", "CLLEXT", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLEXT_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLEXT__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLEXT__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLEXT", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CLLEXT__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLEXT", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLLEXT.CLP");
        			window.setControlWidth(field, "0.8", "CLLEXT", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLEXT_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLEXT__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLEXT__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLEXT", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_CLLEXT__CLDES(null, null, null, isOnLoad);
    onValidate_CLLEXT__CLLOI(null, null, null, isOnLoad);
    onValidate_CLLEXT__CLR(null, null, null, isOnLoad);
    onValidate_CLLEXT__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id65664998a1e64f519156536cc2c50b17" class="general-layout-container">
...
<div id="id254ddf174adf4063875002dd8f11fc06" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CLLEXT" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-CLLEXT-CLDES">

		
		<asp:Label ID="lblCLLEXT_CLDES" runat="server" AssociatedControlID="CLLEXT__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CLLEXT__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCLLEXT_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CLLEXT__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLLEXT-CLLOI">
		<asp:Label ID="lblCLLEXT_CLLOI" runat="server" AssociatedControlID="CLLEXT__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLEXT__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLEXT_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CLLEXT__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CLLEXT-CLR">
		<asp:Label ID="lblCLLEXT_CLR" runat="server" AssociatedControlID="CLLEXT__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CLLEXT__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCLLEXT_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_CLLEXT__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLLEXT-CLP">
		<asp:Label ID="lblCLLEXT_CLP" runat="server" AssociatedControlID="CLLEXT__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLEXT__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLEXT_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CLLEXT__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id254ddf174adf4063875002dd8f11fc06 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id254ddf174adf4063875002dd8f11fc06 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id254ddf174adf4063875002dd8f11fc06 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id254ddf174adf4063875002dd8f11fc06 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id254ddf174adf4063875002dd8f11fc06 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id254ddf174adf4063875002dd8f11fc06 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id254ddf174adf4063875002dd8f11fc06 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id254ddf174adf4063875002dd8f11fc06 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id254ddf174adf4063875002dd8f11fc06 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id254ddf174adf4063875002dd8f11fc06 input{text-align:left;}"; break;
		}
	}
