...
Namespace Nexus
    Partial Class PB2_SBLNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_SBL_NNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If SBL_NNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		SBL_NNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		SBL_NNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_SBL_NNOTES_DETAILS__NOTE_DETAILS()
End Sub
