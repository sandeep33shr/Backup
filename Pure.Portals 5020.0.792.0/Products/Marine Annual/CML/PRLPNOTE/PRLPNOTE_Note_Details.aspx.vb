...
Namespace Nexus
    Partial Class PB2_PRLPNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_PRL_PNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If PRL_PNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		PRL_PNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		PRL_PNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_PRL_PNOTES_DETAILS__NOTE_DETAILS()
End Sub
