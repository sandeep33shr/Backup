<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SLLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_SLLEXT_Mariners_Operators_Liability" %>
...
function onValidate_SLLEXT__SLLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SLLEXT", "SLLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SLLEXT.SLLDES");
        			window.setControlWidth(field, "0.8", "SLLEXT", "SLLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSLLEXT_SLLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SLLEXT__SLLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SLLEXT__SLLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SLLEXT", "SLLDES");
        		}
...
function onValidate_SLLEXT__SLLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SLLEXT", "SLLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SLLEXT.SLLLOI");
        			window.setControlWidth(field, "0.8", "SLLEXT", "SLLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SLLEXT", "SLLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSLLEXT_SLLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SLLEXT__SLLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SLLEXT__SLLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SLLEXT__SLLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SLLEXT", "SLLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SLLEXT.SLLR");
        			window.setControlWidth(field, "0.8", "SLLEXT", "SLLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSLLEXT_SLLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SLLEXT__SLLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SLLEXT__SLLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SLLEXT", "SLLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_SLLEXT__SLLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SLLEXT", "SLLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SLLEXT.SLLP");
        			window.setControlWidth(field, "0.8", "SLLEXT", "SLLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSLLEXT_SLLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SLLEXT__SLLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SLLEXT__SLLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SLLEXT", "SLLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_SLLEXT__SLLDES(null, null, null, isOnLoad);
    onValidate_SLLEXT__SLLLOI(null, null, null, isOnLoad);
    onValidate_SLLEXT__SLLR(null, null, null, isOnLoad);
    onValidate_SLLEXT__SLLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id05dae771563e46598c678b2aa1bb951e" class="general-layout-container">
...
<div id="idb7c29fc428684617b423b2f2f88886c7" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SLLEXT" 
		data-property-name="SLLDES" 
		 
		
		 
		id="pb-container-text-SLLEXT-SLLDES">

		
		<asp:Label ID="lblSLLEXT_SLLDES" runat="server" AssociatedControlID="SLLEXT__SLLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SLLEXT__SLLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSLLEXT_SLLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SLLEXT__SLLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SLLEXT" 
		data-property-name="SLLLOI" 
		id="pb-container-currency-SLLEXT-SLLLOI">
		<asp:Label ID="lblSLLEXT_SLLLOI" runat="server" AssociatedControlID="SLLEXT__SLLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SLLEXT__SLLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSLLEXT_SLLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SLLEXT__SLLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SLLEXT" 
		data-property-name="SLLR" 
		id="pb-container-percentage-SLLEXT-SLLR">
		<asp:Label ID="lblSLLEXT_SLLR" runat="server" AssociatedControlID="SLLEXT__SLLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SLLEXT__SLLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSLLEXT_SLLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SLLEXT__SLLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SLLEXT-SLLP">
		<asp:Label ID="lblSLLEXT_SLLP" runat="server" AssociatedControlID="SLLEXT__SLLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SLLEXT__SLLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSLLEXT_SLLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SLLEXT__SLLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb7c29fc428684617b423b2f2f88886c7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb7c29fc428684617b423b2f2f88886c7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb7c29fc428684617b423b2f2f88886c7 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb7c29fc428684617b423b2f2f88886c7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb7c29fc428684617b423b2f2f88886c7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb7c29fc428684617b423b2f2f88886c7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb7c29fc428684617b423b2f2f88886c7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb7c29fc428684617b423b2f2f88886c7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb7c29fc428684617b423b2f2f88886c7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb7c29fc428684617b423b2f2f88886c7 input{text-align:left;}"; break;
		}
	}
