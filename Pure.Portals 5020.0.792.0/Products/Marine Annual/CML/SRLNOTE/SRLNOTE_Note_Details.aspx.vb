...
Namespace Nexus
    Partial Class PB2_SRLNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_SRL_NNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If SRL_NNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		SRL_NNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		SRL_NNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_SRL_NNOTES_DETAILS__NOTE_DETAILS()
End Sub
