<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_CLEXT_Mariners_Operators_Liability" %>
...
function onValidate_CLEXT__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLEXT", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLEXT.CLDES");
        			window.setControlWidth(field, "0.8", "CLEXT", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLEXT_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLEXT__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLEXT__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLEXT", "CLDES");
        		}
...
function onValidate_CLEXT__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLEXT", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLEXT.CLLOI");
        			window.setControlWidth(field, "0.8", "CLEXT", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLEXT", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLEXT_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLEXT__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLEXT__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CLEXT__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLEXT", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLEXT.CLR");
        			window.setControlWidth(field, "0.8", "CLEXT", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLEXT_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLEXT__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLEXT__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLEXT", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CLEXT__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLEXT", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLEXT.CLP");
        			window.setControlWidth(field, "0.8", "CLEXT", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLEXT_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLEXT__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLEXT__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLEXT", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_CLEXT__CLDES(null, null, null, isOnLoad);
    onValidate_CLEXT__CLLOI(null, null, null, isOnLoad);
    onValidate_CLEXT__CLR(null, null, null, isOnLoad);
    onValidate_CLEXT__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idfa7e0b2deb47406db27247c1dfc96e48" class="general-layout-container">
...
<div id="id9fbaf4180164422ea8d4550fcb539a03" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CLEXT" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-CLEXT-CLDES">

		
		<asp:Label ID="lblCLEXT_CLDES" runat="server" AssociatedControlID="CLEXT__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CLEXT__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCLEXT_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CLEXT__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLEXT-CLLOI">
		<asp:Label ID="lblCLEXT_CLLOI" runat="server" AssociatedControlID="CLEXT__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLEXT__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLEXT_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CLEXT__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CLEXT-CLR">
		<asp:Label ID="lblCLEXT_CLR" runat="server" AssociatedControlID="CLEXT__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CLEXT__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCLEXT_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_CLEXT__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLEXT-CLP">
		<asp:Label ID="lblCLEXT_CLP" runat="server" AssociatedControlID="CLEXT__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLEXT__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLEXT_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CLEXT__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9fbaf4180164422ea8d4550fcb539a03 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9fbaf4180164422ea8d4550fcb539a03 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9fbaf4180164422ea8d4550fcb539a03 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9fbaf4180164422ea8d4550fcb539a03 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9fbaf4180164422ea8d4550fcb539a03 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9fbaf4180164422ea8d4550fcb539a03 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9fbaf4180164422ea8d4550fcb539a03 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9fbaf4180164422ea8d4550fcb539a03 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9fbaf4180164422ea8d4550fcb539a03 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9fbaf4180164422ea8d4550fcb539a03 input{text-align:left;}"; break;
		}
	}
