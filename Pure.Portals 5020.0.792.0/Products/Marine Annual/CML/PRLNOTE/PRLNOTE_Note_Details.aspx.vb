...
Namespace Nexus
    Partial Class PB2_PRLNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_PRL_NNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If PRL_NNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		PRL_NNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		PRL_NNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_PRL_NNOTES_DETAILS__NOTE_DETAILS()
End Sub
