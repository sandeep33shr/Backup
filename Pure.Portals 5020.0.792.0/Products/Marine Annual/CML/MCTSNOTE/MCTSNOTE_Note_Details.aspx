<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MCTSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_MCTSNOTE_Note_Details" %>
...
<div id="id53757cede05e4db18113b229912a7fd9" class="general-layout-container">
...
<div id="idc0401a5a64554225b1f1bc0d79fc9abc" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc0401a5a64554225b1f1bc0d79fc9abc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc0401a5a64554225b1f1bc0d79fc9abc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc0401a5a64554225b1f1bc0d79fc9abc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc0401a5a64554225b1f1bc0d79fc9abc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc0401a5a64554225b1f1bc0d79fc9abc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc0401a5a64554225b1f1bc0d79fc9abc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc0401a5a64554225b1f1bc0d79fc9abc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc0401a5a64554225b1f1bc0d79fc9abc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc0401a5a64554225b1f1bc0d79fc9abc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc0401a5a64554225b1f1bc0d79fc9abc input{text-align:left;}"; break;
		}
	}
