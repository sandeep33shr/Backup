<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SBLEXT_Charterers_Liability.aspx.vb" Inherits="Nexus.PB2_SBLEXT_Charterers_Liability" %>
...
function onValidate_SBLEXTS__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLEXTS", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBLEXTS.CLDES");
        			window.setControlWidth(field, "0.8", "SBLEXTS", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLEXTS_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLEXTS__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLEXTS__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLEXTS", "CLDES");
        		}
...
function onValidate_SBLEXTS__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLEXTS", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBLEXTS.CLLOI");
        			window.setControlWidth(field, "0.8", "SBLEXTS", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLEXTS", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLEXTS_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLEXTS__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLEXTS__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SBLEXTS__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLEXTS", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBLEXTS.CLR");
        			window.setControlWidth(field, "0.8", "SBLEXTS", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLEXTS_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLEXTS__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLEXTS__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLEXTS", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_SBLEXTS__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLEXTS", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBLEXTS.CLP");
        			window.setControlWidth(field, "0.8", "SBLEXTS", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLEXTS_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLEXTS__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLEXTS__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLEXTS", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_SBLEXTS__CLDES(null, null, null, isOnLoad);
    onValidate_SBLEXTS__CLLOI(null, null, null, isOnLoad);
    onValidate_SBLEXTS__CLR(null, null, null, isOnLoad);
    onValidate_SBLEXTS__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idf403bf2c4332467395fca05d8764a95f" class="general-layout-container">
...
<div id="id466553c2412b49fbbb916a2c2f711a1b" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SBLEXTS" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-SBLEXTS-CLDES">

		
		<asp:Label ID="lblSBLEXTS_CLDES" runat="server" AssociatedControlID="SBLEXTS__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SBLEXTS__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSBLEXTS_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SBLEXTS__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SBLEXTS-CLLOI">
		<asp:Label ID="lblSBLEXTS_CLLOI" runat="server" AssociatedControlID="SBLEXTS__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SBLEXTS__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSBLEXTS_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SBLEXTS__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SBLEXTS-CLR">
		<asp:Label ID="lblSBLEXTS_CLR" runat="server" AssociatedControlID="SBLEXTS__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SBLEXTS__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSBLEXTS_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SBLEXTS__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SBLEXTS-CLP">
		<asp:Label ID="lblSBLEXTS_CLP" runat="server" AssociatedControlID="SBLEXTS__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SBLEXTS__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSBLEXTS_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SBLEXTS__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id466553c2412b49fbbb916a2c2f711a1b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id466553c2412b49fbbb916a2c2f711a1b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id466553c2412b49fbbb916a2c2f711a1b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id466553c2412b49fbbb916a2c2f711a1b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id466553c2412b49fbbb916a2c2f711a1b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id466553c2412b49fbbb916a2c2f711a1b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id466553c2412b49fbbb916a2c2f711a1b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id466553c2412b49fbbb916a2c2f711a1b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id466553c2412b49fbbb916a2c2f711a1b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id466553c2412b49fbbb916a2c2f711a1b input{text-align:left;}"; break;
		}
	}
