<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SBLEXT_Ship_Builders_Liability.aspx.vb" Inherits="Nexus.PB2_SBLEXT_Ship_Builders_Liability" %>
...
function onValidate_SBLEXT__SBLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLEXT", "SBLDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLEXT_SBLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLEXT__SBLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLEXT__SBLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLEXT", "SBLDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SBLEXT", "SBLDES");
...
function onValidate_SBLEXT__SBLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLEXT", "SBLLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLEXT", "SBLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLEXT_SBLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLEXT__SBLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLEXT__SBLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SBLEXT", "SBLLOI");
...
function onValidate_SBLEXT__SBLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLEXT", "SBLR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLEXT_SBLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLEXT__SBLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLEXT__SBLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLEXT", "SBLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SBLEXT", "SBLR");
...
function onValidate_SBLEXT__SBLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLEXT", "SBLP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLEXT_SBLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLEXT__SBLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLEXT__SBLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLEXT", "SBLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SBLEXT", "SBLP");
...
function DoLogic(isOnLoad) {
    onValidate_SBLEXT__SBLDES(null, null, null, isOnLoad);
    onValidate_SBLEXT__SBLLOI(null, null, null, isOnLoad);
    onValidate_SBLEXT__SBLR(null, null, null, isOnLoad);
    onValidate_SBLEXT__SBLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idd5e4f04909244d74a477342886b9db98" class="general-layout-container">
...
<div id="id3e7e9eceb77848b0b8474e6b5239fb8b" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SBLEXT" 
		data-property-name="SBLDES" 
		 
		
		 
		id="pb-container-text-SBLEXT-SBLDES">

		
		<asp:Label ID="lblSBLEXT_SBLDES" runat="server" AssociatedControlID="SBLEXT__SBLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SBLEXT__SBLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSBLEXT_SBLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SBLEXT__SBLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SBLEXT-SBLLOI">
		<asp:Label ID="lblSBLEXT_SBLLOI" runat="server" AssociatedControlID="SBLEXT__SBLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SBLEXT__SBLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSBLEXT_SBLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SBLEXT__SBLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SBLEXT-SBLR">
		<asp:Label ID="lblSBLEXT_SBLR" runat="server" AssociatedControlID="SBLEXT__SBLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SBLEXT__SBLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSBLEXT_SBLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SBLEXT__SBLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SBLEXT-SBLP">
		<asp:Label ID="lblSBLEXT_SBLP" runat="server" AssociatedControlID="SBLEXT__SBLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SBLEXT__SBLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSBLEXT_SBLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SBLEXT__SBLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3e7e9eceb77848b0b8474e6b5239fb8b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3e7e9eceb77848b0b8474e6b5239fb8b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3e7e9eceb77848b0b8474e6b5239fb8b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3e7e9eceb77848b0b8474e6b5239fb8b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3e7e9eceb77848b0b8474e6b5239fb8b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3e7e9eceb77848b0b8474e6b5239fb8b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3e7e9eceb77848b0b8474e6b5239fb8b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3e7e9eceb77848b0b8474e6b5239fb8b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3e7e9eceb77848b0b8474e6b5239fb8b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3e7e9eceb77848b0b8474e6b5239fb8b input{text-align:left;}"; break;
		}
	}
