<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_CONLEXT_Mariners_Operators_Liability" %>
...
function onValidate_CONLEXT__CONLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONLEXT", "CONLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONLEXT.CONLDES");
        			window.setControlWidth(field, "0.8", "CONLEXT", "CONLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONLEXT_CONLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONLEXT__CONLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONLEXT__CONLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONLEXT", "CONLDES");
        		}
...
function onValidate_CONLEXT__CONLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONLEXT", "CONLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONLEXT.CONLLOI");
        			window.setControlWidth(field, "0.8", "CONLEXT", "CONLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONLEXT", "CONLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONLEXT_CONLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONLEXT__CONLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONLEXT__CONLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CONLEXT__CONLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONLEXT", "CONLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONLEXT.CONLR");
        			window.setControlWidth(field, "0.8", "CONLEXT", "CONLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONLEXT_CONLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONLEXT__CONLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONLEXT__CONLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONLEXT", "CONLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CONLEXT__CONLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONLEXT", "CONLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONLEXT.CONLP");
        			window.setControlWidth(field, "0.8", "CONLEXT", "CONLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONLEXT_CONLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONLEXT__CONLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONLEXT__CONLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONLEXT", "CONLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_CONLEXT__CONLDES(null, null, null, isOnLoad);
    onValidate_CONLEXT__CONLLOI(null, null, null, isOnLoad);
    onValidate_CONLEXT__CONLR(null, null, null, isOnLoad);
    onValidate_CONLEXT__CONLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id27c38c99b6e948ceb099d6c9eb007963" class="general-layout-container">
...
<div id="ide72e5e0e294b4a59aabb69f969368e7a" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CONLEXT" 
		data-property-name="CONLDES" 
		 
		
		 
		id="pb-container-text-CONLEXT-CONLDES">

		
		<asp:Label ID="lblCONLEXT_CONLDES" runat="server" AssociatedControlID="CONLEXT__CONLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CONLEXT__CONLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCONLEXT_CONLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CONLEXT__CONLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CONLEXT" 
		data-property-name="CONLLOI" 
		id="pb-container-currency-CONLEXT-CONLLOI">
		<asp:Label ID="lblCONLEXT_CONLLOI" runat="server" AssociatedControlID="CONLEXT__CONLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CONLEXT__CONLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCONLEXT_CONLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CONLEXT__CONLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CONLEXT" 
		data-property-name="CONLR" 
		id="pb-container-percentage-CONLEXT-CONLR">
		<asp:Label ID="lblCONLEXT_CONLR" runat="server" AssociatedControlID="CONLEXT__CONLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CONLEXT__CONLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCONLEXT_CONLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_CONLEXT__CONLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CONLEXT-CONLP">
		<asp:Label ID="lblCONLEXT_CONLP" runat="server" AssociatedControlID="CONLEXT__CONLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CONLEXT__CONLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCONLEXT_CONLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CONLEXT__CONLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide72e5e0e294b4a59aabb69f969368e7a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide72e5e0e294b4a59aabb69f969368e7a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide72e5e0e294b4a59aabb69f969368e7a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide72e5e0e294b4a59aabb69f969368e7a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide72e5e0e294b4a59aabb69f969368e7a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide72e5e0e294b4a59aabb69f969368e7a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide72e5e0e294b4a59aabb69f969368e7a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide72e5e0e294b4a59aabb69f969368e7a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide72e5e0e294b4a59aabb69f969368e7a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide72e5e0e294b4a59aabb69f969368e7a input{text-align:left;}"; break;
		}
	}
