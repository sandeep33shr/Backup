<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FFLEXT_Charterers_Liability.aspx.vb" Inherits="Nexus.PB2_FFLEXT_Charterers_Liability" %>
...
function onValidate_FFLEXTS__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLEXTS", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FFLEXTS.CLDES");
        			window.setControlWidth(field, "0.8", "FFLEXTS", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLEXTS_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLEXTS__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLEXTS__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLEXTS", "CLDES");
        		}
...
function onValidate_FFLEXTS__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLEXTS", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FFLEXTS.CLLOI");
        			window.setControlWidth(field, "0.8", "FFLEXTS", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLEXTS", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLEXTS_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLEXTS__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLEXTS__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_FFLEXTS__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLEXTS", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FFLEXTS.CLR");
        			window.setControlWidth(field, "0.8", "FFLEXTS", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLEXTS_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLEXTS__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLEXTS__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLEXTS", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_FFLEXTS__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLEXTS", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FFLEXTS.CLP");
        			window.setControlWidth(field, "0.8", "FFLEXTS", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLEXTS_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLEXTS__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLEXTS__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLEXTS", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_FFLEXTS__CLDES(null, null, null, isOnLoad);
    onValidate_FFLEXTS__CLLOI(null, null, null, isOnLoad);
    onValidate_FFLEXTS__CLR(null, null, null, isOnLoad);
    onValidate_FFLEXTS__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="iddb14ce34525947f8ac78411befc64e0d" class="general-layout-container">
...
<div id="id60414f6c266c4b338695bd77de2b476b" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="FFLEXTS" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-FFLEXTS-CLDES">

		
		<asp:Label ID="lblFFLEXTS_CLDES" runat="server" AssociatedControlID="FFLEXTS__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FFLEXTS__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFFLEXTS_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_FFLEXTS__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FFLEXTS-CLLOI">
		<asp:Label ID="lblFFLEXTS_CLLOI" runat="server" AssociatedControlID="FFLEXTS__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FFLEXTS__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFFLEXTS_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_FFLEXTS__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-FFLEXTS-CLR">
		<asp:Label ID="lblFFLEXTS_CLR" runat="server" AssociatedControlID="FFLEXTS__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FFLEXTS__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFFLEXTS_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_FFLEXTS__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FFLEXTS-CLP">
		<asp:Label ID="lblFFLEXTS_CLP" runat="server" AssociatedControlID="FFLEXTS__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FFLEXTS__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFFLEXTS_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_FFLEXTS__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id60414f6c266c4b338695bd77de2b476b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id60414f6c266c4b338695bd77de2b476b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id60414f6c266c4b338695bd77de2b476b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id60414f6c266c4b338695bd77de2b476b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id60414f6c266c4b338695bd77de2b476b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60414f6c266c4b338695bd77de2b476b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60414f6c266c4b338695bd77de2b476b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id60414f6c266c4b338695bd77de2b476b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60414f6c266c4b338695bd77de2b476b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60414f6c266c4b338695bd77de2b476b input{text-align:left;}"; break;
		}
	}
