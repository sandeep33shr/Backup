<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PRLLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_PRLLEXT_Mariners_Operators_Liability" %>
...
function onValidate_PRLLEXT__PRLLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLLEXT", "PRLLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PRLLEXT.PRLLDES");
        			window.setControlWidth(field, "0.8", "PRLLEXT", "PRLLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLLEXT_PRLLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLLEXT__PRLLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLLEXT__PRLLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLLEXT", "PRLLDES");
        		}
...
function onValidate_PRLLEXT__PRLLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLLEXT", "PRLLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PRLLEXT.PRLLLOI");
        			window.setControlWidth(field, "0.8", "PRLLEXT", "PRLLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLLEXT", "PRLLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLLEXT_PRLLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLLEXT__PRLLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLLEXT__PRLLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PRLLEXT__PRLLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLLEXT", "PRLLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PRLLEXT.PRLLR");
        			window.setControlWidth(field, "0.8", "PRLLEXT", "PRLLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLLEXT_PRLLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLLEXT__PRLLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLLEXT__PRLLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLLEXT", "PRLLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_PRLLEXT__PRLLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLLEXT", "PRLLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PRLLEXT.PRLLP");
        			window.setControlWidth(field, "0.8", "PRLLEXT", "PRLLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLLEXT_PRLLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLLEXT__PRLLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLLEXT__PRLLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLLEXT", "PRLLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_PRLLEXT__PRLLDES(null, null, null, isOnLoad);
    onValidate_PRLLEXT__PRLLLOI(null, null, null, isOnLoad);
    onValidate_PRLLEXT__PRLLR(null, null, null, isOnLoad);
    onValidate_PRLLEXT__PRLLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id6b0b298a8cd14c328c513e38132191dd" class="general-layout-container">
...
<div id="idabe79afca6e14f86acd703a51d2de0c3" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PRLLEXT" 
		data-property-name="PRLLDES" 
		 
		
		 
		id="pb-container-text-PRLLEXT-PRLLDES">

		
		<asp:Label ID="lblPRLLEXT_PRLLDES" runat="server" AssociatedControlID="PRLLEXT__PRLLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PRLLEXT__PRLLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPRLLEXT_PRLLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_PRLLEXT__PRLLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PRLLEXT" 
		data-property-name="PRLLLOI" 
		id="pb-container-currency-PRLLEXT-PRLLLOI">
		<asp:Label ID="lblPRLLEXT_PRLLLOI" runat="server" AssociatedControlID="PRLLEXT__PRLLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLLEXT__PRLLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLLEXT_PRLLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_PRLLEXT__PRLLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PRLLEXT" 
		data-property-name="PRLLR" 
		id="pb-container-percentage-PRLLEXT-PRLLR">
		<asp:Label ID="lblPRLLEXT_PRLLR" runat="server" AssociatedControlID="PRLLEXT__PRLLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PRLLEXT__PRLLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPRLLEXT_PRLLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_PRLLEXT__PRLLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PRLLEXT-PRLLP">
		<asp:Label ID="lblPRLLEXT_PRLLP" runat="server" AssociatedControlID="PRLLEXT__PRLLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLLEXT__PRLLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLLEXT_PRLLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PRLLEXT__PRLLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idabe79afca6e14f86acd703a51d2de0c3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idabe79afca6e14f86acd703a51d2de0c3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idabe79afca6e14f86acd703a51d2de0c3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idabe79afca6e14f86acd703a51d2de0c3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idabe79afca6e14f86acd703a51d2de0c3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idabe79afca6e14f86acd703a51d2de0c3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idabe79afca6e14f86acd703a51d2de0c3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idabe79afca6e14f86acd703a51d2de0c3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idabe79afca6e14f86acd703a51d2de0c3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idabe79afca6e14f86acd703a51d2de0c3 input{text-align:left;}"; break;
		}
	}
