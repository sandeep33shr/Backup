<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLLLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_CLLLEXT_Mariners_Operators_Liability" %>
...
function onValidate_CLLLEXT__CLLLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLLEXT", "CLLLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLLLEXT.CLLLDES");
        			window.setControlWidth(field, "0.8", "CLLLEXT", "CLLLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLLEXT_CLLLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLLEXT__CLLLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLLEXT__CLLLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLLEXT", "CLLLDES");
        		}
...
function onValidate_CLLLEXT__CLLLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLLEXT", "CLLLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLLLEXT.CLLLLOI");
        			window.setControlWidth(field, "0.8", "CLLLEXT", "CLLLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLLEXT", "CLLLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLLEXT_CLLLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLLEXT__CLLLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLLEXT__CLLLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CLLLEXT__CLLLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLLEXT", "CLLLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLLLEXT.CLLLR");
        			window.setControlWidth(field, "0.8", "CLLLEXT", "CLLLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLLEXT_CLLLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLLEXT__CLLLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLLEXT__CLLLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLLEXT", "CLLLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CLLLEXT__CLLLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLLEXT", "CLLLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLLLEXT.CLLLP");
        			window.setControlWidth(field, "0.8", "CLLLEXT", "CLLLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLLEXT_CLLLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLLEXT__CLLLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLLEXT__CLLLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLLEXT", "CLLLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_CLLLEXT__CLLLDES(null, null, null, isOnLoad);
    onValidate_CLLLEXT__CLLLLOI(null, null, null, isOnLoad);
    onValidate_CLLLEXT__CLLLR(null, null, null, isOnLoad);
    onValidate_CLLLEXT__CLLLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idaba509b6c2aa4bb494c4720bcb3a724d" class="general-layout-container">
...
<div id="id927bb8cfaa234ec289e9fd376a56ade8" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CLLLEXT" 
		data-property-name="CLLLDES" 
		 
		
		 
		id="pb-container-text-CLLLEXT-CLLLDES">

		
		<asp:Label ID="lblCLLLEXT_CLLLDES" runat="server" AssociatedControlID="CLLLEXT__CLLLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CLLLEXT__CLLLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCLLLEXT_CLLLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CLLLEXT__CLLLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CLLLEXT" 
		data-property-name="CLLLLOI" 
		id="pb-container-currency-CLLLEXT-CLLLLOI">
		<asp:Label ID="lblCLLLEXT_CLLLLOI" runat="server" AssociatedControlID="CLLLEXT__CLLLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLLEXT__CLLLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLLEXT_CLLLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CLLLEXT__CLLLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CLLLEXT" 
		data-property-name="CLLLR" 
		id="pb-container-percentage-CLLLEXT-CLLLR">
		<asp:Label ID="lblCLLLEXT_CLLLR" runat="server" AssociatedControlID="CLLLEXT__CLLLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CLLLEXT__CLLLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCLLLEXT_CLLLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_CLLLEXT__CLLLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLLLEXT-CLLLP">
		<asp:Label ID="lblCLLLEXT_CLLLP" runat="server" AssociatedControlID="CLLLEXT__CLLLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLLEXT__CLLLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLLEXT_CLLLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CLLLEXT__CLLLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id927bb8cfaa234ec289e9fd376a56ade8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id927bb8cfaa234ec289e9fd376a56ade8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id927bb8cfaa234ec289e9fd376a56ade8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id927bb8cfaa234ec289e9fd376a56ade8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id927bb8cfaa234ec289e9fd376a56ade8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id927bb8cfaa234ec289e9fd376a56ade8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id927bb8cfaa234ec289e9fd376a56ade8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id927bb8cfaa234ec289e9fd376a56ade8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id927bb8cfaa234ec289e9fd376a56ade8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id927bb8cfaa234ec289e9fd376a56ade8 input{text-align:left;}"; break;
		}
	}
