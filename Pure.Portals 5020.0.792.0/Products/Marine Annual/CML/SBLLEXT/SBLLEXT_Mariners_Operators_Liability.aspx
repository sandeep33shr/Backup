<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SBLLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_SBLLEXT_Mariners_Operators_Liability" %>
...
function onValidate_SBLLEXT__SBLLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLLEXT", "SBLLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBLLEXT.SBLLDES");
        			window.setControlWidth(field, "0.8", "SBLLEXT", "SBLLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLLEXT_SBLLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLLEXT__SBLLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLLEXT__SBLLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLLEXT", "SBLLDES");
        		}
...
function onValidate_SBLLEXT__SBLLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLLEXT", "SBLLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBLLEXT.SBLLLOI");
        			window.setControlWidth(field, "0.8", "SBLLEXT", "SBLLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLLEXT", "SBLLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLLEXT_SBLLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLLEXT__SBLLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLLEXT__SBLLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SBLLEXT__SBLLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLLEXT", "SBLLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBLLEXT.SBLLR");
        			window.setControlWidth(field, "0.8", "SBLLEXT", "SBLLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLLEXT_SBLLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLLEXT__SBLLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLLEXT__SBLLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLLEXT", "SBLLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_SBLLEXT__SBLLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBLLEXT", "SBLLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBLLEXT.SBLLP");
        			window.setControlWidth(field, "0.8", "SBLLEXT", "SBLLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBLLEXT_SBLLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBLLEXT__SBLLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBLLEXT__SBLLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBLLEXT", "SBLLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_SBLLEXT__SBLLDES(null, null, null, isOnLoad);
    onValidate_SBLLEXT__SBLLLOI(null, null, null, isOnLoad);
    onValidate_SBLLEXT__SBLLR(null, null, null, isOnLoad);
    onValidate_SBLLEXT__SBLLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id52c1d651edd14a7eaaefa7c6e6dfad29" class="general-layout-container">
...
<div id="idba6b998759ee4396a3b6c8e01a97ff88" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SBLLEXT" 
		data-property-name="SBLLDES" 
		 
		
		 
		id="pb-container-text-SBLLEXT-SBLLDES">

		
		<asp:Label ID="lblSBLLEXT_SBLLDES" runat="server" AssociatedControlID="SBLLEXT__SBLLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SBLLEXT__SBLLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSBLLEXT_SBLLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SBLLEXT__SBLLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SBLLEXT" 
		data-property-name="SBLLLOI" 
		id="pb-container-currency-SBLLEXT-SBLLLOI">
		<asp:Label ID="lblSBLLEXT_SBLLLOI" runat="server" AssociatedControlID="SBLLEXT__SBLLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SBLLEXT__SBLLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSBLLEXT_SBLLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SBLLEXT__SBLLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SBLLEXT" 
		data-property-name="SBLLR" 
		id="pb-container-percentage-SBLLEXT-SBLLR">
		<asp:Label ID="lblSBLLEXT_SBLLR" runat="server" AssociatedControlID="SBLLEXT__SBLLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SBLLEXT__SBLLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSBLLEXT_SBLLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SBLLEXT__SBLLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SBLLEXT-SBLLP">
		<asp:Label ID="lblSBLLEXT_SBLLP" runat="server" AssociatedControlID="SBLLEXT__SBLLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SBLLEXT__SBLLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSBLLEXT_SBLLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SBLLEXT__SBLLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idba6b998759ee4396a3b6c8e01a97ff88 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idba6b998759ee4396a3b6c8e01a97ff88 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idba6b998759ee4396a3b6c8e01a97ff88 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idba6b998759ee4396a3b6c8e01a97ff88 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idba6b998759ee4396a3b6c8e01a97ff88 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idba6b998759ee4396a3b6c8e01a97ff88 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idba6b998759ee4396a3b6c8e01a97ff88 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idba6b998759ee4396a3b6c8e01a97ff88 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idba6b998759ee4396a3b6c8e01a97ff88 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idba6b998759ee4396a3b6c8e01a97ff88 input{text-align:left;}"; break;
		}
	}
