...
Namespace Nexus
    Partial Class PB2_FFLPNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_FFL_PNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If FFL_PNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		FFL_PNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		FFL_PNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_FFL_PNOTES_DETAILS__NOTE_DETAILS()
End Sub
