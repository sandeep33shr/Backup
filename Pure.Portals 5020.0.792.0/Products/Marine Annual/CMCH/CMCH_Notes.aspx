<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMCH_Notes.aspx.vb" Inherits="Nexus.PB2_CMCH_Notes" %>
...
function onValidate_MARINENOTES__MNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MARINENOTES", "MNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MARINENOTES__MNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="idd67a4fc0211f481aab38e7949d00a49b" class="general-layout-container">
...
<div id="id85450f39165542eca3939e4d8be56de6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading29" runat="server" Text="Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MARINENOTES__MNOTES"
		data-field-type="Child" 
		data-object-name="MARINENOTES" 
		data-property-name="MNOTES" 
		id="pb-container-childscreen-MARINENOTES-MNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MARINENOTES__CNOTE_DETAILS" runat="server" ScreenCode="MNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MNOTES/MNOTES_Notes_Detail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMARINENOTES_MNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_MARINENOTES__MNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id85450f39165542eca3939e4d8be56de6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id85450f39165542eca3939e4d8be56de6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id85450f39165542eca3939e4d8be56de6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id85450f39165542eca3939e4d8be56de6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id85450f39165542eca3939e4d8be56de6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id85450f39165542eca3939e4d8be56de6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id85450f39165542eca3939e4d8be56de6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id85450f39165542eca3939e4d8be56de6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id85450f39165542eca3939e4d8be56de6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id85450f39165542eca3939e4d8be56de6 input{text-align:left;}"; break;
		}
	}
