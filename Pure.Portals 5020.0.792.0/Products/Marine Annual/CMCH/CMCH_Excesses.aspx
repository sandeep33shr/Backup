<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMCH_Excesses.aspx.vb" Inherits="Nexus.PB2_CMCH_Excesses" %>
...
function onValidate_EXCS__MEXCSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXCS", "MEXCSCL", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_EXCS__MEXCSCL(null, null, null, isOnLoad);
}
</script>
...
<div id="id223adca419be45e18cf2ce30217c9daf" class="general-layout-container">
...
<div id="id5c150b493c6447ac97a7b91a109fbe64" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EXCS__MEXCSCL"
		data-field-type="Child" 
		data-object-name="EXCS" 
		data-property-name="MEXCSCL" 
		id="pb-container-childscreen-EXCS-MEXCSCL">
		
		    <legend>Excess</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EXCS__EXCSCL" runat="server" ScreenCode="MEXCSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MEXCSCL/MEXCSCL_Excess_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:GISLookupField HeaderText="Type Of Excess" ListType="PMLookup" ListCode="UDL_TOFEXCSS" DataField="TPOFEXCESS" DataItemValue="key" />
<Nexus:RiskAttribute HeaderText="Description" DataField="DSCRIPTIN" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Excess  %" DataField="EXCSSP" DataFormatString="{0:0}%"/>
<Nexus:RiskAttribute HeaderText="Minimum Amount" DataField="MNAMOUNT" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Maximum Amount" DataField="MXAMOUNT" DataFormatString="{0:N}"/>
<Nexus:GISLookupField HeaderText="Basis Of Excess" ListType="PMLookup" ListCode="UDL_BFACCESS" DataField="BOEXCESS" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valEXCS_MEXCSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Excess"
						ClientValidationFunction="onValidate_EXCS__MEXCSCL" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5c150b493c6447ac97a7b91a109fbe64 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5c150b493c6447ac97a7b91a109fbe64 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5c150b493c6447ac97a7b91a109fbe64 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5c150b493c6447ac97a7b91a109fbe64 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5c150b493c6447ac97a7b91a109fbe64 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5c150b493c6447ac97a7b91a109fbe64 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5c150b493c6447ac97a7b91a109fbe64 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5c150b493c6447ac97a7b91a109fbe64 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5c150b493c6447ac97a7b91a109fbe64 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5c150b493c6447ac97a7b91a109fbe64 input{text-align:left;}"; break;
		}
	}
