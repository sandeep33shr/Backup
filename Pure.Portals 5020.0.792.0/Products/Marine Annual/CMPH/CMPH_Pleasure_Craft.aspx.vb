...
Namespace Nexus
    Partial Class PB2_CMPH_Pleasure_Craft : Inherits BaseRisk
...
End Sub
Protected Sub onValidate_IPPC_VESSELS__INCEP_DATE()
...
Protected Sub CallRuleScripts()
    ...
    onValidate_IPPC_VESSELS__INCEP_DATE()
...
End Sub
        ...
        Protected Shadows Sub LoadCoverStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If isTrueMonthly Then
        		IPPC_VESSELS__INCEP_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	Else
        		IPPC_VESSELS__INCEP_DATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
        	
        	'IPPC_VESSELS__ENDDATE.Text = RTrim(LTrim(oQuote.CoverEndDate))
