...
Namespace Nexus
    Partial Class PB2_PCENDPREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_PC_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PC_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'WC_REFERRAL_CLAUSES - Standard Wording Parent Object
        'REFERRAL_CLAUSES - Standard Wording Parent Property
        'WC_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/WC_REFERRAL_CLAUSES/SW.REFERRAL_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("WC_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/WC_REFERRAL_CLAUSES/WC_CLAUSEPREM")
        
        	Dim CurrentSelected As String = PC_CLAUSEPREM__ENDORSE_CAP.Text
