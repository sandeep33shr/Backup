<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="BMAPC_Pleasure_Hull.aspx.vb" Inherits="Nexus.PB2_BMAPC_Pleasure_Hull" %>
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("NOW"), 
        			condition = (Expression.isValidParameter("WC_GENERAL.RISKATTACHDATE = '' OR WC_GENERAL.RISKATTACHDATE = null")) ? new Expression("WC_GENERAL.RISKATTACHDATE = '' OR WC_GENERAL.RISKATTACHDATE = null") : null, 
...
function onValidate_PC_GENERAL__PRIMARY_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_GENERAL", "PRIMARY_INDUSTRY", "RateList");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_GENERAL.PRIMARY_INDUSTRY");
        			window.setControlWidth(field, "0.9", "PC_GENERAL", "PRIMARY_INDUSTRY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_GENERAL_PRIMARY_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_GENERAL__PRIMARY_INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_GENERAL__PRIMARY_INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_GENERAL", "PRIMARY_INDUSTRY");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_PC_GENERAL__SECOND_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_GENERAL", "SECOND_INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_GENERAL", "SECOND_INDUSTRY");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_GENERAL.SECOND_INDUSTRY");
        			window.setControlWidth(field, "0.9", "PC_GENERAL", "SECOND_INDUSTRY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_GENERAL_SECOND_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_GENERAL__SECOND_INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_GENERAL__SECOND_INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_GENERAL__TERTIARY_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_GENERAL", "TERTIARY_INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_GENERAL", "TERTIARY_INDUSTRY");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_GENERAL.TERTIARY_INDUSTRY");
        			window.setControlWidth(field, "0.9", "PC_GENERAL", "TERTIARY_INDUSTRY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_GENERAL_TERTIARY_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_GENERAL__TERTIARY_INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_GENERAL__TERTIARY_INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_GENERAL__INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_GENERAL", "INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_GENERAL", "INDUSTRY");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_GENERAL.INDUSTRY");
        			window.setControlWidth(field, "0.9", "PC_GENERAL", "INDUSTRY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_GENERAL_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_GENERAL__INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_GENERAL__INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_VESSELS__NVESSEL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "NVESSEL", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PC_VESSELS", "NVESSEL");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.NVESSEL");
        			window.setControlWidth(field, "0.7", "PC_VESSELS", "NVESSEL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_NVESSEL");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__NVESSEL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__NVESSEL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_VESSELS__VRAFT_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "VRAFT_TYPE", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PC_VESSELS", "VRAFT_TYPE");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.VRAFT_TYPE");
        			window.setControlWidth(field, "0.3", "PC_VESSELS", "VRAFT_TYPE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_VRAFT_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__VRAFT_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__VRAFT_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_VESSELS__TVMOTOR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "TVMOTOR", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "TVMOTOR");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.TVMOTOR");
        			window.setControlWidth(field, "0.3", "PC_VESSELS", "TVMOTOR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_TVMOTOR");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__TVMOTOR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__TVMOTOR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_VESSELS__TYPE_USE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "TYPE_USE", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "TYPE_USE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.TYPE_USE");
        			window.setControlWidth(field, "0.3", "PC_VESSELS", "TYPE_USE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_TYPE_USE");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__TYPE_USE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__TYPE_USE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_VESSELS__VUSE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "VUSE", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "VUSE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.VUSE");
        			window.setControlWidth(field, "0.3", "PC_VESSELS", "VUSE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_VUSE");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__VUSE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__VUSE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_VESSELS__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PC_VESSELS", "SUMINSURED");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.SUMINSURED");
        			window.setControlWidth(field, "0.8", "PC_VESSELS", "SUMINSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_VESSELS__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "RATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.RATE");
        			window.setControlWidth(field, "0.8", "PC_VESSELS", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "PC_VESSELS".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "PC_VESSELS".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=PC_VESSELS&propertyName=RATE&name={name}");
...
function onValidate_PC_VESSELS__PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.PREM");
        			window.setControlWidth(field, "0.8", "PC_VESSELS", "PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PC_VESSELS&propertyName=PREM&name={name}");
...
function onValidate_PC_VESSELS__POST_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "POST_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PC_VESSELS", "POST_PREM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.POST_PREM");
        			window.setControlWidth(field, "0.8", "PC_VESSELS", "POST_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_POST_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__POST_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__POST_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PC_VESSELS&propertyName=POST_PREM&name={name}");
...
function onValidate_PC_VESSELS__FAP_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "FAP_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "FAP_PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.FAP_PERC");
        			window.setControlWidth(field, "0.8", "PC_VESSELS", "FAP_PERC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_FAP_PERC");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__FAP_PERC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__FAP_PERC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "PC_VESSELS".toUpperCase() + "__" + "FAP_PERC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "PC_VESSELS".toUpperCase() + "_" + "FAP_PERC");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=PC_VESSELS&propertyName=FAP_PERC&name={name}");
...
function onValidate_PC_VESSELS__MIN_AMNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "MIN_AMNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "MIN_AMNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.MIN_AMNT");
        			window.setControlWidth(field, "0.8", "PC_VESSELS", "MIN_AMNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_MIN_AMNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__MIN_AMNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__MIN_AMNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PC_VESSELS&propertyName=MIN_AMNT&name={name}");
...
function onValidate_PC_VESSELS__IS_NASRIA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "IS_NASRIA", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "IS_NASRIA");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_PC_VESSELS__NASRIA_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "NASRIA_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "NASRIA_LIMIT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.NASRIA_LIMIT");
        			window.setControlWidth(field, "0.4", "PC_VESSELS", "NASRIA_LIMIT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_NASRIA_LIMIT");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__NASRIA_LIMIT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__NASRIA_LIMIT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PC_VESSELS&propertyName=NASRIA_LIMIT&name={name}");
...
function onValidate_PC_VESSELS__INTPARTY_NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "INTPARTY_NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "INTPARTY_NAME");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.INTPARTY_NAME");
        			window.setControlWidth(field, "0.8", "PC_VESSELS", "INTPARTY_NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_INTPARTY_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__INTPARTY_NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__INTPARTY_NAME_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_VESSELS__INTPARTY_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "INTPARTY_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "INTPARTY_DATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_VESSELS.INTPARTY_DATE");
        			window.setControlWidth(field, "0.3", "PC_VESSELS", "INTPARTY_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_VESSELS_INTPARTY_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_VESSELS__INTPARTY_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_VESSELS__INTPARTY_DATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "PC_VESSELS".toUpperCase() + "__" + "INTPARTY_DATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "PC_VESSELS".toUpperCase() + "_" + "INTPARTY_DATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
...
function onValidate_PC_VESSELS__INCEP_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "INCEP_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PC_VESSELS", "INCEP_DATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PC_VESSELS", "INCEP_DATE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_PC_REFERRAL_CLAUSES__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_REFERRAL_CLAUSES", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("PC_REFERRAL_CLAUSES", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_REFERRAL_CLAUSES.TOT_PREM");
        			window.setControlWidth(field, "0.2", "PC_REFERRAL_CLAUSES", "TOT_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_REFERRAL_CLAUSES_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_REFERRAL_CLAUSES__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_REFERRAL_CLAUSES__TOT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PC_REFERRAL_CLAUSES__PCENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_REFERRAL_CLAUSES", "PCENDPREM", "ChildScreen");
        })();
}
function onValidate_PC_NOTES__PCNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_NOTES", "PCNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("PC_NOTES", "PCNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_PC_NOTES__PCNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("PC_NOTES", "PCNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'PC_NOTES' and property 'PCNOTES'.");
        			error.display();
...
function onValidate_PC_NOTES__PCSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_NOTES", "PCSNOTES", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("PC_NOTES", "PCSNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_PC_NOTES__PCSNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("PC_NOTES", "PCSNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'PC_NOTES' and property 'PCSNOTES'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function DoLogic(isOnLoad) {
    ...
    onValidate_PC_GENERAL__PRIMARY_INDUSTRY(null, null, null, isOnLoad);
    onValidate_PC_GENERAL__SECOND_INDUSTRY(null, null, null, isOnLoad);
    onValidate_PC_GENERAL__TERTIARY_INDUSTRY(null, null, null, isOnLoad);
    onValidate_PC_GENERAL__INDUSTRY(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__NVESSEL(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__VRAFT_TYPE(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__TVMOTOR(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__TYPE_USE(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__VUSE(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__SUMINSURED(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__RATE(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__PREM(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__POST_PREM(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__FAP_PERC(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__MIN_AMNT(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__IS_NASRIA(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__NASRIA_LIMIT(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__INTPARTY_NAME(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__INTPARTY_DATE(null, null, null, isOnLoad);
    onValidate_PC_VESSELS__INCEP_DATE(null, null, null, isOnLoad);
    onValidate_PC_REFERRAL_CLAUSES__TOT_PREM(null, null, null, isOnLoad);
    onValidate_PC_REFERRAL_CLAUSES__PCENDPREM(null, null, null, isOnLoad);
    onValidate_PC_NOTES__PCNOTES(null, null, null, isOnLoad);
    onValidate_PC_NOTES__PCSNOTES(null, null, null, isOnLoad);
...
<div id="id3c7f016568db48cc907b088587da2447" class="general-layout-container">
...
<div id="id081010ffefdc4784b788c8a9c04ed75c" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id081010ffefdc4784b788c8a9c04ed75c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id081010ffefdc4784b788c8a9c04ed75c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id081010ffefdc4784b788c8a9c04ed75c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id081010ffefdc4784b788c8a9c04ed75c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id081010ffefdc4784b788c8a9c04ed75c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id081010ffefdc4784b788c8a9c04ed75c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id081010ffefdc4784b788c8a9c04ed75c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id081010ffefdc4784b788c8a9c04ed75c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id081010ffefdc4784b788c8a9c04ed75c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id081010ffefdc4784b788c8a9c04ed75c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0a33af286be043beaf05e7ca8153acc1" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0a33af286be043beaf05e7ca8153acc1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0a33af286be043beaf05e7ca8153acc1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0a33af286be043beaf05e7ca8153acc1 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0a33af286be043beaf05e7ca8153acc1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0a33af286be043beaf05e7ca8153acc1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0a33af286be043beaf05e7ca8153acc1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0a33af286be043beaf05e7ca8153acc1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0a33af286be043beaf05e7ca8153acc1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0a33af286be043beaf05e7ca8153acc1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0a33af286be043beaf05e7ca8153acc1 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb0b77e59bb2046d08b8a6eaf2093986b" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_GENERAL-PRIMARY_INDUSTRY">
		<asp:Label ID="lblPC_GENERAL_PRIMARY_INDUSTRY" runat="server" AssociatedControlID="PC_GENERAL__PRIMARY_INDUSTRY" 
			Text="Primary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_GENERAL__PRIMARY_INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDONE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_GENERAL__PRIMARY_INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_GENERAL_PRIMARY_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Primary Industry"
			ClientValidationFunction="onValidate_PC_GENERAL__PRIMARY_INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_GENERAL-SECOND_INDUSTRY">
		<asp:Label ID="lblPC_GENERAL_SECOND_INDUSTRY" runat="server" AssociatedControlID="PC_GENERAL__SECOND_INDUSTRY" 
			Text="Secondary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_GENERAL__SECOND_INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDTWO" ParentLookupListID="PC_GENERAL__PRIMARY_INDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_GENERAL__SECOND_INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_GENERAL_SECOND_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Secondary Industry"
			ClientValidationFunction="onValidate_PC_GENERAL__SECOND_INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_GENERAL-TERTIARY_INDUSTRY">
		<asp:Label ID="lblPC_GENERAL_TERTIARY_INDUSTRY" runat="server" AssociatedControlID="PC_GENERAL__TERTIARY_INDUSTRY" 
			Text="Tertiary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_GENERAL__TERTIARY_INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDTHR" ParentLookupListID="PC_GENERAL__SECOND_INDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_GENERAL__TERTIARY_INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_GENERAL_TERTIARY_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Tertiary Industry"
			ClientValidationFunction="onValidate_PC_GENERAL__TERTIARY_INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_GENERAL-INDUSTRY">
		<asp:Label ID="lblPC_GENERAL_INDUSTRY" runat="server" AssociatedControlID="PC_GENERAL__INDUSTRY" 
			Text="Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_GENERAL__INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDUST" ParentLookupListID="PC_GENERAL__TERTIARY_INDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_GENERAL__INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_GENERAL_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Industry"
			ClientValidationFunction="onValidate_PC_GENERAL__INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb0b77e59bb2046d08b8a6eaf2093986b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb0b77e59bb2046d08b8a6eaf2093986b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb0b77e59bb2046d08b8a6eaf2093986b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb0b77e59bb2046d08b8a6eaf2093986b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb0b77e59bb2046d08b8a6eaf2093986b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb0b77e59bb2046d08b8a6eaf2093986b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb0b77e59bb2046d08b8a6eaf2093986b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb0b77e59bb2046d08b8a6eaf2093986b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb0b77e59bb2046d08b8a6eaf2093986b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb0b77e59bb2046d08b8a6eaf2093986b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2b387e2a2721441ab229c959f648114f" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PC_VESSELS" 
		data-property-name="NVESSEL" 
		id="pb-container-comment-PC_VESSELS-NVESSEL">
		<asp:Label ID="lblPC_VESSELS_NVESSEL" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="PC_VESSELS__NVESSEL" 
			Text="Name of Vessel"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="PC_VESSELS__NVESSEL" runat="server" />
		
		<asp:CustomValidator ID="valPC_VESSELS_NVESSEL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Name of Vessel"
			ClientValidationFunction="onValidate_PC_VESSELS__NVESSEL"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_VESSELS-VRAFT_TYPE">
		<asp:Label ID="lblPC_VESSELS_VRAFT_TYPE" runat="server" AssociatedControlID="PC_VESSELS__VRAFT_TYPE" 
			Text="Craft Type " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_VESSELS__VRAFT_TYPE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_WC_CRAFT_TYPE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_VESSELS__VRAFT_TYPE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_VESSELS_VRAFT_TYPE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Craft Type "
			ClientValidationFunction="onValidate_PC_VESSELS__VRAFT_TYPE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_VESSELS-TVMOTOR">
		<asp:Label ID="lblPC_VESSELS_TVMOTOR" runat="server" AssociatedControlID="PC_VESSELS__TVMOTOR" 
			Text="Type of Motor " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_VESSELS__TVMOTOR" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_WC_TYPE_MOTOR" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_VESSELS__TVMOTOR(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_VESSELS_TVMOTOR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Type of Motor "
			ClientValidationFunction="onValidate_PC_VESSELS__TVMOTOR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_VESSELS-TYPE_USE">
		<asp:Label ID="lblPC_VESSELS_TYPE_USE" runat="server" AssociatedControlID="PC_VESSELS__TYPE_USE" 
			Text="Type of Use" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_VESSELS__TYPE_USE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_WC_TYPE_USE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_VESSELS__TYPE_USE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_VESSELS_TYPE_USE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Type of Use"
			ClientValidationFunction="onValidate_PC_VESSELS__TYPE_USE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_VESSELS-VUSE">
		<asp:Label ID="lblPC_VESSELS_VUSE" runat="server" AssociatedControlID="PC_VESSELS__VUSE" 
			Text="Use" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_VESSELS__VUSE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_WC_USE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_VESSELS__VUSE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_VESSELS_VUSE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Use"
			ClientValidationFunction="onValidate_PC_VESSELS__VUSE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-suffix-none="true" 
		id="pb-container-text-PC_VESSELS-VRAFT_TYPECode">

		
		
			
		
				<asp:HiddenField ID="PC_VESSELS__VRAFT_TYPECode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-suffix-none="true" 
		id="pb-container-text-PC_VESSELS-TVMOTORCode">

		
		
			
		
				<asp:HiddenField ID="PC_VESSELS__TVMOTORCode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-suffix-none="true" 
		id="pb-container-text-PC_VESSELS-TYPE_USECode">

		
		
			
		
				<asp:HiddenField ID="PC_VESSELS__TYPE_USECode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-suffix-none="true" 
		id="pb-container-text-PC_VESSELS-VUSECode">

		
		
			
		
				<asp:HiddenField ID="PC_VESSELS__VUSECode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2b387e2a2721441ab229c959f648114f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2b387e2a2721441ab229c959f648114f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2b387e2a2721441ab229c959f648114f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2b387e2a2721441ab229c959f648114f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2b387e2a2721441ab229c959f648114f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b387e2a2721441ab229c959f648114f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b387e2a2721441ab229c959f648114f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2b387e2a2721441ab229c959f648114f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b387e2a2721441ab229c959f648114f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b387e2a2721441ab229c959f648114f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd185bd1c3643485cb868cd62a57579a5" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PC_VESSELS-SUMINSURED">
		<asp:Label ID="lblPC_VESSELS_SUMINSURED" runat="server" AssociatedControlID="PC_VESSELS__SUMINSURED" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PC_VESSELS__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPC_VESSELS_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PC_VESSELS.SUMINSURED"
			ClientValidationFunction="onValidate_PC_VESSELS__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-PC_VESSELS-RATE">
		<asp:Label ID="lblPC_VESSELS_RATE" runat="server" AssociatedControlID="PC_VESSELS__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PC_VESSELS__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPC_VESSELS_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PC_VESSELS.RATE"
			ClientValidationFunction="onValidate_PC_VESSELS__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PC_VESSELS-PREM">
		<asp:Label ID="lblPC_VESSELS_PREM" runat="server" AssociatedControlID="PC_VESSELS__PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PC_VESSELS__PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPC_VESSELS_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PC_VESSELS.PREM"
			ClientValidationFunction="onValidate_PC_VESSELS__PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PC_VESSELS-POST_PREM">
		<asp:Label ID="lblPC_VESSELS_POST_PREM" runat="server" AssociatedControlID="PC_VESSELS__POST_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PC_VESSELS__POST_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPC_VESSELS_POST_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PC_VESSELS.POST_PREM"
			ClientValidationFunction="onValidate_PC_VESSELS__POST_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-PC_VESSELS-FAP_PERC">
		<asp:Label ID="lblPC_VESSELS_FAP_PERC" runat="server" AssociatedControlID="PC_VESSELS__FAP_PERC" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PC_VESSELS__FAP_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPC_VESSELS_FAP_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PC_VESSELS.FAP_PERC"
			ClientValidationFunction="onValidate_PC_VESSELS__FAP_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PC_VESSELS-MIN_AMNT">
		<asp:Label ID="lblPC_VESSELS_MIN_AMNT" runat="server" AssociatedControlID="PC_VESSELS__MIN_AMNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PC_VESSELS__MIN_AMNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPC_VESSELS_MIN_AMNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PC_VESSELS.MIN_AMNT"
			ClientValidationFunction="onValidate_PC_VESSELS__MIN_AMNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd185bd1c3643485cb868cd62a57579a5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd185bd1c3643485cb868cd62a57579a5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd185bd1c3643485cb868cd62a57579a5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd185bd1c3643485cb868cd62a57579a5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd185bd1c3643485cb868cd62a57579a5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd185bd1c3643485cb868cd62a57579a5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd185bd1c3643485cb868cd62a57579a5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd185bd1c3643485cb868cd62a57579a5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd185bd1c3643485cb868cd62a57579a5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd185bd1c3643485cb868cd62a57579a5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf4d0f8e610e84f709b3b861d0a578e79" class="column-layout-container,no-border  ">
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblPC_VESSELS_IS_NASRIA" for="ctl00_cntMainBody_PC_VESSELS__IS_NASRIA" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-PC_VESSELS-IS_NASRIA">	
		
		<asp:TextBox ID="PC_VESSELS__IS_NASRIA" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valPC_VESSELS_IS_NASRIA" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PC_VESSELS.IS_NASRIA"
			ClientValidationFunction="onValidate_PC_VESSELS__IS_NASRIA" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label14">
		<span class="label" id="label14">NASRIA Pleasure Hull</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PC_VESSELS-NASRIA_LIMIT">
		<asp:Label ID="lblPC_VESSELS_NASRIA_LIMIT" runat="server" AssociatedControlID="PC_VESSELS__NASRIA_LIMIT" 
			Text="Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PC_VESSELS__NASRIA_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPC_VESSELS_NASRIA_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indemnity"
			ClientValidationFunction="onValidate_PC_VESSELS__NASRIA_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf4d0f8e610e84f709b3b861d0a578e79 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf4d0f8e610e84f709b3b861d0a578e79 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf4d0f8e610e84f709b3b861d0a578e79 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf4d0f8e610e84f709b3b861d0a578e79 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf4d0f8e610e84f709b3b861d0a578e79 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf4d0f8e610e84f709b3b861d0a578e79 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf4d0f8e610e84f709b3b861d0a578e79 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf4d0f8e610e84f709b3b861d0a578e79 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf4d0f8e610e84f709b3b861d0a578e79 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf4d0f8e610e84f709b3b861d0a578e79 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb7f55a6fae11463c88fdc2dae5390d15" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PC_VESSELS-INTPARTY_NAME">

		
		<asp:Label ID="lblPC_VESSELS_INTPARTY_NAME" runat="server" AssociatedControlID="PC_VESSELS__INTPARTY_NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PC_VESSELS__INTPARTY_NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPC_VESSELS_INTPARTY_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name"
					ClientValidationFunction="onValidate_PC_VESSELS__INTPARTY_NAME"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /Text -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-PC_VESSELS-INTPARTY_DATE">
		<asp:Label ID="lblPC_VESSELS_INTPARTY_DATE" runat="server" AssociatedControlID="PC_VESSELS__INTPARTY_DATE" 
			Text="Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="PC_VESSELS__INTPARTY_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calPC_VESSELS__INTPARTY_DATE" runat="server" LinkedControl="PC_VESSELS__INTPARTY_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valPC_VESSELS_INTPARTY_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date"
			ClientValidationFunction="onValidate_PC_VESSELS__INTPARTY_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-PC_VESSELS-INCEP_DATE">
		<asp:Label ID="lblPC_VESSELS_INCEP_DATE" runat="server" AssociatedControlID="PC_VESSELS__INCEP_DATE" 
			Text="Inception Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="PC_VESSELS__INCEP_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calPC_VESSELS__INCEP_DATE" runat="server" LinkedControl="PC_VESSELS__INCEP_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valPC_VESSELS_INCEP_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Inception Date"
			ClientValidationFunction="onValidate_PC_VESSELS__INCEP_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb7f55a6fae11463c88fdc2dae5390d15 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb7f55a6fae11463c88fdc2dae5390d15 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb7f55a6fae11463c88fdc2dae5390d15 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb7f55a6fae11463c88fdc2dae5390d15 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb7f55a6fae11463c88fdc2dae5390d15 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb7f55a6fae11463c88fdc2dae5390d15 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb7f55a6fae11463c88fdc2dae5390d15 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb7f55a6fae11463c88fdc2dae5390d15 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb7f55a6fae11463c88fdc2dae5390d15 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb7f55a6fae11463c88fdc2dae5390d15 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblPC_REFERRAL_CLAUSES_REFERRAL_CLAUSES" runat="server" AssociatedControlID="PC_REFERRAL_CLAUSES__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="PC_REFERRAL_CLAUSES__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="PC_REFERRAL_CLAUSES" 
		data-property-name="TOT_PREM" 
		id="pb-container-currency-PC_REFERRAL_CLAUSES-TOT_PREM">
		<asp:Label ID="lblPC_REFERRAL_CLAUSES_TOT_PREM" runat="server" AssociatedControlID="PC_REFERRAL_CLAUSES__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PC_REFERRAL_CLAUSES__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPC_REFERRAL_CLAUSES_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_PC_REFERRAL_CLAUSES__TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PC_REFERRAL_CLAUSES__PCENDPREM"
		data-field-type="Child" 
		data-object-name="PC_REFERRAL_CLAUSES" 
		data-property-name="PCENDPREM" 
		id="pb-container-childscreen-PC_REFERRAL_CLAUSES-PCENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PC_REFERRAL_CLAUSES__PC_CLAUSEPREM" runat="server" ScreenCode="PCENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PCENDPREM/PCENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valPC_REFERRAL_CLAUSES_PCENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for PC_REFERRAL_CLAUSES.PCENDPREM"
						ClientValidationFunction="onValidate_PC_REFERRAL_CLAUSES__PCENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7e900b69f6874e21b67a836197d5e265" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PC_NOTES__PCNOTES"
		data-field-type="Child" 
		data-object-name="PC_NOTES" 
		data-property-name="PCNOTES" 
		id="pb-container-childscreen-PC_NOTES-PCNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PC_NOTES__PC_CNOTE_DETAILS" runat="server" ScreenCode="PCNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PCNOTES/PCNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valPC_NOTES_PCNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for PC_NOTES.PCNOTES"
						ClientValidationFunction="onValidate_PC_NOTES__PCNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7e900b69f6874e21b67a836197d5e265 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7e900b69f6874e21b67a836197d5e265 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7e900b69f6874e21b67a836197d5e265 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7e900b69f6874e21b67a836197d5e265 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7e900b69f6874e21b67a836197d5e265 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7e900b69f6874e21b67a836197d5e265 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7e900b69f6874e21b67a836197d5e265 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7e900b69f6874e21b67a836197d5e265 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7e900b69f6874e21b67a836197d5e265 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7e900b69f6874e21b67a836197d5e265 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7dc6ebc734bd4270b23379d16a92cb9c" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PC_NOTES__PCSNOTES"
		data-field-type="Child" 
		data-object-name="PC_NOTES" 
		data-property-name="PCSNOTES" 
		id="pb-container-childscreen-PC_NOTES-PCSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PC_NOTES__PC_SCNOTE_DETAILS" runat="server" ScreenCode="PCSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PCSNOTES/PCSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valPC_NOTES_PCSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for PC_NOTES.PCSNOTES"
						ClientValidationFunction="onValidate_PC_NOTES__PCSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7dc6ebc734bd4270b23379d16a92cb9c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7dc6ebc734bd4270b23379d16a92cb9c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7dc6ebc734bd4270b23379d16a92cb9c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7dc6ebc734bd4270b23379d16a92cb9c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7dc6ebc734bd4270b23379d16a92cb9c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7dc6ebc734bd4270b23379d16a92cb9c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7dc6ebc734bd4270b23379d16a92cb9c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7dc6ebc734bd4270b23379d16a92cb9c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7dc6ebc734bd4270b23379d16a92cb9c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7dc6ebc734bd4270b23379d16a92cb9c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf222d0fff1ab48a0b9ee0c8b946017d8" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf222d0fff1ab48a0b9ee0c8b946017d8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf222d0fff1ab48a0b9ee0c8b946017d8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf222d0fff1ab48a0b9ee0c8b946017d8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf222d0fff1ab48a0b9ee0c8b946017d8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf222d0fff1ab48a0b9ee0c8b946017d8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf222d0fff1ab48a0b9ee0c8b946017d8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf222d0fff1ab48a0b9ee0c8b946017d8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf222d0fff1ab48a0b9ee0c8b946017d8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf222d0fff1ab48a0b9ee0c8b946017d8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf222d0fff1ab48a0b9ee0c8b946017d8 input{text-align:left;}"; break;
		}
	}
