<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PCENDPREM_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_PCENDPREM_Endorsement_Premium" %>
...
function onValidate_PC_CLAUSEPREM__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_CLAUSEPREM", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PC_CLAUSEPREM", "ENDORSE_ID");
        		}
...
function onValidate_PC_CLAUSEPREM__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_CLAUSEPREM", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PC_CLAUSEPREM", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_CLAUSEPREM.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "PC_CLAUSEPREM", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_CLAUSEPREM_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_CLAUSEPREM__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_CLAUSEPREM__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_PC_CLAUSEPREM__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_CLAUSEPREM", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PC_CLAUSEPREM", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=PC_CLAUSEPREM&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(PC_CLAUSEPREM.ENDORSE_DESC)"), 
...
function onValidate_PC_CLAUSEPREM__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_CLAUSEPREM", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PC_CLAUSEPREM", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PC_CLAUSEPREM.PREMIUM");
        			window.setControlWidth(field, "0.4", "PC_CLAUSEPREM", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPC_CLAUSEPREM_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_PC_CLAUSEPREM__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PC_CLAUSEPREM__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_PC_CLAUSEPREM__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_PC_CLAUSEPREM__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_PC_CLAUSEPREM__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_PC_CLAUSEPREM__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id5bea0a05814842ff80a128f7dddb2078" class="general-layout-container">
...
<div id="id1dd1266f40ec4700b1240e513718a554" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PC_CLAUSEPREM" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-PC_CLAUSEPREM-ENDORSE_ID">
		<asp:Label ID="lblPC_CLAUSEPREM_ENDORSE_ID" runat="server" AssociatedControlID="PC_CLAUSEPREM__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="PC_CLAUSEPREM__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valPC_CLAUSEPREM_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_PC_CLAUSEPREM__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PC_CLAUSEPREM-ENDORSE_DESC">
		<asp:Label ID="lblPC_CLAUSEPREM_ENDORSE_DESC" runat="server" AssociatedControlID="PC_CLAUSEPREM__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PC_CLAUSEPREM__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PC_CLAUSEPREM__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPC_CLAUSEPREM_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_PC_CLAUSEPREM__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PC_CLAUSEPREM-ENDORSE_CAP">

		
		<asp:Label ID="lblPC_CLAUSEPREM_ENDORSE_CAP" runat="server" AssociatedControlID="PC_CLAUSEPREM__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PC_CLAUSEPREM__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPC_CLAUSEPREM_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_PC_CLAUSEPREM__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PC_CLAUSEPREM-PREMIUM">
		<asp:Label ID="lblPC_CLAUSEPREM_PREMIUM" runat="server" AssociatedControlID="PC_CLAUSEPREM__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PC_CLAUSEPREM__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPC_CLAUSEPREM_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PC_CLAUSEPREM__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PC_CLAUSEPREM-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="PC_CLAUSEPREM__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1dd1266f40ec4700b1240e513718a554 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1dd1266f40ec4700b1240e513718a554 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1dd1266f40ec4700b1240e513718a554 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1dd1266f40ec4700b1240e513718a554 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1dd1266f40ec4700b1240e513718a554 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1dd1266f40ec4700b1240e513718a554 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1dd1266f40ec4700b1240e513718a554 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1dd1266f40ec4700b1240e513718a554 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1dd1266f40ec4700b1240e513718a554 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1dd1266f40ec4700b1240e513718a554 input{text-align:left;}"; break;
		}
	}
