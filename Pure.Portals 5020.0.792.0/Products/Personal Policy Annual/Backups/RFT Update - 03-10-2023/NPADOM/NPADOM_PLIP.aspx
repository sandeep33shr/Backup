<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="NPADOM_PLIP.aspx.vb" Inherits="Nexus.PB2_NPADOM_PLIP" %>
...
function onValidate_PLIP__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLIP", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("PLIP", "SUMINSURED");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PLIP&propertyName=SUMINSURED&name={name}");
        		
        		var value = new Expression("GENERAL.PLIP_SUMINSURED"), 
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPLIP_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_PLIP__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLIP__SUMINSURED_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLIP.SUMINSURED");
        			window.setControlWidth(field, "0.7", "PLIP", "SUMINSURED");
        		})();
        	}
        })();
        /**
...
function onValidate_PLIP__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLIP", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("PLIP", "PREMIUM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPLIP_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_PLIP__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLIP__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLIP.PREMIUM");
        			window.setControlWidth(field, "0.7", "PLIP", "PREMIUM");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    onValidate_PLIP__SUMINSURED(null, null, null, isOnLoad);
    onValidate_PLIP__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id25d1de162f884b90a3aa9999fe6486e6" class="general-layout-container">
...
<div id="id8edd401d15524fceab8eec26a54ca715" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PLIP" 
		data-property-name="SUMINSURED" 
		id="pb-container-currency-PLIP-SUMINSURED">
		<asp:Label ID="lblPLIP_SUMINSURED" runat="server" AssociatedControlID="PLIP__SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PLIP__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPLIP_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_PLIP__SUMINSURED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PLIP-PREMIUM">
		<asp:Label ID="lblPLIP_PREMIUM" runat="server" AssociatedControlID="PLIP__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PLIP__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPLIP_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PLIP__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- Button -->
     <asp:Button ID="btnPLIPCalculate" runat="server" Text="Calculate Premium" CssClass="btn btn-sm btn-primary" OnClientClick="clearCookieScrollPos()"/>
	<script type="text/javascript">
		if (window.rulesDisabled){
			document.getElementById('btnPLIPCalculate').style.display = "none";
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8edd401d15524fceab8eec26a54ca715 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8edd401d15524fceab8eec26a54ca715 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8edd401d15524fceab8eec26a54ca715 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8edd401d15524fceab8eec26a54ca715 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8edd401d15524fceab8eec26a54ca715 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8edd401d15524fceab8eec26a54ca715 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8edd401d15524fceab8eec26a54ca715 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8edd401d15524fceab8eec26a54ca715 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8edd401d15524fceab8eec26a54ca715 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8edd401d15524fceab8eec26a54ca715 input{text-align:left;}"; break;
		}
	}
