...
End Sub
        ...
        Protected Shadows Sub Page_Load_VehicleChangeCheck(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	If Session("VehChanged") = 1 Then
        		MOTOR__MAKE.Text = ""
        		MOTOR__MAKEMODEL.Text = ""
        		MOTOR__MMCODE.Text = ""
        		Session("VehChanged") = 0
        	End If
        End Sub
        ...
        Protected Shadows Sub Page_Load_ClientInfo(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		If MOTOR__QUOTE_DATE.Text = "" Or MOTOR__QUOTE_DATE.Text Is Nothing Then
        ...
        Protected Shadows Sub Page_Load_SICheck(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If Session("SIData") is Nothing Then
        		...
        		If VehicleTypeCode = "5" Then
        			If (MOTOR__VEH_VALUE.Text = "") Or (MOTOR__VEH_VALUE.Text = Nothing) Then ' Or (MOTOR__PREMIUM.Text = "") Or (MOTOR__PREMIUM.Text = Nothing) Then
        				Session("SIData") = -1
        			Else
        				Session("SIData") = MOTOR__VEH_VALUE.Text
        			End If
        		Else
        			If (MOTOR__TOT_SI.Text = "") Or (MOTOR__TOT_SI.Text = Nothing) Then ' Or (MOTOR__PREMIUM.Text = "") Or (MOTOR__PREMIUM.Text = Nothing) Then
        				Session("SIData") = -1
        			Else
        	...
        	If Session("InvalidSI") IsNot Nothing Then
        		If VehicleTypeCode = "5" Then
        			MOTOR__VEH_VALUE.Text = Session("InvalidSI")
        		Else
        			MOTOR__TOT_SI.Text = Session("InvalidSI")
        		End If
        	End If
        	If VehicleTypeCode = "5" Then
        		If (MOTOR__VEH_VALUE.Text = "") Or (MOTOR__VEH_VALUE.Text = Nothing) Then
        			Session("CurrentSI") = -2
        		Else
        			Session("CurrentSI") = MOTOR__VEH_VALUE.Text
        		End If
        	Else
        		If (MOTOR__TOT_SI.Text = "") Or (MOTOR__TOT_SI.Text = Nothing) Then
        			Session("CurrentSI") = -2
        		Else
        			Session("CurrentSI") = MOTOR__TOT_SI.Text
        		End If
        	End If
        ...
        Protected Sub btnBackTopSICheck_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBackTop.Click
        	...
        	If Not (CType(Session.Item(CNMode), Mode) = Mode.View Or CType(Session.Item(CNMode), Mode) = Mode.Review) Then
        		...
        		If Session("ValidSI") = 1 Then
        			If VehicleTypeCode = "5" Then
        				MOTOR__VEH_VALUE.Text = Session("SIData")
        			Else
        				MOTOR__TOT_SI.Text = Session("SIData")
        			End If
        		End If
        		Session("SIData") = Nothing
        	End If
        ...
        Private Sub SIValidator()
        	...
        	'Get the original SI
        	OriginalSI = CDbl(Session("SIData"))
        	
        	'Get the current SI
        	CurrentSI = CDbl(Session("CurrentSI"))
        	'If VehicleTypeCode = "5" Then
        ...
        Protected Sub CalculatePremiums()
        	...
        	If Session("ValidSI") = 1 Then
        		...
        		VehicleTypeCode = GetValue("MOTOR", "VEHTYPECODE")
        		If VehicleTypeCode = "5" Then
        			Session("InvalidSI") = MOTOR__VEH_VALUE.Text
        			MOTOR__VEH_VALUE.Text = Session("SIData")
        		Else
        			Session("InvalidSI") = MOTOR__TOT_SI.Text
        			MOTOR__TOT_SI.Text = Session("SIData")
        		End If
        	End If
