<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PCRAFTRISK_Notes.aspx.vb" Inherits="Nexus.PB2_PCRAFTRISK_Notes" %>
...
function onValidate_NOTES__PCNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "PCNOTES", "ChildScreen");
        })();
}
function onValidate_NOTES__PCEXTRN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "PCEXTRN", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__PCNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__PCEXTRN(null, null, null, isOnLoad);
}
</script>
...
<div id="idd4a25ebdacc74a7794e7c3c406f08636" class="general-layout-container">
...
<div id="idc860a67ef91048a0806a710fd5f01a69" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading19" runat="server" Text="Pleasure Craft Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__PCNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="PCNOTES" 
		id="pb-container-childscreen-NOTES-PCNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="PCNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_PCNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__PCNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc860a67ef91048a0806a710fd5f01a69 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc860a67ef91048a0806a710fd5f01a69 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc860a67ef91048a0806a710fd5f01a69 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc860a67ef91048a0806a710fd5f01a69 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc860a67ef91048a0806a710fd5f01a69 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc860a67ef91048a0806a710fd5f01a69 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc860a67ef91048a0806a710fd5f01a69 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc860a67ef91048a0806a710fd5f01a69 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc860a67ef91048a0806a710fd5f01a69 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc860a67ef91048a0806a710fd5f01a69 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id81f8cdff2e7a47e4b35e50d9e2997f2a" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__PCEXTRN"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="PCEXTRN" 
		id="pb-container-childscreen-NOTES-PCEXTRN">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__EXT_DETAILS" runat="server" ScreenCode="PCEXTRN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PCEXTRN/PCEXTRN_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_PCEXTRN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__PCEXTRN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id81f8cdff2e7a47e4b35e50d9e2997f2a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id81f8cdff2e7a47e4b35e50d9e2997f2a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id81f8cdff2e7a47e4b35e50d9e2997f2a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id81f8cdff2e7a47e4b35e50d9e2997f2a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id81f8cdff2e7a47e4b35e50d9e2997f2a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id81f8cdff2e7a47e4b35e50d9e2997f2a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id81f8cdff2e7a47e4b35e50d9e2997f2a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id81f8cdff2e7a47e4b35e50d9e2997f2a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id81f8cdff2e7a47e4b35e50d9e2997f2a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id81f8cdff2e7a47e4b35e50d9e2997f2a input{text-align:left;}"; break;
		}
	}
