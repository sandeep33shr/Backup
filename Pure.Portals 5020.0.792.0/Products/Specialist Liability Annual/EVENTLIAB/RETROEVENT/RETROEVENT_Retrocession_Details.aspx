<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="RETROEVENT_Retrocession_Details.aspx.vb" Inherits="Nexus.PB2_RETROEVENT_Retrocession_Details" %>
...
function onValidate_RETRO_DETAILS__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETRO_DETAILS", "NAME", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("RETRO_DETAILS", "NAME");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RETRO_DETAILS.NAME");
        			window.setControlWidth(field, "0.8", "RETRO_DETAILS", "NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRETRO_DETAILS_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_RETRO_DETAILS__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RETRO_DETAILS__NAME_lblFindParty");
        			    }
        			}
...
function DoLogic(isOnLoad) {
    onValidate_RETRO_DETAILS__NAME(null, null, null, isOnLoad);
}
</script>
...
<div id="id0606d167dd8a4042819b05f50e1c2703" class="general-layout-container">
...
<div id="id2d8b021853f5460ea6fc12da0d354dff" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Retrocession Participants" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="RETRO_DETAILS" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-RETRO_DETAILS-NAME">

		
		<asp:Label ID="lblRETRO_DETAILS_NAME" runat="server" AssociatedControlID="RETRO_DETAILS__NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="RETRO_DETAILS__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valRETRO_DETAILS_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name"
					ClientValidationFunction="onValidate_RETRO_DETAILS__NAME"
					ValidationGroup=""
					Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2d8b021853f5460ea6fc12da0d354dff div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2d8b021853f5460ea6fc12da0d354dff div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2d8b021853f5460ea6fc12da0d354dff div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2d8b021853f5460ea6fc12da0d354dff label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2d8b021853f5460ea6fc12da0d354dff label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2d8b021853f5460ea6fc12da0d354dff label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2d8b021853f5460ea6fc12da0d354dff label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2d8b021853f5460ea6fc12da0d354dff input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2d8b021853f5460ea6fc12da0d354dff input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2d8b021853f5460ea6fc12da0d354dff input{text-align:left;}"; break;
		}
	}
