...
<div id="idcdce6d10a6ad4c54991665e90d5f7a16" class="general-layout-container">
...
<div id="id84d1f7b92ab54c78bdc130b70cbaba60" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id84d1f7b92ab54c78bdc130b70cbaba60 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id84d1f7b92ab54c78bdc130b70cbaba60 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id84d1f7b92ab54c78bdc130b70cbaba60 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id84d1f7b92ab54c78bdc130b70cbaba60 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id84d1f7b92ab54c78bdc130b70cbaba60 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id84d1f7b92ab54c78bdc130b70cbaba60 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id84d1f7b92ab54c78bdc130b70cbaba60 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id84d1f7b92ab54c78bdc130b70cbaba60 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id84d1f7b92ab54c78bdc130b70cbaba60 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id84d1f7b92ab54c78bdc130b70cbaba60 input{text-align:left;}"; break;
		}
	}
