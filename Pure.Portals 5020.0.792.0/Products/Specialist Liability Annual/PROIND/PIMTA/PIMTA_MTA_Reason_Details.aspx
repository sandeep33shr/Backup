<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PIMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_PIMTA_MTA_Reason_Details" %>
...
<div id="idaf9fd54917bc4cafacb45a960aef0a04" class="general-layout-container">
...
<div id="id07d2a350f1684a5aaea3e29e059c7c47" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id07d2a350f1684a5aaea3e29e059c7c47 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id07d2a350f1684a5aaea3e29e059c7c47 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id07d2a350f1684a5aaea3e29e059c7c47 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id07d2a350f1684a5aaea3e29e059c7c47 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id07d2a350f1684a5aaea3e29e059c7c47 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id07d2a350f1684a5aaea3e29e059c7c47 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id07d2a350f1684a5aaea3e29e059c7c47 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id07d2a350f1684a5aaea3e29e059c7c47 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id07d2a350f1684a5aaea3e29e059c7c47 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id07d2a350f1684a5aaea3e29e059c7c47 input{text-align:left;}"; break;
		}
	}
