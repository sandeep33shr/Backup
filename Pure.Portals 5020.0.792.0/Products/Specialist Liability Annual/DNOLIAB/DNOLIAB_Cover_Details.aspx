<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DNOLIAB_Cover_Details.aspx.vb" Inherits="Nexus.PB2_DNOLIAB_Cover_Details" %>
...
function onValidate_GENERAL__MTAREASON(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "MTAREASON", "ChildScreen");
        })();
}
...
function onValidate_DNOLIAB__PRIMINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOLIAB", "PRIMINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DNOLIAB", "PRIMINDUSTRY");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblDNOLIAB_PRIMINDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_DNOLIAB__PRIMINDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_DNOLIAB__PRIMINDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DNOLIAB.PRIMINDUSTRY");
        			window.setControlWidth(field, "0.8", "DNOLIAB", "PRIMINDUSTRY");
        		})();
        	}
        })();
...
function onValidate_DNOLIAB__SCNDINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOLIAB", "SCNDINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DNOLIAB", "SCNDINDUSTRY");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblDNOLIAB_SCNDINDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_DNOLIAB__SCNDINDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_DNOLIAB__SCNDINDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DNOLIAB.SCNDINDUSTRY");
        			window.setControlWidth(field, "0.8", "DNOLIAB", "SCNDINDUSTRY");
        		})();
        	}
        })();
...
function onValidate_DNOLIAB__INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOLIAB", "INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DNOLIAB", "INDUSTRY");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblDNOLIAB_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_DNOLIAB__INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_DNOLIAB__INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DNOLIAB.INDUSTRY");
        			window.setControlWidth(field, "0.8", "DNOLIAB", "INDUSTRY");
        		})();
        	}
        })();
...
function onValidate_RETROCESSION__DRETRONOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETROCESSION", "DRETRONOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__MTAREASON(null, null, null, isOnLoad);
    ...
    onValidate_DNOLIAB__PRIMINDUSTRY(null, null, null, isOnLoad);
    onValidate_DNOLIAB__SCNDINDUSTRY(null, null, null, isOnLoad);
    onValidate_DNOLIAB__INDUSTRY(null, null, null, isOnLoad);
    onValidate_RETROCESSION__DRETRONOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id903a817d83884a4bb70a720f33d31f69" class="general-layout-container">
...
<div id="id055aa50370f24abf9766b334f87aa829" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Directors and Officers Liability" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id055aa50370f24abf9766b334f87aa829 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id055aa50370f24abf9766b334f87aa829 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id055aa50370f24abf9766b334f87aa829 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id055aa50370f24abf9766b334f87aa829 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id055aa50370f24abf9766b334f87aa829 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id055aa50370f24abf9766b334f87aa829 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id055aa50370f24abf9766b334f87aa829 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id055aa50370f24abf9766b334f87aa829 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id055aa50370f24abf9766b334f87aa829 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id055aa50370f24abf9766b334f87aa829 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__MTAREASON"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="MTAREASON" 
		id="pb-container-childscreen-GENERAL-MTAREASON">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="MTAREASON" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MTAREASON/MTAREASON_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_MTAREASON" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.MTAREASON"
						ClientValidationFunction="onValidate_GENERAL__MTAREASON" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id06b8013331d64d258e3e38b3317c4ebd" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id06b8013331d64d258e3e38b3317c4ebd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id06b8013331d64d258e3e38b3317c4ebd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id06b8013331d64d258e3e38b3317c4ebd div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#