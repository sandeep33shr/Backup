<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPECVBASIS_Specified_Vehicle_Basis.aspx.vb" Inherits="Nexus.PB2_SPECVBASIS_Specified_Vehicle_Basis" %>
...
function onValidate_SVBASIS__REGNUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SVBASIS", "REGNUM", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SVBASIS", "REGNUM");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSVBASIS_REGNUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_SVBASIS__REGNUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SVBASIS__REGNUM_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SVBASIS.REGNUM");
        			window.setControlWidth(field, "0.8", "SVBASIS", "REGNUM");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_SVBASIS__REGNUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id50db9ee1897f47d0b97ab691d8fe185e" class="general-layout-container">
...
<div id="idfce043b5b3354f81954fcb52b7bf504c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="Specified Vehicle Basis" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SVBASIS" 
		data-property-name="REGNUM" 
		 
		
		 
		id="pb-container-text-SVBASIS-REGNUM">

		
		<asp:Label ID="lblSVBASIS_REGNUM" runat="server" AssociatedControlID="SVBASIS__REGNUM" 
			Text="Registration Number" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SVBASIS__REGNUM" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSVBASIS_REGNUM" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Registration Number"
					ClientValidationFunction="onValidate_SVBASIS__REGNUM"
					ValidationGroup=""
					Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfce043b5b3354f81954fcb52b7bf504c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfce043b5b3354f81954fcb52b7bf504c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfce043b5b3354f81954fcb52b7bf504c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfce043b5b3354f81954fcb52b7bf504c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfce043b5b3354f81954fcb52b7bf504c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfce043b5b3354f81954fcb52b7bf504c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfce043b5b3354f81954fcb52b7bf504c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfce043b5b3354f81954fcb52b7bf504c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfce043b5b3354f81954fcb52b7bf504c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfce043b5b3354f81954fcb52b7bf504c input{text-align:left;}"; break;
		}
	}
