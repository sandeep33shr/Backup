<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENVGIT_Cover_Details.aspx.vb" Inherits="Nexus.PB2_ENVGIT_Cover_Details" %>
...
function onValidate_GENERAL__CHILD_COUNTER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHILD_COUNTER > 0 && GENERAL.TRANSTYPE =='MTA') || GENERAL.TRANSTYPE == 'NB'|| GENERAL.TRANSTYPE == 'REN'");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__GITMTAREAS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "GITMTAREAS", "ChildScreen");
        })();
}
...
function onValidate_RETROCESSION__RETROGIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETROCESSION", "RETROGIT", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__GITMTAREAS(null, null, null, isOnLoad);
    ...
    onValidate_RETROCESSION__RETROGIT(null, null, null, isOnLoad);
}
</script>
...
<div id="id06931642c8d843ebb9a657ebc4ccb501" class="general-layout-container">
...
<div id="ide9b4e66236bd47fab0a1a5c125773f96" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Environmental GIT Liability" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide9b4e66236bd47fab0a1a5c125773f96 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide9b4e66236bd47fab0a1a5c125773f96 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide9b4e66236bd47fab0a1a5c125773f96 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide9b4e66236bd47fab0a1a5c125773f96 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide9b4e66236bd47fab0a1a5c125773f96 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide9b4e66236bd47fab0a1a5c125773f96 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide9b4e66236bd47fab0a1a5c125773f96 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide9b4e66236bd47fab0a1a5c125773f96 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide9b4e66236bd47fab0a1a5c125773f96 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide9b4e66236bd47fab0a1a5c125773f96 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__GITMTAREAS"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="GITMTAREAS" 
		id="pb-container-childscreen-GENERAL-GITMTAREAS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="GITMTAREAS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GITMTAREAS/GITMTAREAS_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_GITMTAREAS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.GITMTAREAS"
						ClientValidationFunction="onValidate_GENERAL__GITMTAREAS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id278cf5e2ed01435cab5c7803c8e0fc22" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id278cf5e2ed01435cab5c7803c8e0fc22 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id278cf5e2ed01435cab5c7803c8e0fc22 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id278cf5e2ed01435cab5c7803c8e0fc22 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id278cf5e2ed01435cab5c7803c8e0fc22 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id278cf5e2ed01435cab5c7803c8e0fc22 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id278cf5e2ed01435cab5c7803c8e0fc22 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id278cf5e2ed01435cab5c7803c8e0fc22 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id278cf5e2ed01435cab5c7803c8e0fc22 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id278cf5e2ed01435cab5c7803c8e0fc22 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id278cf5e2ed01435cab5c7803c8e0fc22 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id401648e7eadc45a481c8485b1280daf5" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RETROCESSION__RETROGIT"
		data-field-type="Child" 
		data-object-name="RETROCESSION" 
		data-property-name="RETROGIT" 
		id="pb-container-childscreen-RETROCESSION-RETROGIT">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RETROCESSION__RETRO_DETAILS" runat="server" ScreenCode="RETROGIT" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RETROGIT/RETROGIT_Retrocession_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valRETROCESSION_RETROGIT" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RETROCESSION.RETROGIT"
						ClientValidationFunction="onValidate_RETROCESSION__RETROGIT" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id401648e7eadc45a481c8485b1280daf5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id401648e7eadc45a481c8485b1280daf5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id401648e7eadc45a481c8485b1280daf5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id401648e7eadc45a481c8485b1280daf5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id401648e7eadc45a481c8485b1280daf5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id401648e7eadc45a481c8485b1280daf5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id401648e7eadc45a481c8485b1280daf5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id401648e7eadc45a481c8485b1280daf5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id401648e7eadc45a481c8485b1280daf5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id401648e7eadc45a481c8485b1280daf5 input{text-align:left;}"; break;
		}
	}
