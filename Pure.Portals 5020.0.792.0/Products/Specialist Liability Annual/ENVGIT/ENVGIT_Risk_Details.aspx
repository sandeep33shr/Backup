        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "POLICYTYPE");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__POLICYTYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISK_DETAILS__POLICYTYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "POLICYCOVER");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__POLICYCOVER');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISK_DETAILS__POLICYCOVER_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_RISK_DETAILS__NUMVEHICLES(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "Code(RISK_DETAILS.POLICYTYPE) == 2", "R", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("No of Vehicles cannot be negative")) ? "No of Vehicles cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_RISK_DETAILS__RETROACTIVE_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_DETAILS.RETROACTIVE_DATE_EXPIRY == 0 and RISK_DETAILS.RETROACTIVE_DATE_INCEPTION == 0", "VE", "{3}");
...
function onValidate_RISK_DETAILS__RETRO_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_DETAILS.ADD_RETRO_DATE_INFO=1", "R", "{3}");
...
function onValidate_RISK_DETAILS__LIMIT_OF_INDEMNITY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Please enter the Limit of Indemnity";
...
function onValidate_RISK_DETAILS__BASISOFLIMIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Please select a Basis of Limit";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
...
function onValidate_RISK_DETAILS__BASE_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Please enter the Base rate";
        		var go = function(){
        			if (exp.getValue() == true){
        				field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        			} else {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Base Rate must be between 0 and 100")) ? "Base Rate must be between 0 and 100" : null;
        			args.IsValid = false;
        			if (message != null){
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "DEDUCT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__DEDUCT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISK_DETAILS__DEDUCT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "BASISDEDUCT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__BASISDEDUCT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISK_DETAILS__BASISDEDUCT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_INSIDE__BASE_DEDUCT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "INSIDE.INSIDE_NAM == 1", "R", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_INSIDE__BASE_DEDUCT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_INSIDE__BASE_DEDUCT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_INSIDE__DEDUCT(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_INSIDE__DEDUCT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_INSIDE__DEDUCT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("INSIDE.DEDUCT < RISK_DETAILS.LIMIT_OF_INDEMINITY || (RISK_DETAILS.DEDUCTIBLES == 0 || INSIDE.INSIDE_NAM == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Inside Namibia Deductible cannot be negative")) ? "Inside Namibia Deductible cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "INSIDE".toUpperCase() + "__" + "DEDUCT");
        				if (node == null){
...
function onValidate_OUTSIDE__BASE_DEDUCT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "OUTSIDE.OUTSIDE_NAM == 1", "R", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_OUTSIDE__BASE_DEDUCT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OUTSIDE__BASE_DEDUCT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_OUTSIDE__DEDUCT(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_OUTSIDE__DEDUCT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OUTSIDE__DEDUCT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("OUTSIDE.DEDUCT < RISK_DETAILS.LIMIT_OF_INDEMINITY || (RISK_DETAILS.DEDUCTIBLES == 0 || OUTSIDE.OUTSIDE_NAM == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Outside Namibia Deductible cannot be negative")) ? "Outside Namibia Deductible cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "OUTSIDE".toUpperCase() + "__" + "DEDUCT");
        				if (node == null){
...
<div id="id636f2f75fd974496ab7447aa1b884297" class="general-layout-container">
...
<div id="id25805ac001db4261adce6071d8b3a12a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id25805ac001db4261adce6071d8b3a12a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id25805ac001db4261adce6071d8b3a12a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id25805ac001db4261adce6071d8b3a12a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id25805ac001db4261adce6071d8b3a12a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id25805ac001db4261adce6071d8b3a12a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id25805ac001db4261adce6071d8b3a12a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id25805ac001db4261adce6071d8b3a12a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id25805ac001db4261adce6071d8b3a12a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id25805ac001db4261adce6071d8b3a12a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id25805ac001db4261adce6071d8b3a12a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id90beb1403be4439c9706f0d713ff9d20" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id90beb1403be4439c9706f0d713ff9d20 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id90beb1403be4439c9706f0d713ff9d20 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id90beb1403be4439c9706f0d713ff9d20 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id90beb1403be4439c9706f0d713ff9d20 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id90beb1403be4439c9706f0d713ff9d20 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id90beb1403be4439c9706f0d713ff9d20 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id90beb1403be4439c9706f0d713ff9d20 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id90beb1403be4439c9706f0d713ff9d20 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id90beb1403be4439c9706f0d713ff9d20 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id90beb1403be4439c9706f0d713ff9d20 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmSpecVehBasis" class="column-layout-container,no-border  ">
