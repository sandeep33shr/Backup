<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MEDREASON_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_MEDREASON_MTA_Reason_Details" %>
...
<div id="id6b13e7688b1643fe83cdadc42059c497" class="general-layout-container">
...
<div id="id97a5efbe348f45d0b0d2f12b76f4143d" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id97a5efbe348f45d0b0d2f12b76f4143d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id97a5efbe348f45d0b0d2f12b76f4143d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id97a5efbe348f45d0b0d2f12b76f4143d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id97a5efbe348f45d0b0d2f12b76f4143d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id97a5efbe348f45d0b0d2f12b76f4143d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id97a5efbe348f45d0b0d2f12b76f4143d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id97a5efbe348f45d0b0d2f12b76f4143d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id97a5efbe348f45d0b0d2f12b76f4143d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id97a5efbe348f45d0b0d2f12b76f4143d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id97a5efbe348f45d0b0d2f12b76f4143d input{text-align:left;}"; break;
		}
	}
