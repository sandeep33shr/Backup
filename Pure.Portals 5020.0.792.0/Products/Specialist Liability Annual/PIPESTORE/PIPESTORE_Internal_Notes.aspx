<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PIPESTORE_Internal_Notes.aspx.vb" Inherits="Nexus.PB2_PIPESTORE_Internal_Notes" %>
...
<div id="id0541927526c848d9a1b4274e19aa6eb1" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Environmental - Pipelines and Storage Notes" /></legend>
		    ...
		    <legend>Notes</legend>
			        ...
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="PIPENOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PIPENOTES/PIPENOTES_Notes.aspx" emptydatatext="sac">
							<columns>
