...
function onValidate_GENERAL__CHILD_COUNTER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHILD_COUNTER > 0 && GENERAL.TRANSTYPE =='MTA' ) || GENERAL.TRANSTYPE =='NB'");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INDUSTRY", "PRIMARY_INDUSTRY");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("INDUSTRY.PRIMARY_INDUSTRY");
        			window.setControlWidth(field, "0.8", "INDUSTRY", "PRIMARY_INDUSTRY");
        		})();
        	}
        })();
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INDUSTRY", "SECONDARY_INDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("INDUSTRY.SECONDARY_INDUSTRY");
        			window.setControlWidth(field, "0.8", "INDUSTRY", "SECONDARY_INDUSTRY");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("INDUSTRY.INDUSTRY");
        			window.setControlWidth(field, "0.8", "INDUSTRY", "INDUSTRY");
        		})();
        	}
        })();
...
<div id="idae485bce783d49c98d92a0a8ec6350c0" class="general-layout-container">
...
<div id="idc6f6d61b46df43faa07ccf1cd663702e" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc6f6d61b46df43faa07ccf1cd663702e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc6f6d61b46df43faa07ccf1cd663702e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc6f6d61b46df43faa07ccf1cd663702e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc6f6d61b46df43faa07ccf1cd663702e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc6f6d61b46df43faa07ccf1cd663702e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc6f6d61b46df43faa07ccf1cd663702e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc6f6d61b46df43faa07ccf1cd663702e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc6f6d61b46df43faa07ccf1cd663702e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc6f6d61b46df43faa07ccf1cd663702e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc6f6d61b46df43faa07ccf1cd663702e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida669ebae6d5647a7bbb1e1899836255a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida669ebae6d5647a7bbb1e1899836255a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida669ebae6d5647a7bbb1e1899836255a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida669ebae6d5647a7bbb1e1899836255a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida669ebae6d5647a7bbb1e1899836255a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida669ebae6d5647a7bbb1e1899836255a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida669ebae6d5647a7bbb1e1899836255a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida669ebae6d5647a7bbb1e1899836255a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida669ebae6d5647a7bbb1e1899836255a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida669ebae6d5647a7bbb1e1899836255a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida669ebae6d5647a7bbb1e1899836255a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id66a69fa65fb1475fbd3fba9d3e76c650" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id66a69fa65fb1475fbd3fba9d3e76c650 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id66a69fa65fb1475fbd3fba9d3e76c650 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id66a69fa65fb1475fbd3fba9d3e76c650 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id66a69fa65fb1475fbd3fba9d3e76c650 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id66a69fa65fb1475fbd3fba9d3e76c650 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id66a69fa65fb1475fbd3fba9d3e76c650 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id66a69fa65fb1475fbd3fba9d3e76c650 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id66a69fa65fb1475fbd3fba9d3e76c650 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id66a69fa65fb1475fbd3fba9d3e76c650 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id66a69fa65fb1475fbd3fba9d3e76c650 input{text-align:left;}"; break;
		}
	}
