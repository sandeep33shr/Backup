        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "TYPE_OF_COVER");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__TYPE_OF_COVER');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISK_DETAILS__TYPE_OF_COVER_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "AGGREGATE_LIMIT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Aggregate Limit cannot be negative")) ? "Aggregate Limit cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_RISK_DETAILS__RETRO_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_DETAILS.IS_RETRO_DATE_EXPIRY == false and RISK_DETAILS.IS_RETRO_DATE_INCEPTION == false", "VE", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__RETRO_DATE_INFO');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISK_DETAILS__RETRO_DATE_INFO_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
<div id="ide3c0986ec3374d05afb294535c325683" class="general-layout-container">
...
<div id="idf5aa50e685bd4f65ad8994ed95ea508e" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf5aa50e685bd4f65ad8994ed95ea508e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf5aa50e685bd4f65ad8994ed95ea508e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf5aa50e685bd4f65ad8994ed95ea508e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf5aa50e685bd4f65ad8994ed95ea508e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf5aa50e685bd4f65ad8994ed95ea508e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf5aa50e685bd4f65ad8994ed95ea508e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf5aa50e685bd4f65ad8994ed95ea508e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf5aa50e685bd4f65ad8994ed95ea508e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf5aa50e685bd4f65ad8994ed95ea508e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf5aa50e685bd4f65ad8994ed95ea508e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmRiskDets" class="column-layout-container,no-border  ">
