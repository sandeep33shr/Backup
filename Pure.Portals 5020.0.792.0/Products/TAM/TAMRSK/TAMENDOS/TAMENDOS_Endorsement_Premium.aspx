...
function onValidate_TAMRSK_END__ENDORSE_CAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK_END.ENDORSE_CAP");
        			window.setControlWidth(field, "0.5", "TAMRSK_END", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
...
function onValidate_TAMRSK_END__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK_END.PREMIUM");
        			window.setControlWidth(field, "0.5", "TAMRSK_END", "PREMIUM");
        		})();
        	}
        })();
        /**
...
<div id="id57c385ddc7524f51b32cd8677f13301b" class="general-layout-container">
...
<div id="idb1842d98ba194adaa74ae2f6f80dbea2" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb1842d98ba194adaa74ae2f6f80dbea2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb1842d98ba194adaa74ae2f6f80dbea2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb1842d98ba194adaa74ae2f6f80dbea2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb1842d98ba194adaa74ae2f6f80dbea2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb1842d98ba194adaa74ae2f6f80dbea2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb1842d98ba194adaa74ae2f6f80dbea2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb1842d98ba194adaa74ae2f6f80dbea2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb1842d98ba194adaa74ae2f6f80dbea2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb1842d98ba194adaa74ae2f6f80dbea2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb1842d98ba194adaa74ae2f6f80dbea2 input{text-align:left;}"; break;
		}
	}
