...
function onValidate_TAM_END__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_END", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TAM_END", "ENDORSE_ID");
        		}
...
function onValidate_TAM_END__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_END", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TAM_END", "ENDORSE_DESC");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAM_END_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAM_END__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAM_END__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_TAM_END__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_END", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TAM_END", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=TAM_END&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(TAM_END.ENDORSE_DESC)"), 
...
function onValidate_TAM_END__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_END", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TAM_END", "PREMIUM");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAM_END_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAM_END__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAM_END__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_TAM_END__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_TAM_END__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_TAM_END__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_TAM_END__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id55083c1b64484ccda966d0583f2f5dc4" class="general-layout-container">
...
<div id="ida69a35e274bc45d69eadb3b2078c8d6a" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TAM_END" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-TAM_END-ENDORSE_ID">
		<asp:Label ID="lblTAM_END_ENDORSE_ID" runat="server" AssociatedControlID="TAM_END__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="TAM_END__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valTAM_END_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_TAM_END__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-TAM_END-ENDORSE_DESC">
		<asp:Label ID="lblTAM_END_ENDORSE_DESC" runat="server" AssociatedControlID="TAM_END__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="TAM_END__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_TAM_END__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valTAM_END_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_TAM_END__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAM_END-ENDORSE_CAP">

		
		<asp:Label ID="lblTAM_END_ENDORSE_CAP" runat="server" AssociatedControlID="TAM_END__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAM_END__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAM_END_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_TAM_END__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TAM_END-PREMIUM">
		<asp:Label ID="lblTAM_END_PREMIUM" runat="server" AssociatedControlID="TAM_END__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TAM_END__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTAM_END_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_TAM_END__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida69a35e274bc45d69eadb3b2078c8d6a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida69a35e274bc45d69eadb3b2078c8d6a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida69a35e274bc45d69eadb3b2078c8d6a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida69a35e274bc45d69eadb3b2078c8d6a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida69a35e274bc45d69eadb3b2078c8d6a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida69a35e274bc45d69eadb3b2078c8d6a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida69a35e274bc45d69eadb3b2078c8d6a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida69a35e274bc45d69eadb3b2078c8d6a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida69a35e274bc45d69eadb3b2078c8d6a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida69a35e274bc45d69eadb3b2078c8d6a input{text-align:left;}"; break;
		}
	}
