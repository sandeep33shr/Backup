...
function onValidate_TAM_ELSNOTES_DETAILS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_ELSNOTES_DETAILS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAM_ELSNOTES_DETAILS", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("TAM_ELSNOTES_DETAILS", "DATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=TAM_ELSNOTES_DETAILS&propertyName=DATE_CREATED&name={name}");
...
function onValidate_TAM_ELSNOTES_DETAILS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_ELSNOTES_DETAILS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAM_ELSNOTES_DETAILS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("TAM_ELSNOTES_DETAILS", "CREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_TAM_ELSNOTES_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_ELSNOTES_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAM_ELSNOTES_DETAILS", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("TAM_ELSNOTES_DETAILS", "COVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=TAM_ELSNOTES_DETAILS&propertyName=COVER_TYPE&name={name}");
...
function onValidate_TAM_ELSNOTES_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_ELSNOTES_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAM_ELSNOTES_DETAILS", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("TAM_ELSNOTES_DETAILS", "NOTE_DESCRIPTION");
...
function onValidate_TAM_ELSNOTES_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAM_ELSNOTES_DETAILS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAM_ELSNOTES_DETAILS", "NOTE_DETAILS");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("TAM_ELSNOTES_DETAILS", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=TAM_ELSNOTES_DETAILS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_TAM_ELSNOTES_DETAILS__NOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_TAM_ELSNOTES_DETAILS_NOTE_DETAILS_textarea');
        			if (textarea != null){
...
function DoLogic(isOnLoad) {
    onValidate_TAM_ELSNOTES_DETAILS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_TAM_ELSNOTES_DETAILS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_TAM_ELSNOTES_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_TAM_ELSNOTES_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_TAM_ELSNOTES_DETAILS__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="iddff69913b37c4fbea044fc7fc8f666ee" class="general-layout-container">
...
<div id="id663d0564a49146478318f41f1d818e89" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TAM_ELSNOTES_DETAILS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-TAM_ELSNOTES_DETAILS-DATE_CREATED">
		<asp:Label ID="lblTAM_ELSNOTES_DETAILS_DATE_CREATED" runat="server" AssociatedControlID="TAM_ELSNOTES_DETAILS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TAM_ELSNOTES_DETAILS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTAM_ELSNOTES_DETAILS__DATE_CREATED" runat="server" LinkedControl="TAM_ELSNOTES_DETAILS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTAM_ELSNOTES_DETAILS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_TAM_ELSNOTES_DETAILS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAM_ELSNOTES_DETAILS-CREATED_BY">

		
		<asp:Label ID="lblTAM_ELSNOTES_DETAILS_CREATED_BY" runat="server" AssociatedControlID="TAM_ELSNOTES_DETAILS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAM_ELSNOTES_DETAILS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAM_ELSNOTES_DETAILS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_TAM_ELSNOTES_DETAILS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAM_ELSNOTES_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblTAM_ELSNOTES_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="TAM_ELSNOTES_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAM_ELSNOTES_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAM_ELSNOTES_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_TAM_ELSNOTES_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAM_ELSNOTES_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblTAM_ELSNOTES_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="TAM_ELSNOTES_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAM_ELSNOTES_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAM_ELSNOTES_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_TAM_ELSNOTES_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-TAM_ELSNOTES_DETAILS-NOTE_DETAILS">
		<asp:Label ID="lblTAM_ELSNOTES_DETAILS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="TAM_ELSNOTES_DETAILS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="TAM_ELSNOTES_DETAILS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valTAM_ELSNOTES_DETAILS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_TAM_ELSNOTES_DETAILS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id663d0564a49146478318f41f1d818e89 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id663d0564a49146478318f41f1d818e89 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id663d0564a49146478318f41f1d818e89 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id663d0564a49146478318f41f1d818e89 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id663d0564a49146478318f41f1d818e89 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id663d0564a49146478318f41f1d818e89 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id663d0564a49146478318f41f1d818e89 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id663d0564a49146478318f41f1d818e89 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id663d0564a49146478318f41f1d818e89 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id663d0564a49146478318f41f1d818e89 input{text-align:left;}"; break;
		}
	}
