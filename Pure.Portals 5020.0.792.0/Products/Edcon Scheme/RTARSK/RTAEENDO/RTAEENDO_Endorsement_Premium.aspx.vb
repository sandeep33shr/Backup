...
Namespace Nexus
    Partial Class PB2_RTAEENDO_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_RTA_ENDORSE__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RTA_ENDORSE__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'RTARSK - Standard Wording Parent Object
        'REFERRAL_CLAUSES - Standard Wording Parent Property
        'RTA_ENDORSE - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/RTARSK/SW.REFERRAL_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("RTA_ENDORSE__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/RTARSK/RTA_ENDORSE")
        
        	Dim CurrentSelected As String = RTA_ENDORSE__ENDORSE_CAP.Text
