<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="RTARSK_Edcon_Scheme.aspx.vb" Inherits="Nexus.PB2_RTARSK_Edcon_Scheme" %>
...
function onValidate_GENERAL__RTARSKMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "RTARSKMTA", "ChildScreen");
        })();
}
function onValidate_RTARSK__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RTARSK", "DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RTARSK.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "RTARSK", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRTARSK_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_RTARSK__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RTARSK__DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_RTARSK__PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RTARSK", "PREM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RTARSK.PREM");
        			window.setControlWidth(field, "0.8", "RTARSK", "PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRTARSK_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_RTARSK__PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RTARSK__PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_RTARSK__ENDORSE_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "ENDORSE_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RTARSK", "ENDORSE_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RTARSK.ENDORSE_PREMIUM");
        			window.setControlWidth(field, "0.3", "RTARSK", "ENDORSE_PREMIUM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRTARSK_ENDORSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_RTARSK__ENDORSE_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RTARSK__ENDORSE_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
         ...
         /**
          * @fileoverview GetColumn
          * @param RTARSK The Parent (Root) object name.
          * @param RTA_ENDORSE.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RTARSK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "RTA_ENDORSE.PREMIUM";
        		//count, average, total, min, max
...
function onValidate_RTARSK__RTAEENDO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "RTAEENDO", "ChildScreen");
        })();
}
function onValidate_RTARSK__RTAENOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "RTAENOTES", "ChildScreen");
        })();
}
function onValidate_RTARSK__RTAESNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "RTAESNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__RTARSKMTA(null, null, null, isOnLoad);
    onValidate_RTARSK__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_RTARSK__PREM(null, null, null, isOnLoad);
    onValidate_RTARSK__ENDORSE_PREMIUM(null, null, null, isOnLoad);
    onValidate_RTARSK__RTAEENDO(null, null, null, isOnLoad);
    onValidate_RTARSK__RTAENOTES(null, null, null, isOnLoad);
    onValidate_RTARSK__RTAESNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="idf2b13b58bf704d50900ba964e5fec292" class="general-layout-container">
...
<div id="idc3ffbacdb4794b12afef4fa59b92935c" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc3ffbacdb4794b12afef4fa59b92935c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc3ffbacdb4794b12afef4fa59b92935c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc3ffbacdb4794b12afef4fa59b92935c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc3ffbacdb4794b12afef4fa59b92935c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc3ffbacdb4794b12afef4fa59b92935c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc3ffbacdb4794b12afef4fa59b92935c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc3ffbacdb4794b12afef4fa59b92935c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc3ffbacdb4794b12afef4fa59b92935c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc3ffbacdb4794b12afef4fa59b92935c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc3ffbacdb4794b12afef4fa59b92935c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id87f04e6f0b074463ad7df012d8aa208c" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id87f04e6f0b074463ad7df012d8aa208c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id87f04e6f0b074463ad7df012d8aa208c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id87f04e6f0b074463ad7df012d8aa208c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id87f04e6f0b074463ad7df012d8aa208c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id87f04e6f0b074463ad7df012d8aa208c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id87f04e6f0b074463ad7df012d8aa208c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id87f04e6f0b074463ad7df012d8aa208c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id87f04e6f0b074463ad7df012d8aa208c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id87f04e6f0b074463ad7df012d8aa208c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id87f04e6f0b074463ad7df012d8aa208c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id838f4528067d47b58e75b6dc34f33fbc" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id838f4528067d47b58e75b6dc34f33fbc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id838f4528067d47b58e75b6dc34f33fbc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id838f4528067d47b58e75b6dc34f33fbc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id838f4528067d47b58e75b6dc34f33fbc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id838f4528067d47b58e75b6dc34f33fbc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id838f4528067d47b58e75b6dc34f33fbc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id838f4528067d47b58e75b6dc34f33fbc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id838f4528067d47b58e75b6dc34f33fbc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id838f4528067d47b58e75b6dc34f33fbc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id838f4528067d47b58e75b6dc34f33fbc input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__RTARSKMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="RTARSKMTA" 
		id="pb-container-childscreen-GENERAL-RTARSKMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="RTARSKMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RTARSKMTA/RTARSKMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_RTARSKMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.RTARSKMTA"
						ClientValidationFunction="onValidate_GENERAL__RTARSKMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id189902ea378c4da08db0ea41377a0265" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-RTARSK-DESCRIPTION">

		
		<asp:Label ID="lblRTARSK_DESCRIPTION" runat="server" AssociatedControlID="RTARSK__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="RTARSK__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valRTARSK_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_RTARSK__DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-RTARSK-PREM">
		<asp:Label ID="lblRTARSK_PREM" runat="server" AssociatedControlID="RTARSK__PREM" 
			Text="Premium " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RTARSK__PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRTARSK_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium "
			ClientValidationFunction="onValidate_RTARSK__PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id189902ea378c4da08db0ea41377a0265 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id189902ea378c4da08db0ea41377a0265 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id189902ea378c4da08db0ea41377a0265 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id189902ea378c4da08db0ea41377a0265 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id189902ea378c4da08db0ea41377a0265 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id189902ea378c4da08db0ea41377a0265 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id189902ea378c4da08db0ea41377a0265 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id189902ea378c4da08db0ea41377a0265 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id189902ea378c4da08db0ea41377a0265 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id189902ea378c4da08db0ea41377a0265 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblRTARSK_REFERRAL_CLAUSES" runat="server" AssociatedControlID="RTARSK__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="RTARSK__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-RTARSK-ENDORSE_PREMIUM">
		<asp:Label ID="lblRTARSK_ENDORSE_PREMIUM" runat="server" AssociatedControlID="RTARSK__ENDORSE_PREMIUM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RTARSK__ENDORSE_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRTARSK_ENDORSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_RTARSK__ENDORSE_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RTARSK__RTAEENDO"
		data-field-type="Child" 
		data-object-name="RTARSK" 
		data-property-name="RTAEENDO" 
		id="pb-container-childscreen-RTARSK-RTAEENDO">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RTARSK__RTA_ENDORSE" runat="server" ScreenCode="RTAEENDO" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RTAEENDO/RTAEENDO_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valRTARSK_RTAEENDO" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RTARSK.RTAEENDO"
						ClientValidationFunction="onValidate_RTARSK__RTAEENDO" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RTARSK__RTAENOTES"
		data-field-type="Child" 
		data-object-name="RTARSK" 
		data-property-name="RTAENOTES" 
		id="pb-container-childscreen-RTARSK-RTAENOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RTARSK__CNOTE_DETAILS" runat="server" ScreenCode="RTAENOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RTAENOTES/RTAENOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valRTARSK_RTAENOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RTARSK.RTAENOTES"
						ClientValidationFunction="onValidate_RTARSK__RTAENOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RTARSK__RTAESNOTES"
		data-field-type="Child" 
		data-object-name="RTARSK" 
		data-property-name="RTAESNOTES" 
		id="pb-container-childscreen-RTARSK-RTAESNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RTARSK__SNOTE_DETAILS" runat="server" ScreenCode="RTAESNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RTAESNOTES/RTAESNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created By" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valRTARSK_RTAESNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RTARSK.RTAESNOTES"
						ClientValidationFunction="onValidate_RTARSK__RTAESNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
