<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FRSTCAPRSK_Risk_Details.aspx.vb" Inherits="Nexus.PB2_FRSTCAPRSK_Risk_Details" %>
...
function onValidate_FIRSTCAP__CONSTRUCT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Construction is mandatory and an option must be selected";
...
function onValidate_FIRSTCAP__RESIDENCE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Residence is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
...
function onValidate_FIRSTCAP__OCCUPANCY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Occupancy is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
...
function onValidate_FIRSTCAP__LOCALITY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Locality is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
...
function onValidate_FIRSTCAP__SECURITY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Security is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
...
function onValidate_FIRSTCAP__DATEOFBIRTH(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FIRSTCAP".toUpperCase() + "__" + "DATEOFBIRTH");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FIRSTCAP".toUpperCase() + "_" + "DATEOFBIRTH");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(FIRSTCAP.DATEOFBIRTH<NOW())");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	var helpText = goog.string.unescapeEntities("Date of birth must not be present or in the future");
        	
        	// Get the field
        	var field = Field.getWithQuery("type=Date&objectName=FIRSTCAP&propertyName=DATEOFBIRTH&name={name}");
...
function onValidate_FIRSTCAP__SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FIRSTCAP".toUpperCase() + "__" + "SUMINSURED");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FIRSTCAP".toUpperCase() + "_" + "SUMINSURED");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("FIRSTCAP.SUMINSURED>0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (()=>{
                ...
                $('#<%= FIRSTCAP__SUMINSURED.ClientID %>').bind("keypress",function(e){
...
function onValidate_FIRSTCAP__STD_EXCESS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=FIRSTCAP&propertyName=STD_EXCESS&name={name}");
        		
        		var value = new Expression("500"), 
        			condition = (Expression.isValidParameter("FIRSTCAP.STD_EXCESS < 500")) ? new Expression("FIRSTCAP.STD_EXCESS < 500") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_FIRSTCAP__LD_PERCENT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIRSTCAP", "LD_PERCENT", "List");
        })();
        /**
         * @fileoverview
         * RequiredWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIRSTCAP", "LD_PERCENT");
        		var exp = new Expression("FIRSTCAP.LD_AMOUNT > 0 AND FIRSTCAP.LDREASON <> ''");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIRSTCAP.LD_PERCENT");
        			window.setControlWidth(field, "0.8", "FIRSTCAP", "LD_PERCENT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFIRSTCAP_LD_PERCENT");
        			    var ele = document.getElementById('ctl00_cntMainBody_FIRSTCAP__LD_PERCENT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FIRSTCAP__LD_PERCENT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        $(document).ready(function() {
        	...
        	var List = Field.getInstance("FIRSTCAP", "TYPEBOAT");
        	var thisField = Field.getInstance("FIRSTCAP","LD_PERCENT");
...
function onValidate_FIRSTCAP__INDICATORCDE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIRSTCAP", "INDICATORCDE", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FIRSTCAP", "INDICATORCDE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=FIRSTCAP&propertyName=INDICATORCDE&name={name}");
        		
        		var value = new Expression("Code(FIRSTCAP.LD_PERCENT)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_FIRSTCAP__LD_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIRSTCAP", "LD_AMOUNT", "Percentage");
        })();
        /**
         * @fileoverview
         * RequiredWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIRSTCAP", "LD_AMOUNT");
        		var exp = new Expression("FIRSTCAP.LD_PERCENT <> '' AND FIRSTCAP.LDREASON <> ''");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIRSTCAP.LD_AMOUNT");
        			window.setControlWidth(field, "0.8", "FIRSTCAP", "LD_AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFIRSTCAP_LD_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_FIRSTCAP__LD_AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FIRSTCAP__LD_AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        $(document).ready(function() {
        	...
        	var List = Field.getInstance("FIRSTCAP", "LD_PERCENT");
        	var thisField = Field.getInstance("FIRSTCAP","LD_AMOUNT");
        ...
        (()=>{
                ...
                $('#<%= FIRSTCAP__LD_AMOUNT.ClientID %>').bind("keypress",function(e){
...
function onValidate_FIRSTCAP__LDREASON(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIRSTCAP", "LDREASON", "List");
        })();
        /**
         * @fileoverview
         * RequiredWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIRSTCAP", "LDREASON");
        		var exp = new Expression("FIRSTCAP.LD_PERCENT <> '' AND FIRSTCAP.LD_AMOUNT > 0");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIRSTCAP.LDREASON");
        			window.setControlWidth(field, "0.8", "FIRSTCAP", "LDREASON");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFIRSTCAP_LDREASON");
        			    var ele = document.getElementById('ctl00_cntMainBody_FIRSTCAP__LDREASON');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FIRSTCAP__LDREASON_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        $(document).ready(function() {
        	...
        	var List = Field.getInstance("FIRSTCAP", "LD_PERCENT");
        	var thisField = Field.getInstance("FIRSTCAP","LDREASON");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FIRSTCAP".toUpperCase() + "__" + "LDREASON");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FIRSTCAP".toUpperCase() + "_" + "LDREASON");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(PFIRSTCAP.LD_PERCENT <> '' AND FIRSTCAP.LD_AMOUNT> 0 AND FIRSTCAP.LDREASON<>'')OR(FIRSTCAP.LD_PERCENT== '' AND FIRSTCAP.LD_AMOUNT== null AND FIRSTCAP.LDREASON =='') OR ((FIRSTCAP.LD_PERCENT<> '' AND FIRSTCAP. LD_AMOUNT > 0)OR (FIRSTCAP. LD_AMOUNT> 0 AND FIRSTCAP. LDREASON <> '') OR (FIRSTCAP.LD_PERCENT <> '' AND FIRSTCAP. LDREASON <> ''))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_FIRSTCAP__NAME(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "FIRSTCAP.INCEPTION_DATE != null", "VE", "Interest Party name is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "FIRSTCAP.INCEPTION_DATE != null",
            paramElseValue = "VE",
...
function onValidate_FIRSTCAP__INCEPTION_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "FIRSTCAP.NAME != ''", "VE", "Interest Party date is mandatory and date must be entered or date format is invalid");
        
            var paramValue = "VEM",
            paramCondition = "FIRSTCAP.NAME != ''",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FIRSTCAP".toUpperCase() + "__" + "INCEPTION_DATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FIRSTCAP".toUpperCase() + "_" + "INCEPTION_DATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(FIRSTCAP.INCEPTION_DATE>=GENERAL.QUOTEDATE) || (FIRSTCAP.INCEPTION_DATE= null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_FIRSTCAP__TOT_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIRSTCAP", "TOT_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIRSTCAP", "TOT_PREMIUM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIRSTCAP.TOT_PREMIUM");
        			window.setControlWidth(field, "0.8", "FIRSTCAP", "TOT_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFIRSTCAP_TOT_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_FIRSTCAP__TOT_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FIRSTCAP__TOT_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        $(document).ready(function() {
        	...
        	var List = Field.getInstance("FIRSTCAP", "SUMINSURED");
        	var thisField = Field.getInstance("FIRSTCAP","TOT_PREMIUM");
		...
		$(document).ready(function() {
        	...
        	var List = Field.getInstance("FIRSTCAP", "RESIDENCE");
        	var thisField = Field.getInstance("FIRSTCAP","TOT_PREMIUM");
		...
		$(document).ready(function() {
        	...
        	var List = Field.getInstance("FIRSTCAP", "CONSTRUCT");
        	var thisField = Field.getInstance("FIRSTCAP","TOT_PREMIUM");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_FIRSTCAP__LD_PERCENT(null, null, null, isOnLoad);
    onValidate_FIRSTCAP__INDICATORCDE(null, null, null, isOnLoad);
    onValidate_FIRSTCAP__LD_AMOUNT(null, null, null, isOnLoad);
    onValidate_FIRSTCAP__LDREASON(null, null, null, isOnLoad);
    ...
    onValidate_FIRSTCAP__TOT_PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idfda1062a9a914eb891be1bd72901b384" class="general-layout-container">
...
<div id="iddf7e221de77e42b18ed97a30ec281e82" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddf7e221de77e42b18ed97a30ec281e82 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddf7e221de77e42b18ed97a30ec281e82 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddf7e221de77e42b18ed97a30ec281e82 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddf7e221de77e42b18ed97a30ec281e82 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddf7e221de77e42b18ed97a30ec281e82 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddf7e221de77e42b18ed97a30ec281e82 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddf7e221de77e42b18ed97a30ec281e82 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddf7e221de77e42b18ed97a30ec281e82 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddf7e221de77e42b18ed97a30ec281e82 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddf7e221de77e42b18ed97a30ec281e82 input{text-align:left;}"; break;
		}
	}
...
<div id="frmLoad" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading8" runat="server" Text="Loadings/Discounts" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="FIRSTCAP" 
		data-property-name="LD_PERCENT" 
		id="pb-container-list-FIRSTCAP-LD_PERCENT">
		<asp:Label ID="lblFIRSTCAP_LD_PERCENT" runat="server" AssociatedControlID="FIRSTCAP__LD_PERCENT" 
			Text="Indicator" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="FIRSTCAP__LD_PERCENT" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_LOADDIND" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_FIRSTCAP__LD_PERCENT(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valFIRSTCAP_LD_PERCENT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Indicator"
			ClientValidationFunction="onValidate_FIRSTCAP__LD_PERCENT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIRSTCAP-INDICATORCDE">

		
		<asp:Label ID="lblFIRSTCAP_INDICATORCDE" runat="server" AssociatedControlID="FIRSTCAP__INDICATORCDE" 
			Text="Indicator Code" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIRSTCAP__INDICATORCDE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIRSTCAP_INDICATORCDE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Indicator Code"
					ClientValidationFunction="onValidate_FIRSTCAP__INDICATORCDE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FIRSTCAP" 
		data-property-name="LD_AMOUNT" 
		id="pb-container-percentage-FIRSTCAP-LD_AMOUNT">
		<asp:Label ID="lblFIRSTCAP_LD_AMOUNT" runat="server" AssociatedControlID="FIRSTCAP__LD_AMOUNT" 
			Text="Percentage" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FIRSTCAP__LD_AMOUNT" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFIRSTCAP_LD_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Percentage"
			ClientValidationFunction="onValidate_FIRSTCAP__LD_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="FIRSTCAP" 
		data-property-name="LDREASON" 
		id="pb-container-list-FIRSTCAP-LDREASON">
		<asp:Label ID="lblFIRSTCAP_LDREASON" runat="server" AssociatedControlID="FIRSTCAP__LDREASON" 
			Text="Reason" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="FIRSTCAP__LDREASON" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_LOADDISC" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_FIRSTCAP__LDREASON(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valFIRSTCAP_LDREASON" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Reason"
			ClientValidationFunction="onValidate_FIRSTCAP__LDREASON" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div id="frmLoad" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Interest Party" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FIRSTCAP-TOT_PREMIUM">
		<asp:Label ID="lblFIRSTCAP_TOT_PREMIUM" runat="server" AssociatedControlID="FIRSTCAP__TOT_PREMIUM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FIRSTCAP__TOT_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFIRSTCAP_TOT_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_FIRSTCAP__TOT_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- Button -->
     <asp:Button ID="btnCalculatePrem" runat="server" Text="Calculate Premium" CssClass="btn btn-sm btn-primary" OnClientClick="clearCookieScrollPos()"/>
	<script type="text/javascript">
		if (window.rulesDisabled){
			document.getElementById('btnCalculatePrem').style.display = "none";
