...
Namespace Nexus
    Partial Class PB2_HTPPA_Personal_Accident : Inherits BaseRisk
		...
		Protected Sub onValidate_TRUCKING__RISK_ATTACH_DATE()
        
End Sub
Protected Sub onValidate_TRUCKING__EFFECTIVEDATE()
...
Protected Sub CallRuleScripts()
    onValidate_TRUCKING__RISK_ATTACH_DATE()
    onValidate_TRUCKING__EFFECTIVEDATE()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If TRUCKING__RISK_ATTACH_DATE.Text = "" or TRUCKING__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			TRUCKING__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			TRUCKING__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (TRUCKING__RISK_ATTACH_DATE.Text <> "" Or TRUCKING__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		TRUCKING__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		TRUCKING__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		TRUCKING__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
