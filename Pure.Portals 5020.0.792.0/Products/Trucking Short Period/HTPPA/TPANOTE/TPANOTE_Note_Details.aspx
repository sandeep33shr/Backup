<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TPANOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_TPANOTE_Note_Details" %>
...
function onValidate_TPASNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TPASNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TPASNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TPASNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "TPASNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=TPASNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_TPASNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TPASNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TPASNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TPASNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "TPASNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_TPASNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TPASNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TPASNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TPASNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "TPASNOTES", "COVER_TYPE");
        		})();
        	}
        })();
}
function onValidate_TPASNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TPASNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TPASNOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TPASNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "TPASNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_TPASNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TPASNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TPASNOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TPASNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "TPASNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TPASNOTES", "NOTE_DETAILS");
        		var exp = new Expression("TPASNOTES.NoteCheck = 1");
...
function onValidate_TPASNOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TPASNOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TPASNOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_TPASNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_TPASNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_TPASNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_TPASNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_TPASNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_TPASNOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id3f05eb4a86bf46af8e699def98fdd095" class="general-layout-container">
...
<div id="id5899ed5528bb4fb786895bc5a15b0668" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading7" runat="server" Text="Notes (Printed On Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TPASNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-TPASNOTES-DATE_CREATED">
		<asp:Label ID="lblTPASNOTES_DATE_CREATED" runat="server" AssociatedControlID="TPASNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TPASNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTPASNOTES__DATE_CREATED" runat="server" LinkedControl="TPASNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTPASNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_TPASNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TPASNOTES-CREATED_BY">

		
		<asp:Label ID="lblTPASNOTES_CREATED_BY" runat="server" AssociatedControlID="TPASNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TPASNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTPASNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_TPASNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TPASNOTES-COVER_TYPE">

		
		<asp:Label ID="lblTPASNOTES_COVER_TYPE" runat="server" AssociatedControlID="TPASNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TPASNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTPASNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_TPASNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TPASNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblTPASNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="TPASNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TPASNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTPASNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_TPASNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-TPASNOTES-NOTE_DETAILS">
		<asp:Label ID="lblTPASNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="TPASNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="TPASNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valTPASNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_TPASNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblTPASNOTES_NoteCheck" for="ctl00_cntMainBody_TPASNOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-TPASNOTES-NoteCheck">	
		
		<asp:TextBox ID="TPASNOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valTPASNOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_TPASNOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5899ed5528bb4fb786895bc5a15b0668 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5899ed5528bb4fb786895bc5a15b0668 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5899ed5528bb4fb786895bc5a15b0668 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5899ed5528bb4fb786895bc5a15b0668 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5899ed5528bb4fb786895bc5a15b0668 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5899ed5528bb4fb786895bc5a15b0668 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5899ed5528bb4fb786895bc5a15b0668 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5899ed5528bb4fb786895bc5a15b0668 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5899ed5528bb4fb786895bc5a15b0668 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5899ed5528bb4fb786895bc5a15b0668 input{text-align:left;}"; break;
		}
	}
