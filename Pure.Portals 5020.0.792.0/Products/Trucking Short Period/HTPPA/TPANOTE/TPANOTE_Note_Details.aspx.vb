...
Namespace Nexus
    Partial Class PB2_TPANOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_TPASNOTES__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If TPASNOTES__Date_Created.Text.ToString = "" Then
        		TPASNOTES__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		TPASNOTES__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_TPASNOTES__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_TPASNOTES__NOTE_DETAILS()
    onValidate_TPASNOTES__NoteCheck()
End Sub
