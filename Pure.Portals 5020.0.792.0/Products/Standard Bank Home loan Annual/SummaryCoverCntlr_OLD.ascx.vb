...
Partial Class PrivateCar_SummaryOfCover : Inherits System.Web.UI.UserControl
    ...
    Sub DocumentsDisplay()
       ...
       If oQuote.ProductCode = "PKA" Then
            ...
            If Session(CNMTAType) = MTAType.TEMPORARY Or Session(CNMTAType) = MTAType.PERMANENT Then
                ...
                If docs = "" Then
                    docs += "Home Loan MTA,Tax Invoice,Cover Letter Tax Invoice,Credit Note,Debit Note,MTA Cover Letter"
                Else
                    docs += ",Home Loan MTA,Tax Invoice,Cover Letter Tax Invoice,Credit Note, Debit Note,MTA Cover Letter"
                    docMgr.Documents = ""
                End If
            ...
            Else
               If docs = "" Then
                   docs += "Home Loan Quotation,QT Cover Letter"
               Else
                   docs += ",Home Loan Quotation,QT Cover Letter"
                   docMgr.Documents = ""
               End If
       ...
       If Not oQuote.ProductCode = "PKA" Then
