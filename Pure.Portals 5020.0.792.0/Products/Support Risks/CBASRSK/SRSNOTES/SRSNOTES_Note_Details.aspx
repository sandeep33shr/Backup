<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SRSNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_SRSNOTES_Note_Details" %>
...
function onValidate_TAMSNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Support Risks'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
<div id="ide7216336e2c84f578f04581b43812535" class="general-layout-container">
...
<div id="id2e33df8bd6274bcd99181adb4ecfee0c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading7" runat="server" Text="Support Risks Note Details (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2e33df8bd6274bcd99181adb4ecfee0c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2e33df8bd6274bcd99181adb4ecfee0c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2e33df8bd6274bcd99181adb4ecfee0c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2e33df8bd6274bcd99181adb4ecfee0c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2e33df8bd6274bcd99181adb4ecfee0c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2e33df8bd6274bcd99181adb4ecfee0c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2e33df8bd6274bcd99181adb4ecfee0c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2e33df8bd6274bcd99181adb4ecfee0c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2e33df8bd6274bcd99181adb4ecfee0c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2e33df8bd6274bcd99181adb4ecfee0c input{text-align:left;}"; break;
		}
	}
