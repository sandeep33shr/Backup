...
Namespace Nexus
    Partial Class PB2_SRENDOS_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_TSMR_END__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_TSMR_END__ENDORSE_ID()
End Sub
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/TAMRSK/SW.REFERRAL_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("TSMR_END__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/TAMRSK/TSMR_END")
        
        	Dim CurrentSelected As String = TSMR_END__ENDORSE_CAP.Text
