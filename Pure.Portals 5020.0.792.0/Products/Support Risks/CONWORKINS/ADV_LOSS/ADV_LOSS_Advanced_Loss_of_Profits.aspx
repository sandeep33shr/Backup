<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ADV_LOSS_Advanced_Loss_of_Profits.aspx.vb" Inherits="Nexus.PB2_ADV_LOSS_Advanced_Loss_of_Profits" %>
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADV_OBJ", "DECSRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADV_OBJ.DECSRIPTION");
        			window.setControlWidth(field, "0.5", "ADV_OBJ", "DECSRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADV_OBJ", "TIME");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADV_OBJ.TIME");
        			window.setControlWidth(field, "0.5", "ADV_OBJ", "TIME");
        		})();
        	}
        })();
...
function onValidate_ADV_OBJ__MONEY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADV_OBJ.MONEY");
        			window.setControlWidth(field, "0.5", "ADV_OBJ", "MONEY");
        		})();
        	}
        })();
}
...
<div id="id4f4219f6d4134923b166c0974773b3cf" class="general-layout-container">
...
<div id="id18a663b52fa044e2ac8ce696876794c0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading33" runat="server" Text="Advanced Loss of Profits - Deductibles" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id18a663b52fa044e2ac8ce696876794c0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id18a663b52fa044e2ac8ce696876794c0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id18a663b52fa044e2ac8ce696876794c0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id18a663b52fa044e2ac8ce696876794c0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id18a663b52fa044e2ac8ce696876794c0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id18a663b52fa044e2ac8ce696876794c0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id18a663b52fa044e2ac8ce696876794c0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id18a663b52fa044e2ac8ce696876794c0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id18a663b52fa044e2ac8ce696876794c0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id18a663b52fa044e2ac8ce696876794c0 input{text-align:left;}"; break;
		}
	}
