<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKINS_Advanced_Loss_of_Profits.aspx.vb" Inherits="Nexus.PB2_CONWORKINS_Advanced_Loss_of_Profits" %>
...
function onValidate_ADVANCE__ADV_LOSS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADVANCE", "ADV_LOSS", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_ADVANCE__ADV_LOSS(null, null, null, isOnLoad);
}
</script>
...
<div id="idca1ee455dfcc46bd82e686700f32eebd" class="general-layout-container">
...
<div id="ide0b40ca21af6479f9dd2d61ea342429f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading35" runat="server" Text="Advanced Loss of Profits" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide0b40ca21af6479f9dd2d61ea342429f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide0b40ca21af6479f9dd2d61ea342429f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide0b40ca21af6479f9dd2d61ea342429f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide0b40ca21af6479f9dd2d61ea342429f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide0b40ca21af6479f9dd2d61ea342429f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide0b40ca21af6479f9dd2d61ea342429f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide0b40ca21af6479f9dd2d61ea342429f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide0b40ca21af6479f9dd2d61ea342429f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide0b40ca21af6479f9dd2d61ea342429f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide0b40ca21af6479f9dd2d61ea342429f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc3e3ac447d87484e84eef4910953a06f" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ADVANCE__ADV_LOSS"
		data-field-type="Child" 
		data-object-name="ADVANCE" 
		data-property-name="ADV_LOSS" 
		id="pb-container-childscreen-ADVANCE-ADV_LOSS">
		
		    <legend>Advanced Loss of Profits - Deductibles</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ADVANCE__ADV_OBJ" runat="server" ScreenCode="ADV_LOSS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ADV_LOSS/ADV_LOSS_Advanced_Loss_of_Profits.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valADVANCE_ADV_LOSS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Advanced Loss of Profits - Deductibles"
						ClientValidationFunction="onValidate_ADVANCE__ADV_LOSS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc3e3ac447d87484e84eef4910953a06f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc3e3ac447d87484e84eef4910953a06f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc3e3ac447d87484e84eef4910953a06f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc3e3ac447d87484e84eef4910953a06f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc3e3ac447d87484e84eef4910953a06f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc3e3ac447d87484e84eef4910953a06f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc3e3ac447d87484e84eef4910953a06f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc3e3ac447d87484e84eef4910953a06f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc3e3ac447d87484e84eef4910953a06f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc3e3ac447d87484e84eef4910953a06f input{text-align:left;}"; break;
		}
	}
