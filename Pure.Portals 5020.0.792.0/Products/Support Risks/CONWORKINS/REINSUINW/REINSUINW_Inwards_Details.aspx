...
<div id="id2e339f4bed7b4d7b8fe2fa4337cbeef1" class="general-layout-container">
...
<div id="id3fbf7a01eb6940f9a74d784965f6e312" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCONTESTP_PER_SHARE" runat="server" AssociatedControlID="CONTESTP__PER_SHARE" 
			Text="Percentage Share / Share Percentage " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valCONTESTP_PER_SHARE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Percentage Share / Share Percentage "
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3fbf7a01eb6940f9a74d784965f6e312 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3fbf7a01eb6940f9a74d784965f6e312 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3fbf7a01eb6940f9a74d784965f6e312 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3fbf7a01eb6940f9a74d784965f6e312 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3fbf7a01eb6940f9a74d784965f6e312 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3fbf7a01eb6940f9a74d784965f6e312 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3fbf7a01eb6940f9a74d784965f6e312 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3fbf7a01eb6940f9a74d784965f6e312 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3fbf7a01eb6940f9a74d784965f6e312 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3fbf7a01eb6940f9a74d784965f6e312 input{text-align:left;}"; break;
		}
	}
