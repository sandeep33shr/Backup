<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="VAPRISK_Notes.aspx.vb" Inherits="Nexus.PB2_VAPRISK_Notes" %>
...
function onValidate_NOTES__VAPNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "VAPNOTES", "ChildScreen");
        })();
}
function onValidate_NOTES__VAPEXTNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "VAPEXTNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onScreenLogic(null, null, null, isOnLoad);
    onValidate_NOTES__VAPNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__VAPEXTNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id1cd1d8dda20941b0b40cacc6678c02a7" class="general-layout-container">
...
<div id="id7306bc89d9974a1fb7ba8baba6db3b8a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading23" runat="server" Text="Value Added Products Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__VAPNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="VAPNOTES" 
		id="pb-container-childscreen-NOTES-VAPNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="VAPNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="VAPNOTES/VAPNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_VAPNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__VAPNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7306bc89d9974a1fb7ba8baba6db3b8a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7306bc89d9974a1fb7ba8baba6db3b8a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7306bc89d9974a1fb7ba8baba6db3b8a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7306bc89d9974a1fb7ba8baba6db3b8a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7306bc89d9974a1fb7ba8baba6db3b8a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7306bc89d9974a1fb7ba8baba6db3b8a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7306bc89d9974a1fb7ba8baba6db3b8a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7306bc89d9974a1fb7ba8baba6db3b8a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7306bc89d9974a1fb7ba8baba6db3b8a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7306bc89d9974a1fb7ba8baba6db3b8a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="iddc4ffe6b153d47549cd6d6551b9aea07" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading24" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__VAPEXTNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="VAPEXTNOTE" 
		id="pb-container-childscreen-NOTES-VAPEXTNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__EXT_DETAILS" runat="server" ScreenCode="VAPEXTNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="VAPEXTNOTE/VAPEXTNOTE_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_VAPEXTNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__VAPEXTNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#iddc4ffe6b153d47549cd6d6551b9aea07 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddc4ffe6b153d47549cd6d6551b9aea07 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddc4ffe6b153d47549cd6d6551b9aea07 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#iddc4ffe6b153d47549cd6d6551b9aea07 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddc4ffe6b153d47549cd6d6551b9aea07 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddc4ffe6b153d47549cd6d6551b9aea07 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddc4ffe6b153d47549cd6d6551b9aea07 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddc4ffe6b153d47549cd6d6551b9aea07 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddc4ffe6b153d47549cd6d6551b9aea07 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddc4ffe6b153d47549cd6d6551b9aea07 input{text-align:left;}"; break;
		}
	}
