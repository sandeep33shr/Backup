...
Partial Class PrivateCar_SummaryOfCover : Inherits System.Web.UI.UserControl
    ...
    Sub DocumentsDisplay()
        ...
        If oQuote.ProductCode = "PVA" Then
            ...
            If Session(CNMTAType) = MTAType.TEMPORARY Or Session(CNMTAType) = MTAType.PERMANENT Then
                ...
                If docs = "" Then
                    docs += "VAPS_MTA,Tax Invoice,Cover Letter Tax Invoice,Credit Note,Debit Note,MTA Cover Letter"
                Else
                    docs += ",VAPS_MTA,Tax Invoice,Cover Letter Tax Invoice,Credit Note,Debit Note,MTA Cover Letter"
                    docMgr.Documents = ""
                End If
        ...
        If Not oQuote.ProductCode = "PVA" Then
