<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="STBKHL_Cover_Details.aspx.vb" Inherits="Nexus.PB2_STBKHL_Cover_Details" %>
...
function onValidate_GENERAL__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Standard Bank Home loan - ' + ADDRESS.LINE1"), 
...
function onValidate_GENERAL__STBMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "STBMTA", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__STBMTA(null, null, null, isOnLoad);
...
<div id="idef7d039f0d3e4f4ca70896894e6f6a76" class="general-layout-container">
...
<div id="ide8cc217e6c4744fca7b21e7a91b4114e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Standard Bank Home loan" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide8cc217e6c4744fca7b21e7a91b4114e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide8cc217e6c4744fca7b21e7a91b4114e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide8cc217e6c4744fca7b21e7a91b4114e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide8cc217e6c4744fca7b21e7a91b4114e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide8cc217e6c4744fca7b21e7a91b4114e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide8cc217e6c4744fca7b21e7a91b4114e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide8cc217e6c4744fca7b21e7a91b4114e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide8cc217e6c4744fca7b21e7a91b4114e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide8cc217e6c4744fca7b21e7a91b4114e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide8cc217e6c4744fca7b21e7a91b4114e input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__STBMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="STBMTA" 
		id="pb-container-childscreen-GENERAL-STBMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="STBMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="STBMTA/STBMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_STBMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.STBMTA"
						ClientValidationFunction="onValidate_GENERAL__STBMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb294404d35cd4c44bce818285f0790cd" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb294404d35cd4c44bce818285f0790cd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb294404d35cd4c44bce818285f0790cd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb294404d35cd4c44bce818285f0790cd div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb294404d35cd4c44bce818285f0790cd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb294404d35cd4c44bce818285f0790cd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb294404d35cd4c44bce818285f0790cd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb294404d35cd4c44bce818285f0790cd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb294404d35cd4c44bce818285f0790cd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb294404d35cd4c44bce818285f0790cd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb294404d35cd4c44bce818285f0790cd input{text-align:left;}"; break;
		}
	}
