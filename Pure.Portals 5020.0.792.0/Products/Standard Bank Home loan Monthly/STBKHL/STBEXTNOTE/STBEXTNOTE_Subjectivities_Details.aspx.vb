...
Namespace Nexus
    Partial Class PB2_STBEXTNOTE_Subjectivities_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_EXT_DETAILS__Note_Details()
...
Protected Sub CallRuleScripts()
    onValidate_EXT_DETAILS__Note_Details()
End Sub
