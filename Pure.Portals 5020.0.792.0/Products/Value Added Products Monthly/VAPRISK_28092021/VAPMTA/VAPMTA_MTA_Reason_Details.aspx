<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="VAPMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_VAPMTA_MTA_Reason_Details" %>
...
function onValidate_MTA_REASON__MTA_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MTA_REASON", "MTA_DESCRIPTION", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MTA_REASON", "MTA_DESCRIPTION");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMTA_REASON_MTA_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_MTA_REASON__MTA_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MTA_REASON__MTA_DESCRIPTION_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MTA_REASON.MTA_DESCRIPTION");
        			window.setControlWidth(field, "0.6", "MTA_REASON", "MTA_DESCRIPTION");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MTA_REASON__MTA_DESCRIPTION(null, null, null, isOnLoad);
}
</script>
...
<div id="id0df57ce2df5a4a8a8ac4077b9460914c" class="general-layout-container">
...
<div id="id9dab032a620e4b9b9626d48a85a45621" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading1" runat="server" Text="Mid-Term Adjustment Reason Detail" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MTA_REASON" 
		data-property-name="MTA_DESCRIPTION" 
		id="pb-container-list-MTA_REASON-MTA_DESCRIPTION">
		<asp:Label ID="lblMTA_REASON_MTA_DESCRIPTION" runat="server" AssociatedControlID="MTA_REASON__MTA_DESCRIPTION" 
			Text="Reason" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="MTA_REASON__MTA_DESCRIPTION" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_MTAREASON" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_MTA_REASON__MTA_DESCRIPTION(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valMTA_REASON_MTA_DESCRIPTION" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Reason"
			ClientValidationFunction="onValidate_MTA_REASON__MTA_DESCRIPTION" 
			ValidationGroup=""
			Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9dab032a620e4b9b9626d48a85a45621 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9dab032a620e4b9b9626d48a85a45621 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9dab032a620e4b9b9626d48a85a45621 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9dab032a620e4b9b9626d48a85a45621 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9dab032a620e4b9b9626d48a85a45621 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9dab032a620e4b9b9626d48a85a45621 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9dab032a620e4b9b9626d48a85a45621 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9dab032a620e4b9b9626d48a85a45621 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9dab032a620e4b9b9626d48a85a45621 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9dab032a620e4b9b9626d48a85a45621 input{text-align:left;}"; break;
		}
	}
