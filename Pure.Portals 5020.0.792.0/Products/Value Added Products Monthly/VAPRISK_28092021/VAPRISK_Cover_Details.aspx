<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="VAPRISK_Cover_Details.aspx.vb" Inherits="Nexus.PB2_VAPRISK_Cover_Details" %>
...
function onValidate_GENERAL__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Value Added Products - ' + ADDRESS.LINE1"), 
...
function onValidate_GENERAL__COVER_END_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "COVER_END_DATE", "Date");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "COVER_END_DATE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__RENEWAL_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "RENEWAL_DATE", "Date");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "RENEWAL_DATE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__VAPMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "VAPMTA", "ChildScreen");
        })();
}
...
function onValidate_VAP__VEHTYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VAP", "VEHTYPE", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("VAP", "VEHTYPE");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVAP_VEHTYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_VAP__VEHTYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VAP__VEHTYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VAP.VEHTYPE");
        			window.setControlWidth(field, "0.7", "VAP", "VEHTYPE");
        		})();
        	}
        })();
        /**
        ...
        $(document).ready(function () {
            var listInstance = Field.getInstance("VAP", "VEHTYPE");
        		
            events.listen(listInstance, "change", function(e){		
                var VAP__VEHTYPE_Value = listInstance.getValue();
        		var code = listInstance.getCode();
        		
                if (listInstance.getType() == "list")
                {
                    if (VAP__VEHTYPE_Value != "" || VAP__VEHTYPE_Value != null) {
                        __doPostBack('<%=asyncPanel.ClientID%>', 'PopulateDefaults_VAP_VEHTYPE' + ',' + "VEHTYPE" + ',' + code);
                    }
                }
...
function onValidate_VAP__VEHTYPECAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VAP", "VEHTYPECAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("VAP", "VEHTYPECAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=VAP&propertyName=VEHTYPECAP&name={name}");
        		
        		var value = new Expression("Caption(VAP.VEHTYPE)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_VAP__DEPOSIAMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VAP", "DEPOSIAMT", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("VAP", "DEPOSIAMT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__COVER_END_DATE(null, null, null, isOnLoad);
    onValidate_GENERAL__RENEWAL_DATE(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__VAPMTA(null, null, null, isOnLoad);
    ...
    onValidate_VAP__VEHTYPE(null, null, null, isOnLoad);
    onValidate_VAP__VEHTYPECAP(null, null, null, isOnLoad);
    onValidate_VAP__DEPOSIAMT(null, null, null, isOnLoad);
}
</script>
...
<div id="id7842530b18774a6083b2ce8e0024f1bc" class="general-layout-container">
...
<div id="id6f4d0539b2ab4161b5fd9c9000011642" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Value Added Products" /></legend>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Date" 
		data-object-name="GENERAL" 
		data-property-name="COVER_END_DATE" 
		id="pb-container-datejquerycompatible-GENERAL-COVER_END_DATE">
		<asp:Label ID="lblGENERAL_COVER_END_DATE" runat="server" AssociatedControlID="GENERAL__COVER_END_DATE" 
			Text="Cover End Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="GENERAL__COVER_END_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calGENERAL__COVER_END_DATE" runat="server" LinkedControl="GENERAL__COVER_END_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valGENERAL_COVER_END_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Cover End Date"
			ClientValidationFunction="onValidate_GENERAL__COVER_END_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Date" 
		data-object-name="GENERAL" 
		data-property-name="RENEWAL_DATE" 
		id="pb-container-datejquerycompatible-GENERAL-RENEWAL_DATE">
		<asp:Label ID="lblGENERAL_RENEWAL_DATE" runat="server" AssociatedControlID="GENERAL__RENEWAL_DATE" 
			Text="Renewal Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="GENERAL__RENEWAL_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calGENERAL__RENEWAL_DATE" runat="server" LinkedControl="GENERAL__RENEWAL_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valGENERAL_RENEWAL_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Renewal Date"
			ClientValidationFunction="onValidate_GENERAL__RENEWAL_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6f4d0539b2ab4161b5fd9c9000011642 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6f4d0539b2ab4161b5fd9c9000011642 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6f4d0539b2ab4161b5fd9c9000011642 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6f4d0539b2ab4161b5fd9c9000011642 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6f4d0539b2ab4161b5fd9c9000011642 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6f4d0539b2ab4161b5fd9c9000011642 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6f4d0539b2ab4161b5fd9c9000011642 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6f4d0539b2ab4161b5fd9c9000011642 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6f4d0539b2ab4161b5fd9c9000011642 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6f4d0539b2ab4161b5fd9c9000011642 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__VAPMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="VAPMTA" 
		id="pb-container-childscreen-GENERAL-VAPMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="VAPMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="VAPMTA/VAPMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_VAPMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.VAPMTA"
						ClientValidationFunction="onValidate_GENERAL__VAPMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2969b163cf1943deb86d4491b517f667" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2969b163cf1943deb86d4491b517f667 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2969b163cf1943deb86d4491b517f667 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2969b163cf1943deb86d4491b517f667 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2969b163cf1943deb86d4491b517f667 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2969b163cf1943deb86d4491b517f667 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2969b163cf1943deb86d4491b517f667 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2969b163cf1943deb86d4491b517f667 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2969b163cf1943deb86d4491b517f667 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2969b163cf1943deb86d4491b517f667 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2969b163cf1943deb86d4491b517f667 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5d4d9a954fad489fbe3c2f36bbb8519d" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-VAP-VEHTYPE">
		<asp:Label ID="lblVAP_VEHTYPE" runat="server" AssociatedControlID="VAP__VEHTYPE" 
			Text="Type of Vehicle" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="VAP__VEHTYPE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_VEHICLETYPE_VAP" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_VAP__VEHTYPE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valVAP_VEHTYPE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Type of Vehicle"
			ClientValidationFunction="onValidate_VAP__VEHTYPE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-VAP-VEHTYPECAP">

		
		<asp:Label ID="lblVAP_VEHTYPECAP" runat="server" AssociatedControlID="VAP__VEHTYPECAP" 
			Text="Caption" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="VAP__VEHTYPECAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valVAP_VEHTYPECAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Caption"
					ClientValidationFunction="onValidate_VAP__VEHTYPECAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="VAP" 
		data-property-name="DEPOSIAMT" 
		id="pb-container-currency-VAP-DEPOSIAMT">
		<asp:Label ID="lblVAP_DEPOSIAMT" runat="server" AssociatedControlID="VAP__DEPOSIAMT" 
			Text="Deposit Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="VAP__DEPOSIAMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valVAP_DEPOSIAMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deposit Amount"
			ClientValidationFunction="onValidate_VAP__DEPOSIAMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5d4d9a954fad489fbe3c2f36bbb8519d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5d4d9a954fad489fbe3c2f36bbb8519d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5d4d9a954fad489fbe3c2f36bbb8519d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5d4d9a954fad489fbe3c2f36bbb8519d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5d4d9a954fad489fbe3c2f36bbb8519d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d4d9a954fad489fbe3c2f36bbb8519d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d4d9a954fad489fbe3c2f36bbb8519d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5d4d9a954fad489fbe3c2f36bbb8519d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d4d9a954fad489fbe3c2f36bbb8519d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d4d9a954fad489fbe3c2f36bbb8519d input{text-align:left;}"; break;
		}
	}
