<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="VAPRISK_Endorsements.aspx.vb" Inherits="Nexus.PB2_VAPRISK_Endorsements" %>
...
function onValidate_ENDORSCHLD__VAPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENDORSCHLD", "VAPPREM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onScreenLogic(null, null, null, isOnLoad);
    onValidate_ENDORSCHLD__VAPPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id1fd16c640d7a4270a19ac5e9c0f72366" class="general-layout-container">
...
<div id="idf38a3ebbceab433db2cbff0781e61661" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading16" runat="server" Text="Premium Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENDORSCHLD__VAPPREM"
		data-field-type="Child" 
		data-object-name="ENDORSCHLD" 
		data-property-name="VAPPREM" 
		id="pb-container-childscreen-ENDORSCHLD-VAPPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENDORSCHLD__PREMENDORS" runat="server" ScreenCode="VAPPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="VAPPREM/VAPPREM_Premium_Endorsements.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Description" DataField="ENDORS_DES" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATECREATE" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valENDORSCHLD_VAPPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ENDORSCHLD.VAPPREM"
						ClientValidationFunction="onValidate_ENDORSCHLD__VAPPREM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf38a3ebbceab433db2cbff0781e61661 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf38a3ebbceab433db2cbff0781e61661 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf38a3ebbceab433db2cbff0781e61661 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf38a3ebbceab433db2cbff0781e61661 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf38a3ebbceab433db2cbff0781e61661 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf38a3ebbceab433db2cbff0781e61661 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf38a3ebbceab433db2cbff0781e61661 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf38a3ebbceab433db2cbff0781e61661 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf38a3ebbceab433db2cbff0781e61661 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf38a3ebbceab433db2cbff0781e61661 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblREFERRAL_CLAUSES_STANDARDWORDING" runat="server" AssociatedControlID="REFERRAL_CLAUSES__STANDARDWORDING" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="REFERRAL_CLAUSES__STANDARDWORDING" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
