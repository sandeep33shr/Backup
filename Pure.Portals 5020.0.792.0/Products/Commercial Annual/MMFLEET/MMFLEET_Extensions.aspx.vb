...
Namespace Nexus
    Partial Class PB2_MMFLEET_Extensions : Inherits BaseRisk
		...
		Protected Sub onValidate_FLEET_EXTENSIONS__LOSS_KEYS_LIMIT()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FLEET_EXTENSIONS__LOSS_KEYS_LIMIT()
End Sub
