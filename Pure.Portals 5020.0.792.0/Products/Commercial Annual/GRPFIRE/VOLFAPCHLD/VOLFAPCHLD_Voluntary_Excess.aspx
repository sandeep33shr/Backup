<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="VOLFAPCHLD_Voluntary_Excess.aspx.vb" Inherits="Nexus.PB2_VOLFAPCHLD_Voluntary_Excess" %>
...
function onValidate_VOL_EXCESS__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VOL_EXCESS", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("VOL_EXCESS", "COUNTER_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=VOL_EXCESS&propertyName=COUNTER_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "VOL_EXCESS" && field.getPropertyName() == "COUNTER_ID")
...
function onValidate_VOL_EXCESS__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VOL_EXCESS", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("VOL_EXCESS", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VOL_EXCESS.DESCRIPTION");
        			window.setControlWidth(field, "0.7", "VOL_EXCESS", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVOL_EXCESS_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_VOL_EXCESS__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VOL_EXCESS__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_VOL_EXCESS__AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VOL_EXCESS", "AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VOL_EXCESS", "AMOUNT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VOL_EXCESS.AMOUNT");
        			window.setControlWidth(field, "0.7", "VOL_EXCESS", "AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVOL_EXCESS_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_VOL_EXCESS__AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VOL_EXCESS__AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_VOL_EXCESS__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_VOL_EXCESS__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_VOL_EXCESS__AMOUNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id2c9843e98b4b4cec9746048211c2569a" class="general-layout-container">
...
<div id="idf34b6bbb8e1f4e7490cc215ed4b529b8" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="VOL_EXCESS" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-VOL_EXCESS-COUNTER_ID">

		
		<asp:Label ID="lblVOL_EXCESS_COUNTER_ID" runat="server" AssociatedControlID="VOL_EXCESS__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="VOL_EXCESS__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valVOL_EXCESS_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_VOL_EXCESS__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-VOL_EXCESS-DESCRIPTION">

		
		<asp:Label ID="lblVOL_EXCESS_DESCRIPTION" runat="server" AssociatedControlID="VOL_EXCESS__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="VOL_EXCESS__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valVOL_EXCESS_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_VOL_EXCESS__DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-VOL_EXCESS-AMOUNT">
		<asp:Label ID="lblVOL_EXCESS_AMOUNT" runat="server" AssociatedControlID="VOL_EXCESS__AMOUNT" 
			Text="Excess Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="VOL_EXCESS__AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valVOL_EXCESS_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Excess Amount"
			ClientValidationFunction="onValidate_VOL_EXCESS__AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf34b6bbb8e1f4e7490cc215ed4b529b8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf34b6bbb8e1f4e7490cc215ed4b529b8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf34b6bbb8e1f4e7490cc215ed4b529b8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf34b6bbb8e1f4e7490cc215ed4b529b8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf34b6bbb8e1f4e7490cc215ed4b529b8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf34b6bbb8e1f4e7490cc215ed4b529b8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf34b6bbb8e1f4e7490cc215ed4b529b8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf34b6bbb8e1f4e7490cc215ed4b529b8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf34b6bbb8e1f4e7490cc215ed4b529b8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf34b6bbb8e1f4e7490cc215ed4b529b8 input{text-align:left;}"; break;
		}
	}
