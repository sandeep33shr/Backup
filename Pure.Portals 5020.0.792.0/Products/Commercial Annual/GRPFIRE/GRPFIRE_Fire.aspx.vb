...
End Sub
        ...
        Protected Shadows Sub FirePage_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If oQuote IsNot Nothing Then
        		...
        		Dim TotExtPrem = FIRE_EXTENSIONS__TOTAL_PREMIUM.Text + FIRE__BLD_ESC_TOTALPREM.Text + FIRE__PLANT_ESC_TOTALPREM.Text
        		UpdateXML("FIRE_EXT_PREMIUM", TotExtPrem, "PREMIUM_SUMMARY")
