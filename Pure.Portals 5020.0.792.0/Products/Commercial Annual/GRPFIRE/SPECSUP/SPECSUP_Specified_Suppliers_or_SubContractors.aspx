<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPECSUP_Specified_Suppliers_or_SubContractors.aspx.vb" Inherits="Nexus.PB2_SPECSUP_Specified_Suppliers_or_SubContractors" %>
...
function onValidate_SUP_ITEMS__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUP_ITEMS", "NAME", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SUP_ITEMS", "NAME");
        		var errorMessage = "Specified Suppliers Name is mandatory and must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SUP_ITEMS.NAME");
        			window.setControlWidth(field, "0.7", "SUP_ITEMS", "NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSUP_ITEMS_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_SUP_ITEMS__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SUP_ITEMS__NAME_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SUP_ITEMS&propertyName=NAME&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "SUP_ITEMS" && field.getPropertyName() == "NAME")
...
function onValidate_SUP_ITEMS__PERCENTAGE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUP_ITEMS", "PERCENTAGE", "Percentage");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SUP_ITEMS", "PERCENTAGE");
        		var errorMessage = "Specified Suppliers Percentage is mandatory and must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SUP_ITEMS.PERCENTAGE");
        			window.setControlWidth(field, "0.7", "SUP_ITEMS", "PERCENTAGE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSUP_ITEMS_PERCENTAGE");
        			    var ele = document.getElementById('ctl00_cntMainBody_SUP_ITEMS__PERCENTAGE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SUP_ITEMS__PERCENTAGE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "SUP_ITEMS".toUpperCase() + "__" + "PERCENTAGE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "SUP_ITEMS".toUpperCase() + "_" + "PERCENTAGE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("SUP_ITEMS.PERCENTAGE<= 50");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    onValidate_SUP_ITEMS__NAME(null, null, null, isOnLoad);
    onValidate_SUP_ITEMS__PERCENTAGE(null, null, null, isOnLoad);
}
</script>
...
<div id="id997ae4d1ae354df0bf89ca6b53c8c80c" class="general-layout-container">
...
<div id="id5a654453ee774ce080ea34178934b52d" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SUP_ITEMS" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-SUP_ITEMS-NAME">

		
		<asp:Label ID="lblSUP_ITEMS_NAME" runat="server" AssociatedControlID="SUP_ITEMS__NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SUP_ITEMS__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSUP_ITEMS_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name"
					ClientValidationFunction="onValidate_SUP_ITEMS__NAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SUP_ITEMS-PERCENTAGE">
		<asp:Label ID="lblSUP_ITEMS_PERCENTAGE" runat="server" AssociatedControlID="SUP_ITEMS__PERCENTAGE" 
			Text="Percentage" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SUP_ITEMS__PERCENTAGE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSUP_ITEMS_PERCENTAGE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Percentage"
			ClientValidationFunction="onValidate_SUP_ITEMS__PERCENTAGE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5a654453ee774ce080ea34178934b52d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5a654453ee774ce080ea34178934b52d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5a654453ee774ce080ea34178934b52d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5a654453ee774ce080ea34178934b52d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5a654453ee774ce080ea34178934b52d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5a654453ee774ce080ea34178934b52d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5a654453ee774ce080ea34178934b52d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5a654453ee774ce080ea34178934b52d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5a654453ee774ce080ea34178934b52d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5a654453ee774ce080ea34178934b52d input{text-align:left;}"; break;
		}
	}
