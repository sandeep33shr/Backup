...
function onValidate_AD__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "AD" && field.getPropertyName() == "RISK_ATTACH_DATE")
        		...
        		var condition = (Expression.isValidParameter("GENERAL.IS_ADCode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("GENERAL.IS_ADCode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null;
        		if (condition == null){ 
        			disablePage(false);
        		} else {
...
function onValidate_AD__TOTAL_FINAL_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("AD.AD_PREMIUM + AD.LEAK_PREMIUM + AD_EXTENSIONS.ACPC_PREMIUM + AD.TOTAL_ENDORSE_PREM"), 
        			condition = (Expression.isValidParameter("AD.AD_PREMIUM != null || AD.LEAK_PREMIUM != null || AD_EXTENSIONS.ACPC_PREMIUM != null|| AD.TOTAL_ENDORSE_PREM != null")) ? new Expression("AD.AD_PREMIUM != null || AD.LEAK_PREMIUM != null || AD_EXTENSIONS.ACPC_PREMIUM != null|| AD.TOTAL_ENDORSE_PREM != null") : null, 
...
function onValidate_AD__AD_FIRST_LOSS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AD.AD_PREMIUM.setValue((AD.AD_FIRST_LOSS* AD.AD_RATE)*0.01)");
        		var whenExp = (Expression.isValidParameter("(AD.AD_FIRST_LOSS <> '' AND AD.AD_FIRST_LOSS <> null ) and (AD.AD_RATE <> '' AND AD.AD_RATE <> null ) ")) ? new Expression("(AD.AD_FIRST_LOSS <> '' AND AD.AD_FIRST_LOSS <> null ) and (AD.AD_RATE <> '' AND AD.AD_RATE <> null ) ") : null;
...
function onValidate_AD__AD_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AD.AD_RATE.setValue((AD.AD_PREMIUM/AD.AD_FIRST_LOSS) * 100)");
        		var whenExp = (Expression.isValidParameter("(AD.AD_FIRST_LOSS <> '' AND AD.AD_FIRST_LOSS <> null ) and (AD.AD_RATE <> '' AND  AD.AD_RATE <> null )")) ? new Expression("(AD.AD_FIRST_LOSS <> '' AND AD.AD_FIRST_LOSS <> null ) and (AD.AD_RATE <> '' AND  AD.AD_RATE <> null )") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AD__AD_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.AD_FAP"), 
        			condition = (Expression.isValidParameter("AD.AD_FAP < GENERAL.AD_FAP ||(AD.AD_FAP == null || AD.AD_FAP =='')")) ? new Expression("AD.AD_FAP < GENERAL.AD_FAP ||(AD.AD_FAP == null || AD.AD_FAP =='')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Accidental Damage FAP% cannot be more than 100%")) ? "Accidental Damage FAP% cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AD".toUpperCase() + "__" + "AD_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AD".toUpperCase() + "_" + "AD_FAP");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("AD.AD_FAP <= 100 || (AD.AD_FAP == '' || AD.AD_FAP == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AD__AD_FAP_MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.AD_FAP_AMT"), 
        			condition = (Expression.isValidParameter("AD.AD_FAP_MIN_AMOUNT < GENERAL.AD_FAP_AMT ||(AD.AD_FAP_MIN_AMOUNT == null || AD.AD_FAP_MIN_AMOUNT =='')")) ? new Expression("AD.AD_FAP_MIN_AMOUNT < GENERAL.AD_FAP_AMT ||(AD.AD_FAP_MIN_AMOUNT == null || AD.AD_FAP_MIN_AMOUNT =='')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Accidental Damage Minimum amount cannot be greater than maximum amount")) ? "Accidental Damage Minimum amount cannot be greater than maximum amount" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(AD.AD_FAP_MIN_AMOUNT<=AD.AD_FAP_MAX_AMOUNT) || (AD.AD_FAP_MIN_AMOUNT !=null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AD__AD_FAP_MAX_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Accidental Damage Maximum amount cannot be lesser than minimum amount")) ? "Accidental Damage Maximum amount cannot be lesser than minimum amount" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(AD.AD_FAP_MAX_AMOUNT != null AND AD.AD_FAP_MIN_AMOUNT != null AND AD.AD_FAP_MAX_AMOUNT >= AD.AD_FAP_MIN_AMOUNT) OR AD.AD_FAP_MAX_AMOUNT == null OR AD.AD_FAP_MAX_AMOUNT == ''");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AD__LEAK_FIRST_LOSS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Please Enter Leakage First Loss Value";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AD.LEAK_PREMIUM.setValue((AD.LEAK_FIRST_LOSS* AD.LEAK_RATE)*0.01)");
        		var whenExp = (Expression.isValidParameter("(AD.LEAK_FIRST_LOSS <> '' AND AD.LEAK_FIRST_LOSS <> null ) and (AD.LEAK_RATE <> '' AND AD.LEAK_RATE <> null ) ")) ? new Expression("(AD.LEAK_FIRST_LOSS <> '' AND AD.LEAK_FIRST_LOSS <> null ) and (AD.LEAK_RATE <> '' AND AD.LEAK_RATE <> null ) ") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AD__LEAK_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Please Enter Leakage Premium";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AD.LEAK_RATE.setValue((AD.LEAK_PREMIUM/AD.LEAK_FIRST_LOSS) * 100)");
        		var whenExp = (Expression.isValidParameter("(AD.LEAK_FIRST_LOSS <> '' AND AD.LEAK_FIRST_LOSS <> null ) and (AD.LEAK_RATE <> '' AND  AD.LEAK_RATE <> null )")) ? new Expression("(AD.LEAK_FIRST_LOSS <> '' AND AD.LEAK_FIRST_LOSS <> null ) and (AD.LEAK_RATE <> '' AND  AD.LEAK_RATE <> null )") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AD__LEAK_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.AD_FAP"), 
        			condition = (Expression.isValidParameter("AD.LEAK_FAP < GENERAL.AD_FAP ||(AD.LEAK_FAP == null || AD.LEAK_FAP =='')")) ? new Expression("AD.LEAK_FAP < GENERAL.AD_FAP ||(AD.LEAK_FAP == null || AD.LEAK_FAP =='')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Leakage FAP% cannot be more than 100%")) ? "Leakage FAP% cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AD".toUpperCase() + "__" + "LEAK_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AD".toUpperCase() + "_" + "LEAK_FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("AD.LEAK_FAP <= 100 || (AD.LEAK_FAP == '' || AD.LEAK_FAP == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AD__LEAK_FAP_MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.AD_FAP_AMT"), 
        			condition = (Expression.isValidParameter("AD.LEAK_FAP_MIN_AMOUNT < GENERAL.AD_FAP_AMT ||(AD.LEAK_FAP_MIN_AMOUNT == null || AD.LEAK_FAP_MIN_AMOUNT =='')")) ? new Expression("AD.LEAK_FAP_MIN_AMOUNT < GENERAL.AD_FAP_AMT ||(AD.LEAK_FAP_MIN_AMOUNT == null || AD.LEAK_FAP_MIN_AMOUNT =='')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Leakage Minimum amount cannot be greater than maximum amount")) ? "Leakage Minimum amount cannot be greater than maximum amount" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(AD.LEAK_FAP_MIN_AMOUNT<=AD.LEAK_FAP_MAX_AMOUNT) || (AD.LEAK_FAP_MIN_AMOUNT !=null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AD__LEAK_FAP_MAX_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Leakage Maximum amount cannot be lesser than minimum amount")) ? "Leakage Maximum amount cannot be lesser than minimum amount" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(AD.LEAK_FAP_MAX_AMOUNT != null AND AD.LEAK_FAP_MIN_AMOUNT != null AND AD.LEAK_FAP_MAX_AMOUNT >= AD.LEAK_FAP_MIN_AMOUNT) OR AD.LEAK_FAP_MAX_AMOUNT == null OR AD.LEAK_FAP_MAX_AMOUNT == ''");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AD_EXTENSIONS__IS_ACPC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AD_EXTENSIONS.ACPC_LOI.setValue('')||AD_EXTENSIONS.ACPC_RATE.setValue('')||AD_EXTENSIONS.ACPC_PREMIUM.setValue('')");
...
function onValidate_AD_EXTENSIONS__ACPC_LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AD_EXTENSIONS.IS_ACPC == true  ", "V", "Additional Claims Preparation Costs Limit of Indemnity Is Required");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Limit of Indemnity Cannot exceed Accidental damage Cover first loss Sum insured")) ? "Limit of Indemnity Cannot exceed Accidental damage Cover first loss Sum insured" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AD_EXTENSIONS".toUpperCase() + "__" + "ACPC_LOI");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AD_EXTENSIONS".toUpperCase() + "_" + "ACPC_LOI");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(AD.AD_FIRST_LOSS >= AD_EXTENSIONS.ACPC_LOI) ||(AD_EXTENSIONS.ACPC_LOI =='' || AD_EXTENSIONS.ACPC_LOI ==null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AD_EXTENSIONS.ACPC_PREMIUM.setValue((AD_EXTENSIONS.ACPC_LOI * AD_EXTENSIONS.ACPC_RATE)*0.01)");
        		var whenExp = (Expression.isValidParameter("(AD_EXTENSIONS.ACPC_LOI <> '' AND AD_EXTENSIONS.ACPC_LOI <> null ) and (AD_EXTENSIONS.ACPC_RATE <> '' AND AD_EXTENSIONS.ACPC_RATE <> null ) ")) ? new Expression("(AD_EXTENSIONS.ACPC_LOI <> '' AND AD_EXTENSIONS.ACPC_LOI <> null ) and (AD_EXTENSIONS.ACPC_RATE <> '' AND AD_EXTENSIONS.ACPC_RATE <> null ) ") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AD_EXTENSIONS__ACPC_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "AD_EXTENSIONS.IS_ACPC == true  ", "V", "{3}");
...
function onValidate_AD_EXTENSIONS__ACPC_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AD_EXTENSIONS.IS_ACPC == true  ", "V", "Additional Claims Preparation Costs Premium Is Required");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AD_EXTENSIONS.ACPC_RATE.setValue((AD_EXTENSIONS.ACPC_PREMIUM/AD_EXTENSIONS.ACPC_LOI) * 100)");
        		var whenExp = (Expression.isValidParameter("(AD_EXTENSIONS.ACPC_LOI <> '' AND AD_EXTENSIONS.ACPC_LOI <> null ) and (AD_EXTENSIONS.ACPC_RATE <> '' AND  AD_EXTENSIONS.ACPC_RATE <> null )")) ? new Expression("(AD_EXTENSIONS.ACPC_LOI <> '' AND AD_EXTENSIONS.ACPC_LOI <> null ) and (AD_EXTENSIONS.ACPC_RATE <> '' AND  AD_EXTENSIONS.ACPC_RATE <> null )") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("AD.IS_LOSS_AVG");
        			window.setControlWidth(field, "0.7", "AD", "IS_LOSS_AVG");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAD_IS_LOSS_AVG");
        			    var ele = document.getElementById('ctl00_cntMainBody_AD__IS_LOSS_AVG');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AD__IS_LOSS_AVG_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_AD__EXCL_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "EXCL_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AD.EXCL_PROPERTY == true", "V", "Excluded Property Description is Required");
        
            var paramValue = "VEM",
            paramCondition = "AD.EXCL_PROPERTY == true",
            paramElseValue = "V",
            paramValidationMessage = "Excluded Property Description is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("AD.EXCL_DESCRIPTION");
        			window.setControlWidth(field, "0.7", "AD", "EXCL_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAD_EXCL_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_AD__EXCL_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AD__EXCL_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_AD__DEFINE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "DEFINE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AD.DEFINE_PROPERTY == true", "V", "Defined Property Description is Required");
        
            var paramValue = "VEM",
            paramCondition = "AD.DEFINE_PROPERTY == true",
            paramElseValue = "V",
            paramValidationMessage = "Defined Property Description is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("AD.DEFINE_DESCRIPTION");
        			window.setControlWidth(field, "0.7", "AD", "DEFINE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAD_DEFINE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_AD__DEFINE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AD__DEFINE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_AD__TOTAL_ENDORSE_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AD.TOTAL_ENDORSE_PREM");
        			window.setControlWidth(field, "0.4", "AD", "TOTAL_ENDORSE_PREM");
        		})();
        	}
        })();
        /**
...
function onValidate_AD__ADENDPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("AD", "ADENDPREM");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_AD__ADENDPREM table td a");
        				
        		} else {
        		   links = goog.dom.query("a", field.getElement());
        		}		
                var exp = new Expression("GENERAL.IS_ADCode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')");
...
function onValidate_AD__ADEND_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "ADEND_CNT", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AD", "ADEND_CNT");
        		}
          ...
          * @fileoverview GetColumn
          * @param AD The Parent (Root) object name.
          * @param AC_CLAUSE.ENDORSE_ID The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AD".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "AC_CLAUSE.ENDORSE_ID";
        		//count, average, total, min, max
...
function onValidate_AD__ADNOTES(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("AD", "ADNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_AD__ADNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("AD", "ADNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'AD' and property 'ADNOTES'.");
        			error.display();
...
function onValidate_AD__ADNOTES_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "ADNOTES_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AD", "ADNOTES_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param AD The Parent (Root) object name.
          * @param AD_CNOTE_DETAILS.Date_Created The object.property to sum the totals of.
          * @param MAX The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AD".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "AD_CNOTE_DETAILS.Date_Created";
        		//count, average, total, min, max
        		var type = "MAX".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_AD__ADSNOTES(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("AD", "ADSNOTES");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_AD__ADSNOTES table td a");
...
function onValidate_AD__ADSNOTES_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "ADSNOTES_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AD", "ADSNOTES_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param AD The Parent (Root) object name.
          * @param AD_SNOTE_DETAILS.Date_Created The object.property to sum the totals of.
          * @param MAX The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AD".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "AD_SNOTE_DETAILS.Date_Created";
        		//count, average, total, min, max
        		var type = "MAX".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_AD__ADEND_CNT(null, null, null, isOnLoad);
    onValidate_AD__ADNOTES(null, null, null, isOnLoad);
    onValidate_AD__ADNOTES_CNT(null, null, null, isOnLoad);
    onValidate_AD__ADSNOTES(null, null, null, isOnLoad);
    onValidate_AD__ADSNOTES_CNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id96426d6f10484b97aa17d2f1d5131d32" class="general-layout-container">
...
<div id="idb1961389bfdd4f7dac5fa3e6da1d57d3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading151" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb1961389bfdd4f7dac5fa3e6da1d57d3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb1961389bfdd4f7dac5fa3e6da1d57d3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb1961389bfdd4f7dac5fa3e6da1d57d3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb1961389bfdd4f7dac5fa3e6da1d57d3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb1961389bfdd4f7dac5fa3e6da1d57d3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb1961389bfdd4f7dac5fa3e6da1d57d3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb1961389bfdd4f7dac5fa3e6da1d57d3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb1961389bfdd4f7dac5fa3e6da1d57d3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb1961389bfdd4f7dac5fa3e6da1d57d3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb1961389bfdd4f7dac5fa3e6da1d57d3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf3db829f60014c14a102b837c8e28c11" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading152" runat="server" Text="Cover" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label467">
		<span class="label" id="label467">Full Value</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label468">
		<span class="label" id="label468">First Loss</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label469">
		<span class="label" id="label469">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label470">
		<span class="label" id="label470">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label471">
		<span class="label" id="label471">Average</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label472">
		<span class="label" id="label472">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label473">
		<span class="label" id="label473">Minimum Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label474">
		<span class="label" id="label474">Maximum Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label475">
		<span class="label" id="label475">Accidental Damage </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label476">
		<span class="label" id="label476">Leakage </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf3db829f60014c14a102b837c8e28c11 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf3db829f60014c14a102b837c8e28c11 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf3db829f60014c14a102b837c8e28c11 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf3db829f60014c14a102b837c8e28c11 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf3db829f60014c14a102b837c8e28c11 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf3db829f60014c14a102b837c8e28c11 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf3db829f60014c14a102b837c8e28c11 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf3db829f60014c14a102b837c8e28c11 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf3db829f60014c14a102b837c8e28c11 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf3db829f60014c14a102b837c8e28c11 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id20d2642b03514439a634ac79a4759a2b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading153" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label480">
		<span class="label" id="label480">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label481">
		<span class="label" id="label481">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label482">
		<span class="label" id="label482">Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label483">
		<span class="label" id="label483">Additional Claims Preparation Costs </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id20d2642b03514439a634ac79a4759a2b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id20d2642b03514439a634ac79a4759a2b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id20d2642b03514439a634ac79a4759a2b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id20d2642b03514439a634ac79a4759a2b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id20d2642b03514439a634ac79a4759a2b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id20d2642b03514439a634ac79a4759a2b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id20d2642b03514439a634ac79a4759a2b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id20d2642b03514439a634ac79a4759a2b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id20d2642b03514439a634ac79a4759a2b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id20d2642b03514439a634ac79a4759a2b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2d19130e690040969dfcad177f4b64e7" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading154" runat="server" Text="Memoranda" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AD-EXCL_DESCRIPTION">

		
		<asp:Label ID="lblAD_EXCL_DESCRIPTION" runat="server" AssociatedControlID="AD__EXCL_DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AD__EXCL_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AD-DEFINE_DESCRIPTION">

		
		<asp:Label ID="lblAD_DEFINE_DESCRIPTION" runat="server" AssociatedControlID="AD__DEFINE_DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AD__DEFINE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2d19130e690040969dfcad177f4b64e7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2d19130e690040969dfcad177f4b64e7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2d19130e690040969dfcad177f4b64e7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2d19130e690040969dfcad177f4b64e7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2d19130e690040969dfcad177f4b64e7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2d19130e690040969dfcad177f4b64e7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2d19130e690040969dfcad177f4b64e7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2d19130e690040969dfcad177f4b64e7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2d19130e690040969dfcad177f4b64e7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2d19130e690040969dfcad177f4b64e7 input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading155" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblAD_AD_CLAUSES" runat="server" AssociatedControlID="AD__AD_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="AD__AD_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="AD" 
		data-property-name="ADEND_CNT" 
		id="pb-container-integer-AD-ADEND_CNT">
		<asp:Label ID="lblAD_ADEND_CNT" runat="server" AssociatedControlID="AD__ADEND_CNT" 
			Text="Accidental Damage Endorsement Counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="AD__ADEND_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAD_ADEND_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Accidental Damage Endorsement Counter"
			ClientValidationFunction="onValidate_AD__ADEND_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide101f19bab7a4461987e73f38a747ffe" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading156" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide101f19bab7a4461987e73f38a747ffe div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide101f19bab7a4461987e73f38a747ffe div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide101f19bab7a4461987e73f38a747ffe div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide101f19bab7a4461987e73f38a747ffe label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide101f19bab7a4461987e73f38a747ffe label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide101f19bab7a4461987e73f38a747ffe label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide101f19bab7a4461987e73f38a747ffe label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide101f19bab7a4461987e73f38a747ffe input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide101f19bab7a4461987e73f38a747ffe input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide101f19bab7a4461987e73f38a747ffe input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id954d2f208f524882ab494015926bc60f" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading157" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="AD" 
		data-property-name="ADNOTES_CNT" 
		id="pb-container-integer-AD-ADNOTES_CNT">
		<asp:Label ID="lblAD_ADNOTES_CNT" runat="server" AssociatedControlID="AD__ADNOTES_CNT" 
			Text="Accidental Damage Not Printed Note Counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="AD__ADNOTES_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAD_ADNOTES_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Accidental Damage Not Printed Note Counter"
			ClientValidationFunction="onValidate_AD__ADNOTES_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id954d2f208f524882ab494015926bc60f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id954d2f208f524882ab494015926bc60f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id954d2f208f524882ab494015926bc60f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id954d2f208f524882ab494015926bc60f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id954d2f208f524882ab494015926bc60f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id954d2f208f524882ab494015926bc60f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id954d2f208f524882ab494015926bc60f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id954d2f208f524882ab494015926bc60f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id954d2f208f524882ab494015926bc60f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id954d2f208f524882ab494015926bc60f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9bfd067a96e54120b200947e60321eb2" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading158" runat="server" Text="Notes (Printed on Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="AD" 
		data-property-name="ADSNOTES_CNT" 
		id="pb-container-integer-AD-ADSNOTES_CNT">
		<asp:Label ID="lblAD_ADSNOTES_CNT" runat="server" AssociatedControlID="AD__ADSNOTES_CNT" 
			Text="Accidental Damage Note Counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="AD__ADSNOTES_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAD_ADSNOTES_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Accidental Damage Note Counter"
			ClientValidationFunction="onValidate_AD__ADSNOTES_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9bfd067a96e54120b200947e60321eb2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9bfd067a96e54120b200947e60321eb2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9bfd067a96e54120b200947e60321eb2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9bfd067a96e54120b200947e60321eb2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9bfd067a96e54120b200947e60321eb2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9bfd067a96e54120b200947e60321eb2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9bfd067a96e54120b200947e60321eb2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9bfd067a96e54120b200947e60321eb2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9bfd067a96e54120b200947e60321eb2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9bfd067a96e54120b200947e60321eb2 input{text-align:left;}"; break;
		}
	}
