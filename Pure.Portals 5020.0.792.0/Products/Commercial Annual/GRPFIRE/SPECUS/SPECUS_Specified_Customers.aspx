<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPECUS_Specified_Customers.aspx.vb" Inherits="Nexus.PB2_SPECUS_Specified_Customers" %>
...
function onValidate_CUSTOMER_ITEMS__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CUSTOMER_ITEMS", "NAME", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CUSTOMER_ITEMS", "NAME");
        		var errorMessage = "Specified Customers Name is mandatory and must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CUSTOMER_ITEMS.NAME");
        			window.setControlWidth(field, "0.7", "CUSTOMER_ITEMS", "NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCUSTOMER_ITEMS_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_CUSTOMER_ITEMS__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CUSTOMER_ITEMS__NAME_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CUSTOMER_ITEMS&propertyName=NAME&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "CUSTOMER_ITEMS" && field.getPropertyName() == "NAME")
...
function onValidate_CUSTOMER_ITEMS__PERCENTAGE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CUSTOMER_ITEMS", "PERCENTAGE", "Percentage");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CUSTOMER_ITEMS", "PERCENTAGE");
        		var errorMessage = "Specified Customers Percentage is mandatory and must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CUSTOMER_ITEMS.PERCENTAGE");
        			window.setControlWidth(field, "0.7", "CUSTOMER_ITEMS", "PERCENTAGE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCUSTOMER_ITEMS_PERCENTAGE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CUSTOMER_ITEMS__PERCENTAGE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CUSTOMER_ITEMS__PERCENTAGE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Percentage Cannot Exceed 50%")) ? "Percentage Cannot Exceed 50%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CUSTOMER_ITEMS".toUpperCase() + "__" + "PERCENTAGE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CUSTOMER_ITEMS".toUpperCase() + "_" + "PERCENTAGE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("CUSTOMER_ITEMS.PERCENTAGE<= 50");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    onValidate_CUSTOMER_ITEMS__NAME(null, null, null, isOnLoad);
    onValidate_CUSTOMER_ITEMS__PERCENTAGE(null, null, null, isOnLoad);
}
</script>
...
<div id="id6e79cc64534f47a5b3daa7c7745cbaef" class="general-layout-container">
...
<div id="idf9ea6142cf844e3f8677163aa73d347d" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CUSTOMER_ITEMS" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-CUSTOMER_ITEMS-NAME">

		
		<asp:Label ID="lblCUSTOMER_ITEMS_NAME" runat="server" AssociatedControlID="CUSTOMER_ITEMS__NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CUSTOMER_ITEMS__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCUSTOMER_ITEMS_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name"
					ClientValidationFunction="onValidate_CUSTOMER_ITEMS__NAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CUSTOMER_ITEMS-PERCENTAGE">
		<asp:Label ID="lblCUSTOMER_ITEMS_PERCENTAGE" runat="server" AssociatedControlID="CUSTOMER_ITEMS__PERCENTAGE" 
			Text="Percentage" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CUSTOMER_ITEMS__PERCENTAGE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCUSTOMER_ITEMS_PERCENTAGE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Percentage"
			ClientValidationFunction="onValidate_CUSTOMER_ITEMS__PERCENTAGE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf9ea6142cf844e3f8677163aa73d347d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf9ea6142cf844e3f8677163aa73d347d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf9ea6142cf844e3f8677163aa73d347d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf9ea6142cf844e3f8677163aa73d347d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf9ea6142cf844e3f8677163aa73d347d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9ea6142cf844e3f8677163aa73d347d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9ea6142cf844e3f8677163aa73d347d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf9ea6142cf844e3f8677163aa73d347d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9ea6142cf844e3f8677163aa73d347d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9ea6142cf844e3f8677163aa73d347d input{text-align:left;}"; break;
		}
	}
