<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="BCVAPCHLD_Voluntary_Excess.aspx.vb" Inherits="Nexus.PB2_BCVAPCHLD_Voluntary_Excess" %>
...
function onValidate_BC_VOLFAP_CHILD__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BC_VOLFAP_CHILD", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BC_VOLFAP_CHILD", "COUNTER_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=BC_VOLFAP_CHILD&propertyName=COUNTER_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "BC_VOLFAP_CHILD" && field.getPropertyName() == "COUNTER_ID")
...
function onValidate_BC_VOLFAP_CHILD__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BC_VOLFAP_CHILD", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BC_VOLFAP_CHILD", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BC_VOLFAP_CHILD.DESCRIPTION");
        			window.setControlWidth(field, "0.7", "BC_VOLFAP_CHILD", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBC_VOLFAP_CHILD_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_BC_VOLFAP_CHILD__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BC_VOLFAP_CHILD__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_BC_VOLFAP_CHILD__AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BC_VOLFAP_CHILD", "AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BC_VOLFAP_CHILD", "AMOUNT");
        		var errorMessage = "Excess Amount is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BC_VOLFAP_CHILD.AMOUNT");
        			window.setControlWidth(field, "0.7", "BC_VOLFAP_CHILD", "AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBC_VOLFAP_CHILD_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_BC_VOLFAP_CHILD__AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BC_VOLFAP_CHILD__AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_BC_VOLFAP_CHILD__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_BC_VOLFAP_CHILD__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_BC_VOLFAP_CHILD__AMOUNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id15df5680f2ab4fba87d42c8010848965" class="general-layout-container">
...
<div id="id96b7a824b8184ed788c4a4a96044a2f1" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BC_VOLFAP_CHILD" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-BC_VOLFAP_CHILD-COUNTER_ID">

		
		<asp:Label ID="lblBC_VOLFAP_CHILD_COUNTER_ID" runat="server" AssociatedControlID="BC_VOLFAP_CHILD__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BC_VOLFAP_CHILD__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBC_VOLFAP_CHILD_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_BC_VOLFAP_CHILD__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-BC_VOLFAP_CHILD-DESCRIPTION">

		
		<asp:Label ID="lblBC_VOLFAP_CHILD_DESCRIPTION" runat="server" AssociatedControlID="BC_VOLFAP_CHILD__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BC_VOLFAP_CHILD__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBC_VOLFAP_CHILD_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_BC_VOLFAP_CHILD__DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-BC_VOLFAP_CHILD-AMOUNT">
		<asp:Label ID="lblBC_VOLFAP_CHILD_AMOUNT" runat="server" AssociatedControlID="BC_VOLFAP_CHILD__AMOUNT" 
			Text="Excess Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="BC_VOLFAP_CHILD__AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valBC_VOLFAP_CHILD_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Excess Amount"
			ClientValidationFunction="onValidate_BC_VOLFAP_CHILD__AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id96b7a824b8184ed788c4a4a96044a2f1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id96b7a824b8184ed788c4a4a96044a2f1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id96b7a824b8184ed788c4a4a96044a2f1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id96b7a824b8184ed788c4a4a96044a2f1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id96b7a824b8184ed788c4a4a96044a2f1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id96b7a824b8184ed788c4a4a96044a2f1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id96b7a824b8184ed788c4a4a96044a2f1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id96b7a824b8184ed788c4a4a96044a2f1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id96b7a824b8184ed788c4a4a96044a2f1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id96b7a824b8184ed788c4a4a96044a2f1 input{text-align:left;}"; break;
		}
	}
