<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MONEYSAFE_Type_of_Safe.aspx.vb" Inherits="Nexus.PB2_MONEYSAFE_Type_of_Safe" %>
...
function onValidate_MONEY_SAFE__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEY_SAFE", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MONEY_SAFE", "COUNTER_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MONEY_SAFE&propertyName=COUNTER_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "MONEY_SAFE" && field.getPropertyName() == "COUNTER_ID")
...
function onValidate_MONEY_SAFE__DESCRIPT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEY_SAFE", "DESCRIPT", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MONEY_SAFE", "DESCRIPT");
        		}
        		//window.setProperty(field, "VEM", "MONEY_SAFE.SUMINSURED <> '' AND MONEY_SAFE.SUMINSURED <> null", "VE", "Description is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "MONEY_SAFE.SUMINSURED <> '' AND MONEY_SAFE.SUMINSURED <> null",
            paramElseValue = "VE",
            paramValidationMessage = "Description is mandatory and must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MONEY_SAFE.DESCRIPT");
        			window.setControlWidth(field, "0.3", "MONEY_SAFE", "DESCRIPT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMONEY_SAFE_DESCRIPT");
        			    var ele = document.getElementById('ctl00_cntMainBody_MONEY_SAFE__DESCRIPT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MONEY_SAFE__DESCRIPT_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("MONEY_SAFE.SUMINSURED <> '' AND MONEY_SAFE.SUMINSURED <> null")) ? new Expression("MONEY_SAFE.SUMINSURED <> '' AND MONEY_SAFE.SUMINSURED <> null") : null;
...
function onValidate_MONEY_SAFE__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEY_SAFE", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MONEY_SAFE", "SUMINSURED");
        		}
        		//window.setProperty(field, "VEM", "MONEY_SAFE.DESCRIPT <> '' AND MONEY_SAFE.DESCRIPT <> null", "VE", "Sum Insured is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "MONEY_SAFE.DESCRIPT <> '' AND MONEY_SAFE.DESCRIPT <> null",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MONEY_SAFE.SUMINSURED");
        			window.setControlWidth(field, "0.3", "MONEY_SAFE", "SUMINSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMONEY_SAFE_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_MONEY_SAFE__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MONEY_SAFE__SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("MONEY_SAFE.DESCRIPT <> '' AND MONEY_SAFE.DESCRIPT <> null")) ? new Expression("MONEY_SAFE.DESCRIPT <> '' AND MONEY_SAFE.DESCRIPT <> null") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
...
function DoLogic(isOnLoad) {
    onValidate_MONEY_SAFE__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_MONEY_SAFE__DESCRIPT(null, null, null, isOnLoad);
    onValidate_MONEY_SAFE__SUMINSURED(null, null, null, isOnLoad);
}
</script>
...
<div id="idd180c36b52d148d0a81293fcbe4f7684" class="general-layout-container">
...
<div id="id016f7531d7d64c9f9b085d18ff4e95a2" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading77" runat="server" Text="Type of Safe" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MONEY_SAFE" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-MONEY_SAFE-COUNTER_ID">

		
		<asp:Label ID="lblMONEY_SAFE_COUNTER_ID" runat="server" AssociatedControlID="MONEY_SAFE__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MONEY_SAFE__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMONEY_SAFE_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_MONEY_SAFE__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MONEY_SAFE-DESCRIPT">

		
		<asp:Label ID="lblMONEY_SAFE_DESCRIPT" runat="server" AssociatedControlID="MONEY_SAFE__DESCRIPT" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MONEY_SAFE__DESCRIPT" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMONEY_SAFE_DESCRIPT" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_MONEY_SAFE__DESCRIPT"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MONEY_SAFE-SUMINSURED">
		<asp:Label ID="lblMONEY_SAFE_SUMINSURED" runat="server" AssociatedControlID="MONEY_SAFE__SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEY_SAFE__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMONEY_SAFE_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_MONEY_SAFE__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id016f7531d7d64c9f9b085d18ff4e95a2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id016f7531d7d64c9f9b085d18ff4e95a2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id016f7531d7d64c9f9b085d18ff4e95a2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id016f7531d7d64c9f9b085d18ff4e95a2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id016f7531d7d64c9f9b085d18ff4e95a2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id016f7531d7d64c9f9b085d18ff4e95a2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id016f7531d7d64c9f9b085d18ff4e95a2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id016f7531d7d64c9f9b085d18ff4e95a2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id016f7531d7d64c9f9b085d18ff4e95a2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id016f7531d7d64c9f9b085d18ff4e95a2 input{text-align:left;}"; break;
		}
	}
