...
Namespace Nexus
    Partial Class PB2_EEQMP_Multiple_Premises : Inherits BaseRisk
		...
		Protected Sub onValidate_EE_MULTIPLE_PREMISES__COUNTER_ID()
        
End Sub
Protected Sub onValidate_EE_MULTIPLE_PREMISES__SITEADDRESSLIST()
        
End Sub
Protected Sub onValidate_EE_MULTIPLE_PREMISES__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_EE_MULTIPLE_PREMISES__COUNTER_ID()
    onValidate_EE_MULTIPLE_PREMISES__SITEADDRESSLIST()
    onValidate_EE_MULTIPLE_PREMISES__COUNTRY()
End Sub

		    
        'ELECTEQUIP - Parent object
        'EE_MULTIPLE_PREMISES - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "ELECTEQUIP" & "/" & "EE_MULTIPLE_PREMISES", sXMLDataset)
                            If sChildId <> "0" Then
                                EE_MULTIPLE_PREMISES__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	' Dim SiteAddressScheme As Object = oMaster.FindControl("PREMISES_DETAILS__SITEADDRESSLIST")
        	' Dim HomeAddressScheme As Object = oMaster.FindControl("PREMISES_DETAILS__HOMEADDRESSLIST")
        	' Dim BusinessAddressScheme As Object = oMaster.FindControl("PREMISES_DETAILS__B_ADDRESSLIST")
        	Dim SiteAddressScheme As Object = oMaster.FindControl("EE_MULTIPLE_PREMISES__SITEADDRESSLIST")
                    Dim HomeAddressScheme As Object = oMaster.FindControl("EE_MULTIPLE_PREMISES__HOMEADDRESSLIST")
                    Dim BusinessAddressScheme As Object = oMaster.FindControl("EE_MULTIPLE_PREMISES__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('PREMISES_DETAILS', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('PREMISES_DETAILS', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('PREMISES_DETAILS', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('PREMISES_DETAILS', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('PREMISES_DETAILS', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('PREMISES_DETAILS', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('PREMISES_DETAILS', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('PREMISES_DETAILS', 'COUNTRY').setValue(3);"
        	End If
        
           ScriptManager.RegisterStartupScript(asyncPanelchild, Me.GetType, "AsyncPostback", buildScript,True)
            asyncPanelchild.Update()	
        End Sub
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = EE_MULTIPLE_PREMISES__LINE1.Text
        	Dim Suburb as String = EE_MULTIPLE_PREMISES__SUBURB.Text
