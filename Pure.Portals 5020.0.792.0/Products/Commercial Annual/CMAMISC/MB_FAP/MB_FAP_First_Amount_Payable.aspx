<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MB_FAP_First_Amount_Payable.aspx.vb" Inherits="Nexus.PB2_MB_FAP_First_Amount_Payable" %>
...
function onValidate_MB_FAP__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_FAP", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MB_FAP", "COUNTER_ID");
        		}
...
function onValidate_MB_FAP__FAPDESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_FAP", "FAPDESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MB_FAP", "FAPDESCRIPTION");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_FAP_FAPDESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_FAP__FAPDESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_FAP__FAPDESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_MB_FAP__FAPCHILD_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_FAP", "FAPCHILD_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MB_FAP", "FAPCHILD_PERC");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_FAP_FAPCHILD_PERC");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_FAP__FAPCHILD_PERC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_FAP__FAPCHILD_PERC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("FAP% under First Amount Payable cannot be more than 100%")) ? "FAP% under First Amount Payable cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "MB_FAP".toUpperCase() + "__" + "FAPCHILD_PERC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "MB_FAP".toUpperCase() + "_" + "FAPCHILD_PERC");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("MB_FAP.FAPCHILD_PERC > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_MB_FAP__FAPCHILD_MIN_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_FAP", "FAPCHILD_MIN_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MB_FAP", "FAPCHILD_MIN_AMOUNT");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_FAP_FAPCHILD_MIN_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_FAP__FAPCHILD_MIN_AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_FAP__FAPCHILD_MIN_AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_MB_FAP__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_MB_FAP__FAPDESCRIPTION(null, null, null, isOnLoad);
    onValidate_MB_FAP__FAPCHILD_PERC(null, null, null, isOnLoad);
    onValidate_MB_FAP__FAPCHILD_MIN_AMOUNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id87c837662d3e4961b766efcfbf86624b" class="general-layout-container">
...
<div id="idf979eb762b874117aa3e5ab7a25b5727" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MB_FAP" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-MB_FAP-COUNTER_ID">

		
		<asp:Label ID="lblMB_FAP_COUNTER_ID" runat="server" AssociatedControlID="MB_FAP__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_FAP__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMB_FAP_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_MB_FAP__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_FAP-FAPDESCRIPTION">

		
		<asp:Label ID="lblMB_FAP_FAPDESCRIPTION" runat="server" AssociatedControlID="MB_FAP__FAPDESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_FAP__FAPDESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMB_FAP_FAPDESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_MB_FAP__FAPDESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-MB_FAP-FAPCHILD_PERC">
		<asp:Label ID="lblMB_FAP_FAPCHILD_PERC" runat="server" AssociatedControlID="MB_FAP__FAPCHILD_PERC" 
			Text="FAP %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MB_FAP__FAPCHILD_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMB_FAP_FAPCHILD_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP %"
			ClientValidationFunction="onValidate_MB_FAP__FAPCHILD_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MB_FAP-FAPCHILD_MIN_AMOUNT">
		<asp:Label ID="lblMB_FAP_FAPCHILD_MIN_AMOUNT" runat="server" AssociatedControlID="MB_FAP__FAPCHILD_MIN_AMOUNT" 
			Text="Min Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_FAP__FAPCHILD_MIN_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMB_FAP_FAPCHILD_MIN_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Min Amount"
			ClientValidationFunction="onValidate_MB_FAP__FAPCHILD_MIN_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf979eb762b874117aa3e5ab7a25b5727 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf979eb762b874117aa3e5ab7a25b5727 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf979eb762b874117aa3e5ab7a25b5727 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf979eb762b874117aa3e5ab7a25b5727 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf979eb762b874117aa3e5ab7a25b5727 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf979eb762b874117aa3e5ab7a25b5727 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf979eb762b874117aa3e5ab7a25b5727 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf979eb762b874117aa3e5ab7a25b5727 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf979eb762b874117aa3e5ab7a25b5727 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf979eb762b874117aa3e5ab7a25b5727 input{text-align:left;}"; break;
		}
	}
