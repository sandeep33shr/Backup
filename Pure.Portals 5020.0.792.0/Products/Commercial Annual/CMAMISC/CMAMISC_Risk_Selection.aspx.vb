...
Namespace Nexus
    Partial Class PB2_CMAMISC_Risk_Selection : Inherits BaseRisk
...
End Sub
        ...
        Protected Shadows Sub SetFileCount(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If (value <> FileCnt) Then
        		GENERAL__CHECK_BAR.Value = ""
        		GENERAL__CHECK_GLASS.Value = ""
        		GENERAL__CHECK_THFT.Value = ""
        		GENERAL__CHECK_MONEY.Value = ""
        		GENERAL__CHECK_GIT.Value = ""
        		GENERAL__CHECK_PA.Value = ""
        		GENERAL__CHECK_SB.Value = ""
        		GENERAL__CHECK_FG.Value = ""
        		GENERAL__CHECK_ELECEQ.Value = ""
        		GENERAL__CHECK_MBRK.Value = ""
