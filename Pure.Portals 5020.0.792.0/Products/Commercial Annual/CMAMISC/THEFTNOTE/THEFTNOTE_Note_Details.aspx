...
<div id="id7aa9729ea2814d6bb31374ae412bf802" class="general-layout-container">
...
<div id="id20f4c1cfbdc64179abb8b139661ff1a8" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id20f4c1cfbdc64179abb8b139661ff1a8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id20f4c1cfbdc64179abb8b139661ff1a8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id20f4c1cfbdc64179abb8b139661ff1a8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id20f4c1cfbdc64179abb8b139661ff1a8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id20f4c1cfbdc64179abb8b139661ff1a8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id20f4c1cfbdc64179abb8b139661ff1a8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id20f4c1cfbdc64179abb8b139661ff1a8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id20f4c1cfbdc64179abb8b139661ff1a8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id20f4c1cfbdc64179abb8b139661ff1a8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id20f4c1cfbdc64179abb8b139661ff1a8 input{text-align:left;}"; break;
		}
	}
