<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SAENDORSE_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_SAENDORSE_Endorsement_Premium" %>
...
function onValidate_SEC_A__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_A", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SEC_A", "ENDORSE_ID");
        		}
...
function onValidate_SEC_A__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_A", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SEC_A", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SEC_A.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "SEC_A", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSEC_A_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_SEC_A__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SEC_A__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_SEC_A__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_A", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SEC_A", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SEC_A.ENDORSE_CAP");
        			window.setControlWidth(field, "0.4", "SEC_A", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SEC_A&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(SEC_A.ENDORSE_DESC)"), 
...
function onValidate_SEC_A__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_A", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SEC_A", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SEC_A.PREMIUM");
        			window.setControlWidth(field, "0.4", "SEC_A", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSEC_A_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_SEC_A__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SEC_A__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_SEC_A__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_SEC_A__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_SEC_A__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_SEC_A__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id14a8ed9d543e4da4a80d3d3ae238f138" class="general-layout-container">
...
<div id="id2f9e3b45d8bc4c998475f7a4c74c45b6" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SEC_A" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-SEC_A-ENDORSE_ID">
		<asp:Label ID="lblSEC_A_ENDORSE_ID" runat="server" AssociatedControlID="SEC_A__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="SEC_A__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valSEC_A_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_SEC_A__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-SEC_A-ENDORSE_DESC">
		<asp:Label ID="lblSEC_A_ENDORSE_DESC" runat="server" AssociatedControlID="SEC_A__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="SEC_A__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_SEC_A__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valSEC_A_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_SEC_A__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SEC_A-ENDORSE_CAP">

		
		<asp:Label ID="lblSEC_A_ENDORSE_CAP" runat="server" AssociatedControlID="SEC_A__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SEC_A__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSEC_A_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_SEC_A__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SEC_A-PREMIUM">
		<asp:Label ID="lblSEC_A_PREMIUM" runat="server" AssociatedControlID="SEC_A__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SEC_A__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSEC_A_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SEC_A__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SEC_A-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="SEC_A__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2f9e3b45d8bc4c998475f7a4c74c45b6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2f9e3b45d8bc4c998475f7a4c74c45b6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2f9e3b45d8bc4c998475f7a4c74c45b6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2f9e3b45d8bc4c998475f7a4c74c45b6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2f9e3b45d8bc4c998475f7a4c74c45b6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2f9e3b45d8bc4c998475f7a4c74c45b6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2f9e3b45d8bc4c998475f7a4c74c45b6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2f9e3b45d8bc4c998475f7a4c74c45b6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2f9e3b45d8bc4c998475f7a4c74c45b6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2f9e3b45d8bc4c998475f7a4c74c45b6 input{text-align:left;}"; break;
		}
	}
