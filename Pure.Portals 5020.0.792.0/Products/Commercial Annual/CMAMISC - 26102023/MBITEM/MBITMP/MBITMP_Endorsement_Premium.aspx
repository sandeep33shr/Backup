...
<div id="idff14f53bd90b4b64ae5188970ba4d92c" class="general-layout-container">
...
<div id="idd4670b8e9da14a25a8cc0138b2e03229" class="column-layout-container  ">
		...
		<asp:Label ID="lblMBITEM_CLAUSEPREM_COUNTER_ID" runat="server" AssociatedControlID="MBITEM_CLAUSEPREM__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MBITEM_CLAUSEPREM__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblMBITEM_CLAUSEPREM_ENDORSE_CAP" runat="server" AssociatedControlID="MBITEM_CLAUSEPREM__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MBITEM_CLAUSEPREM__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MBITEM_CLAUSEPREM-ENDORSE_DESCCode">
				...
				<asp:HiddenField ID="MBITEM_CLAUSEPREM__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd4670b8e9da14a25a8cc0138b2e03229 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd4670b8e9da14a25a8cc0138b2e03229 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd4670b8e9da14a25a8cc0138b2e03229 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd4670b8e9da14a25a8cc0138b2e03229 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd4670b8e9da14a25a8cc0138b2e03229 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd4670b8e9da14a25a8cc0138b2e03229 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd4670b8e9da14a25a8cc0138b2e03229 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd4670b8e9da14a25a8cc0138b2e03229 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd4670b8e9da14a25a8cc0138b2e03229 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd4670b8e9da14a25a8cc0138b2e03229 input{text-align:left;}"; break;
		}
	}
