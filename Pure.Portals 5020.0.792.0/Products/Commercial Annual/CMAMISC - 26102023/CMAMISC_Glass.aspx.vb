...
Namespace Nexus
    Partial Class PB2_CMAMISC_Glass : Inherits BaseRisk
		...
		Protected Sub onValidate_GLASS__ATTACHMENTDATE()
        
        
End Sub
Protected Sub onValidate_GLASS__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GLASS__ATTACHMENTDATE()
    onValidate_GLASS__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If GLASS__ATTACHMENTDATE.Text = "" or GLASS__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			GLASS__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			GLASS__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (GLASS__ATTACHMENTDATE.Text <> "" Or GLASS__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		GLASS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		GLASS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		GLASS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
