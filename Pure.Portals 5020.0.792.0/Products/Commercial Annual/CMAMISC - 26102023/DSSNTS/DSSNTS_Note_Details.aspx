<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DSSNTS_Note_Details.aspx.vb" Inherits="Nexus.PB2_DSSNTS_Note_Details" %>
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "DS_SNOTES" && field.getPropertyName() == "DATE_CREATED")
...
function onValidate_DS_SNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DS_SNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "DS_SNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblDS_SNOTES_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_DS_SNOTES__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_DS_SNOTES__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_DS_SNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DS_SNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "DS_SNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblDS_SNOTES_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_DS_SNOTES__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_DS_SNOTES__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
<div id="idcbeb12e6430c4c7a9e1cc17d8ed59599" class="general-layout-container">
...
<div id="id264688bd21de436c8f11a60df0a628f4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading279" runat="server" Text="Note Details (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id264688bd21de436c8f11a60df0a628f4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id264688bd21de436c8f11a60df0a628f4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id264688bd21de436c8f11a60df0a628f4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id264688bd21de436c8f11a60df0a628f4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id264688bd21de436c8f11a60df0a628f4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id264688bd21de436c8f11a60df0a628f4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id264688bd21de436c8f11a60df0a628f4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id264688bd21de436c8f11a60df0a628f4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id264688bd21de436c8f11a60df0a628f4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id264688bd21de436c8f11a60df0a628f4 input{text-align:left;}"; break;
		}
	}
