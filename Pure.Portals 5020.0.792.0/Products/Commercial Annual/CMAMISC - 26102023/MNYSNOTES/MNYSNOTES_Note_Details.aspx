...
<div id="id956b9214f0344d4190b879a26fb83c3f" class="general-layout-container">
...
<div id="id8ecc9a1dc6c0427b867475def8b5a68e" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8ecc9a1dc6c0427b867475def8b5a68e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8ecc9a1dc6c0427b867475def8b5a68e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8ecc9a1dc6c0427b867475def8b5a68e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8ecc9a1dc6c0427b867475def8b5a68e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8ecc9a1dc6c0427b867475def8b5a68e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8ecc9a1dc6c0427b867475def8b5a68e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8ecc9a1dc6c0427b867475def8b5a68e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8ecc9a1dc6c0427b867475def8b5a68e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8ecc9a1dc6c0427b867475def8b5a68e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8ecc9a1dc6c0427b867475def8b5a68e input{text-align:left;}"; break;
		}
	}
