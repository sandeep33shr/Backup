<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMSSOUND_Sound_Equipment.aspx.vb" Inherits="Nexus.PB2_CMAMSSOUND_Sound_Equipment" %>
...
function onValidate_SOUND__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SOUND", "DESCRIPTION");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND__DESCRIPTION_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "SOUND", "DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_SOUND__LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND", "LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SOUND", "LIMIT");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_LIMIT");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND__LIMIT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND__LIMIT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND.LIMIT");
        			window.setControlWidth(field, "0.8", "SOUND", "LIMIT");
        		})();
        	}
        })();
...
function onValidate_SOUND__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SOUND", "PREMIUM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SOUND", "PREMIUM");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND.PREMIUM");
        			window.setControlWidth(field, "0.8", "SOUND", "PREMIUM");
        		})();
        	}
        })();
        /**
...
function onValidate_SOUND__FAP_PER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND", "FAP_PER", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SOUND", "FAP_PER");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SOUND", "FAP_PER");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_FAP_PER");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND__FAP_PER');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND__FAP_PER_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND.FAP_PER");
        			window.setControlWidth(field, "0.5", "SOUND", "FAP_PER");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "SOUND".toUpperCase() + "__" + "FAP_PER");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "SOUND".toUpperCase() + "_" + "FAP_PER");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("SOUND.FAP_PER > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_SOUND__FAP_AMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND", "FAP_AMT", "Currency");
        })();
        /**
         * @fileoverview SetFormat, Set the formatting of a field
         * @param {string} firstParam Takes the format pattern the field should be displayed in
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SOUND", "FAP_AMT");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_FAP_AMT");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND__FAP_AMT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND__FAP_AMT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND.FAP_AMT");
        			window.setControlWidth(field, "0.8", "SOUND", "FAP_AMT");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=SOUND&propertyName=FAP_AMT&name={name}");
...
function DoLogic(isOnLoad) {
    onValidate_SOUND__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SOUND__LIMIT(null, null, null, isOnLoad);
    onValidate_SOUND__PREMIUM(null, null, null, isOnLoad);
    onValidate_SOUND__FAP_PER(null, null, null, isOnLoad);
    onValidate_SOUND__FAP_AMT(null, null, null, isOnLoad);
}
</script>
...
<div id="id532ec3ae5d874571b8f56cc95f4c7ccf" class="general-layout-container">
...
<div id="id9f618d76962144898e86bf9fc51ed7c2" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading16" runat="server" Text="Specified Sound Equipment" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SOUND" 
		data-property-name="DESCRIPTION" 
		 
		
		 
		id="pb-container-text-SOUND-DESCRIPTION">

		
		<asp:Label ID="lblSOUND_DESCRIPTION" runat="server" AssociatedControlID="SOUND__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SOUND__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSOUND_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SOUND__DESCRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SOUND-LIMIT">
		<asp:Label ID="lblSOUND_LIMIT" runat="server" AssociatedControlID="SOUND__LIMIT" 
			Text="Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SOUND__LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSOUND_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indemnity"
			ClientValidationFunction="onValidate_SOUND__LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SOUND-PREMIUM">
		<asp:Label ID="lblSOUND_PREMIUM" runat="server" AssociatedControlID="SOUND__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SOUND__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSOUND_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SOUND__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SOUND-FAP_PER">
		<asp:Label ID="lblSOUND_FAP_PER" runat="server" AssociatedControlID="SOUND__FAP_PER" 
			Text="FAP %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SOUND__FAP_PER" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSOUND_FAP_PER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP %"
			ClientValidationFunction="onValidate_SOUND__FAP_PER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SOUND-FAP_AMT">
		<asp:Label ID="lblSOUND_FAP_AMT" runat="server" AssociatedControlID="SOUND__FAP_AMT" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SOUND__FAP_AMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSOUND_FAP_AMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_SOUND__FAP_AMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9f618d76962144898e86bf9fc51ed7c2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9f618d76962144898e86bf9fc51ed7c2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9f618d76962144898e86bf9fc51ed7c2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9f618d76962144898e86bf9fc51ed7c2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9f618d76962144898e86bf9fc51ed7c2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9f618d76962144898e86bf9fc51ed7c2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9f618d76962144898e86bf9fc51ed7c2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9f618d76962144898e86bf9fc51ed7c2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9f618d76962144898e86bf9fc51ed7c2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9f618d76962144898e86bf9fc51ed7c2 input{text-align:left;}"; break;
		}
	}
