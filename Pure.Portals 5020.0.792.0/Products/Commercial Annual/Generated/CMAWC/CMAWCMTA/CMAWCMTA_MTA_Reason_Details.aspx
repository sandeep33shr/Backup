<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAWCMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_CMAWCMTA_MTA_Reason_Details" %>
...
function onValidate_MTA_REASON__MTA_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MTA_REASON.MTA_DESCRIPTION");
        			window.setControlWidth(field, "0.4", "MTA_REASON", "MTA_DESCRIPTION");
        		})();
        	}
        })();
        /**
...
<div id="id568e127bd313453387dee5d8aa18e373" class="general-layout-container">
...
<div id="idc9b31fbc748f484390c0a8daa8ae5d3b" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc9b31fbc748f484390c0a8daa8ae5d3b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc9b31fbc748f484390c0a8daa8ae5d3b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc9b31fbc748f484390c0a8daa8ae5d3b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc9b31fbc748f484390c0a8daa8ae5d3b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc9b31fbc748f484390c0a8daa8ae5d3b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc9b31fbc748f484390c0a8daa8ae5d3b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc9b31fbc748f484390c0a8daa8ae5d3b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc9b31fbc748f484390c0a8daa8ae5d3b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc9b31fbc748f484390c0a8daa8ae5d3b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc9b31fbc748f484390c0a8daa8ae5d3b input{text-align:left;}"; break;
		}
	}
