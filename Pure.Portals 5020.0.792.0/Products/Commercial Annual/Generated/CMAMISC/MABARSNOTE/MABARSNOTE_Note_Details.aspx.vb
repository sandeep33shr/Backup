...
Namespace Nexus
    Partial Class PB2_MABARSNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_BAR_SCNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If BAR_SCNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		BAR_SCNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		BAR_SCNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_BAR_SCNOTE_DETAILS__NOTE_DETAILS()
End Sub
