...
<div id="id643bcdadf7e04d43b46ad0055c63748a" class="general-layout-container">
	...
	<span class="field-container"
		...
		<asp:Label ID="lblMB_OEXTENSIONS_COUNTER_ID" runat="server" AssociatedControlID="MB_OEXTENSIONS__COUNTER_ID" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_OEXTENSIONS__COUNTER_ID" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMB_OEXTENSIONS_DESCRIPTION" runat="server" AssociatedControlID="MB_OEXTENSIONS__DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_OEXTENSIONS__DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
