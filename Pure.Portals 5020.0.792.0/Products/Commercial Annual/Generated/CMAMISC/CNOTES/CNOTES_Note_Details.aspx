...
<div id="idfc28b9ff5c3040299a524bd37be1e1f0" class="general-layout-container">
...
<div id="id4c66ac02c65241fdaf3f4fb748f593f1" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCL_NOTES_CREATED_BY" runat="server" AssociatedControlID="CL_NOTES__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CL_NOTES__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCL_NOTES_COVER_TYPE" runat="server" AssociatedControlID="CL_NOTES__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CL_NOTES__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCL_NOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="CL_NOTES__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CL_NOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4c66ac02c65241fdaf3f4fb748f593f1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4c66ac02c65241fdaf3f4fb748f593f1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4c66ac02c65241fdaf3f4fb748f593f1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4c66ac02c65241fdaf3f4fb748f593f1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4c66ac02c65241fdaf3f4fb748f593f1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4c66ac02c65241fdaf3f4fb748f593f1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4c66ac02c65241fdaf3f4fb748f593f1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4c66ac02c65241fdaf3f4fb748f593f1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4c66ac02c65241fdaf3f4fb748f593f1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4c66ac02c65241fdaf3f4fb748f593f1 input{text-align:left;}"; break;
		}
	}
