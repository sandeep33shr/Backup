<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISCMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_CMAMISCMTA_MTA_Reason_Details" %>
...
<div id="id657adc3542f9470e8476bd343d4104b6" class="general-layout-container">
...
<div id="id65331dc4834f4a8ea15004c9a8f9a043" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MTA_REASON" 
		data-property-name="MTA_DESCRIPTIONCode" 
		id="pb-container-Text-MTA_REASON-MTA_DESCRIPTIONCode">
		
		
		<asp:Label ID="lblMTA_REASON_MTA_DESCRIPTIONCode" runat="server" AssociatedControlID="MTA_REASON__MTA_DESCRIPTIONCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MTA_REASON__MTA_DESCRIPTIONCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMTA_REASON_MTA_DESCRIPTIONCode" 
			runat="server" 
			Text="*" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id65331dc4834f4a8ea15004c9a8f9a043 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id65331dc4834f4a8ea15004c9a8f9a043 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id65331dc4834f4a8ea15004c9a8f9a043 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id65331dc4834f4a8ea15004c9a8f9a043 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id65331dc4834f4a8ea15004c9a8f9a043 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65331dc4834f4a8ea15004c9a8f9a043 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65331dc4834f4a8ea15004c9a8f9a043 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id65331dc4834f4a8ea15004c9a8f9a043 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65331dc4834f4a8ea15004c9a8f9a043 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65331dc4834f4a8ea15004c9a8f9a043 input{text-align:left;}"; break;
		}
	}
