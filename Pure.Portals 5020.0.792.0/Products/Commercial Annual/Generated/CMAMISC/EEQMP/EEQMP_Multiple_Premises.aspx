        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("EE_MULTIPLE_PREMISES.LINE1");
        			window.setControlWidth(field, "0.7", "EE_MULTIPLE_PREMISES", "LINE1");
        		})();
        	}
        })();
        /**
...
function onValidate_EE_MULTIPLE_PREMISES__LINE2(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EE_MULTIPLE_PREMISES", "LINE2", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EE_MULTIPLE_PREMISES", "LINE2");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EE_MULTIPLE_PREMISES.LINE2");
        			window.setControlWidth(field, "0.7", "EE_MULTIPLE_PREMISES", "LINE2");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEE_MULTIPLE_PREMISES_LINE2");
        			    var ele = document.getElementById('ctl00_cntMainBody_EE_MULTIPLE_PREMISES__LINE2');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EE_MULTIPLE_PREMISES__LINE2_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_EE_MULTIPLE_PREMISES__LINE3(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EE_MULTIPLE_PREMISES", "LINE3", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EE_MULTIPLE_PREMISES", "LINE3");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EE_MULTIPLE_PREMISES.LINE3");
        			window.setControlWidth(field, "0.7", "EE_MULTIPLE_PREMISES", "LINE3");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEE_MULTIPLE_PREMISES_LINE3");
        			    var ele = document.getElementById('ctl00_cntMainBody_EE_MULTIPLE_PREMISES__LINE3');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EE_MULTIPLE_PREMISES__LINE3_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_EE_MULTIPLE_PREMISES__LINE4(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EE_MULTIPLE_PREMISES", "LINE4", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EE_MULTIPLE_PREMISES", "LINE4");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EE_MULTIPLE_PREMISES.LINE4");
        			window.setControlWidth(field, "0.7", "EE_MULTIPLE_PREMISES", "LINE4");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEE_MULTIPLE_PREMISES_LINE4");
        			    var ele = document.getElementById('ctl00_cntMainBody_EE_MULTIPLE_PREMISES__LINE4');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EE_MULTIPLE_PREMISES__LINE4_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("EE_MULTIPLE_PREMISES.POSTCODE");
        			window.setControlWidth(field, "0.7", "EE_MULTIPLE_PREMISES", "POSTCODE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("EE_MULTIPLE_PREMISES.COUNTRY");
        			window.setControlWidth(field, "0.7", "EE_MULTIPLE_PREMISES", "COUNTRY");
        		})();
        	}
        })();
        /**
...
function onValidate_EE_MULTIPLE_PREMISES__COUNTRY_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EE_MULTIPLE_PREMISES", "COUNTRY_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("EE_MULTIPLE_PREMISES", "COUNTRY_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EE_MULTIPLE_PREMISES&propertyName=COUNTRY_CAP&name={name}");
        		
        		var value = new Expression("Caption(EE_MULTIPLE_PREMISES.COUNTRY)"), 
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EE_MULTIPLE_PREMISES", "SUMINSURED");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("EE_MULTIPLE_PREMISES.SUMINSURED");
        			window.setControlWidth(field, "0.7", "EE_MULTIPLE_PREMISES", "SUMINSURED");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    ...
    onValidate_EE_MULTIPLE_PREMISES__LINE2(null, null, null, isOnLoad);
    onValidate_EE_MULTIPLE_PREMISES__LINE3(null, null, null, isOnLoad);
    onValidate_EE_MULTIPLE_PREMISES__LINE4(null, null, null, isOnLoad);
    ...
    onValidate_EE_MULTIPLE_PREMISES__COUNTRY_CAP(null, null, null, isOnLoad);
...
<div id="idbe86bc8ddc674fbb9d74d5ff8e75adea" class="general-layout-container">
...
<div id="id398249c5867e4ff3b2cf40ba1fcc5699" class="column-layout-container,no-border  ">
	...
	<span class="field-container"
		...
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_COUNTER_ID" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__COUNTER_ID" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EE_MULTIPLE_PREMISES__COUNTER_ID" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_LINE1" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__LINE1" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EE_MULTIPLE_PREMISES__LINE1" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-EE_MULTIPLE_PREMISES-LINE2">
		
		
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_LINE2" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__LINE2" 
			Text="Line 2" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EE_MULTIPLE_PREMISES__LINE2" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEE_MULTIPLE_PREMISES_LINE2" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Line 2"
			ClientValidationFunction="onValidate_EE_MULTIPLE_PREMISES__LINE2" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Text" 
		data-object-name="EE_MULTIPLE_PREMISES" 
		data-property-name="LINE3" 
		id="pb-container-Text-EE_MULTIPLE_PREMISES-LINE3">
		
		
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_LINE3" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__LINE3" 
			Text="Line 3" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EE_MULTIPLE_PREMISES__LINE3" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEE_MULTIPLE_PREMISES_LINE3" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Line 3"
			ClientValidationFunction="onValidate_EE_MULTIPLE_PREMISES__LINE3" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Text" 
		data-object-name="EE_MULTIPLE_PREMISES" 
		data-property-name="LINE4" 
		id="pb-container-Text-EE_MULTIPLE_PREMISES-LINE4">
		
		
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_LINE4" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__LINE4" 
			Text="Line 4" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EE_MULTIPLE_PREMISES__LINE4" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEE_MULTIPLE_PREMISES_LINE4" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Line 4"
			ClientValidationFunction="onValidate_EE_MULTIPLE_PREMISES__LINE4" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_POSTCODE" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__POSTCODE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EE_MULTIPLE_PREMISES__POSTCODE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Text" 
		data-object-name="EE_MULTIPLE_PREMISES" 
		data-property-name="COUNTRY_CAP" 
		id="pb-container-Text-EE_MULTIPLE_PREMISES-COUNTRY_CAP">
		
		
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_COUNTRY_CAP" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__COUNTRY_CAP" 
			Text="Country" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EE_MULTIPLE_PREMISES__COUNTRY_CAP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEE_MULTIPLE_PREMISES_COUNTRY_CAP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Country"
			ClientValidationFunction="onValidate_EE_MULTIPLE_PREMISES__COUNTRY_CAP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_COUNTRYCode" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__COUNTRYCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EE_MULTIPLE_PREMISES__COUNTRYCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEE_MULTIPLE_PREMISES_COUNTRYCode" 
			runat="server" 
			Text="*" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id398249c5867e4ff3b2cf40ba1fcc5699 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id398249c5867e4ff3b2cf40ba1fcc5699 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id398249c5867e4ff3b2cf40ba1fcc5699 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id398249c5867e4ff3b2cf40ba1fcc5699 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id398249c5867e4ff3b2cf40ba1fcc5699 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id398249c5867e4ff3b2cf40ba1fcc5699 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id398249c5867e4ff3b2cf40ba1fcc5699 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id398249c5867e4ff3b2cf40ba1fcc5699 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id398249c5867e4ff3b2cf40ba1fcc5699 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id398249c5867e4ff3b2cf40ba1fcc5699 input{text-align:left;}"; break;
		}
	}
