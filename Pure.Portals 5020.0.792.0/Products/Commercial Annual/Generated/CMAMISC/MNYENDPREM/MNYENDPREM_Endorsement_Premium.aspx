<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MNYENDPREM_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_MNYENDPREM_Endorsement_Premium" %>
...
function onValidate_MONEY_CLAUSEPREM__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEY_CLAUSEPREM", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MONEY_CLAUSEPREM", "COUNTER_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MONEY_CLAUSEPREM&propertyName=COUNTER_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "MONEY_CLAUSEPREM" && field.getPropertyName() == "COUNTER_ID")
...
function onValidate_MONEY_CLAUSEPREM__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEY_CLAUSEPREM", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MONEY_CLAUSEPREM", "ENDORSE_ID");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_MONEY_CLAUSEPREM__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEY_CLAUSEPREM", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MONEY_CLAUSEPREM", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MONEY_CLAUSEPREM.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "MONEY_CLAUSEPREM", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMONEY_CLAUSEPREM_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_MONEY_CLAUSEPREM__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MONEY_CLAUSEPREM__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_MONEY_CLAUSEPREM__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEY_CLAUSEPREM", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MONEY_CLAUSEPREM", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MONEY_CLAUSEPREM&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(MONEY_CLAUSEPREM.ENDORSE_DESC)"), 
...
function onValidate_MONEY_CLAUSEPREM__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEY_CLAUSEPREM", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MONEY_CLAUSEPREM", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MONEY_CLAUSEPREM.PREMIUM");
        			window.setControlWidth(field, "0.4", "MONEY_CLAUSEPREM", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMONEY_CLAUSEPREM_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MONEY_CLAUSEPREM__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MONEY_CLAUSEPREM__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_MONEY_CLAUSEPREM__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_MONEY_CLAUSEPREM__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_MONEY_CLAUSEPREM__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_MONEY_CLAUSEPREM__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_MONEY_CLAUSEPREM__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id3a85e402b5c84c788678a62cea0f38a2" class="general-layout-container">
...
<div id="id6392274e583347bd9ca319deda84db98" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading79" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MONEY_CLAUSEPREM" 
		data-property-name="COUNTER_ID" 
		id="pb-container-Text-MONEY_CLAUSEPREM-COUNTER_ID">
		
		
		<asp:Label ID="lblMONEY_CLAUSEPREM_COUNTER_ID" runat="server" AssociatedControlID="MONEY_CLAUSEPREM__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEY_CLAUSEPREM__COUNTER_ID" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMONEY_CLAUSEPREM_COUNTER_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for ID"
			ClientValidationFunction="onValidate_MONEY_CLAUSEPREM__COUNTER_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-MONEY_CLAUSEPREM-ENDORSE_ID">
		<asp:Label ID="lblMONEY_CLAUSEPREM_ENDORSE_ID" runat="server" AssociatedControlID="MONEY_CLAUSEPREM__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MONEY_CLAUSEPREM__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMONEY_CLAUSEPREM_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_MONEY_CLAUSEPREM__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-MONEY_CLAUSEPREM-ENDORSE_DESC">
		<asp:Label ID="lblMONEY_CLAUSEPREM_ENDORSE_DESC" runat="server" AssociatedControlID="MONEY_CLAUSEPREM__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="MONEY_CLAUSEPREM__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_MONEY_CLAUSEPREM__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valMONEY_CLAUSEPREM_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_MONEY_CLAUSEPREM__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-MONEY_CLAUSEPREM-ENDORSE_CAP">
		
		
		<asp:Label ID="lblMONEY_CLAUSEPREM_ENDORSE_CAP" runat="server" AssociatedControlID="MONEY_CLAUSEPREM__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEY_CLAUSEPREM__ENDORSE_CAP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMONEY_CLAUSEPREM_ENDORSE_CAP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_MONEY_CLAUSEPREM__ENDORSE_CAP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MONEY_CLAUSEPREM-PREMIUM">
		<asp:Label ID="lblMONEY_CLAUSEPREM_PREMIUM" runat="server" AssociatedControlID="MONEY_CLAUSEPREM__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEY_CLAUSEPREM__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMONEY_CLAUSEPREM_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_MONEY_CLAUSEPREM__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-MONEY_CLAUSEPREM-ENDORSE_DESCCode">
		
		
		<asp:Label ID="lblMONEY_CLAUSEPREM_ENDORSE_DESCCode" runat="server" AssociatedControlID="MONEY_CLAUSEPREM__ENDORSE_DESCCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEY_CLAUSEPREM__ENDORSE_DESCCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMONEY_CLAUSEPREM_ENDORSE_DESCCode" 
			runat="server" 
			Text="*" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6392274e583347bd9ca319deda84db98 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6392274e583347bd9ca319deda84db98 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6392274e583347bd9ca319deda84db98 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6392274e583347bd9ca319deda84db98 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6392274e583347bd9ca319deda84db98 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6392274e583347bd9ca319deda84db98 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6392274e583347bd9ca319deda84db98 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6392274e583347bd9ca319deda84db98 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6392274e583347bd9ca319deda84db98 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6392274e583347bd9ca319deda84db98 input{text-align:left;}"; break;
		}
	}
