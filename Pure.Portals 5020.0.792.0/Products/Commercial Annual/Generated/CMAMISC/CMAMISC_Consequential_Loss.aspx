        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "TYPE");
        		}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "BASIS");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "IND_PER_UNIT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "IND_PER");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "SUM_INSURED");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CLOSS__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=CLOSS&propertyName=RATE&name={name}");
...
function onValidate_CLOSS__POSTPREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "POSTPREMIUM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=POSTPREMIUM&name={name}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "TIME_EX_UNIT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CLOSS__AICOW_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "CLOSS.IS_AICOW = 1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CLOSS.AICOW_SUMINSURED"), 
        			condition = (Expression.isValidParameter("CLOSS.IS_AICOW = 1")) ? new Expression("CLOSS.IS_AICOW = 1") : null, 
        			elseValue = (Expression.isValidParameter("''")) ? new Expression("''") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.AICOW_POST_PREMIUM.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLOSS__AICOW_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CLOSS.AICOW_RATE"), 
        			condition = (Expression.isValidParameter("CLOSS.IS_AICOW = 1")) ? new Expression("CLOSS.IS_AICOW = 1") : null, 
        			elseValue = (Expression.isValidParameter("''")) ? new Expression("''") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CLOSS.AICOW_POST_PREMIUM / CLOSS.AICOW_SUMINSURED * 100"), 
        			condition = (Expression.isValidParameter("CLOSS.AICOW_POST_PREMIUM > 0")) ? new Expression("CLOSS.AICOW_POST_PREMIUM > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_CLOSS__AICOW_POST_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CLOSS.AICOW_AICOW_POST_PREMIUM"), 
        			condition = (Expression.isValidParameter("CLOSS.IS_AICOW = 1")) ? new Expression("CLOSS.IS_AICOW = 1") : null, 
        			elseValue = (Expression.isValidParameter("''")) ? new Expression("''") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CLOSS.AICOW_SUMINSURED * CLOSS.AICOW_RATE / 100"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_CLOSS__AICOW_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CLOSS.AICOW_FAP"), 
        			condition = (Expression.isValidParameter("CLOSS.IS_AICOW = 1")) ? new Expression("CLOSS.IS_AICOW = 1") : null, 
        			elseValue = (Expression.isValidParameter("''")) ? new Expression("''") : null;
...
function onValidate_CLOSS__AICOW_MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CLOSS.AICOW_AICOW_MIN_AMOUNT"), 
        			condition = (Expression.isValidParameter("CLOSS.IS_AICOW = 1")) ? new Expression("CLOSS.IS_AICOW = 1") : null, 
        			elseValue = (Expression.isValidParameter("''")) ? new Expression("''") : null;
...
<div id="id6b38f0289e6348059aa4be8e603b12f0" class="general-layout-container">
...
<div id="ide162dcceb37547948a90c3908fc61c10" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide162dcceb37547948a90c3908fc61c10 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide162dcceb37547948a90c3908fc61c10 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide162dcceb37547948a90c3908fc61c10 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide162dcceb37547948a90c3908fc61c10 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide162dcceb37547948a90c3908fc61c10 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide162dcceb37547948a90c3908fc61c10 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide162dcceb37547948a90c3908fc61c10 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide162dcceb37547948a90c3908fc61c10 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide162dcceb37547948a90c3908fc61c10 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide162dcceb37547948a90c3908fc61c10 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id706d07affa7e4d53bc7535c39d0c06f9" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id706d07affa7e4d53bc7535c39d0c06f9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id706d07affa7e4d53bc7535c39d0c06f9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id706d07affa7e4d53bc7535c39d0c06f9 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id706d07affa7e4d53bc7535c39d0c06f9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id706d07affa7e4d53bc7535c39d0c06f9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id706d07affa7e4d53bc7535c39d0c06f9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id706d07affa7e4d53bc7535c39d0c06f9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id706d07affa7e4d53bc7535c39d0c06f9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id706d07affa7e4d53bc7535c39d0c06f9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id706d07affa7e4d53bc7535c39d0c06f9 input{text-align:left;}"; break;
		}
	}
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLOSS_IND_PER" runat="server" AssociatedControlID="CLOSS__IND_PER" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__IND_PER" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLOSS_TIME_EXC" runat="server" AssociatedControlID="CLOSS__TIME_EXC" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__TIME_EXC" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLOSS_TYPECode" runat="server" AssociatedControlID="CLOSS__TYPECode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__TYPECode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_TYPECode" 
			runat="server" 
			Text="*" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLOSS_BASISCode" runat="server" AssociatedControlID="CLOSS__BASISCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__BASISCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_BASISCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLOSS_IND_PER_UNITCode" runat="server" AssociatedControlID="CLOSS__IND_PER_UNITCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__IND_PER_UNITCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_IND_PER_UNITCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLOSS_TIME_EX_UNITCode" runat="server" AssociatedControlID="CLOSS__TIME_EX_UNITCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__TIME_EX_UNITCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_TIME_EX_UNITCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
				...
				<div data-column-count="7" data-column-ratio="4:20:16:14:16:14:16" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:4%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label631">
		<span class="label" id="label631"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label633">
		<span class="label" id="label633">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label634">
		<span class="label" id="label634">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label635">
		<span class="label" id="label635">Posting Premium </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label636">
		<span class="label" id="label636">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label637">
		<span class="label" id="label637">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label638">
		<span class="label" id="label638">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label639">
		<span class="label" id="label639"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label641">
		<span class="label" id="label641">Additional Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label642">
		<span class="label" id="label642">Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label643">
		<span class="label" id="label643"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label644">
		<span class="label" id="label644">Total</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label645">
		<span class="label" id="label645"></span>
	</span>
<!-- /Label -->
