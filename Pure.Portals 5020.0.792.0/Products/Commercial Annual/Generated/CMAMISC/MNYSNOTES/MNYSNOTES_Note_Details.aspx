...
<div id="idf208c3fe56b74123ba6529286baead05" class="general-layout-container">
...
<div id="id511e346dd91c4acaa7f6d57a3bbdc50a" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMONEY_SCNOTE_DETAILS_CREATED_BY" runat="server" AssociatedControlID="MONEY_SCNOTE_DETAILS__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEY_SCNOTE_DETAILS__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMONEY_SCNOTE_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="MONEY_SCNOTE_DETAILS__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEY_SCNOTE_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMONEY_SCNOTE_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="MONEY_SCNOTE_DETAILS__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEY_SCNOTE_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id511e346dd91c4acaa7f6d57a3bbdc50a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id511e346dd91c4acaa7f6d57a3bbdc50a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id511e346dd91c4acaa7f6d57a3bbdc50a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id511e346dd91c4acaa7f6d57a3bbdc50a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id511e346dd91c4acaa7f6d57a3bbdc50a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id511e346dd91c4acaa7f6d57a3bbdc50a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id511e346dd91c4acaa7f6d57a3bbdc50a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id511e346dd91c4acaa7f6d57a3bbdc50a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id511e346dd91c4acaa7f6d57a3bbdc50a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id511e346dd91c4acaa7f6d57a3bbdc50a input{text-align:left;}"; break;
		}
	}
