<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="GPAENDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_GPAENDOS_Endorsement_Premium" %>
...
function onValidate_GPA_ENDOSE__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSE", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GPA_ENDOSE", "COUNTER_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GPA_ENDOSE&propertyName=COUNTER_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "GPA_ENDOSE" && field.getPropertyName() == "COUNTER_ID")
...
function onValidate_GPA_ENDOSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GPA_ENDOSE", "ENDORSE_ID");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GPA_ENDOSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GPA_ENDOSE", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPA_ENDOSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "GPA_ENDOSE", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGPA_ENDOSE_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_GPA_ENDOSE__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GPA_ENDOSE__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_GPA_ENDOSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GPA_ENDOSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPA_ENDOSE.ENDORSE_CAP");
        			window.setControlWidth(field, "0.4", "GPA_ENDOSE", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGPA_ENDOSE_ENDORSE_CAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_GPA_ENDOSE__ENDORSE_CAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GPA_ENDOSE__ENDORSE_CAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GPA_ENDOSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(GPA_ENDOSE.ENDORSE_DESC)"), 
...
function onValidate_GPA_ENDOSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GPA_ENDOSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPA_ENDOSE.PREMIUM");
        			window.setControlWidth(field, "0.4", "GPA_ENDOSE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGPA_ENDOSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_GPA_ENDOSE__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GPA_ENDOSE__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_GPA_ENDOSE__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_GPA_ENDOSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_GPA_ENDOSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_GPA_ENDOSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_GPA_ENDOSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="ide25cb88cc3ee4e0f9311b0fa2b79d2b2" class="general-layout-container">
...
<div id="id820ea762aa5445d689d4a5f2bee98a12" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading123" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GPA_ENDOSE" 
		data-property-name="COUNTER_ID" 
		id="pb-container-Text-GPA_ENDOSE-COUNTER_ID">
		
		
		<asp:Label ID="lblGPA_ENDOSE_COUNTER_ID" runat="server" AssociatedControlID="GPA_ENDOSE__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GPA_ENDOSE__COUNTER_ID" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGPA_ENDOSE_COUNTER_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for ID"
			ClientValidationFunction="onValidate_GPA_ENDOSE__COUNTER_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-GPA_ENDOSE-ENDORSE_ID">
		<asp:Label ID="lblGPA_ENDOSE_ENDORSE_ID" runat="server" AssociatedControlID="GPA_ENDOSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="GPA_ENDOSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valGPA_ENDOSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_GPA_ENDOSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-GPA_ENDOSE-ENDORSE_DESC">
		<asp:Label ID="lblGPA_ENDOSE_ENDORSE_DESC" runat="server" AssociatedControlID="GPA_ENDOSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="GPA_ENDOSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_GPA_ENDOSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valGPA_ENDOSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_GPA_ENDOSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-GPA_ENDOSE-ENDORSE_CAP">
		
		
		<asp:Label ID="lblGPA_ENDOSE_ENDORSE_CAP" runat="server" AssociatedControlID="GPA_ENDOSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GPA_ENDOSE__ENDORSE_CAP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGPA_ENDOSE_ENDORSE_CAP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_GPA_ENDOSE__ENDORSE_CAP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-GPA_ENDOSE-PREMIUM">
		<asp:Label ID="lblGPA_ENDOSE_PREMIUM" runat="server" AssociatedControlID="GPA_ENDOSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GPA_ENDOSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGPA_ENDOSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_GPA_ENDOSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-GPA_ENDOSE-ENDORSE_DESCCode">
		
		
		<asp:Label ID="lblGPA_ENDOSE_ENDORSE_DESCCode" runat="server" AssociatedControlID="GPA_ENDOSE__ENDORSE_DESCCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GPA_ENDOSE__ENDORSE_DESCCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGPA_ENDOSE_ENDORSE_DESCCode" 
			runat="server" 
			Text="*" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id820ea762aa5445d689d4a5f2bee98a12 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id820ea762aa5445d689d4a5f2bee98a12 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id820ea762aa5445d689d4a5f2bee98a12 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id820ea762aa5445d689d4a5f2bee98a12 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id820ea762aa5445d689d4a5f2bee98a12 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id820ea762aa5445d689d4a5f2bee98a12 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id820ea762aa5445d689d4a5f2bee98a12 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id820ea762aa5445d689d4a5f2bee98a12 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id820ea762aa5445d689d4a5f2bee98a12 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id820ea762aa5445d689d4a5f2bee98a12 input{text-align:left;}"; break;
		}
	}
