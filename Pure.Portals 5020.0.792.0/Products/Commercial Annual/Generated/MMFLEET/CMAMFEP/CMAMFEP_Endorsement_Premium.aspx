<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMFEP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CMAMFEP_Endorsement_Premium" %>
...
function onValidate_CLAUSEPREM__ENDORSE_DESC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREM.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "CLAUSEPREM", "ENDORSE_DESC");
        		})();
        	}
        })();
}
...
function onValidate_CLAUSEPREM__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREM.PREMIUM");
        			window.setControlWidth(field, "0.5", "CLAUSEPREM", "PREMIUM");
        		})();
        	}
        })();
        /**
...
<div id="idde56aafb348c493d83f2c98efa41c617" class="general-layout-container">
...
<div id="id951a4d4e6a9749c7b92aa129b3075ff9" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLAUSEPREM_ENDORSE_CAP" runat="server" AssociatedControlID="CLAUSEPREM__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLAUSEPREM__ENDORSE_CAP" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLAUSEPREM_ENDORSE_DESCCode" runat="server" AssociatedControlID="CLAUSEPREM__ENDORSE_DESCCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLAUSEPREM__ENDORSE_DESCCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLAUSEPREM_ENDORSE_DESCCode" 
			runat="server" 
			Text="*" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id951a4d4e6a9749c7b92aa129b3075ff9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id951a4d4e6a9749c7b92aa129b3075ff9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id951a4d4e6a9749c7b92aa129b3075ff9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id951a4d4e6a9749c7b92aa129b3075ff9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id951a4d4e6a9749c7b92aa129b3075ff9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id951a4d4e6a9749c7b92aa129b3075ff9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id951a4d4e6a9749c7b92aa129b3075ff9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id951a4d4e6a9749c7b92aa129b3075ff9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id951a4d4e6a9749c7b92aa129b3075ff9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id951a4d4e6a9749c7b92aa129b3075ff9 input{text-align:left;}"; break;
		}
	}
