...
<div id="idc5bcdb95a2b74f4d80e6379fb7156a54" class="general-layout-container">
	...
	<span class="field-container"
		...
		<asp:Label ID="lblINT_PARTIES_NAME" runat="server" AssociatedControlID="INT_PARTIES__NAME" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="INT_PARTIES__NAME" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblINT_PARTIES_REGNO" runat="server" AssociatedControlID="INT_PARTIES__REGNO" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="INT_PARTIES__REGNO" runat="server" CssClass="form-control" />
		   </div>
