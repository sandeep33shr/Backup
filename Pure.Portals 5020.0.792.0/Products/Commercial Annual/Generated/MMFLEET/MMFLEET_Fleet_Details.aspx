<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MMFLEET_Fleet_Details.aspx.vb" Inherits="Nexus.PB2_MMFLEET_Fleet_Details" %>
...
function onValidate_FLEET__TOTAL_PREM_ES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "TOTAL_PREM_ES", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FLEET", "TOTAL_PREM_ES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FLEET.TOTAL_PREM_ES");
        			window.setControlWidth(field, "0.8", "FLEET", "TOTAL_PREM_ES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFLEET_TOTAL_PREM_ES");
        			    var ele = document.getElementById('ctl00_cntMainBody_FLEET__TOTAL_PREM_ES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FLEET__TOTAL_PREM_ES_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=FLEET&propertyName=TOTAL_PREM_ES&name={name}");
        		
        		var value = new Expression("FLEET.TOTAL_PREMIUM + FLEET.SOUND_PREM"), 
...
function onValidate_FLEET__DEP_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "FLEET.FLEET_OPTION = 1 or FLEET.FLEET_OPTION = 2", "VE", "{3}");
        
            var paramValue = "V",
            paramCondition = "FLEET.FLEET_OPTION = 1 or FLEET.FLEET_OPTION = 2",
            paramElseValue = "VE",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.FD_DEP_PER"), 
        			condition = (Expression.isValidParameter("FLEET.FLEET_OPTION = 2")) ? new Expression("FLEET.FLEET_OPTION = 2") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("FLEET.FLEET_OPTION = 1")) ? new Expression("FLEET.FLEET_OPTION = 1") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("FLEET.TOTAL_PREMIUM * FLEET.DEP_RATE/100"), 
        			condition = (Expression.isValidParameter("FLEET.FLEET_OPTION = 3 OR FLEET.FLEET_OPTION = 2")) ? new Expression("FLEET.FLEET_OPTION = 3 OR FLEET.FLEET_OPTION = 2") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("FLEET.TOTAL_PREMIUM * FLEET.FRETAINED_RATE/100"), 
        			condition = (Expression.isValidParameter("FLEET.FLEET_OPTIONCode = 3 OR FLEET.FLEET_OPTION = 2")) ? new Expression("FLEET.FLEET_OPTIONCode = 3 OR FLEET.FLEET_OPTION = 2") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Motor Fleet - ' + Caption(FLEET.TYPEFLEET) + ' - '+ ADDRESS.LINE1"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_FLEET__CMAMFFLEET(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "CMAMFFLEET", "ChildScreen");
        })();
}
function onValidate_FLEET__CMAMFVDET(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "CMAMFVDET", "ChildScreen");
        })();
}
function onValidate_FLEET__CMAMFSOUND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "CMAMFSOUND", "ChildScreen");
        })();
}
...
function onValidate_FLEET__CMAMFPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "CMAMFPARTY", "ChildScreen");
        })();
}
...
function onValidate_FLEET__FAP_ODMIN_PER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "FLEET.COVERTYPE = 2", "VEM", "Basic - Own Damage (Sub-Section A) FAP % is mandatory and an amount must be entered");
        
            var paramValue = "V",
            paramCondition = "FLEET.COVERTYPE = 2",
            paramElseValue = "VEM",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#00000000";
        		var condition = (Expression.isValidParameter("FLEET.COVERTYPE = 2")) ? new Expression("FLEET.COVERTYPE = 2") : null;
        		var elseColour = (Expression.isValidParameter("#FFFFD9")) ? "#FFFFD9" : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("FAP% cannot be greater than 100%")) ? "FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FLEET".toUpperCase() + "__" + "FAP_ODMIN_PER");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FLEET".toUpperCase() + "_" + "FAP_ODMIN_PER");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("FLEET.FAP_ODMIN_PER<= 100 || (FLEET.FAP_ODMIN_PER == '' || FLEET.FAP_ODMIN_PER == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=FLEET&propertyName=FAP_ODMIN_PER&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("FLEET.COVERTYPE = 2")) ? new Expression("FLEET.COVERTYPE = 2") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_FLEET__FAP_ODMIN_AMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "FLEET.COVERTYPE = 2", "VEM", "Basic - Own Damage (Sub-Section A) Minimum Amount is mandatory and an amount must be entered");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=FLEET&propertyName=FAP_ODMIN_AMT&name={name}");
...
function onValidate_FLEET__FAP_THMIN_PER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=FLEET&propertyName=FAP_THMIN_PER&name={name}");
...
function onValidate_FLEET__FAP_THMIN_AMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=FLEET&propertyName=FAP_THMIN_AMT&name={name}");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_FLEET__TOTAL_PREM_ES(null, null, null, isOnLoad);
    ...
    onValidate_FLEET__CMAMFFLEET(null, null, null, isOnLoad);
    onValidate_FLEET__CMAMFVDET(null, null, null, isOnLoad);
    onValidate_FLEET__CMAMFSOUND(null, null, null, isOnLoad);
    onValidate_FLEET__SOUND_PREM(null, null, null, isOnLoad);
    onValidate_FLEET__COUNT_SOUND(null, null, null, isOnLoad);
    onValidate_FLEET__CMAMFPARTY(null, null, null, isOnLoad);
...
<div id="id52528add160e4181a1c6649ba9310f6e" class="general-layout-container">
...
<div id="idc41edc050753475c8c995728653c64c3" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading18" runat="server" Text="Motor Fleet Premium Basis" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="FLEET" 
		data-property-name="TOTAL_PREM_ES" 
		id="pb-container-currency-FLEET-TOTAL_PREM_ES">
		<asp:Label ID="lblFLEET_TOTAL_PREM_ES" runat="server" AssociatedControlID="FLEET__TOTAL_PREM_ES" 
			Text="Total Fleet And Sound Equipment Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FLEET__TOTAL_PREM_ES" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFLEET_TOTAL_PREM_ES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Fleet And Sound Equipment Premium"
			ClientValidationFunction="onValidate_FLEET__TOTAL_PREM_ES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblFLEET_FLEET_OPTIONCode" runat="server" AssociatedControlID="FLEET__FLEET_OPTIONCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FLEET__FLEET_OPTIONCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFLEET_FLEET_OPTIONCode" 
			runat="server" 
			Text="*" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc41edc050753475c8c995728653c64c3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc41edc050753475c8c995728653c64c3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc41edc050753475c8c995728653c64c3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc41edc050753475c8c995728653c64c3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc41edc050753475c8c995728653c64c3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc41edc050753475c8c995728653c64c3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc41edc050753475c8c995728653c64c3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc41edc050753475c8c995728653c64c3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc41edc050753475c8c995728653c64c3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc41edc050753475c8c995728653c64c3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id52c7c3485c1f496aa9cfe2decbd71096" class="column-layout-container,no-border  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label5">
		<span class="label" id="label5">Percentage</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label7">
		<span class="label" id="label7">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label8">
		<span class="label" id="label8">Deposit</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label10">
		<span class="label" id="label10">Retained Fund - 1st</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label12">
		<span class="label" id="label12">Retained Fund - 2nd</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id52c7c3485c1f496aa9cfe2decbd71096 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id52c7c3485c1f496aa9cfe2decbd71096 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id52c7c3485c1f496aa9cfe2decbd71096 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id52c7c3485c1f496aa9cfe2decbd71096 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id52c7c3485c1f496aa9cfe2decbd71096 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id52c7c3485c1f496aa9cfe2decbd71096 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id52c7c3485c1f496aa9cfe2decbd71096 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id52c7c3485c1f496aa9cfe2decbd71096 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id52c7c3485c1f496aa9cfe2decbd71096 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id52c7c3485c1f496aa9cfe2decbd71096 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idbea1593c63e145ea9f83f6467886655e" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblFLEET_TYPE_OF_AGGRCode" runat="server" AssociatedControlID="FLEET__TYPE_OF_AGGRCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FLEET__TYPE_OF_AGGRCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFLEET_TYPE_OF_AGGRCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idbea1593c63e145ea9f83f6467886655e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbea1593c63e145ea9f83f6467886655e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbea1593c63e145ea9f83f6467886655e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idbea1593c63e145ea9f83f6467886655e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbea1593c63e145ea9f83f6467886655e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbea1593c63e145ea9f83f6467886655e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbea1593c63e145ea9f83f6467886655e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbea1593c63e145ea9f83f6467886655e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbea1593c63e145ea9f83f6467886655e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbea1593c63e145ea9f83f6467886655e input{text-align:left;}"; break;
		}
	}
...
<div id="frmFleetDetails" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading21" runat="server" Text="Fleet Cover Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblFLEET_TYPEFLEETCode" runat="server" AssociatedControlID="FLEET__TYPEFLEETCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FLEET__TYPEFLEETCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFLEET_TYPEFLEETCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblFLEET_COVERTYPECode" runat="server" AssociatedControlID="FLEET__COVERTYPECode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FLEET__COVERTYPECode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFLEET_COVERTYPECode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div id="frmFleetDetails" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading22" runat="server" Text="Fleet Details" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FLEET__CMAMFFLEET"
		data-field-type="Child" 
		data-object-name="FLEET" 
		data-property-name="CMAMFFLEET" 
		id="pb-container-childscreen-FLEET-CMAMFFLEET">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FLEET__FLEET_DETAILS" runat="server" ScreenCode="CMAMFFLEET" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMFFLEET/CMAMFFLEET_Fleet_Cover_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Number of Units" DataField="NO_UNITS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFLEET_CMAMFFLEET" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FLEET.CMAMFFLEET"
						ClientValidationFunction="onValidate_FLEET__CMAMFFLEET" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4ff9c7c5a9b14682bd4b18e2db586491" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading23" runat="server" Text="Vehicle Details" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FLEET__CMAMFVDET"
		data-field-type="Child" 
		data-object-name="FLEET" 
		data-property-name="CMAMFVDET" 
		id="pb-container-childscreen-FLEET-CMAMFVDET">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FLEET__VEHICLE_DETAILS" runat="server" ScreenCode="CMAMFVDET" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMFVDET/CMAMFVDET_Vehicle_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Sum Insured" DataField="SUMINSURED" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFLEET_CMAMFVDET" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FLEET.CMAMFVDET"
						ClientValidationFunction="onValidate_FLEET__CMAMFVDET" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4ff9c7c5a9b14682bd4b18e2db586491 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4ff9c7c5a9b14682bd4b18e2db586491 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4ff9c7c5a9b14682bd4b18e2db586491 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4ff9c7c5a9b14682bd4b18e2db586491 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4ff9c7c5a9b14682bd4b18e2db586491 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4ff9c7c5a9b14682bd4b18e2db586491 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4ff9c7c5a9b14682bd4b18e2db586491 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4ff9c7c5a9b14682bd4b18e2db586491 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4ff9c7c5a9b14682bd4b18e2db586491 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4ff9c7c5a9b14682bd4b18e2db586491 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd8c128a1a82a4c7983c07eb844becd28" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading24" runat="server" Text="Specified Sound Equipment" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FLEET__CMAMFSOUND"
		data-field-type="Child" 
		data-object-name="FLEET" 
		data-property-name="CMAMFSOUND" 
		id="pb-container-childscreen-FLEET-CMAMFSOUND">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FLEET__SOUND_EQUIPMENT" runat="server" ScreenCode="CMAMFSOUND" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMFSOUND/CMAMFSOUND_Sound_Equipment.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Minimum Amount" DataField="FAP_AMT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valFLEET_CMAMFSOUND" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FLEET.CMAMFSOUND"
						ClientValidationFunction="onValidate_FLEET__CMAMFSOUND" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd8c128a1a82a4c7983c07eb844becd28 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd8c128a1a82a4c7983c07eb844becd28 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd8c128a1a82a4c7983c07eb844becd28 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd8c128a1a82a4c7983c07eb844becd28 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd8c128a1a82a4c7983c07eb844becd28 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd8c128a1a82a4c7983c07eb844becd28 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd8c128a1a82a4c7983c07eb844becd28 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd8c128a1a82a4c7983c07eb844becd28 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd8c128a1a82a4c7983c07eb844becd28 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd8c128a1a82a4c7983c07eb844becd28 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7421b58b733040259f2d7a133cecbdc2" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FLEET__CMAMFPARTY"
		data-field-type="Child" 
		data-object-name="FLEET" 
		data-property-name="CMAMFPARTY" 
		id="pb-container-childscreen-FLEET-CMAMFPARTY">
		
		    <legend>Interest Parties </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FLEET__INT_PARTIES" runat="server" ScreenCode="CMAMFPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMFPARTY/CMAMFPARTY_Interest_Parties.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Vehicle Registration Number" DataField="REGNO" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFLEET_CMAMFPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Interest Parties "
						ClientValidationFunction="onValidate_FLEET__CMAMFPARTY" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7421b58b733040259f2d7a133cecbdc2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7421b58b733040259f2d7a133cecbdc2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7421b58b733040259f2d7a133cecbdc2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7421b58b733040259f2d7a133cecbdc2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7421b58b733040259f2d7a133cecbdc2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7421b58b733040259f2d7a133cecbdc2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7421b58b733040259f2d7a133cecbdc2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7421b58b733040259f2d7a133cecbdc2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7421b58b733040259f2d7a133cecbdc2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7421b58b733040259f2d7a133cecbdc2 input{text-align:left;}"; break;
		}
	}
...
<!-- /Label -->
	...
	<span id="pb-container-label-label18">
		<span class="label" id="label18">Minimum Amount </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label19">
		<span class="label" id="label19">Basic - Own Damage (Sub-Section A)</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label21">
		<span class="label" id="label21">Additional Theft/Hijack</span>
	</span>
<!-- /Label -->
