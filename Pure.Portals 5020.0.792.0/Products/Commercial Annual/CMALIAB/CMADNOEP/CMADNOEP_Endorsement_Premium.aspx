<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMADNOEP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CMADNOEP_Endorsement_Premium" %>
...
function onValidate_CLAUSEPREM__ENDORSE_ID(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=CLAUSEPREM&propertyName=ENDORSE_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "CLAUSEPREM" && field.getPropertyName() == "ENDORSE_ID")
...
function onValidate_CLAUSEPREM__ENDORSE_DESC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREM.ENDORSE_DESC");
        			window.setControlWidth(field, "0.3", "CLAUSEPREM", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
...
function onValidate_CLAUSEPREM__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREM.PREMIUM");
        			window.setControlWidth(field, "0.3", "CLAUSEPREM", "PREMIUM");
        		})();
        	}
        })();
        /**
...
<div id="id41d6b277b6e6437faa20edebd8ce9201" class="general-layout-container">
...
<div id="idb9f81e4d844644ae93c9f939653fd5a3" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading67" runat="server" Text="Endorsement Premium" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb9f81e4d844644ae93c9f939653fd5a3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb9f81e4d844644ae93c9f939653fd5a3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb9f81e4d844644ae93c9f939653fd5a3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb9f81e4d844644ae93c9f939653fd5a3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb9f81e4d844644ae93c9f939653fd5a3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb9f81e4d844644ae93c9f939653fd5a3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb9f81e4d844644ae93c9f939653fd5a3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb9f81e4d844644ae93c9f939653fd5a3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb9f81e4d844644ae93c9f939653fd5a3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb9f81e4d844644ae93c9f939653fd5a3 input{text-align:left;}"; break;
		}
	}
