...
Namespace Nexus
    Partial Class PB2_CMALIAB_Directors_and_Officers : Inherits BaseRisk
		...
		Protected Sub onValidate_DNOLIAB__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_DNOLIAB__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DNOLIAB__ATTACHMENTDATE()
    onValidate_DNOLIAB__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If DNOLIAB__ATTACHMENTDATE.Text = "" or DNOLIAB__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			DNOLIAB__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			DNOLIAB__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (DNOLIAB__ATTACHMENTDATE.Text <> "" Or DNOLIAB__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		DNOLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		DNOLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		DNOLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
