<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MMGEN_Endorsements.aspx.vb" Inherits="Nexus.PB2_MMGEN_Endorsements" %>
...
function onValidate_REFERRAL_CLAUSES__MGENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "REFERRAL_CLAUSES", "MGENDPREM", "ChildScreen");
        })();
}
function onValidate_REFERRAL_CLAUSES__COUNT_ENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "REFERRAL_CLAUSES", "COUNT_ENDPREM", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("REFERRAL_CLAUSES", "COUNT_ENDPREM");
        		}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_REFERRAL_CLAUSES__MGENDPREM(null, null, null, isOnLoad);
    onValidate_REFERRAL_CLAUSES__COUNT_ENDPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="ide0ab1e51f3b54680b97d9aac3c6fa8b1" class="general-layout-container">
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_REFERRAL_CLAUSES__MGENDPREM"
		data-field-type="Child" 
		data-object-name="REFERRAL_CLAUSES" 
		data-property-name="MGENDPREM" 
		id="pb-container-childscreen-REFERRAL_CLAUSES-MGENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="REFERRAL_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="MGENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGENDPREM/MGENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valREFERRAL_CLAUSES_MGENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for REFERRAL_CLAUSES.MGENDPREM"
						ClientValidationFunction="onValidate_REFERRAL_CLAUSES__MGENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-REFERRAL_CLAUSES-COUNT_ENDPREM">
		<asp:Label ID="lblREFERRAL_CLAUSES_COUNT_ENDPREM" runat="server" AssociatedControlID="REFERRAL_CLAUSES__COUNT_ENDPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="REFERRAL_CLAUSES__COUNT_ENDPREM" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valREFERRAL_CLAUSES_COUNT_ENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for REFERRAL_CLAUSES.COUNT_ENDPREM"
			ClientValidationFunction="onValidate_REFERRAL_CLAUSES__COUNT_ENDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
