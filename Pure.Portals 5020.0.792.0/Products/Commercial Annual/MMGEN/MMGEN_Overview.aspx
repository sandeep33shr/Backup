<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MMGEN_Overview.aspx.vb" Inherits="Nexus.PB2_MMGEN_Overview" %>
...
function onValidate_MOTGEN__EXTPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTGEN", "EXTPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOTGEN", "EXTPREM");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOTGEN&propertyName=EXTPREM&name={name}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOTGEN_EXTPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOTGEN__EXTPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOTGEN__EXTPREM_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOTGEN.EXTPREM");
        			window.setControlWidth(field, "0.8", "MOTGEN", "EXTPREM");
        		})();
        	}
        })();
}
function onValidate_MOTGEN__ENDORSPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTGEN", "ENDORSPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOTGEN", "ENDORSPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOTGEN_ENDORSPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOTGEN__ENDORSPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOTGEN__ENDORSPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOTGEN.ENDORSPREM");
        			window.setControlWidth(field, "0.8", "MOTGEN", "ENDORSPREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOTGEN&propertyName=ENDORSPREM&name={name}");
...
function onValidate_MOTGEN__TOTPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTGEN", "TOTPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOTGEN", "TOTPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOTGEN_TOTPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOTGEN__TOTPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOTGEN__TOTPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOTGEN.TOTPREM");
        			window.setControlWidth(field, "0.8", "MOTGEN", "TOTPREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MOTGEN&propertyName=TOTPREM&name={name}");
...
function DoLogic(isOnLoad) {
    onValidate_MOTGEN__EXTPREM(null, null, null, isOnLoad);
    onValidate_MOTGEN__ENDORSPREM(null, null, null, isOnLoad);
    onValidate_MOTGEN__TOTPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id71893246a8244e1891d94b7ddd909532" class="general-layout-container">
...
<div id="id37dc30447b6542f99cd3eff689b78387" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading19" runat="server" Text="Financial Overview" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MOTGEN-EXTPREM">
		<asp:Label ID="lblMOTGEN_EXTPREM" runat="server" AssociatedControlID="MOTGEN__EXTPREM" 
			Text="Cover Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOTGEN__EXTPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOTGEN_EXTPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Cover Premium"
			ClientValidationFunction="onValidate_MOTGEN__EXTPREM" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MOTGEN-ENDORSPREM">
		<asp:Label ID="lblMOTGEN_ENDORSPREM" runat="server" AssociatedControlID="MOTGEN__ENDORSPREM" 
			Text="Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOTGEN__ENDORSPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOTGEN_ENDORSPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement Premium"
			ClientValidationFunction="onValidate_MOTGEN__ENDORSPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MOTGEN-TOTPREM">
		<asp:Label ID="lblMOTGEN_TOTPREM" runat="server" AssociatedControlID="MOTGEN__TOTPREM" 
			Text="Total Risk Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOTGEN__TOTPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOTGEN_TOTPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Risk Premium"
			ClientValidationFunction="onValidate_MOTGEN__TOTPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id37dc30447b6542f99cd3eff689b78387 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id37dc30447b6542f99cd3eff689b78387 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id37dc30447b6542f99cd3eff689b78387 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id37dc30447b6542f99cd3eff689b78387 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id37dc30447b6542f99cd3eff689b78387 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37dc30447b6542f99cd3eff689b78387 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37dc30447b6542f99cd3eff689b78387 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id37dc30447b6542f99cd3eff689b78387 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37dc30447b6542f99cd3eff689b78387 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37dc30447b6542f99cd3eff689b78387 input{text-align:left;}"; break;
		}
	}
