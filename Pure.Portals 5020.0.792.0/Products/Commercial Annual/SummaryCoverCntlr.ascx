<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SummaryCoverCntlr.ascx.vb" Inherits="MultiMark_SummaryOfCover" %>
...
<div>
    <div>
		...
		<uc8:DocumentManager runat="server" id="docMgr" Autoarchiveselected="false"  />
    </div>
	
	<div id="divWarning" runat="server">
        <br />
        <h2>&nbsp;&nbsp;Policy Bind Warnings</h2>
