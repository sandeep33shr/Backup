...
function onValidate_TAMSNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TAMSNOTES", "NOTE_DETAILS");
        		var exp = new Expression("TAMSNOTES.NoteCheck = 1");
...
<div id="id9b339f84853a4130a2f7f84c0d2a9987" class="general-layout-container">
...
<div id="idf86d93cd88394c0f80ad232f8d93fcd6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="ART Note Details (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf86d93cd88394c0f80ad232f8d93fcd6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf86d93cd88394c0f80ad232f8d93fcd6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf86d93cd88394c0f80ad232f8d93fcd6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf86d93cd88394c0f80ad232f8d93fcd6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf86d93cd88394c0f80ad232f8d93fcd6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf86d93cd88394c0f80ad232f8d93fcd6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf86d93cd88394c0f80ad232f8d93fcd6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf86d93cd88394c0f80ad232f8d93fcd6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf86d93cd88394c0f80ad232f8d93fcd6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf86d93cd88394c0f80ad232f8d93fcd6 input{text-align:left;}"; break;
		}
	}
