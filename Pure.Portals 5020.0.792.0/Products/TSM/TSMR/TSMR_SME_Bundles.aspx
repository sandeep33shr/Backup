...
function onValidate_TAMRSK__TSMENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TSMENDOS", "ChildScreen");
        })();
}
function onValidate_TAMRSK__TSMNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TSMNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMRSK", "TSMNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_TAMRSK__TSMNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMRSK", "TSMNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TAMRSK' and property 'TSMNOTES'.");
        			error.display();
...
function onValidate_TAMRSK__TSMSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TSMSNOTES", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("TAMRSK", "TSMSNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_TAMRSK__TSMSNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMRSK", "TSMSNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TAMRSK' and property 'TSMSNOTES'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function DoLogic(isOnLoad) {
    ...
    onValidate_TAMRSK__TSMENDOS(null, null, null, isOnLoad);
    onValidate_TAMRSK__TSMNOTES(null, null, null, isOnLoad);
    onValidate_TAMRSK__TSMSNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id29aad675288f4ea98a6bc158399ad8b1" class="general-layout-container">
...
<div id="idac0cba5dfc9147558ede29e578f61c87" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idac0cba5dfc9147558ede29e578f61c87 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idac0cba5dfc9147558ede29e578f61c87 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idac0cba5dfc9147558ede29e578f61c87 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idac0cba5dfc9147558ede29e578f61c87 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idac0cba5dfc9147558ede29e578f61c87 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idac0cba5dfc9147558ede29e578f61c87 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idac0cba5dfc9147558ede29e578f61c87 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idac0cba5dfc9147558ede29e578f61c87 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idac0cba5dfc9147558ede29e578f61c87 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idac0cba5dfc9147558ede29e578f61c87 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="iddb800a59fce947ed858ae47defc307fd" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#iddb800a59fce947ed858ae47defc307fd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddb800a59fce947ed858ae47defc307fd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddb800a59fce947ed858ae47defc307fd div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#iddb800a59fce947ed858ae47defc307fd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddb800a59fce947ed858ae47defc307fd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddb800a59fce947ed858ae47defc307fd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddb800a59fce947ed858ae47defc307fd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddb800a59fce947ed858ae47defc307fd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddb800a59fce947ed858ae47defc307fd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddb800a59fce947ed858ae47defc307fd input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc180c48ea5914455bee7ef336c17a34d" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc180c48ea5914455bee7ef336c17a34d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc180c48ea5914455bee7ef336c17a34d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc180c48ea5914455bee7ef336c17a34d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc180c48ea5914455bee7ef336c17a34d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc180c48ea5914455bee7ef336c17a34d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc180c48ea5914455bee7ef336c17a34d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc180c48ea5914455bee7ef336c17a34d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc180c48ea5914455bee7ef336c17a34d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc180c48ea5914455bee7ef336c17a34d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc180c48ea5914455bee7ef336c17a34d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id283e9f2726f8452396f0bea129c1e5cb" class="column-layout-container,no-border  ">
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMRSK__TSMENDOS"
		data-field-type="Child" 
		data-object-name="TAMRSK" 
		data-property-name="TSMENDOS" 
		id="pb-container-childscreen-TAMRSK-TSMENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMRSK__TSMR_END" runat="server" ScreenCode="TSMENDOS" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valTAMRSK_TSMENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TAMRSK.TSMENDOS"
						ClientValidationFunction="onValidate_TAMRSK__TSMENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id283e9f2726f8452396f0bea129c1e5cb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id283e9f2726f8452396f0bea129c1e5cb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id283e9f2726f8452396f0bea129c1e5cb div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id283e9f2726f8452396f0bea129c1e5cb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id283e9f2726f8452396f0bea129c1e5cb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id283e9f2726f8452396f0bea129c1e5cb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id283e9f2726f8452396f0bea129c1e5cb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id283e9f2726f8452396f0bea129c1e5cb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id283e9f2726f8452396f0bea129c1e5cb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id283e9f2726f8452396f0bea129c1e5cb input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idcc8a7ae1272c4afc820b58bdc0de07cf" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMRSK__TSMNOTES"
		data-field-type="Child" 
		data-object-name="TAMRSK" 
		data-property-name="TSMNOTES" 
		id="pb-container-childscreen-TAMRSK-TSMNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMRSK__TAMNOTES" runat="server" ScreenCode="TSMNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTAMRSK_TSMNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TAMRSK.TSMNOTES"
						ClientValidationFunction="onValidate_TAMRSK__TSMNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idcc8a7ae1272c4afc820b58bdc0de07cf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcc8a7ae1272c4afc820b58bdc0de07cf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcc8a7ae1272c4afc820b58bdc0de07cf div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idcc8a7ae1272c4afc820b58bdc0de07cf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcc8a7ae1272c4afc820b58bdc0de07cf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcc8a7ae1272c4afc820b58bdc0de07cf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcc8a7ae1272c4afc820b58bdc0de07cf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcc8a7ae1272c4afc820b58bdc0de07cf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcc8a7ae1272c4afc820b58bdc0de07cf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcc8a7ae1272c4afc820b58bdc0de07cf input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8a740f5015174da9b293690cc6c88df5" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMRSK__TSMSNOTES"
		data-field-type="Child" 
		data-object-name="TAMRSK" 
		data-property-name="TSMSNOTES" 
		id="pb-container-childscreen-TAMRSK-TSMSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMRSK__TAMSNOTES" runat="server" ScreenCode="TSMSNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTAMRSK_TSMSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TAMRSK.TSMSNOTES"
						ClientValidationFunction="onValidate_TAMRSK__TSMSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8a740f5015174da9b293690cc6c88df5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8a740f5015174da9b293690cc6c88df5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8a740f5015174da9b293690cc6c88df5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8a740f5015174da9b293690cc6c88df5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8a740f5015174da9b293690cc6c88df5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8a740f5015174da9b293690cc6c88df5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8a740f5015174da9b293690cc6c88df5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8a740f5015174da9b293690cc6c88df5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8a740f5015174da9b293690cc6c88df5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8a740f5015174da9b293690cc6c88df5 input{text-align:left;}"; break;
		}
	}
