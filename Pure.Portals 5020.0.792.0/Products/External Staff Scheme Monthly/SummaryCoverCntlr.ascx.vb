...
Partial Class PrivateCar_SummaryOfCover : Inherits System.Web.UI.UserControl
    ...
    Sub DocumentsDisplay()
        ...
        If oQuote.ProductCode = "NSM" Then
                If (oQuote.InsuranceFileTypeCode = "MTAQUOTE  ") OR (oQuote.InsuranceFileTypeCode = "MTAQTETEMP") Then
					If CheckUnderwritingRIColumn("Type") Then
                        docs += "ESSMTAQ,MTA Cover Letter"
                    Else
                        docs += "ESSMTAQ,MTA Cover Letter"
                        docMgr.Documents = ""
                    End If
				'End If
				ElseIf (oQuote.InsuranceFileTypeCode = "MTA TEMP  ") OR (oQuote.InsuranceFileTypeCode = "MTA PERM  ") Then

                    If CheckUnderwritingRIColumn("Type") Then
                        docs += "ESSMTA,MTA Cover Letter"
                    Else
                        docs += "ESSMTA,MTA Cover Letter"
                        docMgr.Documents = ""
                    End If
                ...
                ElseIf (oQuote.InsuranceFileTypeCode = "RENEWAL   ") Then
                    ...
                    If CheckUnderwritingRIColumn("Type") Then
                        docs += "Cover Letter Renewal,EXSSRN"
                    Else
                        docs += "Cover Letter Renewal,EXSSRN"
                        docMgr.Documents = ""
                    End If
                ...
                ElseIf (oQuote.InsuranceFileTypeCode = "MTAQCAN   ") OR (oQuote.InsuranceFileTypeCode = "MTACAN    ") Then
                    ...
                    If CheckUnderwritingRIColumn("Type") Then
                        docs += "EXSSCN,Cover Letter Cancellation"
                    Else
                        docs += "EXSSCN,Cover Letter Cancellation"
                        docMgr.Documents = ""
                    End If
                    ...
                    If Session(CNMode) = Mode.View Then
						If oQuote.Regarding.Trim() = "Renewals" Or
						   ...
						   (oQuote.InsuranceFileTypeCode.Trim() = "POLICY" And oQuote.InsuranceFileVersion > 1 And oQuote.RenewalCount > 0) Then
                            ...
                            docs += "Cover Letter Renewal,EXSSRN"
                        Else
                            docs += "EXSSNB,NB Cover Letter"
                            docMgr.Documents = ""
                        End If
					Else
						If CheckUnderwritingRIColumn("Type") Then
							docs += "EXSSQT,QT Cover Letter"
						Else
							docs += "EXSSQT,QT Cover Letter"
							docMgr.Documents = ""
						End If
