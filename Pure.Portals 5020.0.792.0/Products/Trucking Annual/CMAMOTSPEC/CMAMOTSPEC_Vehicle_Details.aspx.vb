...
Namespace Nexus
    Partial Class PB2_CMAMOTSPEC_Vehicle_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_RISK_DETAILS__TRCK_FITTED()
        
End Sub
Protected Sub onValidate_RISK_DETAILS__REG_OWN()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RISK_DETAILS__TRCK_FITTED()
    onValidate_RISK_DETAILS__REG_OWN()
End Sub
        ...
        Protected Shadows Sub SetInsuredName(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	Dim oQuote As NexusProvider.Quote = Session(CNQuote)
            RISK_DETAILS__REG_OWN.Text = oQuote.InsuredName
        End Sub
