...
Namespace Nexus
    Partial Class PB2_CMAMISC_Goods_In_Transit : Inherits BaseRisk
...
End Sub
Protected Sub onValidate_GIT__RISKATTACHDATE()
        
        
End Sub
Protected Sub onValidate_GIT__EFFECTIVEDATE()
        
End Sub
Protected Sub onValidate_GENERAL__IS_NEWRISK()
...
Protected Sub CallRuleScripts()
    ...
    onValidate_GIT__RISKATTACHDATE()
    onValidate_GIT__EFFECTIVEDATE()
    onValidate_GENERAL__IS_NEWRISK()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If GIT__RISKATTACHDATE.Text = "" or GIT__RISKATTACHDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			GIT__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			GIT__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (GIT__RISKATTACHDATE.Text <> "" Or GIT__RISKATTACHDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		GIT__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		GIT__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		GIT__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
        	
        End Sub
    
        Protected Shadows Sub Page_Load_IsNewRisk(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	Dim oQuote As NexusProvider.Quote = Session(CNQuote)
        	Dim isTrueMonthly = Session(CNIsTrueMonthlyPolicy)
        	...
        	If transactionValue <> "NB" Then
        		If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate = oQuote.InceptionDate Then
        			GENERAL__IS_NEWRISK.Text = 0
        		End If
        	End If
