<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMANASBIT_Business_Interruption.aspx.vb" Inherits="Nexus.PB2_CMANASBIT_Business_Interruption" %>
...
function onValidate_NASRIA_BI__DISPLAY_IND_PERIOD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NASRIA_BI", "DISPLAY_IND_PERIOD", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NASRIA_BI", "DISPLAY_IND_PERIOD");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NASRIA_BI.DISPLAY_IND_PERIOD");
        			window.setControlWidth(field, "0.2", "NASRIA_BI", "DISPLAY_IND_PERIOD");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNASRIA_BI_DISPLAY_IND_PERIOD");
        			    var ele = document.getElementById('ctl00_cntMainBody_NASRIA_BI__DISPLAY_IND_PERIOD');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NASRIA_BI__DISPLAY_IND_PERIOD_lblFindParty");
        			    }
        			}
...
function onValidate_NASRIA_BI__DISPLAY_SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NASRIA_BI", "DISPLAY_SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NASRIA_BI", "DISPLAY_SUMINSURED");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NASRIA_BI.DISPLAY_SUMINSURED");
        			window.setControlWidth(field, "0.2", "NASRIA_BI", "DISPLAY_SUMINSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNASRIA_BI_DISPLAY_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_NASRIA_BI__DISPLAY_SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NASRIA_BI__DISPLAY_SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_NASRIA_BI__DISPLAY_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NASRIA_BI", "DISPLAY_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NASRIA_BI", "DISPLAY_RATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NASRIA_BI.DISPLAY_RATE");
        			window.setControlWidth(field, "0.2", "NASRIA_BI", "DISPLAY_RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNASRIA_BI_DISPLAY_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_NASRIA_BI__DISPLAY_RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NASRIA_BI__DISPLAY_RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_NASRIA_BI__DISPLAY_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NASRIA_BI", "DISPLAY_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NASRIA_BI", "DISPLAY_PREMIUM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NASRIA_BI.DISPLAY_PREMIUM");
        			window.setControlWidth(field, "0.2", "NASRIA_BI", "DISPLAY_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNASRIA_BI_DISPLAY_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_NASRIA_BI__DISPLAY_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NASRIA_BI__DISPLAY_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=NASRIA_BI&propertyName=DISPLAY_PREMIUM&name={name}");
        		
        		var value = new Expression("NASRIA_BI.DISPLAY_SUMINSURED *(NASRIA_BI.DISPLAY_RATE * 0.01)"), 
        			condition = (Expression.isValidParameter("NASRIA_BI.DISPLAY_SUMINSURED > 0")) ? new Expression("NASRIA_BI.DISPLAY_SUMINSURED > 0") : null, 
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("NASRIA_BI", "DISPLAY_SUMINSURED");
        	var Rate = Field.getInstance("NASRIA_BI", "DISPLAY_RATE");
        	var Premium = Field.getInstance("NASRIA_BI", "DISPLAY_PREMIUM");
...
function DoLogic(isOnLoad) {
    onValidate_NASRIA_BI__DISPLAY_IND_PERIOD(null, null, null, isOnLoad);
    onValidate_NASRIA_BI__DISPLAY_SUMINSURED(null, null, null, isOnLoad);
    onValidate_NASRIA_BI__DISPLAY_RATE(null, null, null, isOnLoad);
    onValidate_NASRIA_BI__DISPLAY_PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id379c51828545474798f42a6873f092d4" class="general-layout-container">
...
<div id="Business Interruption Premium Overview" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NASRIA_BI" 
		data-property-name="DISPLAY_IND_PERIOD" 
		id="pb-container-list-NASRIA_BI-DISPLAY_IND_PERIOD">
		<asp:Label ID="lblNASRIA_BI_DISPLAY_IND_PERIOD" runat="server" AssociatedControlID="NASRIA_BI__DISPLAY_IND_PERIOD" 
			Text="Indemnity Period" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="NASRIA_BI__DISPLAY_IND_PERIOD" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_NASRIA_INDPER" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_NASRIA_BI__DISPLAY_IND_PERIOD(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valNASRIA_BI_DISPLAY_IND_PERIOD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Indemnity Period"
			ClientValidationFunction="onValidate_NASRIA_BI__DISPLAY_IND_PERIOD" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NASRIA_BI" 
		data-property-name="DISPLAY_SUMINSURED" 
		id="pb-container-currency-NASRIA_BI-DISPLAY_SUMINSURED">
		<asp:Label ID="lblNASRIA_BI_DISPLAY_SUMINSURED" runat="server" AssociatedControlID="NASRIA_BI__DISPLAY_SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="NASRIA_BI__DISPLAY_SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valNASRIA_BI_DISPLAY_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_NASRIA_BI__DISPLAY_SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NASRIA_BI" 
		data-property-name="DISPLAY_RATE" 
		id="pb-container-percentage-NASRIA_BI-DISPLAY_RATE">
		<asp:Label ID="lblNASRIA_BI_DISPLAY_RATE" runat="server" AssociatedControlID="NASRIA_BI__DISPLAY_RATE" 
			Text="Rate " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="NASRIA_BI__DISPLAY_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valNASRIA_BI_DISPLAY_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate "
			ClientValidationFunction="onValidate_NASRIA_BI__DISPLAY_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="NASRIA_BI" 
		data-property-name="DISPLAY_PREMIUM" 
		id="pb-container-currency-NASRIA_BI-DISPLAY_PREMIUM">
		<asp:Label ID="lblNASRIA_BI_DISPLAY_PREMIUM" runat="server" AssociatedControlID="NASRIA_BI__DISPLAY_PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="NASRIA_BI__DISPLAY_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valNASRIA_BI_DISPLAY_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_NASRIA_BI__DISPLAY_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="NASRIA_BI" 
		data-property-name="DISPLAY_IND_PERIODCode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-NASRIA_BI-DISPLAY_IND_PERIODCode">

		
		
			
		
				<asp:HiddenField ID="NASRIA_BI__DISPLAY_IND_PERIODCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#Business Interruption Premium Overview div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#Business Interruption Premium Overview div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#Business Interruption Premium Overview div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#Business Interruption Premium Overview label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#Business Interruption Premium Overview label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#Business Interruption Premium Overview label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#Business Interruption Premium Overview label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#Business Interruption Premium Overview input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#Business Interruption Premium Overview input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#Business Interruption Premium Overview input{text-align:left;}"; break;
		}
	}
