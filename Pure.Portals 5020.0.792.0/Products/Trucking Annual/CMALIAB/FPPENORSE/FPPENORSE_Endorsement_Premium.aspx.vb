...
Namespace Nexus
    Partial Class PB2_FPPENORSE_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_FPPL__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FPPL__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'FPPLIAB - Standard Wording Parent Object
        'FPPLIAB_CLAUSES - Standard Wording Parent Property
        'FPPL - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/FPPLIAB/SW.FPPLIAB_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("FPPL__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/FPPLIAB/FPPL")
        
        	Dim CurrentSelected As String = FPPL__ENDORSE_CAP.Text
