<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMALIAB_Fare_Paying_Passengers.aspx.vb" Inherits="Nexus.PB2_CMALIAB_Fare_Paying_Passengers" %>
...
function onValidate_GENERAL__INS_FILE_CNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.TRANSTYPE =='MTA' &&(GENERAL.CHECK_FARECode=='ADD' || GENERAL.CHECK_FARECode=='VIEW' || GENERAL.CHECK_FARECode=='DELETE')) || ( GENERAL.TRANSTYPE =='NB' || GENERAL.TRANSTYPE == 'REN' || GENERAL.TRANSTYPE == 'MTC')");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_FPPLIAB__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "RISK_ATTACH_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "RISK_ATTACH_DATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.7", "FPPLIAB", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_RISK_ATTACH_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__RISK_ATTACH_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__RISK_ATTACH_DATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=FPPLIAB&propertyName=RISK_ATTACH_DATE&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "FPPLIAB" && field.getPropertyName() == "RISK_ATTACH_DATE")
        		...
        		var condition = (Expression.isValidParameter("GENERAL.CHECK_FARECode == 'VIEW' && (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')")) ? new Expression("GENERAL.CHECK_FARECode == 'VIEW' && (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')") : null;
        		if (condition == null){ 
        			disablePage(false);
        		} else {
...
function onValidate_FPPLIAB__EFFECTIVEDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "EFFECTIVEDATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.7", "FPPLIAB", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_FPPLIAB__TOTAL_FINAL_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "TOTAL_FINAL_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "TOTAL_FINAL_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.TOTAL_FINAL_PREMIUM");
        			window.setControlWidth(field, "0.7", "FPPLIAB", "TOTAL_FINAL_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_TOTAL_FINAL_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__TOTAL_FINAL_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__TOTAL_FINAL_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=FPPLIAB&propertyName=TOTAL_FINAL_PREMIUM&name={name}");
        		
        		var value = new Expression("FPPLIAB.TOT_PREM + FPPLIAB.POSTPREMIUM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_FPPLIAB__ENDORSE_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "ENDORSE_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=FPPLIAB&propertyName=ENDORSE_PREM&name={name}");
        		
        		var value = new Expression("FPPLIAB.TOT_PREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FPPLIAB", "ENDORSE_PREM");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_FPPLIAB__FLAT_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "FLAT_PREMIUM", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "FLAT_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.FLAT_PREMIUM");
        			window.setControlWidth(field, "0.7", "FPPLIAB", "FLAT_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_FLAT_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__FLAT_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__FLAT_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=FPPLIAB&propertyName=FLAT_PREMIUM&name={name}");
...
function onValidate_FPPLIAB__LIMITINDEM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "LIMITINDEM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "LIMITINDEM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.LIMITINDEM");
        			window.setControlWidth(field, "0.8", "FPPLIAB", "LIMITINDEM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_LIMITINDEM");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__LIMITINDEM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__LIMITINDEM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_FPPLIAB__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "RATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.RATE");
        			window.setControlWidth(field, "0.8", "FPPLIAB", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FPPLIAB".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FPPLIAB".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("FPPLIAB.RATE <= 0 || FPPLIAB.RATE > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_FPPLIAB__FAP_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "FAP_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "FAP_RATE");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.FAP_RATE");
        			window.setControlWidth(field, "0.8", "FPPLIAB", "FAP_RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_FAP_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__FAP_RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__FAP_RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=FPPLIAB&propertyName=FAP_RATE&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("FPPLIAB.FAP_RATE < 0")) ? new Expression("FPPLIAB.FAP_RATE < 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FPPLIAB".toUpperCase() + "__" + "FAP_RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FPPLIAB".toUpperCase() + "_" + "FAP_RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("FPPLIAB.FAP_RATE > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_FPPLIAB__FAP_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "FAP_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "FAP_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.FAP_AMOUNT");
        			window.setControlWidth(field, "0.8", "FPPLIAB", "FAP_AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_FAP_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__FAP_AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__FAP_AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=FPPLIAB&propertyName=FAP_AMOUNT&name={name}");
        		
        		var value = new Expression("5000"), 
        			condition = (Expression.isValidParameter("FPPLIAB.FAP_AMOUNT < 5000")) ? new Expression("FPPLIAB.FAP_AMOUNT < 5000") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_FPPLIAB__POSTPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "POSTPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FPPLIAB", "POSTPREMIUM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.POSTPREMIUM");
        			window.setControlWidth(field, "0.8", "FPPLIAB", "POSTPREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_POSTPREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__POSTPREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__POSTPREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=FPPLIAB&propertyName=POSTPREMIUM&name={name}");
        		
        		var value = new Expression("FPPLIAB.RATE * FPPLIAB.LIMITINDEM * 0.01"), 
        			condition = (Expression.isValidParameter("FPPLIAB.RATE > 0")) ? new Expression("FPPLIAB.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("FPPLIAB.POSTPREMIUM")) ? new Expression("FPPLIAB.POSTPREMIUM") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FPPLIAB", "POSTPREMIUM");
        		var exp = new Expression("FPPLIAB.RATE <= 0 ||FPPLIAB.RATE == ''");
        		var errorMessage = "Please enter the Posting Premium";
        		var go = function(){
        			if (exp.getValue() == true){
...
function onValidate_FPPLIAB__CAR_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "CAR_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FPPLIAB", "CAR_COUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_FPPLIAB__VEH_ITEMS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "VEH_ITEMS", "ChildScreen");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FPPLIAB", "VEH_ITEMS");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_FPPLIAB__VEH_ITEMS table td a");
        				
        		} else {
        		   links = goog.dom.query("a", field.getElement());
        		}		
                var exp = new Expression("GENERAL.CHECK_FARECode == 'VIEW' && (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')");
...
function onValidate_FPPLIAB__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("FPPLIAB", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPLIAB.TOT_PREM");
        			window.setControlWidth(field, "0.3", "FPPLIAB", "TOT_PREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPLIAB_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPLIAB__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPLIAB__TOT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
          ...
          * @param FPPLIAB The Parent (Root) object name.
          * @param FPPL.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "FPPLIAB".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "FPPL.PREMIUM";
...
function onValidate_FPPLIAB__FPPENORSE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "FPPENORSE", "ChildScreen");
        })();
        /**
         * @fileoverview
         * DisableAddWhen, used only on child screen objects.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FPPLIAB", "FPPENORSE");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_FPPLIAB__FPPENORSE table td a");
...
function onValidate_FPPLIAB__FPPCNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "FPPCNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("FPPLIAB", "FPPCNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_FPPLIAB__FPPCNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("FPPLIAB", "FPPCNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'FPPLIAB' and property 'FPPCNOTES'.");
        			error.display();
...
function onValidate_FPPLIAB__FPPSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPLIAB", "FPPSNOTES", "ChildScreen");
        })();
        /**
         * @fileoverview
         * DisableAddWhen, used only on child screen objects.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FPPLIAB", "FPPSNOTES");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_FPPLIAB__FPPSNOTES table td a");
...
function onValidate_GENERAL__IS_MTA_REASON(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "R", "GENERAL.TRANSTYPE =='MTA'", "R", "{3}");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_FPPLIAB__RISK_ATTACH_DATE(null, null, null, isOnLoad);
    onValidate_FPPLIAB__EFFECTIVEDATE(null, null, null, isOnLoad);
    onValidate_FPPLIAB__TOTAL_FINAL_PREMIUM(null, null, null, isOnLoad);
    onValidate_FPPLIAB__ENDORSE_PREM(null, null, null, isOnLoad);
    onValidate_FPPLIAB__FLAT_PREMIUM(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_VAT(null, null, null, isOnLoad);
    onValidate_FPPLIAB__LIMITINDEM(null, null, null, isOnLoad);
    onValidate_FPPLIAB__RATE(null, null, null, isOnLoad);
    onValidate_FPPLIAB__FAP_RATE(null, null, null, isOnLoad);
    onValidate_FPPLIAB__FAP_AMOUNT(null, null, null, isOnLoad);
    onValidate_FPPLIAB__POSTPREMIUM(null, null, null, isOnLoad);
    onValidate_FPPLIAB__CAR_COUNTER(null, null, null, isOnLoad);
    onValidate_FPPLIAB__VEH_ITEMS(null, null, null, isOnLoad);
    onValidate_FPPLIAB__TOT_PREM(null, null, null, isOnLoad);
    onValidate_FPPLIAB__FPPENORSE(null, null, null, isOnLoad);
    onValidate_FPPLIAB__FPPCNOTES(null, null, null, isOnLoad);
    onValidate_FPPLIAB__FPPSNOTES(null, null, null, isOnLoad);
...
<div id="ide92378d1a5e54a95a8a014b76770424e" class="general-layout-container">
...
<div id="frmMTAReason" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="MTA" /></legend>
...
<div id="frmMTAReason" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="MTA Affected Covers" /></legend>
...
<div id="frmMTAReason" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Mid-Term Adjustment Reason" /></legend>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd68f5c2fff4340b4a11eed90548e9a69" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FPPLIAB" 
		data-property-name="RISK_ATTACH_DATE" 
		id="pb-container-datejquerycompatible-FPPLIAB-RISK_ATTACH_DATE">
		<asp:Label ID="lblFPPLIAB_RISK_ATTACH_DATE" runat="server" AssociatedControlID="FPPLIAB__RISK_ATTACH_DATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="FPPLIAB__RISK_ATTACH_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calFPPLIAB__RISK_ATTACH_DATE" runat="server" LinkedControl="FPPLIAB__RISK_ATTACH_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valFPPLIAB_RISK_ATTACH_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_FPPLIAB__RISK_ATTACH_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-FPPLIAB-EFFECTIVEDATE">
		<asp:Label ID="lblFPPLIAB_EFFECTIVEDATE" runat="server" AssociatedControlID="FPPLIAB__EFFECTIVEDATE" 
			Text="Effective Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="FPPLIAB__EFFECTIVEDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calFPPLIAB__EFFECTIVEDATE" runat="server" LinkedControl="FPPLIAB__EFFECTIVEDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valFPPLIAB_EFFECTIVEDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective Date"
			ClientValidationFunction="onValidate_FPPLIAB__EFFECTIVEDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FPPLIAB-TOTAL_FINAL_PREMIUM">
		<asp:Label ID="lblFPPLIAB_TOTAL_FINAL_PREMIUM" runat="server" AssociatedControlID="FPPLIAB__TOTAL_FINAL_PREMIUM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FPPLIAB__TOTAL_FINAL_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFPPLIAB_TOTAL_FINAL_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_FPPLIAB__TOTAL_FINAL_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FPPLIAB-ENDORSE_PREM">
		<asp:Label ID="lblFPPLIAB_ENDORSE_PREM" runat="server" AssociatedControlID="FPPLIAB__ENDORSE_PREM" 
			Text="Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FPPLIAB__ENDORSE_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFPPLIAB_ENDORSE_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement Premium"
			ClientValidationFunction="onValidate_FPPLIAB__ENDORSE_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblFPPLIAB_FLAT_PREMIUM" for="ctl00_cntMainBody_FPPLIAB__FLAT_PREMIUM" class="col-md-4 col-sm-3 control-label">
		Flat Premium</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-FPPLIAB-FLAT_PREMIUM">	
		
		<asp:TextBox ID="FPPLIAB__FLAT_PREMIUM" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valFPPLIAB_FLAT_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Flat Premium"
			ClientValidationFunction="onValidate_FPPLIAB__FLAT_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd68f5c2fff4340b4a11eed90548e9a69 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd68f5c2fff4340b4a11eed90548e9a69 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd68f5c2fff4340b4a11eed90548e9a69 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd68f5c2fff4340b4a11eed90548e9a69 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd68f5c2fff4340b4a11eed90548e9a69 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd68f5c2fff4340b4a11eed90548e9a69 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd68f5c2fff4340b4a11eed90548e9a69 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd68f5c2fff4340b4a11eed90548e9a69 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd68f5c2fff4340b4a11eed90548e9a69 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd68f5c2fff4340b4a11eed90548e9a69 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idca1846f20042496fb471194bd33991bb" class="column-layout-container,no-border  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label1">
		<span class="label" id="label1">Rate %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label2">
		<span class="label" id="label2">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label3">
		<span class="label" id="label3">FAP Amount</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FPPLIAB-LIMITINDEM">
		<asp:Label ID="lblFPPLIAB_LIMITINDEM" runat="server" AssociatedControlID="FPPLIAB__LIMITINDEM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FPPLIAB__LIMITINDEM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFPPLIAB_LIMITINDEM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FPPLIAB.LIMITINDEM"
			ClientValidationFunction="onValidate_FPPLIAB__LIMITINDEM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-FPPLIAB-RATE">
		<asp:Label ID="lblFPPLIAB_RATE" runat="server" AssociatedControlID="FPPLIAB__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FPPLIAB__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFPPLIAB_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FPPLIAB.RATE"
			ClientValidationFunction="onValidate_FPPLIAB__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-FPPLIAB-FAP_RATE">
		<asp:Label ID="lblFPPLIAB_FAP_RATE" runat="server" AssociatedControlID="FPPLIAB__FAP_RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FPPLIAB__FAP_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFPPLIAB_FAP_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FPPLIAB.FAP_RATE"
			ClientValidationFunction="onValidate_FPPLIAB__FAP_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FPPLIAB-FAP_AMOUNT">
		<asp:Label ID="lblFPPLIAB_FAP_AMOUNT" runat="server" AssociatedControlID="FPPLIAB__FAP_AMOUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FPPLIAB__FAP_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFPPLIAB_FAP_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FPPLIAB.FAP_AMOUNT"
			ClientValidationFunction="onValidate_FPPLIAB__FAP_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FPPLIAB-POSTPREMIUM">
		<asp:Label ID="lblFPPLIAB_POSTPREMIUM" runat="server" AssociatedControlID="FPPLIAB__POSTPREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FPPLIAB__POSTPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFPPLIAB_POSTPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FPPLIAB.POSTPREMIUM"
			ClientValidationFunction="onValidate_FPPLIAB__POSTPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="FPPLIAB" 
		data-property-name="CAR_COUNTER" 
		id="pb-container-integer-FPPLIAB-CAR_COUNTER">
		<asp:Label ID="lblFPPLIAB_CAR_COUNTER" runat="server" AssociatedControlID="FPPLIAB__CAR_COUNTER" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="FPPLIAB__CAR_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valFPPLIAB_CAR_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FPPLIAB.CAR_COUNTER"
			ClientValidationFunction="onValidate_FPPLIAB__CAR_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idca1846f20042496fb471194bd33991bb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idca1846f20042496fb471194bd33991bb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idca1846f20042496fb471194bd33991bb div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idca1846f20042496fb471194bd33991bb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idca1846f20042496fb471194bd33991bb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idca1846f20042496fb471194bd33991bb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idca1846f20042496fb471194bd33991bb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idca1846f20042496fb471194bd33991bb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idca1846f20042496fb471194bd33991bb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idca1846f20042496fb471194bd33991bb input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida5cf64babf614e878f5b47adc8ecf105" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FPPLIAB__VEH_ITEMS"
		data-field-type="Child" 
		data-object-name="FPPLIAB" 
		data-property-name="VEH_ITEMS" 
		id="pb-container-childscreen-FPPLIAB-VEH_ITEMS">
		
		    <legend>Vehicle Details</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FPPLIAB__ITEM_DET" runat="server" ScreenCode="VEH_ITEMS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="VEH_ITEMS/VEH_ITEMS_Vehicle_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Make/Model" DataField="MAKE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Year" DataField="YEAR" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Reg No" DataField="REGNO" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="No of Seats" DataField="NUM_SEATS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFPPLIAB_VEH_ITEMS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Vehicle Details"
						ClientValidationFunction="onValidate_FPPLIAB__VEH_ITEMS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida5cf64babf614e878f5b47adc8ecf105 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida5cf64babf614e878f5b47adc8ecf105 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida5cf64babf614e878f5b47adc8ecf105 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida5cf64babf614e878f5b47adc8ecf105 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida5cf64babf614e878f5b47adc8ecf105 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5cf64babf614e878f5b47adc8ecf105 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5cf64babf614e878f5b47adc8ecf105 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida5cf64babf614e878f5b47adc8ecf105 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5cf64babf614e878f5b47adc8ecf105 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5cf64babf614e878f5b47adc8ecf105 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id631b20baff664cffaff833a7ebdaed38" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblFPPLIAB_FPPLIAB_CLAUSES" runat="server" AssociatedControlID="FPPLIAB__FPPLIAB_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="FPPLIAB__FPPLIAB_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FPPLIAB-TOT_PREM">
		<asp:Label ID="lblFPPLIAB_TOT_PREM" runat="server" AssociatedControlID="FPPLIAB__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FPPLIAB__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFPPLIAB_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_FPPLIAB__TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FPPLIAB__FPPENORSE"
		data-field-type="Child" 
		data-object-name="FPPLIAB" 
		data-property-name="FPPENORSE" 
		id="pb-container-childscreen-FPPLIAB-FPPENORSE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FPPLIAB__FPPL" runat="server" ScreenCode="FPPENORSE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="FPPENORSE/FPPENORSE_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valFPPLIAB_FPPENORSE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FPPLIAB.FPPENORSE"
						ClientValidationFunction="onValidate_FPPLIAB__FPPENORSE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id631b20baff664cffaff833a7ebdaed38 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id631b20baff664cffaff833a7ebdaed38 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id631b20baff664cffaff833a7ebdaed38 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id631b20baff664cffaff833a7ebdaed38 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id631b20baff664cffaff833a7ebdaed38 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id631b20baff664cffaff833a7ebdaed38 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id631b20baff664cffaff833a7ebdaed38 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id631b20baff664cffaff833a7ebdaed38 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id631b20baff664cffaff833a7ebdaed38 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id631b20baff664cffaff833a7ebdaed38 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2634c5b840e1486fbfbb9e2b71fff2c4" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FPPLIAB__FPPCNOTES"
		data-field-type="Child" 
		data-object-name="FPPLIAB" 
		data-property-name="FPPCNOTES" 
		id="pb-container-childscreen-FPPLIAB-FPPCNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FPPLIAB__FPP_NOTES_DETAILS" runat="server" ScreenCode="FPPCNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="FPPCNOTES/FPPCNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFPPLIAB_FPPCNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FPPLIAB.FPPCNOTES"
						ClientValidationFunction="onValidate_FPPLIAB__FPPCNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2634c5b840e1486fbfbb9e2b71fff2c4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2634c5b840e1486fbfbb9e2b71fff2c4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2634c5b840e1486fbfbb9e2b71fff2c4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2634c5b840e1486fbfbb9e2b71fff2c4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2634c5b840e1486fbfbb9e2b71fff2c4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2634c5b840e1486fbfbb9e2b71fff2c4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2634c5b840e1486fbfbb9e2b71fff2c4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2634c5b840e1486fbfbb9e2b71fff2c4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2634c5b840e1486fbfbb9e2b71fff2c4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2634c5b840e1486fbfbb9e2b71fff2c4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id874d284ad4a5473191b37d73597fe822" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FPPLIAB__FPPSNOTES"
		data-field-type="Child" 
		data-object-name="FPPLIAB" 
		data-property-name="FPPSNOTES" 
		id="pb-container-childscreen-FPPLIAB-FPPSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FPPLIAB__FPP_SNOTES_DETAILS" runat="server" ScreenCode="FPPSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="FPPSNOTES/FPPSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFPPLIAB_FPPSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FPPLIAB.FPPSNOTES"
						ClientValidationFunction="onValidate_FPPLIAB__FPPSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id874d284ad4a5473191b37d73597fe822 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id874d284ad4a5473191b37d73597fe822 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id874d284ad4a5473191b37d73597fe822 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id874d284ad4a5473191b37d73597fe822 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id874d284ad4a5473191b37d73597fe822 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id874d284ad4a5473191b37d73597fe822 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id874d284ad4a5473191b37d73597fe822 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id874d284ad4a5473191b37d73597fe822 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id874d284ad4a5473191b37d73597fe822 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id874d284ad4a5473191b37d73597fe822 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6e68669737db4f82ac52395c99fd7bff" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6e68669737db4f82ac52395c99fd7bff div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6e68669737db4f82ac52395c99fd7bff div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6e68669737db4f82ac52395c99fd7bff div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6e68669737db4f82ac52395c99fd7bff label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6e68669737db4f82ac52395c99fd7bff label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6e68669737db4f82ac52395c99fd7bff label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6e68669737db4f82ac52395c99fd7bff label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6e68669737db4f82ac52395c99fd7bff input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6e68669737db4f82ac52395c99fd7bff input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6e68669737db4f82ac52395c99fd7bff input{text-align:left;}"; break;
		}
	}
