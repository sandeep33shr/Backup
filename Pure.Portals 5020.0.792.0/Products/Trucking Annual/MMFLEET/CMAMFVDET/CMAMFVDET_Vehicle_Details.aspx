<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMFVDET_Vehicle_Details.aspx.vb" Inherits="Nexus.PB2_CMAMFVDET_Vehicle_Details" %>
...
function onValidate_VEHICLE_DETAILS__MAKEMODEL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VEHICLE_DETAILS", "MAKEMODEL", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("VEHICLE_DETAILS", "MAKEMODEL");
        		var errorMessage = "Make/Model is mandatory and must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VEHICLE_DETAILS.MAKEMODEL");
        			window.setControlWidth(field, "0.8", "VEHICLE_DETAILS", "MAKEMODEL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVEHICLE_DETAILS_MAKEMODEL");
        			    var ele = document.getElementById('ctl00_cntMainBody_VEHICLE_DETAILS__MAKEMODEL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VEHICLE_DETAILS__MAKEMODEL_lblFindParty");
        			    }
        			}
...
function onValidate_VEHICLE_DETAILS__CYEAR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VEHICLE_DETAILS", "CYEAR", "Integer");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("VEHICLE_DETAILS", "CYEAR");
        		var errorMessage = "Year is mandatory and must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VEHICLE_DETAILS.CYEAR");
        			window.setControlWidth(field, "0.8", "VEHICLE_DETAILS", "CYEAR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVEHICLE_DETAILS_CYEAR");
        			    var ele = document.getElementById('ctl00_cntMainBody_VEHICLE_DETAILS__CYEAR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VEHICLE_DETAILS__CYEAR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Year must be in the format CCYY")) ? "Year must be in the format CCYY" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "VEHICLE_DETAILS".toUpperCase() + "__" + "CYEAR");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "VEHICLE_DETAILS".toUpperCase() + "_" + "CYEAR");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("VEHICLE_DETAILS.CYEAR > 999 AND VEHICLE_DETAILS.CYEAR < 10000");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Year is invalid")) ? "Year is invalid" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "VEHICLE_DETAILS".toUpperCase() + "__" + "CYEAR");
        				if (node == null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(VEHICLE_DETAILS.CYEAR >= 1800) AND (VEHICLE_DETAILS.CYEAR <= (GetYear(TODAY())+1))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_VEHICLE_DETAILS__REGNO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VEHICLE_DETAILS", "REGNO", "Text");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("VEHICLE_DETAILS", "REGNO");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VEHICLE_DETAILS.REGNO");
        			window.setControlWidth(field, "0.8", "VEHICLE_DETAILS", "REGNO");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVEHICLE_DETAILS_REGNO");
        			    var ele = document.getElementById('ctl00_cntMainBody_VEHICLE_DETAILS__REGNO');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VEHICLE_DETAILS__REGNO_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_VEHICLE_DETAILS__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VEHICLE_DETAILS", "SUMINSURED", "Integer");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("VEHICLE_DETAILS", "SUMINSURED");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VEHICLE_DETAILS.SUMINSURED");
        			window.setControlWidth(field, "0.8", "VEHICLE_DETAILS", "SUMINSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVEHICLE_DETAILS_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_VEHICLE_DETAILS__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VEHICLE_DETAILS__SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_VEHICLE_DETAILS__VEH_NO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VEHICLE_DETAILS", "VEH_NO", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("VEHICLE_DETAILS", "VEH_NO");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_VEHICLE_DETAILS__MAKEMODEL(null, null, null, isOnLoad);
    onValidate_VEHICLE_DETAILS__CYEAR(null, null, null, isOnLoad);
    onValidate_VEHICLE_DETAILS__REGNO(null, null, null, isOnLoad);
    onValidate_VEHICLE_DETAILS__SUMINSURED(null, null, null, isOnLoad);
    onValidate_VEHICLE_DETAILS__VEH_NO(null, null, null, isOnLoad);
}
</script>
...
<div id="id2f1342b4fb4e4749ba163204ab583ffb" class="general-layout-container">
...
<div id="frmTypeFleet" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Vehicle Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="VEHICLE_DETAILS" 
		data-property-name="MAKEMODEL" 
		 
		
		 
		id="pb-container-text-VEHICLE_DETAILS-MAKEMODEL">

		
		<asp:Label ID="lblVEHICLE_DETAILS_MAKEMODEL" runat="server" AssociatedControlID="VEHICLE_DETAILS__MAKEMODEL" 
			Text="Make/Model" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="VEHICLE_DETAILS__MAKEMODEL" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valVEHICLE_DETAILS_MAKEMODEL" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Make/Model"
					ClientValidationFunction="onValidate_VEHICLE_DETAILS__MAKEMODEL"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="VEHICLE_DETAILS" 
		data-property-name="CYEAR" 
		id="pb-container-integer-VEHICLE_DETAILS-CYEAR">
		<asp:Label ID="lblVEHICLE_DETAILS_CYEAR" runat="server" AssociatedControlID="VEHICLE_DETAILS__CYEAR" 
			Text="Year" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="VEHICLE_DETAILS__CYEAR" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valVEHICLE_DETAILS_CYEAR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Year"
			ClientValidationFunction="onValidate_VEHICLE_DETAILS__CYEAR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="VEHICLE_DETAILS" 
		data-property-name="REGNO" 
		 
		
		 
		id="pb-container-text-VEHICLE_DETAILS-REGNO">

		
		<asp:Label ID="lblVEHICLE_DETAILS_REGNO" runat="server" AssociatedControlID="VEHICLE_DETAILS__REGNO" 
			Text="Vehicle Registration Number" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="VEHICLE_DETAILS__REGNO" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valVEHICLE_DETAILS_REGNO" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Vehicle Registration Number"
					ClientValidationFunction="onValidate_VEHICLE_DETAILS__REGNO"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-VEHICLE_DETAILS-SUMINSURED">
		<asp:Label ID="lblVEHICLE_DETAILS_SUMINSURED" runat="server" AssociatedControlID="VEHICLE_DETAILS__SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="VEHICLE_DETAILS__SUMINSURED" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valVEHICLE_DETAILS_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_VEHICLE_DETAILS__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="VEHICLE_DETAILS" 
		data-property-name="VEH_NO" 
		id="pb-container-integer-VEHICLE_DETAILS-VEH_NO">
		<asp:Label ID="lblVEHICLE_DETAILS_VEH_NO" runat="server" AssociatedControlID="VEHICLE_DETAILS__VEH_NO" 
			Text="Vehicle Number" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="VEHICLE_DETAILS__VEH_NO" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valVEHICLE_DETAILS_VEH_NO" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Vehicle Number"
			ClientValidationFunction="onValidate_VEHICLE_DETAILS__VEH_NO" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#frmTypeFleet div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmTypeFleet div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmTypeFleet div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#frmTypeFleet label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmTypeFleet label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmTypeFleet label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmTypeFleet label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmTypeFleet input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmTypeFleet input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmTypeFleet input{text-align:left;}"; break;
		}
	}
