...
Namespace Nexus
    Partial Class PB2_DNOLIAB_Risk_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_DNOLIAB__RETRODATE()
         
End Sub
Protected Sub CallRuleScripts()
    onValidate_DNOLIAB__RETRODATE()
End Sub
