<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="GENLIA_Notes.aspx.vb" Inherits="Nexus.PB2_GENLIA_Notes" %>
...
function onValidate_NOTES__GENNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "GENNOTES", "ChildScreen");
        })();
}
function onValidate_NOTESEXT__EXT_NOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTESEXT", "EXT_NOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__GENNOTES(null, null, null, isOnLoad);
    onValidate_NOTESEXT__EXT_NOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id2dd5c5f9eee949d6948e47ed82f70f51" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container fieldset-wrapper,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__GENNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="GENNOTES" 
		id="pb-container-childscreen-NOTES-GENNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="GENNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GENNOTES/GENNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_GENNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__GENNOTES" 
						Display="None"
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id733749b107684834b2d1b6bcd984f7c8" class="column-layout-container fieldset-wrapper,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTESEXT__EXT_NOTES"
		data-field-type="Child" 
		data-object-name="NOTESEXT" 
		data-property-name="EXT_NOTES" 
		id="pb-container-childscreen-NOTESEXT-EXT_NOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTESEXT__EXT_DETAILS" runat="server" ScreenCode="EXT_NOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EXT_NOTES/EXT_NOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTESEXT_EXT_NOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTESEXT__EXT_NOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id733749b107684834b2d1b6bcd984f7c8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id733749b107684834b2d1b6bcd984f7c8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id733749b107684834b2d1b6bcd984f7c8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id733749b107684834b2d1b6bcd984f7c8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id733749b107684834b2d1b6bcd984f7c8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id733749b107684834b2d1b6bcd984f7c8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id733749b107684834b2d1b6bcd984f7c8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id733749b107684834b2d1b6bcd984f7c8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id733749b107684834b2d1b6bcd984f7c8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id733749b107684834b2d1b6bcd984f7c8 input{text-align:left;}"; break;
		}
	}
