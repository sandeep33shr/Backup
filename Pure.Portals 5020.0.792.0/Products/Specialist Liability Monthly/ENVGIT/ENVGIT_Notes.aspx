<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENVGIT_Notes.aspx.vb" Inherits="Nexus.PB2_ENVGIT_Notes" %>
...
function onValidate_NOTES__EGITNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "EGITNOTES", "ChildScreen");
        })();
}
function onValidate_EX_NOTES__GITEXNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EX_NOTES", "GITEXNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__EGITNOTES(null, null, null, isOnLoad);
    onValidate_EX_NOTES__GITEXNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id6558a0d84fbd4fd49f41facfb7edf511" class="general-layout-container">
...
<div id="idce2799b281804501bc309efc9fdfd269" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="Environmental GIT Liability Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__EGITNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="EGITNOTES" 
		id="pb-container-childscreen-NOTES-EGITNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="EGITNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EGITNOTES/EGITNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_EGITNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__EGITNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#idce2799b281804501bc309efc9fdfd269 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idce2799b281804501bc309efc9fdfd269 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idce2799b281804501bc309efc9fdfd269 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idce2799b281804501bc309efc9fdfd269 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idce2799b281804501bc309efc9fdfd269 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idce2799b281804501bc309efc9fdfd269 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idce2799b281804501bc309efc9fdfd269 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idce2799b281804501bc309efc9fdfd269 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idce2799b281804501bc309efc9fdfd269 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idce2799b281804501bc309efc9fdfd269 input{text-align:left;}"; break;
		}
	}
...
<div id="frmExtNotes" class="column-layout-container fieldset-wrapper,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading27" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EX_NOTES__GITEXNOTES"
		data-field-type="Child" 
		data-object-name="EX_NOTES" 
		data-property-name="GITEXNOTES" 
		id="pb-container-childscreen-EX_NOTES-GITEXNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EX_NOTES__EXT_DETAILS" runat="server" ScreenCode="GITEXNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GITEXNOTES/GITEXNOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEX_NOTES_GITEXNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_EX_NOTES__GITEXNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
