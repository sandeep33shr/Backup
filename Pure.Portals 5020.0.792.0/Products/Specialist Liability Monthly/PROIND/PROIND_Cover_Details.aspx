<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PROIND_Cover_Details.aspx.vb" Inherits="Nexus.PB2_PROIND_Cover_Details" %>
...
function onValidate_GENERAL__BRANCH(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GENERAL&propertyName=BRANCH&name={name}");
        		
        		var value = new Expression("POLICYHEADER.BRANCH"), 
...
function onValidate_GENERAL__PIMTAREAS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "PIMTAREAS", "ChildScreen");
        })();
}
        		...
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblINDUSTRY_PRIMARY_INDUSTRY");
        					var ele = document.getElementById('ctl00_cntMainBody_INDUSTRY__PRIMARY_INDUSTRY');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_INDUSTRY__PRIMARY_INDUSTRY_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        		...
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblINDUSTRY_SECONDARY_INDUSTRY");
        					var ele = document.getElementById('ctl00_cntMainBody_INDUSTRY__SECONDARY_INDUSTRY');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_INDUSTRY__SECONDARY_INDUSTRY_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_RETROCESSION__RTPRONOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETROCESSION", "RTPRONOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__PIMTAREAS(null, null, null, isOnLoad);
    ...
    onValidate_RETROCESSION__RTPRONOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id5f18eaf646034d65befa41be801f02c7" class="general-layout-container">
...
<div id="id762d957c02b74926bc248865dcd30861" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Commercial Professional Liability" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id762d957c02b74926bc248865dcd30861 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id762d957c02b74926bc248865dcd30861 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id762d957c02b74926bc248865dcd30861 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id762d957c02b74926bc248865dcd30861 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id762d957c02b74926bc248865dcd30861 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id762d957c02b74926bc248865dcd30861 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id762d957c02b74926bc248865dcd30861 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id762d957c02b74926bc248865dcd30861 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id762d957c02b74926bc248865dcd30861 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id762d957c02b74926bc248865dcd30861 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__PIMTAREAS"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="PIMTAREAS" 
		id="pb-container-childscreen-GENERAL-PIMTAREAS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="PIMTAREAS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PIMTAREAS/PIMTAREAS_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_PIMTAREAS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.PIMTAREAS"
						ClientValidationFunction="onValidate_GENERAL__PIMTAREAS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmAddress" class="column-layout-container,no-border  ">
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmIndustry" class="column-layout-container,no-border  ">
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id16a5a81231d845f2951c982239af46d8" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RETROCESSION__RTPRONOTE"
		data-field-type="Child" 
		data-object-name="RETROCESSION" 
		data-property-name="RTPRONOTE" 
		id="pb-container-childscreen-RETROCESSION-RTPRONOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RETROCESSION__RETRO_DETAILS" runat="server" ScreenCode="RTPRONOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RTPRONOTE/RTPRONOTE_Retrocession_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valRETROCESSION_RTPRONOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RETROCESSION.RTPRONOTE"
						ClientValidationFunction="onValidate_RETROCESSION__RTPRONOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id16a5a81231d845f2951c982239af46d8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id16a5a81231d845f2951c982239af46d8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id16a5a81231d845f2951c982239af46d8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id16a5a81231d845f2951c982239af46d8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id16a5a81231d845f2951c982239af46d8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id16a5a81231d845f2951c982239af46d8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id16a5a81231d845f2951c982239af46d8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id16a5a81231d845f2951c982239af46d8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id16a5a81231d845f2951c982239af46d8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id16a5a81231d845f2951c982239af46d8 input{text-align:left;}"; break;
		}
	}
