<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PROIND_Notes.aspx.vb" Inherits="Nexus.PB2_PROIND_Notes" %>
...
function onValidate_NOTES__PRONOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "PRONOTES", "ChildScreen");
        })();
}
function onValidate_EX_NOTES__CPEXNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EX_NOTES", "CPEXNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__PRONOTES(null, null, null, isOnLoad);
    onValidate_EX_NOTES__CPEXNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id190d5f5f38d74822a8dff3315d326eda" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="Professional Indemnity Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__PRONOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="PRONOTES" 
		id="pb-container-childscreen-NOTES-PRONOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="PRONOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PRONOTES/PRONOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_PRONOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__PRONOTES" 
						Display="None"
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EX_NOTES__CPEXNOTES"
		data-field-type="Child" 
		data-object-name="EX_NOTES" 
		data-property-name="CPEXNOTES" 
		id="pb-container-childscreen-EX_NOTES-CPEXNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EX_NOTES__EXT_DETAILS" runat="server" ScreenCode="CPEXNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPEXNOTES/CPEXNOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEX_NOTES_CPEXNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_EX_NOTES__CPEXNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
