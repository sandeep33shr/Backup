<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PROIND_Risk_Details.aspx.vb" Inherits="Nexus.PB2_PROIND_Risk_Details" %>
...
function onValidate_RISK_DETAILS__FEES_TURNOVERS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "FEES_TURNOVERS", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("RISK_DETAILS", "FEES_TURNOVERS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RISK_DETAILS.FEES_TURNOVERS");
        			window.setControlWidth(field, "0.8", "RISK_DETAILS", "FEES_TURNOVERS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblRISK_DETAILS_FEES_TURNOVERS");
        					var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__FEES_TURNOVERS');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_RISK_DETAILS__FEES_TURNOVERS_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Fess/Turnover must be greater than 0")) ? "Fess/Turnover must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISK_DETAILS".toUpperCase() + "__" + "FEES_TURNOVERS");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISK_DETAILS".toUpperCase() + "_" + "FEES_TURNOVERS");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISK_DETAILS.FEES_TURNOVERS > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISK_DETAILS__PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("RISK_DETAILS", "FEES_TURNOVERS");
        	var Rate = Field.getInstance("RISK_DETAILS", "BASE_RATE");
        	var Premium = Field.getInstance("RISK_DETAILS", "PREMIUM");
...
function onValidate_RISK_DETAILS__BASISOFDEDUCTIBLE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "BASISOFDEDUCTIBLE", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("RISK_DETAILS", "BASISOFDEDUCTIBLE");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RISK_DETAILS.BASISOFDEDUCTIBLE");
        			window.setControlWidth(field, "0.8", "RISK_DETAILS", "BASISOFDEDUCTIBLE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblRISK_DETAILS_BASISOFDEDUCTIBLE");
        					var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__BASISOFDEDUCTIBLE');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_RISK_DETAILS__BASISOFDEDUCTIBLE_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_RISK_DETAILS__RETROACTIVE_DATE_INCEPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "RETROACTIVE_DATE_INCEPTION", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "RETROACTIVE_DATE_INCEPTION");
        		}
        		//window.setProperty(field, "VE", "RISK_DETAILS.RETROACTIVE_DATE_EXPIRY == false", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "RISK_DETAILS.RETROACTIVE_DATE_EXPIRY == false",
            paramElseValue = "V",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("RISK_DETAILS", "RETROACTIVE_DATE_INCEPTION");
...
function onValidate_RISK_DETAILS__PERCENTAGE_OF_CLAIM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "PERCENTAGE_OF_CLAIM", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "PERCENTAGE_OF_CLAIM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RISK_DETAILS.PERCENTAGE_OF_CLAIM");
        			window.setControlWidth(field, "0.8", "RISK_DETAILS", "PERCENTAGE_OF_CLAIM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblRISK_DETAILS_PERCENTAGE_OF_CLAIM");
        					var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__PERCENTAGE_OF_CLAIM');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_RISK_DETAILS__PERCENTAGE_OF_CLAIM_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_RISK_DETAILS__MINIMUM_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "MINIMUM_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "MINIMUM_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RISK_DETAILS.MINIMUM_AMOUNT");
        			window.setControlWidth(field, "0.8", "RISK_DETAILS", "MINIMUM_AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblRISK_DETAILS_MINIMUM_AMOUNT");
        					var ele = document.getElementById('ctl00_cntMainBody_RISK_DETAILS__MINIMUM_AMOUNT');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_RISK_DETAILS__MINIMUM_AMOUNT_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISK_DETAILS".toUpperCase() + "__" + "MINIMUM_AMOUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISK_DETAILS".toUpperCase() + "_" + "MINIMUM_AMOUNT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISK_DETAILS.MINIMUM_AMOUNT >= 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISK_DETAILS__IS_EXTENDED_GL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "IS_EXTENDED_GL", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("RISK_DETAILS.IS_EXTENDED_GL");
        		var update = function(){
...
function DoLogic(isOnLoad) {
    ...
    onValidate_RISK_DETAILS__FEES_TURNOVERS(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__BASE_RATE(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__PREMIUM(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__BASISOFDEDUCTIBLE(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__BASISOFLIMIT(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__RETROACTIVE_DATE_INCEPTION(null, null, null, isOnLoad);
    ...
    onValidate_RISK_DETAILS__PERCENTAGE_OF_CLAIM(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__MINIMUM_AMOUNT(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__IS_EXTENDED_GL(null, null, null, isOnLoad);
}
</script>
...
<div id="id3c79de8c54a241efba606019a2be3b80" class="general-layout-container">
...
<div id="ida0eb603f1b744adfa2614a454b4b2596" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida0eb603f1b744adfa2614a454b4b2596 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida0eb603f1b744adfa2614a454b4b2596 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida0eb603f1b744adfa2614a454b4b2596 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida0eb603f1b744adfa2614a454b4b2596 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida0eb603f1b744adfa2614a454b4b2596 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida0eb603f1b744adfa2614a454b4b2596 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida0eb603f1b744adfa2614a454b4b2596 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida0eb603f1b744adfa2614a454b4b2596 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida0eb603f1b744adfa2614a454b4b2596 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida0eb603f1b744adfa2614a454b4b2596 input{text-align:left;}"; break;
		}
	}
...
<div id="frmLimitDetails" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Limit Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="RISK_DETAILS" 
		data-property-name="FEES_TURNOVERS" 
		id="pb-container-currency-RISK_DETAILS-FEES_TURNOVERS">
		<asp:Label ID="lblRISK_DETAILS_FEES_TURNOVERS" runat="server" AssociatedControlID="RISK_DETAILS__FEES_TURNOVERS" 
			Text="Fees/Turnover" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_DETAILS__FEES_TURNOVERS" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_DETAILS_FEES_TURNOVERS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Fees/Turnover"
			ClientValidationFunction="onValidate_RISK_DETAILS__FEES_TURNOVERS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div id="frmRetroactive" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Standard Risk Conditions" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="RISK_DETAILS" 
		data-property-name="BASISOFDEDUCTIBLE" 
		id="pb-container-list-RISK_DETAILS-BASISOFDEDUCTIBLE">
		<asp:Label ID="lblRISK_DETAILS_BASISOFDEDUCTIBLE" runat="server" AssociatedControlID="RISK_DETAILS__BASISOFDEDUCTIBLE" 
			Text="Basis Of Deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="RISK_DETAILS__BASISOFDEDUCTIBLE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_BOD" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_RISK_DETAILS__BASISOFDEDUCTIBLE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valRISK_DETAILS_BASISOFDEDUCTIBLE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis Of Deductible"
			ClientValidationFunction="onValidate_RISK_DETAILS__BASISOFDEDUCTIBLE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div id="frmRetroactive" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading14" runat="server" Text="Retroactive Date" /></legend>
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblRISK_DETAILS_RETROACTIVE_DATE_INCEPTION" for="ctl00_cntMainBody_RISK_DETAILS__RETROACTIVE_DATE_INCEPTION" class="col-md-4 col-sm-3 control-label">
		Retroactive Date Per Inception</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="RISK_DETAILS" 
		data-property-name="RETROACTIVE_DATE_INCEPTION" 
		id="pb-container-checkbox-RISK_DETAILS-RETROACTIVE_DATE_INCEPTION">	
		
		<asp:TextBox ID="RISK_DETAILS__RETROACTIVE_DATE_INCEPTION" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valRISK_DETAILS_RETROACTIVE_DATE_INCEPTION" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Retroactive Date Per Inception"
			ClientValidationFunction="onValidate_RISK_DETAILS__RETROACTIVE_DATE_INCEPTION" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="RISK_DETAILS" 
		data-property-name="PERCENTAGE_OF_CLAIM" 
		 
		
		 
		id="pb-container-text-RISK_DETAILS-PERCENTAGE_OF_CLAIM">

		
		<asp:Label ID="lblRISK_DETAILS_PERCENTAGE_OF_CLAIM" runat="server" AssociatedControlID="RISK_DETAILS__PERCENTAGE_OF_CLAIM" 
			Text="Percentage Of Claim" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="RISK_DETAILS__PERCENTAGE_OF_CLAIM" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valRISK_DETAILS_PERCENTAGE_OF_CLAIM" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Percentage Of Claim"
					ClientValidationFunction="onValidate_RISK_DETAILS__PERCENTAGE_OF_CLAIM"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-RISK_DETAILS-MINIMUM_AMOUNT">
		<asp:Label ID="lblRISK_DETAILS_MINIMUM_AMOUNT" runat="server" AssociatedControlID="RISK_DETAILS__MINIMUM_AMOUNT" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_DETAILS__MINIMUM_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_DETAILS_MINIMUM_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_RISK_DETAILS__MINIMUM_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frm" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading16" runat="server" Text="Cover Details and Documentation" /></legend>
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblRISK_DETAILS_IS_EXTENDED_GL" for="ctl00_cntMainBody_RISK_DETAILS__IS_EXTENDED_GL" class="col-md-4 col-sm-3 control-label">
		Extended GL</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="RISK_DETAILS" 
		data-property-name="IS_EXTENDED_GL" 
		id="pb-container-checkbox-RISK_DETAILS-IS_EXTENDED_GL">	
		
		<asp:TextBox ID="RISK_DETAILS__IS_EXTENDED_GL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valRISK_DETAILS_IS_EXTENDED_GL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Extended GL"
			ClientValidationFunction="onValidate_RISK_DETAILS__IS_EXTENDED_GL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
