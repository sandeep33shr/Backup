<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TRUSTLIAB_Cover_Details.aspx.vb" Inherits="Nexus.PB2_TRUSTLIAB_Cover_Details" %>
...
function onValidate_GENERAL__TRSTREASON(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "TRSTREASON", "ChildScreen");
        })();
}
...
function onValidate_GENERAL__INDUSTRY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.INDUSTRY");
        			window.setControlWidth(field, "0.6", "GENERAL", "INDUSTRY");
        		})();
        	}
        })();
}
function onValidate_RETROCESSION__TRUSTRETR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETROCESSION", "TRUSTRETR", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__TRSTREASON(null, null, null, isOnLoad);
    ...
    onValidate_RETROCESSION__TRUSTRETR(null, null, null, isOnLoad);
}
</script>
...
<div id="id4e8eb7bf8696432995c2424de7396acd" class="general-layout-container">
...
<div id="id4926604a9db74649acad134f563e0d75" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Trustees Liability" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id4926604a9db74649acad134f563e0d75 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4926604a9db74649acad134f563e0d75 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4926604a9db74649acad134f563e0d75 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4926604a9db74649acad134f563e0d75 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4926604a9db74649acad134f563e0d75 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4926604a9db74649acad134f563e0d75 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4926604a9db74649acad134f563e0d75 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4926604a9db74649acad134f563e0d75 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4926604a9db74649acad134f563e0d75 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4926604a9db74649acad134f563e0d75 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__TRSTREASON"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="TRSTREASON" 
		id="pb-container-childscreen-GENERAL-TRSTREASON">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="TRSTREASON" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRSTREASON/TRSTREASON_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_TRSTREASON" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.TRSTREASON"
						ClientValidationFunction="onValidate_GENERAL__TRSTREASON" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfcf5ef8ed20341b6bb7b1ec4f00f3f04" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfcf5ef8ed20341b6bb7b1ec4f00f3f04 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id24cef6df802e48baacf1dfe298c1320e" class="column-layout-container fieldset-wrapper,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_INDUSTRY" runat="server" AssociatedControlID="GENERAL__INDUSTRY" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="GENERAL__INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTHREE" ParentLookupListID="GENERAL__SCNDINDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_GENERAL__INDUSTRY(null, null, this);" data-type="List" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id24cef6df802e48baacf1dfe298c1320e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id24cef6df802e48baacf1dfe298c1320e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id24cef6df802e48baacf1dfe298c1320e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id24cef6df802e48baacf1dfe298c1320e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id24cef6df802e48baacf1dfe298c1320e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id24cef6df802e48baacf1dfe298c1320e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id24cef6df802e48baacf1dfe298c1320e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id24cef6df802e48baacf1dfe298c1320e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id24cef6df802e48baacf1dfe298c1320e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id24cef6df802e48baacf1dfe298c1320e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf82fb01a307948879af939c4f91f1175" class="column-layout-container fieldset-wrapper,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RETROCESSION__TRUSTRETR"
		data-field-type="Child" 
		data-object-name="RETROCESSION" 
		data-property-name="TRUSTRETR" 
		id="pb-container-childscreen-RETROCESSION-TRUSTRETR">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RETROCESSION__RETRO_DETAILS" runat="server" ScreenCode="TRUSTRETR" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRUSTRETR/TRUSTRETR_Retrocession_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valRETROCESSION_TRUSTRETR" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RETROCESSION.TRUSTRETR"
						ClientValidationFunction="onValidate_RETROCESSION__TRUSTRETR" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#idf82fb01a307948879af939c4f91f1175 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf82fb01a307948879af939c4f91f1175 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf82fb01a307948879af939c4f91f1175 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf82fb01a307948879af939c4f91f1175 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf82fb01a307948879af939c4f91f1175 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf82fb01a307948879af939c4f91f1175 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf82fb01a307948879af939c4f91f1175 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf82fb01a307948879af939c4f91f1175 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf82fb01a307948879af939c4f91f1175 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf82fb01a307948879af939c4f91f1175 input{text-align:left;}"; break;
		}
	}
