<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TRUSTLIAB_Notes.aspx.vb" Inherits="Nexus.PB2_TRUSTLIAB_Notes" %>
...
function onValidate_NOTES__TRSTNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "TRSTNOTES", "ChildScreen");
        })();
}
function onValidate_TRS_NOTES__TSREXNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRS_NOTES", "TSREXNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__TRSTNOTES(null, null, null, isOnLoad);
    onValidate_TRS_NOTES__TSREXNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="idcae68abec21640ffa1ec1ed01b418ca1" class="general-layout-container">
...
<div id="idfdb82eaacd1e425e9a86aba45bfc36bf" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading28" runat="server" Text="Trustees Liability Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__TRSTNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="TRSTNOTES" 
		id="pb-container-childscreen-NOTES-TRSTNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="TRSTNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRSTNOTES/TRSTNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_TRSTNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__TRSTNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#idfdb82eaacd1e425e9a86aba45bfc36bf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfdb82eaacd1e425e9a86aba45bfc36bf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfdb82eaacd1e425e9a86aba45bfc36bf div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfdb82eaacd1e425e9a86aba45bfc36bf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfdb82eaacd1e425e9a86aba45bfc36bf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfdb82eaacd1e425e9a86aba45bfc36bf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfdb82eaacd1e425e9a86aba45bfc36bf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfdb82eaacd1e425e9a86aba45bfc36bf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfdb82eaacd1e425e9a86aba45bfc36bf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfdb82eaacd1e425e9a86aba45bfc36bf input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmExtNotes" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading29" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TRS_NOTES__TSREXNOTES"
		data-field-type="Child" 
		data-object-name="TRS_NOTES" 
		data-property-name="TSREXNOTES" 
		id="pb-container-childscreen-TRS_NOTES-TSREXNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TRS_NOTES__EXT_DETAILS" runat="server" ScreenCode="TSREXNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSREXNOTES/TSREXNOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTRS_NOTES_TSREXNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_TRS_NOTES__TSREXNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
