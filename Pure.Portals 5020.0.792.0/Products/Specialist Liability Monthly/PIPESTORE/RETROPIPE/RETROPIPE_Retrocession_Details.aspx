...
<div id="id07355bbf5ec44dfb9242ae3125f71271" class="general-layout-container">
...
<div id="id5c6a26bcc6334f66af8559ebdeb56507" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id5c6a26bcc6334f66af8559ebdeb56507 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5c6a26bcc6334f66af8559ebdeb56507 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5c6a26bcc6334f66af8559ebdeb56507 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5c6a26bcc6334f66af8559ebdeb56507 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5c6a26bcc6334f66af8559ebdeb56507 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5c6a26bcc6334f66af8559ebdeb56507 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5c6a26bcc6334f66af8559ebdeb56507 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5c6a26bcc6334f66af8559ebdeb56507 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5c6a26bcc6334f66af8559ebdeb56507 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5c6a26bcc6334f66af8559ebdeb56507 input{text-align:left;}"; break;
		}
	}
