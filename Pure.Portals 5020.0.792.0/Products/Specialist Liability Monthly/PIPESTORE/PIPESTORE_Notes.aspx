<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PIPESTORE_Notes.aspx.vb" Inherits="Nexus.PB2_PIPESTORE_Notes" %>
...
function onValidate_NOTES__PIPENOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "PIPENOTES", "ChildScreen");
        })();
}
function onValidate_EX_NOTES__PSTXNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EX_NOTES", "PSTXNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__PIPENOTES(null, null, null, isOnLoad);
    onValidate_EX_NOTES__PSTXNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="idb9e5eddc50e44db5a3ef1b49002ca9b2" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container fieldset-wrapper,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading31" runat="server" Text="Environmental - Pipelines and Storage Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__PIPENOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="PIPENOTES" 
		id="pb-container-childscreen-NOTES-PIPENOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="PIPENOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PIPENOTES/PIPENOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_PIPENOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__PIPENOTES" 
						Display="None"
...
<div id="frmExtNotes" class="column-layout-container fieldset-wrapper,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EX_NOTES__PSTXNOTES"
		data-field-type="Child" 
		data-object-name="EX_NOTES" 
		data-property-name="PSTXNOTES" 
		id="pb-container-childscreen-EX_NOTES-PSTXNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EX_NOTES__EXT_DETAILS" runat="server" ScreenCode="PSTXNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PSTXNOTES/PSTXNOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEX_NOTES_PSTXNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_EX_NOTES__PSTXNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
