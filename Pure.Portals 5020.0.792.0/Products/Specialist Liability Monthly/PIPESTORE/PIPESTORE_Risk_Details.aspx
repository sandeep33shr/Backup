<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PIPESTORE_Risk_Details.aspx.vb" Inherits="Nexus.PB2_PIPESTORE_Risk_Details" %>
...
function onValidate_RISK_DETAILS__TYPE_OF_COVER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "TYPE_OF_COVER", "RateList");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("RISK_DETAILS", "TYPE_OF_COVER");
        		var errorMessage = "Type Of Cover is mandatory and an option must be selected";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RISK_DETAILS.TYPE_OF_COVER");
        			window.setControlWidth(field, "0.8", "RISK_DETAILS", "TYPE_OF_COVER");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblRISK_DETAILS_TYPE_OF_COVER");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
...
function onValidate_RISK_DETAILS__COVERDESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "COVERDESC", "Text");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=RISK_DETAILS&propertyName=COVERDESC&name={name}");
        		
        		var value = new Expression("Code(RISK_DETAILS.TYPE_OF_COVER)"), 
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_DETAILS", "COVERDESC");
        		}
...
function onValidate_RISK_DETAILS__AGGREGATE_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "AGGREGATE_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("RISK_DETAILS", "AGGREGATE_LIMIT");
        		var errorMessage = "Aggregate Limit is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RISK_DETAILS.AGGREGATE_LIMIT");
        			window.setControlWidth(field, "0.8", "RISK_DETAILS", "AGGREGATE_LIMIT");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Aggregate Limit must be greater than 0")) ? "Aggregate Limit must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISK_DETAILS".toUpperCase() + "__" + "AGGREGATE_LIMIT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISK_DETAILS".toUpperCase() + "_" + "AGGREGATE_LIMIT");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("RISK_DETAILS.AGGREGATE_LIMIT >  0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISK_DETAILS__RETRO_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "RETRO_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_DETAILS.IS_RETRO_DATE_EXPIRY == false and RISK_DETAILS.IS_RETRO_DATE_INCEPTION == false", "VE", "Retroactive Date is mandatory and a date must be selected");
        
            var paramValue = "VEM",
            paramCondition = "RISK_DETAILS.IS_RETRO_DATE_EXPIRY == false and RISK_DETAILS.IS_RETRO_DATE_INCEPTION == false",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	// Get the field
        	var field = Field.getWithQuery("type=Date&objectName=RISK_DETAILS&propertyName=RETRO_DATE&name={name}");
...
function onValidate_RISK_DETAILS__RETRO_DATE_INFO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "RETRO_DATE_INFO", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_DETAILS", "RETRO_DATE_INFO");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RISK_DETAILS.RETRO_DATE_INFO");
        			window.setControlWidth(field, "0.8", "RISK_DETAILS", "RETRO_DATE_INFO");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblRISK_DETAILS_RETRO_DATE_INFO");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
...
function onValidate_RISK_DETAILS__TOTALSI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "TOTALSI", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param RISK_DETAILS The Parent (Root) object name.
          * @param SITECHLD.LIMIT_OF_INDEMNITY The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var childFieldStr = "SITECHLD.LIMIT_OF_INDEMNITY";
        		...
        		var field = Field.getInstance("RISK_DETAILS", "TOTALSI");
        		try {
...
function onValidate_RISK_DETAILS__TOTALPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "TOTALPREM", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param RISK_DETAILS The Parent (Root) object name.
          * @param SITECHLD.PREMIUM The object.property to sum the totals of.
          * @param Total The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_DETAILS".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "SITECHLD.PREMIUM";
        		//count, average, total, min, max
        		var type = "Total".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
        		...
        		var field = Field.getInstance("RISK_DETAILS", "TOTALPREM");
        		try {
...
function onValidate_RISK_DETAILS__SITECOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "SITECOUNT", "Integer");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param RISK_DETAILS The Parent (Root) object name.
          * @param SITECHLD.SITE_NAME The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_DETAILS".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "SITECHLD.SITE_NAME";
        		//count, average, total, min, max
        		...
        		var field = Field.getInstance("RISK_DETAILS", "SITECOUNT");
        		try {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("At least one Site must be added")) ? "At least one Site must be added" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISK_DETAILS".toUpperCase() + "__" + "SITECOUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISK_DETAILS".toUpperCase() + "_" + "SITECOUNT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISK_DETAILS.SITECOUNT > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISK_DETAILS__SITEDETS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_DETAILS", "SITEDETS", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_RISK_DETAILS__ITOOAPPROV(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__TYPE_OF_COVER(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__COVERDESC(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__AGGREGATE_LIMIT(null, null, null, isOnLoad);
    ...
    onValidate_RISK_DETAILS__RETRO_DATE_INFO(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__TOTALSI(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__TOTALPREM(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__SITECOUNT(null, null, null, isOnLoad);
    onValidate_RISK_DETAILS__SITEDETS(null, null, null, isOnLoad);
}
</script>
...
<div id="idcc6db67c114141929fe1cd35122e96dc" class="general-layout-container">
...
<div id="id38d448cd19294a1b8993efd9ba29bfcd" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Approval" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id38d448cd19294a1b8993efd9ba29bfcd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id38d448cd19294a1b8993efd9ba29bfcd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id38d448cd19294a1b8993efd9ba29bfcd div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id38d448cd19294a1b8993efd9ba29bfcd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id38d448cd19294a1b8993efd9ba29bfcd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38d448cd19294a1b8993efd9ba29bfcd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38d448cd19294a1b8993efd9ba29bfcd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id38d448cd19294a1b8993efd9ba29bfcd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38d448cd19294a1b8993efd9ba29bfcd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38d448cd19294a1b8993efd9ba29bfcd input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmCover" class="column-layout-container fieldset-wrapper,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="RISK_DETAILS" 
		data-property-name="TYPE_OF_COVER" 
		id="pb-container-list-RISK_DETAILS-TYPE_OF_COVER">
		<asp:Label ID="lblRISK_DETAILS_TYPE_OF_COVER" runat="server" AssociatedControlID="RISK_DETAILS__TYPE_OF_COVER" 
			Text="Type Of Cover" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="RISK_DETAILS__TYPE_OF_COVER" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CTYPE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_RISK_DETAILS__TYPE_OF_COVER(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valRISK_DETAILS_TYPE_OF_COVER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Type Of Cover"
			ClientValidationFunction="onValidate_RISK_DETAILS__TYPE_OF_COVER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="RISK_DETAILS" 
		data-property-name="COVERDESC" 
		 
		
		 
		id="pb-container-text-RISK_DETAILS-COVERDESC">

		
		<asp:Label ID="lblRISK_DETAILS_COVERDESC" runat="server" AssociatedControlID="RISK_DETAILS__COVERDESC" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="RISK_DETAILS__COVERDESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valRISK_DETAILS_COVERDESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for RISK_DETAILS.COVERDESC"
					ClientValidationFunction="onValidate_RISK_DETAILS__COVERDESC"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmRiskDets" class="column-layout-container fieldset-wrapper,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="RISK_DETAILS" 
		data-property-name="AGGREGATE_LIMIT" 
		id="pb-container-currency-RISK_DETAILS-AGGREGATE_LIMIT">
		<asp:Label ID="lblRISK_DETAILS_AGGREGATE_LIMIT" runat="server" AssociatedControlID="RISK_DETAILS__AGGREGATE_LIMIT" 
			Text="Aggregate Limit" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_DETAILS__AGGREGATE_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_DETAILS_AGGREGATE_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Aggregate Limit"
			ClientValidationFunction="onValidate_RISK_DETAILS__AGGREGATE_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-RISK_DETAILS-RETRO_DATE">
		<asp:Label ID="lblRISK_DETAILS_RETRO_DATE" runat="server" AssociatedControlID="RISK_DETAILS__RETRO_DATE" 
			Text="Retroactive Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="RISK_DETAILS__RETRO_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calRISK_DETAILS__RETRO_DATE" runat="server" LinkedControl="RISK_DETAILS__RETRO_DATE" HLevel="1" />
		     </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="RISK_DETAILS" 
		data-property-name="RETRO_DATE_INFO" 
		id="pb-container-comment-RISK_DETAILS-RETRO_DATE_INFO">
		<asp:Label ID="lblRISK_DETAILS_RETRO_DATE_INFO" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="RISK_DETAILS__RETRO_DATE_INFO" 
			Text="Retroactive Date Info"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="RISK_DETAILS__RETRO_DATE_INFO" runat="server" />
		
		<asp:CustomValidator ID="valRISK_DETAILS_RETRO_DATE_INFO" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Retroactive Date Info"
			ClientValidationFunction="onValidate_RISK_DETAILS__RETRO_DATE_INFO"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-RISK_DETAILS-TOTALSI">
		<asp:Label ID="lblRISK_DETAILS_TOTALSI" runat="server" AssociatedControlID="RISK_DETAILS__TOTALSI" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_DETAILS__TOTALSI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_DETAILS_TOTALSI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_RISK_DETAILS__TOTALSI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-RISK_DETAILS-TOTALPREM">
		<asp:Label ID="lblRISK_DETAILS_TOTALPREM" runat="server" AssociatedControlID="RISK_DETAILS__TOTALPREM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_DETAILS__TOTALPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_DETAILS_TOTALPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_RISK_DETAILS__TOTALPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="RISK_DETAILS" 
		data-property-name="SITECOUNT" 
		id="pb-container-integer-RISK_DETAILS-SITECOUNT">
		<asp:Label ID="lblRISK_DETAILS_SITECOUNT" runat="server" AssociatedControlID="RISK_DETAILS__SITECOUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="RISK_DETAILS__SITECOUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valRISK_DETAILS_SITECOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for RISK_DETAILS.SITECOUNT"
			ClientValidationFunction="onValidate_RISK_DETAILS__SITECOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#frmRiskDets div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmRiskDets div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmRiskDets div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmRiskDets label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmRiskDets label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmRiskDets label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmRiskDets label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmRiskDets input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmRiskDets input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmRiskDets input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmSiteChild" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading23" runat="server" Text="Site Details" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RISK_DETAILS__SITEDETS"
		data-field-type="Child" 
		data-object-name="RISK_DETAILS" 
		data-property-name="SITEDETS" 
		id="pb-container-childscreen-RISK_DETAILS-SITEDETS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RISK_DETAILS__SITECHLD" runat="server" ScreenCode="SITEDETS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SITEDETS/SITEDETS_Site_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Site Number" DataField="SITE_NUMBER" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Site Name" DataField="SITE_NAME" DataFormatString=""/>
...
<Nexus:GISLookupField HeaderText="Basis of Limit" ListType="PMLookup" ListCode="UDL_BOL" DataField="BASIS_OF_LIMIT" DataItemValue="key" />
<Nexus:RiskAttribute HeaderText="Limit of Indemnity / site p.a" DataField="LIMIT_OF_INDEMNITY" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Limit of Indemnity per claim" DataField="LIMIT_OF_INDEMNITY_CLAIMS" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valRISK_DETAILS_SITEDETS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RISK_DETAILS.SITEDETS"
						ClientValidationFunction="onValidate_RISK_DETAILS__SITEDETS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
