...
Namespace Nexus
    Partial Class PB2_PIPESTORE_Risk_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_RISK_DETAILS__RETRO_DATE()
         
End Sub
Protected Sub CallRuleScripts()
    onValidate_RISK_DETAILS__RETRO_DATE()
End Sub
