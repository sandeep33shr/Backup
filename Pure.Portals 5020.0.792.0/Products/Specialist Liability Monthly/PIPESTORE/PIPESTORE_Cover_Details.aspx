<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PIPESTORE_Cover_Details.aspx.vb" Inherits="Nexus.PB2_PIPESTORE_Cover_Details" %>
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("At least one Mid-Term Adjustment reason should be entered")) ? "At least one Mid-Term Adjustment reason should be entered" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_GENERAL__IS_MTA_REASON(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "GENERAL.TRANSTYPE =='MTA'", "R", "{3}");
...
function onValidate_GENERAL__PIPESTREAS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "PIPESTREAS", "ChildScreen");
        })();
}
...
function onValidate_ADDRESS__LINE1(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "ADDRESS.ADDRESS_CHECK == 1", "V", "No. & Street name is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "ADDRESS.ADDRESS_CHECK == 1",
            paramElseValue = "V",
            paramValidationMessage = "No. & Street name is mandatory and must be entered";
...
function onValidate_ADDRESS__SUBURB(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "ADDRESS.ADDRESS_CHECK == 1", "V", "Suburb is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "ADDRESS.ADDRESS_CHECK == 1",
            paramElseValue = "V",
            paramValidationMessage = "Suburb is mandatory and must be entered";
...
function onValidate_ADDRESS__TOWN(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "ADDRESS.ADDRESS_CHECK == 1", "V", "{3}");
        ...
        $(document).ready(function()
        {
        	...
        	events.listen(address_field,"change", function (e)
        	{
        		...
        		{
        			__doPostBack('<%=asyncPanel.ClientID%>', 'ClientAddress,' + address_result);
        		}
...
function onValidate_ADDRESS__COUNTRY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "ADDRESS.ADDRESS_CHECK == 1", "V", "Country is mandatory and an option must be selected");
        
            var paramValue = "VEM",
            paramCondition = "ADDRESS.ADDRESS_CHECK == 1",
            paramElseValue = "V",
            paramValidationMessage = "Country is mandatory and an option must be selected";
...
function onValidate_ADDRESS__ADDRESS_CHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDRESS", "ADDRESS_CHECK", "Checkbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("ADDRESS", "ADDRESS_CHECK");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_INDUSTRY__PRIMARY_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INDUSTRY", "PRIMARY_INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("INDUSTRY", "PRIMARY_INDUSTRY");
        		var errorMessage = "Primary Industry is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblINDUSTRY_PRIMARY_INDUSTRY");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INDUSTRY.PRIMARY_INDUSTRY");
        			window.setControlWidth(field, "0.6", "INDUSTRY", "PRIMARY_INDUSTRY");
        		})();
        	}
        })();
}
function onValidate_INDUSTRY__SECONDARY_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INDUSTRY", "SECONDARY_INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("INDUSTRY", "SECONDARY_INDUSTRY");
        		var errorMessage = "Secondary Industry is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblINDUSTRY_SECONDARY_INDUSTRY");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INDUSTRY.SECONDARY_INDUSTRY");
        			window.setControlWidth(field, "0.6", "INDUSTRY", "SECONDARY_INDUSTRY");
        		})();
        	}
        })();
}
function onValidate_INDUSTRY__INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INDUSTRY", "INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("INDUSTRY", "INDUSTRY");
        		var errorMessage = "Industry is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblINDUSTRY_INDUSTRY");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INDUSTRY.INDUSTRY");
        			window.setControlWidth(field, "0.6", "INDUSTRY", "INDUSTRY");
        		})();
        	}
        })();
}
function onValidate_RETROCESSION__RETROPIPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETROCESSION", "RETROPIPE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__PIPESTREAS(null, null, null, isOnLoad);
    ...
    onValidate_ADDRESS__ADDRESS_CHECK(null, null, null, isOnLoad);
    onValidate_INDUSTRY__PRIMARY_INDUSTRY(null, null, null, isOnLoad);
    onValidate_INDUSTRY__SECONDARY_INDUSTRY(null, null, null, isOnLoad);
    onValidate_INDUSTRY__INDUSTRY(null, null, null, isOnLoad);
    onValidate_RETROCESSION__RETROPIPE(null, null, null, isOnLoad);
}
</script>
...
<div id="id667a9df07b584f69b365e1afe4cf9b89" class="general-layout-container">
...
<div id="id0a13572750c042858b43491daff6a37b" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Environmental - Pipelines and Storage" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id0a13572750c042858b43491daff6a37b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0a13572750c042858b43491daff6a37b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0a13572750c042858b43491daff6a37b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0a13572750c042858b43491daff6a37b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0a13572750c042858b43491daff6a37b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0a13572750c042858b43491daff6a37b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0a13572750c042858b43491daff6a37b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0a13572750c042858b43491daff6a37b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0a13572750c042858b43491daff6a37b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0a13572750c042858b43491daff6a37b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmMTAReason" class="column-layout-container fieldset-wrapper,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__PIPESTREAS"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="PIPESTREAS" 
		id="pb-container-childscreen-GENERAL-PIPESTREAS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="PIPESTREAS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PIPESTREAS/PIPESTREAS_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_PIPESTREAS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.PIPESTREAS"
						ClientValidationFunction="onValidate_GENERAL__PIPESTREAS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmAddress" class="column-layout-container fieldset-wrapper,no-border  ">
...
<!-- /List -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblADDRESS_ADDRESS_CHECK" for="ctl00_cntMainBody_ADDRESS__ADDRESS_CHECK" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="ADDRESS" 
		data-property-name="ADDRESS_CHECK" 
		id="pb-container-checkbox-ADDRESS-ADDRESS_CHECK">	
		
		<asp:TextBox ID="ADDRESS__ADDRESS_CHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valADDRESS_ADDRESS_CHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for ADDRESS.ADDRESS_CHECK"
			ClientValidationFunction="onValidate_ADDRESS__ADDRESS_CHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#frmAddress div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmAddress div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmAddress div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmAddress label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmAddress label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmAddress label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmAddress label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmAddress input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmAddress input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmAddress input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmIndustry" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading8" runat="server" Text="Industry" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="INDUSTRY" 
		data-property-name="PRIMARY_INDUSTRY" 
		id="pb-container-list-INDUSTRY-PRIMARY_INDUSTRY">
		<asp:Label ID="lblINDUSTRY_PRIMARY_INDUSTRY" runat="server" AssociatedControlID="INDUSTRY__PRIMARY_INDUSTRY" 
			Text="Primary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="INDUSTRY__PRIMARY_INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSONE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_INDUSTRY__PRIMARY_INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valINDUSTRY_PRIMARY_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Primary Industry"
			ClientValidationFunction="onValidate_INDUSTRY__PRIMARY_INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="INDUSTRY" 
		data-property-name="SECONDARY_INDUSTRY" 
		id="pb-container-list-INDUSTRY-SECONDARY_INDUSTRY">
		<asp:Label ID="lblINDUSTRY_SECONDARY_INDUSTRY" runat="server" AssociatedControlID="INDUSTRY__SECONDARY_INDUSTRY" 
			Text="Secondary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="INDUSTRY__SECONDARY_INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTWO" ParentLookupListID="INDUSTRY__PRIMARY_INDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_INDUSTRY__SECONDARY_INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valINDUSTRY_SECONDARY_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Secondary Industry"
			ClientValidationFunction="onValidate_INDUSTRY__SECONDARY_INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-INDUSTRY-INDUSTRY">
		<asp:Label ID="lblINDUSTRY_INDUSTRY" runat="server" AssociatedControlID="INDUSTRY__INDUSTRY" 
			Text="Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="INDUSTRY__INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTHREE" ParentLookupListID="INDUSTRY__SECONDARY_INDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_INDUSTRY__INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valINDUSTRY_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Industry"
			ClientValidationFunction="onValidate_INDUSTRY__INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb4bfd66c75204bc0aa506aa23660403e" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Retrocession" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RETROCESSION__RETROPIPE"
		data-field-type="Child" 
		data-object-name="RETROCESSION" 
		data-property-name="RETROPIPE" 
		id="pb-container-childscreen-RETROCESSION-RETROPIPE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RETROCESSION__RETRO_DETAILS" runat="server" ScreenCode="RETROPIPE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RETROPIPE/RETROPIPE_Retrocession_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valRETROCESSION_RETROPIPE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RETROCESSION.RETROPIPE"
						ClientValidationFunction="onValidate_RETROCESSION__RETROPIPE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#idb4bfd66c75204bc0aa506aa23660403e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb4bfd66c75204bc0aa506aa23660403e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb4bfd66c75204bc0aa506aa23660403e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb4bfd66c75204bc0aa506aa23660403e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb4bfd66c75204bc0aa506aa23660403e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb4bfd66c75204bc0aa506aa23660403e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb4bfd66c75204bc0aa506aa23660403e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb4bfd66c75204bc0aa506aa23660403e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb4bfd66c75204bc0aa506aa23660403e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb4bfd66c75204bc0aa506aa23660403e input{text-align:left;}"; break;
		}
	}
