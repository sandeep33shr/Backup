<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EVENTLIAB_Notes.aspx.vb" Inherits="Nexus.PB2_EVENTLIAB_Notes" %>
...
function onValidate_NOTES__EVNNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "EVNNOTES", "ChildScreen");
        })();
}
function onValidate_NOTESEXT__EXT_NTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTESEXT", "EXT_NTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__EVNNOTES(null, null, null, isOnLoad);
    onValidate_NOTESEXT__EXT_NTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id52c1fdc50aee4c16a7a5902c1078e7c5" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading25" runat="server" Text="Events Liability Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__EVNNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="EVNNOTES" 
		id="pb-container-childscreen-NOTES-EVNNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="EVNNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EVNNOTES/EVNNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_EVNNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__EVNNOTES" 
						Display="None"
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5112ba7c93fd4da0a2e56128d92327c6" class="column-layout-container fieldset-wrapper,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTESEXT__EXT_NTES"
		data-field-type="Child" 
		data-object-name="NOTESEXT" 
		data-property-name="EXT_NTES" 
		id="pb-container-childscreen-NOTESEXT-EXT_NTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTESEXT__EXT_DETAILS" runat="server" ScreenCode="EXT_NTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EXT_NTES/EXT_NTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTESEXT_EXT_NTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTESEXT__EXT_NTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id5112ba7c93fd4da0a2e56128d92327c6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5112ba7c93fd4da0a2e56128d92327c6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5112ba7c93fd4da0a2e56128d92327c6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5112ba7c93fd4da0a2e56128d92327c6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5112ba7c93fd4da0a2e56128d92327c6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5112ba7c93fd4da0a2e56128d92327c6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5112ba7c93fd4da0a2e56128d92327c6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5112ba7c93fd4da0a2e56128d92327c6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5112ba7c93fd4da0a2e56128d92327c6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5112ba7c93fd4da0a2e56128d92327c6 input{text-align:left;}"; break;
		}
	}
