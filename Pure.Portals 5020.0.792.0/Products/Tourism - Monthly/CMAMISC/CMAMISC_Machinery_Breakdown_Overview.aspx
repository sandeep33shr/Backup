...
function onValidate_label650(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label650" != "{na" + "me}"){
        			instance = Field.getLabel("label650");
        		} else { 
...
function DoLogic(isOnLoad) {
    onValidate_label650(null, null, null, isOnLoad);
...
<div id="iddd23273836ab4951ba98273fac3c6797" class="general-layout-container">
...
<div id="id3e770046433c473db27ea25decb0f73b" class="column-layout-container,no-border  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label650">
		<span class="label" id="label650">Total Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label651">
		<span class="label" id="label651">EML%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label652">
		<span class="label" id="label652">RI Exposure (VAT Incl.)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label653">
		<span class="label" id="label653">RI Exposure (VAT Excl.)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label654">
		<span class="label" id="label654">Machinery Breakdown</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label655">
		<span class="label" id="label655">Machinery Breakdown Additional Claims Preparation Cost</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label656">
		<span class="label" id="label656">Consequential Loss Gross Profit/Revenue</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label657">
		<span class="label" id="label657">Consequential Loss Additional Claims Preparation Cost</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label658">
		<span class="label" id="label658">Deterioration of Stock</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label659">
		<span class="label" id="label659">Totals</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label660">
		<span class="label" id="label660"></span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3e770046433c473db27ea25decb0f73b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3e770046433c473db27ea25decb0f73b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3e770046433c473db27ea25decb0f73b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3e770046433c473db27ea25decb0f73b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3e770046433c473db27ea25decb0f73b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3e770046433c473db27ea25decb0f73b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3e770046433c473db27ea25decb0f73b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3e770046433c473db27ea25decb0f73b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3e770046433c473db27ea25decb0f73b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3e770046433c473db27ea25decb0f73b input{text-align:left;}"; break;
		}
	}
