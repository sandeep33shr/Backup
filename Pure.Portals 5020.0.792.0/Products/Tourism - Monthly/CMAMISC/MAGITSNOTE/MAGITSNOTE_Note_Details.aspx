<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MAGITSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_MAGITSNOTE_Note_Details" %>
...
function onValidate_GIT_SCNOTE_DETAILS__Date_Created(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_SCNOTE_DETAILS", "Date_Created", "Date");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("GIT_SCNOTE_DETAILS", "Date_Created");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=GIT_SCNOTE_DETAILS&propertyName=Date_Created&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "GIT_SCNOTE_DETAILS" && field.getPropertyName() == "Date_Created")
...
function onValidate_GIT_SCNOTE_DETAILS__Time_Created(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_SCNOTE_DETAILS", "Time_Created", "Text");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GIT_SCNOTE_DETAILS&propertyName=Time_Created&name={name}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("GIT_SCNOTE_DETAILS", "Time_Created");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
...
function onValidate_GIT_SCNOTE_DETAILS__Created_By(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_SCNOTE_DETAILS", "Created_By", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("GIT_SCNOTE_DETAILS", "Created_By");
        	field.setReadOnly(true);
        })();
}
function onValidate_GIT_SCNOTE_DETAILS__Risk_Cover(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_SCNOTE_DETAILS", "Risk_Cover", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GIT_SCNOTE_DETAILS.Risk_Cover");
        			window.setControlWidth(field, "3", "GIT_SCNOTE_DETAILS", "Risk_Cover");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GIT_SCNOTE_DETAILS&propertyName=Risk_Cover&name={name}");
...
function onValidate_GIT_SCNOTE_DETAILS__Note_Subject(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_SCNOTE_DETAILS", "Note_Subject", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GIT_SCNOTE_DETAILS", "Note_Subject");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GIT_SCNOTE_DETAILS.Note_Subject");
        			window.setControlWidth(field, "3", "GIT_SCNOTE_DETAILS", "Note_Subject");
        		})();
        	}
        })();
}
function onValidate_GIT_SCNOTE_DETAILS__Note_Details(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_SCNOTE_DETAILS", "Note_Details", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GIT_SCNOTE_DETAILS", "Note_Details");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GIT_SCNOTE_DETAILS.Note_Details");
        			window.setControlWidth(field, "3", "GIT_SCNOTE_DETAILS", "Note_Details");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=GIT_SCNOTE_DETAILS&propertyName=Note_Details&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_GIT_SCNOTE_DETAILS__Note_Details');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_GIT_SCNOTE_DETAILS_Note_Details_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_GIT_SCNOTE_DETAILS__Date_Created(null, null, null, isOnLoad);
    onValidate_GIT_SCNOTE_DETAILS__Time_Created(null, null, null, isOnLoad);
    onValidate_GIT_SCNOTE_DETAILS__Created_By(null, null, null, isOnLoad);
    onValidate_GIT_SCNOTE_DETAILS__Risk_Cover(null, null, null, isOnLoad);
    onValidate_GIT_SCNOTE_DETAILS__Note_Subject(null, null, null, isOnLoad);
    onValidate_GIT_SCNOTE_DETAILS__Note_Details(null, null, null, isOnLoad);
}
</script>
...
<div id="idf51e3a4358c84e8dbdde987cdb90862e" class="general-layout-container">
...
<div id="idb81dce556cfd4ad6bed90291327d38a3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading104" runat="server" Text="Note Detail (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GIT_SCNOTE_DETAILS" 
		data-property-name="Date_Created" 
		id="pb-container-datejquerycompatible-GIT_SCNOTE_DETAILS-Date_Created">
		<asp:Label ID="lblGIT_SCNOTE_DETAILS_Date_Created" runat="server" AssociatedControlID="GIT_SCNOTE_DETAILS__Date_Created" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="GIT_SCNOTE_DETAILS__Date_Created" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calGIT_SCNOTE_DETAILS__Date_Created" runat="server" LinkedControl="GIT_SCNOTE_DETAILS__Date_Created" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valGIT_SCNOTE_DETAILS_Date_Created" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_GIT_SCNOTE_DETAILS__Date_Created" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GIT_SCNOTE_DETAILS-Time_Created">

		
		<asp:Label ID="lblGIT_SCNOTE_DETAILS_Time_Created" runat="server" AssociatedControlID="GIT_SCNOTE_DETAILS__Time_Created" 
			Text="Time Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GIT_SCNOTE_DETAILS__Time_Created" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGIT_SCNOTE_DETAILS_Time_Created" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Time Created"
					ClientValidationFunction="onValidate_GIT_SCNOTE_DETAILS__Time_Created"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GIT_SCNOTE_DETAILS-Created_By">

		
		<asp:Label ID="lblGIT_SCNOTE_DETAILS_Created_By" runat="server" AssociatedControlID="GIT_SCNOTE_DETAILS__Created_By" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GIT_SCNOTE_DETAILS__Created_By" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGIT_SCNOTE_DETAILS_Created_By" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_GIT_SCNOTE_DETAILS__Created_By"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GIT_SCNOTE_DETAILS-Risk_Cover">

		
		<asp:Label ID="lblGIT_SCNOTE_DETAILS_Risk_Cover" runat="server" AssociatedControlID="GIT_SCNOTE_DETAILS__Risk_Cover" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GIT_SCNOTE_DETAILS__Risk_Cover" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGIT_SCNOTE_DETAILS_Risk_Cover" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_GIT_SCNOTE_DETAILS__Risk_Cover"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GIT_SCNOTE_DETAILS-Note_Subject">

		
		<asp:Label ID="lblGIT_SCNOTE_DETAILS_Note_Subject" runat="server" AssociatedControlID="GIT_SCNOTE_DETAILS__Note_Subject" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GIT_SCNOTE_DETAILS__Note_Subject" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGIT_SCNOTE_DETAILS_Note_Subject" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_GIT_SCNOTE_DETAILS__Note_Subject"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-GIT_SCNOTE_DETAILS-Note_Details">
		<asp:Label ID="lblGIT_SCNOTE_DETAILS_Note_Details" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="GIT_SCNOTE_DETAILS__Note_Details" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="GIT_SCNOTE_DETAILS__Note_Details" runat="server" />
		
		<asp:CustomValidator ID="valGIT_SCNOTE_DETAILS_Note_Details" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_GIT_SCNOTE_DETAILS__Note_Details"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb81dce556cfd4ad6bed90291327d38a3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb81dce556cfd4ad6bed90291327d38a3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb81dce556cfd4ad6bed90291327d38a3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb81dce556cfd4ad6bed90291327d38a3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb81dce556cfd4ad6bed90291327d38a3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb81dce556cfd4ad6bed90291327d38a3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb81dce556cfd4ad6bed90291327d38a3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb81dce556cfd4ad6bed90291327d38a3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb81dce556cfd4ad6bed90291327d38a3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb81dce556cfd4ad6bed90291327d38a3 input{text-align:left;}"; break;
		}
	}
