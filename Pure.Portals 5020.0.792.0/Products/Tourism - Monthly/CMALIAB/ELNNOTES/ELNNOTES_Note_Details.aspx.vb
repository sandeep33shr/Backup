...
Namespace Nexus
    Partial Class PB2_ELNNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_EL_CNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If EL_CNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		EL_CNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		EL_CNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_EL_CNOTE_DETAILS__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_EL_CNOTE_DETAILS__NOTE_DETAILS()
    onValidate_EL_CNOTE_DETAILS__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		EL_CNOTE_DETAILS__NoteCheck.Text = 1
        	End If
        End Sub
