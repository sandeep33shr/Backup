...
Namespace Nexus
    Partial Class PB2_CMDNOSNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_DNO_SCNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If DNO_SCNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		DNO_SCNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		DNO_SCNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_DNO_SCNOTE_DETAILS__NOTE_DETAILS()
End Sub
