...
Namespace Nexus
    Partial Class PB2_PL_PREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_CLPL_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CLPL_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'COMLIAB - Standard Wording Parent Object
        'COMLIAB_CLAUSES - Standard Wording Parent Property
        'CLPL_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/COMLIAB/SW.COMLIAB_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("CLPL_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/COMLIAB/CLPL_CLAUSEPREM")
        
        	Dim CurrentSelected As String = CLPL_CLAUSEPREM__ENDORSE_CAP.Text
