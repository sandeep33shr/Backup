<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCNDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CCNDOS_Endorsement_Premium" %>
...
function onValidate_CC_ENDOSE__CCENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CC_ENDOSE", "CCENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CC_ENDOSE", "CCENDORSE_ID");
        		}
...
function onValidate_CC_ENDOSE__CCENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CC_ENDOSE", "CCENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CC_ENDOSE", "CCENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CC_ENDOSE.CCENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "CC_ENDOSE", "CCENDORSE_DESC");
        		})();
        	}
        })();
}
function onValidate_CC_ENDOSE__CCENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CC_ENDOSE", "CCENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CC_ENDOSE", "CCENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CC_ENDOSE&propertyName=CCENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(CC_ENDOSE.CCENDORSE_DESC)"), 
...
function onValidate_CC_ENDOSE__CCPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CC_ENDOSE", "CCPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CC_ENDOSE", "CCPREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CC_ENDOSE.CCPREMIUM");
        			window.setControlWidth(field, "0.5", "CC_ENDOSE", "CCPREMIUM");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CC_ENDOSE__CCENDORSE_ID(null, null, null, isOnLoad);
    onValidate_CC_ENDOSE__CCENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_CC_ENDOSE__CCENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_CC_ENDOSE__CCPREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idc4167e394ecb4245b48c29cad0dd6b24" class="general-layout-container">
...
<div id="id73a5fa923f834102b4e15266b3de24cc" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CC_ENDOSE" 
		data-property-name="CCENDORSE_ID" 
		id="pb-container-integer-CC_ENDOSE-CCENDORSE_ID">
		<asp:Label ID="lblCC_ENDOSE_CCENDORSE_ID" runat="server" AssociatedControlID="CC_ENDOSE__CCENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CC_ENDOSE__CCENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCC_ENDOSE_CCENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_CC_ENDOSE__CCENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CC_ENDOSE" 
		data-property-name="CCENDORSE_DESC" 
		id="pb-container-list-CC_ENDOSE-CCENDORSE_DESC">
		<asp:Label ID="lblCC_ENDOSE_CCENDORSE_DESC" runat="server" AssociatedControlID="CC_ENDOSE__CCENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CC_ENDOSE__CCENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CC_ENDOSE__CCENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCC_ENDOSE_CCENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_CC_ENDOSE__CCENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CC_ENDOSE" 
		data-property-name="CCENDORSE_CAP" 
		 
		
		 
		id="pb-container-text-CC_ENDOSE-CCENDORSE_CAP">

		
		<asp:Label ID="lblCC_ENDOSE_CCENDORSE_CAP" runat="server" AssociatedControlID="CC_ENDOSE__CCENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CC_ENDOSE__CCENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCC_ENDOSE_CCENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_CC_ENDOSE__CCENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CC_ENDOSE" 
		data-property-name="CCPREMIUM" 
		id="pb-container-currency-CC_ENDOSE-CCPREMIUM">
		<asp:Label ID="lblCC_ENDOSE_CCPREMIUM" runat="server" AssociatedControlID="CC_ENDOSE__CCPREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CC_ENDOSE__CCPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCC_ENDOSE_CCPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CC_ENDOSE__CCPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id73a5fa923f834102b4e15266b3de24cc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id73a5fa923f834102b4e15266b3de24cc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id73a5fa923f834102b4e15266b3de24cc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id73a5fa923f834102b4e15266b3de24cc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id73a5fa923f834102b4e15266b3de24cc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id73a5fa923f834102b4e15266b3de24cc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id73a5fa923f834102b4e15266b3de24cc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id73a5fa923f834102b4e15266b3de24cc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id73a5fa923f834102b4e15266b3de24cc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id73a5fa923f834102b4e15266b3de24cc input{text-align:left;}"; break;
		}
	}
