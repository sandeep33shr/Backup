<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TCNDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_TCNDOS_Endorsement_Premium" %>
...
function onValidate_TC_ENDOSE__TCENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TC_ENDOSE", "TCENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TC_ENDOSE", "TCENDORSE_ID");
        		}
...
function onValidate_TC_ENDOSE__TCENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TC_ENDOSE", "TCENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TC_ENDOSE", "TCENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TC_ENDOSE.TCENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "TC_ENDOSE", "TCENDORSE_DESC");
        		})();
        	}
        })();
}
function onValidate_TC_ENDOSE__TCENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TC_ENDOSE", "TCENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TC_ENDOSE", "TCENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=TC_ENDOSE&propertyName=TCENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(TC_ENDOSE.TCENDORSE_DESC)"), 
...
function onValidate_TC_ENDOSE__TCPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TC_ENDOSE", "TCPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TC_ENDOSE", "TCPREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TC_ENDOSE.TCPREMIUM");
        			window.setControlWidth(field, "0.5", "TC_ENDOSE", "TCPREMIUM");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TC_ENDOSE__TCENDORSE_ID(null, null, null, isOnLoad);
    onValidate_TC_ENDOSE__TCENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_TC_ENDOSE__TCENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_TC_ENDOSE__TCPREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id82188fc61ce6440a841e03785583ab15" class="general-layout-container">
...
<div id="idd2500bde9205418bbc65f42e5cd899d8" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TC_ENDOSE" 
		data-property-name="TCENDORSE_ID" 
		id="pb-container-integer-TC_ENDOSE-TCENDORSE_ID">
		<asp:Label ID="lblTC_ENDOSE_TCENDORSE_ID" runat="server" AssociatedControlID="TC_ENDOSE__TCENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="TC_ENDOSE__TCENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valTC_ENDOSE_TCENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_TC_ENDOSE__TCENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TC_ENDOSE" 
		data-property-name="TCENDORSE_DESC" 
		id="pb-container-list-TC_ENDOSE-TCENDORSE_DESC">
		<asp:Label ID="lblTC_ENDOSE_TCENDORSE_DESC" runat="server" AssociatedControlID="TC_ENDOSE__TCENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="TC_ENDOSE__TCENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_TC_ENDOSE__TCENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valTC_ENDOSE_TCENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_TC_ENDOSE__TCENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="TC_ENDOSE" 
		data-property-name="TCENDORSE_CAP" 
		 
		
		 
		id="pb-container-text-TC_ENDOSE-TCENDORSE_CAP">

		
		<asp:Label ID="lblTC_ENDOSE_TCENDORSE_CAP" runat="server" AssociatedControlID="TC_ENDOSE__TCENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TC_ENDOSE__TCENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTC_ENDOSE_TCENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_TC_ENDOSE__TCENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TC_ENDOSE" 
		data-property-name="TCPREMIUM" 
		id="pb-container-currency-TC_ENDOSE-TCPREMIUM">
		<asp:Label ID="lblTC_ENDOSE_TCPREMIUM" runat="server" AssociatedControlID="TC_ENDOSE__TCPREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TC_ENDOSE__TCPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTC_ENDOSE_TCPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_TC_ENDOSE__TCPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd2500bde9205418bbc65f42e5cd899d8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd2500bde9205418bbc65f42e5cd899d8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd2500bde9205418bbc65f42e5cd899d8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd2500bde9205418bbc65f42e5cd899d8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd2500bde9205418bbc65f42e5cd899d8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd2500bde9205418bbc65f42e5cd899d8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd2500bde9205418bbc65f42e5cd899d8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd2500bde9205418bbc65f42e5cd899d8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd2500bde9205418bbc65f42e5cd899d8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd2500bde9205418bbc65f42e5cd899d8 input{text-align:left;}"; break;
		}
	}
