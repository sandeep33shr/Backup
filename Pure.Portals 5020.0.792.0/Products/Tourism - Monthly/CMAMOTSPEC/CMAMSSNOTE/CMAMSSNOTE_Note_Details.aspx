<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMSSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_CMAMSSNOTE_Note_Details" %>
...
<div id="id04620c865b0a414fac2cb63d6a4d7032" class="general-layout-container">
...
<div id="iddd7d4961ba5249d9a1c62cb6bcbc0b59" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddd7d4961ba5249d9a1c62cb6bcbc0b59 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddd7d4961ba5249d9a1c62cb6bcbc0b59 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddd7d4961ba5249d9a1c62cb6bcbc0b59 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddd7d4961ba5249d9a1c62cb6bcbc0b59 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddd7d4961ba5249d9a1c62cb6bcbc0b59 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddd7d4961ba5249d9a1c62cb6bcbc0b59 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddd7d4961ba5249d9a1c62cb6bcbc0b59 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddd7d4961ba5249d9a1c62cb6bcbc0b59 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddd7d4961ba5249d9a1c62cb6bcbc0b59 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddd7d4961ba5249d9a1c62cb6bcbc0b59 input{text-align:left;}"; break;
		}
	}
