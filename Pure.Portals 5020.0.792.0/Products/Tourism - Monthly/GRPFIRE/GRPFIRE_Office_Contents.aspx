...
function onValidate_OFFICE__THEFT_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("OFFICE.THEFT_SI * (OFFICE.THEFT_RATE * 0.01)"), 
        			condition = (Expression.isValidParameter("OFFICE.THEFT_SI>0")) ? new Expression("OFFICE.THEFT_SI>0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("OFFICE", "THEFT_SI");
        	var Rate = Field.getInstance("OFFICE", "THEFT_RATE");
        	var Premium = Field.getInstance("OFFICE", "THEFT_PREMIUM");
...
function onValidate_OFFICE__THEFT_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Theft (following forcible and violent entry/exit) FAP% cannot be greater than 100%")) ? "Theft (following forcible and violent entry/exit) FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_OFFICE_EXTENSIONS__THEFT_PREMIUM(source, args, sender, isOnLoad) {
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("OFFICE_EXTENSIONS", "THEFT_LOI");
        	var Rate = Field.getInstance("OFFICE_EXTENSIONS", "THEFT_RATE");
        	var Premium = Field.getInstance("OFFICE_EXTENSIONS", "THEFT_PREMIUM");
...
function onValidate_OFFICE_EXTENSIONS__THEFT_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Theft (Non Forcible) FAP% cannot be greater than 100%")) ? "Theft (Non Forcible) FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_OFFICE_EXTENSIONS__WILD_BM_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("OFFICE_EXTENSIONS.WILD_BM_LOI*(OFFICE_EXTENSIONS.WILD_BM_RATE*0.01)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("OFFICE_EXTENSIONS", "WILD_BM_LOI");
        	var Rate = Field.getInstance("OFFICE_EXTENSIONS", "WILD_BM_RATE");
        	var Premium = Field.getInstance("OFFICE_EXTENSIONS", "WILD_BM_PREMIUM");
...
function onValidate_OFFICE_EXTENSIONS__WILD_BM_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Wild Baboons and Monkeys FAP% cannot be greater than 100%")) ? "Wild Baboons and Monkeys FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
<div id="idfef601f806d7400e9c7a1b596b85b2de" class="general-layout-container">
...
<div id="idad4405577a7d4249bb7c400aa7f30b43" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idad4405577a7d4249bb7c400aa7f30b43 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idad4405577a7d4249bb7c400aa7f30b43 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idad4405577a7d4249bb7c400aa7f30b43 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idad4405577a7d4249bb7c400aa7f30b43 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idad4405577a7d4249bb7c400aa7f30b43 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idad4405577a7d4249bb7c400aa7f30b43 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idad4405577a7d4249bb7c400aa7f30b43 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idad4405577a7d4249bb7c400aa7f30b43 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idad4405577a7d4249bb7c400aa7f30b43 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idad4405577a7d4249bb7c400aa7f30b43 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5a372bec57ae4b908ff20410fc9f8fcf" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5a372bec57ae4b908ff20410fc9f8fcf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5a372bec57ae4b908ff20410fc9f8fcf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5a372bec57ae4b908ff20410fc9f8fcf div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5a372bec57ae4b908ff20410fc9f8fcf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5a372bec57ae4b908ff20410fc9f8fcf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5a372bec57ae4b908ff20410fc9f8fcf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5a372bec57ae4b908ff20410fc9f8fcf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5a372bec57ae4b908ff20410fc9f8fcf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5a372bec57ae4b908ff20410fc9f8fcf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5a372bec57ae4b908ff20410fc9f8fcf input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0ea68e22e52e43df93ab00e1c7de4fd5" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id