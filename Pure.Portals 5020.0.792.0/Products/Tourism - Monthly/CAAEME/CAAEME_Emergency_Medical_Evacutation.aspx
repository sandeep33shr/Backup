<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAEME_Emergency_Medical_Evacutation.aspx.vb" Inherits="Nexus.PB2_CAAEME_Emergency_Medical_Evacutation" %>
...
function onValidate_CAAEMERSK__SEAT_NO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "SEAT_NO", "Integer");
        })();
}
function onValidate_CAAEMERSK__SEAT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "SEAT_PREM", "Currency");
        })();
}
function onValidate_CAAEMERSK__BED_NO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "BED_NO", "Integer");
        })();
}
function onValidate_CAAEMERSK__BED_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "BED_PREM", "Currency");
        })();
}
function onValidate_CAAEMERSK__EMP_NO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "EMP_NO", "Integer");
        })();
}
function onValidate_CAAEMERSK__EMP_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "EMP_PREM", "Currency");
        })();
}
function onValidate_CAAEMERSK__TOTAL_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "TOTAL_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CAAEMERSK&propertyName=TOTAL_PREM&name={name}");
        		
        		var value = new Expression("CAAEMERSK.SEAT_PREM + CAAEMERSK.BED_PREM + CAAEMERSK.EMP_PREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EXTENSIONS__IS_EXTT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTENSIONS", "IS_EXTT", "Checkbox");
        })();
}
function onValidate_EXTENSIONS__EXTT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTENSIONS", "EXTT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTENSIONS", "EXTT_PREM");
        		}
        		//window.setProperty(field, "VEM", "EXTENSIONS.IS_EXTT == 1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EXTENSIONS.IS_EXTT == 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_EXTENSIONS__IS_GQB(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTENSIONS", "IS_GQB", "Checkbox");
        })();
}
function onValidate_EXTENSIONS__GQB_PPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTENSIONS", "GQB_PPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTENSIONS", "GQB_PPREM");
        		}
        		//window.setProperty(field, "VEM", "EXTENSIONS.IS_GQB == 1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EXTENSIONS.IS_GQB == 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_EXTENSIONS__IS_GHR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTENSIONS", "IS_GHR", "Checkbox");
        })();
}
function onValidate_EXTENSIONS__GHR_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTENSIONS", "GHR_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTENSIONS", "GHR_PREM");
        		}
        		//window.setProperty(field, "VEM", "EXTENSIONS.IS_GHR == 1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EXTENSIONS.IS_GHR == 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_EXTENSIONS__TOTAL_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("EXTENSIONS", "TOTAL_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EXTENSIONS.EXTT_PREM + EXTENSIONS.GQB_PPREM + EXTENSIONS.GHR_PREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_FAP__EE_PER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP", "EE_PER", "Percentage");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FAP", "EE_PER");
        		var errorMessage = "Emergency Evacuation FAP % is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
...
function onValidate_FAP__EE_MIN_AMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP", "EE_MIN_AMT", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FAP", "EE_MIN_AMT");
        		var errorMessage = "Emergency Evacuation Minimum Amount is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
...
function onValidate_FAP__HA_PER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP", "HA_PER", "Percentage");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FAP", "HA_PER");
        		var errorMessage = "Hospital Admission FAP % is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
...
function onValidate_FAP__HA_MIN_AMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP", "HA_MIN_AMT", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FAP", "HA_MIN_AMT");
        		var errorMessage = "Hospital Admission Minimum Amount is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
...
function onValidate_FAP__OTHER_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP", "OTHER_DESC", "Text");
        })();
}
function onValidate_FAP__OTHER_PER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP", "OTHER_PER", "Percentage");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FAP", "OTHER_PER");
...
function onValidate_FAP__OTHER_MIN_AMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP", "OTHER_MIN_AMT", "Currency");
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FAP", "OTHER_MIN_AMT");
...
function onValidate_ENDORSEMENT__TOT_ENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENDORSEMENT", "TOT_ENDPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("ENDORSEMENT", "TOT_ENDPREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ENDORSEMENT.TOT_ENDPREM");
        			window.setControlWidth(field, "0.4", "ENDORSEMENT", "TOT_ENDPREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblENDORSEMENT_TOT_ENDPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_ENDORSEMENT__TOT_ENDPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ENDORSEMENT__TOT_ENDPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
          ...
          * @param ENDORSEMENT The Parent (Root) object name.
          * @param CAAEME_ENDOSE.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "ENDORSEMENT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "CAAEME_ENDOSE.PREMIUM";
...
function onValidate_ENDORSEMENT__CAAEMENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENDORSEMENT", "CAAEMENDOS", "ChildScreen");
        })();
}
function onValidate_CAAEMERSK__CAAEMENOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "CAAEMENOTE", "ChildScreen");
        })();
}
function onValidate_CAAEMERSK__CAAEMENOT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEMERSK", "CAAEMENOT", "ChildScreen");
        })();
}
function onValidate_EMPDE__TOT_SUM_INS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TOT_SUM_INS", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("EMPDE", "TOT_SUM_INS");
        	field.setReadOnly(true);
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CAAEMERSK__SEAT_NO(null, null, null, isOnLoad);
    onValidate_CAAEMERSK__SEAT_PREM(null, null, null, isOnLoad);
    onValidate_CAAEMERSK__BED_NO(null, null, null, isOnLoad);
    onValidate_CAAEMERSK__BED_PREM(null, null, null, isOnLoad);
    onValidate_CAAEMERSK__EMP_NO(null, null, null, isOnLoad);
    onValidate_CAAEMERSK__EMP_PREM(null, null, null, isOnLoad);
    onValidate_CAAEMERSK__TOTAL_PREM(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__IS_EXTT(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__EXTT_PREM(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__IS_GQB(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__GQB_PPREM(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__IS_GHR(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__GHR_PREM(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__TOTAL_PREM(null, null, null, isOnLoad);
    onValidate_FAP__EE_PER(null, null, null, isOnLoad);
    onValidate_FAP__EE_MIN_AMT(null, null, null, isOnLoad);
    onValidate_FAP__HA_PER(null, null, null, isOnLoad);
    onValidate_FAP__HA_MIN_AMT(null, null, null, isOnLoad);
    onValidate_FAP__OTHER_DESC(null, null, null, isOnLoad);
    onValidate_FAP__OTHER_PER(null, null, null, isOnLoad);
    onValidate_FAP__OTHER_MIN_AMT(null, null, null, isOnLoad);
    onValidate_ENDORSEMENT__TOT_ENDPREM(null, null, null, isOnLoad);
    onValidate_ENDORSEMENT__CAAEMENDOS(null, null, null, isOnLoad);
    onValidate_CAAEMERSK__CAAEMENOTE(null, null, null, isOnLoad);
    onValidate_CAAEMERSK__CAAEMENOT(null, null, null, isOnLoad);
    onValidate_EMPDE__TOT_SUM_INS(null, null, null, isOnLoad);
...
<div id="id1a309af2858944a8999bfecd7ee52554" class="general-layout-container">
...
<div id="id02bbfccfe26c44d4a5750fe0a8ef8e0a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id02bbfccfe26c44d4a5750fe0a8ef8e0a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id02bbfccfe26c44d4a5750fe0a8ef8e0a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id02bbfccfe26c44d4a5750fe0a8ef8e0a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id02bbfccfe26c44d4a5750fe0a8ef8e0a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id02bbfccfe26c44d4a5750fe0a8ef8e0a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id02bbfccfe26c44d4a5750fe0a8ef8e0a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id02bbfccfe26c44d4a5750fe0a8ef8e0a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id02bbfccfe26c44d4a5750fe0a8ef8e0a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id02bbfccfe26c44d4a5750fe0a8ef8e0a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id02bbfccfe26c44d4a5750fe0a8ef8e0a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1539556f3dea4ffd9c8dbdfbe38e41f8" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id1539556f3dea4ffd9c8dbdfbe38e41f8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1539556f3dea4ffd9c8dbdfbe38e41f8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1539556f3dea4ffd9c8dbdfbe38e41f8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1539556f3dea4ffd9c8dbdfbe38e41f8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1539556f3dea4ffd9c8dbdfbe38e41f8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1539556f3dea4ffd9c8dbdfbe38e41f8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1539556f3dea4ffd9c8dbdfbe38e41f8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1539556f3dea4ffd9c8dbdfbe38e41f8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1539556f3dea4ffd9c8dbdfbe38e41f8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1539556f3dea4ffd9c8dbdfbe38e41f8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id489a7af121ce4758831f3e5741fec07d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Insured Persons" /></legend>
				...
				<div data-column-count="3" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:33%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-LBL_SEAT_NO">
		<span class="label" id="LBL_SEAT_NO">Number of Seats</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CAAEMERSK" 
		data-property-name="SEAT_NO" 
		id="pb-container-integer-CAAEMERSK-SEAT_NO">
		<asp:Label ID="lblCAAEMERSK_SEAT_NO" runat="server" AssociatedControlID="CAAEMERSK__SEAT_NO" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CAAEMERSK__SEAT_NO" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCAAEMERSK_SEAT_NO" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CAAEMERSK.SEAT_NO"
			ClientValidationFunction="onValidate_CAAEMERSK__SEAT_NO" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CAAEMERSK" 
		data-property-name="SEAT_PREM" 
		id="pb-container-currency-CAAEMERSK-SEAT_PREM">
		<asp:Label ID="lblCAAEMERSK_SEAT_PREM" runat="server" AssociatedControlID="CAAEMERSK__SEAT_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CAAEMERSK__SEAT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCAAEMERSK_SEAT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CAAEMERSK.SEAT_PREM"
			ClientValidationFunction="onValidate_CAAEMERSK__SEAT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:33%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-LBL_BED_NO">
		<span class="label" id="LBL_BED_NO">Number of Beds</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="CAAEMERSK" 
		data-property-name="BED_NO" 
		id="pb-container-integer-CAAEMERSK-BED_NO">
		<asp:Label ID="lblCAAEMERSK_BED_NO" runat="server" AssociatedControlID="CAAEMERSK__BED_NO" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CAAEMERSK__BED_NO" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCAAEMERSK_BED_NO" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CAAEMERSK.BED_NO"
			ClientValidationFunction="onValidate_CAAEMERSK__BED_NO" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CAAEMERSK" 
		data-property-name="BED_PREM" 
		id="pb-container-currency-CAAEMERSK-BED_PREM">
		<asp:Label ID="lblCAAEMERSK_BED_PREM" runat="server" AssociatedControlID="CAAEMERSK__BED_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CAAEMERSK__BED_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCAAEMERSK_BED_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CAAEMERSK.BED_PREM"
			ClientValidationFunction="onValidate_CAAEMERSK__BED_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:33%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-LBLEMP_NO">
		<span class="label" id="LBLEMP_NO">Number of Employees</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="CAAEMERSK" 
		data-property-name="EMP_NO" 
		id="pb-container-integer-CAAEMERSK-EMP_NO">
		<asp:Label ID="lblCAAEMERSK_EMP_NO" runat="server" AssociatedControlID="CAAEMERSK__EMP_NO" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CAAEMERSK__EMP_NO" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCAAEMERSK_EMP_NO" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CAAEMERSK.EMP_NO"
			ClientValidationFunction="onValidate_CAAEMERSK__EMP_NO" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CAAEMERSK" 
		data-property-name="EMP_PREM" 
		id="pb-container-currency-CAAEMERSK-EMP_PREM">
		<asp:Label ID="lblCAAEMERSK_EMP_PREM" runat="server" AssociatedControlID="CAAEMERSK__EMP_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CAAEMERSK__EMP_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCAAEMERSK_EMP_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CAAEMERSK.EMP_PREM"
			ClientValidationFunction="onValidate_CAAEMERSK__EMP_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:33%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-LBL_TOTAL">
		<span class="label" id="LBL_TOTAL">Total Premium</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:33%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-LBL_TOT_SPACER">
		<span class="label" id="LBL_TOT_SPACER"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CAAEMERSK-TOTAL_PREM">
		<asp:Label ID="lblCAAEMERSK_TOTAL_PREM" runat="server" AssociatedControlID="CAAEMERSK__TOTAL_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CAAEMERSK__TOTAL_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCAAEMERSK_TOTAL_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CAAEMERSK.TOTAL_PREM"
			ClientValidationFunction="onValidate_CAAEMERSK__TOTAL_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id489a7af121ce4758831f3e5741fec07d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id489a7af121ce4758831f3e5741fec07d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id489a7af121ce4758831f3e5741fec07d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id489a7af121ce4758831f3e5741fec07d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id489a7af121ce4758831f3e5741fec07d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id489a7af121ce4758831f3e5741fec07d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id489a7af121ce4758831f3e5741fec07d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id489a7af121ce4758831f3e5741fec07d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id489a7af121ce4758831f3e5741fec07d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id489a7af121ce4758831f3e5741fec07d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id56e7ce7808a94709a118fa56ad669fe6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="Extensions" /></legend>
				
				
				<div data-column-count="3" data-column-ratio="20:40:40" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:20%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-lblExtSpacer">
		<span class="label" id="lblExtSpacer"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:40%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-lblExtSpacer1">
		<span class="label" id="lblExtSpacer1"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblEXTENSIONS_IS_EXTT" for="ctl00_cntMainBody_EXTENSIONS__IS_EXTT" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="EXTENSIONS" 
		data-property-name="IS_EXTT" 
		id="pb-container-checkbox-EXTENSIONS-IS_EXTT">	
		
		<asp:TextBox ID="EXTENSIONS__IS_EXTT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valEXTENSIONS_IS_EXTT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EXTENSIONS.IS_EXTT"
			ClientValidationFunction="onValidate_EXTENSIONS__IS_EXTT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label0">
		<span class="label" id="label0">Extended Territoriess</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EXTENSIONS" 
		data-property-name="EXTT_PREM" 
		id="pb-container-currency-EXTENSIONS-EXTT_PREM">
		<asp:Label ID="lblEXTENSIONS_EXTT_PREM" runat="server" AssociatedControlID="EXTENSIONS__EXTT_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EXTENSIONS__EXTT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEXTENSIONS_EXTT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EXTENSIONS.EXTT_PREM"
			ClientValidationFunction="onValidate_EXTENSIONS__EXTT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblEXTENSIONS_IS_GQB" for="ctl00_cntMainBody_EXTENSIONS__IS_GQB" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="EXTENSIONS" 
		data-property-name="IS_GQB" 
		id="pb-container-checkbox-EXTENSIONS-IS_GQB">	
		
		<asp:TextBox ID="EXTENSIONS__IS_GQB" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valEXTENSIONS_IS_GQB" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EXTENSIONS.IS_GQB"
			ClientValidationFunction="onValidate_EXTENSIONS__IS_GQB" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label1">
		<span class="label" id="label1">Guided Quad Biking</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EXTENSIONS" 
		data-property-name="GQB_PPREM" 
		id="pb-container-currency-EXTENSIONS-GQB_PPREM">
		<asp:Label ID="lblEXTENSIONS_GQB_PPREM" runat="server" AssociatedControlID="EXTENSIONS__GQB_PPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EXTENSIONS__GQB_PPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEXTENSIONS_GQB_PPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EXTENSIONS.GQB_PPREM"
			ClientValidationFunction="onValidate_EXTENSIONS__GQB_PPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblEXTENSIONS_IS_GHR" for="ctl00_cntMainBody_EXTENSIONS__IS_GHR" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="EXTENSIONS" 
		data-property-name="IS_GHR" 
		id="pb-container-checkbox-EXTENSIONS-IS_GHR">	
		
		<asp:TextBox ID="EXTENSIONS__IS_GHR" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valEXTENSIONS_IS_GHR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EXTENSIONS.IS_GHR"
			ClientValidationFunction="onValidate_EXTENSIONS__IS_GHR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label2">
		<span class="label" id="label2">Guided Horse Riding</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EXTENSIONS" 
		data-property-name="GHR_PREM" 
		id="pb-container-currency-EXTENSIONS-GHR_PREM">
		<asp:Label ID="lblEXTENSIONS_GHR_PREM" runat="server" AssociatedControlID="EXTENSIONS__GHR_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EXTENSIONS__GHR_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEXTENSIONS_GHR_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EXTENSIONS.GHR_PREM"
			ClientValidationFunction="onValidate_EXTENSIONS__GHR_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:20%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-lblExtTotal">
		<span class="label" id="lblExtTotal"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label3">
		<span class="label" id="label3">Total Premium</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id56e7ce7808a94709a118fa56ad669fe6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id56e7ce7808a94709a118fa56ad669fe6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id56e7ce7808a94709a118fa56ad669fe6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id56e7ce7808a94709a118fa56ad669fe6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id56e7ce7808a94709a118fa56ad669fe6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id56e7ce7808a94709a118fa56ad669fe6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id56e7ce7808a94709a118fa56ad669fe6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id56e7ce7808a94709a118fa56ad669fe6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id56e7ce7808a94709a118fa56ad669fe6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id56e7ce7808a94709a118fa56ad669fe6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmFirstAmountPayable" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="First Amount Payable" /></legend>
...
<!-- /Label -->
									...
									<li class="co-cell"  style="width:25%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-lblEmergencyEvacuation">
		<span class="label" id="lblEmergencyEvacuation">Emergency Evacuation</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:25%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-lblEmergencyEvacuationSpacer">
		<span class="label" id="lblEmergencyEvacuationSpacer"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-property-name="EE_PER" 
		id="pb-container-percentage-FAP-EE_PER">
		<asp:Label ID="lblFAP_EE_PER" runat="server" AssociatedControlID="FAP__EE_PER" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FAP__EE_PER" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFAP_EE_PER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP.EE_PER"
			ClientValidationFunction="onValidate_FAP__EE_PER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="FAP" 
		data-property-name="EE_MIN_AMT" 
		id="pb-container-currency-FAP-EE_MIN_AMT">
		<asp:Label ID="lblFAP_EE_MIN_AMT" runat="server" AssociatedControlID="FAP__EE_MIN_AMT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FAP__EE_MIN_AMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFAP_EE_MIN_AMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP.EE_MIN_AMT"
			ClientValidationFunction="onValidate_FAP__EE_MIN_AMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:25%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-lblHospitalAdmission">
		<span class="label" id="lblHospitalAdmission">Hospital Admission</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:25%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-lblHospitalAdmissionSpacer">
		<span class="label" id="lblHospitalAdmissionSpacer"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="FAP" 
		data-property-name="HA_PER" 
		id="pb-container-percentage-FAP-HA_PER">
		<asp:Label ID="lblFAP_HA_PER" runat="server" AssociatedControlID="FAP__HA_PER" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FAP__HA_PER" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFAP_HA_PER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP.HA_PER"
			ClientValidationFunction="onValidate_FAP__HA_PER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="FAP" 
		data-property-name="HA_MIN_AMT" 
		id="pb-container-currency-FAP-HA_MIN_AMT">
		<asp:Label ID="lblFAP_HA_MIN_AMT" runat="server" AssociatedControlID="FAP__HA_MIN_AMT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FAP__HA_MIN_AMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFAP_HA_MIN_AMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP.HA_MIN_AMT"
			ClientValidationFunction="onValidate_FAP__HA_MIN_AMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:25%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-lblOther">
		<span class="label" id="lblOther">Other</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="FAP" 
		data-property-name="OTHER_DESC" 
		 
		
		 
		id="pb-container-text-FAP-OTHER_DESC">

		
		<asp:Label ID="lblFAP_OTHER_DESC" runat="server" AssociatedControlID="FAP__OTHER_DESC" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FAP__OTHER_DESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFAP_OTHER_DESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for FAP.OTHER_DESC"
					ClientValidationFunction="onValidate_FAP__OTHER_DESC"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="FAP" 
		data-property-name="OTHER_PER" 
		id="pb-container-percentage-FAP-OTHER_PER">
		<asp:Label ID="lblFAP_OTHER_PER" runat="server" AssociatedControlID="FAP__OTHER_PER" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FAP__OTHER_PER" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFAP_OTHER_PER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP.OTHER_PER"
			ClientValidationFunction="onValidate_FAP__OTHER_PER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FAP-OTHER_MIN_AMT">
		<asp:Label ID="lblFAP_OTHER_MIN_AMT" runat="server" AssociatedControlID="FAP__OTHER_MIN_AMT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FAP__OTHER_MIN_AMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFAP_OTHER_MIN_AMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP.OTHER_MIN_AMT"
			ClientValidationFunction="onValidate_FAP__OTHER_MIN_AMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmFirstAmountPayable div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmFirstAmountPayable div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmFirstAmountPayable div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmFirstAmountPayable label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmFirstAmountPayable label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmFirstAmountPayable label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmFirstAmountPayable label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmFirstAmountPayable input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmFirstAmountPayable input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmFirstAmountPayable input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblENDORSEMENT_REFERRAL_CLAUSES" runat="server" AssociatedControlID="ENDORSEMENT__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="ENDORSEMENT__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="ENDORSEMENT" 
		data-property-name="TOT_ENDPREM" 
		id="pb-container-currency-ENDORSEMENT-TOT_ENDPREM">
		<asp:Label ID="lblENDORSEMENT_TOT_ENDPREM" runat="server" AssociatedControlID="ENDORSEMENT__TOT_ENDPREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ENDORSEMENT__TOT_ENDPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valENDORSEMENT_TOT_ENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_ENDORSEMENT__TOT_ENDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENDORSEMENT__CAAEMENDOS"
		data-field-type="Child" 
		data-object-name="ENDORSEMENT" 
		data-property-name="CAAEMENDOS" 
		id="pb-container-childscreen-ENDORSEMENT-CAAEMENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENDORSEMENT__CAAEME_ENDOSE" runat="server" ScreenCode="CAAEMENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAAEMENDOS/CAAEMENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valENDORSEMENT_CAAEMENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ENDORSEMENT.CAAEMENDOS"
						ClientValidationFunction="onValidate_ENDORSEMENT__CAAEMENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida7370cd733014aa28a38c87315193563" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CAAEMERSK__CAAEMENOTE"
		data-field-type="Child" 
		data-object-name="CAAEMERSK" 
		data-property-name="CAAEMENOTE" 
		id="pb-container-childscreen-CAAEMERSK-CAAEMENOTE">
		
		    <legend>Notes (Not Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CAAEMERSK__CAAEME_NNOTES" runat="server" ScreenCode="CAAEMENOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAAEMENOTE/CAAEMENOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCAAEMERSK_CAAEMENOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Not Printed on Schedule)"
						ClientValidationFunction="onValidate_CAAEMERSK__CAAEMENOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida7370cd733014aa28a38c87315193563 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida7370cd733014aa28a38c87315193563 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida7370cd733014aa28a38c87315193563 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida7370cd733014aa28a38c87315193563 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida7370cd733014aa28a38c87315193563 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida7370cd733014aa28a38c87315193563 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida7370cd733014aa28a38c87315193563 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida7370cd733014aa28a38c87315193563 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida7370cd733014aa28a38c87315193563 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida7370cd733014aa28a38c87315193563 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CAAEMERSK__CAAEMENOT"
		data-field-type="Child" 
		data-object-name="CAAEMERSK" 
		data-property-name="CAAEMENOT" 
		id="pb-container-childscreen-CAAEMERSK-CAAEMENOT">
		
		    <legend>Notes (Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CAAEMERSK__CAAEME_PNOTES" runat="server" ScreenCode="CAAEMENOT" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAAEMENOT/CAAEMENOT_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCAAEMERSK_CAAEMENOT" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Printed on Schedule)"
						ClientValidationFunction="onValidate_CAAEMERSK__CAAEMENOT" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id644d83554ff549adaf0230ace2b43cd8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Premium Breakdown" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-property-name="TOT_SUM_INS" 
		id="pb-container-currency-EMPDE-TOT_SUM_INS">
		<asp:Label ID="lblEMPDE_TOT_SUM_INS" runat="server" AssociatedControlID="EMPDE__TOT_SUM_INS" 
			Text="Total Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TOT_SUM_INS" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TOT_SUM_INS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Sum Insured"
			ClientValidationFunction="onValidate_EMPDE__TOT_SUM_INS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id644d83554ff549adaf0230ace2b43cd8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id644d83554ff549adaf0230ace2b43cd8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id644d83554ff549adaf0230ace2b43cd8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id644d83554ff549adaf0230ace2b43cd8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id644d83554ff549adaf0230ace2b43cd8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id644d83554ff549adaf0230ace2b43cd8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id644d83554ff549adaf0230ace2b43cd8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id644d83554ff549adaf0230ace2b43cd8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id644d83554ff549adaf0230ace2b43cd8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id644d83554ff549adaf0230ace2b43cd8 input{text-align:left;}"; break;
		}
	}
