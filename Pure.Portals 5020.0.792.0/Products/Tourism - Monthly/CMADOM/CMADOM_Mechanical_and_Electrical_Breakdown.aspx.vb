...
Namespace Nexus
    Partial Class PB2_CMADOM_Mechanical_and_Electrical_Breakdown : Inherits BaseRisk
		...
		Protected Sub onValidate_MECHELECTRIC__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_MECHELECTRIC__EFFECTIVEDATE()
...
End Sub
Protected Sub onValidate_MECHELECTRIC__SUMINSURED()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MECHELECTRIC__ATTACHMENTDATE()
    onValidate_MECHELECTRIC__EFFECTIVEDATE()
    onValidate_MECHELECTRIC__PREMIUM()
    onValidate_Button_btnMechCalculate()
    onValidate_MECHELECTRIC__SUMINSURED()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If MECHELECTRIC__ATTACHMENTDATE.Text = "" or MECHELECTRIC__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			MECHELECTRIC__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			MECHELECTRIC__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (MECHELECTRIC__ATTACHMENTDATE.Text <> "" Or MECHELECTRIC__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		MECHELECTRIC__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		MECHELECTRIC__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		MECHELECTRIC__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
