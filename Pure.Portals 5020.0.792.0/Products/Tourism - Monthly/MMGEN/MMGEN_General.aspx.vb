...
Namespace Nexus
    Partial Class PB2_MMGEN_General : Inherits BaseRisk
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (GENERAL__ATTACHDATE.Text <> "" Or GENERAL__ATTACHDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
