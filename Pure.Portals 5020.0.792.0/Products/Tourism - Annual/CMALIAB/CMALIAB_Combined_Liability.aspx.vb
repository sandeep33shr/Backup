...
Namespace Nexus
    Partial Class PB2_CMALIAB_Combined_Liability : Inherits BaseRisk
		...
		Protected Sub onValidate_COMLIAB__RISKATTACHDATE()
        
End Sub
Protected Sub onValidate_COMLIAB__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_COMLIAB__RISKATTACHDATE()
    onValidate_COMLIAB__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If COMLIAB__RISKATTACHDATE.Text = "" or COMLIAB__RISKATTACHDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			COMLIAB__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			COMLIAB__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (COMLIAB__RISKATTACHDATE.Text <> "" Or COMLIAB__RISKATTACHDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		COMLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		COMLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		COMLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
