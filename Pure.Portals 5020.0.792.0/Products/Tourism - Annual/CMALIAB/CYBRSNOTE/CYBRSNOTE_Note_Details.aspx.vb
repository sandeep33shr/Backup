...
Namespace Nexus
    Partial Class PB2_CYBRSNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CYBER_SCNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CYBER_SCNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		CYBER_SCNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CYBER_SCNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_CYBER_SCNOTE_DETAILS__NOTE_DETAILS()
End Sub
