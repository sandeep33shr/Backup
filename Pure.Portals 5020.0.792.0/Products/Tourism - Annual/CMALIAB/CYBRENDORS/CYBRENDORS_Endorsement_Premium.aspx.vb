...
Namespace Nexus
    Partial Class PB2_CYBRENDORS_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_CYBER_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CYBER_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'CYBER - Standard Wording Parent Object
        'CYBER_CLAUSES - Standard Wording Parent Property
        'CYBER_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/CYBER/SW.CYBER_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("CYBER_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/CYBER/CYBER_CLAUSEPREM")
        
        	Dim CurrentSelected As String = CYBER_CLAUSEPREM__ENDORSE_CAP.Text
