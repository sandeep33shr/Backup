<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAALGNDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CAALGNDOS_Endorsement_Premium" %>
...
function onValidate_CAALG_ENDOSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAALG_ENDOSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CAALG_ENDOSE", "ENDORSE_ID");
        		}
...
function onValidate_CAALG_ENDOSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAALG_ENDOSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CAALG_ENDOSE", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CAALG_ENDOSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "CAALG_ENDOSE", "ENDORSE_DESC");
        		})();
        	}
        })();
}
function onValidate_CAALG_ENDOSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAALG_ENDOSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CAALG_ENDOSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CAALG_ENDOSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(CAALG_ENDOSE.ENDORSE_DESC)"), 
...
function onValidate_CAALG_ENDOSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAALG_ENDOSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CAALG_ENDOSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CAALG_ENDOSE.PREMIUM");
        			window.setControlWidth(field, "0.5", "CAALG_ENDOSE", "PREMIUM");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CAALG_ENDOSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_CAALG_ENDOSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_CAALG_ENDOSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_CAALG_ENDOSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idb9c5ada08ea846b8bf8bba526253aded" class="general-layout-container">
...
<div id="idcfa966c11eda43289523d89ec5e2ba1d" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading25" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CAALG_ENDOSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-CAALG_ENDOSE-ENDORSE_ID">
		<asp:Label ID="lblCAALG_ENDOSE_ENDORSE_ID" runat="server" AssociatedControlID="CAALG_ENDOSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CAALG_ENDOSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCAALG_ENDOSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_CAALG_ENDOSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-CAALG_ENDOSE-ENDORSE_DESC">
		<asp:Label ID="lblCAALG_ENDOSE_ENDORSE_DESC" runat="server" AssociatedControlID="CAALG_ENDOSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CAALG_ENDOSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CAALG_ENDOSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCAALG_ENDOSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_CAALG_ENDOSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CAALG_ENDOSE-ENDORSE_CAP">

		
		<asp:Label ID="lblCAALG_ENDOSE_ENDORSE_CAP" runat="server" AssociatedControlID="CAALG_ENDOSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CAALG_ENDOSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCAALG_ENDOSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_CAALG_ENDOSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CAALG_ENDOSE-PREMIUM">
		<asp:Label ID="lblCAALG_ENDOSE_PREMIUM" runat="server" AssociatedControlID="CAALG_ENDOSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CAALG_ENDOSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCAALG_ENDOSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CAALG_ENDOSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idcfa966c11eda43289523d89ec5e2ba1d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcfa966c11eda43289523d89ec5e2ba1d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcfa966c11eda43289523d89ec5e2ba1d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idcfa966c11eda43289523d89ec5e2ba1d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcfa966c11eda43289523d89ec5e2ba1d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcfa966c11eda43289523d89ec5e2ba1d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcfa966c11eda43289523d89ec5e2ba1d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcfa966c11eda43289523d89ec5e2ba1d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcfa966c11eda43289523d89ec5e2ba1d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcfa966c11eda43289523d89ec5e2ba1d input{text-align:left;}"; break;
		}
	}
