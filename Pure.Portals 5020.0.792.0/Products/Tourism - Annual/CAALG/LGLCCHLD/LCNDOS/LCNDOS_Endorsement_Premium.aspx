<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="LCNDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_LCNDOS_Endorsement_Premium" %>
...
function onValidate_LC_ENDOSE__LCENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LC_ENDOSE", "LCENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("LC_ENDOSE", "LCENDORSE_ID");
        		}
...
function onValidate_LC_ENDOSE__LCENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LC_ENDOSE", "LCENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("LC_ENDOSE", "LCENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("LC_ENDOSE.LCENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "LC_ENDOSE", "LCENDORSE_DESC");
        		})();
        	}
        })();
}
function onValidate_LC_ENDOSE__LCENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LC_ENDOSE", "LCENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("LC_ENDOSE", "LCENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=LC_ENDOSE&propertyName=LCENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(LC_ENDOSE.LCENDORSE_DESC)"), 
...
function onValidate_LC_ENDOSE__LCPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LC_ENDOSE", "LCPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("LC_ENDOSE", "LCPREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("LC_ENDOSE.LCPREMIUM");
        			window.setControlWidth(field, "0.5", "LC_ENDOSE", "LCPREMIUM");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_LC_ENDOSE__LCENDORSE_ID(null, null, null, isOnLoad);
    onValidate_LC_ENDOSE__LCENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_LC_ENDOSE__LCENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_LC_ENDOSE__LCPREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="ide45863842d3f43f5916ce9f1e5e6a6b9" class="general-layout-container">
...
<div id="idc5d0920f5c2b49f1ac8572633c555343" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="LC_ENDOSE" 
		data-property-name="LCENDORSE_ID" 
		id="pb-container-integer-LC_ENDOSE-LCENDORSE_ID">
		<asp:Label ID="lblLC_ENDOSE_LCENDORSE_ID" runat="server" AssociatedControlID="LC_ENDOSE__LCENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="LC_ENDOSE__LCENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valLC_ENDOSE_LCENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_LC_ENDOSE__LCENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="LC_ENDOSE" 
		data-property-name="LCENDORSE_DESC" 
		id="pb-container-list-LC_ENDOSE-LCENDORSE_DESC">
		<asp:Label ID="lblLC_ENDOSE_LCENDORSE_DESC" runat="server" AssociatedControlID="LC_ENDOSE__LCENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="LC_ENDOSE__LCENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_LC_ENDOSE__LCENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valLC_ENDOSE_LCENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_LC_ENDOSE__LCENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="LC_ENDOSE" 
		data-property-name="LCENDORSE_CAP" 
		 
		
		 
		id="pb-container-text-LC_ENDOSE-LCENDORSE_CAP">

		
		<asp:Label ID="lblLC_ENDOSE_LCENDORSE_CAP" runat="server" AssociatedControlID="LC_ENDOSE__LCENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="LC_ENDOSE__LCENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valLC_ENDOSE_LCENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_LC_ENDOSE__LCENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="LC_ENDOSE" 
		data-property-name="LCPREMIUM" 
		id="pb-container-currency-LC_ENDOSE-LCPREMIUM">
		<asp:Label ID="lblLC_ENDOSE_LCPREMIUM" runat="server" AssociatedControlID="LC_ENDOSE__LCPREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LC_ENDOSE__LCPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLC_ENDOSE_LCPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_LC_ENDOSE__LCPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc5d0920f5c2b49f1ac8572633c555343 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc5d0920f5c2b49f1ac8572633c555343 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc5d0920f5c2b49f1ac8572633c555343 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc5d0920f5c2b49f1ac8572633c555343 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc5d0920f5c2b49f1ac8572633c555343 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc5d0920f5c2b49f1ac8572633c555343 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc5d0920f5c2b49f1ac8572633c555343 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc5d0920f5c2b49f1ac8572633c555343 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc5d0920f5c2b49f1ac8572633c555343 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc5d0920f5c2b49f1ac8572633c555343 input{text-align:left;}"; break;
		}
	}
