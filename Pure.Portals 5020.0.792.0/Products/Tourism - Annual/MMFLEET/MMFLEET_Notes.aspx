<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MMFLEET_Notes.aspx.vb" Inherits="Nexus.PB2_MMFLEET_Notes" %>
...
function onValidate_NOTES__CMAMFNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "CMAMFNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "CMAMFNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__CMAMFNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "CMAMFNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'CMAMFNOTES'.");
        			error.display();
...
function onValidate_NOTES__CMAMFSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "CMAMFSNOTE", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    onValidate_NOTES__CMAMFNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__COUNT_NOTES(null, null, null, isOnLoad);
    onValidate_NOTES__CMAMFSNOTE(null, null, null, isOnLoad);
...
<div id="id21180cbe0b424848849e4edb2111b4c5" class="general-layout-container">
...
<div id="id39e7414ef423439ca68ef2e528b15b21" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__CMAMFNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="CMAMFNOTES" 
		id="pb-container-childscreen-NOTES-CMAMFNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="CMAMFNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMFNOTES/CMAMFNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_CMAMFNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.CMAMFNOTES"
						ClientValidationFunction="onValidate_NOTES__CMAMFNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id39e7414ef423439ca68ef2e528b15b21 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id39e7414ef423439ca68ef2e528b15b21 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id39e7414ef423439ca68ef2e528b15b21 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id39e7414ef423439ca68ef2e528b15b21 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id39e7414ef423439ca68ef2e528b15b21 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id39e7414ef423439ca68ef2e528b15b21 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id39e7414ef423439ca68ef2e528b15b21 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id39e7414ef423439ca68ef2e528b15b21 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id39e7414ef423439ca68ef2e528b15b21 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id39e7414ef423439ca68ef2e528b15b21 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide27506e3f651487ea5eeaba0fcd7ebfc" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__CMAMFSNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="CMAMFSNOTE" 
		id="pb-container-childscreen-NOTES-CMAMFSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__SCNOTE_DETAILS" runat="server" ScreenCode="CMAMFSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMFSNOTE/CMAMFSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_CMAMFSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.CMAMFSNOTE"
						ClientValidationFunction="onValidate_NOTES__CMAMFSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide27506e3f651487ea5eeaba0fcd7ebfc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide27506e3f651487ea5eeaba0fcd7ebfc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide27506e3f651487ea5eeaba0fcd7ebfc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide27506e3f651487ea5eeaba0fcd7ebfc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide27506e3f651487ea5eeaba0fcd7ebfc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide27506e3f651487ea5eeaba0fcd7ebfc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide27506e3f651487ea5eeaba0fcd7ebfc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide27506e3f651487ea5eeaba0fcd7ebfc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide27506e3f651487ea5eeaba0fcd7ebfc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide27506e3f651487ea5eeaba0fcd7ebfc input{text-align:left;}"; break;
		}
	}
