<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EQNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_EQNOTES_Note_Details" %>
...
function onValidate_EENOTE_DETAILS__Date_Created(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EENOTE_DETAILS", "Date_Created", "Date");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("EENOTE_DETAILS", "Date_Created");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EENOTE_DETAILS.Date_Created");
        			window.setControlWidth(field, "0.5", "EENOTE_DETAILS", "Date_Created");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=EENOTE_DETAILS&propertyName=Date_Created&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "EENOTE_DETAILS" && field.getPropertyName() == "Date_Created")
...
function onValidate_EENOTE_DETAILS__Time_Created(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EENOTE_DETAILS", "Time_Created", "Text");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EENOTE_DETAILS&propertyName=Time_Created&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EENOTE_DETAILS.Time_Created");
        			window.setControlWidth(field, "0.5", "EENOTE_DETAILS", "Time_Created");
        		})();
        	}
        })();
        /**
...
function onValidate_EENOTE_DETAILS__Created_By(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EENOTE_DETAILS", "Created_By", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("EENOTE_DETAILS", "Created_By");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EENOTE_DETAILS.Created_By");
        			window.setControlWidth(field, "0.5", "EENOTE_DETAILS", "Created_By");
        		})();
        	}
        })();
}
function onValidate_EENOTE_DETAILS__Risk_Cover(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EENOTE_DETAILS", "Risk_Cover", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("EENOTE_DETAILS", "Risk_Cover");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EENOTE_DETAILS.Risk_Cover");
        			window.setControlWidth(field, "0.5", "EENOTE_DETAILS", "Risk_Cover");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EENOTE_DETAILS&propertyName=Risk_Cover&name={name}");
...
function onValidate_EENOTE_DETAILS__Note_Subject(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EENOTE_DETAILS", "Note_Subject", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("EENOTE_DETAILS", "Note_Subject");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EENOTE_DETAILS.Note_Subject");
        			window.setControlWidth(field, "0.5", "EENOTE_DETAILS", "Note_Subject");
        		})();
        	}
        })();
        /**
...
function onValidate_EENOTE_DETAILS__Note_Details(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EENOTE_DETAILS", "Note_Details", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("EENOTE_DETAILS", "Note_Details");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EENOTE_DETAILS.Note_Details");
        			window.setControlWidth(field, "0.5", "EENOTE_DETAILS", "Note_Details");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=EENOTE_DETAILS&propertyName=Note_Details&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_EENOTE_DETAILS__Note_Details');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_EENOTE_DETAILS_Note_Details_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_EENOTE_DETAILS__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EENOTE_DETAILS", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("EENOTE_DETAILS", "NoteCheck");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_EENOTE_DETAILS__Date_Created(null, null, null, isOnLoad);
    onValidate_EENOTE_DETAILS__Time_Created(null, null, null, isOnLoad);
    onValidate_EENOTE_DETAILS__Created_By(null, null, null, isOnLoad);
    onValidate_EENOTE_DETAILS__Risk_Cover(null, null, null, isOnLoad);
    onValidate_EENOTE_DETAILS__Note_Subject(null, null, null, isOnLoad);
    onValidate_EENOTE_DETAILS__Note_Details(null, null, null, isOnLoad);
    onValidate_EENOTE_DETAILS__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="idd71c78f452494f81afb936e18c5743bb" class="general-layout-container">
...
<div id="idce7a6408dd3e4b67ae02d2d36035886b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading198" runat="server" Text="Note Detail (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="EENOTE_DETAILS" 
		data-property-name="Date_Created" 
		id="pb-container-datejquerycompatible-EENOTE_DETAILS-Date_Created">
		<asp:Label ID="lblEENOTE_DETAILS_Date_Created" runat="server" AssociatedControlID="EENOTE_DETAILS__Date_Created" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="EENOTE_DETAILS__Date_Created" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calEENOTE_DETAILS__Date_Created" runat="server" LinkedControl="EENOTE_DETAILS__Date_Created" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valEENOTE_DETAILS_Date_Created" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_EENOTE_DETAILS__Date_Created" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-EENOTE_DETAILS-Time_Created">

		
		<asp:Label ID="lblEENOTE_DETAILS_Time_Created" runat="server" AssociatedControlID="EENOTE_DETAILS__Time_Created" 
			Text="Time Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EENOTE_DETAILS__Time_Created" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valEENOTE_DETAILS_Time_Created" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Time Created"
					ClientValidationFunction="onValidate_EENOTE_DETAILS__Time_Created"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-EENOTE_DETAILS-Created_By">

		
		<asp:Label ID="lblEENOTE_DETAILS_Created_By" runat="server" AssociatedControlID="EENOTE_DETAILS__Created_By" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EENOTE_DETAILS__Created_By" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valEENOTE_DETAILS_Created_By" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_EENOTE_DETAILS__Created_By"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-EENOTE_DETAILS-Risk_Cover">

		
		<asp:Label ID="lblEENOTE_DETAILS_Risk_Cover" runat="server" AssociatedControlID="EENOTE_DETAILS__Risk_Cover" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EENOTE_DETAILS__Risk_Cover" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valEENOTE_DETAILS_Risk_Cover" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_EENOTE_DETAILS__Risk_Cover"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-EENOTE_DETAILS-Note_Subject">

		
		<asp:Label ID="lblEENOTE_DETAILS_Note_Subject" runat="server" AssociatedControlID="EENOTE_DETAILS__Note_Subject" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EENOTE_DETAILS__Note_Subject" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valEENOTE_DETAILS_Note_Subject" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_EENOTE_DETAILS__Note_Subject"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-EENOTE_DETAILS-Note_Details">
		<asp:Label ID="lblEENOTE_DETAILS_Note_Details" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="EENOTE_DETAILS__Note_Details" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="EENOTE_DETAILS__Note_Details" runat="server" />
		
		<asp:CustomValidator ID="valEENOTE_DETAILS_Note_Details" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_EENOTE_DETAILS__Note_Details"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblEENOTE_DETAILS_NoteCheck" for="ctl00_cntMainBody_EENOTE_DETAILS__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-EENOTE_DETAILS-NoteCheck">	
		
		<asp:TextBox ID="EENOTE_DETAILS__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valEENOTE_DETAILS_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_EENOTE_DETAILS__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idce7a6408dd3e4b67ae02d2d36035886b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idce7a6408dd3e4b67ae02d2d36035886b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idce7a6408dd3e4b67ae02d2d36035886b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idce7a6408dd3e4b67ae02d2d36035886b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idce7a6408dd3e4b67ae02d2d36035886b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idce7a6408dd3e4b67ae02d2d36035886b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idce7a6408dd3e4b67ae02d2d36035886b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idce7a6408dd3e4b67ae02d2d36035886b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idce7a6408dd3e4b67ae02d2d36035886b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idce7a6408dd3e4b67ae02d2d36035886b input{text-align:left;}"; break;
		}
	}
