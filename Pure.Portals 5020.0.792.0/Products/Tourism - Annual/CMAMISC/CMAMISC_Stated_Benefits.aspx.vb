...
Namespace Nexus
    Partial Class PB2_CMAMISC_Stated_Benefits : Inherits BaseRisk
		...
		Protected Sub onValidate_STATED__RISK_ATTACH_DATE()
        
        
End Sub
Protected Sub onValidate_STATED__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_STATED__RISK_ATTACH_DATE()
    onValidate_STATED__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If STATED__RISK_ATTACH_DATE.Text = "" or STATED__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			STATED__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			STATED__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (STATED__RISK_ATTACH_DATE.Text <> "" Or STATED__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		STATED__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		STATED__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		STATED__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
