...
Namespace Nexus
    Partial Class PB2_FIDGCNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_FIDGCNOTES__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If FIDGCNOTES__Date_Created.Text.ToString = "" Then
        		FIDGCNOTES__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		FIDGCNOTES__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_FIDGCNOTES__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FIDGCNOTES__NOTE_DETAILS()
    onValidate_FIDGCNOTES__NoteCheck()
End Sub
