<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAEMENDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CAAEMENDOS_Endorsement_Premium" %>
...
function onValidate_CAAEME_ENDOSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEME_ENDOSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CAAEME_ENDOSE", "ENDORSE_ID");
        		}
...
function onValidate_CAAEME_ENDOSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEME_ENDOSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CAAEME_ENDOSE", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CAAEME_ENDOSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "CAAEME_ENDOSE", "ENDORSE_DESC");
        		})();
        	}
        })();
}
function onValidate_CAAEME_ENDOSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEME_ENDOSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CAAEME_ENDOSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CAAEME_ENDOSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(CAAEME_ENDOSE.ENDORSE_DESC)"), 
...
function onValidate_CAAEME_ENDOSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CAAEME_ENDOSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CAAEME_ENDOSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CAAEME_ENDOSE.PREMIUM");
        			window.setControlWidth(field, "0.5", "CAAEME_ENDOSE", "PREMIUM");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CAAEME_ENDOSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_CAAEME_ENDOSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_CAAEME_ENDOSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_CAAEME_ENDOSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idc16ab74145584ec29c6687ed0e3b3b7e" class="general-layout-container">
...
<div id="ide1751d9306f64bf28c5046aec52e2e56" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CAAEME_ENDOSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-CAAEME_ENDOSE-ENDORSE_ID">
		<asp:Label ID="lblCAAEME_ENDOSE_ENDORSE_ID" runat="server" AssociatedControlID="CAAEME_ENDOSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CAAEME_ENDOSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCAAEME_ENDOSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_CAAEME_ENDOSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-CAAEME_ENDOSE-ENDORSE_DESC">
		<asp:Label ID="lblCAAEME_ENDOSE_ENDORSE_DESC" runat="server" AssociatedControlID="CAAEME_ENDOSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CAAEME_ENDOSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CAAEME_ENDOSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCAAEME_ENDOSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_CAAEME_ENDOSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CAAEME_ENDOSE-ENDORSE_CAP">

		
		<asp:Label ID="lblCAAEME_ENDOSE_ENDORSE_CAP" runat="server" AssociatedControlID="CAAEME_ENDOSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CAAEME_ENDOSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCAAEME_ENDOSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_CAAEME_ENDOSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CAAEME_ENDOSE-PREMIUM">
		<asp:Label ID="lblCAAEME_ENDOSE_PREMIUM" runat="server" AssociatedControlID="CAAEME_ENDOSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CAAEME_ENDOSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCAAEME_ENDOSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CAAEME_ENDOSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide1751d9306f64bf28c5046aec52e2e56 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide1751d9306f64bf28c5046aec52e2e56 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide1751d9306f64bf28c5046aec52e2e56 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide1751d9306f64bf28c5046aec52e2e56 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide1751d9306f64bf28c5046aec52e2e56 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide1751d9306f64bf28c5046aec52e2e56 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide1751d9306f64bf28c5046aec52e2e56 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide1751d9306f64bf28c5046aec52e2e56 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide1751d9306f64bf28c5046aec52e2e56 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide1751d9306f64bf28c5046aec52e2e56 input{text-align:left;}"; break;
		}
	}
