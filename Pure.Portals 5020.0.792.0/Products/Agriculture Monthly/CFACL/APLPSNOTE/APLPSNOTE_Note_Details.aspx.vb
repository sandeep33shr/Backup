...
Namespace Nexus
    Partial Class PB2_APLPSNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_AGRIPL_NOTES__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If AGRIPL_NOTES__Date_Created.Text.ToString = "" Then
        		AGRIPL_NOTES__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		AGRIPL_NOTES__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_AGRIPL_NOTES__Note_Details()
End Sub
