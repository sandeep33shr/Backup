...
Namespace Nexus
    Partial Class PB2_APDWNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_AGRIPD_NOTE__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If AGRIPD_NOTE__Date_Created.Text.ToString = "" Then
        		AGRIPD_NOTE__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		AGRIPD_NOTE__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_AGRIPD_NOTE__Note_Details()
End Sub
