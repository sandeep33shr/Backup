<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="APDWTPREM_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_APDWTPREM_Endorsement_Premium" %>
...
function onValidate_APDL_CLAUSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "APDL_CLAUSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("APDL_CLAUSE", "ENDORSE_ID");
        		}
...
function onValidate_APDL_CLAUSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "APDL_CLAUSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("APDL_CLAUSE", "ENDORSE_DESC");
...
function onValidate_APDL_CLAUSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "APDL_CLAUSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("APDL_CLAUSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=APDL_CLAUSE&propertyName=ENDORSE_CAP&name={name}");
...
function onValidate_APDL_CLAUSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "APDL_CLAUSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("APDL_CLAUSE", "PREMIUM");
...
function DoLogic(isOnLoad) {
    onValidate_APDL_CLAUSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_APDL_CLAUSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_APDL_CLAUSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_APDL_CLAUSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="iddb991cf9e4b54eb385199fd009e81604" class="general-layout-container">
...
<div id="idf40ff3e08b5d424d8675eae4123ea4ea" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="APDL_CLAUSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-APDL_CLAUSE-ENDORSE_ID">
		<asp:Label ID="lblAPDL_CLAUSE_ENDORSE_ID" runat="server" AssociatedControlID="APDL_CLAUSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="APDL_CLAUSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAPDL_CLAUSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_APDL_CLAUSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-APDL_CLAUSE-ENDORSE_DESC">
		<asp:Label ID="lblAPDL_CLAUSE_ENDORSE_DESC" runat="server" AssociatedControlID="APDL_CLAUSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="APDL_CLAUSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_APDL_CLAUSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valAPDL_CLAUSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_APDL_CLAUSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-APDL_CLAUSE-ENDORSE_CAP">

		
		<asp:Label ID="lblAPDL_CLAUSE_ENDORSE_CAP" runat="server" AssociatedControlID="APDL_CLAUSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="APDL_CLAUSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAPDL_CLAUSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_APDL_CLAUSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-APDL_CLAUSE-PREMIUM">
		<asp:Label ID="lblAPDL_CLAUSE_PREMIUM" runat="server" AssociatedControlID="APDL_CLAUSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="APDL_CLAUSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valAPDL_CLAUSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_APDL_CLAUSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf40ff3e08b5d424d8675eae4123ea4ea div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf40ff3e08b5d424d8675eae4123ea4ea div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf40ff3e08b5d424d8675eae4123ea4ea div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf40ff3e08b5d424d8675eae4123ea4ea label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf40ff3e08b5d424d8675eae4123ea4ea label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf40ff3e08b5d424d8675eae4123ea4ea label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf40ff3e08b5d424d8675eae4123ea4ea label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf40ff3e08b5d424d8675eae4123ea4ea input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf40ff3e08b5d424d8675eae4123ea4ea input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf40ff3e08b5d424d8675eae4123ea4ea input{text-align:left;}"; break;
		}
	}
