...
Namespace Nexus
    Partial Class PB2_PLENDPREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_APL_CLAUSE__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_APL_CLAUSE__ENDORSE_ID()
End Sub
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim CurrentSelected As String = APL_CLAUSE__ENDORSE_CAP.Text
