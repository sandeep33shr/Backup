...
function onValidate_APL_CLAUSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "APL_CLAUSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("APL_CLAUSE", "ENDORSE_ID");
        		}
...
function onValidate_APL_CLAUSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "APL_CLAUSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("APL_CLAUSE", "ENDORSE_DESC");
...
function onValidate_APL_CLAUSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "APL_CLAUSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("APL_CLAUSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=APL_CLAUSE&propertyName=ENDORSE_CAP&name={name}");
...
function onValidate_APL_CLAUSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "APL_CLAUSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("APL_CLAUSE", "PREMIUM");
...
function DoLogic(isOnLoad) {
    onValidate_APL_CLAUSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_APL_CLAUSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_APL_CLAUSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_APL_CLAUSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idff104e0887894ca5915a66ff279b5dc6" class="general-layout-container">
...
<div id="id661b3b0f21c04e5cbfc170897b0b5ea9" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading6" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="APL_CLAUSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-APL_CLAUSE-ENDORSE_ID">
		<asp:Label ID="lblAPL_CLAUSE_ENDORSE_ID" runat="server" AssociatedControlID="APL_CLAUSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="APL_CLAUSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAPL_CLAUSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_APL_CLAUSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-APL_CLAUSE-ENDORSE_DESC">
		<asp:Label ID="lblAPL_CLAUSE_ENDORSE_DESC" runat="server" AssociatedControlID="APL_CLAUSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="APL_CLAUSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_APL_CLAUSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valAPL_CLAUSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_APL_CLAUSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-APL_CLAUSE-ENDORSE_CAP">

		
		<asp:Label ID="lblAPL_CLAUSE_ENDORSE_CAP" runat="server" AssociatedControlID="APL_CLAUSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="APL_CLAUSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAPL_CLAUSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_APL_CLAUSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-APL_CLAUSE-PREMIUM">
		<asp:Label ID="lblAPL_CLAUSE_PREMIUM" runat="server" AssociatedControlID="APL_CLAUSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="APL_CLAUSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valAPL_CLAUSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_APL_CLAUSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id661b3b0f21c04e5cbfc170897b0b5ea9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id661b3b0f21c04e5cbfc170897b0b5ea9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id661b3b0f21c04e5cbfc170897b0b5ea9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id661b3b0f21c04e5cbfc170897b0b5ea9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id661b3b0f21c04e5cbfc170897b0b5ea9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id661b3b0f21c04e5cbfc170897b0b5ea9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id661b3b0f21c04e5cbfc170897b0b5ea9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id661b3b0f21c04e5cbfc170897b0b5ea9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id661b3b0f21c04e5cbfc170897b0b5ea9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id661b3b0f21c04e5cbfc170897b0b5ea9 input{text-align:left;}"; break;
		}
	}
