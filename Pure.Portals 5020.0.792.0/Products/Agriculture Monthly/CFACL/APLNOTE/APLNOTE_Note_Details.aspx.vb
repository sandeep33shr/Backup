...
Namespace Nexus
    Partial Class PB2_APLNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_AGRIPL_NOTE__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If AGRIPL_NOTE__Date_Created.Text.ToString = "" Then
        		AGRIPL_NOTE__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		AGRIPL_NOTE__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_AGRIPL_NOTE__Note_Details()
End Sub
