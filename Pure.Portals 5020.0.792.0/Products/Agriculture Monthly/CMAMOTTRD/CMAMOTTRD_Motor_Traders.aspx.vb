...
Namespace Nexus
    Partial Class PB2_CMAMOTTRD_Motor_Traders : Inherits BaseRisk
		...
		Protected Sub onValidate_GENERAL__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_GENERAL__EFFECTIVEDATE()
...
Protected Sub CallRuleScripts()
    onValidate_GENERAL__ATTACHMENTDATE()
    onValidate_GENERAL__EFFECTIVEDATE()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If GENERAL__ATTACHMENTDATE.Text = "" or GENERAL__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			GENERAL__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			GENERAL__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (GENERAL__ATTACHMENTDATE.Text <> "" Or GENERAL__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		GENERAL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		GENERAL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		GENERAL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
