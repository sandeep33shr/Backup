<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMOTSPEC_Notes.aspx.vb" Inherits="Nexus.PB2_CMAMOTSPEC_Notes" %>
...
function onValidate_NOTES__CMAMSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "CMAMSNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "CMAMSNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__CMAMSNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "CMAMSNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'CMAMSNOTES'.");
        			error.display();
...
function onValidate_NOTES__CMAMSSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "CMAMSSNOTE", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    onValidate_NOTES__CMAMSNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__COUNT_NOTES(null, null, null, isOnLoad);
    onValidate_NOTES__CMAMSSNOTE(null, null, null, isOnLoad);
...
<div id="id752a8fba6182458aa3232db3939b9cc8" class="general-layout-container">
...
<div id="id5f412cfdca71494c8816d0bf1a88d57f" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading47" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__CMAMSNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="CMAMSNOTES" 
		id="pb-container-childscreen-NOTES-CMAMSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="CMAMSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMSNOTES/CMAMSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_CMAMSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.CMAMSNOTES"
						ClientValidationFunction="onValidate_NOTES__CMAMSNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5f412cfdca71494c8816d0bf1a88d57f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5f412cfdca71494c8816d0bf1a88d57f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5f412cfdca71494c8816d0bf1a88d57f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5f412cfdca71494c8816d0bf1a88d57f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5f412cfdca71494c8816d0bf1a88d57f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5f412cfdca71494c8816d0bf1a88d57f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5f412cfdca71494c8816d0bf1a88d57f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5f412cfdca71494c8816d0bf1a88d57f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5f412cfdca71494c8816d0bf1a88d57f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5f412cfdca71494c8816d0bf1a88d57f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb72adccd7d7842b290cbc972e8b37211" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading48" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__CMAMSSNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="CMAMSSNOTE" 
		id="pb-container-childscreen-NOTES-CMAMSSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__SCNOTE_DETAILS" runat="server" ScreenCode="CMAMSSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMSSNOTE/CMAMSSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_CMAMSSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.CMAMSSNOTE"
						ClientValidationFunction="onValidate_NOTES__CMAMSSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb72adccd7d7842b290cbc972e8b37211 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb72adccd7d7842b290cbc972e8b37211 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb72adccd7d7842b290cbc972e8b37211 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb72adccd7d7842b290cbc972e8b37211 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb72adccd7d7842b290cbc972e8b37211 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb72adccd7d7842b290cbc972e8b37211 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb72adccd7d7842b290cbc972e8b37211 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb72adccd7d7842b290cbc972e8b37211 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb72adccd7d7842b290cbc972e8b37211 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb72adccd7d7842b290cbc972e8b37211 input{text-align:left;}"; break;
		}
	}
