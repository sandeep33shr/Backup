...
function onValidate_ITEM_DET__MAKE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ITEM_DET", "MAKE", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=ITEM_DET&propertyName=MAKE&name={name}");
...
function onValidate_ITEM_DET__YEAR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ITEM_DET", "YEAR", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
...
<div id="idb4e44c56ca024acf8d25a69d90c58e60" class="general-layout-container">
...
<div id="id106ddea2c5dd4ce5ab9a97ec0d5872b0" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-ITEM_DET-MAKE">
		<asp:Label ID="lblITEM_DET_MAKE" runat="server" AssociatedControlID="ITEM_DET__MAKE" 
			...
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ITEM_DET__MAKE" runat="server" CssClass="form-control" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-ITEM_DET-YEAR">
		<asp:Label ID="lblITEM_DET_YEAR" runat="server" AssociatedControlID="ITEM_DET__YEAR" 
			...
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ITEM_DET__YEAR" runat="server" CssClass="form-control" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id106ddea2c5dd4ce5ab9a97ec0d5872b0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id106ddea2c5dd4ce5ab9a97ec0d5872b0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id106ddea2c5dd4ce5ab9a97ec0d5872b0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id106ddea2c5dd4ce5ab9a97ec0d5872b0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id106ddea2c5dd4ce5ab9a97ec0d5872b0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id106ddea2c5dd4ce5ab9a97ec0d5872b0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id106ddea2c5dd4ce5ab9a97ec0d5872b0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id106ddea2c5dd4ce5ab9a97ec0d5872b0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id106ddea2c5dd4ce5ab9a97ec0d5872b0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id106ddea2c5dd4ce5ab9a97ec0d5872b0 input{text-align:left;}"; break;
		}
	}
