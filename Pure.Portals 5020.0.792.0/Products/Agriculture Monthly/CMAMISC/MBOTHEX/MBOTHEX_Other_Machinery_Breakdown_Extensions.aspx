<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBOTHEX_Other_Machinery_Breakdown_Extensions.aspx.vb" Inherits="Nexus.PB2_MBOTHEX_Other_Machinery_Breakdown_Extensions" %>
...
function onValidate_MB_OEXTENSIONS__FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Machinery breakdown FAP % cannot be more than 100%")) ? "Machinery breakdown FAP % cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
<div id="ida64c4bb9e10d4ec19fabf171afb51a3c" class="general-layout-container">
