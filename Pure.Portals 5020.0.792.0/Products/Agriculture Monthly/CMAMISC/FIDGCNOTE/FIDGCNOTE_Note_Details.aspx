<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FIDGCNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_FIDGCNOTE_Note_Details" %>
...
function onValidate_FIDGCNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGCNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDGCNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGCNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "FIDGCNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=FIDGCNOTES&propertyName=DATE_CREATED&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "FIDGCNOTES" && field.getPropertyName() == "DATE_CREATED")
...
function onValidate_FIDGCNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGCNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDGCNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGCNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "FIDGCNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_FIDGCNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGCNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDGCNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGCNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "FIDGCNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=FIDGCNOTES&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'Fidelity Guarantee'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_FIDGCNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGCNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIDGCNOTES", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGCNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "FIDGCNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIDGCNOTES", "NOTE_DESCRIPTION");
        		var exp = new Expression("FIDGCNOTES.NoteCheck = 1");
...
function onValidate_FIDGCNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGCNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIDGCNOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGCNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "FIDGCNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=FIDGCNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_FIDGCNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_FIDGCNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_FIDGCNOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGCNOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FIDGCNOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_FIDGCNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_FIDGCNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_FIDGCNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_FIDGCNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_FIDGCNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_FIDGCNOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id200e9973c707482c9bbf2ab97831fc98" class="general-layout-container">
...
<div id="id1e5cb46b060c4d288114891386fdafe1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading163" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FIDGCNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-FIDGCNOTES-DATE_CREATED">
		<asp:Label ID="lblFIDGCNOTES_DATE_CREATED" runat="server" AssociatedControlID="FIDGCNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="FIDGCNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calFIDGCNOTES__DATE_CREATED" runat="server" LinkedControl="FIDGCNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valFIDGCNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_FIDGCNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDGCNOTES-CREATED_BY">

		
		<asp:Label ID="lblFIDGCNOTES_CREATED_BY" runat="server" AssociatedControlID="FIDGCNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDGCNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDGCNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_FIDGCNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDGCNOTES-COVER_TYPE">

		
		<asp:Label ID="lblFIDGCNOTES_COVER_TYPE" runat="server" AssociatedControlID="FIDGCNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDGCNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDGCNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_FIDGCNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDGCNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblFIDGCNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="FIDGCNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDGCNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDGCNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_FIDGCNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-FIDGCNOTES-NOTE_DETAILS">
		<asp:Label ID="lblFIDGCNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="FIDGCNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="FIDGCNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valFIDGCNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_FIDGCNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblFIDGCNOTES_NoteCheck" for="ctl00_cntMainBody_FIDGCNOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-FIDGCNOTES-NoteCheck">	
		
		<asp:TextBox ID="FIDGCNOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valFIDGCNOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_FIDGCNOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1e5cb46b060c4d288114891386fdafe1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1e5cb46b060c4d288114891386fdafe1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1e5cb46b060c4d288114891386fdafe1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1e5cb46b060c4d288114891386fdafe1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1e5cb46b060c4d288114891386fdafe1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1e5cb46b060c4d288114891386fdafe1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1e5cb46b060c4d288114891386fdafe1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1e5cb46b060c4d288114891386fdafe1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1e5cb46b060c4d288114891386fdafe1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1e5cb46b060c4d288114891386fdafe1 input{text-align:left;}"; break;
		}
	}
