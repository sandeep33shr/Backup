...
Namespace Nexus
    Partial Class PB2_MABASNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_BALLRISK_SCNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If BALLRISK_SCNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		BALLRISK_SCNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		BALLRISK_SCNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_BALLRISK_SCNOTE_DETAILS__NOTE_DETAILS()
End Sub
