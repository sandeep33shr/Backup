...
Namespace Nexus
    Partial Class PB2_THFTSNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_THEFT_SCNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If THEFT_SCNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		THEFT_SCNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		THEFT_SCNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_THEFT_SCNOTES_DETAILS__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_THEFT_SCNOTES_DETAILS__NOTE_DETAILS()
    onValidate_THEFT_SCNOTES_DETAILS__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		THEFT_SCNOTES_DETAILS__NoteCheck.Text = 1
        	End If
        End Sub
