<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="LVPSTOCK_Livestock_and_Pedigree_Animals.aspx.vb" Inherits="Nexus.PB2_LVPSTOCK_Livestock_and_Pedigree_Animals" %>
...
function onValidate_GENERAL__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=GENERAL&propertyName=RISK_ATTACH_DATE&name={name}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "FLAT_PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.FLAT_PREM");
        			window.setControlWidth(field, "0.4", "GENERAL", "FLAT_PREM");
        		})();
        	}
        })();
        /**
...
function onValidate_ADDRESS__TOT_LV(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDRESS", "TOT_LV", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDRESS", "TOT_LV");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_LSTOCK__LVITEMS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LSTOCK", "LVITEMS", "ChildScreen");
        })();
}
function onValidate_LSTOCK__TOT_PA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LSTOCK", "TOT_PA", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LSTOCK", "TOT_PA");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_LSTOCK__LVPITEMS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LSTOCK", "LVPITEMS", "ChildScreen");
        })();
}
function onValidate_FCS_EXTENSIONS__IS_ADD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "IS_ADD", "Checkbox");
        })();
}
function onValidate_FCS_EXTENSIONS__ADD_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "ADD_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "ADD_LOI");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_ADD == 1", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "FCS_EXTENSIONS.IS_ADD == 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_FCS_EXTENSIONS__ADD_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "ADD_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "ADD_RATE");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_ADD == 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__ADD_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "ADD_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "ADD_PREM");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_ADD == 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__ADD_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "ADD_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "ADD_PERC");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_ADD == 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__ADD_MIN_AMNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "ADD_MIN_AMNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "ADD_MIN_AMNT");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_ADD == 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__IS_RIOT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "IS_RIOT", "Checkbox");
        })();
}
function onValidate_FCS_EXTENSIONS__RIOT_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "RIOT_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "RIOT_LOI");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_RIOT == 1", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "FCS_EXTENSIONS.IS_RIOT == 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_FCS_EXTENSIONS__RIOT_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "RIOT_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "RIOT_RATE");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_RIOT = 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__RIOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "RIOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "RIOT_PREM");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_RIOT = 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__RIOT_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "RIOT_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "RIOT_PERC");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_RIOT = 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__RIOT_MIN_AMNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "RIOT_MIN_AMNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "RIOT_MIN_AMNT");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_RIOT = 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__IS_TRSIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "IS_TRSIT", "Checkbox");
        })();
}
function onValidate_FCS_EXTENSIONS__TRSIT_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "TRSIT_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "TRSIT_LOI");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_TRSIT == 1", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "FCS_EXTENSIONS.IS_TRSIT == 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_FCS_EXTENSIONS__TRSIT_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "TRSIT_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "TRSIT_RATE");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_TRSIT == 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__TRSIT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "TRSIT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "TRSIT_PREM");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_TRSIT == 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__TRSIT_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "TRSIT_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "TRSIT_PERC");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_TRSIT == 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__TRSIT_MIN_AMNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "TRSIT_MIN_AMNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FCS_EXTENSIONS", "TRSIT_MIN_AMNT");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_TRSIT == 1", "V", "{3}");
...
function onValidate_FCS_EXTENSIONS__TOTAL_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCS_EXTENSIONS", "TOTAL_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("FCS_EXTENSIONS", "TOTAL_PREM");
        	field.setReadOnly(true);
        })();
}
function onValidate_LSTOCK__TOT_ENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LSTOCK", "TOT_ENDPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("LSTOCK", "TOT_ENDPREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("LSTOCK.TOT_ENDPREM");
        			window.setControlWidth(field, "0.4", "LSTOCK", "TOT_ENDPREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblLSTOCK_TOT_ENDPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_LSTOCK__TOT_ENDPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_LSTOCK__TOT_ENDPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_LSTOCK__LVENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LSTOCK", "LVENDOS", "ChildScreen");
        })();
}
function onValidate_LSTOCK__LVSANOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LSTOCK", "LVSANOTES", "ChildScreen");
        })();
}
function onValidate_LSTOCK__LVETANOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LSTOCK", "LVETANOTES", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_ADDRESS__TOT_LV(null, null, null, isOnLoad);
    onValidate_LSTOCK__LVITEMS(null, null, null, isOnLoad);
    onValidate_LSTOCK__TOT_PA(null, null, null, isOnLoad);
    onValidate_LSTOCK__LVPITEMS(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__IS_ADD(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__ADD_LOI(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__ADD_RATE(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__ADD_PREM(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__ADD_PERC(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__ADD_MIN_AMNT(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__IS_RIOT(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__RIOT_LOI(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__RIOT_RATE(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__RIOT_PREM(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__RIOT_PERC(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__RIOT_MIN_AMNT(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__IS_TRSIT(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__TRSIT_LOI(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__TRSIT_RATE(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__TRSIT_PREM(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__TRSIT_PERC(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__TRSIT_MIN_AMNT(null, null, null, isOnLoad);
    onValidate_FCS_EXTENSIONS__TOTAL_PREM(null, null, null, isOnLoad);
    onValidate_LSTOCK__TOT_ENDPREM(null, null, null, isOnLoad);
    onValidate_LSTOCK__LVENDOS(null, null, null, isOnLoad);
    onValidate_LSTOCK__LVSANOTES(null, null, null, isOnLoad);
    onValidate_LSTOCK__LVETANOTES(null, null, null, isOnLoad);
...
<div id="ida3dc3030b27c4c8595fc7eba4ec280d5" class="general-layout-container">
...
<div id="idfec59e8216a84051b0967ef3d91072c5" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfec59e8216a84051b0967ef3d91072c5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfec59e8216a84051b0967ef3d91072c5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfec59e8216a84051b0967ef3d91072c5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfec59e8216a84051b0967ef3d91072c5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfec59e8216a84051b0967ef3d91072c5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfec59e8216a84051b0967ef3d91072c5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfec59e8216a84051b0967ef3d91072c5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfec59e8216a84051b0967ef3d91072c5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfec59e8216a84051b0967ef3d91072c5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfec59e8216a84051b0967ef3d91072c5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id03e774230c5c45e58daffc74502de659" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading36" runat="server" Text="Address" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id03e774230c5c45e58daffc74502de659 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id03e774230c5c45e58daffc74502de659 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id03e774230c5c45e58daffc74502de659 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id03e774230c5c45e58daffc74502de659 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id03e774230c5c45e58daffc74502de659 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id03e774230c5c45e58daffc74502de659 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id03e774230c5c45e58daffc74502de659 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id03e774230c5c45e58daffc74502de659 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id03e774230c5c45e58daffc74502de659 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id03e774230c5c45e58daffc74502de659 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id067c13b9b7604514a3ab42eaae7d2a47" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ADDRESS" 
		data-property-name="TOT_LV" 
		id="pb-container-currency-ADDRESS-TOT_LV">
		<asp:Label ID="lblADDRESS_TOT_LV" runat="server" AssociatedControlID="ADDRESS__TOT_LV" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__TOT_LV" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDRESS_TOT_LV" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_ADDRESS__TOT_LV" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id067c13b9b7604514a3ab42eaae7d2a47 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id067c13b9b7604514a3ab42eaae7d2a47 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id067c13b9b7604514a3ab42eaae7d2a47 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id067c13b9b7604514a3ab42eaae7d2a47 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id067c13b9b7604514a3ab42eaae7d2a47 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id067c13b9b7604514a3ab42eaae7d2a47 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id067c13b9b7604514a3ab42eaae7d2a47 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id067c13b9b7604514a3ab42eaae7d2a47 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id067c13b9b7604514a3ab42eaae7d2a47 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id067c13b9b7604514a3ab42eaae7d2a47 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida9ac3d09cd5b4ffc88db49e4b08a5739" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_LSTOCK__LVITEMS"
		data-field-type="Child" 
		data-object-name="LSTOCK" 
		data-property-name="LVITEMS" 
		id="pb-container-childscreen-LSTOCK-LVITEMS">
		
		    <legend>Livestock Items </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="LSTOCK__LSTOCKC" runat="server" ScreenCode="LVITEMS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVITEMS/LVITEMS_Livestock.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Added" DataField="DATE" DataFormatString="Y"/>
<Nexus:GISLookupField HeaderText="Type" ListType="PMLookup" ListCode="UDL_CFLPA_TYPE" DataField="TYPE" DataItemValue="key" />
<Nexus:RiskAttribute HeaderText="No of Animals" DataField="NO_ANIM" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Value Per Animal" DataField="VAL_ANIM" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Total Sum Insured" DataField="TOT_SIND" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Description" DataField="DESCLV" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Rate" DataField="RATE" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREM" DataFormatString="Y"/>
					...
					<asp:CustomValidator ID="valLSTOCK_LVITEMS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Livestock Items "
						ClientValidationFunction="onValidate_LSTOCK__LVITEMS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida9ac3d09cd5b4ffc88db49e4b08a5739 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida9ac3d09cd5b4ffc88db49e4b08a5739 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida9ac3d09cd5b4ffc88db49e4b08a5739 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida9ac3d09cd5b4ffc88db49e4b08a5739 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida9ac3d09cd5b4ffc88db49e4b08a5739 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida9ac3d09cd5b4ffc88db49e4b08a5739 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida9ac3d09cd5b4ffc88db49e4b08a5739 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida9ac3d09cd5b4ffc88db49e4b08a5739 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida9ac3d09cd5b4ffc88db49e4b08a5739 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida9ac3d09cd5b4ffc88db49e4b08a5739 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide1fd0295d87941cdb6f5282309568e13" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="LSTOCK" 
		data-property-name="TOT_PA" 
		id="pb-container-currency-LSTOCK-TOT_PA">
		<asp:Label ID="lblLSTOCK_TOT_PA" runat="server" AssociatedControlID="LSTOCK__TOT_PA" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LSTOCK__TOT_PA" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLSTOCK_TOT_PA" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_LSTOCK__TOT_PA" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide1fd0295d87941cdb6f5282309568e13 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide1fd0295d87941cdb6f5282309568e13 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide1fd0295d87941cdb6f5282309568e13 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide1fd0295d87941cdb6f5282309568e13 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide1fd0295d87941cdb6f5282309568e13 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide1fd0295d87941cdb6f5282309568e13 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide1fd0295d87941cdb6f5282309568e13 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide1fd0295d87941cdb6f5282309568e13 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide1fd0295d87941cdb6f5282309568e13 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide1fd0295d87941cdb6f5282309568e13 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id74d8739fbc9f49efbaa08780fffb1b81" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_LSTOCK__LVPITEMS"
		data-field-type="Child" 
		data-object-name="LSTOCK" 
		data-property-name="LVPITEMS" 
		id="pb-container-childscreen-LSTOCK-LVPITEMS">
		
		    <legend>Pedigree Animal Items </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="LSTOCK__LSTOCKPA" runat="server" ScreenCode="LVPITEMS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVPITEMS/LVPITEMS_Pedigree_Animals.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Added" DataField="DATE" DataFormatString="Y"/>
<Nexus:GISLookupField HeaderText="Category" ListType="PMLookup" ListCode="UDL_CFLPA_CAT" DataField="CAT" DataItemValue="key" />
<Nexus:RiskAttribute HeaderText="Sum Insured" DataField="SUM_IND" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Description" DataField="DESCP" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Age" DataField="AGE" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Rate" DataField="RATE" DataFormatString="Y"/>
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREM" DataFormatString="Y"/>
					...
					<asp:CustomValidator ID="valLSTOCK_LVPITEMS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Pedigree Animal Items "
						ClientValidationFunction="onValidate_LSTOCK__LVPITEMS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id74d8739fbc9f49efbaa08780fffb1b81 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id74d8739fbc9f49efbaa08780fffb1b81 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id74d8739fbc9f49efbaa08780fffb1b81 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id74d8739fbc9f49efbaa08780fffb1b81 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id74d8739fbc9f49efbaa08780fffb1b81 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id74d8739fbc9f49efbaa08780fffb1b81 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id74d8739fbc9f49efbaa08780fffb1b81 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id74d8739fbc9f49efbaa08780fffb1b81 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id74d8739fbc9f49efbaa08780fffb1b81 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id74d8739fbc9f49efbaa08780fffb1b81 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2cd1ad30309e4c2f849037accd3d39ea" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading41" runat="server" Text="Extensions" /></legend>
				
				
				<div data-column-count="7" data-column-ratio="20:20:20:10:10:10:10" data-layout="" class="clearfix form-horizontal">
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblFCS_EXTENSIONS_IS_ADD" for="ctl00_cntMainBody_FCS_EXTENSIONS__IS_ADD" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="IS_ADD" 
		id="pb-container-checkbox-FCS_EXTENSIONS-IS_ADD">	
		
		<asp:TextBox ID="FCS_EXTENSIONS__IS_ADD" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valFCS_EXTENSIONS_IS_ADD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.IS_ADD"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__IS_ADD" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FCS_EXTENSIONS-ADD_LOI">
		<asp:Label ID="lblFCS_EXTENSIONS_ADD_LOI" runat="server" AssociatedControlID="FCS_EXTENSIONS__ADD_LOI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__ADD_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_ADD_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.ADD_LOI"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__ADD_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-FCS_EXTENSIONS-ADD_RATE">
		<asp:Label ID="lblFCS_EXTENSIONS_ADD_RATE" runat="server" AssociatedControlID="FCS_EXTENSIONS__ADD_RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FCS_EXTENSIONS__ADD_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_ADD_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.ADD_RATE"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__ADD_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FCS_EXTENSIONS-ADD_PREM">
		<asp:Label ID="lblFCS_EXTENSIONS_ADD_PREM" runat="server" AssociatedControlID="FCS_EXTENSIONS__ADD_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__ADD_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_ADD_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.ADD_PREM"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__ADD_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="ADD_PERC" 
		id="pb-container-percentage-FCS_EXTENSIONS-ADD_PERC">
		<asp:Label ID="lblFCS_EXTENSIONS_ADD_PERC" runat="server" AssociatedControlID="FCS_EXTENSIONS__ADD_PERC" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FCS_EXTENSIONS__ADD_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_ADD_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.ADD_PERC"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__ADD_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="ADD_MIN_AMNT" 
		id="pb-container-currency-FCS_EXTENSIONS-ADD_MIN_AMNT">
		<asp:Label ID="lblFCS_EXTENSIONS_ADD_MIN_AMNT" runat="server" AssociatedControlID="FCS_EXTENSIONS__ADD_MIN_AMNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__ADD_MIN_AMNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_ADD_MIN_AMNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.ADD_MIN_AMNT"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__ADD_MIN_AMNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblFCS_EXTENSIONS_IS_RIOT" for="ctl00_cntMainBody_FCS_EXTENSIONS__IS_RIOT" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-FCS_EXTENSIONS-IS_RIOT">	
		
		<asp:TextBox ID="FCS_EXTENSIONS__IS_RIOT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valFCS_EXTENSIONS_IS_RIOT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.IS_RIOT"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__IS_RIOT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label8">
		<span class="label" id="label8">Riot & Strike </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="RIOT_LOI" 
		id="pb-container-currency-FCS_EXTENSIONS-RIOT_LOI">
		<asp:Label ID="lblFCS_EXTENSIONS_RIOT_LOI" runat="server" AssociatedControlID="FCS_EXTENSIONS__RIOT_LOI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__RIOT_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_RIOT_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.RIOT_LOI"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__RIOT_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-FCS_EXTENSIONS-RIOT_RATE">
		<asp:Label ID="lblFCS_EXTENSIONS_RIOT_RATE" runat="server" AssociatedControlID="FCS_EXTENSIONS__RIOT_RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FCS_EXTENSIONS__RIOT_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_RIOT_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.RIOT_RATE"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__RIOT_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FCS_EXTENSIONS-RIOT_PREM">
		<asp:Label ID="lblFCS_EXTENSIONS_RIOT_PREM" runat="server" AssociatedControlID="FCS_EXTENSIONS__RIOT_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__RIOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_RIOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.RIOT_PREM"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__RIOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="RIOT_PERC" 
		id="pb-container-percentage-FCS_EXTENSIONS-RIOT_PERC">
		<asp:Label ID="lblFCS_EXTENSIONS_RIOT_PERC" runat="server" AssociatedControlID="FCS_EXTENSIONS__RIOT_PERC" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FCS_EXTENSIONS__RIOT_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_RIOT_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.RIOT_PERC"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__RIOT_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FCS_EXTENSIONS-RIOT_MIN_AMNT">
		<asp:Label ID="lblFCS_EXTENSIONS_RIOT_MIN_AMNT" runat="server" AssociatedControlID="FCS_EXTENSIONS__RIOT_MIN_AMNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__RIOT_MIN_AMNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_RIOT_MIN_AMNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.RIOT_MIN_AMNT"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__RIOT_MIN_AMNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblFCS_EXTENSIONS_IS_TRSIT" for="ctl00_cntMainBody_FCS_EXTENSIONS__IS_TRSIT" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="IS_TRSIT" 
		id="pb-container-checkbox-FCS_EXTENSIONS-IS_TRSIT">	
		
		<asp:TextBox ID="FCS_EXTENSIONS__IS_TRSIT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valFCS_EXTENSIONS_IS_TRSIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.IS_TRSIT"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__IS_TRSIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label9">
		<span class="label" id="label9">Transit </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="TRSIT_LOI" 
		id="pb-container-currency-FCS_EXTENSIONS-TRSIT_LOI">
		<asp:Label ID="lblFCS_EXTENSIONS_TRSIT_LOI" runat="server" AssociatedControlID="FCS_EXTENSIONS__TRSIT_LOI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__TRSIT_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_TRSIT_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.TRSIT_LOI"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__TRSIT_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="TRSIT_RATE" 
		id="pb-container-percentage-FCS_EXTENSIONS-TRSIT_RATE">
		<asp:Label ID="lblFCS_EXTENSIONS_TRSIT_RATE" runat="server" AssociatedControlID="FCS_EXTENSIONS__TRSIT_RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FCS_EXTENSIONS__TRSIT_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_TRSIT_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.TRSIT_RATE"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__TRSIT_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="TRSIT_PREM" 
		id="pb-container-currency-FCS_EXTENSIONS-TRSIT_PREM">
		<asp:Label ID="lblFCS_EXTENSIONS_TRSIT_PREM" runat="server" AssociatedControlID="FCS_EXTENSIONS__TRSIT_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__TRSIT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_TRSIT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.TRSIT_PREM"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__TRSIT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="TRSIT_PERC" 
		id="pb-container-percentage-FCS_EXTENSIONS-TRSIT_PERC">
		<asp:Label ID="lblFCS_EXTENSIONS_TRSIT_PERC" runat="server" AssociatedControlID="FCS_EXTENSIONS__TRSIT_PERC" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FCS_EXTENSIONS__TRSIT_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_TRSIT_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.TRSIT_PERC"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__TRSIT_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="FCS_EXTENSIONS" 
		data-property-name="TRSIT_MIN_AMNT" 
		id="pb-container-currency-FCS_EXTENSIONS-TRSIT_MIN_AMNT">
		<asp:Label ID="lblFCS_EXTENSIONS_TRSIT_MIN_AMNT" runat="server" AssociatedControlID="FCS_EXTENSIONS__TRSIT_MIN_AMNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__TRSIT_MIN_AMNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_TRSIT_MIN_AMNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.TRSIT_MIN_AMNT"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__TRSIT_MIN_AMNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label11">
		<span class="label" id="label11">Total </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FCS_EXTENSIONS-TOTAL_PREM">
		<asp:Label ID="lblFCS_EXTENSIONS_TOTAL_PREM" runat="server" AssociatedControlID="FCS_EXTENSIONS__TOTAL_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FCS_EXTENSIONS__TOTAL_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFCS_EXTENSIONS_TOTAL_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FCS_EXTENSIONS.TOTAL_PREM"
			ClientValidationFunction="onValidate_FCS_EXTENSIONS__TOTAL_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2cd1ad30309e4c2f849037accd3d39ea div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2cd1ad30309e4c2f849037accd3d39ea div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2cd1ad30309e4c2f849037accd3d39ea div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2cd1ad30309e4c2f849037accd3d39ea label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2cd1ad30309e4c2f849037accd3d39ea label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2cd1ad30309e4c2f849037accd3d39ea label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2cd1ad30309e4c2f849037accd3d39ea label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2cd1ad30309e4c2f849037accd3d39ea input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2cd1ad30309e4c2f849037accd3d39ea input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2cd1ad30309e4c2f849037accd3d39ea input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblLSTOCK_REFERRAL_CLAUSES" runat="server" AssociatedControlID="LSTOCK__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="LSTOCK__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LSTOCK-TOT_ENDPREM">
		<asp:Label ID="lblLSTOCK_TOT_ENDPREM" runat="server" AssociatedControlID="LSTOCK__TOT_ENDPREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LSTOCK__TOT_ENDPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLSTOCK_TOT_ENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_LSTOCK__TOT_ENDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_LSTOCK__LVENDOS"
		data-field-type="Child" 
		data-object-name="LSTOCK" 
		data-property-name="LVENDOS" 
		id="pb-container-childscreen-LSTOCK-LVENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="LSTOCK__CLAUSEPREMC" runat="server" ScreenCode="LVENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVENDOS/LVENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valLSTOCK_LVENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for LSTOCK.LVENDOS"
						ClientValidationFunction="onValidate_LSTOCK__LVENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idebb3c3a5c15c44b2ac968369ac12d7b7" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_LSTOCK__LVSANOTES"
		data-field-type="Child" 
		data-object-name="LSTOCK" 
		data-property-name="LVSANOTES" 
		id="pb-container-childscreen-LSTOCK-LVSANOTES">
		
		    <legend>Notes (Not Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="LSTOCK__CFNOTE_DETAILS" runat="server" ScreenCode="LVSANOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVSANOTES/LVSANOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valLSTOCK_LVSANOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Not Printed on Schedule)"
						ClientValidationFunction="onValidate_LSTOCK__LVSANOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idebb3c3a5c15c44b2ac968369ac12d7b7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idebb3c3a5c15c44b2ac968369ac12d7b7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idebb3c3a5c15c44b2ac968369ac12d7b7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idebb3c3a5c15c44b2ac968369ac12d7b7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idebb3c3a5c15c44b2ac968369ac12d7b7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idebb3c3a5c15c44b2ac968369ac12d7b7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idebb3c3a5c15c44b2ac968369ac12d7b7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idebb3c3a5c15c44b2ac968369ac12d7b7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idebb3c3a5c15c44b2ac968369ac12d7b7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idebb3c3a5c15c44b2ac968369ac12d7b7 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_LSTOCK__LVETANOTES"
		data-field-type="Child" 
		data-object-name="LSTOCK" 
		data-property-name="LVETANOTES" 
		id="pb-container-childscreen-LSTOCK-LVETANOTES">
		
		    <legend>Notes (Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="LSTOCK__SCFNOTE_DETAILS" runat="server" ScreenCode="LVETANOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVETANOTES/LVETANOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valLSTOCK_LVETANOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Printed on Schedule)"
						ClientValidationFunction="onValidate_LSTOCK__LVETANOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9e538d7e95724908b82e15d6227b2ab0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading45" runat="server" Text="Premium Breakdown" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9e538d7e95724908b82e15d6227b2ab0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9e538d7e95724908b82e15d6227b2ab0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9e538d7e95724908b82e15d6227b2ab0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9e538d7e95724908b82e15d6227b2ab0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9e538d7e95724908b82e15d6227b2ab0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9e538d7e95724908b82e15d6227b2ab0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9e538d7e95724908b82e15d6227b2ab0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9e538d7e95724908b82e15d6227b2ab0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9e538d7e95724908b82e15d6227b2ab0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9e538d7e95724908b82e15d6227b2ab0 input{text-align:left;}"; break;
		}
	}
