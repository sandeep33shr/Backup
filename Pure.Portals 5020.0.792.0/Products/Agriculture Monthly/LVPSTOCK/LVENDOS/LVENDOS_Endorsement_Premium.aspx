<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="LVENDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_LVENDOS_Endorsement_Premium" %>
...
function onValidate_CLAUSEPREMC__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLAUSEPREMC", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CLAUSEPREMC", "ENDORSE_ID");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREMC.ENDORSE_ID");
        			window.setControlWidth(field, "0.5", "CLAUSEPREMC", "ENDORSE_ID");
        		})();
        	}
        })();
}
function onValidate_CLAUSEPREMC__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLAUSEPREMC", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CLAUSEPREMC", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREMC.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "CLAUSEPREMC", "ENDORSE_DESC");
        		})();
        	}
        })();
}
function onValidate_CLAUSEPREMC__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLAUSEPREMC", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CLAUSEPREMC", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREMC.ENDORSE_CAP");
        			window.setControlWidth(field, "0.5", "CLAUSEPREMC", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CLAUSEPREMC&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(CLAUSEPREMC.ENDORSE_DESC)"), 
...
function onValidate_CLAUSEPREMC__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLAUSEPREMC", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CLAUSEPREMC", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLAUSEPREMC.PREMIUM");
        			window.setControlWidth(field, "0.5", "CLAUSEPREMC", "PREMIUM");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CLAUSEPREMC__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_CLAUSEPREMC__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_CLAUSEPREMC__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_CLAUSEPREMC__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id69818049cf374c7ead2ace72c6882590" class="general-layout-container">
...
<div id="id618a1535c034414789b1be0bbb1c5745" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CLAUSEPREMC" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-CLAUSEPREMC-ENDORSE_ID">
		<asp:Label ID="lblCLAUSEPREMC_ENDORSE_ID" runat="server" AssociatedControlID="CLAUSEPREMC__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CLAUSEPREMC__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCLAUSEPREMC_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_CLAUSEPREMC__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-CLAUSEPREMC-ENDORSE_DESC">
		<asp:Label ID="lblCLAUSEPREMC_ENDORSE_DESC" runat="server" AssociatedControlID="CLAUSEPREMC__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CLAUSEPREMC__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CLAUSEPREMC__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCLAUSEPREMC_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_CLAUSEPREMC__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CLAUSEPREMC-ENDORSE_CAP">

		
		<asp:Label ID="lblCLAUSEPREMC_ENDORSE_CAP" runat="server" AssociatedControlID="CLAUSEPREMC__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CLAUSEPREMC__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCLAUSEPREMC_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_CLAUSEPREMC__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLAUSEPREMC-PREMIUM">
		<asp:Label ID="lblCLAUSEPREMC_PREMIUM" runat="server" AssociatedControlID="CLAUSEPREMC__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLAUSEPREMC__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLAUSEPREMC_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CLAUSEPREMC__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id618a1535c034414789b1be0bbb1c5745 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id618a1535c034414789b1be0bbb1c5745 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id618a1535c034414789b1be0bbb1c5745 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id618a1535c034414789b1be0bbb1c5745 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id618a1535c034414789b1be0bbb1c5745 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id618a1535c034414789b1be0bbb1c5745 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id618a1535c034414789b1be0bbb1c5745 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id618a1535c034414789b1be0bbb1c5745 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id618a1535c034414789b1be0bbb1c5745 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id618a1535c034414789b1be0bbb1c5745 input{text-align:left;}"; break;
		}
	}
