        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BC_VOLFAP_CHILD", "DESCRIPTION");
        		}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BC_VOLFAP_CHILD", "AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
<div id="id2ae29000943942b8ae77cb52f82ec1de" class="general-layout-container">
...
<div id="id780a5986c9dc44b4a125bbe78bd5d5f5" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id780a5986c9dc44b4a125bbe78bd5d5f5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id780a5986c9dc44b4a125bbe78bd5d5f5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id780a5986c9dc44b4a125bbe78bd5d5f5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id780a5986c9dc44b4a125bbe78bd5d5f5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id780a5986c9dc44b4a125bbe78bd5d5f5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id780a5986c9dc44b4a125bbe78bd5d5f5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id780a5986c9dc44b4a125bbe78bd5d5f5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id780a5986c9dc44b4a125bbe78bd5d5f5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id780a5986c9dc44b4a125bbe78bd5d5f5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id780a5986c9dc44b4a125bbe78bd5d5f5 input{text-align:left;}"; break;
		}
	}
