<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="BCFAPCHLD_First_Amount_Payable.aspx.vb" Inherits="Nexus.PB2_BCFAPCHLD_First_Amount_Payable" %>
...
function onValidate_BC_FAP_CHILD__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BC_FAP_CHILD", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BC_FAP_CHILD", "COUNTER_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=BC_FAP_CHILD&propertyName=COUNTER_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "BC_FAP_CHILD" && field.getPropertyName() == "COUNTER_ID")
...
function onValidate_BC_FAP_CHILD__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BC_FAP_CHILD", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BC_FAP_CHILD", "DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BC_FAP_CHILD.DESCRIPTION");
        			window.setControlWidth(field, "0.7", "BC_FAP_CHILD", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBC_FAP_CHILD_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_BC_FAP_CHILD__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BC_FAP_CHILD__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_BC_FAP_CHILD__FAP_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BC_FAP_CHILD", "FAP_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BC_FAP_CHILD", "FAP_PERC");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BC_FAP_CHILD.FAP_PERC");
        			window.setControlWidth(field, "0.7", "BC_FAP_CHILD", "FAP_PERC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBC_FAP_CHILD_FAP_PERC");
        			    var ele = document.getElementById('ctl00_cntMainBody_BC_FAP_CHILD__FAP_PERC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BC_FAP_CHILD__FAP_PERC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "BC_FAP_CHILD".toUpperCase() + "__" + "FAP_PERC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "BC_FAP_CHILD".toUpperCase() + "_" + "FAP_PERC");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("BC_FAP_CHILD.FAP_PERC<= 100 || (BC_FAP_CHILD.FAP_PERC == '' || BC_FAP_CHILD.FAP_PERC == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_BC_FAP_CHILD__MIN_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BC_FAP_CHILD", "MIN_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BC_FAP_CHILD", "MIN_AMOUNT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BC_FAP_CHILD.MIN_AMOUNT");
        			window.setControlWidth(field, "0.7", "BC_FAP_CHILD", "MIN_AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBC_FAP_CHILD_MIN_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_BC_FAP_CHILD__MIN_AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BC_FAP_CHILD__MIN_AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "BC_FAP_CHILD".toUpperCase() + "__" + "MIN_AMOUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "BC_FAP_CHILD".toUpperCase() + "_" + "MIN_AMOUNT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(BC_FAP_CHILD.MIN_AMOUNT <= BC_FAP_CHILD.MAX_AMOUNT) || (BC_FAP_CHILD.MIN_AMOUNT == '' || BC_FAP_CHILD.MIN_AMOUNT == null || BC_FAP_CHILD.MIN_AMOUNT !=null) ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_BC_FAP_CHILD__MAX_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BC_FAP_CHILD", "MAX_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BC_FAP_CHILD", "MAX_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BC_FAP_CHILD.MAX_AMOUNT");
        			window.setControlWidth(field, "0.7", "BC_FAP_CHILD", "MAX_AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBC_FAP_CHILD_MAX_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_BC_FAP_CHILD__MAX_AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BC_FAP_CHILD__MAX_AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "BC_FAP_CHILD".toUpperCase() + "__" + "MAX_AMOUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "BC_FAP_CHILD".toUpperCase() + "_" + "MAX_AMOUNT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(BC_FAP_CHILD.MAX_AMOUNT != null AND BC_FAP_CHILD.MIN_AMOUNT != null AND BC_FAP_CHILD.MAX_AMOUNT >= BC_FAP_CHILD.MIN_AMOUNT) OR BC_FAP_CHILD.MAX_AMOUNT == null OR BC_FAP_CHILD.MAX_AMOUNT == ''");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    onValidate_BC_FAP_CHILD__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_BC_FAP_CHILD__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_BC_FAP_CHILD__FAP_PERC(null, null, null, isOnLoad);
    onValidate_BC_FAP_CHILD__MIN_AMOUNT(null, null, null, isOnLoad);
    onValidate_BC_FAP_CHILD__MAX_AMOUNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id67e19b38311241e1a4684a2a11d85a4b" class="general-layout-container">
...
<div id="id139a5713d0764f3d8a908dd6a4e50c71" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BC_FAP_CHILD" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-BC_FAP_CHILD-COUNTER_ID">

		
		<asp:Label ID="lblBC_FAP_CHILD_COUNTER_ID" runat="server" AssociatedControlID="BC_FAP_CHILD__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BC_FAP_CHILD__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBC_FAP_CHILD_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_BC_FAP_CHILD__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-BC_FAP_CHILD-DESCRIPTION">

		
		<asp:Label ID="lblBC_FAP_CHILD_DESCRIPTION" runat="server" AssociatedControlID="BC_FAP_CHILD__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BC_FAP_CHILD__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBC_FAP_CHILD_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_BC_FAP_CHILD__DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-BC_FAP_CHILD-FAP_PERC">
		<asp:Label ID="lblBC_FAP_CHILD_FAP_PERC" runat="server" AssociatedControlID="BC_FAP_CHILD__FAP_PERC" 
			Text="FAP %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="BC_FAP_CHILD__FAP_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valBC_FAP_CHILD_FAP_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP %"
			ClientValidationFunction="onValidate_BC_FAP_CHILD__FAP_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-BC_FAP_CHILD-MIN_AMOUNT">
		<asp:Label ID="lblBC_FAP_CHILD_MIN_AMOUNT" runat="server" AssociatedControlID="BC_FAP_CHILD__MIN_AMOUNT" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="BC_FAP_CHILD__MIN_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valBC_FAP_CHILD_MIN_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_BC_FAP_CHILD__MIN_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-BC_FAP_CHILD-MAX_AMOUNT">
		<asp:Label ID="lblBC_FAP_CHILD_MAX_AMOUNT" runat="server" AssociatedControlID="BC_FAP_CHILD__MAX_AMOUNT" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="BC_FAP_CHILD__MAX_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valBC_FAP_CHILD_MAX_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_BC_FAP_CHILD__MAX_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id139a5713d0764f3d8a908dd6a4e50c71 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id139a5713d0764f3d8a908dd6a4e50c71 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id139a5713d0764f3d8a908dd6a4e50c71 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id139a5713d0764f3d8a908dd6a4e50c71 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id139a5713d0764f3d8a908dd6a4e50c71 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id139a5713d0764f3d8a908dd6a4e50c71 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id139a5713d0764f3d8a908dd6a4e50c71 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id139a5713d0764f3d8a908dd6a4e50c71 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id139a5713d0764f3d8a908dd6a4e50c71 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id139a5713d0764f3d8a908dd6a4e50c71 input{text-align:left;}"; break;
		}
	}
