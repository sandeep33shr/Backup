<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OCENDPREM_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_OCENDPREM_Endorsement_Premium" %>
...
function onValidate_OC_CLAUSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OC_CLAUSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OC_CLAUSE", "ENDORSE_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=OC_CLAUSE&propertyName=ENDORSE_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "OC_CLAUSE" && field.getPropertyName() == "ENDORSE_ID")
...
function onValidate_OC_CLAUSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OC_CLAUSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OC_CLAUSE", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OC_CLAUSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "OC_CLAUSE", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblOC_CLAUSE_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_OC_CLAUSE__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OC_CLAUSE__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_OC_CLAUSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OC_CLAUSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OC_CLAUSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OC_CLAUSE.ENDORSE_CAP");
        			window.setControlWidth(field, "0.5", "OC_CLAUSE", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblOC_CLAUSE_ENDORSE_CAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_OC_CLAUSE__ENDORSE_CAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OC_CLAUSE__ENDORSE_CAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=OC_CLAUSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(OC_CLAUSE.ENDORSE_DESC)"), 
...
function onValidate_OC_CLAUSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OC_CLAUSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OC_CLAUSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OC_CLAUSE.PREMIUM");
        			window.setControlWidth(field, "0.5", "OC_CLAUSE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblOC_CLAUSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_OC_CLAUSE__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OC_CLAUSE__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_OC_CLAUSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_OC_CLAUSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_OC_CLAUSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_OC_CLAUSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id0d6e5ff7a0f3410c84a45af5d2a01580" class="general-layout-container">
...
<div id="id50a287e96cbb413a963c5c2cf022c62e" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OC_CLAUSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-OC_CLAUSE-ENDORSE_ID">
		<asp:Label ID="lblOC_CLAUSE_ENDORSE_ID" runat="server" AssociatedControlID="OC_CLAUSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="OC_CLAUSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valOC_CLAUSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_OC_CLAUSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-OC_CLAUSE-ENDORSE_DESC">
		<asp:Label ID="lblOC_CLAUSE_ENDORSE_DESC" runat="server" AssociatedControlID="OC_CLAUSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="OC_CLAUSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_OC_CLAUSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valOC_CLAUSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_OC_CLAUSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OC_CLAUSE-ENDORSE_CAP">

		
		<asp:Label ID="lblOC_CLAUSE_ENDORSE_CAP" runat="server" AssociatedControlID="OC_CLAUSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OC_CLAUSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOC_CLAUSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_OC_CLAUSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OC_CLAUSE-PREMIUM">
		<asp:Label ID="lblOC_CLAUSE_PREMIUM" runat="server" AssociatedControlID="OC_CLAUSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OC_CLAUSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOC_CLAUSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_OC_CLAUSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OC_CLAUSE-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="OC_CLAUSE__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id50a287e96cbb413a963c5c2cf022c62e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id50a287e96cbb413a963c5c2cf022c62e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id50a287e96cbb413a963c5c2cf022c62e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id50a287e96cbb413a963c5c2cf022c62e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id50a287e96cbb413a963c5c2cf022c62e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id50a287e96cbb413a963c5c2cf022c62e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id50a287e96cbb413a963c5c2cf022c62e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id50a287e96cbb413a963c5c2cf022c62e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id50a287e96cbb413a963c5c2cf022c62e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id50a287e96cbb413a963c5c2cf022c62e input{text-align:left;}"; break;
		}
	}
