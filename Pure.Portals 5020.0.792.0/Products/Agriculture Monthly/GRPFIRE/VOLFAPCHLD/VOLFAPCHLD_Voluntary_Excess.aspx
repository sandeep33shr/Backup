        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VOL_EXCESS", "DESCRIPTION");
        		}
...
<div id="id5f4b22899c2d41619b7724474853dca6" class="general-layout-container">
...
<div id="idf696ebc76b9f424394c7fb3f2ddb47f8" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf696ebc76b9f424394c7fb3f2ddb47f8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf696ebc76b9f424394c7fb3f2ddb47f8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf696ebc76b9f424394c7fb3f2ddb47f8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf696ebc76b9f424394c7fb3f2ddb47f8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf696ebc76b9f424394c7fb3f2ddb47f8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf696ebc76b9f424394c7fb3f2ddb47f8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf696ebc76b9f424394c7fb3f2ddb47f8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf696ebc76b9f424394c7fb3f2ddb47f8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf696ebc76b9f424394c7fb3f2ddb47f8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf696ebc76b9f424394c7fb3f2ddb47f8 input{text-align:left;}"; break;
		}
	}
