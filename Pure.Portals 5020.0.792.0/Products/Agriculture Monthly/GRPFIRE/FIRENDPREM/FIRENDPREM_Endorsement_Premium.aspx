<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FIRENDPREM_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_FIRENDPREM_Endorsement_Premium" %>
...
function onValidate_FI_CLAUSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FI_CLAUSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FI_CLAUSE", "ENDORSE_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=FI_CLAUSE&propertyName=ENDORSE_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "FI_CLAUSE" && field.getPropertyName() == "ENDORSE_ID")
...
function onValidate_FI_CLAUSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FI_CLAUSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FI_CLAUSE", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FI_CLAUSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "FI_CLAUSE", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFI_CLAUSE_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_FI_CLAUSE__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FI_CLAUSE__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_FI_CLAUSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FI_CLAUSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FI_CLAUSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FI_CLAUSE.ENDORSE_CAP");
        			window.setControlWidth(field, "0.5", "FI_CLAUSE", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFI_CLAUSE_ENDORSE_CAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_FI_CLAUSE__ENDORSE_CAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FI_CLAUSE__ENDORSE_CAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=FI_CLAUSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(FI_CLAUSE.ENDORSE_DESC)"), 
...
function onValidate_FI_CLAUSE__ENDORSE_COVER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FI_CLAUSE", "ENDORSE_COVER", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FI_CLAUSE", "ENDORSE_COVER");
        		var errorMessage = "Endorsement cover must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FI_CLAUSE.ENDORSE_COVER");
        			window.setControlWidth(field, "0.5", "FI_CLAUSE", "ENDORSE_COVER");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFI_CLAUSE_ENDORSE_COVER");
        			    var ele = document.getElementById('ctl00_cntMainBody_FI_CLAUSE__ENDORSE_COVER');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FI_CLAUSE__ENDORSE_COVER_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_FI_CLAUSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FI_CLAUSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FI_CLAUSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FI_CLAUSE.PREMIUM");
        			window.setControlWidth(field, "0.5", "FI_CLAUSE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFI_CLAUSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_FI_CLAUSE__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FI_CLAUSE__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_FI_CLAUSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_FI_CLAUSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_FI_CLAUSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_FI_CLAUSE__ENDORSE_COVER(null, null, null, isOnLoad);
    onValidate_FI_CLAUSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id8fc3396ec1dd49dc8e3a4fa9c8587d31" class="general-layout-container">
...
<div id="idf02fd7add120464ba95b89d11e4c4178" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading33" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FI_CLAUSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-FI_CLAUSE-ENDORSE_ID">
		<asp:Label ID="lblFI_CLAUSE_ENDORSE_ID" runat="server" AssociatedControlID="FI_CLAUSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="FI_CLAUSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valFI_CLAUSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_FI_CLAUSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-FI_CLAUSE-ENDORSE_DESC">
		<asp:Label ID="lblFI_CLAUSE_ENDORSE_DESC" runat="server" AssociatedControlID="FI_CLAUSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="FI_CLAUSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_FI_CLAUSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valFI_CLAUSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_FI_CLAUSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FI_CLAUSE-ENDORSE_CAP">

		
		<asp:Label ID="lblFI_CLAUSE_ENDORSE_CAP" runat="server" AssociatedControlID="FI_CLAUSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FI_CLAUSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFI_CLAUSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_FI_CLAUSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="FI_CLAUSE" 
		data-property-name="ENDORSE_COVER" 
		id="pb-container-list-FI_CLAUSE-ENDORSE_COVER">
		<asp:Label ID="lblFI_CLAUSE_ENDORSE_COVER" runat="server" AssociatedControlID="FI_CLAUSE__ENDORSE_COVER" 
			Text="Cover to be endorsed" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="FI_CLAUSE__ENDORSE_COVER" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_FIRE_ENDORSE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_FI_CLAUSE__ENDORSE_COVER(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valFI_CLAUSE_ENDORSE_COVER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Cover to be endorsed"
			ClientValidationFunction="onValidate_FI_CLAUSE__ENDORSE_COVER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FI_CLAUSE-PREMIUM">
		<asp:Label ID="lblFI_CLAUSE_PREMIUM" runat="server" AssociatedControlID="FI_CLAUSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FI_CLAUSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFI_CLAUSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_FI_CLAUSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FI_CLAUSE-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="FI_CLAUSE__ENDORSE_DESCCode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="FI_CLAUSE" 
		data-property-name="ENDORSE_COVERCode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-FI_CLAUSE-ENDORSE_COVERCode">

		
		
			
		
				<asp:HiddenField ID="FI_CLAUSE__ENDORSE_COVERCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf02fd7add120464ba95b89d11e4c4178 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf02fd7add120464ba95b89d11e4c4178 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf02fd7add120464ba95b89d11e4c4178 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf02fd7add120464ba95b89d11e4c4178 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf02fd7add120464ba95b89d11e4c4178 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf02fd7add120464ba95b89d11e4c4178 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf02fd7add120464ba95b89d11e4c4178 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf02fd7add120464ba95b89d11e4c4178 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf02fd7add120464ba95b89d11e4c4178 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf02fd7add120464ba95b89d11e4c4178 input{text-align:left;}"; break;
		}
	}
