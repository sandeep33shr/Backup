...
Namespace Nexus
    Partial Class PB2_MOTORP_Motor_Extensions : Inherits BaseRisk
		...
		Protected Sub onValidate_MOTOR_ADDON__ROADSIDE_ASSIST()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	CalculateRSAMultiplier()
        End If
        
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MOTOR_ADDON__ROADSIDE_ASSIST()
End Sub

		    
        Protected Sub CalculateRSAMultiplier()
        	MOTOR_ADDON__RSA_MULTIPLIER.Text = 12
        End Sub
