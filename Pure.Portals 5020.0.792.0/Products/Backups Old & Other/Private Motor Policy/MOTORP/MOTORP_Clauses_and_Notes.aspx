<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOTORP_Clauses_and_Notes.aspx.vb" Inherits="Nexus.PB2_MOTORP_Clauses_and_Notes" %>
...
function onValidate_MOTOR_NOTES__MOTNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTOR_NOTES", "MOTNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MOTOR_NOTES__MOTNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id1dd8db8464c240fa9a1fb422fbc14dae" class="general-layout-container">
...
<div id="id8d2deb3bd249450088cf7fe4f41510a8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading27" runat="server" Text="Private Motor Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MOTOR_NOTES__MOTNOTE"
		data-field-type="Child" 
		data-object-name="MOTOR_NOTES" 
		data-property-name="MOTNOTE" 
		id="pb-container-childscreen-MOTOR_NOTES-MOTNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MOTOR_NOTES__NOTE_DETAILS" runat="server" ScreenCode="MOTNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MOTNOTE/MOTNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMOTOR_NOTES_MOTNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_MOTOR_NOTES__MOTNOTE" 
						Display="None"
...
<script type="text/javascript">
	(function(){
		var container = document.getElementById('id8d2deb3bd249450088cf7fe4f41510a8'),
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8d2deb3bd249450088cf7fe4f41510a8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8d2deb3bd249450088cf7fe4f41510a8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8d2deb3bd249450088cf7fe4f41510a8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8d2deb3bd249450088cf7fe4f41510a8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8d2deb3bd249450088cf7fe4f41510a8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8d2deb3bd249450088cf7fe4f41510a8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8d2deb3bd249450088cf7fe4f41510a8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8d2deb3bd249450088cf7fe4f41510a8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8d2deb3bd249450088cf7fe4f41510a8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8d2deb3bd249450088cf7fe4f41510a8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmMotorCombinedClause" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading28" runat="server" Text="Motor Vehicle Clauses" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblWORDING_WORDING" runat="server" AssociatedControlID="WORDING__WORDING" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="WORDING__WORDING" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<script type="text/javascript">
	(function(){
		var container = document.getElementById('frmMotorCombinedClause'),
		zippy = new pb.ui.Zippy(
			container,
			goog.dom.query("legend", container)[0],
			goog.dom.query(".column-content", container)[0],
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmMotorCombinedClause div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmMotorCombinedClause div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmMotorCombinedClause div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmMotorCombinedClause label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmMotorCombinedClause label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmMotorCombinedClause label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmMotorCombinedClause label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmMotorCombinedClause input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmMotorCombinedClause input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmMotorCombinedClause input{text-align:left;}"; break;
		}
	}
