...
Namespace Nexus
    Partial Class PB2_SDUTY_Stamp_Duty : Inherits BaseRisk
		...
		Protected Sub onValidate_STAMPDUTY__TOTAL_PREMIUM()
...
Protected Sub CallRuleScripts()
    onValidate_STAMPDUTY__TOTAL_PREMIUM()
End Sub
        ...
        Sub RunRatingRuleAndRefreshValues()
        	Try
        		...
        		STAMPDUTY__TOTAL_PREMIUM.Text = GetValue("STAMPDUTY", "TOTAL_PREMIUM")
