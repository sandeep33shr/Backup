<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="HTPMF_Notes.aspx.vb" Inherits="Nexus.PB2_HTPMF_Notes" %>
...
function onValidate_NOTES__MFNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "MFNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MFNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__MFNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MFNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'MFNOTES'.");
        			error.display();
...
function onValidate_NOTES__COUNT_NOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "COUNT_NOTES", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("NOTES", "COUNT_NOTES");
        		}
          ...
          * @param NOTES The Parent (Root) object name.
          * @param CNOTE_DETAILS.NOTE_DESCRIPTION The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "NOTES".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "CNOTE_DETAILS.NOTE_DESCRIPTION";
...
function onValidate_NOTES__MFSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "MFSNOTES", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("NOTES", "MFSNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__MFSNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MFSNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'MFSNOTES'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function onValidate_NOTES__COUNT_SNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "COUNT_SNOTES", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("NOTES", "COUNT_SNOTES");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param NOTES The Parent (Root) object name.
          * @param SCNOTE_DETAILS.NOTE_DESCRIPTION The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "NOTES".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "SCNOTE_DETAILS.NOTE_DESCRIPTION";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    onValidate_NOTES__MFNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__COUNT_NOTES(null, null, null, isOnLoad);
    onValidate_NOTES__MFSNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__COUNT_SNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id661cd6e0809a493ab8ce11545b51598e" class="general-layout-container">
...
<div id="id308b999a1f3e4232b4379c95b79d9808" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__MFNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="MFNOTES" 
		id="pb-container-childscreen-NOTES-MFNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="MFNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MFNOTES/MFNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_MFNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.MFNOTES"
						ClientValidationFunction="onValidate_NOTES__MFNOTES" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NOTES" 
		data-property-name="COUNT_NOTES" 
		id="pb-container-integer-NOTES-COUNT_NOTES">
		<asp:Label ID="lblNOTES_COUNT_NOTES" runat="server" AssociatedControlID="NOTES__COUNT_NOTES" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="NOTES__COUNT_NOTES" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valNOTES_COUNT_NOTES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NOTES.COUNT_NOTES"
			ClientValidationFunction="onValidate_NOTES__COUNT_NOTES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id308b999a1f3e4232b4379c95b79d9808 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id308b999a1f3e4232b4379c95b79d9808 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id308b999a1f3e4232b4379c95b79d9808 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id308b999a1f3e4232b4379c95b79d9808 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id308b999a1f3e4232b4379c95b79d9808 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id308b999a1f3e4232b4379c95b79d9808 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id308b999a1f3e4232b4379c95b79d9808 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id308b999a1f3e4232b4379c95b79d9808 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id308b999a1f3e4232b4379c95b79d9808 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id308b999a1f3e4232b4379c95b79d9808 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0ea2bac5382f4b21bfa2899d5a7456ed" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__MFSNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="MFSNOTES" 
		id="pb-container-childscreen-NOTES-MFSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__SCNOTE_DETAILS" runat="server" ScreenCode="MFSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MFSNOTES/MFSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_MFSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.MFSNOTES"
						ClientValidationFunction="onValidate_NOTES__MFSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="NOTES" 
		data-property-name="COUNT_SNOTES" 
		id="pb-container-integer-NOTES-COUNT_SNOTES">
		<asp:Label ID="lblNOTES_COUNT_SNOTES" runat="server" AssociatedControlID="NOTES__COUNT_SNOTES" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="NOTES__COUNT_SNOTES" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valNOTES_COUNT_SNOTES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NOTES.COUNT_SNOTES"
			ClientValidationFunction="onValidate_NOTES__COUNT_SNOTES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0ea2bac5382f4b21bfa2899d5a7456ed div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0ea2bac5382f4b21bfa2899d5a7456ed div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0ea2bac5382f4b21bfa2899d5a7456ed div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0ea2bac5382f4b21bfa2899d5a7456ed label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0ea2bac5382f4b21bfa2899d5a7456ed label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0ea2bac5382f4b21bfa2899d5a7456ed label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0ea2bac5382f4b21bfa2899d5a7456ed label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0ea2bac5382f4b21bfa2899d5a7456ed input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0ea2bac5382f4b21bfa2899d5a7456ed input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0ea2bac5382f4b21bfa2899d5a7456ed input{text-align:left;}"; break;
		}
	}
