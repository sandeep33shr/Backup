<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="HTPMF_Endorsements.aspx.vb" Inherits="Nexus.PB2_HTPMF_Endorsements" %>
...
function onValidate_REFERRAL_CLAUSES__MFENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "REFERRAL_CLAUSES", "MFENDPREM", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_REFERRAL_CLAUSES__MFENDPREM(null, null, null, isOnLoad);
...
<div id="id4dfd5f49272b4f9b923d40709c55d6ab" class="general-layout-container">
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_REFERRAL_CLAUSES__MFENDPREM"
		data-field-type="Child" 
		data-object-name="REFERRAL_CLAUSES" 
		data-property-name="MFENDPREM" 
		id="pb-container-childscreen-REFERRAL_CLAUSES-MFENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="REFERRAL_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="MFENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MFENDPREM/MFENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valREFERRAL_CLAUSES_MFENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for REFERRAL_CLAUSES.MFENDPREM"
						ClientValidationFunction="onValidate_REFERRAL_CLAUSES__MFENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
