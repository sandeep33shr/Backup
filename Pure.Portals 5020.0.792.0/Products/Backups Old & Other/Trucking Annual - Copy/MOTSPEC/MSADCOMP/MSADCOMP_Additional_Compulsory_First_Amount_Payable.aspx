<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSADCOMP_Additional_Compulsory_First_Amount_Payable.aspx.vb" Inherits="Nexus.PB2_MSADCOMP_Additional_Compulsory_First_Amount_Payable" %>
...
function onValidate_ADD_COMP_CHILD__COMP_PERCC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "ADD_COMP_CHILD.COMP_MIN != null", "VE", "FAP % is mandatory and a percentage must be entered");
        
            var paramValue = "VEM",
            paramCondition = "ADD_COMP_CHILD.COMP_MIN != null",
            paramElseValue = "VE",
            paramValidationMessage = "FAP % is mandatory and a percentage must be entered";
...
function onValidate_ADD_COMP_CHILD__COMP_MIN(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "ADD_COMP_CHILD.COMP_PERCC != null", "VE", "Minimum Amount is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "ADD_COMP_CHILD.COMP_PERCC != null",
            paramElseValue = "VE",
            paramValidationMessage = "Minimum Amount is mandatory and an amount must be entered";
...
<div id="idb407dce0b2aa422cbc3f076023bf1001" class="general-layout-container">
