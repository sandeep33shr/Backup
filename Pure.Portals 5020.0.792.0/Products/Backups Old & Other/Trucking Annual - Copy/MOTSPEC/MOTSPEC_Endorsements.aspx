<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOTSPEC_Endorsements.aspx.vb" Inherits="Nexus.PB2_MOTSPEC_Endorsements" %>
...
function onValidate_REFERRAL_CLAUSES__MSPENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "REFERRAL_CLAUSES", "MSPENDPREM", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_REFERRAL_CLAUSES__MSPENDPREM(null, null, null, isOnLoad);
...
<div id="id70b08e2e39184397a41e0f6fdb513afb" class="general-layout-container">
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_REFERRAL_CLAUSES__MSPENDPREM"
		data-field-type="Child" 
		data-object-name="REFERRAL_CLAUSES" 
		data-property-name="MSPENDPREM" 
		id="pb-container-childscreen-REFERRAL_CLAUSES-MSPENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="REFERRAL_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="MSPENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPENDPREM/MSPENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valREFERRAL_CLAUSES_MSPENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for REFERRAL_CLAUSES.MSPENDPREM"
						ClientValidationFunction="onValidate_REFERRAL_CLAUSES__MSPENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
