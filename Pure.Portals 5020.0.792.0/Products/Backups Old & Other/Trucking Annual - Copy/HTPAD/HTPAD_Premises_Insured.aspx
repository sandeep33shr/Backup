<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="HTPAD_Premises_Insured.aspx.vb" Inherits="Nexus.PB2_HTPAD_Premises_Insured" %>
...
function onValidate_GENERAL__CMAMFLMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CMAMFLMTA", "ChildScreen");
        })();
}
...
function onValidate_GENERAL__PRIMARY_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "PRIMARY_INDUSTRY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function onValidate_GENERAL__SECOND_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "SECOND_INDUSTRY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function onValidate_GENERAL__TERTIARY_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "TERTIARY_INDUSTRY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function onValidate_GENERAL__INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "INDUSTRY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function DoLogic(isOnLoad) {
    onValidate_GENERAL__CMAMFLMTA(null, null, null, isOnLoad);
...
<div id="id292ad26133294c3aab576a4f29111f23" class="general-layout-container">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CMAMFLMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CMAMFLMTA" 
		id="pb-container-childscreen-GENERAL-CMAMFLMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CMAMFLMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMFLMTA/CMAMFLMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CMAMFLMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CMAMFLMTA"
						ClientValidationFunction="onValidate_GENERAL__CMAMFLMTA" 
						Display="None"
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id150a3836717b401f8119196551c15d32" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id150a3836717b401f8119196551c15d32 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id150a3836717b401f8119196551c15d32 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id150a3836717b401f8119196551c15d32 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id150a3836717b401f8119196551c15d32 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id150a3836717b401f8119196551c15d32 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id150a3836717b401f8119196551c15d32 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id150a3836717b401f8119196551c15d32 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id150a3836717b401f8119196551c15d32 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id150a3836717b401f8119196551c15d32 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id150a3836717b401f8119196551c15d32 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id76e635833db34635b3464a06260a879d" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id76e635833db34635b3464a06260a879d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id76e635833db34635b3464a06260a879d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id76e635833db34635b3464a06260a879d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id76e635833db34635b3464a06260a879d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id76e635833db34635b3464a06260a879d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id76e635833db34635b3464a06260a879d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id76e635833db34635b3464a06260a879d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id76e635833db34635b3464a06260a879d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id76e635833db34635b3464a06260a879d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id76e635833db34635b3464a06260a879d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf02d89cbbb754d11a9366ee1f7bd4e5f" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf02d89cbbb754d11a9366ee1f7bd4e5f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf02d89cbbb754d11a9366ee1f7bd4e5f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf02d89cbbb754d11a9366ee1f7bd4e5f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf02d89cbbb754d11a9366ee1f7bd4e5f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf02d89cbbb754d11a9366ee1f7bd4e5f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf02d89cbbb754d11a9366ee1f7bd4e5f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf02d89cbbb754d11a9366ee1f7bd4e5f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf02d89cbbb754d11a9366ee1f7bd4e5f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf02d89cbbb754d11a9366ee1f7bd4e5f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf02d89cbbb754d11a9366ee1f7bd4e5f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb44ce8ab696e4ab1954a326a048693d3" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GENERAL-PRIMARY_INDUSTRY">
		...
		<asp:Label ID="lblGENERAL_PRIMARY_INDUSTRY" runat="server" AssociatedControlID="GENERAL__PRIMARY_INDUSTRY" 
			Text="Primary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GENERAL__PRIMARY_INDUSTRY" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GENERAL-SECOND_INDUSTRY">
		...
		<asp:Label ID="lblGENERAL_SECOND_INDUSTRY" runat="server" AssociatedControlID="GENERAL__SECOND_INDUSTRY" 
			Text="Secondary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GENERAL__SECOND_INDUSTRY" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GENERAL-TERTIARY_INDUSTRY">
		...
		<asp:Label ID="lblGENERAL_TERTIARY_INDUSTRY" runat="server" AssociatedControlID="GENERAL__TERTIARY_INDUSTRY" 
			Text="Tertiary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GENERAL__TERTIARY_INDUSTRY" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GENERAL-INDUSTRY">
		...
		<asp:Label ID="lblGENERAL_INDUSTRY" runat="server" AssociatedControlID="GENERAL__INDUSTRY" 
			Text="Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GENERAL__INDUSTRY" runat="server" CssClass="form-control" data-type="Text" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb44ce8ab696e4ab1954a326a048693d3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb44ce8ab696e4ab1954a326a048693d3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb44ce8ab696e4ab1954a326a048693d3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb44ce8ab696e4ab1954a326a048693d3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb44ce8ab696e4ab1954a326a048693d3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb44ce8ab696e4ab1954a326a048693d3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb44ce8ab696e4ab1954a326a048693d3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb44ce8ab696e4ab1954a326a048693d3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb44ce8ab696e4ab1954a326a048693d3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb44ce8ab696e4ab1954a326a048693d3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf75bfaf013474d91ab9e3f92fe07b445" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf75bfaf013474d91ab9e3f92fe07b445 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf75bfaf013474d91ab9e3f92fe07b445 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf75bfaf013474d91ab9e3f92fe07b445 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf75bfaf013474d91ab9e3f92fe07b445 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf75bfaf013474d91ab9e3f92fe07b445 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf75bfaf013474d91ab9e3f92fe07b445 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf75bfaf013474d91ab9e3f92fe07b445 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf75bfaf013474d91ab9e3f92fe07b445 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf75bfaf013474d91ab9e3f92fe07b445 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf75bfaf013474d91ab9e3f92fe07b445 input{text-align:left;}"; break;
		}
	}
