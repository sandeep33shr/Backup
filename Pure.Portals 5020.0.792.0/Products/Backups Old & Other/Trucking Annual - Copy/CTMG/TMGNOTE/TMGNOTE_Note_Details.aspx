<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TMGNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_TMGNOTE_Note_Details" %>
...
<div id="ide25f554093da4b079ec7d29df8b82c46" class="general-layout-container">
...
<div id="id4c2b6e59dc764865bec45bfb0a9e149d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading8" runat="server" Text="Note Detail (Not Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4c2b6e59dc764865bec45bfb0a9e149d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4c2b6e59dc764865bec45bfb0a9e149d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4c2b6e59dc764865bec45bfb0a9e149d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4c2b6e59dc764865bec45bfb0a9e149d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4c2b6e59dc764865bec45bfb0a9e149d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4c2b6e59dc764865bec45bfb0a9e149d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4c2b6e59dc764865bec45bfb0a9e149d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4c2b6e59dc764865bec45bfb0a9e149d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4c2b6e59dc764865bec45bfb0a9e149d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4c2b6e59dc764865bec45bfb0a9e149d input{text-align:left;}"; break;
		}
	}
