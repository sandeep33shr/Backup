<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CTMG_Notes.aspx.vb" Inherits="Nexus.PB2_CTMG_Notes" %>
...
function onValidate_NOTES__TMGNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "TMGNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "TMGNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__TMGNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "TMGNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'TMGNOTE'.");
        			error.display();
...
function onValidate_NOTES__TMGSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "TMGSNOTE", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("NOTES", "TMGSNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__TMGSNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "TMGSNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'TMGSNOTE'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function DoLogic(isOnLoad) {
    onValidate_NOTES__TMGNOTE(null, null, null, isOnLoad);
    onValidate_NOTES__COUNT_NOTES(null, null, null, isOnLoad);
    onValidate_NOTES__TMGSNOTE(null, null, null, isOnLoad);
...
<div id="ida78d3a297f354148bd4d815115ad5e7c" class="general-layout-container">
...
<div id="idf756d3f7bfdd42a1bc026bb7acf9c068" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__TMGNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="TMGNOTE" 
		id="pb-container-childscreen-NOTES-TMGNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="TMGNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TMGNOTE/TMGNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_TMGNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.TMGNOTE"
						ClientValidationFunction="onValidate_NOTES__TMGNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf756d3f7bfdd42a1bc026bb7acf9c068 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf756d3f7bfdd42a1bc026bb7acf9c068 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf756d3f7bfdd42a1bc026bb7acf9c068 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf756d3f7bfdd42a1bc026bb7acf9c068 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf756d3f7bfdd42a1bc026bb7acf9c068 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf756d3f7bfdd42a1bc026bb7acf9c068 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf756d3f7bfdd42a1bc026bb7acf9c068 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf756d3f7bfdd42a1bc026bb7acf9c068 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf756d3f7bfdd42a1bc026bb7acf9c068 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf756d3f7bfdd42a1bc026bb7acf9c068 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id63f8a6015db94293b216fb800792faf4" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__TMGSNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="TMGSNOTE" 
		id="pb-container-childscreen-NOTES-TMGSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__SCNOTE_DETAILS" runat="server" ScreenCode="TMGSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TMGSNOTE/TMGSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_TMGSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.TMGSNOTE"
						ClientValidationFunction="onValidate_NOTES__TMGSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id63f8a6015db94293b216fb800792faf4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id63f8a6015db94293b216fb800792faf4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id63f8a6015db94293b216fb800792faf4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id63f8a6015db94293b216fb800792faf4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id63f8a6015db94293b216fb800792faf4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id63f8a6015db94293b216fb800792faf4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id63f8a6015db94293b216fb800792faf4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id63f8a6015db94293b216fb800792faf4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id63f8a6015db94293b216fb800792faf4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id63f8a6015db94293b216fb800792faf4 input{text-align:left;}"; break;
		}
	}
