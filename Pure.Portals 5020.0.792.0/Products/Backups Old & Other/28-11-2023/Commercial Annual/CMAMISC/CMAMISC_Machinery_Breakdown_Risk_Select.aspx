<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISC_Machinery_Breakdown_Risk_Select.aspx.vb" Inherits="Nexus.PB2_CMAMISC_Machinery_Breakdown_Risk_Select" %>
...
<div id="id8a761f971a2e4502a018a602d9f36797" class="general-layout-container">
...
<div id="id60b0e3cdf7dc4fcca2484f75c9778f5e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading217" runat="server" Text="Options" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id60b0e3cdf7dc4fcca2484f75c9778f5e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id60b0e3cdf7dc4fcca2484f75c9778f5e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id60b0e3cdf7dc4fcca2484f75c9778f5e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id60b0e3cdf7dc4fcca2484f75c9778f5e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id60b0e3cdf7dc4fcca2484f75c9778f5e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60b0e3cdf7dc4fcca2484f75c9778f5e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60b0e3cdf7dc4fcca2484f75c9778f5e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id60b0e3cdf7dc4fcca2484f75c9778f5e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60b0e3cdf7dc4fcca2484f75c9778f5e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60b0e3cdf7dc4fcca2484f75c9778f5e input{text-align:left;}"; break;
		}
	}
