...
Namespace Nexus
    Partial Class PB2_CMAMISC_Machinery_Breakdown_Overview : Inherits BaseRisk
		...
		Protected Sub onValidate_EXPOSURE_SUMMARY__MB_TOTAL_SI()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_EXPOSURE_SUMMARY__MB_TOTAL_SI()
End Sub
