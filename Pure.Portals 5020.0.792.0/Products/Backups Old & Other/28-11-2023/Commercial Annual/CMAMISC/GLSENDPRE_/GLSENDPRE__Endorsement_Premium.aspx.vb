...
Namespace Nexus
    Partial Class PB2_GLSENDPRE__Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_GLASS_CLAUSEPREM__COUNTER_ID()
        
End Sub
Protected Sub onValidate_GLASS_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GLASS_CLAUSEPREM__COUNTER_ID()
    onValidate_GLASS_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'GLASS - Parent object
        'GLASS_CLAUSEPREM - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "GLASS" & "/" & "GLASS_CLAUSEPREM", sXMLDataset)
                            If sChildId <> "0" Then
                                GLASS_CLAUSEPREM__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        'Parameters:
        'GLASS - Standard Wording Parent Object
        'GLASS_CLAUSES - Standard Wording Parent Property
        'GLASS_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/GLASS/SW.GLASS_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("GLASS_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/GLASS/GLASS_CLAUSEPREM")
        
        	Dim CurrentSelected As String = GLASS_CLAUSEPREM__ENDORSE_CAP.Text
