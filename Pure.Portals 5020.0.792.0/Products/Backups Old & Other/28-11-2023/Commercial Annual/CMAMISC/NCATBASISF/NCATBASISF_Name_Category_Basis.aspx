<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="NCATBASISF_Name_Category_Basis.aspx.vb" Inherits="Nexus.PB2_NCATBASISF_Name_Category_Basis" %>
...
function onValidate_GUAR__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GUAR", "COUNTER_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GUAR&propertyName=COUNTER_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "GUAR" && field.getPropertyName() == "COUNTER_ID")
...
function onValidate_GUAR__DATEADDED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "DATEADDED", "Date");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("GUAR", "DATEADDED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=GUAR&propertyName=DATEADDED&name={name}");
...
function onValidate_GUAR__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "NAME", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GUAR", "NAME");
        		var errorMessage = "Name/Category is mandatory and an option  must be selected";
...
function onValidate_GUAR__CAT_SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "CAT_SUMINSURED", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GUAR", "CAT_SUMINSURED");
        		}
...
function onValidate_GUAR__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GUAR", "SUMINSURED");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GUAR.CAT_PPREM.setValue(GUAR.SUMINSURED * GUAR.CAT_RATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("(GUAR.SUMINSURED <> '' AND GUAR.SUMINSURED <> null) AND (GUAR.CAT_RATE <> '' AND GUAR.CAT_RATE <> null)")) ? new Expression("(GUAR.SUMINSURED <> '' AND GUAR.SUMINSURED <> null) AND (GUAR.CAT_RATE <> '' AND GUAR.CAT_RATE <> null)") : null;
...
function onValidate_GUAR__CAT_NO_PERSONS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "CAT_NO_PERSONS", "Text");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GUAR", "CAT_NO_PERSONS");
        		var errorMessage = "Number of Employees is mandatory and an option  must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
...
function onValidate_GUAR__CAT_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "CAT_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GUAR", "CAT_RATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("GUAR", "CAT_RATE");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GUAR".toUpperCase() + "__" + "CAT_RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GUAR".toUpperCase() + "_" + "CAT_RATE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("GUAR.CAT_RATE>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GUAR__CAT_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "CAT_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GUAR", "CAT_PREMIUM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('GUAR', 'CAT_PREMIUM');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=GUAR&propertyName=CAT_PREMIUM&name={name}");
        		
        		var value = new Expression("GUAR.CAT_PPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GUAR__CAT_PPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GUAR", "CAT_PPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GUAR", "CAT_PPREM");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GUAR.CAT_RATE.setValue(GUAR.CAT_PPREM/GUAR.SUMINSURED*100)");
        		var whenExp = (Expression.isValidParameter("(GUAR.SUMINSURED <> '' AND GUAR.SUMINSURED <> null) AND (GUAR.CAT_RATE <> '' AND GUAR.CAT_RATE <> null)")) ? new Expression("(GUAR.SUMINSURED <> '' AND GUAR.SUMINSURED <> null) AND (GUAR.CAT_RATE <> '' AND GUAR.CAT_RATE <> null)") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function DoLogic(isOnLoad) {
    onValidate_GUAR__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_GUAR__DATEADDED(null, null, null, isOnLoad);
    onValidate_GUAR__NAME(null, null, null, isOnLoad);
    onValidate_GUAR__CAT_SUMINSURED(null, null, null, isOnLoad);
    onValidate_GUAR__SUMINSURED(null, null, null, isOnLoad);
    onValidate_GUAR__CAT_NO_PERSONS(null, null, null, isOnLoad);
    onValidate_GUAR__CAT_RATE(null, null, null, isOnLoad);
    onValidate_GUAR__CAT_PREMIUM(null, null, null, isOnLoad);
    onValidate_GUAR__CAT_PPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="idd8c3798f192f4bda877291a8645cb020" class="general-layout-container">
...
<div id="idde264fe73c50415c96c82ad253e0295d" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="GUAR" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-GUAR-COUNTER_ID">

		
		<asp:Label ID="lblGUAR_COUNTER_ID" runat="server" AssociatedControlID="GUAR__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GUAR__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGUAR_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_GUAR__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<!-- /Text -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-GUAR-DATEADDED">
		<asp:Label ID="lblGUAR_DATEADDED" runat="server" AssociatedControlID="GUAR__DATEADDED" 
			Text="Date Added" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="GUAR__DATEADDED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calGUAR__DATEADDED" runat="server" LinkedControl="GUAR__DATEADDED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valGUAR_DATEADDED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Added"
			ClientValidationFunction="onValidate_GUAR__DATEADDED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GUAR-NAME">

		
		<asp:Label ID="lblGUAR_NAME" runat="server" AssociatedControlID="GUAR__NAME" 
			Text="Name/Category" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GUAR__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGUAR_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name/Category"
					ClientValidationFunction="onValidate_GUAR__NAME"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="GUAR" 
		data-property-name="CAT_SUMINSURED" 
		 
		
		 
		id="pb-container-text-GUAR-CAT_SUMINSURED">

		
		<asp:Label ID="lblGUAR_CAT_SUMINSURED" runat="server" AssociatedControlID="GUAR__CAT_SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GUAR__CAT_SUMINSURED" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGUAR_CAT_SUMINSURED" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Sum Insured"
					ClientValidationFunction="onValidate_GUAR__CAT_SUMINSURED"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-GUAR-SUMINSURED">
		<asp:Label ID="lblGUAR_SUMINSURED" runat="server" AssociatedControlID="GUAR__SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GUAR__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGUAR_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_GUAR__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="GUAR" 
		data-property-name="CAT_NO_PERSONS" 
		 
		
		 
		id="pb-container-text-GUAR-CAT_NO_PERSONS">

		
		<asp:Label ID="lblGUAR_CAT_NO_PERSONS" runat="server" AssociatedControlID="GUAR__CAT_NO_PERSONS" 
			Text="Number of Employees" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GUAR__CAT_NO_PERSONS" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGUAR_CAT_NO_PERSONS" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Number of Employees"
					ClientValidationFunction="onValidate_GUAR__CAT_NO_PERSONS"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GUAR" 
		data-property-name="CAT_RATE" 
		id="pb-container-percentage-GUAR-CAT_RATE">
		<asp:Label ID="lblGUAR_CAT_RATE" runat="server" AssociatedControlID="GUAR__CAT_RATE" 
			Text="Rate %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="GUAR__CAT_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valGUAR_CAT_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate %"
			ClientValidationFunction="onValidate_GUAR__CAT_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="GUAR" 
		data-property-name="CAT_PREMIUM" 
		id="pb-container-currency-GUAR-CAT_PREMIUM">
		<asp:Label ID="lblGUAR_CAT_PREMIUM" runat="server" AssociatedControlID="GUAR__CAT_PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GUAR__CAT_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGUAR_CAT_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_GUAR__CAT_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="GUAR" 
		data-property-name="CAT_PPREM" 
		id="pb-container-currency-GUAR-CAT_PPREM">
		<asp:Label ID="lblGUAR_CAT_PPREM" runat="server" AssociatedControlID="GUAR__CAT_PPREM" 
			Text="Posting Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GUAR__CAT_PPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGUAR_CAT_PPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Posting Premium"
			ClientValidationFunction="onValidate_GUAR__CAT_PPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idde264fe73c50415c96c82ad253e0295d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idde264fe73c50415c96c82ad253e0295d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idde264fe73c50415c96c82ad253e0295d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idde264fe73c50415c96c82ad253e0295d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idde264fe73c50415c96c82ad253e0295d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idde264fe73c50415c96c82ad253e0295d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idde264fe73c50415c96c82ad253e0295d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idde264fe73c50415c96c82ad253e0295d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idde264fe73c50415c96c82ad253e0295d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idde264fe73c50415c96c82ad253e0295d input{text-align:left;}"; break;
		}
	}
