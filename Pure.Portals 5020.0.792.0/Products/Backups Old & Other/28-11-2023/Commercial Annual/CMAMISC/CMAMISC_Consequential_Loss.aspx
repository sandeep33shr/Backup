<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISC_Consequential_Loss.aspx.vb" Inherits="Nexus.PB2_CMAMISC_Consequential_Loss" %>
...
function onValidate_CLOSS__ATTACHMENTDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ATTACHMENTDATE");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=CLOSS&propertyName=ATTACHMENTDATE&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "CLOSS" && field.getPropertyName() == "ATTACHMENTDATE")
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_CLOSS__FLAT_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "FLAT_PREMIUM", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "FLAT_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLOSS.FLAT_PREMIUM");
        			window.setControlWidth(field, "0.4", "CLOSS", "FLAT_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLOSS_FLAT_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLOSS__FLAT_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLOSS__FLAT_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CLOSS__TOTAL_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "TOTAL_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "TOTAL_PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLOSS.TOTAL_PREM");
        			window.setControlWidth(field, "0.4", "CLOSS", "TOTAL_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLOSS_TOTAL_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLOSS__TOTAL_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLOSS__TOTAL_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=TOTAL_PREM&name={name}");
...
function onValidate_CLOSS__CL_TOTSUMIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CL_TOTSUMIN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "CL_TOTSUMIN");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLOSS.CL_TOTSUMIN");
        			window.setControlWidth(field, "0.4", "CLOSS", "CL_TOTSUMIN");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLOSS_CL_TOTSUMIN");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLOSS__CL_TOTSUMIN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLOSS__CL_TOTSUMIN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=CL_TOTSUMIN&name={name}");
...
function onValidate_CLOSS__CL_TOTPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CL_TOTPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "CL_TOTPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLOSS.CL_TOTPREM");
        			window.setControlWidth(field, "0.4", "CLOSS", "CL_TOTPREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLOSS_CL_TOTPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLOSS__CL_TOTPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLOSS__CL_TOTPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=CL_TOTPREM&name={name}");
...
function onValidate_CLOSS__CL_TOTENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CL_TOTENDPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "CL_TOTENDPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLOSS.CL_TOTENDPREM");
        			window.setControlWidth(field, "0.4", "CLOSS", "CL_TOTENDPREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLOSS_CL_TOTENDPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLOSS__CL_TOTENDPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLOSS__CL_TOTENDPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=CL_TOTENDPREM&name={name}");
...
function onValidate_CLOSS__DATEADDED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "DATEADDED");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=CLOSS&propertyName=DATEADDED&name={name}");
...
function onValidate_CLOSS__TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Type is mandatory and an option must be selected";
...
function onValidate_CLOSS__BASIS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Basis is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueWhen = new ValueWhenHelper(new Expression("2"), (Expression.isValidParameter("Code(CLOSS.BASIS) = null or Code(CLOSS.BASIS) = ''")) ? new Expression("Code(CLOSS.BASIS) = null or Code(CLOSS.BASIS) = ''") : null, (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null);
...
function onValidate_CLOSS__IND_PER_UNIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Indemnity Period Unit is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
...
function onValidate_CLOSS__IND_PER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Indemnity Period is mandatory and must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
...
function onValidate_CLOSS__SUM_INSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.POSTPREMIUM.setValue(CLOSS.SUM_INSURED * CLOSS.RATE / 100)");
        		var whenExp = (Expression.isValidParameter("(CLOSS.SUM_INSURED <> '' AND CLOSS.SUM_INSURED <> null) AND (CLOSS.RATE <> '' AND CLOSS.RATE <> null)")) ? new Expression("(CLOSS.SUM_INSURED <> '' AND CLOSS.SUM_INSURED <> null) AND (CLOSS.RATE <> '' AND CLOSS.RATE <> null)") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "RATE");
        		}
...
function onValidate_CLOSS__POSTPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "POSTPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CLOSS", "POSTPREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLOSS.POSTPREMIUM");
        			window.setControlWidth(field, "0.8", "CLOSS", "POSTPREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLOSS_POSTPREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLOSS__POSTPREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLOSS__POSTPREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.RATE.setValue(CLOSS.POSTPREMIUM / CLOSS.SUM_INSURED * 100)");
        		var whenExp = (Expression.isValidParameter("(CLOSS.SUM_INSURED <> '' AND CLOSS.SUM_INSURED <> null) AND (CLOSS.RATE <> '' AND CLOSS.RATE <> null)")) ? new Expression("(CLOSS.SUM_INSURED <> '' AND CLOSS.SUM_INSURED <> null) AND (CLOSS.RATE <> '' AND CLOSS.RATE <> null)") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLOSS__TIME_EX_UNIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Time Excess Unit is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "FAP");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Consequential Loss FAP % cannot be more than 100%")) ? "Consequential Loss FAP % cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CLOSS".toUpperCase() + "__" + "FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CLOSS".toUpperCase() + "_" + "FAP");
        				}
        				if (node != null){
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "MINAMOUNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CLOSS__ACPC_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ACPC_SUMINSURED");
        		}
        		//window.setProperty(field, "VEM", "CLOSS.IS_ACPC = 1", "V", "Additional Claims Preparation Costs Limit of Indemnity is mandatory and an amount must be entered");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.ACPC_POST_PREMIUM.setValue(CLOSS.ACPC_SUMINSURED * CLOSS.ACPC_RATE / 100)");
        		var whenExp = (Expression.isValidParameter("(CLOSS.ACPC_SUMINSURED <> '' AND CLOSS.ACPC_SUMINSURED <> null) AND (CLOSS.ACPC_RATE <> '' AND CLOSS.ACPC_RATE <> null) AND CLOSS.IS_ACPC = 1")) ? new Expression("(CLOSS.ACPC_SUMINSURED <> '' AND CLOSS.ACPC_SUMINSURED <> null) AND (CLOSS.ACPC_RATE <> '' AND CLOSS.ACPC_RATE <> null) AND CLOSS.IS_ACPC = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=ACPC_SUMINSURED&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("CLOSS.IS_ACPC = 0")) ? new Expression("CLOSS.IS_ACPC = 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_CLOSS__ACPC_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ACPC_RATE");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=CLOSS&propertyName=ACPC_RATE&name={name}");
...
function onValidate_CLOSS__ACPC_POST_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "ACPC_POST_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ACPC_POST_PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "CLOSS.IS_ACPC = 1", "V", "Additional Claims Preparation Costs Posting Premium is mandatory and an amount must be entered");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLOSS", "ACPC_POST_PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.ACPC_RATE.setValue(CLOSS.ACPC_POST_PREMIUM / CLOSS.ACPC_SUMINSURED * 100)");
        		var whenExp = (Expression.isValidParameter("(CLOSS.ACPC_SUMINSURED <> '' AND CLOSS.ACPC_SUMINSURED <> null) AND (CLOSS.ACPC_RATE <> '' AND CLOSS.ACPC_RATE <> null) AND CLOSS.IS_ACPC = 1")) ? new Expression("(CLOSS.ACPC_SUMINSURED <> '' AND CLOSS.ACPC_SUMINSURED <> null) AND (CLOSS.ACPC_RATE <> '' AND CLOSS.ACPC_RATE <> null) AND CLOSS.IS_ACPC = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=ACPC_POST_PREMIUM&name={name}");
...
function onValidate_CLOSS__AICOW_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "AICOW_SUMINSURED");
        		}
        		//window.setProperty(field, "VEM", "CLOSS.IS_AICOW = 1", "V", "Additional Increase Cost of Working Limit of Indemnity is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "CLOSS.IS_AICOW = 1",
            paramElseValue = "V",
            paramValidationMessage = "Additional Increase Cost of Working Limit of Indemnity is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.AICOW_POST_PREMIUM.setValue(CLOSS.AICOW_SUMINSURED * CLOSS.AICOW_RATE / 100)");
        		var whenExp = (Expression.isValidParameter("(CLOSS.AICOW_SUMINSURED <> '' AND CLOSS.AICOW_SUMINSURED <> null) AND (CLOSS.AICOW_RATE <> '' AND CLOSS.AICOW_RATE <> null) AND CLOSS.IS_AICOW = 1")) ? new Expression("(CLOSS.AICOW_SUMINSURED <> '' AND CLOSS.AICOW_SUMINSURED <> null) AND (CLOSS.AICOW_RATE <> '' AND CLOSS.AICOW_RATE <> null) AND CLOSS.IS_AICOW = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=AICOW_SUMINSURED&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("CLOSS.IS_AICOW = 0")) ? new Expression("CLOSS.IS_AICOW = 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_CLOSS__AICOW_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "AICOW_RATE");
        		}
        		//window.setProperty(field, "VE", "CLOSS.IS_AICOW= 1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=CLOSS&propertyName=AICOW_RATE&name={name}");
...
function onValidate_CLOSS__AICOW_POST_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "AICOW_POST_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "AICOW_POST_PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "CLOSS.IS_AICOW= 1", "V", "Additional Increase Cost of Working Posting Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "CLOSS.IS_AICOW= 1",
            paramElseValue = "V",
            paramValidationMessage = "Additional Increase Cost of Working Posting Premium is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLOSS", "AICOW_POST_PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.AICOW_RATE.setValue(CLOSS.AICOW_POST_PREMIUM / CLOSS.AICOW_SUMINSURED * 100)");
        		var whenExp = (Expression.isValidParameter("(CLOSS.AICOW_SUMINSURED <> '' AND CLOSS.AICOW_SUMINSURED <> null) AND (CLOSS.AICOW_RATE <> '' AND CLOSS.AICOW_RATE <> null) AND CLOSS.IS_AICOW = 1")) ? new Expression("(CLOSS.AICOW_SUMINSURED <> '' AND CLOSS.AICOW_SUMINSURED <> null) AND (CLOSS.AICOW_RATE <> '' AND CLOSS.AICOW_RATE <> null) AND CLOSS.IS_AICOW = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=AICOW_POST_PREMIUM&name={name}");
...
function onValidate_CLOSS__AICOW_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "AICOW_FAP");
        		}
        		//window.setProperty(field, "VE", "CLOSS.IS_AICOW= 1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=CLOSS&propertyName=AICOW_FAP&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Additional Increase Cost of Working FAP % cannot be more than 100%")) ? "Additional Increase Cost of Working FAP % cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CLOSS".toUpperCase() + "__" + "AICOW_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CLOSS".toUpperCase() + "_" + "AICOW_FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("CLOSS.AICOW_FAP > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CLOSS__AICOW_MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "AICOW_MIN_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "CLOSS.IS_AICOW= 1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=AICOW_MIN_AMOUNT&name={name}");
...
function onValidate_CLOSS__ICOW_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ICOW_SUMINSURED");
        		}
        		//window.setProperty(field, "VEM", "CLOSS.IS_ICOW= 1", "V", "Increase Cost of Working Limit of Indemnity is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "CLOSS.IS_ICOW= 1",
            paramElseValue = "V",
            paramValidationMessage = "Increase Cost of Working Limit of Indemnity is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.ICOW_POST_PREMIUM.setValue(CLOSS.ICOW_SUMINSURED * CLOSS.ICOW_RATE / 100)");
        		var whenExp = (Expression.isValidParameter("(CLOSS.ICOW_SUMINSURED <> '' AND CLOSS.ICOW_SUMINSURED <> null) AND (CLOSS.ICOW_RATE <> '' AND CLOSS.ICOW_RATE <> null) AND CLOSS.IS_ICOW == 1")) ? new Expression("(CLOSS.ICOW_SUMINSURED <> '' AND CLOSS.ICOW_SUMINSURED <> null) AND (CLOSS.ICOW_RATE <> '' AND CLOSS.ICOW_RATE <> null) AND CLOSS.IS_ICOW == 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=ICOW_SUMINSURED&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("CLOSS.IS_ICOW = 0")) ? new Expression("CLOSS.IS_ICOW = 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_CLOSS__ICOW_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ICOW_RATE");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=CLOSS&propertyName=ICOW_RATE&name={name}");
...
function onValidate_CLOSS__ICOW_POST_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "ICOW_POST_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ICOW_POST_PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "CLOSS.IS_ICOW= 1", "V", "Increase Cost of Working Posting Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "CLOSS.IS_ICOW= 1",
            paramElseValue = "V",
            paramValidationMessage = "Increase Cost of Working Posting Premium is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLOSS", "ICOW_POST_PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLOSS.ICOW_RATE.setValue(CLOSS.ICOW_POST_PREMIUM / CLOSS.ICOW_SUMINSURED * 100)");
        		var whenExp = (Expression.isValidParameter("(CLOSS.ICOW_SUMINSURED <> '' AND CLOSS.ICOW_SUMINSURED <> null) AND (CLOSS.ICOW_RATE <> '' AND CLOSS.ICOW_RATE <> null) AND CLOSS.IS_ICOW == 1")) ? new Expression("(CLOSS.ICOW_SUMINSURED <> '' AND CLOSS.ICOW_SUMINSURED <> null) AND (CLOSS.ICOW_RATE <> '' AND CLOSS.ICOW_RATE <> null) AND CLOSS.IS_ICOW == 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=ICOW_POST_PREMIUM&name={name}");
...
function onValidate_CLOSS__ICOW_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ICOW_FAP");
        		}
        		//window.setProperty(field, "VE", "CLOSS.IS_ICOW= 1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=CLOSS&propertyName=ICOW_FAP&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Increase Cost of Working FAP % cannot be more than 100%")) ? "Increase Cost of Working FAP % cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CLOSS".toUpperCase() + "__" + "ICOW_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CLOSS".toUpperCase() + "_" + "ICOW_FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
...
function onValidate_CLOSS__ICOW_MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "ICOW_MIN_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "CLOSS.IS_ICOW= 1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=ICOW_MIN_AMOUNT&name={name}");
...
function onValidate_CLOSS__POST_TOTAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "POST_TOTAL", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLOSS", "POST_TOTAL");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLOSS&propertyName=POST_TOTAL&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLOSS", "POST_TOTAL");
...
function onValidate_CLOSS__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("CLOSS", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CLOSS.TOT_PREM");
        			window.setControlWidth(field, "0.4", "CLOSS", "TOT_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLOSS_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLOSS__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLOSS__TOT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CLOSS__CENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CENDPREM", "ChildScreen");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CLOSS", "CENDPREM");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_CLOSS__CENDPREM table td a");
        				
        		} else {
        		   links = goog.dom.query("a", field.getElement());
        		}		
                var exp = new Expression("GENERAL.CHECK_MBRKCode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')");
...
function onValidate_CLOSS__CL_COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CL_COUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CLOSS", "CL_COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_CLOSS__CNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CLOSS", "CNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_CLOSS__CNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CLOSS", "CNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CLOSS' and property 'CNOTES'.");
        			error.display();
...
function onValidate_CLOSS__CSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CSNOTES", "ChildScreen");
        })();
        /**
         * @fileoverview
         * DisableAddWhen, used only on child screen objects.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CLOSS", "CSNOTES");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_CLOSS__CSNOTES table td a");
...
function onValidate_CLOSS__CL_NTS_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CL_NTS_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CLOSS", "CL_NTS_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CLOSS__FLAT_PREMIUM(null, null, null, isOnLoad);
    onValidate_CLOSS__TOTAL_PREM(null, null, null, isOnLoad);
    onValidate_CLOSS__CL_TOTSUMIN(null, null, null, isOnLoad);
    onValidate_CLOSS__CL_TOTPREM(null, null, null, isOnLoad);
    onValidate_CLOSS__CL_TOTENDPREM(null, null, null, isOnLoad);
    ...
    onValidate_CLOSS__POSTPREMIUM(null, null, null, isOnLoad);
    ...
    onValidate_CLOSS__ACPC_POST_PREMIUM(null, null, null, isOnLoad);
    ...
    onValidate_CLOSS__AICOW_POST_PREMIUM(null, null, null, isOnLoad);
    ...
    onValidate_CLOSS__ICOW_POST_PREMIUM(null, null, null, isOnLoad);
    onValidate_CLOSS__ICOW_FAP(null, null, null, isOnLoad);
    onValidate_CLOSS__ICOW_MIN_AMOUNT(null, null, null, isOnLoad);
    onValidate_CLOSS__POST_TOTAL(null, null, null, isOnLoad);
    onValidate_CLOSS__TOT_PREM(null, null, null, isOnLoad);
    onValidate_CLOSS__CENDPREM(null, null, null, isOnLoad);
    onValidate_CLOSS__CL_COUNT(null, null, null, isOnLoad);
    onValidate_CLOSS__CNOTES(null, null, null, isOnLoad);
    onValidate_CLOSS__CSNOTES(null, null, null, isOnLoad);
    onValidate_CLOSS__CL_NTS_CNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id07debd409cdb44e191d2010ae257c7b4" class="general-layout-container">
...
<div id="ida0db09e939b64548a0c6b4dc2f1f4581" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading256" runat="server" Text="" /></legend>
...
<!-- /Date -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCLOSS_FLAT_PREMIUM" for="ctl00_cntMainBody_CLOSS__FLAT_PREMIUM" class="col-md-4 col-sm-3 control-label">
		Flat Premium</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CLOSS-FLAT_PREMIUM">	
		
		<asp:TextBox ID="CLOSS__FLAT_PREMIUM" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCLOSS_FLAT_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Flat Premium"
			ClientValidationFunction="onValidate_CLOSS__FLAT_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-TOTAL_PREM">
		<asp:Label ID="lblCLOSS_TOTAL_PREM" runat="server" AssociatedControlID="CLOSS__TOTAL_PREM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__TOTAL_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_TOTAL_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_CLOSS__TOTAL_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida0db09e939b64548a0c6b4dc2f1f4581 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida0db09e939b64548a0c6b4dc2f1f4581 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida0db09e939b64548a0c6b4dc2f1f4581 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida0db09e939b64548a0c6b4dc2f1f4581 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida0db09e939b64548a0c6b4dc2f1f4581 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida0db09e939b64548a0c6b4dc2f1f4581 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida0db09e939b64548a0c6b4dc2f1f4581 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida0db09e939b64548a0c6b4dc2f1f4581 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida0db09e939b64548a0c6b4dc2f1f4581 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida0db09e939b64548a0c6b4dc2f1f4581 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id160a594f9e9c4c5db29768b73e81bf51" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading257" runat="server" Text="Consequential Loss " /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-CL_TOTSUMIN">
		<asp:Label ID="lblCLOSS_CL_TOTSUMIN" runat="server" AssociatedControlID="CLOSS__CL_TOTSUMIN" 
			Text="Total Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__CL_TOTSUMIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_CL_TOTSUMIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Sum Insured"
			ClientValidationFunction="onValidate_CLOSS__CL_TOTSUMIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-CL_TOTPREM">
		<asp:Label ID="lblCLOSS_CL_TOTPREM" runat="server" AssociatedControlID="CLOSS__CL_TOTPREM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__CL_TOTPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_CL_TOTPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_CLOSS__CL_TOTPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-CL_TOTENDPREM">
		<asp:Label ID="lblCLOSS_CL_TOTENDPREM" runat="server" AssociatedControlID="CLOSS__CL_TOTENDPREM" 
			Text="Total Endosement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__CL_TOTENDPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_CL_TOTENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endosement Premium"
			ClientValidationFunction="onValidate_CLOSS__CL_TOTENDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id160a594f9e9c4c5db29768b73e81bf51 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id160a594f9e9c4c5db29768b73e81bf51 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id160a594f9e9c4c5db29768b73e81bf51 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id160a594f9e9c4c5db29768b73e81bf51 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id160a594f9e9c4c5db29768b73e81bf51 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id160a594f9e9c4c5db29768b73e81bf51 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id160a594f9e9c4c5db29768b73e81bf51 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id160a594f9e9c4c5db29768b73e81bf51 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id160a594f9e9c4c5db29768b73e81bf51 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id160a594f9e9c4c5db29768b73e81bf51 input{text-align:left;}"; break;
		}
	}
...
<div id="frmCL" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading258" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLOSS_TYPE" runat="server" AssociatedControlID="CLOSS__TYPE" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CLOSS__TYPE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_MBCL_CLT" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CLOSS__TYPE(null, null, this);" data-type="List" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCLOSS_IND_PER_UNIT" runat="server" AssociatedControlID="CLOSS__IND_PER_UNIT" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CLOSS__IND_PER_UNIT" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_MBCL_INDPER" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CLOSS__IND_PER_UNIT(null, null, this);" data-type="List" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-POSTPREMIUM">
		<asp:Label ID="lblCLOSS_POSTPREMIUM" runat="server" AssociatedControlID="CLOSS__POSTPREMIUM" 
			Text="Posting Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__POSTPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_POSTPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Posting Premium"
			ClientValidationFunction="onValidate_CLOSS__POSTPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div id="frmCLEXT" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading259" runat="server" Text="Extensions" /></legend>
				...
				<div data-column-count="7" data-column-ratio="4:20:16:14:16:14:16" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:4%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label632">
		<span class="label" id="label632"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:20%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label633">
		<span class="label" id="label633"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label634">
		<span class="label" id="label634">Limit of Indemnity</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:14%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label635">
		<span class="label" id="label635">Rate</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label636">
		<span class="label" id="label636">Posting Premium </span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:14%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label637">
		<span class="label" id="label637">FAP %</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label638">
		<span class="label" id="label638">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
									...
									<li class="co-cell"  style="width:20%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label639">
		<span class="label" id="label639">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-ACPC_POST_PREMIUM">
		<asp:Label ID="lblCLOSS_ACPC_POST_PREMIUM" runat="server" AssociatedControlID="CLOSS__ACPC_POST_PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__ACPC_POST_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_ACPC_POST_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CLOSS.ACPC_POST_PREMIUM"
			ClientValidationFunction="onValidate_CLOSS__ACPC_POST_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:14%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label640">
		<span class="label" id="label640"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label641">
		<span class="label" id="label641"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
									...
									<li class="co-cell"  style="width:20%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label642">
		<span class="label" id="label642">Additional Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CLOSS" 
		data-property-name="AICOW_POST_PREMIUM" 
		id="pb-container-currency-CLOSS-AICOW_POST_PREMIUM">
		<asp:Label ID="lblCLOSS_AICOW_POST_PREMIUM" runat="server" AssociatedControlID="CLOSS__AICOW_POST_PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__AICOW_POST_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_AICOW_POST_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CLOSS.AICOW_POST_PREMIUM"
			ClientValidationFunction="onValidate_CLOSS__AICOW_POST_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
									...
									<li class="co-cell"  style="width:20%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label643">
		<span class="label" id="label643">Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-ICOW_POST_PREMIUM">
		<asp:Label ID="lblCLOSS_ICOW_POST_PREMIUM" runat="server" AssociatedControlID="CLOSS__ICOW_POST_PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__ICOW_POST_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_ICOW_POST_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CLOSS.ICOW_POST_PREMIUM"
			ClientValidationFunction="onValidate_CLOSS__ICOW_POST_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:4%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label644">
		<span class="label" id="label644"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:20%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label645">
		<span class="label" id="label645">Total</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label646">
		<span class="label" id="label646"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:14%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label647">
		<span class="label" id="label647"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-POST_TOTAL">
		<asp:Label ID="lblCLOSS_POST_TOTAL" runat="server" AssociatedControlID="CLOSS__POST_TOTAL" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__POST_TOTAL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_POST_TOTAL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CLOSS.POST_TOTAL"
			ClientValidationFunction="onValidate_CLOSS__POST_TOTAL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:14%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label648">
		<span class="label" id="label648"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label649">
		<span class="label" id="label649"></span>
	</span>
<!-- /Label -->
...
<div id="frmCLEnd" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading260" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblCLOSS_CLOSS_CLAUSES" runat="server" AssociatedControlID="CLOSS__CLOSS_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="CLOSS__CLOSS_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLOSS-TOT_PREM">
		<asp:Label ID="lblCLOSS_TOT_PREM" runat="server" AssociatedControlID="CLOSS__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLOSS__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLOSS_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_CLOSS__TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CENDPREM"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CENDPREM" 
		id="pb-container-childscreen-CLOSS-CENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_CLAUSEPREM" runat="server" ScreenCode="CENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CENDPREM/CENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCLOSS_CENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CENDPREM"
						ClientValidationFunction="onValidate_CLOSS__CENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-CLOSS-CL_COUNT">
		<asp:Label ID="lblCLOSS_CL_COUNT" runat="server" AssociatedControlID="CLOSS__CL_COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CLOSS__CL_COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCLOSS_CL_COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CLOSS.CL_COUNT"
			ClientValidationFunction="onValidate_CLOSS__CL_COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmCNOTES" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading261" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CNOTES"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CNOTES" 
		id="pb-container-childscreen-CLOSS-CNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_NOTES" runat="server" ScreenCode="CNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CNOTES/CNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCLOSS_CNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CNOTES"
						ClientValidationFunction="onValidate_CLOSS__CNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmCNOTES div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmCNOTES div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmCNOTES div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmCNOTES label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmCNOTES label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmCNOTES label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmCNOTES label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmCNOTES input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmCNOTES input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmCNOTES input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmCSNOTES" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading262" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CSNOTES"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CSNOTES" 
		id="pb-container-childscreen-CLOSS-CSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_SNOTES" runat="server" ScreenCode="CSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CSNOTES/CSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCLOSS_CSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CSNOTES"
						ClientValidationFunction="onValidate_CLOSS__CSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-CLOSS-CL_NTS_CNT">
		<asp:Label ID="lblCLOSS_CL_NTS_CNT" runat="server" AssociatedControlID="CLOSS__CL_NTS_CNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CLOSS__CL_NTS_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCLOSS_CL_NTS_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CLOSS.CL_NTS_CNT"
			ClientValidationFunction="onValidate_CLOSS__CL_NTS_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmCSNOTES div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmCSNOTES div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmCSNOTES div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmCSNOTES label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmCSNOTES label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmCSNOTES label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmCSNOTES label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmCSNOTES input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmCSNOTES input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmCSNOTES input{text-align:left;}"; break;
		}
	}
