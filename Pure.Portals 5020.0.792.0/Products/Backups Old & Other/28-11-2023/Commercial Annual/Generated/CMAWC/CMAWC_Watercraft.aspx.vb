...
Namespace Nexus
    Partial Class PB2_CMAWC_Watercraft : Inherits BaseRisk
...
End Sub
Protected Sub onValidate_WC_GENERAL__RISKATTACHDATE()
        
End Sub
Protected Sub onValidate_WC_GENERAL__EFFECTIVEDATE()
...
End Sub
Protected Sub onValidate_WC_GENERAL__PRIMARY_INDUSTRY()
...
End Sub
Protected Sub onValidate_WC_VESSELS__INCEP_DATE()
...
Protected Sub CallRuleScripts()
    ...
    onValidate_WC_GENERAL__RISKATTACHDATE()
    onValidate_WC_GENERAL__EFFECTIVEDATE()
    onValidate_ADDRESS__TOWN()
    onValidate_ADDRESS__COUNTRY()
    onValidate_WC_GENERAL__PRIMARY_INDUSTRY()
    onValidate_WC_VESSELS__INCEP_DATE()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If WC_GENERAL__RISKATTACHDATE.Text = "" or WC_GENERAL__RISKATTACHDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			WC_GENERAL__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			WC_GENERAL__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (WC_GENERAL__RISKATTACHDATE.Text <> "" Or WC_GENERAL__RISKATTACHDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		WC_GENERAL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		WC_GENERAL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		WC_GENERAL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
        		...
        		If PrimaryKey <> "" Then
        			If Not String.IsNullOrEmpty(PrimaryKey) Then
        				If ListIndOne.FindItemByKey(PrimaryKey).ToString() IsNot Nothing Then
        					If WC_GENERAL__PRIMARY_INDUSTRY.Value Is Nothing Then
        						WC_GENERAL__PRIMARY_INDUSTRY.Value = PrimaryKey
        					End If
        				End If
        			End If
        			
        			If Not String.IsNullOrEmpty(SecondaryKey) Then
        				If ListIndTwo.FindItemByKey(SecondaryKey).ToString() IsNot Nothing Then
        					If WC_GENERAL__SECOND_INDUSTRY.Value Is Nothing Then
        						WC_GENERAL__SECOND_INDUSTRY.Value = SecondaryKey
        					End If
        				End If
        			End If
        			
        			If Not String.IsNullOrEmpty(TertiaryKey) Then
        				If ListIndThree.FindItemByKey(TertiaryKey).ToString() IsNot Nothing Then
        					If WC_GENERAL__TERTIARY_INDUSTRY.Value Is Nothing Then
        						WC_GENERAL__TERTIARY_INDUSTRY.Value = TertiaryKey
        					End If
        				End If
        			End If
        			
        			If Not String.IsNullOrEmpty(IndustryKey) Then
        				If ListInd.FindItemByKey(IndustryKey).ToString() IsNot Nothing Then
        					If WC_GENERAL__INDUSTRY.Value Is Nothing Then
        						WC_GENERAL__INDUSTRY.Value = IndustryKey
        					End If
        				End If
        			End If
        ...
        Protected Shadows Sub LoadCoverStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If isTrueMonthly Then
        		WC_VESSELS__INCEP_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	Else
        		WC_VESSELS__INCEP_DATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
        	
        	'WC_VESSELS__ENDDATE.Text = RTrim(LTrim(oQuote.CoverEndDate))
