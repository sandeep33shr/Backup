<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAWC_Watercraft.aspx.vb" Inherits="Nexus.PB2_CMAWC_Watercraft" %>
...
function onValidate_GENERAL__IS_WCRAFT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_WCRAFT", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_WCRAFT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.IS_WCRAFT");
        			window.setControlWidth(field, "0.4", "GENERAL", "IS_WCRAFT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_WCRAFT");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_WCRAFT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_WCRAFT_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "IS_WCRAFT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "IS_WCRAFT");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("GENERAL.TRANSTYPE =='MTA' && GENERAL.IS_WCRAFTCode=='DELETE'");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__INS_FILE_CNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.TRANSTYPE =='MTA' &&(GENERAL.IS_WCRAFTCode=='ADD' || GENERAL.IS_WCRAFTCode =='VIEW')) || ( GENERAL.TRANSTYPE =='NB' || GENERAL.TRANSTYPE == 'REN' || GENERAL.TRANSTYPE == 'MTC')");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CMAWCMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CMAWCMTA", "ChildScreen");
        })();
}
function onValidate_WC_GENERAL__RISKATTACHDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "RISKATTACHDATE", "Date");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("WC_GENERAL", "RISKATTACHDATE");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.RISKATTACHDATE");
        			window.setControlWidth(field, "0.3", "WC_GENERAL", "RISKATTACHDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_RISKATTACHDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__RISKATTACHDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__RISKATTACHDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "RISKATTACHDATE");
        		}
...
function onValidate_WC_GENERAL__EFFECTIVEDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "EFFECTIVEDATE", "Date");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("WC_GENERAL", "EFFECTIVEDATE");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.3", "WC_GENERAL", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_WC_GENERAL__IS_VAT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "IS_VAT", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "IS_VAT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.IS_VAT");
        			window.setControlWidth(field, "0.2", "WC_GENERAL", "IS_VAT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_IS_VAT");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__IS_VAT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__IS_VAT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("WC_GENERAL", "IS_VAT");
        		var exp = new Expression("GENERAL.IS_WCRAFTCode == 'VIEW' && (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')");
...
function onValidate_WC_GENERAL__FLAT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "FLAT_PREM", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "FLAT_PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.FLAT_PREM");
        			window.setControlWidth(field, "0.3", "WC_GENERAL", "FLAT_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_FLAT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__FLAT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__FLAT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_GENERAL__TOTAL_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "TOTAL_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=WC_GENERAL&propertyName=TOTAL_PREM&name={name}");
        		
        		var value = new Expression("WC_VESSELS.POST_PREM + WC_REFERRAL_CLAUSES.TOT_PREM"), 
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.TOTAL_PREM");
        			window.setControlWidth(field, "0.3", "WC_GENERAL", "TOTAL_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_TOTAL_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__TOTAL_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__TOTAL_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "TOTAL_PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_WC_GENERAL__PRIMARY_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "PRIMARY_INDUSTRY", "RateList");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.PRIMARY_INDUSTRY");
        			window.setControlWidth(field, "0.9", "WC_GENERAL", "PRIMARY_INDUSTRY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_PRIMARY_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__PRIMARY_INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__PRIMARY_INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "PRIMARY_INDUSTRY");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_WC_GENERAL__SECOND_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "SECOND_INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "SECOND_INDUSTRY");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.SECOND_INDUSTRY");
        			window.setControlWidth(field, "0.9", "WC_GENERAL", "SECOND_INDUSTRY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_SECOND_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__SECOND_INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__SECOND_INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_GENERAL__TERTIARY_INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "TERTIARY_INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "TERTIARY_INDUSTRY");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.TERTIARY_INDUSTRY");
        			window.setControlWidth(field, "0.9", "WC_GENERAL", "TERTIARY_INDUSTRY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_TERTIARY_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__TERTIARY_INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__TERTIARY_INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_GENERAL__INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_GENERAL", "INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_GENERAL", "INDUSTRY");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_GENERAL.INDUSTRY");
        			window.setControlWidth(field, "0.9", "WC_GENERAL", "INDUSTRY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_GENERAL_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_GENERAL__INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_GENERAL__INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_VESSELS__NVESSEL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "NVESSEL", "Text");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("WC_VESSELS", "NVESSEL");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.NVESSEL");
        			window.setControlWidth(field, "0.7", "WC_VESSELS", "NVESSEL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_NVESSEL");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__NVESSEL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__NVESSEL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_VESSELS__VRAFT_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "VRAFT_TYPE", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("WC_VESSELS", "VRAFT_TYPE");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.VRAFT_TYPE");
        			window.setControlWidth(field, "0.3", "WC_VESSELS", "VRAFT_TYPE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_VRAFT_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__VRAFT_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__VRAFT_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_VESSELS__TVMOTOR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "TVMOTOR", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "TVMOTOR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.TVMOTOR");
        			window.setControlWidth(field, "0.3", "WC_VESSELS", "TVMOTOR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_TVMOTOR");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__TVMOTOR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__TVMOTOR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_VESSELS__TYPE_USE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "TYPE_USE", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "TYPE_USE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.TYPE_USE");
        			window.setControlWidth(field, "0.3", "WC_VESSELS", "TYPE_USE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_TYPE_USE");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__TYPE_USE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__TYPE_USE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_VESSELS__VUSE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "VUSE", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "VUSE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.VUSE");
        			window.setControlWidth(field, "0.3", "WC_VESSELS", "VUSE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_VUSE");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__VUSE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__VUSE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_WC_VESSELS__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("WC_VESSELS", "SUMINSURED");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.SUMINSURED");
        			window.setControlWidth(field, "0.8", "WC_VESSELS", "SUMINSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("WC_VESSELS.POST_PREM.setValue(WC_VESSELS.SUMINSURED*WC_VESSELS.RATE/100)");
        		var whenExp = (Expression.isValidParameter("WC_VESSELS.SUMINSURED <> '' AND WC_VESSELS.SUMINSURED <> null and WC_VESSELS.RATE <> '' AND WC_VESSELS.RATE <> null")) ? new Expression("WC_VESSELS.SUMINSURED <> '' AND WC_VESSELS.SUMINSURED <> null and WC_VESSELS.RATE <> '' AND WC_VESSELS.RATE <> null") : null;
...
function onValidate_WC_VESSELS__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "RATE");
        		}
        		//window.setProperty(field, "V", "WC_GENERAL.FLAT_PREM == 0", "VE", "{3}");
        
            var paramValue = "V",
            paramCondition = "WC_GENERAL.FLAT_PREM == 0",
            paramElseValue = "VE",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.RATE");
        			window.setControlWidth(field, "0.8", "WC_VESSELS", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "WC_VESSELS".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "WC_VESSELS".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("WC_VESSELS.RATE > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_WC_VESSELS__PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.PREM");
        			window.setControlWidth(field, "0.8", "WC_VESSELS", "PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=WC_VESSELS&propertyName=PREM&name={name}");
        		
        		var value = new Expression("WC_VESSELS.POST_PREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_WC_VESSELS__POST_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "POST_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("WC_VESSELS", "POST_PREM");
        		var errorMessage = "Posting Premium is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.POST_PREM");
        			window.setControlWidth(field, "0.8", "WC_VESSELS", "POST_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_POST_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__POST_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__POST_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("WC_GENERAL.FLAT_PREM == 1 ")) ? new Expression("WC_GENERAL.FLAT_PREM == 1 ") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("WC_VESSELS.RATE.setValue(WC_VESSELS.POST_PREM/WC_VESSELS.SUMINSURED *100)");
        		var whenExp = (Expression.isValidParameter("WC_VESSELS.SUMINSURED <> '' AND WC_VESSELS.SUMINSURED <> null and WC_VESSELS.RATE <> '' AND WC_VESSELS.RATE <> null")) ? new Expression("WC_VESSELS.SUMINSURED <> '' AND WC_VESSELS.SUMINSURED <> null and WC_VESSELS.RATE <> '' AND WC_VESSELS.RATE <> null") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_WC_VESSELS__FAP_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "FAP_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "FAP_PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.FAP_PERC");
        			window.setControlWidth(field, "0.8", "WC_VESSELS", "FAP_PERC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_FAP_PERC");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__FAP_PERC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__FAP_PERC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "WC_VESSELS".toUpperCase() + "__" + "FAP_PERC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "WC_VESSELS".toUpperCase() + "_" + "FAP_PERC");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("WC_VESSELS.FAP_PERC > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=WC_VESSELS&propertyName=FAP_PERC&name={name}");
        		
        		var value = new Expression("WC_VESSELS.FAP_PERC"), 
        			condition = (Expression.isValidParameter("WC_VESSELS.FAP_PERC > GENERAL.WC_FAP")) ? new Expression("WC_VESSELS.FAP_PERC > GENERAL.WC_FAP") : null, 
        			elseValue = (Expression.isValidParameter("GENERAL.WC_FAP")) ? new Expression("GENERAL.WC_FAP") : null;
...
function onValidate_WC_VESSELS__MIN_AMNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "MIN_AMNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "MIN_AMNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.MIN_AMNT");
        			window.setControlWidth(field, "0.8", "WC_VESSELS", "MIN_AMNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_MIN_AMNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__MIN_AMNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__MIN_AMNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=WC_VESSELS&propertyName=MIN_AMNT&name={name}");
        		
        		var value = new Expression("WC_VESSELS.MIN_AMNT"), 
        			condition = (Expression.isValidParameter("WC_VESSELS.MIN_AMNT > GENERAL.WC_MIN_AMT")) ? new Expression("WC_VESSELS.MIN_AMNT > GENERAL.WC_MIN_AMT") : null, 
        			elseValue = (Expression.isValidParameter("GENERAL.WC_MIN_AMT")) ? new Expression("GENERAL.WC_MIN_AMT") : null;
...
function onValidate_WC_VESSELS__IS_NASRIA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "IS_NASRIA", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "IS_NASRIA");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("WC_VESSELS", "IS_NASRIA");
        		var exp = new Expression("GENERAL.IS_WCRAFTCode == 'VIEW' && (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')");
...
function onValidate_WC_VESSELS__NASRIA_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "NASRIA_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "NASRIA_LIMIT");
        		}
        		//window.setProperty(field, "VEM", "WC_VESSELS.IS_NASRIA == 1 ", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "WC_VESSELS.IS_NASRIA == 1 ",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.NASRIA_LIMIT");
        			window.setControlWidth(field, "0.4", "WC_VESSELS", "NASRIA_LIMIT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_NASRIA_LIMIT");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__NASRIA_LIMIT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__NASRIA_LIMIT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("WC_VESSELS.IS_NASRIA == 1 ")) ? new Expression("WC_VESSELS.IS_NASRIA == 1 ") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=WC_VESSELS&propertyName=NASRIA_LIMIT&name={name}");
        		
        		var value = new Expression("WC_VESSELS.NASRIA_LIMIT"), 
        			condition = (Expression.isValidParameter("WC_VESSELS.IS_NASRIA= 1")) ? new Expression("WC_VESSELS.IS_NASRIA= 1") : null, 
...
function onValidate_WC_VESSELS__INTPARTY_NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "INTPARTY_NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "INTPARTY_NAME");
        		}
        		//window.setProperty(field, "VEM", "WC_VESSELS.INTPARTY_DATE != null", "VE", "Interest Party name is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "WC_VESSELS.INTPARTY_DATE != null",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.INTPARTY_NAME");
        			window.setControlWidth(field, "0.8", "WC_VESSELS", "INTPARTY_NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_INTPARTY_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__INTPARTY_NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__INTPARTY_NAME_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("WC_VESSELS.INTPARTY_DATE != null")) ? new Expression("WC_VESSELS.INTPARTY_DATE != null") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
...
function onValidate_WC_VESSELS__INTPARTY_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "INTPARTY_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "INTPARTY_DATE");
        		}
        		//window.setProperty(field, "VEM", "WC_VESSELS.INTPARTY_NAME != ''", "VE", "Enter interest party date");
        
            var paramValue = "VEM",
            paramCondition = "WC_VESSELS.INTPARTY_NAME != ''",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_VESSELS.INTPARTY_DATE");
        			window.setControlWidth(field, "0.3", "WC_VESSELS", "INTPARTY_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_VESSELS_INTPARTY_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_VESSELS__INTPARTY_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_VESSELS__INTPARTY_DATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("WC_VESSELS.INTPARTY_NAME  != null")) ? new Expression("WC_VESSELS.INTPARTY_NAME  != null") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Interest Party Date cannot be less than the Original Inception date of the policy")) ? "Interest Party Date cannot be less than the Original Inception date of the policy" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "WC_VESSELS".toUpperCase() + "__" + "INTPARTY_DATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "WC_VESSELS".toUpperCase() + "_" + "INTPARTY_DATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("WC_VESSELS.INCEP_DATE > WC_VESSELS.INTPARTY_DATE AND WC_VESSELS.INTPARTY_DATE != null ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_WC_VESSELS__INCEP_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_VESSELS", "INCEP_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WC_VESSELS", "INCEP_DATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("WC_VESSELS", "INCEP_DATE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_WC_REFERRAL_CLAUSES__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_REFERRAL_CLAUSES", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("WC_REFERRAL_CLAUSES", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WC_REFERRAL_CLAUSES.TOT_PREM");
        			window.setControlWidth(field, "0.2", "WC_REFERRAL_CLAUSES", "TOT_PREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblWC_REFERRAL_CLAUSES_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_WC_REFERRAL_CLAUSES__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_WC_REFERRAL_CLAUSES__TOT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
          ...
          * @param WC_REFERRAL_CLAUSES The Parent (Root) object name.
          * @param WC_CLAUSEPREM.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "WC_REFERRAL_CLAUSES".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "WC_CLAUSEPREM.PREMIUM";
...
function onValidate_WC_REFERRAL_CLAUSES__WCENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_REFERRAL_CLAUSES", "WCENDPREM", "ChildScreen");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("WC_REFERRAL_CLAUSES", "WCENDPREM");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_WC_REFERRAL_CLAUSES__WCENDPREM table td a");
...
function onValidate_WC_NOTES__WCNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_NOTES", "WCNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("WC_NOTES", "WCNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_WC_NOTES__WCNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("WC_NOTES", "WCNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'WC_NOTES' and property 'WCNOTES'.");
        			error.display();
...
function onValidate_WC_NOTES__WCSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WC_NOTES", "WCSNOTES", "ChildScreen");
        })();
        /**
         * @fileoverview
         * DisableAddWhen, used only on child screen objects.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("WC_NOTES", "WCSNOTES");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_WC_NOTES__WCSNOTES table td a");
...
function onValidate_GENERAL__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Watercraft - ' + WC_VESSELS.NVESSEL + ' - ' + ADDRESS.LINE1"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__WC_FAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "WC_FAP", "Percentage");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "WC_FAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__WC_MIN_AMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "WC_MIN_AMT", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "WC_MIN_AMT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_GENERAL__IS_WCRAFT(null, null, null, isOnLoad);
    onValidate_GENERAL__INS_FILE_CNT(null, null, null, isOnLoad);
    onValidate_GENERAL__CMAWCMTA(null, null, null, isOnLoad);
    onValidate_WC_GENERAL__RISKATTACHDATE(null, null, null, isOnLoad);
    onValidate_WC_GENERAL__EFFECTIVEDATE(null, null, null, isOnLoad);
    onValidate_WC_GENERAL__IS_VAT(null, null, null, isOnLoad);
    onValidate_WC_GENERAL__FLAT_PREM(null, null, null, isOnLoad);
    onValidate_WC_GENERAL__TOTAL_PREM(null, null, null, isOnLoad);
    ...
    onValidate_WC_GENERAL__PRIMARY_INDUSTRY(null, null, null, isOnLoad);
    onValidate_WC_GENERAL__SECOND_INDUSTRY(null, null, null, isOnLoad);
    onValidate_WC_GENERAL__TERTIARY_INDUSTRY(null, null, null, isOnLoad);
    onValidate_WC_GENERAL__INDUSTRY(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__NVESSEL(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__VRAFT_TYPE(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__TVMOTOR(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__TYPE_USE(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__VUSE(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__SUMINSURED(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__RATE(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__PREM(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__POST_PREM(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__FAP_PERC(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__MIN_AMNT(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__IS_NASRIA(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__NASRIA_LIMIT(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__INTPARTY_NAME(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__INTPARTY_DATE(null, null, null, isOnLoad);
    onValidate_WC_VESSELS__INCEP_DATE(null, null, null, isOnLoad);
    onValidate_WC_REFERRAL_CLAUSES__TOT_PREM(null, null, null, isOnLoad);
    onValidate_WC_REFERRAL_CLAUSES__WCENDPREM(null, null, null, isOnLoad);
    onValidate_WC_NOTES__WCNOTES(null, null, null, isOnLoad);
    onValidate_WC_NOTES__WCSNOTES(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__WC_FAP(null, null, null, isOnLoad);
    onValidate_GENERAL__WC_MIN_AMT(null, null, null, isOnLoad);
...
<div id="id0f1e421adeac4c62b9bccf98298fe78f" class="general-layout-container">
...
<div id="frmMTAReason" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Mid-Term Adjustment Reason" /></legend>
...
<div id="frmMTAReason" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="MTA Affected Covers" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-property-name="IS_WCRAFT" 
		id="pb-container-list-GENERAL-IS_WCRAFT">
		
			  

					
		<asp:Label ID="lblGENERAL_IS_WCRAFT" runat="server" AssociatedControlID="GENERAL__IS_WCRAFT" 
			Text="MTA Action" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="GENERAL__IS_WCRAFT" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_ACTION_ITEMS" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_GENERAL__IS_WCRAFT(null, null, this);" data-type="List" AutoPostBack="true"  />
			<asp:CustomValidator ID="valGENERAL_IS_WCRAFT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MTA Action"
			ClientValidationFunction="onValidate_GENERAL__IS_WCRAFT" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GENERAL" 
		data-property-name="IS_WCRAFTCode" 
		id="pb-container-Text-GENERAL-IS_WCRAFTCode">
		
		
		<asp:Label ID="lblGENERAL_IS_WCRAFTCode" runat="server" AssociatedControlID="GENERAL__IS_WCRAFTCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__IS_WCRAFTCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGENERAL_IS_WCRAFTCode" 
			runat="server" 
			Text="*" 
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CMAWCMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CMAWCMTA" 
		id="pb-container-childscreen-GENERAL-CMAWCMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CMAWCMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAWCMTA/CMAWCMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CMAWCMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CMAWCMTA"
						ClientValidationFunction="onValidate_GENERAL__CMAWCMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id11f7be2ea9404c7fa15f957c8edaade8" class="column-layout-container  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="WC_GENERAL" 
		data-property-name="RISKATTACHDATE" 
		id="pb-container-datejquerycompatible-WC_GENERAL-RISKATTACHDATE">
		<asp:Label ID="lblWC_GENERAL_RISKATTACHDATE" runat="server" AssociatedControlID="WC_GENERAL__RISKATTACHDATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="WC_GENERAL__RISKATTACHDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calWC_GENERAL__RISKATTACHDATE" runat="server" LinkedControl="WC_GENERAL__RISKATTACHDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valWC_GENERAL_RISKATTACHDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_WC_GENERAL__RISKATTACHDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-WC_GENERAL-EFFECTIVEDATE">
		<asp:Label ID="lblWC_GENERAL_EFFECTIVEDATE" runat="server" AssociatedControlID="WC_GENERAL__EFFECTIVEDATE" 
			Text="Effective Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="WC_GENERAL__EFFECTIVEDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calWC_GENERAL__EFFECTIVEDATE" runat="server" LinkedControl="WC_GENERAL__EFFECTIVEDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valWC_GENERAL_EFFECTIVEDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective Date"
			ClientValidationFunction="onValidate_WC_GENERAL__EFFECTIVEDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_GENERAL-IS_VAT">
		
					
		<asp:Label ID="lblWC_GENERAL_IS_VAT" runat="server" AssociatedControlID="WC_GENERAL__IS_VAT" 
			Text="VAT" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_GENERAL__IS_VAT" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_VAT" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_GENERAL__IS_VAT(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_GENERAL_IS_VAT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for VAT"
			ClientValidationFunction="onValidate_WC_GENERAL__IS_VAT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /List -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblWC_GENERAL_FLAT_PREM" for="ctl00_cntMainBody_WC_GENERAL__FLAT_PREM" class="col-md-4 col-sm-3 control-label">
		Flat Premium</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-WC_GENERAL-FLAT_PREM">	
		
		<asp:TextBox ID="WC_GENERAL__FLAT_PREM" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valWC_GENERAL_FLAT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Flat Premium"
			ClientValidationFunction="onValidate_WC_GENERAL__FLAT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-WC_GENERAL-TOTAL_PREM">
		<asp:Label ID="lblWC_GENERAL_TOTAL_PREM" runat="server" AssociatedControlID="WC_GENERAL__TOTAL_PREM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_GENERAL__TOTAL_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_GENERAL_TOTAL_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_WC_GENERAL__TOTAL_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-WC_GENERAL-IS_VATCode">
		
		
		<asp:Label ID="lblWC_GENERAL_IS_VATCode" runat="server" AssociatedControlID="WC_GENERAL__IS_VATCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_GENERAL__IS_VATCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_GENERAL_IS_VATCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id11f7be2ea9404c7fa15f957c8edaade8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id11f7be2ea9404c7fa15f957c8edaade8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id11f7be2ea9404c7fa15f957c8edaade8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id11f7be2ea9404c7fa15f957c8edaade8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id11f7be2ea9404c7fa15f957c8edaade8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id11f7be2ea9404c7fa15f957c8edaade8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id11f7be2ea9404c7fa15f957c8edaade8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id11f7be2ea9404c7fa15f957c8edaade8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id11f7be2ea9404c7fa15f957c8edaade8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id11f7be2ea9404c7fa15f957c8edaade8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0efdefb47e43440197f403431f83dd5b" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_LINE1" runat="server" AssociatedControlID="ADDRESS__LINE1" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__LINE1" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_SUBURB" runat="server" AssociatedControlID="ADDRESS__SUBURB" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__SUBURB" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_TOWN" runat="server" AssociatedControlID="ADDRESS__TOWN" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__TOWN" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_POSTCODE" runat="server" AssociatedControlID="ADDRESS__POSTCODE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__POSTCODE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_REGION" runat="server" AssociatedControlID="ADDRESS__REGION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__REGION" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_AREACODE" runat="server" AssociatedControlID="ADDRESS__AREACODE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__AREACODE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_ADDRESSLISTCode" runat="server" AssociatedControlID="ADDRESS__ADDRESSLISTCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__ADDRESSLISTCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDRESS_ADDRESSLISTCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_SITEADDRESSLISTCode" runat="server" AssociatedControlID="ADDRESS__SITEADDRESSLISTCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__SITEADDRESSLISTCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDRESS_SITEADDRESSLISTCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_HOMEADDRESSLISTCode" runat="server" AssociatedControlID="ADDRESS__HOMEADDRESSLISTCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__HOMEADDRESSLISTCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDRESS_HOMEADDRESSLISTCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_B_ADDRESSLISTCode" runat="server" AssociatedControlID="ADDRESS__B_ADDRESSLISTCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__B_ADDRESSLISTCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDRESS_B_ADDRESSLISTCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblADDRESS_COUNTRYCode" runat="server" AssociatedControlID="ADDRESS__COUNTRYCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDRESS__COUNTRYCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDRESS_COUNTRYCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0efdefb47e43440197f403431f83dd5b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0efdefb47e43440197f403431f83dd5b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0efdefb47e43440197f403431f83dd5b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0efdefb47e43440197f403431f83dd5b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0efdefb47e43440197f403431f83dd5b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0efdefb47e43440197f403431f83dd5b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0efdefb47e43440197f403431f83dd5b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0efdefb47e43440197f403431f83dd5b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0efdefb47e43440197f403431f83dd5b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0efdefb47e43440197f403431f83dd5b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6ac3228dfbbd419ab8a7f4c76bdcb65f" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_GENERAL-PRIMARY_INDUSTRY">
		
					
		<asp:Label ID="lblWC_GENERAL_PRIMARY_INDUSTRY" runat="server" AssociatedControlID="WC_GENERAL__PRIMARY_INDUSTRY" 
			Text="Primary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_GENERAL__PRIMARY_INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDONE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_GENERAL__PRIMARY_INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_GENERAL_PRIMARY_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Primary Industry"
			ClientValidationFunction="onValidate_WC_GENERAL__PRIMARY_INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_GENERAL-SECOND_INDUSTRY">
		
					
		<asp:Label ID="lblWC_GENERAL_SECOND_INDUSTRY" runat="server" AssociatedControlID="WC_GENERAL__SECOND_INDUSTRY" 
			Text="Secondary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_GENERAL__SECOND_INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDTWO" ParentLookupListID="WC_GENERAL__PRIMARY_INDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_GENERAL__SECOND_INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_GENERAL_SECOND_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Secondary Industry"
			ClientValidationFunction="onValidate_WC_GENERAL__SECOND_INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_GENERAL-TERTIARY_INDUSTRY">
		
					
		<asp:Label ID="lblWC_GENERAL_TERTIARY_INDUSTRY" runat="server" AssociatedControlID="WC_GENERAL__TERTIARY_INDUSTRY" 
			Text="Tertiary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_GENERAL__TERTIARY_INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDTHR" ParentLookupListID="WC_GENERAL__SECOND_INDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_GENERAL__TERTIARY_INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_GENERAL_TERTIARY_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Tertiary Industry"
			ClientValidationFunction="onValidate_WC_GENERAL__TERTIARY_INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_GENERAL-INDUSTRY">
		
					
		<asp:Label ID="lblWC_GENERAL_INDUSTRY" runat="server" AssociatedControlID="WC_GENERAL__INDUSTRY" 
			Text="Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_GENERAL__INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDUST" ParentLookupListID="WC_GENERAL__TERTIARY_INDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_GENERAL__INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_GENERAL_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Industry"
			ClientValidationFunction="onValidate_WC_GENERAL__INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6ac3228dfbbd419ab8a7f4c76bdcb65f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6ac3228dfbbd419ab8a7f4c76bdcb65f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6ac3228dfbbd419ab8a7f4c76bdcb65f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6ac3228dfbbd419ab8a7f4c76bdcb65f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6ac3228dfbbd419ab8a7f4c76bdcb65f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6ac3228dfbbd419ab8a7f4c76bdcb65f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6ac3228dfbbd419ab8a7f4c76bdcb65f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6ac3228dfbbd419ab8a7f4c76bdcb65f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6ac3228dfbbd419ab8a7f4c76bdcb65f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6ac3228dfbbd419ab8a7f4c76bdcb65f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id38852109a1ca4e22a31fe3928bd13ec3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Vessel Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Text" 
		data-object-name="WC_VESSELS" 
		data-property-name="NVESSEL" 
		id="pb-container-Text-WC_VESSELS-NVESSEL">
		
		
		<asp:Label ID="lblWC_VESSELS_NVESSEL" runat="server" AssociatedControlID="WC_VESSELS__NVESSEL" 
			Text="Name of Vessel" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__NVESSEL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_NVESSEL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Name of Vessel"
			ClientValidationFunction="onValidate_WC_VESSELS__NVESSEL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_VESSELS-VRAFT_TYPE">
		
					
		<asp:Label ID="lblWC_VESSELS_VRAFT_TYPE" runat="server" AssociatedControlID="WC_VESSELS__VRAFT_TYPE" 
			Text="Craft Type " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_VESSELS__VRAFT_TYPE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_WC_CRAFT_TYPE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_VESSELS__VRAFT_TYPE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_VESSELS_VRAFT_TYPE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Craft Type "
			ClientValidationFunction="onValidate_WC_VESSELS__VRAFT_TYPE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_VESSELS-TVMOTOR">
		
					
		<asp:Label ID="lblWC_VESSELS_TVMOTOR" runat="server" AssociatedControlID="WC_VESSELS__TVMOTOR" 
			Text="Type of Motor " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_VESSELS__TVMOTOR" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_WC_TYPE_MOTOR" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_VESSELS__TVMOTOR(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_VESSELS_TVMOTOR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Type of Motor "
			ClientValidationFunction="onValidate_WC_VESSELS__TVMOTOR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_VESSELS-TYPE_USE">
		
					
		<asp:Label ID="lblWC_VESSELS_TYPE_USE" runat="server" AssociatedControlID="WC_VESSELS__TYPE_USE" 
			Text="Type of Use" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_VESSELS__TYPE_USE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_WC_TYPE_USE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_VESSELS__TYPE_USE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_VESSELS_TYPE_USE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Type of Use"
			ClientValidationFunction="onValidate_WC_VESSELS__TYPE_USE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-WC_VESSELS-VUSE">
		
					
		<asp:Label ID="lblWC_VESSELS_VUSE" runat="server" AssociatedControlID="WC_VESSELS__VUSE" 
			Text="Use" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="WC_VESSELS__VUSE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_WC_USE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_WC_VESSELS__VUSE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valWC_VESSELS_VUSE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Use"
			ClientValidationFunction="onValidate_WC_VESSELS__VUSE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Text" 
		data-object-name="WC_VESSELS" 
		data-property-name="VRAFT_TYPECode" 
		id="pb-container-Text-WC_VESSELS-VRAFT_TYPECode">
		
		
		<asp:Label ID="lblWC_VESSELS_VRAFT_TYPECode" runat="server" AssociatedControlID="WC_VESSELS__VRAFT_TYPECode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__VRAFT_TYPECode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_VRAFT_TYPECode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Text" 
		data-object-name="WC_VESSELS" 
		data-property-name="TVMOTORCode" 
		id="pb-container-Text-WC_VESSELS-TVMOTORCode">
		
		
		<asp:Label ID="lblWC_VESSELS_TVMOTORCode" runat="server" AssociatedControlID="WC_VESSELS__TVMOTORCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__TVMOTORCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_TVMOTORCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Text" 
		data-object-name="WC_VESSELS" 
		data-property-name="TYPE_USECode" 
		id="pb-container-Text-WC_VESSELS-TYPE_USECode">
		
		
		<asp:Label ID="lblWC_VESSELS_TYPE_USECode" runat="server" AssociatedControlID="WC_VESSELS__TYPE_USECode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__TYPE_USECode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_TYPE_USECode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Text" 
		data-object-name="WC_VESSELS" 
		data-property-name="VUSECode" 
		id="pb-container-Text-WC_VESSELS-VUSECode">
		
		
		<asp:Label ID="lblWC_VESSELS_VUSECode" runat="server" AssociatedControlID="WC_VESSELS__VUSECode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__VUSECode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_VUSECode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id38852109a1ca4e22a31fe3928bd13ec3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id38852109a1ca4e22a31fe3928bd13ec3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id38852109a1ca4e22a31fe3928bd13ec3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id38852109a1ca4e22a31fe3928bd13ec3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id38852109a1ca4e22a31fe3928bd13ec3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38852109a1ca4e22a31fe3928bd13ec3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38852109a1ca4e22a31fe3928bd13ec3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id38852109a1ca4e22a31fe3928bd13ec3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38852109a1ca4e22a31fe3928bd13ec3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38852109a1ca4e22a31fe3928bd13ec3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idde31eabc4cd24b43a91f7d6c49e1febf" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-WC_VESSELS-SUMINSURED">
		<asp:Label ID="lblWC_VESSELS_SUMINSURED" runat="server" AssociatedControlID="WC_VESSELS__SUMINSURED" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WC_VESSELS.SUMINSURED"
			ClientValidationFunction="onValidate_WC_VESSELS__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-WC_VESSELS-RATE">
		<asp:Label ID="lblWC_VESSELS_RATE" runat="server" AssociatedControlID="WC_VESSELS__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="WC_VESSELS__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valWC_VESSELS_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WC_VESSELS.RATE"
			ClientValidationFunction="onValidate_WC_VESSELS__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-WC_VESSELS-PREM">
		<asp:Label ID="lblWC_VESSELS_PREM" runat="server" AssociatedControlID="WC_VESSELS__PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WC_VESSELS.PREM"
			ClientValidationFunction="onValidate_WC_VESSELS__PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-WC_VESSELS-POST_PREM">
		<asp:Label ID="lblWC_VESSELS_POST_PREM" runat="server" AssociatedControlID="WC_VESSELS__POST_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__POST_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_POST_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WC_VESSELS.POST_PREM"
			ClientValidationFunction="onValidate_WC_VESSELS__POST_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-WC_VESSELS-FAP_PERC">
		<asp:Label ID="lblWC_VESSELS_FAP_PERC" runat="server" AssociatedControlID="WC_VESSELS__FAP_PERC" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="WC_VESSELS__FAP_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valWC_VESSELS_FAP_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WC_VESSELS.FAP_PERC"
			ClientValidationFunction="onValidate_WC_VESSELS__FAP_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-WC_VESSELS-MIN_AMNT">
		<asp:Label ID="lblWC_VESSELS_MIN_AMNT" runat="server" AssociatedControlID="WC_VESSELS__MIN_AMNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__MIN_AMNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_MIN_AMNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WC_VESSELS.MIN_AMNT"
			ClientValidationFunction="onValidate_WC_VESSELS__MIN_AMNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idde31eabc4cd24b43a91f7d6c49e1febf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idde31eabc4cd24b43a91f7d6c49e1febf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idde31eabc4cd24b43a91f7d6c49e1febf div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idde31eabc4cd24b43a91f7d6c49e1febf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idde31eabc4cd24b43a91f7d6c49e1febf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idde31eabc4cd24b43a91f7d6c49e1febf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idde31eabc4cd24b43a91f7d6c49e1febf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idde31eabc4cd24b43a91f7d6c49e1febf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idde31eabc4cd24b43a91f7d6c49e1febf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idde31eabc4cd24b43a91f7d6c49e1febf input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id19622146a4d24901b0beae97d84a226f" class="column-layout-container,no-border  ">
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblWC_VESSELS_IS_NASRIA" for="ctl00_cntMainBody_WC_VESSELS__IS_NASRIA" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-WC_VESSELS-IS_NASRIA">	
		
		<asp:TextBox ID="WC_VESSELS__IS_NASRIA" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valWC_VESSELS_IS_NASRIA" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for WC_VESSELS.IS_NASRIA"
			ClientValidationFunction="onValidate_WC_VESSELS__IS_NASRIA" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-WC_VESSELS-NASRIA_LIMIT">
		<asp:Label ID="lblWC_VESSELS_NASRIA_LIMIT" runat="server" AssociatedControlID="WC_VESSELS__NASRIA_LIMIT" 
			Text="Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__NASRIA_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_NASRIA_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indemnity"
			ClientValidationFunction="onValidate_WC_VESSELS__NASRIA_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id19622146a4d24901b0beae97d84a226f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id19622146a4d24901b0beae97d84a226f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id19622146a4d24901b0beae97d84a226f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id19622146a4d24901b0beae97d84a226f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id19622146a4d24901b0beae97d84a226f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id19622146a4d24901b0beae97d84a226f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id19622146a4d24901b0beae97d84a226f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id19622146a4d24901b0beae97d84a226f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id19622146a4d24901b0beae97d84a226f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id19622146a4d24901b0beae97d84a226f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5dcd1e0469ee474bbb53750b890a5bea" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading18" runat="server" Text="Interest Party" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-WC_VESSELS-INTPARTY_NAME">
		
		
		<asp:Label ID="lblWC_VESSELS_INTPARTY_NAME" runat="server" AssociatedControlID="WC_VESSELS__INTPARTY_NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_VESSELS__INTPARTY_NAME" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_VESSELS_INTPARTY_NAME" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Name"
			ClientValidationFunction="onValidate_WC_VESSELS__INTPARTY_NAME" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Text -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-WC_VESSELS-INTPARTY_DATE">
		<asp:Label ID="lblWC_VESSELS_INTPARTY_DATE" runat="server" AssociatedControlID="WC_VESSELS__INTPARTY_DATE" 
			Text="Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="WC_VESSELS__INTPARTY_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calWC_VESSELS__INTPARTY_DATE" runat="server" LinkedControl="WC_VESSELS__INTPARTY_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valWC_VESSELS_INTPARTY_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date"
			ClientValidationFunction="onValidate_WC_VESSELS__INTPARTY_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-WC_VESSELS-INCEP_DATE">
		<asp:Label ID="lblWC_VESSELS_INCEP_DATE" runat="server" AssociatedControlID="WC_VESSELS__INCEP_DATE" 
			Text="Inception Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="WC_VESSELS__INCEP_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calWC_VESSELS__INCEP_DATE" runat="server" LinkedControl="WC_VESSELS__INCEP_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valWC_VESSELS_INCEP_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Inception Date"
			ClientValidationFunction="onValidate_WC_VESSELS__INCEP_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5dcd1e0469ee474bbb53750b890a5bea div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5dcd1e0469ee474bbb53750b890a5bea div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5dcd1e0469ee474bbb53750b890a5bea div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5dcd1e0469ee474bbb53750b890a5bea label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5dcd1e0469ee474bbb53750b890a5bea label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5dcd1e0469ee474bbb53750b890a5bea label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5dcd1e0469ee474bbb53750b890a5bea label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5dcd1e0469ee474bbb53750b890a5bea input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5dcd1e0469ee474bbb53750b890a5bea input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5dcd1e0469ee474bbb53750b890a5bea input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblWC_REFERRAL_CLAUSES_REFERRAL_CLAUSES" runat="server" AssociatedControlID="WC_REFERRAL_CLAUSES__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="WC_REFERRAL_CLAUSES__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="WC_REFERRAL_CLAUSES" 
		data-property-name="TOT_PREM" 
		id="pb-container-currency-WC_REFERRAL_CLAUSES-TOT_PREM">
		<asp:Label ID="lblWC_REFERRAL_CLAUSES_TOT_PREM" runat="server" AssociatedControlID="WC_REFERRAL_CLAUSES__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WC_REFERRAL_CLAUSES__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWC_REFERRAL_CLAUSES_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_WC_REFERRAL_CLAUSES__TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_WC_REFERRAL_CLAUSES__WCENDPREM"
		data-field-type="Child" 
		data-object-name="WC_REFERRAL_CLAUSES" 
		data-property-name="WCENDPREM" 
		id="pb-container-childscreen-WC_REFERRAL_CLAUSES-WCENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="WC_REFERRAL_CLAUSES__WC_CLAUSEPREM" runat="server" ScreenCode="WCENDPREM" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valWC_REFERRAL_CLAUSES_WCENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for WC_REFERRAL_CLAUSES.WCENDPREM"
						ClientValidationFunction="onValidate_WC_REFERRAL_CLAUSES__WCENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id704e9c47c02d49c794efdbec7ade1f3c" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_WC_NOTES__WCNOTES"
		data-field-type="Child" 
		data-object-name="WC_NOTES" 
		data-property-name="WCNOTES" 
		id="pb-container-childscreen-WC_NOTES-WCNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="WC_NOTES__WC_CNOTE_DETAILS" runat="server" ScreenCode="WCNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valWC_NOTES_WCNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for WC_NOTES.WCNOTES"
						ClientValidationFunction="onValidate_WC_NOTES__WCNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id704e9c47c02d49c794efdbec7ade1f3c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id704e9c47c02d49c794efdbec7ade1f3c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id704e9c47c02d49c794efdbec7ade1f3c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id704e9c47c02d49c794efdbec7ade1f3c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id704e9c47c02d49c794efdbec7ade1f3c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id704e9c47c02d49c794efdbec7ade1f3c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id704e9c47c02d49c794efdbec7ade1f3c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id704e9c47c02d49c794efdbec7ade1f3c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id704e9c47c02d49c794efdbec7ade1f3c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id704e9c47c02d49c794efdbec7ade1f3c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id39b91cc79a18434390f33629f9883266" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_WC_NOTES__WCSNOTES"
		data-field-type="Child" 
		data-object-name="WC_NOTES" 
		data-property-name="WCSNOTES" 
		id="pb-container-childscreen-WC_NOTES-WCSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="WC_NOTES__WC_SCNOTE_DETAILS" runat="server" ScreenCode="WCSNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valWC_NOTES_WCSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for WC_NOTES.WCSNOTES"
						ClientValidationFunction="onValidate_WC_NOTES__WCSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id39b91cc79a18434390f33629f9883266 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id39b91cc79a18434390f33629f9883266 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id39b91cc79a18434390f33629f9883266 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id39b91cc79a18434390f33629f9883266 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id39b91cc79a18434390f33629f9883266 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id39b91cc79a18434390f33629f9883266 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id39b91cc79a18434390f33629f9883266 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id39b91cc79a18434390f33629f9883266 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id39b91cc79a18434390f33629f9883266 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id39b91cc79a18434390f33629f9883266 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide267292431bf4fd084b6941957b5e260" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_PRODCODE" runat="server" AssociatedControlID="GENERAL__PRODCODE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__PRODCODE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_QUOTENUMBER" runat="server" AssociatedControlID="GENERAL__QUOTENUMBER" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__QUOTENUMBER" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_TRANSTYPE" runat="server" AssociatedControlID="GENERAL__TRANSTYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__TRANSTYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_BRANCH" runat="server" AssociatedControlID="GENERAL__BRANCH" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__BRANCH" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_DESCRIPTION" runat="server" AssociatedControlID="GENERAL__DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_UserGroup" runat="server" AssociatedControlID="GENERAL__UserGroup" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__UserGroup" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_LoggedInUser" runat="server" AssociatedControlID="GENERAL__LoggedInUser" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__LoggedInUser" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_LoggedInUserFullName" runat="server" AssociatedControlID="GENERAL__LoggedInUserFullName" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__LoggedInUserFullName" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_LoggedInUserEmail" runat="server" AssociatedControlID="GENERAL__LoggedInUserEmail" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__LoggedInUserEmail" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="GENERAL" 
		data-property-name="WC_FAP" 
		id="pb-container-percentage-GENERAL-WC_FAP">
		<asp:Label ID="lblGENERAL_WC_FAP" runat="server" AssociatedControlID="GENERAL__WC_FAP" 
			Text="First Amount Payable %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="GENERAL__WC_FAP" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valGENERAL_WC_FAP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for First Amount Payable %"
			ClientValidationFunction="onValidate_GENERAL__WC_FAP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="GENERAL" 
		data-property-name="WC_MIN_AMT" 
		id="pb-container-currency-GENERAL-WC_MIN_AMT">
		<asp:Label ID="lblGENERAL_WC_MIN_AMT" runat="server" AssociatedControlID="GENERAL__WC_MIN_AMT" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__WC_MIN_AMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGENERAL_WC_MIN_AMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_GENERAL__WC_MIN_AMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_TRANSACTION_TYPE" runat="server" AssociatedControlID="GENERAL__TRANSACTION_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__TRANSACTION_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblPOLICYHEADER_POLICYNUMBER" runat="server" AssociatedControlID="POLICYHEADER__POLICYNUMBER" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="POLICYHEADER__POLICYNUMBER" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide267292431bf4fd084b6941957b5e260 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide267292431bf4fd084b6941957b5e260 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide267292431bf4fd084b6941957b5e260 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide267292431bf4fd084b6941957b5e260 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide267292431bf4fd084b6941957b5e260 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide267292431bf4fd084b6941957b5e260 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide267292431bf4fd084b6941957b5e260 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide267292431bf4fd084b6941957b5e260 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide267292431bf4fd084b6941957b5e260 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide267292431bf4fd084b6941957b5e260 input{text-align:left;}"; break;
		}
	}
