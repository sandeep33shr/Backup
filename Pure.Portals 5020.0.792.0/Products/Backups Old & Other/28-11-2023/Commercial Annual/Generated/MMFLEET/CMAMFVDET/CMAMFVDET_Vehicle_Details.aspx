...
<div id="id4ff5e0b805284f179418457c036fe587" class="general-layout-container">
	...
	<span class="field-container"
		...
		<asp:Label ID="lblVEHICLE_DETAILS_MAKEMODEL" runat="server" AssociatedControlID="VEHICLE_DETAILS__MAKEMODEL" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="VEHICLE_DETAILS__MAKEMODEL" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblVEHICLE_DETAILS_REGNO" runat="server" AssociatedControlID="VEHICLE_DETAILS__REGNO" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="VEHICLE_DETAILS__REGNO" runat="server" CssClass="form-control" />
		   </div>
