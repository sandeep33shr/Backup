...
<div id="id070360d5bd254fbeaa207b5f4184cda3" class="general-layout-container">
...
<div id="id8bde46bf112a4ddbab2fc304b42cfadc" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMB_SNOTES_CREATED_BY" runat="server" AssociatedControlID="MB_SNOTES__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_SNOTES__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMB_SNOTES_COVER_TYPE" runat="server" AssociatedControlID="MB_SNOTES__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_SNOTES__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMB_SNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="MB_SNOTES__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_SNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8bde46bf112a4ddbab2fc304b42cfadc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8bde46bf112a4ddbab2fc304b42cfadc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8bde46bf112a4ddbab2fc304b42cfadc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8bde46bf112a4ddbab2fc304b42cfadc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8bde46bf112a4ddbab2fc304b42cfadc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8bde46bf112a4ddbab2fc304b42cfadc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8bde46bf112a4ddbab2fc304b42cfadc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8bde46bf112a4ddbab2fc304b42cfadc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8bde46bf112a4ddbab2fc304b42cfadc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8bde46bf112a4ddbab2fc304b42cfadc input{text-align:left;}"; break;
		}
	}
