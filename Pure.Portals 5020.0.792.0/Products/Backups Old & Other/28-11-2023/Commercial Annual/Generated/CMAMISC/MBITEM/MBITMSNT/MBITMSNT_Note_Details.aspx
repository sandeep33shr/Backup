...
<div id="id7153c01266fc4a6ea7a7b93b60a55931" class="general-layout-container">
...
<div id="id6cf3611303d84ad0a4991cacdb3c7db1" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMBITEM_SCNOTE_CREATED_BY" runat="server" AssociatedControlID="MBITEM_SCNOTE__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MBITEM_SCNOTE__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMBITEM_SCNOTE_COVER_TYPE" runat="server" AssociatedControlID="MBITEM_SCNOTE__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MBITEM_SCNOTE__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMBITEM_SCNOTE_NOTE_DESCRIPTION" runat="server" AssociatedControlID="MBITEM_SCNOTE__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MBITEM_SCNOTE__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6cf3611303d84ad0a4991cacdb3c7db1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6cf3611303d84ad0a4991cacdb3c7db1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6cf3611303d84ad0a4991cacdb3c7db1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6cf3611303d84ad0a4991cacdb3c7db1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6cf3611303d84ad0a4991cacdb3c7db1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6cf3611303d84ad0a4991cacdb3c7db1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6cf3611303d84ad0a4991cacdb3c7db1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6cf3611303d84ad0a4991cacdb3c7db1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6cf3611303d84ad0a4991cacdb3c7db1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6cf3611303d84ad0a4991cacdb3c7db1 input{text-align:left;}"; break;
		}
	}
