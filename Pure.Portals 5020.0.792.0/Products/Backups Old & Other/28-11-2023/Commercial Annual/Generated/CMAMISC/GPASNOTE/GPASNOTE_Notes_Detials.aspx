...
<div id="id3fbddb5ad8554346b2e32a32cc629eb8" class="general-layout-container">
...
<div id="idc04b1a62d72c4c7282fb063f5e6a34fa" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGPANOTES_CREATED_BY" runat="server" AssociatedControlID="GPANOTES__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GPANOTES__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGPANOTES_COVER_TYPE" runat="server" AssociatedControlID="GPANOTES__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GPANOTES__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGPANOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="GPANOTES__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GPANOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc04b1a62d72c4c7282fb063f5e6a34fa div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc04b1a62d72c4c7282fb063f5e6a34fa div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc04b1a62d72c4c7282fb063f5e6a34fa div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc04b1a62d72c4c7282fb063f5e6a34fa label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc04b1a62d72c4c7282fb063f5e6a34fa label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc04b1a62d72c4c7282fb063f5e6a34fa label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc04b1a62d72c4c7282fb063f5e6a34fa label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc04b1a62d72c4c7282fb063f5e6a34fa input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc04b1a62d72c4c7282fb063f5e6a34fa input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc04b1a62d72c4c7282fb063f5e6a34fa input{text-align:left;}"; break;
		}
	}
