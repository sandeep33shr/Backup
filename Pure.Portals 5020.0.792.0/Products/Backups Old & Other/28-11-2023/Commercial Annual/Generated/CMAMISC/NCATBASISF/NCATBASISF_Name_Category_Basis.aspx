...
<div id="id05a1c3c7c7324177b12a5668725266d4" class="general-layout-container">
...
<div id="id0f0410be263a47f0a0cb3c329c1cc70b" class="column-layout-container,no-border  ">
	...
	<span class="field-container"
		...
		<asp:Label ID="lblGUAR_COUNTER_ID" runat="server" AssociatedControlID="GUAR__COUNTER_ID" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GUAR__COUNTER_ID" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGUAR_NAME" runat="server" AssociatedControlID="GUAR__NAME" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GUAR__NAME" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGUAR_CAT_SUMINSURED" runat="server" AssociatedControlID="GUAR__CAT_SUMINSURED" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GUAR__CAT_SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGUAR_CAT_NO_PERSONS" runat="server" AssociatedControlID="GUAR__CAT_NO_PERSONS" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GUAR__CAT_NO_PERSONS" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0f0410be263a47f0a0cb3c329c1cc70b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0f0410be263a47f0a0cb3c329c1cc70b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0f0410be263a47f0a0cb3c329c1cc70b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0f0410be263a47f0a0cb3c329c1cc70b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0f0410be263a47f0a0cb3c329c1cc70b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f0410be263a47f0a0cb3c329c1cc70b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f0410be263a47f0a0cb3c329c1cc70b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0f0410be263a47f0a0cb3c329c1cc70b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f0410be263a47f0a0cb3c329c1cc70b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f0410be263a47f0a0cb3c329c1cc70b input{text-align:left;}"; break;
		}
	}
