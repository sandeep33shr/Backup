<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MABARSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_MABARSNOTE_Note_Details" %>
...
function onValidate_BAR_SCNOTE_DETAILS__DATE_CREATED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("BAR_SCNOTE_DETAILS", "DATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=BAR_SCNOTE_DETAILS&propertyName=DATE_CREATED&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "BAR_SCNOTE_DETAILS" && field.getPropertyName() == "DATE_CREATED")
...
function onValidate_BAR_SCNOTE_DETAILS__CREATED_BY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("BAR_SCNOTE_DETAILS", "CREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_BAR_SCNOTE_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=BAR_SCNOTE_DETAILS&propertyName=COVER_TYPE&name={name}");
...
<div id="id956d8daec2524b38aafbbc919d427064" class="general-layout-container">
...
<div id="id7d048b0a254f444d8ad85cf7538ebf32" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblBAR_SCNOTE_DETAILS_CREATED_BY" runat="server" AssociatedControlID="BAR_SCNOTE_DETAILS__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="BAR_SCNOTE_DETAILS__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblBAR_SCNOTE_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="BAR_SCNOTE_DETAILS__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="BAR_SCNOTE_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblBAR_SCNOTE_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="BAR_SCNOTE_DETAILS__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="BAR_SCNOTE_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7d048b0a254f444d8ad85cf7538ebf32 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7d048b0a254f444d8ad85cf7538ebf32 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7d048b0a254f444d8ad85cf7538ebf32 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7d048b0a254f444d8ad85cf7538ebf32 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7d048b0a254f444d8ad85cf7538ebf32 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7d048b0a254f444d8ad85cf7538ebf32 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7d048b0a254f444d8ad85cf7538ebf32 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7d048b0a254f444d8ad85cf7538ebf32 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7d048b0a254f444d8ad85cf7538ebf32 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7d048b0a254f444d8ad85cf7538ebf32 input{text-align:left;}"; break;
		}
	}
