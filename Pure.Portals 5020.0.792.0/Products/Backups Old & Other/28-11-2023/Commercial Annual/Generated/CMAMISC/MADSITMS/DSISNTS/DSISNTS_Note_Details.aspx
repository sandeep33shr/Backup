...
<div id="id1eedd7ea0413452b90f86644fb06ae7d" class="general-layout-container">
...
<div id="id0d0d4ae34c01443cb06f0cf814ebef6b" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblDSITEM_SNOTES_CREATED_BY" runat="server" AssociatedControlID="DSITEM_SNOTES__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DSITEM_SNOTES__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblDSITEM_SNOTES_COVER_TYPE" runat="server" AssociatedControlID="DSITEM_SNOTES__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DSITEM_SNOTES__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblDSITEM_SNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="DSITEM_SNOTES__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DSITEM_SNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0d0d4ae34c01443cb06f0cf814ebef6b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0d0d4ae34c01443cb06f0cf814ebef6b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0d0d4ae34c01443cb06f0cf814ebef6b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0d0d4ae34c01443cb06f0cf814ebef6b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0d0d4ae34c01443cb06f0cf814ebef6b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d0d4ae34c01443cb06f0cf814ebef6b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d0d4ae34c01443cb06f0cf814ebef6b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0d0d4ae34c01443cb06f0cf814ebef6b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d0d4ae34c01443cb06f0cf814ebef6b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d0d4ae34c01443cb06f0cf814ebef6b input{text-align:left;}"; break;
		}
	}
