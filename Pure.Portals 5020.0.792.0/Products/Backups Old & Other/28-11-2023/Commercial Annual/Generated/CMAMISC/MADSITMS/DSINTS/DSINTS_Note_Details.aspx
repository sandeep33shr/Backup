<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DSINTS_Note_Details.aspx.vb" Inherits="Nexus.PB2_DSINTS_Note_Details" %>
...
function onValidate_DSITEM_NOTES__DATE_CREATED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DSITEM_NOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=DSITEM_NOTES&propertyName=DATE_CREATED&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "DSITEM_NOTES" && field.getPropertyName() == "DATE_CREATED")
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DSITEM_NOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_DSITEM_NOTES__COVER_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DSITEM_NOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=DSITEM_NOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_DSITEM_NOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DSITEM_NOTES", "NOTE_DESCRIPTION");
        		var exp = new Expression("DSITEM_NOTES.NoteCheck = 1");
...
function onValidate_DSITEM_NOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DSITEM_NOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("DSITEM_NOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_DSITEM_NOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id29ac7dd21a48452690265b02e23d7831" class="general-layout-container">
...
<div id="ide55fdff577494d7ca9cd98f911aa192d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading266" runat="server" Text="Note Details (Not Printed on Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblDSITEM_NOTES_CREATED_BY" runat="server" AssociatedControlID="DSITEM_NOTES__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DSITEM_NOTES__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblDSITEM_NOTES_COVER_TYPE" runat="server" AssociatedControlID="DSITEM_NOTES__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DSITEM_NOTES__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblDSITEM_NOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="DSITEM_NOTES__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DSITEM_NOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblDSITEM_NOTES_NoteCheck" for="ctl00_cntMainBody_DSITEM_NOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-DSITEM_NOTES-NoteCheck">	
		
		<asp:TextBox ID="DSITEM_NOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valDSITEM_NOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_DSITEM_NOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide55fdff577494d7ca9cd98f911aa192d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide55fdff577494d7ca9cd98f911aa192d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide55fdff577494d7ca9cd98f911aa192d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide55fdff577494d7ca9cd98f911aa192d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide55fdff577494d7ca9cd98f911aa192d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide55fdff577494d7ca9cd98f911aa192d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide55fdff577494d7ca9cd98f911aa192d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide55fdff577494d7ca9cd98f911aa192d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide55fdff577494d7ca9cd98f911aa192d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide55fdff577494d7ca9cd98f911aa192d input{text-align:left;}"; break;
		}
	}
