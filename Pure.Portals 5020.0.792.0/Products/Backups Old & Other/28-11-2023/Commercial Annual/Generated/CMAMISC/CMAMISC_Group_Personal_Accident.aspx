<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISC_Group_Personal_Accident.aspx.vb" Inherits="Nexus.PB2_CMAMISC_Group_Personal_Accident" %>
...
function onValidate_EMPDE__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=EMPDE&propertyName=RISK_ATTACH_DATE&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "EMPDE" && field.getPropertyName() == "RISK_ATTACH_DATE")
        		...
        		var condition = (Expression.isValidParameter("GENERAL.CHECK_PACode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("GENERAL.CHECK_PACode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null;
        		if (condition == null){ 
        			disablePage(false);
        		} else {
...
function onValidate_EMPDE__TOTAL_FINAL_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TOTAL_FINAL_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TOTAL_FINAL_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EMPDE.TOTAL_FINAL_PREMIUM");
        			window.setControlWidth(field, "0.7", "EMPDE", "TOTAL_FINAL_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEMPDE_TOTAL_FINAL_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_EMPDE__TOTAL_FINAL_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EMPDE__TOTAL_FINAL_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TOTAL_FINAL_PREMIUM&name={name}");
        		
        		var value = new Expression("EMPDE.TOT_COVPREM + EMPDE.TOT_EXTPREM + EMPDE.TOT_ENDPREM+ EMPDE.HIVPREM + EMPDE.ACCPREM"), 
...
function onValidate_EMPDE__NMOFEMP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "EMPDE.INDCOVER == 1", "VEM", "{3}");
        
            var paramValue = "V",
            paramCondition = "EMPDE.INDCOVER == 1",
            paramElseValue = "VEM",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#000000";
        		var condition = (Expression.isValidParameter("EMPDE.INDCOVER==1")) ? new Expression("EMPDE.INDCOVER==1") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=EMPDE&propertyName=NMOFEMP&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.INDCOVER==1")) ? new Expression("EMPDE.INDCOVER==1") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__INDCOVER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.NMOFEMP.setValue('')");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.NAME.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_EMPDE__NAME(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.INDCOVER==1", "V", "{3}");
...
function onValidate_EMPDE__OCC_DESC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "Code(EMPDE.OCCUP)=='Other'", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "Code(EMPDE.OCCUP)=='Other'",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("Code(EMPDE.OCCUP)=='Other'")) ? new Expression("Code(EMPDE.OCCUP)=='Other'") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
...
function onValidate_EMPDE__DEATH(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("EMPDE", "DEATH");
        	field.setReadOnly(true);
        })();
}
function onValidate_EMPDE__SMINSLMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.DEATH==1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=SMINSLMT&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Death Sum Insured +Limit cannot be Zero")) ? "Death Sum Insured +Limit cannot be Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "SMINSLMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "SMINSLMT");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.SMINSLMT <=0 || EMPDE.SMINSLMT=='' )&&EMPDE.DEATH==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.DPPREM.setValue(EMPDE.SMINSLMT * EMPDE.EMPRATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.EMPRATE>0 && EMPDE.DEATH = 1")) ? new Expression("EMPDE.EMPRATE>0 && EMPDE.DEATH = 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.DPPREM") ? new Expression("EMPDE.DPPREM") : null;
...
function onValidate_EMPDE__EMPRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "EMPRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "EMPRATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'EMPRATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=EMPRATE&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Death Rate cannot be Greater than 100%")) ? "Death Rate cannot be Greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "EMPRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "EMPRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.EMPRATE>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__DPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.EMPRATE.setValue(EMPDE.DPPREM/EMPDE.SMINSLMT*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Enter Death Posting Premium")) ? "Please Enter Death Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "DPPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "DPPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.DPPREM <=0 ||EMPDE.DPPREM =='') && EMPDE.DEATH ==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__PDT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("EMPDE", "PDT");
        	field.setReadOnly(true);
        })();
}
function onValidate_EMPDE__PDTSMISLM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.PDT==1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.PDT==1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=PDTSMISLM&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.PDT== 0")) ? new Expression("EMPDE.PDT== 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Permanent Disability Total/Partial Sum Insured Limit cannot be Zero")) ? "Permanent Disability Total/Partial Sum Insured Limit cannot be Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "PDTSMISLM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "PDTSMISLM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.PDTSMISLM<=0 || EMPDE.PDTSMISLM=='')&&EMPDE.PDT==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.PDTPPREM.setValue(EMPDE.PDTSMISLM * EMPDE.PDTPRATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.PDTPRATE>0 && EMPDE.PDT = 1")) ? new Expression("EMPDE.PDTPRATE>0 && EMPDE.PDT = 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.PDTPPREM") ? new Expression("EMPDE.PDTPPREM") : null;
...
function onValidate_EMPDE__PDTPRATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EMPDE.PDT==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Permanent Disability Total/Partial Rate cannot be Greater than 100%")) ? "Permanent Disability Total/Partial Rate cannot be Greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "PDTPRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "PDTPRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.PDTPRATE>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__PDTPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.PDTPRATE.setValue(EMPDE.PDTPPREM/EMPDE.PDTSMISLM*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Permanent Disability Total/Partial Posting Premium")) ? "Please enter Permanent Disability Total/Partial Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "PDTPPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "PDTPPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.PDTPPREM<=0 || EMPDE.PDTPPREM == null) &&EMPDE.PDT==1 ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__TDSUINLI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.TDPTDISB==1", "V", "Temporary  Disability: Total Sum Insured/Limit is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.TDPTDISB==1",
            paramElseValue = "V",
            paramValidationMessage = "Temporary  Disability: Total Sum Insured/Limit is mandatory and an amount must be entered";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TDSUINLI&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.TDPTDISB== 0")) ? new Expression("EMPDE.TDPTDISB== 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.TDPPREM.setValue(EMPDE.TDSUINLI * EMPDE.TDRATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.TDRATE>0 && EMPDE.TDPTDISB = 1")) ? new Expression("EMPDE.TDRATE>0 && EMPDE.TDPTDISB = 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.TDPPREM") ? new Expression("EMPDE.TDPPREM") : null;
...
function onValidate_EMPDE__TDNOWEE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.TDPTDISB==1", "V", "Temporary Disability: Total No of Weeks is mandatory and an option must be selected");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "TDNOWEE");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=List&objectName=EMPDE&propertyName=TDNOWEE&name={name}");
...
function onValidate_EMPDE__TDRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TDRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TDRATE");
        		}
        		//window.setProperty(field, "VE", "EMPDE.TDPTDISB==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TDRATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=TDRATE&name={name}");
...
function onValidate_EMPDE__TDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TDPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TDPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TDPREM&name={name}");
        		
        		var value = new Expression("EMPDE.TDPPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TDPREM');
...
function onValidate_EMPDE__TDPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TDPPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TDPPREM");
        		}
        		//window.setProperty(field, "VEM", "EMPDE.TDPTDISB==1", "V", "Temporary  Disability: Total Posting Premium is mandatory and an amount must be entered");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "TDPPREM");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.TDRATE.setValue(EMPDE.TDPPREM/EMPDE.TDSUINLI*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TDPPREM&name={name}");
...
function onValidate_EMPDE__TDSUINLIP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.TEMPPART==1", "V", "Temporary  Disability: Partial Sum Insured/Limit is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.TEMPPART==1",
            paramElseValue = "V",
            paramValidationMessage = "Temporary  Disability: Partial Sum Insured/Limit is mandatory and an amount must be entered";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TDSUINLIP&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.TEMPPART== 0")) ? new Expression("EMPDE.TEMPPART== 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.TDPPREMP.setValue(EMPDE.TDSUINLIP * EMPDE.TDRATEP * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.TDRATEP>0 && EMPDE.TEMPPART == 1")) ? new Expression("EMPDE.TDRATEP>0 && EMPDE.TEMPPART == 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.TDPPREMP") ? new Expression("EMPDE.TDPPREMP") : null;
...
function onValidate_EMPDE__TDNOWEEP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.TEMPPART==1", "V", "Temporary  Disability: Partial Number of weeks is mandatory and must be selected");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.TEMPPART==1",
            paramElseValue = "V",
            paramValidationMessage = "Temporary  Disability: Partial Number of weeks is mandatory and must be selected";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "TDNOWEEP");
        		
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EMPDE.TEMPPART==1")) ? new Expression("EMPDE.TEMPPART==1") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=List&objectName=EMPDE&propertyName=TDNOWEEP&name={name}");
...
function onValidate_EMPDE__TDRATEP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TDRATEP", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TDRATEP");
        		}
        		//window.setProperty(field, "VE", "EMPDE.TEMPPART==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TDRATEP');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=TDRATEP&name={name}");
...
function onValidate_EMPDE__TDPREMP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TDPREMP", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TDPREMP");
        		}
        		//window.setProperty(field, "V", "EMPDE.TEMPPART==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TDPREMP');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TDPREMP&name={name}");
        		
        		var value = new Expression("EMPDE.TDPPREMP"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__TDPPREMP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TDPPREMP", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TDPPREMP");
        		}
        		//window.setProperty(field, "VEM", "EMPDE.TEMPPART==1", "V", "Temporary  Disability: Partial Posting Premium is mandatory and an amount must be entered");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "TDPPREMP");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.TDRATEP.setValue(EMPDE.TDPPREMP/EMPDE.TDSUINLIP*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TDPPREMP&name={name}");
...
function onValidate_EMPDE__MDCALEXPNS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.MDCLEXPNS==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Medical Expenses Sum Insured/Limit is mandatory and an amount must be entered")) ? "Medical Expenses Sum Insured/Limit is mandatory and an amount must be entered" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "MDCALEXPNS");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "MDCALEXPNS");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.MDCALEXPNS<=0 ||EMPDE.MDCALEXPNS == '')&&EMPDE.MDCLEXPNS==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.MEDPREM.setValue(EMPDE.MDCALEXPNS * EMPDE.MEDRATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.MEDRATE>0 && EMPDE.MDCLEXPNS == 1")) ? new Expression("EMPDE.MEDRATE>0 && EMPDE.MDCLEXPNS == 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.MEDPREM") ? new Expression("EMPDE.MEDPREM") : null;
...
function onValidate_EMPDE__MEDRATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Medical Expenses Rate cannot be Greater than 100%")) ? "Medical Expenses Rate cannot be Greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "MEDRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "MEDRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.MEDRATE>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__MEDPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.MEDPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__MEDPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.MEDRATE.setValue(EMPDE.MEDPREM/EMPDE.MDCALEXPNS*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Medical Expenses Posting Premium is mandatory and an amount must be entered")) ? "Medical Expenses Posting Premium is mandatory and an amount must be entered" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "MEDPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "MEDPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.MEDPREM<=0 || EMPDE.MEDPREM == null)&&EMPDE.MDCLEXPNS== 1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__TOT_COVPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TOT_COVPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TOT_COVPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TOT_COVPREM&name={name}");
        		
        		var value = new Expression("EMPDE.DPPREM + EMPDE.PDTPPREM + EMPDE.TDPPREM + EMPDE.TDPPREMP + EMPDE.MEDPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TOT_COVPREM');
...
function onValidate_EMPDE__MED_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=MED_FAP&name={name}");
        		
        		var value = new Expression("GENERAL.GPAFAP"), 
        			condition = (Expression.isValidParameter("EMPDE.MDCLEXPNS==1 AND EMPDE.MED_FAP < GENERAL.GPAFAP")) ? new Expression("EMPDE.MDCLEXPNS==1 AND EMPDE.MED_FAP < GENERAL.GPAFAP") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Medical Expenses FAP% cannot exceed 100%")) ? "Medical Expenses FAP% cannot exceed 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "MED_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "MED_FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.MED_FAP>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__MED_MINA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=MED_MINA&name={name}");
        		
        		var value = new Expression("GENERAL.GPAMIN"), 
        			condition = (Expression.isValidParameter("EMPDE.MDCLEXPNS==1 AND EMPDE.MED_MINA<GENERAL.GPAMIN")) ? new Expression("EMPDE.MDCLEXPNS==1 AND EMPDE.MED_MINA<GENERAL.GPAMIN") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__TEMP_DAYS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EMPDE.TDPTDISB ==1 || EMPDE.TEMPPART == 1", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "EMPDE.TDPTDISB ==1 || EMPDE.TEMPPART == 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=EMPDE&propertyName=TEMP_DAYS&name={name}");
        		
        		var value = new Expression("GENERAL.GPATIME"), 
        			condition = (Expression.isValidParameter("EMPDE.TDPTDISB ==1 || EMPDE.TEMPPART == 1")) ? new Expression("EMPDE.TDPTDISB ==1 || EMPDE.TEMPPART == 1") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.TDPTDISB ==0 && EMPDE.TEMPPART == 0")) ? new Expression("EMPDE.TDPTDISB ==0 && EMPDE.TEMPPART == 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_label344(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label345(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label346(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EMPDE__HIVLIMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=HIVLIMT&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.HVACCEXP==0")) ? new Expression("EMPDE.HVACCEXP==0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("HIV Accidental Exposure Limit of Indemnity has to greater than Zero")) ? "HIV Accidental Exposure Limit of Indemnity has to greater than Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HIVLIMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HIVLIMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.HIVLIMT<=0 || EMPDE.HIVLIMT == '') && EMPDE.HVACCEXP==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.HIVAPREM.setValue(EMPDE.HIVLIMT * EMPDE.HIVRATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.HIVRATE>0 && EMPDE.HVACCEXP == 1")) ? new Expression("EMPDE.HIVRATE>0 && EMPDE.HVACCEXP == 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.HIVAPREM") ? new Expression("EMPDE.HIVAPREM") : null;
...
function onValidate_EMPDE__HIVRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "HIVRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "HIVRATE");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'HIVRATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=HIVRATE&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("HIV Accidental Exposure Rate cannot be Greater than 100%")) ? "HIV Accidental Exposure Rate cannot be Greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HIVRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HIVRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.HIVRATE>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__HIVAPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "HIVAPPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "HIVAPPREM");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'HIVAPPREM');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=HIVAPPREM&name={name}");
        		
        		var value = new Expression("EMPDE.HIVAPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__HIVAPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "HIVAPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "HIVAPREM");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "HIVAPREM");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.HIVRATE.setValue(EMPDE.HIVAPREM/EMPDE.HIVLIMT*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=HIVAPREM&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter HIV Accidental Exposure Posting Premium")) ? "Please enter HIV Accidental Exposure Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HIVAPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HIVAPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.HIVAPREM<=0 || EMPDE.HIVAPREM=='')&&EMPDE.HVACCEXP==1 ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label347(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label348(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label349(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EMPDE__HSPTMEX(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EMPDE&propertyName=HSPTMEX&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.HSPTL==0")) ? new Expression("EMPDE.HSPTL==0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Enter Hospitalisation Time Excess")) ? "Please Enter Hospitalisation Time Excess" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HSPTMEX");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HSPTMEX");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.HSPTL==1 && EMPDE.HSPTMEX==''");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__HSPPERIOD(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("EMPDE", "HSPPERIOD");
        		var exp = new Expression("EMPDE.HSPTL==0");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EMPDE&propertyName=HSPPERIOD&name={name}");
...
function onValidate_EMPDE__LMTIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=LMTIND&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Hospitalisation Limit of Indemnity has to greater than Zero")) ? "Please Hospitalisation Limit of Indemnity has to greater than Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "LMTIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "LMTIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.LMTIND<=0 || EMPDE.LMTIND == null) && EMPDE.HSPTL==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.HSPREM.setValue(EMPDE.LMTIND * EMPDE.HSPRATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.HSPRATE>0 && EMPDE.HSPTL == 1")) ? new Expression("EMPDE.HSPRATE>0 && EMPDE.HSPTL == 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.HSPREM") ? new Expression("EMPDE.HSPREM") : null;
...
function onValidate_EMPDE__HSPRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "HSPRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "HSPRATE");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'HSPRATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=HSPRATE&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Hospitalisation Rate cannot be Greater than 100%")) ? "Hospitalisation Rate cannot be Greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HSPRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HSPRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.HSPRATE>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__HSPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "HSPPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "HSPPREM");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'HSPPREM');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=HSPPREM&name={name}");
        		
        		var value = new Expression("EMPDE.HSPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__HSPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "HSPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "HSPREM");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "HSPREM");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.HSPRATE.setValue(EMPDE.HSPREM/EMPDE.LMTIND*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=HSPREM&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Hospitalisation Posting Premium")) ? "Please enter Hospitalisation Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HSPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HSPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.HSPREM<=0 || EMPDE.HSPREM == null)&&EMPDE.HSPTL==1 ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label350(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label351(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label352(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EMPDE__SRSTMEX(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EMPDE&propertyName=SRSTMEX&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.SRSILL==0")) ? new Expression("EMPDE.SRSILL==0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Enter Serious Illness Time Excess")) ? "Please Enter Serious Illness Time Excess" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "SRSTMEX");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "SRSTMEX");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.SRSTMEX=='') && EMPDE.SRSILL==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label353(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EMPDE__SRSLMTIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EMPDE.SRSILL==1")) ? new Expression("EMPDE.SRSILL==1") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=SRSLMTIND&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Serious Illness Limit of Indemnity has to greater than Zero")) ? "Please Serious Illness Limit of Indemnity has to greater than Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "SRSLMTIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "SRSLMTIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.SRSLMTIND<=0 || EMPDE.SRSLMTIND == null) && EMPDE.SRSILL==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.SRSPREM.setValue(EMPDE.SRSLMTIND * EMPDE.SRSRATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.SRSRATE>0 && EMPDE.SRSILL == 1")) ? new Expression("EMPDE.SRSRATE>0 && EMPDE.SRSILL == 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.SRSPREM") ? new Expression("EMPDE.SRSPREM") : null;
...
function onValidate_EMPDE__SRSRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "SRSRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "SRSRATE");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'SRSRATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=SRSRATE&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Serious Illness Rate cannot be Greater than 100%")) ? "Serious Illness Rate cannot be Greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "SRSRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "SRSRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.SRSRATE>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__SRSPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "SRSPPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "SRSPPREM");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=SRSPPREM&name={name}");
        		
        		var value = new Expression("EMPDE.SRSPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'SRSPPREM');
...
function onValidate_EMPDE__SRSPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "SRSPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "SRSPREM");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "SRSPREM");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.SRSRATE.setValue(EMPDE.SRSPREM/EMPDE.SRSLMTIND*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=SRSPREM&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Serious Illness Posting Premium")) ? "Please enter Serious Illness Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "SRSPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "SRSPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.SRSPREM<=0 || EMPDE.SRSPREM == null) && EMPDE.SRSILL==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__SRSFAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=SRSFAP&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "SRSFAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "SRSFAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.SRSFAP>100 )");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__SRSFAPAM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=SRSFAPAM&name={name}");
...
function onValidate_label354(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EMPDE__TTDTMEX(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EMPDE.TTDSCK==1")) ? new Expression("EMPDE.TTDSCK==1") : null;
        		var elseColour = (Expression.isValidParameter("#000000")) ? "#000000" : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EMPDE&propertyName=TTDTMEX&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.TTDSCK==0")) ? new Expression("EMPDE.TTDSCK==0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Enter Temporary Total Disablement Sickness Time Excess")) ? "Please Enter Temporary Total Disablement Sickness Time Excess" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "TTDTMEX");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "TTDTMEX");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.TTDTMEX == '' &&EMPDE.TTDSCK==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label355(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EMPDE__TTDLIMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TTDLIMT&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Temporary Total Disablement - Sickness Limit of Indemnity has to greater than Zero")) ? "Please Temporary Total Disablement - Sickness Limit of Indemnity has to greater than Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "TTDLIMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "TTDLIMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.TTDLIMT<=0 || EMPDE.TTDLIMT == null) && EMPDE.TTDSCK==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.TTDPREM.setValue(EMPDE.TTDLIMT * EMPDE.TTDRATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("EMPDE.TTDRATE>0 && EMPDE.TTDSCK == 1")) ? new Expression("EMPDE.TTDRATE>0 && EMPDE.TTDSCK == 1") : null;
        		var elseExp = Expression.isValidParameter("EMPDE.TTDPREM") ? new Expression("EMPDE.TTDPREM") : null;
...
function onValidate_EMPDE__TTDRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TTDRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TTDRATE");
        		}
        		//window.setProperty(field, "R", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TTDRATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=TTDRATE&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Temporary Total Disablement - Sickness Rate cannot be Greater than 100%")) ? "Temporary Total Disablement - Sickness Rate cannot be Greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "TTDRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "TTDRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.TTDRATE>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__TTDPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.TTDPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__TTDPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("EMPDE.TTDRATE.setValue(EMPDE.TTDPREM/EMPDE.TTDLIMT*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Temporary Total Disablement - Sickness Posting Premium")) ? "Please enter Temporary Total Disablement - Sickness Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "TTDPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "TTDPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.TTDPREM<=0 || EMPDE.TTDPREM == null) &&EMPDE.TTDSCK == 1 ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__TTDFAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=TTDFAP&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "TTDFAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "TTDFAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.TTDFAP>100 )");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__TTDFAPP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TTDFAPP&name={name}");
...
function onValidate_EMPDE__WRPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "WRPPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "WRPPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'WRPPREM');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=WRPPREM&name={name}");
        		
        		var value = new Expression("EMPDE.WRPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__WRPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "WRPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "WRPREM");
        		}
        		//window.setProperty(field, "VEM", "EMPDE.WRRISK==1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.WRRISK==1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "WRPREM");
        		
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EMPDE.WRRISK==1")) ? new Expression("EMPDE.WRRISK==1") : null;
        		var elseColour = (Expression.isValidParameter("#000000")) ? "#000000" : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("War Risk Posting Premium has to greater than Zero")) ? "War Risk Posting Premium has to greater than Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "WRPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "WRPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.WRPREM<=0 || EMPDE.WRPREM == null) && EMPDE.WRRISK == 1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=WRPREM&name={name}");
        		
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.WRRISK==0")) ? new Expression("EMPDE.WRRISK==0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__TOT_EXTPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TOT_EXTPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TOT_EXTPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "TOT_EXTPREM");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TOT_EXTPREM&name={name}");
        		
        		var value = new Expression("EMPDE.WRPREM + EMPDE.TTDPREM +EMPDE.SRSPREM + EMPDE.HSPREM + EMPDE.HIVAPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__Temp_Hide(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "Temp_Hide", "TempCheckbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("EMPDE", "Temp_Hide");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=TempCheckbox&objectName=EMPDE&propertyName=Temp_Hide&name={name}");
        ...
        /** 
         * ToggleContainer
         * @param frmGPAAS The element to toggle
        ...
        (function(){
        	...
        	if (isOnLoad) {
        		...
        		var update = function(){
        			...
        			if (!inverse){
        				(new Expression("SetElementDisplay('frmGPAAS', !!" + value + ")")).valueOf();
        			} else {
        				(new Expression("SetElementDisplay('frmGPAAS', !" + value + ")")).valueOf();
        			}
        		};
        		events.listen(Field.getInstance("EMPDE", "Temp_Hide"), "change", update);
        		update();
        	}
...
function onValidate_EMPDE__HIVNEMP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.HIVACCEXP==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Assistance Services HIV Accidental Exposure No of Employees cannot be Zero or empty")) ? "Assistance Services HIV Accidental Exposure No of Employees cannot be Zero or empty" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HIVNEMP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HIVNEMP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.HIVNEMP<=0 || EMPDE.HIVNEMP== null)&&EMPDE.HIVACCEXP==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__HIVPREMP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EMPDE.HIVACCEXP==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("HIV Accidental Exposure Premium per Person cannot be Zero or empty")) ? "HIV Accidental Exposure Premium per Person cannot be Zero or empty" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HIVPREMP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HIVPREMP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.HIVPREMP<=0 )&&EMPDE.HIVACCEXP==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__HIVPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.HIVPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__HIVPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Assistance Services HIV Accidental Exposure Posting Premium")) ? "Please enter Assistance Services HIV Accidental Exposure Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "HIVPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "HIVPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.HIVPREM<=0 || EMPDE.HIVPREM == null)&&EMPDE.HIVACCEXP==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.HIVNEMP * EMPDE.HIVPREMP"), 
        			condition = (Expression.isValidParameter("EMPDE.HIVPREMP>0")) ? new Expression("EMPDE.HIVPREMP>0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__ACCNEMPS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.ACCEXPASS==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Assistance Services Accidental Expert Assistance No of Employees cannot be Zero or empty")) ? "Assistance Services Accidental Expert Assistance No of Employees cannot be Zero or empty" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "ACCNEMPS");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "ACCNEMPS");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.ACCNEMPS<=0 || EMPDE.ACCNEMPS== null)&&EMPDE.ACCEXPASS==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__ACCPREMPP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EMPDE.ACCEXPASS==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Assistance Services Accidental Expert Assistance Premium per Person cannot be Zero or empty")) ? "Assistance Services Accidental Expert Assistance Premium per Person cannot be Zero or empty" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "ACCPREMPP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "ACCPREMPP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.ACCPREMPP<=0 )&&EMPDE.ACCEXPASS==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__ACCPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.ACCPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__ACCPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Assistance Services Accidental Expert Assistance Posting Premium")) ? "Please enter Assistance Services Accidental Expert Assistance Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "ACCPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "ACCPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.ACCPREM<=0 || EMPDE.ACCPREM == null)&&EMPDE.ACCEXPASS==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.ACCNEMPS * EMPDE.ACCPREMPP"), 
        			condition = (Expression.isValidParameter("EMPDE.ACCPREMPP>0")) ? new Expression("EMPDE.ACCPREMPP>0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__label385(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "label385", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "label385");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=label385&name={name}");
        		
        		var value = new Expression("EMPDE.HIVPREM + EMPDE.ACCPREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'label385');
...
function onValidate_EMPDE__EMPDE_COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "EMPDE_COUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("EMPDE", "EMPDE_COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @param EMPDE_CLAUSEPREM.ENDORSE_ID The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var childFieldStr = "EMPDE_CLAUSEPREM.ENDORSE_ID";
...
function onValidate_EMPDE__TOT_ENDPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EMPDE.TOT_ENDPREM");
        			window.setControlWidth(field, "0.4", "EMPDE", "TOT_ENDPREM");
        		})();
        	}
        })();
        /**
...
function onValidate_EMPDE__GPAENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "GPAENDOS", "ChildScreen");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("EMPDE", "GPAENDOS");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_EMPDE__GPAENDOS table td a");
        				
        		} else {
        		   links = goog.dom.query("a", field.getElement());
        		}		
                var exp = new Expression("GENERAL.CHECK_PACode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')");
...
function onValidate_EMPDE__EMP_END_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "EMP_END_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("EMPDE", "EMP_END_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_EMPDE__GPASNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "GPASNOTE", "ChildScreen");
        })();
        /**
         * @fileoverview
         * DisableAddWhen, used only on child screen objects.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("EMPDE", "GPASNOTE");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_EMPDE__GPASNOTE table td a");
...
function onValidate_EMPDE__GPA_NTS_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "GPA_NTS_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("EMPDE", "GPA_NTS_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_EMPDE__GPANOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "GPANOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("EMPDE", "GPANOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_EMPDE__GPANOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("EMPDE", "GPANOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'EMPDE' and property 'GPANOTE'.");
        			error.display();
...
function DoLogic(isOnLoad) {
    ...
    onValidate_EMPDE__TOTAL_FINAL_PREMIUM(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__EMPRATE(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__TDRATE(null, null, null, isOnLoad);
    onValidate_EMPDE__TDPREM(null, null, null, isOnLoad);
    onValidate_EMPDE__TDPPREM(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__TDRATEP(null, null, null, isOnLoad);
    onValidate_EMPDE__TDPREMP(null, null, null, isOnLoad);
    onValidate_EMPDE__TDPPREMP(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__TOT_COVPREM(null, null, null, isOnLoad);
    ...
    onValidate_label344(null, null, null, isOnLoad);
    onValidate_label345(null, null, null, isOnLoad);
    onValidate_label346(null, null, null, isOnLoad);
    onValidate_EMPDE__HIVLIMT(null, null, null, isOnLoad);
    onValidate_EMPDE__HIVRATE(null, null, null, isOnLoad);
    onValidate_EMPDE__HIVAPPREM(null, null, null, isOnLoad);
    onValidate_EMPDE__HIVAPREM(null, null, null, isOnLoad);
    onValidate_label347(null, null, null, isOnLoad);
    onValidate_label348(null, null, null, isOnLoad);
    onValidate_EMPDE__HSPTL(null, null, null, isOnLoad);
    onValidate_label349(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__HSPRATE(null, null, null, isOnLoad);
    onValidate_EMPDE__HSPPREM(null, null, null, isOnLoad);
    onValidate_EMPDE__HSPREM(null, null, null, isOnLoad);
    onValidate_label350(null, null, null, isOnLoad);
    onValidate_label351(null, null, null, isOnLoad);
    onValidate_EMPDE__SRSILL(null, null, null, isOnLoad);
    onValidate_label352(null, null, null, isOnLoad);
    onValidate_EMPDE__SRSTMEX(null, null, null, isOnLoad);
    onValidate_label353(null, null, null, isOnLoad);
    onValidate_EMPDE__SRSLMTIND(null, null, null, isOnLoad);
    onValidate_EMPDE__SRSRATE(null, null, null, isOnLoad);
    onValidate_EMPDE__SRSPPREM(null, null, null, isOnLoad);
    onValidate_EMPDE__SRSPREM(null, null, null, isOnLoad);
    ...
    onValidate_label354(null, null, null, isOnLoad);
    onValidate_EMPDE__TTDTMEX(null, null, null, isOnLoad);
    onValidate_label355(null, null, null, isOnLoad);
    onValidate_EMPDE__TTDLIMT(null, null, null, isOnLoad);
    onValidate_EMPDE__TTDRATE(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__WRPPREM(null, null, null, isOnLoad);
    onValidate_EMPDE__WRPREM(null, null, null, isOnLoad);
    onValidate_EMPDE__TOT_EXTPREM(null, null, null, isOnLoad);
    onValidate_EMPDE__Temp_Hide(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__label385(null, null, null, isOnLoad);
    onValidate_EMPDE__EMPDE_COUNT(null, null, null, isOnLoad);
    onValidate_EMPDE__TOT_ENDPREM(null, null, null, isOnLoad);
    onValidate_EMPDE__GPAENDOS(null, null, null, isOnLoad);
    onValidate_EMPDE__EMP_END_CNT(null, null, null, isOnLoad);
    onValidate_EMPDE__GPASNOTE(null, null, null, isOnLoad);
    onValidate_EMPDE__GPA_NTS_CNT(null, null, null, isOnLoad);
    onValidate_EMPDE__GPANOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id53f420ad71324175a2ef77910281c877" class="general-layout-container">
...
<div id="id3925fa2424c1487daaa7f5b9c825a53b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading129" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-TOTAL_FINAL_PREMIUM">
		<asp:Label ID="lblEMPDE_TOTAL_FINAL_PREMIUM" runat="server" AssociatedControlID="EMPDE__TOTAL_FINAL_PREMIUM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TOTAL_FINAL_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TOTAL_FINAL_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_EMPDE__TOTAL_FINAL_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3925fa2424c1487daaa7f5b9c825a53b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3925fa2424c1487daaa7f5b9c825a53b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3925fa2424c1487daaa7f5b9c825a53b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3925fa2424c1487daaa7f5b9c825a53b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3925fa2424c1487daaa7f5b9c825a53b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3925fa2424c1487daaa7f5b9c825a53b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3925fa2424c1487daaa7f5b9c825a53b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3925fa2424c1487daaa7f5b9c825a53b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3925fa2424c1487daaa7f5b9c825a53b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3925fa2424c1487daaa7f5b9c825a53b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id85d66aeae2d0413ebc00582002a1d4ab" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading130" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_BUSLIMCode" runat="server" AssociatedControlID="EMPDE__BUSLIMCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__BUSLIMCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_BUSLIMCode" 
			runat="server" 
			Text="*" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id85d66aeae2d0413ebc00582002a1d4ab div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id85d66aeae2d0413ebc00582002a1d4ab div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id85d66aeae2d0413ebc00582002a1d4ab div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id85d66aeae2d0413ebc00582002a1d4ab label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id85d66aeae2d0413ebc00582002a1d4ab label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id85d66aeae2d0413ebc00582002a1d4ab label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id85d66aeae2d0413ebc00582002a1d4ab label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id85d66aeae2d0413ebc00582002a1d4ab input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id85d66aeae2d0413ebc00582002a1d4ab input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id85d66aeae2d0413ebc00582002a1d4ab input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id776871d63d8f4113bb86cfd76cd48e3e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading131" runat="server" Text="Employee Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_NAME" runat="server" AssociatedControlID="EMPDE__NAME" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__NAME" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_OCC_DESC" runat="server" AssociatedControlID="EMPDE__OCC_DESC" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__OCC_DESC" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_OCCUPCode" runat="server" AssociatedControlID="EMPDE__OCCUPCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__OCCUPCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_OCCUPCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id776871d63d8f4113bb86cfd76cd48e3e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id776871d63d8f4113bb86cfd76cd48e3e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id776871d63d8f4113bb86cfd76cd48e3e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id776871d63d8f4113bb86cfd76cd48e3e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id776871d63d8f4113bb86cfd76cd48e3e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id776871d63d8f4113bb86cfd76cd48e3e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id776871d63d8f4113bb86cfd76cd48e3e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id776871d63d8f4113bb86cfd76cd48e3e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id776871d63d8f4113bb86cfd76cd48e3e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id776871d63d8f4113bb86cfd76cd48e3e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2d1a7d02d9544ee29fa8e36a9a4ebecc" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading132" runat="server" Text="Cover Details" /></legend>
				
				
				<div data-column-count="7" data-column-ratio="5:30:15:15:10:10:15" data-layout="" class="clearfix form-horizontal">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label302">
		<span class="label" id="label302"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label303">
		<span class="label" id="label303">Sum Insured/Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label304">
		<span class="label" id="label304">No of Weeks</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label305">
		<span class="label" id="label305">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label306">
		<span class="label" id="label306">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label307">
		<span class="label" id="label307">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label308">
		<span class="label" id="label308">Death </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="EMPDE" 
		data-property-name="EMPRATE" 
		id="pb-container-percentage-EMPDE-EMPRATE">
		<asp:Label ID="lblEMPDE_EMPRATE" runat="server" AssociatedControlID="EMPDE__EMPRATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EMPDE__EMPRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEMPDE_EMPRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.EMPRATE"
			ClientValidationFunction="onValidate_EMPDE__EMPRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label310">
		<span class="label" id="label310">Permanent Disability Total/Partial</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label311">
		<span class="label" id="label311"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label312">
		<span class="label" id="label312">Temporary Disability: Total</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="EMPDE" 
		data-property-name="TDRATE" 
		id="pb-container-percentage-EMPDE-TDRATE">
		<asp:Label ID="lblEMPDE_TDRATE" runat="server" AssociatedControlID="EMPDE__TDRATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EMPDE__TDRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEMPDE_TDRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TDRATE"
			ClientValidationFunction="onValidate_EMPDE__TDRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="TDPREM" 
		id="pb-container-currency-EMPDE-TDPREM">
		<asp:Label ID="lblEMPDE_TDPREM" runat="server" AssociatedControlID="EMPDE__TDPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TDPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TDPREM"
			ClientValidationFunction="onValidate_EMPDE__TDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="TDPPREM" 
		id="pb-container-currency-EMPDE-TDPPREM">
		<asp:Label ID="lblEMPDE_TDPPREM" runat="server" AssociatedControlID="EMPDE__TDPPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TDPPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TDPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TDPPREM"
			ClientValidationFunction="onValidate_EMPDE__TDPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label313">
		<span class="label" id="label313">Temporary  Disability: Partial </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="EMPDE" 
		data-property-name="TDRATEP" 
		id="pb-container-percentage-EMPDE-TDRATEP">
		<asp:Label ID="lblEMPDE_TDRATEP" runat="server" AssociatedControlID="EMPDE__TDRATEP" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EMPDE__TDRATEP" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEMPDE_TDRATEP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TDRATEP"
			ClientValidationFunction="onValidate_EMPDE__TDRATEP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="TDPREMP" 
		id="pb-container-currency-EMPDE-TDPREMP">
		<asp:Label ID="lblEMPDE_TDPREMP" runat="server" AssociatedControlID="EMPDE__TDPREMP" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TDPREMP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TDPREMP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TDPREMP"
			ClientValidationFunction="onValidate_EMPDE__TDPREMP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="TDPPREMP" 
		id="pb-container-currency-EMPDE-TDPPREMP">
		<asp:Label ID="lblEMPDE_TDPPREMP" runat="server" AssociatedControlID="EMPDE__TDPPREMP" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TDPPREMP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TDPPREMP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TDPPREMP"
			ClientValidationFunction="onValidate_EMPDE__TDPPREMP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label314">
		<span class="label" id="label314">Medical Expenses </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label316">
		<span class="label" id="label316"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label317">
		<span class="label" id="label317">Total </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label318">
		<span class="label" id="label318"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label320">
		<span class="label" id="label320"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="TOT_COVPREM" 
		id="pb-container-currency-EMPDE-TOT_COVPREM">
		<asp:Label ID="lblEMPDE_TOT_COVPREM" runat="server" AssociatedControlID="EMPDE__TOT_COVPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TOT_COVPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TOT_COVPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TOT_COVPREM"
			ClientValidationFunction="onValidate_EMPDE__TOT_COVPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_TDNOWEECode" runat="server" AssociatedControlID="EMPDE__TDNOWEECode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TDNOWEECode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TDNOWEECode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_TDNOWEEPCode" runat="server" AssociatedControlID="EMPDE__TDNOWEEPCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TDNOWEEPCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TDNOWEEPCode" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for "
			ClientValidationFunction="javascript:void" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2d1a7d02d9544ee29fa8e36a9a4ebecc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2d1a7d02d9544ee29fa8e36a9a4ebecc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2d1a7d02d9544ee29fa8e36a9a4ebecc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2d1a7d02d9544ee29fa8e36a9a4ebecc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2d1a7d02d9544ee29fa8e36a9a4ebecc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2d1a7d02d9544ee29fa8e36a9a4ebecc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2d1a7d02d9544ee29fa8e36a9a4ebecc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2d1a7d02d9544ee29fa8e36a9a4ebecc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2d1a7d02d9544ee29fa8e36a9a4ebecc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2d1a7d02d9544ee29fa8e36a9a4ebecc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfae0c6e894484bca865431c48f4fa92c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading133" runat="server" Text="First Amount Payable" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label324">
		<span class="label" id="label324">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label325">
		<span class="label" id="label325">Min Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label326">
		<span class="label" id="label326">Time Excess (days)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label327">
		<span class="label" id="label327"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label328">
		<span class="label" id="label328">Medical Expenses</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label331">
		<span class="label" id="label331">Temporary Disability</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label332">
		<span class="label" id="label332"></span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idfae0c6e894484bca865431c48f4fa92c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfae0c6e894484bca865431c48f4fa92c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfae0c6e894484bca865431c48f4fa92c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfae0c6e894484bca865431c48f4fa92c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfae0c6e894484bca865431c48f4fa92c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfae0c6e894484bca865431c48f4fa92c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfae0c6e894484bca865431c48f4fa92c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfae0c6e894484bca865431c48f4fa92c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfae0c6e894484bca865431c48f4fa92c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfae0c6e894484bca865431c48f4fa92c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idaa8f0a4b23f448fb97271f7f465ea3c9" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading134" runat="server" Text="Extensions" /></legend>
				
				
				<div data-column-count="10" data-column-ratio="4:20:10:10:11:7:9:12:7:10" data-layout="" class="clearfix form-horizontal">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label336">
		<span class="label" id="label336">Time Excess</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label337">
		<span class="label" id="label337">Hospitalisation Period</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label338">
		<span class="label" id="label338">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label339">
		<span class="label" id="label339">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label340">
		<span class="label" id="label340">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label341">
		<span class="label" id="label341">Posting Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label342">
		<span class="label" id="label342">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label343">
		<span class="label" id="label343">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label344">
		<span class="label" id="label344">HIV Accidental Exposure </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label345">
		<span class="label" id="label345"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label346">
		<span class="label" id="label346"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-EMPDE-HIVRATE">
		<asp:Label ID="lblEMPDE_HIVRATE" runat="server" AssociatedControlID="EMPDE__HIVRATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EMPDE__HIVRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEMPDE_HIVRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.HIVRATE"
			ClientValidationFunction="onValidate_EMPDE__HIVRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-HIVAPPREM">
		<asp:Label ID="lblEMPDE_HIVAPPREM" runat="server" AssociatedControlID="EMPDE__HIVAPPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__HIVAPPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_HIVAPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.HIVAPPREM"
			ClientValidationFunction="onValidate_EMPDE__HIVAPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-HIVAPREM">
		<asp:Label ID="lblEMPDE_HIVAPREM" runat="server" AssociatedControlID="EMPDE__HIVAPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__HIVAPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_HIVAPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.HIVAPREM"
			ClientValidationFunction="onValidate_EMPDE__HIVAPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label347">
		<span class="label" id="label347"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label349">
		<span class="label" id="label349">Hospitalisation </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_HSPTMEX" runat="server" AssociatedControlID="EMPDE__HSPTMEX" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__HSPTMEX" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_HSPPERIOD" runat="server" AssociatedControlID="EMPDE__HSPPERIOD" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__HSPPERIOD" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-EMPDE-HSPRATE">
		<asp:Label ID="lblEMPDE_HSPRATE" runat="server" AssociatedControlID="EMPDE__HSPRATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EMPDE__HSPRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEMPDE_HSPRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.HSPRATE"
			ClientValidationFunction="onValidate_EMPDE__HSPRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-HSPPREM">
		<asp:Label ID="lblEMPDE_HSPPREM" runat="server" AssociatedControlID="EMPDE__HSPPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__HSPPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_HSPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.HSPPREM"
			ClientValidationFunction="onValidate_EMPDE__HSPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-HSPREM">
		<asp:Label ID="lblEMPDE_HSPREM" runat="server" AssociatedControlID="EMPDE__HSPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__HSPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_HSPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.HSPREM"
			ClientValidationFunction="onValidate_EMPDE__HSPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label352">
		<span class="label" id="label352">Serious Illness</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_SRSTMEX" runat="server" AssociatedControlID="EMPDE__SRSTMEX" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__SRSTMEX" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-EMPDE-SRSRATE">
		<asp:Label ID="lblEMPDE_SRSRATE" runat="server" AssociatedControlID="EMPDE__SRSRATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EMPDE__SRSRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEMPDE_SRSRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.SRSRATE"
			ClientValidationFunction="onValidate_EMPDE__SRSRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-SRSPPREM">
		<asp:Label ID="lblEMPDE_SRSPPREM" runat="server" AssociatedControlID="EMPDE__SRSPPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__SRSPPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_SRSPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.SRSPPREM"
			ClientValidationFunction="onValidate_EMPDE__SRSPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-SRSPREM">
		<asp:Label ID="lblEMPDE_SRSPREM" runat="server" AssociatedControlID="EMPDE__SRSPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__SRSPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_SRSPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.SRSPREM"
			ClientValidationFunction="onValidate_EMPDE__SRSPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label354">
		<span class="label" id="label354">Temporary Total Disablement - Sickness </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblEMPDE_TTDTMEX" runat="server" AssociatedControlID="EMPDE__TTDTMEX" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TTDTMEX" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-EMPDE-TTDRATE">
		<asp:Label ID="lblEMPDE_TTDRATE" runat="server" AssociatedControlID="EMPDE__TTDRATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EMPDE__TTDRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEMPDE_TTDRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TTDRATE"
			ClientValidationFunction="onValidate_EMPDE__TTDRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label356">
		<span class="label" id="label356">War Risk </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label360">
		<span class="label" id="label360"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-WRPPREM">
		<asp:Label ID="lblEMPDE_WRPPREM" runat="server" AssociatedControlID="EMPDE__WRPPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__WRPPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_WRPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.WRPPREM"
			ClientValidationFunction="onValidate_EMPDE__WRPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EMPDE-WRPREM">
		<asp:Label ID="lblEMPDE_WRPREM" runat="server" AssociatedControlID="EMPDE__WRPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__WRPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_WRPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.WRPREM"
			ClientValidationFunction="onValidate_EMPDE__WRPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label364">
		<span class="label" id="label364">Total</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label368">
		<span class="label" id="label368"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="TOT_EXTPREM" 
		id="pb-container-currency-EMPDE-TOT_EXTPREM">
		<asp:Label ID="lblEMPDE_TOT_EXTPREM" runat="server" AssociatedControlID="EMPDE__TOT_EXTPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TOT_EXTPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TOT_EXTPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TOT_EXTPREM"
			ClientValidationFunction="onValidate_EMPDE__TOT_EXTPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
	...
	<span class="field-container"
		...
		id="pb-container-checkbox-EMPDE-Temp_Hide"
	>
		<label id="ctl00_cntMainBody_lblEMPDE_Temp_Hide" for="ctl00_cntMainBody_EMPDE_Temp_Hide_select">Temprarily hide Assistance Services until needed</label>
		<input id="ctl00_cntMainBody_EMPDE_Temp_Hide" class="field-medium hidden" />
			<asp:CustomValidator ID="valEMPDE_Temp_Hide" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Temprarily hide Assistance Services until needed"
			ClientValidationFunction="onValidate_EMPDE__Temp_Hide" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"
		/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idaa8f0a4b23f448fb97271f7f465ea3c9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idaa8f0a4b23f448fb97271f7f465ea3c9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idaa8f0a4b23f448fb97271f7f465ea3c9 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idaa8f0a4b23f448fb97271f7f465ea3c9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idaa8f0a4b23f448fb97271f7f465ea3c9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaa8f0a4b23f448fb97271f7f465ea3c9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaa8f0a4b23f448fb97271f7f465ea3c9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idaa8f0a4b23f448fb97271f7f465ea3c9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaa8f0a4b23f448fb97271f7f465ea3c9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaa8f0a4b23f448fb97271f7f465ea3c9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmGPAAS" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading135" runat="server" Text="Assistance Services" /></legend>
	...
	<span id="pb-container-label-label372">
		<span class="label" id="label372"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label374">
		<span class="label" id="label374">No of Employees</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label375">
		<span class="label" id="label375">Premium per Person</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label376">
		<span class="label" id="label376">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label377">
		<span class="label" id="label377">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label378">
		<span class="label" id="label378">HIV/Aids Assistance</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label379">
		<span class="label" id="label379">Accidental Expert Assistance</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label380">
		<span class="label" id="label380"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label381">
		<span class="label" id="label381">Total</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="label385" 
		id="pb-container-currency-EMPDE-label385">
		<asp:Label ID="lblEMPDE_label385" runat="server" AssociatedControlID="EMPDE__label385" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__label385" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_label385" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.label385"
			ClientValidationFunction="onValidate_EMPDE__label385" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmGPAAS div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmGPAAS div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmGPAAS div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmGPAAS label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmGPAAS label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmGPAAS label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmGPAAS label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmGPAAS input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmGPAAS input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmGPAAS input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading136" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblEMPDE_EMPDE_CLAUSES" runat="server" AssociatedControlID="EMPDE__EMPDE_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="EMPDE__EMPDE_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="EMPDE" 
		data-property-name="EMPDE_COUNT" 
		id="pb-container-integer-EMPDE-EMPDE_COUNT">
		<asp:Label ID="lblEMPDE_EMPDE_COUNT" runat="server" AssociatedControlID="EMPDE__EMPDE_COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="EMPDE__EMPDE_COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valEMPDE_EMPDE_COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.EMPDE_COUNT"
			ClientValidationFunction="onValidate_EMPDE__EMPDE_COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EMPDE__GPAENDOS"
		data-field-type="Child" 
		data-object-name="EMPDE" 
		data-property-name="GPAENDOS" 
		id="pb-container-childscreen-EMPDE-GPAENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EMPDE__GPA_ENDOSE" runat="server" ScreenCode="GPAENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GPAENDOS/GPAENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valEMPDE_GPAENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for EMPDE.GPAENDOS"
						ClientValidationFunction="onValidate_EMPDE__GPAENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="EMPDE" 
		data-property-name="EMP_END_CNT" 
		id="pb-container-integer-EMPDE-EMP_END_CNT">
		<asp:Label ID="lblEMPDE_EMP_END_CNT" runat="server" AssociatedControlID="EMPDE__EMP_END_CNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="EMPDE__EMP_END_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valEMPDE_EMP_END_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.EMP_END_CNT"
			ClientValidationFunction="onValidate_EMPDE__EMP_END_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id09e46ab017e545cb9d2771a4a7fab5ad" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading137" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EMPDE__GPASNOTE"
		data-field-type="Child" 
		data-object-name="EMPDE" 
		data-property-name="GPASNOTE" 
		id="pb-container-childscreen-EMPDE-GPASNOTE">
		
		    <legend>Notes (Printed On Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EMPDE__GPANOTES" runat="server" ScreenCode="GPASNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GPASNOTE/GPASNOTE_Notes_Detials.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEMPDE_GPASNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Printed On Schedule)"
						ClientValidationFunction="onValidate_EMPDE__GPASNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="EMPDE" 
		data-property-name="GPA_NTS_CNT" 
		id="pb-container-integer-EMPDE-GPA_NTS_CNT">
		<asp:Label ID="lblEMPDE_GPA_NTS_CNT" runat="server" AssociatedControlID="EMPDE__GPA_NTS_CNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="EMPDE__GPA_NTS_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valEMPDE_GPA_NTS_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.GPA_NTS_CNT"
			ClientValidationFunction="onValidate_EMPDE__GPA_NTS_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id09e46ab017e545cb9d2771a4a7fab5ad div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id09e46ab017e545cb9d2771a4a7fab5ad div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id09e46ab017e545cb9d2771a4a7fab5ad div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id09e46ab017e545cb9d2771a4a7fab5ad label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id09e46ab017e545cb9d2771a4a7fab5ad label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id09e46ab017e545cb9d2771a4a7fab5ad label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id09e46ab017e545cb9d2771a4a7fab5ad label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id09e46ab017e545cb9d2771a4a7fab5ad input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id09e46ab017e545cb9d2771a4a7fab5ad input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id09e46ab017e545cb9d2771a4a7fab5ad input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id91967645b1234146b454b0d4d8ee3843" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading138" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EMPDE__GPANOTE"
		data-field-type="Child" 
		data-object-name="EMPDE" 
		data-property-name="GPANOTE" 
		id="pb-container-childscreen-EMPDE-GPANOTE">
		
		    <legend>Notes (Not Printed On Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EMPDE__GPASNOTES" runat="server" ScreenCode="GPANOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GPANOTE/GPANOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEMPDE_GPANOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Not Printed On Schedule)"
						ClientValidationFunction="onValidate_EMPDE__GPANOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id91967645b1234146b454b0d4d8ee3843 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id91967645b1234146b454b0d4d8ee3843 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id91967645b1234146b454b0d4d8ee3843 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id91967645b1234146b454b0d4d8ee3843 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id91967645b1234146b454b0d4d8ee3843 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id91967645b1234146b454b0d4d8ee3843 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id91967645b1234146b454b0d4d8ee3843 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id91967645b1234146b454b0d4d8ee3843 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id91967645b1234146b454b0d4d8ee3843 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id91967645b1234146b454b0d4d8ee3843 input{text-align:left;}"; break;
		}
	}
