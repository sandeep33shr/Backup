<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EQSNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_EQSNOTES_Note_Details" %>
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "EESNOTE_DETAILS" && field.getPropertyName() == "Date_Created")
...
<div id="idbbc1b05b0da548d688aaeeaa22a9bb5f" class="general-layout-container">
...
<div id="id8a826dc785754ec0a09c31bf59e5fcb8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading200" runat="server" Text="Note Detail (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8a826dc785754ec0a09c31bf59e5fcb8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8a826dc785754ec0a09c31bf59e5fcb8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8a826dc785754ec0a09c31bf59e5fcb8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8a826dc785754ec0a09c31bf59e5fcb8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8a826dc785754ec0a09c31bf59e5fcb8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8a826dc785754ec0a09c31bf59e5fcb8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8a826dc785754ec0a09c31bf59e5fcb8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8a826dc785754ec0a09c31bf59e5fcb8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8a826dc785754ec0a09c31bf59e5fcb8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8a826dc785754ec0a09c31bf59e5fcb8 input{text-align:left;}"; break;
		}
	}
