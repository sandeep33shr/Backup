...
Namespace Nexus
    Partial Class PB2_CMAMISC_Money : Inherits BaseRisk
		...
		Protected Sub onValidate_MONEY__RISKATTACHDATE()
        
        
End Sub
Protected Sub onValidate_MONEY__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MONEY__RISKATTACHDATE()
    onValidate_MONEY__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If MONEY__RISKATTACHDATE.Text = "" or MONEY__RISKATTACHDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			MONEY__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			MONEY__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (MONEY__RISKATTACHDATE.Text <> "" Or MONEY__RISKATTACHDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		MONEY__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		MONEY__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		MONEY__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
