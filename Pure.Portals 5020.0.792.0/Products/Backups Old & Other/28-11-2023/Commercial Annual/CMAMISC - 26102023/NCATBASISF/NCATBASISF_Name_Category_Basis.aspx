...
function onValidate_GUAR__CAT_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GUAR", "CAT_SUMINSURED");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GUAR.CAT_PPREM.setValue(GUAR.CAT_SUMINSURED * GUAR.CAT_RATE * 0.01)");
        		var whenExp = (Expression.isValidParameter("GUAR.CAT_RATE>0")) ? new Expression("GUAR.CAT_RATE>0") : null;
        		var elseExp = Expression.isValidParameter("GUAR.CAT_PPREM") ? new Expression("GUAR.CAT_PPREM") : null;
...
function onValidate_GUAR__CAT_PPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GUAR.CAT_RATE.setValue(GUAR.CAT_PPREM/GUAR.CAT_SUMINSURED*100)");
...
<div id="id0e0a1678b8ab4fc09e406aa744963601" class="general-layout-container">
...
<div id="idc5ff11fe77d540f0b93d04fc81a6b60a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc5ff11fe77d540f0b93d04fc81a6b60a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc5ff11fe77d540f0b93d04fc81a6b60a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc5ff11fe77d540f0b93d04fc81a6b60a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc5ff11fe77d540f0b93d04fc81a6b60a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc5ff11fe77d540f0b93d04fc81a6b60a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc5ff11fe77d540f0b93d04fc81a6b60a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc5ff11fe77d540f0b93d04fc81a6b60a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc5ff11fe77d540f0b93d04fc81a6b60a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc5ff11fe77d540f0b93d04fc81a6b60a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc5ff11fe77d540f0b93d04fc81a6b60a input{text-align:left;}"; break;
		}
	}
