...
Namespace Nexus
    Partial Class PB2_CMAMISC_Consequential_Loss : Inherits BaseRisk
		...
		Protected Sub onValidate_CLOSS__ATTACHMENTDATE()
        
        
End Sub
Protected Sub onValidate_CLOSS__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CLOSS__ATTACHMENTDATE()
    onValidate_CLOSS__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If CLOSS__ATTACHMENTDATE.Text = "" or CLOSS__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			CLOSS__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			CLOSS__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (CLOSS__ATTACHMENTDATE.Text <> "" Or CLOSS__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		CLOSS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		CLOSS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		CLOSS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
