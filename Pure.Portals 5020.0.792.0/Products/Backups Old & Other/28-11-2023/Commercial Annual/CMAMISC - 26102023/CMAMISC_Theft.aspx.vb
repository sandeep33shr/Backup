...
Namespace Nexus
    Partial Class PB2_CMAMISC_Theft : Inherits BaseRisk
		...
		Protected Sub onValidate_THEFT__RISK_ATTACH_DATE()
        
        
End Sub
Protected Sub onValidate_THEFT__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_THEFT__RISK_ATTACH_DATE()
    onValidate_THEFT__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If THEFT__RISK_ATTACH_DATE.Text = "" or THEFT__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			THEFT__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			THEFT__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (THEFT__RISK_ATTACH_DATE.Text <> "" Or THEFT__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		THEFT__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		THEFT__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		THEFT__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
