...
function onValidate_GENERAL__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Motor section details'"), 
...
function onValidate_GENERAL__UW_CRITE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "UW_CRITE", "Integer");
        })();
        /**
         * Set the field width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('GENERAL', 'UW_CRITE');
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.UW_CRITE");
        			window.setControlWidth(field, "0.2", "GENERAL", "UW_CRITE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_UW_CRITE");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__UW_CRITE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__UW_CRITE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CLAIM_HISTORY__MS0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.MS0_12_AMOUNT.setValue('')");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.MS0_12_AMOUNT.setValue(0)");
        		var whenExp = (Expression.isValidParameter("CLAIM_HISTORY.MS0_12_MONTHSCode = 1 OR CLAIM_HISTORY.MS0_12_MONTHSCode = 2")) ? new Expression("CLAIM_HISTORY.MS0_12_MONTHSCode = 1 OR CLAIM_HISTORY.MS0_12_MONTHSCode = 2") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__MS13_24_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.MS13_24_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.MS13_24_AMOUNT.setValue(0)");
        		var whenExp = (Expression.isValidParameter("CLAIM_HISTORY.MS13_24_MONTHSCode = 1 OR CLAIM_HISTORY.MS13_24_MONTHSCode = 2")) ? new Expression("CLAIM_HISTORY.MS13_24_MONTHSCode = 1 OR CLAIM_HISTORY.MS13_24_MONTHSCode = 2") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__MS25_36_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.MS25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.MS25_36_AMOUNT.setValue(0)");
        		var whenExp = (Expression.isValidParameter("CLAIM_HISTORY.MS25_36_MONTHSCode = 1 OR CLAIM_HISTORY.MS25_36_MONTHSCode = 2")) ? new Expression("CLAIM_HISTORY.MS25_36_MONTHSCode = 1 OR CLAIM_HISTORY.MS25_36_MONTHSCode = 2") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__UW_CRITE(null, null, null, isOnLoad);
...
<div id="ida925f41e831742be8db719357bd679e8" class="general-layout-container">
...
<div id="id99cfe06ea68e4704a089c08470b91f1a" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id99cfe06ea68e4704a089c08470b91f1a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id99cfe06ea68e4704a089c08470b91f1a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id99cfe06ea68e4704a089c08470b91f1a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id99cfe06ea68e4704a089c08470b91f1a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id99cfe06ea68e4704a089c08470b91f1a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id99cfe06ea68e4704a089c08470b91f1a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id99cfe06ea68e4704a089c08470b91f1a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id99cfe06ea68e4704a089c08470b91f1a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id99cfe06ea68e4704a089c08470b91f1a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id99cfe06ea68e4704a089c08470b91f1a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3d7bab6d33c04c53ac62fe6ab805fe8a" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-GENERAL-UW_CRITE">
		<asp:Label ID="lblGENERAL_UW_CRITE" runat="server" AssociatedControlID="GENERAL__UW_CRITE" 
			Text="Number of Vehicles on Policy " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="GENERAL__UW_CRITE" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valGENERAL_UW_CRITE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Number of Vehicles on Policy "
			ClientValidationFunction="onValidate_GENERAL__UW_CRITE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3d7bab6d33c04c53ac62fe6ab805fe8a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3d7bab6d33c04c53ac62fe6ab805fe8a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3d7bab6d33c04c53ac62fe6ab805fe8a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3d7bab6d33c04c53ac62fe6ab805fe8a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3d7bab6d33c04c53ac62fe6ab805fe8a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3d7bab6d33c04c53ac62fe6ab805fe8a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3d7bab6d33c04c53ac62fe6ab805fe8a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3d7bab6d33c04c53ac62fe6ab805fe8a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3d7bab6d33c04c53ac62fe6ab805fe8a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3d7bab6d33c04c53ac62fe6ab805fe8a input{text-align:left;}"; break;
		}
	}
...
<div id="frmClaims History" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Past Claims History" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CLAIM_HISTORY-MS0_12_MONTHSCode">

		
		
			
		
				<asp:HiddenField ID="CLAIM_HISTORY__MS0_12_MONTHSCode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-suffix-none="true" 
		id="pb-container-text-CLAIM_HISTORY-MS13_24_MONTHSCode">

		
		
			
		
				<asp:HiddenField ID="CLAIM_HISTORY__MS13_24_MONTHSCode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-suffix-none="true" 
		id="pb-container-text-CLAIM_HISTORY-MS25_36_MONTHSCode">

		
		
			
		
				<asp:HiddenField ID="CLAIM_HISTORY__MS25_36_MONTHSCode" runat="server" />
