<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLPDSNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_CLPDSNOTES_Note_Details" %>
...
function onValidate_PDSNOTE_DETAILS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PDSNOTE_DETAILS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PDSNOTE_DETAILS", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PDSNOTE_DETAILS.DATE_CREATED");
        			window.setControlWidth(field, "0.7", "PDSNOTE_DETAILS", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPDSNOTE_DETAILS_DATE_CREATED");
        			    var ele = document.getElementById('ctl00_cntMainBody_PDSNOTE_DETAILS__DATE_CREATED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PDSNOTE_DETAILS__DATE_CREATED_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=PDSNOTE_DETAILS&propertyName=DATE_CREATED&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "PDSNOTE_DETAILS" && field.getPropertyName() == "DATE_CREATED")
...
function onValidate_PDSNOTE_DETAILS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PDSNOTE_DETAILS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PDSNOTE_DETAILS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PDSNOTE_DETAILS.CREATED_BY");
        			window.setControlWidth(field, "0.7", "PDSNOTE_DETAILS", "CREATED_BY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPDSNOTE_DETAILS_CREATED_BY");
        			    var ele = document.getElementById('ctl00_cntMainBody_PDSNOTE_DETAILS__CREATED_BY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PDSNOTE_DETAILS__CREATED_BY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PDSNOTE_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PDSNOTE_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("PDSNOTE_DETAILS", "COVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PDSNOTE_DETAILS.COVER_TYPE");
        			window.setControlWidth(field, "0.7", "PDSNOTE_DETAILS", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPDSNOTE_DETAILS_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_PDSNOTE_DETAILS__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PDSNOTE_DETAILS__COVER_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=PDSNOTE_DETAILS&propertyName=COVER_TYPE&name={name}");
...
function onValidate_PDSNOTE_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PDSNOTE_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PDSNOTE_DETAILS", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PDSNOTE_DETAILS.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.7", "PDSNOTE_DETAILS", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPDSNOTE_DETAILS_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_PDSNOTE_DETAILS__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PDSNOTE_DETAILS__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PDSNOTE_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PDSNOTE_DETAILS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PDSNOTE_DETAILS", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PDSNOTE_DETAILS.NOTE_DETAILS");
        			window.setControlWidth(field, "0.7", "PDSNOTE_DETAILS", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPDSNOTE_DETAILS_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_PDSNOTE_DETAILS__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PDSNOTE_DETAILS__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=PDSNOTE_DETAILS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_PDSNOTE_DETAILS_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_PDSNOTE_DETAILS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_PDSNOTE_DETAILS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_PDSNOTE_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_PDSNOTE_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_PDSNOTE_DETAILS__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="idb159d377971c4723a72321007556458d" class="general-layout-container">
...
<div id="id4c264da44fc147dc80558177a7770eb8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading115" runat="server" Text="Note Details (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PDSNOTE_DETAILS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-PDSNOTE_DETAILS-DATE_CREATED">
		<asp:Label ID="lblPDSNOTE_DETAILS_DATE_CREATED" runat="server" AssociatedControlID="PDSNOTE_DETAILS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="PDSNOTE_DETAILS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calPDSNOTE_DETAILS__DATE_CREATED" runat="server" LinkedControl="PDSNOTE_DETAILS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valPDSNOTE_DETAILS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_PDSNOTE_DETAILS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PDSNOTE_DETAILS-CREATED_BY">

		
		<asp:Label ID="lblPDSNOTE_DETAILS_CREATED_BY" runat="server" AssociatedControlID="PDSNOTE_DETAILS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PDSNOTE_DETAILS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPDSNOTE_DETAILS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_PDSNOTE_DETAILS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PDSNOTE_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblPDSNOTE_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="PDSNOTE_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PDSNOTE_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPDSNOTE_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_PDSNOTE_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PDSNOTE_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblPDSNOTE_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="PDSNOTE_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PDSNOTE_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPDSNOTE_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_PDSNOTE_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-PDSNOTE_DETAILS-NOTE_DETAILS">
		<asp:Label ID="lblPDSNOTE_DETAILS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="PDSNOTE_DETAILS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="PDSNOTE_DETAILS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valPDSNOTE_DETAILS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_PDSNOTE_DETAILS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4c264da44fc147dc80558177a7770eb8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4c264da44fc147dc80558177a7770eb8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4c264da44fc147dc80558177a7770eb8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4c264da44fc147dc80558177a7770eb8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4c264da44fc147dc80558177a7770eb8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4c264da44fc147dc80558177a7770eb8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4c264da44fc147dc80558177a7770eb8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4c264da44fc147dc80558177a7770eb8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4c264da44fc147dc80558177a7770eb8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4c264da44fc147dc80558177a7770eb8 input{text-align:left;}"; break;
		}
	}
