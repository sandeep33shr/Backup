...
Namespace Nexus
    Partial Class PB2_CMALIAB_Risk_Selection : Inherits BaseRisk
...
End Sub
        ...
        Protected Shadows Sub SetFileCount(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If (value <> FileCnt) Then
        		GENERAL__CHECK_CYBER.Value = ""
        		GENERAL__CHECK_EMPLOYERS.Value = ""
        		GENERAL__CHECK_COMBINED.Value = ""
        		GENERAL__CHECK_DNO.Value = ""
        		GENERAL__CHECK_PUBLIC.Value = ""
