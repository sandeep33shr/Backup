...
function onValidate_GENERAL__isNBTempStatus(source, args, sender, isOnLoad) {
        ...
        /** 
         * ToggleContainer
         * @param frmCoverSelection The element to toggle
        ...
        (function(){
        	...
        	if (isOnLoad) {
        		...
        		var update = function(){
        			...
        			if (!inverse){
        				(new Expression("SetElementDisplay('frmCoverSelection', !!" + value + ")")).valueOf();
        			} else {
        				(new Expression("SetElementDisplay('frmCoverSelection', !" + value + ")")).valueOf();
        			}
        		};
        		events.listen(Field.getInstance("GENERAL", "isNBTempStatus"), "change", update);
        		update();
        	}
...
function onValidate_GENERAL__IS_CYBER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.CHECK_CYBERCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')")) ? new Expression("(GENERAL.CHECK_CYBERCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__IS_EMPLOYERS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.CHECK_EMPLOYERSCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')")) ? new Expression("(GENERAL.CHECK_EMPLOYERSCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__IS_COMBINED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.CHECK_COMBINEDCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')")) ? new Expression("(GENERAL.CHECK_COMBINEDCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__IS_DNO(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.CHECK_DNOCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')")) ? new Expression("(GENERAL.CHECK_DNOCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__IS_PUBLIC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.CHECK_PUBLICCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')")) ? new Expression("(GENERAL.CHECK_PUBLICCode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__IS_FARE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.CHECK_FARECode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')")) ? new Expression("(GENERAL.CHECK_FARECode =='ADD')&& (GENERAL.TRANSTYPE =='MTA' || GENERAL.TRANSTYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
<div id="idae6a1b2fa7a441e4894e2e94d681e898" class="general-layout-container">
...
<div id="id2b8bddbda9b241dfa2900e31f943be4b" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2b8bddbda9b241dfa2900e31f943be4b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2b8bddbda9b241dfa2900e31f943be4b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2b8bddbda9b241dfa2900e31f943be4b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2b8bddbda9b241dfa2900e31f943be4b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2b8bddbda9b241dfa2900e31f943be4b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b8bddbda9b241dfa2900e31f943be4b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b8bddbda9b241dfa2900e31f943be4b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2b8bddbda9b241dfa2900e31f943be4b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b8bddbda9b241dfa2900e31f943be4b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b8bddbda9b241dfa2900e31f943be4b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id526c517251104f36a2ffc1f7aa0268ae" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id526c517251104f36a2ffc1f7aa0268ae div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id526c517251104f36a2ffc1f7aa0268ae div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id526c517251104f36a2ffc1f7aa0268ae div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id526c517251104f36a2ffc1f7aa0268ae label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id526c517251104f36a2ffc1f7aa0268ae label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id526c517251104f36a2ffc1f7aa0268ae label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id526c517251104f36a2ffc1f7aa0268ae label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id526c517251104f36a2ffc1f7aa0268ae input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id526c517251104f36a2ffc1f7aa0268ae input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id526c517251104f36a2ffc1f7aa0268ae input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7d4bb78bf71549708d3b816af65415fc" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7d4bb78bf71549708d3b816af65415fc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7d4bb78bf71549708d3b816af65415fc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7d4bb78bf71549708d3b816af65415fc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7d4bb78bf71549708d3b816af65415fc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7d4bb78bf71549708d3b816af65415fc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7d4bb78bf71549708d3b816af65415fc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7d4bb78bf71549708d3b816af65415fc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7d4bb78bf71549708d3b816af65415fc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7d4bb78bf71549708d3b816af65415fc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7d4bb78bf71549708d3b816af65415fc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id334cb9f35ef94160aace6fba3b6988df" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id334cb9f35ef94160aace6fba3b6988df div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id334cb9f35ef94160aace6fba3b6988df div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id334cb9f35ef94160aace6fba3b6988df div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id334cb9f35ef94160aace6fba3b6988df label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id334cb9f35ef94160aace6fba3b6988df label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id334cb9f35ef94160aace6fba3b6988df label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id334cb9f35ef94160aace6fba3b6988df label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id334cb9f35ef94160aace6fba3b6988df input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id334cb9f35ef94160aace6fba3b6988df input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id334cb9f35ef94160aace6fba3b6988df input{text-align:left;}"; break;
		}
	}
