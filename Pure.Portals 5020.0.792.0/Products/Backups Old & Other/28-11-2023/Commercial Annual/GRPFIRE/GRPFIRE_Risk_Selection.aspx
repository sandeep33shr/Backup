<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="GRPFIRE_Risk_Selection.aspx.vb" Inherits="Nexus.PB2_GRPFIRE_Risk_Selection" %>
...
function onValidate_RISK_SELECTION__FIRE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=RISK_SELECTION&propertyName=FIRE&name={name}");
        		
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_FIRECode =='ADD')&& (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_FIRECode =='ADD')&& (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("false"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_FIRECode =='DELETE')&& (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_FIRECode =='DELETE')&& (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var exp = new Expression("(RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')) || ((GENERAL.IS_FIRECode =='ADD' ||GENERAL.IS_FIRECode =='VIEW') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))");
        		var update = function(){
        			if (exp.getValue() == true)
        				ShowTab("4");
        			else
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.FIRE0_12_MONTHS.setValue('')||CLAIM_HISTORY.FIRE0_12_AMOUNT.setValue('')||CLAIM_HISTORY.FIRE13_24_MONTHS.setValue('')||CLAIM_HISTORY.FIRE13_24_AMOUNT.setValue('')||CLAIM_HISTORY.FIRE25_36_MONTHS.setValue('')||CLAIM_HISTORY.FIRE25_36_AMOUNT.setValue('')");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "(GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')", "VE", "{3}");
        
            var paramValue = "V",
            paramCondition = "(GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')",
            paramElseValue = "VE",
...
function onValidate_RISK_SELECTION__BUILDINGS_COMB(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=RISK_SELECTION&propertyName=BUILDINGS_COMB&name={name}");
        		
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_BCCode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_BCCode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("false"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_BCCode =='DELETE') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_BCCode =='DELETE') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var exp = new Expression("(RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')) || ((GENERAL.IS_BCCode =='ADD' || GENERAL.IS_BCCode =='VIEW') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))");
        		var update = function(){
        			if (exp.getValue() == true)
        				ShowTab("5");
        			else
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.BC0_12_MONTHS.setValue('')||CLAIM_HISTORY.BC0_12_AMOUNT.setValue('')||CLAIM_HISTORY.BC13_24_MONTHS.setValue('')||CLAIM_HISTORY.BC13_24_AMOUNT.setValue('')||CLAIM_HISTORY.BC25_36_MONTHS.setValue('')||CLAIM_HISTORY.BC25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "R", "(GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')", "VE", "{3}");
...
function onValidate_RISK_SELECTION__OFFICE_CONT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=RISK_SELECTION&propertyName=OFFICE_CONT&name={name}");
        		
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_OCCode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_OCCode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("false"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_OCCode =='DELETE') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_OCCode =='DELETE') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var exp = new Expression("(RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')) ||((GENERAL.IS_OCCode =='ADD' || GENERAL.IS_OCCode =='VIEW')  && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))");
        		var update = function(){
        			if (exp.getValue() == true)
        				ShowTab("6");
        			else
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.OC0_12_MONTHS.setValue('')||CLAIM_HISTORY.OC0_12_AMOUNT.setValue('')||CLAIM_HISTORY.OC13_24_MONTHS.setValue('')||CLAIM_HISTORY.OC13_24_AMOUNT.setValue('')||CLAIM_HISTORY.OC25_36_MONTHS.setValue('')||CLAIM_HISTORY.OC25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_RISK_SELECTION__BI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "(RISK_SELECTION.FIRE == true ||RISK_SELECTION.BUILDINGS_COMB == true || RISK_SELECTION.OFFICE_CONT == true) && (GENERAL.TRANSACTION_TYPE =='NB')", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "(RISK_SELECTION.FIRE == true ||RISK_SELECTION.BUILDINGS_COMB == true || RISK_SELECTION.OFFICE_CONT == true) && (GENERAL.TRANSACTION_TYPE =='NB')",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=RISK_SELECTION&propertyName=BI&name={name}");
        		
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_BICode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_BICode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("false"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_BICode =='DELETE' ) && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_BICode =='DELETE' ) && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("false"), 
        			condition = (Expression.isValidParameter("RISK_SELECTION.FIRE == false AND RISK_SELECTION.BUILDINGS_COMB == false AND RISK_SELECTION.OFFICE_CONT == false ")) ? new Expression("RISK_SELECTION.FIRE == false AND RISK_SELECTION.BUILDINGS_COMB == false AND RISK_SELECTION.OFFICE_CONT == false ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var exp = new Expression("(RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')) || ((GENERAL.IS_BICode =='ADD' || GENERAL.IS_BICode =='VIEW' ) && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))");
        		var update = function(){
        			if (exp.getValue() == true)
        				ShowTab("7");
        			else
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.BI0_12_MONTHS.setValue('')||CLAIM_HISTORY.BI0_12_AMOUNT.setValue('')||CLAIM_HISTORY.BI13_24_MONTHS.setValue('')||CLAIM_HISTORY.BI13_24_AMOUNT.setValue('')||CLAIM_HISTORY.BI25_36_MONTHS.setValue('')||CLAIM_HISTORY.BI25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "(GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')", "V", "{3}");
...
function onValidate_RISK_SELECTION__ACCOUNT_RECEIVE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "ACCOUNT_RECEIVE", "Checkbox");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=RISK_SELECTION&propertyName=ACCOUNT_RECEIVE&name={name}");
        		
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_ARCode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_ARCode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRISK_SELECTION_ACCOUNT_RECEIVE");
        			    var ele = document.getElementById('ctl00_cntMainBody_RISK_SELECTION__ACCOUNT_RECEIVE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISK_SELECTION__ACCOUNT_RECEIVE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("false"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_ARCode =='DELETE') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_ARCode =='DELETE') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("RISK_SELECTION.ACCOUNT_RECEIVE");
        		var update = function(){
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var exp = new Expression("(RISK_SELECTION.ACCOUNT_RECEIVE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN'))||((GENERAL.IS_ARCode =='ADD' || GENERAL.IS_ARCode =='VIEW')&& (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))");
        		var update = function(){
        			if (exp.getValue() == true)
        				ShowTab("8");
        			else
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.AR0_12_MONTHS.setValue('')||CLAIM_HISTORY.AR0_12_AMOUNT.setValue('')||CLAIM_HISTORY.AR13_24_MONTHS.setValue('')||CLAIM_HISTORY.AR13_24_AMOUNT.setValue('')||CLAIM_HISTORY.AR25_36_MONTHS.setValue('')||CLAIM_HISTORY.AR25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "ACCOUNT_RECEIVE");
        		}
        		//window.setProperty(field, "V", "(GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')", "VE", "{3}");
...
function onValidate_RISK_SELECTION__ACCIDENTAL_DAMAGE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=RISK_SELECTION&propertyName=ACCIDENTAL_DAMAGE&name={name}");
        		
        		var value = new Expression("true"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_ADCode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_ADCode =='ADD') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("false"), 
        			condition = (Expression.isValidParameter("(GENERAL.IS_ADCode =='DELETE') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("(GENERAL.IS_ADCode =='DELETE') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var exp = new Expression("(RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN'))||((GENERAL.IS_ADCode =='ADD' ||GENERAL.IS_ADCode =='VIEW') && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))");
        		var update = function(){
        			if (exp.getValue() == true)
        				ShowTab("9");
        			else
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.AC0_12_MONTHS.setValue('')||CLAIM_HISTORY.AC0_12_AMOUNT.setValue('')||CLAIM_HISTORY.AC13_24_MONTHS.setValue('')||CLAIM_HISTORY.AC13_24_AMOUNT.setValue('')||CLAIM_HISTORY.AC25_36_MONTHS.setValue('')||CLAIM_HISTORY.AC25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "POLICYTYPE");
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Either Fire or Buildings Combined or Office Contents or Accounts Receivable must be selected to proceed")) ? "Either Fire or Buildings Combined or Office Contents or Accounts Receivable must be selected to proceed" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISK_SELECTION".toUpperCase() + "__" + "POLICYTYPE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISK_SELECTION".toUpperCase() + "_" + "POLICYTYPE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("RISK_SELECTION.FIRE== true || RISK_SELECTION.BUILDINGS_COMB == true || RISK_SELECTION.OFFICE_CONT == true || RISK_SELECTION.ACCOUNT_RECEIVE == true");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISK_SELECTION__TRANSTYPETemp(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "TRANSTYPETemp", "TempCheckbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_SELECTION", "TRANSTYPETemp");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=TempCheckbox&objectName=RISK_SELECTION&propertyName=TRANSTYPETemp&name={name}");
        		
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN'")) ? new Expression("GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN'") : null, 
...
function onValidate_RISK_SELECTION__LIMIT_NO(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "LIMIT_NO");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=RISK_SELECTION&propertyName=LIMIT_NO&name={name}");
        		
        		var value = new Expression("GENERAL.REINSURANCE_LIMIT"), 
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "MANUAL_LIMIT_NO");
        		}
...
function onValidate_RISK_SELECTION__BRIGADE_AREA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "BRIGADE_AREA");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=RISK_SELECTION&propertyName=BRIGADE_AREA&name={name}");
        		
        		var value = new Expression("ADDRESS.AREACODE"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "TYPE_OF_CONST");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_RISK_SELECTION__APPLICABLE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "APPLICABLE");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("RISK_SELECTION.DATE_LASTSURVEY.setValue('')||RISK_SELECTION.SURVEY_NUMBER.setValue('')||RISK_SELECTION.DATE_SUR_REQ.setValue('')||RISK_SELECTION.FREQUENCY.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_RISK_SELECTION__DATE_LASTSURVEY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "DATE_LASTSURVEY");
        		}
        		//window.setProperty(field, "VE", "RISK_SELECTION.APPLICABLE == 1", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "RISK_SELECTION.APPLICABLE == 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Last Survey Date must not be in the future")) ? "Last Survey Date must not be in the future" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISK_SELECTION".toUpperCase() + "__" + "DATE_LASTSURVEY");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISK_SELECTION".toUpperCase() + "_" + "DATE_LASTSURVEY");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(RISK_SELECTION.DATE_LASTSURVEY <= NOW )");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "SURVEY_NUMBER");
        		}
        		//window.setProperty(field, "VE", "RISK_SELECTION.APPLICABLE == 1", "V", "{3}");
...
function onValidate_RISK_SELECTION__DATE_SUR_REQ(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "DATE_SUR_REQ");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.APPLICABLE == 1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("RISK_SELECTION.APPLICABLE == 1")) ? new Expression("RISK_SELECTION.APPLICABLE == 1") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISK_SELECTION", "FREQUENCY");
        		}
        		//window.setProperty(field, "VE", "RISK_SELECTION.APPLICABLE == 1", "V", "{3}");
...
function onValidate_RISK_SELECTION__BLCKSCRN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "BLCKSCRN", "ChildScreen");
        })();
}
function onValidate_RISK_SELECTION__BLCK_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "BLCK_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_SELECTION", "BLCK_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @param RISK_SELECTION The Parent (Root) object name.
          * @param BLCKR_ITEM.POLICY_NUMBER  The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_SELECTION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "BLCKR_ITEM.POLICY_NUMBER ";
...
function onValidate_RISK_SELECTION__BLCK_TOTAL_FI_SI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "BLCK_TOTAL_FI_SI", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_SELECTION", "BLCK_TOTAL_FI_SI");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param RISK_SELECTION The Parent (Root) object name.
          * @param BLCKR_ITEM.MPL_FIRE  The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_SELECTION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "BLCKR_ITEM.MPL_FIRE ";
        		//count, average, total, min, max
...
function onValidate_RISK_SELECTION__BLCK_TOTAL_BC_SI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "BLCK_TOTAL_BC_SI", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_SELECTION", "BLCK_TOTAL_BC_SI");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param RISK_SELECTION The Parent (Root) object name.
          * @param BLCKR_ITEM.MPL_BC  The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_SELECTION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "BLCKR_ITEM.MPL_BC ";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_RISK_SELECTION__BLCK_TOTAL_OC_SI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "BLCK_TOTAL_OC_SI", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_SELECTION", "BLCK_TOTAL_OC_SI");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param RISK_SELECTION The Parent (Root) object name.
          * @param BLCKR_ITEM.MPL_OC  The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_SELECTION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "BLCKR_ITEM.MPL_OC ";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_RISK_SELECTION__BLCK_TOTAL_BI_SI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "BLCK_TOTAL_BI_SI", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_SELECTION", "BLCK_TOTAL_BI_SI");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param RISK_SELECTION The Parent (Root) object name.
          * @param BLCKR_ITEM.MPL_BI  The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_SELECTION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "BLCKR_ITEM.MPL_BI ";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_RISK_SELECTION__BLCK_TOTAL_AR_SI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "BLCK_TOTAL_AR_SI", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_SELECTION", "BLCK_TOTAL_AR_SI");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param RISK_SELECTION The Parent (Root) object name.
          * @param BLCKR_ITEM.MPL_AR  The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_SELECTION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "BLCKR_ITEM.MPL_AR ";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_RISK_SELECTION__BLCK_TOTAL_AD_SI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISK_SELECTION", "BLCK_TOTAL_AD_SI", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RISK_SELECTION", "BLCK_TOTAL_AD_SI");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param RISK_SELECTION The Parent (Root) object name.
          * @param BLCKR_ITEM.MPL_AD The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "RISK_SELECTION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "BLCKR_ITEM.MPL_AD";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_label9(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label9" != "{na" + "me}"){
        			instance = Field.getLabel("label9");
        		} else { 
...
function onValidate_CLAIM_HISTORY__FIRE0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "FIRE0_12_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Fire Claim History 0-12 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Fire Claim History 0-12 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("RISK_SELECTION.FIRE == true")) ? new Expression("RISK_SELECTION.FIRE == true") : null;
        		var elseColour = (Expression.isValidParameter(" #00000000")) ? " #00000000" : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.FIRE0_12_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__FIRE0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "FIRE0_12_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Fire Claim History 0-12 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Fire Claim History 0-12 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=FIRE0_12_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.FIRE0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE0_12_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.FIRE0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE0_12_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "FIRE0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.FIRE0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE0_12_MONTHS) == 1) OR (RISK_SELECTION.FIRE == false)");
...
function onValidate_CLAIM_HISTORY__FIRE13_24_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "FIRE13_24_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Fire Claim History 13-24 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Fire Claim History 13-24 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.FIRE13_24_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__FIRE13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "FIRE13_24_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Fire Claim History 13-24 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Fire Claim History 13-24 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=FIRE13_24_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.FIRE13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE13_24_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.FIRE13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE13_24_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "FIRE13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.FIRE13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE13_24_MONTHS) == 1) OR (RISK_SELECTION.FIRE == false)");
...
function onValidate_CLAIM_HISTORY__FIRE25_36_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "FIRE25_36_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Fire Claim History 25-36 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Fire Claim History 25-36 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.FIRE25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__FIRE25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "FIRE25_36_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Fire Claim History 25-36 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.FIRE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_FIRECode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Fire Claim History 25-36 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=FIRE25_36_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.FIRE25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE25_36_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.FIRE25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE25_36_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "FIRE25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.FIRE25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE25_36_MONTHS) == 1) OR (RISK_SELECTION.FIRE == false)");
...
function onValidate_CLAIM_HISTORY__BC0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BC0_12_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Buildings Combined Claim History 0-12 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Buildings Combined Claim History 0-12 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter(" RISK_SELECTION.BUILDINGS_COMB == true")) ? new Expression(" RISK_SELECTION.BUILDINGS_COMB == true") : null;
        		var elseColour = (Expression.isValidParameter(" #00000000")) ? " #00000000" : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.BC0_12_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__BC0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BC0_12_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Buildings Combined Claim History 0-12 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Buildings Combined Claim History 0-12 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=BC0_12_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.BC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC0_12_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.BC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC0_12_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BC0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC0_12_MONTHS) == 1) OR (RISK_SELECTION.BUILDINGS_COMB == false)");
...
function onValidate_CLAIM_HISTORY__BC13_24_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BC13_24_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Buildings Combined Claim History 13-24 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Buildings Combined Claim History 13-24 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.BC13_24_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__BC13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BC13_24_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Buildings Combined Claim History 13-24 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Buildings Combined Claim History 13-24 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=BC13_24_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.BC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC13_24_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.BC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC13_24_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BC13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC13_24_MONTHS) == 1) OR (RISK_SELECTION.BUILDINGS_COMB == false)");
...
function onValidate_CLAIM_HISTORY__BC25_36_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BC25_36_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Buildings Combined Claim History 25-36 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Buildings Combined Claim History 25-36 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.BC25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__BC25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BC25_36_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Buildings Combined Claim History 25-36 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BUILDINGS_COMB == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') || (GENERAL.IS_BCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Buildings Combined Claim History 25-36 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=BC25_36_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.BC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC25_36_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.BC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC25_36_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BC25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC25_36_MONTHS) == 1) OR (RISK_SELECTION.BUILDINGS_COMB == false)");
...
function onValidate_CLAIM_HISTORY__BI0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BI0_12_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BI == true  && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')|| (GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Business Interruption Claim History 0-12 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BI == true  && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')|| (GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Business Interruption Claim History 0-12 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter(" RISK_SELECTION.BI == true")) ? new Expression(" RISK_SELECTION.BI == true") : null;
        		var elseColour = (Expression.isValidParameter(" #00000000")) ? " #00000000" : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.BI0_12_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__BI0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BI0_12_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Business Interruption Claim History 0-12 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Business Interruption Claim History 0-12 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=BI0_12_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.BI0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI0_12_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.BI0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI0_12_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BI0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BI0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI0_12_MONTHS) == 1) OR (RISK_SELECTION.BI == false)");
...
function onValidate_CLAIM_HISTORY__BI13_24_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BI13_24_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Business Interruption Claim History 13-24 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Business Interruption Claim History 13-24 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.BI13_24_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__BI13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BI13_24_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Business Interruption Claim History 13-24 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Business Interruption Claim History 13-24 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=BI13_24_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.BI13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI13_24_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.BI13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI13_24_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BI13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BI13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI13_24_MONTHS) == 1) OR (RISK_SELECTION.BI == false)");
...
function onValidate_CLAIM_HISTORY__BI25_36_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BI25_36_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Business Interruption Claim History 25-36 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Business Interruption Claim History 25-36 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.BI25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__BI25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "BI25_36_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Business Interruption Claim History 25-36 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.BI == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_BICode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Business Interruption Claim History 25-36 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=BI25_36_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.BI25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI25_36_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.BI25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI25_36_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BI25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BI25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI25_36_MONTHS) == 1) OR (RISK_SELECTION.BI == false)");
...
function onValidate_label12(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label12" != "{na" + "me}"){
        			instance = Field.getLabel("label12");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_CLAIM_HISTORY__OC0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "OC0_12_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Office Contents Claim History 0-12 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Office Contents Claim History 0-12 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("RISK_SELECTION.OFFICE_CONT == true")) ? new Expression("RISK_SELECTION.OFFICE_CONT == true") : null;
        		var elseColour = (Expression.isValidParameter(" #00000000")) ? " #00000000" : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.OC0_12_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__OC0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "OC0_12_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Office Contents Claim History 0-12 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Office Contents Claim History 0-12 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=OC0_12_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.OC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC0_12_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.OC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC0_12_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "OC0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.OC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC0_12_MONTHS) == 1) OR (RISK_SELECTION.OFFICE_CONT == false)");
...
function onValidate_CLAIM_HISTORY__OC13_24_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "OC13_24_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Office Contents Claim History 13-24 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Office Contents Claim History 13-24 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.OC13_24_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__OC13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "OC13_24_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Office Contents Claim History 13-24 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Office Contents Claim History 13-24 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=OC13_24_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.OC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC13_24_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.OC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC13_24_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "OC13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.OC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC13_24_MONTHS) == 1) OR (RISK_SELECTION.OFFICE_CONT == false)");
...
function onValidate_CLAIM_HISTORY__OC25_36_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "OC25_36_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Office Contents Claim History 25-36 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Office Contents Claim History 25-36 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.OC25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__OC25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "OC25_36_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Office Contents Claim History 25-36 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.OFFICE_CONT == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_OCCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Office Contents Claim History 25-36 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=OC25_36_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.OC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC25_36_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.OC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC25_36_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "OC25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.OC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC25_36_MONTHS) == 1) OR (RISK_SELECTION.OFFICE_CONT == false)");
...
function onValidate_label13(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label13" != "{na" + "me}"){
        			instance = Field.getLabel("label13");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_CLAIM_HISTORY__AR0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AR0_12_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accounts Receivable Claim History 0-12 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accounts Receivable Claim History 0-12 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter(" RISK_SELECTION.ACCOUNT_RECEIVE  == true")) ? new Expression(" RISK_SELECTION.ACCOUNT_RECEIVE  == true") : null;
        		var elseColour = (Expression.isValidParameter(" #00000000")) ? " #00000000" : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.AR0_12_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__AR0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AR0_12_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accounts Receivable Claim History 0-12 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accounts Receivable Claim History 0-12 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=AR0_12_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.AR0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR0_12_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.AR0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR0_12_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AR0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AR0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR0_12_MONTHS) == 1) OR (RISK_SELECTION.ACCOUNT_RECEIVE  ==false)");
...
function onValidate_CLAIM_HISTORY__AR13_24_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AR13_24_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accounts Receivable Claim History 13-24 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accounts Receivable Claim History 13-24 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.AR13_24_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__AR13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AR13_24_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accounts Receivable Claim History 13-24 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accounts Receivable Claim History 13-24 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=AR13_24_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.AR13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR13_24_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.AR13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR13_24_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AR13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AR13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR13_24_MONTHS) == 1) OR (RISK_SELECTION.ACCOUNT_RECEIVE  ==false)");
...
function onValidate_CLAIM_HISTORY__AR25_36_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AR25_36_MONTHS");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accounts Receivable Claim History 25-36 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accounts Receivable Claim History 25-36 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.AR25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__AR25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AR25_36_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accounts Receivable Claim History 25-36 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = " RISK_SELECTION.ACCOUNT_RECEIVE  == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ARCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accounts Receivable Claim History 25-36 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=AR25_36_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.AR25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR25_36_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.AR25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR25_36_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AR25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AR25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR25_36_MONTHS) == 1) OR (RISK_SELECTION.ACCOUNT_RECEIVE  ==false)");
...
function onValidate_label14(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label14" != "{na" + "me}"){
        			instance = Field.getLabel("label14");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_CLAIM_HISTORY__AC0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AC0_12_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accidental Damage Claim History 0-12 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accidental Damage Claim History 0-12 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("RISK_SELECTION.ACCIDENTAL_DAMAGE == true")) ? new Expression("RISK_SELECTION.ACCIDENTAL_DAMAGE == true") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.AC0_12_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__AC0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AC0_12_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accidental Damage Claim History 0-12 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accidental Damage Claim History 0-12 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=AC0_12_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.AC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC0_12_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.AC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC0_12_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AC0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC0_12_MONTHS) == 1) OR (RISK_SELECTION.ACCIDENTAL_DAMAGE == false)");
...
function onValidate_CLAIM_HISTORY__AC13_24_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AC13_24_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accidental Damage Claim History 13-24 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accidental Damage Claim History 13-24 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.AC13_24_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__AC13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AC13_24_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accidental Damage Claim History 13-24 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accidental Damage Claim History 13-24 Months Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=AC13_24_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.AC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC13_24_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.AC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC13_24_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AC13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC13_24_MONTHS) == 1) OR (RISK_SELECTION.ACCIDENTAL_DAMAGE == false)");
...
function onValidate_CLAIM_HISTORY__AC25_36_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AC25_36_MONTHS");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accidental Damage Claim History 25-36 Months Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN') ||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accidental Damage Claim History 25-36 Months Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CLAIM_HISTORY.AC25_36_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_CLAIM_HISTORY__AC25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLAIM_HISTORY", "AC25_36_AMOUNT");
        		}
        		//window.setProperty(field, "VEM", "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))", "V", "Accidental Damage Claim History 25-36 Months Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "RISK_SELECTION.ACCIDENTAL_DAMAGE == true && (GENERAL.TRANSACTION_TYPE =='NB' || GENERAL.TRANSACTION_TYPE =='REN')||(GENERAL.IS_ADCode =='ADD' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC'))",
            paramElseValue = "V",
            paramValidationMessage = "Accidental Damage Claim History 25-36 Months Amount Is Required";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AC25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC25_36_MONTHS) == 1) OR (RISK_SELECTION.ACCIDENTAL_DAMAGE == false)");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CLAIM_HISTORY&propertyName=AC25_36_AMOUNT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("(Code(CLAIM_HISTORY.AC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC25_36_MONTHS) == 1)")) ? new Expression("(Code(CLAIM_HISTORY.AC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC25_36_MONTHS) == 1)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_RISK_SELECTION__ACCOUNT_RECEIVE(null, null, null, isOnLoad);
    ...
    onValidate_RISK_SELECTION__TRANSTYPETemp(null, null, null, isOnLoad);
    ...
    onValidate_RISK_SELECTION__BLCKSCRN(null, null, null, isOnLoad);
    onValidate_RISK_SELECTION__BLCK_CNT(null, null, null, isOnLoad);
    onValidate_RISK_SELECTION__BLCK_TOTAL_FI_SI(null, null, null, isOnLoad);
    onValidate_RISK_SELECTION__BLCK_TOTAL_BC_SI(null, null, null, isOnLoad);
    onValidate_RISK_SELECTION__BLCK_TOTAL_OC_SI(null, null, null, isOnLoad);
    onValidate_RISK_SELECTION__BLCK_TOTAL_BI_SI(null, null, null, isOnLoad);
    onValidate_RISK_SELECTION__BLCK_TOTAL_AR_SI(null, null, null, isOnLoad);
    onValidate_RISK_SELECTION__BLCK_TOTAL_AD_SI(null, null, null, isOnLoad);
...
<div id="id12a8972b5b2c40e9a533a1726761bc00" class="general-layout-container">
...
<div id="id9572922d327643c6bcd360b676a46341" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading16" runat="server" Text=" Section" /></legend>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblRISK_SELECTION_ACCOUNT_RECEIVE" for="ctl00_cntMainBody_RISK_SELECTION__ACCOUNT_RECEIVE" class="col-md-4 col-sm-3 control-label">
		Accounts Receivable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="RISK_SELECTION" 
		data-property-name="ACCOUNT_RECEIVE" 
		id="pb-container-checkbox-RISK_SELECTION-ACCOUNT_RECEIVE">	
		
		<asp:TextBox ID="RISK_SELECTION__ACCOUNT_RECEIVE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valRISK_SELECTION_ACCOUNT_RECEIVE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Accounts Receivable"
			ClientValidationFunction="onValidate_RISK_SELECTION__ACCOUNT_RECEIVE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /List -->
	...
	<span class="field-container"
		...
		id="pb-container-checkbox-RISK_SELECTION-TRANSTYPETemp"
	>
		<label id="ctl00_cntMainBody_lblRISK_SELECTION_TRANSTYPETemp" for="ctl00_cntMainBody_RISK_SELECTION_TRANSTYPETemp_select"></label>
		<input id="ctl00_cntMainBody_RISK_SELECTION_TRANSTYPETemp" class="field-medium hidden" />
			<asp:CustomValidator ID="valRISK_SELECTION_TRANSTYPETemp" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for RISK_SELECTION.TRANSTYPETemp"
			ClientValidationFunction="onValidate_RISK_SELECTION__TRANSTYPETemp" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"
		/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9572922d327643c6bcd360b676a46341 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9572922d327643c6bcd360b676a46341 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9572922d327643c6bcd360b676a46341 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9572922d327643c6bcd360b676a46341 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9572922d327643c6bcd360b676a46341 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9572922d327643c6bcd360b676a46341 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9572922d327643c6bcd360b676a46341 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9572922d327643c6bcd360b676a46341 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9572922d327643c6bcd360b676a46341 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9572922d327643c6bcd360b676a46341 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb077a5de5c0b489b98be0edd84212fcf" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading17" runat="server" Text="Premises Assessment" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb077a5de5c0b489b98be0edd84212fcf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb077a5de5c0b489b98be0edd84212fcf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb077a5de5c0b489b98be0edd84212fcf div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb077a5de5c0b489b98be0edd84212fcf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb077a5de5c0b489b98be0edd84212fcf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb077a5de5c0b489b98be0edd84212fcf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb077a5de5c0b489b98be0edd84212fcf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb077a5de5c0b489b98be0edd84212fcf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb077a5de5c0b489b98be0edd84212fcf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb077a5de5c0b489b98be0edd84212fcf input{text-align:left;}"; break;
		}
	}
...
<div id="SurveyReport" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading18" runat="server" Text="Survey Report" /></legend>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb659488923244e2d8392ac33613272c8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading19" runat="server" Text=" Fire Sections" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb659488923244e2d8392ac33613272c8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb659488923244e2d8392ac33613272c8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb659488923244e2d8392ac33613272c8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb659488923244e2d8392ac33613272c8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb659488923244e2d8392ac33613272c8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb659488923244e2d8392ac33613272c8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb659488923244e2d8392ac33613272c8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb659488923244e2d8392ac33613272c8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb659488923244e2d8392ac33613272c8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb659488923244e2d8392ac33613272c8 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RISK_SELECTION__BLCKSCRN"
		data-field-type="Child" 
		data-object-name="RISK_SELECTION" 
		data-property-name="BLCKSCRN" 
		id="pb-container-childscreen-RISK_SELECTION-BLCKSCRN">
		
		    <legend>Risk Blocked</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RISK_SELECTION__BLCKR_ITEM" runat="server" ScreenCode="BLCKSCRN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="BLCKSCRN/BLCKSCRN_Blocked_Risks.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Client Name" DataField="CLIENT_NAME" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valRISK_SELECTION_BLCKSCRN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Risk Blocked"
						ClientValidationFunction="onValidate_RISK_SELECTION__BLCKSCRN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="RISK_SELECTION" 
		data-property-name="BLCK_CNT" 
		id="pb-container-integer-RISK_SELECTION-BLCK_CNT">
		<asp:Label ID="lblRISK_SELECTION_BLCK_CNT" runat="server" AssociatedControlID="RISK_SELECTION__BLCK_CNT" 
			Text="Risk Blocked" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="RISK_SELECTION__BLCK_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valRISK_SELECTION_BLCK_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Risk Blocked"
			ClientValidationFunction="onValidate_RISK_SELECTION__BLCK_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="RISK_SELECTION" 
		data-property-name="BLCK_TOTAL_FI_SI" 
		id="pb-container-currency-RISK_SELECTION-BLCK_TOTAL_FI_SI">
		<asp:Label ID="lblRISK_SELECTION_BLCK_TOTAL_FI_SI" runat="server" AssociatedControlID="RISK_SELECTION__BLCK_TOTAL_FI_SI" 
			Text="Blocked Fire Total SI " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_SELECTION__BLCK_TOTAL_FI_SI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_SELECTION_BLCK_TOTAL_FI_SI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Blocked Fire Total SI "
			ClientValidationFunction="onValidate_RISK_SELECTION__BLCK_TOTAL_FI_SI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="RISK_SELECTION" 
		data-property-name="BLCK_TOTAL_BC_SI" 
		id="pb-container-currency-RISK_SELECTION-BLCK_TOTAL_BC_SI">
		<asp:Label ID="lblRISK_SELECTION_BLCK_TOTAL_BC_SI" runat="server" AssociatedControlID="RISK_SELECTION__BLCK_TOTAL_BC_SI" 
			Text="Blocked Building Combined Total SI " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_SELECTION__BLCK_TOTAL_BC_SI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_SELECTION_BLCK_TOTAL_BC_SI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Blocked Building Combined Total SI "
			ClientValidationFunction="onValidate_RISK_SELECTION__BLCK_TOTAL_BC_SI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="RISK_SELECTION" 
		data-property-name="BLCK_TOTAL_OC_SI" 
		id="pb-container-currency-RISK_SELECTION-BLCK_TOTAL_OC_SI">
		<asp:Label ID="lblRISK_SELECTION_BLCK_TOTAL_OC_SI" runat="server" AssociatedControlID="RISK_SELECTION__BLCK_TOTAL_OC_SI" 
			Text="Blocked office Contents Total SI " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_SELECTION__BLCK_TOTAL_OC_SI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_SELECTION_BLCK_TOTAL_OC_SI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Blocked office Contents Total SI "
			ClientValidationFunction="onValidate_RISK_SELECTION__BLCK_TOTAL_OC_SI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="RISK_SELECTION" 
		data-property-name="BLCK_TOTAL_BI_SI" 
		id="pb-container-currency-RISK_SELECTION-BLCK_TOTAL_BI_SI">
		<asp:Label ID="lblRISK_SELECTION_BLCK_TOTAL_BI_SI" runat="server" AssociatedControlID="RISK_SELECTION__BLCK_TOTAL_BI_SI" 
			Text="Blocked Business Interruption Total SI " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_SELECTION__BLCK_TOTAL_BI_SI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_SELECTION_BLCK_TOTAL_BI_SI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Blocked Business Interruption Total SI "
			ClientValidationFunction="onValidate_RISK_SELECTION__BLCK_TOTAL_BI_SI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="RISK_SELECTION" 
		data-property-name="BLCK_TOTAL_AR_SI" 
		id="pb-container-currency-RISK_SELECTION-BLCK_TOTAL_AR_SI">
		<asp:Label ID="lblRISK_SELECTION_BLCK_TOTAL_AR_SI" runat="server" AssociatedControlID="RISK_SELECTION__BLCK_TOTAL_AR_SI" 
			Text="Blocked Account Receivable Total SI " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_SELECTION__BLCK_TOTAL_AR_SI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_SELECTION_BLCK_TOTAL_AR_SI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Blocked Account Receivable Total SI "
			ClientValidationFunction="onValidate_RISK_SELECTION__BLCK_TOTAL_AR_SI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="RISK_SELECTION" 
		data-property-name="BLCK_TOTAL_AD_SI" 
		id="pb-container-currency-RISK_SELECTION-BLCK_TOTAL_AD_SI">
		<asp:Label ID="lblRISK_SELECTION_BLCK_TOTAL_AD_SI" runat="server" AssociatedControlID="RISK_SELECTION__BLCK_TOTAL_AD_SI" 
			Text="Blocked Accidental Damage Total SI " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RISK_SELECTION__BLCK_TOTAL_AD_SI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRISK_SELECTION_BLCK_TOTAL_AD_SI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Blocked Accidental Damage Total SI "
			ClientValidationFunction="onValidate_RISK_SELECTION__BLCK_TOTAL_AD_SI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div id="Pastclaimscount" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading21" runat="server" Text="Past Claims Count" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label3">
		<span class="label" id="label3">0-12 Months</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label5">
		<span class="label" id="label5">13-24 Months</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label7">
		<span class="label" id="label7">25-36 Months</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label8">
		<span class="label" id="label8">Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label9">
		<span class="label" id="label9">Fire</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label10">
		<span class="label" id="label10">Buildings Combined</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label11">
		<span class="label" id="label11">Business Interruption</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label12">
		<span class="label" id="label12">Office Contents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label13">
		<span class="label" id="label13">Accounts Receivable</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label14">
		<span class="label" id="label14">Accidental Damage</span>
	</span>
<!-- /Label -->
