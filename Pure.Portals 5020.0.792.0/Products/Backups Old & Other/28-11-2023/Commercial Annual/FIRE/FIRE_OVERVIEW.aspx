        ...
        <div class="card">
            ...
            <div class="card-body clearfix">
                ...
                <div class="form-horizontal">
                    ...
                    <div id="liSEC_OVRW__CRI_TOTAL_SUM_INSURED" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label"></label>

                    </div>
                    <div id="liSEC_OVRW__CRI_TARGET_RISK_SI" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label"></label>

                    </div>
                    <div id="liSEC_OVRW__CRI_RI_EXPOSURE" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label"></label>

                    </div>
                    <div id="liSEC_OVRW__CRI_RI_EXPOSURE_VAT_EXCL" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label"></label>
