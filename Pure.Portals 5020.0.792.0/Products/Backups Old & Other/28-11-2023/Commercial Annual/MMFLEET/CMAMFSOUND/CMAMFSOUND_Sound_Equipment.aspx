<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMFSOUND_Sound_Equipment.aspx.vb" Inherits="Nexus.PB2_CMAMFSOUND_Sound_Equipment" %>
...
function onValidate_SOUND_EQUIPMENT__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND_EQUIPMENT", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SOUND_EQUIPMENT", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND_EQUIPMENT.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "SOUND_EQUIPMENT", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_EQUIPMENT_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND_EQUIPMENT__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND_EQUIPMENT__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_SOUND_EQUIPMENT__REG_NUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND_EQUIPMENT", "REG_NUM", "Text");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SOUND_EQUIPMENT", "REG_NUM");
        		var errorMessage = "Vehicle Registration Number  is mandatory and must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND_EQUIPMENT.REG_NUM");
        			window.setControlWidth(field, "0.8", "SOUND_EQUIPMENT", "REG_NUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_EQUIPMENT_REG_NUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND_EQUIPMENT__REG_NUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND_EQUIPMENT__REG_NUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SOUND_EQUIPMENT__LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND_EQUIPMENT", "LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SOUND_EQUIPMENT", "LIMIT");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND_EQUIPMENT.LIMIT");
        			window.setControlWidth(field, "0.8", "SOUND_EQUIPMENT", "LIMIT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_EQUIPMENT_LIMIT");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND_EQUIPMENT__LIMIT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND_EQUIPMENT__LIMIT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SOUND_EQUIPMENT__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND_EQUIPMENT", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SOUND_EQUIPMENT", "PREMIUM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND_EQUIPMENT.PREMIUM");
        			window.setControlWidth(field, "0.8", "SOUND_EQUIPMENT", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_EQUIPMENT_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND_EQUIPMENT__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND_EQUIPMENT__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SOUND_EQUIPMENT__FAP_PER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND_EQUIPMENT", "FAP_PER", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SOUND_EQUIPMENT", "FAP_PER");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND_EQUIPMENT.FAP_PER");
        			window.setControlWidth(field, "0.8", "SOUND_EQUIPMENT", "FAP_PER");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_EQUIPMENT_FAP_PER");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND_EQUIPMENT__FAP_PER');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND_EQUIPMENT__FAP_PER_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "SOUND_EQUIPMENT".toUpperCase() + "__" + "FAP_PER");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "SOUND_EQUIPMENT".toUpperCase() + "_" + "FAP_PER");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("SOUND_EQUIPMENT.FAP_PER <= 100 || (SOUND_EQUIPMENT.FAP_PER == '' || SOUND_EQUIPMENT.FAP_PER == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_SOUND_EQUIPMENT__FAP_AMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND_EQUIPMENT", "FAP_AMT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SOUND_EQUIPMENT", "FAP_AMT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SOUND_EQUIPMENT.FAP_AMT");
        			window.setControlWidth(field, "0.8", "SOUND_EQUIPMENT", "FAP_AMT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSOUND_EQUIPMENT_FAP_AMT");
        			    var ele = document.getElementById('ctl00_cntMainBody_SOUND_EQUIPMENT__FAP_AMT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SOUND_EQUIPMENT__FAP_AMT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=SOUND_EQUIPMENT&propertyName=FAP_AMT&name={name}");
        		
        		var value = new Expression("GENERAL.SE_MIN"), 
        			condition = (Expression.isValidParameter("SOUND_EQUIPMENT.FAP_AMT <= 0 OR SOUND_EQUIPMENT.FAP_AMT = null OR SOUND_EQUIPMENT.FAP_AMT = ''")) ? new Expression("SOUND_EQUIPMENT.FAP_AMT <= 0 OR SOUND_EQUIPMENT.FAP_AMT = null OR SOUND_EQUIPMENT.FAP_AMT = ''") : null, 
...
function DoLogic(isOnLoad) {
    onValidate_SOUND_EQUIPMENT__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SOUND_EQUIPMENT__REG_NUM(null, null, null, isOnLoad);
    onValidate_SOUND_EQUIPMENT__LIMIT(null, null, null, isOnLoad);
    onValidate_SOUND_EQUIPMENT__PREMIUM(null, null, null, isOnLoad);
    onValidate_SOUND_EQUIPMENT__FAP_PER(null, null, null, isOnLoad);
    onValidate_SOUND_EQUIPMENT__FAP_AMT(null, null, null, isOnLoad);
}
</script>
...
<div id="id41ac6c255265495e8cf3abcb422a1bbd" class="general-layout-container">
...
<div id="id3fe9e4fce46a498f944d74b35ca5d93f" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading14" runat="server" Text="Specified Sound Equipment" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SOUND_EQUIPMENT" 
		data-property-name="DESCRIPTION" 
		 
		
		 
		id="pb-container-text-SOUND_EQUIPMENT-DESCRIPTION">

		
		<asp:Label ID="lblSOUND_EQUIPMENT_DESCRIPTION" runat="server" AssociatedControlID="SOUND_EQUIPMENT__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SOUND_EQUIPMENT__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSOUND_EQUIPMENT_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SOUND_EQUIPMENT__DESCRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SOUND_EQUIPMENT" 
		data-property-name="REG_NUM" 
		 
		
		 
		id="pb-container-text-SOUND_EQUIPMENT-REG_NUM">

		
		<asp:Label ID="lblSOUND_EQUIPMENT_REG_NUM" runat="server" AssociatedControlID="SOUND_EQUIPMENT__REG_NUM" 
			Text="Vehicle Registration Number " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SOUND_EQUIPMENT__REG_NUM" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSOUND_EQUIPMENT_REG_NUM" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Vehicle Registration Number "
					ClientValidationFunction="onValidate_SOUND_EQUIPMENT__REG_NUM"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SOUND_EQUIPMENT-LIMIT">
		<asp:Label ID="lblSOUND_EQUIPMENT_LIMIT" runat="server" AssociatedControlID="SOUND_EQUIPMENT__LIMIT" 
			Text="Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SOUND_EQUIPMENT__LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSOUND_EQUIPMENT_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indemnity"
			ClientValidationFunction="onValidate_SOUND_EQUIPMENT__LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SOUND_EQUIPMENT-PREMIUM">
		<asp:Label ID="lblSOUND_EQUIPMENT_PREMIUM" runat="server" AssociatedControlID="SOUND_EQUIPMENT__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SOUND_EQUIPMENT__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSOUND_EQUIPMENT_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SOUND_EQUIPMENT__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SOUND_EQUIPMENT-FAP_PER">
		<asp:Label ID="lblSOUND_EQUIPMENT_FAP_PER" runat="server" AssociatedControlID="SOUND_EQUIPMENT__FAP_PER" 
			Text="FAP %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SOUND_EQUIPMENT__FAP_PER" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSOUND_EQUIPMENT_FAP_PER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP %"
			ClientValidationFunction="onValidate_SOUND_EQUIPMENT__FAP_PER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SOUND_EQUIPMENT-FAP_AMT">
		<asp:Label ID="lblSOUND_EQUIPMENT_FAP_AMT" runat="server" AssociatedControlID="SOUND_EQUIPMENT__FAP_AMT" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SOUND_EQUIPMENT__FAP_AMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSOUND_EQUIPMENT_FAP_AMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_SOUND_EQUIPMENT__FAP_AMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3fe9e4fce46a498f944d74b35ca5d93f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3fe9e4fce46a498f944d74b35ca5d93f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3fe9e4fce46a498f944d74b35ca5d93f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3fe9e4fce46a498f944d74b35ca5d93f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3fe9e4fce46a498f944d74b35ca5d93f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3fe9e4fce46a498f944d74b35ca5d93f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3fe9e4fce46a498f944d74b35ca5d93f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3fe9e4fce46a498f944d74b35ca5d93f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3fe9e4fce46a498f944d74b35ca5d93f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3fe9e4fce46a498f944d74b35ca5d93f input{text-align:left;}"; break;
		}
	}
