...
function onValidate_FLEET__SRETAINED_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("FLEET.TOTAL_PREMIUM * FLEET.SRETAINED_RATE/100"), 
...
function onValidate_FLEET__FAP_ODMIN_PER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Basic - Own Damage (Sub-Section A) FAP% cannot be more than 100%")) ? "Basic - Own Damage (Sub-Section A) FAP% cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_FLEET__FAP_THMIN_PER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Additional Theft/Hijack FAP% cannot be more than 100%")) ? "Additional Theft/Hijack FAP% cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FLEET".toUpperCase() + "__" + "FAP_THMIN_PER");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FLEET".toUpperCase() + "_" + "FAP_THMIN_PER");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("FLEET.FAP_THMIN_PER<= 100 || (FLEET.FAP_THMIN_PER == '' || FLEET.FAP_THMIN_PER == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
<div id="id3ffcb8d8983d4db3b53e365ecb1898d8" class="general-layout-container">
...
<div id="ide3c76e8af4b943cbb7f12bb427e7f0f7" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide3c76e8af4b943cbb7f12bb427e7f0f7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide3c76e8af4b943cbb7f12bb427e7f0f7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide3c76e8af4b943cbb7f12bb427e7f0f7 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide3c76e8af4b943cbb7f12bb427e7f0f7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide3c76e8af4b943cbb7f12bb427e7f0f7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide3c76e8af4b943cbb7f12bb427e7f0f7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide3c76e8af4b943cbb7f12bb427e7f0f7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide3c76e8af4b943cbb7f12bb427e7f0f7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide3c76e8af4b943cbb7f12bb427e7f0f7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide3c76e8af4b943cbb7f12bb427e7f0f7 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9ce85a33b4d1489d84764079e223a380" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9ce85a33b4d1489d84764079e223a380 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9ce85a33b4d1489d84764079e223a380 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9ce85a33b4d1489d84764079e223a380 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9ce85a33b4d1489d84764079e223a380 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9ce85a33b4d1489d84764079e223a380 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9ce85a33b4d1489d84764079e223a380 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9ce85a33b4d1489d84764079e223a380 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9ce85a33b4d1489d84764079e223a380 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9ce85a33b4d1489d84764079e223a380 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9ce85a33b4d1489d84764079e223a380 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id156acc89d6e84e6e8f1b036a084e3692" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id156acc89d6e84e6e8f1b036a084e3692 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id156acc89d6e84e6e8f1b036a084e3692 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id156acc89d6e84e6e8f1b036a084e3692 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id156acc89d6e84e6e8f1b036a084e3692 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id156acc89d6e84e6e8f1b036a084e3692 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id156acc89d6e84e6e8f1b036a084e3692 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id156acc89d6e84e6e8f1b036a084e3692 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id156acc89d6e84e6e8f1b036a084e3692 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id156acc89d6e84e6e8f1b036a084e3692 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id156acc89d6e84e6e8f1b036a084e3692 input{text-align:left;}"; break;
		}
	}
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblFLEET_RI_LIMIT" runat="server" AssociatedControlID="FLEET__RI_LIMIT" 
			Text="Reinsurance Calculated" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valFLEET_RI_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Reinsurance Calculated"
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idcde017b6e6d74d0fa4849eab9a432e5a" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idcde017b6e6d74d0fa4849eab9a432e5a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcde017b6e6d74d0fa4849eab9a432e5a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcde017b6e6d74d0fa4849eab9a432e5a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idcde017b6e6d74d0fa4849eab9a432e5a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcde017b6e6d74d0fa4849eab9a432e5a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcde017b6e6d74d0fa4849eab9a432e5a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcde017b6e6d74d0fa4849eab9a432e5a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcde017b6e6d74d0fa4849eab9a432e5a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcde017b6e6d74d0fa4849eab9a432e5a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcde017b6e6d74d0fa4849eab9a432e5a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfdb1f4a341d344bc91f327e8e649e980" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idfdb1f4a341d344bc91f327e8e649e980 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfdb1f4a341d344bc91f327e8e649e980 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfdb1f4a341d344bc91f327e8e649e980 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfdb1f4a341d344bc91f327e8e649e980 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfdb1f4a341d344bc91f327e8e649e980 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfdb1f4a341d344bc91f327e8e649e980 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfdb1f4a341d344bc91f327e8e649e980 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfdb1f4a341d344bc91f327e8e649e980 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfdb1f4a341d344bc91f327e8e649e980 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfdb1f4a341d344bc91f327e8e649e980 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5af23fcb069b48edbd3a323839707d4c" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5af23fcb069b48edbd3a323839707d4c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5af23fcb069b48edbd3a323839707d4c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5af23fcb069b48edbd3a323839707d4c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5af23fcb069b48edbd3a323839707d4c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5af23fcb069b48edbd3a323839707d4c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5af23fcb069b48edbd3a323839707d4c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5af23fcb069b48edbd3a323839707d4c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5af23fcb069b48edbd3a323839707d4c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5af23fcb069b48edbd3a323839707d4c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5af23fcb069b48edbd3a323839707d4c input{text-align:left;}"; break;
		}
	}
