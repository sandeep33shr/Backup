<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PVTMEXTRA_Private_Motor_Extra_Item.aspx.vb" Inherits="Nexus.PB2_PVTMEXTRA_Private_Motor_Extra_Item" %>
...
function onValidate_MOTOR_EXTRA__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTOR_EXTRA", "DESCRIPTION", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MOTOR_EXTRA", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOTOR_EXTRA.DESCRIPTION");
        			window.setControlWidth(field, "0.7", "MOTOR_EXTRA", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOTOR_EXTRA_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOTOR_EXTRA__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOTOR_EXTRA__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_MOTOR_EXTRA__VALUE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTOR_EXTRA", "VALUE", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MOTOR_EXTRA", "VALUE");
        		var errorMessage = "Value is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOTOR_EXTRA.VALUE");
        			window.setControlWidth(field, "0.7", "MOTOR_EXTRA", "VALUE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOTOR_EXTRA_VALUE");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOTOR_EXTRA__VALUE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOTOR_EXTRA__VALUE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (()=>{
                ...
                $('#<%= MOTOR_EXTRA__VALUE.ClientID %>').bind("keypress",function(e){
...
function DoLogic(isOnLoad) {
    onValidate_MOTOR_EXTRA__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_MOTOR_EXTRA__VALUE(null, null, null, isOnLoad);
}
</script>
...
<div id="id7b493cc07afb434cac49db712a6bf645" class="general-layout-container">
...
<div id="frmExtraDet" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading8" runat="server" Text="Extra Item" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MOTOR_EXTRA" 
		data-property-name="DESCRIPTION" 
		id="pb-container-comment-MOTOR_EXTRA-DESCRIPTION">
		<asp:Label ID="lblMOTOR_EXTRA_DESCRIPTION" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="MOTOR_EXTRA__DESCRIPTION" 
			Text="Description"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="MOTOR_EXTRA__DESCRIPTION" runat="server" />
		
		<asp:CustomValidator ID="valMOTOR_EXTRA_DESCRIPTION" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Description"
			ClientValidationFunction="onValidate_MOTOR_EXTRA__DESCRIPTION"
			ValidationGroup="" 
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MOTOR_EXTRA-VALUE">
		<asp:Label ID="lblMOTOR_EXTRA_VALUE" runat="server" AssociatedControlID="MOTOR_EXTRA__VALUE" 
			Text="Value" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOTOR_EXTRA__VALUE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOTOR_EXTRA_VALUE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Value"
			ClientValidationFunction="onValidate_MOTOR_EXTRA__VALUE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#frmExtraDet div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmExtraDet div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmExtraDet div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#frmExtraDet label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmExtraDet label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmExtraDet label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmExtraDet label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmExtraDet input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmExtraDet input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmExtraDet input{text-align:left;}"; break;
		}
	}
