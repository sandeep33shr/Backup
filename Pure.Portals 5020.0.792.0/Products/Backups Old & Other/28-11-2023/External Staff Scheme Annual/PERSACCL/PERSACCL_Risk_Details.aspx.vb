...
Namespace Nexus
    Partial Class PB2_PERSACCL_Risk_Details : Inherits BaseRisk
...
End Sub
Protected Sub onValidate_PSACC__PROD_CODE()
         
End Sub
Protected Sub CallRuleScripts()
    onValidate_GENERAL__TRANSTYPE()
    onValidate_PSACC__PROD_CODE()
End Sub

		    
         Protected Shadows Sub GetQuote(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	 Dim oQuote As NexusProvider.Quote = Session(CNQuote) 
        	 Dim TransactionType = GENERAL__TRANSTYPE.Text
        ...
        End Sub
         ...
         Protected Shadows Sub GetProdCode(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If Session(CNQuote) IsNot Nothing Then
        		'PSACC__BRANCH.Text = Trim(oQuote.BranchCode).ToString
        		PSACC__PROD_CODE.Text = Trim(oQuote.ProductCode).ToString
        	End If
        End Sub
