<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMSADCOM_Additional_Compulsory_First_Amount_Payable.aspx.vb" Inherits="Nexus.PB2_CMAMSADCOM_Additional_Compulsory_First_Amount_Payable" %>
...
function onValidate_ADD_COMP_CHILD__COMP_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADD_COMP_CHILD", "COMP_DESC", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ADD_COMP_CHILD", "COMP_DESC");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADD_COMP_CHILD_COMP_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADD_COMP_CHILD__COMP_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADD_COMP_CHILD__COMP_DESC_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADD_COMP_CHILD.COMP_DESC");
        			window.setControlWidth(field, "0.8", "ADD_COMP_CHILD", "COMP_DESC");
        		})();
        	}
        })();
...
function onValidate_ADD_COMP_CHILD__COMP_PERCC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADD_COMP_CHILD", "COMP_PERCC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADD_COMP_CHILD", "COMP_PERCC");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("ADD_COMP_CHILD", "COMP_PERCC");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADD_COMP_CHILD_COMP_PERCC");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADD_COMP_CHILD__COMP_PERCC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADD_COMP_CHILD__COMP_PERCC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADD_COMP_CHILD.COMP_PERCC");
        			window.setControlWidth(field, "0.5", "ADD_COMP_CHILD", "COMP_PERCC");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("ADD_COMP_CHILD.COMP_MIN != null")) ? new Expression("ADD_COMP_CHILD.COMP_MIN != null") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADD_COMP_CHILD".toUpperCase() + "__" + "COMP_PERCC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADD_COMP_CHILD".toUpperCase() + "_" + "COMP_PERCC");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("ADD_COMP_CHILD.COMP_PERCC > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADD_COMP_CHILD__COMP_MIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADD_COMP_CHILD", "COMP_MIN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADD_COMP_CHILD", "COMP_MIN");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("ADD_COMP_CHILD", "COMP_MIN");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADD_COMP_CHILD_COMP_MIN");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADD_COMP_CHILD__COMP_MIN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADD_COMP_CHILD__COMP_MIN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADD_COMP_CHILD.COMP_MIN");
        			window.setControlWidth(field, "0.5", "ADD_COMP_CHILD", "COMP_MIN");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("ADD_COMP_CHILD.COMP_PERCC != null")) ? new Expression("ADD_COMP_CHILD.COMP_PERCC != null") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Either FAP % or Minimum Amount must be entered")) ? "Either FAP % or Minimum Amount must be entered" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADD_COMP_CHILD".toUpperCase() + "__" + "COMP_MIN");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADD_COMP_CHILD".toUpperCase() + "_" + "COMP_MIN");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("ADD_COMP_CHILD.COMP_PERCC != null || ADD_COMP_CHILD.COMP_MIN != null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    onValidate_ADD_COMP_CHILD__COMP_DESC(null, null, null, isOnLoad);
    onValidate_ADD_COMP_CHILD__COMP_PERCC(null, null, null, isOnLoad);
    onValidate_ADD_COMP_CHILD__COMP_MIN(null, null, null, isOnLoad);
}
</script>
...
<div id="id9119e1098101457aa23ea2ade3a4331b" class="general-layout-container">
...
<div id="frmAdditional Compulsory First Amount Payable" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ADD_COMP_CHILD" 
		data-property-name="COMP_DESC" 
		 
		
		 
		id="pb-container-text-ADD_COMP_CHILD-COMP_DESC">

		
		<asp:Label ID="lblADD_COMP_CHILD_COMP_DESC" runat="server" AssociatedControlID="ADD_COMP_CHILD__COMP_DESC" 
			Text="Description " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ADD_COMP_CHILD__COMP_DESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valADD_COMP_CHILD_COMP_DESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description "
					ClientValidationFunction="onValidate_ADD_COMP_CHILD__COMP_DESC"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ADD_COMP_CHILD" 
		data-property-name="COMP_PERCC" 
		id="pb-container-percentage-ADD_COMP_CHILD-COMP_PERCC">
		<asp:Label ID="lblADD_COMP_CHILD_COMP_PERCC" runat="server" AssociatedControlID="ADD_COMP_CHILD__COMP_PERCC" 
			Text="FAP % " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="ADD_COMP_CHILD__COMP_PERCC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valADD_COMP_CHILD_COMP_PERCC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP % "
			ClientValidationFunction="onValidate_ADD_COMP_CHILD__COMP_PERCC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ADD_COMP_CHILD" 
		data-property-name="COMP_MIN" 
		id="pb-container-currency-ADD_COMP_CHILD-COMP_MIN">
		<asp:Label ID="lblADD_COMP_CHILD_COMP_MIN" runat="server" AssociatedControlID="ADD_COMP_CHILD__COMP_MIN" 
			Text="Minimum Amount " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADD_COMP_CHILD__COMP_MIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADD_COMP_CHILD_COMP_MIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount "
			ClientValidationFunction="onValidate_ADD_COMP_CHILD__COMP_MIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#frmAdditional Compulsory First Amount Payable div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmAdditional Compulsory First Amount Payable div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmAdditional Compulsory First Amount Payable div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#frmAdditional Compulsory First Amount Payable label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmAdditional Compulsory First Amount Payable label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmAdditional Compulsory First Amount Payable label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmAdditional Compulsory First Amount Payable label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmAdditional Compulsory First Amount Payable input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmAdditional Compulsory First Amount Payable input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmAdditional Compulsory First Amount Payable input{text-align:left;}"; break;
		}
	}
