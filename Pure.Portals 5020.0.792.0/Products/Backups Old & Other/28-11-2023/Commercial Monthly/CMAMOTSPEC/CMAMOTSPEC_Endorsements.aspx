<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMOTSPEC_Endorsements.aspx.vb" Inherits="Nexus.PB2_CMAMOTSPEC_Endorsements" %>
...
function onValidate_REFERRAL_CLAUSES__CMAMSEP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "REFERRAL_CLAUSES", "CMAMSEP", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_REFERRAL_CLAUSES__CMAMSEP(null, null, null, isOnLoad);
...
<div id="idf735c0175ae24e16a5ac32b25fdc159d" class="general-layout-container">
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_REFERRAL_CLAUSES__CMAMSEP"
		data-field-type="Child" 
		data-object-name="REFERRAL_CLAUSES" 
		data-property-name="CMAMSEP" 
		id="pb-container-childscreen-REFERRAL_CLAUSES-CMAMSEP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="REFERRAL_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="CMAMSEP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMSEP/CMAMSEP_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valREFERRAL_CLAUSES_CMAMSEP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for REFERRAL_CLAUSES.CMAMSEP"
						ClientValidationFunction="onValidate_REFERRAL_CLAUSES__CMAMSEP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
