<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMOTSPEC_Extensions.aspx.vb" Inherits="Nexus.PB2_CMAMOTSPEC_Extensions" %>
...
function onValidate_EXTENSIONS__IS_WSCREEN(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=EXTENSIONS&propertyName=IS_WSCREEN&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Windscreen FAP% cannot be greater than 100%")) ? "Windscreen FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EXTENSIONS".toUpperCase() + "__" + "EXT_WD_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EXTENSIONS".toUpperCase() + "_" + "EXT_WD_FAP");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("EXTENSIONS.EXT_WD_FAP > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EXTENSIONS__EXT_LK_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Loss of Keys FAP% cannot be greater than 100%")) ? "Loss of Keys FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EXTENSIONS".toUpperCase() + "__" + "EXT_LK_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EXTENSIONS".toUpperCase() + "_" + "EXT_LK_FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EXTENSIONS.EXT_LK_FAP > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EXTENSIONS__IS_RIOT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "RISK_DETAILS.COVER_TYPE == 2", "VE", "{3}");
        
            var paramValue = "V",
            paramCondition = "RISK_DETAILS.COVER_TYPE == 2",
            paramElseValue = "VE",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=EXTENSIONS&propertyName=IS_RIOT&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("RISK_DETAILS.COVER_TYPE == 2")) ? new Expression("RISK_DETAILS.COVER_TYPE == 2") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EXTENSIONS__IS_EXCESS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=EXTENSIONS&propertyName=IS_EXCESS&name={name}");
...
function onValidate_EXTENSIONS__IS_EXT_TERRITORY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=EXTENSIONS&propertyName=IS_EXT_TERRITORY&name={name}");
...
function onValidate_EXTENSIONS__EXT_ET_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Extended Territories FAP% cannot be greater than 100%")) ? "Extended Territories FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EXTENSIONS".toUpperCase() + "__" + "EXT_ET_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EXTENSIONS".toUpperCase() + "_" + "EXT_ET_FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EXTENSIONS.EXT_ET_FAP > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EXTENSIONS__IS_CAR_HIRE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "RISK_DETAILS.COVER_TYPE ==  1 AND (RISK_DETAILS.TYPEVEHICLECODE  == 'A' OR RISK_DETAILS.TYPEVEHICLECODE == 'B' )", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "RISK_DETAILS.COVER_TYPE ==  1 AND (RISK_DETAILS.TYPEVEHICLECODE  == 'A' OR RISK_DETAILS.TYPEVEHICLECODE == 'B' )",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=EXTENSIONS&propertyName=IS_CAR_HIRE&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("RISK_DETAILS.COVER_TYPE <> 1 OR (RISK_DETAILS.TYPEVEHICLECODE <> 'A' AND RISK_DETAILS.TYPEVEHICLECODE <> 'B') ")) ? new Expression("RISK_DETAILS.COVER_TYPE <> 1 OR (RISK_DETAILS.TYPEVEHICLECODE <> 'A' AND RISK_DETAILS.TYPEVEHICLECODE <> 'B') ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EXTENSIONS__IS_LOSS_USE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "(RISK_DETAILS.COVER_TYPE ==  1) and (RISK_DETAILS.TYPEVEHICLECODE <> 'A' AND RISK_DETAILS.TYPEVEHICLECODE <> 'B' AND RISK_DETAILS.TYPEVEHICLECODE <> 'C')", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "(RISK_DETAILS.COVER_TYPE ==  1) and (RISK_DETAILS.TYPEVEHICLECODE <> 'A' AND RISK_DETAILS.TYPEVEHICLECODE <> 'B' AND RISK_DETAILS.TYPEVEHICLECODE <> 'C')",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=EXTENSIONS&propertyName=IS_LOSS_USE&name={name}");
        		
        		var value = new Expression("0"), 
        			condition = (Expression.isValidParameter("RISK_DETAILS.COVER_TYPE <>  1 OR RISK_DETAILS.TYPEVEHICLECODE == 'A' OR RISK_DETAILS.TYPEVEHICLECODE == 'C' OR RISK_DETAILS.TYPEVEHICLECODE == 'B'")) ? new Expression("RISK_DETAILS.COVER_TYPE <>  1 OR RISK_DETAILS.TYPEVEHICLECODE == 'A' OR RISK_DETAILS.TYPEVEHICLECODE == 'C' OR RISK_DETAILS.TYPEVEHICLECODE == 'B'") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
<div id="idad3a27f7fb8148589b19efc5c4308f29" class="general-layout-container">
...
<div id="id9ed80fecacad4ccdbaa62c4280cca07f" class="column-layout-container  ">
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label94">
		<span class="label" id="label94">NASRIA - Motor Specified</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label102">
		<span class="label" id="label102">Total</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="EXTENSIONS" 
		data-property-name="EXT_CH_DAYSCode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-EXTENSIONS-EXT_CH_DAYSCode">

		
		
			
		
				<asp:HiddenField ID="EXTENSIONS__EXT_CH_DAYSCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9ed80fecacad4ccdbaa62c4280cca07f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9ed80fecacad4ccdbaa62c4280cca07f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9ed80fecacad4ccdbaa62c4280cca07f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9ed80fecacad4ccdbaa62c4280cca07f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9ed80fecacad4ccdbaa62c4280cca07f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9ed80fecacad4ccdbaa62c4280cca07f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9ed80fecacad4ccdbaa62c4280cca07f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9ed80fecacad4ccdbaa62c4280cca07f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9ed80fecacad4ccdbaa62c4280cca07f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9ed80fecacad4ccdbaa62c4280cca07f input{text-align:left;}"; break;
		}
	}
...
<div id="frmFleetNASRIA" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading37" runat="server" Text="NASRIA - Motor Fleet" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-suffix-none="true" 
		id="pb-container-text-EXTENSIONS-NASRIA_CATEGORYCode">

		
		
			
		
				<asp:HiddenField ID="EXTENSIONS__NASRIA_CATEGORYCode" runat="server" />
