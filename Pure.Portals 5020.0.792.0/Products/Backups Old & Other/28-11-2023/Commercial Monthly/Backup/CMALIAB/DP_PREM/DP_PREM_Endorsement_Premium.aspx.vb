...
Namespace Nexus
    Partial Class PB2_DP_PREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_DW_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DW_CLAUSEPREM__ENDORSE_ID()
End Sub
        ...
        'DEF_COMLIAB_CLAUSES - Standard Wording Parent Property
        'DW_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/COMLIAB/SW.DEF_COMLIAB_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("DW_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/COMLIAB/DW_CLAUSEPREM")
        
        	Dim CurrentSelected As String = DW_CLAUSEPREM__ENDORSE_CAP.Text
