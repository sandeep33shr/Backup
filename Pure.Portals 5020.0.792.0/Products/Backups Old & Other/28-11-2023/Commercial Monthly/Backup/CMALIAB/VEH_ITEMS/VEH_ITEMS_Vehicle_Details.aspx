<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="VEH_ITEMS_Vehicle_Details.aspx.vb" Inherits="Nexus.PB2_VEH_ITEMS_Vehicle_Details" %>
...
function onValidate_ITEM_DET__MAKE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ITEM_DET", "MAKE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ITEM_DET", "MAKE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ITEM_DET.MAKE");
        			window.setControlWidth(field, "0.8", "ITEM_DET", "MAKE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblITEM_DET_MAKE");
        			    var ele = document.getElementById('ctl00_cntMainBody_ITEM_DET__MAKE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ITEM_DET__MAKE_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=ITEM_DET&propertyName=MAKE&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "ITEM_DET" && field.getPropertyName() == "MAKE")
...
function onValidate_ITEM_DET__YEAR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ITEM_DET", "YEAR", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ITEM_DET", "YEAR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ITEM_DET.YEAR");
        			window.setControlWidth(field, "0.8", "ITEM_DET", "YEAR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblITEM_DET_YEAR");
        			    var ele = document.getElementById('ctl00_cntMainBody_ITEM_DET__YEAR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ITEM_DET__YEAR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ITEM_DET__REGNO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ITEM_DET", "REGNO", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ITEM_DET", "REGNO");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ITEM_DET.REGNO");
        			window.setControlWidth(field, "0.8", "ITEM_DET", "REGNO");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblITEM_DET_REGNO");
        			    var ele = document.getElementById('ctl00_cntMainBody_ITEM_DET__REGNO');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ITEM_DET__REGNO_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ITEM_DET__NUM_SEATS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ITEM_DET", "NUM_SEATS", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ITEM_DET", "NUM_SEATS");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ITEM_DET.NUM_SEATS");
        			window.setControlWidth(field, "0.8", "ITEM_DET", "NUM_SEATS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblITEM_DET_NUM_SEATS");
        			    var ele = document.getElementById('ctl00_cntMainBody_ITEM_DET__NUM_SEATS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ITEM_DET__NUM_SEATS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_ITEM_DET__MAKE(null, null, null, isOnLoad);
    onValidate_ITEM_DET__YEAR(null, null, null, isOnLoad);
    onValidate_ITEM_DET__REGNO(null, null, null, isOnLoad);
    onValidate_ITEM_DET__NUM_SEATS(null, null, null, isOnLoad);
}
</script>
...
<div id="id93836cb9628d496e85332ce544220d39" class="general-layout-container">
...
<div id="idcf865d347535424dbfb11f9f1b0b3444" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading124" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ITEM_DET" 
		data-property-name="MAKE" 
		 
		
		 
		id="pb-container-text-ITEM_DET-MAKE">

		
		<asp:Label ID="lblITEM_DET_MAKE" runat="server" AssociatedControlID="ITEM_DET__MAKE" 
			Text="Make/Model" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ITEM_DET__MAKE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valITEM_DET_MAKE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Make/Model"
					ClientValidationFunction="onValidate_ITEM_DET__MAKE"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-ITEM_DET-YEAR">

		
		<asp:Label ID="lblITEM_DET_YEAR" runat="server" AssociatedControlID="ITEM_DET__YEAR" 
			Text="Year" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ITEM_DET__YEAR" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valITEM_DET_YEAR" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Year"
					ClientValidationFunction="onValidate_ITEM_DET__YEAR"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-ITEM_DET-REGNO">

		
		<asp:Label ID="lblITEM_DET_REGNO" runat="server" AssociatedControlID="ITEM_DET__REGNO" 
			Text="Reg No" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ITEM_DET__REGNO" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valITEM_DET_REGNO" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Reg No"
					ClientValidationFunction="onValidate_ITEM_DET__REGNO"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ITEM_DET" 
		data-property-name="NUM_SEATS" 
		id="pb-container-integer-ITEM_DET-NUM_SEATS">
		<asp:Label ID="lblITEM_DET_NUM_SEATS" runat="server" AssociatedControlID="ITEM_DET__NUM_SEATS" 
			Text="No of Seats" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ITEM_DET__NUM_SEATS" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valITEM_DET_NUM_SEATS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for No of Seats"
			ClientValidationFunction="onValidate_ITEM_DET__NUM_SEATS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idcf865d347535424dbfb11f9f1b0b3444 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcf865d347535424dbfb11f9f1b0b3444 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcf865d347535424dbfb11f9f1b0b3444 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idcf865d347535424dbfb11f9f1b0b3444 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcf865d347535424dbfb11f9f1b0b3444 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcf865d347535424dbfb11f9f1b0b3444 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcf865d347535424dbfb11f9f1b0b3444 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcf865d347535424dbfb11f9f1b0b3444 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcf865d347535424dbfb11f9f1b0b3444 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcf865d347535424dbfb11f9f1b0b3444 input{text-align:left;}"; break;
		}
	}
