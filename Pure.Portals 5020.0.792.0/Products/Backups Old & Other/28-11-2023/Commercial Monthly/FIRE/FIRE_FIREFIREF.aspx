    ...
    <script type="text/javascript" language="javascript">
        ...
        function ToggleDS(flag) {
            ...
            if (FIRE__Bldg_ESCINFL_check) {
                ...
                //if ((ctrl == "RI_EXP__RI_IEP_RISK_SI") || (ctrl == "RI_EXP__RI_IEP_MPL_PERC")) {
                //   document.getElementById("<%= RI_EXP__RI_IEP_RI_EXPOSURE.ClientID%>").value = ((parseFloat(document.getElementById("<%= RI_EXP__RI_IEP_RISK_SI.ClientID%>").value) || 0) * (parseFloat(document.getElementById("<%= RI_EXP__RI_IEP_MPL_PERC.ClientID%>").value) || 0)) * .01;
        ...
        function CalculateEscSI() {
           ...
           if (document.getElementById("<%= RI_EXP__TOTAL_FIRE_RI_SI.ClientID%>").value != "") {
            ...
            //if (document.getElementById("<%= FIRE__BUILDINGS_ESCALATION_SI.ClientID%>").value != "") {
            //    document.getElementById("<%= RI_EXP__RI_IEP_MPL_PERC.ClientID%>").value = "100";
            //}
                    ...
                    <table class="grid-table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <%--<asp:RequiredFieldValidator ID="rfvFireRD2SI" runat="server" ControlToValidate="FIRE__RD2_SI"
                                        ErrorMessage="Sum Insured RENT is a required field" Enabled="false" SetFocusOnError="true" Display="none" />--%>
                            </td>
