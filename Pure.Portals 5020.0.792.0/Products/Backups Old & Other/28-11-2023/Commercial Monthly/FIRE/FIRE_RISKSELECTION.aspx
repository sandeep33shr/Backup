                ...
                <div class="form-horizontal">
                    ...
                    <div id="liGROUP_FIRE__FIRE" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Fire :</label><div class="col-md-8 col-sm-9">
                            <asp:CheckBox ID="GROUP_FIRE__FIRE" runat="server" onclick="SetRiskSelection();" Text=" " CssClass="asp-check"></asp:CheckBox>
                        </div>
                    </div>
                    <div id="liGROUP_FIRE__OFFICE_CONTENTS" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="col-md-8 col-sm-9">
                            <asp:CheckBox ID="GROUP_FIRE__OFFICE_CONTENTS" runat="server" onclick="SetRiskSelection();" Text=" " CssClass="asp-check"></asp:CheckBox>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__EX_LIMIT_APPL" runat="server" listtype="UserDefined" listcode="QUES" parentlookuplistid="" dataitemvalue="Key" dataitemtext="Description" sort="Desc" cssclass="form-control"></NexusProvider:lookuplist>
                        </div>
                    </div>
                </div>
                <div class="form-horizontal">
                    ...
                    <div id="liGROUP_FIRE__INDUSTRYN" class="doublewidth form-group form-group-sm col-lg-6 col-md-6 col-sm-12" style="display: none;">
                        <asp:Label ID="Label1" runat="server" Text="Industry" class="col-md-4 col-sm-3 control-label"></asp:Label><div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__INDUSTRYN" runat="server" listtype="UserDefined" listcode="INDUSTRY" parentlookuplistid="" dataitemvalue="Key" dataitemtext="Description" defaulttext="(None)" value="0" cssclass="form-control"></NexusProvider:lookuplist>
                        </div>
                    </div>
                    ...
                    <div id="liGROUP_FIRE__MANUAL_RI_LIMIT_NO" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__MANUAL_RI_LIMIT_NO" runat="server" listtype="PMLookup" listcode="UDL_EBPGF_RILIMITSNOS" defaulttext="(None)" value="0" parentlookuplistid="" cssclass="form-control"></NexusProvider:lookuplist>
                        </div>
                    </div>
                    <div id="liGROUP_FIRE__TYPE_CONSTRUCTION" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__TYPE_CONSTRUCTION" runat="server" listtype="UserDefined" listcode="CONSTTYPE" parentlookuplistid="" dataitemvalue="Key" dataitemtext="Description" defaulttext="(None)" value="0" cssclass="field-mandatory form-control"></NexusProvider:lookuplist>
                        </div>
                    ...
                    <div id="liGROUP_FIRE__RILIMITNUM" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__RILIMITNUM" runat="server" listtype="UserDefined" listcode="RILIMITNO" parentlookuplistid="GROUP_FIRE__INDUSTRYN" dataitemvalue="Key" dataitemtext="Description" defaulttext="(None)" value="0" cssclass="field-mandatory form-control"></NexusProvider:lookuplist>
                        </div>
                ...
                <div class="form-horizontal">
                    ...
                    <div id="liGROUP_FIRE__THREEYEARLOSS" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">3 Year Loss Ratio :</label><div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__THREEYEARLOSS" runat="server" listtype="UserDefined" listcode="THREEYLR" parentlookuplistid="" dataitemvalue="Key" dataitemtext="Description" defaulttext="(None)" value="0" cssclass="field-medium form-control"></NexusProvider:lookuplist>
                        </div>
                    ...
                    <div id="liGROUP_FIRE__BRANCH_MARKET_ADJUST" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Branch Market Adjustment :</label><div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__BRANCH_MARKET_ADJUST" runat="server" listtype="PMLookup" listcode="UDL_EBPGFBMADJUST" defaulttext="(None)" value="0" cssclass="field-medium form-control"></NexusProvider:lookuplist>
                        </div>
                    ...
                    <div id="liGROUP_FIRE__ADJUST_BRANCH_MKT" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">H/O Market Adjustment :</label><div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__ADJUST_BRANCH_MKT" runat="server" listtype="PMLookup" listcode="UDL_EBPGFBMADJUST" defaulttext="(None)" value="0" cssclass="field-medium form-control"></NexusProvider:lookuplist>
                        </div>
                    ...
                    <div id="liGROUP_FIRE__SPECIALS" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Special :</label><div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__SPECIALS" runat="server" listtype="PMLookup" listcode="UDL_EBPGFBMADJUST" defaulttext="(None)" value="0" cssclass="field-medium form-control"></NexusProvider:lookuplist>
                        </div>
                ...
                <div class="form-horizontal">
                    ...
                    <div id="liGROUP_FIRE__APPLICABLE" class="doublewidth form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Applicable</label><div class="col-md-8 col-sm-9">
                            <asp:CheckBox ID="GROUP_FIRE__APPLICABLE" runat="server" onclick="ToggleSurveyReport(this.checked);" Text=" " CssClass="asp-check"></asp:CheckBox>
                        </div>
                    </div>
                    <div id="liGROUP_FIRE__LAST_SURVEY_DATE" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Last Survey Date :</label><div class="col-md-8 col-sm-9">
                            <div class="input-group">
                                <asp:TextBox ID="GROUP_FIRE__LAST_SURVEY_DATE" runat="server" CssClass="form-control"></asp:TextBox><NexusControl:calendarlookup id="calGROUP_FIRE__LAST_SURVEY_DATE" runat="server" linkedcontrol="GROUP_FIRE__LAST_SURVEY_DATE" hlevel="1"></NexusControl:calendarlookup>
                            </div>
                        </div>
                    ...
                    <div id="liGROUP_FIRE__SURVEY_NUMBER" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Survey Number :</label><div class="col-md-8 col-sm-9">
                            <asp:TextBox ID="GROUP_FIRE__SURVEY_NUMBER" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                    </div>
                    <div id="liGROUP_FIRE__DATE_SURVEY_REQUESTED" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Date Survey Requested :</label><div class="col-md-8 col-sm-9">
                            <div class="input-group">
                                <asp:TextBox ID="GROUP_FIRE__DATE_SURVEY_REQUESTED" runat="server" CssClass="form-control"></asp:TextBox><NexusControl:calendarlookup id="calGROUP_FIRE__DATE_SURVEY_REQUESTED" runat="server" linkedcontrol="GROUP_FIRE__DATE_SURVEY_REQUESTED" hlevel="1"></NexusControl:calendarlookup>
                            </div>
                        </div>
                    ...
                    <div id="liGROUP_FIRE__FREQUENCY" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Frequency :</label><div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="GROUP_FIRE__FREQUENCY" runat="server" listtype="PMLookup" listcode="UDL_EBPGFSRFREQ" defaulttext="(None)" value="0" cssclass="form-control"></NexusProvider:lookuplist>
                        </div>
                    </div>
