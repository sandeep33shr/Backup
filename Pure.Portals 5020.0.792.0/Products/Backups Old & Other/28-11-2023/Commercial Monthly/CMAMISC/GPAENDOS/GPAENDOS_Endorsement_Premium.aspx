...
<div id="id9b972f73e02446d59ed83cfeb044c95a" class="general-layout-container">
...
<div id="id6771ce0b78d145d6a5f93071095f6bc8" class="column-layout-container  ">
		...
		<asp:Label ID="lblGPA_ENDOSE_COUNTER_ID" runat="server" AssociatedControlID="GPA_ENDOSE__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPA_ENDOSE__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblGPA_ENDOSE_ENDORSE_CAP" runat="server" AssociatedControlID="GPA_ENDOSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPA_ENDOSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPA_ENDOSE-ENDORSE_DESCCode">
				...
				<asp:HiddenField ID="GPA_ENDOSE__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6771ce0b78d145d6a5f93071095f6bc8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6771ce0b78d145d6a5f93071095f6bc8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6771ce0b78d145d6a5f93071095f6bc8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6771ce0b78d145d6a5f93071095f6bc8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6771ce0b78d145d6a5f93071095f6bc8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6771ce0b78d145d6a5f93071095f6bc8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6771ce0b78d145d6a5f93071095f6bc8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6771ce0b78d145d6a5f93071095f6bc8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6771ce0b78d145d6a5f93071095f6bc8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6771ce0b78d145d6a5f93071095f6bc8 input{text-align:left;}"; break;
		}
	}
