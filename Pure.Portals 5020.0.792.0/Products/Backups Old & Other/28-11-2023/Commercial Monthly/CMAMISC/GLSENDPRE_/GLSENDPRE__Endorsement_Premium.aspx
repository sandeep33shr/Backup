...
<div id="id579a240b2c9941cc953272a53ed45bbc" class="general-layout-container">
...
<div id="idbfcb2adb844b4d0b9af20c505cdcb4da" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idbfcb2adb844b4d0b9af20c505cdcb4da div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbfcb2adb844b4d0b9af20c505cdcb4da div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbfcb2adb844b4d0b9af20c505cdcb4da div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idbfcb2adb844b4d0b9af20c505cdcb4da label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbfcb2adb844b4d0b9af20c505cdcb4da label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbfcb2adb844b4d0b9af20c505cdcb4da label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbfcb2adb844b4d0b9af20c505cdcb4da label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbfcb2adb844b4d0b9af20c505cdcb4da input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbfcb2adb844b4d0b9af20c505cdcb4da input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbfcb2adb844b4d0b9af20c505cdcb4da input{text-align:left;}"; break;
		}
	}
