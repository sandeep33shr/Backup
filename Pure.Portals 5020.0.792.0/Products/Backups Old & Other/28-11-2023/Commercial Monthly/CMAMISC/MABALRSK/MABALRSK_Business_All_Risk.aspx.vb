...
Namespace Nexus
    Partial Class PB2_MABALRSK_Business_All_Risk : Inherits BaseRisk
		...
		Protected Sub onValidate_BALLRISK__INCR()
        
End Sub
Protected Sub onValidate_BALLRISK__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BALLRISK__INCR()
    onValidate_BALLRISK__COUNTER_ID()
End Sub
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "BAR" & "/" & "BALLRISK", sXMLDataset)
                            If sChildId <> "0" Then
                                BALLRISK__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
