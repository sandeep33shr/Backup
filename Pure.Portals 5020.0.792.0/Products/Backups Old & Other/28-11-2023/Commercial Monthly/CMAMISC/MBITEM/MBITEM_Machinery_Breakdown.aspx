...
function onValidate_MB_ITEM__FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("MB_ITEM.BASEDEDUCT.setValue('')");
        		var whenExp = (Expression.isValidParameter("MB_ITEM.FAP = '' || MB_ITEM.FAP = null")) ? new Expression("MB_ITEM.FAP = '' || MB_ITEM.FAP = null") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_MB_ITEM__BASEDEDUCT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueWhen = new ValueWhenHelper(new Expression("1"), (Expression.isValidParameter("(MB_ITEM.FAP <>'' AND MB_ITEM.FAP <> null) AND MB_ITEM.BASEDEDUCTCode = ''")) ? new Expression("(MB_ITEM.FAP <>'' AND MB_ITEM.FAP <> null) AND MB_ITEM.BASEDEDUCTCode = ''") : null, (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null);
...
<div id="id021da661f6f94beabfe8157c938c5518" class="general-layout-container">
...
<div id="id8919c8dd7edc4c1fb78d4cb87d1866ae" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8919c8dd7edc4c1fb78d4cb87d1866ae div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8919c8dd7edc4c1fb78d4cb87d1866ae div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8919c8dd7edc4c1fb78d4cb87d1866ae div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8919c8dd7edc4c1fb78d4cb87d1866ae label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8919c8dd7edc4c1fb78d4cb87d1866ae label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8919c8dd7edc4c1fb78d4cb87d1866ae label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8919c8dd7edc4c1fb78d4cb87d1866ae label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8919c8dd7edc4c1fb78d4cb87d1866ae input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8919c8dd7edc4c1fb78d4cb87d1866ae input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8919c8dd7edc4c1fb78d4cb87d1866ae input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb6912184b6dc40ac90e8e26730fce2b5" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb6912184b6dc40ac90e8e26730fce2b5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb6912184b6dc40ac90e8e26730fce2b5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb6912184b6dc40ac90e8e26730fce2b5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb6912184b6dc40ac90e8e26730fce2b5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb6912184b6dc40ac90e8e26730fce2b5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb6912184b6dc40ac90e8e26730fce2b5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb6912184b6dc40ac90e8e26730fce2b5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb6912184b6dc40ac90e8e26730fce2b5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb6912184b6dc40ac90e8e26730fce2b5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb6912184b6dc40ac90e8e26730fce2b5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8080de8d81304abcab8c9dfbe404bcfd" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8080de8d81304abcab8c9dfbe404bcfd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8080de8d81304abcab8c9dfbe404bcfd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8080de8d81304abcab8c9dfbe404bcfd div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8080de8d81304abcab8c9dfbe404bcfd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8080de8d81304abcab8c9dfbe404bcfd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8080de8d81304abcab8c9dfbe404bcfd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8080de8d81304abcab8c9dfbe404bcfd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8080de8d81304abcab8c9dfbe404bcfd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8080de8d81304abcab8c9dfbe404bcfd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8080de8d81304abcab8c9dfbe404bcfd input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id44af66fa017449a0afb48dc55e67f9fc" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id44af66fa017449a0afb48dc55e67f9fc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id44af66fa017449a0afb48dc55e67f9fc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id44af66fa017449a0afb48dc55e67f9fc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id44af66fa017449a0afb48dc55e67f9fc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id44af66fa017449a0afb48dc55e67f9fc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id44af66fa017449a0afb48dc55e67f9fc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id44af66fa017449a0afb48dc55e67f9fc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id44af66fa017449a0afb48dc55e67f9fc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id44af66fa017449a0afb48dc55e67f9fc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id44af66fa017449a0afb48dc55e67f9fc input{text-align:left;}"; break;
		}
	}
