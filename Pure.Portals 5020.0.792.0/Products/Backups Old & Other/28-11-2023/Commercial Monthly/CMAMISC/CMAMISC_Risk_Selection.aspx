...
function onValidate_GENERAL__CHECK_BAR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_BARCode == 'DELETE' ||GENERAL.CHECK_BARCode == 'VIEW') && GENERAL.IS_BAR == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_GLASS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_GLASSCode == 'DELETE' ||GENERAL.CHECK_GLASSCode == 'VIEW') && GENERAL.IS_GLASS == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_THFT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_THFTCode == 'DELETE' ||GENERAL.CHECK_THFTCode == 'VIEW') && GENERAL.IS_THEFT == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_MONEY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_MONEYCode == 'DELETE' ||GENERAL.CHECK_MONEYCode == 'VIEW') && GENERAL.IS_MONEY == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_GIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_GITCode == 'DELETE' ||GENERAL.CHECK_GITCode == 'VIEW') && GENERAL.IS_GIT == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_PA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_PACode == 'DELETE' ||GENERAL.CHECK_PACode == 'VIEW') && GENERAL.IS_PA == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_SB(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_SBCode == 'DELETE' ||GENERAL.CHECK_SBCode == 'VIEW') && GENERAL.IS_SB == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_FG(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_FGCode == 'DELETE' ||GENERAL.CHECK_FGCode == 'VIEW') && GENERAL.IS_FIDELITY == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_ELECEQ(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_ELECEQCode == 'DELETE' ||GENERAL.CHECK_ELECEQCode == 'VIEW') && GENERAL.IS_ELECEQUIP == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CHECK_MBRK(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_MBRKCode == 'DELETE' ||GENERAL.CHECK_MBRKCode == 'VIEW') && GENERAL.IS_MACHINERY == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
<div id="idcb8dc6f9f7f349c7a62e9b9df3fdf0fa" class="general-layout-container">
...
<div id="iddc8f3a18ddf3417baee02a1fdd029984" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddc8f3a18ddf3417baee02a1fdd029984 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddc8f3a18ddf3417baee02a1fdd029984 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddc8f3a18ddf3417baee02a1fdd029984 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddc8f3a18ddf3417baee02a1fdd029984 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddc8f3a18ddf3417baee02a1fdd029984 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddc8f3a18ddf3417baee02a1fdd029984 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddc8f3a18ddf3417baee02a1fdd029984 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddc8f3a18ddf3417baee02a1fdd029984 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddc8f3a18ddf3417baee02a1fdd029984 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddc8f3a18ddf3417baee02a1fdd029984 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- ColumnLayoutContainer -->
<div id="ida82ba5364bf44a85beabce7597ec62f4" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida82ba5364bf44a85beabce7597ec62f4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida82ba5364bf44a85beabce7597ec62f4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida82ba5364bf44a85beabce7597ec62f4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida82ba5364bf44a85beabce7597ec62f4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida82ba5364bf44a85beabce7597ec62f4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida82ba5364bf44a85beabce7597ec62f4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida82ba5364bf44a85beabce7597ec62f4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida82ba5364bf44a85beabce7597ec62f4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida82ba5364bf44a85beabce7597ec62f4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida82ba5364bf44a85beabce7597ec62f4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf4bac88545fa4a69963c34a6f04f88ea" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf4bac88545fa4a69963c34a6f04f88ea div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf4bac88545fa4a69963c34a6f04f88ea div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf4bac88545fa4a69963c34a6f04f88ea div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf4bac88545fa4a69963c34a6f04f88ea label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf4bac88545fa4a69963c34a6f04f88ea label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf4bac88545fa4a69963c34a6f04f88ea label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf4bac88545fa4a69963c34a6f04f88ea label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf4bac88545fa4a69963c34a6f04f88ea input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf4bac88545fa4a69963c34a6f04f88ea input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf4bac88545fa4a69963c34a6f04f88ea input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7efe52fb50ba4d65b2ec9c11deba3d1e" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7efe52fb50ba4d65b2ec9c11deba3d1e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7efe52fb50ba4d65b2ec9c11deba3d1e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7efe52fb50ba4d65b2ec9c11deba3d1e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7efe52fb50ba4d65b2ec9c11deba3d1e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7efe52fb50ba4d65b2ec9c11deba3d1e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7efe52fb50ba4d65b2ec9c11deba3d1e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7efe52fb50ba4d65b2ec9c11deba3d1e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7efe52fb50ba4d65b2ec9c11deba3d1e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7efe52fb50ba4d65b2ec9c11deba3d1e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7efe52fb50ba4d65b2ec9c11deba3d1e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6051f47548a448548bcd195149f0995a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6051f47548a448548bcd195149f0995a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6051f47548a448548bcd195149f0995a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6051f47548a448548bcd195149f0995a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6051f47548a448548bcd195149f0995a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6051f47548a448548bcd195149f0995a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6051f47548a448548bcd195149f0995a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6051f47548a448548bcd195149f0995a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6051f47548a448548bcd195149f0995a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6051f47548a448548bcd195149f0995a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6051f47548a448548bcd195149f0995a input{text-align:left;}"; break;
		}
	}
