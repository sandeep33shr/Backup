...
function onValidate_AR__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "AR" && field.getPropertyName() == "RISK_ATTACH_DATE")
        		...
        		var condition = (Expression.isValidParameter("GENERAL.IS_ARCode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')")) ? new Expression("GENERAL.IS_ARCode == 'VIEW' && (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')") : null;
        		if (condition == null){ 
        			disablePage(false);
        		} else {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AR", "FLAT_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_AR__ODB_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Outstanding Debit Balances Sum Insured Is Required";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("REINSEXP_AR.ODB_TOTAL_SI.setValue('') ||REINSEXP_AR.ODB_TARGET_SI.setValue('') ||REINSEXP_AR.ODB_MPL.setValue('') ||REINSEXP_AR.ODB_RI_EXP.setValue('') ");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AR.ODB_PREMIUM.setValue((AR.ODB_SI* AR.ODB_RATE)*0.01)");
        		var whenExp = (Expression.isValidParameter("(AR.ODB_SI <> '' AND AR.ODB_SI <> null ) and (AR.ODB_RATE <> '' AND AR.ODB_RATE <> null ) ")) ? new Expression("(AR.ODB_SI <> '' AND AR.ODB_SI <> null ) and (AR.ODB_RATE <> '' AND AR.ODB_RATE <> null ) ") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AR__ODB_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Outstanding Debit Balances Premium Is Required";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AR.ODB_RATE.setValue((AR.ODB_PREMIUM/AR.ODB_SI) * 100)");
        		var whenExp = (Expression.isValidParameter("(AR.ODB_SI <> '' AND AR.ODB_SI <> null ) and (AR.ODB_RATE <> '' AND  AR.ODB_RATE <> null )")) ? new Expression("(AR.ODB_SI <> '' AND AR.ODB_SI <> null ) and (AR.ODB_RATE <> '' AND  AR.ODB_RATE <> null )") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AR".toUpperCase() + "__" + "FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AR".toUpperCase() + "_" + "FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("AR.FAP <= 100 || (AR.FAP == '' || AR.FAP == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AR__FAP_MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(AR.FAP_MIN_AMOUNT<=AR.FAP_MAX_AMOUNT) || (AR.FAP_MIN_AMOUNT == '' || AR.FAP_MIN_AMOUNT == null || AR.FAP_MIN_AMOUNT !=null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AR__FAP_MAX_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Maximum Amount should be more than Min if min completed /Maximum Amount cannot be entered if minimum is not entered")) ? "Maximum Amount should be more than Min if min completed /Maximum Amount cannot be entered if minimum is not entered" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(AR.FAP_MAX_AMOUNT != null AND AR.FAP_MIN_AMOUNT != null AND AR.FAP_MAX_AMOUNT >= AR.FAP_MIN_AMOUNT) OR AR.FAP_MAX_AMOUNT == null OR AR.FAP_MAX_AMOUNT == ''");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AR_EXTENSIONS__IS_ACPC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		// Setup an instance of the field
        		var field = Field.getInstance("AR_EXTENSIONS", "IS_ACPC");
        		
        		var valueExp = new Expression("AR_EXTENSIONS.ACPC_LOI.setValue('')||AR_EXTENSIONS.ACPC_RATE.setValue('')||AR_EXTENSIONS.ACPC_PREMIUM.setValue('')||REINSEXP_AR.ACPC_TOTAL_SI.setValue('') ||REINSEXP_AR.ACPC_TARGET_SI.setValue('') ||REINSEXP_AR.ACPC_MPL.setValue('') ||REINSEXP_AR.ACPC_RI_EXP.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AR_EXTENSIONS__ACPC_LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AR_EXTENSIONS.IS_ACPC == true", "V", "Additional Claims Preparation Costs Limit of Indemnity Is Required");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Limit of Indemnity cannot exceed Sum Insured entered for Outstanding Debit Balances.")) ? "Limit of Indemnity cannot exceed Sum Insured entered for Outstanding Debit Balances." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AR_EXTENSIONS".toUpperCase() + "__" + "ACPC_LOI");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AR_EXTENSIONS".toUpperCase() + "_" + "ACPC_LOI");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(AR.ODB_SI >= AR_EXTENSIONS.ACPC_LOI) ||(AR_EXTENSIONS.ACPC_LOI =='' || AR_EXTENSIONS.ACPC_LOI ==null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AR_EXTENSIONS.ACPC_PREMIUM.setValue((AR_EXTENSIONS.ACPC_LOI* AR_EXTENSIONS.ACPC_RATE)*0.01)");
        		var whenExp = (Expression.isValidParameter("(AR_EXTENSIONS.ACPC_LOI <> '' AND AR_EXTENSIONS.ACPC_LOI <> null ) and (AR_EXTENSIONS.ACPC_RATE <> '' AND AR_EXTENSIONS.ACPC_RATE <> null ) ")) ? new Expression("(AR_EXTENSIONS.ACPC_LOI <> '' AND AR_EXTENSIONS.ACPC_LOI <> null ) and (AR_EXTENSIONS.ACPC_RATE <> '' AND AR_EXTENSIONS.ACPC_RATE <> null ) ") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AR_EXTENSIONS__ACPC_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AR_EXTENSIONS.ACPC_PREMIUM.setValue(AR_EXTENSIONS.ACPC_LOI * (AR_EXTENSIONS.ACPC_RATE * 0.01))");
        		var whenExp = (Expression.isValidParameter("AR_EXTENSIONS.ACPC_LOI > 0")) ? new Expression("AR_EXTENSIONS.ACPC_LOI > 0") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AR_EXTENSIONS__ACPC_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AR_EXTENSIONS.IS_ACPC == true", "V", "Additional Claims Preparation Costs Premium Is Required");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("AR_EXTENSIONS.ACPC_RATE.setValue((AR_EXTENSIONS.ACPC_PREMIUM/AR_EXTENSIONS.ACPC_LOI) * 100)");
        		var whenExp = (Expression.isValidParameter("(AR_EXTENSIONS.ACPC_LOI <> '' AND AR_EXTENSIONS.ACPC_LOI <> null ) and (AR_EXTENSIONS.ACPC_RATE <> '' AND  AR_EXTENSIONS.ACPC_RATE <> null )")) ? new Expression("(AR_EXTENSIONS.ACPC_LOI <> '' AND AR_EXTENSIONS.ACPC_LOI <> null ) and (AR_EXTENSIONS.ACPC_RATE <> '' AND  AR_EXTENSIONS.ACPC_RATE <> null )") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AR_EXTENSIONS__IS_RIOT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		// Setup an instance of the field
        		var field = Field.getInstance("AR_EXTENSIONS", "IS_RIOT");
        		
        		var valueExp = new Expression("AR_EXTENSIONS.RIOT_PREMIUM.setValue('')||AR_EXTENSIONS.RIOT_FAP.setValue('')||AR_EXTENSIONS.RIOT_FAP_AMOUNT.setValue('')");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_AR_EXTENSIONS__RIOT_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AR_EXTENSIONS.IS_RIOT == true", "V", "Riot & Strike Premium Is Required");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AR_EXTENSIONS".toUpperCase() + "__" + "RIOT_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AR_EXTENSIONS".toUpperCase() + "_" + "RIOT_FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("AR_EXTENSIONS.RIOT_FAP<= 100 || (AR_EXTENSIONS.RIOT_FAP == '' || AR_EXTENSIONS.RIOT_FAP == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AR_EXTENSIONS__RIOT_FAP_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AR_EXTENSIONS.IS_RIOT ==1", "V", "Riot & Strike FAP Minimum Amount Is Required");
        
            var paramValue = "VEM",
            paramCondition = "AR_EXTENSIONS.IS_RIOT ==1",
            paramElseValue = "V",
            paramValidationMessage = "Riot & Strike FAP Minimum Amount Is Required";
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("AR_EXTENSIONS.ACPC_PREMIUM + AR_EXTENSIONS.RIOT_PREMIUM"), 
        			condition = (Expression.isValidParameter("(AR_EXTENSIONS.ACPC_PREMIUM != '' ||AR_EXTENSIONS.ACPC_PREMIUM !=null) || (AR_EXTENSIONS.RIOT_PREMIUM != null ||AR_EXTENSIONS.RIOT_PREMIUM !='')")) ? new Expression("(AR_EXTENSIONS.ACPC_PREMIUM != '' ||AR_EXTENSIONS.ACPC_PREMIUM !=null) || (AR_EXTENSIONS.RIOT_PREMIUM != null ||AR_EXTENSIONS.RIOT_PREMIUM !='')") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_AR__ARENDPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("AR", "ARENDPREM");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_AR__ARENDPREM table td a");
        				
        		} else {
        		   links = goog.dom.query("a", field.getElement());
        		}		
                var exp = new Expression("GENERAL.IS_ARCode == 'VIEW'&& (GENERAL.TRANSACTION_TYPE =='MTA' || GENERAL.TRANSACTION_TYPE =='MTC')");
...
function onValidate_AR__AREND_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AR", "AREND_CNT", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AR", "AREND_CNT");
        		}
          ...
          * @fileoverview GetColumn
          * @param AR The Parent (Root) object name.
          * @param AR_CLAUSE.ENDORSE_ID The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AR".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "AR_CLAUSE.ENDORSE_ID";
        		//count, average, total, min, max
...
function onValidate_AR__ARNOTES(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("AR", "ARNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_AR__ARNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("AR", "ARNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'AR' and property 'ARNOTES'.");
        			error.display();
...
function onValidate_AR__ARNOTES_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AR", "ARNOTES_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AR", "ARNOTES_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param AR The Parent (Root) object name.
          * @param AR_CNOTE_DETAILS.Date_Created The object.property to sum the totals of.
          * @param MAX The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AR".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "AR_CNOTE_DETAILS.Date_Created";
        		//count, average, total, min, max
        		var type = "MAX".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_AR__ARSNOTES(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("AR", "ARSNOTES");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_AR__ARSNOTES table td a");
...
function onValidate_AR__ARSNOTES_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AR", "ARSNOTES_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AR", "ARSNOTES_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param AR The Parent (Root) object name.
          * @param AR_SNOTE_DETAILS.Date_Created The object.property to sum the totals of.
          * @param MAX The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AR".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "AR_SNOTE_DETAILS.Date_Created";
        		//count, average, total, min, max
        		var type = "MAX".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_REINSEXP_AR__ODB_TOTAL_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("REINSEXP_AR.ODB_TARGET_SI.setValue(REINSEXP_AR.ODB_TOTAL_SI) || REINSEXP_AR.ODB_MPL.setValue(100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_REINSEXP_AR__ODB_TARGET_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "REINSEXP_AR.ODB_TOTAL_SI > 0", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("REINSEXP_AR.ODB_TOTAL_SI == '' || REINSEXP_AR.ODB_TOTAL_SI == null")) ? new Expression("REINSEXP_AR.ODB_TOTAL_SI == '' || REINSEXP_AR.ODB_TOTAL_SI == null") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_REINSEXP_AR__ODB_MPL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Outstanding Debit Balances MPL% cannot be less than 50%")) ? "Outstanding Debit Balances MPL% cannot be less than 50%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REINSEXP_AR".toUpperCase() + "__" + "ODB_MPL");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "REINSEXP_AR".toUpperCase() + "_" + "ODB_MPL");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(REINSEXP_AR.ODB_MPL >= GENERAL.FIRE_MPL) || (REINSEXP_AR.ODB_MPL == '' || REINSEXP_AR.ODB_MPL == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Outstanding Debit Balances MPL% cannot exceed 100%")) ? "Outstanding Debit Balances MPL% cannot exceed 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REINSEXP_AR".toUpperCase() + "__" + "ODB_MPL");
        				if (node == null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(REINSEXP_AR.ODB_MPL <= 100) || (REINSEXP_AR.ODB_MPL == '' || REINSEXP_AR.ODB_MPL == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_REINSEXP_AR__ODB_RI_EXP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "REINSEXP_AR.ODB_TOTAL_SI > 0", "V", "{3}");
...
function onValidate_REINSEXP_AR__ACPC_TOTAL_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "AR_EXTENSIONS.IS_ACPC == true", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("AR_EXTENSIONS.ACPC_LOI"), 
        			condition = (Expression.isValidParameter("AR_EXTENSIONS.IS_ACPC == true")) ? new Expression("AR_EXTENSIONS.IS_ACPC == true") : null, 
        			elseValue = (Expression.isValidParameter("null")) ? new Expression("null") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("REINSEXP_AR.ACPC_TARGET_SI.setValue(REINSEXP_AR.ACPC_TOTAL_SI) || REINSEXP_AR.ACPC_MPL.setValue(100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_REINSEXP_AR__ACPC_TARGET_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("REINSEXP_AR.ACPC_TOTAL_SI == '' ||REINSEXP_AR.ACPC_TOTAL_SI == null")) ? new Expression("REINSEXP_AR.ACPC_TOTAL_SI == '' ||REINSEXP_AR.ACPC_TOTAL_SI == null") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_REINSEXP_AR__ACPC_MPL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Additional Claim Preparation Costs MPL% cannot be less than 50%")) ? "Additional Claim Preparation Costs MPL% cannot be less than 50%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REINSEXP_AR".toUpperCase() + "__" + "ACPC_MPL");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "REINSEXP_AR".toUpperCase() + "_" + "ACPC_MPL");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(REINSEXP_AR.ACPC_MPL >= GENERAL.FIRE_MPL) || (REINSEXP_AR.ACPC_MPL == '' || REINSEXP_AR.ACPC_MPL == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Additional Claim Preparation Costs MPL% cannot exceed 100%")) ? "Additional Claim Preparation Costs MPL% cannot exceed 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REINSEXP_AR".toUpperCase() + "__" + "ACPC_MPL");
        				if (node == null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(REINSEXP_AR.ACPC_MPL <= 100) || (REINSEXP_AR.ACPC_MPL == '' || REINSEXP_AR.ACPC_MPL == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_AR__AREND_CNT(null, null, null, isOnLoad);
    onValidate_AR__ARNOTES(null, null, null, isOnLoad);
    onValidate_AR__ARNOTES_CNT(null, null, null, isOnLoad);
    onValidate_AR__ARSNOTES(null, null, null, isOnLoad);
    onValidate_AR__ARSNOTES_CNT(null, null, null, isOnLoad);
...
<div id="idddc2eeaea2f746bdaaefd2cfc503deb3" class="general-layout-container">
...
<div id="id7162359781f94dea83751ffe580a228c" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7162359781f94dea83751ffe580a228c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7162359781f94dea83751ffe580a228c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7162359781f94dea83751ffe580a228c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7162359781f94dea83751ffe580a228c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7162359781f94dea83751ffe580a228c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7162359781f94dea83751ffe580a228c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7162359781f94dea83751ffe580a228c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7162359781f94dea83751ffe580a228c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7162359781f94dea83751ffe580a228c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7162359781f94dea83751ffe580a228c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id988dd26090d2441f86effb831b5886e0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading135" runat="server" Text="Aggregate" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id988dd26090d2441f86effb831b5886e0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id988dd26090d2441f86effb831b5886e0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id988dd26090d2441f86effb831b5886e0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id988dd26090d2441f86effb831b5886e0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id988dd26090d2441f86effb831b5886e0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id988dd26090d2441f86effb831b5886e0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id988dd26090d2441f86effb831b5886e0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id988dd26090d2441f86effb831b5886e0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id988dd26090d2441f86effb831b5886e0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id988dd26090d2441f86effb831b5886e0 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide20f8aedc7bb4549b46a9021140ee658" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading136" runat="server" Text="Outstanding Debit Balances" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide20f8aedc7bb4549b46a9021140ee658 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide20f8aedc7bb4549b46a9021140ee658 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide20f8aedc7bb4549b46a9021140ee658 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide20f8aedc7bb4549b46a9021140ee658 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide20f8aedc7bb4549b46a9021140ee658 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide20f8aedc7bb4549b46a9021140ee658 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide20f8aedc7bb4549b46a9021140ee658 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide20f8aedc7bb4549b46a9021140ee658 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide20f8aedc7bb4549b46a9021140ee658 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide20f8aedc7bb4549b46a9021140ee658 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id54ff97c916dc4fe69c82e69a54272284" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading137" runat="server" Text="First Amount Payable" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id54ff97c916dc4fe69c82e69a54272284 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id54ff97c916dc4fe69c82e69a54272284 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id54ff97c916dc4fe69c82e69a54272284 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id54ff97c916dc4fe69c82e69a54272284 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id54ff97c916dc4fe69c82e69a54272284 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54ff97c916dc4fe69c82e69a54272284 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54ff97c916dc4fe69c82e69a54272284 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id54ff97c916dc4fe69c82e69a54272284 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54ff97c916dc4fe69c82e69a54272284 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54ff97c916dc4fe69c82e69a54272284 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id64bdee6851474f4f82cf41d5ad391fb4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading138" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label422">
		<span class="label" id="label422">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label423">
		<span class="label" id="label423">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label424">
		<span class="label" id="label424">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label425">
		<span class="label" id="label425">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label426">
		<span class="label" id="label426">Minimum Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label427">
		<span class="label" id="label427">Additonal Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label430">
		<span class="label" id="label430">Riot & Strike</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label433">
		<span class="label" id="label433">Duplicate Records</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label439">
		<span class="label" id="label439">Protections</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label445">
		<span class="label" id="label445">Transit</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label452">
		<span class="label" id="label452">Total</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id64bdee6851474f4f82cf41d5ad391fb4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id64bdee6851474f4f82cf41d5ad391fb4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id64bdee6851474f4f82cf41d5ad391fb4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id64bdee6851474f4f82cf41d5ad391fb4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id64bdee6851474f4f82cf41d5ad391fb4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id64bdee6851474f4f82cf41d5ad391fb4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id64bdee6851474f4f82cf41d5ad391fb4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id64bdee6851474f4f82cf41d5ad391fb4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id64bdee6851474f4f82cf41d5ad391fb4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id64bdee6851474f4f82cf41d5ad391fb4 input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading139" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblAR_AR_CLAUSES" runat="server" AssociatedControlID="AR__AR_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="AR__AR_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="AR" 
		data-property-name="AREND_CNT" 
		id="pb-container-integer-AR-AREND_CNT">
		<asp:Label ID="lblAR_AREND_CNT" runat="server" AssociatedControlID="AR__AREND_CNT" 
			Text="Account Receivable Note Counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="AR__AREND_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAR_AREND_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Account Receivable Note Counter"
			ClientValidationFunction="onValidate_AR__AREND_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idff754106a3154775a08e48450b212561" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading140" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idff754106a3154775a08e48450b212561 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idff754106a3154775a08e48450b212561 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idff754106a3154775a08e48450b212561 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idff754106a3154775a08e48450b212561 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idff754106a3154775a08e48450b212561 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idff754106a3154775a08e48450b212561 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idff754106a3154775a08e48450b212561 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idff754106a3154775a08e48450b212561 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idff754106a3154775a08e48450b212561 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idff754106a3154775a08e48450b212561 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7b3716f487f346d48ee8c5abfce6dab6" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading141" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="AR" 
		data-property-name="ARNOTES_CNT" 
		id="pb-container-integer-AR-ARNOTES_CNT">
		<asp:Label ID="lblAR_ARNOTES_CNT" runat="server" AssociatedControlID="AR__ARNOTES_CNT" 
			Text="Account Receivable Note Counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="AR__ARNOTES_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAR_ARNOTES_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Account Receivable Note Counter"
			ClientValidationFunction="onValidate_AR__ARNOTES_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7b3716f487f346d48ee8c5abfce6dab6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7b3716f487f346d48ee8c5abfce6dab6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7b3716f487f346d48ee8c5abfce6dab6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7b3716f487f346d48ee8c5abfce6dab6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7b3716f487f346d48ee8c5abfce6dab6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7b3716f487f346d48ee8c5abfce6dab6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7b3716f487f346d48ee8c5abfce6dab6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7b3716f487f346d48ee8c5abfce6dab6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7b3716f487f346d48ee8c5abfce6dab6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7b3716f487f346d48ee8c5abfce6dab6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7eb24d2aa63a4dc08e2f3b77da273028" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading142" runat="server" Text="Notes (Printed on Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-AR-ARSNOTES_CNT">
		<asp:Label ID="lblAR_ARSNOTES_CNT" runat="server" AssociatedControlID="AR__ARSNOTES_CNT" 
			Text="Account Receivable Note Counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="AR__ARSNOTES_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valAR_ARSNOTES_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Account Receivable Note Counter"
			ClientValidationFunction="onValidate_AR__ARSNOTES_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7eb24d2aa63a4dc08e2f3b77da273028 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7eb24d2aa63a4dc08e2f3b77da273028 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7eb24d2aa63a4dc08e2f3b77da273028 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7eb24d2aa63a4dc08e2f3b77da273028 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7eb24d2aa63a4dc08e2f3b77da273028 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7eb24d2aa63a4dc08e2f3b77da273028 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7eb24d2aa63a4dc08e2f3b77da273028 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7eb24d2aa63a4dc08e2f3b77da273028 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7eb24d2aa63a4dc08e2f3b77da273028 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7eb24d2aa63a4dc08e2f3b77da273028 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="iddbc82ceadaa74bd7b671037163a21d42" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading143" runat="server" Text="Reinsurance Exposure" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label458">
		<span class="label" id="label458">Total Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label459">
		<span class="label" id="label459">Target Risk SI</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label460">
		<span class="label" id="label460">MPL %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label461">
		<span class="label" id="label461">RI Exposure</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label462">
		<span class="label" id="label462">Outstanding Debit Balances</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label463">
		<span class="label" id="label463">Additional Claim Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label464">
		<span class="label" id="label464">Total RI Exposure</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#iddbc82ceadaa74bd7b671037163a21d42 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddbc82ceadaa74bd7b671037163a21d42 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddbc82ceadaa74bd7b671037163a21d42 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#iddbc82ceadaa74bd7b671037163a21d42 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddbc82ceadaa74bd7b671037163a21d42 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddbc82ceadaa74bd7b671037163a21d42 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddbc82ceadaa74bd7b671037163a21d42 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddbc82ceadaa74bd7b671037163a21d42 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddbc82ceadaa74bd7b671037163a21d42 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddbc82ceadaa74bd7b671037163a21d42 input{text-align:left;}"; break;
		}
	}
