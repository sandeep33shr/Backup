<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMFPARTY_Interest_Parties.aspx.vb" Inherits="Nexus.PB2_CMAMFPARTY_Interest_Parties" %>
...
function onValidate_INT_PARTIES__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INT_PARTIES", "NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INT_PARTIES", "NAME");
        		}
        		//window.setProperty(field, "VEM", "INT_PARTIES.STARTDATE != null", "VE", "Name is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "INT_PARTIES.STARTDATE != null",
            paramElseValue = "VE",
            paramValidationMessage = "Name is mandatory and must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INT_PARTIES.NAME");
        			window.setControlWidth(field, "0.8", "INT_PARTIES", "NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblINT_PARTIES_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_INT_PARTIES__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_INT_PARTIES__NAME_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("INT_PARTIES.STARTDATE != null")) ? new Expression("INT_PARTIES.STARTDATE != null") : null;
...
function onValidate_INT_PARTIES__STARTDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INT_PARTIES", "STARTDATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INT_PARTIES", "STARTDATE");
        		}
        		//window.setProperty(field, "VEM", "INT_PARTIES.NAME != ''", "VE", "Date is mandatory and a date must be entered or the date format is invalid");
        
            var paramValue = "VEM",
            paramCondition = "INT_PARTIES.NAME != ''",
            paramElseValue = "VE",
            paramValidationMessage = "Date is mandatory and a date must be entered or the date format is invalid";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INT_PARTIES.STARTDATE");
        			window.setControlWidth(field, "0.8", "INT_PARTIES", "STARTDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblINT_PARTIES_STARTDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_INT_PARTIES__STARTDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_INT_PARTIES__STARTDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("INT_PARTIES.NAME != ''")) ? new Expression("INT_PARTIES.NAME != ''") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "INT_PARTIES".toUpperCase() + "__" + "STARTDATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "INT_PARTIES".toUpperCase() + "_" + "STARTDATE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(INT_PARTIES.STARTDATE >= POLICYHEADER.INCEPTION) OR (INT_PARTIES.STARTDATE = null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_INT_PARTIES__REGNO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INT_PARTIES", "REGNO", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("INT_PARTIES", "REGNO");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INT_PARTIES.REGNO");
        			window.setControlWidth(field, "0.8", "INT_PARTIES", "REGNO");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblINT_PARTIES_REGNO");
        			    var ele = document.getElementById('ctl00_cntMainBody_INT_PARTIES__REGNO');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_INT_PARTIES__REGNO_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_INT_PARTIES__NAME(null, null, null, isOnLoad);
    onValidate_INT_PARTIES__STARTDATE(null, null, null, isOnLoad);
    onValidate_INT_PARTIES__REGNO(null, null, null, isOnLoad);
...
<div id="id5679f528409945798164beb87a624f5b" class="general-layout-container">
...
<div id="frmTypeFleet" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading16" runat="server" Text="Interested Parties" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="INT_PARTIES" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-INT_PARTIES-NAME">

		
		<asp:Label ID="lblINT_PARTIES_NAME" runat="server" AssociatedControlID="INT_PARTIES__NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="INT_PARTIES__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valINT_PARTIES_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name"
					ClientValidationFunction="onValidate_INT_PARTIES__NAME"
					ValidationGroup=""
					Display="None"
...
<!-- /Text -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-INT_PARTIES-STARTDATE">
		<asp:Label ID="lblINT_PARTIES_STARTDATE" runat="server" AssociatedControlID="INT_PARTIES__STARTDATE" 
			Text="Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="INT_PARTIES__STARTDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calINT_PARTIES__STARTDATE" runat="server" LinkedControl="INT_PARTIES__STARTDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valINT_PARTIES_STARTDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date"
			ClientValidationFunction="onValidate_INT_PARTIES__STARTDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-INT_PARTIES-REGNO">

		
		<asp:Label ID="lblINT_PARTIES_REGNO" runat="server" AssociatedControlID="INT_PARTIES__REGNO" 
			Text="Vehicle Registration Number" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="INT_PARTIES__REGNO" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valINT_PARTIES_REGNO" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Vehicle Registration Number"
					ClientValidationFunction="onValidate_INT_PARTIES__REGNO"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
