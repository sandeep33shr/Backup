...
Namespace Nexus
    Partial Class PB2_REFPLPC_Referral_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_REFERRAL_DETAILS__ReferrralDate()
        If eLifecycleEvent = LifecycleEvent.Page_Load
        	Dim tempDate As Date
        	If DateTime.TryParse(CStr(REFERRAL_DETAILS__ReferrralDate.Text), tempDate) Then
        	   REFERRAL_DETAILS__ReferrralDate.Text = tempDate.ToShortDateString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_REFERRAL_DETAILS__ReferrralDate()
End Sub
