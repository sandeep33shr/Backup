<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PVTMRAD_Private_Motor_Radio_Items.aspx.vb" Inherits="Nexus.PB2_PVTMRAD_Private_Motor_Radio_Items" %>
...
function onValidate_MOTOR_RADIO__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTOR_RADIO", "DESCRIPTION", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MOTOR_RADIO", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOTOR_RADIO.DESCRIPTION");
        			window.setControlWidth(field, "0.7", "MOTOR_RADIO", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOTOR_RADIO_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOTOR_RADIO__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOTOR_RADIO__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_MOTOR_RADIO__VALUE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTOR_RADIO", "VALUE", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MOTOR_RADIO", "VALUE");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOTOR_RADIO.VALUE");
        			window.setControlWidth(field, "0.7", "MOTOR_RADIO", "VALUE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOTOR_RADIO_VALUE");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOTOR_RADIO__VALUE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOTOR_RADIO__VALUE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (()=>{
                ...
                $('#<%= MOTOR_RADIO__VALUE.ClientID %>').bind("keypress",function(e){
...
function DoLogic(isOnLoad) {
    onValidate_MOTOR_RADIO__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_MOTOR_RADIO__VALUE(null, null, null, isOnLoad);
}
</script>
...
<div id="idf99fc334d14a4aaa8511ff6aa6965b72" class="general-layout-container">
...
<div id="frmExtraDet" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="Extra Item" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MOTOR_RADIO" 
		data-property-name="DESCRIPTION" 
		id="pb-container-comment-MOTOR_RADIO-DESCRIPTION">
		<asp:Label ID="lblMOTOR_RADIO_DESCRIPTION" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="MOTOR_RADIO__DESCRIPTION" 
			Text="Description"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="MOTOR_RADIO__DESCRIPTION" runat="server" />
		
		<asp:CustomValidator ID="valMOTOR_RADIO_DESCRIPTION" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Description"
			ClientValidationFunction="onValidate_MOTOR_RADIO__DESCRIPTION"
			ValidationGroup="" 
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MOTOR_RADIO-VALUE">
		<asp:Label ID="lblMOTOR_RADIO_VALUE" runat="server" AssociatedControlID="MOTOR_RADIO__VALUE" 
			Text="Value" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOTOR_RADIO__VALUE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOTOR_RADIO_VALUE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Value"
			ClientValidationFunction="onValidate_MOTOR_RADIO__VALUE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
