<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PCOMPEQRSK_Risk_Details.aspx.vb" Inherits="Nexus.PB2_PCOMPEQRSK_Risk_Details" %>
...
function onValidate_COMPEQ__AREA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COMPEQ", "AREA", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("COMPEQ", "AREA");
        		}
...
function onValidate_COMPEQ__TOTALSI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COMPEQ", "TOTALSI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COMPEQ", "TOTALSI");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('COMPEQ', 'TOTALSI');
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COMPEQ.TOTALSI");
        			window.setControlWidth(field, "0.7", "COMPEQ", "TOTALSI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCOMPEQ_TOTALSI");
        			    var ele = document.getElementById('ctl00_cntMainBody_COMPEQ__TOTALSI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_COMPEQ__TOTALSI_lblFindParty");
        			    }
        			}
          ...
          * @param COMPEQ The Parent (Root) object name.
          * @param COMPEQ_DET.SUMINSURED The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "COMPEQ".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "COMPEQ_DET.SUMINSURED";
...
function onValidate_COMPEQ__TOTALPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COMPEQ", "TOTALPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COMPEQ", "TOTALPREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('COMPEQ', 'TOTALPREMIUM');
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COMPEQ.TOTALPREMIUM");
        			window.setControlWidth(field, "0.7", "COMPEQ", "TOTALPREMIUM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCOMPEQ_TOTALPREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_COMPEQ__TOTALPREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_COMPEQ__TOTALPREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
          ...
          * @fileoverview GetColumn
          * @param COMPEQ The Parent (Root) object name.
          * @param COMPEQ_DET.PREMIUM The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "COMPEQ".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "COMPEQ_DET.PREMIUM";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_COMPEQ__PERCOMPEQ(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COMPEQ", "PERCOMPEQ", "ChildScreen");
        })();
}
function onValidate_COMPEQ__RISK_COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COMPEQ", "RISK_COUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("COMPEQ", "RISK_COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param COMPEQ The Parent (Root) object name.
          * @param COMPEQ_DET.COUNT_ID The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "COMPEQ".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "COMPEQ_DET.COUNT_ID";
        		//count, average, total, min, max
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "COMPEQ".toUpperCase() + "__" + "RISK_COUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "COMPEQ".toUpperCase() + "_" + "RISK_COUNT");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("COMPEQ.RISK_COUNT>0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_COMPEQ__FINALCOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COMPEQ", "FINALCOUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("COMPEQ", "FINALCOUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_COMPEQ__AREA(null, null, null, isOnLoad);
    onValidate_COMPEQ__TOTALSI(null, null, null, isOnLoad);
    onValidate_COMPEQ__TOTALPREMIUM(null, null, null, isOnLoad);
    onValidate_COMPEQ__PERCOMPEQ(null, null, null, isOnLoad);
    onValidate_COMPEQ__RISK_COUNT(null, null, null, isOnLoad);
    onValidate_COMPEQ__FINALCOUNT(null, null, null, isOnLoad);
}
</script>
...
<div id="idbfec618d12754ed6858ce1f338999cbb" class="general-layout-container">
...
<div id="id8092dde9ad8545019dd91d62170c375d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Personal Computer Equipment " /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="COMPEQ" 
		data-property-name="AREA" 
		 
		
		 
		id="pb-container-text-COMPEQ-AREA">

		
		<asp:Label ID="lblCOMPEQ_AREA" runat="server" AssociatedControlID="COMPEQ__AREA" 
			Text="Area" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="COMPEQ__AREA" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCOMPEQ_AREA" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Area"
					ClientValidationFunction="onValidate_COMPEQ__AREA"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-COMPEQ-TOTALSI">
		<asp:Label ID="lblCOMPEQ_TOTALSI" runat="server" AssociatedControlID="COMPEQ__TOTALSI" 
			Text="Total Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="COMPEQ__TOTALSI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCOMPEQ_TOTALSI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Sum Insured"
			ClientValidationFunction="onValidate_COMPEQ__TOTALSI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="COMPEQ" 
		data-property-name="TOTALPREMIUM" 
		id="pb-container-currency-COMPEQ-TOTALPREMIUM">
		<asp:Label ID="lblCOMPEQ_TOTALPREMIUM" runat="server" AssociatedControlID="COMPEQ__TOTALPREMIUM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="COMPEQ__TOTALPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCOMPEQ_TOTALPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_COMPEQ__TOTALPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8092dde9ad8545019dd91d62170c375d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8092dde9ad8545019dd91d62170c375d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8092dde9ad8545019dd91d62170c375d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8092dde9ad8545019dd91d62170c375d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8092dde9ad8545019dd91d62170c375d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8092dde9ad8545019dd91d62170c375d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8092dde9ad8545019dd91d62170c375d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8092dde9ad8545019dd91d62170c375d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8092dde9ad8545019dd91d62170c375d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8092dde9ad8545019dd91d62170c375d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4b8fd3990f96431292d3ca31ae4032df" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_COMPEQ__PERCOMPEQ"
		data-field-type="Child" 
		data-object-name="COMPEQ" 
		data-property-name="PERCOMPEQ" 
		id="pb-container-childscreen-COMPEQ-PERCOMPEQ">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="COMPEQ__COMPEQ_DET" runat="server" ScreenCode="PERCOMPEQ" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PERCOMPEQ/PERCOMPEQ_Personal_Computer_Equipment.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="COUNT_ID" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Category " ListType="PMLookup" ListCode="UDL_PCEQRITEM" DataField="CATEGORY" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Total Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCOMPEQ_PERCOMPEQ" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for COMPEQ.PERCOMPEQ"
						ClientValidationFunction="onValidate_COMPEQ__PERCOMPEQ" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="COMPEQ" 
		data-property-name="RISK_COUNT" 
		id="pb-container-integer-COMPEQ-RISK_COUNT">
		<asp:Label ID="lblCOMPEQ_RISK_COUNT" runat="server" AssociatedControlID="COMPEQ__RISK_COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="COMPEQ__RISK_COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCOMPEQ_RISK_COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for COMPEQ.RISK_COUNT"
			ClientValidationFunction="onValidate_COMPEQ__RISK_COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="COMPEQ" 
		data-property-name="FINALCOUNT" 
		id="pb-container-integer-COMPEQ-FINALCOUNT">
		<asp:Label ID="lblCOMPEQ_FINALCOUNT" runat="server" AssociatedControlID="COMPEQ__FINALCOUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="COMPEQ__FINALCOUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCOMPEQ_FINALCOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for COMPEQ.FINALCOUNT"
			ClientValidationFunction="onValidate_COMPEQ__FINALCOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4b8fd3990f96431292d3ca31ae4032df div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4b8fd3990f96431292d3ca31ae4032df div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4b8fd3990f96431292d3ca31ae4032df div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4b8fd3990f96431292d3ca31ae4032df label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4b8fd3990f96431292d3ca31ae4032df label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4b8fd3990f96431292d3ca31ae4032df label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4b8fd3990f96431292d3ca31ae4032df label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4b8fd3990f96431292d3ca31ae4032df input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4b8fd3990f96431292d3ca31ae4032df input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4b8fd3990f96431292d3ca31ae4032df input{text-align:left;}"; break;
		}
	}
