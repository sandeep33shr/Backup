...
Namespace Nexus
    Partial Class PB2_NPADOM_Endorsements : Inherits BaseRisk
...
End Sub
	...
	Protected Shadows Sub BtnNext_AddressCheck(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFinish.Click, btnFinishTop.Click
