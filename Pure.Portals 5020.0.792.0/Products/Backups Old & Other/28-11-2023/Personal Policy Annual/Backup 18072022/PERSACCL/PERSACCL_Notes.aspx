<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PERSACCL_Notes.aspx.vb" Inherits="Nexus.PB2_PERSACCL_Notes" %>
...
function onValidate_NOTES__PARNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "PARNOTES", "ChildScreen");
        })();
}
function onValidate_NOTES__EXTPERSACC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "EXTPERSACC", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__PARNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__EXTPERSACC(null, null, null, isOnLoad);
}
</script>
...
<div id="id085a6fbdadaa4c33bd872b9fc5b0f99e" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading17" runat="server" Text="Personal Accident Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__PARNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="PARNOTES" 
		id="pb-container-childscreen-NOTES-PARNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="PARNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PARNOTES/PARNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_PARNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__PARNOTES" 
						Display="None"
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__EXTPERSACC"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="EXTPERSACC" 
		id="pb-container-childscreen-NOTES-EXTPERSACC">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__EXT_DETAILS" runat="server" ScreenCode="EXTPERSACC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EXTPERSACC/EXTPERSACC_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_EXTPERSACC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__EXTPERSACC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
