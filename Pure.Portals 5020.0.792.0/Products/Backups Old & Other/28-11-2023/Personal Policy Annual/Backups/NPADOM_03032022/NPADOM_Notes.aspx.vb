...
Namespace Nexus
    Partial Class PB2_NPADOM_Notes : Inherits BaseRisk
...
End Sub
	...
	Protected Shadows Sub BtnNext_AddressCheck(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
            Session("RemoveFinish") = Nothing
            Session("AddressChanged") = Nothing
            Session("AddressCheck") = Nothing
	End Sub
