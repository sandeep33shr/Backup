...
Namespace Nexus
    Partial Class PB2_NPADOM_PLIP : Inherits BaseRisk
		...
		Protected Sub onValidate_PLIP__PREMIUM()
        
        
End Sub
Protected Sub onValidate_Button_btnPLIPCalculate()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PLIP__PREMIUM()
    onValidate_Button_btnPLIPCalculate()
End Sub
        ...
        Private Sub PremiumValidator()
        	...
        	If (PLIP__PREMIUM.Text = "") And (PLIP__PREMIUM.Text = Nothing) Then
        ...
        Private Sub btnPLIPCalculate_Click(sender As Object, e As EventArgs) Handles btnPLIPCalculate.Click
