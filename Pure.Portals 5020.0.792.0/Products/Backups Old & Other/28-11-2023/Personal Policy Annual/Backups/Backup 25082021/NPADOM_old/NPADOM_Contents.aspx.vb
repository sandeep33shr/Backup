...
End Sub
        ...
        Private Sub AlarmValidation()
        	...
        	Dim Town As String = ""
        	Dim Other As String = CONTENTS__ALARMTYPECDE.text
        	
        	'AlarmType = Other.Substring(0, Other.IndexOf(","))
        	'Dim remaining As String = Other.Remove(0, Other.IndexOf(",")+1)
        	'Town = remaining.Substring(0, remaining.IndexOf(","))
        	'AlarmSanction = remaining.Remove(0, remaining.IndexOf(",")+1)
