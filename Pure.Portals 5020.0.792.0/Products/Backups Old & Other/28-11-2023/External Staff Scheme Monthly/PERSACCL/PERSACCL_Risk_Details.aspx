<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PERSACCL_Risk_Details.aspx.vb" Inherits="Nexus.PB2_PERSACCL_Risk_Details" %>
...
function onValidate_GENERAL__PSAMTARSN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "PSAMTARSN", "ChildScreen");
        })();
}
function onValidate_PSACC__DEATH_SUM_INSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACC", "DEATH_SUM_INSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PSACC", "DEATH_SUM_INSURED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PSACC.DEATH_SUM_INSURED");
        			window.setControlWidth(field, "0.7", "PSACC", "DEATH_SUM_INSURED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPSACC_DEATH_SUM_INSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_PSACC__DEATH_SUM_INSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PSACC__DEATH_SUM_INSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
         ...
         /**
          * @fileoverview GetColumn
          * @param PSACC The Parent (Root) object name.
          * @param PSINSURED.DEATHSUMIN The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "PSACC".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PSINSURED.DEATHSUMIN";
        		//count, average, total, min, max
...
function onValidate_PSACC__TEMP_DISAB_SUM_INSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACC", "TEMP_DISAB_SUM_INSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PSACC", "TEMP_DISAB_SUM_INSURED");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PSACC.TEMP_DISAB_SUM_INSURED");
        			window.setControlWidth(field, "0.7", "PSACC", "TEMP_DISAB_SUM_INSURED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPSACC_TEMP_DISAB_SUM_INSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_PSACC__TEMP_DISAB_SUM_INSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PSACC__TEMP_DISAB_SUM_INSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
          ...
          * @fileoverview GetColumn
          * @param PSACC The Parent (Root) object name.
          * @param PSINSURED.TEMPSI The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "PSACC".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PSINSURED.TEMPSI";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_PSACC__MEDICAL_EXP_SUM_INS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACC", "MEDICAL_EXP_SUM_INS", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PSACC", "MEDICAL_EXP_SUM_INS");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PSACC.MEDICAL_EXP_SUM_INS");
        			window.setControlWidth(field, "0.7", "PSACC", "MEDICAL_EXP_SUM_INS");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPSACC_MEDICAL_EXP_SUM_INS");
        			    var ele = document.getElementById('ctl00_cntMainBody_PSACC__MEDICAL_EXP_SUM_INS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PSACC__MEDICAL_EXP_SUM_INS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
          ...
          * @fileoverview GetColumn
          * @param PSACC The Parent (Root) object name.
          * @param PSINSURED.MED_EXP_VAL The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "PSACC".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PSINSURED.MED_EXP_VAL";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_PSACC__TOTAL_SUM_INSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACC", "TOTAL_SUM_INSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PSACC", "TOTAL_SUM_INSURED");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('PSACC', 'TOTAL_SUM_INSURED');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PSACC&propertyName=TOTAL_SUM_INSURED&name={name}");
        		
        		var value = new Expression("PSACC.DEATH_SUM_INSURED+PSACC.PERM_DISABILITY+PSACC.TEMP_DISAB_SUM_INSURED+PSACC.MEDICAL_EXP_SUM_INS"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PSACC.TOTAL_SUM_INSURED");
        			window.setControlWidth(field, "0.7", "PSACC", "TOTAL_SUM_INSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPSACC_TOTAL_SUM_INSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_PSACC__TOTAL_SUM_INSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PSACC__TOTAL_SUM_INSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("At least one record must be entered")) ? "At least one record must be entered" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "PSACC".toUpperCase() + "__" + "TOTAL_SUM_INSURED");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "PSACC".toUpperCase() + "_" + "TOTAL_SUM_INSURED");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("PSACC.TOTAL_SUM_INSURED>0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_PSACC__TOTAL_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACC", "TOTAL_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PSACC", "TOTAL_PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PSACC.TOTAL_PREM");
        			window.setControlWidth(field, "0.7", "PSACC", "TOTAL_PREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPSACC_TOTAL_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_PSACC__TOTAL_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PSACC__TOTAL_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
          ...
          * @fileoverview GetColumn
          * @param PSACC The Parent (Root) object name.
          * @param PSINSURED.TOTAL_PRE The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "PSACC".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PSINSURED.TOTAL_PRE";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_PSACC__PROD_CODE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACC", "PROD_CODE", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PSACC", "PROD_CODE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_PSACC__PERSCHLD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACC", "PERSCHLD", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__PSAMTARSN(null, null, null, isOnLoad);
    onValidate_PSACC__DEATH_SUM_INSURED(null, null, null, isOnLoad);
    onValidate_PSACC__TEMP_DISAB_SUM_INSURED(null, null, null, isOnLoad);
    onValidate_PSACC__MEDICAL_EXP_SUM_INS(null, null, null, isOnLoad);
    onValidate_PSACC__TOTAL_SUM_INSURED(null, null, null, isOnLoad);
    onValidate_PSACC__TOTAL_PREM(null, null, null, isOnLoad);
    onValidate_PSACC__PROD_CODE(null, null, null, isOnLoad);
    onValidate_PSACC__PERSCHLD(null, null, null, isOnLoad);
}
</script>
...
<div id="idff302c8ab79c4c7f8251e75a706e2df2" class="general-layout-container">
...
<div id="idfee24774defa49a8a6460101150af930" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfee24774defa49a8a6460101150af930 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfee24774defa49a8a6460101150af930 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfee24774defa49a8a6460101150af930 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfee24774defa49a8a6460101150af930 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfee24774defa49a8a6460101150af930 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfee24774defa49a8a6460101150af930 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfee24774defa49a8a6460101150af930 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfee24774defa49a8a6460101150af930 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfee24774defa49a8a6460101150af930 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfee24774defa49a8a6460101150af930 input{text-align:left;}"; break;
		}
	}
...
<div id="frmMTAReason" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading7" runat="server" Text="Mid-Term Adjustment Reason" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__PSAMTARSN"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="PSAMTARSN" 
		id="pb-container-childscreen-GENERAL-PSAMTARSN">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="PSAMTARSN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PSAMTARSN/PSAMTARSN_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_PSAMTARSN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.PSAMTARSN"
						ClientValidationFunction="onValidate_GENERAL__PSAMTARSN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id792fb91858434f38875c38b9d6adf246" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PSACC" 
		data-property-name="DEATH_SUM_INSURED" 
		id="pb-container-currency-PSACC-DEATH_SUM_INSURED">
		<asp:Label ID="lblPSACC_DEATH_SUM_INSURED" runat="server" AssociatedControlID="PSACC__DEATH_SUM_INSURED" 
			Text="Death Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PSACC__DEATH_SUM_INSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPSACC_DEATH_SUM_INSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Death Sum Insured"
			ClientValidationFunction="onValidate_PSACC__DEATH_SUM_INSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PSACC-TEMP_DISAB_SUM_INSURED">
		<asp:Label ID="lblPSACC_TEMP_DISAB_SUM_INSURED" runat="server" AssociatedControlID="PSACC__TEMP_DISAB_SUM_INSURED" 
			Text="Temporary Disability Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PSACC__TEMP_DISAB_SUM_INSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPSACC_TEMP_DISAB_SUM_INSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Temporary Disability Sum Insured"
			ClientValidationFunction="onValidate_PSACC__TEMP_DISAB_SUM_INSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="PSACC" 
		data-property-name="MEDICAL_EXP_SUM_INS" 
		id="pb-container-currency-PSACC-MEDICAL_EXP_SUM_INS">
		<asp:Label ID="lblPSACC_MEDICAL_EXP_SUM_INS" runat="server" AssociatedControlID="PSACC__MEDICAL_EXP_SUM_INS" 
			Text="Medical Expenses Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PSACC__MEDICAL_EXP_SUM_INS" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPSACC_MEDICAL_EXP_SUM_INS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Medical Expenses Sum Insured"
			ClientValidationFunction="onValidate_PSACC__MEDICAL_EXP_SUM_INS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PSACC-TOTAL_SUM_INSURED">
		<asp:Label ID="lblPSACC_TOTAL_SUM_INSURED" runat="server" AssociatedControlID="PSACC__TOTAL_SUM_INSURED" 
			Text="Total Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PSACC__TOTAL_SUM_INSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPSACC_TOTAL_SUM_INSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Sum Insured"
			ClientValidationFunction="onValidate_PSACC__TOTAL_SUM_INSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PSACC-TOTAL_PREM">
		<asp:Label ID="lblPSACC_TOTAL_PREM" runat="server" AssociatedControlID="PSACC__TOTAL_PREM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PSACC__TOTAL_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPSACC_TOTAL_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_PSACC__TOTAL_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PSACC" 
		data-property-name="PROD_CODE" 
		 
		
		 
		id="pb-container-text-PSACC-PROD_CODE">

		
		<asp:Label ID="lblPSACC_PROD_CODE" runat="server" AssociatedControlID="PSACC__PROD_CODE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PSACC__PROD_CODE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPSACC_PROD_CODE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for PSACC.PROD_CODE"
					ClientValidationFunction="onValidate_PSACC__PROD_CODE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id792fb91858434f38875c38b9d6adf246 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id792fb91858434f38875c38b9d6adf246 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id792fb91858434f38875c38b9d6adf246 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id792fb91858434f38875c38b9d6adf246 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id792fb91858434f38875c38b9d6adf246 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id792fb91858434f38875c38b9d6adf246 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id792fb91858434f38875c38b9d6adf246 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id792fb91858434f38875c38b9d6adf246 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id792fb91858434f38875c38b9d6adf246 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id792fb91858434f38875c38b9d6adf246 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2a753397d0bc4a0a8c163b9ba9b92924" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PSACC__PERSCHLD"
		data-field-type="Child" 
		data-object-name="PSACC" 
		data-property-name="PERSCHLD" 
		id="pb-container-childscreen-PSACC-PERSCHLD">
		
		    <legend>Personal Accident</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PSACC__PSINSURED" runat="server" ScreenCode="PERSCHLD" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PERSCHLD/PERSCHLD_Risk_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Insured Person" DataField="INSURED_PERSON" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Death Sum Insured" DataField="DEATHSUMIN" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Temporary Disability  Sum Insured" DataField="TEMPSI" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Medical Expenses Sum Insured" DataField="MED_EXP_VAL" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Total Premium" DataField="TOTAL_PRE" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valPSACC_PERSCHLD" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Personal Accident"
						ClientValidationFunction="onValidate_PSACC__PERSCHLD" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2a753397d0bc4a0a8c163b9ba9b92924 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2a753397d0bc4a0a8c163b9ba9b92924 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2a753397d0bc4a0a8c163b9ba9b92924 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2a753397d0bc4a0a8c163b9ba9b92924 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2a753397d0bc4a0a8c163b9ba9b92924 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2a753397d0bc4a0a8c163b9ba9b92924 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2a753397d0bc4a0a8c163b9ba9b92924 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2a753397d0bc4a0a8c163b9ba9b92924 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2a753397d0bc4a0a8c163b9ba9b92924 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2a753397d0bc4a0a8c163b9ba9b92924 input{text-align:left;}"; break;
		}
	}
