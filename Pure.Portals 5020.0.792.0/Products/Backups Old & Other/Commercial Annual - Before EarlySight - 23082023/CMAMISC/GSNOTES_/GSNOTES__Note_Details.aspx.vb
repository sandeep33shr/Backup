...
Namespace Nexus
    Partial Class PB2_GSNOTES__Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_GLASS_SCNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If GLASS_SCNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		GLASS_SCNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		GLASS_SCNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_GLASS_SCNOTE_DETAILS__NOTE_DETAILS()
End Sub
