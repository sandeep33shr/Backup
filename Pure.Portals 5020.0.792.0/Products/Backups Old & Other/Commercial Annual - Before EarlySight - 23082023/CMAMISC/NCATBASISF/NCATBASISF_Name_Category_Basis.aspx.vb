...
Namespace Nexus
    Partial Class PB2_NCATBASISF_Name_Category_Basis : Inherits BaseRisk
		...
		Protected Sub onValidate_GUAR__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GUAR__COUNTER_ID()
End Sub
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "FIDGUAR" & "/" & "GUAR", sXMLDataset)
                            If sChildId <> "0" Then
                                GUAR__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
