<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FIDGNOTESS_Note_Details.aspx.vb" Inherits="Nexus.PB2_FIDGNOTESS_Note_Details" %>
...
function onValidate_FIDGNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDGNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "FIDGNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=FIDGNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_FIDGNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDGNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "FIDGNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_FIDGNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDGNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "FIDGNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=FIDGNOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_FIDGNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIDGNOTES", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "FIDGNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_FIDGNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDGNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIDGNOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDGNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "FIDGNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=FIDGNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_FIDGNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_FIDGNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_FIDGNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_FIDGNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_FIDGNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_FIDGNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_FIDGNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id3df573f5013a4bf38ff0ea71478e01f4" class="general-layout-container">
...
<div id="id0b0c316d61234f759cd51eb1a811e5f4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading165" runat="server" Text="Notes (Printed On Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FIDGNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-FIDGNOTES-DATE_CREATED">
		<asp:Label ID="lblFIDGNOTES_DATE_CREATED" runat="server" AssociatedControlID="FIDGNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="FIDGNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calFIDGNOTES__DATE_CREATED" runat="server" LinkedControl="FIDGNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valFIDGNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_FIDGNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDGNOTES-CREATED_BY">

		
		<asp:Label ID="lblFIDGNOTES_CREATED_BY" runat="server" AssociatedControlID="FIDGNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDGNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDGNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_FIDGNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDGNOTES-COVER_TYPE">

		
		<asp:Label ID="lblFIDGNOTES_COVER_TYPE" runat="server" AssociatedControlID="FIDGNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDGNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDGNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_FIDGNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDGNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblFIDGNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="FIDGNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDGNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDGNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_FIDGNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-FIDGNOTES-NOTE_DETAILS">
		<asp:Label ID="lblFIDGNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="FIDGNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="FIDGNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valFIDGNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_FIDGNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0b0c316d61234f759cd51eb1a811e5f4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0b0c316d61234f759cd51eb1a811e5f4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0b0c316d61234f759cd51eb1a811e5f4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0b0c316d61234f759cd51eb1a811e5f4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0b0c316d61234f759cd51eb1a811e5f4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b0c316d61234f759cd51eb1a811e5f4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b0c316d61234f759cd51eb1a811e5f4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0b0c316d61234f759cd51eb1a811e5f4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b0c316d61234f759cd51eb1a811e5f4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b0c316d61234f759cd51eb1a811e5f4 input{text-align:left;}"; break;
		}
	}
