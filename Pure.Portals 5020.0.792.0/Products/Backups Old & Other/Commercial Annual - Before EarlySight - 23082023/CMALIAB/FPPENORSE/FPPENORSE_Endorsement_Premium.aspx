<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FPPENORSE_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_FPPENORSE_Endorsement_Premium" %>
...
function onValidate_FPPL__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPL", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FPPL", "ENDORSE_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=FPPL&propertyName=ENDORSE_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "FPPL" && field.getPropertyName() == "ENDORSE_ID")
...
function onValidate_FPPL__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPL", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FPPL", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPL.ENDORSE_DESC");
        			window.setControlWidth(field, "0.3", "FPPL", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPL_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPL__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPL__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_FPPL__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPL", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FPPL", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=FPPL&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(FPPL.ENDORSE_DESC)"), 
...
function onValidate_FPPL__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FPPL", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FPPL", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FPPL.PREMIUM");
        			window.setControlWidth(field, "0.3", "FPPL", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFPPL_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_FPPL__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FPPL__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_FPPL__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_FPPL__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_FPPL__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_FPPL__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idb67c20b7a37141538764d40795177a3b" class="general-layout-container">
...
<div id="id7af3391733dc45499b07468d835bfe63" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading123" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FPPL" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-FPPL-ENDORSE_ID">
		<asp:Label ID="lblFPPL_ENDORSE_ID" runat="server" AssociatedControlID="FPPL__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="FPPL__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valFPPL_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_FPPL__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-FPPL-ENDORSE_DESC">
		<asp:Label ID="lblFPPL_ENDORSE_DESC" runat="server" AssociatedControlID="FPPL__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="FPPL__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_FPPL__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valFPPL_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_FPPL__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FPPL-ENDORSE_CAP">

		
		<asp:Label ID="lblFPPL_ENDORSE_CAP" runat="server" AssociatedControlID="FPPL__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FPPL__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFPPL_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_FPPL__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FPPL-PREMIUM">
		<asp:Label ID="lblFPPL_PREMIUM" runat="server" AssociatedControlID="FPPL__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FPPL__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFPPL_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_FPPL__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FPPL-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="FPPL__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7af3391733dc45499b07468d835bfe63 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7af3391733dc45499b07468d835bfe63 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7af3391733dc45499b07468d835bfe63 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7af3391733dc45499b07468d835bfe63 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7af3391733dc45499b07468d835bfe63 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7af3391733dc45499b07468d835bfe63 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7af3391733dc45499b07468d835bfe63 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7af3391733dc45499b07468d835bfe63 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7af3391733dc45499b07468d835bfe63 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7af3391733dc45499b07468d835bfe63 input{text-align:left;}"; break;
		}
	}
