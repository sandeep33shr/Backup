<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="AHRISK_Accidental_Health.aspx.vb" Inherits="Nexus.PB2_AHRISK_Accidental_Health" %>
...
function onValidate_EMPDE__EFFECTIVEDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=EMPDE&propertyName=EFFECTIVEDATE&name={name}");
...
function onValidate_EMPDE__CO_INS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "CO_INS", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "CO_INS");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EMPDE.CO_INS");
        			window.setControlWidth(field, "0.7", "EMPDE", "CO_INS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEMPDE_CO_INS");
        			    var ele = document.getElementById('ctl00_cntMainBody_EMPDE__CO_INS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EMPDE__CO_INS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "PMAOLL");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_EMPDE__MAOAL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "OAL == 1", "VEM", "{3}");
        
            var paramValue = "V",
            paramCondition = "OAL == 1",
            paramElseValue = "VEM",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "PMAOAL");
        		}
        		//window.setProperty(field, "V", "OAL == 1", "VEM", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OVE", "BOL");
        		}
...
function onValidate_OVE__TP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OVE", "TP", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OVE", "TP");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OVE.TP");
        			window.setControlWidth(field, "0.7", "OVE", "TP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblOVE_TP");
        			    var ele = document.getElementById('ctl00_cntMainBody_OVE__TP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OVE__TP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "CAT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "NME");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "SNE");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_EMPDE__NOE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "NOE");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=EMPDE&propertyName=NOE&name={name}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "CPE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_EMPDE__DLOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "BOL==2", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "BOL==2",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Death Limit of Indemnity cannot be Zero or empty")) ? "Death Limit of Indemnity cannot be Zero or empty" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "DLOI");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "DLOI");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.SMINSLMT<=0 ||EMPDE.SMINSLMT == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__DPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.DPPREM==0 ||EMPDE.DPPREM == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__PDTPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EMPDE.PDT==1")) ? new Expression("EMPDE.PDT==1") : null;
        		var elseColour = (Expression.isValidParameter(" #000000")) ? " #000000" : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("(EMPDE.PDTSMISLM*EMPDE.PDTPRATE)*0.01"), 
        			condition = (Expression.isValidParameter("EMPDE.PDTPRATE>0 && EMPDE.PDTSMISLM>0")) ? new Expression("EMPDE.PDTPRATE>0 && EMPDE.PDTSMISLM>0") : null, 
        			elseValue = (Expression.isValidParameter("EMPDE.PDTPPREM")) ? new Expression("EMPDE.PDTPPREM") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.PDTPPREM<=0 || EMPDE.PDTPPREM == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__TTDMUL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TTDMUL", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TTDMUL");
        		}
        		//window.setProperty(field, "VM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EMPDE&propertyName=TTDMUL&name={name}");
...
function onValidate_EMPDE__TTDNOWEE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TTDNOWEE", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.TDPTDISB==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EMPDE.TDPTDISB==1")) ? new Expression("EMPDE.TDPTDISB==1") : null;
        		var elseColour = (Expression.isValidParameter(" #000000")) ? " #000000" : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=List&objectName=EMPDE&propertyName=TTDNOWEE&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "TTDPPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "TTDPPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
...
function onValidate_EMPDE__TPDFAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TPDFAP", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TPDFAP");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TPDFAP');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=TPDFAP&name={name}");
...
function onValidate_EMPDE__TPDMUL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TPDMUL", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=EMPDE&propertyName=TPDMUL&name={name}");
...
function onValidate_EMPDE__TPDNOWEEP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TPDNOWEEP", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.TEMPPART==1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=List&objectName=EMPDE&propertyName=TPDNOWEEP&name={name}");
...
function onValidate_EMPDE__TPDR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TPDR", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TPDR");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TPDR');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=EMPDE&propertyName=TPDR&name={name}");
...
function onValidate_EMPDE__TPDPREMP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TPDPREMP", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TPDPREMP");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'TPDPREMP');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TPDPREMP&name={name}");
...
function onValidate_EMPDE__TPDPPREMP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "TPDPPREMP", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "TPDPPREMP");
        		}
        		//window.setProperty(field, "VEM", "EMPDE.TEMPPART==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("EMPDE", "TPDPPREMP");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=TPDPPREMP&name={name}");
        		
        		var value = new Expression("(EMPDE.TDSUINLIP*EMPDE.TDRATEP)*0.01"), 
        			condition = (Expression.isValidParameter("EMPDE.TDRATEP>0 && EMPDE.TDSUINLIP>0")) ? new Expression("EMPDE.TDRATEP>0 && EMPDE.TDSUINLIP>0") : null, 
        			elseValue = (Expression.isValidParameter("EMPDE.TDPPREMP")) ? new Expression("EMPDE.TDPPREMP") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Temporary  Disability: Partial Posting Premium")) ? "Please enter Temporary  Disability: Partial Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "__" + "TPDPPREMP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EMPDE".toUpperCase() + "_" + "TPDPPREMP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.TDPPREMP<=0 || EMPDE.TDPPREMP == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__MEDPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("(EMPDE.MDCALEXPNS*EMPDE.MEDRATE)*0.01"), 
        			condition = (Expression.isValidParameter("EMPDE.MEDRATE>0 && EMPDE.MDCALEXPNS>0")) ? new Expression("EMPDE.MEDRATE>0 && EMPDE.MDCALEXPNS>0") : null, 
        			elseValue = (Expression.isValidParameter("EMPDE.MEDPREM")) ? new Expression("EMPDE.MEDPREM") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Medical Expenses Posting Premium")) ? "Please enter Medical Expenses Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.MEDPREM<=0 || EMPDE.MEDPREM == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__label27(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "label27", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "label27");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=label27&name={name}");
...
function onValidate_AHEXT__HIVLIMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EMPDE.HVACCEXP==1")) ? new Expression("EMPDE.HVACCEXP==1") : null;
        		var elseColour = (Expression.isValidParameter("#000000")) ? "#000000" : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "HIVLIMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "HIVLIMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.HIVLIMT<=0 || EMPDE.HIVLIMT == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AHEXT__HIVAPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.HIVLIMT*EMPDE.HIVRATE*0.01"), 
        			condition = (Expression.isValidParameter("EMPDE.HIVRATE>0")) ? new Expression("EMPDE.HIVRATE>0") : null, 
        			elseValue = (Expression.isValidParameter("EMPDE.HIVAPREM")) ? new Expression("EMPDE.HIVAPREM") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "HIVAPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "HIVAPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.HIVRATE<=0 || EMPDE.HIVRATE==null)&&EMPDE.HVACCEXP==1 ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AHEXT__HSPTMEX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHEXT", "HSPTMEX", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EMPDE.HSPTL==1")) ? new Expression("EMPDE.HSPTL==1") : null;
        		var elseColour = (Expression.isValidParameter("#000000")) ? "#000000" : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=AHEXT&propertyName=HSPTMEX&name={name}");
...
function onValidate_AHEXT__HSPPERIOD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHEXT", "HSPPERIOD", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=AHEXT&propertyName=HSPPERIOD&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "LMTIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "LMTIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.LMTIND<=0 || EMPDE.LMTIND == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AHEXT__HSPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.LMTIND*EMPDE.HSPRATE*0.01"), 
        			condition = (Expression.isValidParameter("EMPDE.HSPRATE>0")) ? new Expression("EMPDE.HSPRATE>0") : null, 
        			elseValue = (Expression.isValidParameter("EMPDE.HSPREM")) ? new Expression("EMPDE.HSPREM") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "HSPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "HSPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.HSPRATE<=0 || EMPDE.HSPRATE == null)&&EMPDE.HVACCEXP==1 ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AHEXT__IMRPPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHEXT", "IMRPPPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHEXT", "IMRPPPREM");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=AHEXT&propertyName=IMRPPPREM&name={name}");
...
function onValidate_AHEXT__IMRPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.SRSLMTIND*EMPDE.SRSRATE*0.01"), 
        			condition = (Expression.isValidParameter("EMPDE.SRSRATE>0")) ? new Expression("EMPDE.SRSRATE>0") : null, 
        			elseValue = (Expression.isValidParameter("EMPDE.SRSPREM")) ? new Expression("EMPDE.SRSPREM") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "IMRPPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "IMRPPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.SRSRATE<=0 || EMPDE.SRSRATE == null) && EMPDE.SRSILL==1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AHEXT__SRSLMTIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Serious Illness Limit of Indemnity has to greater than Zero")) ? "Serious Illness Limit of Indemnity has to greater than Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "SRSLMTIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "SRSLMTIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.SRSLMTIND<=0 || EMPDE.SRSLMTIND == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "SRSPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "SRSPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
...
function onValidate_AHEXT__TTDLIMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Temporary Total Disablement - Sickness  Limit of Indemnity has to greater than Zero")) ? "Temporary Total Disablement - Sickness  Limit of Indemnity has to greater than Zero" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "TTDLIMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "TTDLIMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.TTDLIMT<=0 || EMPDE.TTDLIMT == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AHEXT__TTDPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("EMPDE.TTDLIMT*EMPDE.TTDRATE*0.01"), 
        			condition = (Expression.isValidParameter("EMPDE.TTDRATE>0")) ? new Expression("EMPDE.TTDRATE>0") : null, 
        			elseValue = (Expression.isValidParameter("EMPDE.TTDPREM")) ? new Expression("EMPDE.TTDPREM") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "TTDPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "TTDPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EMPDE.TTDRATE<=0 || EMPDE.TTDRATE == null) &&EMPDE.TTDSCK == 1 ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_AHEXT__WRPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "EMPDE.WRRISK==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "__" + "WRPREM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHEXT".toUpperCase() + "_" + "WRPREM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
...
function onValidate_AHEXT__label72(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHEXT", "label72", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHEXT", "label72");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_EMPDE__HIVNEMP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("HIV Accidental Exposure No of Employees cannot be Zero or empty")) ? "HIV Accidental Exposure No of Employees cannot be Zero or empty" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.HIVNEMP<=0 || EMPDE.HIVNEMP== null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__HIVPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.HIVPREM<=0 || EMPDE.HIVPREM == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__ACCNEMPS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Accidental Expert Assistance No of Employees cannot be Zero or empty")) ? "Accidental Expert Assistance No of Employees cannot be Zero or empty" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.ACCNEMPS<=0 || EMPDE.ACCNEMPS== null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__ACCPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter Accidental Expert Assistance Posting Premium")) ? "Please enter Accidental Expert Assistance Posting Premium" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("EMPDE.ACCPREM<=0 || EMPDE.ACCPREM == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EMPDE__label88(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "label88", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "label88");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=label88&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'label88');
...
function onValidate_EMPDE__TOT_ENDPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @param AHOBJECT The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "AHOBJECT".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function DoLogic(isOnLoad) {
    ...
    onValidate_EMPDE__CO_INS(null, null, null, isOnLoad);
    ...
    onValidate_OVE__TP(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__TPDFAP(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__TPDR(null, null, null, isOnLoad);
    onValidate_EMPDE__TPDPREMP(null, null, null, isOnLoad);
    onValidate_EMPDE__TPDPPREMP(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__label27(null, null, null, isOnLoad);
    ...
    onValidate_AHEXT__IMRPPPREM(null, null, null, isOnLoad);
    ...
    onValidate_AHEXT__label72(null, null, null, isOnLoad);
    ...
    onValidate_EMPDE__label88(null, null, null, isOnLoad);
...
<div id="idae2792eed21c4b06ad09c600d1077b43" class="general-layout-container">
...
<div id="id24cd4f1f46a54b9fb5af50544a08c518" class="column-layout-container,no-border  ">
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblEMPDE_CO_INS" for="ctl00_cntMainBody_EMPDE__CO_INS" class="col-md-4 col-sm-3 control-label">
		Co- Insurance</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="EMPDE" 
		data-property-name="CO_INS" 
		id="pb-container-checkbox-EMPDE-CO_INS">	
		
		<asp:TextBox ID="EMPDE__CO_INS" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valEMPDE_CO_INS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Co- Insurance"
			ClientValidationFunction="onValidate_EMPDE__CO_INS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id24cd4f1f46a54b9fb5af50544a08c518 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id24cd4f1f46a54b9fb5af50544a08c518 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id24cd4f1f46a54b9fb5af50544a08c518 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id24cd4f1f46a54b9fb5af50544a08c518 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id24cd4f1f46a54b9fb5af50544a08c518 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id24cd4f1f46a54b9fb5af50544a08c518 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id24cd4f1f46a54b9fb5af50544a08c518 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id24cd4f1f46a54b9fb5af50544a08c518 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id24cd4f1f46a54b9fb5af50544a08c518 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id24cd4f1f46a54b9fb5af50544a08c518 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6b20916a4c914c508e80d3f444cf10cd" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6b20916a4c914c508e80d3f444cf10cd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6b20916a4c914c508e80d3f444cf10cd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6b20916a4c914c508e80d3f444cf10cd div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6b20916a4c914c508e80d3f444cf10cd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6b20916a4c914c508e80d3f444cf10cd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6b20916a4c914c508e80d3f444cf10cd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6
null, null, this);" data-type="List" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="EMPDE" 
		data-property-name="TPDR" 
		id="pb-container-percentage-EMPDE-TPDR">
		<asp:Label ID="lblEMPDE_TPDR" runat="server" AssociatedControlID="EMPDE__TPDR" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EMPDE__TPDR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEMPDE_TPDR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TPDR"
			ClientValidationFunction="onValidate_EMPDE__TPDR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="TPDPREMP" 
		id="pb-container-currency-EMPDE-TPDPREMP">
		<asp:Label ID="lblEMPDE_TPDPREMP" runat="server" AssociatedControlID="EMPDE__TPDPREMP" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TPDPREMP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TPDPREMP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TPDPREMP"
			ClientValidationFunction="onValidate_EMPDE__TPDPREMP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="TPDPPREMP" 
		id="pb-container-currency-EMPDE-TPDPPREMP">
		<asp:Label ID="lblEMPDE_TPDPPREMP" runat="server" AssociatedControlID="EMPDE__TPDPPREMP" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__TPDPPREMP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_TPDPPREMP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.TPDPPREMP"
			ClientValidationFunction="onValidate_EMPDE__TPDPPREMP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label18">
		<span class="label" id="label18">Medical Expenses </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label22">
		<span class="label" id="label22">Total</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="label27" 
		id="pb-container-currency-EMPDE-label27">
		<asp:Label ID="lblEMPDE_label27" runat="server" AssociatedControlID="EMPDE__label27" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__label27" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_label27" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.label27"
			ClientValidationFunction="onValidate_EMPDE__label27" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id500019937d4c41948c3cffad56d413b5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id500019937d4c41948c3cffad56d413b5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id500019937d4c41948c3cffad56d413b5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id500019937d4c41948c3cffad56d413b5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id500019937d4c41948c3cffad56d413b5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id500019937d4c41948c3cffad56d413b5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id500019937d4c41948c3cffad56d413b5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id500019937d4c41948c3cffad56d413b5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id500019937d4c41948c3cffad56d413b5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id500019937d4c41948c3cffad56d413b5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id44c038600dea4f13a70ff6f7841365bb" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Extensions" /></legend>
				
				
				<div data-column-count="10" data-column-ratio="5:20:15:10:8:8:10:7:7:10" data-layout="" class="clearfix form-horizontal">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label31">
		<span class="label" id="label31">Time Excess</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label32">
		<span class="label" id="label32">Hospitalisation Period</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label33">
		<span class="label" id="label33">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label34">
		<span class="label" id="label34">Rate</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label37">
		<span class="label" id="label37">FAP%/Time Excess</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label38">
		<span class="label" id="label38">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label39">
		<span class="label" id="label39">HIV Accidental Exposure </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label44">
		<span class="label" id="label44">Hospitalisation </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AHEXT-HSPTMEX">
		...
		<asp:Label ID="lblAHEXT_HSPTMEX" runat="server" AssociatedControlID="AHEXT__HSPTMEX" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHEXT__HSPTMEX" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AHEXT-HSPPERIOD">
		...
		<asp:Label ID="lblAHEXT_HSPPERIOD" runat="server" AssociatedControlID="AHEXT__HSPPERIOD" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHEXT__HSPPERIOD" runat="server" CssClass="form-control" data-type="Text" />
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label47">
		<span class="label" id="label47">Image Protection Risk</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="AHEXT" 
		data-property-name="IMRPPPREM" 
		id="pb-container-currency-AHEXT-IMRPPPREM">
		<asp:Label ID="lblAHEXT_IMRPPPREM" runat="server" AssociatedControlID="AHEXT__IMRPPPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AHEXT__IMRPPPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valAHEXT_IMRPPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for AHEXT.IMRPPPREM"
			ClientValidationFunction="onValidate_AHEXT__IMRPPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label54">
		<span class="label" id="label54">Serious Illness</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label56">
		<span class="label" id="label56">Temporary Total Disablement - Sickness </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label58">
		<span class="label" id="label58">War Risk </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label66">
		<span class="label" id="label66">Total</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name