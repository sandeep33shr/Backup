...
Namespace Nexus
    Partial Class PB2_FRP_SNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_FPP_SNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If FPP_SNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		FPP_SNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		FPP_SNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_FPP_SNOTES_DETAILS__NOTE_DETAILS()
End Sub
