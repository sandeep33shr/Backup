<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PUBSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_PUBSNOTE_Note_Details" %>
...
function onValidate_GENTEN_SCNOTE_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENTEN_SCNOTE_DETAILS.COVER_TYPE");
        			window.setControlWidth(field, "3", "GENTEN_SCNOTE_DETAILS", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'General & Tenants'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENTEN_SCNOTE_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENTEN_SCNOTE_DETAILS.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "3", "GENTEN_SCNOTE_DETAILS", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_GENTEN_SCNOTE_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENTEN_SCNOTE_DETAILS.NOTE_DETAILS");
        			window.setControlWidth(field, "3", "GENTEN_SCNOTE_DETAILS", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
...
<div id="idbbcc3324a1994702b9f5c9c633e6197b" class="general-layout-container">
...
<div id="id613d3d74f2d647ec828dfefc142d2ce5" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading73" runat="server" Text="Motor Fleet Note Detail (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id613d3d74f2d647ec828dfefc142d2ce5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id613d3d74f2d647ec828dfefc142d2ce5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id613d3d74f2d647ec828dfefc142d2ce5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id613d3d74f2d647ec828dfefc142d2ce5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id613d3d74f2d647ec828dfefc142d2ce5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id613d3d74f2d647ec828dfefc142d2ce5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id613d3d74f2d647ec828dfefc142d2ce5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id613d3d74f2d647ec828dfefc142d2ce5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id613d3d74f2d647ec828dfefc142d2ce5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id613d3d74f2d647ec828dfefc142d2ce5 input{text-align:left;}"; break;
		}
	}
