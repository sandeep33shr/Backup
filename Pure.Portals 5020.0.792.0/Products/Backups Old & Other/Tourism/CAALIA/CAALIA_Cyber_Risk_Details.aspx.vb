...
Namespace Nexus
    Partial Class PB2_CAALIA_Cyber_Risk_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CYBER__RETRODATE()
         
End Sub
Protected Sub CallRuleScripts()
    onValidate_CYBER__RETRODATE()
End Sub
