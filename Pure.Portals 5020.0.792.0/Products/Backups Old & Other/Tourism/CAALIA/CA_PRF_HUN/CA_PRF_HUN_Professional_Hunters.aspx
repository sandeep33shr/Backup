<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CA_PRF_HUN_Professional_Hunters.aspx.vb" Inherits="Nexus.PB2_CA_PRF_HUN_Professional_Hunters" %>
...
function onValidate_PROFDETAILS__HUN_NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PROFDETAILS", "HUN_NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PROFDETAILS", "HUN_NAME");
        		}
...
function onValidate_PROFDETAILS__ID_NUMBER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PROFDETAILS", "ID_NUMBER", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PROFDETAILS", "ID_NUMBER");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_PROFDETAILS__HUN_NAME(null, null, null, isOnLoad);
    onValidate_PROFDETAILS__ID_NUMBER(null, null, null, isOnLoad);
}
</script>
...
<div id="idca94edcbeac64fefa4269ac285970f99" class="general-layout-container">
...
<div id="id287472ba05474518922adbf5a0dfe430" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PROFDETAILS" 
		data-property-name="HUN_NAME" 
		 
		
		 
		id="pb-container-text-PROFDETAILS-HUN_NAME">

		
		<asp:Label ID="lblPROFDETAILS_HUN_NAME" runat="server" AssociatedControlID="PROFDETAILS__HUN_NAME" 
			Text="Hunters Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PROFDETAILS__HUN_NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPROFDETAILS_HUN_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Hunters Name"
					ClientValidationFunction="onValidate_PROFDETAILS__HUN_NAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PROFDETAILS-ID_NUMBER">

		
		<asp:Label ID="lblPROFDETAILS_ID_NUMBER" runat="server" AssociatedControlID="PROFDETAILS__ID_NUMBER" 
			Text="ID Number" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PROFDETAILS__ID_NUMBER" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPROFDETAILS_ID_NUMBER" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID Number"
					ClientValidationFunction="onValidate_PROFDETAILS__ID_NUMBER"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id287472ba05474518922adbf5a0dfe430 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id287472ba05474518922adbf5a0dfe430 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id287472ba05474518922adbf5a0dfe430 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id287472ba05474518922adbf5a0dfe430 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id287472ba05474518922adbf5a0dfe430 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id287472ba05474518922adbf5a0dfe430 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id287472ba05474518922adbf5a0dfe430 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id287472ba05474518922adbf5a0dfe430 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id287472ba05474518922adbf5a0dfe430 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id287472ba05474518922adbf5a0dfe430 input{text-align:left;}"; break;
		}
	}
