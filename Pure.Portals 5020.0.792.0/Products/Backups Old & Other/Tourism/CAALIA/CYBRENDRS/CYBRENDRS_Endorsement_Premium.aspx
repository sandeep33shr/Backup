<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CYBRENDRS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CYBRENDRS_Endorsement_Premium" %>
...
function onValidate_CYBER_CLAUSEPREM__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CYBER_CLAUSEPREM", "ENDORSE_DESC", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CYBER_CLAUSEPREM.ENDORSE_DESC");
        			window.setControlWidth(field, "0.7", "CYBER_CLAUSEPREM", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
...
function onValidate_CYBER_CLAUSEPREM__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CYBER_CLAUSEPREM.PREMIUM");
        			window.setControlWidth(field, "0.7", "CYBER_CLAUSEPREM", "PREMIUM");
        		})();
        	}
        })();
        /**
...
<div id="id46892010321e4ea38d8e2eb6378832ec" class="general-layout-container">
...
<div id="ide1c86cbdd3be4f9cb7403f2785af6f17" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CYBER_CLAUSEPREM-ENDORSE_DESC">
		...
		<asp:Label ID="lblCYBER_CLAUSEPREM_ENDORSE_DESC" runat="server" AssociatedControlID="CYBER_CLAUSEPREM__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CYBER_CLAUSEPREM__ENDORSE_DESC" runat="server" CssClass="form-control" data-type="Text" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide1c86cbdd3be4f9cb7403f2785af6f17 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide1c86cbdd3be4f9cb7403f2785af6f17 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide1c86cbdd3be4f9cb7403f2785af6f17 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide1c86cbdd3be4f9cb7403f2785af6f17 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide1c86cbdd3be4f9cb7403f2785af6f17 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide1c86cbdd3be4f9cb7403f2785af6f17 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide1c86cbdd3be4f9cb7403f2785af6f17 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide1c86cbdd3be4f9cb7403f2785af6f17 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide1c86cbdd3be4f9cb7403f2785af6f17 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide1c86cbdd3be4f9cb7403f2785af6f17 input{text-align:left;}"; break;
		}
	}
