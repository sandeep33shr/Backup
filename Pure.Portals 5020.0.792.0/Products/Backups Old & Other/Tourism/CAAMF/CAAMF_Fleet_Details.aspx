<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMF_Fleet_Details.aspx.vb" Inherits="Nexus.PB2_CAAMF_Fleet_Details" %>
...
function onValidate_FLEET__FLEET_BS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "FLEET_BS", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FLEET", "FLEET_BS");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FLEET.FLEET_BS");
        			window.setControlWidth(field, "0.8", "FLEET", "FLEET_BS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFLEET_FLEET_BS");
        			    var ele = document.getElementById('ctl00_cntMainBody_FLEET__FLEET_BS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FLEET__FLEET_BS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_FLEET__MFLEETDET(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "MFLEETDET", "ChildScreen");
        })();
}
function onValidate_FLEET__MFVEHDET(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "MFVEHDET", "ChildScreen");
        })();
}
function onValidate_FLEET__SOUNDEQ(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "SOUNDEQ", "ChildScreen");
        })();
}
...
function onValidate_FLEET__MFPRTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FLEET", "MFPRTY", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_FLEET__FLEET_BS(null, null, null, isOnLoad);
    ...
    onValidate_FLEET__MFLEETDET(null, null, null, isOnLoad);
    onValidate_FLEET__MFVEHDET(null, null, null, isOnLoad);
    onValidate_FLEET__SOUNDEQ(null, null, null, isOnLoad);
    onValidate_FLEET__SOUND_PREM(null, null, null, isOnLoad);
    onValidate_FLEET__COUNT_SOUND(null, null, null, isOnLoad);
    onValidate_FLEET__MFPRTY(null, null, null, isOnLoad);
...
<div id="id1ff397d7628d4641ad80ecc0acaaa661" class="general-layout-container">
...
<div id="id5ea3b6763dd14683b819fbada79e17bd" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading17" runat="server" Text="Motor Fleet Premium Basis" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5ea3b6763dd14683b819fbada79e17bd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5ea3b6763dd14683b819fbada79e17bd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5ea3b6763dd14683b819fbada79e17bd div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5ea3b6763dd14683b819fbada79e17bd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5ea3b6763dd14683b819fbada79e17bd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5ea3b6763dd14683b819fbada79e17bd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5ea3b6763dd14683b819fbada79e17bd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5ea3b6763dd14683b819fbada79e17bd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5ea3b6763dd14683b819fbada79e17bd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5ea3b6763dd14683b819fbada79e17bd input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2b98426274c14503bb74998f17d690b2" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2b98426274c14503bb74998f17d690b2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2b98426274c14503bb74998f17d690b2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2b98426274c14503bb74998f17d690b2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2b98426274c14503bb74998f17d690b2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2b98426274c14503bb74998f17d690b2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b98426274c14503bb74998f17d690b2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b98426274c14503bb74998f17d690b2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2b98426274c14503bb74998f17d690b2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b98426274c14503bb74998f17d690b2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b98426274c14503bb74998f17d690b2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id462899389a4f417e968afcdc7eaff213" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id462899389a4f417e968afcdc7eaff213 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id462899389a4f417e968afcdc7eaff213 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id462899389a4f417e968afcdc7eaff213 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id462899389a4f417e968afcdc7eaff213 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id462899389a4f417e968afcdc7eaff213 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id462899389a4f417e968afcdc7eaff213 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id462899389a4f417e968afcdc7eaff213 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id462899389a4f417e968afcdc7eaff213 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id462899389a4f417e968afcdc7eaff213 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id462899389a4f417e968afcdc7eaff213 input{text-align:left;}"; break;
		}
	}
...
<div id="frmFleetDetails" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Fleet Cover Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="FLEET" 
		data-property-name="FLEET_BS" 
		 
		
		 
		id="pb-container-text-FLEET-FLEET_BS">

		
		<asp:Label ID="lblFLEET_FLEET_BS" runat="server" AssociatedControlID="FLEET__FLEET_BS" 
			Text="Basis of Settlement " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FLEET__FLEET_BS" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFLEET_FLEET_BS" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Basis of Settlement "
					ClientValidationFunction="onValidate_FLEET__FLEET_BS"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div id="frmFleetDetails" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading21" runat="server" Text="Fleet Details" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FLEET__MFLEETDET"
		data-field-type="Child" 
		data-object-name="FLEET" 
		data-property-name="MFLEETDET" 
		id="pb-container-childscreen-FLEET-MFLEETDET">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FLEET__FLEET_DETAILS" runat="server" ScreenCode="MFLEETDET" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MFLEETDET/MFLEETDET_Fleet_Cover_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Number of Units" DataField="NO_UNITS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFLEET_MFLEETDET" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FLEET.MFLEETDET"
						ClientValidationFunction="onValidate_FLEET__MFLEETDET" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9b8483f12c244d97b193c1c2d9677aff" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading22" runat="server" Text="Vehicle Details" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FLEET__MFVEHDET"
		data-field-type="Child" 
		data-object-name="FLEET" 
		data-property-name="MFVEHDET" 
		id="pb-container-childscreen-FLEET-MFVEHDET">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FLEET__VEHICLE_DETAILS" runat="server" ScreenCode="MFVEHDET" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MFVEHDET/MFVEHDET_Vehicle_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Sum Insured" DataField="SUMINSURED" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFLEET_MFVEHDET" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FLEET.MFVEHDET"
						ClientValidationFunction="onValidate_FLEET__MFVEHDET" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9b8483f12c244d97b193c1c2d9677aff div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9b8483f12c244d97b193c1c2d9677aff div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9b8483f12c244d97b193c1c2d9677aff div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9b8483f12c244d97b193c1c2d9677aff label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9b8483f12c244d97b193c1c2d9677aff label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9b8483f12c244d97b193c1c2d9677aff label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9b8483f12c244d97b193c1c2d9677aff label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9b8483f12c244d97b193c1c2d9677aff input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9b8483f12c244d97b193c1c2d9677aff input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9b8483f12c244d97b193c1c2d9677aff input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5d954529b3b6472c90a36d712af36626" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FLEET__SOUNDEQ"
		data-field-type="Child" 
		data-object-name="FLEET" 
		data-property-name="SOUNDEQ" 
		id="pb-container-childscreen-FLEET-SOUNDEQ">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FLEET__SOUND_EQUIPMENT" runat="server" ScreenCode="SOUNDEQ" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SOUNDEQ/SOUNDEQ_Sound_Equipment.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Minimum Amount" DataField="FAP_AMT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valFLEET_SOUNDEQ" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FLEET.SOUNDEQ"
						ClientValidationFunction="onValidate_FLEET__SOUNDEQ" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5d954529b3b6472c90a36d712af36626 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5d954529b3b6472c90a36d712af36626 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5d954529b3b6472c90a36d712af36626 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5d954529b3b6472c90a36d712af36626 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5d954529b3b6472c90a36d712af36626 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d954529b3b6472c90a36d712af36626 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d954529b3b6472c90a36d712af36626 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5d954529b3b6472c90a36d712af36626 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d954529b3b6472c90a36d712af36626 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d954529b3b6472c90a36d712af36626 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id41cf0acb907046df9862009db39939d6" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FLEET__MFPRTY"
		data-field-type="Child" 
		data-object-name="FLEET" 
		data-property-name="MFPRTY" 
		id="pb-container-childscreen-FLEET-MFPRTY">
		
		    <legend>Interest Parties </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FLEET__INT_PARTIES" runat="server" ScreenCode="MFPRTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MFPRTY/MFPRTY_Interest_Parties.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Vehicle Registration Number" DataField="REGNO" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFLEET_MFPRTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Interest Parties "
						ClientValidationFunction="onValidate_FLEET__MFPRTY" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id41cf0acb907046df9862009db39939d6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id41cf0acb907046df9862009db39939d6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id41cf0acb907046df9862009db39939d6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id41cf0acb907046df9862009db39939d6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id41cf0acb907046df9862009db39939d6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id41cf0acb907046df9862009db39939d6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id41cf0acb907046df9862009db39939d6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id41cf0acb907046df9862009db39939d6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id41cf0acb907046df9862009db39939d6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id41cf0acb907046df9862009db39939d6 input{text-align:left;}"; break;
		}
	}
...
<div id="frmFirst Amount Payable" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading25" runat="server" Text="First Amount Payable" /></legend>
