<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMF_Endorsements.aspx.vb" Inherits="Nexus.PB2_CAAMF_Endorsements" %>
...
function onValidate_MFLEET_CLAUSES__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MFLEET_CLAUSES", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("MFLEET_CLAUSES", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMFLEET_CLAUSES_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MFLEET_CLAUSES__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MFLEET_CLAUSES__TOT_PREM_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MFLEET_CLAUSES.TOT_PREM");
        			window.setControlWidth(field, "0.3", "MFLEET_CLAUSES", "TOT_PREM");
        		})();
        	}
        })();
          ...
          * @param MFLEET_CLAUSES The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MFLEET_CLAUSES".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_MFLEET_CLAUSES__MFENDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MFLEET_CLAUSES", "MFENDPRM", "ChildScreen");
        })();
}
function onValidate_MFLEET_CLAUSES__COUNT_ENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MFLEET_CLAUSES", "COUNT_ENDPREM", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MFLEET_CLAUSES", "COUNT_ENDPREM");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_MFLEET_CLAUSES__TOT_PREM(null, null, null, isOnLoad);
    onValidate_MFLEET_CLAUSES__MFENDPRM(null, null, null, isOnLoad);
    onValidate_MFLEET_CLAUSES__COUNT_ENDPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id83c0f2e9550f4b81b736e90234353192" class="general-layout-container">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblMFLEET_CLAUSES_MFLEET_CLAUSES" runat="server" AssociatedControlID="MFLEET_CLAUSES__MFLEET_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="MFLEET_CLAUSES__MFLEET_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MFLEET_CLAUSES" 
		data-property-name="TOT_PREM" 
		id="pb-container-currency-MFLEET_CLAUSES-TOT_PREM">
		<asp:Label ID="lblMFLEET_CLAUSES_TOT_PREM" runat="server" AssociatedControlID="MFLEET_CLAUSES__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MFLEET_CLAUSES__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMFLEET_CLAUSES_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_MFLEET_CLAUSES__TOT_PREM" 
			ValidationGroup=""
			Display="None"
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MFLEET_CLAUSES__MFENDPRM"
		data-field-type="Child" 
		data-object-name="MFLEET_CLAUSES" 
		data-property-name="MFENDPRM" 
		id="pb-container-childscreen-MFLEET_CLAUSES-MFENDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MFLEET_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="MFENDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MFENDPRM/MFENDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMFLEET_CLAUSES_MFENDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MFLEET_CLAUSES.MFENDPRM"
						ClientValidationFunction="onValidate_MFLEET_CLAUSES__MFENDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MFLEET_CLAUSES" 
		data-property-name="COUNT_ENDPREM" 
		id="pb-container-integer-MFLEET_CLAUSES-COUNT_ENDPREM">
		<asp:Label ID="lblMFLEET_CLAUSES_COUNT_ENDPREM" runat="server" AssociatedControlID="MFLEET_CLAUSES__COUNT_ENDPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MFLEET_CLAUSES__COUNT_ENDPREM" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMFLEET_CLAUSES_COUNT_ENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MFLEET_CLAUSES.COUNT_ENDPREM"
			ClientValidationFunction="onValidate_MFLEET_CLAUSES__COUNT_ENDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
