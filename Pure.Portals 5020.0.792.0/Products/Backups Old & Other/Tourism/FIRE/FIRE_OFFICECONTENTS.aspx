                ...
                <div class="form-horizontal">
                    ...
                    <div id="liOC__ALARM_WARRANTY" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Alarm Warranty</label><div class="col-md-8 col-sm-9">
                            <NexusProvider:lookuplist id="OC__ALARM_WARRANTY" runat="server" listtype="PMLookup" listcode="UDL_EBPGFOCALARM" defaulttext="(None)" value="0" cssclass="field-mandatory field-medium form-control"></NexusProvider:lookuplist></div>
                    ...
                    <div id="liOC__OCO_FLATPREM" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <label class="col-md-4 col-sm-3 control-label">Flat Premium</label><div class="col-md-8 col-sm-9">
                            <asp:CheckBox ID="OC__OCO_FLATPREM" runat="server" onclick="ToggleFlatPremium(this.checked);" Text=" " CssClass="asp-check"></asp:CheckBox></div>
                    </div>
                </div>
                <legend>Cover</legend>
