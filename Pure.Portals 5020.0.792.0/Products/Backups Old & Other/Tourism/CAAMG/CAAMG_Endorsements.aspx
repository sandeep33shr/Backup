<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMG_Endorsements.aspx.vb" Inherits="Nexus.PB2_CAAMG_Endorsements" %>
...
function onValidate_GEN_CLAUSES__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GEN_CLAUSES", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("GEN_CLAUSES", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGEN_CLAUSES_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_GEN_CLAUSES__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GEN_CLAUSES__TOT_PREM_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GEN_CLAUSES.TOT_PREM");
        			window.setControlWidth(field, "0.3", "GEN_CLAUSES", "TOT_PREM");
        		})();
        	}
        })();
          ...
          * @param GEN_CLAUSES The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "GEN_CLAUSES".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_GEN_CLAUSES__MGENDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GEN_CLAUSES", "MGENDPRM", "ChildScreen");
        })();
}
function onValidate_GEN_CLAUSES__COUNT_ENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GEN_CLAUSES", "COUNT_ENDPREM", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GEN_CLAUSES", "COUNT_ENDPREM");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_GEN_CLAUSES__TOT_PREM(null, null, null, isOnLoad);
    onValidate_GEN_CLAUSES__MGENDPRM(null, null, null, isOnLoad);
    onValidate_GEN_CLAUSES__COUNT_ENDPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id916a3d2cdec441d6a24acdc286b9aeb5" class="general-layout-container">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblGEN_CLAUSES_GEN_CLAUSES" runat="server" AssociatedControlID="GEN_CLAUSES__GEN_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="GEN_CLAUSES__GEN_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GEN_CLAUSES" 
		data-property-name="TOT_PREM" 
		id="pb-container-currency-GEN_CLAUSES-TOT_PREM">
		<asp:Label ID="lblGEN_CLAUSES_TOT_PREM" runat="server" AssociatedControlID="GEN_CLAUSES__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GEN_CLAUSES__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGEN_CLAUSES_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_GEN_CLAUSES__TOT_PREM" 
			ValidationGroup=""
			Display="None"
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GEN_CLAUSES__MGENDPRM"
		data-field-type="Child" 
		data-object-name="GEN_CLAUSES" 
		data-property-name="MGENDPRM" 
		id="pb-container-childscreen-GEN_CLAUSES-MGENDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GEN_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="MGENDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGENDPRM/MGENDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valGEN_CLAUSES_MGENDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GEN_CLAUSES.MGENDPRM"
						ClientValidationFunction="onValidate_GEN_CLAUSES__MGENDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-GEN_CLAUSES-COUNT_ENDPREM">
		<asp:Label ID="lblGEN_CLAUSES_COUNT_ENDPREM" runat="server" AssociatedControlID="GEN_CLAUSES__COUNT_ENDPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="GEN_CLAUSES__COUNT_ENDPREM" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valGEN_CLAUSES_COUNT_ENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for GEN_CLAUSES.COUNT_ENDPREM"
			ClientValidationFunction="onValidate_GEN_CLAUSES__COUNT_ENDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
