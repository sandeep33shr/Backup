<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMG_Notes.aspx.vb" Inherits="Nexus.PB2_CAAMG_Notes" %>
...
function onValidate_NOTES__MGNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "MGNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MGNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__MGNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MGNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'MGNOTE'.");
        			error.display();
...
function onValidate_NOTES__MGSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "MGSNOTE", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("NOTES", "MGSNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__MGSNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MGSNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'MGSNOTE'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function DoLogic(isOnLoad) {
    onValidate_NOTES__MGNOTE(null, null, null, isOnLoad);
    onValidate_NOTES__COUNT_NOTES(null, null, null, isOnLoad);
    onValidate_NOTES__MGSNOTE(null, null, null, isOnLoad);
...
<div id="idb2202a2efbaa4a4b8f03699a14d60739" class="general-layout-container">
...
<div id="id7caeca8254874ed7bc24d0fc8921ec23" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__MGNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="MGNOTE" 
		id="pb-container-childscreen-NOTES-MGNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="MGNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGNOTE/MGNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_MGNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.MGNOTE"
						ClientValidationFunction="onValidate_NOTES__MGNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7caeca8254874ed7bc24d0fc8921ec23 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7caeca8254874ed7bc24d0fc8921ec23 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7caeca8254874ed7bc24d0fc8921ec23 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7caeca8254874ed7bc24d0fc8921ec23 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7caeca8254874ed7bc24d0fc8921ec23 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7caeca8254874ed7bc24d0fc8921ec23 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7caeca8254874ed7bc24d0fc8921ec23 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7caeca8254874ed7bc24d0fc8921ec23 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7caeca8254874ed7bc24d0fc8921ec23 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7caeca8254874ed7bc24d0fc8921ec23 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfc8d142cdb614617a94e69642ac05095" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__MGSNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="MGSNOTE" 
		id="pb-container-childscreen-NOTES-MGSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__SCNOTE_DETAILS" runat="server" ScreenCode="MGSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGSNOTE/MGSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_MGSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.MGSNOTE"
						ClientValidationFunction="onValidate_NOTES__MGSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idfc8d142cdb614617a94e69642ac05095 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfc8d142cdb614617a94e69642ac05095 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfc8d142cdb614617a94e69642ac05095 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfc8d142cdb614617a94e69642ac05095 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfc8d142cdb614617a94e69642ac05095 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfc8d142cdb614617a94e69642ac05095 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfc8d142cdb614617a94e69642ac05095 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfc8d142cdb614617a94e69642ac05095 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfc8d142cdb614617a94e69642ac05095 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfc8d142cdb614617a94e69642ac05095 input{text-align:left;}"; break;
		}
	}
