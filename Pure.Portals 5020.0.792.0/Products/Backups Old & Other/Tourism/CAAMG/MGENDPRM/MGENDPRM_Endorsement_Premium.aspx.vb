...
Namespace Nexus
    Partial Class PB2_MGENDPRM_Endorsement_Premium : Inherits BaseRisk
...
End Sub
        ...
        'Parameters:
        'GEN_CLAUSES - Standard Wording Parent Object
        'GEN_CLAUSES - Standard Wording Parent Property
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/GEN_CLAUSES/SW.GEN_CLAUSES")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/GEN_CLAUSES/CLAUSEPREM")
