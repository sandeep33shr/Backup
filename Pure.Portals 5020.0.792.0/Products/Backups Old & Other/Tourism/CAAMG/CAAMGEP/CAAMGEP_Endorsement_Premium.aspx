<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMGEP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CAAMGEP_Endorsement_Premium" %>
...
<div id="id2224f36e904b47bb905434debabf4e10" class="general-layout-container">
...
<div id="id68bc590d8bb84c25b4a1cf0f58e5f8bc" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id68bc590d8bb84c25b4a1cf0f58e5f8bc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id68bc590d8bb84c25b4a1cf0f58e5f8bc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id68bc590d8bb84c25b4a1cf0f58e5f8bc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id68bc590d8bb84c25b4a1cf0f58e5f8bc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id68bc590d8bb84c25b4a1cf0f58e5f8bc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id68bc590d8bb84c25b4a1cf0f58e5f8bc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id68bc590d8bb84c25b4a1cf0f58e5f8bc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id68bc590d8bb84c25b4a1cf0f58e5f8bc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id68bc590d8bb84c25b4a1cf0f58e5f8bc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id68bc590d8bb84c25b4a1cf0f58e5f8bc input{text-align:left;}"; break;
		}
	}
