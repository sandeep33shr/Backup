<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMG_General.aspx.vb" Inherits="Nexus.PB2_CAAMG_General" %>
...
function onValidate_GENERAL__CAAMGENMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CAAMGENMTA", "ChildScreen");
        })();
}
...
function onValidate_GENERAL__PARKLIMDEF(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "PARKLIMDEF", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "PARKLIMDEF");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__IS_MTA_REASON(source, args, sender, isOnLoad) {
        ...
        /** 
         * ToggleContainer
         * @param frTourismTAReason The element to toggle
        ...
        (function(){
        	...
        	if (isOnLoad) {
        		...
        		var update = function(){
        			...
        			if (!inverse){
        				(new Expression("SetElementDisplay('frTourismTAReason', !!" + value + ")")).valueOf();
        			} else {
        				(new Expression("SetElementDisplay('frTourismTAReason', !" + value + ")")).valueOf();
        			}
        		};
...
function DoLogic(isOnLoad) {
    onValidate_GENERAL__CAAMGENMTA(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__PARKLIMDEF(null, null, null, isOnLoad);
...
<div id="idfec899cd01e447228445584796b4b104" class="general-layout-container">
...
<div id="frTourismTAReason" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Mid-Term Adjustment Reason" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CAAMGENMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CAAMGENMTA" 
		id="pb-container-childscreen-GENERAL-CAAMGENMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CAAMGENMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAAMGENMTA/CAAMGENMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CAAMGENMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CAAMGENMTA"
						ClientValidationFunction="onValidate_GENERAL__CAAMGENMTA" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#frTourismTAReason div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frTourismTAReason div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frTourismTAReason div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#frTourismTAReason label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frTourismTAReason label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frTourismTAReason label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frTourismTAReason label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frTourismTAReason input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frTourismTAReason input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frTourismTAReason input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idbffdb6ea35b04780ab9ac94c5d4eb49a" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idbffdb6ea35b04780ab9ac94c5d4eb49a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbffdb6ea35b04780ab9ac94c5d4eb49a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbffdb6ea35b04780ab9ac94c5d4eb49a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idbffdb6ea35b04780ab9ac94c5d4eb49a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbffdb6ea35b04780ab9ac94c5d4eb49a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbffdb6ea35b04780ab9ac94c5d4eb49a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbffdb6ea35b04780ab9ac94c5d4eb49a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbffdb6ea35b04780ab9ac94c5d4eb49a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbffdb6ea35b04780ab9ac94c5d4eb49a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbffdb6ea35b04780ab9ac94c5d4eb49a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd7c85b5780dd463c838e381ef9945d2a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Cover" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label5">
		<span class="label" id="label5">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label6">
		<span class="label" id="label6">Contingent Liability </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label7">
		<span class="label" id="label7">Parking Facilities </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label9">
		<span class="label" id="label9">Total</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd7c85b5780dd463c838e381ef9945d2a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd7c85b5780dd463c838e381ef9945d2a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd7c85b5780dd463c838e381ef9945d2a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd7c85b5780dd463c838e381ef9945d2a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd7c85b5780dd463c838e381ef9945d2a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd7c85b5780dd463c838e381ef9945d2a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd7c85b5780dd463c838e381ef9945d2a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd7c85b5780dd463c838e381ef9945d2a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd7c85b5780dd463c838e381ef9945d2a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd7c85b5780dd463c838e381ef9945d2a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3381bff19542487f80250ec34df62746" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading6" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="GENERAL" 
		data-property-name="PARKLIMDEF" 
		id="pb-container-integer-GENERAL-PARKLIMDEF">
		<asp:Label ID="lblGENERAL_PARKLIMDEF" runat="server" AssociatedControlID="GENERAL__PARKLIMDEF" 
			Text="Parking Limit of Indemnity Default" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="GENERAL__PARKLIMDEF" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valGENERAL_PARKLIMDEF" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Parking Limit of Indemnity Default"
			ClientValidationFunction="onValidate_GENERAL__PARKLIMDEF" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3381bff19542487f80250ec34df62746 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3381bff19542487f80250ec34df62746 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3381bff19542487f80250ec34df62746 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3381bff19542487f80250ec34df62746 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3381bff19542487f80250ec34df62746 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3381bff19542487f80250ec34df62746 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3381bff19542487f80250ec34df62746 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3381bff19542487f80250ec34df62746 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3381bff19542487f80250ec34df62746 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3381bff19542487f80250ec34df62746 input{text-align:left;}"; break;
		}
	}
