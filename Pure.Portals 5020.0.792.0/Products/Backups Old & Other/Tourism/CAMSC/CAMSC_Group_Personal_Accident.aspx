<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAMSC_Group_Personal_Accident.aspx.vb" Inherits="Nexus.PB2_CAMSC_Group_Personal_Accident" %>
...
function onValidate_STBEN__MED_FAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STBEN", "MED_FAP", "Percentage");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=STBEN&propertyName=MED_FAP&name={name}");
        		
        		var value = new Expression("GENERAL.GPAFAP"), 
        			condition = (Expression.isValidParameter("STBEN.MED_FAP<GENERAL.GPAFAP")) ? new Expression("STBEN.MED_FAP<GENERAL.GPAFAP") : null, 
        			elseValue = (Expression.isValidParameter("STBEN.MED_FAP")) ? new Expression("STBEN.MED_FAP") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "STBEN".toUpperCase() + "__" + "MED_FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "STBEN".toUpperCase() + "_" + "MED_FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("STBEN.MED_FAP>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("STBEN", "MED_FAP");
        		}
        		//window.setProperty(field, "VE", "EMPDE.MDCLEXPNS==1", "V", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.MDCLEXPNS==0")) ? new Expression("EMPDE.MDCLEXPNS==0") : null, 
        			elseValue = (Expression.isValidParameter("GENERAL.GPAFAP")) ? new Expression("GENERAL.GPAFAP") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('STBEN', 'MED_FAP');
...
function onValidate_STBEN__MED_MINA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STBEN", "MED_MINA", "Currency");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=STBEN&propertyName=MED_MINA&name={name}");
        		
        		var value = new Expression("GENERAL.GPAMIN"), 
        			condition = (Expression.isValidParameter("STBEN.MED_MINA<GENERAL.GPAMIN")) ? new Expression("STBEN.MED_MINA<GENERAL.GPAMIN") : null, 
        			elseValue = (Expression.isValidParameter("STBEN.MED_MINA")) ? new Expression("STBEN.MED_MINA") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("''"), 
        			condition = (Expression.isValidParameter("EMPDE.MDCLEXPNS==0")) ? new Expression("EMPDE.MDCLEXPNS==0") : null, 
        			elseValue = (Expression.isValidParameter("GENERAL.GPAMIN")) ? new Expression("GENERAL.GPAMIN") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("STBEN", "MED_MINA");
        		}
        		//window.setProperty(field, "VE", "EMPDE.MDCLEXPNS==1", "V", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('STBEN', 'MED_MINA');
...
function onValidate_STBEN__TEMP_DAYS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STBEN", "TEMP_DAYS", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("STBEN", "TEMP_DAYS");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=STBEN&propertyName=TEMP_DAYS&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('STBEN', 'TEMP_DAYS');
...
function onValidate_EMPDE__HIVLIMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.HVACCEXP==1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.HVACCEXP==1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_EMPDE__HIVRATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EMPDE.HVACCEXP==1", "V", "{3}");
...
function onValidate_EMPDE__HIVAPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "EMPDE.HVACCEXP==1", "V", "{3}");
...
function onValidate_EMPDE__HSPTMEX(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.HSPTL==1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.HSPTL==1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_EMPDE__HSPPERIOD(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var exp = new Expression("EMPDE.HSPTL==1");
        		var errorMessage = "Please Enter Hospitalisation Period ";
        		var go = function(){
        			if (exp.getValue() == true){
...
function onValidate_EMPDE__HSPRATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EMPDE.HSPTL==1", "V", "{3}");
...
function onValidate_EMPDE__HSPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "EMPDE.HSPTL==1", "V", "{3}");
...
function onValidate_EMPDE__SRSTMEX(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.SRSILL==1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.SRSILL==1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_EMPDE__SRSRATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EMPDE.SRSILL==1", "V", "{3}");
...
function onValidate_EMPDE__SRSPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "EMPDE.SRSILL==1", "V", "{3}");
...
function onValidate_EMPDE__TTDTMEX(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EMPDE.TTDSCK==1", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "EMPDE.TTDSCK==1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_EMPDE__TTDRATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EMPDE.TTDSCK==1", "V", "{3}");
...
function onValidate_EMPDE__TTDPPREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "EMPDE.TTDSCK==1", "V", "{3}");
...
function onValidate_EMPDE__label310(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "label310", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EMPDE", "label310");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EMPDE&propertyName=label310&name={name}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('EMPDE', 'label310');
...
function onValidate_EMPDE__GPAENDS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "GPAENDS", "ChildScreen");
        })();
}
...
function onValidate_EMPDE__PASNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "PASNOTE", "ChildScreen");
        })();
}
function onValidate_EMPDE__GPA_NTS_CNT(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param EMPDE The Parent (Root) object name.
          * @param PASNOTES.DATE_CREATED The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "EMPDE".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "PASNOTES.DATE_CREATED";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_EMPDE__PANOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EMPDE", "PANOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("EMPDE", "PANOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_EMPDE__PANOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("EMPDE", "PANOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'EMPDE' and property 'PANOTE'.");
        			error.display();
...
function DoLogic(isOnLoad) {
    ...
    onValidate_STBEN__MED_FAP(null, null, null, isOnLoad);
    onValidate_STBEN__MED_MINA(null, null, null, isOnLoad);
    onValidate_STBEN__TEMP_DAYS(null, null, null, isOnLoad);
...
<div id="id469fe4e041554eccac6ede20f9468e5a" class="general-layout-container">
...
<div id="ide23f4b81c07f4dffae46d6a2c4decbf5" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading110" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide23f4b81c07f4dffae46d6a2c4decbf5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide23f4b81c07f4dffae46d6a2c4decbf5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide23f4b81c07f4dffae46d6a2c4decbf5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide23f4b81c07f4dffae46d6a2c4decbf5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide23f4b81c07f4dffae46d6a2c4decbf5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide23f4b81c07f4dffae46d6a2c4decbf5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide23f4b81c07f4dffae46d6a2c4decbf5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide23f4b81c07f4dffae46d6a2c4decbf5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide23f4b81c07f4dffae46d6a2c4decbf5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide23f4b81c07f4dffae46d6a2c4decbf5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2f3409305a054663a6873b80c1d14cf9" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading111" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2f3409305a054663a6873b80c1d14cf9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2f3409305a054663a6873b80c1d14cf9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2f3409305a054663a6873b80c1d14cf9 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2f3409305a054663a6873b80c1d14cf9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2f3409305a054663a6873b80c1d14cf9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2f3409305a054663a6873b80c1d14cf9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2f3409305a054663a6873b80c1d14cf9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2f3409305a054663a6873b80c1d14cf9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2f3409305a054663a6873b80c1d14cf9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2f3409305a054663a6873b80c1d14cf9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4101898ee24f4951b4b3df0e90201771" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading112" runat="server" Text="Employee Details" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4101898ee24f4951b4b3df0e90201771 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4101898ee24f4951b4b3df0e90201771 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4101898ee24f4951b4b3df0e90201771 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4101898ee24f4951b4b3df0e90201771 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4101898ee24f4951b4b3df0e90201771 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4101898ee24f4951b4b3df0e90201771 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4101898ee24f4951b4b3df0e90201771 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4101898ee24f4951b4b3df0e90201771 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4101898ee24f4951b4b3df0e90201771 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4101898ee24f4951b4b3df0e90201771 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="iddd2316a509ec495a936732e74d936841" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading113" runat="server" Text="Cover Details" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label235">
		<span class="label" id="label235">Sum Insured/Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label236">
		<span class="label" id="label236">No of Weeks</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label237">
		<span class="label" id="label237">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label238">
		<span class="label" id="label238">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label239">
		<span class="label" id="label239">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label240">
		<span class="label" id="label240">Death </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label241">
		<span class="label" id="label241"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label242">
		<span class="label" id="label242">Permanent Disability Total/Partial</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label244">
		<span class="label" id="label244">Temporary Disability: Total</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label245">
		<span class="label" id="label245">Temporary  Disability: Partial </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label246">
		<span class="label" id="label246">Medical Expenses </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label249">
		<span class="label" id="label249">Total </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#iddd2316a509ec495a936732e74d936841 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddd2316a509ec495a936732e74d936841 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddd2316a509ec495a936732e74d936841 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#iddd2316a509ec495a936732e74d936841 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddd2316a509ec495a936732e74d936841 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddd2316a509ec495a936732e74d936841 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddd2316a509ec495a936732e74d936841 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddd2316a509ec495a936732e74d936841 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddd2316a509ec495a936732e74d936841 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddd2316a509ec495a936732e74d936841 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id29f4d39d81514c97bd35cd5769d2deab" class="column-layout-container,no-border  ">
	...
	<span id="pb-container-label-label254">
		<span class="label" id="label254"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label256">
		<span class="label" id="label256">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label257">
		<span class="label" id="label257">Min Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label258">
		<span class="label" id="label258">Time Excess (days)</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label260">
		<span class="label" id="label260">Medical Expenses</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="STBEN" 
		data-property-name="MED_FAP" 
		id="pb-container-percentage-STBEN-MED_FAP">
		<asp:Label ID="lblSTBEN_MED_FAP" runat="server" AssociatedControlID="STBEN__MED_FAP" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="STBEN__MED_FAP" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSTBEN_MED_FAP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for STBEN.MED_FAP"
			ClientValidationFunction="onValidate_STBEN__MED_FAP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-STBEN-MED_MINA">
		<asp:Label ID="lblSTBEN_MED_MINA" runat="server" AssociatedControlID="STBEN__MED_MINA" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="STBEN__MED_MINA" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSTBEN_MED_MINA" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for STBEN.MED_MINA"
			ClientValidationFunction="onValidate_STBEN__MED_MINA" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label263">
		<span class="label" id="label263">Temporary Disability</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-STBEN-TEMP_DAYS">
		<asp:Label ID="lblSTBEN_TEMP_DAYS" runat="server" AssociatedControlID="STBEN__TEMP_DAYS" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="STBEN__TEMP_DAYS" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valSTBEN_TEMP_DAYS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for STBEN.TEMP_DAYS"
			ClientValidationFunction="onValidate_STBEN__TEMP_DAYS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id29f4d39d81514c97bd35cd5769d2deab div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id29f4d39d81514c97bd35cd5769d2deab div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id29f4d39d81514c97bd35cd5769d2deab div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id29f4d39d81514c97bd35cd5769d2deab label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id29f4d39d81514c97bd35cd5769d2deab label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id29f4d39d81514c97bd35cd5769d2deab label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id29f4d39d81514c97bd35cd5769d2deab label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id29f4d39d81514c97bd35cd5769d2deab input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id29f4d39d81514c97bd35cd5769d2deab input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id29f4d39d81514c97bd35cd5769d2deab input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ided9e49ff001b4f22b7cc19d7a051a3e8" class="column-layout-container,no-border  ">
	...
	<span id="pb-container-label-label266">
		<span class="label" id="label266"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label268">
		<span class="label" id="label268">Time Excess</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label269">
		<span class="label" id="label269">Hospitalisation Period</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label270">
		<span class="label" id="label270">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label271">
		<span class="label" id="label271">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label272">
		<span class="label" id="label272">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label273">
		<span class="label" id="label273">Posting Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label274">
		<span class="label" id="label274">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label275">
		<span class="label" id="label275">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label276">
		<span class="label" id="label276">HIV Accidental Exposure </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label278">
		<span class="label" id="label278"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label281">
		<span class="label" id="label281">Hospitalisation </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label284">
		<span class="label" id="label284">Serious Illness</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label286">
		<span class="label" id="label286">Temporary Total Disablement - Sickness </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label289">
		<span class="label" id="label289">Total</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label296">
		<span class="label" id="label296"></span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ided9e49ff001b4f22b7cc19d7a051a3e8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ided9e49ff001b4f22b7cc19d7a051a3e8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ided9e49ff001b4f22b7cc19d7a051a3e8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ided9e49ff001b4f22b7cc19d7a051a3e8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ided9e49ff001b4f22b7cc19d7a051a3e8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided9e49ff001b4f22b7cc19d7a051a3e8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided9e49ff001b4f22b7cc19d7a051a3e8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ided9e49ff001b4f22b7cc19d7a051a3e8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided9e49ff001b4f22b7cc19d7a051a3e8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided9e49ff001b4f22b7cc19d7a051a3e8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfde35c74228c466b92cbea09c1bdb9ff" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading116" runat="server" Text="Assistance Services" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label299">
		<span class="label" id="label299">No of Employees</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label300">
		<span class="label" id="label300">Premium per Person</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label301">
		<span class="label" id="label301">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label302">
		<span class="label" id="label302">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label303">
		<span class="label" id="label303">HIV/Aids Assistance</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label304">
		<span class="label" id="label304">Accidental Expert Assistance</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label305">
		<span class="label" id="label305"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label306">
		<span class="label" id="label306">Total</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label308">
		<span class="label" id="label308"></span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="EMPDE" 
		data-property-name="label310" 
		id="pb-container-currency-EMPDE-label310">
		<asp:Label ID="lblEMPDE_label310" runat="server" AssociatedControlID="EMPDE__label310" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EMPDE__label310" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEMPDE_label310" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EMPDE.label310"
			ClientValidationFunction="onValidate_EMPDE__label310" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idfde35c74228c466b92cbea09c1bdb9ff div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfde35c74228c466b92cbea09c1bdb9ff div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfde35c74228c466b92cbea09c1bdb9ff div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfde35c74228c466b92cbea09c1bdb9ff label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfde35c74228c466b92cbea09c1bdb9ff label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfde35c74228c466b92cbea09c1bdb9ff label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfde35c74228c466b92cbea09c1bdb9ff label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfde35c74228c466b92cbea09c1bdb9ff input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfde35c74228c466b92cbea09c1bdb9ff input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfde35c74228c466b92cbea09c1bdb9ff input{text-align:left;}"; break;
		}
	}
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EMPDE__GPAENDS"
		data-field-type="Child" 
		data-object-name="EMPDE" 
		data-property-name="GPAENDS" 
		id="pb-container-childscreen-EMPDE-GPAENDS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EMPDE__GPA_ENDOSE" runat="server" ScreenCode="GPAENDS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GPAENDS/GPAENDS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valEMPDE_GPAENDS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for EMPDE.GPAENDS"
						ClientValidationFunction="onValidate_EMPDE__GPAENDS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb7e60752425843c88348afd08b4ec209" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EMPDE__PASNOTE"
		data-field-type="Child" 
		data-object-name="EMPDE" 
		data-property-name="PASNOTE" 
		id="pb-container-childscreen-EMPDE-PASNOTE">
		
		    <legend>Notes (Printed On Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EMPDE__PANOTES" runat="server" ScreenCode="PASNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PASNOTE/PASNOTE_Notes_Detials.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEMPDE_PASNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Printed On Schedule)"
						ClientValidationFunction="onValidate_EMPDE__PASNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb7e60752425843c88348afd08b4ec209 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb7e60752425843c88348afd08b4ec209 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb7e60752425843c88348afd08b4ec209 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb7e60752425843c88348afd08b4ec209 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb7e60752425843c88348afd08b4ec209 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb7e60752425843c88348afd08b4ec209 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb7e60752425843c88348afd08b4ec209 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb7e60752425843c88348afd08b4ec209 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb7e60752425843c88348afd08b4ec209 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb7e60752425843c88348afd08b4ec209 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="iddfec6d6bd6e94be691c3778332496758" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EMPDE__PANOTE"
		data-field-type="Child" 
		data-object-name="EMPDE" 
		data-property-name="PANOTE" 
		id="pb-container-childscreen-EMPDE-PANOTE">
		
		    <legend>Notes (Not Printed On Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EMPDE__PASNOTES" runat="server" ScreenCode="PANOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PANOTE/PANOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEMPDE_PANOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Not Printed On Schedule)"
						ClientValidationFunction="onValidate_EMPDE__PANOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#iddfec6d6bd6e94be691c3778332496758 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddfec6d6bd6e94be691c3778332496758 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddfec6d6bd6e94be691c3778332496758 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#iddfec6d6bd6e94be691c3778332496758 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddfec6d6bd6e94be691c3778332496758 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddfec6d6bd6e94be691c3778332496758 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddfec6d6bd6e94be691c3778332496758 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddfec6d6bd6e94be691c3778332496758 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddfec6d6bd6e94be691c3778332496758 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddfec6d6bd6e94be691c3778332496758 input{text-align:left;}"; break;
		}
	}
