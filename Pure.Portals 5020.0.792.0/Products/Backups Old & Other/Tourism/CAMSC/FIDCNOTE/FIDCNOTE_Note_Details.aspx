<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FIDCNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_FIDCNOTE_Note_Details" %>
...
function onValidate_FIDCNOTE__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDCNOTE", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDCNOTE", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDCNOTE.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "FIDCNOTE", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=FIDCNOTE&propertyName=DATE_CREATED&name={name}");
...
function onValidate_FIDCNOTE__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDCNOTE", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDCNOTE", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDCNOTE.CREATED_BY");
        			window.setControlWidth(field, "0.5", "FIDCNOTE", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_FIDCNOTE__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDCNOTE", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FIDCNOTE", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDCNOTE.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "FIDCNOTE", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=FIDCNOTE&propertyName=COVER_TYPE&name={name}");
...
function onValidate_FIDCNOTE__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDCNOTE", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIDCNOTE", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDCNOTE.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "FIDCNOTE", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIDCNOTE", "NOTE_DESCRIPTION");
        		var exp = new Expression("FIDCNOTE.NoteCheck = 1");
...
function onValidate_FIDCNOTE__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDCNOTE", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("FIDCNOTE", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FIDCNOTE.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "FIDCNOTE", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=FIDCNOTE&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_FIDCNOTE__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_FIDCNOTE_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_FIDCNOTE__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FIDCNOTE", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FIDCNOTE", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_FIDCNOTE__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_FIDCNOTE__CREATED_BY(null, null, null, isOnLoad);
    onValidate_FIDCNOTE__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_FIDCNOTE__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_FIDCNOTE__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_FIDCNOTE__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="idf8eb96dc0a9f4e5eb6364bfa8ae0bdc3" class="general-layout-container">
...
<div id="ideb50c591b65e46f997d4b39ea577ee88" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading144" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FIDCNOTE" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-FIDCNOTE-DATE_CREATED">
		<asp:Label ID="lblFIDCNOTE_DATE_CREATED" runat="server" AssociatedControlID="FIDCNOTE__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="FIDCNOTE__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calFIDCNOTE__DATE_CREATED" runat="server" LinkedControl="FIDCNOTE__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valFIDCNOTE_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_FIDCNOTE__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDCNOTE-CREATED_BY">

		
		<asp:Label ID="lblFIDCNOTE_CREATED_BY" runat="server" AssociatedControlID="FIDCNOTE__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDCNOTE__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDCNOTE_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_FIDCNOTE__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDCNOTE-COVER_TYPE">

		
		<asp:Label ID="lblFIDCNOTE_COVER_TYPE" runat="server" AssociatedControlID="FIDCNOTE__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDCNOTE__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDCNOTE_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_FIDCNOTE__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FIDCNOTE-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblFIDCNOTE_NOTE_DESCRIPTION" runat="server" AssociatedControlID="FIDCNOTE__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FIDCNOTE__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFIDCNOTE_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_FIDCNOTE__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-FIDCNOTE-NOTE_DETAILS">
		<asp:Label ID="lblFIDCNOTE_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="FIDCNOTE__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="FIDCNOTE__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valFIDCNOTE_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_FIDCNOTE__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblFIDCNOTE_NoteCheck" for="ctl00_cntMainBody_FIDCNOTE__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-FIDCNOTE-NoteCheck">	
		
		<asp:TextBox ID="FIDCNOTE__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valFIDCNOTE_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_FIDCNOTE__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ideb50c591b65e46f997d4b39ea577ee88 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ideb50c591b65e46f997d4b39ea577ee88 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ideb50c591b65e46f997d4b39ea577ee88 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ideb50c591b65e46f997d4b39ea577ee88 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ideb50c591b65e46f997d4b39ea577ee88 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ideb50c591b65e46f997d4b39ea577ee88 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ideb50c591b65e46f997d4b39ea577ee88 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ideb50c591b65e46f997d4b39ea577ee88 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ideb50c591b65e46f997d4b39ea577ee88 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ideb50c591b65e46f997d4b39ea577ee88 input{text-align:left;}"; break;
		}
	}
