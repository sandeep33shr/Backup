<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAMSC_Machinery_Breakdown.aspx.vb" Inherits="Nexus.PB2_CAMSC_Machinery_Breakdown" %>
...
function onValidate_MBREAK__MBOTHEXS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBOTHEXS", "ChildScreen");
        })();
}
...
function onValidate_MBREAK__MB_FAP_(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MB_FAP_", "ChildScreen");
        })();
}
...
function onValidate_MBREAK__MBEDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBEDPRM", "ChildScreen");
        })();
}
...
function onValidate_MBREAK__MBNTS_(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBNTS_", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MBREAK", "MBNTS_");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_MBREAK__MBNTS_ table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MBREAK", "MBNTS_");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MBREAK' and property 'MBNTS_'.");
        			error.display();
...
function onValidate_MBREAK__MBSNTS_(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBSNTS_", "ChildScreen");
        })();
}
...
<div id="id6361abe76e5c4d07abaf00af6ef4bca4" class="general-layout-container">
...
<div id="id01f7cfa505854f829496b66f31534e64" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading221" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id01f7cfa505854f829496b66f31534e64 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id01f7cfa505854f829496b66f31534e64 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id01f7cfa505854f829496b66f31534e64 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id01f7cfa505854f829496b66f31534e64 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id01f7cfa505854f829496b66f31534e64 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id01f7cfa505854f829496b66f31534e64 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id01f7cfa505854f829496b66f31534e64 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id01f7cfa505854f829496b66f31534e64 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id01f7cfa505854f829496b66f31534e64 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id01f7cfa505854f829496b66f31534e64 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4d17c4f152744f42bf46d50d5e6c27e2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading222" runat="server" Text="Machinery Breakdown" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4d17c4f152744f42bf46d50d5e6c27e2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4d17c4f152744f42bf46d50d5e6c27e2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4d17c4f152744f42bf46d50d5e6c27e2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4d17c4f152744f42bf46d50d5e6c27e2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4d17c4f152744f42bf46d50d5e6c27e2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4d17c4f152744f42bf46d50d5e6c27e2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4d17c4f152744f42bf46d50d5e6c27e2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4d17c4f152744f42bf46d50d5e6c27e2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4d17c4f152744f42bf46d50d5e6c27e2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4d17c4f152744f42bf46d50d5e6c27e2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4bf270ae4c52429698499eb8bb093bef" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading223" runat="server" Text="" /></legend>
		    ...
		    <legend></legend>
			        ...
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_ITEM" runat="server" ScreenCode="MBITMS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMS/MBITMS_Machinery_Breakdown.aspx" emptydatatext="sac">
							<columns>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4bf270ae4c52429698499eb8bb093bef div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4bf270ae4c52429698499eb8bb093bef div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4bf270ae4c52429698499eb8bb093bef div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4bf270ae4c52429698499eb8bb093bef label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4bf270ae4c52429698499eb8bb093bef label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4bf270ae4c52429698499eb8bb093bef label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4bf270ae4c52429698499eb8bb093bef label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4bf270ae4c52429698499eb8bb093bef input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4bf270ae4c52429698499eb8bb093bef input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4bf270ae4c52429698499eb8bb093bef input{text-align:left;}"; break;
		}
	}
...
<div id="frmMBE" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading224" runat="server" Text="Extensions" /></legend>
	...
	<span id="pb-container-label-label529">
		<span class="label" id="label529"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label531">
		<span class="label" id="label531">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label532">
		<span class="label" id="label532">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label533">
		<span class="label" id="label533">Posting Premium </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label534">
		<span class="label" id="label534">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label535">
		<span class="label" id="label535">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label536">
		<span class="label" id="label536">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label539">
		<span class="label" id="label539">Riot and Strike </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label540">
		<span class="label" id="label540"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label541">
		<span class="label" id="label541"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label543">
		<span class="label" id="label543">Total</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label544">
		<span class="label" id="label544"></span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label546">
		<span class="label" id="label546"></span>
	</span>
<!-- /Label -->
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBOTHEXS"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBOTHEXS" 
		id="pb-container-childscreen-MBREAK-MBOTHEXS">
		
		    <legend>Other Machinery Breakdown Extensions</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_OEXTENSIONS" runat="server" ScreenCode="MBOTHEXS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBOTHEXS/MBOTHEXS_Other_Machinery_Breakdown_Extensions.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MBOTHEXS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Other Machinery Breakdown Extensions"
						ClientValidationFunction="onValidate_MBREAK__MBOTHEXS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id55c94a589f6f44278833b8afaefde824" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MB_FAP_"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MB_FAP_" 
		id="pb-container-childscreen-MBREAK-MB_FAP_">
		
		    <legend>First Amount Payable </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_FAP_" runat="server" ScreenCode="MB_FAP_" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MB_FAP_/MB_FAP__First_Amount_Payable.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="FAPCHILD_MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MB_FAP_" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for First Amount Payable "
						ClientValidationFunction="onValidate_MBREAK__MB_FAP_" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id55c94a589f6f44278833b8afaefde824 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id55c94a589f6f44278833b8afaefde824 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id55c94a589f6f44278833b8afaefde824 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id55c94a589f6f44278833b8afaefde824 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id55c94a589f6f44278833b8afaefde824 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id55c94a589f6f44278833b8afaefde824 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id55c94a589f6f44278833b8afaefde824 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id55c94a589f6f44278833b8afaefde824 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id55c94a589f6f44278833b8afaefde824 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id55c94a589f6f44278833b8afaefde824 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7ae8ec17e2e34c529038cbd505e4d457" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading227" runat="server" Text="Endorsements" /></legend>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBEDPRM"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBEDPRM" 
		id="pb-container-childscreen-MBREAK-MBEDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_CLAUSEPREM" runat="server" ScreenCode="MBEDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBEDPRM/MBEDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MBEDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBEDPRM"
						ClientValidationFunction="onValidate_MBREAK__MBEDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7ae8ec17e2e34c529038cbd505e4d457 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7ae8ec17e2e34c529038cbd505e4d457 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7ae8ec17e2e34c529038cbd505e4d457 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7ae8ec17e2e34c529038cbd505e4d457 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7ae8ec17e2e34c529038cbd505e4d457 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7ae8ec17e2e34c529038cbd505e4d457 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7ae8ec17e2e34c529038cbd505e4d457 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7ae8ec17e2e34c529038cbd505e4d457 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7ae8ec17e2e34c529038cbd505e4d457 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7ae8ec17e2e34c529038cbd505e4d457 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id27718bb1fb9e4974bb47aa2f71b2a066" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading228" runat="server" Text="Machinery Breakdown Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBNTS_"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBNTS_" 
		id="pb-container-childscreen-MBREAK-MBNTS_">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_NOTES" runat="server" ScreenCode="MBNTS_" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBNTS_/MBNTS__Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_MBNTS_" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBNTS_"
						ClientValidationFunction="onValidate_MBREAK__MBNTS_" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id27718bb1fb9e4974bb47aa2f71b2a066 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id27718bb1fb9e4974bb47aa2f71b2a066 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id27718bb1fb9e4974bb47aa2f71b2a066 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id27718bb1fb9e4974bb47aa2f71b2a066 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id27718bb1fb9e4974bb47aa2f71b2a066 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27718bb1fb9e4974bb47aa2f71b2a066 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27718bb1fb9e4974bb47aa2f71b2a066 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id27718bb1fb9e4974bb47aa2f71b2a066 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27718bb1fb9e4974bb47aa2f71b2a066 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27718bb1fb9e4974bb47aa2f71b2a066 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id14bffbbabd1f4a3bb20f07b5d58045cc" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading229" runat="server" Text="Machinery Breakdown Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBSNTS_"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBSNTS_" 
		id="pb-container-childscreen-MBREAK-MBSNTS_">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_SNOTES" runat="server" ScreenCode="MBSNTS_" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBSNTS_/MBSNTS__Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_MBSNTS_" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBSNTS_"
						ClientValidationFunction="onValidate_MBREAK__MBSNTS_" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id14bffbbabd1f4a3bb20f07b5d58045cc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id14bffbbabd1f4a3bb20f07b5d58045cc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id14bffbbabd1f4a3bb20f07b5d58045cc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id14bffbbabd1f4a3bb20f07b5d58045cc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id14bffbbabd1f4a3bb20f07b5d58045cc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id14bffbbabd1f4a3bb20f07b5d58045cc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id14bffbbabd1f4a3bb20f07b5d58045cc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id14bffbbabd1f4a3bb20f07b5d58045cc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id14bffbbabd1f4a3bb20f07b5d58045cc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id14bffbbabd1f4a3bb20f07b5d58045cc input{text-align:left;}"; break;
		}
	}
