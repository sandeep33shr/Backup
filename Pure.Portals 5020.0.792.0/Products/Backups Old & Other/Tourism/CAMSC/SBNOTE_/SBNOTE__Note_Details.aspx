...
<div id="id9bcd7ceda9ff40399c2bd9e1ecb78db2" class="general-layout-container">
...
<div id="id871aca9b76a24073ae03f866f8f9edec" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading123" runat="server" Text="Notes (Not Printed On Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id871aca9b76a24073ae03f866f8f9edec div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id871aca9b76a24073ae03f866f8f9edec div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id871aca9b76a24073ae03f866f8f9edec div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id871aca9b76a24073ae03f866f8f9edec label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id871aca9b76a24073ae03f866f8f9edec label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id871aca9b76a24073ae03f866f8f9edec label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id871aca9b76a24073ae03f866f8f9edec label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id871aca9b76a24073ae03f866f8f9edec input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id871aca9b76a24073ae03f866f8f9edec input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id871aca9b76a24073ae03f866f8f9edec input{text-align:left;}"; break;
		}
	}
