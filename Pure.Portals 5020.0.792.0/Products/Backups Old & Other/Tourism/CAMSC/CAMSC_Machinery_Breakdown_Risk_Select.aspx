<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAMSC_Machinery_Breakdown_Risk_Select.aspx.vb" Inherits="Nexus.PB2_CAMSC_Machinery_Breakdown_Risk_Select" %>
...
<div id="idfade7dc7057544fcb464b344c86286ee" class="general-layout-container">
...
<div id="idcd9e374f3af34b52a381fb4c4b95fe29" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading198" runat="server" Text="Options" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idcd9e374f3af34b52a381fb4c4b95fe29 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcd9e374f3af34b52a381fb4c4b95fe29 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcd9e374f3af34b52a381fb4c4b95fe29 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idcd9e374f3af34b52a381fb4c4b95fe29 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcd9e374f3af34b52a381fb4c4b95fe29 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcd9e374f3af34b52a381fb4c4b95fe29 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcd9e374f3af34b52a381fb4c4b95fe29 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcd9e374f3af34b52a381fb4c4b95fe29 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcd9e374f3af34b52a381fb4c4b95fe29 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcd9e374f3af34b52a381fb4c4b95fe29 input{text-align:left;}"; break;
		}
	}
