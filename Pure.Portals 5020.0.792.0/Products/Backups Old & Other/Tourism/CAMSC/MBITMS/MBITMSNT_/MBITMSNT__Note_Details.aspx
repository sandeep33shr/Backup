<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBITMSNT__Note_Details.aspx.vb" Inherits="Nexus.PB2_MBITMSNT__Note_Details" %>
...
function onValidate_MBITMS_SCNOTE__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITMS_SCNOTE", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MBITMS_SCNOTE", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITMS_SCNOTE.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "MBITMS_SCNOTE", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITMS_SCNOTE_DATE_CREATED");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITMS_SCNOTE__DATE_CREATED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITMS_SCNOTE__DATE_CREATED_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=MBITMS_SCNOTE&propertyName=DATE_CREATED&name={name}");
...
function onValidate_MBITMS_SCNOTE__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITMS_SCNOTE", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MBITMS_SCNOTE", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITMS_SCNOTE.CREATED_BY");
        			window.setControlWidth(field, "0.5", "MBITMS_SCNOTE", "CREATED_BY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITMS_SCNOTE_CREATED_BY");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITMS_SCNOTE__CREATED_BY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITMS_SCNOTE__CREATED_BY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MBITMS_SCNOTE__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITMS_SCNOTE", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MBITMS_SCNOTE", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITMS_SCNOTE.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "MBITMS_SCNOTE", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITMS_SCNOTE_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITMS_SCNOTE__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITMS_SCNOTE__COVER_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MBITMS_SCNOTE&propertyName=COVER_TYPE&name={name}");
...
function onValidate_MBITMS_SCNOTE__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITMS_SCNOTE", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MBITMS_SCNOTE", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITMS_SCNOTE.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "MBITMS_SCNOTE", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITMS_SCNOTE_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITMS_SCNOTE__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITMS_SCNOTE__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MBITMS_SCNOTE__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITMS_SCNOTE", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MBITMS_SCNOTE", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITMS_SCNOTE.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "MBITMS_SCNOTE", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITMS_SCNOTE_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITMS_SCNOTE__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITMS_SCNOTE__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=MBITMS_SCNOTE&propertyName=NOTE_DETAILS&name={name}");
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_MBITMS_SCNOTE_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_MBITMS_SCNOTE__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_MBITMS_SCNOTE__CREATED_BY(null, null, null, isOnLoad);
    onValidate_MBITMS_SCNOTE__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_MBITMS_SCNOTE__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_MBITMS_SCNOTE__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="idb5e75ad2a575434eb6e22f71b5892340" class="general-layout-container">
...
<div id="id4fe2d8e231594f7596e6e9323dcb24f4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading204" runat="server" Text="Note Details (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MBITMS_SCNOTE" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-MBITMS_SCNOTE-DATE_CREATED">
		<asp:Label ID="lblMBITMS_SCNOTE_DATE_CREATED" runat="server" AssociatedControlID="MBITMS_SCNOTE__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="MBITMS_SCNOTE__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calMBITMS_SCNOTE__DATE_CREATED" runat="server" LinkedControl="MBITMS_SCNOTE__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valMBITMS_SCNOTE_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_MBITMS_SCNOTE__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MBITMS_SCNOTE-CREATED_BY">

		
		<asp:Label ID="lblMBITMS_SCNOTE_CREATED_BY" runat="server" AssociatedControlID="MBITMS_SCNOTE__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MBITMS_SCNOTE__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMBITMS_SCNOTE_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_MBITMS_SCNOTE__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MBITMS_SCNOTE-COVER_TYPE">

		
		<asp:Label ID="lblMBITMS_SCNOTE_COVER_TYPE" runat="server" AssociatedControlID="MBITMS_SCNOTE__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MBITMS_SCNOTE__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMBITMS_SCNOTE_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_MBITMS_SCNOTE__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MBITMS_SCNOTE-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblMBITMS_SCNOTE_NOTE_DESCRIPTION" runat="server" AssociatedControlID="MBITMS_SCNOTE__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MBITMS_SCNOTE__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMBITMS_SCNOTE_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_MBITMS_SCNOTE__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-MBITMS_SCNOTE-NOTE_DETAILS">
		<asp:Label ID="lblMBITMS_SCNOTE_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="MBITMS_SCNOTE__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="MBITMS_SCNOTE__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valMBITMS_SCNOTE_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_MBITMS_SCNOTE__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4fe2d8e231594f7596e6e9323dcb24f4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4fe2d8e231594f7596e6e9323dcb24f4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4fe2d8e231594f7596e6e9323dcb24f4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4fe2d8e231594f7596e6e9323dcb24f4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4fe2d8e231594f7596e6e9323dcb24f4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4fe2d8e231594f7596e6e9323dcb24f4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4fe2d8e231594f7596e6e9323dcb24f4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4fe2d8e231594f7596e6e9323dcb24f4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4fe2d8e231594f7596e6e9323dcb24f4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4fe2d8e231594f7596e6e9323dcb24f4 input{text-align:left;}"; break;
		}
	}
