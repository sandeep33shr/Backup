<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBITMS_Machinery_Breakdown.aspx.vb" Inherits="Nexus.PB2_MBITMS_Machinery_Breakdown" %>
...
function onValidate_MB_ITEM__CATEG(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "CATEG", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function onValidate_MB_ITEM__SUB_CATEG(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "SUB_CATEG", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function onValidate_MB_ITEM__MINAMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Machine Breakdown Minimum amount cannot be more than maximum amount")) ? "Machine Breakdown Minimum amount cannot be more than maximum amount" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_MB_ITEM__MAXAMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Machine Breakdown Maximum value cannot be less than minimum amount")) ? "Machine Breakdown Maximum value cannot be less than minimum amount" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_MB_ITEM__TOT_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @param MBITMS_CLAUSEPREM.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var childFieldStr = "MBITMS_CLAUSEPREM.PREMIUM";
...
function onValidate_MB_ITEM__MBITMP_(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMP_", "ChildScreen");
        })();
}
function onValidate_MB_ITEM__MBI_END_COUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param MB_ITEM The Parent (Root) object name.
          * @param MBITMS_CLAUSEPREM.COUNTER_ID The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MB_ITEM".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MBITMS_CLAUSEPREM.COUNTER_ID";
        		//count, average, total, min, max
...
function onValidate_MB_ITEM__MBITMNT_(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMNT_", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MB_ITEM", "MBITMNT_");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_MB_ITEM__MBITMNT_ table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MB_ITEM", "MBITMNT_");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MB_ITEM' and property 'MBITMNT_'.");
        			error.display();
...
function onValidate_MB_ITEM__MBITMSNT_(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMSNT_", "ChildScreen");
        })();
}
function onValidate_MB_ITEM__MBI_NTS_CNT(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param MB_ITEM The Parent (Root) object name.
          * @param MBITMS_SCNOTE.DATE_CREATED The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MB_ITEM".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MBITMS_SCNOTE.DATE_CREATED";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MB_ITEM__MBITMP_(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBI_END_COUNT(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBITMNT_(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBITMSNT_(null, null, null, isOnLoad);
...
<div id="id6e78f1c769d24768a9a7a088856cd524" class="general-layout-container">
...
<div id="id93374c5a0f6e4922a0127ec72d51c492" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading206" runat="server" Text="" /></legend>
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblMB_ITEM_COUNTER_ID" runat="server" AssociatedControlID="MB_ITEM__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_ITEM__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_ITEM-CATEG">
		...
		<asp:Label ID="lblMB_ITEM_CATEG" runat="server" AssociatedControlID="MB_ITEM__CATEG" 
			Text="Category" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_ITEM__CATEG" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_ITEM-SUB_CATEG">
		...
		<asp:Label ID="lblMB_ITEM_SUB_CATEG" runat="server" AssociatedControlID="MB_ITEM__SUB_CATEG" 
			Text="Sub-Category" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_ITEM__SUB_CATEG" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_ITEM-AGECode">
				...
				<asp:HiddenField ID="MB_ITEM__AGECode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_ITEM-BASEDEDUCTCode">
				...
				<asp:HiddenField ID="MB_ITEM__BASEDEDUCTCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id93374c5a0f6e4922a0127ec72d51c492 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id93374c5a0f6e4922a0127ec72d51c492 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id93374c5a0f6e4922a0127ec72d51c492 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id93374c5a0f6e4922a0127ec72d51c492 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id93374c5a0f6e4922a0127ec72d51c492 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id93374c5a0f6e4922a0127ec72d51c492 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id93374c5a0f6e4922a0127ec72d51c492 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id93374c5a0f6e4922a0127ec72d51c492 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id93374c5a0f6e4922a0127ec72d51c492 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id93374c5a0f6e4922a0127ec72d51c492 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2011f2c2f121481a8736d8cd0d35e63e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading207" runat="server" Text="Endorsements" /></legend>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMP_"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMP_" 
		id="pb-container-childscreen-MB_ITEM-MBITMP_">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITMS_CLAUSEPREM" runat="server" ScreenCode="MBITMP_" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMP_/MBITMP__Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMP_" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMP_"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMP_" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2011f2c2f121481a8736d8cd0d35e63e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2011f2c2f121481a8736d8cd0d35e63e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2011f2c2f121481a8736d8cd0d35e63e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2011f2c2f121481a8736d8cd0d35e63e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2011f2c2f121481a8736d8cd0d35e63e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2011f2c2f121481a8736d8cd0d35e63e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2011f2c2f121481a8736d8cd0d35e63e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2011f2c2f121481a8736d8cd0d35e63e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2011f2c2f121481a8736d8cd0d35e63e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2011f2c2f121481a8736d8cd0d35e63e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc426a114093e4d57aabfcf8d0e69f2df" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading208" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMNT_"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMNT_" 
		id="pb-container-childscreen-MB_ITEM-MBITMNT_">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITMS_CNOTE" runat="server" ScreenCode="MBITMNT_" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMNT_/MBITMNT__Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMNT_" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMNT_"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMNT_" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc426a114093e4d57aabfcf8d0e69f2df div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc426a114093e4d57aabfcf8d0e69f2df div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc426a114093e4d57aabfcf8d0e69f2df div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc426a114093e4d57aabfcf8d0e69f2df label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc426a114093e4d57aabfcf8d0e69f2df label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc426a114093e4d57aabfcf8d0e69f2df label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc426a114093e4d57aabfcf8d0e69f2df label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc426a114093e4d57aabfcf8d0e69f2df input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc426a114093e4d57aabfcf8d0e69f2df input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc426a114093e4d57aabfcf8d0e69f2df input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4102e84f8dc54c43aa2128c5c3412a89" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading209" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMSNT_"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMSNT_" 
		id="pb-container-childscreen-MB_ITEM-MBITMSNT_">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITMS_SCNOTE" runat="server" ScreenCode="MBITMSNT_" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMSNT_/MBITMSNT__Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMSNT_" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMSNT_"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMSNT_" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4102e84f8dc54c43aa2128c5c3412a89 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4102e84f8dc54c43aa2128c5c3412a89 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4102e84f8dc54c43aa2128c5c3412a89 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4102e84f8dc54c43aa2128c5c3412a89 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4102e84f8dc54c43aa2128c5c3412a89 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4102e84f8dc54c43aa2128c5c3412a89 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4102e84f8dc54c43aa2128c5c3412a89 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4102e84f8dc54c43aa2128c5c3412a89 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4102e84f8dc54c43aa2128c5c3412a89 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4102e84f8dc54c43aa2128c5c3412a89 input{text-align:left;}"; break;
		}
	}
