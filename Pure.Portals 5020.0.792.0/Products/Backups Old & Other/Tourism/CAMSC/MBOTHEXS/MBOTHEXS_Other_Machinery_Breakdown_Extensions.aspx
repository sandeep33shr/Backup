<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBOTHEXS_Other_Machinery_Breakdown_Extensions.aspx.vb" Inherits="Nexus.PB2_MBOTHEXS_Other_Machinery_Breakdown_Extensions" %>
...
function onValidate_MB_OEXTENSIONS__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_OEXTENSIONS", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MB_OEXTENSIONS", "COUNTER_ID");
        		}
...
function onValidate_MB_OEXTENSIONS__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_OEXTENSIONS", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_OEXTENSIONS", "DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_OEXTENSIONS.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "MB_OEXTENSIONS", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_OEXTENSIONS_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_OEXTENSIONS__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_OEXTENSIONS__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_MB_OEXTENSIONS__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_OEXTENSIONS", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_OEXTENSIONS", "SUMINSURED");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_OEXTENSIONS.SUMINSURED");
        			window.setControlWidth(field, "0.8", "MB_OEXTENSIONS", "SUMINSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_OEXTENSIONS_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_OEXTENSIONS__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_OEXTENSIONS__SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("MB_OEXTENSIONS.POST_PREMIUM.setValue('')");
...
function onValidate_MB_OEXTENSIONS__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_OEXTENSIONS", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_OEXTENSIONS", "RATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_OEXTENSIONS.RATE");
        			window.setControlWidth(field, "0.8", "MB_OEXTENSIONS", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_OEXTENSIONS_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_OEXTENSIONS__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_OEXTENSIONS__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "MB_OEXTENSIONS".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "MB_OEXTENSIONS".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("MB_OEXTENSIONS.RATE > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=MB_OEXTENSIONS&propertyName=RATE&name={name}");
        		
        		var value = new Expression("MB_OEXTENSIONS.POST_PREMIUM / MB_OEXTENSIONS.SUMINSURED * 100"), 
        			condition = (Expression.isValidParameter("MB_OEXTENSIONS.POST_PREMIUM > 0")) ? new Expression("MB_OEXTENSIONS.POST_PREMIUM > 0") : null, 
...
function onValidate_MB_OEXTENSIONS__POST_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_OEXTENSIONS", "POST_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_OEXTENSIONS", "POST_PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_OEXTENSIONS.POST_PREMIUM");
        			window.setControlWidth(field, "0.8", "MB_OEXTENSIONS", "POST_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_OEXTENSIONS_POST_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_OEXTENSIONS__POST_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_OEXTENSIONS__POST_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MB_OEXTENSIONS&propertyName=POST_PREMIUM&name={name}");
        		
        		var value = new Expression("MB_OEXTENSIONS.SUMINSURED * MB_OEXTENSIONS.RATE / 100"), 
...
function onValidate_MB_OEXTENSIONS__FAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_OEXTENSIONS", "FAP", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_OEXTENSIONS", "FAP");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_OEXTENSIONS.FAP");
        			window.setControlWidth(field, "0.8", "MB_OEXTENSIONS", "FAP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_OEXTENSIONS_FAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_OEXTENSIONS__FAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_OEXTENSIONS__FAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Machinery breakdown FAP value cannot be more than 100%")) ? "Machinery breakdown FAP value cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "MB_OEXTENSIONS".toUpperCase() + "__" + "FAP");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "MB_OEXTENSIONS".toUpperCase() + "_" + "FAP");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("MB_OEXTENSIONS.FAP > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_MB_OEXTENSIONS__MIN_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_OEXTENSIONS", "MIN_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_OEXTENSIONS", "MIN_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_OEXTENSIONS.MIN_AMOUNT");
        			window.setControlWidth(field, "0.8", "MB_OEXTENSIONS", "MIN_AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_OEXTENSIONS_MIN_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_OEXTENSIONS__MIN_AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_OEXTENSIONS__MIN_AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_MB_OEXTENSIONS__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_MB_OEXTENSIONS__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_MB_OEXTENSIONS__SUMINSURED(null, null, null, isOnLoad);
    onValidate_MB_OEXTENSIONS__RATE(null, null, null, isOnLoad);
    onValidate_MB_OEXTENSIONS__POST_PREMIUM(null, null, null, isOnLoad);
    onValidate_MB_OEXTENSIONS__FAP(null, null, null, isOnLoad);
    onValidate_MB_OEXTENSIONS__MIN_AMOUNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id520e75e495d64cf7b85f58270cf415c3" class="general-layout-container">
...
<div id="frmMBE" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading211" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MB_OEXTENSIONS" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-MB_OEXTENSIONS-COUNTER_ID">

		
		<asp:Label ID="lblMB_OEXTENSIONS_COUNTER_ID" runat="server" AssociatedControlID="MB_OEXTENSIONS__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_OEXTENSIONS__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMB_OEXTENSIONS_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_MB_OEXTENSIONS__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_OEXTENSIONS-DESCRIPTION">

		
		<asp:Label ID="lblMB_OEXTENSIONS_DESCRIPTION" runat="server" AssociatedControlID="MB_OEXTENSIONS__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_OEXTENSIONS__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMB_OEXTENSIONS_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_MB_OEXTENSIONS__DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MB_OEXTENSIONS-SUMINSURED">
		<asp:Label ID="lblMB_OEXTENSIONS_SUMINSURED" runat="server" AssociatedControlID="MB_OEXTENSIONS__SUMINSURED" 
			Text="Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_OEXTENSIONS__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMB_OEXTENSIONS_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indemnity"
			ClientValidationFunction="onValidate_MB_OEXTENSIONS__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-MB_OEXTENSIONS-RATE">
		<asp:Label ID="lblMB_OEXTENSIONS_RATE" runat="server" AssociatedControlID="MB_OEXTENSIONS__RATE" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MB_OEXTENSIONS__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMB_OEXTENSIONS_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_MB_OEXTENSIONS__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MB_OEXTENSIONS-POST_PREMIUM">
		<asp:Label ID="lblMB_OEXTENSIONS_POST_PREMIUM" runat="server" AssociatedControlID="MB_OEXTENSIONS__POST_PREMIUM" 
			Text="Posting Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_OEXTENSIONS__POST_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMB_OEXTENSIONS_POST_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Posting Premium"
			ClientValidationFunction="onValidate_MB_OEXTENSIONS__POST_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-MB_OEXTENSIONS-FAP">
		<asp:Label ID="lblMB_OEXTENSIONS_FAP" runat="server" AssociatedControlID="MB_OEXTENSIONS__FAP" 
			Text="FAP %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MB_OEXTENSIONS__FAP" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMB_OEXTENSIONS_FAP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP %"
			ClientValidationFunction="onValidate_MB_OEXTENSIONS__FAP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MB_OEXTENSIONS-MIN_AMOUNT">
		<asp:Label ID="lblMB_OEXTENSIONS_MIN_AMOUNT" runat="server" AssociatedControlID="MB_OEXTENSIONS__MIN_AMOUNT" 
			Text="Min Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MB_OEXTENSIONS__MIN_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMB_OEXTENSIONS_MIN_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Min Amount"
			ClientValidationFunction="onValidate_MB_OEXTENSIONS__MIN_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
