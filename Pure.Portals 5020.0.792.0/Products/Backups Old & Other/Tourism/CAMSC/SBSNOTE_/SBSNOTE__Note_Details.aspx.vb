...
Namespace Nexus
    Partial Class PB2_SBSNOTE__Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_STATED_SCNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If STATED_SCNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		STATED_SCNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		STATED_SCNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_STATED_SCNOTE_DETAILS__NOTE_DETAILS()
End Sub
