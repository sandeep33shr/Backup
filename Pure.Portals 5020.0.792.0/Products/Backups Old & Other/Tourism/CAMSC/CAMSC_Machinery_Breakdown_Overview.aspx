<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAMSC_Machinery_Breakdown_Overview.aspx.vb" Inherits="Nexus.PB2_CAMSC_Machinery_Breakdown_Overview" %>
...
function onValidate_label574(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label574" != "{na" + "me}"){
        			instance = Field.getLabel("label574");
        		} else { 
...
function onValidate_label575(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label575" != "{na" + "me}"){
        			instance = Field.getLabel("label575");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label576(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label576" != "{na" + "me}"){
        			instance = Field.getLabel("label576");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label577(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label577" != "{na" + "me}"){
        			instance = Field.getLabel("label577");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label578(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label578" != "{na" + "me}"){
        			instance = Field.getLabel("label578");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label579(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label579" != "{na" + "me}"){
        			instance = Field.getLabel("label579");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_EXPOSURE_SUMMARY__MBACPC_EML(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("EXPOSURE_SUMMARY.MBACPC_EML > GENERAL.EML OR EXPOSURE_SUMMARY.MBACPC_EML < GENERAL.EML_MIN ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label580(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label580" != "{na" + "me}"){
        			instance = Field.getLabel("label580");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_EXPOSURE_SUMMARY__CONSLGPR_EML(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("EXPOSURE_SUMMARY.CONSLGPR_EML > GENERAL.EML OR EXPOSURE_SUMMARY.CONSLGPR_EML < GENERAL.EML_MIN ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label581(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label581" != "{na" + "me}"){
        			instance = Field.getLabel("label581");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_EXPOSURE_SUMMARY__CONSLACPC_EML(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("EXPOSURE_SUMMARY.CONSLACPC_EML > GENERAL.EML OR EXPOSURE_SUMMARY.CONSLACPC_EML< GENERAL.EML_MIN ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label582(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label582" != "{na" + "me}"){
        			instance = Field.getLabel("label582");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_EXPOSURE_SUMMARY__MBDETOST_EML(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("EXPOSURE_SUMMARY.MBDETOST_EML > GENERAL.EML OR EXPOSURE_SUMMARY.MBDETOST_EML < GENERAL.EML_MIN ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label583(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label583" != "{na" + "me}"){
        			instance = Field.getLabel("label583");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_label574(null, null, null, isOnLoad);
    onValidate_label575(null, null, null, isOnLoad);
    onValidate_label576(null, null, null, isOnLoad);
    onValidate_label577(null, null, null, isOnLoad);
    onValidate_label578(null, null, null, isOnLoad);
    ...
    onValidate_label579(null, null, null, isOnLoad);
    ...
    onValidate_label580(null, null, null, isOnLoad);
    ...
    onValidate_label581(null, null, null, isOnLoad);
    ...
    onValidate_label582(null, null, null, isOnLoad);
    ...
    onValidate_label583(null, null, null, isOnLoad);
...
<div id="id83f1d1933d1040e6bcf1b4644142f3c6" class="general-layout-container">
...
<div id="iddca9e1e6cbcf445fa9e18f8f4a7e902b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading270" runat="server" Text="Combined Reinsurance Exposure" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label574">
		<span class="label" id="label574">Total Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label575">
		<span class="label" id="label575">EML%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label576">
		<span class="label" id="label576">RI Exposure (VAT Incl.)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label577">
		<span class="label" id="label577">RI Exposure (VAT Excl.)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label578">
		<span class="label" id="label578">Machinery Breakdown</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label579">
		<span class="label" id="label579">Machinery Breakdown Additional Claims Preparation Cost</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label580">
		<span class="label" id="label580">Consequential Loss Gross Profit/Revenue</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label581">
		<span class="label" id="label581">Consequential Loss Additional Claims Preparation Cost</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label582">
		<span class="label" id="label582">Deterioration of Stock</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label583">
		<span class="label" id="label583">Totals</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddca9e1e6cbcf445fa9e18f8f4a7e902b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddca9e1e6cbcf445fa9e18f8f4a7e902b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddca9e1e6cbcf445fa9e18f8f4a7e902b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddca9e1e6cbcf445fa9e18f8f4a7e902b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddca9e1e6cbcf445fa9e18f8f4a7e902b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddca9e1e6cbcf445fa9e18f8f4a7e902b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddca9e1e6cbcf445fa9e18f8f4a7e902b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddca9e1e6cbcf445fa9e18f8f4a7e902b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddca9e1e6cbcf445fa9e18f8f4a7e902b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddca9e1e6cbcf445fa9e18f8f4a7e902b input{text-align:left;}"; break;
		}
	}
