...
Namespace Nexus
    Partial Class PB2_CAMSC_Goods_In_Transit : Inherits BaseRisk
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (GIT__RISKATTACHDATE.Text <> "" And GIT__RISKATTACHDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        			GIT__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		Else
        			GIT__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
