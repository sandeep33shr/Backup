...
Namespace Nexus
    Partial Class PB2_CAMSC_Deterioration_of_Stock : Inherits BaseRisk
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (DSTOCK__ATTACHMENTDATE.Text <> "" And DSTOCK__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        			DSTOCK__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		Else
        			DSTOCK__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        ...
        End Sub
        		...
        		Private Sub NumberLocacationItems()
        			...
        			If Session("Refresh") = "1" Then
        				Dim sUrl As String = "/Products/Commercial%20Annual/CMAMISC/CMAMISC_Deterioration_of_Stock.aspx"
