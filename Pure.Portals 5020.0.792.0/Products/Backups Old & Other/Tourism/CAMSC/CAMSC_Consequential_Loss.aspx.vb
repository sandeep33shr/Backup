...
Namespace Nexus
    Partial Class PB2_CAMSC_Consequential_Loss : Inherits BaseRisk
		...
		Protected Sub onValidate_CONSL__ATTACHMENTDATE()
        
        
End Sub
Protected Sub onValidate_CONSL__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CONSL__ATTACHMENTDATE()
    onValidate_CONSL__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If CONSL__ATTACHMENTDATE.Text = "" or CONSL__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			CONSL__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			CONSL__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (CONSL__ATTACHMENTDATE.Text <> "" And CONSL__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        			CONSL__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		Else
        			CONSL__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		CONSL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		CONSL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		CONSL__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
