<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAMSC_Goods_In_Transit.aspx.vb" Inherits="Nexus.PB2_CAMSC_Goods_In_Transit" %>
...
function onValidate_GIT__MGITENDP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT", "MGITENDP", "ChildScreen");
        })();
}
...
function onValidate_GIT_NOTES__MAGITNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_NOTES", "MAGITNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GIT_NOTES", "MAGITNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_GIT_NOTES__MAGITNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GIT_NOTES", "MAGITNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'GIT_NOTES' and property 'MAGITNOTE'.");
        			error.display();
...
function onValidate_GIT_NOTES__MGITSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_NOTES", "MGITSNOTE", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GIT__MGITENDP(null, null, null, isOnLoad);
    onValidate_GIT__GIT_END_CNT(null, null, null, isOnLoad);
    onValidate_GIT_NOTES__MAGITNOTE(null, null, null, isOnLoad);
    onValidate_GIT_NOTES__MGITSNOTE(null, null, null, isOnLoad);
...
<div id="id1fcc9a8a71864b50aaaa5d75203bef5d" class="general-layout-container">
...
<div id="id8ca21cd1f51c468a816bdf16e2d6ffdb" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8ca21cd1f51c468a816bdf16e2d6ffdb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8ca21cd1f51c468a816bdf16e2d6ffdb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8ca21cd1f51c468a816bdf16e2d6ffdb div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8ca21cd1f51c468a816bdf16e2d6ffdb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8ca21cd1f51c468a816bdf16e2d6ffdb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8ca21cd1f51c468a816bdf16e2d6ffdb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8ca21cd1f51c468a816bdf16e2d6ffdb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8ca21cd1f51c468a816bdf16e2d6ffdb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8ca21cd1f51c468a816bdf16e2d6ffdb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8ca21cd1f51c468a816bdf16e2d6ffdb input{text-align:left;}"; break;
		}
	}
...
<div id="Pastclaimscount" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading90" runat="server" Text="Past Claims Count" /></legend>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida2f2f5b9652e40dbbe5d2d50a7014269" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading91" runat="server" Text="Rating Method" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida2f2f5b9652e40dbbe5d2d50a7014269 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida2f2f5b9652e40dbbe5d2d50a7014269 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida2f2f5b9652e40dbbe5d2d50a7014269 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida2f2f5b9652e40dbbe5d2d50a7014269 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida2f2f5b9652e40dbbe5d2d50a7014269 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida2f2f5b9652e40dbbe5d2d50a7014269 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida2f2f5b9652e40dbbe5d2d50a7014269 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida2f2f5b9652e40dbbe5d2d50a7014269 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida2f2f5b9652e40dbbe5d2d50a7014269 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida2f2f5b9652e40dbbe5d2d50a7014269 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2519ef91019b48d3a8be0daa809d42e4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading92" runat="server" Text="Means of Conveyance" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2519ef91019b48d3a8be0daa809d42e4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2519ef91019b48d3a8be0daa809d42e4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2519ef91019b48d3a8be0daa809d42e4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2519ef91019b48d3a8be0daa809d42e4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2519ef91019b48d3a8be0daa809d42e4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2519ef91019b48d3a8be0daa809d42e4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2519ef91019b48d3a8be0daa809d42e4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2519ef91019b48d3a8be0daa809d42e4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2519ef91019b48d3a8be0daa809d42e4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2519ef91019b48d3a8be0daa809d42e4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6f9414bbd7814158aec95f626f3af10d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading93" runat="server" Text="Description of Goods Carried" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6f9414bbd7814158aec95f626f3af10d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6f9414bbd7814158aec95f626f3af10d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6f9414bbd7814158aec95f626f3af10d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6f9414bbd7814158aec95f626f3af10d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6f9414bbd7814158aec95f626f3af10d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6f9414bbd7814158aec95f626f3af10d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6f9414bbd7814158aec95f626f3af10d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6f9414bbd7814158aec95f626f3af10d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6f9414bbd7814158aec95f626f3af10d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6f9414bbd7814158aec95f626f3af10d input{text-align:left;}"; break;
		}
	}
...
<div id="frmAC" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading94" runat="server" Text="Goods in Transit - Annual Carry" /></legend>
...
<div id="frmLL" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading95" runat="server" Text="Goods in Transit - Load Limit" /></legend>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id648168e7d3c346daaa11fbe64c147441" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading96" runat="server" Text="First Amount Payable" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id648168e7d3c346daaa11fbe64c147441 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id648168e7d3c346daaa11fbe64c147441 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id648168e7d3c346daaa11fbe64c147441 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id648168e7d3c346daaa11fbe64c147441 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id648168e7d3c346daaa11fbe64c147441 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id648168e7d3c346daaa11fbe64c147441 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id648168e7d3c346daaa11fbe64c147441 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id648168e7d3c346daaa11fbe64c147441 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id648168e7d3c346daaa11fbe64c147441 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id648168e7d3c346daaa11fbe64c147441 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id13022b72eca542fe9775db38dd2cb804" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id13022b72eca542fe9775db38dd2cb804 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id13022b72eca542fe9775db38dd2cb804 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id13022b72eca542fe9775db38dd2cb804 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id13022b72eca542fe9775db38dd2cb804 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id13022b72eca542fe9775db38dd2cb804 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id13022b72eca542fe9775db38dd2cb804 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id13022b72eca542fe9775db38dd2cb804 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id13022b72eca542fe9775db38dd2cb804 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id13022b72eca542fe9775db38dd2cb804 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id13022b72eca542fe9775db38dd2cb804 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GIT__MGITENDP"
		data-field-type="Child" 
		data-object-name="GIT" 
		data-property-name="MGITENDP" 
		id="pb-container-childscreen-GIT-MGITENDP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GIT__GIT_CLAUSEPREM" runat="server" ScreenCode="MGITENDP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGITENDP/MGITENDP_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valGIT_MGITENDP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GIT.MGITENDP"
						ClientValidationFunction="onValidate_GIT__MGITENDP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6eff9fdb3cb04082bab9cc47bba359de" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading101" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GIT_NOTES__MAGITNOTE"
		data-field-type="Child" 
		data-object-name="GIT_NOTES" 
		data-property-name="MAGITNOTE" 
		id="pb-container-childscreen-GIT_NOTES-MAGITNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GIT_NOTES__GIT_CNOTE_DETAILS" runat="server" ScreenCode="MAGITNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MAGITNOTE/MAGITNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGIT_NOTES_MAGITNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GIT_NOTES.MAGITNOTE"
						ClientValidationFunction="onValidate_GIT_NOTES__MAGITNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6eff9fdb3cb04082bab9cc47bba359de div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6eff9fdb3cb04082bab9cc47bba359de div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6eff9fdb3cb04082bab9cc47bba359de div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6eff9fdb3cb04082bab9cc47bba359de label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6eff9fdb3cb04082bab9cc47bba359de label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6eff9fdb3cb04082bab9cc47bba359de label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6eff9fdb3cb04082bab9cc47bba359de label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6eff9fdb3cb04082bab9cc47bba359de input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6eff9fdb3cb04082bab9cc47bba359de input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6eff9fdb3cb04082bab9cc47bba359de input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfe3ae6b11b1840e7bd5ca55a3eec6243" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading102" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GIT_NOTES__MGITSNOTE"
		data-field-type="Child" 
		data-object-name="GIT_NOTES" 
		data-property-name="MGITSNOTE" 
		id="pb-container-childscreen-GIT_NOTES-MGITSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GIT_NOTES__GIT_SCNOTE_DETAILS" runat="server" ScreenCode="MGITSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGITSNOTE/MGITSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGIT_NOTES_MGITSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GIT_NOTES.MGITSNOTE"
						ClientValidationFunction="onValidate_GIT_NOTES__MGITSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idfe3ae6b11b1840e7bd5ca55a3eec6243 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfe3ae6b11b1840e7bd5ca55a3eec6243 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfe3ae6b11b1840e7bd5ca55a3eec6243 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfe3ae6b11b1840e7bd5ca55a3eec6243 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfe3ae6b11b1840e7bd5ca55a3eec6243 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfe3ae6b11b1840e7bd5ca55a3eec6243 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfe3ae6b11b1840e7bd5ca55a3eec6243 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfe3ae6b11b1840e7bd5ca55a3eec6243 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfe3ae6b11b1840e7bd5ca55a3eec6243 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfe3ae6b11b1840e7bd5ca55a3eec6243 input{text-align:left;}"; break;
		}
	}
