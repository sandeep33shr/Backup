...
Namespace Nexus
    Partial Class PB2_CAAGRPFIRE_Accidental_Damage : Inherits BaseRisk
		...
		Protected Sub onValidate_AD__RISK_ATTACH_DATE()
        
End Sub
Protected Sub onValidate_AD__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_AD__RISK_ATTACH_DATE()
    onValidate_AD__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If AD__RISK_ATTACH_DATE.Text = "" or AD__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			AD__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			AD__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (AD__RISK_ATTACH_DATE.Text <> "" Or AD__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		AD__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		AD__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		AD__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
