...
Namespace Nexus
    Partial Class PB2_CAAGRPFIRE_Buildings_Combined : Inherits BaseRisk
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (BUILDCOM__RISK_ATTACH_DATE.Text <> "" And BUILDCOM__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        			BUILDCOM__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		Else
        			BUILDCOM__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        ...
        Protected Shadows Sub FirePage_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If oQuote IsNot Nothing Then
        		...
        		UpdateXML("BC_RISK_PREMIUM", BUILDCOM__TOTAL_PREMIUM.Text, "PREMIUM_SUMMARY")
        		UpdateXML("BC_EXT_PREM", BCOM_EXTENSIONS__TOTAL_PREMIUM.Text, "PREMIUM_SUMMARY")
                UpdateXML("BC_ENDORSE_PREMIUM", BUILDCOM__TOTAL_ENDORSE_PREM.Text, "PREMIUM_SUMMARY")
        		UpdateXML("BC_LIAB_PREMIUM", BUILDCOM__LIAB_PREMIUM.Text, "PREMIUM_SUMMARY")
                UpdateXML("BC_TOTAL_PREMIUM", BUILDCOM__TOTAL_PREMIUM.Text, "PREMIUM_SUMMARY")
