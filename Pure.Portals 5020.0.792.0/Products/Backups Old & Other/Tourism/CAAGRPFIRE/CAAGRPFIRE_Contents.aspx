<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAGRPFIRE_Contents.aspx.vb" Inherits="Nexus.PB2_CAAGRPFIRE_Contents" %>
...
function onValidate_OFFICE__OC_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OFFICE&propertyName=OC_PREMIUM&name={name}");
        		
        		var value = new Expression("OFFICE.OC_SI * (OFFICE.OC_RATE * 0.01)"), 
...
function onValidate_label168(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Label&objectName=&propertyName=&name=label168");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Office Contents FAP% cannot be greater than 100%")) ? "Office Contents FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_label169(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
         * Check performed only when the page is submitted
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Label&objectName=&propertyName=&name=label169");
...
function onValidate_label170(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_OFFICE__LOD_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OFFICE&propertyName=LOD_PREMIUM&name={name}");
        		
        		var value = new Expression("OFFICE.LOD_SI * (OFFICE.LOD_RATE * 0.01)"), 
        			condition = (Expression.isValidParameter("OFFICE.LOD_SI > 0")) ? new Expression("OFFICE.LOD_SI > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("OFFICE", "LOD_SI");
        	var Rate = Field.getInstance("OFFICE", "LOD_RATE");
        	var Premium = Field.getInstance("OFFICE", "LOD_PREMIUM");
...
function onValidate_OFFICE__LOD_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Loss of Documents FAP% cannot be greater than 100%")) ? "Loss of Documents FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_OFFICE__LFD_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OFFICE&propertyName=LFD_PREMIUM&name={name}");
        		
        		var value = new Expression("OFFICE.LFD_SI * (OFFICE.LFD_RATE * 0.01)"), 
        			condition = (Expression.isValidParameter("OFFICE.LFD_SI >0")) ? new Expression("OFFICE.LFD_SI >0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("OFFICE", "LFD_SI");
        	var Rate = Field.getInstance("OFFICE", "LFD_RATE");
        	var Premium = Field.getInstance("OFFICE", "LFD_PREMIUM");
...
function onValidate_OFFICE__LFD_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Liability For Documents FAP% cannot be greater than 100%")) ? "Liability For Documents FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_OFFICE__AOC_PER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE", "AOC_PER", "Percentage");
        })();
}
function onValidate_OFFICE__AOC_MIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE", "AOC_MIN", "Currency");
        })();
}
...
function onValidate_OFFICE_EXTENSIONS__ACPC_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OFFICE_EXTENSIONS&propertyName=ACPC_PREMIUM&name={name}");
        		
        		var value = new Expression("OFFICE_EXTENSIONS.ACPC_LOI * (OFFICE_EXTENSIONS.ACPC_RATE * 0.01)"), 
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("OFFICE_EXTENSIONS", "ACPC_LOI");
        	var Rate = Field.getInstance("OFFICE_EXTENSIONS", "ACPC_RATE");
        	var Premium = Field.getInstance("OFFICE_EXTENSIONS", "ACPC_PREMIUM");
...
function onValidate_OFFICE_EXTENSIONS__LEAKAGE_LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("((OFFICE.OC_SI + OFFICE.LEAKAGE_LOI) > OFFICE_EXTENSIONS.LEAKAGE_LOI) ||(OFFICE_EXTENSIONS.LEAKAGE_LOI =='' || OFFICE_EXTENSIONS.LEAKAGE_LOI ==null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_OFFICE_EXTENSIONS__LEAKAGE_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OFFICE_EXTENSIONS&propertyName=LEAKAGE_PREMIUM&name={name}");
        		
        		var value = new Expression("OFFICE_EXTENSIONS.LEAKAGE_LOI * (OFFICE_EXTENSIONS.LEAKAGE_RATE * 0.01)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("OFFICE_EXTENSIONS", "LEAKAGE_LOI");
        	var Rate = Field.getInstance("OFFICE_EXTENSIONS", "LEAKAGE_RATE");
        	var Premium = Field.getInstance("OFFICE_EXTENSIONS", "LEAKAGE_PREMIUM");
...
function onValidate_OFFICE_EXTENSIONS__LEAKAGE_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Additional Leakage - First Loss FAP% cannot be greater than 100%")) ? "Additional Leakage - First Loss FAP% cannot be greater than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_OFFICE_EXTENSIONS__IS_THAFV(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "IS_THAFV", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "IS_THAFV");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		// Setup an instance of the field
        		var field = Field.getInstance("OFFICE_EXTENSIONS", "IS_THAFV");
...
function onValidate_OFFICE_EXTENSIONS__THAFV_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "THAFV_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "THAFV_LOI");
        		}
        		//window.setProperty(field, "VEM", "OFFICE_EXTENSIONS.IS_THAFV == true ", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "OFFICE_EXTENSIONS.IS_THAFV == true ",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("OFFICE_EXTENSIONS", "THAFV_LOI");
...
function onValidate_OFFICE_EXTENSIONS__THAFVV_R(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "THAFVV_R", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "THAFVV_R");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("OFFICE_EXTENSIONS", "THAFVV_R");
...
function onValidate_OFFICE_EXTENSIONS__THAFVV_PR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "THAFVV_PR", "Currency");
        })();
        /**
         * Set the field width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('OFFICE_EXTENSIONS', 'THAFVV_PR');
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "THAFVV_PR");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_OFFICE_EXTENSIONS__THAFV_PER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "THAFV_PER", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "THAFV_PER");
        		}
        		//window.setProperty(field, "VE", "OFFICE_EXTENSIONS.IS_THAFV == true ", "V", "{3}");
...
function onValidate_OFFICE_EXTENSIONS__THAFV_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "THAFV_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "THAFV_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "OFFICE_EXTENSIONS.IS_THAFV == true ", "V", "{3}");
...
function onValidate_OFFICE_EXTENSIONS__IS_THAFVV(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "IS_THAFVV", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "IS_THAFVV");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		// Setup an instance of the field
        		var field = Field.getInstance("OFFICE_EXTENSIONS", "IS_THAFVV");
...
function onValidate_OFFICE_EXTENSIONS__THAFVV_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "THAFVV_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "THAFVV_LOI");
        		}
        		//window.setProperty(field, "VEM", "OFFICE_EXTENSIONS.IS_THAFVV == true ", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "OFFICE_EXTENSIONS.IS_THAFVV == true ",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("OFFICE_EXTENSIONS", "THAFVV_LOI");
...
function onValidate_OFFICE_EXTENSIONS__THAFVV_PER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "THAFVV_PER", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "THAFVV_PER");
        		}
        		//window.setProperty(field, "VE", "OFFICE_EXTENSIONS.IS_THAFVV == true ", "V", "{3}");
...
function onValidate_OFFICE_EXTENSIONS__THAFVV_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE_EXTENSIONS", "THAFVV_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE_EXTENSIONS", "THAFVV_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "OFFICE_EXTENSIONS.IS_THAFVV == true ", "V", "{3}");
...
function onValidate_CON__TOTAL_ENDORSE_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CON", "TOTAL_ENDORSE_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CON", "TOTAL_ENDORSE_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCON_TOTAL_ENDORSE_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CON__TOTAL_ENDORSE_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CON__TOTAL_ENDORSE_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CON.TOTAL_ENDORSE_PREM");
        			window.setControlWidth(field, "0.3", "CON", "TOTAL_ENDORSE_PREM");
        		})();
        	}
        })();
...
function onValidate_CON__CTOTAL_FINAL_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CON", "CTOTAL_FINAL_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CON", "CTOTAL_FINAL_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CON.CTOTAL_FINAL_PREMIUM");
        			window.setControlWidth(field, "0.7", "CON", "CTOTAL_FINAL_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCON_CTOTAL_FINAL_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CON__CTOTAL_FINAL_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CON__CTOTAL_FINAL_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CON__OC_ENDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CON", "OC_ENDPRM", "ChildScreen");
        })();
}
function onValidate_OFFICE__CONT_NOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE", "CONT_NOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("OFFICE", "CONT_NOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_OFFICE__CONT_NOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("OFFICE", "CONT_NOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'OFFICE' and property 'CONT_NOTE'.");
        			error.display();
...
function onValidate_OFFICE__NCONT_NOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OFFICE", "NCONT_NOTE", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("OFFICE", "NCONT_NOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_OFFICE__NCONT_NOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("OFFICE", "NCONT_NOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'OFFICE' and property 'NCONT_NOTE'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function onValidate_REINSEXP_OC__POP_TOTAL_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("REINSEXP_OC.POP_TARGET_SI.setValue(REINSEXP_OC.POP_TOTAL_SI) || REINSEXP_OC.POP_MPL.setValue(100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_REINSEXP_OC__CD_TOTAL_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("REINSEXP_OC.CD_TARGET_SI.setValue(REINSEXP_OC.CD_TOTAL_SI) || REINSEXP_OC.CD_MPL.setValue(100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_label168(null, null, null, isOnLoad);
    onValidate_label169(null, null, null, isOnLoad);
    onValidate_label170(null, null, null, isOnLoad);
    ...
    onValidate_OFFICE__AOC_PER(null, null, null, isOnLoad);
    onValidate_OFFICE__AOC_MIN(null, null, null, isOnLoad);
    ...
    onValidate_OFFICE_EXTENSIONS__IS_THAFV(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__THAFV_LOI(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__THAFVV_R(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__THAFVV_PR(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__THAFV_PER(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__THAFV_AMOUNT(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__IS_THAFVV(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__THAFVV_LOI(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__THAFVV_PER(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__THAFVV_AMOUNT(null, null, null, isOnLoad);
    onValidate_OFFICE_EXTENSIONS__TOTAL_PREMIUM(null, null, null, isOnLoad);
    onValidate_CON__TOTAL_ENDORSE_PREM(null, null, null, isOnLoad);
    onValidate_CON__CTOTAL_FINAL_PREMIUM(null, null, null, isOnLoad);
    onValidate_CON__OC_ENDPRM(null, null, null, isOnLoad);
    onValidate_OFFICE__CONT_NOTE(null, null, null, isOnLoad);
    onValidate_OFFICE__NCONT_NOTE(null, null, null, isOnLoad);
...
<div id="id48d72541b75c42eabb4d0b0af35ba8e1" class="general-layout-container">
...
<div id="id469962bbf5054856bc1b528553002173" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading52" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id469962bbf5054856bc1b528553002173 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id469962bbf5054856bc1b528553002173 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id469962bbf5054856bc1b528553002173 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id469962bbf5054856bc1b528553002173 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id469962bbf5054856bc1b528553002173 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id469962bbf5054856bc1b528553002173 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id469962bbf5054856bc1b528553002173 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id469962bbf5054856bc1b528553002173 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id469962bbf5054856bc1b528553002173 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id469962bbf5054856bc1b528553002173 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd9efbd55510847369059c786ac686937" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading53" runat="server" Text="Aggregate" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd9efbd55510847369059c786ac686937 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd9efbd55510847369059c786ac686937 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd9efbd55510847369059c786ac686937 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd9efbd55510847369059c786ac686937 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd9efbd55510847369059c786ac686937 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd9efbd55510847369059c786ac686937 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd9efbd55510847369059c786ac686937 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd9efbd55510847369059c786ac686937 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd9efbd55510847369059c786ac686937 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd9efbd55510847369059c786ac686937 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0780517ff0404bed92b8f2e7d93782bc" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading54" runat="server" Text="Cover" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label161">
		<span class="label" id="label161">Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label162">
		<span class="label" id="label162">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label163">
		<span class="label" id="label163">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label164">
		<span class="label" id="label164">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label165">
		<span class="label" id="label165">Minimum Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label166">
		<span class="label" id="label166">Maximum Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label167">
		<span class="label" id="label167">Sub-Section A - Contents </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label171">
		<span class="label" id="label171">Sub-Section C - Documents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label172">
		<span class="label" id="label172">Sub-Section D - Liablity Documents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label173">
		<span class="label" id="label173">Total </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0780517ff0404bed92b8f2e7d93782bc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0780517ff0404bed92b8f2e7d93782bc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0780517ff0404bed92b8f2e7d93782bc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0780517ff0404bed92b8f2e7d93782bc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0780517ff0404bed92b8f2e7d93782bc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0780517ff0404bed92b8f2e7d93782bc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0780517ff0404bed92b8f2e7d93782bc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0780517ff0404bed92b8f2e7d93782bc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0780517ff0404bed92b8f2e7d93782bc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0780517ff0404bed92b8f2e7d93782bc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3997832fbea34ae785d046a7644bfb5a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading55" runat="server" Text="First Amount Payable" /></legend>
				
				
				<div data-column-count="3" data-column-ratio="45:15:40" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:45%;" >
...
<!-- /Label -->
	...
	<span id="pb-container-label-label176">
		<span class="label" id="label176">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label177">
		<span class="label" id="label177">Minimum Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label178">
		<span class="label" id="label178">All other Contents - definded events</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="OFFICE" 
		data-property-name="AOC_PER" 
		id="pb-container-percentage-OFFICE-AOC_PER">
		<asp:Label ID="lblOFFICE_AOC_PER" runat="server" AssociatedControlID="OFFICE__AOC_PER" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="OFFICE__AOC_PER" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valOFFICE_AOC_PER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE.AOC_PER"
			ClientValidationFunction="onValidate_OFFICE__AOC_PER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OFFICE" 
		data-property-name="AOC_MIN" 
		id="pb-container-currency-OFFICE-AOC_MIN">
		<asp:Label ID="lblOFFICE_AOC_MIN" runat="server" AssociatedControlID="OFFICE__AOC_MIN" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OFFICE__AOC_MIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOFFICE_AOC_MIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE.AOC_MIN"
			ClientValidationFunction="onValidate_OFFICE__AOC_MIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3997832fbea34ae785d046a7644bfb5a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3997832fbea34ae785d046a7644bfb5a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3997832fbea34ae785d046a7644bfb5a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3997832fbea34ae785d046a7644bfb5a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3997832fbea34ae785d046a7644bfb5a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3997832fbea34ae785d046a7644bfb5a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3997832fbea34ae785d046a7644bfb5a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3997832fbea34ae785d046a7644bfb5a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3997832fbea34ae785d046a7644bfb5a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3997832fbea34ae785d046a7644bfb5a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="iddf585ff2c9e446b896294c3bb8cb70d0" class="column-layout-container,no-border  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label181">
		<span class="label" id="label181">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label182">
		<span class="label" id="label182">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label183">
		<span class="label" id="label183">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label184">
		<span class="label" id="label184">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label185">
		<span class="label" id="label185">Minimum Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label186">
		<span class="label" id="label186">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label189">
		<span class="label" id="label189">Leakage - First Loss</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label190">
		<span class="label" id="label190">Riot & Strike</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label193">
		<span class="label" id="label193">NASRIA -Contents</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label196">
		<span class="label" id="label196"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblOFFICE_EXTENSIONS_IS_THAFV" for="ctl00_cntMainBody_OFFICE_EXTENSIONS__IS_THAFV" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="IS_THAFV" 
		id="pb-container-checkbox-OFFICE_EXTENSIONS-IS_THAFV">	
		
		<asp:TextBox ID="OFFICE_EXTENSIONS__IS_THAFV" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_IS_THAFV" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.IS_THAFV"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__IS_THAFV" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label198">
		<span class="label" id="label198">Theft - Accompanied F&V</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="THAFV_LOI" 
		id="pb-container-currency-OFFICE_EXTENSIONS-THAFV_LOI">
		<asp:Label ID="lblOFFICE_EXTENSIONS_THAFV_LOI" runat="server" AssociatedControlID="OFFICE_EXTENSIONS__THAFV_LOI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OFFICE_EXTENSIONS__THAFV_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_THAFV_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.THAFV_LOI"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__THAFV_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="THAFVV_R" 
		id="pb-container-percentage-OFFICE_EXTENSIONS-THAFVV_R">
		<asp:Label ID="lblOFFICE_EXTENSIONS_THAFVV_R" runat="server" AssociatedControlID="OFFICE_EXTENSIONS__THAFVV_R" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="OFFICE_EXTENSIONS__THAFVV_R" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_THAFVV_R" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.THAFVV_R"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__THAFVV_R" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="THAFVV_PR" 
		id="pb-container-currency-OFFICE_EXTENSIONS-THAFVV_PR">
		<asp:Label ID="lblOFFICE_EXTENSIONS_THAFVV_PR" runat="server" AssociatedControlID="OFFICE_EXTENSIONS__THAFVV_PR" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OFFICE_EXTENSIONS__THAFVV_PR" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_THAFVV_PR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.THAFVV_PR"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__THAFVV_PR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="THAFV_PER" 
		id="pb-container-percentage-OFFICE_EXTENSIONS-THAFV_PER">
		<asp:Label ID="lblOFFICE_EXTENSIONS_THAFV_PER" runat="server" AssociatedControlID="OFFICE_EXTENSIONS__THAFV_PER" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="OFFICE_EXTENSIONS__THAFV_PER" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_THAFV_PER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.THAFV_PER"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__THAFV_PER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="THAFV_AMOUNT" 
		id="pb-container-currency-OFFICE_EXTENSIONS-THAFV_AMOUNT">
		<asp:Label ID="lblOFFICE_EXTENSIONS_THAFV_AMOUNT" runat="server" AssociatedControlID="OFFICE_EXTENSIONS__THAFV_AMOUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OFFICE_EXTENSIONS__THAFV_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_THAFV_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.THAFV_AMOUNT"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__THAFV_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblOFFICE_EXTENSIONS_IS_THAFVV" for="ctl00_cntMainBody_OFFICE_EXTENSIONS__IS_THAFVV" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="IS_THAFVV" 
		id="pb-container-checkbox-OFFICE_EXTENSIONS-IS_THAFVV">	
		
		<asp:TextBox ID="OFFICE_EXTENSIONS__IS_THAFVV" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_IS_THAFVV" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.IS_THAFVV"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__IS_THAFVV" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label199">
		<span class="label" id="label199">Theft - Unaccompanied F&V </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="THAFVV_LOI" 
		id="pb-container-currency-OFFICE_EXTENSIONS-THAFVV_LOI">
		<asp:Label ID="lblOFFICE_EXTENSIONS_THAFVV_LOI" runat="server" AssociatedControlID="OFFICE_EXTENSIONS__THAFVV_LOI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OFFICE_EXTENSIONS__THAFVV_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_THAFVV_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.THAFVV_LOI"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__THAFVV_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="THAFVV_PER" 
		id="pb-container-percentage-OFFICE_EXTENSIONS-THAFVV_PER">
		<asp:Label ID="lblOFFICE_EXTENSIONS_THAFVV_PER" runat="server" AssociatedControlID="OFFICE_EXTENSIONS__THAFVV_PER" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="OFFICE_EXTENSIONS__THAFVV_PER" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_THAFVV_PER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.THAFVV_PER"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__THAFVV_PER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OFFICE_EXTENSIONS" 
		data-property-name="THAFVV_AMOUNT" 
		id="pb-container-currency-OFFICE_EXTENSIONS-THAFVV_AMOUNT">
		<asp:Label ID="lblOFFICE_EXTENSIONS_THAFVV_AMOUNT" runat="server" AssociatedControlID="OFFICE_EXTENSIONS__THAFVV_AMOUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OFFICE_EXTENSIONS__THAFVV_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOFFICE_EXTENSIONS_THAFVV_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for OFFICE_EXTENSIONS.THAFVV_AMOUNT"
			ClientValidationFunction="onValidate_OFFICE_EXTENSIONS__THAFVV_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label201">
		<span class="label" id="label201">Total</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label202">
		<span class="label" id="label202"></span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#iddf585ff2c9e446b896294c3bb8cb70d0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddf585ff2c9e446b896294c3bb8cb70d0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddf585ff2c9e446b896294c3bb8cb70d0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#iddf585ff2c9e446b896294c3bb8cb70d0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddf585ff2c9e446b896294c3bb8cb70d0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddf585ff2c9e446b896294c3bb8cb70d0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddf585ff2c9e446b896294c3bb8cb70d0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddf585ff2c9e446b896294c3bb8cb70d0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddf585ff2c9e446b896294c3bb8cb70d0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddf585ff2c9e446b896294c3bb8cb70d0 input{text-align:left;}"; break;
		}
	}
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CON" 
		data-property-name="TOTAL_ENDORSE_PREM" 
		id="pb-container-currency-CON-TOTAL_ENDORSE_PREM">
		<asp:Label ID="lblCON_TOTAL_ENDORSE_PREM" runat="server" AssociatedControlID="CON__TOTAL_ENDORSE_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CON__TOTAL_ENDORSE_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCON_TOTAL_ENDORSE_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_CON__TOTAL_ENDORSE_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CON" 
		data-property-name="CTOTAL_FINAL_PREMIUM" 
		id="pb-container-currency-CON-CTOTAL_FINAL_PREMIUM">
		<asp:Label ID="lblCON_CTOTAL_FINAL_PREMIUM" runat="server" AssociatedControlID="CON__CTOTAL_FINAL_PREMIUM" 
			Text="Total Risk  Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CON__CTOTAL_FINAL_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCON_CTOTAL_FINAL_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Risk  Premium"
			ClientValidationFunction="onValidate_CON__CTOTAL_FINAL_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmenPremium" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CON__OC_ENDPRM"
		data-field-type="Child" 
		data-object-name="CON" 
		data-property-name="OC_ENDPRM" 
		id="pb-container-childscreen-CON-OC_ENDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CON__OC_CLAUSE" runat="server" ScreenCode="OC_ENDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="OC_ENDPRM/OC_ENDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCON_OC_ENDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CON.OC_ENDPRM"
						ClientValidationFunction="onValidate_CON__OC_ENDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmenPremium div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmenPremium div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmenPremium div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmenPremium label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmenPremium label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmenPremium label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmenPremium label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmenPremium input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmenPremium input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmenPremium input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1eee2292669e4243a6e781c963dbb69f" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading60" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_OFFICE__CONT_NOTE"
		data-field-type="Child" 
		data-object-name="OFFICE" 
		data-property-name="CONT_NOTE" 
		id="pb-container-childscreen-OFFICE-CONT_NOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="OFFICE__OC_CNOTE_DETAILS" runat="server" ScreenCode="CONT_NOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CONT_NOTE/CONT_NOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valOFFICE_CONT_NOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for OFFICE.CONT_NOTE"
						ClientValidationFunction="onValidate_OFFICE__CONT_NOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id1eee2292669e4243a6e781c963dbb69f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1eee2292669e4243a6e781c963dbb69f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1eee2292669e4243a6e781c963dbb69f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1eee2292669e4243a6e781c963dbb69f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1eee2292669e4243a6e781c963dbb69f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1eee2292669e4243a6e781c963dbb69f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1eee2292669e4243a6e781c963dbb69f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1eee2292669e4243a6e781c963dbb69f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1eee2292669e4243a6e781c963dbb69f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1eee2292669e4243a6e781c963dbb69f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idbe545d273196487a94617740fdb58311" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading61" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_OFFICE__NCONT_NOTE"
		data-field-type="Child" 
		data-object-name="OFFICE" 
		data-property-name="NCONT_NOTE" 
		id="pb-container-childscreen-OFFICE-NCONT_NOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="OFFICE__OC_SNOTE_DETAILS" runat="server" ScreenCode="NCONT_NOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="NCONT_NOTE/NCONT_NOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valOFFICE_NCONT_NOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for OFFICE.NCONT_NOTE"
						ClientValidationFunction="onValidate_OFFICE__NCONT_NOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idbe545d273196487a94617740fdb58311 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbe545d273196487a94617740fdb58311 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbe545d273196487a94617740fdb58311 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idbe545d273196487a94617740fdb58311 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbe545d273196487a94617740fdb58311 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbe545d273196487a94617740fdb58311 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbe545d273196487a94617740fdb58311 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbe545d273196487a94617740fdb58311 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbe545d273196487a94617740fdb58311 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbe545d273196487a94617740fdb58311 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id82b512940f69405f95b400c02c2e3e67" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading62" runat="server" Text="Reinsurance Exposure" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label207">
		<span class="label" id="label207">Total Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label208">
		<span class="label" id="label208">Target Risk SI</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label209">
		<span class="label" id="label209">MPL %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label210">
		<span class="label" id="label210">RI Exposure</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label211">
		<span class="label" id="label211">Contents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label212">
		<span class="label" id="label212">Rent</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label213">
		<span class="label" id="label213">Increase in Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label214">
		<span class="label" id="label214">Loss of Documents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label215">
		<span class="label" id="label215">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label216">
		<span class="label" id="label216">Property Owned by Partner</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label217">
		<span class="label" id="label217">Capital Additions</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label218">
		<span class="label" id="label218">Clearance & Dem</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label219">
		<span class="label" id="label219">Total Contents RI Exposure</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id82b512940f69405f95b400c02c2e3e67 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id82b512940f69405f95b400c02c2e3e67 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id82b512940f69405f95b400c02c2e3e67 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id82b512940f69405f95b400c02c2e3e67 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id82b512940f69405f95b400c02c2e3e67 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id82b512940f69405f95b400c02c2e3e67 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id82b512940f69405f95b400c02c2e3e67 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id82b512940f69405f95b400c02c2e3e67 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id82b512940f69405f95b400c02c2e3e67 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id82b512940f69405f95b400c02c2e3e67 input{text-align:left;}"; break;
		}
	}
