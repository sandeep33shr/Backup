...
Namespace Nexus
    Partial Class PB2_CA_BINOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_BI_CNOTE_DETAILS__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If BI_CNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		BI_CNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		BI_CNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_BI_CNOTE_DETAILS__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BI_CNOTE_DETAILS__Note_Details()
    onValidate_BI_CNOTE_DETAILS__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		BI_CNOTE_DETAILS__NoteCheck.Text = 1
        	End If
        End Sub
