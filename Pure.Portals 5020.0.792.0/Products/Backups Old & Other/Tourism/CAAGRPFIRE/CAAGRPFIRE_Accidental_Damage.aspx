<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAGRPFIRE_Accidental_Damage.aspx.vb" Inherits="Nexus.PB2_CAAGRPFIRE_Accidental_Damage" %>
...
function onValidate_LEAK_FIRST_LOSS(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
         * Check performed only when the page is submitted
...
function onValidate_LEAK_RATE(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
        (function(){
        	if (isOnLoad) {	
        		var field
        		if ("LEAK_RATE" != "{na" + "me}"){
        			field = Field.getLabel("LEAK_RATE");
        		} else { 
...
function onValidate_AD__ADTOTAL_FINAL_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "ADTOTAL_FINAL_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AD", "ADTOTAL_FINAL_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AD.ADTOTAL_FINAL_PREMIUM");
        			window.setControlWidth(field, "0.7", "AD", "ADTOTAL_FINAL_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAD_ADTOTAL_FINAL_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_AD__ADTOTAL_FINAL_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AD__ADTOTAL_FINAL_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_AD__CA_ADENPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "CA_ADENPRM", "ChildScreen");
        })();
}
function onValidate_AD__CA_ADNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "CA_ADNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("AD", "CA_ADNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_AD__CA_ADNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("AD", "CA_ADNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'AD' and property 'CA_ADNOTE'.");
        			error.display();
...
function onValidate_AD__CA_ADSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AD", "CA_ADSNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_LEAK_FIRST_LOSS(null, null, null, isOnLoad);
    onValidate_LEAK_RATE(null, null, null, isOnLoad);
    ...
    onValidate_AD__ADTOTAL_FINAL_PREMIUM(null, null, null, isOnLoad);
    onValidate_AD__CA_ADENPRM(null, null, null, isOnLoad);
    onValidate_AD__CA_ADNOTE(null, null, null, isOnLoad);
    onValidate_AD__CA_ADSNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id9a74a465b3474cafb5c96939a233e78b" class="general-layout-container">
...
<div id="ida03c0e584d01423c9d433b7999e1a732" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida03c0e584d01423c9d433b7999e1a732 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida03c0e584d01423c9d433b7999e1a732 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida03c0e584d01423c9d433b7999e1a732 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida03c0e584d01423c9d433b7999e1a732 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida03c0e584d01423c9d433b7999e1a732 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida03c0e584d01423c9d433b7999e1a732 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida03c0e584d01423c9d433b7999e1a732 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida03c0e584d01423c9d433b7999e1a732 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida03c0e584d01423c9d433b7999e1a732 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida03c0e584d01423c9d433b7999e1a732 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide4db844011894cc8928c8ba7313c577c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading117" runat="server" Text="Cover" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label382">
		<span class="label" id="label382">Full Value</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label383">
		<span class="label" id="label383">First Loss</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label384">
		<span class="label" id="label384">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label385">
		<span class="label" id="label385">Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label390">
		<span class="label" id="label390">Defined Event 1 - Property</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label391">
		<span class="label" id="label391">Defined Event 2 - Leakage</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
									...
									<li class="co-cell"  style="width:10%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-LEAK_FIRST_LOSS">
		<span class="label" id="LEAK_FIRST_LOSS"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:10%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-LEAK_RATE">
		<span class="label" id="LEAK_RATE"></span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide4db844011894cc8928c8ba7313c577c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide4db844011894cc8928c8ba7313c577c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide4db844011894cc8928c8ba7313c577c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide4db844011894cc8928c8ba7313c577c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide4db844011894cc8928c8ba7313c577c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide4db844011894cc8928c8ba7313c577c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide4db844011894cc8928c8ba7313c577c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide4db844011894cc8928c8ba7313c577c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide4db844011894cc8928c8ba7313c577c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide4db844011894cc8928c8ba7313c577c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6b2898347ecc4a0baaa80084b0c50a5d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading118" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label396">
		<span class="label" id="label396">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label397">
		<span class="label" id="label397">Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label398">
		<span class="label" id="label398">Additional Claims Preparation Costs </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6b2898347ecc4a0baaa80084b0c50a5d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6b2898347ecc4a0baaa80084b0c50a5d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6b2898347ecc4a0baaa80084b0c50a5d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6b2898347ecc4a0baaa80084b0c50a5d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6b2898347ecc4a0baaa80084b0c50a5d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6b2898347ecc4a0baaa80084b0c50a5d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6b2898347ecc4a0baaa80084b0c50a5d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6b2898347ecc4a0baaa80084b0c50a5d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6b2898347ecc4a0baaa80084b0c50a5d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6b2898347ecc4a0baaa80084b0c50a5d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf3b88d76411c45739e2266a0767de67e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading119" runat="server" Text="Memoranda" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf3b88d76411c45739e2266a0767de67e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf3b88d76411c45739e2266a0767de67e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf3b88d76411c45739e2266a0767de67e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf3b88d76411c45739e2266a0767de67e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf3b88d76411c45739e2266a0767de67e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf3b88d76411c45739e2266a0767de67e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf3b88d76411c45739e2266a0767de67e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf3b88d76411c45739e2266a0767de67e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf3b88d76411c45739e2266a0767de67e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf3b88d76411c45739e2266a0767de67e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmPrem" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="AD" 
		data-property-name="ADTOTAL_FINAL_PREMIUM" 
		id="pb-container-currency-AD-ADTOTAL_FINAL_PREMIUM">
		<asp:Label ID="lblAD_ADTOTAL_FINAL_PREMIUM" runat="server" AssociatedControlID="AD__ADTOTAL_FINAL_PREMIUM" 
			Text="Total Risk Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AD__ADTOTAL_FINAL_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valAD_ADTOTAL_FINAL_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Risk Premium"
			ClientValidationFunction="onValidate_AD__ADTOTAL_FINAL_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div id="frmend" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading122" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_AD__CA_ADENPRM"
		data-field-type="Child" 
		data-object-name="AD" 
		data-property-name="CA_ADENPRM" 
		id="pb-container-childscreen-AD-CA_ADENPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AD__AC_CLAUSE" runat="server" ScreenCode="CA_ADENPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CA_ADENPRM/CA_ADENPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valAD_CA_ADENPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for AD.CA_ADENPRM"
						ClientValidationFunction="onValidate_AD__CA_ADENPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc544672d856d46d9823c1114d99868ac" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc544672d856d46d9823c1114d99868ac div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc544672d856d46d9823c1114d99868ac div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc544672d856d46d9823c1114d99868ac div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc544672d856d46d9823c1114d99868ac label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc544672d856d46d9823c1114d99868ac label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc544672d856d46d9823c1114d99868ac label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc544672d856d46d9823c1114d99868ac label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc544672d856d46d9823c1114d99868ac input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc544672d856d46d9823c1114d99868ac input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc544672d856d46d9823c1114d99868ac input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4eb1042bfde7423c9e4c82e52909e372" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_AD__CA_ADNOTE"
		data-field-type="Child" 
		data-object-name="AD" 
		data-property-name="CA_ADNOTE" 
		id="pb-container-childscreen-AD-CA_ADNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AD__AD_CNOTE_DETAILS" runat="server" ScreenCode="CA_ADNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CA_ADNOTE/CA_ADNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valAD_CA_ADNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for AD.CA_ADNOTE"
						ClientValidationFunction="onValidate_AD__CA_ADNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4eb1042bfde7423c9e4c82e52909e372 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4eb1042bfde7423c9e4c82e52909e372 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4eb1042bfde7423c9e4c82e52909e372 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4eb1042bfde7423c9e4c82e52909e372 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4eb1042bfde7423c9e4c82e52909e372 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4eb1042bfde7423c9e4c82e52909e372 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4eb1042bfde7423c9e4c82e52909e372 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4eb1042bfde7423c9e4c82e52909e372 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4eb1042bfde7423c9e4c82e52909e372 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4eb1042bfde7423c9e4c82e52909e372 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idedefd0d2cd3d43c38ca44981aa19c12b" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_AD__CA_ADSNOTE"
		data-field-type="Child" 
		data-object-name="AD" 
		data-property-name="CA_ADSNOTE" 
		id="pb-container-childscreen-AD-CA_ADSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AD__AD_SNOTE_DETAILS" runat="server" ScreenCode="CA_ADSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CA_ADSNOTE/CA_ADSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valAD_CA_ADSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for AD.CA_ADSNOTE"
						ClientValidationFunction="onValidate_AD__CA_ADSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idedefd0d2cd3d43c38ca44981aa19c12b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idedefd0d2cd3d43c38ca44981aa19c12b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idedefd0d2cd3d43c38ca44981aa19c12b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idedefd0d2cd3d43c38ca44981aa19c12b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idedefd0d2cd3d43c38ca44981aa19c12b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idedefd0d2cd3d43c38ca44981aa19c12b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idedefd0d2cd3d43c38ca44981aa19c12b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idedefd0d2cd3d43c38ca44981aa19c12b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idedefd0d2cd3d43c38ca44981aa19c12b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idedefd0d2cd3d43c38ca44981aa19c12b input{text-align:left;}"; break;
		}
	}
