<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPECUST_Specified_Customers.aspx.vb" Inherits="Nexus.PB2_SPECUST_Specified_Customers" %>
...
<div id="iddcb614f3456e4283852874cc1466b42f" class="general-layout-container">
...
<div id="id4ca21cd1775b4690a6ece7ec5eb91343" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4ca21cd1775b4690a6ece7ec5eb91343 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4ca21cd1775b4690a6ece7ec5eb91343 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4ca21cd1775b4690a6ece7ec5eb91343 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4ca21cd1775b4690a6ece7ec5eb91343 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4ca21cd1775b4690a6ece7ec5eb91343 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4ca21cd1775b4690a6ece7ec5eb91343 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4ca21cd1775b4690a6ece7ec5eb91343 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4ca21cd1775b4690a6ece7ec5eb91343 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4ca21cd1775b4690a6ece7ec5eb91343 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4ca21cd1775b4690a6ece7ec5eb91343 input{text-align:left;}"; break;
		}
	}
