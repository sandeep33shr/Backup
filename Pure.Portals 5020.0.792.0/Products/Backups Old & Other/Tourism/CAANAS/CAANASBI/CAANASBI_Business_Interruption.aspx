<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAANASBI_Business_Interruption.aspx.vb" Inherits="Nexus.PB2_CAANASBI_Business_Interruption" %>
...
function onValidate_TNASRIA_BI__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TNASRIA_BI", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TNASRIA_BI", "SUMINSURED");
        		}
...
function onValidate_TNASRIA_BI__IND_PERIOD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TNASRIA_BI", "IND_PERIOD", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TNASRIA_BI", "IND_PERIOD");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_TNASRIA_BI__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TNASRIA_BI", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TNASRIA_BI", "RATE");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_TNASRIA_BI__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TNASRIA_BI", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TNASRIA_BI", "PREMIUM");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_TNASRIA_BI__SUMINSURED(null, null, null, isOnLoad);
    onValidate_TNASRIA_BI__IND_PERIOD(null, null, null, isOnLoad);
    onValidate_TNASRIA_BI__RATE(null, null, null, isOnLoad);
    onValidate_TNASRIA_BI__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id1f2c8b1e56ff4cd49d6fc5771c58ced3" class="general-layout-container">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label46">
		<span class="label" id="label46">Indemnity Period</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label47">
		<span class="label" id="label47">Rate </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TNASRIA_BI" 
		data-property-name="SUMINSURED" 
		id="pb-container-currency-TNASRIA_BI-SUMINSURED">
		<asp:Label ID="lblTNASRIA_BI_SUMINSURED" runat="server" AssociatedControlID="TNASRIA_BI__SUMINSURED" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TNASRIA_BI__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTNASRIA_BI_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for TNASRIA_BI.SUMINSURED"
			ClientValidationFunction="onValidate_TNASRIA_BI__SUMINSURED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="TNASRIA_BI" 
		data-property-name="IND_PERIOD" 
		 
		
		 
		id="pb-container-text-TNASRIA_BI-IND_PERIOD">

		
		<asp:Label ID="lblTNASRIA_BI_IND_PERIOD" runat="server" AssociatedControlID="TNASRIA_BI__IND_PERIOD" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TNASRIA_BI__IND_PERIOD" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTNASRIA_BI_IND_PERIOD" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for TNASRIA_BI.IND_PERIOD"
					ClientValidationFunction="onValidate_TNASRIA_BI__IND_PERIOD"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-TNASRIA_BI-RATE">
		<asp:Label ID="lblTNASRIA_BI_RATE" runat="server" AssociatedControlID="TNASRIA_BI__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="TNASRIA_BI__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valTNASRIA_BI_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for TNASRIA_BI.RATE"
			ClientValidationFunction="onValidate_TNASRIA_BI__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TNASRIA_BI-PREMIUM">
		<asp:Label ID="lblTNASRIA_BI_PREMIUM" runat="server" AssociatedControlID="TNASRIA_BI__PREMIUM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TNASRIA_BI__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTNASRIA_BI_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for TNASRIA_BI.PREMIUM"
			ClientValidationFunction="onValidate_TNASRIA_BI__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
