<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CA_EEQMP_Multiple_Premises.aspx.vb" Inherits="Nexus.PB2_CA_EEQMP_Multiple_Premises" %>
...
<div id="idaf6c134324bf4e928345d7ff6b1c26a5" class="general-layout-container">
...
<div id="idfb29f670053a4e82a1ee2a5e9ad9d648" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading177" runat="server" Text="Multiple Premises" /></legend>
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_LINE2" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__LINE2" 
			Text="Line 2" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EE_MULTIPLE_PREMISES__LINE2" runat="server" CssClass="form-control" data-type="Text" />
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_LINE3" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__LINE3" 
			Text="Line 3" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EE_MULTIPLE_PREMISES__LINE3" runat="server" CssClass="form-control" data-type="Text" />
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_LINE4" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__LINE4" 
			Text="Line 4" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EE_MULTIPLE_PREMISES__LINE4" runat="server" CssClass="form-control" data-type="Text" />
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblEE_MULTIPLE_PREMISES_COUNTRY_CAP" runat="server" AssociatedControlID="EE_MULTIPLE_PREMISES__COUNTRY_CAP" 
			Text="Country" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EE_MULTIPLE_PREMISES__COUNTRY_CAP" runat="server" CssClass="form-control" data-type="Text" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfb29f670053a4e82a1ee2a5e9ad9d648 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfb29f670053a4e82a1ee2a5e9ad9d648 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfb29f670053a4e82a1ee2a5e9ad9d648 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfb29f670053a4e82a1ee2a5e9ad9d648 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfb29f670053a4e82a1ee2a5e9ad9d648 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfb29f670053a4e82a1ee2a5e9ad9d648 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfb29f670053a4e82a1ee2a5e9ad9d648 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfb29f670053a4e82a1ee2a5e9ad9d648 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfb29f670053a4e82a1ee2a5e9ad9d648 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfb29f670053a4e82a1ee2a5e9ad9d648 input{text-align:left;}"; break;
		}
	}
