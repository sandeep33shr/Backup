<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBKITEMS_Machinery_Breakdown.aspx.vb" Inherits="Nexus.PB2_MBKITEMS_Machinery_Breakdown" %>
...
function onValidate_MB_ITEM__MBK_TMP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBK_TMP", "ChildScreen");
        })();
}
...
function onValidate_MB_ITEM__MBK_NOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBK_NOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MB_ITEM", "MBK_NOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_MB_ITEM__MBK_NOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MB_ITEM", "MBK_NOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MB_ITEM' and property 'MBK_NOTE'.");
        			error.display();
...
function onValidate_MB_ITEM__MBK_SNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBK_SNOTE", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MB_ITEM__MBK_TMP(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBI_END_COUNT(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBK_NOTE(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBK_SNOTE(null, null, null, isOnLoad);
...
<div id="idae94a3045b764d80b4f1adbc72d39949" class="general-layout-container">
...
<div id="id41820f6b105e4c41a7a954f1663550a5" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading209" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id41820f6b105e4c41a7a954f1663550a5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id41820f6b105e4c41a7a954f1663550a5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id41820f6b105e4c41a7a954f1663550a5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id41820f6b105e4c41a7a954f1663550a5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id41820f6b105e4c41a7a954f1663550a5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id41820f6b105e4c41a7a954f1663550a5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id41820f6b105e4c41a7a954f1663550a5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id41820f6b105e4c41a7a954f1663550a5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id41820f6b105e4c41a7a954f1663550a5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id41820f6b105e4c41a7a954f1663550a5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8bd5bdbba5cb4b3fb777c539f3430e17" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading210" runat="server" Text="Endorsements" /></legend>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBK_TMP"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBK_TMP" 
		id="pb-container-childscreen-MB_ITEM-MBK_TMP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITMS_CLAUSEPREM" runat="server" ScreenCode="MBK_TMP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBK_TMP/MBK_TMP_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBK_TMP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBK_TMP"
						ClientValidationFunction="onValidate_MB_ITEM__MBK_TMP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8bd5bdbba5cb4b3fb777c539f3430e17 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8bd5bdbba5cb4b3fb777c539f3430e17 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8bd5bdbba5cb4b3fb777c539f3430e17 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8bd5bdbba5cb4b3fb777c539f3430e17 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8bd5bdbba5cb4b3fb777c539f3430e17 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8bd5bdbba5cb4b3fb777c539f3430e17 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8bd5bdbba5cb4b3fb777c539f3430e17 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8bd5bdbba5cb4b3fb777c539f3430e17 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8bd5bdbba5cb4b3fb777c539f3430e17 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8bd5bdbba5cb4b3fb777c539f3430e17 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc0a568bbdfb84952ab797fa33df5949c" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading211" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBK_NOTE"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBK_NOTE" 
		id="pb-container-childscreen-MB_ITEM-MBK_NOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITMS_CNOTE" runat="server" ScreenCode="MBK_NOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBK_NOTE/MBK_NOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBK_NOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBK_NOTE"
						ClientValidationFunction="onValidate_MB_ITEM__MBK_NOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc0a568bbdfb84952ab797fa33df5949c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc0a568bbdfb84952ab797fa33df5949c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc0a568bbdfb84952ab797fa33df5949c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc0a568bbdfb84952ab797fa33df5949c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc0a568bbdfb84952ab797fa33df5949c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc0a568bbdfb84952ab797fa33df5949c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc0a568bbdfb84952ab797fa33df5949c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc0a568bbdfb84952ab797fa33df5949c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc0a568bbdfb84952ab797fa33df5949c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc0a568bbdfb84952ab797fa33df5949c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide544c095f8b6460cb6aa788c93eda590" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading212" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBK_SNOTE"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBK_SNOTE" 
		id="pb-container-childscreen-MB_ITEM-MBK_SNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITMS_SCNOTE" runat="server" ScreenCode="MBK_SNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBK_SNOTE/MBK_SNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBK_SNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBK_SNOTE"
						ClientValidationFunction="onValidate_MB_ITEM__MBK_SNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide544c095f8b6460cb6aa788c93eda590 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide544c095f8b6460cb6aa788c93eda590 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide544c095f8b6460cb6aa788c93eda590 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide544c095f8b6460cb6aa788c93eda590 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide544c095f8b6460cb6aa788c93eda590 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide544c095f8b6460cb6aa788c93eda590 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide544c095f8b6460cb6aa788c93eda590 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide544c095f8b6460cb6aa788c93eda590 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide544c095f8b6460cb6aa788c93eda590 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide544c095f8b6460cb6aa788c93eda590 input{text-align:left;}"; break;
		}
	}
