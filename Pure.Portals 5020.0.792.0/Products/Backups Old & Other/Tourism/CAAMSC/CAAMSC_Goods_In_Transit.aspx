<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMSC_Goods_In_Transit.aspx.vb" Inherits="Nexus.PB2_CAAMSC_Goods_In_Transit" %>
...
function onValidate_GIT__LL_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GIT.LL_POST_PREM.setValue(GIT.LL_SI*GIT.LL_NUM)");
        		var whenExp = (Expression.isValidParameter("GIT.LL_RATE == '' OR GIT.LL_RATE == null")) ? new Expression("GIT.LL_RATE == '' OR GIT.LL_RATE == null") : null;
        		var elseExp = Expression.isValidParameter("GIT.LL_POST_PREM.setValue((GIT.LL_SI*GIT.LL_NUM*GIT.LL_RATE)/100)") ? new Expression("GIT.LL_POST_PREM.setValue((GIT.LL_SI*GIT.LL_NUM*GIT.LL_RATE)/100)") : null;
...
function onValidate_GIT__LL_NUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var elseExp = Expression.isValidParameter("GIT.LL_POST_PREM.setValue(GIT.LL_SI*GIT.LL_NUM)") ? new Expression("GIT.LL_POST_PREM.setValue(GIT.LL_SI*GIT.LL_NUM)") : null;
...
function onValidate_GIT_EXTENSIONS__ACPC_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "GIT_EXTENSIONS.IS_ACPC=1 && GIT.IS_MIGRATED = 0 && GENERAL.TRANSTYPE =='NB'", "VE", "Additional Claims Preparation Costs Rate is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "GIT_EXTENSIONS.IS_ACPC=1 && GIT.IS_MIGRATED = 0 && GENERAL.TRANSTYPE =='NB'",
            paramElseValue = "VE",
...
function onValidate_GIT_EXTENSIONS__DEB_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "GIT_EXTENSIONS.IS_DEB=1 && GIT.IS_MIGRATED = 0 && GENERAL.TRANSTYPE =='NB'", "VE", "Debris Removal Rate is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "GIT_EXTENSIONS.IS_DEB=1 && GIT.IS_MIGRATED = 0 && GENERAL.TRANSTYPE =='NB'",
            paramElseValue = "VE",
...
function onValidate_GIT__GT_ENPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT", "GT_ENPREM", "ChildScreen");
        })();
}
...
function onValidate_GIT_NOTES__GT_NOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_NOTES", "GT_NOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GIT_NOTES", "GT_NOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_GIT_NOTES__GT_NOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GIT_NOTES", "GT_NOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'GIT_NOTES' and property 'GT_NOTES'.");
        			error.display();
...
function onValidate_GIT_NOTES__GT_SNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GIT_NOTES", "GT_SNOTES", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GIT__GT_ENPREM(null, null, null, isOnLoad);
    onValidate_GIT__GIT_END_CNT(null, null, null, isOnLoad);
    onValidate_GIT_NOTES__GT_NOTES(null, null, null, isOnLoad);
    onValidate_GIT_NOTES__GT_SNOTES(null, null, null, isOnLoad);
...
<div id="id159141f6f62045e99f29c40b77887083" class="general-layout-container">
...
<div id="id60cdbcdf737144a6bebe7b254be67a1f" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading87" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id60cdbcdf737144a6bebe7b254be67a1f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id60cdbcdf737144a6bebe7b254be67a1f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id60cdbcdf737144a6bebe7b254be67a1f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id60cdbcdf737144a6bebe7b254be67a1f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id60cdbcdf737144a6bebe7b254be67a1f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60cdbcdf737144a6bebe7b254be67a1f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60cdbcdf737144a6bebe7b254be67a1f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id60cdbcdf737144a6bebe7b254be67a1f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60cdbcdf737144a6bebe7b254be67a1f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60cdbcdf737144a6bebe7b254be67a1f input{text-align:left;}"; break;
		}
	}
...
<div id="Pastclaimscount" class="column-layout-container,no-border  ">
	...
	<span id="pb-container-label-label181">
		<span class="label" id="label181"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label182">
		<span class="label" id="label182">0-12 Months</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label183">
		<span class="label" id="label183">Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label184">
		<span class="label" id="label184">13-24 Months</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label186">
		<span class="label" id="label186">25-36 Months</span>
	</span>
<!-- /Label -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id25a31dddf75140239b33ff260c3599ae" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading89" runat="server" Text="Rating Method" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGIT_BASIS_OF_RATING" runat="server" AssociatedControlID="GIT__BASIS_OF_RATING" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="GIT__BASIS_OF_RATING" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CAA_GIT_BASISRATING" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_GIT__BASIS_OF_RATING(null, null, this);" data-type="List" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id25a31dddf75140239b33ff260c3599ae div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id25a31dddf75140239b33ff260c3599ae div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id25a31dddf75140239b33ff260c3599ae div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id25a31dddf75140239b33ff260c3599ae label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id25a31dddf75140239b33ff260c3599ae label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id25a31dddf75140239b33ff260c3599ae label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id25a31dddf75140239b33ff260c3599ae label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id25a31dddf75140239b33ff260c3599ae input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id25a31dddf75140239b33ff260c3599ae input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id25a31dddf75140239b33ff260c3599ae input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida70fdc2aa27047418d6cc5ca1c59d22d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading90" runat="server" Text="Means of Conveyance" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida70fdc2aa27047418d6cc5ca1c59d22d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida70fdc2aa27047418d6cc5ca1c59d22d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida70fdc2aa27047418d6cc5ca1c59d22d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida70fdc2aa27047418d6cc5ca1c59d22d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida70fdc2aa27047418d6cc5ca1c59d22d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida70fdc2aa27047418d6cc5ca1c59d22d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida70fdc2aa27047418d6cc5ca1c59d22d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida70fdc2aa27047418d6cc5ca1c59d22d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida70fdc2aa27047418d6cc5ca1c59d22d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida70fdc2aa27047418d6cc5ca1c59d22d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6094e28520804ff59a058a43b51544d4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading91" runat="server" Text="Description of Goods Carried" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6094e28520804ff59a058a43b51544d4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6094e28520804ff59a058a43b51544d4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6094e28520804ff59a058a43b51544d4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6094e28520804ff59a058a43b51544d4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6094e28520804ff59a058a43b51544d4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6094e28520804ff59a058a43b51544d4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6094e28520804ff59a058a43b51544d4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6094e28520804ff59a058a43b51544d4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6094e28520804ff59a058a43b51544d4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6094e28520804ff59a058a43b51544d4 input{text-align:left;}"; break;
		}
	}
...
<div id="frmAC" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading92" runat="server" Text="Goods in Transit - Annual Carry" /></legend>
	...
	<span id="pb-container-label-label189">
		<span class="label" id="label189">Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label190">
		<span class="label" id="label190">Load Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label191">
		<span class="label" id="label191">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label192">
		<span class="label" id="label192">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label193">
		<span class="label" id="label193">Posting Premium</span>
	</span>
<!-- /Label -->
...
<div id="frmLL" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading93" runat="server" Text="Goods in Transit - Load Limit" /></legend>
	...
	<span id="pb-container-label-label194">
		<span class="label" id="label194">Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label195">
		<span class="label" id="label195">Number of Vehicles</span>
	</span>
<!-- /Label -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide586b149d9f14608a455cee9bc2a7af1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading94" runat="server" Text="First Amount Payable" /></legend>
	...
	<span id="pb-container-label-label199">
		<span class="label" id="label199"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label200">
		<span class="label" id="label200">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label201">
		<span class="label" id="label201">Min Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label202">
		<span class="label" id="label202">Max Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label203">
		<span class="label" id="label203">Basic</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label204">
		<span class="label" id="label204">Theft</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label205">
		<span class="label" id="label205">Additional First Amount Payable</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide586b149d9f14608a455cee9bc2a7af1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide586b149d9f14608a455cee9bc2a7af1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide586b149d9f14608a455cee9bc2a7af1 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide586b149d9f14608a455cee9bc2a7af1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide586b149d9f14608a455cee9bc2a7af1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide586b149d9f14608a455cee9bc2a7af1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide586b149d9f14608a455cee9bc2a7af1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide586b149d9f14608a455cee9bc2a7af1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide586b149d9f14608a455cee9bc2a7af1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide586b149d9f14608a455cee9bc2a7af1 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8598c6640b4142e79739d05f1f8ea11e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading95" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label208">
		<span class="label" id="label208">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label209">
		<span class="label" id="label209">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label210">
		<span class="label" id="label210">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label211">
		<span class="label" id="label211">Posting Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label212">
		<span class="label" id="label212">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label213">
		<span class="label" id="label213">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label214">
		<span class="label" id="label214">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label217">
		<span class="label" id="label217">Debris Removal</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label218">
		<span class="label" id="label218">Riot & Strike</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label220">
		<span class="label" id="label220"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label221">
		<span class="label" id="label221">NASRIA - Goods in Transit</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label225">
		<span class="label" id="label225"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label228">
		<span class="label" id="label228">Total</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8598c6640b4142e79739d05f1f8ea11e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8598c6640b4142e79739d05f1f8ea11e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8598c6640b4142e79739d05f1f8ea11e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8598c6640b4142e79739d05f1f8ea11e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8598c6640b4142e79739d05f1f8ea11e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8598c6640b4142e79739d05f1f8ea11e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8598c6640b4142e79739d05f1f8ea11e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8598c6640b4142e79739d05f1f8ea11e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8598c6640b4142e79739d05f1f8ea11e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8598c6640b4142e79739d05f1f8ea11e input{text-align:left;}"; break;
		}
	}
...
<div id="frmEndorsement" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading96" runat="server" Text="Endorsements" /></legend>
...
<div id="frmEndorsement" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading98" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GIT__GT_ENPREM"
		data-field-type="Child" 
		data-object-name="GIT" 
		data-property-name="GT_ENPREM" 
		id="pb-container-childscreen-GIT-GT_ENPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GIT__GIT_CLAUSEPREM" runat="server" ScreenCode="GT_ENPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GT_ENPREM/GT_ENPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valGIT_GT_ENPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GIT.GT_ENPREM"
						ClientValidationFunction="onValidate_GIT__GT_ENPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2b115217d9f54fa68601217d2f5f85e6" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading99" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GIT_NOTES__GT_NOTES"
		data-field-type="Child" 
		data-object-name="GIT_NOTES" 
		data-property-name="GT_NOTES" 
		id="pb-container-childscreen-GIT_NOTES-GT_NOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GIT_NOTES__GIT_CNOTE_DETAILS" runat="server" ScreenCode="GT_NOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GT_NOTES/GT_NOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGIT_NOTES_GT_NOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GIT_NOTES.GT_NOTES"
						ClientValidationFunction="onValidate_GIT_NOTES__GT_NOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2b115217d9f54fa68601217d2f5f85e6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2b115217d9f54fa68601217d2f5f85e6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2b115217d9f54fa68601217d2f5f85e6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2b115217d9f54fa68601217d2f5f85e6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2b115217d9f54fa68601217d2f5f85e6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b115217d9f54fa68601217d2f5f85e6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b115217d9f54fa68601217d2f5f85e6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2b115217d9f54fa68601217d2f5f85e6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b115217d9f54fa68601217d2f5f85e6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b115217d9f54fa68601217d2f5f85e6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id44474b405e13414a89db546a7ef4fffc" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading100" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GIT_NOTES__GT_SNOTES"
		data-field-type="Child" 
		data-object-name="GIT_NOTES" 
		data-property-name="GT_SNOTES" 
		id="pb-container-childscreen-GIT_NOTES-GT_SNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GIT_NOTES__GIT_SCNOTE_DETAILS" runat="server" ScreenCode="GT_SNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GT_SNOTES/GT_SNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGIT_NOTES_GT_SNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GIT_NOTES.GT_SNOTES"
						ClientValidationFunction="onValidate_GIT_NOTES__GT_SNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id44474b405e13414a89db546a7ef4fffc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id44474b405e13414a89db546a7ef4fffc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id44474b405e13414a89db546a7ef4fffc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id44474b405e13414a89db546a7ef4fffc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id44474b405e13414a89db546a7ef4fffc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id44474b405e13414a89db546a7ef4fffc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id44474b405e13414a89db546a7ef4fffc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id44474b405e13414a89db546a7ef4fffc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id44474b405e13414a89db546a7ef4fffc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id44474b405e13414a89db546a7ef4fffc input{text-align:left;}"; break;
		}
	}
