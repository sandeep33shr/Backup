<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EEENOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_EEENOTES_Note_Details" %>
...
<div id="idac41e911df2e4c89bad3d98a184af784" class="general-layout-container">
...
<div id="id0c4b487d24de4b6ebb33e1b085f32d12" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading166" runat="server" Text="Note Details (Not Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0c4b487d24de4b6ebb33e1b085f32d12 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0c4b487d24de4b6ebb33e1b085f32d12 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0c4b487d24de4b6ebb33e1b085f32d12 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0c4b487d24de4b6ebb33e1b085f32d12 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0c4b487d24de4b6ebb33e1b085f32d12 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0c4b487d24de4b6ebb33e1b085f32d12 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0c4b487d24de4b6ebb33e1b085f32d12 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0c4b487d24de4b6ebb33e1b085f32d12 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0c4b487d24de4b6ebb33e1b085f32d12 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0c4b487d24de4b6ebb33e1b085f32d12 input{text-align:left;}"; break;
		}
	}
