...
Namespace Nexus
    Partial Class PB2_CA_EELCHLD_Electric_Equipment_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_ELECTEQ__COUNTER_ID()
        
End Sub
Protected Sub onValidate_ELECTEQ__INCR()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ELECTEQ__COUNTER_ID()
    onValidate_ELECTEQ__INCR()
End Sub

		    
        'ELECTEQUIP - Parent object
        'ELECTEQ - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "ELECTEQUIP" & "/" & "ELECTEQ", sXMLDataset)
                            If sChildId <> "0" Then
                                ELECTEQ__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        Protected Shadows Sub Page_Load_INCR(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	Session("Refresh") = "1"
        End Sub
