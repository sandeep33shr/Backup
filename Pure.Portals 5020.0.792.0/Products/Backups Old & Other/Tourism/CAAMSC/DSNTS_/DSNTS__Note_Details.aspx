<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DSNTS__Note_Details.aspx.vb" Inherits="Nexus.PB2_DSNTS__Note_Details" %>
...
<div id="idf391f774ad2845ff84ad9bc9159bf947" class="general-layout-container">
...
<div id="id203fb2def3ec44768e3e826d793de9c6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading274" runat="server" Text="Note Details (Not Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id203fb2def3ec44768e3e826d793de9c6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id203fb2def3ec44768e3e826d793de9c6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id203fb2def3ec44768e3e826d793de9c6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id203fb2def3ec44768e3e826d793de9c6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id203fb2def3ec44768e3e826d793de9c6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id203fb2def3ec44768e3e826d793de9c6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id203fb2def3ec44768e3e826d793de9c6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id203fb2def3ec44768e3e826d793de9c6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id203fb2def3ec44768e3e826d793de9c6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id203fb2def3ec44768e3e826d793de9c6 input{text-align:left;}"; break;
		}
	}
