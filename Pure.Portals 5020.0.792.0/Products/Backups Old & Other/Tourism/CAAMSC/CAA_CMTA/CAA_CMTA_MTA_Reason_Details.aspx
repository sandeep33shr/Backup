<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAA_CMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_CAA_CMTA_MTA_Reason_Details" %>
...
<div id="id0ac261d0057b4050ae2b35f275aa797c" class="general-layout-container">
...
<div id="id814e9ae7213e4f9383aef2ba4ccf339f" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id814e9ae7213e4f9383aef2ba4ccf339f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id814e9ae7213e4f9383aef2ba4ccf339f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id814e9ae7213e4f9383aef2ba4ccf339f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id814e9ae7213e4f9383aef2ba4ccf339f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id814e9ae7213e4f9383aef2ba4ccf339f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id814e9ae7213e4f9383aef2ba4ccf339f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id814e9ae7213e4f9383aef2ba4ccf339f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id814e9ae7213e4f9383aef2ba4ccf339f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id814e9ae7213e4f9383aef2ba4ccf339f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id814e9ae7213e4f9383aef2ba4ccf339f input{text-align:left;}"; break;
		}
	}
