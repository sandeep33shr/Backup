<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMSC_Theft.aspx.vb" Inherits="Nexus.PB2_CAAMSC_Theft" %>
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("THEFT.AC_FAP"), 
        			condition = (Expression.isValidParameter("THEFT.FAP_PERC < THEFT.AC_FAP || THEFT.FAP_PERC = '' || THEFT.FAP_PERC = null")) ? new Expression("THEFT.FAP_PERC < THEFT.AC_FAP || THEFT.FAP_PERC = '' || THEFT.FAP_PERC = null") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("All Contents FAP % must be greater than 0 and less than 100")) ? "All Contents FAP % must be greater than 0 and less than 100" : null;
        			args.IsValid = false;
        			if (message != null){
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("THEFT.AC_MIN"), 
        			condition = (Expression.isValidParameter("THEFT.MIN_AMNT < THEFT.AC_MIN || THEFT.MIN_AMNT = '' || THEFT.MIN_AMNT = null")) ? new Expression("THEFT.MIN_AMNT < THEFT.AC_MIN || THEFT.MIN_AMNT = '' || THEFT.MIN_AMNT = null") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_THEFT__THEFT_TPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "THEFT", "THEFT_TPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("THEFT", "THEFT_TPREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("THEFT.THEFT_TPREM");
        			window.setControlWidth(field, "0.3", "THEFT", "THEFT_TPREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTHEFT_THEFT_TPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_THEFT__THEFT_TPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_THEFT__THEFT_TPREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_THEFT__CA_THFTEND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "THEFT", "CA_THFTEND", "ChildScreen");
        })();
}
function onValidate_THEFT_NOTES__CA_THFNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "THEFT_NOTES", "CA_THFNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("THEFT_NOTES", "CA_THFNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_THEFT_NOTES__CA_THFNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("THEFT_NOTES", "CA_THFNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'THEFT_NOTES' and property 'CA_THFNOTE'.");
        			error.display();
...
function onValidate_THEFT_NOTES__CA_THFSNTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "THEFT_NOTES", "CA_THFSNTE", "ChildScreen");
        })();
}
function onValidate_THEFT_NOTES__TFT_NTS_CNT(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @param THEFT_SCNOTE_DETAILS.DATE_CREATED The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var childFieldStr = "THEFT_SCNOTE_DETAILS.DATE_CREATED";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_THEFT__THEFT_TPREM(null, null, null, isOnLoad);
    onValidate_THEFT__CA_THFTEND(null, null, null, isOnLoad);
    onValidate_THEFT_NOTES__CA_THFNOTE(null, null, null, isOnLoad);
    onValidate_THEFT_NOTES__CA_THFSNTE(null, null, null, isOnLoad);
...
<div id="id2f6714c9c4fe443cb0f62a86297c3d1a" class="general-layout-container">
...
<div id="id5a14a17bb1ab4d5c803e622171e7d12e" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5a14a17bb1ab4d5c803e622171e7d12e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5a14a17bb1ab4d5c803e622171e7d12e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5a14a17bb1ab4d5c803e622171e7d12e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5a14a17bb1ab4d5c803e622171e7d12e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5a14a17bb1ab4d5c803e622171e7d12e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5a14a17bb1ab4d5c803e622171e7d12e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5a14a17bb1ab4d5c803e622171e7d12e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5a14a17bb1ab4d5c803e622171e7d12e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5a14a17bb1ab4d5c803e622171e7d12e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5a14a17bb1ab4d5c803e622171e7d12e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id42570c58d27c466e8fea64c1ba33c93e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading48" runat="server" Text="Malicious Damage Following Theft" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id42570c58d27c466e8fea64c1ba33c93e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id42570c58d27c466e8fea64c1ba33c93e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id42570c58d27c466e8fea64c1ba33c93e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id42570c58d27c466e8fea64c1ba33c93e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id42570c58d27c466e8fea64c1ba33c93e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id42570c58d27c466e8fea64c1ba33c93e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id42570c58d27c466e8fea64c1ba33c93e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id42570c58d27c466e8fea64c1ba33c93e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id42570c58d27c466e8fea64c1ba33c93e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id42570c58d27c466e8fea64c1ba33c93e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id624a66d34c5245b1bef15db24f23ea51" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading49" runat="server" Text="Past Claims Count" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label48">
		<span class="label" id="label48">0-12 Months</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label49">
		<span class="label" id="label49">Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label50">
		<span class="label" id="label50">13-24 Months</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label51">
		<span class="label" id="label51">Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label52">
		<span class="label" id="label52">25-36 Months</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label53">
		<span class="label" id="label53">Amount</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id624a66d34c5245b1bef15db24f23ea51 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id624a66d34c5245b1bef15db24f23ea51 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id624a66d34c5245b1bef15db24f23ea51 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id624a66d34c5245b1bef15db24f23ea51 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id624a66d34c5245b1bef15db24f23ea51 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id624a66d34c5245b1bef15db24f23ea51 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id624a66d34c5245b1bef15db24f23ea51 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id624a66d34c5245b1bef15db24f23ea51 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id624a66d34c5245b1bef15db24f23ea51 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id624a66d34c5245b1bef15db24f23ea51 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida74463b3eef941eda59c037bcf80c7e6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading50" runat="server" Text="All Contents" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label57">
		<span class="label" id="label57">Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label58">
		<span class="label" id="label58">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label59">
		<span class="label" id="label59">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label60">
		<span class="label" id="label60">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label62">
		<span class="label" id="label62">Min Amount</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida74463b3eef941eda59c037bcf80c7e6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida74463b3eef941eda59c037bcf80c7e6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida74463b3eef941eda59c037bcf80c7e6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida74463b3eef941eda59c037bcf80c7e6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida74463b3eef941eda59c037bcf80c7e6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida74463b3eef941eda59c037bcf80c7e6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida74463b3eef941eda59c037bcf80c7e6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida74463b3eef941eda59c037bcf80c7e6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida74463b3eef941eda59c037bcf80c7e6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida74463b3eef941eda59c037bcf80c7e6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id971d277d03f54d7eb18fe6c05d36c255" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading51" runat="server" Text="Extensions" /></legend>
				
				
				<div data-column-count="6" data-column-ratio="10:30:20:15:15:10" data-layout="" class="clearfix form-horizontal">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label67">
		<span class="label" id="label67">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label68">
		<span class="label" id="label68">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label69">
		<span class="label" id="label69">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label70">
		<span class="label" id="label70">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label72">
		<span class="label" id="label72">Additional Damage to Building</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label74">
		<span class="label" id="label74">Total</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id971d277d03f54d7eb18fe6c05d36c255 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id971d277d03f54d7eb18fe6c05d36c255 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id971d277d03f54d7eb18fe6c05d36c255 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id971d277d03f54d7eb18fe6c05d36c255 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id971d277d03f54d7eb18fe6c05d36c255 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id971d277d03f54d7eb18fe6c05d36c255 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id971d277d03f54d7eb18fe6c05d36c255 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id971d277d03f54d7eb18fe6c05d36c255 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id971d277d03f54d7eb18fe6c05d36c255 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id971d277d03f54d7eb18fe6c05d36c255 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida6d7409d0ca54ed992218798e53a55f2" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="THEFT" 
		data-property-name="THEFT_TPREM" 
		id="pb-container-currency-THEFT-THEFT_TPREM">
		<asp:Label ID="lblTHEFT_THEFT_TPREM" runat="server" AssociatedControlID="THEFT__THEFT_TPREM" 
			Text="Total Risk Premium " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="THEFT__THEFT_TPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTHEFT_THEFT_TPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Risk Premium "
			ClientValidationFunction="onValidate_THEFT__THEFT_TPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida6d7409d0ca54ed992218798e53a55f2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida6d7409d0ca54ed992218798e53a55f2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida6d7409d0ca54ed992218798e53a55f2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida6d7409d0ca54ed992218798e53a55f2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida6d7409d0ca54ed992218798e53a55f2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida6d7409d0ca54ed992218798e53a55f2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida6d7409d0ca54ed992218798e53a55f2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#