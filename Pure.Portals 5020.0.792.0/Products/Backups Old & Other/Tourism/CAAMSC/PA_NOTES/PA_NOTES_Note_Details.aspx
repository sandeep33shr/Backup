<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PA_NOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_PA_NOTES_Note_Details" %>
...
function onValidate_PASNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PASNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PASNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PASNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "PASNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=PASNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_PASNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PASNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PASNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PASNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "PASNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_PASNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PASNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PASNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PASNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "PASNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=PASNOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_PASNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PASNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PASNOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PASNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "PASNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PASNOTES", "NOTE_DESCRIPTION");
        		var exp = new Expression("PASNOTES.NoteCheck = 1");
...
function onValidate_PASNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PASNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PASNOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PASNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "PASNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=PASNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_PASNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_PASNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_PASNOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PASNOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PASNOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_PASNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_PASNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_PASNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_PASNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_PASNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_PASNOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id8fc68af10a684c64850c2b4a125693d0" class="general-layout-container">
...
<div id="id67e3160fca67484a85cb45a8a1257a60" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading104" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PASNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-PASNOTES-DATE_CREATED">
		<asp:Label ID="lblPASNOTES_DATE_CREATED" runat="server" AssociatedControlID="PASNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="PASNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calPASNOTES__DATE_CREATED" runat="server" LinkedControl="PASNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valPASNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_PASNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PASNOTES-CREATED_BY">

		
		<asp:Label ID="lblPASNOTES_CREATED_BY" runat="server" AssociatedControlID="PASNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PASNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPASNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_PASNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PASNOTES-COVER_TYPE">

		
		<asp:Label ID="lblPASNOTES_COVER_TYPE" runat="server" AssociatedControlID="PASNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PASNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPASNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_PASNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PASNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblPASNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="PASNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PASNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPASNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_PASNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-PASNOTES-NOTE_DETAILS">
		<asp:Label ID="lblPASNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="PASNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="PASNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valPASNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_PASNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblPASNOTES_NoteCheck" for="ctl00_cntMainBody_PASNOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-PASNOTES-NoteCheck">	
		
		<asp:TextBox ID="PASNOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valPASNOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_PASNOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id67e3160fca67484a85cb45a8a1257a60 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id67e3160fca67484a85cb45a8a1257a60 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id67e3160fca67484a85cb45a8a1257a60 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id67e3160fca67484a85cb45a8a1257a60 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id67e3160fca67484a85cb45a8a1257a60 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id67e3160fca67484a85cb45a8a1257a60 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id67e3160fca67484a85cb45a8a1257a60 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id67e3160fca67484a85cb45a8a1257a60 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id67e3160fca67484a85cb45a8a1257a60 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id67e3160fca67484a85cb45a8a1257a60 input{text-align:left;}"; break;
		}
	}
