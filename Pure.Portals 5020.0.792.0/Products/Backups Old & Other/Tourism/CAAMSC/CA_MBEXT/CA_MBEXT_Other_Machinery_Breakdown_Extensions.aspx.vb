...
Namespace Nexus
    Partial Class PB2_CA_MBEXT_Other_Machinery_Breakdown_Extensions : Inherits BaseRisk
		...
		Protected Sub onValidate_MB_OEXTENSIONS__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MB_OEXTENSIONS__COUNTER_ID()
End Sub

		    
        'MBREAK - Parent object
        'MB_OEXTENSIONS - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "MBREAK" & "/" & "MB_OEXTENSIONS", sXMLDataset)
                            If sChildId <> "0" Then
                                MB_OEXTENSIONS__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
