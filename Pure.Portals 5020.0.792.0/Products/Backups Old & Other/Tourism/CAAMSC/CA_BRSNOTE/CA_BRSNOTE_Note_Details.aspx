<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CA_BRSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_CA_BRSNOTE_Note_Details" %>
...
<div id="id4c1859accf9c4949b42879387f42beaf" class="general-layout-container">
...
<div id="idd68b6206f1994b5f8ca72f98f48e0c25" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd68b6206f1994b5f8ca72f98f48e0c25 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd68b6206f1994b5f8ca72f98f48e0c25 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd68b6206f1994b5f8ca72f98f48e0c25 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd68b6206f1994b5f8ca72f98f48e0c25 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd68b6206f1994b5f8ca72f98f48e0c25 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd68b6206f1994b5f8ca72f98f48e0c25 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd68b6206f1994b5f8ca72f98f48e0c25 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd68b6206f1994b5f8ca72f98f48e0c25 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd68b6206f1994b5f8ca72f98f48e0c25 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd68b6206f1994b5f8ca72f98f48e0c25 input{text-align:left;}"; break;
		}
	}
