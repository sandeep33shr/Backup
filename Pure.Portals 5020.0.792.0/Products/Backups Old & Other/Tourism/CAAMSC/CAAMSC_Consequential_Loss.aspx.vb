...
Namespace Nexus
    Partial Class PB2_CAAMSC_Consequential_Loss : Inherits BaseRisk
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (CONSL__ATTACHMENTDATE.Text <> "" Or CONSL__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
