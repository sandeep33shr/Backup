<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMSC_Machinery_Breakdown_Overview.aspx.vb" Inherits="Nexus.PB2_CAAMSC_Machinery_Breakdown_Overview" %>
...
function onValidate_label552(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label552" != "{na" + "me}"){
        			instance = Field.getLabel("label552");
        		} else { 
...
function onValidate_label553(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label553" != "{na" + "me}"){
        			instance = Field.getLabel("label553");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label554(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label554" != "{na" + "me}"){
        			instance = Field.getLabel("label554");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label555(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label555" != "{na" + "me}"){
        			instance = Field.getLabel("label555");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label556(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label556" != "{na" + "me}"){
        			instance = Field.getLabel("label556");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label557(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label557" != "{na" + "me}"){
        			instance = Field.getLabel("label557");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label558(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label558" != "{na" + "me}"){
        			instance = Field.getLabel("label558");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label559(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label559" != "{na" + "me}"){
        			instance = Field.getLabel("label559");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label560(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label560" != "{na" + "me}"){
        			instance = Field.getLabel("label560");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label561(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label561" != "{na" + "me}"){
        			instance = Field.getLabel("label561");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_label552(null, null, null, isOnLoad);
    onValidate_label553(null, null, null, isOnLoad);
    onValidate_label554(null, null, null, isOnLoad);
    onValidate_label555(null, null, null, isOnLoad);
    onValidate_label556(null, null, null, isOnLoad);
    ...
    onValidate_label557(null, null, null, isOnLoad);
    ...
    onValidate_label558(null, null, null, isOnLoad);
    ...
    onValidate_label559(null, null, null, isOnLoad);
    ...
    onValidate_label560(null, null, null, isOnLoad);
    ...
    onValidate_label561(null, null, null, isOnLoad);
...
<div id="idbcb1b36bba424112811d051916e9e13b" class="general-layout-container">
...
<div id="id25013a775c2441d7989f5a0d4d4d1be1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading277" runat="server" Text="Combined Reinsurance Exposure" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label552">
		<span class="label" id="label552">Total Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label553">
		<span class="label" id="label553">EML%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label554">
		<span class="label" id="label554">RI Exposure (VAT Incl.)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label555">
		<span class="label" id="label555">RI Exposure (VAT Excl.)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label556">
		<span class="label" id="label556">Machinery Breakdown</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label557">
		<span class="label" id="label557">Machinery Breakdown Additional Claims Preparation Cost</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label558">
		<span class="label" id="label558">Consequential Loss Gross Profit/Revenue</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label559">
		<span class="label" id="label559">Consequential Loss Additional Claims Preparation Cost</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label560">
		<span class="label" id="label560">Deterioration of Stock</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label561">
		<span class="label" id="label561">Totals</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id25013a775c2441d7989f5a0d4d4d1be1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id25013a775c2441d7989f5a0d4d4d1be1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id25013a775c2441d7989f5a0d4d4d1be1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id25013a775c2441d7989f5a0d4d4d1be1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id25013a775c2441d7989f5a0d4d4d1be1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id25013a775c2441d7989f5a0d4d4d1be1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id25013a775c2441d7989f5a0d4d4d1be1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id25013a775c2441d7989f5a0d4d4d1be1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id25013a775c2441d7989f5a0d4d4d1be1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id25013a775c2441d7989f5a0d4d4d1be1 input{text-align:left;}"; break;
		}
	}
