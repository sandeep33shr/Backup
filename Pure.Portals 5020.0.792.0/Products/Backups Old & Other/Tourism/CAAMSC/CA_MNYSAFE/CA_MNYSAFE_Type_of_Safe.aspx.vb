...
Namespace Nexus
    Partial Class PB2_CA_MNYSAFE_Type_of_Safe : Inherits BaseRisk
		...
		Protected Sub onValidate_MONEY_SAFE__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MONEY_SAFE__COUNTER_ID()
End Sub

		    
        'MONEY - Parent object
        'MONEY_SAFE - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "MONEY" & "/" & "MONEY_SAFE", sXMLDataset)
                            If sChildId <> "0" Then
                                MONEY_SAFE__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
