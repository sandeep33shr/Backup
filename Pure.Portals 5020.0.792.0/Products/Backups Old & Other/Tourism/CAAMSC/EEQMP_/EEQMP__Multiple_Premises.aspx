<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EEQMP__Multiple_Premises.aspx.vb" Inherits="Nexus.PB2_EEQMP__Multiple_Premises" %>
...
<div id="id97d5070530054d169c76621276756369" class="general-layout-container">
...
<div id="id5728a7c33d814ff48dfdca2f6eb34366" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading191" runat="server" Text="Multiple Premises" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5728a7c33d814ff48dfdca2f6eb34366 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5728a7c33d814ff48dfdca2f6eb34366 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5728a7c33d814ff48dfdca2f6eb34366 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5728a7c33d814ff48dfdca2f6eb34366 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5728a7c33d814ff48dfdca2f6eb34366 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5728a7c33d814ff48dfdca2f6eb34366 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5728a7c33d814ff48dfdca2f6eb34366 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5728a7c33d814ff48dfdca2f6eb34366 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5728a7c33d814ff48dfdca2f6eb34366 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5728a7c33d814ff48dfdca2f6eb34366 input{text-align:left;}"; break;
		}
	}
