<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PA_SNOTES_Notes_Details.aspx.vb" Inherits="Nexus.PB2_PA_SNOTES_Notes_Details" %>
...
function onValidate_PANOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PANOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PANOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PANOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "PANOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=PANOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_PANOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PANOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PANOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PANOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "PANOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_PANOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PANOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PANOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PANOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "PANOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=PANOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_PANOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PANOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PANOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PANOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "PANOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_PANOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PANOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PANOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PANOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "PANOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=PANOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_PANOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_PANOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_PANOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_PANOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_PANOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_PANOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_PANOTES__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="ida81c587b5d854afe95851070e4400975" class="general-layout-container">
...
<div id="id45694ead84c14ac888346aea7f4cb7d8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading106" runat="server" Text="Notes (Printed On Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PANOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-PANOTES-DATE_CREATED">
		<asp:Label ID="lblPANOTES_DATE_CREATED" runat="server" AssociatedControlID="PANOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="PANOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calPANOTES__DATE_CREATED" runat="server" LinkedControl="PANOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valPANOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_PANOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PANOTES-CREATED_BY">

		
		<asp:Label ID="lblPANOTES_CREATED_BY" runat="server" AssociatedControlID="PANOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PANOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPANOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_PANOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PANOTES-COVER_TYPE">

		
		<asp:Label ID="lblPANOTES_COVER_TYPE" runat="server" AssociatedControlID="PANOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PANOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPANOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_PANOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PANOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblPANOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="PANOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PANOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPANOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_PANOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-PANOTES-NOTE_DETAILS">
		<asp:Label ID="lblPANOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="PANOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="PANOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valPANOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_PANOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id45694ead84c14ac888346aea7f4cb7d8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id45694ead84c14ac888346aea7f4cb7d8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id45694ead84c14ac888346aea7f4cb7d8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id45694ead84c14ac888346aea7f4cb7d8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id45694ead84c14ac888346aea7f4cb7d8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id45694ead84c14ac888346aea7f4cb7d8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id45694ead84c14ac888346aea7f4cb7d8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id45694ead84c14ac888346aea7f4cb7d8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id45694ead84c14ac888346aea7f4cb7d8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id45694ead84c14ac888346aea7f4cb7d8 input{text-align:left;}"; break;
		}
	}
