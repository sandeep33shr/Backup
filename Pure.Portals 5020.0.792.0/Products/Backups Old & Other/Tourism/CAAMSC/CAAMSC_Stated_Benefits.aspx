<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMSC_Stated_Benefits.aspx.vb" Inherits="Nexus.PB2_CAAMSC_Stated_Benefits" %>
...
function onValidate_STATED_COVER__DEATH_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("STATED_COVER.DEATH_POST_PREM.setValue(STATED.TOTAL_ANNUAL*STATED_COVER.DEATH_RATE/100)");
...
function onValidate_STATED_COVER__PDTP_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("STATED_COVER.PDTP_POST_PREM.setValue(STATED.TOTAL_ANNUAL*STATED_COVER.PDTP_RATE/100)");
...
function onValidate_STATED_COVER__DISTOT_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("STATED_COVER.DISTOT_POST_PREM.setValue(STATED.TOTAL_ANNUAL*STATED_COVER.DISTOT_RATE/100)");
...
function onValidate_STATED_COVER__DISPAR_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("STATED_COVER.DISPAR_POST_PREM.setValue(STATED.TOTAL_ANNUAL*STATED_COVER.DISPAR_RATE/100)");
...
function onValidate_STATED_EXTENSIONS__HIVAE_LIMIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_HIVAE = 1", "V", "HIV Accidental Exposure  Limit of Indemnity is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "STATED_EXTENSIONS.IS_HIVAE = 1",
            paramElseValue = "V",
            paramValidationMessage = "HIV Accidental Exposure  Limit of Indemnity is mandatory and an amount must be entered";
...
function onValidate_STATED_EXTENSIONS__HIVAE_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "STATED_EXTENSIONS.IS_HIVAE = 1", "V", "{3}");
...
function onValidate_STATED_EXTENSIONS__HIVAE_POST_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_HIVAE = 1", "V", "HIV Accidental Exposure Posting Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "STATED_EXTENSIONS.IS_HIVAE = 1",
            paramElseValue = "V",
            paramValidationMessage = "HIV Accidental Exposure Posting Premium is mandatory and an amount must be entered";
...
function onValidate_STATED_EXTENSIONS__HOSP_TIME(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_HOSP = 1", "V", "Hospitalisation Time Excess is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "STATED_EXTENSIONS.IS_HOSP = 1",
            paramElseValue = "V",
            paramValidationMessage = "Hospitalisation Time Excess is mandatory and must be entered";
...
function onValidate_STATED_EXTENSIONS__HOSP_PERIOD(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_HOSP = 1", "V", "Hospitalisation Period is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "STATED_EXTENSIONS.IS_HOSP = 1",
            paramElseValue = "V",
            paramValidationMessage = "Hospitalisation Period is mandatory and must be entered";
...
function onValidate_STATED_EXTENSIONS__HOSP_LIMIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_HOSP = 1", "V", "Hospitalisation Limit of Indemnity is mandatory and an amount must be entered");
...
function onValidate_STATED_EXTENSIONS__HOSP_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "STATED_EXTENSIONS.IS_HOSP = 1", "V", "{3}");
...
function onValidate_STATED_EXTENSIONS__HOSP_POST_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_HOSP = 1", "V", "Hospitalisation Posting Premium is mandatory and an amount must be entered");
...
function onValidate_STATED_EXTENSIONS__SILL_TIME(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_SILL = 1", "V", "Hospitalisation Time Excess is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "STATED_EXTENSIONS.IS_SILL = 1",
            paramElseValue = "V",
            paramValidationMessage = "Hospitalisation Time Excess is mandatory and must be entered";
...
function onValidate_STATED_EXTENSIONS__SILL_LIMIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_SILL = 1", "V", "Hospitalisation Limit of Indemnity is mandatory and an amount must be entered");
...
function onValidate_STATED_EXTENSIONS__SILL_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "STATED_EXTENSIONS.IS_SILL = 1", "V", "{3}");
...
function onValidate_STATED_EXTENSIONS__SILL_POST_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_SILL = 1", "V", "Hospitalisation Posting Premium is mandatory and an amount must be entered");
...
function onValidate_STATED_EXTENSIONS__TTDSICK_TIME(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_TTDSICK = 1", "V", "Temporary Total Disablement - Sickness Time Excess is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "STATED_EXTENSIONS.IS_TTDSICK = 1",
            paramElseValue = "V",
            paramValidationMessage = "Temporary Total Disablement - Sickness Time Excess is mandatory and must be entered";
...
function onValidate_STATED_EXTENSIONS__TTDSICK_LIMIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_TTDSICK = 1", "V", "Temporary Total Disablement - Sickness Limit of Indemnity is mandatory and an amount must be entered");
...
function onValidate_STATED_EXTENSIONS__TTDSICK_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "STATED_EXTENSIONS.IS_TTDSICK = 1", "V", "{3}");
...
function onValidate_STATED_EXTENSIONS__TTDSICK_POST_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "STATED_EXTENSIONS.IS_TTDSICK = 1", "V", "Temporary Total Disablement - Sickness Posting Premium is mandatory and an amount must be entered");
...
function onValidate_STATED__SB_ENDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STATED", "SB_ENDPRM", "ChildScreen");
        })();
}
...
function onValidate_STATED__SB_NOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STATED", "SB_NOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("STATED", "SB_NOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_STATED__SB_NOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("STATED", "SB_NOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'STATED' and property 'SB_NOTES'.");
        			error.display();
...
function onValidate_STATED__SB_SNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STATED", "SB_SNOTES", "ChildScreen");
        })();
}
function onValidate_STATED__STD_NTS_CNT(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param STATED The Parent (Root) object name.
          * @param STATED_SCNOTE_DETAILS.DATE_CREATED The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "STATED".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "STATED_SCNOTE_DETAILS.DATE_CREATED";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_STATED__SB_ENDPRM(null, null, null, isOnLoad);
    onValidate_STATED__ST_END_CNT(null, null, null, isOnLoad);
    onValidate_STATED__SB_NOTES(null, null, null, isOnLoad);
    onValidate_STATED__SB_SNOTES(null, null, null, isOnLoad);
...
<div id="id2916c29c111b4c4f9e0339da559ba1b7" class="general-layout-container">
...
<div id="id60021ffccf714bf4a2cd77a4059523e3" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id60021ffccf714bf4a2cd77a4059523e3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id60021ffccf714bf4a2cd77a4059523e3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id60021ffccf714bf4a2cd77a4059523e3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id60021ffccf714bf4a2cd77a4059523e3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id60021ffccf714bf4a2cd77a4059523e3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60021ffccf714bf4a2cd77a4059523e3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60021ffccf714bf4a2cd77a4059523e3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id60021ffccf714bf4a2cd77a4059523e3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60021ffccf714bf4a2cd77a4059523e3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60021ffccf714bf4a2cd77a4059523e3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8a6c84cdf1c644c3abc5d2fada2c7d12" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading128" runat="server" Text="Stated Benefits" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8a6c84cdf1c644c3abc5d2fada2c7d12 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8a6c84cdf1c644c3abc5d2fada2c7d12 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8a6c84cdf1c644c3abc5d2fada2c7d12 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8a6c84cdf1c644c3abc5d2fada2c7d12 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8a6c84cdf1c644c3abc5d2fada2c7d12 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8a6c84cdf1c644c3abc5d2fada2c7d12 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8a6c84cdf1c644c3abc5d2fada2c7d12 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8a6c84cdf1c644c3abc5d2fada2c7d12 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8a6c84cdf1c644c3abc5d2fada2c7d12 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8a6c84cdf1c644c3abc5d2fada2c7d12 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id52e13c3601944a169bd2813143788861" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading129" runat="server" Text="Employee Details" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id52e13c3601944a169bd2813143788861 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id52e13c3601944a169bd2813143788861 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id52e13c3601944a169bd2813143788861 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id52e13c3601944a169bd2813143788861 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id52e13c3601944a169bd2813143788861 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id52e13c3601944a169bd2813143788861 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id52e13c3601944a169bd2813143788861 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id52e13c3601944a169bd2813143788861 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id52e13c3601944a169bd2813143788861 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id52e13c3601944a169bd2813143788861 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id37ea9bdcd9b94a85bd781ace7cf2c8e3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading130" runat="server" Text="Cover Details" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label313">
		<span class="label" id="label313">No of Years</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label314">
		<span class="label" id="label314">No of Weeks</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label315">
		<span class="label" id="label315">Sum Insured/Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label316">
		<span class="label" id="label316">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label317">
		<span class="label" id="label317">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label318">
		<span class="label" id="label318">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label319">
		<span class="label" id="label319">Death </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label322">
		<span class="label" id="label322">Permanent Disability Total/Partial</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label325">
		<span class="label" id="label325">Temporary Disability : Total</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label328">
		<span class="label" id="label328">Temporary  Disability: Partial </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label331">
		<span class="label" id="label331">Medical Expenses </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label335">
		<span class="label" id="label335">Total </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label336">
		<span class="label" id="label336"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label337">
		<span class="label" id="label337"></span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id37ea9bdcd9b94a85bd781ace7cf2c8e3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id37ea9bdcd9b94a85bd781ace7cf2c8e3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id37ea9bdcd9b94a85bd781ace7cf2c8e3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id37ea9bdcd9b94a85bd781ace7cf2c8e3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id37ea9bdcd9b94a85bd781ace7cf2c8e3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37ea9bdcd9b94a85bd781ace7cf2c8e3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37ea9bdcd9b94a85bd781ace7cf2c8e3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id37ea9bdcd9b94a85bd781ace7cf2c8e3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37ea9bdcd9b94a85bd781ace7cf2c8e3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37ea9bdcd9b94a85bd781ace7cf2c8e3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0f700d838006475b8585e587b0a4e368" class="column-layout-container,no-border  ">
	...
	<span id="pb-container-label-label340">
		<span class="label" id="label340"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label341">
		<span class="label" id="label341"></span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label344">
		<span class="label" id="label344">Time Excess (days)</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label346">
		<span class="label" id="label346">Medical Expenses</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label349">
		<span class="label" id="label349">Temporary Disability</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0f700d838006475b8585e587b0a4e368 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0f700d838006475b8585e587b0a4e368 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0f700d838006475b8585e587b0a4e368 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0f700d838006475b8585e587b0a4e368 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0f700d838006475b8585e587b0a4e368 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f700d838006475b8585e587b0a4e368 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f700d838006475b8585e587b0a4e368 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0f700d838006475b8585e587b0a4e368 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f700d838006475b8585e587b0a4e368 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f700d838006475b8585e587b0a4e368 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0042787a0d704669b6aa624744540125" class="column-layout-container,no-border  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label354">
		<span class="label" id="label354">Time Excess</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label355">
		<span class="label" id="label355">Hospitalisation Period</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label356">
		<span class="label" id="label356">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label357">
		<span class="label" id="label357">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label358">
		<span class="label" id="label358">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label359">
		<span class="label" id="label359">Posting Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label360">
		<span class="label" id="label360">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label361">
		<span class="label" id="label361">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label362">
		<span class="label" id="label362">HIV Accidental Exposure </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label364">
		<span class="label" id="label364"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label367">
		<span class="label" id="label367">Hospitalisation </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label370">
		<span class="label" id="label370">Serious Illness</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label372">
		<span class="label" id="label372">Temporary Total Disablement - Sickness </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label375">
		<span class="label" id="label375">Total</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label376">
		<span class="label" id="label376"></span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0042787a0d704669b6aa624744540125 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0042787a0d704669b6aa624744540125 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0042787a0d704669b6aa624744540125 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0042787a0d704669b6aa624744540125 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0042787a0d704669b6aa624744540125 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0042787a0d704669b6aa624744540125 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0042787a0d704669b6aa624744540125 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0042787a0d704669b6aa624744540125 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0042787a0d704669b6aa624744540125 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0042787a0d704669b6aa624744540125 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc0ae9ac8de624835935a3ef4801f727b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading133" runat="server" Text="Assistance Services" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label384">
		<span class="label" id="label384">No of Employees</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label385">
		<span class="label" id="label385">Premium per Person</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label386">
		<span class="label" id="label386">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label387">
		<span class="label" id="label387">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label388">
		<span class="label" id="label388">HIV/Aids Assistance</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label389">
		<span class="label" id="label389">Accidental Expert Assistance</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label390">
		<span class="label" id="label390"></span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label391">
		<span class="label" id="label391">Total</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc0ae9ac8de624835935a3ef4801f727b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc0ae9ac8de624835935a3ef4801f727b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc0ae9ac8de624835935a3ef4801f727b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc0ae9ac8de624835935a3ef4801f727b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc0ae9ac8de624835935a3ef4801f727b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc0ae9ac8de624835935a3ef4801f727b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc0ae9ac8de624835935a3ef4801f727b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc0ae9ac8de624835935a3ef4801f727b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc0ae9ac8de624835935a3ef4801f727b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc0ae9ac8de624835935a3ef4801f727b input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading134" runat="server" Text="Endorsements" /></legend>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb2720a7966b64e4bb692c88d992fa295" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading135" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb2720a7966b64e4bb692c88d992fa295 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb2720a7966b64e4bb692c88d992fa295 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb2720a7966b64e4bb692c88d992fa295 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb2720a7966b64e4bb692c88d992fa295 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb2720a7966b64e4bb692c88d992fa295 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb2720a7966b64e4bb692c88d992fa295 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb2720a7966b64e4bb692c88d992fa295 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb2720a7966b64e4bb692c88d992fa295 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb2720a7966b64e4bb692c88d992fa295 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb2720a7966b64e4bb692c88d992fa295 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6d90db6e61cd4086af384535843702a0" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading136" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STATED__SB_ENDPRM"
		data-field-type="Child" 
		data-object-name="STATED" 
		data-property-name="SB_ENDPRM" 
		id="pb-container-childscreen-STATED-SB_ENDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STATED__STATED_CLAUSEPREM" runat="server" ScreenCode="SB_ENDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SB_ENDPRM/SB_ENDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valSTATED_SB_ENDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for STATED.SB_ENDPRM"
						ClientValidationFunction="onValidate_STATED__SB_ENDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6d90db6e61cd4086af384535843702a0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6d90db6e61cd4086af384535843702a0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6d90db6e61cd4086af384535843702a0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6d90db6e61cd4086af384535843702a0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6d90db6e61cd4086af384535843702a0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d90db6e61cd4086af384535843702a0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d90db6e61cd4086af384535843702a0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6d90db6e61cd4086af384535843702a0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d90db6e61cd4086af384535843702a0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d90db6e61cd4086af384535843702a0 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5d5486469ccd44ffb084e5fa7ef2125e" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading137" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STATED__SB_NOTES"
		data-field-type="Child" 
		data-object-name="STATED" 
		data-property-name="SB_NOTES" 
		id="pb-container-childscreen-STATED-SB_NOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STATED__STATED_SCNOTE_DETAILS" runat="server" ScreenCode="SB_NOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SB_NOTES/SB_NOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valSTATED_SB_NOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for STATED.SB_NOTES"
						ClientValidationFunction="onValidate_STATED__SB_NOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5d5486469ccd44ffb084e5fa7ef2125e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5d5486469ccd44ffb084e5fa7ef2125e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5d5486469ccd44ffb084e5fa7ef2125e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5d5486469ccd44ffb084e5fa7ef2125e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5d5486469ccd44ffb084e5fa7ef2125e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d5486469ccd44ffb084e5fa7ef2125e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d5486469ccd44ffb084e5fa7ef2125e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5d5486469ccd44ffb084e5fa7ef2125e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d5486469ccd44ffb084e5fa7ef2125e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d5486469ccd44ffb084e5fa7ef2125e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf5cae3b82a7d4dfabe31800ecc4618f2" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading138" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STATED__SB_SNOTES"
		data-field-type="Child" 
		data-object-name="STATED" 
		data-property-name="SB_SNOTES" 
		id="pb-container-childscreen-STATED-SB_SNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STATED__STATED_CNOTE_DETAILS" runat="server" ScreenCode="SB_SNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SB_SNOTES/SB_SNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valSTATED_SB_SNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for STATED.SB_SNOTES"
						ClientValidationFunction="onValidate_STATED__SB_SNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf5cae3b82a7d4dfabe31800ecc4618f2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf5cae3b82a7d4dfabe31800ecc4618f2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf5cae3b82a7d4dfabe31800ecc4618f2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf5cae3b82a7d4dfabe31800ecc4618f2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf5cae3b82a7d4dfabe31800ecc4618f2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf5cae3b82a7d4dfabe31800ecc4618f2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf5cae3b82a7d4dfabe31800ecc4618f2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf5cae3b82a7d4dfabe31800ecc4618f2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf5cae3b82a7d4dfabe31800ecc4618f2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf5cae3b82a7d4dfabe31800ecc4618f2 input{text-align:left;}"; break;
		}
	}
