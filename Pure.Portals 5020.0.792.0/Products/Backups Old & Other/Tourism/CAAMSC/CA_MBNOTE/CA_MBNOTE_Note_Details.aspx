<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CA_MBNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_CA_MBNOTE_Note_Details" %>
...
function onValidate_MB_NOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_NOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_NOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_NOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "MB_NOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_NOTES_DATE_CREATED");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_NOTES__DATE_CREATED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_NOTES__DATE_CREATED_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=MB_NOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_MB_NOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_NOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_NOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_NOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "MB_NOTES", "CREATED_BY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_NOTES_CREATED_BY");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_NOTES__CREATED_BY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_NOTES__CREATED_BY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MB_NOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_NOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MB_NOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_NOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "MB_NOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_NOTES_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_NOTES__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_NOTES__COVER_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MB_NOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_MB_NOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_NOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MB_NOTES", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_NOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "MB_NOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_NOTES_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_NOTES__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_NOTES__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MB_NOTES", "NOTE_DESCRIPTION");
        		var exp = new Expression("MB_NOTES.NoteCheck = 1");
...
function onValidate_MB_NOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_NOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MB_NOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MB_NOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "MB_NOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMB_NOTES_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_MB_NOTES__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MB_NOTES__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=MB_NOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_MB_NOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_MB_NOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_NOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MB_NOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_MB_NOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_MB_NOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_MB_NOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_MB_NOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_MB_NOTES__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_MB_NOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id252c4962fdcd4a79ae0909da3ebeaaaf" class="general-layout-container">
...
<div id="id5ddb523646af48ff851a289774409e35" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading220" runat="server" Text="Note Details (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MB_NOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-MB_NOTES-DATE_CREATED">
		<asp:Label ID="lblMB_NOTES_DATE_CREATED" runat="server" AssociatedControlID="MB_NOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="MB_NOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calMB_NOTES__DATE_CREATED" runat="server" LinkedControl="MB_NOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valMB_NOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_MB_NOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_NOTES-CREATED_BY">

		
		<asp:Label ID="lblMB_NOTES_CREATED_BY" runat="server" AssociatedControlID="MB_NOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_NOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMB_NOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_MB_NOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_NOTES-COVER_TYPE">

		
		<asp:Label ID="lblMB_NOTES_COVER_TYPE" runat="server" AssociatedControlID="MB_NOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_NOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMB_NOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_MB_NOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_NOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblMB_NOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="MB_NOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_NOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMB_NOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_MB_NOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-MB_NOTES-NOTE_DETAILS">
		<asp:Label ID="lblMB_NOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="MB_NOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="MB_NOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valMB_NOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_MB_NOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblMB_NOTES_NoteCheck" for="ctl00_cntMainBody_MB_NOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-MB_NOTES-NoteCheck">	
		
		<asp:TextBox ID="MB_NOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valMB_NOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_MB_NOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5ddb523646af48ff851a289774409e35 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5ddb523646af48ff851a289774409e35 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5ddb523646af48ff851a289774409e35 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5ddb523646af48ff851a289774409e35 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5ddb523646af48ff851a289774409e35 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5ddb523646af48ff851a289774409e35 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5ddb523646af48ff851a289774409e35 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5ddb523646af48ff851a289774409e35 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5ddb523646af48ff851a289774409e35 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5ddb523646af48ff851a289774409e35 input{text-align:left;}"; break;
		}
	}
