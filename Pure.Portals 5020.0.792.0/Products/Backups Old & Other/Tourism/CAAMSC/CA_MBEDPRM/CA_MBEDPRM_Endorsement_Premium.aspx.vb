...
Namespace Nexus
    Partial Class PB2_CA_MBEDPRM_Endorsement_Premium : Inherits BaseRisk
...
End Sub
        ...
        'MBREAK_CLAUSES - Standard Wording Parent Property
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/MBREAK/SW.MBREAK_CLAUSES")
