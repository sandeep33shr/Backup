<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SBNOTE__Note_Details.aspx.vb" Inherits="Nexus.PB2_SBNOTE__Note_Details" %>
...
<div id="idc990ba6e2bea43d39f36040a9a97d67e" class="general-layout-container">
...
<div id="idbaa321c259ba4c9b9c7238b5c66547e0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading139" runat="server" Text="Notes (Not Printed On Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idbaa321c259ba4c9b9c7238b5c66547e0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbaa321c259ba4c9b9c7238b5c66547e0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbaa321c259ba4c9b9c7238b5c66547e0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idbaa321c259ba4c9b9c7238b5c66547e0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbaa321c259ba4c9b9c7238b5c66547e0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbaa321c259ba4c9b9c7238b5c66547e0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbaa321c259ba4c9b9c7238b5c66547e0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbaa321c259ba4c9b9c7238b5c66547e0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbaa321c259ba4c9b9c7238b5c66547e0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbaa321c259ba4c9b9c7238b5c66547e0 input{text-align:left;}"; break;
		}
	}
