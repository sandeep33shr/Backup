...
Namespace Nexus
    Partial Class PB2_SB_ENDPRM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_STATED_CLAUSEPREM__COUNTER_ID()
        
End Sub
Protected Sub onValidate_STATED_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_STATED_CLAUSEPREM__COUNTER_ID()
    onValidate_STATED_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'STATED - Parent object
        'STATED_CLAUSEPREM - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "STATED" & "/" & "STATED_CLAUSEPREM", sXMLDataset)
                            If sChildId <> "0" Then
                                STATED_CLAUSEPREM__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        'Parameters:
        'STATED - Standard Wording Parent Object
        'STATED_CLAUSES - Standard Wording Parent Property
        'STATED_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/STATED/SW.STATED_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("STATED_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/STATED/STATED_CLAUSEPREM")
        
        	Dim CurrentSelected As String = STATED_CLAUSEPREM__ENDORSE_CAP.Text
