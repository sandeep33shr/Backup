<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMSC_Machinery_Breakdown.aspx.vb" Inherits="Nexus.PB2_CAAMSC_Machinery_Breakdown" %>
...
function onValidate_MBREAK__MBKITEMS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBKITEMS", "ChildScreen");
        })();
}
...
function onValidate_MBREAK__CA_MBEXT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CA_MBEXT", "ChildScreen");
        })();
}
...
function onValidate_MBREAK__CA_MB_FAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CA_MB_FAP", "ChildScreen");
        })();
}
function onValidate_MBREAK__MB_FAP__COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MB_FAP__COUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MBREAK", "MB_FAP__COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param MBREAK The Parent (Root) object name.
          * @param MB_FAP_.COUNTER_ID The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MBREAK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MB_FAP_.COUNTER_ID";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_MBREAK__MBTOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBTOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("MBREAK", "MBTOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBREAK.MBTOT_PREM");
        			window.setControlWidth(field, "0.4", "MBREAK", "MBTOT_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBREAK_MBTOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBREAK__MBTOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBREAK__MBTOT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MBREAK__CA_MBEDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CA_MBEDPRM", "ChildScreen");
        })();
}
...
function onValidate_MBREAK__CA_MBNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CA_MBNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MBREAK", "CA_MBNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_MBREAK__CA_MBNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MBREAK", "CA_MBNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MBREAK' and property 'CA_MBNOTE'.");
        			error.display();
...
function onValidate_MBREAK__CA_MBSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CA_MBSNOTE", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MBREAK__MBKITEMS(null, null, null, isOnLoad);
    ...
    onValidate_MBREAK__CA_MBEXT(null, null, null, isOnLoad);
    onValidate_MBREAK__OTH_TOT_PREM(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_OTH_COUNT(null, null, null, isOnLoad);
    onValidate_MBREAK__CA_MB_FAP(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_FAP__COUNT(null, null, null, isOnLoad);
    onValidate_MBREAK__TOT_PREM(null, null, null, isOnLoad);
    onValidate_MBREAK__MBTOT_PREM(null, null, null, isOnLoad);
    onValidate_MBREAK__CA_MBEDPRM(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_END_COUNT(null, null, null, isOnLoad);
    onValidate_MBREAK__CA_MBNOTE(null, null, null, isOnLoad);
    onValidate_MBREAK__CA_MBSNOTE(null, null, null, isOnLoad);
...
<div id="idf9a0e8688dd64933bf0e738c27d48bae" class="general-layout-container">
...
<div id="id48f5663192a74a319a754bfd39918d37" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading224" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id48f5663192a74a319a754bfd39918d37 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id48f5663192a74a319a754bfd39918d37 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id48f5663192a74a319a754bfd39918d37 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id48f5663192a74a319a754bfd39918d37 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id48f5663192a74a319a754bfd39918d37 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id48f5663192a74a319a754bfd39918d37 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id48f5663192a74a319a754bfd39918d37 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id48f5663192a74a319a754bfd39918d37 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id48f5663192a74a319a754bfd39918d37 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id48f5663192a74a319a754bfd39918d37 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida5d53d3a70d04ba6acc5515a596995ba" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading225" runat="server" Text="Machinery Breakdown" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida5d53d3a70d04ba6acc5515a596995ba div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida5d53d3a70d04ba6acc5515a596995ba div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida5d53d3a70d04ba6acc5515a596995ba div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida5d53d3a70d04ba6acc5515a596995ba label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida5d53d3a70d04ba6acc5515a596995ba label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5d53d3a70d04ba6acc5515a596995ba label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5d53d3a70d04ba6acc5515a596995ba label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida5d53d3a70d04ba6acc5515a596995ba input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5d53d3a70d04ba6acc5515a596995ba input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5d53d3a70d04ba6acc5515a596995ba input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id86884679ebf2407fac8c5c6332faad95" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading226" runat="server" Text="" /></legend>
...
<!-- /Text -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBKITEMS"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBKITEMS" 
		id="pb-container-childscreen-MBREAK-MBKITEMS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_ITEM" runat="server" ScreenCode="MBKITEMS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBKITEMS/MBKITEMS_Machinery_Breakdown.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Added" DataField="DATEADDED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Category" DataField="CATEG" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Sub-Category" DataField="SUB_CATEG" DataFormatString=""/>
...
<Nexus:GISLookupField HeaderText="Basis of Deductible " ListType="PMLookup" ListCode="UDL_CMA_MBCL_BOD" DataField="BASEDEDUCT" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valMBREAK_MBKITEMS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBKITEMS"
						ClientValidationFunction="onValidate_MBREAK__MBKITEMS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id86884679ebf2407fac8c5c6332faad95 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id86884679ebf2407fac8c5c6332faad95 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id86884679ebf2407fac8c5c6332faad95 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id86884679ebf2407fac8c5c6332faad95 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id86884679ebf2407fac8c5c6332faad95 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id86884679ebf2407fac8c5c6332faad95 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id86884679ebf2407fac8c5c6332faad95 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id86884679ebf2407fac8c5c6332faad95 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id86884679ebf2407fac8c5c6332faad95 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id86884679ebf2407fac8c5c6332faad95 input{text-align:left;}"; break;
		}
	}
...
<div id="frmMBE" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading227" runat="server" Text="Extensions" /></legend>
				
				
				<div data-column-count="5" data-column-ratio="10:30:20:20:20" data-layout="" class="clearfix form-horizontal">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label526">
		<span class="label" id="label526">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label527">
		<span class="label" id="label527">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label528">
		<span class="label" id="label528">Posting Premium </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label529">
		<span class="label" id="label529">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label531">
		<span class="label" id="label531">Total</span>
	</span>
<!-- /Label -->
...
<div id="frmMBEChild" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading228" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CA_MBEXT"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CA_MBEXT" 
		id="pb-container-childscreen-MBREAK-CA_MBEXT">
		
		    <legend>Other Machinery Breakdown Extensions</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_OEXTENSIONS" runat="server" ScreenCode="CA_MBEXT" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CA_MBEXT/CA_MBEXT_Other_Machinery_Breakdown_Extensions.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_CA_MBEXT" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Other Machinery Breakdown Extensions"
						ClientValidationFunction="onValidate_MBREAK__CA_MBEXT" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf9f694ecc0a44f7192441e6eb6ada3e9" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading229" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CA_MB_FAP"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CA_MB_FAP" 
		id="pb-container-childscreen-MBREAK-CA_MB_FAP">
		
		    <legend>First Amount Payable </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_FAP_" runat="server" ScreenCode="CA_MB_FAP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CA_MB_FAP/CA_MB_FAP_First_Amount_Payable.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="FAPCHILD_MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_CA_MB_FAP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for First Amount Payable "
						ClientValidationFunction="onValidate_MBREAK__CA_MB_FAP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MBREAK" 
		data-property-name="MB_FAP__COUNT" 
		id="pb-container-integer-MBREAK-MB_FAP__COUNT">
		<asp:Label ID="lblMBREAK_MB_FAP__COUNT" runat="server" AssociatedControlID="MBREAK__MB_FAP__COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MBREAK__MB_FAP__COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMBREAK_MB_FAP__COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MBREAK.MB_FAP__COUNT"
			ClientValidationFunction="onValidate_MBREAK__MB_FAP__COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf9f694ecc0a44f7192441e6eb6ada3e9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf9f694ecc0a44f7192441e6eb6ada3e9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf9f694ecc0a44f7192441e6eb6ada3e9 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf9f694ecc0a44f7192441e6eb6ada3e9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf9f694ecc0a44f7192441e6eb6ada3e9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9f694ecc0a44f7192441e6eb6ada3e9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9f694ecc0a44f7192441e6eb6ada3e9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf9f694ecc0a44f7192441e6eb6ada3e9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9f694ecc0a44f7192441e6eb6ada3e9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9f694ecc0a44f7192441e6eb6ada3e9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb19b4fe3aa3f424398c60c3f1a6c1fd6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading230" runat="server" Text="Endorsements" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb19b4fe3aa3f424398c60c3f1a6c1fd6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb19b4fe3aa3f424398c60c3f1a6c1fd6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb19b4fe3aa3f424398c60c3f1a6c1fd6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb19b4fe3aa3f424398c60c3f1a6c1fd6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb19b4fe3aa3f424398c60c3f1a6c1fd6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb19b4fe3aa3f424398c60c3f1a6c1fd6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb19b4fe3aa3f424398c60c3f1a6c1fd6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb19b4fe3aa3f424398c60c3f1a6c1fd6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb19b4fe3aa3f424398c60c3f1a6c1fd6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb19b4fe3aa3f424398c60c3f1a6c1fd6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6735d18ef41943f78829d1433e041ade" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading231" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="MBREAK" 
		data-property-name="MBTOT_PREM" 
		id="pb-container-currency-MBREAK-MBTOT_PREM">
		<asp:Label ID="lblMBREAK_MBTOT_PREM" runat="server" AssociatedControlID="MBREAK__MBTOT_PREM" 
			Text="Total Risk Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MBREAK__MBTOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMBREAK_MBTOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Risk Premium"
			ClientValidationFunction="onValidate_MBREAK__MBTOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6735d18ef41943f78829d1433e041ade div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6735d18ef41943f78829d1433e041ade div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6735d18ef41943f78829d1433e041ade div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6735d18ef41943f78829d1433e041ade label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6735d18ef41943f78829d1433e041ade label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6735d18ef41943f78829d1433e041ade label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6735d18ef41943f78829d1433e041ade label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6735d18ef41943f78829d1433e041ade input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6735d18ef41943f78829d1433e041ade input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6735d18ef41943f78829d1433e041ade input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf4c1b1c91b954fceab4bb4f0c789b9a4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading232" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CA_MBEDPRM"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CA_MBEDPRM" 
		id="pb-container-childscreen-MBREAK-CA_MBEDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_CLAUSEPREM" runat="server" ScreenCode="CA_MBEDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CA_MBEDPRM/CA_MBEDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_CA_MBEDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.CA_MBEDPRM"
						ClientValidationFunction="onValidate_MBREAK__CA_MBEDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf4c1b1c91b954fceab4bb4f0c789b9a4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf4c1b1c91b954fceab4bb4f0c789b9a4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf4c1b1c91b954fceab4bb4f0c789b9a4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf4c1b1c91b954fceab4bb4f0c789b9a4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf4c1b1c91b954fceab4bb4f0c789b9a4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf4c1b1c91b954fceab4bb4f0c789b9a4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf4c1b1c91b954fceab4bb4f0c789b9a4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf4c1b1c91b954fceab4bb4f0c789b9a4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf4c1b1c91b954fceab4bb4f0c789b9a4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf4c1b1c91b954fceab4bb4f0c789b9a4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id754c68d2319a442abb9395d0a9071c9c" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading233" runat="server" Text="Machinery Breakdown Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CA_MBNOTE"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CA_MBNOTE" 
		id="pb-container-childscreen-MBREAK-CA_MBNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_NOTES" runat="server" ScreenCode="CA_MBNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CA_MBNOTE/CA_MBNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_CA_MBNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.CA_MBNOTE"
						ClientValidationFunction="onValidate_MBREAK__CA_MBNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id754c68d2319a442abb9395d0a9071c9c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id754c68d2319a442abb9395d0a9071c9c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id754c68d2319a442abb9395d0a9071c9c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id754c68d2319a442abb9395d0a9071c9c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id754c68d2319a442abb9395d0a9071c9c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id754c68d2319a442abb9395d0a9071c9c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id754c68d2319a442abb9395d0a9071c9c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id754c68d2319a442abb9395d0a9071c9c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id754c68d2319a442abb9395d0a9071c9c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id754c68d2319a442abb9395d0a9071c9c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2b4087efaee1474ea77057d43e30b496" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading234" runat="server" Text="Machinery Breakdown Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CA_MBSNOTE"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CA_MBSNOTE" 
		id="pb-container-childscreen-MBREAK-CA_MBSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_SNOTES" runat="server" ScreenCode="CA_MBSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CA_MBSNOTE/CA_MBSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_CA_MBSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.CA_MBSNOTE"
						ClientValidationFunction="onValidate_MBREAK__CA_MBSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2b4087efaee1474ea77057d43e30b496 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2b4087efaee1474ea77057d43e30b496 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2b4087efaee1474ea77057d43e30b496 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2b4087efaee1474ea77057d43e30b496 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2b4087efaee1474ea77057d43e30b496 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b4087efaee1474ea77057d43e30b496 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b4087efaee1474ea77057d43e30b496 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2b4087efaee1474ea77057d43e30b496 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b4087efaee1474ea77057d43e30b496 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b4087efaee1474ea77057d43e30b496 input{text-align:left;}"; break;
		}
	}
