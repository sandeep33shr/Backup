<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMS_Endorsements.aspx.vb" Inherits="Nexus.PB2_CAAMS_Endorsements" %>
...
function onValidate_MS_CLAUSES__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MS_CLAUSES", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("MS_CLAUSES", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMS_CLAUSES_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MS_CLAUSES__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MS_CLAUSES__TOT_PREM_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MS_CLAUSES.TOT_PREM");
        			window.setControlWidth(field, "0.3", "MS_CLAUSES", "TOT_PREM");
        		})();
        	}
        })();
          ...
          * @param MS_CLAUSES The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MS_CLAUSES".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_MS_CLAUSES__MSPENDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MS_CLAUSES", "MSPENDPRM", "ChildScreen");
        })();
}
function onValidate_MS_CLAUSES__COUNT_ENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MS_CLAUSES", "COUNT_ENDPREM", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MS_CLAUSES", "COUNT_ENDPREM");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_MS_CLAUSES__TOT_PREM(null, null, null, isOnLoad);
    onValidate_MS_CLAUSES__MSPENDPRM(null, null, null, isOnLoad);
    onValidate_MS_CLAUSES__COUNT_ENDPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="iddfa4309eae29474d83a5ae10e3657311" class="general-layout-container">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblMS_CLAUSES_MS_CLAUSES" runat="server" AssociatedControlID="MS_CLAUSES__MS_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="MS_CLAUSES__MS_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MS_CLAUSES" 
		data-property-name="TOT_PREM" 
		id="pb-container-currency-MS_CLAUSES-TOT_PREM">
		<asp:Label ID="lblMS_CLAUSES_TOT_PREM" runat="server" AssociatedControlID="MS_CLAUSES__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MS_CLAUSES__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMS_CLAUSES_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_MS_CLAUSES__TOT_PREM" 
			ValidationGroup=""
			Display="None"
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MS_CLAUSES__MSPENDPRM"
		data-field-type="Child" 
		data-object-name="MS_CLAUSES" 
		data-property-name="MSPENDPRM" 
		id="pb-container-childscreen-MS_CLAUSES-MSPENDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MS_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="MSPENDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPENDPRM/MSPENDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMS_CLAUSES_MSPENDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MS_CLAUSES.MSPENDPRM"
						ClientValidationFunction="onValidate_MS_CLAUSES__MSPENDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-MS_CLAUSES-COUNT_ENDPREM">
		<asp:Label ID="lblMS_CLAUSES_COUNT_ENDPREM" runat="server" AssociatedControlID="MS_CLAUSES__COUNT_ENDPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MS_CLAUSES__COUNT_ENDPREM" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMS_CLAUSES_COUNT_ENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MS_CLAUSES.COUNT_ENDPREM"
			ClientValidationFunction="onValidate_MS_CLAUSES__COUNT_ENDPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
