<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMS_Notes.aspx.vb" Inherits="Nexus.PB2_CAAMS_Notes" %>
...
function onValidate_NOTES__MSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "MSNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MSNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__MSNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MSNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'MSNOTE'.");
        			error.display();
...
function onValidate_NOTES__COUNT_NOTES(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @param CNOTE_DETAILS.Note_Subject The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var childFieldStr = "CNOTE_DETAILS.Note_Subject";
...
function onValidate_NOTES__MSSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "MSSNOTE", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("NOTES", "MSSNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_NOTES__MSSNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("NOTES", "MSSNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'NOTES' and property 'MSSNOTE'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function onValidate_NOTES__COUNT_SNOTES(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @fileoverview GetColumn
          * @param NOTES The Parent (Root) object name.
          * @param SCNOTE_DETAILS.Note_Subject The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "NOTES".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "SCNOTE_DETAILS.Note_Subject";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    onValidate_NOTES__MSNOTE(null, null, null, isOnLoad);
    onValidate_NOTES__COUNT_NOTES(null, null, null, isOnLoad);
    onValidate_NOTES__MSSNOTE(null, null, null, isOnLoad);
...
<div id="idc7fee95a76ef428cb352bd8140761fa2" class="general-layout-container">
...
<div id="id38051768f41f4a84a1ae6d01d2a5c8f5" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading45" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__MSNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="MSNOTE" 
		id="pb-container-childscreen-NOTES-MSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="MSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSNOTE/MSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_MSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.MSNOTE"
						ClientValidationFunction="onValidate_NOTES__MSNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id38051768f41f4a84a1ae6d01d2a5c8f5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id38051768f41f4a84a1ae6d01d2a5c8f5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id38051768f41f4a84a1ae6d01d2a5c8f5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id38051768f41f4a84a1ae6d01d2a5c8f5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id38051768f41f4a84a1ae6d01d2a5c8f5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38051768f41f4a84a1ae6d01d2a5c8f5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38051768f41f4a84a1ae6d01d2a5c8f5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id38051768f41f4a84a1ae6d01d2a5c8f5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38051768f41f4a84a1ae6d01d2a5c8f5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38051768f41f4a84a1ae6d01d2a5c8f5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id98ece89a8f3c430497bacb5b365b6fbc" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading46" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__MSSNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="MSSNOTE" 
		id="pb-container-childscreen-NOTES-MSSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__SCNOTE_DETAILS" runat="server" ScreenCode="MSSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSSNOTE/MSSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_MSSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for NOTES.MSSNOTE"
						ClientValidationFunction="onValidate_NOTES__MSSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id98ece89a8f3c430497bacb5b365b6fbc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id98ece89a8f3c430497bacb5b365b6fbc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id98ece89a8f3c430497bacb5b365b6fbc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id98ece89a8f3c430497bacb5b365b6fbc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id98ece89a8f3c430497bacb5b365b6fbc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id98ece89a8f3c430497bacb5b365b6fbc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id98ece89a8f3c430497bacb5b365b6fbc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id98ece89a8f3c430497bacb5b365b6fbc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id98ece89a8f3c430497bacb5b365b6fbc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id98ece89a8f3c430497bacb5b365b6fbc input{text-align:left;}"; break;
		}
	}
