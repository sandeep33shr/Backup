<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAAMS_Extensions.aspx.vb" Inherits="Nexus.PB2_CAAMS_Extensions" %>
...
function onValidate_EXTENSIONS__EXT_WD_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("EXTENSIONS.IS_WSCREEN == 1")) ? new Expression("EXTENSIONS.IS_WSCREEN == 1") : null;
...
function onValidate_EXTENSIONS__IS_RIOT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "RISK_DETAILS.COVER_TYPECode == 2", "VE", "{3}");
        
            var paramValue = "V",
            paramCondition = "RISK_DETAILS.COVER_TYPECode == 2",
            paramElseValue = "VE",
            paramValidationMessage = "{3}";
...
function onValidate_EXTENSIONS__IS_WRECK(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=EXTENSIONS&propertyName=IS_WRECK&name={name}");
...
function onValidate_EXTENSIONS__EXT_CH_DAYS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EXTENSIONS.IS_CAR_HIRE == 1", "V", "Vehicle Hire Number of days is mandatory and an option must be selected");
        
            var paramValue = "VEM",
            paramCondition = "EXTENSIONS.IS_CAR_HIRE == 1",
            paramElseValue = "V",
            paramValidationMessage = "Vehicle Hire Number of days is mandatory and an option must be selected";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=List&objectName=EXTENSIONS&propertyName=EXT_CH_DAYS&name={name}");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Loss of Use Number of days cannot be more than 30")) ? "Loss of Use Number of days cannot be more than 30" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_label90(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label91(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label92(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label93(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EXTENSIONS__IS_DEPPRO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTENSIONS", "IS_DEPPRO", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTENSIONS", "IS_DEPPRO");
        		}
...
function onValidate_label94(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label95(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label96(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label97(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label98(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label100(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EXTENSIONS__IS_GHOVEH(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTENSIONS", "IS_GHOVEH", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTENSIONS", "IS_GHOVEH");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_label102(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label104(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_EXTENSIONS__NASRIA_LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "NASRIA - Motor Specified Limit of Indemnity is mandatory and an amount must be entered";
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=EXTENSIONS&propertyName=NASRIA_LOI&name={name}");
...
function onValidate_EXTENSIONS__NASRIA_CATEGORY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "NASRIA - Motor Specified Vehicle Category is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=List&objectName=EXTENSIONS&propertyName=NASRIA_CATEGORY&name={name}");
        		var condition = (Expression.isValidParameter("{0}")) ? new Expression("{0}") : null;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_label90(null, null, null, isOnLoad);
    onValidate_label91(null, null, null, isOnLoad);
    onValidate_label92(null, null, null, isOnLoad);
    onValidate_label93(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__IS_DEPPRO(null, null, null, isOnLoad);
    onValidate_label94(null, null, null, isOnLoad);
    onValidate_label95(null, null, null, isOnLoad);
    onValidate_label96(null, null, null, isOnLoad);
    onValidate_label97(null, null, null, isOnLoad);
    onValidate_label98(null, null, null, isOnLoad);
    onValidate_label99(null, null, null, isOnLoad);
    onValidate_label100(null, null, null, isOnLoad);
    onValidate_EXTENSIONS__IS_GHOVEH(null, null, null, isOnLoad);
    onValidate_label101(null, null, null, isOnLoad);
    onValidate_label102(null, null, null, isOnLoad);
    onValidate_label103(null, null, null, isOnLoad);
    onValidate_label104(null, null, null, isOnLoad);
...
<div id="id456facbc3d1c4ef18271edef9344fcb6" class="general-layout-container">
...
<div id="idff25d1bb4b8e4acc89d0b9503916f70f" class="column-layout-container  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label52">
		<span class="label" id="label52">Limit of Indemnity</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label55">
		<span class="label" id="label55">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label56">
		<span class="label" id="label56">Minimum Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label57">
		<span class="label" id="label57">Description</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label58">
		<span class="label" id="label58">Windscreen</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label63">
		<span class="label" id="label63">Loss of Keys </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label65">
		<span class="label" id="label65">Riot & Strike </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label70">
		<span class="label" id="label70">Wreckage Removal</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label74">
		<span class="label" id="label74">Excess Waiver</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label79">
		<span class="label" id="label79">Extended Territories</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label81">
		<span class="label" id="label81">Vehicle Hire </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label82">
		<span class="label" id="label82">Number of days </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label84">
		<span class="label" id="label84">Loss of Use </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label85">
		<span class="label" id="label85">Number of days </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label87">
		<span class="label" id="label87">Roadside Assist</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblEXTENSIONS_IS_DEPPRO" for="ctl00_cntMainBody_EXTENSIONS__IS_DEPPRO" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="EXTENSIONS" 
		data-property-name="IS_DEPPRO" 
		id="pb-container-checkbox-EXTENSIONS-IS_DEPPRO">	
		
		<asp:TextBox ID="EXTENSIONS__IS_DEPPRO" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valEXTENSIONS_IS_DEPPRO" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EXTENSIONS.IS_DEPPRO"
			ClientValidationFunction="onValidate_EXTENSIONS__IS_DEPPRO" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label94">
		<span class="label" id="label94">Deposit Protector</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblEXTENSIONS_IS_GHOVEH" for="ctl00_cntMainBody_EXTENSIONS__IS_GHOVEH" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="EXTENSIONS" 
		data-property-name="IS_GHOVEH" 
		id="pb-container-checkbox-EXTENSIONS-IS_GHOVEH">	
		
		<asp:TextBox ID="EXTENSIONS__IS_GHOVEH" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valEXTENSIONS_IS_GHOVEH" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for EXTENSIONS.IS_GHOVEH"
			ClientValidationFunction="onValidate_EXTENSIONS__IS_GHOVEH" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label101">
		<span class="label" id="label101">Ghost Vehicle</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label108">
		<span class="label" id="label108">NASRIA - Motor Specified</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label116">
		<span class="label" id="label116">Total</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idff25d1bb4b8e4acc89d0b9503916f70f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idff25d1bb4b8e4acc89d0b9503916f70f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idff25d1bb4b8e4acc89d0b9503916f70f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idff25d1bb4b8e4acc89d0b9503916f70f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idff25d1bb4b8e4acc89d0b9503916f70f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idff25d1bb4b8e4acc89d0b9503916f70f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idff25d1bb4b8e4acc89d0b9503916f70f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idff25d1bb4b8e4acc89d0b9503916f70f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idff25d1bb4b8e4acc89d0b9503916f70f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idff25d1bb4b8e4acc89d0b9503916f70f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmspecifiedNASRIA" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading35" runat="server" Text="NASRIA - Motor Specified" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmspecifiedNASRIA div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmspecifiedNASRIA div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmspecifiedNASRIA div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmspecifiedNASRIA label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmspecifiedNASRIA label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmspecifiedNASRIA label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmspecifiedNASRIA label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmspecifiedNASRIA input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmspecifiedNASRIA input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmspecifiedNASRIA input{text-align:left;}"; break;
		}
	}
