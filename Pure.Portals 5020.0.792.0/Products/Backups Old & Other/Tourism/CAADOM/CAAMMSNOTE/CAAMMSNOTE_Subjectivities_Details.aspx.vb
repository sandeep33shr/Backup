...
Namespace Nexus
    Partial Class PB2_CAAMMSNOTE_Subjectivities_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_MMM_SDETAILS__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If MMM_SDETAILS__Date_Created.Text.ToString = "" Then
        		MMM_SDETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		MMM_SDETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_MMM_SDETAILS__Note_Details()
End Sub
