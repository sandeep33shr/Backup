<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAADOM_Household_Contents.aspx.vb" Inherits="Nexus.PB2_CAADOM_Household_Contents" %>
...
function onValidate_CONTENTS__ATTACHMENTDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=CONTENTS&propertyName=ATTACHMENTDATE&name={name}");
        		
        		var value = new Expression("GENERAL.QUOTEDATE"), 
        			condition = (Expression.isValidParameter("(CONTENTS.ATTACHMENTDATE =='' ||CONTENTS.ATTACHMENTDATE == null ) && GENERAL.IS_CONTENTS == true")) ? new Expression("(CONTENTS.ATTACHMENTDATE =='' ||CONTENTS.ATTACHMENTDATE == null ) && GENERAL.IS_CONTENTS == true") : null, 
...
function onValidate_CONTENTS__EFFECTIVEDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=CONTENTS&propertyName=EFFECTIVEDATE&name={name}");
...
function onValidate_CONTENTS__TOTAL_FINAL_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CONTENTS.PREMIUM + MMC_REFERRAL_CLAUSES.TOTAL_ENDORSE_PREM "), 
        			condition = (Expression.isValidParameter(" CONTENTS.PREMIUM > 0 || MMC_REFERRAL_CLAUSES.TOTAL_ENDORSE_PREM > 0")) ? new Expression(" CONTENTS.PREMIUM > 0 || MMC_REFERRAL_CLAUSES.TOTAL_ENDORSE_PREM > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.CONTENTS_STDXSAMT"), 
        			condition = (Expression.isValidParameter("(CONTENTS.STDEXCESS < GENERAL.CONTENTS_STDXSAMT) || (CONTENTS.STDEXCESS ==''  OR CONTENTS.STDEXCESS ==null)")) ? new Expression("(CONTENTS.STDEXCESS < GENERAL.CONTENTS_STDXSAMT) || (CONTENTS.STDEXCESS ==''  OR CONTENTS.STDEXCESS ==null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_MMC_REFERRAL_CLAUSES__TOTAL_ENDORSE_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MMC_REFERRAL_CLAUSES", "TOTAL_ENDORSE_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("MMC_REFERRAL_CLAUSES", "TOTAL_ENDORSE_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMMC_REFERRAL_CLAUSES_TOTAL_ENDORSE_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MMC_REFERRAL_CLAUSES__TOTAL_ENDORSE_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MMC_REFERRAL_CLAUSES__TOTAL_ENDORSE_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MMC_REFERRAL_CLAUSES.TOTAL_ENDORSE_PREM");
        			window.setControlWidth(field, "0.3", "MMC_REFERRAL_CLAUSES", "TOTAL_ENDORSE_PREM");
        		})();
        	}
        })();
          ...
          * @param MMC_REFERRAL_CLAUSES The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MMC_REFERRAL_CLAUSES".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_MMC_REFERRAL_CLAUSES__MCENDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MMC_REFERRAL_CLAUSES", "MCENDPRM", "ChildScreen");
        })();
}
function onValidate_MMC_REFERRAL_CLAUSES__CONT_END_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MMC_REFERRAL_CLAUSES", "CONT_END_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MMC_REFERRAL_CLAUSES", "CONT_END_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_CONTENTS__MMCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONTENTS", "MMCNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CONTENTS", "MMCNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_CONTENTS__MMCNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CONTENTS", "MMCNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CONTENTS' and property 'MMCNOTE'.");
        			error.display();
...
function onValidate_CONTENTS__CNOTE_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONTENTS", "CNOTE_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CONTENTS", "CNOTE_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_CONTENTS__MMCSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONTENTS", "MMCSNOTE", "ChildScreen");
        })();
}
function onValidate_CONTENTS__CSNOTE_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONTENTS", "CSNOTE_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CONTENTS", "CSNOTE_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MMC_REFERRAL_CLAUSES__TOTAL_ENDORSE_PREM(null, null, null, isOnLoad);
    onValidate_MMC_REFERRAL_CLAUSES__MCENDPRM(null, null, null, isOnLoad);
    onValidate_MMC_REFERRAL_CLAUSES__CONT_END_CNT(null, null, null, isOnLoad);
    onValidate_CONTENTS__MMCNOTE(null, null, null, isOnLoad);
    onValidate_CONTENTS__CNOTE_CNT(null, null, null, isOnLoad);
    onValidate_CONTENTS__MMCSNOTE(null, null, null, isOnLoad);
    onValidate_CONTENTS__CSNOTE_CNT(null, null, null, isOnLoad);
}
</script>
...
<div id="
div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf88eb5ba2cfb4bc6a66a0d30a4c3e329 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblMMC_REFERRAL_CLAUSES_REFERRAL_CLAUSES" runat="server" AssociatedControlID="MMC_REFERRAL_CLAUSES__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="MMC_REFERRAL_CLAUSES__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="MMC_REFERRAL_CLAUSES" 
		data-property-name="TOTAL_ENDORSE_PREM" 
		id="pb-container-currency-MMC_REFERRAL_CLAUSES-TOTAL_ENDORSE_PREM">
		<asp:Label ID="lblMMC_REFERRAL_CLAUSES_TOTAL_ENDORSE_PREM" runat="server" AssociatedControlID="MMC_REFERRAL_CLAUSES__TOTAL_ENDORSE_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MMC_REFERRAL_CLAUSES__TOTAL_ENDORSE_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMMC_REFERRAL_CLAUSES_TOTAL_ENDORSE_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_MMC_REFERRAL_CLAUSES__TOTAL_ENDORSE_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MMC_REFERRAL_CLAUSES__MCENDPRM"
		data-field-type="Child" 
		data-object-name="MMC_REFERRAL_CLAUSES" 
		data-property-name="MCENDPRM" 
		id="pb-container-childscreen-MMC_REFERRAL_CLAUSES-MCENDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MMC_REFERRAL_CLAUSES__MC_CLAUSE" runat="server" ScreenCode="MCENDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MCENDPRM/MCENDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMMC_REFERRAL_CLAUSES_MCENDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MMC_REFERRAL_CLAUSES.MCENDPRM"
						ClientValidationFunction="onValidate_MMC_REFERRAL_CLAUSES__MCENDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MMC_REFERRAL_CLAUSES" 
		data-property-name="CONT_END_CNT" 
		id="pb-container-integer-MMC_REFERRAL_CLAUSES-CONT_END_CNT">
		<asp:Label ID="lblMMC_REFERRAL_CLAUSES_CONT_END_CNT" runat="server" AssociatedControlID="MMC_REFERRAL_CLAUSES__CONT_END_CNT" 
			Text=" Content Endorsement Count" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MMC_REFERRAL_CLAUSES__CONT_END_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMMC_REFERRAL_CLAUSES_CONT_END_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for  Content Endorsement Count"
			ClientValidationFunction="onValidate_MMC_REFERRAL_CLAUSES__CONT_END_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CONTENTS__MMCNOTE"
		data-field-type="Child" 
		data-object-name="CONTENTS" 
		data-property-name="MMCNOTE" 
		id="pb-container-childscreen-CONTENTS-MMCNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CONTENTS__MMC_DETAILS" runat="server" ScreenCode="MMCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MMCNOTE/MMCNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCONTENTS_MMCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CONTENTS.MMCNOTE"
						ClientValidationFunction="onValidate_CONTENTS__MMCNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="CONTENTS" 
		data-property-name="CNOTE_CNT" 
		id="pb-container-integer-CONTENTS-CNOTE_CNT">
		<asp:Label ID="lblCONTENTS_CNOTE_CNT" runat="server" AssociatedControlID="CONTENTS__CNOTE_CNT" 
			Text="Content Notes Count " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CONTENTS__CNOTE_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCONTENTS_CNOTE_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Content Notes Count "
			ClientValidationFunction="onValidate_CONTENTS__CNOTE_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CONTENTS__MMCSNOTE"
		data-field-type="Child" 
		data-object-name="CONTENTS" 
		data-property-name="MMCSNOTE" 
		id="pb-container-childscreen-CONTENTS-MMCSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CONTENTS__MMC_SDETAILS" runat="server" ScreenCode="MMCSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MMCSNOTE/MMCSNOTE_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCONTENTS_MMCSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CONTENTS.MMCSNOTE"
						ClientValidationFunction="onValidate_CONTENTS__MMCSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="CONTENTS" 
		data-property-name="CSNOTE_CNT" 
		id="pb-container-integer-CONTENTS-CSNOTE_CNT">
		<asp:Label ID="lblCONTENTS_CSNOTE_CNT" runat="server" AssociatedControlID="CONTENTS__CSNOTE_CNT" 
			Text="Content Notes Count " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CONTENTS__CSNOTE_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCONTENTS_CSNOTE_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Content Notes Count "
			ClientValidationFunction="onValidate_CONTENTS__CSNOTE_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
