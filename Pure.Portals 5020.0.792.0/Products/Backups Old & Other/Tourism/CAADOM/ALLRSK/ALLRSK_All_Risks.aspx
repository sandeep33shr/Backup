<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ALLRSK_All_Risks.aspx.vb" Inherits="Nexus.PB2_ALLRSK_All_Risks" %>
...
function onValidate_ALL RISK__IS_IN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ALL RISK", "IS_IN", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ALL RISK", "IS_IN");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblALL RISK_IS_IN");
        			    var ele = document.getElementById('ctl00_cntMainBody_ALL RISK__IS_IN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ALL RISK__IS_IN_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ALL RISK.IS_IN");
        			window.setControlWidth(field, "0.7", "ALL RISK", "IS_IN");
        		})();
        	}
        })();
        /**
        ...
        (()=>{
                ...
                $('#<%= ALL RISK__IS_IN.ClientID %>').bind("keypress",function(e){
...
function onValidate_ALL RISK__IS_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ALL RISK", "IS_DESC", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ALL RISK", "IS_DESC");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblALL RISK_IS_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_ALL RISK__IS_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ALL RISK__IS_DESC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ALL RISK.IS_DESC");
        			window.setControlWidth(field, "0.7", "ALL RISK", "IS_DESC");
        		})();
        	}
        })();
        /**
        ...
        (()=>{
                ...
                $('#<%= ALL RISK__IS_DESC.ClientID %>').bind("keypress",function(e){
...
function onValidate_ALL RISK__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ALL RISK", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ALL RISK", "SUMINSURED");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblALL RISK_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_ALL RISK__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ALL RISK__SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ALL RISK.SUMINSURED");
        			window.setControlWidth(field, "0.7", "ALL RISK", "SUMINSURED");
        		})();
        	}
        })();
        ...
        (()=>{
                ...
                $('#<%= ALL RISK__SUMINSURED.ClientID %>').bind("keypress",function(e){
        ...
        $(document).ready(function() {
        	...
        	var FieldValid = Field.getInstance("ALL RISK", "SUMINSURED");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ALL RISK".toUpperCase() + "__" + "SUMINSURED");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ALL RISK".toUpperCase() + "_" + "SUMINSURED");
        				}
        				if (node != null){
...
function onValidate_ALL RISK__IS_Premium(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ALL RISK", "IS_Premium", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ALL RISK", "IS_Premium");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblALL RISK_IS_Premium");
        			    var ele = document.getElementById('ctl00_cntMainBody_ALL RISK__IS_Premium');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ALL RISK__IS_Premium_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ALL RISK.IS_Premium");
        			window.setControlWidth(field, "0.7", "ALL RISK", "IS_Premium");
        		})();
        	}
        })();
        /**
...
function onValidate_MECHELECTRIC__MMENDPRM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MECHELECTRIC", "MMENDPRM", "ChildScreen");
        })();
}
function onValidate_MECHELECTRIC__MEB_END_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MECHELECTRIC", "MEB_END_CNT", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MECHELECTRIC", "MEB_END_CNT");
        		}
...
function onValidate_MECHELECTRIC__MMMNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MECHELECTRIC", "MMMNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MECHELECTRIC", "MMMNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_MECHELECTRIC__MMMNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MECHELECTRIC", "MMMNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MECHELECTRIC' and property 'MMMNOTE'.");
        			error.display();
...
function onValidate_MECHELECTRIC__MEB_NOTE_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MECHELECTRIC", "MEB_NOTE_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MECHELECTRIC", "MEB_NOTE_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_MECHELECTRIC__MMMSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MECHELECTRIC", "MMMSNOTE", "ChildScreen");
        })();
}
function onValidate_MECHELECTRIC__MEB_SNOTE_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MECHELECTRIC", "MEB_SNOTE_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MECHELECTRIC", "MEB_SNOTE_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_ALL RISK__IS_IN(null, null, null, isOnLoad);
    onValidate_ALL RISK__IS_DESC(null, null, null, isOnLoad);
    onValidate_ALL RISK__SUMINSURED(null, null, null, isOnLoad);
    onValidate_ALL RISK__IS_Premium(null, null, null, isOnLoad);
    onValidate_MECHELECTRIC__TOTAL_ENDORSE_PREM(null, null, null, isOnLoad);
    onValidate_MECHELECTRIC__MMENDPRM(null, null, null, isOnLoad);
    onValidate_MECHELECTRIC__MEB_END_CNT(null, null, null, isOnLoad);
    onValidate_MECHELECTRIC__MMMNOTE(null, null, null, isOnLoad);
    onValidate_MECHELECTRIC__MEB_NOTE_CNT(null, null, null, isOnLoad);
    onValidate_MECHELECTRIC__MMMSNOTE(null, null, null, isOnLoad);
    onValidate_MECHELECTRIC__MEB_SNOTE_CNT(null, null, null, isOnLoad);
}
</script>
...
<div id="idc9374777cba34d44837e924b583b34a2" class="general-layout-container">
...
<div id="id0a96d4f002fc4003a797f21e56a2e2bc" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ALL RISK" 
		data-property-name="IS_IN" 
		id="pb-container-integer-ALL RISK-IS_IN">
		<asp:Label ID="lblALL RISK_IS_IN" runat="server" AssociatedControlID="ALL RISK__IS_IN" 
			Text="Item Number" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ALL RISK__IS_IN" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valALL RISK_IS_IN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Item Number"
			ClientValidationFunction="onValidate_ALL RISK__IS_IN" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ALL RISK" 
		data-property-name="IS_DESC" 
		 
		
		 
		id="pb-container-text-ALL RISK-IS_DESC">

		
		<asp:Label ID="lblALL RISK_IS_DESC" runat="server" AssociatedControlID="ALL RISK__IS_DESC" 
			Text="Category Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ALL RISK__IS_DESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valALL RISK_IS_DESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Category Description"
					ClientValidationFunction="onValidate_ALL RISK__IS_DESC"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ALL RISK-SUMINSURED">
		<asp:Label ID="lblALL RISK_SUMINSURED" runat="server" AssociatedControlID="ALL RISK__SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ALL RISK__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valALL RISK_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_ALL RISK__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="ALL RISK" 
		data-property-name="IS_Premium" 
		id="pb-container-currency-ALL RISK-IS_Premium">
		<asp:Label ID="lblALL RISK_IS_Premium" runat="server" AssociatedControlID="ALL RISK__IS_Premium" 
			Text="Is Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ALL RISK__IS_Premium" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valALL RISK_IS_Premium" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Is Premium"
			ClientValidationFunction="onValidate_ALL RISK__IS_Premium" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0a96d4f002fc4003a797f21e56a2e2bc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0a96d4f002fc4003a797f21e56a2e2bc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0a96d4f002fc4003a797f21e56a2e2bc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0a96d4f002fc4003a797f21e56a2e2bc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0a96d4f002fc4003a797f21e56a2e2bc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0a96d4f002fc4003a797f21e56a2e2bc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0a96d4f002fc4003a797f21e56a2e2bc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0a96d4f002fc4003a797f21e56a2e2bc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0a96d4f002fc4003a797f21e56a2e2bc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0a96d4f002fc4003a797f21e56a2e2bc input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblMECHELECTRIC_MECHE_CLAUSES" runat="server" AssociatedControlID="MECHELECTRIC__MECHE_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="MECHELECTRIC__MECHE_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MECHELECTRIC__MMENDPRM"
		data-field-type="Child" 
		data-object-name="MECHELECTRIC" 
		data-property-name="MMENDPRM" 
		id="pb-container-childscreen-MECHELECTRIC-MMENDPRM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MECHELECTRIC__MM_CLAUSE" runat="server" ScreenCode="MMENDPRM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MMENDPRM/MMENDPRM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMECHELECTRIC_MMENDPRM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MECHELECTRIC.MMENDPRM"
						ClientValidationFunction="onValidate_MECHELECTRIC__MMENDPRM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MECHELECTRIC" 
		data-property-name="MEB_END_CNT" 
		id="pb-container-integer-MECHELECTRIC-MEB_END_CNT">
		<asp:Label ID="lblMECHELECTRIC_MEB_END_CNT" runat="server" AssociatedControlID="MECHELECTRIC__MEB_END_CNT" 
			Text="Machinery Breakdown Endorsement Count" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MECHELECTRIC__MEB_END_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMECHELECTRIC_MEB_END_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Machinery Breakdown Endorsement Count"
			ClientValidationFunction="onValidate_MECHELECTRIC__MEB_END_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div id="frmNotes" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading53" runat="server" Text="Notes Printed on the Schedule (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MECHELECTRIC__MMMNOTE"
		data-field-type="Child" 
		data-object-name="MECHELECTRIC" 
		data-property-name="MMMNOTE" 
		id="pb-container-childscreen-MECHELECTRIC-MMMNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MECHELECTRIC__MMM_DETAILS" runat="server" ScreenCode="MMMNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MMMNOTE/MMMNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMECHELECTRIC_MMMNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MECHELECTRIC.MMMNOTE"
						ClientValidationFunction="onValidate_MECHELECTRIC__MMMNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MECHELECTRIC" 
		data-property-name="MEB_NOTE_CNT" 
		id="pb-container-integer-MECHELECTRIC-MEB_NOTE_CNT">
		<asp:Label ID="lblMECHELECTRIC_MEB_NOTE_CNT" runat="server" AssociatedControlID="MECHELECTRIC__MEB_NOTE_CNT" 
			Text="Machinery Breakdown Notes Count " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MECHELECTRIC__MEB_NOTE_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMECHELECTRIC_MEB_NOTE_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Machinery Breakdown Notes Count "
			ClientValidationFunction="onValidate_MECHELECTRIC__MEB_NOTE_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MECHELECTRIC__MMMSNOTE"
		data-field-type="Child" 
		data-object-name="MECHELECTRIC" 
		data-property-name="MMMSNOTE" 
		id="pb-container-childscreen-MECHELECTRIC-MMMSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MECHELECTRIC__MMM_SDETAILS" runat="server" ScreenCode="MMMSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MMMSNOTE/MMMSNOTE_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMECHELECTRIC_MMMSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MECHELECTRIC.MMMSNOTE"
						ClientValidationFunction="onValidate_MECHELECTRIC__MMMSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MECHELECTRIC" 
		data-property-name="MEB_SNOTE_CNT" 
		id="pb-container-integer-MECHELECTRIC-MEB_SNOTE_CNT">
		<asp:Label ID="lblMECHELECTRIC_MEB_SNOTE_CNT" runat="server" AssociatedControlID="MECHELECTRIC__MEB_SNOTE_CNT" 
			Text="Content Notes Count " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MECHELECTRIC__MEB_SNOTE_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMECHELECTRIC_MEB_SNOTE_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Content Notes Count "
			ClientValidationFunction="onValidate_MECHELECTRIC__MEB_SNOTE_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
