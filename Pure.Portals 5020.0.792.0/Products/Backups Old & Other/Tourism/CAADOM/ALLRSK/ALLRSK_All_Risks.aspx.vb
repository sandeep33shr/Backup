...
Namespace Nexus
    Partial Class PB2_ALLRSK_All_Risks : Inherits BaseRisk
		...
		Protected Sub onValidate_ALL RISK__SUMINSURED()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ALL RISK__SUMINSURED()
End Sub
        ...
        Protected Shadows Sub Page_Load_SICheck(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If Session("SIData") is Nothing Then
        		If (ALL RISK__SUMINSURED.Text = "") Or (ALL RISK__SUMINSURED.Text = Nothing) Then
        			Session("SIData") = -1
        		Else
        			Session("SIData") = ALL RISK__SUMINSURED.Text
        		End If
        	End If
        	SIValidator()
        End Sub
