...
Namespace Nexus
    Partial Class PB2_CAASNOTES_Subjectivities_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CAAS_SDETAILS__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CAAS_SDETAILS__Date_Created.Text.ToString = "" Then
        		CAAS_SDETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CAAS_SDETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_CAAS_SDETAILS__Note_Details()
End Sub
