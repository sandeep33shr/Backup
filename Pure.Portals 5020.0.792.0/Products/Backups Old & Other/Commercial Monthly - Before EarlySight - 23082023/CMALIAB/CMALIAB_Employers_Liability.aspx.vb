...
Namespace Nexus
    Partial Class PB2_CMALIAB_Employers_Liability : Inherits BaseRisk
		...
		Protected Sub onValidate_EMPLIAB__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_EMPLIAB__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_EMPLIAB__ATTACHMENTDATE()
    onValidate_EMPLIAB__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If EMPLIAB__ATTACHMENTDATE.Text = "" or EMPLIAB__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			EMPLIAB__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			EMPLIAB__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (EMPLIAB__ATTACHMENTDATE.Text <> "" Or EMPLIAB__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		EMPLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		EMPLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		EMPLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
