...
Namespace Nexus
    Partial Class PB2_PDWENDPREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_PDW_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PDW_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'PUBLIABDEF - Standard Wording Parent Object
        'DEF_PUBLIABDEF_CLAUSES - Standard Wording Parent Property
        'PLDW_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PUBLIABDEF/SW.DEF_PUBLIABDEF_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("PLDW_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PUBLIABDEF/PLDW_CLAUSEPREM")
        
        	Dim CurrentSelected As String = PDW_CLAUSEPREM__ENDORSE_CAP.Text
