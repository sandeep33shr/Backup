...
Namespace Nexus
    Partial Class PB2_CMALIAB_Public_Liability : Inherits BaseRisk
		...
		Protected Sub onValidate_PUBLIAB__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_PUBLIAB__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PUBLIAB__ATTACHMENTDATE()
    onValidate_PUBLIAB__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If PUBLIAB__ATTACHMENTDATE.Text = "" or PUBLIAB__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			PUBLIAB__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			PUBLIAB__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (PUBLIAB__ATTACHMENTDATE.Text <> "" Or PUBLIAB__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		PUBLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		PUBLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		PUBLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
