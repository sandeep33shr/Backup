<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FAPCHLD_First_Amount_Payable.aspx.vb" Inherits="Nexus.PB2_FAPCHLD_First_Amount_Payable" %>
...
function onValidate_FAP_CHILD__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP_CHILD", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("FAP_CHILD", "COUNTER_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=FAP_CHILD&propertyName=COUNTER_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "FAP_CHILD" && field.getPropertyName() == "COUNTER_ID")
...
function onValidate_FAP_CHILD__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP_CHILD", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FAP_CHILD", "DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FAP_CHILD.DESCRIPTION");
        			window.setControlWidth(field, "0.7", "FAP_CHILD", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFAP_CHILD_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_FAP_CHILD__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FAP_CHILD__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_FAP_CHILD__FAP_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP_CHILD", "FAP_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FAP_CHILD", "FAP_PERC");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FAP_CHILD.FAP_PERC");
        			window.setControlWidth(field, "0.7", "FAP_CHILD", "FAP_PERC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFAP_CHILD_FAP_PERC");
        			    var ele = document.getElementById('ctl00_cntMainBody_FAP_CHILD__FAP_PERC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FAP_CHILD__FAP_PERC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FAP_CHILD".toUpperCase() + "__" + "FAP_PERC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FAP_CHILD".toUpperCase() + "_" + "FAP_PERC");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("FAP_CHILD.FAP_PERC<= 100 || (FAP_CHILD.FAP_PERC == '' || FAP_CHILD.FAP_PERC == null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_FAP_CHILD__MIN_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP_CHILD", "MIN_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FAP_CHILD", "MIN_AMOUNT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FAP_CHILD.MIN_AMOUNT");
        			window.setControlWidth(field, "0.7", "FAP_CHILD", "MIN_AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFAP_CHILD_MIN_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_FAP_CHILD__MIN_AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FAP_CHILD__MIN_AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FAP_CHILD".toUpperCase() + "__" + "MIN_AMOUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FAP_CHILD".toUpperCase() + "_" + "MIN_AMOUNT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(FAP_CHILD.MIN_AMOUNT <= FAP_CHILD.MAX_AMOUNT) || (FAP_CHILD.MIN_AMOUNT == '' || FAP_CHILD.MIN_AMOUNT == null || FAP_CHILD.MIN_AMOUNT !=null) ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_FAP_CHILD__MAX_AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FAP_CHILD", "MAX_AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FAP_CHILD", "MAX_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("FAP_CHILD.MAX_AMOUNT");
        			window.setControlWidth(field, "0.7", "FAP_CHILD", "MAX_AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFAP_CHILD_MAX_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_FAP_CHILD__MAX_AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FAP_CHILD__MAX_AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "FAP_CHILD".toUpperCase() + "__" + "MAX_AMOUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "FAP_CHILD".toUpperCase() + "_" + "MAX_AMOUNT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(FAP_CHILD.MAX_AMOUNT != null AND FAP_CHILD.MIN_AMOUNT != null AND FAP_CHILD.MAX_AMOUNT >= FAP_CHILD.MIN_AMOUNT) OR FAP_CHILD.MAX_AMOUNT == null OR FAP_CHILD.MAX_AMOUNT == ''");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    onValidate_FAP_CHILD__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_FAP_CHILD__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_FAP_CHILD__FAP_PERC(null, null, null, isOnLoad);
    onValidate_FAP_CHILD__MIN_AMOUNT(null, null, null, isOnLoad);
    onValidate_FAP_CHILD__MAX_AMOUNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id8cadd685fce6489490a6c16d3c6b7b0c" class="general-layout-container">
...
<div id="id07166b70e2574d149b706a4bf8ef8c1c" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="FAP_CHILD" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-FAP_CHILD-COUNTER_ID">

		
		<asp:Label ID="lblFAP_CHILD_COUNTER_ID" runat="server" AssociatedControlID="FAP_CHILD__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FAP_CHILD__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFAP_CHILD_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_FAP_CHILD__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-FAP_CHILD-DESCRIPTION">

		
		<asp:Label ID="lblFAP_CHILD_DESCRIPTION" runat="server" AssociatedControlID="FAP_CHILD__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FAP_CHILD__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFAP_CHILD_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_FAP_CHILD__DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-FAP_CHILD-FAP_PERC">
		<asp:Label ID="lblFAP_CHILD_FAP_PERC" runat="server" AssociatedControlID="FAP_CHILD__FAP_PERC" 
			Text="FAP %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FAP_CHILD__FAP_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFAP_CHILD_FAP_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for FAP %"
			ClientValidationFunction="onValidate_FAP_CHILD__FAP_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FAP_CHILD-MIN_AMOUNT">
		<asp:Label ID="lblFAP_CHILD_MIN_AMOUNT" runat="server" AssociatedControlID="FAP_CHILD__MIN_AMOUNT" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FAP_CHILD__MIN_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFAP_CHILD_MIN_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_FAP_CHILD__MIN_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FAP_CHILD-MAX_AMOUNT">
		<asp:Label ID="lblFAP_CHILD_MAX_AMOUNT" runat="server" AssociatedControlID="FAP_CHILD__MAX_AMOUNT" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FAP_CHILD__MAX_AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFAP_CHILD_MAX_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_FAP_CHILD__MAX_AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id07166b70e2574d149b706a4bf8ef8c1c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id07166b70e2574d149b706a4bf8ef8c1c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id07166b70e2574d149b706a4bf8ef8c1c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id07166b70e2574d149b706a4bf8ef8c1c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id07166b70e2574d149b706a4bf8ef8c1c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id07166b70e2574d149b706a4bf8ef8c1c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id07166b70e2574d149b706a4bf8ef8c1c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id07166b70e2574d149b706a4bf8ef8c1c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id07166b70e2574d149b706a4bf8ef8c1c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id07166b70e2574d149b706a4bf8ef8c1c input{text-align:left;}"; break;
		}
	}
