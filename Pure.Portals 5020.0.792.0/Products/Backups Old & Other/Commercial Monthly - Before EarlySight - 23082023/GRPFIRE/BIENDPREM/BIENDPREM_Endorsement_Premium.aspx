<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="BIENDPREM_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_BIENDPREM_Endorsement_Premium" %>
...
function onValidate_BI_CLAUSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BI_CLAUSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BI_CLAUSE", "ENDORSE_ID");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=BI_CLAUSE&propertyName=ENDORSE_ID&name={name}");
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "BI_CLAUSE" && field.getPropertyName() == "ENDORSE_ID")
...
function onValidate_BI_CLAUSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BI_CLAUSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BI_CLAUSE", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BI_CLAUSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "BI_CLAUSE", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBI_CLAUSE_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_BI_CLAUSE__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BI_CLAUSE__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_BI_CLAUSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BI_CLAUSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BI_CLAUSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BI_CLAUSE.ENDORSE_CAP");
        			window.setControlWidth(field, "0.5", "BI_CLAUSE", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBI_CLAUSE_ENDORSE_CAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_BI_CLAUSE__ENDORSE_CAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BI_CLAUSE__ENDORSE_CAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=BI_CLAUSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(BI_CLAUSE.ENDORSE_DESC)"), 
...
function onValidate_BI_CLAUSE__ENDORSE_COVER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BI_CLAUSE", "ENDORSE_COVER", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BI_CLAUSE", "ENDORSE_COVER");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BI_CLAUSE.ENDORSE_COVER");
        			window.setControlWidth(field, "0.5", "BI_CLAUSE", "ENDORSE_COVER");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBI_CLAUSE_ENDORSE_COVER");
        			    var ele = document.getElementById('ctl00_cntMainBody_BI_CLAUSE__ENDORSE_COVER');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BI_CLAUSE__ENDORSE_COVER_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_BI_CLAUSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BI_CLAUSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BI_CLAUSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BI_CLAUSE.PREMIUM");
        			window.setControlWidth(field, "0.5", "BI_CLAUSE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBI_CLAUSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_BI_CLAUSE__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BI_CLAUSE__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_BI_CLAUSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_BI_CLAUSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_BI_CLAUSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_BI_CLAUSE__ENDORSE_COVER(null, null, null, isOnLoad);
    onValidate_BI_CLAUSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id2c9c3c6844924d2cbbe30a527d04a335" class="general-layout-container">
...
<div id="idf63a4a3699e04798bab81a3caf5618ba" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading108" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="BI_CLAUSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-BI_CLAUSE-ENDORSE_ID">
		<asp:Label ID="lblBI_CLAUSE_ENDORSE_ID" runat="server" AssociatedControlID="BI_CLAUSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="BI_CLAUSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valBI_CLAUSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_BI_CLAUSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-BI_CLAUSE-ENDORSE_DESC">
		<asp:Label ID="lblBI_CLAUSE_ENDORSE_DESC" runat="server" AssociatedControlID="BI_CLAUSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="BI_CLAUSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_BI_CLAUSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valBI_CLAUSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_BI_CLAUSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-BI_CLAUSE-ENDORSE_CAP">

		
		<asp:Label ID="lblBI_CLAUSE_ENDORSE_CAP" runat="server" AssociatedControlID="BI_CLAUSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BI_CLAUSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBI_CLAUSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_BI_CLAUSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-BI_CLAUSE-ENDORSE_COVER">
		<asp:Label ID="lblBI_CLAUSE_ENDORSE_COVER" runat="server" AssociatedControlID="BI_CLAUSE__ENDORSE_COVER" 
			Text="Cover to be endorsed" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="BI_CLAUSE__ENDORSE_COVER" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_BI_ENDORSE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_BI_CLAUSE__ENDORSE_COVER(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valBI_CLAUSE_ENDORSE_COVER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Cover to be endorsed"
			ClientValidationFunction="onValidate_BI_CLAUSE__ENDORSE_COVER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-BI_CLAUSE-PREMIUM">
		<asp:Label ID="lblBI_CLAUSE_PREMIUM" runat="server" AssociatedControlID="BI_CLAUSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="BI_CLAUSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valBI_CLAUSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_BI_CLAUSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-BI_CLAUSE-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="BI_CLAUSE__ENDORSE_DESCCode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-suffix-none="true" 
		id="pb-container-text-BI_CLAUSE-ENDORSE_COVERCode">

		
		
			
		
				<asp:HiddenField ID="BI_CLAUSE__ENDORSE_COVERCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf63a4a3699e04798bab81a3caf5618ba div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf63a4a3699e04798bab81a3caf5618ba div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf63a4a3699e04798bab81a3caf5618ba div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf63a4a3699e04798bab81a3caf5618ba label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf63a4a3699e04798bab81a3caf5618ba label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf63a4a3699e04798bab81a3caf5618ba label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf63a4a3699e04798bab81a3caf5618ba label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf63a4a3699e04798bab81a3caf5618ba input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf63a4a3699e04798bab81a3caf5618ba input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf63a4a3699e04798bab81a3caf5618ba input{text-align:left;}"; break;
		}
	}
