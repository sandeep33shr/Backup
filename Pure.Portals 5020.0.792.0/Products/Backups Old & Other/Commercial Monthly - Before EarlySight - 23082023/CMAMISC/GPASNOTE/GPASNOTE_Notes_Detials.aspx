<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="GPASNOTE_Notes_Detials.aspx.vb" Inherits="Nexus.PB2_GPASNOTE_Notes_Detials" %>
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "GPANOTES" && field.getPropertyName() == "DATE_CREATED")
...
<div id="ide28dbfdabb024b97931a23a900542973" class="general-layout-container">
...
<div id="idab1d37345c2e40acb10472fe0db2fbc6" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idab1d37345c2e40acb10472fe0db2fbc6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idab1d37345c2e40acb10472fe0db2fbc6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idab1d37345c2e40acb10472fe0db2fbc6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idab1d37345c2e40acb10472fe0db2fbc6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idab1d37345c2e40acb10472fe0db2fbc6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idab1d37345c2e40acb10472fe0db2fbc6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idab1d37345c2e40acb10472fe0db2fbc6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idab1d37345c2e40acb10472fe0db2fbc6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idab1d37345c2e40acb10472fe0db2fbc6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idab1d37345c2e40acb10472fe0db2fbc6 input{text-align:left;}"; break;
		}
	}
