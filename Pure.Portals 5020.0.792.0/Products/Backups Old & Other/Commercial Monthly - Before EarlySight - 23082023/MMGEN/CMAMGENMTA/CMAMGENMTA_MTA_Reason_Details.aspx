<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMGENMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_CMAMGENMTA_MTA_Reason_Details" %>
...
<div id="id604c25fed625484da79d14917e042490" class="general-layout-container">
...
<div id="id64a68b3c9da74088bce0fb0832ceb2cd" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id64a68b3c9da74088bce0fb0832ceb2cd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id64a68b3c9da74088bce0fb0832ceb2cd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id64a68b3c9da74088bce0fb0832ceb2cd div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id64a68b3c9da74088bce0fb0832ceb2cd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id64a68b3c9da74088bce0fb0832ceb2cd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id64a68b3c9da74088bce0fb0832ceb2cd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id64a68b3c9da74088bce0fb0832ceb2cd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id64a68b3c9da74088bce0fb0832ceb2cd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id64a68b3c9da74088bce0fb0832ceb2cd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id64a68b3c9da74088bce0fb0832ceb2cd input{text-align:left;}"; break;
		}
	}
