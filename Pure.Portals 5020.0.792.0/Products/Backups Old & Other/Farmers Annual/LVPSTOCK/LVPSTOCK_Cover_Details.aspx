<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="LVPSTOCK_Cover_Details.aspx.vb" Inherits="Nexus.PB2_LVPSTOCK_Cover_Details" %>
...
function onValidate_LIVESTOCK__LVITEMS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LIVESTOCK", "LVITEMS", "ChildScreen");
        })();
}
function onValidate_LVT_EXTENSIONS__IS_ADD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "IS_ADD", "Checkbox");
        })();
}
function onValidate_LVT_EXTENSIONS__ADD_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "ADD_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "ADD_LOI");
        		}
...
function onValidate_LVT_EXTENSIONS__ADD_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "ADD_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "ADD_RATE");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_ADD = 1", "V", "{3}");
...
function onValidate_LVT_EXTENSIONS__ADD_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "ADD_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "ADD_PREM");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_ADD = 1", "V", "{3}");
...
function onValidate_LVT_EXTENSIONS__IS_RIOT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "IS_RIOT", "Checkbox");
        })();
}
function onValidate_LVT_EXTENSIONS__RIOT_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "RIOT_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "RIOT_LOI");
        		}
...
function onValidate_LVT_EXTENSIONS__RIOT_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "RIOT_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "RIOT_RATE");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_RIOT = 1", "V", "{3}");
...
function onValidate_LVT_EXTENSIONS__RIOT_PPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "RIOT_PPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "RIOT_PPREM");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_RIOT = 1", "V", "{3}");
...
function onValidate_LVT_EXTENSIONS__IS_TRSIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "IS_TRSIT", "Checkbox");
        })();
}
function onValidate_LVT_EXTENSIONS__TRSIT_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "TRSIT_RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "TRSIT_RATE");
        		}
...
function onValidate_LVT_EXTENSIONS__TRSIT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "TRSIT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "TRSIT_PREM");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_TRSIT = 1", "V", "{3}");
...
function onValidate_LVT_EXTENSIONS__TRSIT_PPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "TRSIT_PPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "TRSIT_PPREM");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_TRSIT = 1", "V", "{3}");
...
function onValidate_LVT_EXTENSIONS__TRSIT_MIN_AMNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "TRSIT_MIN_AMNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "TRSIT_MIN_AMNT");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_TRSIT = 1", "V", "{3}");
...
function onValidate_LVT_EXTENSIONS__IS_NASRIA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "IS_NASRIA", "Checkbox");
        })();
}
function onValidate_LVT_EXTENSIONS__NASRIA_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "NASRIA_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVT_EXTENSIONS", "NASRIA_LOI");
        		}
        		//window.setProperty(field, "VE", "FCS_EXTENSIONS.IS_NASRIA = 1", "V", "{3}");
        
            var paramValue = "VE",
            paramCondition = "FCS_EXTENSIONS.IS_NASRIA = 1",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_LVT_EXTENSIONS__TOTAL_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "TOTAL_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("LVT_EXTENSIONS", "TOTAL_PREM");
        	field.setReadOnly(true);
        })();
}
function onValidate_LVT_EXTENSIONS__TOTAL_PPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVT_EXTENSIONS", "TOTAL_PPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("LVT_EXTENSIONS", "TOTAL_PPREM");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_CPIRSK__LVEANDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "LVEANDOS", "ChildScreen");
        })();
}
function onValidate_NOTES__LVSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "LVSNOTES", "ChildScreen");
        })();
}
function onValidate_NOTES__LVETNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "LVETNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_LIVESTOCK__LVITEMS(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__IS_ADD(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__ADD_LOI(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__ADD_RATE(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__ADD_PREM(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__IS_RIOT(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__RIOT_LOI(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__RIOT_RATE(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__RIOT_PPREM(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__IS_TRSIT(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__TRSIT_RATE(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__TRSIT_PREM(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__TRSIT_PPREM(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__TRSIT_MIN_AMNT(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__IS_NASRIA(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__NASRIA_LOI(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__TOTAL_PREM(null, null, null, isOnLoad);
    onValidate_LVT_EXTENSIONS__TOTAL_PPREM(null, null, null, isOnLoad);
    onValidate_CPIRSK__TOT_ENDPREM(null, null, null, isOnLoad);
    onValidate_CPIRSK__LVEANDOS(null, null, null, isOnLoad);
    onValidate_NOTES__LVSNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__LVETNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id4dbdd1fbf5e447678816c85018c74473" class="general-layout-container">
...
<div id="idc9c323dbf755466994902ac2220ce45b" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc9c323dbf755466994902ac2220ce45b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc9c323dbf755466994902ac2220ce45b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc9c323dbf755466994902ac2220ce45b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc9c323dbf755466994902ac2220ce45b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc9c323dbf755466994902ac2220ce45b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc9c323dbf755466994902ac2220ce45b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc9c323dbf755466994902ac2220ce45b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc9c323dbf755466994902ac2220ce45b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc9c323dbf755466994902ac2220ce45b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc9c323dbf755466994902ac2220ce45b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd1fa2407953a462993dc503546815c0d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading22" runat="server" Text="Address" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd1fa2407953a462993dc503546815c0d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd1fa2407953a462993dc503546815c0d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd1fa2407953a462993dc503546815c0d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd1fa2407953a462993dc503546815c0d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd1fa2407953a462993dc503546815c0d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd1fa2407953a462993dc503546815c0d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd1fa2407953a462993dc503546815c0d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd1fa2407953a462993dc503546815c0d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd1fa2407953a462993dc503546815c0d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd1fa2407953a462993dc503546815c0d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id54a045a362494e43921f5d31eae11257" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading23" runat="server" Text="Livestock Item" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_LIVESTOCK__LVITEMS"
		data-field-type="Child" 
		data-object-name="LIVESTOCK" 
		data-property-name="LVITEMS" 
		id="pb-container-childscreen-LIVESTOCK-LVITEMS">
		
		    <legend>Livestock Items </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="LIVESTOCK__LSTOCK" runat="server" ScreenCode="LVITEMS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVITEMS/LVITEMS_Cover_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valLIVESTOCK_LVITEMS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Livestock Items "
						ClientValidationFunction="onValidate_LIVESTOCK__LVITEMS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id54a045a362494e43921f5d31eae11257 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id54a045a362494e43921f5d31eae11257 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id54a045a362494e43921f5d31eae11257 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id54a045a362494e43921f5d31eae11257 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id54a045a362494e43921f5d31eae11257 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54a045a362494e43921f5d31eae11257 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54a045a362494e43921f5d31eae11257 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id54a045a362494e43921f5d31eae11257 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54a045a362494e43921f5d31eae11257 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54a045a362494e43921f5d31eae11257 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5d816a715b7f416b994565e7f2876058" class="column-layout-container,no-border  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label5">
		<span class="label" id="label5">FAP Amount</span>
	</span>
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblLVT_EXTENSIONS_IS_ADD" for="ctl00_cntMainBody_LVT_EXTENSIONS__IS_ADD" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="LVT_EXTENSIONS" 
		data-property-name="IS_ADD" 
		id="pb-container-checkbox-LVT_EXTENSIONS-IS_ADD">	
		
		<asp:TextBox ID="LVT_EXTENSIONS__IS_ADD" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valLVT_EXTENSIONS_IS_ADD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.IS_ADD"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__IS_ADD" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label6">
		<span class="label" id="label6">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-ADD_LOI">
		<asp:Label ID="lblLVT_EXTENSIONS_ADD_LOI" runat="server" AssociatedControlID="LVT_EXTENSIONS__ADD_LOI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__ADD_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_ADD_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.ADD_LOI"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__ADD_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-LVT_EXTENSIONS-ADD_RATE">
		<asp:Label ID="lblLVT_EXTENSIONS_ADD_RATE" runat="server" AssociatedControlID="LVT_EXTENSIONS__ADD_RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="LVT_EXTENSIONS__ADD_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_ADD_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.ADD_RATE"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__ADD_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-ADD_PREM">
		<asp:Label ID="lblLVT_EXTENSIONS_ADD_PREM" runat="server" AssociatedControlID="LVT_EXTENSIONS__ADD_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__ADD_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_ADD_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.ADD_PREM"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__ADD_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblLVT_EXTENSIONS_IS_RIOT" for="ctl00_cntMainBody_LVT_EXTENSIONS__IS_RIOT" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-LVT_EXTENSIONS-IS_RIOT">	
		
		<asp:TextBox ID="LVT_EXTENSIONS__IS_RIOT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valLVT_EXTENSIONS_IS_RIOT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.IS_RIOT"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__IS_RIOT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-RIOT_LOI">
		<asp:Label ID="lblLVT_EXTENSIONS_RIOT_LOI" runat="server" AssociatedControlID="LVT_EXTENSIONS__RIOT_LOI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__RIOT_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_RIOT_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.RIOT_LOI"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__RIOT_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-LVT_EXTENSIONS-RIOT_RATE">
		<asp:Label ID="lblLVT_EXTENSIONS_RIOT_RATE" runat="server" AssociatedControlID="LVT_EXTENSIONS__RIOT_RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="LVT_EXTENSIONS__RIOT_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_RIOT_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.RIOT_RATE"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__RIOT_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-RIOT_PPREM">
		<asp:Label ID="lblLVT_EXTENSIONS_RIOT_PPREM" runat="server" AssociatedControlID="LVT_EXTENSIONS__RIOT_PPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__RIOT_PPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_RIOT_PPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.RIOT_PPREM"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__RIOT_PPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblLVT_EXTENSIONS_IS_TRSIT" for="ctl00_cntMainBody_LVT_EXTENSIONS__IS_TRSIT" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-LVT_EXTENSIONS-IS_TRSIT">	
		
		<asp:TextBox ID="LVT_EXTENSIONS__IS_TRSIT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valLVT_EXTENSIONS_IS_TRSIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.IS_TRSIT"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__IS_TRSIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label13">
		<span class="label" id="label13">Transit </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-LVT_EXTENSIONS-TRSIT_RATE">
		<asp:Label ID="lblLVT_EXTENSIONS_TRSIT_RATE" runat="server" AssociatedControlID="LVT_EXTENSIONS__TRSIT_RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="LVT_EXTENSIONS__TRSIT_RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_TRSIT_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.TRSIT_RATE"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__TRSIT_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-TRSIT_PREM">
		<asp:Label ID="lblLVT_EXTENSIONS_TRSIT_PREM" runat="server" AssociatedControlID="LVT_EXTENSIONS__TRSIT_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__TRSIT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_TRSIT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.TRSIT_PREM"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__TRSIT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="LVT_EXTENSIONS" 
		data-property-name="TRSIT_PPREM" 
		id="pb-container-currency-LVT_EXTENSIONS-TRSIT_PPREM">
		<asp:Label ID="lblLVT_EXTENSIONS_TRSIT_PPREM" runat="server" AssociatedControlID="LVT_EXTENSIONS__TRSIT_PPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__TRSIT_PPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_TRSIT_PPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.TRSIT_PPREM"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__TRSIT_PPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-TRSIT_MIN_AMNT">
		<asp:Label ID="lblLVT_EXTENSIONS_TRSIT_MIN_AMNT" runat="server" AssociatedControlID="LVT_EXTENSIONS__TRSIT_MIN_AMNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__TRSIT_MIN_AMNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_TRSIT_MIN_AMNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.TRSIT_MIN_AMNT"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__TRSIT_MIN_AMNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblLVT_EXTENSIONS_IS_NASRIA" for="ctl00_cntMainBody_LVT_EXTENSIONS__IS_NASRIA" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-LVT_EXTENSIONS-IS_NASRIA">	
		
		<asp:TextBox ID="LVT_EXTENSIONS__IS_NASRIA" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valLVT_EXTENSIONS_IS_NASRIA" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.IS_NASRIA"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__IS_NASRIA" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label17">
		<span class="label" id="label17">Nasria Fire,Crop and Stack</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-NASRIA_LOI">
		<asp:Label ID="lblLVT_EXTENSIONS_NASRIA_LOI" runat="server" AssociatedControlID="LVT_EXTENSIONS__NASRIA_LOI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__NASRIA_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_NASRIA_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.NASRIA_LOI"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__NASRIA_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-TOTAL_PREM">
		<asp:Label ID="lblLVT_EXTENSIONS_TOTAL_PREM" runat="server" AssociatedControlID="LVT_EXTENSIONS__TOTAL_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__TOTAL_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_TOTAL_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.TOTAL_PREM"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__TOTAL_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-LVT_EXTENSIONS-TOTAL_PPREM">
		<asp:Label ID="lblLVT_EXTENSIONS_TOTAL_PPREM" runat="server" AssociatedControlID="LVT_EXTENSIONS__TOTAL_PPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="LVT_EXTENSIONS__TOTAL_PPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valLVT_EXTENSIONS_TOTAL_PPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for LVT_EXTENSIONS.TOTAL_PPREM"
			ClientValidationFunction="onValidate_LVT_EXTENSIONS__TOTAL_PPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5d816a715b7f416b994565e7f2876058 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5d816a715b7f416b994565e7f2876058 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5d816a715b7f416b994565e7f2876058 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5d816a715b7f416b994565e7f2876058 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5d816a715b7f416b994565e7f2876058 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d816a715b7f416b994565e7f2876058 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d816a715b7f416b994565e7f2876058 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5d816a715b7f416b994565e7f2876058 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d816a715b7f416b994565e7f2876058 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d816a715b7f416b994565e7f2876058 input{text-align:left;}"; break;
		}
	}
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__LVEANDOS"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="LVEANDOS" 
		id="pb-container-childscreen-CPIRSK-LVEANDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__CLAUSEPREM" runat="server" ScreenCode="LVEANDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVEANDOS/LVEANDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPIRSK_LVEANDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CPIRSK.LVEANDOS"
						ClientValidationFunction="onValidate_CPIRSK__LVEANDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id27cd174ff2c247a4bef24b34e8b2337b" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__LVSNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="LVSNOTES" 
		id="pb-container-childscreen-NOTES-LVSNOTES">
		
		    <legend>Notes (Not Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="LVSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVSNOTES/LVSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_LVSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Not Printed on Schedule)"
						ClientValidationFunction="onValidate_NOTES__LVSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id27cd174ff2c247a4bef24b34e8b2337b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id27cd174ff2c247a4bef24b34e8b2337b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id27cd174ff2c247a4bef24b34e8b2337b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id27cd174ff2c247a4bef24b34e8b2337b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id27cd174ff2c247a4bef24b34e8b2337b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27cd174ff2c247a4bef24b34e8b2337b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27cd174ff2c247a4bef24b34e8b2337b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id27cd174ff2c247a4bef24b34e8b2337b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27cd174ff2c247a4bef24b34e8b2337b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27cd174ff2c247a4bef24b34e8b2337b input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__LVETNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="LVETNOTES" 
		id="pb-container-childscreen-NOTES-LVETNOTES">
		
		    <legend>Notes (Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__SCNOTE_DETAILS" runat="server" ScreenCode="LVETNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="LVETNOTES/LVETNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_LVETNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Printed on Schedule)"
						ClientValidationFunction="onValidate_NOTES__LVETNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
