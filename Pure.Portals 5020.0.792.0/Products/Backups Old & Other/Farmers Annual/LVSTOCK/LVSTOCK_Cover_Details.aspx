<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="LVSTOCK_Cover_Details.aspx.vb" Inherits="Nexus.PB2_LVSTOCK_Cover_Details" %>
...
function onValidate_GENERAL__IS_VAT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_VAT", "Text");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GENERAL&propertyName=IS_VAT&name={name}");
...
function onValidate_LVSTOCK__PRIMINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVSTOCK", "PRIMINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVSTOCK", "PRIMINDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblLVSTOCK_PRIMINDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_LVSTOCK__PRIMINDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_LVSTOCK__PRIMINDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("LVSTOCK.PRIMINDUSTRY");
        			window.setControlWidth(field, "0.6", "LVSTOCK", "PRIMINDUSTRY");
        		})();
        	}
        })();
}
function onValidate_LVSTOCK__SCNDINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVSTOCK", "SCNDINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVSTOCK", "SCNDINDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblLVSTOCK_SCNDINDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_LVSTOCK__SCNDINDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_LVSTOCK__SCNDINDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("LVSTOCK.SCNDINDUSTRY");
        			window.setControlWidth(field, "0.6", "LVSTOCK", "SCNDINDUSTRY");
        		})();
        	}
        })();
}
function onValidate_LVSTOCK__INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "LVSTOCK", "INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("LVSTOCK", "INDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblLVSTOCK_INDUSTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_LVSTOCK__INDUSTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_LVSTOCK__INDUSTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("LVSTOCK.INDUSTRY");
        			window.setControlWidth(field, "0.6", "LVSTOCK", "INDUSTRY");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_LVSTOCK__PRIMINDUSTRY(null, null, null, isOnLoad);
    onValidate_LVSTOCK__SCNDINDUSTRY(null, null, null, isOnLoad);
    onValidate_LVSTOCK__INDUSTRY(null, null, null, isOnLoad);
}
</script>
...
<div id="id8632affaf81444d3a28001c6fbac39b3" class="general-layout-container">
...
<div id="id2843ba681f22479992536d2aebf10f3a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading1" runat="server" Text="Farmers" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GENERAL-IS_VAT">
		...
		<asp:Label ID="lblGENERAL_IS_VAT" runat="server" AssociatedControlID="GENERAL__IS_VAT" 
			Text="VAT" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GENERAL__IS_VAT" runat="server" CssClass="form-control" data-type="Text" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2843ba681f22479992536d2aebf10f3a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2843ba681f22479992536d2aebf10f3a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2843ba681f22479992536d2aebf10f3a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2843ba681f22479992536d2aebf10f3a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2843ba681f22479992536d2aebf10f3a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2843ba681f22479992536d2aebf10f3a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2843ba681f22479992536d2aebf10f3a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2843ba681f22479992536d2aebf10f3a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2843ba681f22479992536d2aebf10f3a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2843ba681f22479992536d2aebf10f3a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5609759b54b24563a48b2189dd2467fd" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5609759b54b24563a48b2189dd2467fd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5609759b54b24563a48b2189dd2467fd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5609759b54b24563a48b2189dd2467fd div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5609759b54b24563a48b2189dd2467fd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5609759b54b24563a48b2189dd2467fd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5609759b54b24563a48b2189dd2467fd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5609759b54b24563a48b2189dd2467fd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5609759b54b24563a48b2189dd2467fd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5609759b54b24563a48b2189dd2467fd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5609759b54b24563a48b2189dd2467fd input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id326bc78a24e8426bb07d9b5c1721fefb" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="LVSTOCK" 
		data-property-name="PRIMINDUSTRY" 
		id="pb-container-list-LVSTOCK-PRIMINDUSTRY">
		<asp:Label ID="lblLVSTOCK_PRIMINDUSTRY" runat="server" AssociatedControlID="LVSTOCK__PRIMINDUSTRY" 
			Text="Primary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="LVSTOCK__PRIMINDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSONE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_LVSTOCK__PRIMINDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valLVSTOCK_PRIMINDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Primary Industry"
			ClientValidationFunction="onValidate_LVSTOCK__PRIMINDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-LVSTOCK-SCNDINDUSTRY">
		<asp:Label ID="lblLVSTOCK_SCNDINDUSTRY" runat="server" AssociatedControlID="LVSTOCK__SCNDINDUSTRY" 
			Text="Secondary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="LVSTOCK__SCNDINDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTWO" ParentLookupListID="LVSTOCK__PRIMINDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_LVSTOCK__SCNDINDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valLVSTOCK_SCNDINDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Secondary Industry"
			ClientValidationFunction="onValidate_LVSTOCK__SCNDINDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-LVSTOCK-INDUSTRY">
		<asp:Label ID="lblLVSTOCK_INDUSTRY" runat="server" AssociatedControlID="LVSTOCK__INDUSTRY" 
			Text="Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="LVSTOCK__INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTHREE" ParentLookupListID="LVSTOCK__SCNDINDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_LVSTOCK__INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valLVSTOCK_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Industry"
			ClientValidationFunction="onValidate_LVSTOCK__INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id326bc78a24e8426bb07d9b5c1721fefb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id326bc78a24e8426bb07d9b5c1721fefb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id326bc78a24e8426bb07d9b5c1721fefb div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id326bc78a24e8426bb07d9b5c1721fefb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id326bc78a24e8426bb07d9b5c1721fefb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id326bc78a24e8426bb07d9b5c1721fefb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id326bc78a24e8426bb07d9b5c1721fefb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id326bc78a24e8426bb07d9b5c1721fefb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id326bc78a24e8426bb07d9b5c1721fefb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id326bc78a24e8426bb07d9b5c1721fefb input{text-align:left;}"; break;
		}
	}
