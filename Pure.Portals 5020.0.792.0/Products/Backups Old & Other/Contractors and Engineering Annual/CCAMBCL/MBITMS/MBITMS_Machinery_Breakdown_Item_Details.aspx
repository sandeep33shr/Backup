<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBITMS_Machinery_Breakdown_Item_Details.aspx.vb" Inherits="Nexus.PB2_MBITMS_Machinery_Breakdown_Item_Details" %>
...
function onValidate_MB_ITEM__MBITMEP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMEP", "ChildScreen");
        })();
}
function onValidate_MB_ITEM__MBITMNOT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMNOT", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MB_ITEM", "MBITMNOT");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_MB_ITEM__MBITMNOT table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MB_ITEM", "MBITMNOT");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MB_ITEM' and property 'MBITMNOT'.");
        			error.display();
...
function onValidate_MB_ITEM__MBITMSNOT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMSNOT", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("MB_ITEM", "MBITMSNOT");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_MB_ITEM__MBITMSNOT table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MB_ITEM", "MBITMSNOT");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MB_ITEM' and property 'MBITMSNOT'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MB_ITEM__MBITMEP(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBITMNOT(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBITMSNOT(null, null, null, isOnLoad);
}
</script>
...
<div id="id796d1b0236a94d5ba88c84a5a9d240f0" class="general-layout-container">
...
<div id="idb4ee3cd860fb478dbc92993a910897d5" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb4ee3cd860fb478dbc92993a910897d5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb4ee3cd860fb478dbc92993a910897d5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb4ee3cd860fb478dbc92993a910897d5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb4ee3cd860fb478dbc92993a910897d5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb4ee3cd860fb478dbc92993a910897d5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb4ee3cd860fb478dbc92993a910897d5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb4ee3cd860fb478dbc92993a910897d5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb4ee3cd860fb478dbc92993a910897d5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb4ee3cd860fb478dbc92993a910897d5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb4ee3cd860fb478dbc92993a910897d5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3a5b2d205e704cd79d1f5fe47f8ecb29" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblMB_ITEM_REFFERRAL_CLAUSES" runat="server" AssociatedControlID="MB_ITEM__REFFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="MB_ITEM__REFFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMEP"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMEP" 
		id="pb-container-childscreen-MB_ITEM-MBITMEP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_CLAUSEPREM" runat="server" ScreenCode="MBITMEP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMEP/MBITMEP_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMEP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMEP"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMEP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3a5b2d205e704cd79d1f5fe47f8ecb29 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3a5b2d205e704cd79d1f5fe47f8ecb29 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3a5b2d205e704cd79d1f5fe47f8ecb29 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3a5b2d205e704cd79d1f5fe47f8ecb29 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3a5b2d205e704cd79d1f5fe47f8ecb29 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3a5b2d205e704cd79d1f5fe47f8ecb29 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3a5b2d205e704cd79d1f5fe47f8ecb29 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3a5b2d205e704cd79d1f5fe47f8ecb29 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3a5b2d205e704cd79d1f5fe47f8ecb29 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3a5b2d205e704cd79d1f5fe47f8ecb29 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7ab725348a104e3a991df91fdd1ca7eb" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMNOT"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMNOT" 
		id="pb-container-childscreen-MB_ITEM-MBITMNOT">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_CNOTE" runat="server" ScreenCode="MBITMNOT" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMNOT/MBITMNOT_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMNOT" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMNOT"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMNOT" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7ab725348a104e3a991df91fdd1ca7eb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7ab725348a104e3a991df91fdd1ca7eb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7ab725348a104e3a991df91fdd1ca7eb div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7ab725348a104e3a991df91fdd1ca7eb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7ab725348a104e3a991df91fdd1ca7eb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7ab725348a104e3a991df91fdd1ca7eb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7ab725348a104e3a991df91fdd1ca7eb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7ab725348a104e3a991df91fdd1ca7eb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7ab725348a104e3a991df91fdd1ca7eb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7ab725348a104e3a991df91fdd1ca7eb input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide56618d14a4046c8b5d90660c0fb620c" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMSNOT"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMSNOT" 
		id="pb-container-childscreen-MB_ITEM-MBITMSNOT">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_SCNOTE" runat="server" ScreenCode="MBITMSNOT" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMSNOT/MBITMSNOT_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMSNOT" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMSNOT"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMSNOT" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide56618d14a4046c8b5d90660c0fb620c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide56618d14a4046c8b5d90660c0fb620c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide56618d14a4046c8b5d90660c0fb620c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide56618d14a4046c8b5d90660c0fb620c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide56618d14a4046c8b5d90660c0fb620c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide56618d14a4046c8b5d90660c0fb620c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide56618d14a4046c8b5d90660c0fb620c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide56618d14a4046c8b5d90660c0fb620c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide56618d14a4046c8b5d90660c0fb620c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide56618d14a4046c8b5d90660c0fb620c input{text-align:left;}"; break;
		}
	}
