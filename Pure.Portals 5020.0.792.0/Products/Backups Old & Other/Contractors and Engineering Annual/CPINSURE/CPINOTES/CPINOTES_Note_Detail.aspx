<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPINOTES_Note_Detail.aspx.vb" Inherits="Nexus.PB2_CPINOTES_Note_Detail" %>
...
function onValidate_SNOTE__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SNOTE", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SNOTE", "DATE_CREATED");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSNOTE_DATE_CREATED");
        			    var ele = document.getElementById('ctl00_cntMainBody_SNOTE__DATE_CREATED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SNOTE__DATE_CREATED_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=SNOTE&propertyName=DATE_CREATED&name={name}");
...
function onValidate_SNOTE__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SNOTE", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SNOTE", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSNOTE_CREATED_BY");
        			    var ele = document.getElementById('ctl00_cntMainBody_SNOTE__CREATED_BY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SNOTE__CREATED_BY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SNOTE__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SNOTE", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SNOTE", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSNOTE_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_SNOTE__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SNOTE__COVER_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SNOTE&propertyName=COVER_TYPE&name={name}");
...
function onValidate_SNOTE__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SNOTE", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SNOTE", "NOTE_DESCRIPTION");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSNOTE_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_SNOTE__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SNOTE__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SNOTE", "NOTE_DESCRIPTION");
...
function onValidate_SNOTE__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SNOTE", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SNOTE", "NOTE_DETAILS");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSNOTE_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_SNOTE__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SNOTE__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=SNOTE&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_SNOTE_NOTE_DETAILS_textarea');
        			if (textarea != null){
...
function DoLogic(isOnLoad) {
    onValidate_SNOTE__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_SNOTE__CREATED_BY(null, null, null, isOnLoad);
    onValidate_SNOTE__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_SNOTE__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SNOTE__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id0ae9626c721d45febf02745bdc691ec6" class="general-layout-container">
...
<div id="idff78e83f598644209d610058c762d763" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading30" runat="server" Text="Construction Plant Insurance Note Detail  (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SNOTE" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-SNOTE-DATE_CREATED">
		<asp:Label ID="lblSNOTE_DATE_CREATED" runat="server" AssociatedControlID="SNOTE__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="SNOTE__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calSNOTE__DATE_CREATED" runat="server" LinkedControl="SNOTE__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valSNOTE_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_SNOTE__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SNOTE-CREATED_BY">

		
		<asp:Label ID="lblSNOTE_CREATED_BY" runat="server" AssociatedControlID="SNOTE__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SNOTE__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSNOTE_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_SNOTE__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SNOTE-COVER_TYPE">

		
		<asp:Label ID="lblSNOTE_COVER_TYPE" runat="server" AssociatedControlID="SNOTE__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SNOTE__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSNOTE_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_SNOTE__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SNOTE-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblSNOTE_NOTE_DESCRIPTION" runat="server" AssociatedControlID="SNOTE__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SNOTE__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSNOTE_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_SNOTE__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-SNOTE-NOTE_DETAILS">
		<asp:Label ID="lblSNOTE_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="SNOTE__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="SNOTE__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valSNOTE_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_SNOTE__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idff78e83f598644209d610058c762d763 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idff78e83f598644209d610058c762d763 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idff78e83f598644209d610058c762d763 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idff78e83f598644209d610058c762d763 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idff78e83f598644209d610058c762d763 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idff78e83f598644209d610058c762d763 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idff78e83f598644209d610058c762d763 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idff78e83f598644209d610058c762d763 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idff78e83f598644209d610058c762d763 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idff78e83f598644209d610058c762d763 input{text-align:left;}"; break;
		}
	}
