...
Namespace Nexus
    Partial Class PB2_CPISNOTE_Note_Detail : Inherits BaseRisk
		...
		Protected Sub onValidate_PLANT_SCNOTE_DETAIL__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If PLANT_SCNOTE_DETAIL__Date_Created.Text.ToString = "" Then
        		PLANT_SCNOTE_DETAIL__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		PLANT_SCNOTE_DETAIL__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_PLANT_SCNOTE_DETAIL__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PLANT_SCNOTE_DETAIL__NOTE_DETAILS()
    onValidate_PLANT_SCNOTE_DETAIL__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		PLANT_SCNOTE_DETAIL__NoteCheck.Text = 1
        	End If
        End Sub
