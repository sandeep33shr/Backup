<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="REINSUINW_Inwards_Details.aspx.vb" Inherits="Nexus.PB2_REINSUINW_Inwards_Details" %>
...
function onValidate_CONTESTP__COMPANY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONTESTP", "COMPANY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONTESTP", "COMPANY");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CONTESTP", "COMPANY");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONTESTP.COMPANY");
        			window.setControlWidth(field, "0.5", "CONTESTP", "COMPANY");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Enter Company")) ? "Please Enter Company" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CONTESTP".toUpperCase() + "__" + "COMPANY");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CONTESTP".toUpperCase() + "_" + "COMPANY");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("CONTESTP.COMPANY <> ''");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONTESTP_COMPANY");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONTESTP__COMPANY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONTESTP__COMPANY_lblFindParty");
        			    }
        			}
...
function onValidate_CONTESTP__PER_SHARE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONTESTP", "PER_SHARE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONTESTP", "PER_SHARE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CONTESTP", "PER_SHARE");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Enter Percentage Share")) ? "Please Enter Percentage Share" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CONTESTP".toUpperCase() + "__" + "PER_SHARE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CONTESTP".toUpperCase() + "_" + "PER_SHARE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("CONTESTP.PER_SHARE > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONTESTP.PER_SHARE");
        			window.setControlWidth(field, "0.5", "CONTESTP", "PER_SHARE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONTESTP_PER_SHARE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONTESTP__PER_SHARE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONTESTP__PER_SHARE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CONTESTP__NOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONTESTP", "NOTES", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONTESTP", "NOTES");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CONTESTP", "NOTES");
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Enter NOTES")) ? "Please Enter NOTES" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CONTESTP".toUpperCase() + "__" + "NOTES");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CONTESTP".toUpperCase() + "_" + "NOTES");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONTESTP.NOTES");
        			window.setControlWidth(field, "0.5", "CONTESTP", "NOTES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONTESTP_NOTES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONTESTP__NOTES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONTESTP__NOTES_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_CONTESTP__COMPANY(null, null, null, isOnLoad);
    onValidate_CONTESTP__PER_SHARE(null, null, null, isOnLoad);
    onValidate_CONTESTP__NOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id940c7e11eea149fe86edbd0359ecb6b0" class="general-layout-container">
...
<div id="id7383af847d8c4330a3a5a123d8724d72" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="Co/Re-insurance Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CONTESTP" 
		data-property-name="COMPANY" 
		 
		
		 
		id="pb-container-text-CONTESTP-COMPANY">

		
		<asp:Label ID="lblCONTESTP_COMPANY" runat="server" AssociatedControlID="CONTESTP__COMPANY" 
			Text="Company" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CONTESTP__COMPANY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCONTESTP_COMPANY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Company"
					ClientValidationFunction="onValidate_CONTESTP__COMPANY"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CONTESTP" 
		data-property-name="PER_SHARE" 
		id="pb-container-percentage-CONTESTP-PER_SHARE">
		<asp:Label ID="lblCONTESTP_PER_SHARE" runat="server" AssociatedControlID="CONTESTP__PER_SHARE" 
			Text="Percentage Share" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CONTESTP__PER_SHARE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCONTESTP_PER_SHARE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Percentage Share"
			ClientValidationFunction="onValidate_CONTESTP__PER_SHARE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-CONTESTP-NOTES">
		<asp:Label ID="lblCONTESTP_NOTES" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="CONTESTP__NOTES" 
			Text="Notes"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="CONTESTP__NOTES" runat="server" />
		
		<asp:CustomValidator ID="valCONTESTP_NOTES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Notes"
			ClientValidationFunction="onValidate_CONTESTP__NOTES"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7383af847d8c4330a3a5a123d8724d72 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7383af847d8c4330a3a5a123d8724d72 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7383af847d8c4330a3a5a123d8724d72 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7383af847d8c4330a3a5a123d8724d72 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7383af847d8c4330a3a5a123d8724d72 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7383af847d8c4330a3a5a123d8724d72 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7383af847d8c4330a3a5a123d8724d72 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7383af847d8c4330a3a5a123d8724d72 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7383af847d8c4330a3a5a123d8724d72 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7383af847d8c4330a3a5a123d8724d72 input{text-align:left;}"; break;
		}
	}
