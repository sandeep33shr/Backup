        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDDEDUC.DESCRIPTION");
        			window.setControlWidth(field, "0.5", "ADDDEDUC", "DESCRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDDEDUC.PERCENTAGE");
        			window.setControlWidth(field, "0.5", "ADDDEDUC", "PERCENTAGE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDDEDUC.MINIMUMAMT");
        			window.setControlWidth(field, "0.5", "ADDDEDUC", "MINIMUMAMT");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDDEDUC.MAXIMUMAMT");
        			window.setControlWidth(field, "0.5", "ADDDEDUC", "MAXIMUMAMT");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDDEDUC.BASISDED");
        			window.setControlWidth(field, "0.5", "ADDDEDUC", "BASISDED");
        		})();
        	}
        })();
...
<div id="id103be96fadf94604ac69e8e36a50bb76" class="general-layout-container">
...
<div id="id4e07635caaaf485ab8a71cbf69d5239f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading22" runat="server" Text="Additional Deductibles" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4e07635caaaf485ab8a71cbf69d5239f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4e07635caaaf485ab8a71cbf69d5239f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4e07635caaaf485ab8a71cbf69d5239f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4e07635caaaf485ab8a71cbf69d5239f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4e07635caaaf485ab8a71cbf69d5239f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4e07635caaaf485ab8a71cbf69d5239f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4e07635caaaf485ab8a71cbf69d5239f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4e07635caaaf485ab8a71cbf69d5239f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4e07635caaaf485ab8a71cbf69d5239f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4e07635caaaf485ab8a71cbf69d5239f input{text-align:left;}"; break;
		}
	}
