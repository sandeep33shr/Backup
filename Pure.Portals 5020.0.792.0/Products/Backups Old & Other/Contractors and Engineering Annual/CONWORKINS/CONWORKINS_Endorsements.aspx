<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKINS_Endorsements.aspx.vb" Inherits="Nexus.PB2_CONWORKINS_Endorsements" %>
...
function onValidate_CWIRSK__TOT_ENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "TOT_ENDPREM", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWIRSK.TOT_ENDPREM");
        			window.setControlWidth(field, "0.4", "CWIRSK", "TOT_ENDPREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_TOT_ENDPREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__TOT_ENDPREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__TOT_ENDPREM_lblFindParty");
        			    }
        			}
...
function onValidate_CWIRSK__CWIENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "CWIENDOS", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CWIRSK__TOT_ENDPREM(null, null, null, isOnLoad);
    onValidate_CWIRSK__CWIENDOS(null, null, null, isOnLoad);
}
</script>
...
<div id="id4bca0913337542ad9eb7d386596b6022" class="general-layout-container">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblCWIRSK_REFERRAL_CLAUSES" runat="server" AssociatedControlID="CWIRSK__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="CWIRSK__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CWIRSK-TOT_ENDPREM">
		<asp:Label ID="lblCWIRSK_TOT_ENDPREM" runat="server" AssociatedControlID="CWIRSK__TOT_ENDPREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CWIRSK__TOT_ENDPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCWIRSK_TOT_ENDPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_CWIRSK__TOT_ENDPREM" 
			ValidationGroup=""
			Display="None"
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWIRSK__CWIENDOS"
		data-field-type="Child" 
		data-object-name="CWIRSK" 
		data-property-name="CWIENDOS" 
		id="pb-container-childscreen-CWIRSK-CWIENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWIRSK__GPA_ENDOSES" runat="server" ScreenCode="CWIENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CWIENDOS/CWIENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCWIRSK_CWIENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CWIRSK.CWIENDOS"
						ClientValidationFunction="onValidate_CWIRSK__CWIENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
