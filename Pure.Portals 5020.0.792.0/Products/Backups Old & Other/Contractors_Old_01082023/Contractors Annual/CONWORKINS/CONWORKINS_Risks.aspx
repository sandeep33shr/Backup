...
function onValidate_RISKDETAILS__MAX_VAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISKDETAILS", "MAX_VAL", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RISKDETAILS", "MAX_VAL");
        		}
        		//window.setProperty(field, "VEM", "RISKDETAILS.MAX_VAL < 0", "VEM", "Max Value is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "RISKDETAILS.MAX_VAL < 0",
            paramElseValue = "VEM",
            paramValidationMessage = "Max Value is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Max Value must be greater than 0")) ? "Max Value must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "MAX_VAL");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "MAX_VAL");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("RISKDETAILS.MAX_VAL > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISKDETAILS__MAXPERIOD(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Max Perriod (Months) is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Max Period (Months) must be greater than 0")) ? "Max Period (Months) must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "MAXPERIOD");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "MAXPERIOD");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISKDETAILS.MAXPERIOD > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISKDETAILS__OWNIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("At least one of Own Works or PCI/Sub Contract Works must be selected")) ? "At least one of Own Works or PCI/Sub Contract Works must be selected" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "OWNIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "OWNIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISKDETAILS.OWNIND == 1 || RISKDETAILS.PCIIND == 1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISKDETAILS__ESTANNTUR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.OWNIND == true ", "R", "Own Works Estimated Annual Turnover is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "RISKDETAILS.OWNIND == true ",
            paramElseValue = "R",
            paramValidationMessage = "Own Works Estimated Annual Turnover is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Own Works Estimated Annual Turnover must be greater than 0")) ? "Own Works Estimated Annual Turnover must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "ESTANNTUR");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "ESTANNTUR");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISKDETAILS.ESTANNTUR > 0 || RISKDETAILS.OWNIND == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=RISKDETAILS&propertyName=ESTANNTUR&name={name}");
...
function onValidate_RISKDETAILS__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.OWNIND == true  ", "R", "Own Works Rate is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "RISKDETAILS.OWNIND == true  ",
            paramElseValue = "R",
            paramValidationMessage = "Own Works Rate is mandatory and an amount must be entered";
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("RISKDETAILS.PREMIUM_LIM / RISKDETAILS.ESTANNTUR * 100"), 
        			condition = (Expression.isValidParameter("RISKDETAILS.ESTANNTUR > 0")) ? new Expression("RISKDETAILS.ESTANNTUR > 0") : null, 
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Own Works Rate must be between 0 and 100%")) ? "Own Works Rate must be between 0 and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(RISKDETAILS.RATE > 0 && RISKDETAILS.RATE <= 100) || RISKDETAILS.OWNIND == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISKDETAILS__PREMIUM_LIM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.OWNIND == true ", "R", "Own Works Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "RISKDETAILS.OWNIND == true ",
            paramElseValue = "R",
            paramValidationMessage = "Own Works Premium is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRISKDETAILS_PREMIUM_LIM");
        			    var ele = document.getElementById('ctl00_cntMainBody_RISKDETAILS__PREMIUM_LIM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISKDETAILS__PREMIUM_LIM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Own Works Premium must be greater than 0")) ? "Own Works Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "PREMIUM_LIM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "PREMIUM_LIM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISKDETAILS.PREMIUM_LIM > 0 || RISKDETAILS.OWNIND == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label1(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "RISKDETAILS.OWNIND == true  ", "R", "{3}");
...
function onValidate_RISKDETAILS__PCIESTANNTUR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.PCIIND == true ", "R", "PCI/ Sub Contract Works Estimated Annual Turnover is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "RISKDETAILS.PCIIND == true ",
            paramElseValue = "R",
            paramValidationMessage = "PCI/ Sub Contract Works Estimated Annual Turnover is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRISKDETAILS_PCIESTANNTUR");
        			    var ele = document.getElementById('ctl00_cntMainBody_RISKDETAILS__PCIESTANNTUR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISKDETAILS__PCIESTANNTUR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("PCI/Sub Contract Works Estimated Annual Turnover must be greater than 0")) ? "PCI/Sub Contract Works Estimated Annual Turnover must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "PCIESTANNTUR");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "PCIESTANNTUR");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISKDETAILS.PCIESTANNTUR > 0 || RISKDETAILS.PCIIND == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISKDETAILS__PCIRATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", " RISKDETAILS.PCIIND == true ", "R", "PCI/ Sub Contract Works Rate is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = " RISKDETAILS.PCIIND == true ",
            paramElseValue = "R",
            paramValidationMessage = "PCI/ Sub Contract Works Rate is mandatory and an amount must be entered";
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("RISKDETAILS.PCIIND == true && RISKDETAILS.PCIPREMIUM_LIM / RISKDETAILS.PCIESTANNTUR * 100"), 
        			condition = (Expression.isValidParameter("RISKDETAILS.PCIESTANNTUR> 0")) ? new Expression("RISKDETAILS.PCIESTANNTUR> 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRISKDETAILS_PCIRATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_RISKDETAILS__PCIRATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISKDETAILS__PCIRATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("PCI/Sub Contract Works Rate must be between 0 and 100%")) ? "PCI/Sub Contract Works Rate must be between 0 and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "PCIRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "PCIRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(RISKDETAILS.PCIRATE > 0 && RISKDETAILS.PCIRATE <= 100) || RISKDETAILS.PCIIND == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISKDETAILS__PCIPREMIUM_LIM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.PCIIND == true ", "R", "PCI/ Sub Contract Works Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "RISKDETAILS.PCIIND == true ",
            paramElseValue = "R",
            paramValidationMessage = "PCI/ Sub Contract Works Premium is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRISKDETAILS_PCIPREMIUM_LIM");
        			    var ele = document.getElementById('ctl00_cntMainBody_RISKDETAILS__PCIPREMIUM_LIM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RISKDETAILS__PCIPREMIUM_LIM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("PCI/Sub Contract Works Premium must be greater than 0")) ? "PCI/Sub Contract Works Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "PCIPREMIUM_LIM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "PCIPREMIUM_LIM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("RISKDETAILS.PCIPREMIUM_LIM > 0 || RISKDETAILS.PCIIND == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISKDETAILS__DEP_PREM_PER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("RISKDETAILS", "DEP_PREM_PER");
        		var errorMessage = "Deposit Premium Percentage is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Deposit Premium Percentage must be between 0 and 100")) ? "Deposit Premium Percentage must be between 0 and 100" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "__" + "DEP_PREM_PER");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "RISKDETAILS".toUpperCase() + "_" + "DEP_PREM_PER");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(RISKDETAILS.DEP_PREM_PER > 0 && RISKDETAILS.DEP_PREM_PER <= 100) || RISKDETAILS.DEP_PREM_IND == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_RISKDETAILS__DEP_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("RISKDETAILS.DEP_PREM_PER * 0.01  * RISKDETAILS.TOTPREMIUM_LIM "), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
<div id="id61458924bca74be2b2d81e75e6b2d06d" class="general-layout-container">
...
<div id="id87609d3413124c9ca8cd976338c63bd2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading19" runat="server" Text="Any One Contract Limits" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblRISKDETAILS_MAXPERIOD" runat="server" AssociatedControlID="RISKDETAILS__MAXPERIOD" 
			Text="Max Period (Months)" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="RISKDETAILS__MAXPERIOD" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valRISKDETAILS_MAXPERIOD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Max Period (Months)"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id87609d3413124c9ca8cd976338c63bd2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id87609d3413124c9ca8cd976338c63bd2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id87609d3413124c9ca8cd976338c63bd2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id87609d3413124c9ca8cd976338c63bd2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id87609d3413124c9ca8cd976338c63bd2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id87609d3413124c9ca8cd976338c63bd2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id87609d3413124c9ca8cd976338c63bd2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id87609d3413124c9ca8cd976338c63bd2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id87609d3413124c9ca8cd976338c63bd2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id87609d3413124c9ca8cd976338c63bd2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5e90f9ed98db4cb5b8b989a10d9156ca" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Premium Details" /></legend>
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		<asp:CustomValidator ID="valRISKDETAILS_OWNIND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Own Works"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblRISKDETAILS_ESTANNTUR" runat="server" AssociatedControlID="RISKDETAILS__ESTANNTUR" 
			Text="Estimated Annual Turnover" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valRISKDETAILS_ESTANNTUR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Estimated Annual Turnover"
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		<asp:CustomValidator ID="valRISKDETAILS_PCIIND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PCI/ Sub Contract Works"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5e90f9ed98db4cb5b8b989a10d9156ca div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5e90f9ed98db4cb5b8b989a10d9156ca div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5e90f9ed98db4cb5b8b989a10d9156ca div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5e90f9ed98db4cb5b8b989a10d9156ca label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5e90f9ed98db4cb5b8b989a10d9156ca label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5e90f9ed98db4cb5b8b989a10d9156ca label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5e90f9ed98db4cb5b8b989a10d9156ca label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5e90f9ed98db4cb5b8b989a10d9156ca input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5e90f9ed98db4cb5b8b989a10d9156ca input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5e90f9ed98db4cb5b8b989a10d9156ca input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3fe7e96b02a749379a5517411df1166f" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblRISKDETAILS_TOTAL_EST_TURN" runat="server" AssociatedControlID="RISKDETAILS__TOTAL_EST_TURN" 
			Text="Total Estimated Turnover" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valRISKDETAILS_TOTAL_EST_TURN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Estimated Turnover"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblRISKDETAILS_FINAL_PREM" runat="server" AssociatedControlID="RISKDETAILS__FINAL_PREM" 
			Text="Final Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valRISKDETAILS_FINAL_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Final Premium"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3fe7e96b02a749379a5517411df1166f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3fe7e96b02a749379a5517411df1166f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3fe7e96b02a749379a5517411df1166f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3fe7e96b02a749379a5517411df1166f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3fe7e96b02a749379a5517411df1166f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3fe7e96b02a749379a5517411df1166f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3fe7e96b02a749379a5517411df1166f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3fe7e96b02a749379a5517411df1166f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3fe7e96b02a749379a5517411df1166f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3fe7e96b02a749379a5517411df1166f input{text-align:left;}"; break;
		}
	}
...
<div id="DepPrem" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading22" runat="server" Text="Deposit Premium" /></legend>
