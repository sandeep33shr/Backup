...
Namespace Nexus
    Partial Class PB2_DSINOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_DSITEM_NOTES__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If DSITEM_NOTES__Date_Created.Text.ToString = "" Then
        		DSITEM_NOTES__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		DSITEM_NOTES__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_DSITEM_NOTES__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DSITEM_NOTES__NOTE_DETAILS()
    onValidate_DSITEM_NOTES__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		DSITEM_NOTES__NoteCheck.Text = 1
        	End If
        End Sub
