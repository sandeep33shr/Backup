...
Namespace Nexus
    Partial Class PB2_MBITMSNOT_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_MBITEM_SCNOTE__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If MBITEM_SCNOTE__Date_Created.Text.ToString = "" Then
        		MBITEM_SCNOTE__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		MBITEM_SCNOTE__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_MBITEM_SCNOTE__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MBITEM_SCNOTE__NOTE_DETAILS()
    onValidate_MBITEM_SCNOTE__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		MBITEM_SCNOTE__NoteCheck.Text = 1
        	End If
        End Sub
