...
function onValidate_CLOSS__TOTAL_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CLOSS.CL_TOTPREM + CLOSS.CL_TOTENDPREM + CLOSS.POST_TOTAL + CLOSS.TOT_PREM"), 
...
function onValidate_CLOSS__AICOW_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Additional Increase Cost of Working FAP value cannot be more than 100%")) ? "Additional Increase Cost of Working FAP value cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
<div id="id8d0829be0b1049edaf22cf2479876903" class="general-layout-container">
...
<div id="idaca205f4fc3f4b63b61f9a878aa8983f" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idaca205f4fc3f4b63b61f9a878aa8983f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idaca205f4fc3f4b63b61f9a878aa8983f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idaca205f4fc3f4b63b61f9a878aa8983f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idaca205f4fc3f4b63b61f9a878aa8983f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idaca205f4fc3f4b63b61f9a878aa8983f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaca205f4fc3f4b63b61f9a878aa8983f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaca205f4fc3f4b63b61f9a878aa8983f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idaca205f4fc3f4b63b61f9a878aa8983f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaca205f4fc3f4b63b61f9a878aa8983f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaca205f4fc3f4b63b61f9a878aa8983f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id632aafd83a554a0ab90f244ec0691da3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading42" runat="server" Text="Consequential Loss " /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id632aafd83a554a0ab90f244ec0691da3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id632aafd83a554a0ab90f244ec0691da3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id632aafd83a554a0ab90f244ec0691da3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id632aafd83a554a0ab90f244ec0691da3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id632aafd83a554a0ab90f244ec0691da3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id632aafd83a554a0ab90f244ec0691da3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id632aafd83a554a0ab90f244ec0691da3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id632aafd83a554a0ab90f244ec0691da3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id632aafd83a554a0ab90f244ec0691da3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id632aafd83a554a0ab90f244ec0691da3 input{text-align:left;}"; break;
		}
	}
...
<!-- /Label -->
	...
	<span id="pb-container-label-label23">
		<span class="label" id="label23">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label24">
		<span class="label" id="label24">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label25">
		<span class="label" id="label25">Posting Premium </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label26">
		<span class="label" id="label26">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label27">
		<span class="label" id="label27">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label28">
		<span class="label" id="label28">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label31">
		<span class="label" id="label31">Additional Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label32">
		<span class="label" id="label32">Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label34">
		<span class="label" id="label34">Total</span>
	</span>
<!-- /Label -->
...
<div id="frmCLEnd" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading45" runat="server" Text="Endorsements" /></legend>
...
<div id="frmCLNOTE" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading46" runat="server" Text="Consequential Loss Notes (Not Printed on Schedule)" /></legend>
...
<div id="frmCLSNOTE" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading47" runat="server" Text="Consequential Loss Notes (Printed on Schedule)" /></legend>
