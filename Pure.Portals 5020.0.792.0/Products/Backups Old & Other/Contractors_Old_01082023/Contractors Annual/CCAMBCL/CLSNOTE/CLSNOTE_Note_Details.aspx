<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_CLSNOTE_Note_Details" %>
...
function onValidate_CL_SNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CL_SNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "3", "CL_SNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CL_SNOTES", "NOTE_DESCRIPTION");
        		var exp = new Expression("CL_SNOTES.NoteCheck = 1");
...
function onValidate_CL_SNOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CL_SNOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CL_SNOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CL_SNOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id2afd89c828054c14b1ddbd53560e5c7c" class="general-layout-container">
...
<div id="id27e45e0f6c9d42d2b01da3d33d9b319a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading39" runat="server" Text="Note Details (Printed on Schedule)" /></legend>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCL_SNOTES_NoteCheck" for="ctl00_cntMainBody_CL_SNOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CL_SNOTES-NoteCheck">	
		
		<asp:TextBox ID="CL_SNOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCL_SNOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_CL_SNOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id27e45e0f6c9d42d2b01da3d33d9b319a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id27e45e0f6c9d42d2b01da3d33d9b319a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id27e45e0f6c9d42d2b01da3d33d9b319a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id27e45e0f6c9d42d2b01da3d33d9b319a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id27e45e0f6c9d42d2b01da3d33d9b319a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27e45e0f6c9d42d2b01da3d33d9b319a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27e45e0f6c9d42d2b01da3d33d9b319a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id27e45e0f6c9d42d2b01da3d33d9b319a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27e45e0f6c9d42d2b01da3d33d9b319a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27e45e0f6c9d42d2b01da3d33d9b319a input{text-align:left;}"; break;
		}
	}
