<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPINOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_CPINOTES_Note_Details" %>
...
function onValidate_GPASNOTESS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPASNOTESS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPASNOTESS", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPASNOTESS.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "GPASNOTESS", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=GPASNOTESS&propertyName=DATE_CREATED&name={name}");
...
function onValidate_GPASNOTESS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPASNOTESS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPASNOTESS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPASNOTESS.CREATED_BY");
        			window.setControlWidth(field, "0.5", "GPASNOTESS", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_GPASNOTESS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPASNOTESS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPASNOTESS", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPASNOTESS.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "GPASNOTESS", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GPASNOTESS&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'Contract Plants Insurance'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GPASNOTESS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPASNOTESS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPASNOTESS", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPASNOTESS.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "GPASNOTESS", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_GPASNOTESS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPASNOTESS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GPASNOTESS", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPASNOTESS.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "GPASNOTESS", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=GPASNOTESS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_GPASNOTESS__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_GPASNOTESS_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_GPASNOTESS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_GPASNOTESS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_GPASNOTESS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_GPASNOTESS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_GPASNOTESS__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id9073186966fb4891a27bc8c402d7d54d" class="general-layout-container">
...
<div id="id60ec19cbdf6d40798959958edfd4de0a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading67" runat="server" Text="Construction Plant Insurance Note Detail  (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GPASNOTESS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-GPASNOTESS-DATE_CREATED">
		<asp:Label ID="lblGPASNOTESS_DATE_CREATED" runat="server" AssociatedControlID="GPASNOTESS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="GPASNOTESS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calGPASNOTESS__DATE_CREATED" runat="server" LinkedControl="GPASNOTESS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valGPASNOTESS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_GPASNOTESS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPASNOTESS-CREATED_BY">

		
		<asp:Label ID="lblGPASNOTESS_CREATED_BY" runat="server" AssociatedControlID="GPASNOTESS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPASNOTESS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPASNOTESS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_GPASNOTESS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPASNOTESS-COVER_TYPE">

		
		<asp:Label ID="lblGPASNOTESS_COVER_TYPE" runat="server" AssociatedControlID="GPASNOTESS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPASNOTESS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPASNOTESS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_GPASNOTESS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPASNOTESS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblGPASNOTESS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="GPASNOTESS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPASNOTESS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPASNOTESS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_GPASNOTESS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-GPASNOTESS-NOTE_DETAILS">
		<asp:Label ID="lblGPASNOTESS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="GPASNOTESS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="GPASNOTESS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valGPASNOTESS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_GPASNOTESS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id60ec19cbdf6d40798959958edfd4de0a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id60ec19cbdf6d40798959958edfd4de0a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id60ec19cbdf6d40798959958edfd4de0a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id60ec19cbdf6d40798959958edfd4de0a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id60ec19cbdf6d40798959958edfd4de0a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60ec19cbdf6d40798959958edfd4de0a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60ec19cbdf6d40798959958edfd4de0a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id60ec19cbdf6d40798959958edfd4de0a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60ec19cbdf6d40798959958edfd4de0a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60ec19cbdf6d40798959958edfd4de0a input{text-align:left;}"; break;
		}
	}
