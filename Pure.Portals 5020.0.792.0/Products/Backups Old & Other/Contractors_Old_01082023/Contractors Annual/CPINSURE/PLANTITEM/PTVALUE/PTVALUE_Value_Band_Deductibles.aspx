        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VALUEBD.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "VALUEBD", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_VALUEBD__VALUE_EXC(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__VALUE_EXC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__VALUE_EXC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VALUEBD.VALUE_EXC");
        			window.setControlWidth(field, "0.8", "VALUEBD", "VALUE_EXC");
        		})();
        	}
        })();
        /**
...
function onValidate_VALUEBD__VAL_NOTEXC(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__VAL_NOTEXC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__VAL_NOTEXC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VALUEBD.VAL_NOTEXC");
        			window.setControlWidth(field, "0.8", "VALUEBD", "VAL_NOTEXC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__MINIMUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__MINIMUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VALUEBD.MINIMUM");
        			window.setControlWidth(field, "0.8", "VALUEBD", "MINIMUM");
        		})();
        	}
        })();
        /**
...
function onValidate_VALUEBD__BASIS_DENV(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "VALUEBD.MINIMUM>0 ", "VE", "Basis of Deductible is mandatory and an option must be selected");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__BASIS_DENV');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__BASIS_DENV_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VALUEBD.BASIS_DENV");
        			window.setControlWidth(field, "0.8", "VALUEBD", "BASIS_DENV");
        		})();
        	}
        })();
}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__MAXIMUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__MAXIMUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VALUEBD.MAXIMUM");
        			window.setControlWidth(field, "0.8", "VALUEBD", "MAXIMUM");
        		})();
        	}
        })();
        /**
...
function onValidate_VALUEBD__BASI_DENVB(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "VALUEBD.MAXIMUM>0 ", "VE", "Basis of Deductible is mandatory and an option must be selected");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__BASI_DENVB');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__BASI_DENVB_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VALUEBD.BASI_DENVB");
        			window.setControlWidth(field, "0.8", "VALUEBD", "BASI_DENVB");
        		})();
        	}
        })();
}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__MINIMUM_AM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__MINIMUM_AM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VALUEBD.MINIMUM_AM");
        			window.setControlWidth(field, "0.8", "VALUEBD", "MINIMUM_AM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_VALUEBD__MAXIMUM_AM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VALUEBD__MAXIMUM_AM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VALUEBD.MAXIMUM_AM");
        			window.setControlWidth(field, "0.8", "VALUEBD", "MAXIMUM_AM");
        		})();
        	}
        })();
        /**
...
<div id="id24a5c0a7e8fe4e7ca7186880bdb5b7b2" class="general-layout-container">
...
<div id="id09ab22f97d614d96a1083b0932db80d2" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id09ab22f97d614d96a1083b0932db80d2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id09ab22f97d614d96a1083b0932db80d2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id09ab22f97d614d96a1083b0932db80d2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id09ab22f97d614d96a1083b0932db80d2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id09ab22f97d614d96a1083b0932db80d2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id09ab22f97d614d96a1083b0932db80d2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id09ab22f97d614d96a1083b0932db80d2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id09ab22f97d614d96a1083b0932db80d2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id09ab22f97d614d96a1083b0932db80d2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id09ab22f97d614d96a1083b0932db80d2 input{text-align:left;}"; break;
		}
	}
