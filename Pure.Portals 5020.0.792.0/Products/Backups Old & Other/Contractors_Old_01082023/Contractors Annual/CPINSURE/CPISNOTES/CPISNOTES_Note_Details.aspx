<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPISNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_CPISNOTES_Note_Details" %>
...
function onValidate_GPANOTESS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTESS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTESS", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTESS.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "GPANOTESS", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=GPANOTESS&propertyName=DATE_CREATED&name={name}");
...
function onValidate_GPANOTESS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTESS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTESS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTESS.CREATED_BY");
        			window.setControlWidth(field, "0.5", "GPANOTESS", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_GPANOTESS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTESS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTESS", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTESS.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "GPANOTESS", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GPANOTESS&propertyName=COVER_TYPE&name={name}");
...
function onValidate_GPANOTESS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTESS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTESS", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTESS.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "GPANOTESS", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_GPANOTESS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTESS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GPANOTESS", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTESS.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "GPANOTESS", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=GPANOTESS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_GPANOTESS__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_GPANOTESS_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_GPANOTESS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_GPANOTESS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_GPANOTESS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_GPANOTESS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_GPANOTESS__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id43741863aeaf4194be54d127b891c7a5" class="general-layout-container">
...
<div id="id37638c89002b44868b302667d569a35f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading65" runat="server" Text="Construction Plant Insurance Note Detail (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GPANOTESS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-GPANOTESS-DATE_CREATED">
		<asp:Label ID="lblGPANOTESS_DATE_CREATED" runat="server" AssociatedControlID="GPANOTESS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="GPANOTESS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calGPANOTESS__DATE_CREATED" runat="server" LinkedControl="GPANOTESS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valGPANOTESS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_GPANOTESS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPANOTESS-CREATED_BY">

		
		<asp:Label ID="lblGPANOTESS_CREATED_BY" runat="server" AssociatedControlID="GPANOTESS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPANOTESS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPANOTESS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_GPANOTESS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPANOTESS-COVER_TYPE">

		
		<asp:Label ID="lblGPANOTESS_COVER_TYPE" runat="server" AssociatedControlID="GPANOTESS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPANOTESS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPANOTESS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_GPANOTESS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPANOTESS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblGPANOTESS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="GPANOTESS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPANOTESS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPANOTESS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_GPANOTESS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-GPANOTESS-NOTE_DETAILS">
		<asp:Label ID="lblGPANOTESS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="GPANOTESS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="GPANOTESS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valGPANOTESS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_GPANOTESS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id37638c89002b44868b302667d569a35f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id37638c89002b44868b302667d569a35f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id37638c89002b44868b302667d569a35f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id37638c89002b44868b302667d569a35f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id37638c89002b44868b302667d569a35f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37638c89002b44868b302667d569a35f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37638c89002b44868b302667d569a35f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id37638c89002b44868b302667d569a35f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37638c89002b44868b302667d569a35f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37638c89002b44868b302667d569a35f input{text-align:left;}"; break;
		}
	}
