...
function onValidate_REPLACE__label86(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "REPLACE", "label86", "Currency");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_REPLACE__label86(null, null, null, isOnLoad);
...
<div id="id77b0dd2637d8429e8fd6f95ee961237e" class="general-layout-container">
...
<div id="id394c56f153a24908b288c287f28f2cba" class="column-layout-container,no-border  ">
...
<!-- /Label -->
									...
									<li class="co-cell"  style="width:25%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-TOTAL_PREM">
		<span class="label" id="TOTAL_PREM">Total</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-REPLACE-label86">
		<asp:Label ID="lblREPLACE_label86" runat="server" AssociatedControlID="REPLACE__label86" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="REPLACE__label86" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valREPLACE_label86" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for REPLACE.label86"
			ClientValidationFunction="onValidate_REPLACE__label86" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id394c56f153a24908b288c287f28f2cba div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id394c56f153a24908b288c287f28f2cba div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id394c56f153a24908b288c287f28f2cba div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id394c56f153a24908b288c287f28f2cba label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id394c56f153a24908b288c287f28f2cba label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id394c56f153a24908b288c287f28f2cba label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id394c56f153a24908b288c287f28f2cba label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id394c56f153a24908b288c287f28f2cba input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id394c56f153a24908b288c287f28f2cba input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id394c56f153a24908b288c287f28f2cba input{text-align:left;}"; break;
		}
	}
