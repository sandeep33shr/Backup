...
function onValidate_NOTES__CPISNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "CPISNOTES", "ChildScreen");
        })();
}
function onValidate_NOTES__CPINOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "CPINOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__CPISNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__CPINOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id7691bf3334b746d984afa748ede4da6b" class="general-layout-container">
...
<div id="id95d23ce9102042d494778518d8a18878" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading69" runat="server" Text="Construction Plant Insurance Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__CPISNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="CPISNOTES" 
		id="pb-container-childscreen-NOTES-CPISNOTES">
		
		    <legend>Notes Not Printed</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__GPANOTESS" runat="server" ScreenCode="CPISNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPISNOTES/CPISNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_CPISNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes Not Printed"
						ClientValidationFunction="onValidate_NOTES__CPISNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id95d23ce9102042d494778518d8a18878 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id95d23ce9102042d494778518d8a18878 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id95d23ce9102042d494778518d8a18878 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id95d23ce9102042d494778518d8a18878 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id95d23ce9102042d494778518d8a18878 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id95d23ce9102042d494778518d8a18878 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id95d23ce9102042d494778518d8a18878 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id95d23ce9102042d494778518d8a18878 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id95d23ce9102042d494778518d8a18878 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id95d23ce9102042d494778518d8a18878 input{text-align:left;}"; break;
		}
	}
...
<div id="frmExtNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading70" runat="server" Text="Construction Plant Insurance (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__CPINOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="CPINOTES" 
		id="pb-container-childscreen-NOTES-CPINOTES">
		
		    <legend>Notes Printed</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__GPASNOTESS" runat="server" ScreenCode="CPINOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPINOTES/CPINOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_CPINOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes Printed"
						ClientValidationFunction="onValidate_NOTES__CPINOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
