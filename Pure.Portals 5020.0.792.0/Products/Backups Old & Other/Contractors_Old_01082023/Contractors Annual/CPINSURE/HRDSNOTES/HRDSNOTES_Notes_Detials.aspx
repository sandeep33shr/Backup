<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="HRDSNOTES_Notes_Detials.aspx.vb" Inherits="Nexus.PB2_HRDSNOTES_Notes_Detials" %>
...
function onValidate_OWNNOTESN__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTESN", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNNOTESN", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTESN.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "OWNNOTESN", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=OWNNOTESN&propertyName=DATE_CREATED&name={name}");
...
function onValidate_OWNNOTESN__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTESN", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNNOTESN", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTESN.CREATED_BY");
        			window.setControlWidth(field, "0.5", "OWNNOTESN", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_OWNNOTESN__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTESN", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNNOTESN", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTESN.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "OWNNOTESN", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=OWNNOTESN&propertyName=COVER_TYPE&name={name}");
...
function onValidate_OWNNOTESN__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTESN", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNNOTESN", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTESN.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "OWNNOTESN", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_OWNNOTESN__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTESN", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OWNNOTESN", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTESN.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "OWNNOTESN", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=OWNNOTESN&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_OWNNOTESN__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_OWNNOTESN_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_OWNNOTESN__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_OWNNOTESN__CREATED_BY(null, null, null, isOnLoad);
    onValidate_OWNNOTESN__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_OWNNOTESN__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_OWNNOTESN__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="idd8e8ded969904fda98b86795150ea05c" class="general-layout-container">
...
<div id="id04d691986a9d4250886e55d7c5cb11ee" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading29" runat="server" Text="Construction Plant Insurance Notes (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OWNNOTESN" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-OWNNOTESN-DATE_CREATED">
		<asp:Label ID="lblOWNNOTESN_DATE_CREATED" runat="server" AssociatedControlID="OWNNOTESN__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="OWNNOTESN__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calOWNNOTESN__DATE_CREATED" runat="server" LinkedControl="OWNNOTESN__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valOWNNOTESN_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_OWNNOTESN__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNNOTESN-CREATED_BY">

		
		<asp:Label ID="lblOWNNOTESN_CREATED_BY" runat="server" AssociatedControlID="OWNNOTESN__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNNOTESN__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNNOTESN_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_OWNNOTESN__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNNOTESN-COVER_TYPE">

		
		<asp:Label ID="lblOWNNOTESN_COVER_TYPE" runat="server" AssociatedControlID="OWNNOTESN__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNNOTESN__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNNOTESN_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_OWNNOTESN__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNNOTESN-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblOWNNOTESN_NOTE_DESCRIPTION" runat="server" AssociatedControlID="OWNNOTESN__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNNOTESN__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNNOTESN_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_OWNNOTESN__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-OWNNOTESN-NOTE_DETAILS">
		<asp:Label ID="lblOWNNOTESN_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="OWNNOTESN__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="OWNNOTESN__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valOWNNOTESN_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_OWNNOTESN__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id04d691986a9d4250886e55d7c5cb11ee div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id04d691986a9d4250886e55d7c5cb11ee div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id04d691986a9d4250886e55d7c5cb11ee div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id04d691986a9d4250886e55d7c5cb11ee label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id04d691986a9d4250886e55d7c5cb11ee label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id04d691986a9d4250886e55d7c5cb11ee label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id04d691986a9d4250886e55d7c5cb11ee label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id04d691986a9d4250886e55d7c5cb11ee input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id04d691986a9d4250886e55d7c5cb11ee input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id04d691986a9d4250886e55d7c5cb11ee input{text-align:left;}"; break;
		}
	}
