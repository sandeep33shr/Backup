<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="HRDNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_HRDNOTES_Note_Details" %>
...
function onValidate_OWNSNOTESN__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTESN", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNSNOTESN", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTESN.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "OWNSNOTESN", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=OWNSNOTESN&propertyName=DATE_CREATED&name={name}");
...
function onValidate_OWNSNOTESN__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTESN", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNSNOTESN", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTESN.CREATED_BY");
        			window.setControlWidth(field, "0.5", "OWNSNOTESN", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_OWNSNOTESN__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTESN", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNSNOTESN", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTESN.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "OWNSNOTESN", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=OWNSNOTESN&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'Hired In Plant'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_OWNSNOTESN__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTESN", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNSNOTESN", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTESN.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "OWNSNOTESN", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_OWNSNOTESN__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTESN", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OWNSNOTESN", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTESN.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "OWNSNOTESN", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=OWNSNOTESN&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_OWNSNOTESN__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_OWNSNOTESN_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_OWNSNOTESN__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_OWNSNOTESN__CREATED_BY(null, null, null, isOnLoad);
    onValidate_OWNSNOTESN__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_OWNSNOTESN__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_OWNSNOTESN__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id3e33a083c67041928c5b4c4957503d3f" class="general-layout-container">
...
<div id="id0d7a56a2b22447789068b7380859d6d1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading31" runat="server" Text="Construction Plant Insurance Notes (Printed On Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OWNSNOTESN" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-OWNSNOTESN-DATE_CREATED">
		<asp:Label ID="lblOWNSNOTESN_DATE_CREATED" runat="server" AssociatedControlID="OWNSNOTESN__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="OWNSNOTESN__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calOWNSNOTESN__DATE_CREATED" runat="server" LinkedControl="OWNSNOTESN__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valOWNSNOTESN_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_OWNSNOTESN__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNSNOTESN-CREATED_BY">

		
		<asp:Label ID="lblOWNSNOTESN_CREATED_BY" runat="server" AssociatedControlID="OWNSNOTESN__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNSNOTESN__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNSNOTESN_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_OWNSNOTESN__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNSNOTESN-COVER_TYPE">

		
		<asp:Label ID="lblOWNSNOTESN_COVER_TYPE" runat="server" AssociatedControlID="OWNSNOTESN__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNSNOTESN__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNSNOTESN_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_OWNSNOTESN__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNSNOTESN-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblOWNSNOTESN_NOTE_DESCRIPTION" runat="server" AssociatedControlID="OWNSNOTESN__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNSNOTESN__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNSNOTESN_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_OWNSNOTESN__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-OWNSNOTESN-NOTE_DETAILS">
		<asp:Label ID="lblOWNSNOTESN_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="OWNSNOTESN__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="OWNSNOTESN__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valOWNSNOTESN_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_OWNSNOTESN__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0d7a56a2b22447789068b7380859d6d1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0d7a56a2b22447789068b7380859d6d1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0d7a56a2b22447789068b7380859d6d1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0d7a56a2b22447789068b7380859d6d1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0d7a56a2b22447789068b7380859d6d1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d7a56a2b22447789068b7380859d6d1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d7a56a2b22447789068b7380859d6d1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0d7a56a2b22447789068b7380859d6d1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d7a56a2b22447789068b7380859d6d1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d7a56a2b22447789068b7380859d6d1 input{text-align:left;}"; break;
		}
	}
