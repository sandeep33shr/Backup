<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPINSURE_Endorsements.aspx.vb" Inherits="Nexus.PB2_CPINSURE_Endorsements" %>
...
function onValidate_CPIRSK__CPIENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CPIENDOS", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CPIRSK__TOT_ENDPREM(null, null, null, isOnLoad);
    onValidate_CPIRSK__CPIENDOS(null, null, null, isOnLoad);
}
</script>
...
<div id="id220a48b07b504fec80918627c5e63178" class="general-layout-container">
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__CPIENDOS"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="CPIENDOS" 
		id="pb-container-childscreen-CPIRSK-CPIENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__GPA_ENDOSES" runat="server" ScreenCode="CPIENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPIENDOS/CPIENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPIRSK_CPIENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CPIRSK.CPIENDOS"
						ClientValidationFunction="onValidate_CPIRSK__CPIENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
