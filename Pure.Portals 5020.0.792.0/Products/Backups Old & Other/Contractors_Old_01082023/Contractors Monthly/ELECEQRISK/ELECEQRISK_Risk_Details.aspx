<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ELECEQRISK_Risk_Details.aspx.vb" Inherits="Nexus.PB2_ELECEQRISK_Risk_Details" %>
...
function onValidate_ELECTEQIUP__ELECCHILD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQIUP", "ELECCHILD", "ChildScreen");
        })();
}
function onValidate_ELECTEQIUP__TOTALSI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQIUP", "TOTALSI", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param ELECTEQIUP The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "ELECTEQIUP".toUpperCase().replace(/^\s+|\s+$/g, '');
        		...
        		var field = Field.getInstance("ELECTEQIUP", "TOTALSI");
        		try {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("At least one Electric Equipment Item must be added")) ? "At least one Electric Equipment Item must be added" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ELECTEQIUP".toUpperCase() + "__" + "TOTALSI");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ELECTEQIUP".toUpperCase() + "_" + "TOTALSI");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("ELECTEQIUP.TOTALSI > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ELECTEQIUP__TOTALRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQIUP", "TOTALRATE", "Percentage");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param ELECTEQIUP The Parent (Root) object name.
          * @param ELECTEQ.RATE The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "ELECTEQIUP".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "ELECTEQ.RATE";
        		//count, average, total, min, max
        		...
        		var field = Field.getInstance("ELECTEQIUP", "TOTALRATE");
        		try {
...
function onValidate_ELECTEQIUP__TOTALPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQIUP", "TOTALPREM", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param ELECTEQIUP The Parent (Root) object name.
          * @param ELECTEQ.PREMIUM The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "ELECTEQIUP".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "ELECTEQ.PREMIUM";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
        		...
        		var field = Field.getInstance("ELECTEQIUP", "TOTALPREM");
        		try {
...
function DoLogic(isOnLoad) {
    onValidate_ELECTEQIUP__ELECCHILD(null, null, null, isOnLoad);
    onValidate_ELECTEQIUP__TOTALSI(null, null, null, isOnLoad);
    onValidate_ELECTEQIUP__TOTALRATE(null, null, null, isOnLoad);
    onValidate_ELECTEQIUP__TOTALPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id9cdd1cbc2ea1426f9687829c80158a6b" class="general-layout-container">
...
<div id="ide56485ff99094394881c7b0149bdea5c" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECTEQIUP__ELECCHILD"
		data-field-type="Child" 
		data-object-name="ELECTEQIUP" 
		data-property-name="ELECCHILD" 
		id="pb-container-childscreen-ELECTEQIUP-ELECCHILD">
		
		    <legend>Electric Equipment Items</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECTEQIUP__ELECTEQ" runat="server" ScreenCode="ELECCHILD" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ELECCHILD/ELECCHILD_Electric_Equipment_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECTEQIUP_ELECCHILD" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Electric Equipment Items"
						ClientValidationFunction="onValidate_ELECTEQIUP__ELECCHILD" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ELECTEQIUP-TOTALSI">
		<asp:Label ID="lblELECTEQIUP_TOTALSI" runat="server" AssociatedControlID="ELECTEQIUP__TOTALSI" 
			Text="Total SI" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ELECTEQIUP__TOTALSI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valELECTEQIUP_TOTALSI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total SI"
			ClientValidationFunction="onValidate_ELECTEQIUP__TOTALSI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-ELECTEQIUP-TOTALRATE">
		<asp:Label ID="lblELECTEQIUP_TOTALRATE" runat="server" AssociatedControlID="ELECTEQIUP__TOTALRATE" 
			Text="Total Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="ELECTEQIUP__TOTALRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valELECTEQIUP_TOTALRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Rate"
			ClientValidationFunction="onValidate_ELECTEQIUP__TOTALRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ELECTEQIUP-TOTALPREM">
		<asp:Label ID="lblELECTEQIUP_TOTALPREM" runat="server" AssociatedControlID="ELECTEQIUP__TOTALPREM" 
			Text="Total Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ELECTEQIUP__TOTALPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valELECTEQIUP_TOTALPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium"
			ClientValidationFunction="onValidate_ELECTEQIUP__TOTALPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide56485ff99094394881c7b0149bdea5c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide56485ff99094394881c7b0149bdea5c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide56485ff99094394881c7b0149bdea5c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide56485ff99094394881c7b0149bdea5c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide56485ff99094394881c7b0149bdea5c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide56485ff99094394881c7b0149bdea5c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide56485ff99094394881c7b0149bdea5c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide56485ff99094394881c7b0149bdea5c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide56485ff99094394881c7b0149bdea5c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide56485ff99094394881c7b0149bdea5c input{text-align:left;}"; break;
		}
	}
