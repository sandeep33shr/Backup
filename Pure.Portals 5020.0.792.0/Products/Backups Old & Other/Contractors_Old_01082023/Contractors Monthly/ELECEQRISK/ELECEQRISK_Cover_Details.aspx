<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ELECEQRISK_Cover_Details.aspx.vb" Inherits="Nexus.PB2_ELECEQRISK_Cover_Details" %>
...
function onValidate_GENERAL__EEQMTAREAS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "EEQMTAREAS", "ChildScreen");
        })();
}
...
function onValidate_ELECTEQIUP__PRIMINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQIUP", "PRIMINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ELECTEQIUP", "PRIMINDUSTRY");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblELECTEQIUP_PRIMINDUSTRY");
        					var ele = document.getElementById('ctl00_cntMainBody_ELECTEQIUP__PRIMINDUSTRY');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_ELECTEQIUP__PRIMINDUSTRY_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ELECTEQIUP.PRIMINDUSTRY");
        			window.setControlWidth(field, "0.6", "ELECTEQIUP", "PRIMINDUSTRY");
        		})();
        	}
        })();
}
function onValidate_ELECTEQIUP__SCNDINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQIUP", "SCNDINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ELECTEQIUP", "SCNDINDUSTRY");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblELECTEQIUP_SCNDINDUSTRY");
        					var ele = document.getElementById('ctl00_cntMainBody_ELECTEQIUP__SCNDINDUSTRY');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_ELECTEQIUP__SCNDINDUSTRY_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ELECTEQIUP.SCNDINDUSTRY");
        			window.setControlWidth(field, "0.6", "ELECTEQIUP", "SCNDINDUSTRY");
        		})();
        	}
        })();
}
function onValidate_ELECTEQIUP__INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQIUP", "INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ELECTEQIUP", "INDUSTRY");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblELECTEQIUP_INDUSTRY");
        					var ele = document.getElementById('ctl00_cntMainBody_ELECTEQIUP__INDUSTRY');
        					if(ele.firstElementChild != null && ele.firstElementChild.id=='Controls_FindParty')
        						{
        							label= document.getElementById("ctl00_cntMainBody_ELECTEQIUP__INDUSTRY_lblFindParty");							
        						}
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ELECTEQIUP.INDUSTRY");
        			window.setControlWidth(field, "0.6", "ELECTEQIUP", "INDUSTRY");
        		})();
        	}
        })();
}
function onValidate_RETROCESSION__EEQRETRO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETROCESSION", "EEQRETRO", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__EEQMTAREAS(null, null, null, isOnLoad);
    ...
    onValidate_ELECTEQIUP__PRIMINDUSTRY(null, null, null, isOnLoad);
    onValidate_ELECTEQIUP__SCNDINDUSTRY(null, null, null, isOnLoad);
    onValidate_ELECTEQIUP__INDUSTRY(null, null, null, isOnLoad);
    onValidate_RETROCESSION__EEQRETRO(null, null, null, isOnLoad);
}
</script>
...
<div id="idf7961a959a994ba68fc9ad8e1624d6ca" class="general-layout-container">
...
<div id="id292aad81db9c48f0b3e62e7829569546" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Electronic Equipment" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id292aad81db9c48f0b3e62e7829569546 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id292aad81db9c48f0b3e62e7829569546 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id292aad81db9c48f0b3e62e7829569546 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id292aad81db9c48f0b3e62e7829569546 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id292aad81db9c48f0b3e62e7829569546 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id292aad81db9c48f0b3e62e7829569546 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id292aad81db9c48f0b3e62e7829569546 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id292aad81db9c48f0b3e62e7829569546 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id292aad81db9c48f0b3e62e7829569546 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id292aad81db9c48f0b3e62e7829569546 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__EEQMTAREAS"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="EEQMTAREAS" 
		id="pb-container-childscreen-GENERAL-EEQMTAREAS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="EEQMTAREAS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EEQMTAREAS/EEQMTAREAS_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL