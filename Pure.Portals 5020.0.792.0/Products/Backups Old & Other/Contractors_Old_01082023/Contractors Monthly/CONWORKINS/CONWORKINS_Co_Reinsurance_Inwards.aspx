<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKINS_Co_Reinsurance_Inwards.aspx.vb" Inherits="Nexus.PB2_CONWORKINS_Co_Reinsurance_Inwards" %>
...
<div id="id605d0b383cf1459eac372600f39975a7" class="general-layout-container">
...
<div id="id23fc1cf0366644119aaf29d69f75fcf8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="Co/Re-insurance Inwards Details" /></legend>
...
<Nexus:RiskAttribute HeaderText="Notes" DataField="NOTES" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCOREINSURA_REINSUINW" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Inwards Details"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id23fc1cf0366644119aaf29d69f75fcf8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id23fc1cf0366644119aaf29d69f75fcf8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id23fc1cf0366644119aaf29d69f75fcf8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id23fc1cf0366644119aaf29d69f75fcf8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id23fc1cf0366644119aaf29d69f75fcf8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id23fc1cf0366644119aaf29d69f75fcf8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id23fc1cf0366644119aaf29d69f75fcf8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id23fc1cf0366644119aaf29d69f75fcf8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id23fc1cf0366644119aaf29d69f75fcf8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id23fc1cf0366644119aaf29d69f75fcf8 input{text-align:left;}"; break;
		}
	}
