...
<div id="id0f2e3f06da2442c3b2f933dac57fd7ed" class="general-layout-container">
...
<div id="id9575b540f2fe4a74bded568a38c8f1c4" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading56" runat="server" Text="Contractors - Contact Works Notes" /></legend>
		...
		id="pb-container-childscreen-NOTES-CWONOTES">
		    ...
		    <legend>Notes</legend>
			        ...
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="CWONOTES" AutoGenerateColumns="false"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id9575b540f2fe4a74bded568a38c8f1c4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9575b540f2fe4a74bded568a38c8f1c4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9575b540f2fe4a74bded568a38c8f1c4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9575b540f2fe4a74bded568a38c8f1c4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9575b540f2fe4a74bded568a38c8f1c4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9575b540f2fe4a74bded568a38c8f1c4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9575b540f2fe4a74bded568a38c8f1c4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9575b540f2fe4a74bded568a38c8f1c4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9575b540f2fe4a74bded568a38c8f1c4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9575b540f2fe4a74bded568a38c8f1c4 input{text-align:left;}"; break;
		}
	}
...
<div id="frmExtNotes" class="column-layout-container fieldset-wrapper,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading57" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
	...
	<div class="child-card" id="ctl00_cntMainBody_EX_NOTES__CCWNOTES"
		...
		id="pb-container-childscreen-EX_NOTES-CCWNOTES">
		    ...
		    <legend>Notes</legend>
			        ...
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EX_NOTES__EXT_DETAILS" runat="server" ScreenCode="CCWNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CCWNOTES/CCWNOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
