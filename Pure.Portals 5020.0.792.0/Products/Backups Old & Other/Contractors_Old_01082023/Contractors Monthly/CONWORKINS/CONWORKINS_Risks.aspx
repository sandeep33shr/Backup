...
function onValidate_RISKDETAILS__MAX_VAL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.MAX_VAL < 0", "VEM", "Please Enter Max Value");
        
            var paramValue = "VEM",
            paramCondition = "RISKDETAILS.MAX_VAL < 0",
            paramElseValue = "VEM",
            paramValidationMessage = "Please Enter Max Value";
...
function onValidate_RISKDETAILS__OWNIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please select at least one of Own Works or PCI/Sub Contract Works")) ? "Please select at least one of Own Works or PCI/Sub Contract Works" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_RISKDETAILS__ESTANNTUR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.OWNIND == true ", "R", "Please Enter Estimated Annual Turnover Own Works");
...
function onValidate_RISKDETAILS__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.OWNIND == true  ", "R", "Please Enter Estimated Annual Turnover Own Works Rate");
...
function onValidate_RISKDETAILS__PREMIUM_LIM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.OWNIND == true ", "R", "Please Enter Estimated Annual Turnover Own Works Premium");
...
function onValidate_RISKDETAILS__PCIESTANNTUR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.PCIIND == true ", "R", "Please Enter Estimated Annual Turnover PCI/ Sub Contract Works");
...
function onValidate_RISKDETAILS__PCIRATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", " RISKDETAILS.PCIIND == true ", "R", "Please Enter Estimated Annual Turnover PCI/ Sub Contract Works Rate");
...
function onValidate_RISKDETAILS__PCIPREMIUM_LIM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISKDETAILS.PCIIND == true ", "R", "Please Enter Estimated Annual Turnover PCI/ Sub Contract Works Premium");
...
<div id="id18f4d362f81941b1b245f007bdffb1fe" class="general-layout-container">
...
<div id="ida3164d5719144580b737b5396c51c17f" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#ida3164d5719144580b737b5396c51c17f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida3164d5719144580b737b5396c51c17f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida3164d5719144580b737b5396c51c17f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida3164d5719144580b737b5396c51c17f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida3164d5719144580b737b5396c51c17f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida3164d5719144580b737b5396c51c17f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida3164d5719144580b737b5396c51c17f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida3164d5719144580b737b5396c51c17f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida3164d5719144580b737b5396c51c17f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida3164d5719144580b737b5396c51c17f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide6f474bc4c554663b1cc71d432f3c910" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#ide6f474bc4c554663b1cc71d432f3c910 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide6f474bc4c554663b1cc71d432f3c910 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide6f474bc4c554663b1cc71d432f3c910 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide6f474bc4c554663b1cc71d432f3c910 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide6f474bc4c554663b1cc71d432f3c910 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide6f474bc4c554663b1cc71d432f3c910 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide6f474bc4c554663b1cc71d432f3c910 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide6f474bc4c554663b1cc71d432f3c910 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide6f474bc4c554663b1cc71d432f3c910 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide6f474bc4c554663b1cc71d432f3c910 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4d7d9dd0d40f4f04a9d03da44a60156f" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id4d7d9dd0d40f4f04a9d03da44a60156f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4d7d9dd0d40f4f04a9d03da44a60156f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4d7d9dd0d40f4f04a9d03da44a60156f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4d7d9dd0d40f4f04a9d03da44a60156f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4d7d9dd0d40f4f04a9d03da44a60156f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4d7d9dd0d40f4f04a9d03da44a60156f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4d7d9dd0d40f4f04a9d03da44a60156f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4d7d9dd0d40f4f04a9d03da44a60156f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4d7d9dd0d40f4f04a9d03da44a60156f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4d7d9dd0d40f4f04a9d03da44a60156f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="DepPrem" class="column-layout-container fieldset-wrapper,no-border  ">
