...
Namespace Nexus
    Partial Class PB2_CONWORKINS_Contract_Works : Inherits BaseRisk
		...
		Protected Sub onValidate_CONTWORKS__INSURED()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CONTWORKS__INSURED()
End Sub

		    
        
        Protected Shadows Sub getInsuredName(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	'party
        	...
        	If Session(CNParty) IsNot Nothing Then
        		If TypeOf Session(CNParty) Is NexusProvider.CorporateParty Then
        			...
        			CompanyName = DirectCast(oParty, NexusProvider.CorporateParty).CompanyName
        
        			CONTWORKS__INSURED.Text = CompanyName
        		ElseIf TypeOf Session(CNParty) Is NexusProvider.PersonalParty Then
        			...
        			CONTWORKS__INSURED.Text = firstName & " " & lastName
