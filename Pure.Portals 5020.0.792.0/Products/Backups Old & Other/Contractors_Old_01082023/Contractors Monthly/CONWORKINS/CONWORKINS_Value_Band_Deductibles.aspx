<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKINS_Value_Band_Deductibles.aspx.vb" Inherits="Nexus.PB2_CONWORKINS_Value_Band_Deductibles" %>
...
function onValidate_DED_IND__DEDE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DED_IND", "DEDE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_DED_IND__DEDE(null, null, null, isOnLoad);
}
</script>
...
<div id="ida8969b6d18d74ec9b387c0e73ede7f28" class="general-layout-container">
...
<div id="Ded" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="Contract Value Bands" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_DED_IND__DEDE"
		data-field-type="Child" 
		data-object-name="DED_IND" 
		data-property-name="DEDE" 
		id="pb-container-childscreen-DED_IND-DEDE">
		
		    <legend>Deductibles</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="DED_IND__MAJPERILS" runat="server" ScreenCode="DEDE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DEDE/DEDE_Contract_Value_Bands.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Major Perils" DataField="MAJORPERILS" DataFormatString="{0:Yes;;No}"/>
<Nexus:RiskAttribute HeaderText="Minor Perils" DataField="MINORPERIL" DataFormatString="{0:Yes;;No}"/>
<Nexus:RiskAttribute HeaderText="Theft, Malicious Damage" DataField="THEFTMALDAM" DataFormatString="{0:Yes;;No}"/>
<Nexus:RiskAttribute HeaderText="Transit" DataField="TRANSIT" DataFormatString="{0:Yes;;No}"/>
<Nexus:RiskAttribute HeaderText="Surrounding Property" DataField="SURRPROP" DataFormatString="{0:Yes;;No}"/>
<Nexus:RiskAttribute HeaderText="Fire Perils" DataField="FIREPERILS" DataFormatString="{0:Yes;;No}"/>
<Nexus:RiskAttribute HeaderText="All Perils" DataField="ALLPERIL" DataFormatString="{0:Yes;;No}"/>
<Nexus:RiskAttribute HeaderText="Other" DataField="OTHER" DataFormatString="{0:Yes;;No}"/>
					...
					<asp:CustomValidator ID="valDED_IND_DEDE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Deductibles"
						ClientValidationFunction="onValidate_DED_IND__DEDE" 
						Display="None"
