...
function onValidate_ADDDEDUC__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "DESCRIPTION", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "__" + "DESCRIPTION");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "_" + "DESCRIPTION");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("ADDDEDUC.DESCRIPTION <> ''");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADDDEDUC__PERCENTAGE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "PERCENTAGE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "PERCENTAGE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.PERCENTAGE");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "PERCENTAGE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_PERCENTAGE");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "__" + "PERCENTAGE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "_" + "PERCENTAGE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(ADDDEDUC.PERCENTAGE > 0 && ADDDEDUC.PERCENTAGE <= 100) || ADDDEDUC.PERCENTAGE == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADDDEDUC__MINIMUMAMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "MINIMUMAMT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "MINIMUMAMT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.MINIMUMAMT");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "MINIMUMAMT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_MINIMUMAMT");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "__" + "MINIMUMAMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "_" + "MINIMUMAMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("ADDDEDUC.MINIMUMAMT >= 0 || ADDDEDUC.MINIMUMAMT == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADDDEDUC__MAXIMUMAMT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "MAXIMUMAMT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "MAXIMUMAMT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.MAXIMUMAMT");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "MAXIMUMAMT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_MAXIMUMAMT");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "__" + "MAXIMUMAMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "_" + "MAXIMUMAMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("ADDDEDUC.MAXIMUMAMT > ADDDEDUC.MINIMUMAMT || ADDDEDUC.MAXIMUMAMT == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADDDEDUC__BASISDED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "BASISDED", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "BASISDED");
        		}
        		//window.setProperty(field, "VEM", "ADDDEDUC.PERCENTAGE > 0", "VE", "Please Select Basis of Deductible");
        
            var paramValue = "VEM",
            paramCondition = "ADDDEDUC.PERCENTAGE > 0",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.BASISDED");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "BASISDED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_BASISDED");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_ADDDEDUC__PERCENTAGE(null, null, null, isOnLoad);
    onValidate_ADDDEDUC__MINIMUMAMT(null, null, null, isOnLoad);
    onValidate_ADDDEDUC__MAXIMUMAMT(null, null, null, isOnLoad);
    onValidate_ADDDEDUC__BASISDED(null, null, null, isOnLoad);
}
</script>
...
<div id="id9570fc253c314ecb8ff1b551cfcb1e6d" class="general-layout-container">
...
<div id="id40b75ea1edf14dafa12d1c630612f64b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading24" runat="server" Text="Additional Deductibles" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-ADDDEDUC-DESCRIPTION">
		<asp:Label ID="lblADDDEDUC_DESCRIPTION" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="ADDDEDUC__DESCRIPTION" 
			Text="Description"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="ADDDEDUC__DESCRIPTION" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-ADDDEDUC-PERCENTAGE">
		<asp:Label ID="lblADDDEDUC_PERCENTAGE" runat="server" AssociatedControlID="ADDDEDUC__PERCENTAGE" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="ADDDEDUC__PERCENTAGE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valADDDEDUC_PERCENTAGE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_ADDDEDUC__PERCENTAGE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ADDDEDUC-MINIMUMAMT">
		<asp:Label ID="lblADDDEDUC_MINIMUMAMT" runat="server" AssociatedControlID="ADDDEDUC__MINIMUMAMT" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDDEDUC__MINIMUMAMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDDEDUC_MINIMUMAMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_ADDDEDUC__MINIMUMAMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ADDDEDUC-MAXIMUMAMT">
		<asp:Label ID="lblADDDEDUC_MAXIMUMAMT" runat="server" AssociatedControlID="ADDDEDUC__MAXIMUMAMT" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDDEDUC__MAXIMUMAMT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDDEDUC_MAXIMUMAMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_ADDDEDUC__MAXIMUMAMT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-ADDDEDUC-BASISDED">
		<asp:Label ID="lblADDDEDUC_BASISDED" runat="server" AssociatedControlID="ADDDEDUC__BASISDED" 
			Text="Basis of deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="ADDDEDUC__BASISDED" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="BASISDED" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_ADDDEDUC__BASISDED(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valADDDEDUC_BASISDED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of deductible"
			ClientValidationFunction="onValidate_ADDDEDUC__BASISDED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id40b75ea1edf14dafa12d1c630612f64b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id40b75ea1edf14dafa12d1c630612f64b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id40b75ea1edf14dafa12d1c630612f64b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id40b75ea1edf14dafa12d1c630612f64b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id40b75ea1edf14dafa12d1c630612f64b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id40b75ea1edf14dafa12d1c630612f64b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id40b75ea1edf14dafa12d1c630612f64b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id40b75ea1edf14dafa12d1c630612f64b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id40b75ea1edf14dafa12d1c630612f64b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id40b75ea1edf14dafa12d1c630612f64b input{text-align:left;}"; break;
		}
	}
