...
function onValidate_NONBANDEDS__DEDU_CTIBLE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE > 0 && NONBANDEDS.DEDU_TIBLE <= 100) || NONBANDEDS.MAJORPERILS == 0 || NONBANDEDS.DEDU_CTIBLE == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__DEDU_CTIBLE_MP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE_MP > 0 && NONBANDEDS.DEDU_TIBLE_MP <= 100) || NONBANDEDS.MINORPERIL == 0 || NONBANDEDS.DEDU_CTIBLE_MP == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__DEDU_CTIBLE_TMD(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE_TMD > 0 && NONBANDEDS.DEDU_TIBLE_TMD <= 100) || NONBANDEDS.THEFTMALDAM == 0 || NONBANDEDS.DEDU_CTIBLE_TMD == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__DEDU_CTIBLE_TRAN(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE_TRAN > 0 && NONBANDEDS.DEDU_TIBLE_TRAN <= 100) || NONBANDEDS.TRANSIT == 0 || NONBANDEDS.DEDU_CTIBLE_TRAN == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__DEDU_CTIBLE_SURR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE_SURR > 0 && NONBANDEDS.DEDU_TIBLE_SURR <= 100) || NONBANDEDS.SURRPROP == 0 || NONBANDEDS.DEDU_CTIBLE_SURR == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__DEDU_CTIBLE_FIREP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE_FIREP > 0 && NONBANDEDS.DEDU_TIBLE_FIREP <= 100) || NONBANDEDS.FIREPERILS == 0 || NONBANDEDS.DEDU_CTIBLE_FIREP == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__DEDU_CTIBLE_ALLP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE_ALLP > 0 && NONBANDEDS.DEDU_TIBLE_ALLP <= 100) || NONBANDEDS.ALLPERIL == 0 || NONBANDEDS.DEDU_CTIBLE_ALLP == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__DEDU_CTIBLE_OTHER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE_OTHER > 0 && NONBANDEDS.DEDU_TIBLE_OTHER <= 100) || NONBANDEDS.OTHER == 0 || NONBANDEDS.DEDU_CTIBLE_OTHER == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__DEDU_CTIBLE_ADD(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NONBANDEDS.DEDU_CTIBLE_ADD > 0 && NONBANDEDS.DEDU_TIBLE_ADD <= 100) || NONBANDEDS.ADDITION == 0 || NONBANDEDS.DEDU_CTIBLE_ADD == null");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NONBANDEDS__MIN_AMT_ADD(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Additional Minimum Amount cannot be negative")) ? "Additional Minimum Amount cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
...
<div id="id14d93118a5414c9eb71e534ed0619065" class="general-layout-container">
...
<div id="id70ecabea53dc4c86b9c8c0806aff9059" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id70ecabea53dc4c86b9c8c0806aff9059 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id70ecabea53dc4c86b9c8c0806aff9059 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id70ecabea53dc4c86b9c8c0806aff9059 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id70ecabea53dc4c86b9c8c0806aff9059 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id70ecabea53dc4c86b9c8c0806aff9059 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id70ecabea53dc4c86b9c8c0806aff9059 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id70ecabea53dc4c86b9c8c0806aff9059 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id70ecabea53dc4c86b9c8c0806aff9059 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id70ecabea53dc4c86b9c8c0806aff9059 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id70ecabea53dc4c86b9c8c0806aff9059 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="addDedNonBandDed" class="column-layout-container fieldset-wrapper,no-border  ">
...
<Nexus:RiskAttribute HeaderText="Deductible %" DataField="DEDUCTIBLE1" DataFormatString="{0:0.0000}"/>
