...
function onValidate_RISK_DETAILS__GROSS_PROFIT_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_DETAILS.IS_GROSS_PROFIT_BASIS == 1", "R", "{3}");
...
function onValidate_RISK_DETAILS__GROSS_REVENUE_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_DETAILS.IS_GROSS_REVENUE == 1", "R", "{3}");
...
function onValidate_RISK_DETAILS__DETER_STOCK_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_DETAILS.IS_DETER_STOCK == 1", "R", "{3}");
...
function onValidate_RISK_DETAILS__DETER_STOCK_DEDU_AMNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Deductible Min Amount must be greater than 0")) ? "Deductible Min Amount must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
...
<div id="id420a4faa273340eba123c68f2f569672" class="general-layout-container">
...
<div id="frmMBCL" class="column-layout-container fieldset-wrapper  ">
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmCLRB" class="column-layout-container fieldset-wrapper  ">
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmDOS" class="column-layout-container fieldset-wrapper  ">
