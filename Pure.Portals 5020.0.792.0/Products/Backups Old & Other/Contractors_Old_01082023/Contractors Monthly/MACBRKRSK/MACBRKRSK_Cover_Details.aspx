<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MACBRKRSK_Cover_Details.aspx.vb" Inherits="Nexus.PB2_MACBRKRSK_Cover_Details" %>
...
function onValidate_GENERAL__CMBMTAREAS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CMBMTAREAS", "ChildScreen");
        })();
}
...
function onValidate_ADDRESS__LINE1(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "ADDRESS.LINE1 == ''", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "ADDRESS.LINE1 == ''",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
...
function onValidate_ADDRESS__TOWN(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "ADDRESS.LINE1 == ''", "V", "{3}");
...
function onValidate_INDUSTRY__PRIMINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INDUSTRY", "PRIMINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INDUSTRY", "PRIMINDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblINDUSTRY_PRIMINDUSTRY");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INDUSTRY.PRIMINDUSTRY");
        			window.setControlWidth(field, "0.6", "INDUSTRY", "PRIMINDUSTRY");
        		})();
        	}
        })();
}
function onValidate_INDUSTRY__SCNDINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INDUSTRY", "SCNDINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INDUSTRY", "SCNDINDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblINDUSTRY_SCNDINDUSTRY");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INDUSTRY.SCNDINDUSTRY");
        			window.setControlWidth(field, "0.6", "INDUSTRY", "SCNDINDUSTRY");
        		})();
        	}
        })();
}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INDUSTRY", "INDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_RETROCESSION__RETROMACBR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETROCESSION", "RETROMACBR", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__CMBMTAREAS(null, null, null, isOnLoad);
    ...
    onValidate_INDUSTRY__PRIMINDUSTRY(null, null, null, isOnLoad);
    onValidate_INDUSTRY__SCNDINDUSTRY(null, null, null, isOnLoad);
    onValidate_INDUSTRY__INDUSTRY(null, null, null, isOnLoad);
    onValidate_RETROCESSION__RETROMACBR(null, null, null, isOnLoad);
}
</script>
...
<div id="id312e851c25ee4b368a3a8bc2f78007ec" class="general-layout-container">
...
<div id="id50e0082ffeaf4f01a52eb997442336f3" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Machinery Breakdown" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id50e0082ffeaf4f01a52eb997442336f3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id50e0082ffeaf4f01a52eb997442336f3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id50e0082ffeaf4f01a52eb997442336f3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id50e0082ffeaf4f01a52eb997442336f3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id50e0082ffeaf4f01a52eb997442336f3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id50e0082ffeaf4f01a52eb997442336f3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id50e0082ffeaf4f01a52eb997442336f3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id50e0082ffeaf4f01a52eb997442336f3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id50e0082ffeaf4f01a52eb997442336f3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id50e0082ffeaf4f01a52eb997442336f3 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CMBMTAREAS"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CMBMTAREAS" 
		id="pb-container-childscreen-GENERAL-CMBMTAREAS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CMBMTAREAS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMBMTAREAS/CMBMTAREAS_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CMBMTAREAS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CMBMTAREAS"
						ClientValidationFunction="onValidate_GENERAL__CMBMTAREAS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idee3d44c85e86432a91df3ab1af6abaa5" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#idee3d44c85e86432a91df3ab1af6abaa5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idee3d44c85e86432a91df3ab1af6abaa5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idee3d44c85e86432a91df3ab1af6abaa5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idee3d44c85e86432a91df3ab1af6abaa5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idee3d44c85e86432a91df3ab1af6abaa5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idee3d44c85e86432a91df3ab1af6abaa5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idee3d44c85e86432a91df3ab1af6abaa5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idee3d44c85e86432a91df3ab1af6abaa5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idee3d44c85e86432a91df3ab1af6abaa5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idee3d44c85e86432a91df3ab1af6abaa5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9e5a4f9822734b92867d0229598240d3" class="column-layout-container fieldset-wrapper,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-INDUSTRY-PRIMINDUSTRY">
		<asp:Label ID="lblINDUSTRY_PRIMINDUSTRY" runat="server" AssociatedControlID="INDUSTRY__PRIMINDUSTRY" 
			Text="Primary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="INDUSTRY__PRIMINDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSONE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_INDUSTRY__PRIMINDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valINDUSTRY_PRIMINDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Primary Industry"
			ClientValidationFunction="onValidate_INDUSTRY__PRIMINDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-INDUSTRY-SCNDINDUSTRY">
		<asp:Label ID="lblINDUSTRY_SCNDINDUSTRY" runat="server" AssociatedControlID="INDUSTRY__SCNDINDUSTRY" 
			Text="Secondary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="INDUSTRY__SCNDINDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTWO" ParentLookupListID="INDUSTRY__PRIMINDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_INDUSTRY__SCNDINDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valINDUSTRY_SCNDINDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Secondary Industry"
			ClientValidationFunction="onValidate_INDUSTRY__SCNDINDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblINDUSTRY_INDUSTRY" runat="server" AssociatedControlID="INDUSTRY__INDUSTRY" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="INDUSTRY__INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTHREE" ParentLookupListID="INDUSTRY__SCNDINDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_INDUSTRY__INDUSTRY(null, null, this);" data-type="List" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id9e5a4f9822734b92867d0229598240d3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9e5a4f9822734b92867d0229598240d3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9e5a4f9822734b92867d0229598240d3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9e5a4f9822734b92867d0229598240d3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9e5a4f9822734b92867d0229598240d3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9e5a4f9822734b92867d0229598240d3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9e5a4f9822734b92867d0229598240d3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9e5a4f9822734b92867d0229598240d3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9e5a4f9822734b92867d0229598240d3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9e5a4f9822734b92867d0229598240d3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1126f588ffaf4213a73e8e858ac84656" class="column-layout-container fieldset-wrapper,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RETROCESSION__RETROMACBR"
		data-field-type="Child" 
		data-object-name="RETROCESSION" 
		data-property-name="RETROMACBR" 
		id="pb-container-childscreen-RETROCESSION-RETROMACBR">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RETROCESSION__RETRO_DETAILS" runat="server" ScreenCode="RETROMACBR" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RETROMACBR/RETROMACBR_Retrocession_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valRETROCESSION_RETROMACBR" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RETROCESSION.RETROMACBR"
						ClientValidationFunction="onValidate_RETROCESSION__RETROMACBR" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id1126f588ffaf4213a73e8e858ac84656 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1126f588ffaf4213a73e8e858ac84656 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1126f588ffaf4213a73e8e858ac84656 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1126f588ffaf4213a73e8e858ac84656 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1126f588ffaf4213a73e8e858ac84656 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1126f588ffaf4213a73e8e858ac84656 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1126f588ffaf4213a73e8e858ac84656 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1126f588ffaf4213a73e8e858ac84656 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1126f588ffaf4213a73e8e858ac84656 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1126f588ffaf4213a73e8e858ac84656 input{text-align:left;}"; break;
		}
	}
