...
function onValidate_AUTOADD__LIMITIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "AUTOADD.AUTOADD_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AUTOADD.LIMITIND");
        			window.setControlWidth(field, "0.9", "AUTOADD", "LIMITIND");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Automatic Additions Clause Limit of Indemnity must be greater than 0")) ? "Automatic Additions Clause Limit of Indemnity must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AUTOADD".toUpperCase() + "__" + "LIMITIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AUTOADD".toUpperCase() + "_" + "LIMITIND");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("AUTOADD.LIMITIND > 0 || AUTOADD.AUTOADD_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label28(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		var field
        		if ("label28" != "{na" + "me}"){
        			field = Field.getLabel("label28");
        		} else { 
        			field = Field.getInstance("", "");
        		}
        		//window.setProperty(field, "H", "AUTOADD.AUTOADD_CHK = 1", "R", "{3}");
...
function onValidate_HIRECHARGE__LIMITIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "HIRECHARGE.HIRE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HIRECHARGE.LIMITIND");
        			window.setControlWidth(field, "0.9", "HIRECHARGE", "LIMITIND");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHIRECHARGE_LIMITIND");
        			}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Continuing Hire Charges Limit of Indemnity must be greater than 0")) ? "Continuing Hire Charges Limit of Indemnity must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "__" + "LIMITIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "_" + "LIMITIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("HIRECHARGE.LIMITIND > 0 || HIRECHARGE.HIRE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HIRECHARGE__TIMEDEDUCT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "HIRECHARGE.HIRE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HIRECHARGE.TIMEDEDUCT");
        			window.setControlWidth(field, "0.9", "HIRECHARGE", "TIMEDEDUCT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHIRECHARGE_TIMEDEDUCT");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Continuing Hire Charges Time Deductible (Hours) cannot be negative")) ? "Continuing Hire Charges Time Deductible (Hours) cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "__" + "TIMEDEDUCT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "_" + "TIMEDEDUCT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("HIRECHARGE.TIMEDEDUCT >= 0 || HIRECHARGE.HIRE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HIRECHARGE__INDEMPER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HIRECHARGE.INDEMPER");
        			window.setControlWidth(field, "0.9", "HIRECHARGE", "INDEMPER");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHIRECHARGE_INDEMPER");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Continuing Hire Charges Indemnity Period (Months) cannot be negative")) ? "Continuing Hire Charges Indemnity Period (Months) cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "__" + "INDEMPER");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "_" + "INDEMPER");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("HIRECHARGE.INDEMPER >= 0 || HIRECHARGE.HIRE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HIRECHARGE__DEDUCTCLM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HIRECHARGE.DEDUCTCLM");
        			window.setControlWidth(field, "0.9", "HIRECHARGE", "DEDUCTCLM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHIRECHARGE_DEDUCTCLM");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Continuing Hire Charges Deductible % of Claim must be between 0% and 100%")) ? "Continuing Hire Charges Deductible % of Claim must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "__" + "DEDUCTCLM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "_" + "DEDUCTCLM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(HIRECHARGE.DEDUCTCLM >= 0 && HIRECHARGE.DEDUCTCLM <= 100) || HIRECHARGE.HIRE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HIRECHARGE__DEDUCTAMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HIRECHARGE.DEDUCTAMT");
        			window.setControlWidth(field, "0.9", "HIRECHARGE", "DEDUCTAMT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHIRECHARGE_DEDUCTAMT");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Continuing Hire Charges Deductible Amount cannot be negative")) ? "Continuing Hire Charges Deductible Amount cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "__" + "DEDUCTAMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "_" + "DEDUCTAMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("HIRECHARGE.DEDUCTAMT >= 0 || HIRECHARGE.HIRE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Continuing Hire Charges Deductible Amount cannot be greater than the Continuing Hire Charges Limit of Indemnity")) ? "Continuing Hire Charges Deductible Amount cannot be greater than the Continuing Hire Charges Limit of Indemnity" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "__" + "DEDUCTAMT");
        				if (node == null){
        		...
        		var exp;
        		try {
        			exp = new Expression("HIRECHARGE.DEDUCTAMT < HIRECHARGE.LIMITIND || HIRECHARGE.HIRE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HIRECHARGE__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("HIRECHARGE", "RATE");
        		var exp = new Expression("HIRECHARGE.RATE <= 0 ||HIRECHARGE.RATE == ''");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HIRECHARGE.RATE");
        			window.setControlWidth(field, "0.9", "HIRECHARGE", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHIRECHARGE_RATE");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Continuing Hire Charges Rate must be between 0% and 100%")) ? "Continuing Hire Charges Rate must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(HIRECHARGE.RATE > 0 && HIRECHARGE.RATE <= 100) || HIRECHARGE.HIRE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HIRECHARGE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HIRECHARGE.PREMIUM");
        			window.setControlWidth(field, "0.9", "HIRECHARGE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHIRECHARGE_PREMIUM");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Continuing Hire Charges Premium must be greater than 0")) ? "Continuing Hire Charges Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "__" + "PREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HIRECHARGE".toUpperCase() + "_" + "PREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("HIRECHARGE.PREMIUM > 0 || HIRECHARGE.HIRE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label30(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "HIRECHARGE.HIRE_CHK = 1", "R", "{3}");
...
function onValidate_CREDSHORT__LIMITIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "CREDSHORT.CRED_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CREDSHORT.LIMITIND");
        			window.setControlWidth(field, "0.9", "CREDSHORT", "LIMITIND");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Credit Shortfall Limit of Indemnity must be greater than 0")) ? "Credit Shortfall Limit of Indemnity must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CREDSHORT".toUpperCase() + "__" + "LIMITIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CREDSHORT".toUpperCase() + "_" + "LIMITIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("CREDSHORT.LIMITIND > 0 || CREDSHORT.CRED_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CREDSHORT__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "CREDSHORT.CRED_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CREDSHORT.RATE");
        			window.setControlWidth(field, "0.9", "CREDSHORT", "RATE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Credit Shortfall Rate must be between 0% and 100%")) ? "Credit Shortfall Rate must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CREDSHORT".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CREDSHORT".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(CREDSHORT.RATE > 0 && CREDSHORT.RATE <= 100) || CREDSHORT.CRED_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CREDSHORT__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CREDSHORT.PREMIUM");
        			window.setControlWidth(field, "0.9", "CREDSHORT", "PREMIUM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Credit Shortfall Premium must be greater than 0")) ? "Credit Shortfall Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CREDSHORT".toUpperCase() + "__" + "PREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CREDSHORT".toUpperCase() + "_" + "PREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("CREDSHORT.PREMIUM > 0 || CREDSHORT.CRED_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label32(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "CREDSHORT.CRED_CHK = 1", "R", "{3}");
...
function onValidate_DAMAGE__LIMITIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "DAMAGE.DAMAGE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DAMAGE.LIMITIND");
        			window.setControlWidth(field, "0.9", "DAMAGE", "LIMITIND");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblDAMAGE_LIMITIND");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Damage to Lifted Goods Limit of Indemnity must be greater than 0")) ? "Damage to Lifted Goods Limit of Indemnity must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "__" + "LIMITIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "_" + "LIMITIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("DAMAGE.LIMITIND > 0 || DAMAGE.DAMAGE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_DAMAGE__DEDUCTCLAIM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "DAMAGE.DAMAGE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DAMAGE.DEDUCTCLAIM");
        			window.setControlWidth(field, "0.9", "DAMAGE", "DEDUCTCLAIM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblDAMAGE_DEDUCTCLAIM");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Damage to Lifted Goods Deductible % of Claim must be between 0% and 100%")) ? "Damage to Lifted Goods Deductible % of Claim must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "__" + "DEDUCTCLAIM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "_" + "DEDUCTCLAIM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(DAMAGE.DEDUCTCLAIM >= 0 && DAMAGE.DEDUCTCLAIM <= 100) || DAMAGE.DAMAGE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_DAMAGE__DEDUCTAMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DAMAGE.DEDUCTAMT");
        			window.setControlWidth(field, "0.9", "DAMAGE", "DEDUCTAMT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblDAMAGE_DEDUCTAMT");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Damage to Lifted Goods Deductible Amount cannot be negative")) ? "Damage to Lifted Goods Deductible Amount cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "__" + "DEDUCTAMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "_" + "DEDUCTAMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("DAMAGE.DEDUCTAMT >= 0 || DAMAGE.DAMAGE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Damage to Lifted Goods Deductible Amount cannot be greater than the Damage to Lifted Goods Limit of Indemnity")) ? "Damage to Lifted Goods Deductible Amount cannot be greater than the Damage to Lifted Goods Limit of Indemnity" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "__" + "DEDUCTAMT");
        				if (node == null){
        		...
        		var exp;
        		try {
        			exp = new Expression("DAMAGE.DEDUCTAMT < DAMAGE.LIMITIND || DAMAGE.DAMAGE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_DAMAGE__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DAMAGE.RATE");
        			window.setControlWidth(field, "0.9", "DAMAGE", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblDAMAGE_RATE");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Damage to Lifted Goods Rate must be between 0% and 100%")) ? "Damage to Lifted Goods Rate must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(DAMAGE.RATE > 0 && DAMAGE.RATE <= 100) || DAMAGE.DAMAGE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_DAMAGE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DAMAGE.PREMIUM");
        			window.setControlWidth(field, "0.9", "DAMAGE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblDAMAGE_PREMIUM");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Damage to Lifted Goods Premium must be greater than 0")) ? "Damage to Lifted Goods Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "__" + "PREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DAMAGE".toUpperCase() + "_" + "PREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("DAMAGE.PREMIUM > 0 || DAMAGE.DAMAGE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label34(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "DAMAGE.DAMAGE_CHK = 1", "R", "{3}");
...
function onValidate_HOLECOVER__LIMITIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "HOLECOVER.HOLECOVER_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HOLECOVER.LIMITIND");
        			window.setControlWidth(field, "0.9", "HOLECOVER", "LIMITIND");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHOLECOVER_LIMITIND");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Down the Hole Cover Limit of Indemnity must be greater than 0")) ? "Down the Hole Cover Limit of Indemnity must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "__" + "LIMITIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "_" + "LIMITIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("HOLECOVER.LIMITIND > 0 || HOLECOVER.HOLECOVER_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HOLECOVER__DEDUCTCLAIM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "HOLECOVER.HOLECOVER_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HOLECOVER.DEDUCTCLAIM");
        			window.setControlWidth(field, "0.9", "HOLECOVER", "DEDUCTCLAIM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHOLECOVER_DEDUCTCLAIM");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Down the Hole Cover Deductible % of Claim must be between 0% and 100%")) ? "Down the Hole Cover Deductible % of Claim must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "__" + "DEDUCTCLAIM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "_" + "DEDUCTCLAIM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(HOLECOVER.DEDUCTCLAIM >= 0 && HOLECOVER.DEDUCTCLAIM <= 100) || HOLECOVER.HOLECOVER_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HOLECOVER__DEDUCTAMT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HOLECOVER.DEDUCTAMT");
        			window.setControlWidth(field, "0.9", "HOLECOVER", "DEDUCTAMT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHOLECOVER_DEDUCTAMT");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Down the Hole Cover Deductible Amount cannot be negative")) ? "Down the Hole Cover Deductible Amount cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "__" + "DEDUCTAMT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "_" + "DEDUCTAMT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("HOLECOVER.DEDUCTAMT >= 0 || HOLECOVER.HOLECOVER_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Down the Hole Cover Deductible Amount cannot be greater than the Down the Hole Cover Limit of Indemnity")) ? "Down the Hole Cover Deductible Amount cannot be greater than the Down the Hole Cover Limit of Indemnity" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "__" + "DEDUCTAMT");
        				if (node == null){
        		...
        		var exp;
        		try {
        			exp = new Expression("HOLECOVER.DEDUCTAMT < HOLECOVER.LIMITIND || HOLECOVER.HOLECOVER_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HOLECOVER__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("HOLECOVER", "RATE");
        		var exp = new Expression("HOLECOVER.RATE <= 0 ||HOLECOVER.RATE == ''");
        		var errorMessage = "Please enter the Premium";
        		var go = function(){
        			if (exp.getValue() == true){
        				field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HOLECOVER.RATE");
        			window.setControlWidth(field, "0.9", "HOLECOVER", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHOLECOVER_RATE");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Down the Hole Cover Rate must be between 0% and 100%")) ? "Down the Hole Cover Rate must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(HOLECOVER.RATE > 0 && HOLECOVER.RATE <= 100) || HOLECOVER.HOLECOVER_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_HOLECOVER__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("HOLECOVER.PREMIUM");
        			window.setControlWidth(field, "0.9", "HOLECOVER", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblHOLECOVER_PREMIUM");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Down the Hole Cover Premium must be greater than 0")) ? "Down the Hole Cover Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "__" + "PREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "HOLECOVER".toUpperCase() + "_" + "PREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("HOLECOVER.PREMIUM > 0 || HOLECOVER.HOLECOVER_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label36(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "HOLECOVER.HOLECOVER_CHK = 1", "R", "{3}");
...
function onValidate_EXPENSE__LIMITIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "EXPENSE.EXPENSE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXPENSE.LIMITIND");
        			window.setControlWidth(field, "0.9", "EXPENSE", "LIMITIND");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Expediting Expenses Limit of Indemnity must be greater than 0")) ? "Expediting Expenses Limit of Indemnity must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EXPENSE".toUpperCase() + "__" + "LIMITIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EXPENSE".toUpperCase() + "_" + "LIMITIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EXPENSE.LIMITIND > 0 || EXPENSE.EXPENSE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EXPENSE__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "EXPENSE.EXPENSE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("EXPENSE", "RATE");
        		var exp = new Expression("EXPENSE.RATE <= 0 ||EXPENSE.RATE == ''");
        		var errorMessage = "Please enter the Premium";
        		var go = function(){
        			if (exp.getValue() == true){
        				field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXPENSE.RATE");
        			window.setControlWidth(field, "0.9", "EXPENSE", "RATE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EXPENSE".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EXPENSE".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(EXPENSE.RATE > 0 && EXPENSE.RATE <= 100) || EXPENSE.EXPENSE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_EXPENSE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXPENSE.PREMIUM");
        			window.setControlWidth(field, "0.9", "EXPENSE", "PREMIUM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "EXPENSE".toUpperCase() + "__" + "PREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "EXPENSE".toUpperCase() + "_" + "PREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("EXPENSE.PREMIUM > 0 || EXPENSE.EXPENSE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label38(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "EXPENSE.EXPENSE_CHK = 1", "R", "{3}");
...
function onValidate_CRANELIFT__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "CRANELIFT.CRANE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CRANELIFT", "PREMIUM");
        		var exp = new Expression("CRANELIFT.RATE <= 0 ||CRANELIFT.RATE == ''");
        		var errorMessage = "Please enter the Premium";
        		var go = function(){
        			if (exp.getValue() == true){
        				field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CRANELIFT.PREMIUM");
        			window.setControlWidth(field, "0.9", "CRANELIFT", "PREMIUM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Multi Crane Lifts Premium must be greater than 0")) ? "Multi Crane Lifts Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CRANELIFT".toUpperCase() + "__" + "PREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CRANELIFT".toUpperCase() + "_" + "PREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("CRANELIFT.PREMIUM > 0 || CRANELIFT.CRANE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label40(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "CRANELIFT.CRANE_CHK = 1", "R", "{3}");
...
function onValidate_REPLACE__LIMITIND(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "REPLACE.REPLACE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("REPLACE.LIMITIND");
        			window.setControlWidth(field, "0.9", "REPLACE", "LIMITIND");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblREPLACE_LIMITIND");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Replacement Plant Hired In Limit of Indemnity must be greater than 0")) ? "Replacement Plant Hired In Limit of Indemnity must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "__" + "LIMITIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "_" + "LIMITIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("REPLACE.LIMITIND > 0 || REPLACE.REPLACE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_REPLACE__TIMEDEDUCT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "REPLACE.REPLACE_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("REPLACE.TIMEDEDUCT");
        			window.setControlWidth(field, "0.9", "REPLACE", "TIMEDEDUCT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblREPLACE_TIMEDEDUCT");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Replacement Plant Hired In Time Deductible (Hours) cannot be negative")) ? "Replacement Plant Hired In Time Deductible (Hours) cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "__" + "TIMEDEDUCT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "_" + "TIMEDEDUCT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("REPLACE.TIMEDEDUCT >= 0 || REPLACE.REPLACE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_REPLACE__INDEMPER(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("REPLACE.INDEMPER");
        			window.setControlWidth(field, "0.9", "REPLACE", "INDEMPER");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblREPLACE_INDEMPER");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Replacement Plant Hired In Indemnity Period (Months) cannot be negative")) ? "Replacement Plant Hired In Indemnity Period (Months) cannot be negative" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "__" + "INDEMPER");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "_" + "INDEMPER");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("REPLACE.INDEMPER >= 0 || REPLACE.REPLACE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_REPLACE__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("REPLACE", "RATE");
        		var exp = new Expression("REPLACE.RATE <= 0 ||REPLACE.RATE == ''");
        		var errorMessage = "Please enter the Premium";
        		var go = function(){
        			if (exp.getValue() == true){
        				field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("REPLACE.RATE");
        			window.setControlWidth(field, "0.9", "REPLACE", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblREPLACE_RATE");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Replacement Plant Hired In Rate must be between 0% and 100%")) ? "Replacement Plant Hired In Rate must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(REPLACE.RATE > 0 && REPLACE.RATE <= 100) || REPLACE.REPLACE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_REPLACE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("REPLACE.PREMIUM");
        			window.setControlWidth(field, "0.9", "REPLACE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblREPLACE_PREMIUM");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Replacement Plant Hired In Premium must be greater than 0")) ? "Replacement Plant Hired In Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "__" + "PREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "REPLACE".toUpperCase() + "_" + "PREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("REPLACE.PREMIUM > 0 || REPLACE.REPLACE_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label42(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "REPLACE.REPLACE_CHK = 1", "R", "{3}");
...
function onValidate_WRECKING__WRECK_CHK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WRECKING", "WRECK_CHK", "Checkbox");
        })();
}
function onValidate_WRECKING__LIMITIND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WRECKING", "LIMITIND", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WRECKING", "LIMITIND");
        		}
        		//window.setProperty(field, "VEM", "WRECKING.WRECK_CHK = 1", "R", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "WRECKING.WRECK_CHK = 1",
            paramElseValue = "R",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('WRECKING', 'LIMITIND');
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WRECKING.LIMITIND");
        			window.setControlWidth(field, "0.9", "WRECKING", "LIMITIND");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblWRECKING_LIMITIND");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Wreckage Removal Limit of Indemnity must be greater than 0")) ? "Wreckage Removal Limit of Indemnity must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "WRECKING".toUpperCase() + "__" + "LIMITIND");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "WRECKING".toUpperCase() + "_" + "LIMITIND");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("WRECKING.LIMITIND > 0 || WRECKING.WRECK_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_WRECKING__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WRECKING", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WRECKING", "RATE");
        		}
        		//window.setProperty(field, "VE", "WRECKING.WRECK_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('WRECKING', 'RATE');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=WRECKING&propertyName=RATE&name={name}");
        		
        		var value = new Expression("WRECKING.PREMIUM / WRECKING.LIMITIND * 100"), 
        			condition = (Expression.isValidParameter("WRECKING.PREMIUM > 0")) ? new Expression("WRECKING.PREMIUM > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("WRECKING", "RATE");
        		var exp = new Expression("WRECKING.RATE <= 0 ||WRECKING.RATE == ''");
        		var errorMessage = "Please enter the Premium";
        		var go = function(){
        			if (exp.getValue() == true){
        				field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WRECKING.RATE");
        			window.setControlWidth(field, "0.9", "WRECKING", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblWRECKING_RATE");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Wreckage Removal Rate must be between 0% and 100%")) ? "Wreckage Removal Rate must be between 0% and 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "WRECKING".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "WRECKING".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(WRECKING.RATE > 0 && WRECKING.RATE <= 100) || WRECKING.WRECK_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_WRECKING__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WRECKING", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("WRECKING", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "WRECKING.WRECK_CHK = 1", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('WRECKING', 'PREMIUM');
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=WRECKING&propertyName=PREMIUM&name={name}");
        		
        		var value = new Expression("WRECKING.RATE * WRECKING.LIMITIND * 0.01"), 
        			condition = (Expression.isValidParameter("WRECKING.RATE > 0")) ? new Expression("WRECKING.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("WRECKING.PREMIUM");
        			window.setControlWidth(field, "0.9", "WRECKING", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblWRECKING_PREMIUM");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Wreckage Removal Premium must be greater than 0")) ? "Wreckage Removal Premium must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "WRECKING".toUpperCase() + "__" + "PREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "WRECKING".toUpperCase() + "_" + "PREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("WRECKING.PREMIUM > 0 || WRECKING.WRECK_CHK == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_label44(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "H", "WRECKING.WRECK_CHK = 1", "R", "{3}");
...
function onValidate_ADDITION__OTHERADD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDITION", "OTHERADD", "Checkbox");
        })();
        /** 
         * ToggleContainer
         * @param frmOther The element to toggle
        ...
        (function(){
        	...
        	if (isOnLoad) {
        		var field = Field.getInstance("ADDITION","OTHERADD");
        		...
        		var update = function(){
        			...
        			if (!inverse){
        				(new Expression("SetElementDisplay('frmOther', !!" + value + ")")).valueOf();
        			} else {
        				(new Expression("SetElementDisplay('frmOther', !" + value + ")")).valueOf();
        			}
        		};
        		events.listen(Field.getInstance("ADDITION", "OTHERADD"), "change", update);
        		update();
        	}
        
        })();
}
function onValidate_ADDITION__ADDCHILD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDITION", "ADDCHILD", "ChildScreen");
        })();
}
function onValidate_ADDITION__OTHER_INDEM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDITION", "OTHER_INDEM", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param ADDITION The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "ADDITION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		...
        		var field = Field.getInstance("ADDITION", "OTHER_INDEM");
        		try {
...
function onValidate_ADDITION__OTHER_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDITION", "OTHER_CNT", "Integer");
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var field = Field.getInstance("ADDITION", "OTHER_CNT");
        		try {
...
function onValidate_ADDITION__OTHER_RATE_TOTAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDITION", "OTHER_RATE_TOTAL", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param ADDITION The Parent (Root) object name.
          * @param OTHERSPEC.RATE The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "ADDITION".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "OTHERSPEC.RATE";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
        		...
        		var field = Field.getInstance("ADDITION", "OTHER_RATE_TOTAL");
        		try {
...
function onValidate_ADDITION__OTHER_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDITION", "OTHER_PREMIUM", "Currency");
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var field = Field.getInstance("ADDITION", "OTHER_PREMIUM");
        		try {
...
function DoLogic(isOnLoad) {
    ...
    onValidate_WRECKING__WRECK_CHK(null, null, null, isOnLoad);
    onValidate_WRECKING__LIMITIND(null, null, null, isOnLoad);
    onValidate_WRECKING__RATE(null, null, null, isOnLoad);
    onValidate_WRECKING__PREMIUM(null, null, null, isOnLoad);
    onValidate_label44(null, null, null, isOnLoad);
    onValidate_ADDITION__OTHERADD(null, null, null, isOnLoad);
    onValidate_ADDITION__ADDCHILD(null, null, null, isOnLoad);
    onValidate_ADDITION__OTHER_INDEM(null, null, null, isOnLoad);
    onValidate_ADDITION__OTHER_CNT(null, null, null, isOnLoad);
    onValidate_ADDITION__OTHER_RATE_TOTAL(null, null, null, isOnLoad);
    onValidate_ADDITION__OTHER_PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id8b3720b851c74d859a153ab5c6403813" class="general-layout-container">
...
<div id="id15a9413228f14bdda373ecb58b710ba4" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading52" runat="server" Text="Extensions" /></legend>
...
<label id="ctl00_cntMainBody_lblAUTOADD_AUTOADD_CHK" for="ctl00_cntMainBody_AUTOADD__AUTOADD_CHK" class="col-md-4 col-sm-3 control-label">
		Automatic Additions Clause</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		<asp:CustomValidator ID="valAUTOADD_AUTOADD_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Automatic Additions Clause"
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		<asp:CustomValidator ID="valHIRECHARGE_HIRE_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Continuing Hire Charges"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblHIRECHARGE_TIMEDEDUCT" runat="server" AssociatedControlID="HIRECHARGE__TIMEDEDUCT" 
			Text="Time Deductible (Hours)" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="HIRECHARGE__TIMEDEDUCT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valHIRECHARGE_TIMEDEDUCT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Time Deductible (Hours)"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblHIRECHARGE_INDEMPER" runat="server" AssociatedControlID="HIRECHARGE__INDEMPER" 
			Text="Indemnity Period (Months)" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="HIRECHARGE__INDEMPER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valHIRECHARGE_INDEMPER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Indemnity Period (Months)"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblHIRECHARGE_DEDUCTCLM" runat="server" AssociatedControlID="HIRECHARGE__DEDUCTCLM" 
			Text="Deductible % of Claim" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valHIRECHARGE_DEDUCTCLM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible % of Claim"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblHIRECHARGE_DEDUCTAMT" runat="server" AssociatedControlID="HIRECHARGE__DEDUCTAMT" 
			Text="Deductible Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valHIRECHARGE_DEDUCTAMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible Amount"
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		<asp:CustomValidator ID="valDAMAGE_DAMAGE_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Damage to Lifted Goods"
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		<asp:CustomValidator ID="valHOLECOVER_HOLECOVER_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Down the Hole Cover"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblHOLECOVER_DEDUCTAMT" runat="server" AssociatedControlID="HOLECOVER__DEDUCTAMT" 
			Text="Deductible Amt" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valHOLECOVER_DEDUCTAMT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible Amt"
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		<asp:CustomValidator ID="valCRANELIFT_CRANE_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Multi Crane Lifts"
...
<label id="ctl00_cntMainBody_lblREPLACE_REPLACE_CHK" for="ctl00_cntMainBody_REPLACE__REPLACE_CHK" class="col-md-4 col-sm-3 control-label">
		Replacement Plant Hired In</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		<asp:CustomValidator ID="valREPLACE_REPLACE_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Replacement Plant Hired In"
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblWRECKING_WRECK_CHK" for="ctl00_cntMainBody_WRECKING__WRECK_CHK" class="col-md-4 col-sm-3 control-label">
		Wreckage Removal</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="WRECKING" 
		data-property-name="WRECK_CHK" 
		id="pb-container-checkbox-WRECKING-WRECK_CHK">	
		
		<asp:TextBox ID="WRECKING__WRECK_CHK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valWRECKING_WRECK_CHK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Wreckage Removal"
			ClientValidationFunction="onValidate_WRECKING__WRECK_CHK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="WRECKING" 
		data-property-name="LIMITIND" 
		id="pb-container-currency-WRECKING-LIMITIND">
		<asp:Label ID="lblWRECKING_LIMITIND" runat="server" AssociatedControlID="WRECKING__LIMITIND" 
			Text="Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WRECKING__LIMITIND" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWRECKING_LIMITIND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indemnity"
			ClientValidationFunction="onValidate_WRECKING__LIMITIND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="WRECKING" 
		data-property-name="RATE" 
		id="pb-container-percentage-WRECKING-RATE">
		<asp:Label ID="lblWRECKING_RATE" runat="server" AssociatedControlID="WRECKING__RATE" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="WRECKING__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valWRECKING_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_WRECKING__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="WRECKING" 
		data-property-name="PREMIUM" 
		id="pb-container-currency-WRECKING-PREMIUM">
		<asp:Label ID="lblWRECKING_PREMIUM" runat="server" AssociatedControlID="WRECKING__PREMIUM" 
			Text="Premium " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="WRECKING__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valWRECKING_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium "
			ClientValidationFunction="onValidate_WRECKING__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblADDITION_OTHERADD" for="ctl00_cntMainBody_ADDITION__OTHERADD" class="col-md-4 col-sm-3 control-label">
		Additional</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="ADDITION" 
		data-property-name="OTHERADD" 
		id="pb-container-checkbox-ADDITION-OTHERADD">	
		
		<asp:TextBox ID="ADDITION__OTHERADD" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valADDITION_OTHERADD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Additional"
			ClientValidationFunction="onValidate_ADDITION__OTHERADD" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id15a9413228f14bdda373ecb58b710ba4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id15a9413228f14bdda373ecb58b710ba4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id15a9413228f14bdda373ecb58b710ba4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id15a9413228f14bdda373ecb58b710ba4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id15a9413228f14bdda373ecb58b710ba4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15a9413228f14bdda373ecb58b710ba4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15a9413228f14bdda373ecb58b710ba4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id15a9413228f14bdda373ecb58b710ba4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15a9413228f14bdda373ecb58b710ba4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15a9413228f14bdda373ecb58b710ba4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmOther" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading53" runat="server" Text="Additional Extensions" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ADDITION__ADDCHILD"
		data-field-type="Child" 
		data-object-name="ADDITION" 
		data-property-name="ADDCHILD" 
		id="pb-container-childscreen-ADDITION-ADDCHILD">
		
		    <legend>Additional Extensions </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ADDITION__OTHERSPEC" runat="server" ScreenCode="ADDCHILD" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ADDCHILD/ADDCHILD_Extensions.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Deductible % " DataField="DEDUCTCLM" DataFormatString="{0:0.0000}"/>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valADDITION_ADDCHILD" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Additional Extensions "
						ClientValidationFunction="onValidate_ADDITION__ADDCHILD" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="ADDITION" 
		data-property-name="OTHER_INDEM" 
		id="pb-container-currency-ADDITION-OTHER_INDEM">
		<asp:Label ID="lblADDITION_OTHER_INDEM" runat="server" AssociatedControlID="ADDITION__OTHER_INDEM" 
			Text="Other - Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDITION__OTHER_INDEM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDITION_OTHER_INDEM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Other - Limit of Indemnity"
			ClientValidationFunction="onValidate_ADDITION__OTHER_INDEM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="ADDITION" 
		data-property-name="OTHER_CNT" 
		id="pb-container-integer-ADDITION-OTHER_CNT">
		<asp:Label ID="lblADDITION_OTHER_CNT" runat="server" AssociatedControlID="ADDITION__OTHER_CNT" 
			Text="Other - Child Count" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ADDITION__OTHER_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valADDITION_OTHER_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Other - Child Count"
			ClientValidationFunction="onValidate_ADDITION__OTHER_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="ADDITION" 
		data-property-name="OTHER_RATE_TOTAL" 
		id="pb-container-currency-ADDITION-OTHER_RATE_TOTAL">
		<asp:Label ID="lblADDITION_OTHER_RATE_TOTAL" runat="server" AssociatedControlID="ADDITION__OTHER_RATE_TOTAL" 
			Text="Other - Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDITION__OTHER_RATE_TOTAL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDITION_OTHER_RATE_TOTAL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Other - Rate"
			ClientValidationFunction="onValidate_ADDITION__OTHER_RATE_TOTAL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ADDITION-OTHER_PREMIUM">
		<asp:Label ID="lblADDITION_OTHER_PREMIUM" runat="server" AssociatedControlID="ADDITION__OTHER_PREMIUM" 
			Text="Other - Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDITION__OTHER_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDITION_OTHER_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Other - Premium"
			ClientValidationFunction="onValidate_ADDITION__OTHER_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
