<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPINSURE_Plant_Details.aspx.vb" Inherits="Nexus.PB2_CPINSURE_Plant_Details" %>
...
function onValidate_CPLANT__OWNPLANT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANT", "OWNPLANT", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CPLANT.OWNPLANT");
        		var update = function(){
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("At least one of Own Plant, or  Hired in Plant must be selected")) ? "At least one of Own Plant, or  Hired in Plant must be selected" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CPLANT".toUpperCase() + "__" + "OWNPLANT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CPLANT".toUpperCase() + "_" + "OWNPLANT");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("CPLANT.OWNPLANT == 1 || CPLANT.HIREDPLANT == 1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CPLANT__HIREDPLANT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANT", "HIREDPLANT", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CPLANT.HIREDPLANT");
        		var update = function(){
...
function onValidate_CPLANT__DEPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANT", "DEPPREM", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CPLANT.DEPPREM");
        		var update = function(){
...
function onValidate_CPLANT__PUBLIAB(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANT", "PUBLIAB", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CPLANT.PUBLIAB");
        		var update = function(){
...
function DoLogic(isOnLoad) {
    onValidate_CPLANT__OWNPLANT(null, null, null, isOnLoad);
    onValidate_CPLANT__HIREDPLANT(null, null, null, isOnLoad);
    onValidate_CPLANT__DEPPREM(null, null, null, isOnLoad);
    onValidate_CPLANT__PUBLIAB(null, null, null, isOnLoad);
}
</script>
...
<div id="idab1a6db827ab4e6a85ba68509eade7e0" class="general-layout-container">
...
<div id="id00c4e872bdf64635a4e019a0dcf3af50" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="Construction Plant" /></legend>
...
<label id="ctl00_cntMainBody_lblCPLANT_OWNPLANT" for="ctl00_cntMainBody_CPLANT__OWNPLANT" class="col-md-4 col-sm-3 control-label">
		Own Plant</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CPLANT-OWNPLANT">	
		
		<asp:TextBox ID="CPLANT__OWNPLANT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCPLANT_OWNPLANT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Own Plant"
			ClientValidationFunction="onValidate_CPLANT__OWNPLANT" 
			ValidationGroup=""
			Display="None"
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCPLANT_HIREDPLANT" for="ctl00_cntMainBody_CPLANT__HIREDPLANT" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CPLANT-HIREDPLANT">	
		
		<asp:TextBox ID="CPLANT__HIREDPLANT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCPLANT_HIREDPLANT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Hired in Plant"
			ClientValidationFunction="onValidate_CPLANT__HIREDPLANT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCPLANT_DEPPREM" for="ctl00_cntMainBody_CPLANT__DEPPREM" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CPLANT-DEPPREM">	
		
		<asp:TextBox ID="CPLANT__DEPPREM" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCPLANT_DEPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deposit Premium Applicable"
			ClientValidationFunction="onValidate_CPLANT__DEPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCPLANT_PUBLIAB" for="ctl00_cntMainBody_CPLANT__PUBLIAB" class="col-md-4 col-sm-3 control-label">
		Public Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CPLANT" 
		data-property-name="PUBLIAB" 
		id="pb-container-checkbox-CPLANT-PUBLIAB">	
		
		<asp:TextBox ID="CPLANT__PUBLIAB" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCPLANT_PUBLIAB" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Public Liability"
			ClientValidationFunction="onValidate_CPLANT__PUBLIAB" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id00c4e872bdf64635a4e019a0dcf3af50 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id00c4e872bdf64635a4e019a0dcf3af50 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id00c4e872bdf64635a4e019a0dcf3af50 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id00c4e872bdf64635a4e019a0dcf3af50 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id00c4e872bdf64635a4e019a0dcf3af50 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id00c4e872bdf64635a4e019a0dcf3af50 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id00c4e872bdf64635a4e019a0dcf3af50 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id00c4e872bdf64635a4e019a0dcf3af50 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id00c4e872bdf64635a4e019a0dcf3af50 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id00c4e872bdf64635a4e019a0dcf3af50 input{text-align:left;}"; break;
		}
	}
