<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPINSURE_Cover_Details.aspx.vb" Inherits="Nexus.PB2_CPINSURE_Cover_Details" %>
...
function onValidate_GENERAL__CCAREASON(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CCAREASON", "ChildScreen");
        })();
}
...
function onValidate_CPLANT__PRIMINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANT", "PRIMINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLANT", "PRIMINDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblCPLANT_PRIMINDUSTRY");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLANT.PRIMINDUSTRY");
        			window.setControlWidth(field, "0.6", "CPLANT", "PRIMINDUSTRY");
        		})();
        	}
        })();
}
function onValidate_CPLANT__SCNDINDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANT", "SCNDINDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLANT", "SCNDINDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblCPLANT_SCNDINDUSTRY");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLANT.SCNDINDUSTRY");
        			window.setControlWidth(field, "0.6", "CPLANT", "SCNDINDUSTRY");
        		})();
        	}
        })();
}
function onValidate_CPLANT__INDUSTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANT", "INDUSTRY", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLANT", "INDUSTRY");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblCPLANT_INDUSTRY");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLANT.INDUSTRY");
        			window.setControlWidth(field, "0.6", "CPLANT", "INDUSTRY");
        		})();
        	}
        })();
}
function onValidate_RETROCESSION__CCANOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETROCESSION", "CCANOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__CCAREASON(null, null, null, isOnLoad);
    ...
    onValidate_CPLANT__PRIMINDUSTRY(null, null, null, isOnLoad);
    onValidate_CPLANT__SCNDINDUSTRY(null, null, null, isOnLoad);
    onValidate_CPLANT__INDUSTRY(null, null, null, isOnLoad);
    onValidate_RETROCESSION__CCANOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id3d24c4d42bae4fd0960ab15335262ec2" class="general-layout-container">
...
<div id="idb64c15f376f046a1a8da10dc44a9dc7f" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Construction Plant Insurance" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#idb64c15f376f046a1a8da10dc44a9dc7f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb64c15f376f046a1a8da10dc44a9dc7f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb64c15f376f046a1a8da10dc44a9dc7f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb64c15f376f046a1a8da10dc44a9dc7f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb64c15f376f046a1a8da10dc44a9dc7f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb64c15f376f046a1a8da10dc44a9dc7f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb64c15f376f046a1a8da10dc44a9dc7f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb64c15f376f046a1a8da10dc44a9dc7f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb64c15f376f046a1a8da10dc44a9dc7f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb64c15f376f046a1a8da10dc44a9dc7f input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CCAREASON"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CCAREASON" 
		id="pb-container-childscreen-GENERAL-CCAREASON">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CCAREASON" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CCAREASON/CCAREASON_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CCAREASON" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CCAREASON"
						ClientValidationFunction="onValidate_GENERAL__CCAREASON" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id293f47deb39e40389b853ac455aa22e7" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id293f47deb39e40389b853ac455aa22e7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id293f47deb39e40389b853ac455aa22e7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id293f47deb39e40389b853ac455aa22e7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id293f47deb39e40389b853ac455aa22e7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id293f47deb39e40389b853ac455aa22e7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id293f47deb39e40389b853ac455aa22e7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id293f47deb39e40389b853ac455aa22e7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id293f47deb39e40389b853ac455aa22e7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id293f47deb39e40389b853ac455aa22e7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id293f47deb39e40389b853ac455aa22e7 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc555a10ced6f40f2a2155618dbf16e9b" class="column-layout-container fieldset-wrapper,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="CPLANT" 
		data-property-name="PRIMINDUSTRY" 
		id="pb-container-list-CPLANT-PRIMINDUSTRY">
		<asp:Label ID="lblCPLANT_PRIMINDUSTRY" runat="server" AssociatedControlID="CPLANT__PRIMINDUSTRY" 
			Text="Primary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CPLANT__PRIMINDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSONE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CPLANT__PRIMINDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCPLANT_PRIMINDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Primary Industry"
			ClientValidationFunction="onValidate_CPLANT__PRIMINDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-CPLANT-SCNDINDUSTRY">
		<asp:Label ID="lblCPLANT_SCNDINDUSTRY" runat="server" AssociatedControlID="CPLANT__SCNDINDUSTRY" 
			Text="Secondary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CPLANT__SCNDINDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTWO" ParentLookupListID="CPLANT__PRIMINDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CPLANT__SCNDINDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCPLANT_SCNDINDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Secondary Industry"
			ClientValidationFunction="onValidate_CPLANT__SCNDINDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-CPLANT-INDUSTRY">
		<asp:Label ID="lblCPLANT_INDUSTRY" runat="server" AssociatedControlID="CPLANT__INDUSTRY" 
			Text="Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CPLANT__INDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTHREE" ParentLookupListID="CPLANT__SCNDINDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CPLANT__INDUSTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCPLANT_INDUSTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Industry"
			ClientValidationFunction="onValidate_CPLANT__INDUSTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#idc555a10ced6f40f2a2155618dbf16e9b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc555a10ced6f40f2a2155618dbf16e9b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc555a10ced6f40f2a2155618dbf16e9b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc555a10ced6f40f2a2155618dbf16e9b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc555a10ced6f40f2a2155618dbf16e9b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc555a10ced6f40f2a2155618dbf16e9b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc555a10ced6f40f2a2155618dbf16e9b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc555a10ced6f40f2a2155618dbf16e9b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc555a10ced6f40f2a2155618dbf16e9b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc555a10ced6f40f2a2155618dbf16e9b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id37e1493519db43108b92326056954ca7" class="column-layout-container fieldset-wrapper,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RETROCESSION__CCANOTE"
		data-field-type="Child" 
		data-object-name="RETROCESSION" 
		data-property-name="CCANOTE" 
		id="pb-container-childscreen-RETROCESSION-CCANOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RETROCESSION__RETRO_DETAILS" runat="server" ScreenCode="CCANOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CCANOTE/CCANOTE_Retrocession_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valRETROCESSION_CCANOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RETROCESSION.CCANOTE"
						ClientValidationFunction="onValidate_RETROCESSION__CCANOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id37e1493519db43108b92326056954ca7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id37e1493519db43108b92326056954ca7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id37e1493519db43108b92326056954ca7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id37e1493519db43108b92326056954ca7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id37e1493519db43108b92326056954ca7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37e1493519db43108b92326056954ca7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37e1493519db43108b92326056954ca7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id37e1493519db43108b92326056954ca7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37e1493519db43108b92326056954ca7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37e1493519db43108b92326056954ca7 input{text-align:left;}"; break;
		}
	}
