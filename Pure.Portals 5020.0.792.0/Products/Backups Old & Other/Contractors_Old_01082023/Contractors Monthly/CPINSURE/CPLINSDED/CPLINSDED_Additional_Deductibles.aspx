        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLINSUR", "ADDESCRIPT");
        		}
...
function onValidate_CPLINSUR__ADPERC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("CPLINSUR.ADPERC > 0 && CPLINSUR.ADPERC <= 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CPLINSUR__ADBDED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "CPLINSUR.ADPERC !=null", "V", "{3}");
...
<div id="id1e2bd919ff8e456a96610d98702f6f8f" class="general-layout-container">
...
<div id="ide7764ffb8b214a6fb2bdd0453d7f8dbf" class="column-layout-container fieldset-wrapper,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#ide7764ffb8b214a6fb2bdd0453d7f8dbf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide7764ffb8b214a6fb2bdd0453d7f8dbf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide7764ffb8b214a6fb2bdd0453d7f8dbf div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide7764ffb8b214a6fb2bdd0453d7f8dbf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide7764ffb8b214a6fb2bdd0453d7f8dbf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide7764ffb8b214a6fb2bdd0453d7f8dbf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide7764ffb8b214a6fb2bdd0453d7f8dbf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide7764ffb8b214a6fb2bdd0453d7f8dbf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide7764ffb8b214a6fb2bdd0453d7f8dbf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide7764ffb8b214a6fb2bdd0453d7f8dbf input{text-align:left;}"; break;
		}
	}
