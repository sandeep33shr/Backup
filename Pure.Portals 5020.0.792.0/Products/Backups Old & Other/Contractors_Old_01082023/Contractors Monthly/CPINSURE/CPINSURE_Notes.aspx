<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPINSURE_Notes.aspx.vb" Inherits="Nexus.PB2_CPINSURE_Notes" %>
...
function onValidate_NOTES__PLANTNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "PLANTNOTE", "ChildScreen");
        })();
}
function onValidate_NOTES__DEX_NOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "DEX_NOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__PLANTNOTE(null, null, null, isOnLoad);
    onValidate_NOTES__DEX_NOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id94797eb8951b4f98b7c1c2605a5a5673" class="general-layout-container">
...
<div id="id0f71cd7d5d0a475c80a27fa37e4b282a" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading63" runat="server" Text="Construction Plan Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__PLANTNOTE"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="PLANTNOTE" 
		id="pb-container-childscreen-NOTES-PLANTNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="PLANTNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PLANTNOTE/PLANTNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_PLANTNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__PLANTNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id0f71cd7d5d0a475c80a27fa37e4b282a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0f71cd7d5d0a475c80a27fa37e4b282a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0f71cd7d5d0a475c80a27fa37e4b282a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0f71cd7d5d0a475c80a27fa37e4b282a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0f71cd7d5d0a475c80a27fa37e4b282a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f71cd7d5d0a475c80a27fa37e4b282a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f71cd7d5d0a475c80a27fa37e4b282a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0f71cd7d5d0a475c80a27fa37e4b282a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f71cd7d5d0a475c80a27fa37e4b282a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f71cd7d5d0a475c80a27fa37e4b282a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2cf2fe4cb0b34715bd8dbacc80ef4aa6" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading64" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__DEX_NOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="DEX_NOTES" 
		id="pb-container-childscreen-NOTES-DEX_NOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__EXT_DETAILS" runat="server" ScreenCode="DEX_NOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DEX_NOTES/DEX_NOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_DEX_NOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__DEX_NOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2cf2fe4cb0b34715bd8dbacc80ef4aa6 input{text-align:left;}"; break;
		}
	}
