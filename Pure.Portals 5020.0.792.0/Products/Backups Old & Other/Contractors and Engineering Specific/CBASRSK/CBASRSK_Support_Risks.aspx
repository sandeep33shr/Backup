<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CBASRSK_Support_Risks.aspx.vb" Inherits="Nexus.PB2_CBASRSK_Support_Risks" %>
...
function onValidate_GENERAL__CBASRMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CBASRMTA", "ChildScreen");
        })();
}
function onValidate_RTARSK__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "RISK_ATTACH_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RTARSK", "RISK_ATTACH_DATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RTARSK.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.4", "RTARSK", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRTARSK_RISK_ATTACH_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_RTARSK__RISK_ATTACH_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RTARSK__RISK_ATTACH_DATE_lblFindParty");
        			    }
        			}
...
function onValidate_RTARSK__EFFECTIVEDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "EFFECTIVEDATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RTARSK", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RTARSK.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.4", "RTARSK", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRTARSK_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_RTARSK__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RTARSK__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_RTARSK__IS_VAT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTARSK", "IS_VAT", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("RTARSK", "IS_VAT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RTARSK.IS_VAT");
        			window.setControlWidth(field, "0.4", "RTARSK", "IS_VAT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRTARSK_IS_VAT");
        			    var ele = document.getElementById('ctl00_cntMainBody_RTARSK__IS_VAT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RTARSK__IS_VAT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_INS_DET__INS_NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INS_DET", "INS_NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INS_DET", "INS_NAME");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INS_DET.INS_NAME");
        			window.setControlWidth(field, "0.8", "INS_DET", "INS_NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblINS_DET_INS_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_INS_DET__INS_NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_INS_DET__INS_NAME_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_INS_DET__PRINCIPAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INS_DET", "PRINCIPAL", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INS_DET", "PRINCIPAL");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INS_DET.PRINCIPAL");
        			window.setControlWidth(field, "0.8", "INS_DET", "PRINCIPAL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblINS_DET_PRINCIPAL");
        			    var ele = document.getElementById('ctl00_cntMainBody_INS_DET__PRINCIPAL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_INS_DET__PRINCIPAL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_INS_DET__CONTRACT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INS_DET", "CONTRACT", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INS_DET", "CONTRACT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("INS_DET.CONTRACT");
        			window.setControlWidth(field, "0.8", "INS_DET", "CONTRACT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblINS_DET_CONTRACT");
        			    var ele = document.getElementById('ctl00_cntMainBody_INS_DET__CONTRACT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_INS_DET__CONTRACT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_COVERDET__EXPOSURE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "EXPOSURE", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVERDET", "EXPOSURE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERDET.EXPOSURE");
        			window.setControlWidth(field, "0.8", "COVERDET", "EXPOSURE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCOVERDET_EXPOSURE");
        			    var ele = document.getElementById('ctl00_cntMainBody_COVERDET__EXPOSURE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_COVERDET__EXPOSURE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_COVERDET__HAZARD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "HAZARD", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVERDET", "HAZARD");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERDET.HAZARD");
        			window.setControlWidth(field, "0.8", "COVERDET", "HAZARD");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCOVERDET_HAZARD");
        			    var ele = document.getElementById('ctl00_cntMainBody_COVERDET__HAZARD');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_COVERDET__HAZARD_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_COVERDET__LOINDEMN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "LOINDEMN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVERDET", "LOINDEMN");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERDET.LOINDEMN");
        			window.setControlWidth(field, "0.8", "COVERDET", "LOINDEMN");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCOVERDET_LOINDEMN");
        			    var ele = document.getElementById('ctl00_cntMainBody_COVERDET__LOINDEMN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_COVERDET__LOINDEMN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_COVERDET__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVERDET", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERDET.PREMIUM");
        			window.setControlWidth(field, "0.8", "COVERDET", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCOVERDET_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_COVERDET__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_COVERDET__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_COVERDET__ARCHITECT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "ARCHITECT", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVERDET", "ARCHITECT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERDET.ARCHITECT");
        			window.setControlWidth(field, "0.8", "COVERDET", "ARCHITECT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCOVERDET_ARCHITECT");
        			    var ele = document.getElementById('ctl00_cntMainBody_COVERDET__ARCHITECT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_COVERDET__ARCHITECT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_COVERDET__SUPDEDUC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "SUPDEDUC", "ChildScreen");
        })();
}
function onValidate_COVERDET__TOT_PREM_END(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "TOT_PREM_END", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("COVERDET", "TOT_PREM_END");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERDET.TOT_PREM_END");
        			window.setControlWidth(field, "0.4", "COVERDET", "TOT_PREM_END");
        		})();
        	}
        })();
         ...
         /**
          * @fileoverview GetColumn
          * @param COVERDET The Parent (Root) object name.
          * @param TSMR_END.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "COVERDET".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "TSMR_END.PREMIUM";
        		//count, average, total, min, max
...
function onValidate_COVERDET__SRENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "SRENDOS", "ChildScreen");
        })();
}
function onValidate_COVERDET__SRNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "SRNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var validLinkCaptions = "Delete,Edit";
        		// Trim
        		...
        		var field = Field.getInstance("COVERDET", "SRNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'COVERDET' and property 'SRNOTES'.");
        			error.display();
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_COVERDET__SRNOTES table td a");
...
function onValidate_COVERDET__SRSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERDET", "SRSNOTES", "ChildScreen");
        })();
}
function onValidate_EMPDE__BASE_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("COVERDET.PREMIUM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__END_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("COVERDET.TOT_PREM_END"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_EMPDE__TOT_RISK_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("COVERDET.PREMIUM + COVERDET.TOT_PREM_END"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function DoLogic(isOnLoad) {
    onValidate_GENERAL__CBASRMTA(null, null, null, isOnLoad);
    onValidate_RTARSK__RISK_ATTACH_DATE(null, null, null, isOnLoad);
    onValidate_RTARSK__EFFECTIVEDATE(null, null, null, isOnLoad);
    onValidate_RTARSK__IS_VAT(null, null, null, isOnLoad);
    ...
    onValidate_INS_DET__INS_NAME(null, null, null, isOnLoad);
    onValidate_INS_DET__PRINCIPAL(null, null, null, isOnLoad);
    onValidate_INS_DET__CONTRACT(null, null, null, isOnLoad);
    onValidate_COVERDET__EXPOSURE(null, null, null, isOnLoad);
    onValidate_COVERDET__HAZARD(null, null, null, isOnLoad);
    onValidate_COVERDET__LOINDEMN(null, null, null, isOnLoad);
    onValidate_COVERDET__PREMIUM(null, null, null, isOnLoad);
    onValidate_COVERDET__ARCHITECT(null, null, null, isOnLoad);
    ...
    onValidate_COVERDET__SUPDEDUC(null, null, null, isOnLoad);
    onValidate_COVERDET__TOT_PREM_END(null, null, null, isOnLoad);
    onValidate_COVERDET__SRENDOS(null, null, null, isOnLoad);
    onValidate_COVERDET__SRNOTES(null, null, null, isOnLoad);
    onValidate_COVERDET__SRSNOTES(null, null, null, isOnLoad);
...
<div id="id459eb08a869b4b72827a9ab5a2144a31" class="general-layout-container">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CBASRMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CBASRMTA" 
		id="pb-container-childscreen-GENERAL-CBASRMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CBASRMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CBASRMTA/CBASRMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CBASRMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CBASRMTA"
						ClientValidationFunction="onValidate_GENERAL__CBASRMTA" 
						Display="None"
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8ceb67cb60d747659475bd559917b105" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="RTARSK" 
		data-property-name="RISK_ATTACH_DATE" 
		id="pb-container-datejquerycompatible-RTARSK-RISK_ATTACH_DATE">
		<asp:Label ID="lblRTARSK_RISK_ATTACH_DATE" runat="server" AssociatedControlID="RTARSK__RISK_ATTACH_DATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="RTARSK__RISK_ATTACH_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calRTARSK__RISK_ATTACH_DATE" runat="server" LinkedControl="RTARSK__RISK_ATTACH_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valRTARSK_RISK_ATTACH_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_RTARSK__RISK_ATTACH_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-RTARSK-EFFECTIVEDATE">
		<asp:Label ID="lblRTARSK_EFFECTIVEDATE" runat="server" AssociatedControlID="RTARSK__EFFECTIVEDATE" 
			Text="Effective Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="RTARSK__EFFECTIVEDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calRTARSK__EFFECTIVEDATE" runat="server" LinkedControl="RTARSK__EFFECTIVEDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valRTARSK_EFFECTIVEDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective Date"
			ClientValidationFunction="onValidate_RTARSK__EFFECTIVEDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-RTARSK-IS_VAT">
		<asp:Label ID="lblRTARSK_IS_VAT" runat="server" AssociatedControlID="RTARSK__IS_VAT" 
			Text="VAT" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="RTARSK__IS_VAT" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_VAT" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_RTARSK__IS_VAT(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valRTARSK_IS_VAT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for VAT"
			ClientValidationFunction="onValidate_RTARSK__IS_VAT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-RTARSK-IS_VATCode">

		
		
			
		
				<asp:HiddenField ID="RTARSK__IS_VATCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8ceb67cb60d747659475bd559917b105 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8ceb67cb60d747659475bd559917b105 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8ceb67cb60d747659475bd559917b105 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8ceb67cb60d747659475bd559917b105 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8ceb67cb60d747659475bd559917b105 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8ceb67cb60d747659475bd559917b105 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8ceb67cb60d747659475bd559917b105 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8ceb67cb60d747659475bd559917b105 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8ceb67cb60d747659475bd559917b105 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8ceb67cb60d747659475bd559917b105 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7f389193429445d383ca44ac913a5857" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7f389193429445d383ca44ac913a5857 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7f389193429445d383ca44ac913a5857 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7f389193429445d383ca44ac913a5857 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7f389193429445d383ca44ac913a5857 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7f389193429445d383ca44ac913a5857 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7f389193429445d383ca44ac913a5857 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7f389193429445d383ca44ac913a5857 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7f389193429445d383ca44ac913a5857 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7f389193429445d383ca44ac913a5857 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7f389193429445d383ca44ac913a5857 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6c03a83d1667491183a4c231d069400a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading14" runat="server" Text="Insured Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="INS_DET" 
		data-property-name="INS_NAME" 
		 
		
		 
		id="pb-container-text-INS_DET-INS_NAME">

		
		<asp:Label ID="lblINS_DET_INS_NAME" runat="server" AssociatedControlID="INS_DET__INS_NAME" 
			Text="Insured Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="INS_DET__INS_NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valINS_DET_INS_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Insured Name"
					ClientValidationFunction="onValidate_INS_DET__INS_NAME"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-INS_DET-PRINCIPAL">

		
		<asp:Label ID="lblINS_DET_PRINCIPAL" runat="server" AssociatedControlID="INS_DET__PRINCIPAL" 
			Text="Principal" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="INS_DET__PRINCIPAL" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valINS_DET_PRINCIPAL" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Principal"
					ClientValidationFunction="onValidate_INS_DET__PRINCIPAL"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="INS_DET" 
		data-property-name="CONTRACT" 
		 
		
		 
		id="pb-container-text-INS_DET-CONTRACT">

		
		<asp:Label ID="lblINS_DET_CONTRACT" runat="server" AssociatedControlID="INS_DET__CONTRACT" 
			Text="Contractor" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="INS_DET__CONTRACT" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valINS_DET_CONTRACT" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Contractor"
					ClientValidationFunction="onValidate_INS_DET__CONTRACT"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6c03a83d1667491183a4c231d069400a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6c03a83d1667491183a4c231d069400a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6c03a83d1667491183a4c231d069400a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6c03a83d1667491183a4c231d069400a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6c03a83d1667491183a4c231d069400a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c03a83d1667491183a4c231d069400a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c03a83d1667491183a4c231d069400a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6c03a83d1667491183a4c231d069400a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c03a83d1667491183a4c231d069400a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c03a83d1667491183a4c231d069400a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9aa260b65ae347649975930652d52618" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Cover Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="COVERDET" 
		data-property-name="EXPOSURE" 
		id="pb-container-list-COVERDET-EXPOSURE">
		<asp:Label ID="lblCOVERDET_EXPOSURE" runat="server" AssociatedControlID="COVERDET__EXPOSURE" 
			Text="Exposure" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="COVERDET__EXPOSURE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CBA_EXPO" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_COVERDET__EXPOSURE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCOVERDET_EXPOSURE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Exposure"
			ClientValidationFunction="onValidate_COVERDET__EXPOSURE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="COVERDET" 
		data-property-name="HAZARD" 
		id="pb-container-list-COVERDET-HAZARD">
		<asp:Label ID="lblCOVERDET_HAZARD" runat="server" AssociatedControlID="COVERDET__HAZARD" 
			Text="Hazard" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="COVERDET__HAZARD" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CBA_HAZ" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_COVERDET__HAZARD(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCOVERDET_HAZARD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Hazard"
			ClientValidationFunction="onValidate_COVERDET__HAZARD" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="COVERDET" 
		data-property-name="LOINDEMN" 
		id="pb-container-currency-COVERDET-LOINDEMN">
		<asp:Label ID="lblCOVERDET_LOINDEMN" runat="server" AssociatedControlID="COVERDET__LOINDEMN" 
			Text="Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="COVERDET__LOINDEMN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCOVERDET_LOINDEMN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indemnity"
			ClientValidationFunction="onValidate_COVERDET__LOINDEMN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-COVERDET-PREMIUM">
		<asp:Label ID="lblCOVERDET_PREMIUM" runat="server" AssociatedControlID="COVERDET__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="COVERDET__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCOVERDET_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_COVERDET__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="COVERDET" 
		data-property-name="ARCHITECT" 
		id="pb-container-comment-COVERDET-ARCHITECT">
		<asp:Label ID="lblCOVERDET_ARCHITECT" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="COVERDET__ARCHITECT" 
			Text="Architects/ENG Drawing/Specifications"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="COVERDET__ARCHITECT" runat="server" />
		
		<asp:CustomValidator ID="valCOVERDET_ARCHITECT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Architects/ENG Drawing/Specifications"
			ClientValidationFunction="onValidate_COVERDET__ARCHITECT"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="COVERDET" 
		data-property-name="EXPOSURECode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-COVERDET-EXPOSURECode">

		
		
			
		
				<asp:HiddenField ID="COVERDET__EXPOSURECode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="COVERDET" 
		data-property-name="HAZARDCode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-COVERDET-HAZARDCode">

		
		
			
		
				<asp:HiddenField ID="COVERDET__HAZARDCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9aa260b65ae347649975930652d52618 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9aa260b65ae347649975930652d52618 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9aa260b65ae347649975930652d52618 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9aa260b65ae347649975930652d52618 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9aa260b65ae347649975930652d52618 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9aa260b65ae347649975930652d52618 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9aa260b65ae347649975930652d52618 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9aa260b65ae347649975930652d52618 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9aa260b65ae347649975930652d52618 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9aa260b65ae347649975930652d52618 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb8611f55ae5540859fa8f53050f34969" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb8611f55ae5540859fa8f53050f34969 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb8611f55ae5540859fa8f53050f34969 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb8611f55ae5540859fa8f53050f34969 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb8611f55ae5540859fa8f53050f34969 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb8611f55ae5540859fa8f53050f34969 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb8611f55ae5540859fa8f53050f34969 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb8611f55ae5540859fa8f53050f34969 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb8611f55ae5540859fa8f53050f34969 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb8611f55ae5540859fa8f53050f34969 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb8611f55ae5540859fa8f53050f34969 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idaa9c2741cd794a5ba0a710559159c5e8" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_COVERDET__SUPDEDUC"
		data-field-type="Child" 
		data-object-name="COVERDET" 
		data-property-name="SUPDEDUC" 
		id="pb-container-childscreen-COVERDET-SUPDEDUC">
		
		    <legend> Deductibles</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="COVERDET__DEDUC" runat="server" ScreenCode="SUPDEDUC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SUPDEDUC/SUPDEDUC_Deductibles.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:GISLookupField HeaderText="Basis of Deductible" ListType="PMLookup" ListCode="UDL_BASISDED" DataField="BASISDED" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valCOVERDET_SUPDEDUC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for  Deductibles"
						ClientValidationFunction="onValidate_COVERDET__SUPDEDUC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idaa9c2741cd794a5ba0a710559159c5e8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idaa9c2741cd794a5ba0a710559159c5e8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idaa9c2741cd794a5ba0a710559159c5e8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idaa9c2741cd794a5ba0a710559159c5e8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idaa9c2741cd794a5ba0a710559159c5e8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaa9c2741cd794a5ba0a710559159c5e8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaa9c2741cd794a5ba0a710559159c5e8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idaa9c2741cd794a5ba0a710559159c5e8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaa9c2741cd794a5ba0a710559159c5e8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaa9c2741cd794a5ba0a710559159c5e8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id96af9f3bf2464a108e1133d54ccabc1a" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblCOVERDET_REFERRAL_CLAUSES" runat="server" AssociatedControlID="COVERDET__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="COVERDET__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="COVERDET" 
		data-property-name="TOT_PREM_END" 
		id="pb-container-currency-COVERDET-TOT_PREM_END">
		<asp:Label ID="lblCOVERDET_TOT_PREM_END" runat="server" AssociatedControlID="COVERDET__TOT_PREM_END" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="COVERDET__TOT_PREM_END" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCOVERDET_TOT_PREM_END" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_COVERDET__TOT_PREM_END" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_COVERDET__SRENDOS"
		data-field-type="Child" 
		data-object-name="COVERDET" 
		data-property-name="SRENDOS" 
		id="pb-container-childscreen-COVERDET-SRENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="COVERDET__TSMR_END" runat="server" ScreenCode="SRENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SRENDOS/SRENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCOVERDET_SRENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for COVERDET.SRENDOS"
						ClientValidationFunction="onValidate_COVERDET__SRENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id96af9f3bf2464a108e1133d54ccabc1a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id96af9f3bf2464a108e1133d54ccabc1a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id96af9f3bf2464a108e1133d54ccabc1a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id96af9f3bf2464a108e1133d54ccabc1a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id96af9f3bf2464a108e1133d54ccabc1a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id96af9f3bf2464a108e1133d54ccabc1a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id96af9f3bf2464a108e1133d54ccabc1a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id96af9f3bf2464a108e1133d54ccabc1a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id96af9f3bf2464a108e1133d54ccabc1a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id96af9f3bf2464a108e1133d54ccabc1a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idacddb4f5c365437ab524f72213d42e0f" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading19" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_COVERDET__SRNOTES"
		data-field-type="Child" 
		data-object-name="COVERDET" 
		data-property-name="SRNOTES" 
		id="pb-container-childscreen-COVERDET-SRNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="COVERDET__TAMNOTES" runat="server" ScreenCode="SRNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SRNOTES/SRNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCOVERDET_SRNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for COVERDET.SRNOTES"
						ClientValidationFunction="onValidate_COVERDET__SRNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idacddb4f5c365437ab524f72213d42e0f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idacddb4f5c365437ab524f72213d42e0f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idacddb4f5c365437ab524f72213d42e0f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idacddb4f5c365437ab524f72213d42e0f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idacddb4f5c365437ab524f72213d42e0f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idacddb4f5c365437ab524f72213d42e0f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idacddb4f5c365437ab524f72213d42e0f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idacddb4f5c365437ab524f72213d42e0f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idacddb4f5c365437ab524f72213d42e0f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idacddb4f5c365437ab524f72213d42e0f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7dfacc8e70a44dd986e87a5cd3dafd3b" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_COVERDET__SRSNOTES"
		data-field-type="Child" 
		data-object-name="COVERDET" 
		data-property-name="SRSNOTES" 
		id="pb-container-childscreen-COVERDET-SRSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="COVERDET__TAMSNOTES" runat="server" ScreenCode="SRSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SRSNOTES/SRSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCOVERDET_SRSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for COVERDET.SRSNOTES"
						ClientValidationFunction="onValidate_COVERDET__SRSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7dfacc8e70a44dd986e87a5cd3dafd3b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7dfacc8e70a44dd986e87a5cd3dafd3b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7dfacc8e70a44dd986e87a5cd3dafd3b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id7dfacc8e70a44dd986e87a5cd3dafd3b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7dfacc8e70a44dd986e87a5cd3dafd3b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7dfacc8e70a44dd986e87a5cd3dafd3b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7dfacc8e70a44dd986e87a5cd3dafd3b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7dfacc8e70a44dd986e87a5cd3dafd3b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7dfacc8e70a44dd986e87a5cd3dafd3b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7dfacc8e70a44dd986e87a5cd3dafd3b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id95603f89444840cd8ae7d8dfbb8c573b" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id95603f89444840cd8ae7d8dfbb8c573b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id95603f89444840cd8ae7d8dfbb8c573b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id95603f89444840cd8ae7d8dfbb8c573b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id95603f89444840cd8ae7d8dfbb8c573b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id95603f89444840cd8ae7d8dfbb8c573b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id95603f89444840cd8ae7d8dfbb8c573b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id95603f89444840cd8ae7d8dfbb8c573b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id95603f89444840cd8ae7d8dfbb8c573b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id95603f89444840cd8ae7d8dfbb8c573b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id95603f89444840cd8ae7d8dfbb8c573b input{text-align:left;}"; break;
		}
	}
