<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CEEQMP_Multiple_Premises.aspx.vb" Inherits="Nexus.PB2_CEEQMP_Multiple_Premises" %>
...
<div id="id2998de075c1e425bad55bd9823b1b301" class="general-layout-container">
...
<div id="ide7636f5d6bca4ad982fcfa2ce2cf9d7f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading14" runat="server" Text="Multiple Premises" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide7636f5d6bca4ad982fcfa2ce2cf9d7f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide7636f5d6bca4ad982fcfa2ce2cf9d7f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide7636f5d6bca4ad982fcfa2ce2cf9d7f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide7636f5d6bca4ad982fcfa2ce2cf9d7f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide7636f5d6bca4ad982fcfa2ce2cf9d7f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide7636f5d6bca4ad982fcfa2ce2cf9d7f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide7636f5d6bca4ad982fcfa2ce2cf9d7f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide7636f5d6bca4ad982fcfa2ce2cf9d7f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide7636f5d6bca4ad982fcfa2ce2cf9d7f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide7636f5d6bca4ad982fcfa2ce2cf9d7f input{text-align:left;}"; break;
		}
	}
