<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="NONDED_Additional_Non_Band_Deductible.aspx.vb" Inherits="Nexus.PB2_NONDED_Additional_Non_Band_Deductible" %>
...
function onValidate_NOND__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOND", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NOND.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "NOND", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNOND_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_NOND__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NOND__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_NOND__DED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOND", "DED", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NOND", "DED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NOND.DED");
        			window.setControlWidth(field, "0.8", "NOND", "DED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNOND_DED");
        			    var ele = document.getElementById('ctl00_cntMainBody_NOND__DED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NOND__DED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "NOND".toUpperCase() + "__" + "DED");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "NOND".toUpperCase() + "_" + "DED");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(NOND.DED == '' OR NOND.DED == null) OR (NOND.DED > 0 AND NOND.DED <= 100 AND (NOND.DED <> '' AND NOND.DED <> null))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NOND__MIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOND", "MIN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NOND", "MIN");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NOND.MIN");
        			window.setControlWidth(field, "0.8", "NOND", "MIN");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNOND_MIN");
        			    var ele = document.getElementById('ctl00_cntMainBody_NOND__MIN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NOND__MIN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_NOND__MAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOND", "MAX", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NOND", "MAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NOND.MAX");
        			window.setControlWidth(field, "0.8", "NOND", "MAX");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNOND_MAX");
        			    var ele = document.getElementById('ctl00_cntMainBody_NOND__MAX');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NOND__MAX_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "NOND".toUpperCase() + "__" + "MAX");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "NOND".toUpperCase() + "_" + "MAX");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(NOND.MAX = '' OR NOND.MAX = null) || (NOND.MAX > NOND.MIN && (NOND.MIN <> '' OR NOND.MIN <> null))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_NOND__EVENT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOND", "EVENT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NOND", "EVENT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NOND.EVENT");
        			window.setControlWidth(field, "0.8", "NOND", "EVENT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNOND_EVENT");
        			    var ele = document.getElementById('ctl00_cntMainBody_NOND__EVENT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NOND__EVENT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_NOND__BASIS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOND", "BASIS", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NOND", "BASIS");
        		}
        		//window.setProperty(field, "VEM", "NOND.DED <> '' AND NOND.DED <> null", "V", "Basis of Deductible is mandatory and an option must be selected");
        
            var paramValue = "VEM",
            paramCondition = "NOND.DED <> '' AND NOND.DED <> null",
            paramElseValue = "V",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NOND.BASIS");
        			window.setControlWidth(field, "0.8", "NOND", "BASIS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblNOND_BASIS");
        			    var ele = document.getElementById('ctl00_cntMainBody_NOND__BASIS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_NOND__BASIS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("NOND.DED <> '' AND NOND.DED <> null")) ? new Expression("NOND.DED <> '' AND NOND.DED <> null") : null;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_NOND__DED(null, null, null, isOnLoad);
    onValidate_NOND__MIN(null, null, null, isOnLoad);
    onValidate_NOND__MAX(null, null, null, isOnLoad);
    onValidate_NOND__EVENT(null, null, null, isOnLoad);
    onValidate_NOND__BASIS(null, null, null, isOnLoad);
}
</script>
...
<div id="id1aa003e7cca54d8298a3c559dc4117e4" class="general-layout-container">
...
<div id="id941a1af4ce074454939fe171e0ad3a72" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-NOND-DESCRIPTION">

		
		<asp:Label ID="lblNOND_DESCRIPTION" runat="server" AssociatedControlID="NOND__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="NOND__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-NOND-DED">
		<asp:Label ID="lblNOND_DED" runat="server" AssociatedControlID="NOND__DED" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="NOND__DED" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valNOND_DED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_NOND__DED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-NOND-MIN">
		<asp:Label ID="lblNOND_MIN" runat="server" AssociatedControlID="NOND__MIN" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="NOND__MIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valNOND_MIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_NOND__MIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-NOND-MAX">
		<asp:Label ID="lblNOND_MAX" runat="server" AssociatedControlID="NOND__MAX" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="NOND__MAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valNOND_MAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_NOND__MAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="NOND" 
		data-property-name="EVENT" 
		id="pb-container-currency-NOND-EVENT">
		<asp:Label ID="lblNOND_EVENT" runat="server" AssociatedControlID="NOND__EVENT" 
			Text="Max Per Event/Occurrence" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="NOND__EVENT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valNOND_EVENT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Max Per Event/Occurrence"
			ClientValidationFunction="onValidate_NOND__EVENT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-NOND-BASIS">
		<asp:Label ID="lblNOND_BASIS" runat="server" AssociatedControlID="NOND__BASIS" 
			Text="Basis of deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="NOND__BASIS" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CW_BASISDED" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_NOND__BASIS(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valNOND_BASIS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of deductible"
			ClientValidationFunction="onValidate_NOND__BASIS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-NOND-BASISCode">

		
		
			
		
				<asp:HiddenField ID="NOND__BASISCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id941a1af4ce074454939fe171e0ad3a72 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id941a1af4ce074454939fe171e0ad3a72 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id941a1af4ce074454939fe171e0ad3a72 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id941a1af4ce074454939fe171e0ad3a72 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id941a1af4ce074454939fe171e0ad3a72 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id941a1af4ce074454939fe171e0ad3a72 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id941a1af4ce074454939fe171e0ad3a72 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id941a1af4ce074454939fe171e0ad3a72 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id941a1af4ce074454939fe171e0ad3a72 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id941a1af4ce074454939fe171e0ad3a72 input{text-align:left;}"; break;
		}
	}
