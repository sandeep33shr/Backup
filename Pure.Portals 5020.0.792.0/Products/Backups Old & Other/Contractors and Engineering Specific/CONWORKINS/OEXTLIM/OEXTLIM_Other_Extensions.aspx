...
function onValidate_OTHEREXT__LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "OTHEREXT.CONTRACTVALUE = NULL || OTHEREXT.CONTRACTVALUE =''", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("CW_RISK.CONTRACT_VAL * OTHEREXT.CONTRACTVALUE/100"), 
...
function onValidate_OTHEREXT__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var whenExp = (Expression.isValidParameter("OTHEREXT.RATE <> '' AND OTHEREXT.RATE <> null")) ? new Expression("OTHEREXT.RATE <> '' AND OTHEREXT.RATE <> null") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("OTHEREXT.LOI*OTHEREXT.RATE/100"), 
        			condition = (Expression.isValidParameter("OTHEREXT.RATE <> '' AND OTHEREXT.RATE <> null")) ? new Expression("OTHEREXT.RATE <> '' AND OTHEREXT.RATE <> null") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
<div id="id818ce202972049be9f278f9316049983" class="general-layout-container">
...
<div id="ida0e960f20d5641348495d9e05f964f4d" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida0e960f20d5641348495d9e05f964f4d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida0e960f20d5641348495d9e05f964f4d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida0e960f20d5641348495d9e05f964f4d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida0e960f20d5641348495d9e05f964f4d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida0e960f20d5641348495d9e05f964f4d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida0e960f20d5641348495d9e05f964f4d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida0e960f20d5641348495d9e05f964f4d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida0e960f20d5641348495d9e05f964f4d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida0e960f20d5641348495d9e05f964f4d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida0e960f20d5641348495d9e05f964f4d input{text-align:left;}"; break;
		}
	}
