<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAPLOE_Other_Extentions.aspx.vb" Inherits="Nexus.PB2_CCAPLOE_Other_Extentions" %>
...
function onValidate_CPLIABILITY__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLIABILITY", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLIABILITY", "DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLIABILITY.DESCRIPTION");
        			window.setControlWidth(field, "0.7", "CPLIABILITY", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPLIABILITY_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPLIABILITY__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPLIABILITY__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_CPLIABILITY__LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLIABILITY", "LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLIABILITY", "LOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLIABILITY.LOI");
        			window.setControlWidth(field, "0.7", "CPLIABILITY", "LOI");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPLIABILITY_LOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPLIABILITY__LOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPLIABILITY__LOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CPLIABILITY__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLIABILITY", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLIABILITY", "RATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLIABILITY.RATE");
        			window.setControlWidth(field, "0.7", "CPLIABILITY", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPLIABILITY_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPLIABILITY__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPLIABILITY__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CPLIABILITY__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLIABILITY", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLIABILITY", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLIABILITY.PREMIUM");
        			window.setControlWidth(field, "0.7", "CPLIABILITY", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPLIABILITY_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPLIABILITY__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPLIABILITY__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CPLIABILITY&propertyName=PREMIUM&name={name}");
        		
        		var value = new Expression("CPLIABILITY.LOI * (CPLIABILITY.RATE * 0.01)"), 
        ...
        $(document).ready(function() {
        	...
        	var SumInsured = Field.getInstance("CPLIABILITY", "LOI");
        	var Rate = Field.getInstance("CPLIABILITY", "RATE");
        	var Premium = Field.getInstance("CPLIABILITY", "PREMIUM");
...
function DoLogic(isOnLoad) {
    onValidate_CPLIABILITY__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_CPLIABILITY__LOI(null, null, null, isOnLoad);
    onValidate_CPLIABILITY__RATE(null, null, null, isOnLoad);
    onValidate_CPLIABILITY__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id46b7ae639c49473eb1e95a04f013c1ce" class="general-layout-container">
...
<div id="idd6cd5859377a457a86d0d93407644351" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading64" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CPLIABILITY" 
		data-property-name="DESCRIPTION" 
		 
		
		 
		id="pb-container-text-CPLIABILITY-DESCRIPTION">

		
		<asp:Label ID="lblCPLIABILITY_DESCRIPTION" runat="server" AssociatedControlID="CPLIABILITY__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CPLIABILITY__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCPLIABILITY_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CPLIABILITY__DESCRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CPLIABILITY-LOI">
		<asp:Label ID="lblCPLIABILITY_LOI" runat="server" AssociatedControlID="CPLIABILITY__LOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CPLIABILITY__LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCPLIABILITY_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CPLIABILITY__LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CPLIABILITY-RATE">
		<asp:Label ID="lblCPLIABILITY_RATE" runat="server" AssociatedControlID="CPLIABILITY__RATE" 
			Text="Rate " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CPLIABILITY__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCPLIABILITY_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate "
			ClientValidationFunction="onValidate_CPLIABILITY__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CPLIABILITY-PREMIUM">
		<asp:Label ID="lblCPLIABILITY_PREMIUM" runat="server" AssociatedControlID="CPLIABILITY__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CPLIABILITY__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCPLIABILITY_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CPLIABILITY__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd6cd5859377a457a86d0d93407644351 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd6cd5859377a457a86d0d93407644351 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd6cd5859377a457a86d0d93407644351 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd6cd5859377a457a86d0d93407644351 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd6cd5859377a457a86d0d93407644351 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd6cd5859377a457a86d0d93407644351 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd6cd5859377a457a86d0d93407644351 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd6cd5859377a457a86d0d93407644351 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd6cd5859377a457a86d0d93407644351 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd6cd5859377a457a86d0d93407644351 input{text-align:left;}"; break;
		}
	}
