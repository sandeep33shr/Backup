<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAPLNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_CCAPLNOTES_Note_Details" %>
...
function onValidate_GPASNOTES__Risk_Cover(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPASNOTES", "Risk_Cover", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPASNOTES", "Risk_Cover");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPASNOTES.Risk_Cover");
        			window.setControlWidth(field, "0.5", "GPASNOTES", "Risk_Cover");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GPASNOTES&propertyName=Risk_Cover&name={name}");
...
function onValidate_GPASNOTES__Note_Subject(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPASNOTES", "Note_Subject", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPASNOTES", "Note_Subject");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPASNOTES.Note_Subject");
        			window.setControlWidth(field, "0.5", "GPASNOTES", "Note_Subject");
        		})();
        	}
        })();
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GPASNOTES__Risk_Cover(null, null, null, isOnLoad);
    onValidate_GPASNOTES__Note_Subject(null, null, null, isOnLoad);
...
<div id="ida61729e09ff1457a8a5efe4847923975" class="general-layout-container">
...
<div id="idfd0041c531504baf92a9644cb4df95df" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading70" runat="server" Text="Construction Public Liability Notes (Printed On Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPASNOTES-Risk_Cover">

		
		<asp:Label ID="lblGPASNOTES_Risk_Cover" runat="server" AssociatedControlID="GPASNOTES__Risk_Cover" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPASNOTES__Risk_Cover" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPASNOTES_Risk_Cover" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_GPASNOTES__Risk_Cover"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPASNOTES-Note_Subject">

		
		<asp:Label ID="lblGPASNOTES_Note_Subject" runat="server" AssociatedControlID="GPASNOTES__Note_Subject" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPASNOTES__Note_Subject" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPASNOTES_Note_Subject" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_GPASNOTES__Note_Subject"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfd0041c531504baf92a9644cb4df95df div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfd0041c531504baf92a9644cb4df95df div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfd0041c531504baf92a9644cb4df95df div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfd0041c531504baf92a9644cb4df95df label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfd0041c531504baf92a9644cb4df95df label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfd0041c531504baf92a9644cb4df95df label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfd0041c531504baf92a9644cb4df95df label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfd0041c531504baf92a9644cb4df95df input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfd0041c531504baf92a9644cb4df95df input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfd0041c531504baf92a9644cb4df95df input{text-align:left;}"; break;
		}
	}
