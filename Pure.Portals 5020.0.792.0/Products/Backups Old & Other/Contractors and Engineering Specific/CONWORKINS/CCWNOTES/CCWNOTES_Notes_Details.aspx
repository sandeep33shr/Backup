<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCWNOTES_Notes_Details.aspx.vb" Inherits="Nexus.PB2_CCWNOTES_Notes_Details" %>
...
function onValidate_CWSNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWSNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWSNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWSNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "CWSNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=CWSNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_CWSNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWSNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWSNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWSNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "CWSNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_CWSNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWSNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWSNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWSNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "CWSNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CWSNOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_CWSNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWSNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWSNOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWSNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "CWSNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CWSNOTES", "NOTE_DESCRIPTION");
        		var exp = new Expression("CWSNOTES.NoteCheck = 1");
...
function onValidate_CWSNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWSNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CWSNOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWSNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "CWSNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=CWSNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_CWSNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_CWSNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_CWSNOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWSNOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CWSNOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_CWSNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_CWSNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_CWSNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_CWSNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_CWSNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_CWSNOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id82e10834ddbf4ca1ba4a218a2c9b90e0" class="general-layout-container">
...
<div id="idda6c4ee311114fe29eab405a0bc3ec1b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading27" runat="server" Text="Contact Works Note Detail (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CWSNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-CWSNOTES-DATE_CREATED">
		<asp:Label ID="lblCWSNOTES_DATE_CREATED" runat="server" AssociatedControlID="CWSNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="CWSNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calCWSNOTES__DATE_CREATED" runat="server" LinkedControl="CWSNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valCWSNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_CWSNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CWSNOTES-CREATED_BY">

		
		<asp:Label ID="lblCWSNOTES_CREATED_BY" runat="server" AssociatedControlID="CWSNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CWSNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCWSNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_CWSNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CWSNOTES-COVER_TYPE">

		
		<asp:Label ID="lblCWSNOTES_COVER_TYPE" runat="server" AssociatedControlID="CWSNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CWSNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCWSNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_CWSNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CWSNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblCWSNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="CWSNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CWSNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCWSNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_CWSNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-CWSNOTES-NOTE_DETAILS">
		<asp:Label ID="lblCWSNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="CWSNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="CWSNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valCWSNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_CWSNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWSNOTES_NoteCheck" for="ctl00_cntMainBody_CWSNOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CWSNOTES-NoteCheck">	
		
		<asp:TextBox ID="CWSNOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWSNOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_CWSNOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idda6c4ee311114fe29eab405a0bc3ec1b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idda6c4ee311114fe29eab405a0bc3ec1b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idda6c4ee311114fe29eab405a0bc3ec1b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idda6c4ee311114fe29eab405a0bc3ec1b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idda6c4ee311114fe29eab405a0bc3ec1b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idda6c4ee311114fe29eab405a0bc3ec1b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idda6c4ee311114fe29eab405a0bc3ec1b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idda6c4ee311114fe29eab405a0bc3ec1b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idda6c4ee311114fe29eab405a0bc3ec1b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idda6c4ee311114fe29eab405a0bc3ec1b input{text-align:left;}"; break;
		}
	}
