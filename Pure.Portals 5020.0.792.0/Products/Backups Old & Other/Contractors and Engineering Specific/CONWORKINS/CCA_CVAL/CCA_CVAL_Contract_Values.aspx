...
function onValidate_CONVALS__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var whenExp = (Expression.isValidParameter("CONVALS.RATE <> '' AND CONVALS.RATE <> null")) ? new Expression("CONVALS.RATE <> '' AND CONVALS.RATE <> null") : null;
...
<div id="id1c193222d0b14d6c97c95e2f0f763ed8" class="general-layout-container">
...
<div id="idc661a912a99d4e84848c38924b87b478" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc661a912a99d4e84848c38924b87b478 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc661a912a99d4e84848c38924b87b478 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc661a912a99d4e84848c38924b87b478 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc661a912a99d4e84848c38924b87b478 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc661a912a99d4e84848c38924b87b478 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc661a912a99d4e84848c38924b87b478 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc661a912a99d4e84848c38924b87b478 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc661a912a99d4e84848c38924b87b478 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc661a912a99d4e84848c38924b87b478 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc661a912a99d4e84848c38924b87b478 input{text-align:left;}"; break;
		}
	}
