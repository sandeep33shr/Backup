<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CADDED_Additional_Deductibles.aspx.vb" Inherits="Nexus.PB2_CADDED_Additional_Deductibles" %>
...
function onValidate_ADDDEDUC_CHILD__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC_CHILD", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ADDDEDUC_CHILD", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC_CHILD.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "ADDDEDUC_CHILD", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_CHILD_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC_CHILD__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC_CHILD__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_ADDDEDUC_CHILD__DED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC_CHILD", "DED", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC_CHILD", "DED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC_CHILD.DED");
        			window.setControlWidth(field, "0.8", "ADDDEDUC_CHILD", "DED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_CHILD_DED");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC_CHILD__DED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC_CHILD__DED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC_CHILD".toUpperCase() + "__" + "DED");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC_CHILD".toUpperCase() + "_" + "DED");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(ADDDEDUC_CHILD.DED == '' OR ADDDEDUC_CHILD.DED == null) OR (ADDDEDUC_CHILD.DED > 0 AND ADDDEDUC_CHILD.DED <= 100 AND (ADDDEDUC_CHILD.DED <> '' AND ADDDEDUC_CHILD.DED <> null))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADDDEDUC_CHILD__MIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC_CHILD", "MIN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC_CHILD", "MIN");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC_CHILD.MIN");
        			window.setControlWidth(field, "0.8", "ADDDEDUC_CHILD", "MIN");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_CHILD_MIN");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC_CHILD__MIN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC_CHILD__MIN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ADDDEDUC_CHILD__MAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC_CHILD", "MAX", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC_CHILD", "MAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC_CHILD.MAX");
        			window.setControlWidth(field, "0.8", "ADDDEDUC_CHILD", "MAX");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_CHILD_MAX");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC_CHILD__MAX');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC_CHILD__MAX_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC_CHILD".toUpperCase() + "__" + "MAX");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC_CHILD".toUpperCase() + "_" + "MAX");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(ADDDEDUC_CHILD.MAX = '' OR ADDDEDUC_CHILD.MAX = null) || (ADDDEDUC_CHILD.MAX > ADDDEDUC_CHILD.MIN && (ADDDEDUC_CHILD.MIN <> '' OR ADDDEDUC_CHILD.MIN <> null))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADDDEDUC_CHILD__BASIS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC_CHILD", "BASIS", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC_CHILD", "BASIS");
        		}
        		//window.setProperty(field, "VEM", "ADDDEDUC_CHILD.DED <> '' AND ADDDEDUC_CHILD.DED <> null", "V", "Basis of Deductible is mandatory and an option must be selected");
        
            var paramValue = "VEM",
            paramCondition = "ADDDEDUC_CHILD.DED <> '' AND ADDDEDUC_CHILD.DED <> null",
            paramElseValue = "V",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC_CHILD.BASIS");
        			window.setControlWidth(field, "0.8", "ADDDEDUC_CHILD", "BASIS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_CHILD_BASIS");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC_CHILD__BASIS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC_CHILD__BASIS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("ADDDEDUC_CHILD.DED <> '' AND ADDDEDUC_CHILD.DED <> null")) ? new Expression("ADDDEDUC_CHILD.DED <> '' AND ADDDEDUC_CHILD.DED <> null") : null;
...
function DoLogic(isOnLoad) {
    onValidate_ADDDEDUC_CHILD__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_ADDDEDUC_CHILD__DED(null, null, null, isOnLoad);
    onValidate_ADDDEDUC_CHILD__MIN(null, null, null, isOnLoad);
    onValidate_ADDDEDUC_CHILD__MAX(null, null, null, isOnLoad);
    onValidate_ADDDEDUC_CHILD__BASIS(null, null, null, isOnLoad);
}
</script>
...
<div id="ida5d216a85de84e3db65916e69e4d26f7" class="general-layout-container">
...
<div id="ida9169ba0bb51488a8a7a1f2c5fff3714" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ADDDEDUC_CHILD" 
		data-property-name="DESCRIPTION" 
		 
		
		 
		id="pb-container-text-ADDDEDUC_CHILD-DESCRIPTION">

		
		<asp:Label ID="lblADDDEDUC_CHILD_DESCRIPTION" runat="server" AssociatedControlID="ADDDEDUC_CHILD__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ADDDEDUC_CHILD__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valADDDEDUC_CHILD_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_ADDDEDUC_CHILD__DESCRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ADDDEDUC_CHILD" 
		data-property-name="DED" 
		id="pb-container-percentage-ADDDEDUC_CHILD-DED">
		<asp:Label ID="lblADDDEDUC_CHILD_DED" runat="server" AssociatedControlID="ADDDEDUC_CHILD__DED" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="ADDDEDUC_CHILD__DED" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valADDDEDUC_CHILD_DED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_ADDDEDUC_CHILD__DED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ADDDEDUC_CHILD" 
		data-property-name="MIN" 
		id="pb-container-currency-ADDDEDUC_CHILD-MIN">
		<asp:Label ID="lblADDDEDUC_CHILD_MIN" runat="server" AssociatedControlID="ADDDEDUC_CHILD__MIN" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDDEDUC_CHILD__MIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDDEDUC_CHILD_MIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_ADDDEDUC_CHILD__MIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="ADDDEDUC_CHILD" 
		data-property-name="MAX" 
		id="pb-container-currency-ADDDEDUC_CHILD-MAX">
		<asp:Label ID="lblADDDEDUC_CHILD_MAX" runat="server" AssociatedControlID="ADDDEDUC_CHILD__MAX" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDDEDUC_CHILD__MAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDDEDUC_CHILD_MAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_ADDDEDUC_CHILD__MAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-ADDDEDUC_CHILD-BASIS">
		<asp:Label ID="lblADDDEDUC_CHILD_BASIS" runat="server" AssociatedControlID="ADDDEDUC_CHILD__BASIS" 
			Text="Basis of deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="ADDDEDUC_CHILD__BASIS" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CW_BASISDED" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_ADDDEDUC_CHILD__BASIS(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valADDDEDUC_CHILD_BASIS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of deductible"
			ClientValidationFunction="onValidate_ADDDEDUC_CHILD__BASIS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-ADDDEDUC_CHILD-BASISCode">

		
		
			
		
				<asp:HiddenField ID="ADDDEDUC_CHILD__BASISCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida9169ba0bb51488a8a7a1f2c5fff3714 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida9169ba0bb51488a8a7a1f2c5fff3714 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida9169ba0bb51488a8a7a1f2c5fff3714 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida9169ba0bb51488a8a7a1f2c5fff3714 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida9169ba0bb51488a8a7a1f2c5fff3714 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida9169ba0bb51488a8a7a1f2c5fff3714 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida9169ba0bb51488a8a7a1f2c5fff3714 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida9169ba0bb51488a8a7a1f2c5fff3714 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida9169ba0bb51488a8a7a1f2c5fff3714 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida9169ba0bb51488a8a7a1f2c5fff3714 input{text-align:left;}"; break;
		}
	}
