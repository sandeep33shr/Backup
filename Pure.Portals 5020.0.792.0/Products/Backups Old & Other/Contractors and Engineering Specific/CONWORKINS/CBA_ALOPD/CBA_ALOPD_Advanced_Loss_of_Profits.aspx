<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CBA_ALOPD_Advanced_Loss_of_Profits.aspx.vb" Inherits="Nexus.PB2_CBA_ALOPD_Advanced_Loss_of_Profits" %>
...
function onValidate_ADV_OBJ__DECSRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADV_OBJ", "DECSRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ADV_OBJ", "DECSRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADV_OBJ.DECSRIPTION");
        			window.setControlWidth(field, "0.8", "ADV_OBJ", "DECSRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADV_OBJ_DECSRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADV_OBJ__DECSRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADV_OBJ__DECSRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_ADV_OBJ__TIME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADV_OBJ", "TIME", "Integer");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ADV_OBJ", "TIME");
        		var errorMessage = "Time Deductible (Days) is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADV_OBJ.TIME");
        			window.setControlWidth(field, "0.8", "ADV_OBJ", "TIME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADV_OBJ_TIME");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADV_OBJ__TIME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADV_OBJ__TIME_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ADV_OBJ__MONEY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADV_OBJ", "MONEY", "Currency");
        })();
        /**
         * Set the field width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('ADV_OBJ', 'MONEY');
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADV_OBJ.MONEY");
        			window.setControlWidth(field, "0.8", "ADV_OBJ", "MONEY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADV_OBJ_MONEY");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADV_OBJ__MONEY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADV_OBJ__MONEY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_ADV_OBJ__DECSRIPTION(null, null, null, isOnLoad);
    onValidate_ADV_OBJ__TIME(null, null, null, isOnLoad);
    onValidate_ADV_OBJ__MONEY(null, null, null, isOnLoad);
}
</script>
...
<div id="id20668e3264dd4dbbba80e1c4d770a5b8" class="general-layout-container">
...
<div id="id3fb4bdcf4f564b0c8ffe44d11ea03ebe" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading19" runat="server" Text="Deductibles" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ADV_OBJ" 
		data-property-name="DECSRIPTION" 
		 
		
		 
		id="pb-container-text-ADV_OBJ-DECSRIPTION">

		
		<asp:Label ID="lblADV_OBJ_DECSRIPTION" runat="server" AssociatedControlID="ADV_OBJ__DECSRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ADV_OBJ__DECSRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valADV_OBJ_DECSRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_ADV_OBJ__DECSRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ADV_OBJ" 
		data-property-name="TIME" 
		id="pb-container-integer-ADV_OBJ-TIME">
		<asp:Label ID="lblADV_OBJ_TIME" runat="server" AssociatedControlID="ADV_OBJ__TIME" 
			Text="Time Deductible (Days)" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ADV_OBJ__TIME" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valADV_OBJ_TIME" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Time Deductible (Days)"
			ClientValidationFunction="onValidate_ADV_OBJ__TIME" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ADV_OBJ" 
		data-property-name="MONEY" 
		id="pb-container-currency-ADV_OBJ-MONEY">
		<asp:Label ID="lblADV_OBJ_MONEY" runat="server" AssociatedControlID="ADV_OBJ__MONEY" 
			Text="Money Deductible " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADV_OBJ__MONEY" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADV_OBJ_MONEY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Money Deductible "
			ClientValidationFunction="onValidate_ADV_OBJ__MONEY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3fb4bdcf4f564b0c8ffe44d11ea03ebe div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3fb4bdcf4f564b0c8ffe44d11ea03ebe div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3fb4bdcf4f564b0c8ffe44d11ea03ebe div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3fb4bdcf4f564b0c8ffe44d11ea03ebe label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3fb4bdcf4f564b0c8ffe44d11ea03ebe label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3fb4bdcf4f564b0c8ffe44d11ea03ebe label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3fb4bdcf4f564b0c8ffe44d11ea03ebe label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3fb4bdcf4f564b0c8ffe44d11ea03ebe input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3fb4bdcf4f564b0c8ffe44d11ea03ebe input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3fb4bdcf4f564b0c8ffe44d11ea03ebe input{text-align:left;}"; break;
		}
	}
