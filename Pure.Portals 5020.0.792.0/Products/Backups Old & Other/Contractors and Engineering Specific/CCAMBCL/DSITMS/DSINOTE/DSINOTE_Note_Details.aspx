<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DSINOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_DSINOTE_Note_Details" %>
...
function onValidate_DSITEM_NOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DSITEM_NOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "3", "DSITEM_NOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
...
function onValidate_DSITEM_NOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DSITEM_NOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "3", "DSITEM_NOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
...
<div id="id67ce472a25184575a956fbbefa62e243" class="general-layout-container">
...
<div id="id9a3fa074ed69478586f1c311d6c8f2e1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading51" runat="server" Text="Note Details (Not Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9a3fa074ed69478586f1c311d6c8f2e1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9a3fa074ed69478586f1c311d6c8f2e1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9a3fa074ed69478586f1c311d6c8f2e1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9a3fa074ed69478586f1c311d6c8f2e1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9a3fa074ed69478586f1c311d6c8f2e1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9a3fa074ed69478586f1c311d6c8f2e1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9a3fa074ed69478586f1c311d6c8f2e1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9a3fa074ed69478586f1c311d6c8f2e1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9a3fa074ed69478586f1c311d6c8f2e1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9a3fa074ed69478586f1c311d6c8f2e1 input{text-align:left;}"; break;
		}
	}
