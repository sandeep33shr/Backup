...
<div id="id429f721400884572b8bcfb9d8e83ba7c" class="general-layout-container">
...
<div id="ida70b4a3d7fb04721bff2b06ae444f47e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading37" runat="server" Text="Note Details (Not Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida70b4a3d7fb04721bff2b06ae444f47e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida70b4a3d7fb04721bff2b06ae444f47e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida70b4a3d7fb04721bff2b06ae444f47e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida70b4a3d7fb04721bff2b06ae444f47e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida70b4a3d7fb04721bff2b06ae444f47e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida70b4a3d7fb04721bff2b06ae444f47e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida70b4a3d7fb04721bff2b06ae444f47e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida70b4a3d7fb04721bff2b06ae444f47e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida70b4a3d7fb04721bff2b06ae444f47e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida70b4a3d7fb04721bff2b06ae444f47e input{text-align:left;}"; break;
		}
	}
