<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAMBCL_Machinery_Breakdown_Overview.aspx.vb" Inherits="Nexus.PB2_CCAMBCL_Machinery_Breakdown_Overview" %>
...
function onValidate_label40(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label40" != "{na" + "me}"){
        			instance = Field.getLabel("label40");
        		} else { 
...
function onValidate_label41(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label41" != "{na" + "me}"){
        			instance = Field.getLabel("label41");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label42(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label42" != "{na" + "me}"){
        			instance = Field.getLabel("label42");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label43(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label43" != "{na" + "me}"){
        			instance = Field.getLabel("label43");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label44(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label44" != "{na" + "me}"){
        			instance = Field.getLabel("label44");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label46(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label46" != "{na" + "me}"){
        			instance = Field.getLabel("label46");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label47(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label47" != "{na" + "me}"){
        			instance = Field.getLabel("label47");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
function onValidate_label48(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var instance;
        		if ("label48" != "{na" + "me}"){
        			instance = Field.getLabel("label48");
        		} else { 
        			instance = Field.getInstance("", "");
        		}
...
<div id="id7177975af0ad4b9298fbdc3c057fead8" class="general-layout-container">
...
<div id="ide820bf302a204b79a48557d316abd5b6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading73" runat="server" Text="Combined Reinsurance Exposure" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label40">
		<span class="label" id="label40">Total Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label41">
		<span class="label" id="label41">EML%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label42">
		<span class="label" id="label42">RI Exposure (VAT Incl.)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label43">
		<span class="label" id="label43">RI Exposure (VAT Excl.)</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label44">
		<span class="label" id="label44">Machinery Breakdown</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label45">
		<span class="label" id="label45">Machinery Breakdown Additional Claims Preparation Cost</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label46">
		<span class="label" id="label46">Consequential Loss Gross Profit/Revenue</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label47">
		<span class="label" id="label47">Consequential Loss Additional Claims Preparation Cost</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label48">
		<span class="label" id="label48">Deterioration of Stock</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label49">
		<span class="label" id="label49">Totals</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide820bf302a204b79a48557d316abd5b6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide820bf302a204b79a48557d316abd5b6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide820bf302a204b79a48557d316abd5b6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide820bf302a204b79a48557d316abd5b6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide820bf302a204b79a48557d316abd5b6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide820bf302a204b79a48557d316abd5b6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide820bf302a204b79a48557d316abd5b6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide820bf302a204b79a48557d316abd5b6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide820bf302a204b79a48557d316abd5b6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide820bf302a204b79a48557d316abd5b6 input{text-align:left;}"; break;
		}
	}
