<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPLSNOTES_Notes_Detials.aspx.vb" Inherits="Nexus.PB2_CPLSNOTES_Notes_Detials" %>
...
function onValidate_GPANOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "GPANOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=GPANOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_GPANOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "GPANOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_GPANOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "GPANOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GPANOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_GPANOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "GPANOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GPANOTES", "NOTE_DESCRIPTION");
        		var exp = new Expression("GPANOTES.NoteCheck = 1");
...
function onValidate_GPANOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GPANOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "GPANOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=GPANOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_GPANOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_GPANOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_GPANOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GPANOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_GPANOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_GPANOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_GPANOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_GPANOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_GPANOTES__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_GPANOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id5357a8b3adf64697b45abc45655f7191" class="general-layout-container">
...
<div id="idb74f601912e74c7a99606c96c2d2a783" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading7" runat="server" Text="Construction Public Liability Notes (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GPANOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-GPANOTES-DATE_CREATED">
		<asp:Label ID="lblGPANOTES_DATE_CREATED" runat="server" AssociatedControlID="GPANOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="GPANOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calGPANOTES__DATE_CREATED" runat="server" LinkedControl="GPANOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valGPANOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_GPANOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPANOTES-CREATED_BY">

		
		<asp:Label ID="lblGPANOTES_CREATED_BY" runat="server" AssociatedControlID="GPANOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPANOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPANOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_GPANOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPANOTES-COVER_TYPE">

		
		<asp:Label ID="lblGPANOTES_COVER_TYPE" runat="server" AssociatedControlID="GPANOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPANOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPANOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_GPANOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPANOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblGPANOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="GPANOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPANOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPANOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_GPANOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-GPANOTES-NOTE_DETAILS">
		<asp:Label ID="lblGPANOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="GPANOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="GPANOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valGPANOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_GPANOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGPANOTES_NoteCheck" for="ctl00_cntMainBody_GPANOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-GPANOTES-NoteCheck">	
		
		<asp:TextBox ID="GPANOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGPANOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_GPANOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb74f601912e74c7a99606c96c2d2a783 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb74f601912e74c7a99606c96c2d2a783 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb74f601912e74c7a99606c96c2d2a783 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb74f601912e74c7a99606c96c2d2a783 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb74f601912e74c7a99606c96c2d2a783 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb74f601912e74c7a99606c96c2d2a783 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb74f601912e74c7a99606c96c2d2a783 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb74f601912e74c7a99606c96c2d2a783 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb74f601912e74c7a99606c96c2d2a783 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb74f601912e74c7a99606c96c2d2a783 input{text-align:left;}"; break;
		}
	}
