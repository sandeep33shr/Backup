<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="COWENDOSS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_COWENDOSS_Endorsement_Premium" %>
...
<div id="id84d739af77c7433592c669a70d48dda0" class="general-layout-container">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGPA_ENDOSES_PREMIUM" runat="server" AssociatedControlID="GPA_ENDOSES__PREMIUM" 
			Text="s" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valGPA_ENDOSES_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for s"
