<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKSP_Deductibles.aspx.vb" Inherits="Nexus.PB2_CONWORKSP_Deductibles" %>
...
function onValidate_RISKDETAIL__DEDESP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISKDETAIL", "DEDESP", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_RISKDETAIL__DEDESP(null, null, null, isOnLoad);
}
</script>
...
<div id="id5395d7a077a6406abb7445b00813ef7c" class="general-layout-container">
...
<div id="Ded" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading42" runat="server" Text="Value Band Deductibles" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RISKDETAIL__DEDESP"
		data-field-type="Child" 
		data-object-name="RISKDETAIL" 
		data-property-name="DEDESP" 
		id="pb-container-childscreen-RISKDETAIL-DEDESP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RISKDETAIL__MAJPERILS" runat="server" ScreenCode="DEDESP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DEDESP/DEDESP_Value_Band_Deductibles.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Major Perils" DataField="label63" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Minor Perils" DataField="label64" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Theft, Malicious Damage" DataField="label65" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Transit" DataField="label66" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Surrounding Property" DataField="label67" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Fire Perils" DataField="label68" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="All Perils" DataField="label69" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valRISKDETAIL_DEDESP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for RISKDETAIL.DEDESP"
						ClientValidationFunction="onValidate_RISKDETAIL__DEDESP" 
						Display="None"
