<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKSP_Contract_Works.aspx.vb" Inherits="Nexus.PB2_CONWORKSP_Contract_Works" %>
...
function onValidate_CWIRSK__ADVLOP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "ADVLOP", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWIRSK", "ADVLOP");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CWIRSK.ADVLOP");
        		var update = function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWIRSK_ADVLOP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWIRSK__ADVLOP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWIRSK__ADVLOP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWIRSK__COREINSIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "COREINSIN", "Checkbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CWIRSK", "COREINSIN");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Checkbox&objectName=CWIRSK&propertyName=COREINSIN&name={name}");
        		
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("CWIRSK.CONTALLRKS = 1 or CWIRSK.ERECALLRKS = 1")) ? new Expression("CWIRSK.CONTALLRKS = 1 or CWIRSK.ERECALLRKS = 1") : null, 
...
function onValidate_CWIRSK__CONTESTPES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWIRSK", "CONTESTPES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_CWIRSK__ADVLOP(null, null, null, isOnLoad);
    onValidate_CWIRSK__COREINSIN(null, null, null, isOnLoad);
    ...
    onValidate_CWIRSK__CONTESTPES(null, null, null, isOnLoad);
}
</script>
...
<div id="idd4121f4d1d88440a947bb976b37f2bce" class="general-layout-container">
...
<div id="ida0fcb19a8b204445ba817cfd51253bcb" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida0fcb19a8b204445ba817cfd51253bcb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida0fcb19a8b204445ba817cfd51253bcb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida0fcb19a8b204445ba817cfd51253bcb div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida0fcb19a8b204445ba817cfd51253bcb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida0fcb19a8b204445ba817cfd51253bcb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida0fcb19a8b204445ba817cfd51253bcb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida0fcb19a8b204445ba817cfd51253bcb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida0fcb19a8b204445ba817cfd51253bcb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida0fcb19a8b204445ba817cfd51253bcb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida0fcb19a8b204445ba817cfd51253bcb input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id37f1d81da0a043d5a4f743f5c55fee06" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id37f1d81da0a043d5a4f743f5c55fee06 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id37f1d81da0a043d5a4f743f5c55fee06 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id37f1d81da0a043d5a4f743f5c55fee06 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id37f1d81da0a043d5a4f743f5c55fee06 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id37f1d81da0a043d5a4f743f5c55fee06 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37f1d81da0a043d5a4f743f5c55fee06 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37f1d81da0a043d5a4f743f5c55fee06 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id37f1d81da0a043d5a4f743f5c55fee06 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id37f1d81da0a043d5a4f743f5c55fee06 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id37f1d81da0a043d5a4f743f5c55fee06 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id65cb3538111747d4a362541aaee52010" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id65cb3538111747d4a362541aaee52010 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id65cb3538111747d4a362541aaee52010 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id65cb3538111747d4a362541aaee52010 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id65cb3538111747d4a362541aaee52010 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id65cb3538111747d4a362541aaee52010 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65cb3538111747d4a362541aaee52010 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65cb3538111747d4a362541aaee52010 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id65cb3538111747d4a362541aaee52010 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65cb3538111747d4a362541aaee52010 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65cb3538111747d4a362541aaee52010 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8b4174f86aa64939b9bd3c7f3b48f594" class="column-layout-container,no-border  ">
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_ADVLOP" for="ctl00_cntMainBody_CWIRSK__ADVLOP" class="col-md-4 col-sm-3 control-label">
		Advanced Loss of Profits </label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CWIRSK" 
		data-property-name="ADVLOP" 
		id="pb-container-checkbox-CWIRSK-ADVLOP">	
		
		<asp:TextBox ID="CWIRSK__ADVLOP" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_ADVLOP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Advanced Loss of Profits "
			ClientValidationFunction="onValidate_CWIRSK__ADVLOP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWIRSK_COREINSIN" for="ctl00_cntMainBody_CWIRSK__COREINSIN" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CWIRSK" 
		data-property-name="COREINSIN" 
		id="pb-container-checkbox-CWIRSK-COREINSIN">	
		
		<asp:TextBox ID="CWIRSK__COREINSIN" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWIRSK_COREINSIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for CWIRSK.COREINSIN"
			ClientValidationFunction="onValidate_CWIRSK__COREINSIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8b4174f86aa64939b9bd3c7f3b48f594 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8b4174f86aa64939b9bd3c7f3b48f594 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8b4174f86aa64939b9bd3c7f3b48f594 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8b4174f86aa64939b9bd3c7f3b48f594 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8b4174f86aa64939b9bd3c7f3b48f594 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8b4174f86aa64939b9bd3c7f3b48f594 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8b4174f86aa64939b9bd3c7f3b48f594 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8b4174f86aa64939b9bd3c7f3b48f594 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8b4174f86aa64939b9bd3c7f3b48f594 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8b4174f86aa64939b9bd3c7f3b48f594 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idcc542b2b235e4b92acf8ed28252859f2" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idcc542b2b235e4b92acf8ed28252859f2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcc542b2b235e4b92acf8ed28252859f2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcc542b2b235e4b92acf8ed28252859f2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idcc542b2b235e4b92acf8ed28252859f2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcc542b2b235e4b92acf8ed28252859f2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcc542b2b235e4b92acf8ed28252859f2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcc542b2b235e4b92acf8ed28252859f2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcc542b2b235e4b92acf8ed28252859f2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcc542b2b235e4b92acf8ed28252859f2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcc542b2b235e4b92acf8ed28252859f2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf035d9f570294dbf9919e3b3a91cbfaa" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading8" runat="server" Text="Contract Testing Periods" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWIRSK__CONTESTPES"
		data-field-type="Child" 
		data-object-name="CWIRSK" 
		data-property-name="CONTESTPES" 
		id="pb-container-childscreen-CWIRSK-CONTESTPES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWIRSK__CONTPERIOD" runat="server" ScreenCode="CONTESTPES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CONTESTPES/CONTESTPES_Testing_Period.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:GISLookupField HeaderText="Basis of Deductible" ListType="UserDefined" ListCode="BASISDED" DataField="BASIS_DED" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valCWIRSK_CONTESTPES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CWIRSK.CONTESTPES"
						ClientValidationFunction="onValidate_CWIRSK__CONTESTPES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf035d9f570294dbf9919e3b3a91cbfaa div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf035d9f570294dbf9919e3b3a91cbfaa div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf035d9f570294dbf9919e3b3a91cbfaa div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf035d9f570294dbf9919e3b3a91cbfaa label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf035d9f570294dbf9919e3b3a91cbfaa label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf035d9f570294dbf9919e3b3a91cbfaa label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf035d9f570294dbf9919e3b3a91cbfaa label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf035d9f570294dbf9919e3b3a91cbfaa input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf035d9f570294dbf9919e3b3a91cbfaa input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf035d9f570294dbf9919e3b3a91cbfaa input{text-align:left;}"; break;
		}
	}
