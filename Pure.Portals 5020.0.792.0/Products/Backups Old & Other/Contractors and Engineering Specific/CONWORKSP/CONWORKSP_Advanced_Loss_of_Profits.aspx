<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKSP_Advanced_Loss_of_Profits.aspx.vb" Inherits="Nexus.PB2_CONWORKSP_Advanced_Loss_of_Profits" %>
...
function onValidate_ADVANCE__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADVANCE", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADVANCE", "SUMINSURED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADVANCE.SUMINSURED");
        			window.setControlWidth(field, "0.7", "ADVANCE", "SUMINSURED");
        		})();
        	}
        })();
...
function onValidate_ADVANCE__PERIOD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADVANCE", "PERIOD", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADVANCE", "PERIOD");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADVANCE.PERIOD");
        			window.setControlWidth(field, "0.7", "ADVANCE", "PERIOD");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADVANCE.RATE");
        			window.setControlWidth(field, "0.7", "ADVANCE", "RATE");
        		})();
        	}
        })();
...
function onValidate_ADVANCE__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADVANCE.PREMIUM");
        			window.setControlWidth(field, "0.7", "ADVANCE", "PREMIUM");
        		})();
        	}
        })();
}
function onValidate_ADVANCE__SPADV_LOSS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADVANCE", "SPADV_LOSS", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_ADVANCE__SUMINSURED(null, null, null, isOnLoad);
    onValidate_ADVANCE__PERIOD(null, null, null, isOnLoad);
    onValidate_ADVANCE__RATE(null, null, null, isOnLoad);
    onValidate_ADVANCE__PREMIUM(null, null, null, isOnLoad);
    onValidate_ADVANCE__SPADV_LOSS(null, null, null, isOnLoad);
}
</script>
...
<div id="id92c0bbf0927b486a9c39a7fcc5998682" class="general-layout-container">
...
<div id="id1528f22ef91d4c59920fb4ef1730dbaa" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading34" runat="server" Text="Advanced Loss of Profits" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ADVANCE-SUMINSURED">
		<asp:Label ID="lblADVANCE_SUMINSURED" runat="server" AssociatedControlID="ADVANCE__SUMINSURED" 
			Text="Annual Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADVANCE__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADVANCE_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Annual Sum Insured"
			ClientValidationFunction="onValidate_ADVANCE__SUMINSURED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-ADVANCE-PERIOD">
		<asp:Label ID="lblADVANCE_PERIOD" runat="server" AssociatedControlID="ADVANCE__PERIOD" 
			Text="Indemnity Period (Months)" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ADVANCE__PERIOD" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valADVANCE_PERIOD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Indemnity Period (Months)"
			ClientValidationFunction="onValidate_ADVANCE__PERIOD" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1528f22ef91d4c59920fb4ef1730dbaa div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1528f22ef91d4c59920fb4ef1730dbaa div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1528f22ef91d4c59920fb4ef1730dbaa div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1528f22ef91d4c59920fb4ef1730dbaa label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1528f22ef91d4c59920fb4ef1730dbaa label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1528f22ef91d4c59920fb4ef1730dbaa label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1528f22ef91d4c59920fb4ef1730dbaa label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1528f22ef91d4c59920fb4ef1730dbaa input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1528f22ef91d4c59920fb4ef1730dbaa input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1528f22ef91d4c59920fb4ef1730dbaa input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd2937c2393b340fc9e07aa3c9999d8ac" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ADVANCE__SPADV_LOSS"
		data-field-type="Child" 
		data-object-name="ADVANCE" 
		data-property-name="SPADV_LOSS" 
		id="pb-container-childscreen-ADVANCE-SPADV_LOSS">
		
		    <legend>Deductibles</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ADVANCE__ADV_OBJ" runat="server" ScreenCode="SPADV_LOSS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SPADV_LOSS/SPADV_LOSS_Advanced_Loss_of_Profits.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Description" DataField="DECSRIPTION" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Time Deductible (Days)" DataField="TIME" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Money Deductible " DataField="MONEY" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valADVANCE_SPADV_LOSS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Deductibles"
						ClientValidationFunction="onValidate_ADVANCE__SPADV_LOSS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd2937c2393b340fc9e07aa3c9999d8ac div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd2937c2393b340fc9e07aa3c9999d8ac div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd2937c2393b340fc9e07aa3c9999d8ac div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd2937c2393b340fc9e07aa3c9999d8ac label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd2937c2393b340fc9e07aa3c9999d8ac label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd2937c2393b340fc9e07aa3c9999d8ac label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd2937c2393b340fc9e07aa3c9999d8ac label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd2937c2393b340fc9e07aa3c9999d8ac input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd2937c2393b340fc9e07aa3c9999d8ac input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd2937c2393b340fc9e07aa3c9999d8ac input{text-align:left;}"; break;
		}
	}
