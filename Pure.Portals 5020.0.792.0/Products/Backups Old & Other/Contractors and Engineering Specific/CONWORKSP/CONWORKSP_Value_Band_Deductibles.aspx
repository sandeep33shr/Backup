<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONWORKSP_Value_Band_Deductibles.aspx.vb" Inherits="Nexus.PB2_CONWORKSP_Value_Band_Deductibles" %>
...
function onValidate_RISKDETAILS__DEDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISKDETAILS", "DEDES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_RISKDETAILS__DEDES(null, null, null, isOnLoad);
}
</script>
...
<div id="idf59ea0620b944d12a2f99d1bbe1674b9" class="general-layout-container">
...
<div id="Value Band Deductibles" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RISKDETAILS__DEDES"
		data-field-type="Child" 
		data-object-name="RISKDETAILS" 
		data-property-name="DEDES" 
		id="pb-container-childscreen-RISKDETAILS-DEDES">
		
		    <legend>Deductibles</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RISKDETAILS__MAJPERILS" runat="server" ScreenCode="DEDES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DEDES/DEDES_Contract_Value_Bands.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Major Perils" DataField="label72" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Minor Perils" DataField="label73" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Theft, Malicious Damage" DataField="label74" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Transit" DataField="label75" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Surrounding Property" DataField="label76" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Fire Perils" DataField="label77" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="All Perils" DataField="label78" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valRISKDETAILS_DEDES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Deductibles"
						ClientValidationFunction="onValidate_RISKDETAILS__DEDES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#Value Band Deductibles div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#Value Band Deductibles div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#Value Band Deductibles div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#Value Band Deductibles label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#Value Band Deductibles label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#Value Band Deductibles label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#Value Band Deductibles label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#Value Band Deductibles input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#Value Band Deductibles input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#Value Band Deductibles input{text-align:left;}"; break;
		}
	}
