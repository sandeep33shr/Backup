<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="REINSUINWS_Inwards_Details.aspx.vb" Inherits="Nexus.PB2_REINSUINWS_Inwards_Details" %>
...
<div id="id6ce00cbd3db248109b44421ee05f2482" class="general-layout-container">
...
<div id="id6ac8d33c8c6b4cc19ee1c02195c3f2ae" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblCONTESTP_PER_SHARE" runat="server" AssociatedControlID="CONTESTP__PER_SHARE" 
			Text="Share Percentage " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		...
		<asp:CustomValidator ID="valCONTESTP_PER_SHARE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Share Percentage "
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6ac8d33c8c6b4cc19ee1c02195c3f2ae div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6ac8d33c8c6b4cc19ee1c02195c3f2ae div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6ac8d33c8c6b4cc19ee1c02195c3f2ae div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6ac8d33c8c6b4cc19ee1c02195c3f2ae label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6ac8d33c8c6b4cc19ee1c02195c3f2ae label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6ac8d33c8c6b4cc19ee1c02195c3f2ae label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6ac8d33c8c6b4cc19ee1c02195c3f2ae label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6ac8d33c8c6b4cc19ee1c02195c3f2ae input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6ac8d33c8c6b4cc19ee1c02195c3f2ae input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6ac8d33c8c6b4cc19ee1c02195c3f2ae input{text-align:left;}"; break;
		}
	}
