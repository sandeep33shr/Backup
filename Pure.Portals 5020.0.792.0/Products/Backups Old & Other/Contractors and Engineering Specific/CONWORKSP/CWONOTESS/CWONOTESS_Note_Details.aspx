<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CWONOTESS_Note_Details.aspx.vb" Inherits="Nexus.PB2_CWONOTESS_Note_Details" %>
...
<div id="ida63470acd99447bd854ce91cc135240d" class="general-layout-container">
...
<div id="id54e16ff560cc4eccaf2aca8938bb6d85" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading18" runat="server" Text="Contact Works Note Detail (Not Printed On Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id54e16ff560cc4eccaf2aca8938bb6d85 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id54e16ff560cc4eccaf2aca8938bb6d85 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id54e16ff560cc4eccaf2aca8938bb6d85 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id54e16ff560cc4eccaf2aca8938bb6d85 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id54e16ff560cc4eccaf2aca8938bb6d85 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54e16ff560cc4eccaf2aca8938bb6d85 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54e16ff560cc4eccaf2aca8938bb6d85 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id54e16ff560cc4eccaf2aca8938bb6d85 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54e16ff560cc4eccaf2aca8938bb6d85 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54e16ff560cc4eccaf2aca8938bb6d85 input{text-align:left;}"; break;
		}
	}
