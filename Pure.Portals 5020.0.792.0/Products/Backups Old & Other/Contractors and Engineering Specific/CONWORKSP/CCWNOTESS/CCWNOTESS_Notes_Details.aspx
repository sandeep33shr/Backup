<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCWNOTESS_Notes_Details.aspx.vb" Inherits="Nexus.PB2_CCWNOTESS_Notes_Details" %>
...
<div id="ided6775d103e9462295a9efd184edf036" class="general-layout-container">
...
<div id="id04ca6c3fac9943169cfd87f638e5f6f5" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Contact Works Note Detail (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id04ca6c3fac9943169cfd87f638e5f6f5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id04ca6c3fac9943169cfd87f638e5f6f5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id04ca6c3fac9943169cfd87f638e5f6f5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id04ca6c3fac9943169cfd87f638e5f6f5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id04ca6c3fac9943169cfd87f638e5f6f5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id04ca6c3fac9943169cfd87f638e5f6f5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id04ca6c3fac9943169cfd87f638e5f6f5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id04ca6c3fac9943169cfd87f638e5f6f5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id04ca6c3fac9943169cfd87f638e5f6f5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id04ca6c3fac9943169cfd87f638e5f6f5 input{text-align:left;}"; break;
		}
	}
