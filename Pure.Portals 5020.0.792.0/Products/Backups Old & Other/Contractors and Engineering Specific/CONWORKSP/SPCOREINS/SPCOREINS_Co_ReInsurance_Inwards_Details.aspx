<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPCOREINS_Co_ReInsurance_Inwards_Details.aspx.vb" Inherits="Nexus.PB2_SPCOREINS_Co_ReInsurance_Inwards_Details" %>
...
function onValidate_COREINS__COMPANY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COREINS", "COMPANY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COREINS", "COMPANY");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COREINS.COMPANY");
        			window.setControlWidth(field, "0.5", "COREINS", "COMPANY");
        		})();
        	}
        })();
...
function onValidate_COREINS__SHARE_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COREINS", "SHARE_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COREINS", "SHARE_PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COREINS.SHARE_PERC");
        			window.setControlWidth(field, "0.5", "COREINS", "SHARE_PERC");
        		})();
        	}
        })();
...
function onValidate_COREINS__NOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COREINS", "NOTES", "Text");
        })();
        /**
         * Set the field width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			var field = Field.getInstance('COREINS', 'NOTES');
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COREINS.NOTES");
        			window.setControlWidth(field, "0.5", "COREINS", "NOTES");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_COREINS__COMPANY(null, null, null, isOnLoad);
    onValidate_COREINS__SHARE_PERC(null, null, null, isOnLoad);
    onValidate_COREINS__NOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id45dccae840d84dcc904c0fc2ea309d65" class="general-layout-container">
...
<div id="id0f09db4b218f495e9ab69062b22cbf7d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Co Re-Insurance Inwards Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="COREINS" 
		data-property-name="COMPANY" 
		 
		
		 
		id="pb-container-text-COREINS-COMPANY">

		
		<asp:Label ID="lblCOREINS_COMPANY" runat="server" AssociatedControlID="COREINS__COMPANY" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="COREINS__COMPANY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCOREINS_COMPANY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_COREINS__COMPANY"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="COREINS" 
		data-property-name="SHARE_PERC" 
		id="pb-container-percentage-COREINS-SHARE_PERC">
		<asp:Label ID="lblCOREINS_SHARE_PERC" runat="server" AssociatedControlID="COREINS__SHARE_PERC" 
			Text="Percentage Share" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="COREINS__SHARE_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCOREINS_SHARE_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Percentage Share"
			ClientValidationFunction="onValidate_COREINS__SHARE_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-COREINS-NOTES">

		
		<asp:Label ID="lblCOREINS_NOTES" runat="server" AssociatedControlID="COREINS__NOTES" 
			Text="Notes" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="COREINS__NOTES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCOREINS_NOTES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Notes"
					ClientValidationFunction="onValidate_COREINS__NOTES"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0f09db4b218f495e9ab69062b22cbf7d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0f09db4b218f495e9ab69062b22cbf7d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0f09db4b218f495e9ab69062b22cbf7d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0f09db4b218f495e9ab69062b22cbf7d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0f09db4b218f495e9ab69062b22cbf7d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f09db4b218f495e9ab69062b22cbf7d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f09db4b218f495e9ab69062b22cbf7d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0f09db4b218f495e9ab69062b22cbf7d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f09db4b218f495e9ab69062b22cbf7d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f09db4b218f495e9ab69062b22cbf7d input{text-align:left;}"; break;
		}
	}
