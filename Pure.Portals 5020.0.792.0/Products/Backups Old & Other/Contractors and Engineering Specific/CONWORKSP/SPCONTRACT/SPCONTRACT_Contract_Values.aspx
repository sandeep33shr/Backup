<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPCONTRACT_Contract_Values.aspx.vb" Inherits="Nexus.PB2_SPCONTRACT_Contract_Values" %>
...
function onValidate_CONVALS__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONVALS", "DESCRIPTION", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONVALS", "DESCRIPTION");
        		}
...
function onValidate_CONVALS__CONTRACTVALUE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONVALS", "CONTRACTVALUE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONVALS", "CONTRACTVALUE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONVALS.CONTRACTVALUE");
        			window.setControlWidth(field, "0.5", "CONVALS", "CONTRACTVALUE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONVALS.RATE");
        			window.setControlWidth(field, "0.5", "CONVALS", "RATE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONVALS", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONVALS.PREMIUM");
        			window.setControlWidth(field, "0.5", "CONVALS", "PREMIUM");
        		})();
        	}
        })();
...
<div id="id99b167b44bf44cf890fdb510f11976a8" class="general-layout-container">
...
<div id="idc3187ddaa1f0439f92de3ac6f955349c" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-CONVALS-DESCRIPTION">
		<asp:Label ID="lblCONVALS_DESCRIPTION" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="CONVALS__DESCRIPTION" 
			Text="Description"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="CONVALS__DESCRIPTION" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CONVALS-CONTRACTVALUE">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc3187ddaa1f0439f92de3ac6f955349c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc3187ddaa1f0439f92de3ac6f955349c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc3187ddaa1f0439f92de3ac6f955349c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc3187ddaa1f0439f92de3ac6f955349c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc3187ddaa1f0439f92de3ac6f955349c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc3187ddaa1f0439f92de3ac6f955349c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc3187ddaa1f0439f92de3ac6f955349c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc3187ddaa1f0439f92de3ac6f955349c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc3187ddaa1f0439f92de3ac6f955349c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc3187ddaa1f0439f92de3ac6f955349c input{text-align:left;}"; break;
		}
	}
