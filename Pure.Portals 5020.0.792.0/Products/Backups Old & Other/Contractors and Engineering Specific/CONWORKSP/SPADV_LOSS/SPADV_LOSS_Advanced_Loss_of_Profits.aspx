<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPADV_LOSS_Advanced_Loss_of_Profits.aspx.vb" Inherits="Nexus.PB2_SPADV_LOSS_Advanced_Loss_of_Profits" %>
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADV_OBJ.DECSRIPTION");
        			window.setControlWidth(field, "0.7", "ADV_OBJ", "DECSRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADV_OBJ.TIME");
        			window.setControlWidth(field, "0.7", "ADV_OBJ", "TIME");
        		})();
        	}
        })();
...
function onValidate_ADV_OBJ__MONEY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADV_OBJ.MONEY");
        			window.setControlWidth(field, "0.7", "ADV_OBJ", "MONEY");
        		})();
        	}
        })();
}
...
<div id="id05b94ec5fa9743d593b79be3ebdf83de" class="general-layout-container">
...
<div id="idef9968c5d7454bdf99a2132a24f6f0a1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Deductibles" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idef9968c5d7454bdf99a2132a24f6f0a1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idef9968c5d7454bdf99a2132a24f6f0a1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idef9968c5d7454bdf99a2132a24f6f0a1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idef9968c5d7454bdf99a2132a24f6f0a1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idef9968c5d7454bdf99a2132a24f6f0a1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idef9968c5d7454bdf99a2132a24f6f0a1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idef9968c5d7454bdf99a2132a24f6f0a1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idef9968c5d7454bdf99a2132a24f6f0a1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idef9968c5d7454bdf99a2132a24f6f0a1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idef9968c5d7454bdf99a2132a24f6f0a1 input{text-align:left;}"; break;
		}
	}
