...
function onValidate_MG_NOTES__MGNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MG_NOTES", "MGNOTES", "ChildScreen");
        })();
}
function onValidate_MGEN_NOTES__MGSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MGEN_NOTES", "MGSNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MG_NOTES__MGNOTES(null, null, null, isOnLoad);
    onValidate_MGEN_NOTES__MGSNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="idbfa3bac7b76945c3a95d373d778cf4ad" class="general-layout-container">
...
<div id="ide3eb75727623494997c0d6e867e02f97" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MG_NOTES__MGNOTES"
		data-field-type="Child" 
		data-object-name="MG_NOTES" 
		data-property-name="MGNOTES" 
		id="pb-container-childscreen-MG_NOTES-MGNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MG_NOTES__MG_CNOTE_DETAILS" runat="server" ScreenCode="MGNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMG_NOTES_MGNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MG_NOTES.MGNOTES"
						ClientValidationFunction="onValidate_MG_NOTES__MGNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide3eb75727623494997c0d6e867e02f97 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide3eb75727623494997c0d6e867e02f97 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide3eb75727623494997c0d6e867e02f97 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide3eb75727623494997c0d6e867e02f97 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide3eb75727623494997c0d6e867e02f97 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide3eb75727623494997c0d6e867e02f97 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide3eb75727623494997c0d6e867e02f97 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide3eb75727623494997c0d6e867e02f97 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide3eb75727623494997c0d6e867e02f97 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide3eb75727623494997c0d6e867e02f97 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idaed1ce655c6e452e86596e3cfa506903" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MGEN_NOTES__MGSNOTES"
		data-field-type="Child" 
		data-object-name="MGEN_NOTES" 
		data-property-name="MGSNOTES" 
		id="pb-container-childscreen-MGEN_NOTES-MGSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MGEN_NOTES__MG_SCNOTE_DETAILS" runat="server" ScreenCode="MGSNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMGEN_NOTES_MGSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MGEN_NOTES.MGSNOTES"
						ClientValidationFunction="onValidate_MGEN_NOTES__MGSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idaed1ce655c6e452e86596e3cfa506903 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idaed1ce655c6e452e86596e3cfa506903 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idaed1ce655c6e452e86596e3cfa506903 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idaed1ce655c6e452e86596e3cfa506903 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idaed1ce655c6e452e86596e3cfa506903 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaed1ce655c6e452e86596e3cfa506903 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaed1ce655c6e452e86596e3cfa506903 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idaed1ce655c6e452e86596e3cfa506903 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaed1ce655c6e452e86596e3cfa506903 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaed1ce655c6e452e86596e3cfa506903 input{text-align:left;}"; break;
		}
	}
