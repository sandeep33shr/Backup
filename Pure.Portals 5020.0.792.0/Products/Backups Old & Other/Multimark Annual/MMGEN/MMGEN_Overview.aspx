...
function onValidate_ALLPREM__EXTPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ALLPREM", "EXTPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ALLPREM", "EXTPREM");
        		}
...
function onValidate_ALLPREM__ENDORSPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ALLPREM", "ENDORSPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ALLPREM", "ENDORSPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_ALLPREM__TOTPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ALLPREM", "TOTPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ALLPREM", "TOTPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_ALLPREM__EXTPREM(null, null, null, isOnLoad);
    onValidate_ALLPREM__ENDORSPREM(null, null, null, isOnLoad);
    onValidate_ALLPREM__TOTPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id60fde6bece7c4a8ba4aaf58c29c8a9ab" class="general-layout-container">
...
<div id="id851fccb03609414d88d8462dcf0c4cbd" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Financial Overview" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ALLPREM" 
		data-property-name="EXTPREM" 
		id="pb-container-currency-ALLPREM-EXTPREM">
		<asp:Label ID="lblALLPREM_EXTPREM" runat="server" AssociatedControlID="ALLPREM__EXTPREM" 
			Text="Cover Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ALLPREM__EXTPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valALLPREM_EXTPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Cover Premium"
			ClientValidationFunction="onValidate_ALLPREM__EXTPREM" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ALLPREM-ENDORSPREM">
		<asp:Label ID="lblALLPREM_ENDORSPREM" runat="server" AssociatedControlID="ALLPREM__ENDORSPREM" 
			Text="Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ALLPREM__ENDORSPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valALLPREM_ENDORSPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement Premium"
			ClientValidationFunction="onValidate_ALLPREM__ENDORSPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ALLPREM-TOTPREM">
		<asp:Label ID="lblALLPREM_TOTPREM" runat="server" AssociatedControlID="ALLPREM__TOTPREM" 
			Text="Total Risk Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ALLPREM__TOTPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valALLPREM_TOTPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Risk Premium"
			ClientValidationFunction="onValidate_ALLPREM__TOTPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id851fccb03609414d88d8462dcf0c4cbd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id851fccb03609414d88d8462dcf0c4cbd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id851fccb03609414d88d8462dcf0c4cbd div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id851fccb03609414d88d8462dcf0c4cbd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id851fccb03609414d88d8462dcf0c4cbd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id851fccb03609414d88d8462dcf0c4cbd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id851fccb03609414d88d8462dcf0c4cbd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id851fccb03609414d88d8462dcf0c4cbd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id851fccb03609414d88d8462dcf0c4cbd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id851fccb03609414d88d8462dcf0c4cbd input{text-align:left;}"; break;
		}
	}
