...
Namespace Nexus
    Partial Class PB2_MULTICHLD_Multiple_Buildings : Inherits BaseRisk
		...
		Protected Sub onValidate_MULTIPLE_BLD_ITEMS__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MULTIPLE_BLD_ITEMS__COUNTER_ID()
End Sub
        ...
        'Parameters:
        'FIRE - Parent Object
        'MULTIPLE_BLD_ITEMS - Child Object
        ...
        Protected Shadows Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If (transactionValue <> "VIEW") Then
        		...
        		For index = 0 To oQuote.Risks.Count - 1
        			...
        			Dim sChildId As String = GetAutoNumber("//FIRE/MULTIPLE_BLD_ITEMS", sXMLDataset)
        			If sChildId <> "0" Then
        				MULTIPLE_BLD_ITEMS__COUNTER_ID.Text = "I" & sChildId
        			End If
        		Next
