...
Namespace Nexus
    Partial Class PB2_GEYSERCHLD_Geyser_Extension : Inherits BaseRisk
		...
		Protected Sub onValidate_GEYSER_ITEMS__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GEYSER_ITEMS__COUNTER_ID()
End Sub
        ...
        Protected Shadows Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If (transactionValue <> "VIEW") Then
        		...
        		For index = 0 To oQuote.Risks.Count - 1
        			...
        			Dim sChildId As String = GetAutoNumber("//FIRE/GEYSER_ITEMS", sXMLDataset)
        			If sChildId <> "0" Then
        				GEYSER_ITEMS__COUNTER_ID.Text = "I" & sChildId
        			End If
        		Next
