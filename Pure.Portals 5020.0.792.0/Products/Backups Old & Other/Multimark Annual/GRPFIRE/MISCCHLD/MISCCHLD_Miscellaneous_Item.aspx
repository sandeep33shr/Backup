...
function onValidate_MISC_ITEMS__MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("MISC_ITEMS.MIN_AMOUNT <= MISC_ITEMS.MAX_AMOUNT");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_MISC_ITEMS__MAX_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("MISC_ITEMS.MAX_AMOUNT>= MISC_ITEMS.MIN_AMOUNT");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
<div id="id97aa294a9ee146be8d161aba5f7202a4" class="general-layout-container">
...
<div id="ida147a13a68d442aeb89e5b25e60ce7bd" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading19" runat="server" Text="Miscellaneous Item" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida147a13a68d442aeb89e5b25e60ce7bd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida147a13a68d442aeb89e5b25e60ce7bd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida147a13a68d442aeb89e5b25e60ce7bd div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida147a13a68d442aeb89e5b25e60ce7bd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida147a13a68d442aeb89e5b25e60ce7bd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida147a13a68d442aeb89e5b25e60ce7bd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida147a13a68d442aeb89e5b25e60ce7bd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida147a13a68d442aeb89e5b25e60ce7bd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida147a13a68d442aeb89e5b25e60ce7bd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida147a13a68d442aeb89e5b25e60ce7bd input{text-align:left;}"; break;
		}
	}
