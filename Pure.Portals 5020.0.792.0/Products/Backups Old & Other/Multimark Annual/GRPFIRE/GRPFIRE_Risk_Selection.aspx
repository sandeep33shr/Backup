...
function onValidate_CLAIM_HISTORY__FIRE0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_SELECTION.FIRE == true", "V", "{3}");
...
function onValidate_CLAIM_HISTORY__FIRE0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "FIRE0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.FIRE0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE0_12_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__FIRE13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "FIRE13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.FIRE13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE13_24_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__FIRE25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "FIRE25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.FIRE25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.FIRE25_36_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__BC0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BUILDINGS_COMB == true", "V", "{3}");
...
function onValidate_CLAIM_HISTORY__BC0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BC0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC0_12_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__BC13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BC13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC13_24_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__BC25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BC25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BC25_36_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__BI0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", " RISK_SELECTION.BI == true", "V", "{3}");
...
function onValidate_CLAIM_HISTORY__BI0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BI0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BI0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI0_12_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__BI13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BI13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BI13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI13_24_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__BI25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "BI25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.BI25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.BI25_36_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__OC0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_SELECTION.OFFICE_CONT == true", "V", "{3}");
...
function onValidate_CLAIM_HISTORY__OC0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "OC0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.OC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC0_12_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__OC13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "OC13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.OC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC13_24_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__OC25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "OC25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.OC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.OC25_36_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__AR0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", " RISK_SELECTION.ACCOUNT_RECEIVE  == true", "V", "{3}");
...
function onValidate_CLAIM_HISTORY__AR0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AR0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AR0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR0_12_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__AR13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AR13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AR13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR13_24_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__AR25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AR25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AR25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AR25_36_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__AC0_12_MONTHS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "RISK_SELECTION.ACCIDENTAL_DAMAGE == true", "V", "{3}");
...
function onValidate_CLAIM_HISTORY__AC0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AC0_12_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AC0_12_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC0_12_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__AC13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AC13_24_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AC13_24_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC13_24_MONTHS) == 1)");
...
function onValidate_CLAIM_HISTORY__AC25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLAIM_HISTORY", "AC25_36_AMOUNT");
        		var exp = new Expression("(Code(CLAIM_HISTORY.AC25_36_MONTHS)) == 2 OR (Code(CLAIM_HISTORY.AC25_36_MONTHS) == 1)");
...
<div id="id581bee52065b4518b5f487283a4c40f3" class="general-layout-container">
...
<div id="ide899ab979a974da5bc6d33cd1d3eaa93" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text=" Section" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide899ab979a974da5bc6d33cd1d3eaa93 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide899ab979a974da5bc6d33cd1d3eaa93 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide899ab979a974da5bc6d33cd1d3eaa93 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide899ab979a974da5bc6d33cd1d3eaa93 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide899ab979a974da5bc6d33cd1d3eaa93 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide899ab979a974da5bc6d33cd1d3eaa93 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide899ab979a974da5bc6d33cd1d3eaa93 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide899ab979a974da5bc6d33cd1d3eaa93 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide899ab979a974da5bc6d33cd1d3eaa93 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide899ab979a974da5bc6d33cd1d3eaa93 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id050f6ce4aca445bf992b554f6a61abd2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Premises Assessment" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id050f6ce4aca445bf992b554f6a61abd2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id050f6ce4aca445bf992b554f6a61abd2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id050f6ce4aca445bf992b554f6a61abd2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id050f6ce4aca445bf992b554f6a61abd2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id050f6ce4aca445bf992b554f6a61abd2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id050f6ce4aca445bf992b554f6a61abd2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id050f6ce4aca445bf992b554f6a61abd2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id050f6ce4aca445bf992b554f6a61abd2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id050f6ce4aca445bf992b554f6a61abd2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id050f6ce4aca445bf992b554f6a61abd2 input{text-align:left;}"; break;
		}
	}
...
<div id="SurveyReport" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading14" runat="server" Text="Survey Report" /></legend>
...
<div id="Pastclaimscount" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Past Claims Count" /></legend>
