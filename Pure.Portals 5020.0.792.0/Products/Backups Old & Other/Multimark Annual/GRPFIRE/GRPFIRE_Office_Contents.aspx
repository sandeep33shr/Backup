        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.QUOTEDATE"), 
        			condition = (Expression.isValidParameter("(OFFICE.RISK_ATTACH_DATE =='' ||OFFICE.RISK_ATTACH_DATE == null ) && RISK_SELECTION.OFFICE_CONT == true")) ? new Expression("(OFFICE.RISK_ATTACH_DATE =='' ||OFFICE.RISK_ATTACH_DATE == null ) && RISK_SELECTION.OFFICE_CONT == true") : null, 
...
function onValidate_OFFICE__EFFECTIVEDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=OFFICE&propertyName=EFFECTIVEDATE&name={name}");
...
function onValidate_OFFICE__OC_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE", "OC_SI");
        		}
        		//window.setProperty(field, "VEM", "OFFICE.OC_SI> 0 ", "VE", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "OFFICE.OC_SI> 0 ",
            paramElseValue = "VE",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("OFFICE.OC_SI > 0")) ? new Expression("OFFICE.OC_SI > 0") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
...
function onValidate_OFFICE__OC_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "OFFICE.OC_SI > 0 ", "VE", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE", "OC_PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "OFFICE.OC_SI > 0 ", "VE", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE", "OC_MIN_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "OFFICE.OC_SI > 0 ", "VE", "{3}");
...
function onValidate_OFFICE__LOD_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE", "LOD_SI");
        		}
        		//window.setProperty(field, "VEM", "OFFICE.LOD_SI> 0 ", "VE", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("OFFICE.LOD_SI > 0")) ? new Expression("OFFICE.LOD_SI > 0") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE", "LOD_PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "OFFICE.LOD_SI > 0 ", "VE", "{3}");
...
function onValidate_OFFICE__LFD_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "OFFICE.LFD_SI > 0 ", "VE", "{3}");
...
function onValidate_OFFICE__THEFT_SI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE", "THEFT_SI");
        		}
        		//window.setProperty(field, "VEM", "OFFICE.THEFT_SI > 0 ", "VE", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("OFFICE.THEFT_SI > 0")) ? new Expression("OFFICE.THEFT_SI > 0") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
...
function onValidate_OFFICE__THEFT_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OFFICE&propertyName=THEFT_PREMIUM&name={name}");
        		
        		var value = new Expression("OFFICE.THEFT_SI * (OFFICE.THEFT_RATE * 0.01)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OFFICE", "THEFT_MIN_AMOUNT");
        		}
        		//window.setProperty(field, "VE", "OFFICE.THEFT_SI > 0 ", "VE", "{3}");
...
function onValidate_OFFICE_EXTENSIONS__ACPC_LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "OFFICE_EXTENSIONS.IS_ACPC == true ", "V", "{3}");
...
function onValidate_OFFICE_EXTENSIONS__THEFT_LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "OFFICE_EXTENSIONS.IS_THEFT== true", "V", "{3}");
...
function onValidate_OFFICE_EXTENSIONS__THEFT_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OFFICE_EXTENSIONS&propertyName=THEFT_PREMIUM&name={name}");
        		
        		var value = new Expression("OFFICE_EXTENSIONS.THEFT_LOI*(OFFICE_EXTENSIONS.THEFT_RATE*0.01)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_OFFICE_EXTENSIONS__WILD_BM_LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "OFFICE_EXTENSIONS.IS_WILD_BM== true ", "V", "{3}");
...
function onValidate_OFFICE_EXTENSIONS__WILD_BM_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OFFICE_EXTENSIONS&propertyName=WILD_BM_PREMIUM&name={name}");
        		
        		var value = new Expression("OFFICE_EXTENSIONS.WILD_BM_LOI*(OFFICE_EXTENSIONS.RATE*0.01)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_OFFICE_EXTENSIONS__NASRIA_OC_LOI(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VE", "OFFICE_EXTENSIONS.IS_NASRIA_OC == true ", "V", "{3}");
...
<div id="idebbb470a1b884e0d9486c1f5903e3325" class="general-layout-container">
...
<div id="id4170643c035d4b75aa685692efc02890" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4170643c035d4b75aa685692efc02890 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4170643c035d4b75aa685692efc02890 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4170643c035d4b75aa685692efc02890 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4170643c035d4b75aa685692efc02890 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4170643c035d4b75aa685692efc02890 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4170643c035d4b75aa685692efc02890 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4170643c035d4b75aa685692efc02890 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4170643c035d4b75aa685692efc02890 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4170643c035d4b75aa685692efc02890 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4170643c035d4b75aa685692efc02890 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2a288023d9b24a47b44a2242090b825e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading89" runat="server" Text="Aggregate" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2a288023d9b24a47b44a2242090b825e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2a288023d9b24a47b44a2242090b825e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2a288023d9b24a47b44a2242090b825e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2a288023d9b24a47b44a2242090b825e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2a288023d9b24a47b44a2242090b825e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2a288023d9b24a47b44a2242090b825e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2a288023d9b24a47b44a2242090b825e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2a288023d9b24a47b44a2242090b825e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2a288023d9b24a47b44a2242090b825e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2a288023d9b24a47b44a2242090b825e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida21e85ff7eb94f069ec6f75fe6507d7e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading90" runat="server" Text="Cover" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label265">
		<span class="label" id="label265">Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label266">
		<span class="label" id="label266">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label267">
		<span class="label" id="label267">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label268">
		<span class="label" id="label268">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label269">
		<span class="label" id="label269">Minimum Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label270">
		<span class="label" id="label270">Maximum Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label271">
		<span class="label" id="label271">Office Contents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label272">
		<span class="label" id="label272">Loss of Documents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label273">
		<span class="label" id="label273">Liability For Documents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label274">
		<span class="label" id="label274">Theft (following forcible and violent entry/exit)</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label275">
		<span class="label" id="label275">Total </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida21e85ff7eb94f069ec6f75fe6507d7e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida21e85ff7eb94f069ec6f75fe6507d7e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida21e85ff7eb94f069ec6f75fe6507d7e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida21e85ff7eb94f069ec6f75fe6507d7e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida21e85ff7eb94f069ec6f75fe6507d7e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida21e85ff7eb94f069ec6f75fe6507d7e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida21e85ff7eb94f069ec6f75fe6507d7e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida21e85ff7eb94f069ec6f75fe6507d7e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida21e85ff7eb94f069ec6f75fe6507d7e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida21e85ff7eb94f069ec6f75fe6507d7e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id15b80ff4a4d04fbf8a8e7fc87cd780d0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading91" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label279">
		<span class="label" id="label279">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label280">
		<span class="label" id="label280">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label281">
		<span class="label" id="label281">Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label282">
		<span class="label" id="label282">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label283">
		<span class="label" id="label283">Minimum Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label284">
		<span class="label" id="label284">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label287">
		<span class="label" id="label287">Additional Leakage - First Loss</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label288">
		<span class="label" id="label288">Riot & Strike</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label291">
		<span class="label" id="label291">Theft (Non Forcible)</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label292">
		<span class="label" id="label292">Wild Baboons and Monkeys</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label293">
		<span class="label" id="label293">NASRIA - Office Contents</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label299">
		<span class="label" id="label299">Total</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id15b80ff4a4d04fbf8a8e7fc87cd780d0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id15b80ff4a4d04fbf8a8e7fc87cd780d0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id15b80ff4a4d04fbf8a8e7fc87cd780d0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id15b80ff4a4d04fbf8a8e7fc87cd780d0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id15b80ff4a4d04fbf8a8e7fc87cd780d0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15b80ff4a4d04fbf8a8e7fc87cd780d0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15b80ff4a4d04fbf8a8e7fc87cd780d0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id15b80ff4a4d04fbf8a8e7fc87cd780d0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15b80ff4a4d04fbf8a8e7fc87cd780d0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15b80ff4a4d04fbf8a8e7fc87cd780d0 input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading92" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblOFFICE_REFERRAL_CLAUSES" runat="server" AssociatedControlID="OFFICE__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="OFFICE__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8d77e4e5949b4bdb87d098f7d8beaa7c" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8d77e4e5949b4bdb87d098f7d8beaa7c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8d77e4e5949b4bdb87d098f7d8beaa7c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8d77e4e5949b4bdb87d098f7d8beaa7c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8d77e4e5949b4bdb87d098f7d8beaa7c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8d77e4e5949b4bdb87d098f7d8beaa7c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8d77e4e5949b4bdb87d098f7d8beaa7c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8d77e4e5949b4bdb87d098f7d8beaa7c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8d77e4e5949b4bdb87d098f7d8beaa7c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8d77e4e5949b4bdb87d098f7d8beaa7c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8d77e4e5949b4bdb87d098f7d8beaa7c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id51489f87052c47cf8f71d564b1c13c3c" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id51489f87052c47cf8f71d564b1c13c3c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id51489f87052c47cf8f71d564b1c13c3c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id51489f87052c47cf8f71d564b1c13c3c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id51489f87052c47cf8f71d564b1c13c3c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id51489f87052c47cf8f71d564b1c13c3c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id51489f87052c47cf8f71d564b1c13c3c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id51489f87052c47cf8f71d564b1c13c3c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id51489f87052c47cf8f71d564b1c13c3c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id51489f87052c47cf8f71d564b1c13c3c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id51489f87052c47cf8f71d564b1c13c3c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida015602c40ef4fa3a6ea3413e509b156" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida015602c40ef4fa3a6ea3413e509b156 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida015602c40ef4fa3a6ea3413e509b156 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida015602c40ef4fa3a6ea3413e509b156 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida015602c40ef4fa3a6ea3413e509b156 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida015602c40ef4fa3a6ea3413e509b156 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida015602c40ef4fa3a6ea3413e509b156 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida015602c40ef4fa3a6ea3413e509b156 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida015602c40ef4fa3a6ea3413e509b156 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida015602c40ef4fa3a6ea3413e509b156 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida015602c40ef4fa3a6ea3413e509b156 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb1d13c29f0ae49d2895493a581b96c09" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading96" runat="server" Text="Reinsurance Exposure" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label305">
		<span class="label" id="label305">Total Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label306">
		<span class="label" id="label306">Target Risk SI</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label307">
		<span class="label" id="label307">MPL %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label308">
		<span class="label" id="label308">RI Exposure</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label309">
		<span class="label" id="label309">Contents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label310">
		<span class="label" id="label310">Rent</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label311">
		<span class="label" id="label311">Increase in Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label312">
		<span class="label" id="label312">Loss of Documents</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label313">
		<span class="label" id="label313">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label314">
		<span class="label" id="label314">Property Owned by Partner</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label315">
		<span class="label" id="label315">Capital Additions</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label316">
		<span class="label" id="label316">Clearance & Dem</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label317">
		<span class="label" id="label317">Total Office Contents RI Exposure</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb1d13c29f0ae49d2895493a581b96c09 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb1d13c29f0ae49d2895493a581b96c09 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb1d13c29f0ae49d2895493a581b96c09 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb1d13c29f0ae49d2895493a581b96c09 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb1d13c29f0ae49d2895493a581b96c09 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb1d13c29f0ae49d2895493a581b96c09 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb1d13c29f0ae49d2895493a581b96c09 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb1d13c29f0ae49d2895493a581b96c09 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb1d13c29f0ae49d2895493a581b96c09 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb1d13c29f0ae49d2895493a581b96c09 input{text-align:left;}"; break;
		}
	}
