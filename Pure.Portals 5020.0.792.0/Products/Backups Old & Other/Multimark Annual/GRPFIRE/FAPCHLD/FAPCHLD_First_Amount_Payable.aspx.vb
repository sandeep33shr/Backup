...
Namespace Nexus
    Partial Class PB2_FAPCHLD_First_Amount_Payable : Inherits BaseRisk
		...
		Protected Sub onValidate_FAP_CHILD__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FAP_CHILD__COUNTER_ID()
End Sub
        ...
        Protected Shadows Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If (transactionValue <> "VIEW") Then
        		...
        		For index = 0 To oQuote.Risks.Count - 1
        			...
        			Dim sChildId As String = GetAutoNumber("//FIRE/FAP_CHILD", sXMLDataset)
        			If sChildId <> "0" Then
        				FAP_CHILD__COUNTER_ID.Text = "I" & sChildId
        			End If
        		Next
