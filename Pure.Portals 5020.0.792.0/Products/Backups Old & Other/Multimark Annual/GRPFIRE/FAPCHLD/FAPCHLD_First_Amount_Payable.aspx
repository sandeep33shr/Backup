...
function onValidate_FAP_CHILD__MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("FAP_CHILD.MIN_AMOUNT <= FAP_CHILD.MAX_AMOUNT");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_FAP_CHILD__MAX_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("FAP_CHILD.MAX_AMOUNT>= FAP_CHILD.MIN_AMOUNT");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
<div id="ida3f47d171c6d45e6bab913f463744bc4" class="general-layout-container">
...
<div id="id0b5c1533f3f545a6acf3ef8bd70d0a15" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading21" runat="server" Text="First Amount Payable" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0b5c1533f3f545a6acf3ef8bd70d0a15 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0b5c1533f3f545a6acf3ef8bd70d0a15 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0b5c1533f3f545a6acf3ef8bd70d0a15 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0b5c1533f3f545a6acf3ef8bd70d0a15 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0b5c1533f3f545a6acf3ef8bd70d0a15 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b5c1533f3f545a6acf3ef8bd70d0a15 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b5c1533f3f545a6acf3ef8bd70d0a15 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0b5c1533f3f545a6acf3ef8bd70d0a15 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b5c1533f3f545a6acf3ef8bd70d0a15 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b5c1533f3f545a6acf3ef8bd70d0a15 input{text-align:left;}"; break;
		}
	}
