...
function onValidate_BC_MISC_ITEMS__MIN_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("BC_MISC_ITEMS.MIN_AMOUNT <= BC_MISC_ITEMS.MAX_AMOUNT");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_BC_MISC_ITEMS__MAX_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("BC_MISC_ITEMS.MAX_AMOUNT>= BC_MISC_ITEMS.MIN_AMOUNT");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
<div id="id4790153516bc48daa0368089f31c8f66" class="general-layout-container">
...
<div id="id97baf65deee7417ab4a4b6f9cea2badb" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading50" runat="server" Text="Miscellaneous Item" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id97baf65deee7417ab4a4b6f9cea2badb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id97baf65deee7417ab4a4b6f9cea2badb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id97baf65deee7417ab4a4b6f9cea2badb div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id97baf65deee7417ab4a4b6f9cea2badb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id97baf65deee7417ab4a4b6f9cea2badb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id97baf65deee7417ab4a4b6f9cea2badb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id97baf65deee7417ab4a4b6f9cea2badb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id97baf65deee7417ab4a4b6f9cea2badb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id97baf65deee7417ab4a4b6f9cea2badb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id97baf65deee7417ab4a4b6f9cea2badb input{text-align:left;}"; break;
		}
	}
