...
Namespace Nexus
    Partial Class PB2_BCMISCCHLD_Miscellaneous_Item : Inherits BaseRisk
		...
		Protected Sub onValidate_BC_MISC_ITEMS__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BC_MISC_ITEMS__COUNTER_ID()
End Sub
        ...
        Protected Shadows Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If (transactionValue <> "VIEW") Then
        		...
        		For index = 0 To oQuote.Risks.Count - 1
        			...
        			Dim sChildId As String = GetAutoNumber("//BUILDCOM/BC_MISC_ITEMS", sXMLDataset)
        			If sChildId <> "0" Then
        				BC_MISC_ITEMS__COUNTER_ID.Text = "I" & sChildId
        			End If
        		Next
