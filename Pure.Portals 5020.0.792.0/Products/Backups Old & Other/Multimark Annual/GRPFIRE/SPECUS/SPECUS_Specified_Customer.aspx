<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPECUS_Specified_Customer.aspx.vb" Inherits="Nexus.PB2_SPECUS_Specified_Customer" %>
...
<div id="id9cbe5316fbcb42819420c441dab2ff6a" class="general-layout-container">
...
<div id="id621627f88c6443d6b216afc0ff0c8e41" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading100" runat="server" Text="Specified Customers" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id621627f88c6443d6b216afc0ff0c8e41 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id621627f88c6443d6b216afc0ff0c8e41 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id621627f88c6443d6b216afc0ff0c8e41 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id621627f88c6443d6b216afc0ff0c8e41 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id621627f88c6443d6b216afc0ff0c8e41 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id621627f88c6443d6b216afc0ff0c8e41 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id621627f88c6443d6b216afc0ff0c8e41 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id621627f88c6443d6b216afc0ff0c8e41 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id621627f88c6443d6b216afc0ff0c8e41 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id621627f88c6443d6b216afc0ff0c8e41 input{text-align:left;}"; break;
		}
	}
