<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSIP_Interested_Party_Information.aspx.vb" Inherits="Nexus.PB2_MSIP_Interested_Party_Information" %>
...
function onValidate_INT_PARTY__AGREEMENT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INT_PARTY", "AGREEMENT", "Text");
        })();
}
function onValidate_INT_PARTY__EFF_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INT_PARTY", "EFF_DATE", "Date");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_INT_PARTY__NAME(null, null, null, isOnLoad);
    onValidate_INT_PARTY__AGREEMENT(null, null, null, isOnLoad);
    onValidate_INT_PARTY__EFF_DATE(null, null, null, isOnLoad);
}
</script>
...
<div id="idf7a9b38d7f014bb3866455bb1cd501e7" class="general-layout-container">
...
<div id="frmDetails" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading4" runat="server" Text="Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="INT_PARTY" 
		data-property-name="AGREEMENT" 
		 
		
		 
		id="pb-container-text-INT_PARTY-AGREEMENT">

		
		<asp:Label ID="lblINT_PARTY_AGREEMENT" runat="server" AssociatedControlID="INT_PARTY__AGREEMENT" 
			Text="Type of Agreement " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="INT_PARTY__AGREEMENT" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valINT_PARTY_AGREEMENT" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Type of Agreement "
					ClientValidationFunction="onValidate_INT_PARTY__AGREEMENT"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /Label -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-INT_PARTY-EFF_DATE">
		<asp:Label ID="lblINT_PARTY_EFF_DATE" runat="server" AssociatedControlID="INT_PARTY__EFF_DATE" 
			Text="Effective date " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="INT_PARTY__EFF_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calINT_PARTY__EFF_DATE" runat="server" LinkedControl="INT_PARTY__EFF_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valINT_PARTY_EFF_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective date "
			ClientValidationFunction="onValidate_INT_PARTY__EFF_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#frmDetails div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmDetails div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmDetails div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#frmDetails label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmDetails label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmDetails label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmDetails label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmDetails input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmDetails input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmDetails input{text-align:left;}"; break;
		}
	}
