<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSADCOMP_Additional_Compulsory_Excess.aspx.vb" Inherits="Nexus.PB2_MSADCOMP_Additional_Compulsory_Excess" %>
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADD_COMP_CHILD", "COMP_DESC");
        		}
...
<div id="id5cf3f56d95ae4920b7aadb1abb3979f4" class="general-layout-container">
