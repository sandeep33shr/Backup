<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSSOUND_Sound_Equipment.aspx.vb" Inherits="Nexus.PB2_MSSOUND_Sound_Equipment" %>
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SOUND", "LIMIT");
        		}
        		//window.setProperty(field, "VEM", "Limit of Indemnity is mandatory and an amount must be entered", "{2}", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "Limit of Indemnity is mandatory and an amount must be entered",
            paramElseValue = "{2}",
...
<div id="idda6b329d505f43958c189a4294adb4ee" class="general-layout-container">
...
<div id="id4f781a81e3604535a0fbf1b14105c08d" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4f781a81e3604535a0fbf1b14105c08d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4f781a81e3604535a0fbf1b14105c08d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4f781a81e3604535a0fbf1b14105c08d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4f781a81e3604535a0fbf1b14105c08d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4f781a81e3604535a0fbf1b14105c08d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4f781a81e3604535a0fbf1b14105c08d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4f781a81e3604535a0fbf1b14105c08d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4f781a81e3604535a0fbf1b14105c08d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4f781a81e3604535a0fbf1b14105c08d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4f781a81e3604535a0fbf1b14105c08d input{text-align:left;}"; break;
		}
	}
