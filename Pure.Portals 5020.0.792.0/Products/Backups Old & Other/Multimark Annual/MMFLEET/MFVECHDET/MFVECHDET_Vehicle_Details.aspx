...
function onValidate_VDETAILS__MAKEMODEL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VDETAILS", "MAKEMODEL", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VDETAILS", "MAKEMODEL");
        		}
...
function onValidate_VDETAILS__CYEAR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VDETAILS", "CYEAR", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VDETAILS", "CYEAR");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_VDETAILS__REGNO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VDETAILS", "REGNO", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VDETAILS", "REGNO");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_VDETAILS__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VDETAILS", "SUMINSURED", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VDETAILS", "SUMINSURED");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_VDETAILS__MAKEMODEL(null, null, null, isOnLoad);
    onValidate_VDETAILS__CYEAR(null, null, null, isOnLoad);
    onValidate_VDETAILS__REGNO(null, null, null, isOnLoad);
    onValidate_VDETAILS__SUMINSURED(null, null, null, isOnLoad);
}
</script>
...
<div id="id7ff0e21611c0496687f30278c9b6439f" class="general-layout-container">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="VDETAILS" 
		data-property-name="MAKEMODEL" 
		 
		
		 
		id="pb-container-text-VDETAILS-MAKEMODEL">

		
		<asp:Label ID="lblVDETAILS_MAKEMODEL" runat="server" AssociatedControlID="VDETAILS__MAKEMODEL" 
			Text="Make/Model" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="VDETAILS__MAKEMODEL" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valVDETAILS_MAKEMODEL" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Make/Model"
					ClientValidationFunction="onValidate_VDETAILS__MAKEMODEL"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-VDETAILS-CYEAR">

		
		<asp:Label ID="lblVDETAILS_CYEAR" runat="server" AssociatedControlID="VDETAILS__CYEAR" 
			Text="Year" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="VDETAILS__CYEAR" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valVDETAILS_CYEAR" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Year"
					ClientValidationFunction="onValidate_VDETAILS__CYEAR"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-VDETAILS-REGNO">

		
		<asp:Label ID="lblVDETAILS_REGNO" runat="server" AssociatedControlID="VDETAILS__REGNO" 
			Text="Vehicle Registration Number" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="VDETAILS__REGNO" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valVDETAILS_REGNO" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Vehicle Registration Number"
					ClientValidationFunction="onValidate_VDETAILS__REGNO"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-VDETAILS-SUMINSURED">
		<asp:Label ID="lblVDETAILS_SUMINSURED" runat="server" AssociatedControlID="VDETAILS__SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="VDETAILS__SUMINSURED" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valVDETAILS_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_VDETAILS__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
