<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MFPARTY_Interested_Parties.aspx.vb" Inherits="Nexus.PB2_MFPARTY_Interested_Parties" %>
...
function onValidate_INTP__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INTP", "NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INTP", "NAME");
        		}
...
function onValidate_INTP__STARTDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INTP", "STARTDATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INTP", "STARTDATE");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_INTP__REGNO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "INTP", "REGNO", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("INTP", "REGNO");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_INTP__NAME(null, null, null, isOnLoad);
    onValidate_INTP__STARTDATE(null, null, null, isOnLoad);
    onValidate_INTP__REGNO(null, null, null, isOnLoad);
}
</script>
...
<div id="idc5d818e0b30944b9a9d526599324ae2f" class="general-layout-container">
...
<div id="frmTypeFleet" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading6" runat="server" Text="Interested Parties" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="INTP" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-INTP-NAME">

		
		<asp:Label ID="lblINTP_NAME" runat="server" AssociatedControlID="INTP__NAME" 
			Text="Institution Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="INTP__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valINTP_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Institution Name"
					ClientValidationFunction="onValidate_INTP__NAME"
					ValidationGroup=""
					Display="None"
...
<!-- /Text -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-INTP-STARTDATE">
		<asp:Label ID="lblINTP_STARTDATE" runat="server" AssociatedControlID="INTP__STARTDATE" 
			Text="Start Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="INTP__STARTDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calINTP__STARTDATE" runat="server" LinkedControl="INTP__STARTDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valINTP_STARTDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Start Date"
			ClientValidationFunction="onValidate_INTP__STARTDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-INTP-REGNO">

		
		<asp:Label ID="lblINTP_REGNO" runat="server" AssociatedControlID="INTP__REGNO" 
			Text="Vehicle Registration Number" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="INTP__REGNO" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valINTP_REGNO" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Vehicle Registration Number"
					ClientValidationFunction="onValidate_INTP__REGNO"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
