...
function onValidate_SOUND__REG_NUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SOUND", "REG_NUM", "Text");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_SOUND__REG_NUM(null, null, null, isOnLoad);
...
<div id="id4b76e0e007db492d8a83cbcb91edfaa6" class="general-layout-container">
...
<div id="ide36114be919d4bf0a7381c2f72dbe2ed" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="Specified Sound Equipment" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SOUND-REG_NUM">

		
		<asp:Label ID="lblSOUND_REG_NUM" runat="server" AssociatedControlID="SOUND__REG_NUM" 
			Text="Vehicle Registration Number " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SOUND__REG_NUM" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSOUND_REG_NUM" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Vehicle Registration Number "
					ClientValidationFunction="onValidate_SOUND__REG_NUM"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide36114be919d4bf0a7381c2f72dbe2ed div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide36114be919d4bf0a7381c2f72dbe2ed div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide36114be919d4bf0a7381c2f72dbe2ed div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide36114be919d4bf0a7381c2f72dbe2ed label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide36114be919d4bf0a7381c2f72dbe2ed label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide36114be919d4bf0a7381c2f72dbe2ed label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide36114be919d4bf0a7381c2f72dbe2ed label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide36114be919d4bf0a7381c2f72dbe2ed input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide36114be919d4bf0a7381c2f72dbe2ed input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide36114be919d4bf0a7381c2f72dbe2ed input{text-align:left;}"; break;
		}
	}
