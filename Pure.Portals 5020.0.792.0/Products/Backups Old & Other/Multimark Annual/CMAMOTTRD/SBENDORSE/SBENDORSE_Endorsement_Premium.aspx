<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SBENDORSE_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_SBENDORSE_Endorsement_Premium" %>
...
function onValidate_SEC_B__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_B", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SEC_B", "ENDORSE_ID");
        		}
...
function onValidate_SEC_B__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_B", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SEC_B", "ENDORSE_DESC");
...
function onValidate_SEC_B__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_B", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SEC_B", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SEC_B&propertyName=ENDORSE_CAP&name={name}");
...
function onValidate_SEC_B__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_B", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SEC_B", "PREMIUM");
...
function DoLogic(isOnLoad) {
    onValidate_SEC_B__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_SEC_B__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_SEC_B__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_SEC_B__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id4342d0614e0a474ea0aa150d34258a43" class="general-layout-container">
...
<div id="id5ebe25276c5545bb810e93fe96d50604" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SEC_B" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-SEC_B-ENDORSE_ID">
		<asp:Label ID="lblSEC_B_ENDORSE_ID" runat="server" AssociatedControlID="SEC_B__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="SEC_B__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valSEC_B_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_SEC_B__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-SEC_B-ENDORSE_DESC">
		<asp:Label ID="lblSEC_B_ENDORSE_DESC" runat="server" AssociatedControlID="SEC_B__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="SEC_B__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_SEC_B__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valSEC_B_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_SEC_B__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SEC_B-ENDORSE_CAP">

		
		<asp:Label ID="lblSEC_B_ENDORSE_CAP" runat="server" AssociatedControlID="SEC_B__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SEC_B__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSEC_B_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_SEC_B__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SEC_B-PREMIUM">
		<asp:Label ID="lblSEC_B_PREMIUM" runat="server" AssociatedControlID="SEC_B__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SEC_B__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSEC_B_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SEC_B__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5ebe25276c5545bb810e93fe96d50604 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5ebe25276c5545bb810e93fe96d50604 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5ebe25276c5545bb810e93fe96d50604 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5ebe25276c5545bb810e93fe96d50604 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5ebe25276c5545bb810e93fe96d50604 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5ebe25276c5545bb810e93fe96d50604 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5ebe25276c5545bb810e93fe96d50604 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5ebe25276c5545bb810e93fe96d50604 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5ebe25276c5545bb810e93fe96d50604 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5ebe25276c5545bb810e93fe96d50604 input{text-align:left;}"; break;
		}
	}
