<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SCENDORSE_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_SCENDORSE_Endorsement_Premium" %>
...
function onValidate_SEC_C__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_C", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SEC_C", "ENDORSE_ID");
        		}
...
function onValidate_SEC_C__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_C", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SEC_C", "ENDORSE_DESC");
...
function onValidate_SEC_C__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_C", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SEC_C", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SEC_C&propertyName=ENDORSE_CAP&name={name}");
...
function onValidate_SEC_C__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEC_C", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SEC_C", "PREMIUM");
...
function DoLogic(isOnLoad) {
    onValidate_SEC_C__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_SEC_C__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_SEC_C__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_SEC_C__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="ida02846e97d0c4cf6a137fa974fbb820b" class="general-layout-container">
...
<div id="id6da34625d3c444deabe715003adca313" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SEC_C" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-SEC_C-ENDORSE_ID">
		<asp:Label ID="lblSEC_C_ENDORSE_ID" runat="server" AssociatedControlID="SEC_C__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="SEC_C__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valSEC_C_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_SEC_C__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-SEC_C-ENDORSE_DESC">
		<asp:Label ID="lblSEC_C_ENDORSE_DESC" runat="server" AssociatedControlID="SEC_C__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="SEC_C__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_SEC_C__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valSEC_C_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_SEC_C__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SEC_C-ENDORSE_CAP">

		
		<asp:Label ID="lblSEC_C_ENDORSE_CAP" runat="server" AssociatedControlID="SEC_C__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SEC_C__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSEC_C_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_SEC_C__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SEC_C-PREMIUM">
		<asp:Label ID="lblSEC_C_PREMIUM" runat="server" AssociatedControlID="SEC_C__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SEC_C__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSEC_C_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SEC_C__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6da34625d3c444deabe715003adca313 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6da34625d3c444deabe715003adca313 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6da34625d3c444deabe715003adca313 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6da34625d3c444deabe715003adca313 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6da34625d3c444deabe715003adca313 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6da34625d3c444deabe715003adca313 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6da34625d3c444deabe715003adca313 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6da34625d3c444deabe715003adca313 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6da34625d3c444deabe715003adca313 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6da34625d3c444deabe715003adca313 input{text-align:left;}"; break;
		}
	}
