...
Namespace Nexus
    Partial Class PB2_MMMNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_MMM_CNOTE_DETAILS__Note_Details()
...
Protected Sub CallRuleScripts()
    onValidate_MMM_CNOTE_DETAILS__Note_Details()
End Sub
