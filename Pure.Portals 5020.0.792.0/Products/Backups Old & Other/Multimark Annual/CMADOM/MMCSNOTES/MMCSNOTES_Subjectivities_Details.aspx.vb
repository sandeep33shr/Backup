...
Namespace Nexus
    Partial Class PB2_MMCSNOTES_Subjectivities_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_MMC_EXT_DETAILS__Note_Details()
...
Protected Sub CallRuleScripts()
    onValidate_MMC_EXT_DETAILS__Note_Details()
End Sub
