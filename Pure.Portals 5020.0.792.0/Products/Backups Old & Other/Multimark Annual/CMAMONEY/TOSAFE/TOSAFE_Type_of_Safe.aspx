<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TOSAFE_Type_of_Safe.aspx.vb" Inherits="Nexus.PB2_TOSAFE_Type_of_Safe" %>
...
function onValidate_SAFE__DESCRIPT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SAFE", "DESCRIPT", "Text");
        })();
}
function onValidate_SAFE__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SAFE", "SUMINSURED", "Currency");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_SAFE__DESCRIPT(null, null, null, isOnLoad);
    onValidate_SAFE__SUMINSURED(null, null, null, isOnLoad);
}
</script>
...
<div id="idfd19153ddef142f185b154ddb1e9ed5a" class="general-layout-container">
...
<div id="id05f238a0f3a64d1e9e2cf5851c63f90b" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading1" runat="server" Text="Type of Safe" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SAFE" 
		data-property-name="DESCRIPT" 
		 
		
		 
		id="pb-container-text-SAFE-DESCRIPT">

		
		<asp:Label ID="lblSAFE_DESCRIPT" runat="server" AssociatedControlID="SAFE__DESCRIPT" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SAFE__DESCRIPT" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSAFE_DESCRIPT" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SAFE__DESCRIPT"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SAFE-SUMINSURED">
		<asp:Label ID="lblSAFE_SUMINSURED" runat="server" AssociatedControlID="SAFE__SUMINSURED" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SAFE__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSAFE_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_SAFE__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id05f238a0f3a64d1e9e2cf5851c63f90b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id05f238a0f3a64d1e9e2cf5851c63f90b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id05f238a0f3a64d1e9e2cf5851c63f90b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id05f238a0f3a64d1e9e2cf5851c63f90b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id05f238a0f3a64d1e9e2cf5851c63f90b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id05f238a0f3a64d1e9e2cf5851c63f90b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id05f238a0f3a64d1e9e2cf5851c63f90b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id05f238a0f3a64d1e9e2cf5851c63f90b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id05f238a0f3a64d1e9e2cf5851c63f90b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id05f238a0f3a64d1e9e2cf5851c63f90b input{text-align:left;}"; break;
		}
	}
