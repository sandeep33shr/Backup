<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CWIENDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CWIENDOS_Endorsement_Premium" %>
...
function onValidate_GPA_ENDOSES__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSES", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GPA_ENDOSES", "ENDORSE_ID");
        		}
...
function onValidate_GPA_ENDOSES__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSES", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GPA_ENDOSES", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPA_ENDOSES.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "GPA_ENDOSES", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGPA_ENDOSES_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_GPA_ENDOSES__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GPA_ENDOSES__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_GPA_ENDOSES__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSES", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GPA_ENDOSES", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPA_ENDOSES.ENDORSE_CAP");
        			window.setControlWidth(field, "0.4", "GPA_ENDOSES", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGPA_ENDOSES_ENDORSE_CAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_GPA_ENDOSES__ENDORSE_CAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GPA_ENDOSES__ENDORSE_CAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GPA_ENDOSES&propertyName=ENDORSE_CAP&name={name}");
...
function onValidate_GPA_ENDOSES__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPA_ENDOSES", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GPA_ENDOSES", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPA_ENDOSES.PREMIUM");
        			window.setControlWidth(field, "0.4", "GPA_ENDOSES", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGPA_ENDOSES_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_GPA_ENDOSES__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GPA_ENDOSES__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_GPA_ENDOSES__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_GPA_ENDOSES__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_GPA_ENDOSES__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_GPA_ENDOSES__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id1bbf2e463387466b9257c941ac6035a6" class="general-layout-container">
...
<div id="id0cfd12b95ab844ff96a0a86155da9172" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GPA_ENDOSES" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-GPA_ENDOSES-ENDORSE_ID">
		<asp:Label ID="lblGPA_ENDOSES_ENDORSE_ID" runat="server" AssociatedControlID="GPA_ENDOSES__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="GPA_ENDOSES__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valGPA_ENDOSES_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_GPA_ENDOSES__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-GPA_ENDOSES-ENDORSE_DESC">
		<asp:Label ID="lblGPA_ENDOSES_ENDORSE_DESC" runat="server" AssociatedControlID="GPA_ENDOSES__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="GPA_ENDOSES__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_GPA_ENDOSES__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valGPA_ENDOSES_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_GPA_ENDOSES__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPA_ENDOSES-ENDORSE_CAP">

		
		<asp:Label ID="lblGPA_ENDOSES_ENDORSE_CAP" runat="server" AssociatedControlID="GPA_ENDOSES__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPA_ENDOSES__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPA_ENDOSES_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_GPA_ENDOSES__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-GPA_ENDOSES-PREMIUM">
		<asp:Label ID="lblGPA_ENDOSES_PREMIUM" runat="server" AssociatedControlID="GPA_ENDOSES__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GPA_ENDOSES__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGPA_ENDOSES_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_GPA_ENDOSES__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0cfd12b95ab844ff96a0a86155da9172 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0cfd12b95ab844ff96a0a86155da9172 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0cfd12b95ab844ff96a0a86155da9172 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0cfd12b95ab844ff96a0a86155da9172 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0cfd12b95ab844ff96a0a86155da9172 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0cfd12b95ab844ff96a0a86155da9172 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0cfd12b95ab844ff96a0a86155da9172 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0cfd12b95ab844ff96a0a86155da9172 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0cfd12b95ab844ff96a0a86155da9172 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0cfd12b95ab844ff96a0a86155da9172 input{text-align:left;}"; break;
		}
	}
