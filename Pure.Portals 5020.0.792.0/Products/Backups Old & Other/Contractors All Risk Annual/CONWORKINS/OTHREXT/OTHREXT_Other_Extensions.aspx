        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDEXT.DESCRIPTION");
        			window.setControlWidth(field, "0.5", "CONADDEXT", "DESCRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDEXT.LOL");
        			window.setControlWidth(field, "0.5", "CONADDEXT", "LOL");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please Enter Other Extensions Lol")) ? "Please Enter Other Extensions Lol" : null;
        			args.IsValid = false;
        			if (message != null){
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDEXT.RATE");
        			window.setControlWidth(field, "0.5", "CONADDEXT", "RATE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDEXT.PREMIUM");
        			window.setControlWidth(field, "0.5", "CONADDEXT", "PREMIUM");
        		})();
        	}
        })();
        /**
...
<div id="idbf898156868e4b9dafc8a3d71c0f6368" class="general-layout-container">
...
<div id="id9463be1493b74f8188842cb60a1b979d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading39" runat="server" Text="Other Extensions" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9463be1493b74f8188842cb60a1b979d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9463be1493b74f8188842cb60a1b979d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9463be1493b74f8188842cb60a1b979d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9463be1493b74f8188842cb60a1b979d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9463be1493b74f8188842cb60a1b979d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9463be1493b74f8188842cb60a1b979d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9463be1493b74f8188842cb60a1b979d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9463be1493b74f8188842cb60a1b979d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9463be1493b74f8188842cb60a1b979d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9463be1493b74f8188842cb60a1b979d input{text-align:left;}"; break;
		}
	}
