        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDDED.DESCRIPTION");
        			window.setControlWidth(field, "0.5", "CONADDDED", "DESCRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDDED.DED1");
        			window.setControlWidth(field, "0.5", "CONADDDED", "DED1");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDDED.MINAMT1");
        			window.setControlWidth(field, "0.5", "CONADDDED", "MINAMT1");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDDED.MAXAMT1");
        			window.setControlWidth(field, "0.5", "CONADDDED", "MAXAMT1");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONADDDED.BASISDED1");
        			window.setControlWidth(field, "0.5", "CONADDDED", "BASISDED1");
        		})();
        	}
        })();
...
<div id="id5dc8f7aa498e40c1a621d0d9893654ae" class="general-layout-container">
...
<div id="id32d5832f80c741d8b26cadeb1b2d6f04" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading40" runat="server" Text="Additional Deductibles Details" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id32d5832f80c741d8b26cadeb1b2d6f04 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id32d5832f80c741d8b26cadeb1b2d6f04 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id32d5832f80c741d8b26cadeb1b2d6f04 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id32d5832f80c741d8b26cadeb1b2d6f04 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id32d5832f80c741d8b26cadeb1b2d6f04 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id32d5832f80c741d8b26cadeb1b2d6f04 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id32d5832f80c741d8b26cadeb1b2d6f04 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id32d5832f80c741d8b26cadeb1b2d6f04 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id32d5832f80c741d8b26cadeb1b2d6f04 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id32d5832f80c741d8b26cadeb1b2d6f04 input{text-align:left;}"; break;
		}
	}
