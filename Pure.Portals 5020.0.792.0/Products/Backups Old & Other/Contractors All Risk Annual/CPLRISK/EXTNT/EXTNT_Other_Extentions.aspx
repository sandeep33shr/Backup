<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EXTNT_Other_Extentions.aspx.vb" Inherits="Nexus.PB2_EXTNT_Other_Extentions" %>
...
function onValidate_CPLIABILITY__EXTDESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLIABILITY", "EXTDESC", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLIABILITY", "EXTDESC");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLIABILITY.EXTDESC");
        			window.setControlWidth(field, "0.5", "CPLIABILITY", "EXTDESC");
        		})();
        	}
        })();
...
function onValidate_CPLIABILITY__SLIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLIABILITY", "SLIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLIABILITY", "SLIMIT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLIABILITY.SLIMIT");
        			window.setControlWidth(field, "0.5", "CPLIABILITY", "SLIMIT");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CPLIABILITY.EXTPREMIUM.setValue(CPLIABILITY.SLIMIT * CPLIABILITY.EXTRATE * 0.01)");
...
function onValidate_CPLIABILITY__EXTRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLIABILITY", "EXTRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLIABILITY", "EXTRATE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLIABILITY.EXTRATE");
        			window.setControlWidth(field, "0.5", "CPLIABILITY", "EXTRATE");
        		})();
        	}
        })();
...
function onValidate_CPLIABILITY__EXTPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLIABILITY", "EXTPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPLIABILITY", "EXTPREMIUM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLIABILITY.EXTPREMIUM");
        			window.setControlWidth(field, "0.5", "CPLIABILITY", "EXTPREMIUM");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CPLIABILITY.EXTRATE.setValue(CPLIABILITY.EXTPREMIUM/CPLIABILITY.SLIMIT*100)");
        		var whenExp = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function DoLogic(isOnLoad) {
    onValidate_CPLIABILITY__EXTDESC(null, null, null, isOnLoad);
    onValidate_CPLIABILITY__SLIMIT(null, null, null, isOnLoad);
    onValidate_CPLIABILITY__EXTRATE(null, null, null, isOnLoad);
    onValidate_CPLIABILITY__EXTPREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idb385276a3dd04bc2aad26fdf893e3655" class="general-layout-container">
...
<div id="idd52ae45f6f5f45129a1507f2d1b640b7" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CPLIABILITY-EXTDESC">

		
		<asp:Label ID="lblCPLIABILITY_EXTDESC" runat="server" AssociatedControlID="CPLIABILITY__EXTDESC" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CPLIABILITY__EXTDESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCPLIABILITY_EXTDESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CPLIABILITY__EXTDESC"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CPLIABILITY-SLIMIT">
		<asp:Label ID="lblCPLIABILITY_SLIMIT" runat="server" AssociatedControlID="CPLIABILITY__SLIMIT" 
			Text="Sum Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CPLIABILITY__SLIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCPLIABILITY_SLIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sum Insured"
			ClientValidationFunction="onValidate_CPLIABILITY__SLIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CPLIABILITY-EXTRATE">
		<asp:Label ID="lblCPLIABILITY_EXTRATE" runat="server" AssociatedControlID="CPLIABILITY__EXTRATE" 
			Text="Rate % " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CPLIABILITY__EXTRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCPLIABILITY_EXTRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate % "
			ClientValidationFunction="onValidate_CPLIABILITY__EXTRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CPLIABILITY-EXTPREMIUM">
		<asp:Label ID="lblCPLIABILITY_EXTPREMIUM" runat="server" AssociatedControlID="CPLIABILITY__EXTPREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CPLIABILITY__EXTPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCPLIABILITY_EXTPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CPLIABILITY__EXTPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd52ae45f6f5f45129a1507f2d1b640b7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd52ae45f6f5f45129a1507f2d1b640b7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd52ae45f6f5f45129a1507f2d1b640b7 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd52ae45f6f5f45129a1507f2d1b640b7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd52ae45f6f5f45129a1507f2d1b640b7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd52ae45f6f5f45129a1507f2d1b640b7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd52ae45f6f5f45129a1507f2d1b640b7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd52ae45f6f5f45129a1507f2d1b640b7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd52ae45f6f5f45129a1507f2d1b640b7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd52ae45f6f5f45129a1507f2d1b640b7 input{text-align:left;}"; break;
		}
	}
