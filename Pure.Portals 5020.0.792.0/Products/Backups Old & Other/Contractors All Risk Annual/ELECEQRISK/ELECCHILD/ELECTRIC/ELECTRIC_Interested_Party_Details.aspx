<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ELECTRIC_Interested_Party_Details.aspx.vb" Inherits="Nexus.PB2_ELECTRIC_Interested_Party_Details" %>
...
function onValidate_ELECTRICE__P_NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTRICE", "P_NAME", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ELECTRICE", "P_NAME");
        		var errorMessage = "Interested Party Name is mandatory and must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ELECTRICE.P_NAME");
        			window.setControlWidth(field, "0.8", "ELECTRICE", "P_NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblELECTRICE_P_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_ELECTRICE__P_NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ELECTRICE__P_NAME_lblFindParty");
        			    }
        			}
...
function onValidate_ELECTRICE__AMOUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTRICE", "AMOUNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ELECTRICE", "AMOUNT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ELECTRICE.AMOUNT");
        			window.setControlWidth(field, "0.8", "ELECTRICE", "AMOUNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblELECTRICE_AMOUNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_ELECTRICE__AMOUNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ELECTRICE__AMOUNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Amount must be 0 or greater")) ? "Amount must be 0 or greater" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ELECTRICE".toUpperCase() + "__" + "AMOUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ELECTRICE".toUpperCase() + "_" + "AMOUNT");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("ELECTRICE.AMOUNT >= 0 || ELECTRICE.FAP == 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    onValidate_ELECTRICE__P_NAME(null, null, null, isOnLoad);
    onValidate_ELECTRICE__AMOUNT(null, null, null, isOnLoad);
}
</script>
...
<div id="ide10d19747e0943cc9a2b82e2f88f8f8f" class="general-layout-container">
...
<div id="INTRSTPART" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="Interested Parties" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ELECTRICE" 
		data-property-name="P_NAME" 
		 
		
		 
		id="pb-container-text-ELECTRICE-P_NAME">

		
		<asp:Label ID="lblELECTRICE_P_NAME" runat="server" AssociatedControlID="ELECTRICE__P_NAME" 
			Text="Interested Party Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ELECTRICE__P_NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valELECTRICE_P_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Interested Party Name"
					ClientValidationFunction="onValidate_ELECTRICE__P_NAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ELECTRICE-AMOUNT">
		<asp:Label ID="lblELECTRICE_AMOUNT" runat="server" AssociatedControlID="ELECTRICE__AMOUNT" 
			Text="Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ELECTRICE__AMOUNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valELECTRICE_AMOUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Amount"
			ClientValidationFunction="onValidate_ELECTRICE__AMOUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
