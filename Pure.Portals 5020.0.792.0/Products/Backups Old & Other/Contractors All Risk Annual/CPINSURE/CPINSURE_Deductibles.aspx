...
function onValidate_AGGRE__AGGDEDUCT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AGGRE.AGGDEDUCT");
        			window.setControlWidth(field, "0.8", "AGGRE", "AGGDEDUCT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_AGGRE__AGGDEDUCT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AGGRE__AGGDEDUCT_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("AGGRE.DEDUCTFUND");
        			window.setControlWidth(field, "0.8", "AGGRE", "DEDUCTFUND");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("AGGRE.STOPLOSS");
        			window.setControlWidth(field, "0.8", "AGGRE", "STOPLOSS");
        		})();
        	}
        })();
        /**
...
<div id="id9f423f27d7ea45fe9bc47a2e7f6b2987" class="general-layout-container">
...
<div id="id45348516184845be8d8d308eaff4d9ef" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id45348516184845be8d8d308eaff4d9ef div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id45348516184845be8d8d308eaff4d9ef div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id45348516184845be8d8d308eaff4d9ef div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id45348516184845be8d8d308eaff4d9ef label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id45348516184845be8d8d308eaff4d9ef label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id45348516184845be8d8d308eaff4d9ef label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id45348516184845be8d8d308eaff4d9ef label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id45348516184845be8d8d308eaff4d9ef input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id45348516184845be8d8d308eaff4d9ef input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id45348516184845be8d8d308eaff4d9ef input{text-align:left;}"; break;
		}
	}
