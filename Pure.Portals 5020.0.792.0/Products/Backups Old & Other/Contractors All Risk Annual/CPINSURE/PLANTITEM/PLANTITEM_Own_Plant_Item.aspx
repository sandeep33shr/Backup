...
function onValidate_PLANTDET__PLANTYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Type of Plant is mandatory and an option must be selected";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.SERIAL_NUM");
        			window.setControlWidth(field, "0.8", "PLANTDET", "SERIAL_NUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__SERIAL_NUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__SERIAL_NUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PLANTDET__OCCU_LIMIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Any One Occurrence Limit must be 0 or greater")) ? "Any One Occurrence Limit must be 0 or greater" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_PLANTDET__MAX_ITEM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_GROUPED==true", "V", "Maximum Item Limit is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_GROUPED==true",
            paramElseValue = "V",
            paramValidationMessage = "Maximum Item Limit is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__IS_MAN_APP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__IS_MAN_APP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.IS_MAN_APP");
        			window.setControlWidth(field, "0.8", "PLANTDET", "IS_MAN_APP");
        		})();
        	}
        })();
}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__IS_ROAD_LIA');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__IS_ROAD_LIA_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PLANTDET__LIMIT_OF_RL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_ROAD_LIA == true", "R", "Road Liability Limit of Liability is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_ROAD_LIA == true",
            paramElseValue = "R",
            paramValidationMessage = "Road Liability Limit of Liability is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__LIMIT_OF_RL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__LIMIT_OF_RL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.LIMIT_OF_RL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "LIMIT_OF_RL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__RATE_RL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__RATE_RL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.RATE_RL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "RATE_RL");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANTDET__PREMIUM_RL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_ROAD_LIA == true", "R", "Road Liability Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_ROAD_LIA == true",
            paramElseValue = "R",
            paramValidationMessage = "Road Liability Premium is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__PREMIUM_RL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__PREMIUM_RL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.PREMIUM_RL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "PREMIUM_RL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__MIN_DEDU_RL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__MIN_DEDU_RL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.MIN_DEDU_RL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "MIN_DEDU_RL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__MAX_DEDU_RL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__MAX_DEDU_RL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.MAX_DEDU_RL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "MAX_DEDU_RL");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANTDET__DEDU_MIN_RL(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__DEDU_MIN_RL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__DEDU_MIN_RL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.DEDU_MIN_RL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "DEDU_MIN_RL");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Road Liability Deductible Min Amount must be 0 or greater")) ? "Road Liability Deductible Min Amount must be 0 or greater" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_PLANTDET__DEDU_MAX_RL(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__DEDU_MAX_RL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__DEDU_MAX_RL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.DEDU_MAX_RL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "DEDU_MAX_RL");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Road Liability Deductible Max Amount must be less than the Road Liability Limit of Liability")) ? "Road Liability Deductible Max Amount must be less than the Road Liability Limit of Liability" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "PLANTDET".toUpperCase() + "__" + "DEDU_MAX_RL");
        				if (node == null){
        		...
        		var exp;
        		try {
        			exp = new Expression("PLANTDET.DEDU_MAX_RL < PLANTDET.LIMIT_OF_RL || PLANTDET.IS_ROAD_LIA == 0 || (PLANTDET.DEDU_MIN_RL == null && PLANTDET.DEDU_MAX_RL ==null) || (PLANTDET.DEDU_MIN_RL == 0 && PLANTDET.DEDU_MAX_RL == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_PLANTDET__BASIS_DED_RL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_ROAD_LIA == true", "R", "Road Liability Basis of Deductible is mandatory and an option must be selected");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_ROAD_LIA == true",
            paramElseValue = "R",
            paramValidationMessage = "Road Liability Basis of Deductible is mandatory and an option must be selected";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__BASIS_DED_RL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__BASIS_DED_RL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.BASIS_DED_RL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "BASIS_DED_RL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__IS_SITE_LIA');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__IS_SITE_LIA_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PLANTDET__LIMIT_OF_SL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_SITE_LIA == true", "R", "Site Liability Limit of Liability is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_SITE_LIA == true",
            paramElseValue = "R",
            paramValidationMessage = "Site Liability Limit of Liability is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__LIMIT_OF_SL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__LIMIT_OF_SL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.LIMIT_OF_SL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "LIMIT_OF_SL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__RATE_SL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__RATE_SL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.RATE_SL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "RATE_SL");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANTDET__PREMIUM_SL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_SITE_LIA == true", "R", "Site Liability Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_SITE_LIA == true",
            paramElseValue = "R",
            paramValidationMessage = "Site Liability Premium is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__PREMIUM_SL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__PREMIUM_SL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.PREMIUM_SL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "PREMIUM_SL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__MIN_DEDU_SL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__MIN_DEDU_SL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.MIN_DEDU_SL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "MIN_DEDU_SL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__MAX_DEDU_SL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__MAX_DEDU_SL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.MAX_DEDU_SL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "MAX_DEDU_SL");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANTDET__DEDU_MIN_SL(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__DEDU_MIN_SL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__DEDU_MIN_SL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.DEDU_MIN_SL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "DEDU_MIN_SL");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Site Liability Deductible Min Amount must be 0 or greater")) ? "Site Liability Deductible Min Amount must be 0 or greater" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_PLANTDET__DEDU_MAX_SL(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__DEDU_MAX_SL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__DEDU_MAX_SL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.DEDU_MAX_SL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "DEDU_MAX_SL");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("PLANTDET.DEDU_MAX_SL < PLANTDET.LIMIT_OF_SL || PLANTDET.IS_SITE_LIA == 0 || (PLANTDET.DEDU_MAX_SL == null && PLANTDET.DEDU_MIN_SL == null) || (PLANTDET.DEDU_MAX_SL == 0 && PLANTDET.DEDU_MIN_SL == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_PLANTDET__BASIS_DED_SL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_SITE_LIA == true", "R", "Site Liability Basis of Deductible is mandatory and an option must be selected");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_SITE_LIA == true",
            paramElseValue = "R",
            paramValidationMessage = "Site Liability Basis of Deductible is mandatory and an option must be selected";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__BASIS_DED_SL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__BASIS_DED_SL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.BASIS_DED_SL");
        			window.setControlWidth(field, "0.8", "PLANTDET", "BASIS_DED_SL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__IS_WINDSCR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__IS_WINDSCR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PLANTDET__LIMIT_OF_WSC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_WINDSCR == true", "R", "Windscreen Limit of Liability is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_WINDSCR == true",
            paramElseValue = "R",
            paramValidationMessage = "Windscreen Limit of Liability is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__LIMIT_OF_WSC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__LIMIT_OF_WSC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.LIMIT_OF_WSC");
        			window.setControlWidth(field, "0.8", "PLANTDET", "LIMIT_OF_WSC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__RATE_WSC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__RATE_WSC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.RATE_WSC");
        			window.setControlWidth(field, "0.8", "PLANTDET", "RATE_WSC");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANTDET__PREMIUM_WSC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_WINDSCR == true", "R", "Windscreen Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_WINDSCR == true",
            paramElseValue = "R",
            paramValidationMessage = "Windscreen Premium is mandatory and an amount must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__PREMIUM_WSC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__PREMIUM_WSC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.PREMIUM_WSC");
        			window.setControlWidth(field, "0.8", "PLANTDET", "PREMIUM_WSC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__MIN_DEDU_WSC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__MIN_DEDU_WSC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.MIN_DEDU_WSC");
        			window.setControlWidth(field, "0.8", "PLANTDET", "MIN_DEDU_WSC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__MAX_DEDU_WSC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__MAX_DEDU_WSC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.MAX_DEDU_WSC");
        			window.setControlWidth(field, "0.8", "PLANTDET", "MAX_DEDU_WSC");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANTDET__DEDU_MIN_WSC(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__DEDU_MIN_WSC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__DEDU_MIN_WSC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.DEDU_MIN_WSC");
        			window.setControlWidth(field, "0.8", "PLANTDET", "DEDU_MIN_WSC");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Windscreen Deductible Min Amount must be 0 or greater")) ? "Windscreen Deductible Min Amount must be 0 or greater" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_PLANTDET__DEDU_MAX_WSC(source, args, sender, isOnLoad) {
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__DEDU_MAX_WSC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__DEDU_MAX_WSC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.DEDU_MAX_WSC");
        			window.setControlWidth(field, "0.8", "PLANTDET", "DEDU_MAX_WSC");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var exp;
        		try {
        			exp = new Expression("PLANTDET.DEDU_MAX_WSC < PLANTDET.LIMIT_OF_WSC || PLANTDET.IS_WINDSCR == 0  || (PLANTDET.DEDU_MAX_WSC == null && PLANTDET.DEDU_MIN_WSC == null) || (PLANTDET.DEDU_MAX_WSC == 0 && PLANTDET.DEDU_MIN_WSC == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_PLANTDET__BASIS_DED_WSC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "PLANTDET.IS_WINDSCR == true", "R", "Windscreen Basis of Deductible is mandatory and an option must be selected");
        
            var paramValue = "VEM",
            paramCondition = "PLANTDET.IS_WINDSCR == true",
            paramElseValue = "R",
            paramValidationMessage = "Windscreen Basis of Deductible is mandatory and an option must be selected";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var ele = document.getElementById('ctl00_cntMainBody_PLANTDET__BASIS_DED_WSC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PLANTDET__BASIS_DED_WSC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANTDET.BASIS_DED_WSC");
        			window.setControlWidth(field, "0.8", "PLANTDET", "BASIS_DED_WSC");
        		})();
        	}
        })();
        /**
...
<div id="id50373a0bffa54036b002e84eddef233e" class="general-layout-container">
...
<div id="idbd99d548c45b4455ab6d73314020932c" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idbd99d548c45b4455ab6d73314020932c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbd99d548c45b4455ab6d73314020932c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbd99d548c45b4455ab6d73314020932c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idbd99d548c45b4455ab6d73314020932c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbd99d548c45b4455ab6d73314020932c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbd99d548c45b4455ab6d73314020932c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbd99d548c45b4455ab6d73314020932c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbd99d548c45b4455ab6d73314020932c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbd99d548c45b4455ab6d73314020932c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbd99d548c45b4455ab6d73314020932c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="PlantItem" class="column-layout-container,no-border  ">
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="nonValBand" class="column-layout-container,no-border  ">
...
<Nexus:RiskAttribute HeaderText="Minimum %" DataField="MINIMUM" DataFormatString="{0:0}%"/>
...
<Nexus:RiskAttribute HeaderText="Maximum %" DataField="MAXIMUM" DataFormatString="{0:0}%"/>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="valBand" class="column-layout-container,no-border  ">
