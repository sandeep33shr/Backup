<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPLEXTNT_Extensions.aspx.vb" Inherits="Nexus.PB2_CPLEXTNT_Extensions" %>
...
function onValidate_CPLLIABEXT__EXTDESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLLIABEXT", "EXTDESC", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CPLLIABEXT", "EXTDESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLLIABEXT.EXTDESC");
        			window.setControlWidth(field, "0.8", "CPLLIABEXT", "EXTDESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPLLIABEXT_EXTDESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPLLIABEXT__EXTDESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPLLIABEXT__EXTDESC_lblFindParty");
        			    }
        			}
...
function onValidate_CPLLIABEXT__SLIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLLIABEXT", "SLIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CPLLIABEXT", "SLIMIT");
        		var errorMessage = "SI/Limit is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLLIABEXT.SLIMIT");
        			window.setControlWidth(field, "0.8", "CPLLIABEXT", "SLIMIT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPLLIABEXT_SLIMIT");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPLLIABEXT__SLIMIT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPLLIABEXT__SLIMIT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("SI/Limit must be greater than 0")) ? "SI/Limit must be greater than 0" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CPLLIABEXT".toUpperCase() + "__" + "SLIMIT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CPLLIABEXT".toUpperCase() + "_" + "SLIMIT");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("CPLLIABEXT.SLIMIT > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CPLLIABEXT__EXTRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLLIABEXT", "EXTRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=CPLLIABEXT&propertyName=EXTRATE&name={name}");
        		
        		var value = new Expression("(CPLLIABEXT.EXTPREMIUM/CPLLIABEXT.SLIMIT)*100"), 
        			condition = (Expression.isValidParameter("CPLLIABEXT.SLIMIT>0&&CPLLIABEXT.EXTPREMIUM>0")) ? new Expression("CPLLIABEXT.SLIMIT>0&&CPLLIABEXT.EXTPREMIUM>0") : null, 
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CPLLIABEXT", "EXTRATE");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLLIABEXT.EXTRATE");
        			window.setControlWidth(field, "0.8", "CPLLIABEXT", "EXTRATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPLLIABEXT_EXTRATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPLLIABEXT__EXTRATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPLLIABEXT__EXTRATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CPLLIABEXT".toUpperCase() + "__" + "EXTRATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CPLLIABEXT".toUpperCase() + "_" + "EXTRATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("CPLLIABEXT.EXTRATE > 0 && CPLLIABEXT.EXTRATE <= 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CPLLIABEXT__EXTPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLLIABEXT", "EXTPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CPLLIABEXT&propertyName=EXTPREMIUM&name={name}");
        		
        		var value = new Expression("(CPLLIABEXT.SLIMIT*CPLLIABEXT.EXTRATE)*0.01"), 
        			condition = (Expression.isValidParameter("CPLLIABEXT.SLIMIT>0&&CPLLIABEXT.EXTRATE>0")) ? new Expression("CPLLIABEXT.SLIMIT>0&&CPLLIABEXT.EXTRATE>0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CPLLIABEXT", "EXTPREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPLLIABEXT.EXTPREMIUM");
        			window.setControlWidth(field, "0.8", "CPLLIABEXT", "EXTPREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCPLLIABEXT_EXTPREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CPLLIABEXT__EXTPREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CPLLIABEXT__EXTPREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CPLLIABEXT".toUpperCase() + "__" + "EXTPREMIUM");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CPLLIABEXT".toUpperCase() + "_" + "EXTPREMIUM");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("CPLLIABEXT.EXTPREMIUM > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    onValidate_CPLLIABEXT__EXTDESC(null, null, null, isOnLoad);
    onValidate_CPLLIABEXT__SLIMIT(null, null, null, isOnLoad);
    onValidate_CPLLIABEXT__EXTRATE(null, null, null, isOnLoad);
    onValidate_CPLLIABEXT__EXTPREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id08a12f8bdd4a45e3a3e241edcdc98eb4" class="general-layout-container">
...
<div id="id6501e46c9b94495e93e29d1a08876f4c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Extensions Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CPLLIABEXT" 
		data-property-name="EXTDESC" 
		 
		
		 
		id="pb-container-text-CPLLIABEXT-EXTDESC">

		
		<asp:Label ID="lblCPLLIABEXT_EXTDESC" runat="server" AssociatedControlID="CPLLIABEXT__EXTDESC" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CPLLIABEXT__EXTDESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCPLLIABEXT_EXTDESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CPLLIABEXT__EXTDESC"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CPLLIABEXT" 
		data-property-name="SLIMIT" 
		id="pb-container-currency-CPLLIABEXT-SLIMIT">
		<asp:Label ID="lblCPLLIABEXT_SLIMIT" runat="server" AssociatedControlID="CPLLIABEXT__SLIMIT" 
			Text="SI/Limit" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CPLLIABEXT__SLIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCPLLIABEXT_SLIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SI/Limit"
			ClientValidationFunction="onValidate_CPLLIABEXT__SLIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CPLLIABEXT" 
		data-property-name="EXTRATE" 
		id="pb-container-percentage-CPLLIABEXT-EXTRATE">
		<asp:Label ID="lblCPLLIABEXT_EXTRATE" runat="server" AssociatedControlID="CPLLIABEXT__EXTRATE" 
			Text="Rate % " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CPLLIABEXT__EXTRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCPLLIABEXT_EXTRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate % "
			ClientValidationFunction="onValidate_CPLLIABEXT__EXTRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CPLLIABEXT" 
		data-property-name="EXTPREMIUM" 
		id="pb-container-currency-CPLLIABEXT-EXTPREMIUM">
		<asp:Label ID="lblCPLLIABEXT_EXTPREMIUM" runat="server" AssociatedControlID="CPLLIABEXT__EXTPREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CPLLIABEXT__EXTPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCPLLIABEXT_EXTPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CPLLIABEXT__EXTPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6501e46c9b94495e93e29d1a08876f4c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6501e46c9b94495e93e29d1a08876f4c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6501e46c9b94495e93e29d1a08876f4c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6501e46c9b94495e93e29d1a08876f4c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6501e46c9b94495e93e29d1a08876f4c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6501e46c9b94495e93e29d1a08876f4c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6501e46c9b94495e93e29d1a08876f4c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6501e46c9b94495e93e29d1a08876f4c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6501e46c9b94495e93e29d1a08876f4c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6501e46c9b94495e93e29d1a08876f4c input{text-align:left;}"; break;
		}
	}
