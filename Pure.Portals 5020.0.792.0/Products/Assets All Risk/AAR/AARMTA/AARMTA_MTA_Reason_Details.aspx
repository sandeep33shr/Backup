<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="AARMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_AARMTA_MTA_Reason_Details" %>
...
function onValidate_MTA_REASON__MTA_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MTA_REASON.MTA_DESCRIPTION");
        			window.setControlWidth(field, "yes", "MTA_REASON", "MTA_DESCRIPTION");
        		})();
        	}
        })();
...
<div id="id162dbb63421d40a79e5cafee216c12e7" class="general-layout-container">
...
<div id="idf0cf4ee725294ad18ccee81bef7fdba0" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf0cf4ee725294ad18ccee81bef7fdba0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf0cf4ee725294ad18ccee81bef7fdba0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf0cf4ee725294ad18ccee81bef7fdba0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf0cf4ee725294ad18ccee81bef7fdba0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf0cf4ee725294ad18ccee81bef7fdba0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf0cf4ee725294ad18ccee81bef7fdba0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf0cf4ee725294ad18ccee81bef7fdba0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf0cf4ee725294ad18ccee81bef7fdba0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf0cf4ee725294ad18ccee81bef7fdba0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf0cf4ee725294ad18ccee81bef7fdba0 input{text-align:left;}"; break;
		}
	}
