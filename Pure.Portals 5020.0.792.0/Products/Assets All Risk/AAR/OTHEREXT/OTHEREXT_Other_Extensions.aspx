<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OTHEREXT_Other_Extensions.aspx.vb" Inherits="Nexus.PB2_OTHEREXT_Other_Extensions" %>
...
function onValidate_OTH_EXT__DESCRIP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_EXT", "DESCRIP", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OTH_EXT", "DESCRIP");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblOTH_EXT_DESCRIP");
        			    var ele = document.getElementById('ctl00_cntMainBody_OTH_EXT__DESCRIP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OTH_EXT__DESCRIP_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OTH_EXT.DESCRIP");
        			window.setControlWidth(field, "0.8", "OTH_EXT", "DESCRIP");
        		})();
        	}
        })();
...
function onValidate_OTH_EXT__LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_EXT", "LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OTH_EXT", "LOI");
        		var errorMessage = "Limit of Liability is mandatory and an amount must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblOTH_EXT_LOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_OTH_EXT__LOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OTH_EXT__LOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OTH_EXT.LOI");
        			window.setControlWidth(field, "0.8", "OTH_EXT", "LOI");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    onValidate_OTH_EXT__DESCRIP(null, null, null, isOnLoad);
    onValidate_OTH_EXT__LOI(null, null, null, isOnLoad);
}
</script>
...
<div id="id588bce756f5b490588f0800307a09302" class="general-layout-container">
...
<div id="id8cb74785921c484cadfc24dc0f022bf2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Other Extensions" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="OTH_EXT" 
		data-property-name="DESCRIP" 
		 
		
		 
		id="pb-container-text-OTH_EXT-DESCRIP">

		
		<asp:Label ID="lblOTH_EXT_DESCRIP" runat="server" AssociatedControlID="OTH_EXT__DESCRIP" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OTH_EXT__DESCRIP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOTH_EXT_DESCRIP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_OTH_EXT__DESCRIP"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OTH_EXT-LOI">
		<asp:Label ID="lblOTH_EXT_LOI" runat="server" AssociatedControlID="OTH_EXT__LOI" 
			Text="Limit of Liability" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_EXT__LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_EXT_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Liability"
			ClientValidationFunction="onValidate_OTH_EXT__LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8cb74785921c484cadfc24dc0f022bf2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8cb74785921c484cadfc24dc0f022bf2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8cb74785921c484cadfc24dc0f022bf2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8cb74785921c484cadfc24dc0f022bf2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8cb74785921c484cadfc24dc0f022bf2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8cb74785921c484cadfc24dc0f022bf2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8cb74785921c484cadfc24dc0f022bf2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8cb74785921c484cadfc24dc0f022bf2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8cb74785921c484cadfc24dc0f022bf2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8cb74785921c484cadfc24dc0f022bf2 input{text-align:left;}"; break;
		}
	}
