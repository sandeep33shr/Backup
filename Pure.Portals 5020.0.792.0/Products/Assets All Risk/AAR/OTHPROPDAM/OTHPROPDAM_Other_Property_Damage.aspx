<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OTHPROPDAM_Other_Property_Damage.aspx.vb" Inherits="Nexus.PB2_OTHPROPDAM_Other_Property_Damage" %>
...
function onValidate_OTH_PROP_PD__DESCRIP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_PROP_PD", "DESCRIP", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_PROP_PD", "DESCRIP");
        		}
...
function onValidate_OTH_PROP_PD__LOL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_PROP_PD", "LOL", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_PROP_PD", "LOL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_OTH_PROP_PD__DESCRIP(null, null, null, isOnLoad);
    onValidate_OTH_PROP_PD__LOL(null, null, null, isOnLoad);
}
</script>
...
<div id="idfcce7ac7a99f4aedb840d098d1d528b8" class="general-layout-container">
...
<div id="idf0e598f09b9041ed99c9c0714ef8633a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading27" runat="server" Text="Other Property Damage" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="OTH_PROP_PD" 
		data-property-name="DESCRIP" 
		 
		
		 
		id="pb-container-text-OTH_PROP_PD-DESCRIP">

		
		<asp:Label ID="lblOTH_PROP_PD_DESCRIP" runat="server" AssociatedControlID="OTH_PROP_PD__DESCRIP" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OTH_PROP_PD__DESCRIP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOTH_PROP_PD_DESCRIP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_OTH_PROP_PD__DESCRIP"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OTH_PROP_PD-LOL">
		<asp:Label ID="lblOTH_PROP_PD_LOL" runat="server" AssociatedControlID="OTH_PROP_PD__LOL" 
			Text="Limit of Liability" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_PROP_PD__LOL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_PROP_PD_LOL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Liability"
			ClientValidationFunction="onValidate_OTH_PROP_PD__LOL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf0e598f09b9041ed99c9c0714ef8633a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf0e598f09b9041ed99c9c0714ef8633a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf0e598f09b9041ed99c9c0714ef8633a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf0e598f09b9041ed99c9c0714ef8633a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf0e598f09b9041ed99c9c0714ef8633a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf0e598f09b9041ed99c9c0714ef8633a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf0e598f09b9041ed99c9c0714ef8633a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf0e598f09b9041ed99c9c0714ef8633a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf0e598f09b9041ed99c9c0714ef8633a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf0e598f09b9041ed99c9c0714ef8633a input{text-align:left;}"; break;
		}
	}
