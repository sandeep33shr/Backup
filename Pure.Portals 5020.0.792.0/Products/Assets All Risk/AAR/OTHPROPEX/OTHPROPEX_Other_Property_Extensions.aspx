<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OTHPROPEX_Other_Property_Extensions.aspx.vb" Inherits="Nexus.PB2_OTHPROPEX_Other_Property_Extensions" %>
...
function onValidate_OTH_PROP_EXT__DESCRIP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_PROP_EXT", "DESCRIP", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_PROP_EXT", "DESCRIP");
        		}
...
function onValidate_OTH_PROP_EXT__LOL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_PROP_EXT", "LOL", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_PROP_EXT", "LOL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_OTH_PROP_EXT__DESCRIP(null, null, null, isOnLoad);
    onValidate_OTH_PROP_EXT__LOL(null, null, null, isOnLoad);
}
</script>
...
<div id="idb5f0830982db4010b0e46c658241c116" class="general-layout-container">
...
<div id="idda5c86dbe96a461894baf2c1b187b222" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading29" runat="server" Text="Other Property Extensions" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="OTH_PROP_EXT" 
		data-property-name="DESCRIP" 
		 
		
		 
		id="pb-container-text-OTH_PROP_EXT-DESCRIP">

		
		<asp:Label ID="lblOTH_PROP_EXT_DESCRIP" runat="server" AssociatedControlID="OTH_PROP_EXT__DESCRIP" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OTH_PROP_EXT__DESCRIP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOTH_PROP_EXT_DESCRIP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_OTH_PROP_EXT__DESCRIP"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OTH_PROP_EXT-LOL">
		<asp:Label ID="lblOTH_PROP_EXT_LOL" runat="server" AssociatedControlID="OTH_PROP_EXT__LOL" 
			Text="Limit of Liability" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_PROP_EXT__LOL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_PROP_EXT_LOL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Liability"
			ClientValidationFunction="onValidate_OTH_PROP_EXT__LOL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idda5c86dbe96a461894baf2c1b187b222 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idda5c86dbe96a461894baf2c1b187b222 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idda5c86dbe96a461894baf2c1b187b222 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idda5c86dbe96a461894baf2c1b187b222 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idda5c86dbe96a461894baf2c1b187b222 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idda5c86dbe96a461894baf2c1b187b222 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idda5c86dbe96a461894baf2c1b187b222 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idda5c86dbe96a461894baf2c1b187b222 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idda5c86dbe96a461894baf2c1b187b222 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idda5c86dbe96a461894baf2c1b187b222 input{text-align:left;}"; break;
		}
	}
