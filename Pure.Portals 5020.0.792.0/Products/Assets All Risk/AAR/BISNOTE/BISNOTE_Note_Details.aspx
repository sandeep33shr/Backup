...
function onValidate_SECCS_DETAILS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECCS_DETAILS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECCS_DETAILS", "DATE_CREATED");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECCS_DETAILS_DATE_CREATED");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECCS_DETAILS__DATE_CREATED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECCS_DETAILS__DATE_CREATED_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECCS_DETAILS", "DATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=SECCS_DETAILS&propertyName=DATE_CREATED&name={name}");
...
function onValidate_SECCS_DETAILS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECCS_DETAILS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECCS_DETAILS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECCS_DETAILS", "CREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_SECCS_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECCS_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECCS_DETAILS", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECCS_DETAILS_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECCS_DETAILS__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECCS_DETAILS__COVER_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECCS_DETAILS", "COVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SECCS_DETAILS&propertyName=COVER_TYPE&name={name}");
...
function onValidate_SECCS_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECCS_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SECCS_DETAILS", "NOTE_DESCRIPTION");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECCS_DETAILS_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECCS_DETAILS__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECCS_DETAILS__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SECCS_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECCS_DETAILS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SECCS_DETAILS", "NOTE_DETAILS");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECCS_DETAILS_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECCS_DETAILS__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECCS_DETAILS__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=SECCS_DETAILS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_SECCS_DETAILS_NOTE_DETAILS_textarea');
        			if (textarea != null){
...
function DoLogic(isOnLoad) {
    onValidate_SECCS_DETAILS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_SECCS_DETAILS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_SECCS_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_SECCS_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SECCS_DETAILS__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id26ac1df834624548afbddce1ce957e51" class="general-layout-container">
...
<div id="ide9db4068aaea4d6b84a8eaa9d7b54104" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading84" runat="server" Text="Notes (Printed On Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SECCS_DETAILS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-SECCS_DETAILS-DATE_CREATED">
		<asp:Label ID="lblSECCS_DETAILS_DATE_CREATED" runat="server" AssociatedControlID="SECCS_DETAILS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="SECCS_DETAILS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calSECCS_DETAILS__DATE_CREATED" runat="server" LinkedControl="SECCS_DETAILS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valSECCS_DETAILS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_SECCS_DETAILS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECCS_DETAILS-CREATED_BY">

		
		<asp:Label ID="lblSECCS_DETAILS_CREATED_BY" runat="server" AssociatedControlID="SECCS_DETAILS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECCS_DETAILS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECCS_DETAILS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_SECCS_DETAILS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECCS_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblSECCS_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="SECCS_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECCS_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECCS_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_SECCS_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECCS_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblSECCS_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="SECCS_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECCS_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECCS_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_SECCS_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-SECCS_DETAILS-NOTE_DETAILS">
		<asp:Label ID="lblSECCS_DETAILS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="SECCS_DETAILS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="SECCS_DETAILS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valSECCS_DETAILS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_SECCS_DETAILS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide9db4068aaea4d6b84a8eaa9d7b54104 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide9db4068aaea4d6b84a8eaa9d7b54104 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide9db4068aaea4d6b84a8eaa9d7b54104 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide9db4068aaea4d6b84a8eaa9d7b54104 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide9db4068aaea4d6b84a8eaa9d7b54104 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide9db4068aaea4d6b84a8eaa9d7b54104 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide9db4068aaea4d6b84a8eaa9d7b54104 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide9db4068aaea4d6b84a8eaa9d7b54104 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide9db4068aaea4d6b84a8eaa9d7b54104 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide9db4068aaea4d6b84a8eaa9d7b54104 input{text-align:left;}"; break;
		}
	}
