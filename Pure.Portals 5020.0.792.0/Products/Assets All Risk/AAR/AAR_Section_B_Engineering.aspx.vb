...
Namespace Nexus
    Partial Class PB2_AAR_Section_B_Engineering : Inherits BaseRisk
		...
		Protected Sub onValidate_SECTIONB__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_SECTIONB__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_SECTIONB__ATTACHMENTDATE()
    onValidate_SECTIONB__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If SECTIONB__ATTACHMENTDATE.Text = "" or SECTIONB__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			SECTIONB__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			SECTIONB__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (SECTIONB__ATTACHMENTDATE.Text <> "" Or SECTIONB__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		SECTIONB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		SECTIONB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		SECTIONB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
