...
Namespace Nexus
    Partial Class PB2_AAR_Section_A_Property_Damage : Inherits BaseRisk
		...
		Protected Sub onValidate_SECTIONA__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_SECTIONA__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_SECTIONA__ATTACHMENTDATE()
    onValidate_SECTIONA__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If SECTIONA__ATTACHMENTDATE.Text = "" or SECTIONA__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			SECTIONA__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			SECTIONA__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (SECTIONA__ATTACHMENTDATE.Text <> "" Or SECTIONA__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		SECTIONA__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		SECTIONA__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		SECTIONA__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
