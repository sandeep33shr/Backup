<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENGOTEXT_Other_Extensions.aspx.vb" Inherits="Nexus.PB2_ENGOTEXT_Other_Extensions" %>
...
function onValidate_ENGOEXT__OGE_DES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENGOEXT", "OGE_DES", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ENGOEXT", "OGE_DES");
        		}
...
function onValidate_ENGOEXT__OGE_LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENGOEXT", "OGE_LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ENGOEXT", "OGE_LOI");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_ENGOEXT__OGE_DES(null, null, null, isOnLoad);
    onValidate_ENGOEXT__OGE_LOI(null, null, null, isOnLoad);
}
</script>
...
<div id="idc51afe628aff42c5b705d7e021622e5b" class="general-layout-container">
...
<div id="id0498afdac4cc49ba9570c2e148c1e7c4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Other Extensions" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ENGOEXT" 
		data-property-name="OGE_DES" 
		 
		
		 
		id="pb-container-text-ENGOEXT-OGE_DES">

		
		<asp:Label ID="lblENGOEXT_OGE_DES" runat="server" AssociatedControlID="ENGOEXT__OGE_DES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ENGOEXT__OGE_DES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valENGOEXT_OGE_DES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_ENGOEXT__OGE_DES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ENGOEXT" 
		data-property-name="OGE_LOI" 
		id="pb-container-currency-ENGOEXT-OGE_LOI">
		<asp:Label ID="lblENGOEXT_OGE_LOI" runat="server" AssociatedControlID="ENGOEXT__OGE_LOI" 
			Text="Limit of Liability" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ENGOEXT__OGE_LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valENGOEXT_OGE_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Liability"
			ClientValidationFunction="onValidate_ENGOEXT__OGE_LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0498afdac4cc49ba9570c2e148c1e7c4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0498afdac4cc49ba9570c2e148c1e7c4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0498afdac4cc49ba9570c2e148c1e7c4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0498afdac4cc49ba9570c2e148c1e7c4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0498afdac4cc49ba9570c2e148c1e7c4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0498afdac4cc49ba9570c2e148c1e7c4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0498afdac4cc49ba9570c2e148c1e7c4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0498afdac4cc49ba9570c2e148c1e7c4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0498afdac4cc49ba9570c2e148c1e7c4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0498afdac4cc49ba9570c2e148c1e7c4 input{text-align:left;}"; break;
		}
	}
