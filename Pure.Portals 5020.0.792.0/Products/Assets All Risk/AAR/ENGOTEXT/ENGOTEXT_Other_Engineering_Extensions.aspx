<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENGOTEXT_Other_Engineering_Extensions.aspx.vb" Inherits="Nexus.PB2_ENGOTEXT_Other_Engineering_Extensions" %>
...
function onValidate_OTH_ENG_EXT__DESCRIP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_ENG_EXT", "DESCRIP", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_ENG_EXT", "DESCRIP");
        		}
...
function onValidate_OTH_ENG_EXT__LOL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_ENG_EXT", "LOL", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_ENG_EXT", "LOL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_OTH_ENG_EXT__DESCRIP(null, null, null, isOnLoad);
    onValidate_OTH_ENG_EXT__LOL(null, null, null, isOnLoad);
}
</script>
...
<div id="idfddd2bff20de43f388ae4b775c6f7a7d" class="general-layout-container">
...
<div id="idf251dd90e1da41a78bda2d296e1e6444" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading52" runat="server" Text="Other Engineering Extensions" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="OTH_ENG_EXT" 
		data-property-name="DESCRIP" 
		 
		
		 
		id="pb-container-text-OTH_ENG_EXT-DESCRIP">

		
		<asp:Label ID="lblOTH_ENG_EXT_DESCRIP" runat="server" AssociatedControlID="OTH_ENG_EXT__DESCRIP" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OTH_ENG_EXT__DESCRIP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOTH_ENG_EXT_DESCRIP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_OTH_ENG_EXT__DESCRIP"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OTH_ENG_EXT-LOL">
		<asp:Label ID="lblOTH_ENG_EXT_LOL" runat="server" AssociatedControlID="OTH_ENG_EXT__LOL" 
			Text="Limit of Liability" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_ENG_EXT__LOL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_ENG_EXT_LOL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Liability"
			ClientValidationFunction="onValidate_OTH_ENG_EXT__LOL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf251dd90e1da41a78bda2d296e1e6444 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf251dd90e1da41a78bda2d296e1e6444 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf251dd90e1da41a78bda2d296e1e6444 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf251dd90e1da41a78bda2d296e1e6444 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf251dd90e1da41a78bda2d296e1e6444 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf251dd90e1da41a78bda2d296e1e6444 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf251dd90e1da41a78bda2d296e1e6444 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf251dd90e1da41a78bda2d296e1e6444 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf251dd90e1da41a78bda2d296e1e6444 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf251dd90e1da41a78bda2d296e1e6444 input{text-align:left;}"; break;
		}
	}
