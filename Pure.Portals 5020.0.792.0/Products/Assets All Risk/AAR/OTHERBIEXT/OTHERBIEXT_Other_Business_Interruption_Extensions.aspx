<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OTHERBIEXT_Other_Business_Interruption_Extensions.aspx.vb" Inherits="Nexus.PB2_OTHERBIEXT_Other_Business_Interruption_Extensions" %>
...
function onValidate_OTH_BI_EXT__DESCRIP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_BI_EXT", "DESCRIP", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_BI_EXT", "DESCRIP");
        		}
...
function onValidate_OTH_BI_EXT__LOL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_BI_EXT", "LOL", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_BI_EXT", "LOL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_OTH_BI_EXT__DESCRIP(null, null, null, isOnLoad);
    onValidate_OTH_BI_EXT__LOL(null, null, null, isOnLoad);
}
</script>
...
<div id="idf4884d5ee302472bb68edf5d2c71789b" class="general-layout-container">
...
<div id="idc22c4380f6e94ec7854e91b853353a27" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading72" runat="server" Text="Other Business Interruption Extensions" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="OTH_BI_EXT" 
		data-property-name="DESCRIP" 
		 
		
		 
		id="pb-container-text-OTH_BI_EXT-DESCRIP">

		
		<asp:Label ID="lblOTH_BI_EXT_DESCRIP" runat="server" AssociatedControlID="OTH_BI_EXT__DESCRIP" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OTH_BI_EXT__DESCRIP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOTH_BI_EXT_DESCRIP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_OTH_BI_EXT__DESCRIP"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OTH_BI_EXT-LOL">
		<asp:Label ID="lblOTH_BI_EXT_LOL" runat="server" AssociatedControlID="OTH_BI_EXT__LOL" 
			Text="Limit of Liability" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_BI_EXT__LOL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_BI_EXT_LOL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Liability"
			ClientValidationFunction="onValidate_OTH_BI_EXT__LOL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc22c4380f6e94ec7854e91b853353a27 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc22c4380f6e94ec7854e91b853353a27 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc22c4380f6e94ec7854e91b853353a27 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc22c4380f6e94ec7854e91b853353a27 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc22c4380f6e94ec7854e91b853353a27 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc22c4380f6e94ec7854e91b853353a27 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc22c4380f6e94ec7854e91b853353a27 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc22c4380f6e94ec7854e91b853353a27 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc22c4380f6e94ec7854e91b853353a27 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc22c4380f6e94ec7854e91b853353a27 input{text-align:left;}"; break;
		}
	}
