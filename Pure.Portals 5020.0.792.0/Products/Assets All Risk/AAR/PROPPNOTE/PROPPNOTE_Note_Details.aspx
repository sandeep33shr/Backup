<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PROPPNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_PROPPNOTE_Note_Details" %>
...
function onValidate_SECA_DETAILS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECA_DETAILS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECA_DETAILS", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECA_DETAILS", "DATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=SECA_DETAILS&propertyName=DATE_CREATED&name={name}");
...
function onValidate_SECA_DETAILS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECA_DETAILS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECA_DETAILS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECA_DETAILS", "CREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_SECA_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECA_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECA_DETAILS", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECA_DETAILS_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECA_DETAILS__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECA_DETAILS__COVER_TYPE_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECA_DETAILS", "COVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SECA_DETAILS&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'Property'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_SECA_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECA_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SECA_DETAILS", "NOTE_DESCRIPTION");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECA_DETAILS_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECA_DETAILS__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECA_DETAILS__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SECA_DETAILS", "NOTE_DESCRIPTION");
        		var exp = new Expression("SECA_DETAILS.NoteCheck = 1");
...
function onValidate_SECA_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECA_DETAILS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SECA_DETAILS", "NOTE_DETAILS");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECA_DETAILS_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECA_DETAILS__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECA_DETAILS__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=SECA_DETAILS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_SECA_DETAILS_NOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_SECA_DETAILS__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECA_DETAILS", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SECA_DETAILS", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_SECA_DETAILS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_SECA_DETAILS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_SECA_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_SECA_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SECA_DETAILS__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_SECA_DETAILS__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id0ca89d68369a423c90c54469ccd8a6e2" class="general-layout-container">
...
<div id="id0b2a5bff91ef49fa919701752080e1da" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SECA_DETAILS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-SECA_DETAILS-DATE_CREATED">
		<asp:Label ID="lblSECA_DETAILS_DATE_CREATED" runat="server" AssociatedControlID="SECA_DETAILS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="SECA_DETAILS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calSECA_DETAILS__DATE_CREATED" runat="server" LinkedControl="SECA_DETAILS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valSECA_DETAILS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_SECA_DETAILS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECA_DETAILS-CREATED_BY">

		
		<asp:Label ID="lblSECA_DETAILS_CREATED_BY" runat="server" AssociatedControlID="SECA_DETAILS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECA_DETAILS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECA_DETAILS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_SECA_DETAILS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECA_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblSECA_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="SECA_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECA_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECA_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_SECA_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECA_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblSECA_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="SECA_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECA_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECA_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_SECA_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-SECA_DETAILS-NOTE_DETAILS">
		<asp:Label ID="lblSECA_DETAILS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="SECA_DETAILS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="SECA_DETAILS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valSECA_DETAILS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_SECA_DETAILS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSECA_DETAILS_NoteCheck" for="ctl00_cntMainBody_SECA_DETAILS__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-SECA_DETAILS-NoteCheck">	
		
		<asp:TextBox ID="SECA_DETAILS__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSECA_DETAILS_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_SECA_DETAILS__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0b2a5bff91ef49fa919701752080e1da div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0b2a5bff91ef49fa919701752080e1da div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0b2a5bff91ef49fa919701752080e1da div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0b2a5bff91ef49fa919701752080e1da label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0b2a5bff91ef49fa919701752080e1da label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b2a5bff91ef49fa919701752080e1da label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b2a5bff91ef49fa919701752080e1da label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0b2a5bff91ef49fa919701752080e1da input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b2a5bff91ef49fa919701752080e1da input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b2a5bff91ef49fa919701752080e1da input{text-align:left;}"; break;
		}
	}
