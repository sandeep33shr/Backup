<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="AAR_Risk_Select.aspx.vb" Inherits="Nexus.PB2_AAR_Risk_Select" %>
...
function onValidate_GENERAL__AARMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "AARMTA", "ChildScreen");
        })();
}
...
function onValidate_GENERAL__IS_WORDING(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_WORDING", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_WORDING");
        		var errorMessage = "Wording is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_WORDING");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_WORDING');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_WORDING_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.IS_WORDING");
        			window.setControlWidth(field, "0.8", "GENERAL", "IS_WORDING");
        		})();
        	}
        })();
...
function onValidate_GENERAL__IS_VAT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var errorMessage = "Vat is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
...
function onValidate_GENERAL__IS_GENERAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_GENERAL", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("GENERAL", "IS_GENERAL");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_GENERAL");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_GENERAL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_GENERAL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_SEC_A(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_SEC_A", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_SEC_A");
        		var update = function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_SEC_A");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_SEC_A');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_SEC_A_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_SEC_B(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_SEC_B", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_SEC_B");
        		var update = function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_SEC_B");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_SEC_B');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_SEC_B_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_SEC_C(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_SEC_C", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_SEC_C");
        		var update = function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_SEC_C");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_SEC_C');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_SEC_C_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_GENERAL__AARMTA(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__IS_WORDING(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_VAT(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_GENERAL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_SEC_A(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_SEC_B(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_SEC_C(null, null, null, isOnLoad);
...
<div id="id714ab96d956c448aabf08103ed0e741a" class="general-layout-container">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__AARMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="AARMTA" 
		id="pb-container-childscreen-GENERAL-AARMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="AARMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="AARMTA/AARMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_AARMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.AARMTA"
						ClientValidationFunction="onValidate_GENERAL__AARMTA" 
						Display="None"
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfb254b49f8634c7b9221eba1bf79ec3e" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading4" runat="server" Text="Validation address " /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idfb254b49f8634c7b9221eba1bf79ec3e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfb254b49f8634c7b9221eba1bf79ec3e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfb254b49f8634c7b9221eba1bf79ec3e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfb254b49f8634c7b9221eba1bf79ec3e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfb254b49f8634c7b9221eba1bf79ec3e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfb254b49f8634c7b9221eba1bf79ec3e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfb254b49f8634c7b9221eba1bf79ec3e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfb254b49f8634c7b9221eba1bf79ec3e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfb254b49f8634c7b9221eba1bf79ec3e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfb254b49f8634c7b9221eba1bf79ec3e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9209496797fb460d847429b3c98ae4a9" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="GENERAL" 
		data-property-name="IS_WORDING" 
		id="pb-container-list-GENERAL-IS_WORDING">
		<asp:Label ID="lblGENERAL_IS_WORDING" runat="server" AssociatedControlID="GENERAL__IS_WORDING" 
			Text="Wording" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="GENERAL__IS_WORDING" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_AAR_WORDING" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_GENERAL__IS_WORDING(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valGENERAL_IS_WORDING" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Wording"
			ClientValidationFunction="onValidate_GENERAL__IS_WORDING" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="GENERAL" 
		data-property-name="IS_WORDINGCode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-GENERAL-IS_WORDINGCode">

		
		
			
		
				<asp:HiddenField ID="GENERAL__IS_WORDINGCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9209496797fb460d847429b3c98ae4a9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9209496797fb460d847429b3c98ae4a9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9209496797fb460d847429b3c98ae4a9 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9209496797fb460d847429b3c98ae4a9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9209496797fb460d847429b3c98ae4a9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9209496797fb460d847429b3c98ae4a9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9209496797fb460d847429b3c98ae4a9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9209496797fb460d847429b3c98ae4a9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9209496797fb460d847429b3c98ae4a9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9209496797fb460d847429b3c98ae4a9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id065d29a9ce964409946f208f6074d5fc" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading6" runat="server" Text="Selction " /></legend>
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_GENERAL" for="ctl00_cntMainBody_GENERAL__IS_GENERAL" class="col-md-4 col-sm-3 control-label">
		General</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_GENERAL" 
		id="pb-container-checkbox-GENERAL-IS_GENERAL">	
		
		<asp:TextBox ID="GENERAL__IS_GENERAL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_GENERAL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for General"
			ClientValidationFunction="onValidate_GENERAL__IS_GENERAL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_SEC_A" for="ctl00_cntMainBody_GENERAL__IS_SEC_A" class="col-md-4 col-sm-3 control-label">
		SECTION A:  Property Damage</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_SEC_A" 
		id="pb-container-checkbox-GENERAL-IS_SEC_A">	
		
		<asp:TextBox ID="GENERAL__IS_SEC_A" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_SEC_A" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SECTION A:  Property Damage"
			ClientValidationFunction="onValidate_GENERAL__IS_SEC_A" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_SEC_B" for="ctl00_cntMainBody_GENERAL__IS_SEC_B" class="col-md-4 col-sm-3 control-label">
		SECTION B:  Engineering</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_SEC_B" 
		id="pb-container-checkbox-GENERAL-IS_SEC_B">	
		
		<asp:TextBox ID="GENERAL__IS_SEC_B" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_SEC_B" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SECTION B:  Engineering"
			ClientValidationFunction="onValidate_GENERAL__IS_SEC_B" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_SEC_C" for="ctl00_cntMainBody_GENERAL__IS_SEC_C" class="col-md-4 col-sm-3 control-label">
		SECTION C:  Business Interruption</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_SEC_C" 
		id="pb-container-checkbox-GENERAL-IS_SEC_C">	
		
		<asp:TextBox ID="GENERAL__IS_SEC_C" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_SEC_C" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SECTION C:  Business Interruption"
			ClientValidationFunction="onValidate_GENERAL__IS_SEC_C" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id065d29a9ce964409946f208f6074d5fc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id065d29a9ce964409946f208f6074d5fc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id065d29a9ce964409946f208f6074d5fc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id065d29a9ce964409946f208f6074d5fc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id065d29a9ce964409946f208f6074d5fc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id065d29a9ce964409946f208f6074d5fc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id065d29a9ce964409946f208f6074d5fc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id065d29a9ce964409946f208f6074d5fc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id065d29a9ce964409946f208f6074d5fc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id065d29a9ce964409946f208f6074d5fc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6c1a3097a17f4493a22d86c273bcb1fe" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6c1a3097a17f4493a22d86c273bcb1fe div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6c1a3097a17f4493a22d86c273bcb1fe div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6c1a3097a17f4493a22d86c273bcb1fe div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6c1a3097a17f4493a22d86c273bcb1fe label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6c1a3097a17f4493a22d86c273bcb1fe label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c1a3097a17f4493a22d86c273bcb1fe label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c1a3097a17f4493a22d86c273bcb1fe label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6c1a3097a17f4493a22d86c273bcb1fe input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c1a3097a17f4493a22d86c273bcb1fe input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c1a3097a17f4493a22d86c273bcb1fe input{text-align:left;}"; break;
		}
	}
