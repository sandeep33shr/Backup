<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EXTSPDC_Specified_Direct_Customers.aspx.vb" Inherits="Nexus.PB2_EXTSPDC_Specified_Direct_Customers" %>
...
function onValidate_SPEC_CUST__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPEC_CUST", "NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SPEC_CUST", "NAME");
        		}
...
function onValidate_SPEC_CUST__PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPEC_CUST", "PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SPEC_CUST", "PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_SPEC_CUST__NAME(null, null, null, isOnLoad);
    onValidate_SPEC_CUST__PERC(null, null, null, isOnLoad);
}
</script>
...
<div id="id98730915632e4da08c9c46b1f886f479" class="general-layout-container">
...
<div id="id9ecf52c0e734481ba705925cf07427e3" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SPEC_CUST" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-SPEC_CUST-NAME">

		
		<asp:Label ID="lblSPEC_CUST_NAME" runat="server" AssociatedControlID="SPEC_CUST__NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SPEC_CUST__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSPEC_CUST_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name"
					ClientValidationFunction="onValidate_SPEC_CUST__NAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SPEC_CUST" 
		data-property-name="PERC" 
		id="pb-container-percentage-SPEC_CUST-PERC">
		<asp:Label ID="lblSPEC_CUST_PERC" runat="server" AssociatedControlID="SPEC_CUST__PERC" 
			Text="Percentage" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SPEC_CUST__PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSPEC_CUST_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Percentage"
			ClientValidationFunction="onValidate_SPEC_CUST__PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9ecf52c0e734481ba705925cf07427e3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9ecf52c0e734481ba705925cf07427e3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9ecf52c0e734481ba705925cf07427e3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9ecf52c0e734481ba705925cf07427e3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9ecf52c0e734481ba705925cf07427e3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9ecf52c0e734481ba705925cf07427e3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9ecf52c0e734481ba705925cf07427e3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9ecf52c0e734481ba705925cf07427e3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9ecf52c0e734481ba705925cf07427e3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9ecf52c0e734481ba705925cf07427e3 input{text-align:left;}"; break;
		}
	}
