...
Namespace Nexus
    Partial Class PB2_AAR_General : Inherits BaseRisk
		...
		Protected Sub onValidate_ALLRISK__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_ALLRISK__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ALLRISK__ATTACHMENTDATE()
    onValidate_ALLRISK__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If ALLRISK__ATTACHMENTDATE.Text = "" or ALLRISK__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			ALLRISK__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			ALLRISK__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (ALLRISK__ATTACHMENTDATE.Text <> "" Or ALLRISK__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		ALLRISK__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		ALLRISK__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		ALLRISK__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
