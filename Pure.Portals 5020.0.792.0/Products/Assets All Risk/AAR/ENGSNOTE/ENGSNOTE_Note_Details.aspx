<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENGSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_ENGSNOTE_Note_Details" %>
...
function onValidate_SECBS_DETAILS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECBS_DETAILS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECBS_DETAILS", "DATE_CREATED");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECBS_DETAILS_DATE_CREATED");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECBS_DETAILS__DATE_CREATED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECBS_DETAILS__DATE_CREATED_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECBS_DETAILS", "DATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=SECBS_DETAILS&propertyName=DATE_CREATED&name={name}");
...
function onValidate_SECBS_DETAILS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECBS_DETAILS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECBS_DETAILS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECBS_DETAILS", "CREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_SECBS_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECBS_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SECBS_DETAILS", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECBS_DETAILS_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECBS_DETAILS__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECBS_DETAILS__COVER_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	var field = Field.getInstance("SECBS_DETAILS", "COVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SECBS_DETAILS&propertyName=COVER_TYPE&name={name}");
...
function onValidate_SECBS_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECBS_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SECBS_DETAILS", "NOTE_DESCRIPTION");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECBS_DETAILS_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECBS_DETAILS__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECBS_DETAILS__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SECBS_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SECBS_DETAILS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SECBS_DETAILS", "NOTE_DETAILS");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSECBS_DETAILS_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_SECBS_DETAILS__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SECBS_DETAILS__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=SECBS_DETAILS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_SECBS_DETAILS_NOTE_DETAILS_textarea');
        			if (textarea != null){
...
function DoLogic(isOnLoad) {
    onValidate_SECBS_DETAILS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_SECBS_DETAILS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_SECBS_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_SECBS_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SECBS_DETAILS__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="idcf804e36a8234795bfc8d3a3d5cb0744" class="general-layout-container">
...
<div id="id1eaf27ae897f42119d26a586195122be" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading60" runat="server" Text="Notes (Printed On Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SECBS_DETAILS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-SECBS_DETAILS-DATE_CREATED">
		<asp:Label ID="lblSECBS_DETAILS_DATE_CREATED" runat="server" AssociatedControlID="SECBS_DETAILS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="SECBS_DETAILS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calSECBS_DETAILS__DATE_CREATED" runat="server" LinkedControl="SECBS_DETAILS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valSECBS_DETAILS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_SECBS_DETAILS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECBS_DETAILS-CREATED_BY">

		
		<asp:Label ID="lblSECBS_DETAILS_CREATED_BY" runat="server" AssociatedControlID="SECBS_DETAILS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECBS_DETAILS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECBS_DETAILS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_SECBS_DETAILS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECBS_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblSECBS_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="SECBS_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECBS_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECBS_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_SECBS_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SECBS_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblSECBS_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="SECBS_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SECBS_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSECBS_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_SECBS_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-SECBS_DETAILS-NOTE_DETAILS">
		<asp:Label ID="lblSECBS_DETAILS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="SECBS_DETAILS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="SECBS_DETAILS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valSECBS_DETAILS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_SECBS_DETAILS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1eaf27ae897f42119d26a586195122be div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1eaf27ae897f42119d26a586195122be div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1eaf27ae897f42119d26a586195122be div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1eaf27ae897f42119d26a586195122be label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1eaf27ae897f42119d26a586195122be label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1eaf27ae897f42119d26a586195122be label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1eaf27ae897f42119d26a586195122be label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1eaf27ae897f42119d26a586195122be input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1eaf27ae897f42119d26a586195122be input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1eaf27ae897f42119d26a586195122be input{text-align:left;}"; break;
		}
	}
