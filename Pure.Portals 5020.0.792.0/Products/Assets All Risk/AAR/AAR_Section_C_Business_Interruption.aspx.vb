...
Namespace Nexus
    Partial Class PB2_AAR_Section_C_Business_Interruption : Inherits BaseRisk
		...
		Protected Sub onValidate_SECTIONC__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_SECTIONC__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_SECTIONC__ATTACHMENTDATE()
    onValidate_SECTIONC__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If SECTIONC__ATTACHMENTDATE.Text = "" or SECTIONC__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			SECTIONC__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			SECTIONC__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (SECTIONC__ATTACHMENTDATE.Text <> "" Or SECTIONC__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		SECTIONC__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		SECTIONC__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		SECTIONC__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
