<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OTHERPDED_Other_Property_Deductibles.aspx.vb" Inherits="Nexus.PB2_OTHERPDED_Other_Property_Deductibles" %>
...
function onValidate_OTH_PROP_DED__DESCRIP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_PROP_DED", "DESCRIP", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_PROP_DED", "DESCRIP");
        		}
...
function onValidate_OTH_PROP_DED__DED_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_PROP_DED", "DED_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_PROP_DED", "DED_PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_OTH_PROP_DED__DED_MIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_PROP_DED", "DED_MIN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_PROP_DED", "DED_MIN");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_OTH_PROP_DED__DED_MAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_PROP_DED", "DED_MAX", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_PROP_DED", "DED_MAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_OTH_PROP_DED__DESCRIP(null, null, null, isOnLoad);
    onValidate_OTH_PROP_DED__DED_PERC(null, null, null, isOnLoad);
    onValidate_OTH_PROP_DED__DED_MIN(null, null, null, isOnLoad);
    onValidate_OTH_PROP_DED__DED_MAX(null, null, null, isOnLoad);
}
</script>
...
<div id="id08dc6760eb384376a2231e473a9df724" class="general-layout-container">
...
<div id="id58910c0a63874942ab2cc5e5353f96b2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading31" runat="server" Text="Other Property Deductibles" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="OTH_PROP_DED" 
		data-property-name="DESCRIP" 
		 
		
		 
		id="pb-container-text-OTH_PROP_DED-DESCRIP">

		
		<asp:Label ID="lblOTH_PROP_DED_DESCRIP" runat="server" AssociatedControlID="OTH_PROP_DED__DESCRIP" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OTH_PROP_DED__DESCRIP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOTH_PROP_DED_DESCRIP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_OTH_PROP_DED__DESCRIP"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OTH_PROP_DED" 
		data-property-name="DED_PERC" 
		id="pb-container-percentage-OTH_PROP_DED-DED_PERC">
		<asp:Label ID="lblOTH_PROP_DED_DED_PERC" runat="server" AssociatedControlID="OTH_PROP_DED__DED_PERC" 
			Text="Ded %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="OTH_PROP_DED__DED_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valOTH_PROP_DED_DED_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Ded %"
			ClientValidationFunction="onValidate_OTH_PROP_DED__DED_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OTH_PROP_DED" 
		data-property-name="DED_MIN" 
		id="pb-container-currency-OTH_PROP_DED-DED_MIN">
		<asp:Label ID="lblOTH_PROP_DED_DED_MIN" runat="server" AssociatedControlID="OTH_PROP_DED__DED_MIN" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_PROP_DED__DED_MIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_PROP_DED_DED_MIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_OTH_PROP_DED__DED_MIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="OTH_PROP_DED" 
		data-property-name="DED_MAX" 
		id="pb-container-currency-OTH_PROP_DED-DED_MAX">
		<asp:Label ID="lblOTH_PROP_DED_DED_MAX" runat="server" AssociatedControlID="OTH_PROP_DED__DED_MAX" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_PROP_DED__DED_MAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_PROP_DED_DED_MAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_OTH_PROP_DED__DED_MAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id58910c0a63874942ab2cc5e5353f96b2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id58910c0a63874942ab2cc5e5353f96b2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id58910c0a63874942ab2cc5e5353f96b2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id58910c0a63874942ab2cc5e5353f96b2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id58910c0a63874942ab2cc5e5353f96b2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id58910c0a63874942ab2cc5e5353f96b2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id58910c0a63874942ab2cc5e5353f96b2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id58910c0a63874942ab2cc5e5353f96b2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id58910c0a63874942ab2cc5e5353f96b2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id58910c0a63874942ab2cc5e5353f96b2 input{text-align:left;}"; break;
		}
	}
