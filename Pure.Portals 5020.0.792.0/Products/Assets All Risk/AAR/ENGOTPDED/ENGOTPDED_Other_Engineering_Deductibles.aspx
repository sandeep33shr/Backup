<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENGOTPDED_Other_Engineering_Deductibles.aspx.vb" Inherits="Nexus.PB2_ENGOTPDED_Other_Engineering_Deductibles" %>
...
function onValidate_OTH_ENG_DED__DESCRIP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_ENG_DED", "DESCRIP", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_ENG_DED", "DESCRIP");
        		}
...
function onValidate_OTH_ENG_DED__DED_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_ENG_DED", "DED_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_ENG_DED", "DED_PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_OTH_ENG_DED__DED_MIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_ENG_DED", "DED_MIN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_ENG_DED", "DED_MIN");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_OTH_ENG_DED__DED_MAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTH_ENG_DED", "DED_MAX", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTH_ENG_DED", "DED_MAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_OTH_ENG_DED__DESCRIP(null, null, null, isOnLoad);
    onValidate_OTH_ENG_DED__DED_PERC(null, null, null, isOnLoad);
    onValidate_OTH_ENG_DED__DED_MIN(null, null, null, isOnLoad);
    onValidate_OTH_ENG_DED__DED_MAX(null, null, null, isOnLoad);
}
</script>
...
<div id="idbf02f50cd42e47c9be28cd2bfd2a6f1b" class="general-layout-container">
...
<div id="id8fb40a1908f2415999cd4a3231f00ee1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading54" runat="server" Text="Other Engineering Deductibles" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="OTH_ENG_DED" 
		data-property-name="DESCRIP" 
		 
		
		 
		id="pb-container-text-OTH_ENG_DED-DESCRIP">

		
		<asp:Label ID="lblOTH_ENG_DED_DESCRIP" runat="server" AssociatedControlID="OTH_ENG_DED__DESCRIP" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OTH_ENG_DED__DESCRIP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOTH_ENG_DED_DESCRIP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_OTH_ENG_DED__DESCRIP"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-OTH_ENG_DED-DED_PERC">
		<asp:Label ID="lblOTH_ENG_DED_DED_PERC" runat="server" AssociatedControlID="OTH_ENG_DED__DED_PERC" 
			Text="Ded %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="OTH_ENG_DED__DED_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valOTH_ENG_DED_DED_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Ded %"
			ClientValidationFunction="onValidate_OTH_ENG_DED__DED_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OTH_ENG_DED-DED_MIN">
		<asp:Label ID="lblOTH_ENG_DED_DED_MIN" runat="server" AssociatedControlID="OTH_ENG_DED__DED_MIN" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_ENG_DED__DED_MIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_ENG_DED_DED_MIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_OTH_ENG_DED__DED_MIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OTH_ENG_DED-DED_MAX">
		<asp:Label ID="lblOTH_ENG_DED_DED_MAX" runat="server" AssociatedControlID="OTH_ENG_DED__DED_MAX" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTH_ENG_DED__DED_MAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTH_ENG_DED_DED_MAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_OTH_ENG_DED__DED_MAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8fb40a1908f2415999cd4a3231f00ee1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8fb40a1908f2415999cd4a3231f00ee1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8fb40a1908f2415999cd4a3231f00ee1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8fb40a1908f2415999cd4a3231f00ee1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8fb40a1908f2415999cd4a3231f00ee1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8fb40a1908f2415999cd4a3231f00ee1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8fb40a1908f2415999cd4a3231f00ee1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8fb40a1908f2415999cd4a3231f00ee1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8fb40a1908f2415999cd4a3231f00ee1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8fb40a1908f2415999cd4a3231f00ee1 input{text-align:left;}"; break;
		}
	}
