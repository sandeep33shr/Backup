<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EXTSPDS_Specified_Direct_Suppliers.aspx.vb" Inherits="Nexus.PB2_EXTSPDS_Specified_Direct_Suppliers" %>
...
function onValidate_SPEC_SUPP__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPEC_SUPP", "NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SPEC_SUPP", "NAME");
        		}
...
function onValidate_SPEC_SUPP__PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPEC_SUPP", "PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SPEC_SUPP", "PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_SPEC_SUPP__NAME(null, null, null, isOnLoad);
    onValidate_SPEC_SUPP__PERC(null, null, null, isOnLoad);
}
</script>
...
<div id="id9bb88f42229d457b8f676212a4b84a70" class="general-layout-container">
...
<div id="id3bebe468be4e4ef1bf4138bb352e6805" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SPEC_SUPP" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-SPEC_SUPP-NAME">

		
		<asp:Label ID="lblSPEC_SUPP_NAME" runat="server" AssociatedControlID="SPEC_SUPP__NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SPEC_SUPP__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSPEC_SUPP_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name"
					ClientValidationFunction="onValidate_SPEC_SUPP__NAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SPEC_SUPP-PERC">
		<asp:Label ID="lblSPEC_SUPP_PERC" runat="server" AssociatedControlID="SPEC_SUPP__PERC" 
			Text="Percentage" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SPEC_SUPP__PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSPEC_SUPP_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Percentage"
			ClientValidationFunction="onValidate_SPEC_SUPP__PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3bebe468be4e4ef1bf4138bb352e6805 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3bebe468be4e4ef1bf4138bb352e6805 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3bebe468be4e4ef1bf4138bb352e6805 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3bebe468be4e4ef1bf4138bb352e6805 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3bebe468be4e4ef1bf4138bb352e6805 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3bebe468be4e4ef1bf4138bb352e6805 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3bebe468be4e4ef1bf4138bb352e6805 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3bebe468be4e4ef1bf4138bb352e6805 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3bebe468be4e4ef1bf4138bb352e6805 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3bebe468be4e4ef1bf4138bb352e6805 input{text-align:left;}"; break;
		}
	}
