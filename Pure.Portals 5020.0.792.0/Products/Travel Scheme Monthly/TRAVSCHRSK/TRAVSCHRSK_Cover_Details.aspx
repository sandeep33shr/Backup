<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TRAVSCHRSK_Cover_Details.aspx.vb" Inherits="Nexus.PB2_TRAVSCHRSK_Cover_Details" %>
...
function onValidate_GENERAL__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Travel Scheme - ' + ADDRESS.LINE1"), 
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "PRODCODE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__TRAVSMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "TRAVSMTA", "ChildScreen");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "TRAVSMTA");
        		var errorMessage = "Reason is mandatory and an option must be selected";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_TRAVSMTA");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__TRAVSMTA');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__TRAVSMTA_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.TRAVSMTA");
        			window.setControlWidth(field, "0.7", "GENERAL", "TRAVSMTA");
        		})();
        	}
        })();
}
...
function onValidate_TRAVELSCHM__COVERTYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRAVELSCHM", "COVERTYPE", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TRAVELSCHM", "COVERTYPE");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTRAVELSCHM_COVERTYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TRAVELSCHM__COVERTYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TRAVELSCHM__COVERTYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TRAVELSCHM.COVERTYPE");
        			window.setControlWidth(field, "0.7", "TRAVELSCHM", "COVERTYPE");
        		})();
        	}
        })();
}
function onValidate_TRAVELSCHM__COVERCODE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRAVELSCHM", "COVERCODE", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TRAVELSCHM", "COVERCODE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=TRAVELSCHM&propertyName=COVERCODE&name={name}");
        		
        		var value = new Expression("Code(TRAVELSCHM.COVERTYPE)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTRAVELSCHM_COVERCODE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TRAVELSCHM__COVERCODE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TRAVELSCHM__COVERCODE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TRAVELSCHM.COVERCODE");
        			window.setControlWidth(field, "0.7", "TRAVELSCHM", "COVERCODE");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__TRAVSMTA(null, null, null, isOnLoad);
    ...
    onValidate_TRAVELSCHM__COVERTYPE(null, null, null, isOnLoad);
    onValidate_TRAVELSCHM__COVERCODE(null, null, null, isOnLoad);
}
</script>
...
<div id="id1cd0bbf7636f43d0b04cdb54089c2ddb" class="general-layout-container">
...
<div id="id687160a7f7484b678a4bb2922610ce52" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id687160a7f7484b678a4bb2922610ce52 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id687160a7f7484b678a4bb2922610ce52 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id687160a7f7484b678a4bb2922610ce52 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id687160a7f7484b678a4bb2922610ce52 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id687160a7f7484b678a4bb2922610ce52 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id687160a7f7484b678a4bb2922610ce52 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id687160a7f7484b678a4bb2922610ce52 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id687160a7f7484b678a4bb2922610ce52 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id687160a7f7484b678a4bb2922610ce52 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id687160a7f7484b678a4bb2922610ce52 input{text-align:left;}"; break;
		}
	}
...
<div id="frmMTAReason" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading4" runat="server" Text="Mid-Term Adjustment Reason Detail" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__TRAVSMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="TRAVSMTA" 
		id="pb-container-childscreen-GENERAL-TRAVSMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="TRAVSMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRAVSMTA/TRAVSMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_TRAVSMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.TRAVSMTA"
						ClientValidationFunction="onValidate_GENERAL__TRAVSMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id588f138412184cf0a9763762bc210a93" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id588f138412184cf0a9763762bc210a93 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id588f138412184cf0a9763762bc210a93 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id588f138412184cf0a9763762bc210a93 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id588f138412184cf0a9763762bc210a93 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id588f138412184cf0a9763762bc210a93 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id588f138412184cf0a9763762bc210a93 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id588f138412184cf0a9763762bc210a93 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id588f138412184cf0a9763762bc210a93 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id588f138412184cf0a9763762bc210a93 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id588f138412184cf0a9763762bc210a93 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id42d65108dbc7488b86b4f72091addf25" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading6" runat="server" Text="Type" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="TRAVELSCHM" 
		data-property-name="COVERTYPE" 
		id="pb-container-list-TRAVELSCHM-COVERTYPE">
		<asp:Label ID="lblTRAVELSCHM_COVERTYPE" runat="server" AssociatedControlID="TRAVELSCHM__COVERTYPE" 
			Text="Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="TRAVELSCHM__COVERTYPE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_TRAVELPERIL" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_TRAVELSCHM__COVERTYPE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valTRAVELSCHM_COVERTYPE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Type"
			ClientValidationFunction="onValidate_TRAVELSCHM__COVERTYPE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TRAVELSCHM-COVERCODE">

		
		<asp:Label ID="lblTRAVELSCHM_COVERCODE" runat="server" AssociatedControlID="TRAVELSCHM__COVERCODE" 
			Text="Cover Type Code" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TRAVELSCHM__COVERCODE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTRAVELSCHM_COVERCODE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type Code"
					ClientValidationFunction="onValidate_TRAVELSCHM__COVERCODE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id42d65108dbc7488b86b4f72091addf25 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id42d65108dbc7488b86b4f72091addf25 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id42d65108dbc7488b86b4f72091addf25 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id42d65108dbc7488b86b4f72091addf25 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id42d65108dbc7488b86b4f72091addf25 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id42d65108dbc7488b86b4f72091addf25 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id42d65108dbc7488b86b4f72091addf25 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id42d65108dbc7488b86b4f72091addf25 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id42d65108dbc7488b86b4f72091addf25 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id42d65108dbc7488b86b4f72091addf25 input{text-align:left;}"; break;
		}
	}
