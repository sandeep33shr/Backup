<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TRAVSCHRSK_Endorsements.aspx.vb" Inherits="Nexus.PB2_TRAVSCHRSK_Endorsements" %>
...
function onValidate_ENDORSCHLD__TRMPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENDORSCHLD", "TRMPREM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_ENDORSCHLD__TRMPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id509526a25dd9491a81e89f9320407263" class="general-layout-container">
...
<div id="idb9dc87cbb71e4771a0bb03cbed5883b9" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENDORSCHLD__TRMPREM"
		data-field-type="Child" 
		data-object-name="ENDORSCHLD" 
		data-property-name="TRMPREM" 
		id="pb-container-childscreen-ENDORSCHLD-TRMPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENDORSCHLD__PREMENDORS" runat="server" ScreenCode="TRMPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRMPREM/TRMPREM_Premium_Endorsements.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valENDORSCHLD_TRMPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ENDORSCHLD.TRMPREM"
						ClientValidationFunction="onValidate_ENDORSCHLD__TRMPREM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb9dc87cbb71e4771a0bb03cbed5883b9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb9dc87cbb71e4771a0bb03cbed5883b9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb9dc87cbb71e4771a0bb03cbed5883b9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb9dc87cbb71e4771a0bb03cbed5883b9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb9dc87cbb71e4771a0bb03cbed5883b9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb9dc87cbb71e4771a0bb03cbed5883b9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb9dc87cbb71e4771a0bb03cbed5883b9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb9dc87cbb71e4771a0bb03cbed5883b9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb9dc87cbb71e4771a0bb03cbed5883b9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb9dc87cbb71e4771a0bb03cbed5883b9 input{text-align:left;}"; break;
		}
	}
