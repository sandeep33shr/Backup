<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TRAVSCHRSK_Risk_Details.aspx.vb" Inherits="Nexus.PB2_TRAVSCHRSK_Risk_Details" %>
...
function onValidate_TRAVELSCHM__DESCRIPT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRAVELSCHM", "DESCRIPT", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TRAVELSCHM", "DESCRIPT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TRAVELSCHM.DESCRIPT");
        			window.setControlWidth(field, "0.7", "TRAVELSCHM", "DESCRIPT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTRAVELSCHM_DESCRIPT");
        			    var ele = document.getElementById('ctl00_cntMainBody_TRAVELSCHM__DESCRIPT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TRAVELSCHM__DESCRIPT_lblFindParty");
        			    }
        			}
...
function onValidate_TRAVELSCHM__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRAVELSCHM", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TRAVELSCHM", "PREMIUM");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TRAVELSCHM.PREMIUM");
        			window.setControlWidth(field, "0.7", "TRAVELSCHM", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTRAVELSCHM_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_TRAVELSCHM__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TRAVELSCHM__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_TRAVELSCHM__DESCRIPT(null, null, null, isOnLoad);
    onValidate_TRAVELSCHM__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id7ba1b6ad4ba14310bdfc389d19e52f4f" class="general-layout-container">
...
<div id="id0d7bf19fa00d4e559f8e2294714e4b30" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading8" runat="server" Text="Travel Scheme" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TRAVELSCHM-DESCRIPT">

		
		<asp:Label ID="lblTRAVELSCHM_DESCRIPT" runat="server" AssociatedControlID="TRAVELSCHM__DESCRIPT" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TRAVELSCHM__DESCRIPT" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTRAVELSCHM_DESCRIPT" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_TRAVELSCHM__DESCRIPT"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TRAVELSCHM-PREMIUM">
		<asp:Label ID="lblTRAVELSCHM_PREMIUM" runat="server" AssociatedControlID="TRAVELSCHM__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TRAVELSCHM__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTRAVELSCHM_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_TRAVELSCHM__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0d7bf19fa00d4e559f8e2294714e4b30 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0d7bf19fa00d4e559f8e2294714e4b30 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0d7bf19fa00d4e559f8e2294714e4b30 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0d7bf19fa00d4e559f8e2294714e4b30 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0d7bf19fa00d4e559f8e2294714e4b30 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d7bf19fa00d4e559f8e2294714e4b30 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d7bf19fa00d4e559f8e2294714e4b30 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0d7bf19fa00d4e559f8e2294714e4b30 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d7bf19fa00d4e559f8e2294714e4b30 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d7bf19fa00d4e559f8e2294714e4b30 input{text-align:left;}"; break;
		}
	}
