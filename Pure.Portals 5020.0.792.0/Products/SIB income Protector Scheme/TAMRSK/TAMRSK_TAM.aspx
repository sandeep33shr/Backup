<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TAMRSK_TAM.aspx.vb" Inherits="Nexus.PB2_TAMRSK_TAM" %>
...
function onValidate_TAMRSK__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=TAMRSK&propertyName=RISK_ATTACH_DATE&name={name}");
        		
        		var value = new Expression("NOW"), 
        			condition = (Expression.isValidParameter("(TAMRSK.RISK_ATTACH_DATE =='' ||TAMRSK.RISK_ATTACH_DATE == null ) ")) ? new Expression("(TAMRSK.RISK_ATTACH_DATE =='' ||TAMRSK.RISK_ATTACH_DATE == null ) ") : null, 
...
function onValidate_TAMRSK__EFFECTIVEDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=TAMRSK&propertyName=EFFECTIVEDATE&name={name}");
...
function onValidate_TAMRSK__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMRSK", "NAME");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK.NAME");
        			window.setControlWidth(field, "0.8", "TAMRSK", "NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMRSK_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMRSK__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMRSK__NAME_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_TAMRSK__TOT_PREM_END(source, args, sender, isOnLoad) {
        ...
        (function(){
          ...
          * @param TAMRSK.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var childFieldStr = "TAMRSK.PREMIUM";
...
function onValidate_TAMRSK__TAMNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TAMNOTES", "ChildScreen");
        })();
}
function onValidate_TAMRSK__TAMSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TAMSNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_TAMRSK__NAME(null, null, null, isOnLoad);
    ...
    onValidate_TAMRSK__TAMNOTES(null, null, null, isOnLoad);
    onValidate_TAMRSK__TAMSNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id64f00aa29a2b4652bff5c055da33a7be" class="general-layout-container">
...
<div id="id93a778c4e774428c884c543214cab53c" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id93a778c4e774428c884c543214cab53c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id93a778c4e774428c884c543214cab53c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id93a778c4e774428c884c543214cab53c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id93a778c4e774428c884c543214cab53c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id93a778c4e774428c884c543214cab53c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id93a778c4e774428c884c543214cab53c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id93a778c4e774428c884c543214cab53c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id93a778c4e774428c884c543214cab53c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id93a778c4e774428c884c543214cab53c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id93a778c4e774428c884c543214cab53c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0275060a9ad6430d9b7f690be713f787" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0275060a9ad6430d9b7f690be713f787 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0275060a9ad6430d9b7f690be713f787 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0275060a9ad6430d9b7f690be713f787 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0275060a9ad6430d9b7f690be713f787 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0275060a9ad6430d9b7f690be713f787 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0275060a9ad6430d9b7f690be713f787 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0275060a9ad6430d9b7f690be713f787 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0275060a9ad6430d9b7f690be713f787 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0275060a9ad6430d9b7f690be713f787 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0275060a9ad6430d9b7f690be713f787 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id974fc871f3514f2ea030730db6cb1bb3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Risk Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAMRSK-NAME">

		
		<asp:Label ID="lblTAMRSK_NAME" runat="server" AssociatedControlID="TAMRSK__NAME" 
			Text="Number of Persons Inusred" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAMRSK__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAMRSK_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for