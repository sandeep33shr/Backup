...
Namespace Nexus
    Partial Class PB2_TAMNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_TAMNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If TAMNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		TAMNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		TAMNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_TAMNOTES_DETAILS__NOTE_DETAILS()
End Sub
