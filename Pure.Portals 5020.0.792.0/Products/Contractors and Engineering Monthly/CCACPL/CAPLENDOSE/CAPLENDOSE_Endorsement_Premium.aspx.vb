...
Namespace Nexus
    Partial Class PB2_CAPLENDOSE_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_PL_ENDORSE__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PL_ENDORSE__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'CPLRISK - Standard Wording Parent Object
        'REFERRAL_CLAUSES - Standard Wording Parent Property
        'PL_ENDORSE - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/CPLRISK/SW.REFERRAL_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("PL_ENDORSE__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/CPLRISK/PL_ENDORSE")
        
        	Dim CurrentSelected As String = PL_ENDORSE__ENDORSE_CAP.Text
