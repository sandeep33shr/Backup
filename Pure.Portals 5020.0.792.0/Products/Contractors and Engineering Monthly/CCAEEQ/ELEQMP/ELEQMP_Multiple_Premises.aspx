<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ELEQMP_Multiple_Premises.aspx.vb" Inherits="Nexus.PB2_ELEQMP_Multiple_Premises" %>
...
<div id="id82b817f16b3d4b00b73c768f16d76b0e" class="general-layout-container">
...
<div id="id61846d11cf4c4d11be4762f8a5dc0984" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading16" runat="server" Text="Multiple Premises" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id61846d11cf4c4d11be4762f8a5dc0984 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id61846d11cf4c4d11be4762f8a5dc0984 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id61846d11cf4c4d11be4762f8a5dc0984 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id61846d11cf4c4d11be4762f8a5dc0984 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id61846d11cf4c4d11be4762f8a5dc0984 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id61846d11cf4c4d11be4762f8a5dc0984 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id61846d11cf4c4d11be4762f8a5dc0984 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id61846d11cf4c4d11be4762f8a5dc0984 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id61846d11cf4c4d11be4762f8a5dc0984 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id61846d11cf4c4d11be4762f8a5dc0984 input{text-align:left;}"; break;
		}
	}
