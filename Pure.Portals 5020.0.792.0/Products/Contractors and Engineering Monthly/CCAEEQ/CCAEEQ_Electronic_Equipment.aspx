<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAEEQ_Electronic_Equipment.aspx.vb" Inherits="Nexus.PB2_CCAEEQ_Electronic_Equipment" %>
...
function onValidate_GENERAL__CHECK_ELECEQ(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Deleting a cover on a single risk is not allowed.")) ? "Deleting a cover on a single risk is not allowed." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_ELECEQ");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_ELECEQ");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("GENERAL.TRANSTYPE =='MTA' && GENERAL.CHECK_ELECEQCode=='DELETE'");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__INS_FILE_CNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("A valid MTA action selection is required when processing a MTA.")) ? "A valid MTA action selection is required when processing a MTA." : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.TRANSTYPE =='MTA' &&(GENERAL.CHECK_ELECEQCode=='ADD' || GENERAL.CHECK_ELECEQCode =='VIEW')) || ( GENERAL.TRANSTYPE =='NB' || GENERAL.TRANSTYPE == 'REN' || GENERAL.TRANSTYPE == 'MTC')");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__CCAEEQMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CCAEEQMTA", "ChildScreen");
        })();
}
...
function onValidate_ELECTEQUIP__EECHLD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQUIP", "EECHLD", "ChildScreen");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ELECTEQUIP", "EECHLD");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_ELECTEQUIP__EECHLD table td a");
...
function onValidate_ELECTEQUIP__ELEQMP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQUIP", "ELEQMP", "ChildScreen");
        })();
        /**
         * @fileoverview
         * DisableAddWhen, used only on child screen objects.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ELECTEQUIP", "ELEQMP");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_ELECTEQUIP__ELEQMP table td a");
...
function onValidate_ELECTEQUIP__EEENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQUIP", "EEENDPREM", "ChildScreen");
        })();
        /**
         * @fileoverview
         * DisableAddWhen, used only on child screen objects.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ELECTEQUIP", "EEENDPREM");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_ELECTEQUIP__EEENDPREM table td a");
...
function onValidate_ELECTEQUIP__EESNOTES(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ELECTEQUIP", "EESNOTES");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_ELECTEQUIP__EESNOTES table td a");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__CCAEEQMTA(null, null, null, isOnLoad);
    ...
    onValidate_ELECTEQUIP__EECHLD(null, null, null, isOnLoad);
    ...
    onValidate_ELECTEQUIP__ELEQMP(null, null, null, isOnLoad);
    ...
    onValidate_ELECTEQUIP__EEENDPREM(null, null, null, isOnLoad);
...
<div id="idb8d6893fcc0d41b3a4f5652f38797a33" class="general-layout-container">
...
<div id="id86a1ba520e82497db525d08c7b752581" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id86a1ba520e82497db525d08c7b752581 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id86a1ba520e82497db525d08c7b752581 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id86a1ba520e82497db525d08c7b752581 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id86a1ba520e82497db525d08c7b752581 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id86a1ba520e82497db525d08c7b752581 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id86a1ba520e82497db525d08c7b752581 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id86a1ba520e82497db525d08c7b752581 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id86a1ba520e82497db525d08c7b752581 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id86a1ba520e82497db525d08c7b752581 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id86a1ba520e82497db525d08c7b752581 input{text-align:left;}"; break;
		}
	}
...
<div id="frmMTAReason" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading25" runat="server" Text="MTA" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- ColumnLayoutContainer -->
<div id="id224bd81431b644ce90c5d601ab2a6d3b" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="MTA Affected Covers" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_CHECK_ELECEQ" runat="server" AssociatedControlID="GENERAL__CHECK_ELECEQ" 
			Text="MTA Action" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
			...
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MTA Action"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id224bd81431b644ce90c5d601ab2a6d3b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id224bd81431b644ce90c5d601ab2a6d3b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id224bd81431b644ce90c5d601ab2a6d3b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id224bd81431b644ce90c5d601ab2a6d3b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id224bd81431b644ce90c5d601ab2a6d3b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id224bd81431b644ce90c5d601ab2a6d3b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id224bd81431b644ce90c5d601ab2a6d3b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id224bd81431b644ce90c5d601ab2a6d3b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id224bd81431b644ce90c5d601ab2a6d3b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id224bd81431b644ce90c5d601ab2a6d3b input{text-align:left;}"; break;
		}
	}
...
<div id="frmMTAReason" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading27" runat="server" Text="Mid-Term Adjustment Reason" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CCAEEQMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CCAEEQMTA" 
		id="pb-container-childscreen-GENERAL-CCAEEQMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="CCAEEQMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CCAEEQMTA/CCAEEQMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_CCAEEQMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CCAEEQMTA"
						ClientValidationFunction="onValidate_GENERAL__CCAEEQMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idea169f8d2ade4798871b3191831669df" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading28" runat="server" Text="Address" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idea169f8d2ade4798871b3191831669df div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idea169f8d2ade4798871b3191831669df div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idea169f8d2ade4798871b3191831669df div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idea169f8d2ade4798871b3191831669df label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idea169f8d2ade4798871b3191831669df label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idea169f8d2ade4798871b3191831669df label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idea169f8d2ade4798871b3191831669df label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idea169f8d2ade4798871b3191831669df input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idea169f8d2ade4798871b3191831669df input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idea169f8d2ade4798871b3191831669df input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id34a6282db6b04b72964a7bde2b76c5bf" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading29" runat="server" Text="Industry" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id34a6282db6b04b72964a7bde2b76c5bf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id34a6282db6b04b72964a7bde2b76c5bf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id34a6282db6b04b72964a7bde2b76c5bf div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id34a6282db6b04b72964a7bde2b76c5bf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id34a6282db6b04b72964a7bde2b76c5bf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id34a6282db6b04b72964a7bde2b76c5bf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id34a6282db6b04b72964a7bde2b76c5bf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id34a6282db6b04b72964a7bde2b76c5bf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id34a6282db6b04b72964a7bde2b76c5bf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id34a6282db6b04b72964a7bde2b76c5bf input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idccfde5a90d7d49b99028e68d71cfe225" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idccfde5a90d7d49b99028e68d71cfe225 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idccfde5a90d7d49b99028e68d71cfe225 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idccfde5a90d7d49b99028e68d71cfe225 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idccfde5a90d7d49b99028e68d71cfe225 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idccfde5a90d7d49b99028e68d71cfe225 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idccfde5a90d7d49b99028e68d71cfe225 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idccfde5a90d7d49b99028e68d71cfe225 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idccfde5a90d7d49b99028e68d71cfe225 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idccfde5a90d7d49b99028e68d71cfe225 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idccfde5a90d7d49b99028e68d71cfe225 input{text-align:left;}"; break;
		}
	}
...
<div id="Pastclaimscount" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading31" runat="server" Text="Past Claims Count" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label10">
		<span class="label" id="label10"><B>Electronic Equipment</B></span>
	</span>
<!-- /Label -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0856418108294820bca068b6938658fa" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Electronic Equipment Items" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0856418108294820bca068b6938658fa div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0856418108294820bca068b6938658fa div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0856418108294820bca068b6938658fa div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0856418108294820bca068b6938658fa label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0856418108294820bca068b6938658fa label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0856418108294820bca068b6938658fa label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0856418108294820bca068b6938658fa label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0856418108294820bca068b6938658fa input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0856418108294820bca068b6938658fa input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0856418108294820bca068b6938658fa input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id614faf9c03cc4e548cedd4aec521f95d" class="column-layout-container,no-border  ">
...
<!-- /Text -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECTEQUIP__EECHLD"
		data-field-type="Child" 
		data-object-name="ELECTEQUIP" 
		data-property-name="EECHLD" 
		id="pb-container-childscreen-ELECTEQUIP-EECHLD">
		
		    <legend>Electronic Equipment Items</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECTEQUIP__ELECTEQ" runat="server" ScreenCode="EECHLD" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EECHLD/EECHLD_Electric_Equipment_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECTEQUIP_EECHLD" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Electronic Equipment Items"
						ClientValidationFunction="onValidate_ELECTEQUIP__EECHLD" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id614faf9c03cc4e548cedd4aec521f95d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id614faf9c03cc4e548cedd4aec521f95d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id614faf9c03cc4e548cedd4aec521f95d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id614faf9c03cc4e548cedd4aec521f95d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id614faf9c03cc4e548cedd4aec521f95d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id614faf9c03cc4e548cedd4aec521f95d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id614faf9c03cc4e548cedd4aec521f95d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id614faf9c03cc4e548cedd4aec521f95d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id614faf9c03cc4e548cedd4aec521f95d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id614faf9c03cc4e548cedd4aec521f95d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4064d9bf30cb4f9da74fa45e910073c2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading34" runat="server" Text="First Amount Payable" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label12">
		<span class="label" id="label12">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label13">
		<span class="label" id="label13">Min Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label14">
		<span class="label" id="label14">Max Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label15">
		<span class="label" id="label15">First Amount Payable Per Section</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label16">
		<span class="label" id="label16">First Amount Payable Lightning/Surge</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4064d9bf30cb4f9da74fa45e910073c2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4064d9bf30cb4f9da74fa45e910073c2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4064d9bf30cb4f9da74fa45e910073c2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4064d9bf30cb4f9da74fa45e910073c2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4064d9bf30cb4f9da74fa45e910073c2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4064d9bf30cb4f9da74fa45e910073c2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4064d9bf30cb4f9da74fa45e910073c2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4064d9bf30cb4f9da74fa45e910073c2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4064d9bf30cb4f9da74fa45e910073c2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4064d9bf30cb4f9da74fa45e910073c2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id249cc720d77b425d8386b42f4fb136b7" class="column-layout-container,no-border  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label19">
		<span class="label" id="label19">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label20">
		<span class="label" id="label20">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label21">
		<span class="label" id="label21">Premium </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label22">
		<span class="label" id="label22">Posting Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label23">
		<span class="label" id="label23">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label24">
		<span class="label" id="label24">Min Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label25">
		<span class="label" id="label25">Indemnity Period</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label26">
		<span class="label" id="label26">Time Excess</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label27">
		<span class="label" id="label27">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label32">
		<span class="label" id="label32">Increased Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label33">
		<span class="label" id="label33">Reinstatement Of Data/Programs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label36">
		<span class="label" id="label36">Incompatibility Cover</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label43">
		<span class="label" id="label43">Loss Of Profit</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label45">
		<span class="label" id="label45">Riot & Strike </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label50">
		<span class="label" id="label50">Telecommunication Access Lines</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label53">
		<span class="label" id="label53">Failure Of Electricity</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label56">
		<span class="label" id="label56">Nasria Electronic Equipments</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label65">
		<span class="label" id="label65">Total </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id249cc720d77b425d8386b42f4fb136b7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id249cc720d77b425d8386b42f4fb136b7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id249cc720d77b425d8386b42f4fb136b7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id249cc720d77b425d8386b42f4fb136b7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id249cc720d77b425d8386b42f4fb136b7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id249cc720d77b425d8386b42f4fb136b7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id249cc720d77b425d8386b42f4fb136b7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id249cc720d77b425d8386b42f4fb136b7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id249cc720d77b425d8386b42f4fb136b7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id249cc720d77b425d8386b42f4fb136b7 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc6116f7b68884b6eb5e61f638a9b0c67" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading36" runat="server" Text="Alarm Warranty" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc6116f7b68884b6eb5e61f638a9b0c67 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc6116f7b68884b6eb5e61f638a9b0c67 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc6116f7b68884b6eb5e61f638a9b0c67 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc6116f7b68884b6eb5e61f638a9b0c67 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc6116f7b68884b6eb5e61f638a9b0c67 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc6116f7b68884b6eb5e61f638a9b0c67 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc6116f7b68884b6eb5e61f638a9b0c67 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc6116f7b68884b6eb5e61f638a9b0c67 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc6116f7b68884b6eb5e61f638a9b0c67 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc6116f7b68884b6eb5e61f638a9b0c67 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idee17ec31218641f28fbbd8d67064b1ec" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading37" runat="server" Text="Type of Exposure" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idee17ec31218641f28fbbd8d67064b1ec div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idee17ec31218641f28fbbd8d67064b1ec div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idee17ec31218641f28fbbd8d67064b1ec div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idee17ec31218641f28fbbd8d67064b1ec label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idee17ec31218641f28fbbd8d67064b1ec label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idee17ec31218641f28fbbd8d67064b1ec label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idee17ec31218641f28fbbd8d67064b1ec label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idee17ec31218641f28fbbd8d67064b1ec input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idee17ec31218641f28fbbd8d67064b1ec input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idee17ec31218641f28fbbd8d67064b1ec input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idee0bb879d0e840878fdf60e9b9ea416c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading38" runat="server" Text="Risk" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idee0bb879d0e840878fdf60e9b9ea416c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idee0bb879d0e840878fdf60e9b9ea416c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idee0bb879d0e840878fdf60e9b9ea416c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idee0bb879d0e840878fdf60e9b9ea416c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idee0bb879d0e840878fdf60e9b9ea416c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idee0bb879d0e840878fdf60e9b9ea416c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idee0bb879d0e840878fdf60e9b9ea416c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idee0bb879d0e840878fdf60e9b9ea416c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idee0bb879d0e840878fdf60e9b9ea416c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idee0bb879d0e840878fdf60e9b9ea416c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2b32c9355c2a43d998c8bcf8d3b09415" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading39" runat="server" Text="Maximum Loss - Theft" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2b32c9355c2a43d998c8bcf8d3b09415 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2b32c9355c2a43d998c8bcf8d3b09415 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2b32c9355c2a43d998c8bcf8d3b09415 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2b32c9355c2a43d998c8bcf8d3b09415 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2b32c9355c2a43d998c8bcf8d3b09415 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b32c9355c2a43d998c8bcf8d3b09415 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b32c9355c2a43d998c8bcf8d3b09415 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2b32c9355c2a43d998c8bcf8d3b09415 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b32c9355c2a43d998c8bcf8d3b09415 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b32c9355c2a43d998c8bcf8d3b09415 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id27738ac7a7844d22915435edae154574" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECTEQUIP__ELEQMP"
		data-field-type="Child" 
		data-object-name="ELECTEQUIP" 
		data-property-name="ELEQMP" 
		id="pb-container-childscreen-ELECTEQUIP-ELEQMP">
		
		    <legend>Multiple Premises</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECTEQUIP__EE_MULTIPLE_PREMISES" runat="server" ScreenCode="ELEQMP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ELEQMP/ELEQMP_Multiple_Premises.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Sum Insured" DataField="SUMINSURED" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECTEQUIP_ELEQMP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Multiple Premises"
						ClientValidationFunction="onValidate_ELECTEQUIP__ELEQMP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id27738ac7a7844d22915435edae154574 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id27738ac7a7844d22915435edae154574 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id27738ac7a7844d22915435edae154574 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id27738ac7a7844d22915435edae154574 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id27738ac7a7844d22915435edae154574 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27738ac7a7844d22915435edae154574 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27738ac7a7844d22915435edae154574 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id27738ac7a7844d22915435edae154574 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27738ac7a7844d22915435edae154574 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27738ac7a7844d22915435edae154574 input{text-align:left;}"; break;
		}
	}
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECTEQUIP__EEENDPREM"
		data-field-type="Child" 
		data-object-name="ELECTEQUIP" 
		data-property-name="EEENDPREM" 
		id="pb-container-childscreen-ELECTEQUIP-EEENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECTEQUIP__EE_CLAUSE" runat="server" ScreenCode="EEENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EEENDPREM/EEENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECTEQUIP_EEENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ELECTEQUIP.EEENDPREM"
						ClientValidationFunction="onValidate_ELECTEQUIP__EEENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id26506c1129a942a999731d97532babb5" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id26506c1129a942a999731d97532babb5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id26506c1129a942a999731d97532babb5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id26506c1129a942a999731d97532babb5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id26506c1129a942a999731d97532babb5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id26506c1129a942a999731d97532babb5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id26506c1129a942a999731d97532babb5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id26506c1129a942a999731d97532babb5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id26506c1129a942a999731d97532babb5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id26506c1129a942a999731d97532babb5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id26506c1129a942a999731d97532babb5 input{text-align:left;}"; break;
		}
	}
