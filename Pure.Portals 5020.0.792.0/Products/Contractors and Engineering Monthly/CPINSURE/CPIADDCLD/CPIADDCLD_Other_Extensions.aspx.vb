...
Namespace Nexus
    Partial Class PB2_CPIADDCLD_Other_Extensions : Inherits BaseRisk
		...
		Protected Sub onValidate_OTHERSPEC__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_OTHERSPEC__COUNTER_ID()
End Sub

		    
        'OTHER - Parent object
        'OTHERSPEC - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "OTHER" & "/" & "OTHERSPEC", sXMLDataset)
                            If sChildId <> "0" Then
                                OTHERSPEC__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
