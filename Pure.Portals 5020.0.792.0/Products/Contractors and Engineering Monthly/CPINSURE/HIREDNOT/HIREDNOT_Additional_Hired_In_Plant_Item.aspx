<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="HIREDNOT_Additional_Hired_In_Plant_Item.aspx.vb" Inherits="Nexus.PB2_HIREDNOT_Additional_Hired_In_Plant_Item" %>
...
function onValidate_ADDHIRE__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDHIRE", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("ADDHIRE", "COUNTER_ID");
        		}
...
function onValidate_ADDHIRE__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDHIRE", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ADDHIRE", "DESCRIPTION");
        		var errorMessage = "{0}";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDHIRE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDHIRE__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDHIRE__DESCRIPTION_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDHIRE.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "ADDHIRE", "DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_ADDHIRE__MAX_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDHIRE", "MAX_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDHIRE", "MAX_LIMIT");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDHIRE_MAX_LIMIT");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDHIRE__MAX_LIMIT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDHIRE__MAX_LIMIT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDHIRE.MAX_LIMIT");
        			window.setControlWidth(field, "0.8", "ADDHIRE", "MAX_LIMIT");
        		})();
        	}
        })();
...
function onValidate_ADDHIRE__ANN_FEES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDHIRE", "ANN_FEES", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDHIRE", "ANN_FEES");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDHIRE_ANN_FEES");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDHIRE__ANN_FEES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDHIRE__ANN_FEES_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDHIRE.ANN_FEES");
        			window.setControlWidth(field, "0.8", "ADDHIRE", "ANN_FEES");
        		})();
        	}
        })();
...
function onValidate_ADDHIRE__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDHIRE", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDHIRE", "RATE");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDHIRE_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDHIRE__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDHIRE__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDHIRE.RATE");
        			window.setControlWidth(field, "0.8", "ADDHIRE", "RATE");
        		})();
        	}
        })();
        /**
...
function onValidate_ADDHIRE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDHIRE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDHIRE", "PREMIUM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDHIRE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDHIRE__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDHIRE__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDHIRE.PREMIUM");
        			window.setControlWidth(field, "0.8", "ADDHIRE", "PREMIUM");
        		})();
        	}
        })();
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=ADDHIRE&propertyName=PREMIUM&name={name}");
        		
        		var value = new Expression("ADDHIRE.ANN_FEES * ADDHIRE.RATE * 0.01"), 
...
function DoLogic(isOnLoad) {
    onValidate_ADDHIRE__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_ADDHIRE__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_ADDHIRE__MAX_LIMIT(null, null, null, isOnLoad);
    onValidate_ADDHIRE__ANN_FEES(null, null, null, isOnLoad);
    onValidate_ADDHIRE__RATE(null, null, null, isOnLoad);
    onValidate_ADDHIRE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idb68798c4e778403b82bba5ad0ee4eab3" class="general-layout-container">
...
<div id="id8c9c558f8aeb4d12942cc121abfbc43f" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ADDHIRE" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-ADDHIRE-COUNTER_ID">

		
		<asp:Label ID="lblADDHIRE_COUNTER_ID" runat="server" AssociatedControlID="ADDHIRE__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ADDHIRE__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valADDHIRE_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_ADDHIRE__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-ADDHIRE-DESCRIPTION">

		
		<asp:Label ID="lblADDHIRE_DESCRIPTION" runat="server" AssociatedControlID="ADDHIRE__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ADDHIRE__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valADDHIRE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_ADDHIRE__DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ADDHIRE-MAX_LIMIT">
		<asp:Label ID="lblADDHIRE_MAX_LIMIT" runat="server" AssociatedControlID="ADDHIRE__MAX_LIMIT" 
			Text="Maximum Item Limit" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDHIRE__MAX_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDHIRE_MAX_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Item Limit"
			ClientValidationFunction="onValidate_ADDHIRE__MAX_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="ADDHIRE" 
		data-property-name="ANN_FEES" 
		id="pb-container-currency-ADDHIRE-ANN_FEES">
		<asp:Label ID="lblADDHIRE_ANN_FEES" runat="server" AssociatedControlID="ADDHIRE__ANN_FEES" 
			Text="Estimated Annual Hire Fees" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDHIRE__ANN_FEES" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDHIRE_ANN_FEES" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Estimated Annual Hire Fees"
			ClientValidationFunction="onValidate_ADDHIRE__ANN_FEES" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-ADDHIRE-RATE">
		<asp:Label ID="lblADDHIRE_RATE" runat="server" AssociatedControlID="ADDHIRE__RATE" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="ADDHIRE__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valADDHIRE_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_ADDHIRE__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ADDHIRE-PREMIUM">
		<asp:Label ID="lblADDHIRE_PREMIUM" runat="server" AssociatedControlID="ADDHIRE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDHIRE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDHIRE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_ADDHIRE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8c9c558f8aeb4d12942cc121abfbc43f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8c9c558f8aeb4d12942cc121abfbc43f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8c9c558f8aeb4d12942cc121abfbc43f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8c9c558f8aeb4d12942cc121abfbc43f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8c9c558f8aeb4d12942cc121abfbc43f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8c9c558f8aeb4d12942cc121abfbc43f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8c9c558f8aeb4d12942cc121abfbc43f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8c9c558f8aeb4d12942cc121abfbc43f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8c9c558f8aeb4d12942cc121abfbc43f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8c9c558f8aeb4d12942cc121abfbc43f input{text-align:left;}"; break;
		}
	}
