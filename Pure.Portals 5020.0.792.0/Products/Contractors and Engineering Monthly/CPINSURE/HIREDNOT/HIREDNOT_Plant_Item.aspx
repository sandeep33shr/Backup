<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="HIREDNOT_Plant_Item.aspx.vb" Inherits="Nexus.PB2_HIREDNOT_Plant_Item" %>
...
function onValidate_PLANTVALDN__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTVALDN", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTVALDN", "DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANTVALDN.DESCRIPTION");
        			window.setControlWidth(field, "0.5", "PLANTVALDN", "DESCRIPTION");
        		})();
        	}
        })();
}
function onValidate_PLANTVALDN__EXC_VALUE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTVALDN", "EXC_VALUE", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTVALDN", "EXC_VALUE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANTVALDN.EXC_VALUE");
        			window.setControlWidth(field, "0.5", "PLANTVALDN", "EXC_VALUE");
        		})();
        	}
        })();
...
function onValidate_PLANTVALDN__NOT_EXC_VALUE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTVALDN", "NOT_EXC_VALUE", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTVALDN", "NOT_EXC_VALUE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANTVALDN.NOT_EXC_VALUE");
        			window.setControlWidth(field, "0.5", "PLANTVALDN", "NOT_EXC_VALUE");
        		})();
        	}
        })();
...
function onValidate_PLANTVALDN__MIN_DED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTVALDN", "MIN_DED", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTVALDN", "MIN_DED");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANTVALDN.MIN_DED");
        			window.setControlWidth(field, "0.5", "PLANTVALDN", "MIN_DED");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANTVALDN__DEDUCT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PLANTVALDN", "DEDUCT", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PLANTVALDN", "DEDUCT");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANTVALDN.DEDUCT");
        			window.setControlWidth(field, "0.5", "PLANTVALDN", "DEDUCT");
        		})();
        	}
        })();
...
function DoLogic(isOnLoad) {
    onValidate_PLANTVALDN__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_PLANTVALDN__EXC_VALUE(null, null, null, isOnLoad);
    onValidate_PLANTVALDN__NOT_EXC_VALUE(null, null, null, isOnLoad);
    onValidate_PLANTVALDN__MIN_DED(null, null, null, isOnLoad);
    onValidate_PLANTVALDN__DEDUCT(null, null, null, isOnLoad);
}
</script>
...
<div id="id90a01cc5580542c6b8068f40a700b881" class="general-layout-container">
...
<div id="idbcbbd0d6695b4c0494a53656940d462e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="Hired In Plant Item" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PLANTVALDN" 
		data-property-name="DESCRIPTION" 
		 
		
		 
		id="pb-container-text-PLANTVALDN-DESCRIPTION">

		
		<asp:Label ID="lblPLANTVALDN_DESCRIPTION" runat="server" AssociatedControlID="PLANTVALDN__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PLANTVALDN__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPLANTVALDN_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_PLANTVALDN__DESCRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PLANTVALDN-EXC_VALUE">
		<asp:Label ID="lblPLANTVALDN_EXC_VALUE" runat="server" AssociatedControlID="PLANTVALDN__EXC_VALUE" 
			Text="Maximum Item Limit" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PLANTVALDN__EXC_VALUE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPLANTVALDN_EXC_VALUE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Item Limit"
			ClientValidationFunction="onValidate_PLANTVALDN__EXC_VALUE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PLANTVALDN-NOT_EXC_VALUE">
		<asp:Label ID="lblPLANTVALDN_NOT_EXC_VALUE" runat="server" AssociatedControlID="PLANTVALDN__NOT_EXC_VALUE" 
			Text="Estimated Annual Hire Fees" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PLANTVALDN__NOT_EXC_VALUE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPLANTVALDN_NOT_EXC_VALUE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Estimated Annual Hire Fees"
			ClientValidationFunction="onValidate_PLANTVALDN__NOT_EXC_VALUE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-PLANTVALDN-MIN_DED">
		<asp:Label ID="lblPLANTVALDN_MIN_DED" runat="server" AssociatedControlID="PLANTVALDN__MIN_DED" 
			Text="Rate%" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PLANTVALDN__MIN_DED" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPLANTVALDN_MIN_DED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate%"
			ClientValidationFunction="onValidate_PLANTVALDN__MIN_DED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PLANTVALDN-DEDUCT">
		<asp:Label ID="lblPLANTVALDN_DEDUCT" runat="server" AssociatedControlID="PLANTVALDN__DEDUCT" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PLANTVALDN__DEDUCT" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="BASISDED" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PLANTVALDN__DEDUCT(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPLANTVALDN_DEDUCT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PLANTVALDN__DEDUCT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idbcbbd0d6695b4c0494a53656940d462e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbcbbd0d6695b4c0494a53656940d462e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbcbbd0d6695b4c0494a53656940d462e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idbcbbd0d6695b4c0494a53656940d462e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbcbbd0d6695b4c0494a53656940d462e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbcbbd0d6695b4c0494a53656940d462e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbcbbd0d6695b4c0494a53656940d462e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbcbbd0d6695b4c0494a53656940d462e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbcbbd0d6695b4c0494a53656940d462e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbcbbd0d6695b4c0494a53656940d462e input{text-align:left;}"; break;
		}
	}
