<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OWNSNOTES_Notes_Detials.aspx.vb" Inherits="Nexus.PB2_OWNSNOTES_Notes_Detials" %>
...
function onValidate_OWNNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "OWNNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=OWNNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_OWNNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "OWNNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_OWNNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "OWNNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=OWNNOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_OWNNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNNOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "OWNNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_OWNNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OWNNOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "OWNNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=OWNNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_OWNNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_OWNNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_OWNNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_OWNNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_OWNNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_OWNNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_OWNNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id7fd81a2b8df44f0bbcf85a152928637f" class="general-layout-container">
...
<div id="id6c2f7819cf844bce8f717f55a95d2639" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="Construction Plant Insurance Notes (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OWNNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-OWNNOTES-DATE_CREATED">
		<asp:Label ID="lblOWNNOTES_DATE_CREATED" runat="server" AssociatedControlID="OWNNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="OWNNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calOWNNOTES__DATE_CREATED" runat="server" LinkedControl="OWNNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valOWNNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_OWNNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNNOTES-CREATED_BY">

		
		<asp:Label ID="lblOWNNOTES_CREATED_BY" runat="server" AssociatedControlID="OWNNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_OWNNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNNOTES-COVER_TYPE">

		
		<asp:Label ID="lblOWNNOTES_COVER_TYPE" runat="server" AssociatedControlID="OWNNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_OWNNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblOWNNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="OWNNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_OWNNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-OWNNOTES-NOTE_DETAILS">
		<asp:Label ID="lblOWNNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="OWNNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="OWNNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valOWNNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_OWNNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6c2f7819cf844bce8f717f55a95d2639 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6c2f7819cf844bce8f717f55a95d2639 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6c2f7819cf844bce8f717f55a95d2639 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6c2f7819cf844bce8f717f55a95d2639 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6c2f7819cf844bce8f717f55a95d2639 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c2f7819cf844bce8f717f55a95d2639 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c2f7819cf844bce8f717f55a95d2639 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6c2f7819cf844bce8f717f55a95d2639 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c2f7819cf844bce8f717f55a95d2639 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c2f7819cf844bce8f717f55a95d2639 input{text-align:left;}"; break;
		}
	}
