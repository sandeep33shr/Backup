<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OWNNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_OWNNOTES_Note_Details" %>
...
function onValidate_OWNSNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNSNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "OWNSNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=OWNSNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_OWNSNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNSNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "OWNSNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_OWNSNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNSNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "OWNSNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=OWNSNOTES&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'Own Plants'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_OWNSNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OWNSNOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "OWNSNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_OWNSNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OWNSNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OWNSNOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OWNSNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "OWNSNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=OWNSNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_OWNSNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_OWNSNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_OWNSNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_OWNSNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_OWNSNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_OWNSNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_OWNSNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id5ee7afbd53884a2c95577b0a2cd599c5" class="general-layout-container">
...
<div id="id60ff625aaf8847b6a7273c9d6fa75bb1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Construction Plant Insurance Notes (Printed On Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="OWNSNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-OWNSNOTES-DATE_CREATED">
		<asp:Label ID="lblOWNSNOTES_DATE_CREATED" runat="server" AssociatedControlID="OWNSNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="OWNSNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calOWNSNOTES__DATE_CREATED" runat="server" LinkedControl="OWNSNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valOWNSNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_OWNSNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNSNOTES-CREATED_BY">

		
		<asp:Label ID="lblOWNSNOTES_CREATED_BY" runat="server" AssociatedControlID="OWNSNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNSNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNSNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_OWNSNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNSNOTES-COVER_TYPE">

		
		<asp:Label ID="lblOWNSNOTES_COVER_TYPE" runat="server" AssociatedControlID="OWNSNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNSNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNSNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_OWNSNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OWNSNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblOWNSNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="OWNSNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OWNSNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOWNSNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_OWNSNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-OWNSNOTES-NOTE_DETAILS">
		<asp:Label ID="lblOWNSNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="OWNSNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="OWNSNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valOWNSNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_OWNSNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id60ff625aaf8847b6a7273c9d6fa75bb1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id60ff625aaf8847b6a7273c9d6fa75bb1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id60ff625aaf8847b6a7273c9d6fa75bb1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id60ff625aaf8847b6a7273c9d6fa75bb1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id60ff625aaf8847b6a7273c9d6fa75bb1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60ff625aaf8847b6a7273c9d6fa75bb1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60ff625aaf8847b6a7273c9d6fa75bb1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id60ff625aaf8847b6a7273c9d6fa75bb1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60ff625aaf8847b6a7273c9d6fa75bb1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60ff625aaf8847b6a7273c9d6fa75bb1 input{text-align:left;}"; break;
		}
	}
