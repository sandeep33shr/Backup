<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PLANTSNOTE_Note_Detail.aspx.vb" Inherits="Nexus.PB2_PLANTSNOTE_Note_Detail" %>
...
function onValidate_PLANT_SCNOTE_DETAIL__DATE_CREATED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANT_SCNOTE_DETAIL.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "PLANT_SCNOTE_DETAIL", "DATE_CREATED");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANT_SCNOTE_DETAIL__CREATED_BY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANT_SCNOTE_DETAIL.CREATED_BY");
        			window.setControlWidth(field, "0.5", "PLANT_SCNOTE_DETAIL", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_PLANT_SCNOTE_DETAIL__COVER_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANT_SCNOTE_DETAIL.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "PLANT_SCNOTE_DETAIL", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANT_SCNOTE_DETAIL.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "PLANT_SCNOTE_DETAIL", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_PLANT_SCNOTE_DETAIL__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANT_SCNOTE_DETAIL.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "PLANT_SCNOTE_DETAIL", "NOTE_DETAILS");
        		})();
        	}
        })();
...
<div id="id50762b8141eb400caabde298505d45ae" class="general-layout-container">
...
<div id="idd5681a9233814110ab834df4686f1e9f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading9" runat="server" Text="Note Detail  (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd5681a9233814110ab834df4686f1e9f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd5681a9233814110ab834df4686f1e9f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd5681a9233814110ab834df4686f1e9f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd5681a9233814110ab834df4686f1e9f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd5681a9233814110ab834df4686f1e9f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd5681a9233814110ab834df4686f1e9f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd5681a9233814110ab834df4686f1e9f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd5681a9233814110ab834df4686f1e9f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd5681a9233814110ab834df4686f1e9f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd5681a9233814110ab834df4686f1e9f input{text-align:left;}"; break;
		}
	}
