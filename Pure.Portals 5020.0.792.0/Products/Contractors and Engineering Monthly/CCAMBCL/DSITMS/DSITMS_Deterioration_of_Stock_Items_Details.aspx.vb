...
Namespace Nexus
    Partial Class PB2_DSITMS_Deterioration_of_Stock_Items_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_DS_ITEM__INCR()
        
End Sub
Protected Sub onValidate_DS_ITEM__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DS_ITEM__INCR()
    onValidate_DS_ITEM__COUNTER_ID()
End Sub
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "DSTOCK" & "/" & "DS_ITEM", sXMLDataset)
                            If sChildId <> "0" Then
                                DS_ITEM__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
