...
Namespace Nexus
    Partial Class PB2_DSISNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_DSITEM_SNOTES__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If DSITEM_SNOTES__Date_Created.Text.ToString = "" Then
        		DSITEM_SNOTES__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		DSITEM_SNOTES__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_DSITEM_SNOTES__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DSITEM_SNOTES__NOTE_DETAILS()
    onValidate_DSITEM_SNOTES__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		DSITEM_SNOTES__NoteCheck.Text = 1
        	End If
        End Sub
