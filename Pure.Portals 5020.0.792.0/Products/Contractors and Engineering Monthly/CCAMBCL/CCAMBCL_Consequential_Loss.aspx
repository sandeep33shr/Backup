<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAMBCL_Consequential_Loss.aspx.vb" Inherits="Nexus.PB2_CCAMBCL_Consequential_Loss" %>
...
function onValidate_CLOSS__CLENDPRE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CLENDPRE", "ChildScreen");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CLOSS", "CLENDPRE");
        		var update = function(){
                var links;
        		if (field.getType() == "child_screen"){
        			// Remove the options from the table
        		   links = goog.dom.query("#ctl00_cntMainBody_CLOSS__CLENDPRE table td a");
...
function onValidate_CLOSS__CLNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CLNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CLOSS", "CLNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_CLOSS__CLNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CLOSS", "CLNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CLOSS' and property 'CLNOTE'.");
        			error.display();
...
function onValidate_CLOSS__CLSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CLSNOTE", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("CLOSS", "CLSNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_CLOSS__CLSNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CLOSS", "CLSNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CLOSS' and property 'CLSNOTE'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CLOSS__CLENDPRE(null, null, null, isOnLoad);
    onValidate_CLOSS__CL_COUNT(null, null, null, isOnLoad);
    onValidate_CLOSS__CLNOTE(null, null, null, isOnLoad);
    onValidate_CLOSS__CLSNOTE(null, null, null, isOnLoad);
...
<div id="idab680afa002a4fe7937cf158c77caffd" class="general-layout-container">
...
<div id="idd9861fe7fb7149688fe5a3f24ce893fd" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd9861fe7fb7149688fe5a3f24ce893fd div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd9861fe7fb7149688fe5a3f24ce893fd div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd9861fe7fb7149688fe5a3f24ce893fd div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd9861fe7fb7149688fe5a3f24ce893fd label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd9861fe7fb7149688fe5a3f24ce893fd label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd9861fe7fb7149688fe5a3f24ce893fd label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd9861fe7fb7149688fe5a3f24ce893fd label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd9861fe7fb7149688fe5a3f24ce893fd input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd9861fe7fb7149688fe5a3f24ce893fd input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd9861fe7fb7149688fe5a3f24ce893fd input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id83a729e01a26405ea9f9aa1da7eb41b7" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading50" runat="server" Text="Consequential Loss " /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id83a729e01a26405ea9f9aa1da7eb41b7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id83a729e01a26405ea9f9aa1da7eb41b7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id83a729e01a26405ea9f9aa1da7eb41b7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id83a729e01a26405ea9f9aa1da7eb41b7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id83a729e01a26405ea9f9aa1da7eb41b7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id83a729e01a26405ea9f9aa1da7eb41b7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id83a729e01a26405ea9f9aa1da7eb41b7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id83a729e01a26405ea9f9aa1da7eb41b7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id83a729e01a26405ea9f9aa1da7eb41b7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id83a729e01a26405ea9f9aa1da7eb41b7 input{text-align:left;}"; break;
		}
	}
...
<div id="frmCL" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading51" runat="server" Text="" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label27">
		<span class="label" id="label27">Rate</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label28">
		<span class="label" id="label28">Posting Premium </span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label29">
		<span class="label" id="label29">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label30">
		<span class="label" id="label30">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label31">
		<span class="label" id="label31">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label34">
		<span class="label" id="label34">Additional Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label35">
		<span class="label" id="label35">Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<div id="frmCLEnd" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading53" runat="server" Text="Endorsements" /></legend>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CLENDPRE"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CLENDPRE" 
		id="pb-container-childscreen-CLOSS-CLENDPRE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_CLAUSEPREM" runat="server" ScreenCode="CLENDPRE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLENDPRE/CLENDPRE_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCLOSS_CLENDPRE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CLENDPRE"
						ClientValidationFunction="onValidate_CLOSS__CLENDPRE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmCLNOTE" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading54" runat="server" Text="Consequential Loss Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CLNOTE"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CLNOTE" 
		id="pb-container-childscreen-CLOSS-CLNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_NOTES" runat="server" ScreenCode="CLNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLNOTE/CLNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCLOSS_CLNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CLNOTE"
						ClientValidationFunction="onValidate_CLOSS__CLNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmCLNOTE div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmCLNOTE div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmCLNOTE div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmCLNOTE label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmCLNOTE label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmCLNOTE label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmCLNOTE label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmCLNOTE input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmCLNOTE input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmCLNOTE input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmCLSNOTE" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading55" runat="server" Text="Consequential Loss Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CLSNOTE"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CLSNOTE" 
		id="pb-container-childscreen-CLOSS-CLSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_SNOTES" runat="server" ScreenCode="CLSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLSNOTE/CLSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCLOSS_CLSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CLSNOTE"
						ClientValidationFunction="onValidate_CLOSS__CLSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#frmCLSNOTE div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmCLSNOTE div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmCLSNOTE div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#frmCLSNOTE label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmCLSNOTE label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmCLSNOTE label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmCLSNOTE label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmCLSNOTE input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmCLSNOTE input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmCLSNOTE input{text-align:left;}"; break;
		}
	}
