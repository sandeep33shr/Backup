...
<div id="id08121e2551e1406985730a68481cb5b2" class="general-layout-container">
...
<div id="id9e9fd6adc0154c35b31a172b6e803fc3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading31" runat="server" Text="Note Details (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9e9fd6adc0154c35b31a172b6e803fc3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9e9fd6adc0154c35b31a172b6e803fc3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9e9fd6adc0154c35b31a172b6e803fc3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9e9fd6adc0154c35b31a172b6e803fc3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9e9fd6adc0154c35b31a172b6e803fc3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9e9fd6adc0154c35b31a172b6e803fc3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9e9fd6adc0154c35b31a172b6e803fc3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9e9fd6adc0154c35b31a172b6e803fc3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9e9fd6adc0154c35b31a172b6e803fc3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9e9fd6adc0154c35b31a172b6e803fc3 input{text-align:left;}"; break;
		}
	}
