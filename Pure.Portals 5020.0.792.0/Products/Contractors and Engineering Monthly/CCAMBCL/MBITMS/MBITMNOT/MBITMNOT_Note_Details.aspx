<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBITMNOT_Note_Details.aspx.vb" Inherits="Nexus.PB2_MBITMNOT_Note_Details" %>
...
function onValidate_MBITEM_CNOTE__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_CNOTE.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "3", "MBITEM_CNOTE", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
...
function onValidate_MBITEM_CNOTE__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_CNOTE.NOTE_DETAILS");
        			window.setControlWidth(field, "3", "MBITEM_CNOTE", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
...
<div id="id354b886d9f3c4f6e9a7ca18be1144afb" class="general-layout-container">
...
<div id="ida65e0446e6564486aea044497f9562d3" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida65e0446e6564486aea044497f9562d3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida65e0446e6564486aea044497f9562d3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida65e0446e6564486aea044497f9562d3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida65e0446e6564486aea044497f9562d3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida65e0446e6564486aea044497f9562d3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida65e0446e6564486aea044497f9562d3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida65e0446e6564486aea044497f9562d3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida65e0446e6564486aea044497f9562d3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida65e0446e6564486aea044497f9562d3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida65e0446e6564486aea044497f9562d3 input{text-align:left;}"; break;
		}
	}
