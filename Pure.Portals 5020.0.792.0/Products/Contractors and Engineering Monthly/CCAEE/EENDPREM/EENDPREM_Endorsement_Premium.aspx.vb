...
Namespace Nexus
    Partial Class PB2_EENDPREM_Endorsement_Premium : Inherits BaseRisk
...
End Sub
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/ELECTEQUIP/SW.REFERRAL_CLAUSES")
