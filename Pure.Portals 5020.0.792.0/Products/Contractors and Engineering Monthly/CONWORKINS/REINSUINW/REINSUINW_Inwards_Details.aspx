        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONTESTP.COMPANY");
        			window.setControlWidth(field, "0.8", "CONTESTP", "COMPANY");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONTESTP.PER_SHARE");
        			window.setControlWidth(field, "0.8", "CONTESTP", "PER_SHARE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CONTESTP.NOTES");
        			window.setControlWidth(field, "0.8", "CONTESTP", "NOTES");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please enter any information in order to proceed")) ? "Please enter any information in order to proceed" : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(CONTESTP.COMPANY <> '' AND CONTESTP.COMPANY <> null) || (CONTESTP.PER_SHARE <> '' AND CONTESTP.PER_SHARE <> null)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
<div id="ide8d46660927b47f6ba7b9876c055d422" class="general-layout-container">
...
<div id="id9ff00c186fed46129bc0e71c7cfbbe94" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9ff00c186fed46129bc0e71c7cfbbe94 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9ff00c186fed46129bc0e71c7cfbbe94 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9ff00c186fed46129bc0e71c7cfbbe94 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9ff00c186fed46129bc0e71c7cfbbe94 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9ff00c186fed46129bc0e71c7cfbbe94 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9ff00c186fed46129bc0e71c7cfbbe94 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9ff00c186fed46129bc0e71c7cfbbe94 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9ff00c186fed46129bc0e71c7cfbbe94 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9ff00c186fed46129bc0e71c7cfbbe94 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9ff00c186fed46129bc0e71c7cfbbe94 input{text-align:left;}"; break;
		}
	}
