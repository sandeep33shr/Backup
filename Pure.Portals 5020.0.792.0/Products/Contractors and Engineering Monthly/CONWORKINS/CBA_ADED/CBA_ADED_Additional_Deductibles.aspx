<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CBA_ADED_Additional_Deductibles.aspx.vb" Inherits="Nexus.PB2_CBA_ADED_Additional_Deductibles" %>
...
function onValidate_ADDDEDUC__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("ADDDEDUC", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_ADDDEDUC__DED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "DED", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "DED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.DED");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "DED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_DED");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC__DED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC__DED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "__" + "DED");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "_" + "DED");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(ADDDEDUC.DED == '' OR ADDDEDUC.DED == null) OR (ADDDEDUC.DED > 0 AND ADDDEDUC.DED <= 100 AND (ADDDEDUC.DED <> '' AND ADDDEDUC.DED <> null))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADDDEDUC__MIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "MIN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "MIN");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.MIN");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "MIN");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_MIN");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC__MIN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC__MIN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ADDDEDUC__MAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "MAX", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "MAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.MAX");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "MAX");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_MAX");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC__MAX');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC__MAX_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "__" + "MAX");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "ADDDEDUC".toUpperCase() + "_" + "MAX");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(ADDDEDUC.MAX = '' OR ADDDEDUC.MAX = null) || (ADDDEDUC.MAX > ADDDEDUC.MIN && (ADDDEDUC.MIN <> '' OR ADDDEDUC.MIN <> null))");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_ADDDEDUC__BASIS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDDEDUC", "BASIS", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDDEDUC", "BASIS");
        		}
        		//window.setProperty(field, "VEM", "ADDDEDUC.DED <> '' AND ADDDEDUC.DED <> null", "V", "Basis of Deductible is mandatory and an option must be selected");
        
            var paramValue = "VEM",
            paramCondition = "ADDDEDUC.DED <> '' AND ADDDEDUC.DED <> null",
            paramElseValue = "V",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDDEDUC.BASIS");
        			window.setControlWidth(field, "0.8", "ADDDEDUC", "BASIS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDDEDUC_BASIS");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDDEDUC__BASIS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDDEDUC__BASIS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("ADDDEDUC.DED <> '' AND ADDDEDUC.DED <> null")) ? new Expression("ADDDEDUC.DED <> '' AND ADDDEDUC.DED <> null") : null;
...
function DoLogic(isOnLoad) {
    onValidate_ADDDEDUC__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_ADDDEDUC__DED(null, null, null, isOnLoad);
    onValidate_ADDDEDUC__MIN(null, null, null, isOnLoad);
    onValidate_ADDDEDUC__MAX(null, null, null, isOnLoad);
    onValidate_ADDDEDUC__BASIS(null, null, null, isOnLoad);
}
</script>
...
<div id="idf446d6e8d71e43ca9163f3b39e2d3615" class="general-layout-container">
...
<div id="id3a3615da448643239eef3339dda1ea51" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="ADDDEDUC" 
		data-property-name="DESCRIPTION" 
		 
		
		 
		id="pb-container-text-ADDDEDUC-DESCRIPTION">

		
		<asp:Label ID="lblADDDEDUC_DESCRIPTION" runat="server" AssociatedControlID="ADDDEDUC__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ADDDEDUC__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valADDDEDUC_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_ADDDEDUC__DESCRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-ADDDEDUC-DED">
		<asp:Label ID="lblADDDEDUC_DED" runat="server" AssociatedControlID="ADDDEDUC__DED" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="ADDDEDUC__DED" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valADDDEDUC_DED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_ADDDEDUC__DED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ADDDEDUC-MIN">
		<asp:Label ID="lblADDDEDUC_MIN" runat="server" AssociatedControlID="ADDDEDUC__MIN" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDDEDUC__MIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDDEDUC_MIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_ADDDEDUC__MIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ADDDEDUC-MAX">
		<asp:Label ID="lblADDDEDUC_MAX" runat="server" AssociatedControlID="ADDDEDUC__MAX" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ADDDEDUC__MAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valADDDEDUC_MAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_ADDDEDUC__MAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-ADDDEDUC-BASIS">
		<asp:Label ID="lblADDDEDUC_BASIS" runat="server" AssociatedControlID="ADDDEDUC__BASIS" 
			Text="Basis of deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="ADDDEDUC__BASIS" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CW_BASISDED" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_ADDDEDUC__BASIS(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valADDDEDUC_BASIS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of deductible"
			ClientValidationFunction="onValidate_ADDDEDUC__BASIS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-ADDDEDUC-BASISCode">

		
		
			
		
				<asp:HiddenField ID="ADDDEDUC__BASISCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3a3615da448643239eef3339dda1ea51 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3a3615da448643239eef3339dda1ea51 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3a3615da448643239eef3339dda1ea51 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3a3615da448643239eef3339dda1ea51 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3a3615da448643239eef3339dda1ea51 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3a3615da448643239eef3339dda1ea51 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3a3615da448643239eef3339dda1ea51 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3a3615da448643239eef3339dda1ea51 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3a3615da448643239eef3339dda1ea51 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3a3615da448643239eef3339dda1ea51 input{text-align:left;}"; break;
		}
	}
