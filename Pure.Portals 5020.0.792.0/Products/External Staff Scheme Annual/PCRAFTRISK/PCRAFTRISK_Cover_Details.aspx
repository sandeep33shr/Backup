<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PCRAFTRISK_Cover_Details.aspx.vb" Inherits="Nexus.PB2_PCRAFTRISK_Cover_Details" %>
...
function onValidate_GENERAL__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "DESCRIPTION");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'Pleasure Craft - ' + PCRAFTRISK.VESSELNAME"), 
...
function onValidate_GENERAL__PCMTARSN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "PCMTARSN", "ChildScreen");
        })();
}
function onValidate_ADDRESS__ADDRESSLIST(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDRESS.ADDRESSLIST");
        			window.setControlWidth(field, "0.6", "ADDRESS", "ADDRESSLIST");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.SITEADDRESSLIST");
        			window.setControlWidth(field, "0.6", "ADDRESS", "SITEADDRESSLIST");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.HOMEADDRESSLIST");
        			window.setControlWidth(field, "0.6", "ADDRESS", "HOMEADDRESSLIST");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.B_ADDRESSLIST");
        			window.setControlWidth(field, "0.6", "ADDRESS", "B_ADDRESSLIST");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.LINE1");
        			window.setControlWidth(field, "0.6", "ADDRESS", "LINE1");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.SUBURB");
        			window.setControlWidth(field, "0.6", "ADDRESS", "SUBURB");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.TOWN");
        			window.setControlWidth(field, "0.6", "ADDRESS", "TOWN");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.POSTCODE");
        			window.setControlWidth(field, "0.6", "ADDRESS", "POSTCODE");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.REGION");
        			window.setControlWidth(field, "0.6", "ADDRESS", "REGION");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("ADDRESS.COUNTRY");
        			window.setControlWidth(field, "0.6", "ADDRESS", "COUNTRY");
        		})();
        	}
        })();
}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.ULTIMATECLIENT");
        			window.setControlWidth(field, "0.6", "GENERAL", "ULTIMATECLIENT");
        		})();
        	}
        })();
}
function onValidate_GENERAL__DOB(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "DOB");
        		}
        		//window.setProperty(field, "V", "GENERAL.CLIENTTYPE =='PERSONAL'", "VEM", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.DOB");
        			window.setControlWidth(field, "0.6", "GENERAL", "DOB");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Invalid date of birth or date format")) ? "Invalid date of birth or date format" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "DOB");
        				if (node == null){
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__PCMTARSN(null, null, null, isOnLoad);
...
<div id="id681961ba96194ab8b4f7746853df2e19" class="general-layout-container">
...
<div id="idaa53b9000b9e40e58fefb0f9d7d0130d" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idaa53b9000b9e40e58fefb0f9d7d0130d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idaa53b9000b9e40e58fefb0f9d7d0130d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idaa53b9000b9e40e58fefb0f9d7d0130d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idaa53b9000b9e40e58fefb0f9d7d0130d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idaa53b9000b9e40e58fefb0f9d7d0130d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaa53b9000b9e40e58fefb0f9d7d0130d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaa53b9000b9e40e58fefb0f9d7d0130d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idaa53b9000b9e40e58fefb0f9d7d0130d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaa53b9000b9e40e58fefb0f9d7d0130d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaa53b9000b9e40e58fefb0f9d7d0130d input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__PCMTARSN"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="PCMTARSN" 
		id="pb-container-childscreen-GENERAL-PCMTARSN">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="PCMTARSN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PCMTARSN/PCMTARSN_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_PCMTARSN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.PCMTARSN"
						ClientValidationFunction="onValidate_GENERAL__PCMTARSN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5041c88ca5b54c9aa2f647a5f628d32b" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5041c88ca5b54c9aa2f647a5f628d32b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5041c88ca5b54c9aa2f647a5f628d32b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5041c88ca5b54c9aa2f647a5f628d32b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5041c88ca5b54c9aa2f647a5f628d32b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5041c88ca5b54c9aa2f647a5f628d32b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5041c88ca5b54c9aa2f647a5f628d32b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5041c88ca5b54c9aa2f647a5f628d32b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5041c88ca5b54c9aa2f647a5f628d32b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5041c88ca5b54c9aa2f647a5f628d32b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5041c88ca5b54c9aa2f647a5f628d32b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide22a8a6235604df7870c271fc3fd6215" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide22a8a6235604df7870c271fc3fd6215 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide22a8a6235604df7870c271fc3fd6215 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide22a8a6235604df7870c271fc3fd6215 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide22a8a6235604df7870c271fc3fd6215 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide22a8a6235604df7870c271fc3fd6215 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide22a8a6235604df7870c271fc3fd6215 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide22a8a6235604df7870c271fc3fd6215 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide22a8a6235604df7870c271fc3fd6215 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide22a8a6235604df7870c271fc3fd6215 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide22a8a6235604df7870c271fc3fd6215 input{text-align:left;}"; break;
		}
	}
