<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ARTRSK_ART.aspx.vb" Inherits="Nexus.PB2_ARTRSK_ART" %>
...
function onValidate_ARTRSK__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "RISK_ATTACH_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ARTRSK", "RISK_ATTACH_DATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ARTRSK.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.4", "ARTRSK", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblARTRSK_RISK_ATTACH_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_ARTRSK__RISK_ATTACH_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ARTRSK__RISK_ATTACH_DATE_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=ARTRSK&propertyName=RISK_ATTACH_DATE&name={name}");
...
function onValidate_ARTRSK__EFFECTIVEDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "EFFECTIVEDATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ARTRSK", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ARTRSK.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.4", "ARTRSK", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblARTRSK_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_ARTRSK__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ARTRSK__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=ARTRSK&propertyName=EFFECTIVEDATE&name={name}");
...
function onValidate_ARTRSK__TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "TYPE", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ARTRSK", "TYPE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ARTRSK.TYPE");
        			window.setControlWidth(field, "0.8", "ARTRSK", "TYPE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblARTRSK_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_ARTRSK__TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ARTRSK__TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ARTRSK__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ARTRSK", "DESCRIPTION");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ARTRSK.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "ARTRSK", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblARTRSK_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_ARTRSK__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ARTRSK__DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ARTRSK__PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ARTRSK", "PREM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ARTRSK.PREM");
        			window.setControlWidth(field, "0.8", "ARTRSK", "PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblARTRSK_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_ARTRSK__PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ARTRSK__PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ARTRSK__ENDORSE_PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "ENDORSE_PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ARTRSK", "ENDORSE_PREMIUM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ARTRSK.ENDORSE_PREMIUM");
        			window.setControlWidth(field, "0.3", "ARTRSK", "ENDORSE_PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblARTRSK_ENDORSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_ARTRSK__ENDORSE_PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ARTRSK__ENDORSE_PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_ARTRSK__ARTENDO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "ARTENDO", "ChildScreen");
        })();
}
function onValidate_ARTRSK__ARTNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "ARTNOTES", "ChildScreen");
        })();
}
function onValidate_ARTRSK__ARTSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ARTRSK", "ARTSNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_ARTRSK__RISK_ATTACH_DATE(null, null, null, isOnLoad);
    onValidate_ARTRSK__EFFECTIVEDATE(null, null, null, isOnLoad);
    ...
    onValidate_ARTRSK__TYPE(null, null, null, isOnLoad);
    onValidate_ARTRSK__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_ARTRSK__PREM(null, null, null, isOnLoad);
    onValidate_ARTRSK__ENDORSE_PREMIUM(null, null, null, isOnLoad);
    onValidate_ARTRSK__ARTENDO(null, null, null, isOnLoad);
    onValidate_ARTRSK__ARTNOTES(null, null, null, isOnLoad);
    onValidate_ARTRSK__ARTSNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="ida9986b91a9d84b0d97ab4857c1fe28e2" class="general-layout-container">
...
<div id="id77fc9468ea7449a6b8bb37e24f3ff3f9" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="ARTRSK" 
		data-property-name="RISK_ATTACH_DATE" 
		id="pb-container-datejquerycompatible-ARTRSK-RISK_ATTACH_DATE">
		<asp:Label ID="lblARTRSK_RISK_ATTACH_DATE" runat="server" AssociatedControlID="ARTRSK__RISK_ATTACH_DATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="ARTRSK__RISK_ATTACH_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calARTRSK__RISK_ATTACH_DATE" runat="server" LinkedControl="ARTRSK__RISK_ATTACH_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valARTRSK_RISK_ATTACH_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_ARTRSK__RISK_ATTACH_DATE" 
			ValidationGroup=""
			Display="None"
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-ARTRSK-EFFECTIVEDATE">
		<asp:Label ID="lblARTRSK_EFFECTIVEDATE" runat="server" AssociatedControlID="ARTRSK__EFFECTIVEDATE" 
			Text="Effective Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="ARTRSK__EFFECTIVEDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calARTRSK__EFFECTIVEDATE" runat="server" LinkedControl="ARTRSK__EFFECTIVEDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valARTRSK_EFFECTIVEDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective Date"
			ClientValidationFunction="onValidate_ARTRSK__EFFECTIVEDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id77fc9468ea7449a6b8bb37e24f3ff3f9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id77fc9468ea7449a6b8bb37e24f3ff3f9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id77fc9468ea7449a6b8bb37e24f3ff3f9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id77fc9468ea7449a6b8bb37e24f3ff3f9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id77fc9468ea7449a6b8bb37e24f3ff3f9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77fc9468ea7449a6b8bb37e24f3ff3f9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77fc9468ea7449a6b8bb37e24f3ff3f9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id77fc9468ea7449a6b8bb37e24f3ff3f9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77fc9468ea7449a6b8bb37e24f3ff3f9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77fc9468ea7449a6b8bb37e24f3ff3f9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id77d30bcafdb244338f020d2fc37194c5" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id77d30bcafdb244338f020d2fc37194c5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id77d30bcafdb244338f020d2fc37194c5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id77d30bcafdb244338f020d2fc37194c5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id77d30bcafdb244338f020d2fc37194c5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id77d30bcafdb244338f020d2fc37194c5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77d30bcafdb244338f020d2fc37194c5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77d30bcafdb244338f020d2fc37194c5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id77d30bcafdb244338f020d2fc37194c5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77d30bcafdb244338f020d2fc37194c5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77d30bcafdb244338f020d2fc37194c5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ideb6040a6e68b4ea1850223d727a0f770" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-ARTRSK-TYPE">
		<asp:Label ID="lblARTRSK_TYPE" runat="server" AssociatedControlID="ARTRSK__TYPE" 
			Text="Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="ARTRSK__TYPE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_ADDRESSLIST" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_ARTRSK__TYPE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valARTRSK_TYPE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Type"
			ClientValidationFunction="onValidate_ARTRSK__TYPE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-ARTRSK-DESCRIPTION">

		
		<asp:Label ID="lblARTRSK_DESCRIPTION" runat="server" AssociatedControlID="ARTRSK__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="ARTRSK__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valARTRSK_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_ARTRSK__DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ARTRSK-PREM">
		<asp:Label ID="lblARTRSK_PREM" runat="server" AssociatedControlID="ARTRSK__PREM" 
			Text="Premium " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ARTRSK__PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valARTRSK_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium "
			ClientValidationFunction="onValidate_ARTRSK__PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ideb6040a6e68b4ea1850223d727a0f770 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ideb6040a6e68b4ea1850223d727a0f770 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ideb6040a6e68b4ea1850223d727a0f770 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ideb6040a6e68b4ea1850223d727a0f770 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ideb6040a6e68b4ea1850223d727a0f770 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ideb6040a6e68b4ea1850223d727a0f770 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ideb6040a6e68b4ea1850223d727a0f770 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ideb6040a6e68b4ea1850223d727a0f770 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ideb6040a6e68b4ea1850223d727a0f770 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ideb6040a6e68b4ea1850223d727a0f770 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblARTRSK_REFFERRAL_CLAUSES" runat="server" AssociatedControlID="ARTRSK__REFFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="ARTRSK__REFFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-ARTRSK-ENDORSE_PREMIUM">
		<asp:Label ID="lblARTRSK_ENDORSE_PREMIUM" runat="server" AssociatedControlID="ARTRSK__ENDORSE_PREMIUM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="ARTRSK__ENDORSE_PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valARTRSK_ENDORSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_ARTRSK__ENDORSE_PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ARTRSK__ARTENDO"
		data-field-type="Child" 
		data-object-name="ARTRSK" 
		data-property-name="ARTENDO" 
		id="pb-container-childscreen-ARTRSK-ARTENDO">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ARTRSK__SEC_A" runat="server" ScreenCode="ARTENDO" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valARTRSK_ARTENDO" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ARTRSK.ARTENDO"
						ClientValidationFunction="onValidate_ARTRSK__ARTENDO" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ARTRSK__ARTNOTES"
		data-field-type="Child" 
		data-object-name="ARTRSK" 
		data-property-name="ARTNOTES" 
		id="pb-container-childscreen-ARTRSK-ARTNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ARTRSK__ARTNOTE_DETAILS" runat="server" ScreenCode="ARTNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valARTRSK_ARTNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ARTRSK.ARTNOTES"
						ClientValidationFunction="onValidate_ARTRSK__ARTNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ARTRSK__ARTSNOTES"
		data-field-type="Child" 
		data-object-name="ARTRSK" 
		data-property-name="ARTSNOTES" 
		id="pb-container-childscreen-ARTRSK-ARTSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ARTRSK__ARTSNOTE_DETAILS" runat="server" ScreenCode="ARTSNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valARTRSK_ARTSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ARTRSK.ARTSNOTES"
						ClientValidationFunction="onValidate_ARTRSK__ARTSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
