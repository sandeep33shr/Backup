...
Namespace Nexus
    Partial Class PB2_ARTNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_ARTNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If ARTNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		ARTNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		ARTNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_ARTNOTE_DETAILS__NOTE_DETAILS()
End Sub
