<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DSENDPRE_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_DSENDPRE_Endorsement_Premium" %>
...
<div id="id8a4945aa83e24fc9814c15ed44f7b873" class="general-layout-container">
...
<div id="idbb91760c6a4f45f4ad0f04bf1a548668" class="column-layout-container  ">
		...
		<asp:Label ID="lblDS_CLAUSEPREM_COUNTER_ID" runat="server" AssociatedControlID="DS_CLAUSEPREM__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DS_CLAUSEPREM__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblDS_CLAUSEPREM_ENDORSE_CAP" runat="server" AssociatedControlID="DS_CLAUSEPREM__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DS_CLAUSEPREM__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-DS_CLAUSEPREM-ENDORSE_DESCCode">
				...
				<asp:HiddenField ID="DS_CLAUSEPREM__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idbb91760c6a4f45f4ad0f04bf1a548668 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbb91760c6a4f45f4ad0f04bf1a548668 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbb91760c6a4f45f4ad0f04bf1a548668 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idbb91760c6a4f45f4ad0f04bf1a548668 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbb91760c6a4f45f4ad0f04bf1a548668 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbb91760c6a4f45f4ad0f04bf1a548668 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbb91760c6a4f45f4ad0f04bf1a548668 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbb91760c6a4f45f4ad0f04bf1a548668 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbb91760c6a4f45f4ad0f04bf1a548668 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbb91760c6a4f45f4ad0f04bf1a548668 input{text-align:left;}"; break;
		}
	}
