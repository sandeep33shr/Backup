<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBITMSNOT_Note_Details.aspx.vb" Inherits="Nexus.PB2_MBITMSNOT_Note_Details" %>
...
function onValidate_MBITEM_SCNOTE__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITEM_SCNOTE", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MBITEM_SCNOTE", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_SCNOTE.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "MBITEM_SCNOTE", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITEM_SCNOTE_DATE_CREATED");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITEM_SCNOTE__DATE_CREATED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITEM_SCNOTE__DATE_CREATED_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=MBITEM_SCNOTE&propertyName=DATE_CREATED&name={name}");
...
function onValidate_MBITEM_SCNOTE__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITEM_SCNOTE", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MBITEM_SCNOTE", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_SCNOTE.CREATED_BY");
        			window.setControlWidth(field, "0.5", "MBITEM_SCNOTE", "CREATED_BY");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITEM_SCNOTE_CREATED_BY");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITEM_SCNOTE__CREATED_BY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITEM_SCNOTE__CREATED_BY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MBITEM_SCNOTE__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITEM_SCNOTE", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MBITEM_SCNOTE", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_SCNOTE.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "MBITEM_SCNOTE", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITEM_SCNOTE_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITEM_SCNOTE__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITEM_SCNOTE__COVER_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MBITEM_SCNOTE&propertyName=COVER_TYPE&name={name}");
...
function onValidate_MBITEM_SCNOTE__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITEM_SCNOTE", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MBITEM_SCNOTE", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_SCNOTE.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "3", "MBITEM_SCNOTE", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MBITEM_SCNOTE", "NOTE_DESCRIPTION");
        		var exp = new Expression("MBITEM_SCNOTE.NoteCheck = 1");
...
function onValidate_MBITEM_SCNOTE__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITEM_SCNOTE", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MBITEM_SCNOTE", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_SCNOTE.NOTE_DETAILS");
        			window.setControlWidth(field, "3", "MBITEM_SCNOTE", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=MBITEM_SCNOTE&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_MBITEM_SCNOTE__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_MBITEM_SCNOTE_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_MBITEM_SCNOTE__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBITEM_SCNOTE", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MBITEM_SCNOTE", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_MBITEM_SCNOTE__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_MBITEM_SCNOTE__CREATED_BY(null, null, null, isOnLoad);
    onValidate_MBITEM_SCNOTE__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_MBITEM_SCNOTE__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_MBITEM_SCNOTE__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_MBITEM_SCNOTE__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="idcf9f92e587e946ecace3c625a135f9f6" class="general-layout-container">
...
<div id="id727b222d4aa3460e9b8e51a57660d77d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading16" runat="server" Text="Note Details (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MBITEM_SCNOTE" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-MBITEM_SCNOTE-DATE_CREATED">
		<asp:Label ID="lblMBITEM_SCNOTE_DATE_CREATED" runat="server" AssociatedControlID="MBITEM_SCNOTE__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="MBITEM_SCNOTE__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calMBITEM_SCNOTE__DATE_CREATED" runat="server" LinkedControl="MBITEM_SCNOTE__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valMBITEM_SCNOTE_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_MBITEM_SCNOTE__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MBITEM_SCNOTE-CREATED_BY">

		
		<asp:Label ID="lblMBITEM_SCNOTE_CREATED_BY" runat="server" AssociatedControlID="MBITEM_SCNOTE__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MBITEM_SCNOTE__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMBITEM_SCNOTE_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_MBITEM_SCNOTE__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MBITEM_SCNOTE-COVER_TYPE">

		
		<asp:Label ID="lblMBITEM_SCNOTE_COVER_TYPE" runat="server" AssociatedControlID="MBITEM_SCNOTE__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MBITEM_SCNOTE__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMBITEM_SCNOTE_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_MBITEM_SCNOTE__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MBITEM_SCNOTE-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblMBITEM_SCNOTE_NOTE_DESCRIPTION" runat="server" AssociatedControlID="MBITEM_SCNOTE__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MBITEM_SCNOTE__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMBITEM_SCNOTE_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_MBITEM_SCNOTE__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-MBITEM_SCNOTE-NOTE_DETAILS">
		<asp:Label ID="lblMBITEM_SCNOTE_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="MBITEM_SCNOTE__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="MBITEM_SCNOTE__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valMBITEM_SCNOTE_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_MBITEM_SCNOTE__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblMBITEM_SCNOTE_NoteCheck" for="ctl00_cntMainBody_MBITEM_SCNOTE__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-MBITEM_SCNOTE-NoteCheck">	
		
		<asp:TextBox ID="MBITEM_SCNOTE__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valMBITEM_SCNOTE_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_MBITEM_SCNOTE__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id727b222d4aa3460e9b8e51a57660d77d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id727b222d4aa3460e9b8e51a57660d77d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id727b222d4aa3460e9b8e51a57660d77d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id727b222d4aa3460e9b8e51a57660d77d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id727b222d4aa3460e9b8e51a57660d77d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id727b222d4aa3460e9b8e51a57660d77d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id727b222d4aa3460e9b8e51a57660d77d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id727b222d4aa3460e9b8e51a57660d77d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id727b222d4aa3460e9b8e51a57660d77d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id727b222d4aa3460e9b8e51a57660d77d input{text-align:left;}"; break;
		}
	}
