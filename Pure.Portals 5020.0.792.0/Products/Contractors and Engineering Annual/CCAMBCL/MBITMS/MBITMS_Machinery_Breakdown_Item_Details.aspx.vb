...
Namespace Nexus
    Partial Class PB2_MBITMS_Machinery_Breakdown_Item_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_MB_ITEM__INCR()
        
End Sub
Protected Sub onValidate_MB_ITEM__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MB_ITEM__INCR()
    onValidate_MB_ITEM__COUNTER_ID()
End Sub
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "MBREAK" & "/" & "MB_ITEM", sXMLDataset)
                            If sChildId <> "0" Then
                                MB_ITEM__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
