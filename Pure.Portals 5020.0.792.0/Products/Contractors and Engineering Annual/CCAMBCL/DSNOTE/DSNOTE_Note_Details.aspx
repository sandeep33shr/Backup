<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_DSNOTE_Note_Details" %>
...
function onValidate_DS_NOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DS_NOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "3", "DS_NOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
...
function onValidate_DS_NOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DS_NOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "3", "DS_NOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
...
<div id="id2f8324ca04f14bf2806c8bc140a9976c" class="general-layout-container">
...
<div id="ide472748fbb384bccb6dd4ab10dc2d2ec" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading70" runat="server" Text="Note Details (Not Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide472748fbb384bccb6dd4ab10dc2d2ec div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide472748fbb384bccb6dd4ab10dc2d2ec div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide472748fbb384bccb6dd4ab10dc2d2ec div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide472748fbb384bccb6dd4ab10dc2d2ec label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide472748fbb384bccb6dd4ab10dc2d2ec label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide472748fbb384bccb6dd4ab10dc2d2ec label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide472748fbb384bccb6dd4ab10dc2d2ec label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide472748fbb384bccb6dd4ab10dc2d2ec input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide472748fbb384bccb6dd4ab10dc2d2ec input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide472748fbb384bccb6dd4ab10dc2d2ec input{text-align:left;}"; break;
		}
	}
