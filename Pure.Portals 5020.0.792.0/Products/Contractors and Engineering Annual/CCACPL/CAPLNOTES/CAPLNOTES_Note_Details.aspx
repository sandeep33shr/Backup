<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAPLNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_CAPLNOTES_Note_Details" %>
...
<div id="ide76797d3786c44e7abfdb0d23f2163fe" class="general-layout-container">
...
<div id="idb4d9b378871a4c249040c554ff6f5110" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb4d9b378871a4c249040c554ff6f5110 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb4d9b378871a4c249040c554ff6f5110 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb4d9b378871a4c249040c554ff6f5110 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb4d9b378871a4c249040c554ff6f5110 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb4d9b378871a4c249040c554ff6f5110 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb4d9b378871a4c249040c554ff6f5110 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb4d9b378871a4c249040c554ff6f5110 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb4d9b378871a4c249040c554ff6f5110 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb4d9b378871a4c249040c554ff6f5110 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb4d9b378871a4c249040c554ff6f5110 input{text-align:left;}"; break;
		}
	}
