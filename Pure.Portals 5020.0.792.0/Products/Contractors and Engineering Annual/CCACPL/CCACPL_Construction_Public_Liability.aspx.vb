...
Namespace Nexus
    Partial Class PB2_CCACPL_Construction_Public_Liability : Inherits BaseRisk
		...
		Protected Sub onValidate_CPLRISK__RISK_ATTACH_DATE()
        
End Sub
Protected Sub onValidate_CPLRISK__EFFECTIVEDATE()
...
Protected Sub onValidate_GENERAL__TRANSACTION_TYPE()
        ...
        End If
End Sub
Protected Sub onValidate_GENERAL__PRODUCT_CODE()
         
End Sub
Protected Sub CallRuleScripts()
    onValidate_CPLRISK__RISK_ATTACH_DATE()
    onValidate_CPLRISK__EFFECTIVEDATE()
    onValidate_ADDRESS__TOWN()
    onValidate_ADDRESS__COUNTRY()
    onValidate_GENERAL__QUOTEDATE()
    onValidate_GENERAL__TRANSACTION_TYPE()
    onValidate_GENERAL__PRODUCT_CODE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If CPLRISK__RISK_ATTACH_DATE.Text = "" or CPLRISK__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			CPLRISK__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			CPLRISK__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (CPLRISK__RISK_ATTACH_DATE.Text <> "" Or CPLRISK__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		CPLRISK__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		CPLRISK__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		CPLRISK__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
        ...
        End Sub
         ...
         Protected Shadows Sub GetProdCode(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If Session(CNQuote) IsNot Nothing Then
                ...
                GENERAL__PRODUCT_CODE.Text = Trim(oQuote.ProductCode).ToString
        	End If
        End Sub
