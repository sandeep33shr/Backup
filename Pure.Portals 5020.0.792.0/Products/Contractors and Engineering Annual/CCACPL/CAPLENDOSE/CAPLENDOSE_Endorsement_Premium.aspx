<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAPLENDOSE_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CAPLENDOSE_Endorsement_Premium" %>
...
function onValidate_PL_ENDORSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PL_ENDORSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PL_ENDORSE", "ENDORSE_ID");
        		}
...
function onValidate_PL_ENDORSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PL_ENDORSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PL_ENDORSE", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PL_ENDORSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "PL_ENDORSE", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPL_ENDORSE_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_PL_ENDORSE__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PL_ENDORSE__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_PL_ENDORSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PL_ENDORSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PL_ENDORSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PL_ENDORSE.ENDORSE_CAP");
        			window.setControlWidth(field, "0.5", "PL_ENDORSE", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPL_ENDORSE_ENDORSE_CAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_PL_ENDORSE__ENDORSE_CAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PL_ENDORSE__ENDORSE_CAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=PL_ENDORSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(PL_ENDORSE.ENDORSE_DESC)"), 
...
function onValidate_PL_ENDORSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PL_ENDORSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PL_ENDORSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PL_ENDORSE.PREMIUM");
        			window.setControlWidth(field, "0.5", "PL_ENDORSE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPL_ENDORSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_PL_ENDORSE__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PL_ENDORSE__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_PL_ENDORSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_PL_ENDORSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_PL_ENDORSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_PL_ENDORSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id55527b156de145678b905b36b7b0bbf2" class="general-layout-container">
...
<div id="idfdc6d7f98f21430d861cffbae61ae377" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PL_ENDORSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-PL_ENDORSE-ENDORSE_ID">
		<asp:Label ID="lblPL_ENDORSE_ENDORSE_ID" runat="server" AssociatedControlID="PL_ENDORSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="PL_ENDORSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valPL_ENDORSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_PL_ENDORSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PL_ENDORSE-ENDORSE_DESC">
		<asp:Label ID="lblPL_ENDORSE_ENDORSE_DESC" runat="server" AssociatedControlID="PL_ENDORSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PL_ENDORSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PL_ENDORSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPL_ENDORSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_PL_ENDORSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PL_ENDORSE-ENDORSE_CAP">

		
		<asp:Label ID="lblPL_ENDORSE_ENDORSE_CAP" runat="server" AssociatedControlID="PL_ENDORSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PL_ENDORSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPL_ENDORSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_PL_ENDORSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PL_ENDORSE-PREMIUM">
		<asp:Label ID="lblPL_ENDORSE_PREMIUM" runat="server" AssociatedControlID="PL_ENDORSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PL_ENDORSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPL_ENDORSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PL_ENDORSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PL_ENDORSE-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="PL_ENDORSE__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfdc6d7f98f21430d861cffbae61ae377 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfdc6d7f98f21430d861cffbae61ae377 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfdc6d7f98f21430d861cffbae61ae377 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfdc6d7f98f21430d861cffbae61ae377 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfdc6d7f98f21430d861cffbae61ae377 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfdc6d7f98f21430d861cffbae61ae377 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfdc6d7f98f21430d861cffbae61ae377 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfdc6d7f98f21430d861cffbae61ae377 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfdc6d7f98f21430d861cffbae61ae377 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfdc6d7f98f21430d861cffbae61ae377 input{text-align:left;}"; break;
		}
	}
