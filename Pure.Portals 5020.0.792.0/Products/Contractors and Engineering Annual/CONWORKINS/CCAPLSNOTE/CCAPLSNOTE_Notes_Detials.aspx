<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAPLSNOTE_Notes_Detials.aspx.vb" Inherits="Nexus.PB2_CCAPLSNOTE_Notes_Detials" %>
...
function onValidate_GPANOTES__Risk_Cover(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTES", "Risk_Cover", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("GPANOTES", "Risk_Cover");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTES.Risk_Cover");
        			window.setControlWidth(field, "0.5", "GPANOTES", "Risk_Cover");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=GPANOTES&propertyName=Risk_Cover&name={name}");
...
function onValidate_GPANOTES__Note_Subject(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GPANOTES", "Note_Subject", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GPANOTES", "Note_Subject");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GPANOTES.Note_Subject");
        			window.setControlWidth(field, "0.5", "GPANOTES", "Note_Subject");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GPANOTES__Risk_Cover(null, null, null, isOnLoad);
    onValidate_GPANOTES__Note_Subject(null, null, null, isOnLoad);
...
<div id="idbf72fd35844c4f16afdcb857ec50170d" class="general-layout-container">
...
<div id="idea1f27937ace44569954e8397a953fa6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading68" runat="server" Text="Construction Public Liability Notes (Not Printed on Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPANOTES-Risk_Cover">

		
		<asp:Label ID="lblGPANOTES_Risk_Cover" runat="server" AssociatedControlID="GPANOTES__Risk_Cover" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPANOTES__Risk_Cover" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPANOTES_Risk_Cover" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_GPANOTES__Risk_Cover"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-GPANOTES-Note_Subject">

		
		<asp:Label ID="lblGPANOTES_Note_Subject" runat="server" AssociatedControlID="GPANOTES__Note_Subject" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="GPANOTES__Note_Subject" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valGPANOTES_Note_Subject" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_GPANOTES__Note_Subject"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idea1f27937ace44569954e8397a953fa6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idea1f27937ace44569954e8397a953fa6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idea1f27937ace44569954e8397a953fa6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idea1f27937ace44569954e8397a953fa6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idea1f27937ace44569954e8397a953fa6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idea1f27937ace44569954e8397a953fa6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idea1f27937ace44569954e8397a953fa6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idea1f27937ace44569954e8397a953fa6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idea1f27937ace44569954e8397a953fa6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idea1f27937ace44569954e8397a953fa6 input{text-align:left;}"; break;
		}
	}
