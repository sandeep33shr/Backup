<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCA_CVAL_Contract_Values.aspx.vb" Inherits="Nexus.PB2_CCA_CVAL_Contract_Values" %>
...
function onValidate_CONVALS__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONVALS", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CONVALS", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONVALS.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "CONVALS", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONVALS_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONVALS__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONVALS__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_CONVALS__CONTRACTVALUE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONVALS", "CONTRACTVALUE", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CONVALS", "CONTRACTVALUE");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONVALS.CONTRACTVALUE");
        			window.setControlWidth(field, "0.8", "CONVALS", "CONTRACTVALUE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONVALS_CONTRACTVALUE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONVALS__CONTRACTVALUE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONVALS__CONTRACTVALUE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CONVALS__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONVALS", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONVALS", "RATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONVALS.RATE");
        			window.setControlWidth(field, "0.8", "CONVALS", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONVALS_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONVALS__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONVALS__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CONVALS__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONVALS", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CONVALS", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONVALS.PREMIUM");
        			window.setControlWidth(field, "0.8", "CONVALS", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONVALS_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONVALS__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONVALS__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("CONVALS.RATE.setValue(CONVALS.PREMIUM/CONVALS.CONTRACTVALUE*100)");
        		var whenExp = (Expression.isValidParameter("CONVALS.CONTRACTVALUE <> '' AND CONVALS.CONTRACTVALUE <> null")) ? new Expression("CONVALS.CONTRACTVALUE <> '' AND CONVALS.CONTRACTVALUE <> null") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=CONVALS&propertyName=PREMIUM&name={name}");
        		
        		var value = new Expression("CONVALS.CONTRACTVALUE*CONVALS.RATE/100"), 
        			condition = (Expression.isValidParameter("CONVALS.RATE <> '' AND CONVALS.RATE <> null")) ? new Expression("CONVALS.RATE <> '' AND CONVALS.RATE <> null") : null, 
...
function DoLogic(isOnLoad) {
    onValidate_CONVALS__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_CONVALS__CONTRACTVALUE(null, null, null, isOnLoad);
    onValidate_CONVALS__RATE(null, null, null, isOnLoad);
    onValidate_CONVALS__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id5a4d13b6ac8b497ab4b3dd1062862dfe" class="general-layout-container">
...
<div id="idc4eeaa8c81f6477ab6128163095a4166" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CONVALS" 
		data-property-name="DESCRIPTION" 
		 
		
		 
		id="pb-container-text-CONVALS-DESCRIPTION">

		
		<asp:Label ID="lblCONVALS_DESCRIPTION" runat="server" AssociatedControlID="CONVALS__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CONVALS__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCONVALS_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CONVALS__DESCRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CONVALS-CONTRACTVALUE">
		<asp:Label ID="lblCONVALS_CONTRACTVALUE" runat="server" AssociatedControlID="CONVALS__CONTRACTVALUE" 
			Text="Contract Value" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CONVALS__CONTRACTVALUE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCONVALS_CONTRACTVALUE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Contract Value"
			ClientValidationFunction="onValidate_CONVALS__CONTRACTVALUE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CONVALS-RATE">
		<asp:Label ID="lblCONVALS_RATE" runat="server" AssociatedControlID="CONVALS__RATE" 
			Text="Rate " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CONVALS__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCONVALS_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate "
			ClientValidationFunction="onValidate_CONVALS__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CONVALS-PREMIUM">
		<asp:Label ID="lblCONVALS_PREMIUM" runat="server" AssociatedControlID="CONVALS__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CONVALS__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCONVALS_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CONVALS__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc4eeaa8c81f6477ab6128163095a4166 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc4eeaa8c81f6477ab6128163095a4166 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc4eeaa8c81f6477ab6128163095a4166 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc4eeaa8c81f6477ab6128163095a4166 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc4eeaa8c81f6477ab6128163095a4166 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc4eeaa8c81f6477ab6128163095a4166 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc4eeaa8c81f6477ab6128163095a4166 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc4eeaa8c81f6477ab6128163095a4166 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc4eeaa8c81f6477ab6128163095a4166 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc4eeaa8c81f6477ab6128163095a4166 input{text-align:left;}"; break;
		}
	}
