<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="OEXTLIM_Other_Extensions.aspx.vb" Inherits="Nexus.PB2_OEXTLIM_Other_Extensions" %>
...
function onValidate_OTHEREXT__DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTHEREXT", "DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("OTHEREXT", "DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OTHEREXT.DESCRIPTION");
        			window.setControlWidth(field, "0.8", "OTHEREXT", "DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblOTHEREXT_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_OTHEREXT__DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OTHEREXT__DESCRIPTION_lblFindParty");
        			    }
        			}
...
function onValidate_OTHEREXT__LOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTHEREXT", "LOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("OTHEREXT", "LOI");
        		}
        		//window.setProperty(field, "VEM", "OTHEREXT.CONTRACTVALUE == null || OTHEREXT.CONTRACTVALUE ==''", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "OTHEREXT.CONTRACTVALUE == null || OTHEREXT.CONTRACTVALUE ==''",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("OTHEREXT.LOI");
        			window.setControlWidth(field, "0.8", "OTHEREXT", "LOI");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblOTHEREXT_LOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_OTHEREXT__LOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_OTHEREXT__LOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=OTHEREXT&propertyName=LOI&name={name}");
        		
        		var value = new Expression("OTHEREXT.CONTRACT_VAL * OTHEREXT.CONTRACTVALUE/100"), 
        			condition = (Expression.isValidParameter("OTHEREXT.CONTRACTVALUE <> '' AND OTHEREXT.CONTRACTVALUE <> null")) ? new Expression("OTHEREXT.CONTRACTVALUE <> '' AND OTHEREXT.CONTRACTVALUE <> null") : null, 
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("OTHEREXT.PREMIUM.setValue(OTHEREXT.LOI*OTHEREXT.RATE/100)");
        		var whenExp = (Expression.isValidParameter("(OTHEREXT.LOI <> '' AND OTHEREXT.LOI <> null and OTHEREXT.RATE <> '' AND OTHEREXT.RATE <> null)")) ? new Expression("(OTHEREXT.LOI <> '' AND OTHEREXT.LOI <> null and OTHEREXT.RATE <> '' AND OTHEREXT.RATE <> null)") : null;
...
function onValidate_OTHEREXT__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("OTHEREXT.RATE.setValue(OTHEREXT.PREMIUM/OTHEREXT.LOI*100)");
        		var whenExp = (Expression.isValidParameter("OTHEREXT.RATE <> '' AND OTHEREXT.RATE <> null AND (OTHEREXT.LOI <> '' AND OTHEREXT.LOI <> null)")) ? new Expression("OTHEREXT.RATE <> '' AND OTHEREXT.RATE <> null AND (OTHEREXT.LOI <> '' AND OTHEREXT.LOI <> null)") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_OTHEREXT__CONTRACT_VAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "OTHEREXT", "CONTRACT_VAL", "TempCurrency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("OTHEREXT", "CONTRACT_VAL");
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=TempCurrency&objectName=OTHEREXT&propertyName=CONTRACT_VAL&name={name}");
...
function DoLogic(isOnLoad) {
    onValidate_OTHEREXT__DESCRIPTION(null, null, null, isOnLoad);
    onValidate_OTHEREXT__CONTRACTVALUE(null, null, null, isOnLoad);
    onValidate_OTHEREXT__LOI(null, null, null, isOnLoad);
    onValidate_OTHEREXT__RATE(null, null, null, isOnLoad);
    onValidate_OTHEREXT__PREMIUM(null, null, null, isOnLoad);
    onValidate_OTHEREXT__CONTRACT_VAL(null, null, null, isOnLoad);
}
</script>
...
<div id="id4cfedd8106fc4e5a818453b01e0ec98c" class="general-layout-container">
...
<div id="idd568f63793584a5891b9f32775692bd6" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-OTHEREXT-DESCRIPTION">

		
		<asp:Label ID="lblOTHEREXT_DESCRIPTION" runat="server" AssociatedControlID="OTHEREXT__DESCRIPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="OTHEREXT__DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valOTHEREXT_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_OTHEREXT__DESCRIPTION"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-OTHEREXT-LOI">
		<asp:Label ID="lblOTHEREXT_LOI" runat="server" AssociatedControlID="OTHEREXT__LOI" 
			Text="Limit of Indeminity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="OTHEREXT__LOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valOTHEREXT_LOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indeminity"
			ClientValidationFunction="onValidate_OTHEREXT__LOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:50%;" >
										...
										<!-- TempCurrency -->
	<label id="ctl00_cntMainBody_lblOTHEREXT_CONTRACT_VAL"></label>
	<span class="field-container"
		data-field-type="TempCurrency" 
		data-object-name="OTHEREXT" 
		data-property-name="CONTRACT_VAL" 
		id="pb-container-currency-OTHEREXT-CONTRACT_VAL"
	>
	<input id="ctl00_cntMainBody_OTHEREXT_CONTRACT_VAL" class="field-medium" />
	</span>
	<asp:CustomValidator ID="valOTHEREXT_CONTRACT_VAL" 
								runat="server" 
								Text="*" 
								ErrorMessage="A validation error occurred for OTHEREXT.CONTRACT_VAL"
								ClientValidationFunction="onValidate_OTHEREXT__CONTRACT_VAL" 
								Display="None"
								EnableClientScript="true"
								/>
<!-- /TempCurrency -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd568f63793584a5891b9f32775692bd6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd568f63793584a5891b9f32775692bd6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd568f63793584a5891b9f32775692bd6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd568f63793584a5891b9f32775692bd6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd568f63793584a5891b9f32775692bd6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd568f63793584a5891b9f32775692bd6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd568f63793584a5891b9f32775692bd6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd568f63793584a5891b9f32775692bd6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd568f63793584a5891b9f32775692bd6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd568f63793584a5891b9f32775692bd6 input{text-align:left;}"; break;
		}
	}
