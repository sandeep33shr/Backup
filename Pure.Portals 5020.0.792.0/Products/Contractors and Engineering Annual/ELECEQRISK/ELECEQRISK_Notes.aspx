<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ELECEQRISK_Notes.aspx.vb" Inherits="Nexus.PB2_ELECEQRISK_Notes" %>
...
function onValidate_NOTES__ELECNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "ELECNOTES", "ChildScreen");
        })();
}
function onValidate_EX_NOTES__EEXNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EX_NOTES", "EEXNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__ELECNOTES(null, null, null, isOnLoad);
    onValidate_EX_NOTES__EEXNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id54f65ce9b13240248631964e76794003" class="general-layout-container">
...
<div id="id0fc94c545cc243c58f7e7421fa371a05" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading27" runat="server" Text="Electric Equipment" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__ELECNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="ELECNOTES" 
		id="pb-container-childscreen-NOTES-ELECNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="ELECNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ELECNOTES/ELECNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_ELECNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__ELECNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0fc94c545cc243c58f7e7421fa371a05 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0fc94c545cc243c58f7e7421fa371a05 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0fc94c545cc243c58f7e7421fa371a05 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0fc94c545cc243c58f7e7421fa371a05 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0fc94c545cc243c58f7e7421fa371a05 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0fc94c545cc243c58f7e7421fa371a05 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0fc94c545cc243c58f7e7421fa371a05 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0fc94c545cc243c58f7e7421fa371a05 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0fc94c545cc243c58f7e7421fa371a05 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0fc94c545cc243c58f7e7421fa371a05 input{text-align:left;}"; break;
		}
	}
...
<div id="frmExtNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading28" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EX_NOTES__EEXNOTES"
		data-field-type="Child" 
		data-object-name="EX_NOTES" 
		data-property-name="EEXNOTES" 
		id="pb-container-childscreen-EX_NOTES-EEXNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EX_NOTES__EXT_DETAILS" runat="server" ScreenCode="EEXNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EEXNOTES/EEXNOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEX_NOTES_EEXNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_EX_NOTES__EEXNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
