<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPLINSUR_Additional_Deductibles_Details.aspx.vb" Inherits="Nexus.PB2_CPLINSUR_Additional_Deductibles_Details" %>
...
function onValidate_CBLINSUR__ADDESCRIPT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CBLINSUR", "ADDESCRIPT", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CBLINSUR", "ADDESCRIPT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CBLINSUR.ADDESCRIPT");
        			window.setControlWidth(field, "0.5", "CBLINSUR", "ADDESCRIPT");
        		})();
        	}
        })();
...
function onValidate_CBLINSUR__ADPERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CBLINSUR", "ADPERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CBLINSUR", "ADPERC");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CBLINSUR.ADPERC");
        			window.setControlWidth(field, "0.5", "CBLINSUR", "ADPERC");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CBLINSUR".toUpperCase() + "__" + "ADPERC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CBLINSUR".toUpperCase() + "_" + "ADPERC");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("CBLINSUR.OTHDEDUCT>100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CBLINSUR__ADMIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CBLINSUR", "ADMIN", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CBLINSUR", "ADMIN");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CBLINSUR.ADMIN");
        			window.setControlWidth(field, "0.5", "CBLINSUR", "ADMIN");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Minnimum Amount cannot exceed Maximum Amount")) ? "Minnimum Amount cannot exceed Maximum Amount" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "CBLINSUR".toUpperCase() + "__" + "ADMIN");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "CBLINSUR".toUpperCase() + "_" + "ADMIN");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("CBLINSUR.ADMIN>CBLINSUR.ADMAX");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_CBLINSUR__ADMAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CBLINSUR", "ADMAX", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CBLINSUR", "ADMAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CBLINSUR.ADMAX");
        			window.setControlWidth(field, "0.5", "CBLINSUR", "ADMAX");
        		})();
        	}
        })();
        /**
...
function onValidate_CBLINSUR__ADBDED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CBLINSUR", "ADBDED", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CBLINSUR", "ADBDED");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CBLINSUR.ADBDED");
        			window.setControlWidth(field, "0.5", "CBLINSUR", "ADBDED");
        		})();
        	}
        })();
...
function DoLogic(isOnLoad) {
    onValidate_CBLINSUR__ADDESCRIPT(null, null, null, isOnLoad);
    onValidate_CBLINSUR__ADPERC(null, null, null, isOnLoad);
    onValidate_CBLINSUR__ADMIN(null, null, null, isOnLoad);
    onValidate_CBLINSUR__ADMAX(null, null, null, isOnLoad);
    onValidate_CBLINSUR__ADBDED(null, null, null, isOnLoad);
}
</script>
...
<div id="id86608a7910fe407bb27e52de1e8de1ff" class="general-layout-container">
...
<div id="id12c1ef2591ca40edb225bd2bebe98ba9" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CBLINSUR-ADDESCRIPT">

		
		<asp:Label ID="lblCBLINSUR_ADDESCRIPT" runat="server" AssociatedControlID="CBLINSUR__ADDESCRIPT" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CBLINSUR__ADDESCRIPT" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCBLINSUR_ADDESCRIPT" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CBLINSUR__ADDESCRIPT"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CBLINSUR-ADPERC">
		<asp:Label ID="lblCBLINSUR_ADPERC" runat="server" AssociatedControlID="CBLINSUR__ADPERC" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CBLINSUR__ADPERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCBLINSUR_ADPERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_CBLINSUR__ADPERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CBLINSUR-ADMIN">
		<asp:Label ID="lblCBLINSUR_ADMIN" runat="server" AssociatedControlID="CBLINSUR__ADMIN" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CBLINSUR__ADMIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCBLINSUR_ADMIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_CBLINSUR__ADMIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CBLINSUR-ADMAX">
		<asp:Label ID="lblCBLINSUR_ADMAX" runat="server" AssociatedControlID="CBLINSUR__ADMAX" 
			Text="Maximum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CBLINSUR__ADMAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCBLINSUR_ADMAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Maximum Amount"
			ClientValidationFunction="onValidate_CBLINSUR__ADMAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-CBLINSUR-ADBDED">
		<asp:Label ID="lblCBLINSUR_ADBDED" runat="server" AssociatedControlID="CBLINSUR__ADBDED" 
			Text="Basis of Deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="CBLINSUR__ADBDED" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_BOFDEDUCT" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_CBLINSUR__ADBDED(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valCBLINSUR_ADBDED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of Deductible"
			ClientValidationFunction="onValidate_CBLINSUR__ADBDED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CBLINSUR" 
		data-property-name="ADBDEDCode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-CBLINSUR-ADBDEDCode">

		
		
			
		
				<asp:HiddenField ID="CBLINSUR__ADBDEDCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id12c1ef2591ca40edb225bd2bebe98ba9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id12c1ef2591ca40edb225bd2bebe98ba9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id12c1ef2591ca40edb225bd2bebe98ba9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id12c1ef2591ca40edb225bd2bebe98ba9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id12c1ef2591ca40edb225bd2bebe98ba9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id12c1ef2591ca40edb225bd2bebe98ba9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id12c1ef2591ca40edb225bd2bebe98ba9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id12c1ef2591ca40edb225bd2bebe98ba9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id12c1ef2591ca40edb225bd2bebe98ba9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id12c1ef2591ca40edb225bd2bebe98ba9 input{text-align:left;}"; break;
		}
	}
