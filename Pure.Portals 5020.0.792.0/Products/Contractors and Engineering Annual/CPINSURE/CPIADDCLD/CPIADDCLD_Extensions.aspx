<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPIADDCLD_Extensions.aspx.vb" Inherits="Nexus.PB2_CPIADDCLD_Extensions" %>
...
function onValidate_OTHERSPEC__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("OTHERSPEC.PREMIUM / OTHERSPEC.DEDUCTAMT * 100"), 
...
function onValidate_OTHERSPEC__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("OTHERSPEC.RATE * OTHERSPEC.DEDUCTAMT * 0.01"), 
...
<div id="id09622a87f10c462cbc17bb7ad0c04cfc" class="general-layout-container">
...
<div id="frmOther" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Other Extensions" /></legend>
