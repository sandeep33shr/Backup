...
function onValidate_GENERAL__OWNPLANT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "OWNPLANT", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "OWNPLANT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.OWNPLANT");
        			window.setControlWidth(field, "0.8", "GENERAL", "OWNPLANT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_OWNPLANT");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__OWNPLANT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__OWNPLANT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__HIREDPLANT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "HIREDPLANT", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "HIREDPLANT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.HIREDPLANT");
        			window.setControlWidth(field, "0.8", "GENERAL", "HIREDPLANT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_HIREDPLANT");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__HIREDPLANT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__HIREDPLANT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__OWNPLANT(null, null, null, isOnLoad);
    onValidate_GENERAL__HIREDPLANT(null, null, null, isOnLoad);
...
<div id="id4a6a88d3ad364610b2746775de420485" class="general-layout-container">
...
<div id="id1a22c82eddd2417091b85868c7a9b2ce" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1a22c82eddd2417091b85868c7a9b2ce div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1a22c82eddd2417091b85868c7a9b2ce div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1a22c82eddd2417091b85868c7a9b2ce div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1a22c82eddd2417091b85868c7a9b2ce label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1a22c82eddd2417091b85868c7a9b2ce label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1a22c82eddd2417091b85868c7a9b2ce label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1a22c82eddd2417091b85868c7a9b2ce label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1a22c82eddd2417091b85868c7a9b2ce input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1a22c82eddd2417091b85868c7a9b2ce input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1a22c82eddd2417091b85868c7a9b2ce input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf8bdf1150c454a76b959ab965e9e5971" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf8bdf1150c454a76b959ab965e9e5971 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf8bdf1150c454a76b959ab965e9e5971 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf8bdf1150c454a76b959ab965e9e5971 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf8bdf1150c454a76b959ab965e9e5971 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf8bdf1150c454a76b959ab965e9e5971 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf8bdf1150c454a76b959ab965e9e5971 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf8bdf1150c454a76b959ab965e9e5971 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf8bdf1150c454a76b959ab965e9e5971 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf8bdf1150c454a76b959ab965e9e5971 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf8bdf1150c454a76b959ab965e9e5971 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id79e1e049b7f14ef588a8c451baf5c648" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Cover Details" /></legend>
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_OWNPLANT" for="ctl00_cntMainBody_GENERAL__OWNPLANT" class="col-md-4 col-sm-3 control-label">
		Own Plant </label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="OWNPLANT" 
		id="pb-container-checkbox-GENERAL-OWNPLANT">	
		
		<asp:TextBox ID="GENERAL__OWNPLANT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_OWNPLANT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Own Plant "
			ClientValidationFunction="onValidate_GENERAL__OWNPLANT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_HIREDPLANT" for="ctl00_cntMainBody_GENERAL__HIREDPLANT" class="col-md-4 col-sm-3 control-label">
		Hired In Plant </label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="HIREDPLANT" 
		id="pb-container-checkbox-GENERAL-HIREDPLANT">	
		
		<asp:TextBox ID="GENERAL__HIREDPLANT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_HIREDPLANT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Hired In Plant "
			ClientValidationFunction="onValidate_GENERAL__HIREDPLANT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id79e1e049b7f14ef588a8c451baf5c648 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id79e1e049b7f14ef588a8c451baf5c648 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id79e1e049b7f14ef588a8c451baf5c648 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id79e1e049b7f14ef588a8c451baf5c648 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id79e1e049b7f14ef588a8c451baf5c648 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id79e1e049b7f14ef588a8c451baf5c648 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id79e1e049b7f14ef588a8c451baf5c648 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id79e1e049b7f14ef588a8c451baf5c648 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id79e1e049b7f14ef588a8c451baf5c648 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id79e1e049b7f14ef588a8c451baf5c648 input{text-align:left;}"; break;
		}
	}
