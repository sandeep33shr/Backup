...
Namespace Nexus
    Partial Class PB2_PLANTITEM_Own_Plant_Item : Inherits BaseRisk
		...
		Protected Sub onValidate_PLANTDET__COUNTER_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PLANTDET__COUNTER_ID()
End Sub

		    
        'OWNPLANT - Parent object
        'PLANTDET - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "OWNPLANT" & "/" & "PLANTDET", sXMLDataset)
                            If sChildId <> "0" Then
                                PLANTDET__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
