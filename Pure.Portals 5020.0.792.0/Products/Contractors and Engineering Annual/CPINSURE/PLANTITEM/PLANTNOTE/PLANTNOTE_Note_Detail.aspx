<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PLANTNOTE_Note_Detail.aspx.vb" Inherits="Nexus.PB2_PLANTNOTE_Note_Detail" %>
...
function onValidate_PLANT_NOTE_DETAIL__DATE_CREATED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANT_NOTE_DETAIL.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "PLANT_NOTE_DETAIL", "DATE_CREATED");
        		})();
        	}
        })();
        /**
...
function onValidate_PLANT_NOTE_DETAIL__CREATED_BY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANT_NOTE_DETAIL.CREATED_BY");
        			window.setControlWidth(field, "0.5", "PLANT_NOTE_DETAIL", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_PLANT_NOTE_DETAIL__COVER_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANT_NOTE_DETAIL.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "PLANT_NOTE_DETAIL", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("PLANT_NOTE_DETAIL.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "PLANT_NOTE_DETAIL", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_PLANT_NOTE_DETAIL__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PLANT_NOTE_DETAIL.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "PLANT_NOTE_DETAIL", "NOTE_DETAILS");
        		})();
        	}
        })();
...
<div id="idac616aaa4da648df9d8bc22454e0c89e" class="general-layout-container">
...
<div id="id42ef7d561528452baaf8ebdbf5ca4818" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id42ef7d561528452baaf8ebdbf5ca4818 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id42ef7d561528452baaf8ebdbf5ca4818 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id42ef7d561528452baaf8ebdbf5ca4818 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id42ef7d561528452baaf8ebdbf5ca4818 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id42ef7d561528452baaf8ebdbf5ca4818 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id42ef7d561528452baaf8ebdbf5ca4818 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id42ef7d561528452baaf8ebdbf5ca4818 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id42ef7d561528452baaf8ebdbf5ca4818 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id42ef7d561528452baaf8ebdbf5ca4818 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id42ef7d561528452baaf8ebdbf5ca4818 input{text-align:left;}"; break;
		}
	}
