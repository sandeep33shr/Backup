<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="RETROMACBR_Retrocession_Details.aspx.vb" Inherits="Nexus.PB2_RETROMACBR_Retrocession_Details" %>
...
function onValidate_RETRO_DETAILS__NAME(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RETRO_DETAILS.NAME");
        			window.setControlWidth(field, "0.6", "RETRO_DETAILS", "NAME");
        		})();
        	}
        })();
}
...
<div id="id26a21e739d8e4e5db0074c451328201c" class="general-layout-container">
...
<div id="id353c88f0a2984c658de578b61c682626" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id353c88f0a2984c658de578b61c682626 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id353c88f0a2984c658de578b61c682626 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id353c88f0a2984c658de578b61c682626 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id353c88f0a2984c658de578b61c682626 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id353c88f0a2984c658de578b61c682626 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id353c88f0a2984c658de578b61c682626 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id353c88f0a2984c658de578b61c682626 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id353c88f0a2984c658de578b61c682626 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id353c88f0a2984c658de578b61c682626 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id353c88f0a2984c658de578b61c682626 input{text-align:left;}"; break;
		}
	}
