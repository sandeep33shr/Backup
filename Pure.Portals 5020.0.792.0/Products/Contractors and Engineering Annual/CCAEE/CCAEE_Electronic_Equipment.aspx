<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAEE_Electronic_Equipment.aspx.vb" Inherits="Nexus.PB2_CCAEE_Electronic_Equipment" %>
...
function onValidate_ELECTEQUIP__EE0_12_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "Code(ELECTEQUIP.EE0_12_MONTHS) == 1 || Code(ELECTEQUIP.EE0_12_MONTHS) == 2 ||  Code(ELECTEQUIP.EE0_12_MONTHS) == '' ||  Code(ELECTEQUIP.EE0_12_MONTHS) == null ", "VEM", "{3}");
        
            var paramValue = "V",
            paramCondition = "Code(ELECTEQUIP.EE0_12_MONTHS) == 1 || Code(ELECTEQUIP.EE0_12_MONTHS) == 2 ||  Code(ELECTEQUIP.EE0_12_MONTHS) == '' ||  Code(ELECTEQUIP.EE0_12_MONTHS) == null ",
            paramElseValue = "VEM",
            paramValidationMessage = "{3}";
...
function onValidate_ELECTEQUIP__EE13_24_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "Code(ELECTEQUIP.EE13_24_MONTHS) == 1 || Code(ELECTEQUIP.EE13_24_MONTHS) == 2 ||  Code(ELECTEQUIP.EE13_24_MONTHS) == '' ||  Code(ELECTEQUIP.EE13_24_MONTHS) == null ", "VEM", "{3}");
        
            var paramValue = "V",
            paramCondition = "Code(ELECTEQUIP.EE13_24_MONTHS) == 1 || Code(ELECTEQUIP.EE13_24_MONTHS) == 2 ||  Code(ELECTEQUIP.EE13_24_MONTHS) == '' ||  Code(ELECTEQUIP.EE13_24_MONTHS) == null ",
            paramElseValue = "VEM",
            paramValidationMessage = "{3}";
...
function onValidate_ELECTEQUIP__EE25_36_AMOUNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "V", "Code(ELECTEQUIP.EE25_36_MONTHS) == 1 || Code(ELECTEQUIP.EE25_36_MONTHS) == 2 ||  Code(ELECTEQUIP.EE25_36_MONTHS) == '' ||  Code(ELECTEQUIP.EE25_36_MONTHS) == null ", "VEM", "{3}");
        
            var paramValue = "V",
            paramCondition = "Code(ELECTEQUIP.EE25_36_MONTHS) == 1 || Code(ELECTEQUIP.EE25_36_MONTHS) == 2 ||  Code(ELECTEQUIP.EE25_36_MONTHS) == '' ||  Code(ELECTEQUIP.EE25_36_MONTHS) == null ",
            paramElseValue = "VEM",
            paramValidationMessage = "{3}";
...
function onValidate_ELECTEQUIP__CEEQCHILD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQUIP", "CEEQCHILD", "ChildScreen");
        })();
}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ELECTEQUIP", "ALARM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_ELECTEQUIP__CEEQMP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQUIP", "CEEQMP", "ChildScreen");
        })();
}
...
function onValidate_ELECTEQUIP__EENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECTEQUIP", "EENDPREM", "ChildScreen");
        })();
}
...
function onValidate_ELECTEQUIP__EESNOTES(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("ELECTEQUIP", "EESNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'ELECTEQUIP' and property 'EESNOTES'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function DoLogic(isOnLoad) {
    ...
    onValidate_ELECTEQUIP__CEEQCHILD(null, null, null, isOnLoad);
    ...
    onValidate_ELECTEQUIP__CEEQMP(null, null, null, isOnLoad);
    onValidate_ELECTEQUIP__TOTAL_ENDORSE_PREM(null, null, null, isOnLoad);
    onValidate_ELECTEQUIP__EENDPREM(null, null, null, isOnLoad);
...
<div id="id206bf12b9f2b4fa498b6963ba73c7312" class="general-layout-container">
...
<div id="id5cdb25ceb95d4e46a2c6d17095f1bbbc" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5cdb25ceb95d4e46a2c6d17095f1bbbc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5cdb25ceb95d4e46a2c6d17095f1bbbc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5cdb25ceb95d4e46a2c6d17095f1bbbc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5cdb25ceb95d4e46a2c6d17095f1bbbc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5cdb25ceb95d4e46a2c6d17095f1bbbc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5cdb25ceb95d4e46a2c6d17095f1bbbc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5cdb25ceb95d4e46a2c6d17095f1bbbc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5cdb25ceb95d4e46a2c6d17095f1bbbc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5cdb25ceb95d4e46a2c6d17095f1bbbc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5cdb25ceb95d4e46a2c6d17095f1bbbc input{text-align:left;}"; break;
		}
	}
...
<div id="Pastclaimscount" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading23" runat="server" Text="Past Claims History" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label7">
		<span class="label" id="label7"><B>Electronic Equipment</B></span>
	</span>
<!-- /Label -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id75af3bb759454cbf95cf98708b19a4aa" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading24" runat="server" Text="Electronic Equipment Items" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id75af3bb759454cbf95cf98708b19a4aa div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id75af3bb759454cbf95cf98708b19a4aa div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id75af3bb759454cbf95cf98708b19a4aa div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id75af3bb759454cbf95cf98708b19a4aa label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id75af3bb759454cbf95cf98708b19a4aa label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id75af3bb759454cbf95cf98708b19a4aa label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id75af3bb759454cbf95cf98708b19a4aa label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id75af3bb759454cbf95cf98708b19a4aa input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id75af3bb759454cbf95cf98708b19a4aa input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id75af3bb759454cbf95cf98708b19a4aa input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5087a8dfa3e64da3b786190aad7d8609" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECTEQUIP__CEEQCHILD"
		data-field-type="Child" 
		data-object-name="ELECTEQUIP" 
		data-property-name="CEEQCHILD" 
		id="pb-container-childscreen-ELECTEQUIP-CEEQCHILD">
		
		    <legend>Electronic Equipment Items</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECTEQUIP__ELECTEQ" runat="server" ScreenCode="CEEQCHILD" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CEEQCHILD/CEEQCHILD_Electric_Equipment_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECTEQUIP_CEEQCHILD" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Electronic Equipment Items"
						ClientValidationFunction="onValidate_ELECTEQUIP__CEEQCHILD" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5087a8dfa3e64da3b786190aad7d8609 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5087a8dfa3e64da3b786190aad7d8609 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5087a8dfa3e64da3b786190aad7d8609 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5087a8dfa3e64da3b786190aad7d8609 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5087a8dfa3e64da3b786190aad7d8609 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5087a8dfa3e64da3b786190aad7d8609 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5087a8dfa3e64da3b786190aad7d8609 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5087a8dfa3e64da3b786190aad7d8609 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5087a8dfa3e64da3b786190aad7d8609 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5087a8dfa3e64da3b786190aad7d8609 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3e81139f2b934467a9567288605577f3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="First Amount Payable" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label12">
		<span class="label" id="label12">First Amount Payable Per Section</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label13">
		<span class="label" id="label13">First Amount Payable Lightning/Surge</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3e81139f2b934467a9567288605577f3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3e81139f2b934467a9567288605577f3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3e81139f2b934467a9567288605577f3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3e81139f2b934467a9567288605577f3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3e81139f2b934467a9567288605577f3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3e81139f2b934467a9567288605577f3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3e81139f2b934467a9567288605577f3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3e81139f2b934467a9567288605577f3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3e81139f2b934467a9567288605577f3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3e81139f2b934467a9567288605577f3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb0d022c3d7894975ad102538100bdfbb" class="column-layout-container,no-border  ">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label19">
		<span class="label" id="label19">Posting Premium</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label22">
		<span class="label" id="label22">Indemnity Period</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label23">
		<span class="label" id="label23">Time Excess</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label24">
		<span class="label" id="label24">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label29">
		<span class="label" id="label29">Increased Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label30">
		<span class="label" id="label30">Reinstatement Of Data/Programs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label33">
		<span class="label" id="label33">Incompatibility Cover</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label40">
		<span class="label" id="label40">Loss Of Profit</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label42">
		<span class="label" id="label42">Riot & Strike </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label62">
		<span class="label" id="label62">Total </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb0d022c3d7894975ad102538100bdfbb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb0d022c3d7894975ad102538100bdfbb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb0d022c3d7894975ad102538100bdfbb div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb0d022c3d7894975ad102538100bdfbb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb0d022c3d7894975ad102538100bdfbb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb0d022c3d7894975ad102538100bdfbb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb0d022c3d7894975ad102538100bdfbb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb0d022c3d7894975ad102538100bdfbb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb0d022c3d7894975ad102538100bdfbb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb0d022c3d7894975ad102538100bdfbb input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id177b0da9883b4afa8e4927cb824b5008" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading28" runat="server" Text="Alarm Warranty" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id177b0da9883b4afa8e4927cb824b5008 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id177b0da9883b4afa8e4927cb824b5008 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id177b0da9883b4afa8e4927cb824b5008 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id177b0da9883b4afa8e4927cb824b5008 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id177b0da9883b4afa8e4927cb824b5008 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id177b0da9883b4afa8e4927cb824b5008 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id177b0da9883b4afa8e4927cb824b5008 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id177b0da9883b4afa8e4927cb824b5008 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id177b0da9883b4afa8e4927cb824b5008 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id177b0da9883b4afa8e4927cb824b5008 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id46058cc66a7c4256906ddfdcb8eb8a92" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading29" runat="server" Text="Type of Exposure" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id46058cc66a7c4256906ddfdcb8eb8a92 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id46058cc66a7c4256906ddfdcb8eb8a92 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id46058cc66a7c4256906ddfdcb8eb8a92 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id46058cc66a7c4256906ddfdcb8eb8a92 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id46058cc66a7c4256906ddfdcb8eb8a92 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id46058cc66a7c4256906ddfdcb8eb8a92 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id46058cc66a7c4256906ddfdcb8eb8a92 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id46058cc66a7c4256906ddfdcb8eb8a92 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id46058cc66a7c4256906ddfdcb8eb8a92 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id46058cc66a7c4256906ddfdcb8eb8a92 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0378451c2e7640febc538b392b48e2fc" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading30" runat="server" Text="Risk" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0378451c2e7640febc538b392b48e2fc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0378451c2e7640febc538b392b48e2fc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0378451c2e7640febc538b392b48e2fc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0378451c2e7640febc538b392b48e2fc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0378451c2e7640febc538b392b48e2fc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0378451c2e7640febc538b392b48e2fc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0378451c2e7640febc538b392b48e2fc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0378451c2e7640febc538b392b48e2fc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0378451c2e7640febc538b392b48e2fc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0378451c2e7640febc538b392b48e2fc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id73abd360232b4542a46d6e4304c62e5c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading31" runat="server" Text="Maximum Loss - Theft" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id73abd360232b4542a46d6e4304c62e5c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id73abd360232b4542a46d6e4304c62e5c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id73abd360232b4542a46d6e4304c62e5c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id73abd360232b4542a46d6e4304c62e5c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id73abd360232b4542a46d6e4304c62e5c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id73abd360232b4542a46d6e4304c62e5c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id73abd360232b4542a46d6e4304c62e5c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id73abd360232b4542a46d6e4304c62e5c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id73abd360232b4542a46d6e4304c62e5c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id73abd360232b4542a46d6e4304c62e5c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id46c9d83a41f04903a93d030f010d3fd1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECTEQUIP__CEEQMP"
		data-field-type="Child" 
		data-object-name="ELECTEQUIP" 
		data-property-name="CEEQMP" 
		id="pb-container-childscreen-ELECTEQUIP-CEEQMP">
		
		    <legend>Multiple Premises</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECTEQUIP__EE_MULTIPLE_PREMISES" runat="server" ScreenCode="CEEQMP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CEEQMP/CEEQMP_Multiple_Premises.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Sum Insured" DataField="SUMINSURED" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECTEQUIP_CEEQMP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Multiple Premises"
						ClientValidationFunction="onValidate_ELECTEQUIP__CEEQMP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id46c9d83a41f04903a93d030f010d3fd1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id46c9d83a41f04903a93d030f010d3fd1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id46c9d83a41f04903a93d030f010d3fd1 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id46c9d83a41f04903a93d030f010d3fd1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id46c9d83a41f04903a93d030f010d3fd1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id46c9d83a41f04903a93d030f010d3fd1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id46c9d83a41f04903a93d030f010d3fd1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id46c9d83a41f04903a93d030f010d3fd1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id46c9d83a41f04903a93d030f010d3fd1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id46c9d83a41f04903a93d030f010d3fd1 input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading33" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblELECTEQUIP_REFERRAL_CLAUSES" runat="server" AssociatedControlID="ELECTEQUIP__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="ELECTEQUIP__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECTEQUIP__EENDPREM"
		data-field-type="Child" 
		data-object-name="ELECTEQUIP" 
		data-property-name="EENDPREM" 
		id="pb-container-childscreen-ELECTEQUIP-EENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECTEQUIP__EE_CLAUSE" runat="server" ScreenCode="EENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="EENDPREM/EENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECTEQUIP_EENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ELECTEQUIP.EENDPREM"
						ClientValidationFunction="onValidate_ELECTEQUIP__EENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div id="frmNotes" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading34" runat="server" Text="Notes Printed on the Schedule" /></legend>
...
<div id="frmNotes" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading35" runat="server" Text="Notes Not Printed on the schedule" /></legend>
