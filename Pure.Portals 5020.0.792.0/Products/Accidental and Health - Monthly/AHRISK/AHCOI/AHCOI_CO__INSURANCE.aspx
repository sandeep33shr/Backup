...
<div id="id9b1631e94d7d45d8bb5272b99286e75a" class="general-layout-container">
...
<div id="id51cf1e9a3f08439b9ebc4c8ebecb0e9f" class="column-layout-container,no-border  ">
	...
	<span class="field-container"
		...
		<asp:Label ID="lblAHCOI_CO_INM" runat="server" AssociatedControlID="AHCOI__CO_INM" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AHCOI__CO_INM" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id51cf1e9a3f08439b9ebc4c8ebecb0e9f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id51cf1e9a3f08439b9ebc4c8ebecb0e9f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id51cf1e9a3f08439b9ebc4c8ebecb0e9f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id51cf1e9a3f08439b9ebc4c8ebecb0e9f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id51cf1e9a3f08439b9ebc4c8ebecb0e9f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id51cf1e9a3f08439b9ebc4c8ebecb0e9f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id51cf1e9a3f08439b9ebc4c8ebecb0e9f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id51cf1e9a3f08439b9ebc4c8ebecb0e9f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id51cf1e9a3f08439b9ebc4c8ebecb0e9f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id51cf1e9a3f08439b9ebc4c8ebecb0e9f input{text-align:left;}"; break;
		}
	}
