...
Namespace Nexus
    Partial Class PB2_AHSNOTES_Notes_Detials : Inherits BaseRisk
		...
		Protected Sub onValidate_AHNOTES__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If AHNOTES__Date_Created.Text.ToString = "" Then
        		AHNOTES__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		AHNOTES__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_AHNOTES__NOTE_DETAILS()
End Sub
