...
Namespace Nexus
    Partial Class PB2_AHENDOSE_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_AH_ENDOSE__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_AH_ENDOSE__ENDORSE_ID()
End Sub
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/EMPDE/SW.REFERRAL_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("AH_ENDOSE__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/EMPDE/AH_ENDOSE")
        
        	Dim CurrentSelected As String = AH_ENDOSE__ENDORSE_CAP.Text
