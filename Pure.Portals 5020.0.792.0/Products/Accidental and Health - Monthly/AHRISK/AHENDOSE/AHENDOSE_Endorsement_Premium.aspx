<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="AHENDOSE_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_AHENDOSE_Endorsement_Premium" %>
...
function onValidate_AH_ENDOSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AH_ENDOSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AH_ENDOSE", "ENDORSE_ID");
        		}
...
function onValidate_AH_ENDOSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AH_ENDOSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("AH_ENDOSE", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AH_ENDOSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "AH_ENDOSE", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAH_ENDOSE_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_AH_ENDOSE__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AH_ENDOSE__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_AH_ENDOSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AH_ENDOSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("AH_ENDOSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AH_ENDOSE.ENDORSE_CAP");
        			window.setControlWidth(field, "0.4", "AH_ENDOSE", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAH_ENDOSE_ENDORSE_CAP");
        			    var ele = document.getElementById('ctl00_cntMainBody_AH_ENDOSE__ENDORSE_CAP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AH_ENDOSE__ENDORSE_CAP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=AH_ENDOSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(AH_ENDOSE.ENDORSE_DESC)"), 
...
function onValidate_AH_ENDOSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AH_ENDOSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("AH_ENDOSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AH_ENDOSE.PREMIUM");
        			window.setControlWidth(field, "0.4", "AH_ENDOSE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAH_ENDOSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_AH_ENDOSE__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AH_ENDOSE__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_AH_ENDOSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_AH_ENDOSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_AH_ENDOSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_AH_ENDOSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id9537e9cdad9d42339aff391f64c52a11" class="general-layout-container">
...
<div id="idc92d681eba5c4059ba0a440aaaf76bd1" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="AH_ENDOSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-AH_ENDOSE-ENDORSE_ID">
		
		
		<asp:Label ID="lblAH_ENDOSE_ENDORSE_ID" runat="server" AssociatedControlID="AH_ENDOSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AH_ENDOSE__ENDORSE_ID" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valAH_ENDOSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_AH_ENDOSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-AH_ENDOSE-ENDORSE_DESC">
		
					
		<asp:Label ID="lblAH_ENDOSE_ENDORSE_DESC" runat="server" AssociatedControlID="AH_ENDOSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="AH_ENDOSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_AH_ENDOSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valAH_ENDOSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_AH_ENDOSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-AH_ENDOSE-ENDORSE_CAP">
		
		
		<asp:Label ID="lblAH_ENDOSE_ENDORSE_CAP" runat="server" AssociatedControlID="AH_ENDOSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AH_ENDOSE__ENDORSE_CAP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valAH_ENDOSE_ENDORSE_CAP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_AH_ENDOSE__ENDORSE_CAP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-AH_ENDOSE-PREMIUM">
		
		
		<asp:Label ID="lblAH_ENDOSE_PREMIUM" runat="server" AssociatedControlID="AH_ENDOSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AH_ENDOSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valAH_ENDOSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_AH_ENDOSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-Text-AH_ENDOSE-ENDORSE_DESCCode">
		
		
		<asp:Label ID="lblAH_ENDOSE_ENDORSE_DESCCode" runat="server" AssociatedControlID="AH_ENDOSE__ENDORSE_DESCCode" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AH_ENDOSE__ENDORSE_DESCCode" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valAH_ENDOSE_ENDORSE_DESCCode" 
			runat="server" 
			Text="*" 
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc92d681eba5c4059ba0a440aaaf76bd1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc92d681eba5c4059ba0a440aaaf76bd1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc92d681eba5c4059ba0a440aaaf76bd1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc92d681eba5c4059ba0a440aaaf76bd1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc92d681eba5c4059ba0a440aaaf76bd1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc92d681eba5c4059ba0a440aaaf76bd1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc92d681eba5c4059ba0a440aaaf76bd1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc92d681eba5c4059ba0a440aaaf76bd1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc92d681eba5c4059ba0a440aaaf76bd1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc92d681eba5c4059ba0a440aaaf76bd1 input{text-align:left;}"; break;
		}
	}
