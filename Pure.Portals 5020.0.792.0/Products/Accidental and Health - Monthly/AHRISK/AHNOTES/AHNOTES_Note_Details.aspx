...
<div id="idef1c5ea61f05485aa2301302bea6b496" class="general-layout-container">
...
<div id="iddc5d60ed576549b083f5206aac580285" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblAHSNOTES_CREATED_BY" runat="server" AssociatedControlID="AHSNOTES__CREATED_BY" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AHSNOTES__CREATED_BY" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblAHSNOTES_COVER_TYPE" runat="server" AssociatedControlID="AHSNOTES__COVER_TYPE" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AHSNOTES__COVER_TYPE" runat="server" CssClass="form-control" />
		   </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblAHSNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="AHSNOTES__NOTE_DESCRIPTION" 
		   ...
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="AHSNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" />
		   </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddc5d60ed576549b083f5206aac580285 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddc5d60ed576549b083f5206aac580285 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddc5d60ed576549b083f5206aac580285 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddc5d60ed576549b083f5206aac580285 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddc5d60ed576549b083f5206aac580285 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddc5d60ed576549b083f5206aac580285 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddc5d60ed576549b083f5206aac580285 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddc5d60ed576549b083f5206aac580285 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddc5d60ed576549b083f5206aac580285 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddc5d60ed576549b083f5206aac580285 input{text-align:left;}"; break;
		}
	}
