...
Namespace Nexus
    Partial Class PB2_CMALIAB_Fare_Paying_Passengers : Inherits BaseRisk
...
End Sub
Protected Sub onValidate_FPPLIAB__RISK_ATTACH_DATE()
        
End Sub
Protected Sub onValidate_FPPLIAB__EFFECTIVEDATE()
...
Protected Sub CallRuleScripts()
    ...
    onValidate_FPPLIAB__RISK_ATTACH_DATE()
    onValidate_FPPLIAB__EFFECTIVEDATE()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If FPPLIAB__RISK_ATTACH_DATE.Text = "" or FPPLIAB__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			FPPLIAB__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			FPPLIAB__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (FPPLIAB__RISK_ATTACH_DATE.Text <> "" Or FPPLIAB__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		FPPLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		FPPLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		FPPLIAB__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
