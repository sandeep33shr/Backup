...
Namespace Nexus
    Partial Class PB2_FFSPPNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_FFSP_PNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If FFSP_PNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		FFSP_PNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		FFSP_PNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_FFSP_PNOTES_DETAILS__NOTE_DETAILS()
End Sub
