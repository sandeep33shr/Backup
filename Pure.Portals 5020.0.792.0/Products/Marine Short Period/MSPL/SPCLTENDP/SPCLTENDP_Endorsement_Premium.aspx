<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPCLTENDP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_SPCLTENDP_Endorsement_Premium" %>
...
function onValidate_CL_CLAUSEPREM__PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CL_CLAUSEPREM.PREMIUM");
        			window.setControlWidth(field, "0.3", "CL_CLAUSEPREM", "PREMIUM");
        		})();
        	}
        })();
...
<div id="idd5933584324c4cc98d5b9e7da2c8e13c" class="general-layout-container">
...
<div id="id7dafa74d861e41fd9752cb4e3c74c15c" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7dafa74d861e41fd9752cb4e3c74c15c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7dafa74d861e41fd9752cb4e3c74c15c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7dafa74d861e41fd9752cb4e3c74c15c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7dafa74d861e41fd9752cb4e3c74c15c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7dafa74d861e41fd9752cb4e3c74c15c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7dafa74d861e41fd9752cb4e3c74c15c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7dafa74d861e41fd9752cb4e3c74c15c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7dafa74d861e41fd9752cb4e3c74c15c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7dafa74d861e41fd9752cb4e3c74c15c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7dafa74d861e41fd9752cb4e3c74c15c input{text-align:left;}"; break;
		}
	}
