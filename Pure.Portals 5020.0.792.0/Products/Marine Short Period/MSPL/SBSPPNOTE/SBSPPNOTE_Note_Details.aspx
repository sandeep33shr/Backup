<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SBSPPNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_SBSPPNOTE_Note_Details" %>
...
<div id="id7495636110b34e4cb9507bb86532e47f" class="general-layout-container">
...
<div id="id9cdb71e87d494094b5bc4a2c46d4ee4f" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9cdb71e87d494094b5bc4a2c46d4ee4f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9cdb71e87d494094b5bc4a2c46d4ee4f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9cdb71e87d494094b5bc4a2c46d4ee4f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9cdb71e87d494094b5bc4a2c46d4ee4f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9cdb71e87d494094b5bc4a2c46d4ee4f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9cdb71e87d494094b5bc4a2c46d4ee4f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9cdb71e87d494094b5bc4a2c46d4ee4f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9cdb71e87d494094b5bc4a2c46d4ee4f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9cdb71e87d494094b5bc4a2c46d4ee4f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9cdb71e87d494094b5bc4a2c46d4ee4f input{text-align:left;}"; break;
		}
	}
