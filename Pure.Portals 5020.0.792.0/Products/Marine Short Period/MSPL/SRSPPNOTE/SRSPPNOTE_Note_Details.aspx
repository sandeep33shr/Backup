<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SRSPPNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_SRSPPNOTE_Note_Details" %>
...
<div id="id08dbb3500d9a425ebd5f9d9814395bd8" class="general-layout-container">
...
<div id="id4ed9cf8f1ea4480eaf9da3c03b8dddd2" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4ed9cf8f1ea4480eaf9da3c03b8dddd2 input{text-align:left;}"; break;
		}
	}
