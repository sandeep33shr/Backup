<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPL_Carriers_Legal_Liability.aspx.vb" Inherits="Nexus.PB2_MSPL_Carriers_Legal_Liability" %>
...
function onValidate_CARRIERS__MSPLCLL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "MSPLCLL", "ChildScreen");
        })();
}
function onValidate_CARRIERS__MSPLCLDED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "MSPLCLDED", "ChildScreen");
        })();
}
function onValidate_CARRIERS__TOT_END_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "TOT_END_PREM", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("CARRIERS", "TOT_END_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the label width
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCARRIERS_TOT_END_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_CARRIERS__TOT_END_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CARRIERS__TOT_END_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CARRIERS.TOT_END_PREM");
        			window.setControlWidth(field, "0.3", "CARRIERS", "TOT_END_PREM");
        		})();
        	}
        })();
        /**
...
function onValidate_CARRIERS__MSPLCLEND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "MSPLCLEND", "ChildScreen");
        })();
}
function onValidate_CARRIERS__MSPLCLNPN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "MSPLCLNPN", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CARRIERS", "MSPLCLNPN");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_CARRIERS__MSPLCLNPN table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CARRIERS", "MSPLCLNPN");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CARRIERS' and property 'MSPLCLNPN'.");
        			error.display();
...
function onValidate_CARRIERS__SPCCLPNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "SPCCLPNT", "ChildScreen");
        })();
        /**
         * @fileoverview Renames the matching links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("CARRIERS", "SPCCLPNT");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_CARRIERS__SPCCLPNT table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CARRIERS", "SPCCLPNT");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CARRIERS' and property 'SPCCLPNT'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function onValidate_CARRIERS__BASE_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "BASE_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CARRIERS", "BASE_PREM");
        	field.setReadOnly(true);
        })();
}
function onValidate_CARRIERS__EXT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "EXT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CARRIERS", "EXT_PREM");
        	field.setReadOnly(true);
        })();
}
function onValidate_CARRIERS__END_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "END_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CARRIERS", "END_PREM");
        	field.setReadOnly(true);
        })();
}
function onValidate_CARRIERS__TOT_RISK_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CARRIERS", "TOT_RISK_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CARRIERS", "TOT_RISK_PREM");
        	field.setReadOnly(true);
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_CARRIERS__MSPLCLL(null, null, null, isOnLoad);
    onValidate_CARRIERS__MSPLCLDED(null, null, null, isOnLoad);
    onValidate_CARRIERS__TOT_END_PREM(null, null, null, isOnLoad);
    onValidate_CARRIERS__MSPLCLEND(null, null, null, isOnLoad);
    onValidate_CARRIERS__MSPLCLNPN(null, null, null, isOnLoad);
    onValidate_CARRIERS__SPCCLPNT(null, null, null, isOnLoad);
    onValidate_CARRIERS__BASE_PREM(null, null, null, isOnLoad);
    onValidate_CARRIERS__EXT_PREM(null, null, null, isOnLoad);
    onValidate_CARRIERS__END_PREM(null, null, null, isOnLoad);
    onValidate_CARRIERS__TOT_RISK_PREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id22c3e758552c46f89831c3085963d03b" class="general-layout-container">
...
<div id="id99c82654286840c3a8fcd8118cef7397" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id99c82654286840c3a8fcd8118cef7397 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id99c82654286840c3a8fcd8118cef7397 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id99c82654286840c3a8fcd8118cef7397 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id99c82654286840c3a8fcd8118cef7397 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id99c82654286840c3a8fcd8118cef7397 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id99c82654286840c3a8fcd8118cef7397 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id99c82654286840c3a8fcd8118cef7397 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id99c82654286840c3a8fcd8118cef7397 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id99c82654286840c3a8fcd8118cef7397 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id99c82654286840c3a8fcd8118cef7397 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide75207a05a984566934c3fa5f0718d87" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CARRIERS__MSPLCLL"
		data-field-type="Child" 
		data-object-name="CARRIERS" 
		data-property-name="MSPLCLL" 
		id="pb-container-childscreen-CARRIERS-MSPLCLL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CARRIERS__CLLEXT" runat="server" ScreenCode="MSPLCLL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPLCLL/MSPLCLL_Carriers_Legal_Liability.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="CLLP" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCARRIERS_MSPLCLL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CARRIERS.MSPLCLL"
						ClientValidationFunction="onValidate_CARRIERS__MSPLCLL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide75207a05a984566934c3fa5f0718d87 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide75207a05a984566934c3fa5f0718d87 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide75207a05a984566934c3fa5f0718d87 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide75207a05a984566934c3fa5f0718d87 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide75207a05a984566934c3fa5f0718d87 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide75207a05a984566934c3fa5f0718d87 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide75207a05a984566934c3fa5f0718d87 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide75207a05a984566934c3fa5f0718d87 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide75207a05a984566934c3fa5f0718d87 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide75207a05a984566934c3fa5f0718d87 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idccf4fd9e26e3456e9820fde06adf233c" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CARRIERS__MSPLCLDED"
		data-field-type="Child" 
		data-object-name="CARRIERS" 
		data-property-name="MSPLCLDED" 
		id="pb-container-childscreen-CARRIERS-MSPLCLDED">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CARRIERS__CLLDEDUCT" runat="server" ScreenCode="MSPLCLDED" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPLCLDED/MSPLCLDED_Carriers_Legal_Liability.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Basis of Deductible" DataField="CLLBOE" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCARRIERS_MSPLCLDED" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CARRIERS.MSPLCLDED"
						ClientValidationFunction="onValidate_CARRIERS__MSPLCLDED" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idccf4fd9e26e3456e9820fde06adf233c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idccf4fd9e26e3456e9820fde06adf233c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idccf4fd9e26e3456e9820fde06adf233c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idccf4fd9e26e3456e9820fde06adf233c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idccf4fd9e26e3456e9820fde06adf233c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idccf4fd9e26e3456e9820fde06adf233c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idccf4fd9e26e3456e9820fde06adf233c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idccf4fd9e26e3456e9820fde06adf233c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idccf4fd9e26e3456e9820fde06adf233c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idccf4fd9e26e3456e9820fde06adf233c input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblCARRIERS_REFERRAL_CLAUSES_REFERRAL_CLLAUSES" runat="server" AssociatedControlID="CARRIERS_REFERRAL_CLAUSES__REFERRAL_CLLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="CARRIERS_REFERRAL_CLAUSES__REFERRAL_CLLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id81ccb5257fe44f21bd8bf5bba716e678" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CARRIERS-TOT_END_PREM">
		<asp:Label ID="lblCARRIERS_TOT_END_PREM" runat="server" AssociatedControlID="CARRIERS__TOT_END_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CARRIERS__TOT_END_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCARRIERS_TOT_END_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_CARRIERS__TOT_END_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id81ccb5257fe44f21bd8bf5bba716e678 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id81ccb5257fe44f21bd8bf5bba716e678 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id81ccb5257fe44f21bd8bf5bba716e678 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id81ccb5257fe44f21bd8bf5bba716e678 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id81ccb5257fe44f21bd8bf5bba716e678 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id81ccb5257fe44f21bd8bf5bba716e678 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id81ccb5257fe44f21bd8bf5bba716e678 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id81ccb5257fe44f21bd8bf5bba716e678 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id81ccb5257fe44f21bd8bf5bba716e678 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id81ccb5257fe44f21bd8bf5bba716e678 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id28cdb9e6e6e34fdc9e88217d4e2af081" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CARRIERS__MSPLCLEND"
		data-field-type="Child" 
		data-object-name="CARRIERS" 
		data-property-name="MSPLCLEND" 
		id="pb-container-childscreen-CARRIERS-MSPLCLEND">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CARRIERS__CLL_CLAUSEPREM" runat="server" ScreenCode="MSPLCLEND" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPLCLEND/MSPLCLEND_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCARRIERS_MSPLCLEND" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CARRIERS.MSPLCLEND"
						ClientValidationFunction="onValidate_CARRIERS__MSPLCLEND" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id28cdb9e6e6e34fdc9e88217d4e2af081 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id28cdb9e6e6e34fdc9e88217d4e2af081 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id28cdb9e6e6e34fdc9e88217d4e2af081 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id28cdb9e6e6e34fdc9e88217d4e2af081 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id28cdb9e6e6e34fdc9e88217d4e2af081 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id28cdb9e6e6e34fdc9e88217d4e2af081 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id28cdb9e6e6e34fdc9e88217d4e2af081 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id28cdb9e6e6e34fdc9e88217d4e2af081 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id28cdb9e6e6e34fdc9e88217d4e2af081 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id28cdb9e6e6e34fdc9e88217d4e2af081 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc9f26712d0ba4fa288485c1f7e08c284" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CARRIERS__MSPLCLNPN"
		data-field-type="Child" 
		data-object-name="CARRIERS" 
		data-property-name="MSPLCLNPN" 
		id="pb-container-childscreen-CARRIERS-MSPLCLNPN">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CARRIERS__CLL_NNOTES_DETAILS" runat="server" ScreenCode="MSPLCLNPN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPLCLNPN/MSPLCLNPN_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCARRIERS_MSPLCLNPN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CARRIERS.MSPLCLNPN"
						ClientValidationFunction="onValidate_CARRIERS__MSPLCLNPN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc9f26712d0ba4fa288485c1f7e08c284 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc9f26712d0ba4fa288485c1f7e08c284 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc9f26712d0ba4fa288485c1f7e08c284 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc9f26712d0ba4fa288485c1f7e08c284 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc9f26712d0ba4fa288485c1f7e08c284 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc9f26712d0ba4fa288485c1f7e08c284 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc9f26712d0ba4fa288485c1f7e08c284 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc9f26712d0ba4fa288485c1f7e08c284 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc9f26712d0ba4fa288485c1f7e08c284 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc9f26712d0ba4fa288485c1f7e08c284 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idda81a05600ec4496973f941960bbe92e" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CARRIERS__SPCCLPNT"
		data-field-type="Child" 
		data-object-name="CARRIERS" 
		data-property-name="SPCCLPNT" 
		id="pb-container-childscreen-CARRIERS-SPCCLPNT">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CARRIERS__CLL_PNOTES_DETAILS" runat="server" ScreenCode="SPCCLPNT" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SPCCLPNT/SPCCLPNT_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCARRIERS_SPCCLPNT" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CARRIERS.SPCCLPNT"
						ClientValidationFunction="onValidate_CARRIERS__SPCCLPNT" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idda81a05600ec4496973f941960bbe92e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idda81a05600ec4496973f941960bbe92e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idda81a05600ec4496973f941960bbe92e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idda81a05600ec4496973f941960bbe92e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idda81a05600ec4496973f941960bbe92e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idda81a05600ec4496973f941960bbe92e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idda81a05600ec4496973f941960bbe92e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idda81a05600ec4496973f941960bbe92e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idda81a05600ec4496973f941960bbe92e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idda81a05600ec4496973f941960bbe92e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id60a4471124af4744be2968da62a7dc8d" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CARRIERS-BASE_PREM">
		<asp:Label ID="lblCARRIERS_BASE_PREM" runat="server" AssociatedControlID="CARRIERS__BASE_PREM" 
			Text="Base Cover Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CARRIERS__BASE_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCARRIERS_BASE_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Base Cover Premium"
			ClientValidationFunction="onValidate_CARRIERS__BASE_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CARRIERS-EXT_PREM">
		<asp:Label ID="lblCARRIERS_EXT_PREM" runat="server" AssociatedControlID="CARRIERS__EXT_PREM" 
			Text="Extension Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CARRIERS__EXT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCARRIERS_EXT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Extension Premium"
			ClientValidationFunction="onValidate_CARRIERS__EXT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CARRIERS-END_PREM">
		<asp:Label ID="lblCARRIERS_END_PREM" runat="server" AssociatedControlID="CARRIERS__END_PREM" 
			Text="Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CARRIERS__END_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCARRIERS_END_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement Premium"
			ClientValidationFunction="onValidate_CARRIERS__END_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CARRIERS-TOT_RISK_PREM">
		<asp:Label ID="lblCARRIERS_TOT_RISK_PREM" runat="server" AssociatedControlID="CARRIERS__TOT_RISK_PREM" 
			Text="Total Risk Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CARRIERS__TOT_RISK_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCARRIERS_TOT_RISK_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Risk Premium"
			ClientValidationFunction="onValidate_CARRIERS__TOT_RISK_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id60a4471124af4744be2968da62a7dc8d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id60a4471124af4744be2968da62a7dc8d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id60a4471124af4744be2968da62a7dc8d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id60a4471124af4744be2968da62a7dc8d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id60a4471124af4744be2968da62a7dc8d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60a4471124af4744be2968da62a7dc8d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60a4471124af4744be2968da62a7dc8d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id60a4471124af4744be2968da62a7dc8d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60a4471124af4744be2968da62a7dc8d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60a4471124af4744be2968da62a7dc8d input{text-align:left;}"; break;
		}
	}
