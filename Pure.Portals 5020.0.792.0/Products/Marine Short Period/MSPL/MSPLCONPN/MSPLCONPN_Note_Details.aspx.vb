...
Namespace Nexus
    Partial Class PB2_MSPLCONPN_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CON_NNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CON_NNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		CON_NNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CON_NNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_CON_NNOTES_DETAILS__NOTE_DETAILS()
End Sub
