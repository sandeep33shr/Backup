...
Namespace Nexus
    Partial Class PB2_MSPLCLNPN_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CLL_NNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CLL_NNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		CLL_NNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CLL_NNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_CLL_NNOTES_DETAILS__NOTE_DETAILS()
End Sub
