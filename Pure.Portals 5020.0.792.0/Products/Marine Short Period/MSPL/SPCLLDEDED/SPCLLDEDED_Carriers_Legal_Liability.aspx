<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPCLLDEDED_Carriers_Legal_Liability.aspx.vb" Inherits="Nexus.PB2_SPCLLDEDED_Carriers_Legal_Liability" %>
...
function onValidate_CLLDEDUCT__CLLDDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLDEDUCT", "CLLDDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLDEDUCT_CLLDDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLDEDUCT__CLLDDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLDEDUCT__CLLDDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLDEDUCT", "CLLDDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLLDEDUCT", "CLLDDES");
...
function onValidate_CLLDEDUCT__CLLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLDEDUCT", "CLLP", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLDEDUCT", "CLLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLDEDUCT_CLLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLDEDUCT__CLLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLDEDUCT__CLLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLLDEDUCT", "CLLP");
...
function onValidate_CLLDEDUCT__CLLMIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLDEDUCT", "CLLMIN", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLDEDUCT_CLLMIN");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLDEDUCT__CLLMIN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLDEDUCT__CLLMIN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLDEDUCT", "CLLMIN");
        		}
...
function onValidate_CLLDEDUCT__CLLMAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLDEDUCT", "CLLMAX", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLDEDUCT_CLLMAX");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLDEDUCT__CLLMAX');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLDEDUCT__CLLMAX_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLDEDUCT", "CLLMAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_CLLDEDUCT__CLLBOE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLDEDUCT", "CLLBOE", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLDEDUCT_CLLBOE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLDEDUCT__CLLBOE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLDEDUCT__CLLBOE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLDEDUCT", "CLLBOE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLLDEDUCT", "CLLBOE");
...
function DoLogic(isOnLoad) {
    onValidate_CLLDEDUCT__CLLDDES(null, null, null, isOnLoad);
    onValidate_CLLDEDUCT__CLLP(null, null, null, isOnLoad);
    onValidate_CLLDEDUCT__CLLMIN(null, null, null, isOnLoad);
    onValidate_CLLDEDUCT__CLLMAX(null, null, null, isOnLoad);
    onValidate_CLLDEDUCT__CLLBOE(null, null, null, isOnLoad);
}
</script>
...
<div id="idb5953f8e5de24424834f6483498fe1f6" class="general-layout-container">
...
<div id="idc1c30ddedcbe46069c79cfadb7074488" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-property-name="CLLDDES" 
		 
		
		 
		id="pb-container-text-CLLDEDUCT-CLLDDES">

		
		<asp:Label ID="lblCLLDEDUCT_CLLDDES" runat="server" AssociatedControlID="CLLDEDUCT__CLLDDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CLLDEDUCT__CLLDDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCLLDEDUCT_CLLDDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CLLDEDUCT__CLLDDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CLLDEDUCT" 
		data-property-name="CLLP" 
		id="pb-container-percentage-CLLDEDUCT-CLLP">
		<asp:Label ID="lblCLLDEDUCT_CLLP" runat="server" AssociatedControlID="CLLDEDUCT__CLLP" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CLLDEDUCT__CLLP" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCLLDEDUCT_CLLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_CLLDEDUCT__CLLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CLLDEDUCT" 
		data-property-name="CLLMIN" 
		id="pb-container-currency-CLLDEDUCT-CLLMIN">
		<asp:Label ID="lblCLLDEDUCT_CLLMIN" runat="server" AssociatedControlID="CLLDEDUCT__CLLMIN" 
			Text="Deductible Min Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLDEDUCT__CLLMIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLDEDUCT_CLLMIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible Min Amount"
			ClientValidationFunction="onValidate_CLLDEDUCT__CLLMIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CLLDEDUCT" 
		data-property-name="CLLMAX" 
		id="pb-container-currency-CLLDEDUCT-CLLMAX">
		<asp:Label ID="lblCLLDEDUCT_CLLMAX" runat="server" AssociatedControlID="CLLDEDUCT__CLLMAX" 
			Text="Deductible Max Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLDEDUCT__CLLMAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLDEDUCT_CLLMAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible Max Amount"
			ClientValidationFunction="onValidate_CLLDEDUCT__CLLMAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="CLLDEDUCT" 
		data-property-name="CLLBOE" 
		id="pb-container-currency-CLLDEDUCT-CLLBOE">
		<asp:Label ID="lblCLLDEDUCT_CLLBOE" runat="server" AssociatedControlID="CLLDEDUCT__CLLBOE" 
			Text="Basis of Deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLDEDUCT__CLLBOE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLDEDUCT_CLLBOE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of Deductible"
			ClientValidationFunction="onValidate_CLLDEDUCT__CLLBOE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc1c30ddedcbe46069c79cfadb7074488 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc1c30ddedcbe46069c79cfadb7074488 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc1c30ddedcbe46069c79cfadb7074488 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc1c30ddedcbe46069c79cfadb7074488 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc1c30ddedcbe46069c79cfadb7074488 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc1c30ddedcbe46069c79cfadb7074488 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc1c30ddedcbe46069c79cfadb7074488 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc1c30ddedcbe46069c79cfadb7074488 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc1c30ddedcbe46069c79cfadb7074488 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc1c30ddedcbe46069c79cfadb7074488 input{text-align:left;}"; break;
		}
	}
