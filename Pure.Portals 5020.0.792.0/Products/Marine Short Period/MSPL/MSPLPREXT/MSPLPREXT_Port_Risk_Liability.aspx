<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPLPREXT_Port_Risk_Liability.aspx.vb" Inherits="Nexus.PB2_MSPLPREXT_Port_Risk_Liability" %>
...
function onValidate_PRSPEXT__PRSPDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRSPEXT", "PRSPDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRSPEXT_PRSPDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRSPEXT__PRSPDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRSPEXT__PRSPDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRSPEXT", "PRSPDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRSPEXT", "PRSPDES");
...
function onValidate_PRSPEXT__PRSPLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRSPEXT", "PRSPLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRSPEXT", "PRSPLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRSPEXT_PRSPLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRSPEXT__PRSPLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRSPEXT__PRSPLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRSPEXT", "PRSPLOI");
...
function onValidate_PRSPEXT__PRSPR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRSPEXT", "PRSPR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRSPEXT_PRSPR");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRSPEXT__PRSPR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRSPEXT__PRSPR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRSPEXT", "PRSPR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRSPEXT", "PRSPR");
...
function onValidate_PRSPEXT__PRSPP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRSPEXT", "PRSPP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRSPEXT_PRSPP");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRSPEXT__PRSPP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRSPEXT__PRSPP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRSPEXT", "PRSPP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRSPEXT", "PRSPP");
...
function DoLogic(isOnLoad) {
    onValidate_PRSPEXT__PRSPDES(null, null, null, isOnLoad);
    onValidate_PRSPEXT__PRSPLOI(null, null, null, isOnLoad);
    onValidate_PRSPEXT__PRSPR(null, null, null, isOnLoad);
    onValidate_PRSPEXT__PRSPP(null, null, null, isOnLoad);
}
</script>
...
<div id="id8277f0036fe747a4b942af2a94fc6b1d" class="general-layout-container">
...
<div id="idaf707a04ba2140bab2c5f4b100f9b755" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PRSPEXT" 
		data-property-name="PRSPDES" 
		 
		
		 
		id="pb-container-text-PRSPEXT-PRSPDES">

		
		<asp:Label ID="lblPRSPEXT_PRSPDES" runat="server" AssociatedControlID="PRSPEXT__PRSPDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PRSPEXT__PRSPDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPRSPEXT_PRSPDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_PRSPEXT__PRSPDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PRSPEXT" 
		data-property-name="PRSPLOI" 
		id="pb-container-currency-PRSPEXT-PRSPLOI">
		<asp:Label ID="lblPRSPEXT_PRSPLOI" runat="server" AssociatedControlID="PRSPEXT__PRSPLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRSPEXT__PRSPLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRSPEXT_PRSPLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_PRSPEXT__PRSPLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PRSPEXT" 
		data-property-name="PRSPR" 
		id="pb-container-percentage-PRSPEXT-PRSPR">
		<asp:Label ID="lblPRSPEXT_PRSPR" runat="server" AssociatedControlID="PRSPEXT__PRSPR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PRSPEXT__PRSPR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPRSPEXT_PRSPR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_PRSPEXT__PRSPR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PRSPEXT-PRSPP">
		<asp:Label ID="lblPRSPEXT_PRSPP" runat="server" AssociatedControlID="PRSPEXT__PRSPP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRSPEXT__PRSPP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRSPEXT_PRSPP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PRSPEXT__PRSPP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idaf707a04ba2140bab2c5f4b100f9b755 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idaf707a04ba2140bab2c5f4b100f9b755 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idaf707a04ba2140bab2c5f4b100f9b755 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idaf707a04ba2140bab2c5f4b100f9b755 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idaf707a04ba2140bab2c5f4b100f9b755 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaf707a04ba2140bab2c5f4b100f9b755 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaf707a04ba2140bab2c5f4b100f9b755 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idaf707a04ba2140bab2c5f4b100f9b755 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaf707a04ba2140bab2c5f4b100f9b755 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaf707a04ba2140bab2c5f4b100f9b755 input{text-align:left;}"; break;
		}
	}
