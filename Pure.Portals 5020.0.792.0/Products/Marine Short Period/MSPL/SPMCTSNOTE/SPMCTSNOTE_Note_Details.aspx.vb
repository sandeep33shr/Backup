...
Namespace Nexus
    Partial Class PB2_SPMCTSNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CL_PNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CL_PNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		CL_PNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CL_PNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_CL_PNOTES_DETAILS__NOTE_DETAILS()
End Sub
