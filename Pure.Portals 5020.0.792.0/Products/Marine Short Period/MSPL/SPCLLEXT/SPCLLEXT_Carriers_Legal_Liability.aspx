<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SPCLLEXT_Carriers_Legal_Liability.aspx.vb" Inherits="Nexus.PB2_SPCLLEXT_Carriers_Legal_Liability" %>
...
function onValidate_CLLEXT__CLLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLEXT", "CLLDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLEXT_CLLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLEXT__CLLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLEXT__CLLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLEXT", "CLLDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLLEXT", "CLLDES");
...
function onValidate_CLLEXT__CLLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLEXT", "CLLLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLEXT", "CLLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLEXT_CLLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLEXT__CLLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLEXT__CLLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLLEXT", "CLLLOI");
...
function onValidate_CLLEXT__CLLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLEXT", "CLLR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLEXT_CLLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLEXT__CLLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLEXT__CLLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLEXT", "CLLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLLEXT", "CLLR");
...
function onValidate_CLLEXT__CLLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLLEXT", "CLLP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCLLEXT_CLLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CLLEXT__CLLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CLLEXT__CLLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CLLEXT", "CLLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("CLLEXT", "CLLP");
...
function DoLogic(isOnLoad) {
    onValidate_CLLEXT__CLLDES(null, null, null, isOnLoad);
    onValidate_CLLEXT__CLLLOI(null, null, null, isOnLoad);
    onValidate_CLLEXT__CLLR(null, null, null, isOnLoad);
    onValidate_CLLEXT__CLLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idd0044df69809415095505536959eee1b" class="general-layout-container">
...
<div id="idb988b7f3dfaf41e19fe116c1f207097f" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-property-name="CLLDES" 
		 
		
		 
		id="pb-container-text-CLLEXT-CLLDES">

		
		<asp:Label ID="lblCLLEXT_CLLDES" runat="server" AssociatedControlID="CLLEXT__CLLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CLLEXT__CLLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCLLEXT_CLLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CLLEXT__CLLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CLLEXT" 
		data-property-name="CLLLOI" 
		id="pb-container-currency-CLLEXT-CLLLOI">
		<asp:Label ID="lblCLLEXT_CLLLOI" runat="server" AssociatedControlID="CLLEXT__CLLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLEXT__CLLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLEXT_CLLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CLLEXT__CLLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CLLEXT" 
		data-property-name="CLLR" 
		id="pb-container-percentage-CLLEXT-CLLR">
		<asp:Label ID="lblCLLEXT_CLLR" runat="server" AssociatedControlID="CLLEXT__CLLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CLLEXT__CLLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCLLEXT_CLLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_CLLEXT__CLLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CLLEXT-CLLP">
		<asp:Label ID="lblCLLEXT_CLLP" runat="server" AssociatedControlID="CLLEXT__CLLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CLLEXT__CLLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCLLEXT_CLLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CLLEXT__CLLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb988b7f3dfaf41e19fe116c1f207097f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb988b7f3dfaf41e19fe116c1f207097f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb988b7f3dfaf41e19fe116c1f207097f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb988b7f3dfaf41e19fe116c1f207097f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb988b7f3dfaf41e19fe116c1f207097f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb988b7f3dfaf41e19fe116c1f207097f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb988b7f3dfaf41e19fe116c1f207097f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb988b7f3dfaf41e19fe116c1f207097f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb988b7f3dfaf41e19fe116c1f207097f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb988b7f3dfaf41e19fe116c1f207097f input{text-align:left;}"; break;
		}
	}
