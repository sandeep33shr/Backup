<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPLCOEXT_Containers_Liability.aspx.vb" Inherits="Nexus.PB2_MSPLCOEXT_Containers_Liability" %>
...
function onValidate_CONEXT__CONDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONEXT", "CONDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONEXT.CONDES");
        			window.setControlWidth(field, "0.8", "CONEXT", "CONDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONEXT_CONDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONEXT__CONDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONEXT__CONDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONEXT", "CONDES");
        		}
...
function onValidate_CONEXT__CONLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONEXT", "CONLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONEXT.CONLOI");
        			window.setControlWidth(field, "0.8", "CONEXT", "CONLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONEXT", "CONLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONEXT_CONLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONEXT__CONLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONEXT__CONLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CONEXT__CONR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONEXT", "CONR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONEXT.CONR");
        			window.setControlWidth(field, "0.8", "CONEXT", "CONR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONEXT_CONR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONEXT__CONR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONEXT__CONR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONEXT", "CONR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CONEXT__CONP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONEXT", "CONP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONEXT.CONP");
        			window.setControlWidth(field, "0.8", "CONEXT", "CONP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONEXT_CONP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONEXT__CONP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONEXT__CONP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONEXT", "CONP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_CONEXT__CONDES(null, null, null, isOnLoad);
    onValidate_CONEXT__CONLOI(null, null, null, isOnLoad);
    onValidate_CONEXT__CONR(null, null, null, isOnLoad);
    onValidate_CONEXT__CONP(null, null, null, isOnLoad);
}
</script>
...
<div id="idccf91c37d2474e97a086f1d596b7fec5" class="general-layout-container">
...
<div id="iddf8bf9883c5a4b3fa8bfb1765a404574" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CONEXT" 
		data-property-name="CONDES" 
		 
		
		 
		id="pb-container-text-CONEXT-CONDES">

		
		<asp:Label ID="lblCONEXT_CONDES" runat="server" AssociatedControlID="CONEXT__CONDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CONEXT__CONDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCONEXT_CONDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CONEXT__CONDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CONEXT-CONLOI">
		<asp:Label ID="lblCONEXT_CONLOI" runat="server" AssociatedControlID="CONEXT__CONLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CONEXT__CONLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCONEXT_CONLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CONEXT__CONLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CONEXT-CONR">
		<asp:Label ID="lblCONEXT_CONR" runat="server" AssociatedControlID="CONEXT__CONR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CONEXT__CONR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCONEXT_CONR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_CONEXT__CONR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CONEXT-CONP">
		<asp:Label ID="lblCONEXT_CONP" runat="server" AssociatedControlID="CONEXT__CONP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CONEXT__CONP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCONEXT_CONP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CONEXT__CONP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddf8bf9883c5a4b3fa8bfb1765a404574 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddf8bf9883c5a4b3fa8bfb1765a404574 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddf8bf9883c5a4b3fa8bfb1765a404574 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddf8bf9883c5a4b3fa8bfb1765a404574 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddf8bf9883c5a4b3fa8bfb1765a404574 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddf8bf9883c5a4b3fa8bfb1765a404574 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddf8bf9883c5a4b3fa8bfb1765a404574 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddf8bf9883c5a4b3fa8bfb1765a404574 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddf8bf9883c5a4b3fa8bfb1765a404574 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddf8bf9883c5a4b3fa8bfb1765a404574 input{text-align:left;}"; break;
		}
	}
