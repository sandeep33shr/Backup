...
Namespace Nexus
    Partial Class PB2_MSPLSRNPN_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_SRSP_NNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If SRSP_NNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		SRSP_NNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		SRSP_NNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_SRSP_NNOTES_DETAILS__NOTE_DETAILS()
End Sub
