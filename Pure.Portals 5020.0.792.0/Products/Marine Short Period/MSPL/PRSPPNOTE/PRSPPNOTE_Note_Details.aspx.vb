...
Namespace Nexus
    Partial Class PB2_PRSPPNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_PRSP_PNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If PRSP_PNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		PRSP_PNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		PRSP_PNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_PRSP_PNOTES_DETAILS__NOTE_DETAILS()
End Sub
