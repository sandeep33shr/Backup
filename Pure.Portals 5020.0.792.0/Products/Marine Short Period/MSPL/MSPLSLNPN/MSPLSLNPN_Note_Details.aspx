<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPLSLNPN_Note_Details.aspx.vb" Inherits="Nexus.PB2_MSPLSLNPN_Note_Details" %>
...
function onValidate_SL_NNOTES_DETAILS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SL_NNOTES_DETAILS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SL_NNOTES_DETAILS", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SL_NNOTES_DETAILS.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "SL_NNOTES_DETAILS", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=SL_NNOTES_DETAILS&propertyName=DATE_CREATED&name={name}");
...
function onValidate_SL_NNOTES_DETAILS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SL_NNOTES_DETAILS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SL_NNOTES_DETAILS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SL_NNOTES_DETAILS.CREATED_BY");
        			window.setControlWidth(field, "0.5", "SL_NNOTES_DETAILS", "CREATED_BY");
        		})();
        	}
        })();
        /**
...
function onValidate_SL_NNOTES_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SL_NNOTES_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SL_NNOTES_DETAILS", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SL_NNOTES_DETAILS.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "SL_NNOTES_DETAILS", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=SL_NNOTES_DETAILS&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'Stevedores Liability'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_SL_NNOTES_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SL_NNOTES_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SL_NNOTES_DETAILS", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SL_NNOTES_DETAILS.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "SL_NNOTES_DETAILS", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
...
function onValidate_SL_NNOTES_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SL_NNOTES_DETAILS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SL_NNOTES_DETAILS", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SL_NNOTES_DETAILS.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "SL_NNOTES_DETAILS", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=SL_NNOTES_DETAILS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_SL_NNOTES_DETAILS__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_SL_NNOTES_DETAILS_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_SL_NNOTES_DETAILS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_SL_NNOTES_DETAILS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_SL_NNOTES_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_SL_NNOTES_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_SL_NNOTES_DETAILS__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="ida9bee7684add4525b9953f969c159a6d" class="general-layout-container">
...
<div id="id805661dd09ec45659acebc339f3cd3ca" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading130" runat="server" Text="Stevedore's Liability Notes (Not Printed On Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SL_NNOTES_DETAILS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-SL_NNOTES_DETAILS-DATE_CREATED">
		<asp:Label ID="lblSL_NNOTES_DETAILS_DATE_CREATED" runat="server" AssociatedControlID="SL_NNOTES_DETAILS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="SL_NNOTES_DETAILS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calSL_NNOTES_DETAILS__DATE_CREATED" runat="server" LinkedControl="SL_NNOTES_DETAILS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valSL_NNOTES_DETAILS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_SL_NNOTES_DETAILS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SL_NNOTES_DETAILS-CREATED_BY">

		
		<asp:Label ID="lblSL_NNOTES_DETAILS_CREATED_BY" runat="server" AssociatedControlID="SL_NNOTES_DETAILS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SL_NNOTES_DETAILS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSL_NNOTES_DETAILS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_SL_NNOTES_DETAILS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SL_NNOTES_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblSL_NNOTES_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="SL_NNOTES_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SL_NNOTES_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSL_NNOTES_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_SL_NNOTES_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SL_NNOTES_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblSL_NNOTES_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="SL_NNOTES_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SL_NNOTES_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSL_NNOTES_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_SL_NNOTES_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-SL_NNOTES_DETAILS-NOTE_DETAILS">
		<asp:Label ID="lblSL_NNOTES_DETAILS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="SL_NNOTES_DETAILS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="SL_NNOTES_DETAILS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valSL_NNOTES_DETAILS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_SL_NNOTES_DETAILS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id805661dd09ec45659acebc339f3cd3ca div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id805661dd09ec45659acebc339f3cd3ca div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id805661dd09ec45659acebc339f3cd3ca div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id805661dd09ec45659acebc339f3cd3ca label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id805661dd09ec45659acebc339f3cd3ca label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id805661dd09ec45659acebc339f3cd3ca label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id805661dd09ec45659acebc339f3cd3ca label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id805661dd09ec45659acebc339f3cd3ca input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id805661dd09ec45659acebc339f3cd3ca input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id805661dd09ec45659acebc339f3cd3ca input{text-align:left;}"; break;
		}
	}
