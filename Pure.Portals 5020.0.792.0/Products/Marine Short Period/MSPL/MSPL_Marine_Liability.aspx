<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPL_Marine_Liability.aspx.vb" Inherits="Nexus.PB2_MSPL_Marine_Liability" %>
...
function onValidate_GENERAL__ATTACHMENTDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.ATTACHMENTDATE");
        			window.setControlWidth(field, "0.7", "GENERAL", "ATTACHMENTDATE");
        		})();
        	}
        })();
        /**
...
function onValidate_GENERAL__EFFECTIVEDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.7", "GENERAL", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
...
function onValidate_ADDRESS__PRIM_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDRESS", "PRIM_IND", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDRESS", "PRIM_IND");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDRESS_PRIM_IND");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDRESS__PRIM_IND');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDRESS__PRIM_IND_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDRESS.PRIM_IND");
        			window.setControlWidth(field, "0.7", "ADDRESS", "PRIM_IND");
        		})();
        	}
        })();
}
function onValidate_ADDRESS__SEC_IND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ADDRESS", "SEC_IND", "RateList");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("ADDRESS", "SEC_IND");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblADDRESS_SEC_IND");
        			    var ele = document.getElementById('ctl00_cntMainBody_ADDRESS__SEC_IND');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_ADDRESS__SEC_IND_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ADDRESS.SEC_IND");
        			window.setControlWidth(field, "0.7", "ADDRESS", "SEC_IND");
        		})();
        	}
        })();
}
function onValidate_GENERAL__IS_CL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_CL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_CL");
        		}
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_CL");
        		var update = function(){
...
function onValidate_GENERAL__IS_CLL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_CLL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_CLL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_CLL");
        		var update = function(){
...
function onValidate_GENERAL__IS_CONL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_CONL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_CONL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_CONL");
        		var update = function(){
...
function onValidate_GENERAL__IS_MOL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_MOL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_MOL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_MOL");
        		var update = function(){
...
function onValidate_GENERAL__IS_SRL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_SRL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_SRL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_SRL");
        		var update = function(){
...
function onValidate_GENERAL__IS_SBL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_SBL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_SBL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_SBL");
        		var update = function(){
...
function onValidate_GENERAL__IS_SL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_SL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_SL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_SL");
        		var update = function(){
...
function onValidate_GENERAL__IS_PRL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_PRL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_PRL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_PRL");
        		var update = function(){
...
function onValidate_GENERAL__IS_FFL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_FFL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "IS_FFL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.IS_FFL");
        		var update = function(){
...
function DoLogic(isOnLoad) {
    ...
    onValidate_ADDRESS__PRIM_IND(null, null, null, isOnLoad);
    onValidate_ADDRESS__SEC_IND(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_CL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_CLL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_CONL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_MOL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_SRL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_SBL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_SL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_PRL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_FFL(null, null, null, isOnLoad);
}
</script>
...
<div id="id318f33c38a7d427883e870d6e4bded87" class="general-layout-container">
...
<div id="id83bffb187be8407eb4a23b85d5962e2c" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id83bffb187be8407eb4a23b85d5962e2c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id83bffb187be8407eb4a23b85d5962e2c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id83bffb187be8407eb4a23b85d5962e2c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id83bffb187be8407eb4a23b85d5962e2c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id83bffb187be8407eb4a23b85d5962e2c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id83bffb187be8407eb4a23b85d5962e2c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id83bffb187be8407eb4a23b85d5962e2c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id83bffb187be8407eb4a23b85d5962e2c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id83bffb187be8407eb4a23b85d5962e2c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id83bffb187be8407eb4a23b85d5962e2c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id86801dc59cca4c989af42ad50ee73e2e" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id86801dc59cca4c989af42ad50ee73e2e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id86801dc59cca4c989af42ad50ee73e2e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id86801dc59cca4c989af42ad50ee73e2e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id86801dc59cca4c989af42ad50ee73e2e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id86801dc59cca4c989af42ad50ee73e2e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id86801dc59cca4c989af42ad50ee73e2e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id86801dc59cca4c989af42ad50ee73e2e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id86801dc59cca4c989af42ad50ee73e2e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id86801dc59cca4c989af42ad50ee73e2e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id86801dc59cca4c989af42ad50ee73e2e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0d9da47937c143ab83c9790394f38be6" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="ADDRESS" 
		data-property-name="PRIM_IND" 
		id="pb-container-list-ADDRESS-PRIM_IND">
		<asp:Label ID="lblADDRESS_PRIM_IND" runat="server" AssociatedControlID="ADDRESS__PRIM_IND" 
			Text="Primary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="ADDRESS__PRIM_IND" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSONE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_ADDRESS__PRIM_IND(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valADDRESS_PRIM_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Primary Industry"
			ClientValidationFunction="onValidate_ADDRESS__PRIM_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="List" 
		data-object-name="ADDRESS" 
		data-property-name="SEC_IND" 
		id="pb-container-list-ADDRESS-SEC_IND">
		<asp:Label ID="lblADDRESS_SEC_IND" runat="server" AssociatedControlID="ADDRESS__SEC_IND" 
			Text="Secondary Industry" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="ADDRESS__SEC_IND" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="INDSTWO" ParentLookupListID="ADDRESS__PRIM_IND" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_ADDRESS__SEC_IND(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valADDRESS_SEC_IND" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Secondary Industry"
			ClientValidationFunction="onValidate_ADDRESS__SEC_IND" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0d9da47937c143ab83c9790394f38be6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0d9da47937c143ab83c9790394f38be6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0d9da47937c143ab83c9790394f38be6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0d9da47937c143ab83c9790394f38be6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0d9da47937c143ab83c9790394f38be6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d9da47937c143ab83c9790394f38be6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d9da47937c143ab83c9790394f38be6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0d9da47937c143ab83c9790394f38be6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d9da47937c143ab83c9790394f38be6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d9da47937c143ab83c9790394f38be6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id753d58ea008248a38e9bed548a05070d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading4" runat="server" Text="Cover Selection" /></legend>
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_CL" for="ctl00_cntMainBody_GENERAL__IS_CL" class="col-md-4 col-sm-3 control-label">
		Charterers Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_CL" 
		id="pb-container-checkbox-GENERAL-IS_CL">	
		
		<asp:TextBox ID="GENERAL__IS_CL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_CL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Charterers Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_CL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_CLL" for="ctl00_cntMainBody_GENERAL__IS_CLL" class="col-md-4 col-sm-3 control-label">
		Carriers Legal Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_CLL" 
		id="pb-container-checkbox-GENERAL-IS_CLL">	
		
		<asp:TextBox ID="GENERAL__IS_CLL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_CLL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Carriers Legal Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_CLL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_CONL" for="ctl00_cntMainBody_GENERAL__IS_CONL" class="col-md-4 col-sm-3 control-label">
		Containers Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_CONL" 
		id="pb-container-checkbox-GENERAL-IS_CONL">	
		
		<asp:TextBox ID="GENERAL__IS_CONL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_CONL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Containers Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_CONL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_MOL" for="ctl00_cntMainBody_GENERAL__IS_MOL" class="col-md-4 col-sm-3 control-label">
		Marine Operators Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_MOL" 
		id="pb-container-checkbox-GENERAL-IS_MOL">	
		
		<asp:TextBox ID="GENERAL__IS_MOL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_MOL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Marine Operators Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_MOL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_SRL" for="ctl00_cntMainBody_GENERAL__IS_SRL" class="col-md-4 col-sm-3 control-label">
		Ship Repairers Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_SRL" 
		id="pb-container-checkbox-GENERAL-IS_SRL">	
		
		<asp:TextBox ID="GENERAL__IS_SRL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_SRL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Ship Repairers Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_SRL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_SBL" for="ctl00_cntMainBody_GENERAL__IS_SBL" class="col-md-4 col-sm-3 control-label">
		Ship Builders Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_SBL" 
		id="pb-container-checkbox-GENERAL-IS_SBL">	
		
		<asp:TextBox ID="GENERAL__IS_SBL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_SBL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Ship Builders Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_SBL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_SL" for="ctl00_cntMainBody_GENERAL__IS_SL" class="col-md-4 col-sm-3 control-label">
		Stevedore's Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_SL" 
		id="pb-container-checkbox-GENERAL-IS_SL">	
		
		<asp:TextBox ID="GENERAL__IS_SL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_SL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Stevedore's Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_SL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_PRL" for="ctl00_cntMainBody_GENERAL__IS_PRL" class="col-md-4 col-sm-3 control-label">
		Port Risks Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_PRL" 
		id="pb-container-checkbox-GENERAL-IS_PRL">	
		
		<asp:TextBox ID="GENERAL__IS_PRL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_PRL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Port Risks Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_PRL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_FFL" for="ctl00_cntMainBody_GENERAL__IS_FFL" class="col-md-4 col-sm-3 control-label">
		Freight Forwarders Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_FFL" 
		id="pb-container-checkbox-GENERAL-IS_FFL">	
		
		<asp:TextBox ID="GENERAL__IS_FFL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_FFL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Freight Forwarders Liability"
			ClientValidationFunction="onValidate_GENERAL__IS_FFL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id753d58ea008248a38e9bed548a05070d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id753d58ea008248a38e9bed548a05070d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id753d58ea008248a38e9bed548a05070d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id753d58ea008248a38e9bed548a05070d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id753d58ea008248a38e9bed548a05070d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id753d58ea008248a38e9bed548a05070d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id753d58ea008248a38e9bed548a05070d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id753d58ea008248a38e9bed548a05070d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id753d58ea008248a38e9bed548a05070d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id753d58ea008248a38e9bed548a05070d input{text-align:left;}"; break;
		}
	}
