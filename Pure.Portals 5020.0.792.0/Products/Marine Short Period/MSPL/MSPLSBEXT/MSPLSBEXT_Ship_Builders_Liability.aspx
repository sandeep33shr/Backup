<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPLSBEXT_Ship_Builders_Liability.aspx.vb" Inherits="Nexus.PB2_MSPLSBEXT_Ship_Builders_Liability" %>
...
function onValidate_SBSPEXT__SBSPDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBSPEXT", "SBSPDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBSPEXT_SBSPDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBSPEXT__SBSPDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBSPEXT__SBSPDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBSPEXT", "SBSPDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SBSPEXT", "SBSPDES");
...
function onValidate_SBSPEXT__SBSPLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBSPEXT", "SBSPLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBSPEXT", "SBSPLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBSPEXT_SBSPLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBSPEXT__SBSPLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBSPEXT__SBSPLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SBSPEXT", "SBSPLOI");
...
function onValidate_SBSPEXT__SBSPR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBSPEXT", "SBSPR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBSPEXT_SBSPR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBSPEXT__SBSPR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBSPEXT__SBSPR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBSPEXT", "SBSPR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SBSPEXT", "SBSPR");
...
function onValidate_SBSPEXT__SBSPP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBSPEXT", "SBSPP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSBSPEXT_SBSPP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SBSPEXT__SBSPP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SBSPEXT__SBSPP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBSPEXT", "SBSPP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SBSPEXT", "SBSPP");
...
function DoLogic(isOnLoad) {
    onValidate_SBSPEXT__SBSPDES(null, null, null, isOnLoad);
    onValidate_SBSPEXT__SBSPLOI(null, null, null, isOnLoad);
    onValidate_SBSPEXT__SBSPR(null, null, null, isOnLoad);
    onValidate_SBSPEXT__SBSPP(null, null, null, isOnLoad);
}
</script>
...
<div id="id16c3c68f7f0f4b2d952762e424553e2e" class="general-layout-container">
...
<div id="id976d8fa79d20493fae895d80f0c823a7" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SBSPEXT" 
		data-property-name="SBSPDES" 
		 
		
		 
		id="pb-container-text-SBSPEXT-SBSPDES">

		
		<asp:Label ID="lblSBSPEXT_SBSPDES" runat="server" AssociatedControlID="SBSPEXT__SBSPDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SBSPEXT__SBSPDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSBSPEXT_SBSPDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SBSPEXT__SBSPDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SBSPEXT" 
		data-property-name="SBSPLOI" 
		id="pb-container-currency-SBSPEXT-SBSPLOI">
		<asp:Label ID="lblSBSPEXT_SBSPLOI" runat="server" AssociatedControlID="SBSPEXT__SBSPLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SBSPEXT__SBSPLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSBSPEXT_SBSPLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SBSPEXT__SBSPLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SBSPEXT" 
		data-property-name="SBSPR" 
		id="pb-container-percentage-SBSPEXT-SBSPR">
		<asp:Label ID="lblSBSPEXT_SBSPR" runat="server" AssociatedControlID="SBSPEXT__SBSPR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SBSPEXT__SBSPR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSBSPEXT_SBSPR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SBSPEXT__SBSPR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SBSPEXT-SBSPP">
		<asp:Label ID="lblSBSPEXT_SBSPP" runat="server" AssociatedControlID="SBSPEXT__SBSPP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SBSPEXT__SBSPP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSBSPEXT_SBSPP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SBSPEXT__SBSPP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id976d8fa79d20493fae895d80f0c823a7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id976d8fa79d20493fae895d80f0c823a7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id976d8fa79d20493fae895d80f0c823a7 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id976d8fa79d20493fae895d80f0c823a7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id976d8fa79d20493fae895d80f0c823a7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id976d8fa79d20493fae895d80f0c823a7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id976d8fa79d20493fae895d80f0c823a7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id976d8fa79d20493fae895d80f0c823a7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id976d8fa79d20493fae895d80f0c823a7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id976d8fa79d20493fae895d80f0c823a7 input{text-align:left;}"; break;
		}
	}
