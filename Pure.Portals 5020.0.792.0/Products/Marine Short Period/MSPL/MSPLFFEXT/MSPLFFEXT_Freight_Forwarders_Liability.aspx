<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPLFFEXT_Freight_Forwarders_Liability.aspx.vb" Inherits="Nexus.PB2_MSPLFFEXT_Freight_Forwarders_Liability" %>
...
function onValidate_FFSPEXT__FFSPDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFSPEXT", "FFSPDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFSPEXT_FFSPDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFSPEXT__FFSPDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFSPEXT__FFSPDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFSPEXT", "FFSPDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FFSPEXT", "FFSPDES");
...
function onValidate_FFSPEXT__FFSPLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFSPEXT", "FFSPLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFSPEXT", "FFSPLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFSPEXT_FFSPLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFSPEXT__FFSPLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFSPEXT__FFSPLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FFSPEXT", "FFSPLOI");
...
function onValidate_FFSPEXT__FFSPR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFSPEXT", "FFSPR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFSPEXT_FFSPR");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFSPEXT__FFSPR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFSPEXT__FFSPR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFSPEXT", "FFSPR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FFSPEXT", "FFSPR");
...
function onValidate_FFSPEXT__FFSPP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFSPEXT", "FFSPP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFSPEXT_FFSPP");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFSPEXT__FFSPP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFSPEXT__FFSPP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFSPEXT", "FFSPP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FFSPEXT", "FFSPP");
...
function DoLogic(isOnLoad) {
    onValidate_FFSPEXT__FFSPDES(null, null, null, isOnLoad);
    onValidate_FFSPEXT__FFSPLOI(null, null, null, isOnLoad);
    onValidate_FFSPEXT__FFSPR(null, null, null, isOnLoad);
    onValidate_FFSPEXT__FFSPP(null, null, null, isOnLoad);
}
</script>
...
<div id="ida8044d508add4885a23f3da6a33ad1f3" class="general-layout-container">
...
<div id="id361b403805244198a4e6465fbf64bb5d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading164" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="FFSPEXT" 
		data-property-name="FFSPDES" 
		 
		
		 
		id="pb-container-text-FFSPEXT-FFSPDES">

		
		<asp:Label ID="lblFFSPEXT_FFSPDES" runat="server" AssociatedControlID="FFSPEXT__FFSPDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FFSPEXT__FFSPDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFFSPEXT_FFSPDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_FFSPEXT__FFSPDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FFSPEXT" 
		data-property-name="FFSPLOI" 
		id="pb-container-currency-FFSPEXT-FFSPLOI">
		<asp:Label ID="lblFFSPEXT_FFSPLOI" runat="server" AssociatedControlID="FFSPEXT__FFSPLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FFSPEXT__FFSPLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFFSPEXT_FFSPLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_FFSPEXT__FFSPLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FFSPEXT" 
		data-property-name="FFSPR" 
		id="pb-container-percentage-FFSPEXT-FFSPR">
		<asp:Label ID="lblFFSPEXT_FFSPR" runat="server" AssociatedControlID="FFSPEXT__FFSPR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FFSPEXT__FFSPR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFFSPEXT_FFSPR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_FFSPEXT__FFSPR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FFSPEXT-FFSPP">
		<asp:Label ID="lblFFSPEXT_FFSPP" runat="server" AssociatedControlID="FFSPEXT__FFSPP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FFSPEXT__FFSPP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFFSPEXT_FFSPP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_FFSPEXT__FFSPP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id361b403805244198a4e6465fbf64bb5d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id361b403805244198a4e6465fbf64bb5d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id361b403805244198a4e6465fbf64bb5d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id361b403805244198a4e6465fbf64bb5d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id361b403805244198a4e6465fbf64bb5d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id361b403805244198a4e6465fbf64bb5d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id361b403805244198a4e6465fbf64bb5d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id361b403805244198a4e6465fbf64bb5d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id361b403805244198a4e6465fbf64bb5d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id361b403805244198a4e6465fbf64bb5d input{text-align:left;}"; break;
		}
	}
