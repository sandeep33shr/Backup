<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPLMOEXT_Marine_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_MSPLMOEXT_Marine_Operators_Liability" %>
...
function onValidate_SPMLEXT__SPMLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPMLEXT", "SPMLDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSPMLEXT_SPMLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SPMLEXT__SPMLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SPMLEXT__SPMLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SPMLEXT", "SPMLDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SPMLEXT", "SPMLDES");
...
function onValidate_SPMLEXT__SPMLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPMLEXT", "SPMLLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SPMLEXT", "SPMLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSPMLEXT_SPMLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SPMLEXT__SPMLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SPMLEXT__SPMLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SPMLEXT", "SPMLLOI");
...
function onValidate_SPMLEXT__SPMLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPMLEXT", "SPMLR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSPMLEXT_SPMLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SPMLEXT__SPMLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SPMLEXT__SPMLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SPMLEXT", "SPMLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SPMLEXT", "SPMLR");
...
function onValidate_SPMLEXT__SPMLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPMLEXT", "SPMLP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSPMLEXT_SPMLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SPMLEXT__SPMLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SPMLEXT__SPMLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SPMLEXT", "SPMLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SPMLEXT", "SPMLP");
...
function DoLogic(isOnLoad) {
    onValidate_SPMLEXT__SPMLDES(null, null, null, isOnLoad);
    onValidate_SPMLEXT__SPMLLOI(null, null, null, isOnLoad);
    onValidate_SPMLEXT__SPMLR(null, null, null, isOnLoad);
    onValidate_SPMLEXT__SPMLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id6eaa167b4267495fb78e20fe265edcd5" class="general-layout-container">
...
<div id="idfd4b5e8973e041fb9173d6827e95b814" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SPMLEXT" 
		data-property-name="SPMLDES" 
		 
		
		 
		id="pb-container-text-SPMLEXT-SPMLDES">

		
		<asp:Label ID="lblSPMLEXT_SPMLDES" runat="server" AssociatedControlID="SPMLEXT__SPMLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SPMLEXT__SPMLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSPMLEXT_SPMLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SPMLEXT__SPMLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SPMLEXT" 
		data-property-name="SPMLLOI" 
		id="pb-container-currency-SPMLEXT-SPMLLOI">
		<asp:Label ID="lblSPMLEXT_SPMLLOI" runat="server" AssociatedControlID="SPMLEXT__SPMLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SPMLEXT__SPMLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSPMLEXT_SPMLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SPMLEXT__SPMLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SPMLEXT" 
		data-property-name="SPMLR" 
		id="pb-container-percentage-SPMLEXT-SPMLR">
		<asp:Label ID="lblSPMLEXT_SPMLR" runat="server" AssociatedControlID="SPMLEXT__SPMLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SPMLEXT__SPMLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSPMLEXT_SPMLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SPMLEXT__SPMLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SPMLEXT-SPMLP">
		<asp:Label ID="lblSPMLEXT_SPMLP" runat="server" AssociatedControlID="SPMLEXT__SPMLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SPMLEXT__SPMLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSPMLEXT_SPMLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SPMLEXT__SPMLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfd4b5e8973e041fb9173d6827e95b814 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfd4b5e8973e041fb9173d6827e95b814 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfd4b5e8973e041fb9173d6827e95b814 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfd4b5e8973e041fb9173d6827e95b814 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfd4b5e8973e041fb9173d6827e95b814 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfd4b5e8973e041fb9173d6827e95b814 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfd4b5e8973e041fb9173d6827e95b814 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfd4b5e8973e041fb9173d6827e95b814 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfd4b5e8973e041fb9173d6827e95b814 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfd4b5e8973e041fb9173d6827e95b814 input{text-align:left;}"; break;
		}
	}
