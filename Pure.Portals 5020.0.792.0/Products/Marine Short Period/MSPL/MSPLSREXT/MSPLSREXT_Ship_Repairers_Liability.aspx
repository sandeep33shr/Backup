<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPLSREXT_Ship_Repairers_Liability.aspx.vb" Inherits="Nexus.PB2_MSPLSREXT_Ship_Repairers_Liability" %>
...
function onValidate_SRSPEXT__SRSPDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRSPEXT", "SRSPDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRSPEXT_SRSPDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRSPEXT__SRSPDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRSPEXT__SRSPDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRSPEXT", "SRSPDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRSPEXT", "SRSPDES");
...
function onValidate_SRSPEXT__SRSPLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRSPEXT", "SRSPLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRSPEXT", "SRSPLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRSPEXT_SRSPLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRSPEXT__SRSPLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRSPEXT__SRSPLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRSPEXT", "SRSPLOI");
...
function onValidate_SRSPEXT__SRSPR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRSPEXT", "SRSPR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRSPEXT_SRSPR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRSPEXT__SRSPR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRSPEXT__SRSPR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRSPEXT", "SRSPR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRSPEXT", "SRSPR");
...
function onValidate_SRSPEXT__SRSPP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRSPEXT", "SRSPP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRSPEXT_SRSPP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRSPEXT__SRSPP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRSPEXT__SRSPP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRSPEXT", "SRSPP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRSPEXT", "SRSPP");
...
function DoLogic(isOnLoad) {
    onValidate_SRSPEXT__SRSPDES(null, null, null, isOnLoad);
    onValidate_SRSPEXT__SRSPLOI(null, null, null, isOnLoad);
    onValidate_SRSPEXT__SRSPR(null, null, null, isOnLoad);
    onValidate_SRSPEXT__SRSPP(null, null, null, isOnLoad);
}
</script>
...
<div id="id24d8db9ea48f45468b3d1d3296ad25cc" class="general-layout-container">
...
<div id="id6934141d02e14f028feefeb929fc96ad" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SRSPEXT" 
		data-property-name="SRSPDES" 
		 
		
		 
		id="pb-container-text-SRSPEXT-SRSPDES">

		
		<asp:Label ID="lblSRSPEXT_SRSPDES" runat="server" AssociatedControlID="SRSPEXT__SRSPDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SRSPEXT__SRSPDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSRSPEXT_SRSPDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SRSPEXT__SRSPDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SRSPEXT" 
		data-property-name="SRSPLOI" 
		id="pb-container-currency-SRSPEXT-SRSPLOI">
		<asp:Label ID="lblSRSPEXT_SRSPLOI" runat="server" AssociatedControlID="SRSPEXT__SRSPLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRSPEXT__SRSPLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRSPEXT_SRSPLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SRSPEXT__SRSPLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SRSPEXT" 
		data-property-name="SRSPR" 
		id="pb-container-percentage-SRSPEXT-SRSPR">
		<asp:Label ID="lblSRSPEXT_SRSPR" runat="server" AssociatedControlID="SRSPEXT__SRSPR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SRSPEXT__SRSPR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSRSPEXT_SRSPR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SRSPEXT__SRSPR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SRSPEXT-SRSPP">
		<asp:Label ID="lblSRSPEXT_SRSPP" runat="server" AssociatedControlID="SRSPEXT__SRSPP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRSPEXT__SRSPP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRSPEXT_SRSPP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SRSPEXT__SRSPP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6934141d02e14f028feefeb929fc96ad div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6934141d02e14f028feefeb929fc96ad div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6934141d02e14f028feefeb929fc96ad div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6934141d02e14f028feefeb929fc96ad label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6934141d02e14f028feefeb929fc96ad label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6934141d02e14f028feefeb929fc96ad label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6934141d02e14f028feefeb929fc96ad label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6934141d02e14f028feefeb929fc96ad input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6934141d02e14f028feefeb929fc96ad input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6934141d02e14f028feefeb929fc96ad input{text-align:left;}"; break;
		}
	}
