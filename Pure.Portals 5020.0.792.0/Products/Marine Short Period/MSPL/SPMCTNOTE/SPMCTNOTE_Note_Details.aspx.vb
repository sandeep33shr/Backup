...
Namespace Nexus
    Partial Class PB2_SPMCTNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CL_NNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CL_NNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		CL_NNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CL_NNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_CL_NNOTES_DETAILS__NOTE_DETAILS()
End Sub
