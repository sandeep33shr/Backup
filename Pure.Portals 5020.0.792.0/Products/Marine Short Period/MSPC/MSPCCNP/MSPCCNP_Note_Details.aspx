<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCCNP_Note_Details.aspx.vb" Inherits="Nexus.PB2_MSPCCNP_Note_Details" %>
...
function onValidate_CPCNOTE_DETAILS__CPDATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPCNOTE_DETAILS", "CPDATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPCNOTE_DETAILS", "CPDATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("CPCNOTE_DETAILS", "CPDATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=CPCNOTE_DETAILS&propertyName=CPDATE_CREATED&name={name}");
...
function onValidate_CPCNOTE_DETAILS__CPCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPCNOTE_DETAILS", "CPCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPCNOTE_DETAILS", "CPCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("CPCNOTE_DETAILS", "CPCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_CPCNOTE_DETAILS__CPCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPCNOTE_DETAILS", "CPCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CPCNOTE_DETAILS", "CPCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("CPCNOTE_DETAILS", "CPCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CPCNOTE_DETAILS&propertyName=CPCOVER_TYPE&name={name}");
        		
        		var value = new Expression("'Sub Section C:Inland Transit'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_CPCNOTE_DETAILS__CPNOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPCNOTE_DETAILS", "CPNOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CPCNOTE_DETAILS", "CPNOTE_DESCRIPTION");
...
function onValidate_CPCNOTE_DETAILS__CPNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPCNOTE_DETAILS", "CPNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CPCNOTE_DETAILS", "CPNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=CPCNOTE_DETAILS&propertyName=CPNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_CPCNOTE_DETAILS__CPNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_CPCNOTE_DETAILS_CPNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_CPCNOTE_DETAILS__CPNOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPCNOTE_DETAILS", "CPNOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CPCNOTE_DETAILS", "CPNOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_CPCNOTE_DETAILS__CPDATE_CREATED(null, null, null, isOnLoad);
    onValidate_CPCNOTE_DETAILS__CPCREATED_BY(null, null, null, isOnLoad);
    onValidate_CPCNOTE_DETAILS__CPCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_CPCNOTE_DETAILS__CPNOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_CPCNOTE_DETAILS__CPNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_CPCNOTE_DETAILS__CPNOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="idc8f020e7cfd84854972f71cc32268cbf" class="general-layout-container">
...
<div id="id70875250da5e4c2899bbbed27e027488" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading61" runat="server" Text="Sub Section C:Inland Transit Note Detail (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CPCNOTE_DETAILS" 
		data-property-name="CPDATE_CREATED" 
		id="pb-container-datejquerycompatible-CPCNOTE_DETAILS-CPDATE_CREATED">
		<asp:Label ID="lblCPCNOTE_DETAILS_CPDATE_CREATED" runat="server" AssociatedControlID="CPCNOTE_DETAILS__CPDATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="CPCNOTE_DETAILS__CPDATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calCPCNOTE_DETAILS__CPDATE_CREATED" runat="server" LinkedControl="CPCNOTE_DETAILS__CPDATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valCPCNOTE_DETAILS_CPDATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_CPCNOTE_DETAILS__CPDATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CPCNOTE_DETAILS" 
		data-property-name="CPCREATED_BY" 
		 
		
		 
		id="pb-container-text-CPCNOTE_DETAILS-CPCREATED_BY">

		
		<asp:Label ID="lblCPCNOTE_DETAILS_CPCREATED_BY" runat="server" AssociatedControlID="CPCNOTE_DETAILS__CPCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CPCNOTE_DETAILS__CPCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCPCNOTE_DETAILS_CPCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_CPCNOTE_DETAILS__CPCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CPCNOTE_DETAILS" 
		data-property-name="CPCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-CPCNOTE_DETAILS-CPCOVER_TYPE">

		
		<asp:Label ID="lblCPCNOTE_DETAILS_CPCOVER_TYPE" runat="server" AssociatedControlID="CPCNOTE_DETAILS__CPCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CPCNOTE_DETAILS__CPCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCPCNOTE_DETAILS_CPCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_CPCNOTE_DETAILS__CPCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CPCNOTE_DETAILS" 
		data-property-name="CPNOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-CPCNOTE_DETAILS-CPNOTE_DESCRIPTION">

		
		<asp:Label ID="lblCPCNOTE_DETAILS_CPNOTE_DESCRIPTION" runat="server" AssociatedControlID="CPCNOTE_DETAILS__CPNOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CPCNOTE_DETAILS__CPNOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCPCNOTE_DETAILS_CPNOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_CPCNOTE_DETAILS__CPNOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CPCNOTE_DETAILS" 
		data-property-name="CPNOTE_DETAILS" 
		id="pb-container-comment-CPCNOTE_DETAILS-CPNOTE_DETAILS">
		<asp:Label ID="lblCPCNOTE_DETAILS_CPNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="CPCNOTE_DETAILS__CPNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="CPCNOTE_DETAILS__CPNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valCPCNOTE_DETAILS_CPNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_CPCNOTE_DETAILS__CPNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCPCNOTE_DETAILS_CPNOTECHECK" for="ctl00_cntMainBody_CPCNOTE_DETAILS__CPNOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CPCNOTE_DETAILS" 
		data-property-name="CPNOTECHECK" 
		id="pb-container-checkbox-CPCNOTE_DETAILS-CPNOTECHECK">	
		
		<asp:TextBox ID="CPCNOTE_DETAILS__CPNOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCPCNOTE_DETAILS_CPNOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_CPCNOTE_DETAILS__CPNOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id70875250da5e4c2899bbbed27e027488 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id70875250da5e4c2899bbbed27e027488 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id70875250da5e4c2899bbbed27e027488 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id70875250da5e4c2899bbbed27e027488 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id70875250da5e4c2899bbbed27e027488 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id70875250da5e4c2899bbbed27e027488 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id70875250da5e4c2899bbbed27e027488 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id70875250da5e4c2899bbbed27e027488 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id70875250da5e4c2899bbbed27e027488 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id70875250da5e4c2899bbbed27e027488 input{text-align:left;}"; break;
		}
	}
