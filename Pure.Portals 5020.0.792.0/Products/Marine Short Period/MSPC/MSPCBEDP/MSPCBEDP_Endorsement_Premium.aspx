<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCBEDP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_MSPCBEDP_Endorsement_Premium" %>
...
function onValidate_B_CLAUSEPREM__BENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "B_CLAUSEPREM", "BENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("B_CLAUSEPREM", "BENDORSE_ID");
        		}
...
function onValidate_B_CLAUSEPREM__BENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "B_CLAUSEPREM", "BENDORSE_DESC", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("B_CLAUSEPREM", "BENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("B_CLAUSEPREM.BENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "B_CLAUSEPREM", "BENDORSE_DESC");
        		})();
        	}
        })();
...
function onValidate_B_CLAUSEPREM__BENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "B_CLAUSEPREM", "BENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("B_CLAUSEPREM", "BENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_B_CLAUSEPREM__BPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "B_CLAUSEPREM", "BPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("B_CLAUSEPREM", "BPREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("B_CLAUSEPREM.BPREMIUM");
        			window.setControlWidth(field, "0.5", "B_CLAUSEPREM", "BPREMIUM");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    onValidate_B_CLAUSEPREM__BENDORSE_ID(null, null, null, isOnLoad);
    onValidate_B_CLAUSEPREM__BENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_B_CLAUSEPREM__BENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_B_CLAUSEPREM__BPREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id6f46290beeef4a2eb2925924aefe33e7" class="general-layout-container">
...
<div id="id95469d3fee634227a8860b05635bec8d" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="B_CLAUSEPREM" 
		data-property-name="BENDORSE_ID" 
		id="pb-container-integer-B_CLAUSEPREM-BENDORSE_ID">
		<asp:Label ID="lblB_CLAUSEPREM_BENDORSE_ID" runat="server" AssociatedControlID="B_CLAUSEPREM__BENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="B_CLAUSEPREM__BENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valB_CLAUSEPREM_BENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_B_CLAUSEPREM__BENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="B_CLAUSEPREM" 
		data-property-name="BENDORSE_DESC" 
		 
		
		 
		id="pb-container-text-B_CLAUSEPREM-BENDORSE_DESC">

		
		<asp:Label ID="lblB_CLAUSEPREM_BENDORSE_DESC" runat="server" AssociatedControlID="B_CLAUSEPREM__BENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="B_CLAUSEPREM__BENDORSE_DESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valB_CLAUSEPREM_BENDORSE_DESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_B_CLAUSEPREM__BENDORSE_DESC"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="B_CLAUSEPREM" 
		data-property-name="BENDORSE_CAP" 
		 
		
		 
		id="pb-container-text-B_CLAUSEPREM-BENDORSE_CAP">

		
		<asp:Label ID="lblB_CLAUSEPREM_BENDORSE_CAP" runat="server" AssociatedControlID="B_CLAUSEPREM__BENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="B_CLAUSEPREM__BENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valB_CLAUSEPREM_BENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_B_CLAUSEPREM__BENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="B_CLAUSEPREM" 
		data-property-name="BPREMIUM" 
		id="pb-container-currency-B_CLAUSEPREM-BPREMIUM">
		<asp:Label ID="lblB_CLAUSEPREM_BPREMIUM" runat="server" AssociatedControlID="B_CLAUSEPREM__BPREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="B_CLAUSEPREM__BPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valB_CLAUSEPREM_BPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_B_CLAUSEPREM__BPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id95469d3fee634227a8860b05635bec8d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id95469d3fee634227a8860b05635bec8d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id95469d3fee634227a8860b05635bec8d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id95469d3fee634227a8860b05635bec8d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id95469d3fee634227a8860b05635bec8d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id95469d3fee634227a8860b05635bec8d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id95469d3fee634227a8860b05635bec8d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id95469d3fee634227a8860b05635bec8d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id95469d3fee634227a8860b05635bec8d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id95469d3fee634227a8860b05635bec8d input{text-align:left;}"; break;
		}
	}
