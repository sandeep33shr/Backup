<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPC_Sub_Section_BExports.aspx.vb" Inherits="Nexus.PB2_MSPC_Sub_Section_BExports" %>
...
function onValidate_EXPORTS__MSPCBSMI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXPORTS", "MSPCBSMI", "ChildScreen");
        })();
}
function onValidate_EXPORTS__MSPCBBV(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXPORTS", "MSPCBBV", "ChildScreen");
        })();
}
...
function onValidate_EXPORTS__MSPCBEDP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXPORTS", "MSPCBEDP", "ChildScreen");
        })();
}
function onValidate_EXPORTS__MSPCBNNP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXPORTS", "MSPCBNNP", "ChildScreen");
        })();
}
function onValidate_EXPORTS__MSPCBNP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXPORTS", "MSPCBNP", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_EXPORTS__MSPCBSMI(null, null, null, isOnLoad);
    onValidate_EXPORTS__MSPCBBV(null, null, null, isOnLoad);
    ...
    onValidate_EXPORTS__MSPCBEDP(null, null, null, isOnLoad);
    onValidate_EXPORTS__MSPCBNNP(null, null, null, isOnLoad);
    onValidate_EXPORTS__MSPCBNP(null, null, null, isOnLoad);
}
</script>
...
<div id="iddc0ccae0742145a09e4e2ebca6307c55" class="general-layout-container">
...
<div id="id6efc1ac34e6f4518a72bac36c73fb556" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6efc1ac34e6f4518a72bac36c73fb556 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6efc1ac34e6f4518a72bac36c73fb556 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6efc1ac34e6f4518a72bac36c73fb556 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6efc1ac34e6f4518a72bac36c73fb556 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6efc1ac34e6f4518a72bac36c73fb556 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6efc1ac34e6f4518a72bac36c73fb556 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6efc1ac34e6f4518a72bac36c73fb556 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6efc1ac34e6f4518a72bac36c73fb556 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6efc1ac34e6f4518a72bac36c73fb556 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6efc1ac34e6f4518a72bac36c73fb556 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0b78e25735224682b4e0bbb9ee2c5cd2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading41" runat="server" Text="Limits" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label28">
		<span class="label" id="label28">LOI/RI Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label29">
		<span class="label" id="label29">Sum Insured/Turnover</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0b78e25735224682b4e0bbb9ee2c5cd2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0b78e25735224682b4e0bbb9ee2c5cd2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0b78e25735224682b4e0bbb9ee2c5cd2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0b78e25735224682b4e0bbb9ee2c5cd2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0b78e25735224682b4e0bbb9ee2c5cd2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b78e25735224682b4e0bbb9ee2c5cd2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b78e25735224682b4e0bbb9ee2c5cd2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0b78e25735224682b4e0bbb9ee2c5cd2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b78e25735224682b4e0bbb9ee2c5cd2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b78e25735224682b4e0bbb9ee2c5cd2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd5d0697ac2934733af52a7831496913e" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EXPORTS__MSPCBSMI"
		data-field-type="Child" 
		data-object-name="EXPORTS" 
		data-property-name="MSPCBSMI" 
		id="pb-container-childscreen-EXPORTS-MSPCBSMI">
		
		    <legend>Subject Matter Inclusions</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EXPORTS__BSBMATINC" runat="server" ScreenCode="MSPCBSMI" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPCBSMI/MSPCBSMI_Subject_Matter_Inclusion.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Description" DataField="DESCRPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEXPORTS_MSPCBSMI" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Subject Matter Inclusions"
						ClientValidationFunction="onValidate_EXPORTS__MSPCBSMI" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd5d0697ac2934733af52a7831496913e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd5d0697ac2934733af52a7831496913e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd5d0697ac2934733af52a7831496913e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd5d0697ac2934733af52a7831496913e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd5d0697ac2934733af52a7831496913e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd5d0697ac2934733af52a7831496913e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd5d0697ac2934733af52a7831496913e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd5d0697ac2934733af52a7831496913e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd5d0697ac2934733af52a7831496913e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd5d0697ac2934733af52a7831496913e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide73309429b314d3980ceb69bfabbbfa2" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EXPORTS__MSPCBBV"
		data-field-type="Child" 
		data-object-name="EXPORTS" 
		data-property-name="MSPCBBV" 
		id="pb-container-childscreen-EXPORTS-MSPCBBV">
		
		    <legend>Basis of Valuations</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EXPORTS__SUBBBOV" runat="server" ScreenCode="MSPCBBV" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPCBBV/MSPCBBV_Basis_of_Valuations.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Selected Item Description" DataField="BSIDNAME" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEXPORTS_MSPCBBV" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Basis of Valuations"
						ClientValidationFunction="onValidate_EXPORTS__MSPCBBV" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide73309429b314d3980ceb69bfabbbfa2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide73309429b314d3980ceb69bfabbbfa2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide73309429b314d3980ceb69bfabbbfa2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide73309429b314d3980ceb69bfabbbfa2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide73309429b314d3980ceb69bfabbbfa2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide73309429b314d3980ceb69bfabbbfa2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide73309429b314d3980ceb69bfabbbfa2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide73309429b314d3980ceb69bfabbbfa2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide73309429b314d3980ceb69bfabbbfa2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide73309429b314d3980ceb69bfabbbfa2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf6faca15c6ce402e8be8925ec0b263a4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading44" runat="server" Text="Excesses" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label34">
		<span class="label" id="label34">Excess %</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label37">
		<span class="label" id="label37">Basis of Excess</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label38">
		<span class="label" id="label38">Description</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label39">
		<span class="label" id="label39">General Excess</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label41">
		<span class="label" id="label41">Theft Excess</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label43">
		<span class="label" id="label43">Hijack Excess</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label45">
		<span class="label" id="label45">Other</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf6faca15c6ce402e8be8925ec0b263a4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf6faca15c6ce402e8be8925ec0b263a4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf6faca15c6ce402e8be8925ec0b263a4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf6faca15c6ce402e8be8925ec0b263a4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf6faca15c6ce402e8be8925ec0b263a4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf6faca15c6ce402e8be8925ec0b263a4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf6faca15c6ce402e8be8925ec0b263a4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf6faca15c6ce402e8be8925ec0b263a4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf6faca15c6ce402e8be8925ec0b263a4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf6faca15c6ce402e8be8925ec0b263a4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id751a4680c444477c8ab9c4e3d452809b" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id751a4680c444477c8ab9c4e3d452809b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id751a4680c444477c8ab9c4e3d452809b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id751a4680c444477c8ab9c4e3d452809b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id751a4680c444477c8ab9c4e3d452809b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id751a4680c444477c8ab9c4e3d452809b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id751a4680c444477c8ab9c4e3d452809b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id751a4680c444477c8ab9c4e3d452809b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id751a4680c444477c8ab9c4e3d452809b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id751a4680c444477c8ab9c4e3d452809b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id751a4680c444477c8ab9c4e3d452809b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idab5a3c8b667042b4a78c45f12dfd57ad" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EXPORTS__MSPCBEDP"
		data-field-type="Child" 
		data-object-name="EXPORTS" 
		data-property-name="MSPCBEDP" 
		id="pb-container-childscreen-EXPORTS-MSPCBEDP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EXPORTS__B_CLAUSEPREM" runat="server" ScreenCode="MSPCBEDP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPCBEDP/MSPCBEDP_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="BPREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valEXPORTS_MSPCBEDP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for EXPORTS.MSPCBEDP"
						ClientValidationFunction="onValidate_EXPORTS__MSPCBEDP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idab5a3c8b667042b4a78c45f12dfd57ad div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idab5a3c8b667042b4a78c45f12dfd57ad div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idab5a3c8b667042b4a78c45f12dfd57ad div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idab5a3c8b667042b4a78c45f12dfd57ad label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idab5a3c8b667042b4a78c45f12dfd57ad label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idab5a3c8b667042b4a78c45f12dfd57ad label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idab5a3c8b667042b4a78c45f12dfd57ad label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idab5a3c8b667042b4a78c45f12dfd57ad input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idab5a3c8b667042b4a78c45f12dfd57ad input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idab5a3c8b667042b4a78c45f12dfd57ad input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id90a9c41c50d54e1cbdb30a87aab6dc02" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading48" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EXPORTS__MSPCBNNP"
		data-field-type="Child" 
		data-object-name="EXPORTS" 
		data-property-name="MSPCBNNP" 
		id="pb-container-childscreen-EXPORTS-MSPCBNNP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EXPORTS__BACNOTE_DETAILS" runat="server" ScreenCode="MSPCBNNP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPCBNNP/MSPCBNNP_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="BANOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEXPORTS_MSPCBNNP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for EXPORTS.MSPCBNNP"
						ClientValidationFunction="onValidate_EXPORTS__MSPCBNNP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id90a9c41c50d54e1cbdb30a87aab6dc02 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id90a9c41c50d54e1cbdb30a87aab6dc02 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id90a9c41c50d54e1cbdb30a87aab6dc02 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id90a9c41c50d54e1cbdb30a87aab6dc02 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id90a9c41c50d54e1cbdb30a87aab6dc02 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id90a9c41c50d54e1cbdb30a87aab6dc02 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id90a9c41c50d54e1cbdb30a87aab6dc02 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id90a9c41c50d54e1cbdb30a87aab6dc02 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id90a9c41c50d54e1cbdb30a87aab6dc02 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id90a9c41c50d54e1cbdb30a87aab6dc02 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id13be8f14e6ad472d904aee587f5ab27c" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading49" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EXPORTS__MSPCBNP"
		data-field-type="Child" 
		data-object-name="EXPORTS" 
		data-property-name="MSPCBNP" 
		id="pb-container-childscreen-EXPORTS-MSPCBNP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EXPORTS__BPCNOTE_DETAILS" runat="server" ScreenCode="MSPCBNP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPCBNP/MSPCBNP_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="BPNOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEXPORTS_MSPCBNP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for EXPORTS.MSPCBNP"
						ClientValidationFunction="onValidate_EXPORTS__MSPCBNP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id13be8f14e6ad472d904aee587f5ab27c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id13be8f14e6ad472d904aee587f5ab27c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id13be8f14e6ad472d904aee587f5ab27c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id13be8f14e6ad472d904aee587f5ab27c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id13be8f14e6ad472d904aee587f5ab27c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id13be8f14e6ad472d904aee587f5ab27c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id13be8f14e6ad472d904aee587f5ab27c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id13be8f14e6ad472d904aee587f5ab27c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id13be8f14e6ad472d904aee587f5ab27c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id13be8f14e6ad472d904aee587f5ab27c input{text-align:left;}"; break;
		}
	}
