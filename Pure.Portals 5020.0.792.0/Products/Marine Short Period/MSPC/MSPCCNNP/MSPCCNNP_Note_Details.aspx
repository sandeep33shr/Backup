<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCCNNP_Note_Details.aspx.vb" Inherits="Nexus.PB2_MSPCCNNP_Note_Details" %>
...
function onValidate_CACNOTE_DETAILS__CADATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CACNOTE_DETAILS", "CADATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CACNOTE_DETAILS", "CADATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("CACNOTE_DETAILS", "CADATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=CACNOTE_DETAILS&propertyName=CADATE_CREATED&name={name}");
...
function onValidate_CACNOTE_DETAILS__CCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CACNOTE_DETAILS", "CCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CACNOTE_DETAILS", "CCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("CACNOTE_DETAILS", "CCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_CACNOTE_DETAILS__CCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CACNOTE_DETAILS", "CCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CACNOTE_DETAILS", "CCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("CACNOTE_DETAILS", "CCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CACNOTE_DETAILS&propertyName=CCOVER_TYPE&name={name}");
...
function onValidate_CACNOTE_DETAILS__CANOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CACNOTE_DETAILS", "CANOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CACNOTE_DETAILS", "CANOTE_DESCRIPTION");
...
function onValidate_CACNOTE_DETAILS__CNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CACNOTE_DETAILS", "CNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CACNOTE_DETAILS", "CNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=CACNOTE_DETAILS&propertyName=CNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_CACNOTE_DETAILS__CNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_CACNOTE_DETAILS_CNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_CACNOTE_DETAILS__CANOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CACNOTE_DETAILS", "CANOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CACNOTE_DETAILS", "CANOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_CACNOTE_DETAILS__CADATE_CREATED(null, null, null, isOnLoad);
    onValidate_CACNOTE_DETAILS__CCREATED_BY(null, null, null, isOnLoad);
    onValidate_CACNOTE_DETAILS__CCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_CACNOTE_DETAILS__CANOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_CACNOTE_DETAILS__CNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_CACNOTE_DETAILS__CANOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="id3e56276862794339ac5c26fe74777910" class="general-layout-container">
...
<div id="id573831267b85425c831dd14c0296c898" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading59" runat="server" Text="Sub Section C:Inland Transit Note Detail  (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CACNOTE_DETAILS" 
		data-property-name="CADATE_CREATED" 
		id="pb-container-datejquerycompatible-CACNOTE_DETAILS-CADATE_CREATED">
		<asp:Label ID="lblCACNOTE_DETAILS_CADATE_CREATED" runat="server" AssociatedControlID="CACNOTE_DETAILS__CADATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="CACNOTE_DETAILS__CADATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calCACNOTE_DETAILS__CADATE_CREATED" runat="server" LinkedControl="CACNOTE_DETAILS__CADATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valCACNOTE_DETAILS_CADATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_CACNOTE_DETAILS__CADATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CACNOTE_DETAILS" 
		data-property-name="CCREATED_BY" 
		 
		
		 
		id="pb-container-text-CACNOTE_DETAILS-CCREATED_BY">

		
		<asp:Label ID="lblCACNOTE_DETAILS_CCREATED_BY" runat="server" AssociatedControlID="CACNOTE_DETAILS__CCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CACNOTE_DETAILS__CCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCACNOTE_DETAILS_CCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_CACNOTE_DETAILS__CCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CACNOTE_DETAILS" 
		data-property-name="CCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-CACNOTE_DETAILS-CCOVER_TYPE">

		
		<asp:Label ID="lblCACNOTE_DETAILS_CCOVER_TYPE" runat="server" AssociatedControlID="CACNOTE_DETAILS__CCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CACNOTE_DETAILS__CCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCACNOTE_DETAILS_CCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_CACNOTE_DETAILS__CCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CACNOTE_DETAILS" 
		data-property-name="CANOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-CACNOTE_DETAILS-CANOTE_DESCRIPTION">

		
		<asp:Label ID="lblCACNOTE_DETAILS_CANOTE_DESCRIPTION" runat="server" AssociatedControlID="CACNOTE_DETAILS__CANOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CACNOTE_DETAILS__CANOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCACNOTE_DETAILS_CANOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_CACNOTE_DETAILS__CANOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CACNOTE_DETAILS" 
		data-property-name="CNOTE_DETAILS" 
		id="pb-container-comment-CACNOTE_DETAILS-CNOTE_DETAILS">
		<asp:Label ID="lblCACNOTE_DETAILS_CNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="CACNOTE_DETAILS__CNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="CACNOTE_DETAILS__CNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valCACNOTE_DETAILS_CNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_CACNOTE_DETAILS__CNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCACNOTE_DETAILS_CANOTECHECK" for="ctl00_cntMainBody_CACNOTE_DETAILS__CANOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CACNOTE_DETAILS" 
		data-property-name="CANOTECHECK" 
		id="pb-container-checkbox-CACNOTE_DETAILS-CANOTECHECK">	
		
		<asp:TextBox ID="CACNOTE_DETAILS__CANOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCACNOTE_DETAILS_CANOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_CACNOTE_DETAILS__CANOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id573831267b85425c831dd14c0296c898 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id573831267b85425c831dd14c0296c898 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id573831267b85425c831dd14c0296c898 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id573831267b85425c831dd14c0296c898 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id573831267b85425c831dd14c0296c898 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id573831267b85425c831dd14c0296c898 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id573831267b85425c831dd14c0296c898 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id573831267b85425c831dd14c0296c898 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id573831267b85425c831dd14c0296c898 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id573831267b85425c831dd14c0296c898 input{text-align:left;}"; break;
		}
	}
