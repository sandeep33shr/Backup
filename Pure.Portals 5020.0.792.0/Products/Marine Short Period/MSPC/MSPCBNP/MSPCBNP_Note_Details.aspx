<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCBNP_Note_Details.aspx.vb" Inherits="Nexus.PB2_MSPCBNP_Note_Details" %>
...
function onValidate_BPCNOTE_DETAILS__BPDATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BPCNOTE_DETAILS", "BPDATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BPCNOTE_DETAILS", "BPDATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("BPCNOTE_DETAILS", "BPDATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=BPCNOTE_DETAILS&propertyName=BPDATE_CREATED&name={name}");
...
function onValidate_BPCNOTE_DETAILS__BPCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BPCNOTE_DETAILS", "BPCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BPCNOTE_DETAILS", "BPCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("BPCNOTE_DETAILS", "BPCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_BPCNOTE_DETAILS__BPCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BPCNOTE_DETAILS", "BPCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BPCNOTE_DETAILS", "BPCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("BPCNOTE_DETAILS", "BPCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=BPCNOTE_DETAILS&propertyName=BPCOVER_TYPE&name={name}");
        		
        		var value = new Expression("'Sub Section B:Exports'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_BPCNOTE_DETAILS__BPNOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BPCNOTE_DETAILS", "BPNOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BPCNOTE_DETAILS", "BPNOTE_DESCRIPTION");
...
function onValidate_BPCNOTE_DETAILS__BPNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BPCNOTE_DETAILS", "BPNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BPCNOTE_DETAILS", "BPNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=BPCNOTE_DETAILS&propertyName=BPNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_BPCNOTE_DETAILS__BPNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_BPCNOTE_DETAILS_BPNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_BPCNOTE_DETAILS__BPNOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BPCNOTE_DETAILS", "BPNOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BPCNOTE_DETAILS", "BPNOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_BPCNOTE_DETAILS__BPDATE_CREATED(null, null, null, isOnLoad);
    onValidate_BPCNOTE_DETAILS__BPCREATED_BY(null, null, null, isOnLoad);
    onValidate_BPCNOTE_DETAILS__BPCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_BPCNOTE_DETAILS__BPNOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_BPCNOTE_DETAILS__BPNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_BPCNOTE_DETAILS__BPNOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="idee24c40a85d74b8e94b697359fd20dd3" class="general-layout-container">
...
<div id="id9d26db411238479ea9f6a2631cda3aca" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading38" runat="server" Text="Sub Section B:Exports Note Detail (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="BPCNOTE_DETAILS" 
		data-property-name="BPDATE_CREATED" 
		id="pb-container-datejquerycompatible-BPCNOTE_DETAILS-BPDATE_CREATED">
		<asp:Label ID="lblBPCNOTE_DETAILS_BPDATE_CREATED" runat="server" AssociatedControlID="BPCNOTE_DETAILS__BPDATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="BPCNOTE_DETAILS__BPDATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calBPCNOTE_DETAILS__BPDATE_CREATED" runat="server" LinkedControl="BPCNOTE_DETAILS__BPDATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valBPCNOTE_DETAILS_BPDATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_BPCNOTE_DETAILS__BPDATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BPCNOTE_DETAILS" 
		data-property-name="BPCREATED_BY" 
		 
		
		 
		id="pb-container-text-BPCNOTE_DETAILS-BPCREATED_BY">

		
		<asp:Label ID="lblBPCNOTE_DETAILS_BPCREATED_BY" runat="server" AssociatedControlID="BPCNOTE_DETAILS__BPCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BPCNOTE_DETAILS__BPCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBPCNOTE_DETAILS_BPCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_BPCNOTE_DETAILS__BPCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BPCNOTE_DETAILS" 
		data-property-name="BPCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-BPCNOTE_DETAILS-BPCOVER_TYPE">

		
		<asp:Label ID="lblBPCNOTE_DETAILS_BPCOVER_TYPE" runat="server" AssociatedControlID="BPCNOTE_DETAILS__BPCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BPCNOTE_DETAILS__BPCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBPCNOTE_DETAILS_BPCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_BPCNOTE_DETAILS__BPCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BPCNOTE_DETAILS" 
		data-property-name="BPNOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-BPCNOTE_DETAILS-BPNOTE_DESCRIPTION">

		
		<asp:Label ID="lblBPCNOTE_DETAILS_BPNOTE_DESCRIPTION" runat="server" AssociatedControlID="BPCNOTE_DETAILS__BPNOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BPCNOTE_DETAILS__BPNOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBPCNOTE_DETAILS_BPNOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_BPCNOTE_DETAILS__BPNOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="BPCNOTE_DETAILS" 
		data-property-name="BPNOTE_DETAILS" 
		id="pb-container-comment-BPCNOTE_DETAILS-BPNOTE_DETAILS">
		<asp:Label ID="lblBPCNOTE_DETAILS_BPNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="BPCNOTE_DETAILS__BPNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="BPCNOTE_DETAILS__BPNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valBPCNOTE_DETAILS_BPNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_BPCNOTE_DETAILS__BPNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblBPCNOTE_DETAILS_BPNOTECHECK" for="ctl00_cntMainBody_BPCNOTE_DETAILS__BPNOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="BPCNOTE_DETAILS" 
		data-property-name="BPNOTECHECK" 
		id="pb-container-checkbox-BPCNOTE_DETAILS-BPNOTECHECK">	
		
		<asp:TextBox ID="BPCNOTE_DETAILS__BPNOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valBPCNOTE_DETAILS_BPNOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_BPCNOTE_DETAILS__BPNOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9d26db411238479ea9f6a2631cda3aca div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9d26db411238479ea9f6a2631cda3aca div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9d26db411238479ea9f6a2631cda3aca div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9d26db411238479ea9f6a2631cda3aca label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9d26db411238479ea9f6a2631cda3aca label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9d26db411238479ea9f6a2631cda3aca label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9d26db411238479ea9f6a2631cda3aca label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9d26db411238479ea9f6a2631cda3aca input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9d26db411238479ea9f6a2631cda3aca input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9d26db411238479ea9f6a2631cda3aca input{text-align:left;}"; break;
		}
	}
