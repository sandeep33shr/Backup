<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCBNNP_Note_Details.aspx.vb" Inherits="Nexus.PB2_MSPCBNNP_Note_Details" %>
...
function onValidate_BACNOTE_DETAILS__BADATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BACNOTE_DETAILS", "BADATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BACNOTE_DETAILS", "BADATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("BACNOTE_DETAILS", "BADATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=BACNOTE_DETAILS&propertyName=BADATE_CREATED&name={name}");
...
function onValidate_BACNOTE_DETAILS__BCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BACNOTE_DETAILS", "BCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BACNOTE_DETAILS", "BCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("BACNOTE_DETAILS", "BCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_BACNOTE_DETAILS__BCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BACNOTE_DETAILS", "BCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BACNOTE_DETAILS", "BCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("BACNOTE_DETAILS", "BCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=BACNOTE_DETAILS&propertyName=BCOVER_TYPE&name={name}");
...
function onValidate_BACNOTE_DETAILS__BANOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BACNOTE_DETAILS", "BANOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BACNOTE_DETAILS", "BANOTE_DESCRIPTION");
...
function onValidate_BACNOTE_DETAILS__BNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BACNOTE_DETAILS", "BNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BACNOTE_DETAILS", "BNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=BACNOTE_DETAILS&propertyName=BNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_BACNOTE_DETAILS__BNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_BACNOTE_DETAILS_BNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_BACNOTE_DETAILS__BANOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BACNOTE_DETAILS", "BANOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BACNOTE_DETAILS", "BANOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_BACNOTE_DETAILS__BADATE_CREATED(null, null, null, isOnLoad);
    onValidate_BACNOTE_DETAILS__BCREATED_BY(null, null, null, isOnLoad);
    onValidate_BACNOTE_DETAILS__BCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_BACNOTE_DETAILS__BANOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_BACNOTE_DETAILS__BNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_BACNOTE_DETAILS__BANOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="id7fcc1b6e1bf241e99167d1849866d668" class="general-layout-container">
...
<div id="id65974b9b59e648a4983a7cfbff27e771" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading36" runat="server" Text="Sub Section B:Exports Note Detail  (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="BACNOTE_DETAILS" 
		data-property-name="BADATE_CREATED" 
		id="pb-container-datejquerycompatible-BACNOTE_DETAILS-BADATE_CREATED">
		<asp:Label ID="lblBACNOTE_DETAILS_BADATE_CREATED" runat="server" AssociatedControlID="BACNOTE_DETAILS__BADATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="BACNOTE_DETAILS__BADATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calBACNOTE_DETAILS__BADATE_CREATED" runat="server" LinkedControl="BACNOTE_DETAILS__BADATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valBACNOTE_DETAILS_BADATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_BACNOTE_DETAILS__BADATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BACNOTE_DETAILS" 
		data-property-name="BCREATED_BY" 
		 
		
		 
		id="pb-container-text-BACNOTE_DETAILS-BCREATED_BY">

		
		<asp:Label ID="lblBACNOTE_DETAILS_BCREATED_BY" runat="server" AssociatedControlID="BACNOTE_DETAILS__BCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BACNOTE_DETAILS__BCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBACNOTE_DETAILS_BCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_BACNOTE_DETAILS__BCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BACNOTE_DETAILS" 
		data-property-name="BCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-BACNOTE_DETAILS-BCOVER_TYPE">

		
		<asp:Label ID="lblBACNOTE_DETAILS_BCOVER_TYPE" runat="server" AssociatedControlID="BACNOTE_DETAILS__BCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BACNOTE_DETAILS__BCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBACNOTE_DETAILS_BCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_BACNOTE_DETAILS__BCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BACNOTE_DETAILS" 
		data-property-name="BANOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-BACNOTE_DETAILS-BANOTE_DESCRIPTION">

		
		<asp:Label ID="lblBACNOTE_DETAILS_BANOTE_DESCRIPTION" runat="server" AssociatedControlID="BACNOTE_DETAILS__BANOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BACNOTE_DETAILS__BANOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBACNOTE_DETAILS_BANOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_BACNOTE_DETAILS__BANOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="BACNOTE_DETAILS" 
		data-property-name="BNOTE_DETAILS" 
		id="pb-container-comment-BACNOTE_DETAILS-BNOTE_DETAILS">
		<asp:Label ID="lblBACNOTE_DETAILS_BNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="BACNOTE_DETAILS__BNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="BACNOTE_DETAILS__BNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valBACNOTE_DETAILS_BNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_BACNOTE_DETAILS__BNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblBACNOTE_DETAILS_BANOTECHECK" for="ctl00_cntMainBody_BACNOTE_DETAILS__BANOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="BACNOTE_DETAILS" 
		data-property-name="BANOTECHECK" 
		id="pb-container-checkbox-BACNOTE_DETAILS-BANOTECHECK">	
		
		<asp:TextBox ID="BACNOTE_DETAILS__BANOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valBACNOTE_DETAILS_BANOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_BACNOTE_DETAILS__BANOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id65974b9b59e648a4983a7cfbff27e771 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id65974b9b59e648a4983a7cfbff27e771 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id65974b9b59e648a4983a7cfbff27e771 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id65974b9b59e648a4983a7cfbff27e771 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id65974b9b59e648a4983a7cfbff27e771 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65974b9b59e648a4983a7cfbff27e771 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65974b9b59e648a4983a7cfbff27e771 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id65974b9b59e648a4983a7cfbff27e771 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65974b9b59e648a4983a7cfbff27e771 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65974b9b59e648a4983a7cfbff27e771 input{text-align:left;}"; break;
		}
	}
