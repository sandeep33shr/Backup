<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCBSMI_Subject_Matter_Inclusion.aspx.vb" Inherits="Nexus.PB2_MSPCBSMI_Subject_Matter_Inclusion" %>
...
function onValidate_BSBMATINC__ITMNAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BSBMATINC", "ITMNAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BSBMATINC", "ITMNAME");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BSBMATINC.ITMNAME");
        			window.setControlWidth(field, "0.8", "BSBMATINC", "ITMNAME");
        		})();
        	}
        })();
}
function onValidate_BSBMATINC__DESCRPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BSBMATINC", "DESCRPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("BSBMATINC", "DESCRPTION");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BSBMATINC.DESCRPTION");
        			window.setControlWidth(field, "0.8", "BSBMATINC", "DESCRPTION");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_BSBMATINC__ITMNAME(null, null, null, isOnLoad);
    onValidate_BSBMATINC__DESCRPTION(null, null, null, isOnLoad);
}
</script>
...
<div id="id200092872a0847478aa7cc0f42832c7e" class="general-layout-container">
...
<div id="id643e751a9902455e9cfd23f9acdc0e86" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BSBMATINC" 
		data-property-name="ITMNAME" 
		 
		
		 
		id="pb-container-text-BSBMATINC-ITMNAME">

		
		<asp:Label ID="lblBSBMATINC_ITMNAME" runat="server" AssociatedControlID="BSBMATINC__ITMNAME" 
			Text="Item Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BSBMATINC__ITMNAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBSBMATINC_ITMNAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Item Name"
					ClientValidationFunction="onValidate_BSBMATINC__ITMNAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-BSBMATINC-DESCRPTION">

		
		<asp:Label ID="lblBSBMATINC_DESCRPTION" runat="server" AssociatedControlID="BSBMATINC__DESCRPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BSBMATINC__DESCRPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBSBMATINC_DESCRPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_BSBMATINC__DESCRPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id643e751a9902455e9cfd23f9acdc0e86 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id643e751a9902455e9cfd23f9acdc0e86 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id643e751a9902455e9cfd23f9acdc0e86 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id643e751a9902455e9cfd23f9acdc0e86 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id643e751a9902455e9cfd23f9acdc0e86 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id643e751a9902455e9cfd23f9acdc0e86 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id643e751a9902455e9cfd23f9acdc0e86 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id643e751a9902455e9cfd23f9acdc0e86 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id643e751a9902455e9cfd23f9acdc0e86 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id643e751a9902455e9cfd23f9acdc0e86 input{text-align:left;}"; break;
		}
	}
