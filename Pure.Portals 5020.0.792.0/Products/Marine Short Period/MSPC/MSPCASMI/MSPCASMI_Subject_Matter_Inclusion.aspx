<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCASMI_Subject_Matter_Inclusion.aspx.vb" Inherits="Nexus.PB2_MSPCASMI_Subject_Matter_Inclusion" %>
...
function onValidate_SBMATINC__ITMNAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBMATINC", "ITMNAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBMATINC", "ITMNAME");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBMATINC.ITMNAME");
        			window.setControlWidth(field, "0.8", "SBMATINC", "ITMNAME");
        		})();
        	}
        })();
}
function onValidate_SBMATINC__DESCRPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SBMATINC", "DESCRPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SBMATINC", "DESCRPTION");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SBMATINC.DESCRPTION");
        			window.setControlWidth(field, "0.8", "SBMATINC", "DESCRPTION");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_SBMATINC__ITMNAME(null, null, null, isOnLoad);
    onValidate_SBMATINC__DESCRPTION(null, null, null, isOnLoad);
}
</script>
...
<div id="id795f0eb606d64a229e2300dc05915e44" class="general-layout-container">
...
<div id="id7869c7447a204501a24395e6288c7b9f" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SBMATINC" 
		data-property-name="ITMNAME" 
		 
		
		 
		id="pb-container-text-SBMATINC-ITMNAME">

		
		<asp:Label ID="lblSBMATINC_ITMNAME" runat="server" AssociatedControlID="SBMATINC__ITMNAME" 
			Text="Item Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SBMATINC__ITMNAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSBMATINC_ITMNAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Item Name"
					ClientValidationFunction="onValidate_SBMATINC__ITMNAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SBMATINC-DESCRPTION">

		
		<asp:Label ID="lblSBMATINC_DESCRPTION" runat="server" AssociatedControlID="SBMATINC__DESCRPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SBMATINC__DESCRPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSBMATINC_DESCRPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SBMATINC__DESCRPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7869c7447a204501a24395e6288c7b9f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7869c7447a204501a24395e6288c7b9f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7869c7447a204501a24395e6288c7b9f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7869c7447a204501a24395e6288c7b9f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7869c7447a204501a24395e6288c7b9f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7869c7447a204501a24395e6288c7b9f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7869c7447a204501a24395e6288c7b9f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7869c7447a204501a24395e6288c7b9f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7869c7447a204501a24395e6288c7b9f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7869c7447a204501a24395e6288c7b9f input{text-align:left;}"; break;
		}
	}
