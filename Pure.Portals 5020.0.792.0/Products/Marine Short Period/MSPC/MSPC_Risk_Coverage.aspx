<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPC_Risk_Coverage.aspx.vb" Inherits="Nexus.PB2_MSPC_Risk_Coverage" %>
...
function onValidate_COVERS__SUBSECTION_A(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERS", "SUBSECTION_A", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("COVERS.SUBSECTION_A");
        		var update = function(){
...
function onValidate_COVERS__MAXLIMITY_A(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERS", "MAXLIMITY_A", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVERS", "MAXLIMITY_A");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERS.MAXLIMITY_A");
        			window.setControlWidth(field, "0.6", "COVERS", "MAXLIMITY_A");
        		})();
        	}
        })();
}
function onValidate_COVERS__SUBSECTION_B(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERS", "SUBSECTION_B", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("COVERS.SUBSECTION_B");
        		var update = function(){
...
function onValidate_COVERS__MAXLIMITY_B(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERS", "MAXLIMITY_B", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVERS", "MAXLIMITY_B");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERS.MAXLIMITY_B");
        			window.setControlWidth(field, "0.6", "COVERS", "MAXLIMITY_B");
        		})();
        	}
        })();
}
function onValidate_COVERS__SUBSECTION_C(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERS", "SUBSECTION_C", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("COVERS.SUBSECTION_C");
        		var update = function(){
...
function onValidate_COVERS__MAXLIMITY_C(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERS", "MAXLIMITY_C", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVERS", "MAXLIMITY_C");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("COVERS.MAXLIMITY_C");
        			window.setControlWidth(field, "0.6", "COVERS", "MAXLIMITY_C");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_COVERS__SUBSECTION_A(null, null, null, isOnLoad);
    onValidate_COVERS__MAXLIMITY_A(null, null, null, isOnLoad);
    onValidate_COVERS__SUBSECTION_B(null, null, null, isOnLoad);
    onValidate_COVERS__MAXLIMITY_B(null, null, null, isOnLoad);
    onValidate_COVERS__SUBSECTION_C(null, null, null, isOnLoad);
    onValidate_COVERS__MAXLIMITY_C(null, null, null, isOnLoad);
}
</script>
...
<div id="id28cb0d6a1d9e4c1abbef58d057866e62" class="general-layout-container">
...
<div id="id596b99e18dac44ba973b8a0bb2dda8ce" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id596b99e18dac44ba973b8a0bb2dda8ce div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id596b99e18dac44ba973b8a0bb2dda8ce div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id596b99e18dac44ba973b8a0bb2dda8ce div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id596b99e18dac44ba973b8a0bb2dda8ce label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id596b99e18dac44ba973b8a0bb2dda8ce label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id596b99e18dac44ba973b8a0bb2dda8ce label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id596b99e18dac44ba973b8a0bb2dda8ce label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id596b99e18dac44ba973b8a0bb2dda8ce input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id596b99e18dac44ba973b8a0bb2dda8ce input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id596b99e18dac44ba973b8a0bb2dda8ce input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3feb709494644e03b6c195de7f3f0c86" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading2" runat="server" Text="Marine Industry" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_PRIMINDUSTRY" runat="server" AssociatedControlID="GENERAL__PRIMINDUSTRY" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="GENERAL__PRIMINDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDONE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_GENERAL__PRIMINDUSTRY(null, null, this);" data-type="List" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblGENERAL_SCNDINDUSTRY" runat="server" AssociatedControlID="GENERAL__SCNDINDUSTRY" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="GENERAL__SCNDINDUSTRY" runat="server" CssClass="form-control" ListType="UserDefined" ListCode="CMA_INDTWO" ParentLookupListID="GENERAL__PRIMINDUSTRY" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_GENERAL__SCNDINDUSTRY(null, null, this);" data-type="List" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3feb709494644e03b6c195de7f3f0c86 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3feb709494644e03b6c195de7f3f0c86 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3feb709494644e03b6c195de7f3f0c86 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3feb709494644e03b6c195de7f3f0c86 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3feb709494644e03b6c195de7f3f0c86 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3feb709494644e03b6c195de7f3f0c86 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3feb709494644e03b6c195de7f3f0c86 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3feb709494644e03b6c195de7f3f0c86 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3feb709494644e03b6c195de7f3f0c86 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3feb709494644e03b6c195de7f3f0c86 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc35b0a8f35f1474e8b1a7814d54bb3f7" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Covers" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label1">
		<span class="label" id="label1">Maximum Limit of Indemnity</span>
	</span>
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVERS_SUBSECTION_A" for="ctl00_cntMainBody_COVERS__SUBSECTION_A" class="col-md-4 col-sm-3 control-label">
		Sub Section A: Imports</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="COVERS" 
		data-property-name="SUBSECTION_A" 
		id="pb-container-checkbox-COVERS-SUBSECTION_A">	
		
		<asp:TextBox ID="COVERS__SUBSECTION_A" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVERS_SUBSECTION_A" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sub Section A: Imports"
			ClientValidationFunction="onValidate_COVERS__SUBSECTION_A" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="COVERS" 
		data-property-name="MAXLIMITY_A" 
		id="pb-container-currency-COVERS-MAXLIMITY_A">
		<asp:Label ID="lblCOVERS_MAXLIMITY_A" runat="server" AssociatedControlID="COVERS__MAXLIMITY_A" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="COVERS__MAXLIMITY_A" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCOVERS_MAXLIMITY_A" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for COVERS.MAXLIMITY_A"
			ClientValidationFunction="onValidate_COVERS__MAXLIMITY_A" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVERS_SUBSECTION_B" for="ctl00_cntMainBody_COVERS__SUBSECTION_B" class="col-md-4 col-sm-3 control-label">
		Sub Section B: Exports</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="COVERS" 
		data-property-name="SUBSECTION_B" 
		id="pb-container-checkbox-COVERS-SUBSECTION_B">	
		
		<asp:TextBox ID="COVERS__SUBSECTION_B" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVERS_SUBSECTION_B" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sub Section B: Exports"
			ClientValidationFunction="onValidate_COVERS__SUBSECTION_B" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="COVERS" 
		data-property-name="MAXLIMITY_B" 
		id="pb-container-currency-COVERS-MAXLIMITY_B">
		<asp:Label ID="lblCOVERS_MAXLIMITY_B" runat="server" AssociatedControlID="COVERS__MAXLIMITY_B" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="COVERS__MAXLIMITY_B" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCOVERS_MAXLIMITY_B" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for COVERS.MAXLIMITY_B"
			ClientValidationFunction="onValidate_COVERS__MAXLIMITY_B" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVERS_SUBSECTION_C" for="ctl00_cntMainBody_COVERS__SUBSECTION_C" class="col-md-4 col-sm-3 control-label">
		Sub Section C: Inland Transit</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="COVERS" 
		data-property-name="SUBSECTION_C" 
		id="pb-container-checkbox-COVERS-SUBSECTION_C">	
		
		<asp:TextBox ID="COVERS__SUBSECTION_C" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVERS_SUBSECTION_C" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sub Section C: Inland Transit"
			ClientValidationFunction="onValidate_COVERS__SUBSECTION_C" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="COVERS" 
		data-property-name="MAXLIMITY_C" 
		id="pb-container-currency-COVERS-MAXLIMITY_C">
		<asp:Label ID="lblCOVERS_MAXLIMITY_C" runat="server" AssociatedControlID="COVERS__MAXLIMITY_C" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="COVERS__MAXLIMITY_C" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCOVERS_MAXLIMITY_C" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for COVERS.MAXLIMITY_C"
			ClientValidationFunction="onValidate_COVERS__MAXLIMITY_C" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc35b0a8f35f1474e8b1a7814d54bb3f7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc35b0a8f35f1474e8b1a7814d54bb3f7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc35b0a8f35f1474e8b1a7814d54bb3f7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc35b0a8f35f1474e8b1a7814d54bb3f7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc35b0a8f35f1474e8b1a7814d54bb3f7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc35b0a8f35f1474e8b1a7814d54bb3f7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc35b0a8f35f1474e8b1a7814d54bb3f7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc35b0a8f35f1474e8b1a7814d54bb3f7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc35b0a8f35f1474e8b1a7814d54bb3f7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc35b0a8f35f1474e8b1a7814d54bb3f7 input{text-align:left;}"; break;
		}
	}
