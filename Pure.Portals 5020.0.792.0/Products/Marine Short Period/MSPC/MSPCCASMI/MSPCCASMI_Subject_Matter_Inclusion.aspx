<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCCASMI_Subject_Matter_Inclusion.aspx.vb" Inherits="Nexus.PB2_MSPCCASMI_Subject_Matter_Inclusion" %>
...
function onValidate_CSBMATINC__ITMNAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CSBMATINC", "ITMNAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CSBMATINC", "ITMNAME");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CSBMATINC.ITMNAME");
        			window.setControlWidth(field, "0.8", "CSBMATINC", "ITMNAME");
        		})();
        	}
        })();
}
function onValidate_CSBMATINC__DESCRPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CSBMATINC", "DESCRPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CSBMATINC", "DESCRPTION");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CSBMATINC.DESCRPTION");
        			window.setControlWidth(field, "0.8", "CSBMATINC", "DESCRPTION");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CSBMATINC__ITMNAME(null, null, null, isOnLoad);
    onValidate_CSBMATINC__DESCRPTION(null, null, null, isOnLoad);
}
</script>
...
<div id="id8dad815e14304b35ac2981dab451e0d8" class="general-layout-container">
...
<div id="id0e30e01b7ec845b396664d29833f81a5" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="CSBMATINC" 
		data-property-name="ITMNAME" 
		 
		
		 
		id="pb-container-text-CSBMATINC-ITMNAME">

		
		<asp:Label ID="lblCSBMATINC_ITMNAME" runat="server" AssociatedControlID="CSBMATINC__ITMNAME" 
			Text="Item Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CSBMATINC__ITMNAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCSBMATINC_ITMNAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Item Name"
					ClientValidationFunction="onValidate_CSBMATINC__ITMNAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CSBMATINC-DESCRPTION">

		
		<asp:Label ID="lblCSBMATINC_DESCRPTION" runat="server" AssociatedControlID="CSBMATINC__DESCRPTION" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CSBMATINC__DESCRPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCSBMATINC_DESCRPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CSBMATINC__DESCRPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0e30e01b7ec845b396664d29833f81a5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0e30e01b7ec845b396664d29833f81a5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0e30e01b7ec845b396664d29833f81a5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0e30e01b7ec845b396664d29833f81a5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0e30e01b7ec845b396664d29833f81a5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0e30e01b7ec845b396664d29833f81a5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0e30e01b7ec845b396664d29833f81a5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0e30e01b7ec845b396664d29833f81a5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0e30e01b7ec845b396664d29833f81a5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0e30e01b7ec845b396664d29833f81a5 input{text-align:left;}"; break;
		}
	}
