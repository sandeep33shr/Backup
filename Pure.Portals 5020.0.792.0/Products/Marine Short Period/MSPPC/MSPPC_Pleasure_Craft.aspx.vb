...
Namespace Nexus
    Partial Class PB2_MSPPC_Pleasure_Craft : Inherits BaseRisk
...
End Sub
Protected Sub onValidate_VESSELS__INCEP_DATE()
...
Protected Sub CallRuleScripts()
    ...
    onValidate_VESSELS__INCEP_DATE()
...
End Sub
        ...
        Protected Shadows Sub LoadCoverStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If isTrueMonthly Then
        		VESSELS__INCEP_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	Else
        		VESSELS__INCEP_DATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
        	
        	'VESSELS__ENDDATE.Text = RTrim(LTrim(oQuote.CoverEndDate))
