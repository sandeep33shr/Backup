<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPPC_Pleasure_Craft.aspx.vb" Inherits="Nexus.PB2_MSPPC_Pleasure_Craft" %>
...
function onValidate_GENERAL__RISKATTACHDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.RISKATTACHDATE");
        			window.setControlWidth(field, "0.3", "GENERAL", "RISKATTACHDATE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "RISKATTACHDATE");
        		}
...
function onValidate_GENERAL__EFFECTIVEDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.3", "GENERAL", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.IS_VAT");
        			window.setControlWidth(field, "0.2", "GENERAL", "IS_VAT");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.FLAT_PREM");
        			window.setControlWidth(field, "0.3", "GENERAL", "FLAT_PREM");
        		})();
        	}
        })();
        /**
...
function onValidate_GENERAL__TOTAL_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("VESSELS.POST_PREM + VESSELS.TOT_PREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.TOTAL_PREM");
        			window.setControlWidth(field, "0.3", "GENERAL", "TOTAL_PREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("GENERAL", "TOTAL_PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.PRIMARY_INDUSTRY");
        			window.setControlWidth(field, "0.9", "GENERAL", "PRIMARY_INDUSTRY");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.SECOND_INDUSTRY");
        			window.setControlWidth(field, "0.9", "GENERAL", "SECOND_INDUSTRY");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.TERTIARY_INDUSTRY");
        			window.setControlWidth(field, "0.9", "GENERAL", "TERTIARY_INDUSTRY");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("GENERAL.INDUSTRY");
        			window.setControlWidth(field, "0.9", "GENERAL", "INDUSTRY");
        		})();
        	}
        })();
        /**
...
function onValidate_VESSELS__NVESSEL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.NVESSEL");
        			window.setControlWidth(field, "0.7", "VESSELS", "NVESSEL");
        		})();
        	}
        })();
        /**
...
function onValidate_VESSELS__VRAFT_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.VRAFT_TYPE");
        			window.setControlWidth(field, "0.3", "VESSELS", "VRAFT_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "TVMOTOR");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VESSELS.TVMOTOR");
        			window.setControlWidth(field, "0.3", "VESSELS", "TVMOTOR");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "TYPE_USE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VESSELS.TYPE_USE");
        			window.setControlWidth(field, "0.3", "VESSELS", "TYPE_USE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "VUSE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VESSELS.VUSE");
        			window.setControlWidth(field, "0.3", "VESSELS", "VUSE");
        		})();
        	}
        })();
        /**
...
function onValidate_VESSELS__SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("VESSELS", "SUMINSURED");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.SUMINSURED");
        			window.setControlWidth(field, "0.8", "VESSELS", "SUMINSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVESSELS_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_VESSELS__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VESSELS__SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("VESSELS.POST_PREM.setValue('')");
...
function onValidate_VESSELS__RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "RATE");
        		}
        		//window.setProperty(field, "V", "GENERAL.FLAT_PREM == 0", "VE", "{3}");
        
            var paramValue = "V",
            paramCondition = "GENERAL.FLAT_PREM == 0",
            paramElseValue = "VE",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.RATE");
        			window.setControlWidth(field, "0.8", "VESSELS", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVESSELS_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_VESSELS__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VESSELS__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "VESSELS".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "VESSELS".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("VESSELS.RATE > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=VESSELS&propertyName=RATE&name={name}");
        		
        		var value = new Expression("VESSELS.POST_PREM / VESSELS.SUMINSURED * 100"), 
        			condition = (Expression.isValidParameter("VESSELS.POST_PREM > 0")) ? new Expression("VESSELS.POST_PREM > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_VESSELS__PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.PREM");
        			window.setControlWidth(field, "0.8", "VESSELS", "PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVESSELS_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_VESSELS__PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VESSELS__PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=VESSELS&propertyName=PREM&name={name}");
        		
        		var value = new Expression("VESSELS.POST_PREM"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_VESSELS__POST_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("VESSELS", "POST_PREM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.POST_PREM");
        			window.setControlWidth(field, "0.8", "VESSELS", "POST_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVESSELS_POST_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_VESSELS__POST_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VESSELS__POST_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=VESSELS&propertyName=POST_PREM&name={name}");
        		
        		var value = new Expression("VESSELS.SUMINSURED * VESSELS.RATE / 100"), 
        			condition = (Expression.isValidParameter("VESSELS.RATE > 0")) ? new Expression("VESSELS.RATE > 0") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("GENERAL.FLAT_PREM == 1 ")) ? new Expression("GENERAL.FLAT_PREM == 1 ") : null;
...
function onValidate_VESSELS__FAP_PERC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "FAP_PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.FAP_PERC");
        			window.setControlWidth(field, "0.8", "VESSELS", "FAP_PERC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVESSELS_FAP_PERC");
        			    var ele = document.getElementById('ctl00_cntMainBody_VESSELS__FAP_PERC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VESSELS__FAP_PERC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "VESSELS".toUpperCase() + "__" + "FAP_PERC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "VESSELS".toUpperCase() + "_" + "FAP_PERC");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("VESSELS.FAP_PERC > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=VESSELS&propertyName=FAP_PERC&name={name}");
        		
        		var value = new Expression("VESSELS.FAP_PERC"), 
        			condition = (Expression.isValidParameter("VESSELS.FAP_PERC > GENERAL.PC_FAP")) ? new Expression("VESSELS.FAP_PERC > GENERAL.PC_FAP") : null, 
...
function onValidate_VESSELS__MIN_AMNT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "MIN_AMNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.MIN_AMNT");
        			window.setControlWidth(field, "0.8", "VESSELS", "MIN_AMNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVESSELS_MIN_AMNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_VESSELS__MIN_AMNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VESSELS__MIN_AMNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=VESSELS&propertyName=MIN_AMNT&name={name}");
        		
        		var value = new Expression("VESSELS.MIN_AMNT"), 
        			condition = (Expression.isValidParameter("VESSELS.MIN_AMNT > GENERAL.PC_MIN_AMT")) ? new Expression("VESSELS.MIN_AMNT > GENERAL.PC_MIN_AMT") : null, 
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "IS_NASRIA");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_VESSELS__NASRIA_LIMIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "NASRIA_LIMIT");
        		}
        		//window.setProperty(field, "VEM", "VESSELS.IS_NASRIA == 1 ", "V", "{3}");
        
            var paramValue = "VEM",
            paramCondition = "VESSELS.IS_NASRIA == 1 ",
            paramElseValue = "V",
            paramValidationMessage = "{3}";
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.NASRIA_LIMIT");
        			window.setControlWidth(field, "0.4", "VESSELS", "NASRIA_LIMIT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVESSELS_NASRIA_LIMIT");
        			    var ele = document.getElementById('ctl00_cntMainBody_VESSELS__NASRIA_LIMIT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VESSELS__NASRIA_LIMIT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("VESSELS.IS_NASRIA == 1 ")) ? new Expression("VESSELS.IS_NASRIA == 1 ") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=VESSELS&propertyName=NASRIA_LIMIT&name={name}");
        		
        		var value = new Expression("VESSELS.NASRIA_LIMIT"), 
        			condition = (Expression.isValidParameter("VESSELS.IS_NASRIA= 1")) ? new Expression("VESSELS.IS_NASRIA= 1") : null, 
...
function onValidate_VESSELS__INTPARTY_NAME(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "INTPARTY_NAME");
        		}
        		//window.setProperty(field, "VEM", "VESSELS.INTPARTY_DATE != null", "VE", "Interest Party name is mandatory and must be entered");
        
            var paramValue = "VEM",
            paramCondition = "VESSELS.INTPARTY_DATE != null",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("VESSELS.INTPARTY_DATE != null")) ? new Expression("VESSELS.INTPARTY_DATE != null") : null;
        		var elseColour = (Expression.isValidParameter("#00000000")) ? "#00000000" : null;
...
function onValidate_VESSELS__INTPARTY_DATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "INTPARTY_DATE");
        		}
        		//window.setProperty(field, "VEM", "VESSELS.INTPARTY_NAME != ''", "VE", "Enter interest party date");
        
            var paramValue = "VEM",
            paramCondition = "VESSELS.INTPARTY_NAME != ''",
            paramElseValue = "VE",
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("VESSELS.INTPARTY_DATE");
        			window.setControlWidth(field, "0.3", "VESSELS", "INTPARTY_DATE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var colour = "#FFFFD9";
        		var condition = (Expression.isValidParameter("VESSELS.INTPARTY_NAME  != null")) ? new Expression("VESSELS.INTPARTY_NAME  != null") : null;
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "VESSELS".toUpperCase() + "__" + "INTPARTY_DATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "VESSELS".toUpperCase() + "_" + "INTPARTY_DATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("VESSELS.INCEP_DATE > VESSELS.INTPARTY_DATE AND VESSELS.INTPARTY_DATE != null ");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_VESSELS__INCEP_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VESSELS", "INCEP_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("VESSELS", "INCEP_DATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("VESSELS", "INCEP_DATE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_VESSELS__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VESSELS", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("VESSELS", "TOT_PREM");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("VESSELS.TOT_PREM");
        			window.setControlWidth(field, "0.4", "VESSELS", "TOT_PREM");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblVESSELS_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_VESSELS__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_VESSELS__TOT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
          ...
          * @param VESSAELS The Parent (Root) object name.
          * @param VESSEL_CLAUSEPREM.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "VESSAELS".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "VESSEL_CLAUSEPREM.PREMIUM";
...
function onValidate_VESSELS__MSPPCENPR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VESSELS", "MSPPCENPR", "ChildScreen");
        })();
}
function onValidate_VESSELS__MSPPCNPN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VESSELS", "MSPPCNPN", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("VESSELS", "MSPPCNPN");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_VESSELS__MSPPCNPN table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("VESSELS", "MSPPCNPN");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'VESSELS' and property 'MSPPCNPN'.");
        			error.display();
...
function onValidate_VESSELS__MSPPCNDP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VESSELS", "MSPPCNDP", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_VESSELS__INCEP_DATE(null, null, null, isOnLoad);
    onValidate_VESSELS__TOT_PREM(null, null, null, isOnLoad);
    onValidate_VESSELS__MSPPCENPR(null, null, null, isOnLoad);
    onValidate_VESSELS__MSPPCNPN(null, null, null, isOnLoad);
    onValidate_VESSELS__MSPPCNDP(null, null, null, isOnLoad);
...
<div id="ide8bb7ade1bb14145a660b9b12de943e9" class="general-layout-container">
...
<div id="idf6f375d763364be7a72bd55b6d3cd3ff" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf6f375d763364be7a72bd55b6d3cd3ff div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf6f375d763364be7a72bd55b6d3cd3ff div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf6f375d763364be7a72bd55b6d3cd3ff div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf6f375d763364be7a72bd55b6d3cd3ff label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf6f375d763364be7a72bd55b6d3cd3ff label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf6f375d763364be7a72bd55b6d3cd3ff label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf6f375d763364be7a72bd55b6d3cd3ff label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf6f375d763364be7a72bd55b6d3cd3ff input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf6f375d763364be7a72bd55b6d3cd3ff input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf6f375d763364be7a72bd55b6d3cd3ff input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2a60ece7fab1470dbf85da7ca8c01065" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2a60ece7fab1470dbf85da7ca8c01065 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2a60ece7fab1470dbf85da7ca8c01065 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2a60ece7fab1470dbf85da7ca8c01065 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2a60ece7fab1470dbf85da7ca8c01065 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2a60ece7fab1470dbf85da7ca8c01065 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2a60ece7fab1470dbf85da7ca8c01065 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2a60ece7fab1470dbf85da7ca8c01065 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2a60ece7fab1470dbf85da7ca8c01065 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2a60ece7fab1470dbf85da7ca8c01065 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2a60ece7fab1470dbf85da7ca8c01065 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8d1280772ec64beb8c39b0ed82a5c7c8" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8d1280772ec64beb8c39b0ed82a5c7c8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8d1280772ec64beb8c39b0ed82a5c7c8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8d1280772ec64beb8c39b0ed82a5c7c8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8d1280772ec64beb8c39b0ed82a5c7c8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8d1280772ec64beb8c39b0ed82a5c7c8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8d1280772ec64beb8c39b0ed82a5c7c8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8d1280772ec64beb8c39b0ed82a5c7c8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8d1280772ec64beb8c39b0ed82a5c7c8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8d1280772ec64beb8c39b0ed82a5c7c8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8d1280772ec64beb8c39b0ed82a5c7c8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc5222ca1e1e048cfb661db8374b73816" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc5222ca1e1e048cfb661db8374b73816 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc5222ca1e1e048cfb661db8374b73816 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc5222ca1e1e048cfb661db8374b73816 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc5222ca1e1e048cfb661db8374b73816 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc5222ca1e1e048cfb661db8374b73816 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc5222ca1e1e048cfb661db8374b73816 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc5222ca1e1e048cfb661db8374b73816 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc5222ca1e1e048cfb661db8374b73816 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc5222ca1e1e048cfb661db8374b73816 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc5222ca1e1e048cfb661db8374b73816 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id39cf62beb79044028b3b8a398d5a0585" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id39cf62beb79044028b3b8a398d5a0585 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id39cf62beb79044028b3b8a398d5a0585 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id39cf62beb79044028b3b8a398d5a0585 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id39cf62beb79044028b3b8a398d5a0585 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id39cf62beb79044028b3b8a398d5a0585 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id39cf62beb79044028b3b8a398d5a0585 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id39cf62beb79044028b3b8a398d5a0585 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id39cf62beb79044028b3b8a398d5a0585 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id39cf62beb79044028b3b8a398d5a0585 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id39cf62beb79044028b3b8a398d5a0585 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5d57814bea0945ea93af37316014aef3" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5d57814bea0945ea93af37316014aef3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5d57814bea0945ea93af37316014aef3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5d57814bea0945ea93af37316014aef3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5d57814bea0945ea93af37316014aef3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5d57814bea0945ea93af37316014aef3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d57814bea0945ea93af37316014aef3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d57814bea0945ea93af37316014aef3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5d57814bea0945ea93af37316014aef3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d57814bea0945ea93af37316014aef3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d57814bea0945ea93af37316014aef3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6819571b09d541d3b9142ff1398e965e" class="column-layout-container,no-border  ">
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-VESSELS-INCEP_DATE">
		<asp:Label ID="lblVESSELS_INCEP_DATE" runat="server" AssociatedControlID="VESSELS__INCEP_DATE" 
			Text="Inception Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="VESSELS__INCEP_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calVESSELS__INCEP_DATE" runat="server" LinkedControl="VESSELS__INCEP_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valVESSELS_INCEP_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Inception Date"
			ClientValidationFunction="onValidate_VESSELS__INCEP_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6819571b09d541d3b9142ff1398e965e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6819571b09d541d3b9142ff1398e965e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6819571b09d541d3b9142ff1398e965e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6819571b09d541d3b9142ff1398e965e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6819571b09d541d3b9142ff1398e965e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6819571b09d541d3b9142ff1398e965e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6819571b09d541d3b9142ff1398e965e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6819571b09d541d3b9142ff1398e965e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6819571b09d541d3b9142ff1398e965e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6819571b09d541d3b9142ff1398e965e input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblVESSELS_VESSEL_CLAUSES" runat="server" AssociatedControlID="VESSELS__VESSEL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="VESSELS__VESSEL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-VESSELS-TOT_PREM">
		<asp:Label ID="lblVESSELS_TOT_PREM" runat="server" AssociatedControlID="VESSELS__TOT_PREM" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="VESSELS__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valVESSELS_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_VESSELS__TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_VESSELS__MSPPCENPR"
		data-field-type="Child" 
		data-object-name="VESSELS" 
		data-property-name="MSPPCENPR" 
		id="pb-container-childscreen-VESSELS-MSPPCENPR">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="VESSELS__VESSEL_CLAUSEPREM" runat="server" ScreenCode="MSPPCENPR" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPPCENPR/MSPPCENPR_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valVESSELS_MSPPCENPR" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for VESSELS.MSPPCENPR"
						ClientValidationFunction="onValidate_VESSELS__MSPPCENPR" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9b53de6561504520b6e240be3a447c04" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_VESSELS__MSPPCNPN"
		data-field-type="Child" 
		data-object-name="VESSELS" 
		data-property-name="MSPPCNPN" 
		id="pb-container-childscreen-VESSELS-MSPPCNPN">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="VESSELS__PC_CNOTE_DETAILS" runat="server" ScreenCode="MSPPCNPN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPPCNPN/MSPPCNPN_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valVESSELS_MSPPCNPN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for VESSELS.MSPPCNPN"
						ClientValidationFunction="onValidate_VESSELS__MSPPCNPN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9b53de6561504520b6e240be3a447c04 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9b53de6561504520b6e240be3a447c04 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9b53de6561504520b6e240be3a447c04 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9b53de6561504520b6e240be3a447c04 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9b53de6561504520b6e240be3a447c04 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9b53de6561504520b6e240be3a447c04 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9b53de6561504520b6e240be3a447c04 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9b53de6561504520b6e240be3a447c04 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9b53de6561504520b6e240be3a447c04 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9b53de6561504520b6e240be3a447c04 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idfaeabbaf738a474a820e83071e98e0fe" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_VESSELS__MSPPCNDP"
		data-field-type="Child" 
		data-object-name="VESSELS" 
		data-property-name="MSPPCNDP" 
		id="pb-container-childscreen-VESSELS-MSPPCNDP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="VESSELS__PC_SCNOTE_DETAILS" runat="server" ScreenCode="MSPPCNDP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MSPPCNDP/MSPPCNDP_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valVESSELS_MSPPCNDP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for VESSELS.MSPPCNDP"
						ClientValidationFunction="onValidate_VESSELS__MSPPCNDP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idfaeabbaf738a474a820e83071e98e0fe div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfaeabbaf738a474a820e83071e98e0fe div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfaeabbaf738a474a820e83071e98e0fe div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idfaeabbaf738a474a820e83071e98e0fe label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfaeabbaf738a474a820e83071e98e0fe label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfaeabbaf738a474a820e83071e98e0fe label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfaeabbaf738a474a820e83071e98e0fe label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfaeabbaf738a474a820e83071e98e0fe input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfaeabbaf738a474a820e83071e98e0fe input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfaeabbaf738a474a820e83071e98e0fe input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id79b54c7c49354b599881e1b571ca8b65" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id79b54c7c49354b599881e1b571ca8b65 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id79b54c7c49354b599881e1b571ca8b65 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id79b54c7c49354b599881e1b571ca8b65 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id79b54c7c49354b599881e1b571ca8b65 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id79b54c7c49354b599881e1b571ca8b65 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id79b54c7c49354b599881e1b571ca8b65 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id79b54c7c49354b599881e1b571ca8b65 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id79b54c7c49354b599881e1b571ca8b65 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id79b54c7c49354b599881e1b571ca8b65 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id79b54c7c49354b599881e1b571ca8b65 input{text-align:left;}"; break;
		}
	}
