<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMCH_Extentions.aspx.vb" Inherits="Nexus.PB2_CMCH_Extentions" %>
...
function onValidate_REFFERRAL_CLAUSES__CHENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "REFFERRAL_CLAUSES", "CHENDPREM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_REFFERRAL_CLAUSES__TOT_PREM(null, null, null, isOnLoad);
    onValidate_REFFERRAL_CLAUSES__CHENDPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id9391dfecd38c4d54ab03a9b0dc1a7bc3" class="general-layout-container">
...
<div id="id1719b823e49a4ceb987308d4242c873b" class="column-layout-container,no-border  ">
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_REFFERRAL_CLAUSES__CHENDPREM"
		data-field-type="Child" 
		data-object-name="REFFERRAL_CLAUSES" 
		data-property-name="CHENDPREM" 
		id="pb-container-childscreen-REFFERRAL_CLAUSES-CHENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="REFFERRAL_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="CHENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CHENDPREM/CHENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valREFFERRAL_CLAUSES_CHENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for REFFERRAL_CLAUSES.CHENDPREM"
						ClientValidationFunction="onValidate_REFFERRAL_CLAUSES__CHENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1719b823e49a4ceb987308d4242c873b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1719b823e49a4ceb987308d4242c873b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1719b823e49a4ceb987308d4242c873b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1719b823e49a4ceb987308d4242c873b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1719b823e49a4ceb987308d4242c873b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1719b823e49a4ceb987308d4242c873b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1719b823e49a4ceb987308d4242c873b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1719b823e49a4ceb987308d4242c873b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1719b823e49a4ceb987308d4242c873b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1719b823e49a4ceb987308d4242c873b input{text-align:left;}"; break;
		}
	}
