<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMCH_Trailers.aspx.vb" Inherits="Nexus.PB2_CMCH_Trailers" %>
...
function onValidate_TRLCHD__MTDTRAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRLCHD", "MTDTRAIL", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TRLCHD__MTDTRAIL(null, null, null, isOnLoad);
}
</script>
...
<div id="id00d33cc90474474d985733c12339b4b5" class="general-layout-container">
...
<div id="iddf0a7bf98b4f468b9b4aaf79afe245d3" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TRLCHD__MTDTRAIL"
		data-field-type="Child" 
		data-object-name="TRLCHD" 
		data-property-name="MTDTRAIL" 
		id="pb-container-childscreen-TRLCHD-MTDTRAIL">
		
		    <legend>Trailers</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TRLCHD__TRLERD" runat="server" ScreenCode="MTDTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MTDTRAIL/MTDTRAIL_Trailer_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Make And Model" DataField="TDMAM" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Registration Number" DataField="TDRNUMBER" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Year Of Manufacture" DataField="TDYMAN" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Vin Number" DataField="TDVNUMBER" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Sum Insured" DataField="TDTSMINSRD" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Rate %" DataField="TDTRATE" DataFormatString="{0:0}%"/>
<Nexus:RiskAttribute HeaderText="Premium" DataField="TDTPREM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valTRLCHD_MTDTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Trailers"
						ClientValidationFunction="onValidate_TRLCHD__MTDTRAIL" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddf0a7bf98b4f468b9b4aaf79afe245d3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddf0a7bf98b4f468b9b4aaf79afe245d3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddf0a7bf98b4f468b9b4aaf79afe245d3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddf0a7bf98b4f468b9b4aaf79afe245d3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddf0a7bf98b4f468b9b4aaf79afe245d3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddf0a7bf98b4f468b9b4aaf79afe245d3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddf0a7bf98b4f468b9b4aaf79afe245d3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddf0a7bf98b4f468b9b4aaf79afe245d3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddf0a7bf98b4f468b9b4aaf79afe245d3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddf0a7bf98b4f468b9b4aaf79afe245d3 input{text-align:left;}"; break;
		}
	}
