<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCOMH_Cover_Details.aspx.vb" Inherits="Nexus.PB2_MSPCOMH_Cover_Details" %>
...
function onValidate_SPCH_GENERAL__RISKATTACHDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SPCH_GENERAL.RISKATTACHDATE");
        			window.setControlWidth(field, "0.4", "SPCH_GENERAL", "RISKATTACHDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSPCH_GENERAL_RISKATTACHDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_SPCH_GENERAL__RISKATTACHDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SPCH_GENERAL__RISKATTACHDATE_lblFindParty");
        			    }
        			}
...
function onValidate_SPCH_GENERAL__EFFECTIVEDATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SPCH_GENERAL.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.4", "SPCH_GENERAL", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSPCH_GENERAL_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_SPCH_GENERAL__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SPCH_GENERAL__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SPCH_GENERAL__IS_VAT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPCH_GENERAL", "IS_VAT", "List");
        })();
        /**
         * @fileoverview
         * SetValue
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=List&objectName=SPCH_GENERAL&propertyName=IS_VAT&name={name}");
        		
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("Code(GENERAL.IS_VAT) = '' OR Code(SPCH_GENERAL.IS_VAT) = null")) ? new Expression("Code(GENERAL.IS_VAT) = '' OR Code(SPCH_GENERAL.IS_VAT) = null") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SPCH_GENERAL.IS_VAT");
        			window.setControlWidth(field, "0.4", "SPCH_GENERAL", "IS_VAT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSPCH_GENERAL_IS_VAT");
        			    var ele = document.getElementById('ctl00_cntMainBody_SPCH_GENERAL__IS_VAT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SPCH_GENERAL__IS_VAT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PHYADDRESS__NO(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PHYADDRESS", "NO", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PHYADDRESS", "NO");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPHYADDRESS_NO");
        			    var ele = document.getElementById('ctl00_cntMainBody_PHYADDRESS__NO');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PHYADDRESS__NO_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PHYADDRESS.NO");
        			window.setControlWidth(field, "0.9", "PHYADDRESS", "NO");
        		})();
        	}
        })();
}
function onValidate_PHYADDRESS__WNSUBURB(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PHYADDRESS", "WNSUBURB", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PHYADDRESS", "WNSUBURB");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPHYADDRESS_WNSUBURB");
        			    var ele = document.getElementById('ctl00_cntMainBody_PHYADDRESS__WNSUBURB');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PHYADDRESS__WNSUBURB_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PHYADDRESS.WNSUBURB");
        			window.setControlWidth(field, "0.9", "PHYADDRESS", "WNSUBURB");
        		})();
        	}
        })();
}
function onValidate_PHYADDRESS__WNTOWN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PHYADDRESS", "WNTOWN", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PHYADDRESS", "WNTOWN");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPHYADDRESS_WNTOWN");
        			    var ele = document.getElementById('ctl00_cntMainBody_PHYADDRESS__WNTOWN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PHYADDRESS__WNTOWN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PHYADDRESS.WNTOWN");
        			window.setControlWidth(field, "0.9", "PHYADDRESS", "WNTOWN");
        		})();
        	}
        })();
}
function onValidate_PHYADDRESS__WNPOSTCODE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PHYADDRESS", "WNPOSTCODE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PHYADDRESS", "WNPOSTCODE");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPHYADDRESS_WNPOSTCODE");
        			    var ele = document.getElementById('ctl00_cntMainBody_PHYADDRESS__WNPOSTCODE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PHYADDRESS__WNPOSTCODE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PHYADDRESS.WNPOSTCODE");
        			window.setControlWidth(field, "0.9", "PHYADDRESS", "WNPOSTCODE");
        		})();
        	}
        })();
}
function onValidate_PHYADDRESS__WNCOUNTRY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PHYADDRESS", "WNCOUNTRY", "List");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PHYADDRESS", "WNCOUNTRY");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPHYADDRESS_WNCOUNTRY");
        			    var ele = document.getElementById('ctl00_cntMainBody_PHYADDRESS__WNCOUNTRY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PHYADDRESS__WNCOUNTRY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PHYADDRESS.WNCOUNTRY");
        			window.setControlWidth(field, "0.9", "PHYADDRESS", "WNCOUNTRY");
        		})();
        	}
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_PHYADDRESS__NO(null, null, null, isOnLoad);
    onValidate_PHYADDRESS__WNSUBURB(null, null, null, isOnLoad);
    onValidate_PHYADDRESS__WNTOWN(null, null, null, isOnLoad);
    onValidate_PHYADDRESS__WNPOSTCODE(null, null, null, isOnLoad);
    onValidate_PHYADDRESS__WNCOUNTRY(null, null, null, isOnLoad);
...
<div id="id4dcd0fc59aee4bf29f866373ae9634a3" class="general-layout-container">
...
<div id="id499a1943005149b8930bf010e7d370ce" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-SPCH_GENERAL-IS_VAT">
		<asp:Label ID="lblSPCH_GENERAL_IS_VAT" runat="server" AssociatedControlID="SPCH_GENERAL__IS_VAT" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="SPCH_GENERAL__IS_VAT" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_VAT" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_SPCH_GENERAL__IS_VAT(null, null, this);" data-type="List" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id499a1943005149b8930bf010e7d370ce div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id499a1943005149b8930bf010e7d370ce div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id499a1943005149b8930bf010e7d370ce div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id499a1943005149b8930bf010e7d370ce label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id499a1943005149b8930bf010e7d370ce label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id499a1943005149b8930bf010e7d370ce label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id499a1943005149b8930bf010e7d370ce label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id499a1943005149b8930bf010e7d370ce input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id499a1943005149b8930bf010e7d370ce input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id499a1943005149b8930bf010e7d370ce input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0f1f2d60007b46879db1c65489f23371" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0f1f2d60007b46879db1c65489f23371 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0f1f2d60007b46879db1c65489f23371 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0f1f2d60007b46879db1c65489f23371 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0f1f2d60007b46879db1c65489f23371 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0f1f2d60007b46879db1c65489f23371 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f1f2d60007b46879db1c65489f23371 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f1f2d60007b46879db1c65489f23371 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0f1f2d60007b46879db1c65489f23371 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f1f2d60007b46879db1c65489f23371 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f1f2d60007b46879db1c65489f23371 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id560397688b734015b2e7e6bbf8b8f527" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Physical Address of  Vessel/Boat when not in use." /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PHYADDRESS" 
		data-property-name="NO" 
		 
		
		 
		id="pb-container-text-PHYADDRESS-NO">

		
		<asp:Label ID="lblPHYADDRESS_NO" runat="server" AssociatedControlID="PHYADDRESS__NO" 
			Text="No. & Street name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PHYADDRESS__NO" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPHYADDRESS_NO" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for No. & Street name"
					ClientValidationFunction="onValidate_PHYADDRESS__NO"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PHYADDRESS-WNSUBURB">

		
		<asp:Label ID="lblPHYADDRESS_WNSUBURB" runat="server" AssociatedControlID="PHYADDRESS__WNSUBURB" 
			Text="Suburb" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PHYADDRESS__WNSUBURB" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPHYADDRESS_WNSUBURB" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Suburb"
					ClientValidationFunction="onValidate_PHYADDRESS__WNSUBURB"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PHYADDRESS-WNTOWN">

		
		<asp:Label ID="lblPHYADDRESS_WNTOWN" runat="server" AssociatedControlID="PHYADDRESS__WNTOWN" 
			Text="Town" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PHYADDRESS__WNTOWN" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPHYADDRESS_WNTOWN" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Town"
					ClientValidationFunction="onValidate_PHYADDRESS__WNTOWN"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PHYADDRESS-WNPOSTCODE">

		
		<asp:Label ID="lblPHYADDRESS_WNPOSTCODE" runat="server" AssociatedControlID="PHYADDRESS__WNPOSTCODE" 
			Text="Postal Code" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PHYADDRESS__WNPOSTCODE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPHYADDRESS_WNPOSTCODE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Postal Code"
					ClientValidationFunction="onValidate_PHYADDRESS__WNPOSTCODE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PHYADDRESS-WNCOUNTRY">
		<asp:Label ID="lblPHYADDRESS_WNCOUNTRY" runat="server" AssociatedControlID="PHYADDRESS__WNCOUNTRY" 
			Text="Country" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PHYADDRESS__WNCOUNTRY" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="Country" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PHYADDRESS__WNCOUNTRY(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPHYADDRESS_WNCOUNTRY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Country"
			ClientValidationFunction="onValidate_PHYADDRESS__WNCOUNTRY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id560397688b734015b2e7e6bbf8b8f527 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id560397688b734015b2e7e6bbf8b8f527 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id560397688b734015b2e7e6bbf8b8f527 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id560397688b734015b2e7e6bbf8b8f527 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id560397688b734015b2e7e6bbf8b8f527 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id560397688b734015b2e7e6bbf8b8f527 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id560397688b734015b2e7e6bbf8b8f527 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id560397688b734015b2e7e6bbf8b8f527 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id560397688b734015b2e7e6bbf8b8f527 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id560397688b734015b2e7e6bbf8b8f527 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0db0ef5114e14c05bb632004592209c7" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading4" runat="server" Text=" Marine Industry" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0db0ef5114e14c05bb632004592209c7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0db0ef5114e14c05bb632004592209c7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0db0ef5114e14c05bb632004592209c7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0db0ef5114e14c05bb632004592209c7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0db0ef5114e14c05bb632004592209c7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0db0ef5114e14c05bb632004592209c7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0db0ef5114e14c05bb632004592209c7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0db0ef5114e14c05bb632004592209c7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0db0ef5114e14c05bb632004592209c7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0db0ef5114e14c05bb632004592209c7 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idaf081f93f07745bbabf46f4069ba2b0c" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Name of Marina used during the year " /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idaf081f93f07745bbabf46f4069ba2b0c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idaf081f93f07745bbabf46f4069ba2b0c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idaf081f93f07745bbabf46f4069ba2b0c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idaf081f93f07745bbabf46f4069ba2b0c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idaf081f93f07745bbabf46f4069ba2b0c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaf081f93f07745bbabf46f4069ba2b0c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaf081f93f07745bbabf46f4069ba2b0c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idaf081f93f07745bbabf46f4069ba2b0c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaf081f93f07745bbabf46f4069ba2b0c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaf081f93f07745bbabf46f4069ba2b0c input{text-align:left;}"; break;
		}
	}
