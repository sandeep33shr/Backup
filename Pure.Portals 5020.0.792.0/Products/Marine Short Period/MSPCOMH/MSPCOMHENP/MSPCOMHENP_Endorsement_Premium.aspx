<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MSPCOMHENP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_MSPCOMHENP_Endorsement_Premium" %>
...
function onValidate_SPCLAUSEPREM__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPCLAUSEPREM", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SPCLAUSEPREM", "ENDORSE_ID");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SPCLAUSEPREM.ENDORSE_ID");
        			window.setControlWidth(field, "0.5", "SPCLAUSEPREM", "ENDORSE_ID");
        		})();
        	}
        })();
}
function onValidate_SPCLAUSEPREM__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPCLAUSEPREM", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SPCLAUSEPREM", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SPCLAUSEPREM.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "SPCLAUSEPREM", "ENDORSE_DESC");
        		})();
        	}
        })();
}
function onValidate_SPCLAUSEPREM__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPCLAUSEPREM", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SPCLAUSEPREM", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SPCLAUSEPREM.ENDORSE_CAP");
        			window.setControlWidth(field, "0.5", "SPCLAUSEPREM", "ENDORSE_CAP");
        		})();
        	}
        })();
}
function onValidate_SPCLAUSEPREM__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SPCLAUSEPREM", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SPCLAUSEPREM", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SPCLAUSEPREM.PREMIUM");
        			window.setControlWidth(field, "0.5", "SPCLAUSEPREM", "PREMIUM");
        		})();
        	}
        })();
}
function DoLogic(isOnLoad) {
    onValidate_SPCLAUSEPREM__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_SPCLAUSEPREM__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_SPCLAUSEPREM__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_SPCLAUSEPREM__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idfc71be6e6c564c49b4edb48e7f9acb8d" class="general-layout-container">
...
<div id="id38039871dedd45afaf60076d04f244c2" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SPCLAUSEPREM" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-SPCLAUSEPREM-ENDORSE_ID">
		<asp:Label ID="lblSPCLAUSEPREM_ENDORSE_ID" runat="server" AssociatedControlID="SPCLAUSEPREM__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="SPCLAUSEPREM__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valSPCLAUSEPREM_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_SPCLAUSEPREM__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-SPCLAUSEPREM-ENDORSE_DESC">
		<asp:Label ID="lblSPCLAUSEPREM_ENDORSE_DESC" runat="server" AssociatedControlID="SPCLAUSEPREM__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="SPCLAUSEPREM__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_SPCLAUSEPREM__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valSPCLAUSEPREM_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_SPCLAUSEPREM__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SPCLAUSEPREM-ENDORSE_CAP">

		
		<asp:Label ID="lblSPCLAUSEPREM_ENDORSE_CAP" runat="server" AssociatedControlID="SPCLAUSEPREM__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SPCLAUSEPREM__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSPCLAUSEPREM_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_SPCLAUSEPREM__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SPCLAUSEPREM-PREMIUM">
		<asp:Label ID="lblSPCLAUSEPREM_PREMIUM" runat="server" AssociatedControlID="SPCLAUSEPREM__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SPCLAUSEPREM__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSPCLAUSEPREM_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SPCLAUSEPREM__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id38039871dedd45afaf60076d04f244c2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id38039871dedd45afaf60076d04f244c2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id38039871dedd45afaf60076d04f244c2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id38039871dedd45afaf60076d04f244c2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id38039871dedd45afaf60076d04f244c2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38039871dedd45afaf60076d04f244c2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38039871dedd45afaf60076d04f244c2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id38039871dedd45afaf60076d04f244c2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38039871dedd45afaf60076d04f244c2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38039871dedd45afaf60076d04f244c2 input{text-align:left;}"; break;
		}
	}
