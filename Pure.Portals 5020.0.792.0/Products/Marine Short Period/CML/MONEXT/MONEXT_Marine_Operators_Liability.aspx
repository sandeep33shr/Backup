<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MONEXT_Marine_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_MONEXT_Marine_Operators_Liability" %>
...
function onValidate_MONEXT__MONDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEXT", "MONDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMONEXT_MONDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_MONEXT__MONDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MONEXT__MONDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MONEXT", "MONDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MONEXT", "MONDES");
...
function onValidate_MONEXT__MONLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEXT", "MONLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MONEXT", "MONLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMONEXT_MONLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_MONEXT__MONLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MONEXT__MONLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MONEXT", "MONLOI");
...
function onValidate_MONEXT__MONR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEXT", "MONR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMONEXT_MONR");
        			    var ele = document.getElementById('ctl00_cntMainBody_MONEXT__MONR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MONEXT__MONR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MONEXT", "MONR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MONEXT", "MONR");
...
function onValidate_MONEXT__MONP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MONEXT", "MONP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMONEXT_MONP");
        			    var ele = document.getElementById('ctl00_cntMainBody_MONEXT__MONP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MONEXT__MONP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MONEXT", "MONP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("MONEXT", "MONP");
...
function DoLogic(isOnLoad) {
    onValidate_MONEXT__MONDES(null, null, null, isOnLoad);
    onValidate_MONEXT__MONLOI(null, null, null, isOnLoad);
    onValidate_MONEXT__MONR(null, null, null, isOnLoad);
    onValidate_MONEXT__MONP(null, null, null, isOnLoad);
}
</script>
...
<div id="id7ef5c44369dc436b90017a6d0477b8a3" class="general-layout-container">
...
<div id="id72ede4a9131146b3815304c176a35e28" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MONEXT" 
		data-property-name="MONDES" 
		 
		
		 
		id="pb-container-text-MONEXT-MONDES">

		
		<asp:Label ID="lblMONEXT_MONDES" runat="server" AssociatedControlID="MONEXT__MONDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MONEXT__MONDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMONEXT_MONDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_MONEXT__MONDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MONEXT-MONLOI">
		<asp:Label ID="lblMONEXT_MONLOI" runat="server" AssociatedControlID="MONEXT__MONLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEXT__MONLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMONEXT_MONLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_MONEXT__MONLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-MONEXT-MONR">
		<asp:Label ID="lblMONEXT_MONR" runat="server" AssociatedControlID="MONEXT__MONR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MONEXT__MONR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMONEXT_MONR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_MONEXT__MONR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MONEXT-MONP">
		<asp:Label ID="lblMONEXT_MONP" runat="server" AssociatedControlID="MONEXT__MONP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MONEXT__MONP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMONEXT_MONP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_MONEXT__MONP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id72ede4a9131146b3815304c176a35e28 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id72ede4a9131146b3815304c176a35e28 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id72ede4a9131146b3815304c176a35e28 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id72ede4a9131146b3815304c176a35e28 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id72ede4a9131146b3815304c176a35e28 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id72ede4a9131146b3815304c176a35e28 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id72ede4a9131146b3815304c176a35e28 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id72ede4a9131146b3815304c176a35e28 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id72ede4a9131146b3815304c176a35e28 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id72ede4a9131146b3815304c176a35e28 input{text-align:left;}"; break;
		}
	}
