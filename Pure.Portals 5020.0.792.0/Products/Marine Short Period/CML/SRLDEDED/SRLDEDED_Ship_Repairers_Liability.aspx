<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SRLDEDED_Ship_Repairers_Liability.aspx.vb" Inherits="Nexus.PB2_SRLDEDED_Ship_Repairers_Liability" %>
...
function onValidate_SRLDEDUCT__SRLDDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLDEDUCT", "SRLDDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLDEDUCT_SRLDDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLDEDUCT__SRLDDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLDEDUCT__SRLDDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLDEDUCT", "SRLDDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRLDEDUCT", "SRLDDES");
...
function onValidate_SRLDEDUCT__SRLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLDEDUCT", "SRLP", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLDEDUCT", "SRLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLDEDUCT_SRLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLDEDUCT__SRLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLDEDUCT__SRLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRLDEDUCT", "SRLP");
...
function onValidate_SRLDEDUCT__SRLMIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLDEDUCT", "SRLMIN", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLDEDUCT_SRLMIN");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLDEDUCT__SRLMIN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLDEDUCT__SRLMIN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLDEDUCT", "SRLMIN");
        		}
...
function onValidate_SRLDEDUCT__SRLMAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLDEDUCT", "SRLMAX", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLDEDUCT_SRLMAX");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLDEDUCT__SRLMAX');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLDEDUCT__SRLMAX_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLDEDUCT", "SRLMAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_SRLDEDUCT__SRLBOE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLDEDUCT", "SRLBOE", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLDEDUCT_SRLBOE");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLDEDUCT__SRLBOE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLDEDUCT__SRLBOE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLDEDUCT", "SRLBOE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRLDEDUCT", "SRLBOE");
...
function DoLogic(isOnLoad) {
    onValidate_SRLDEDUCT__SRLDDES(null, null, null, isOnLoad);
    onValidate_SRLDEDUCT__SRLP(null, null, null, isOnLoad);
    onValidate_SRLDEDUCT__SRLMIN(null, null, null, isOnLoad);
    onValidate_SRLDEDUCT__SRLMAX(null, null, null, isOnLoad);
    onValidate_SRLDEDUCT__SRLBOE(null, null, null, isOnLoad);
}
</script>
...
<div id="id54715480a7364d15a1fad7cffeda9076" class="general-layout-container">
...
<div id="idc54addb2b5ae440e85923de913958ba9" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-property-name="SRLDDES" 
		 
		
		 
		id="pb-container-text-SRLDEDUCT-SRLDDES">

		
		<asp:Label ID="lblSRLDEDUCT_SRLDDES" runat="server" AssociatedControlID="SRLDEDUCT__SRLDDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SRLDEDUCT__SRLDDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSRLDEDUCT_SRLDDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SRLDEDUCT__SRLDDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SRLDEDUCT-SRLP">
		<asp:Label ID="lblSRLDEDUCT_SRLP" runat="server" AssociatedControlID="SRLDEDUCT__SRLP" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SRLDEDUCT__SRLP" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSRLDEDUCT_SRLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_SRLDEDUCT__SRLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SRLDEDUCT" 
		data-property-name="SRLMIN" 
		id="pb-container-currency-SRLDEDUCT-SRLMIN">
		<asp:Label ID="lblSRLDEDUCT_SRLMIN" runat="server" AssociatedControlID="SRLDEDUCT__SRLMIN" 
			Text="Deductible Min Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLDEDUCT__SRLMIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLDEDUCT_SRLMIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible Min Amount"
			ClientValidationFunction="onValidate_SRLDEDUCT__SRLMIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="SRLDEDUCT" 
		data-property-name="SRLMAX" 
		id="pb-container-currency-SRLDEDUCT-SRLMAX">
		<asp:Label ID="lblSRLDEDUCT_SRLMAX" runat="server" AssociatedControlID="SRLDEDUCT__SRLMAX" 
			Text="Deductible Max Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLDEDUCT__SRLMAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLDEDUCT_SRLMAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible Max Amount"
			ClientValidationFunction="onValidate_SRLDEDUCT__SRLMAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="SRLDEDUCT" 
		data-property-name="SRLBOE" 
		id="pb-container-currency-SRLDEDUCT-SRLBOE">
		<asp:Label ID="lblSRLDEDUCT_SRLBOE" runat="server" AssociatedControlID="SRLDEDUCT__SRLBOE" 
			Text="Basis of Deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLDEDUCT__SRLBOE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLDEDUCT_SRLBOE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of Deductible"
			ClientValidationFunction="onValidate_SRLDEDUCT__SRLBOE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc54addb2b5ae440e85923de913958ba9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc54addb2b5ae440e85923de913958ba9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc54addb2b5ae440e85923de913958ba9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc54addb2b5ae440e85923de913958ba9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc54addb2b5ae440e85923de913958ba9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc54addb2b5ae440e85923de913958ba9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc54addb2b5ae440e85923de913958ba9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc54addb2b5ae440e85923de913958ba9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc54addb2b5ae440e85923de913958ba9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc54addb2b5ae440e85923de913958ba9 input{text-align:left;}"; break;
		}
	}
