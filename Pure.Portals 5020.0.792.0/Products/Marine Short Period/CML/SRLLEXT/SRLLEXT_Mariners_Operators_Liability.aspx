<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SRLLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_SRLLEXT_Mariners_Operators_Liability" %>
...
function onValidate_SRLLEXT__SRLLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLLEXT", "SRLLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SRLLEXT.SRLLDES");
        			window.setControlWidth(field, "0.8", "SRLLEXT", "SRLLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLLEXT_SRLLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLLEXT__SRLLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLLEXT__SRLLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLLEXT", "SRLLDES");
        		}
...
function onValidate_SRLLEXT__SRLLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLLEXT", "SRLLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SRLLEXT.SRLLLOI");
        			window.setControlWidth(field, "0.8", "SRLLEXT", "SRLLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLLEXT", "SRLLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLLEXT_SRLLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLLEXT__SRLLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLLEXT__SRLLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SRLLEXT__SRLLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLLEXT", "SRLLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SRLLEXT.SRLLR");
        			window.setControlWidth(field, "0.8", "SRLLEXT", "SRLLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLLEXT_SRLLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLLEXT__SRLLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLLEXT__SRLLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLLEXT", "SRLLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_SRLLEXT__SRLLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLLEXT", "SRLLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SRLLEXT.SRLLP");
        			window.setControlWidth(field, "0.8", "SRLLEXT", "SRLLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLLEXT_SRLLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLLEXT__SRLLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLLEXT__SRLLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLLEXT", "SRLLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_SRLLEXT__SRLLDES(null, null, null, isOnLoad);
    onValidate_SRLLEXT__SRLLLOI(null, null, null, isOnLoad);
    onValidate_SRLLEXT__SRLLR(null, null, null, isOnLoad);
    onValidate_SRLLEXT__SRLLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idae002177dda34b06a092a501539ba13d" class="general-layout-container">
...
<div id="idf9304c12dd8c483ca99cdbf74d60f9ed" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SRLLEXT" 
		data-property-name="SRLLDES" 
		 
		
		 
		id="pb-container-text-SRLLEXT-SRLLDES">

		
		<asp:Label ID="lblSRLLEXT_SRLLDES" runat="server" AssociatedControlID="SRLLEXT__SRLLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SRLLEXT__SRLLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSRLLEXT_SRLLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SRLLEXT__SRLLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SRLLEXT" 
		data-property-name="SRLLLOI" 
		id="pb-container-currency-SRLLEXT-SRLLLOI">
		<asp:Label ID="lblSRLLEXT_SRLLLOI" runat="server" AssociatedControlID="SRLLEXT__SRLLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLLEXT__SRLLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLLEXT_SRLLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SRLLEXT__SRLLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SRLLEXT" 
		data-property-name="SRLLR" 
		id="pb-container-percentage-SRLLEXT-SRLLR">
		<asp:Label ID="lblSRLLEXT_SRLLR" runat="server" AssociatedControlID="SRLLEXT__SRLLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SRLLEXT__SRLLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSRLLEXT_SRLLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SRLLEXT__SRLLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SRLLEXT-SRLLP">
		<asp:Label ID="lblSRLLEXT_SRLLP" runat="server" AssociatedControlID="SRLLEXT__SRLLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLLEXT__SRLLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLLEXT_SRLLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SRLLEXT__SRLLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf9304c12dd8c483ca99cdbf74d60f9ed div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf9304c12dd8c483ca99cdbf74d60f9ed div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf9304c12dd8c483ca99cdbf74d60f9ed div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf9304c12dd8c483ca99cdbf74d60f9ed label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf9304c12dd8c483ca99cdbf74d60f9ed label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9304c12dd8c483ca99cdbf74d60f9ed label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9304c12dd8c483ca99cdbf74d60f9ed label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf9304c12dd8c483ca99cdbf74d60f9ed input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9304c12dd8c483ca99cdbf74d60f9ed input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9304c12dd8c483ca99cdbf74d60f9ed input{text-align:left;}"; break;
		}
	}
