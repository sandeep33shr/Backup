<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MAREXT_Charterers_Liability.aspx.vb" Inherits="Nexus.PB2_MAREXT_Charterers_Liability" %>
...
function onValidate_MCONEXT__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCONEXT", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MCONEXT.CLDES");
        			window.setControlWidth(field, "0.8", "MCONEXT", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMCONEXT_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_MCONEXT__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MCONEXT__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MCONEXT", "CLDES");
        		}
...
function onValidate_MCONEXT__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCONEXT", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MCONEXT.CLLOI");
        			window.setControlWidth(field, "0.8", "MCONEXT", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MCONEXT", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMCONEXT_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_MCONEXT__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MCONEXT__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MCONEXT__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCONEXT", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MCONEXT.CLR");
        			window.setControlWidth(field, "0.8", "MCONEXT", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMCONEXT_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_MCONEXT__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MCONEXT__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MCONEXT", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_MCONEXT__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MCONEXT", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MCONEXT.CLP");
        			window.setControlWidth(field, "0.8", "MCONEXT", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMCONEXT_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_MCONEXT__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MCONEXT__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MCONEXT", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_MCONEXT__CLDES(null, null, null, isOnLoad);
    onValidate_MCONEXT__CLLOI(null, null, null, isOnLoad);
    onValidate_MCONEXT__CLR(null, null, null, isOnLoad);
    onValidate_MCONEXT__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idb7a2887143044fc798fa7a15fda16a93" class="general-layout-container">
...
<div id="id2aed311475c842ae8eb3ad3a00231331" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MCONEXT" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-MCONEXT-CLDES">

		
		<asp:Label ID="lblMCONEXT_CLDES" runat="server" AssociatedControlID="MCONEXT__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MCONEXT__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMCONEXT_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_MCONEXT__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MCONEXT-CLLOI">
		<asp:Label ID="lblMCONEXT_CLLOI" runat="server" AssociatedControlID="MCONEXT__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MCONEXT__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMCONEXT_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_MCONEXT__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-MCONEXT-CLR">
		<asp:Label ID="lblMCONEXT_CLR" runat="server" AssociatedControlID="MCONEXT__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MCONEXT__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMCONEXT_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_MCONEXT__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MCONEXT-CLP">
		<asp:Label ID="lblMCONEXT_CLP" runat="server" AssociatedControlID="MCONEXT__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MCONEXT__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMCONEXT_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_MCONEXT__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2aed311475c842ae8eb3ad3a00231331 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2aed311475c842ae8eb3ad3a00231331 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2aed311475c842ae8eb3ad3a00231331 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2aed311475c842ae8eb3ad3a00231331 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2aed311475c842ae8eb3ad3a00231331 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2aed311475c842ae8eb3ad3a00231331 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2aed311475c842ae8eb3ad3a00231331 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2aed311475c842ae8eb3ad3a00231331 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2aed311475c842ae8eb3ad3a00231331 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2aed311475c842ae8eb3ad3a00231331 input{text-align:left;}"; break;
		}
	}
