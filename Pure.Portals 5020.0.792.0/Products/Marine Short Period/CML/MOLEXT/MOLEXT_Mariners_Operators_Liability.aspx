<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOLEXT_Mariners_Operators_Liability.aspx.vb" Inherits="Nexus.PB2_MOLEXT_Mariners_Operators_Liability" %>
...
function onValidate_MOLEXT__MOLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOLEXT", "MOLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOLEXT.MOLDES");
        			window.setControlWidth(field, "0.8", "MOLEXT", "MOLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOLEXT_MOLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOLEXT__MOLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOLEXT__MOLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOLEXT", "MOLDES");
        		}
...
function onValidate_MOLEXT__MOLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOLEXT", "MOLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOLEXT.MOLLOI");
        			window.setControlWidth(field, "0.8", "MOLEXT", "MOLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOLEXT", "MOLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOLEXT_MOLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOLEXT__MOLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOLEXT__MOLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MOLEXT__MOLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOLEXT", "MOLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOLEXT.MOLR");
        			window.setControlWidth(field, "0.8", "MOLEXT", "MOLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOLEXT_MOLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOLEXT__MOLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOLEXT__MOLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOLEXT", "MOLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_MOLEXT__MOLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOLEXT", "MOLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MOLEXT.MOLP");
        			window.setControlWidth(field, "0.8", "MOLEXT", "MOLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMOLEXT_MOLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_MOLEXT__MOLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MOLEXT__MOLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MOLEXT", "MOLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_MOLEXT__MOLDES(null, null, null, isOnLoad);
    onValidate_MOLEXT__MOLLOI(null, null, null, isOnLoad);
    onValidate_MOLEXT__MOLR(null, null, null, isOnLoad);
    onValidate_MOLEXT__MOLP(null, null, null, isOnLoad);
}
</script>
...
<div id="ida66c878246ed4f03aa72a8d4b8bbf7ff" class="general-layout-container">
...
<div id="ida5f8efd2cdfb4674b83d5597ef4a9cad" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MOLEXT" 
		data-property-name="MOLDES" 
		 
		
		 
		id="pb-container-text-MOLEXT-MOLDES">

		
		<asp:Label ID="lblMOLEXT_MOLDES" runat="server" AssociatedControlID="MOLEXT__MOLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MOLEXT__MOLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMOLEXT_MOLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_MOLEXT__MOLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MOLEXT-MOLLOI">
		<asp:Label ID="lblMOLEXT_MOLLOI" runat="server" AssociatedControlID="MOLEXT__MOLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOLEXT__MOLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOLEXT_MOLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_MOLEXT__MOLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-MOLEXT-MOLR">
		<asp:Label ID="lblMOLEXT_MOLR" runat="server" AssociatedControlID="MOLEXT__MOLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MOLEXT__MOLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMOLEXT_MOLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_MOLEXT__MOLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MOLEXT-MOLP">
		<asp:Label ID="lblMOLEXT_MOLP" runat="server" AssociatedControlID="MOLEXT__MOLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MOLEXT__MOLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMOLEXT_MOLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_MOLEXT__MOLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida5f8efd2cdfb4674b83d5597ef4a9cad div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida5f8efd2cdfb4674b83d5597ef4a9cad div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida5f8efd2cdfb4674b83d5597ef4a9cad div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida5f8efd2cdfb4674b83d5597ef4a9cad label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida5f8efd2cdfb4674b83d5597ef4a9cad label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5f8efd2cdfb4674b83d5597ef4a9cad label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5f8efd2cdfb4674b83d5597ef4a9cad label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida5f8efd2cdfb4674b83d5597ef4a9cad input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5f8efd2cdfb4674b83d5597ef4a9cad input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5f8efd2cdfb4674b83d5597ef4a9cad input{text-align:left;}"; break;
		}
	}
