<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FFLEXT_Freight_Forwarders_Liability.aspx.vb" Inherits="Nexus.PB2_FFLEXT_Freight_Forwarders_Liability" %>
...
function onValidate_FFLEXT__FFLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLEXT", "FFLDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLEXT_FFLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLEXT__FFLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLEXT__FFLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLEXT", "FFLDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FFLEXT", "FFLDES");
...
function onValidate_FFLEXT__FFLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLEXT", "FFLLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLEXT", "FFLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLEXT_FFLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLEXT__FFLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLEXT__FFLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FFLEXT", "FFLLOI");
...
function onValidate_FFLEXT__FFLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLEXT", "FFLR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLEXT_FFLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLEXT__FFLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLEXT__FFLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLEXT", "FFLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FFLEXT", "FFLR");
...
function onValidate_FFLEXT__FFLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FFLEXT", "FFLP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblFFLEXT_FFLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_FFLEXT__FFLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_FFLEXT__FFLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("FFLEXT", "FFLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("FFLEXT", "FFLP");
...
function DoLogic(isOnLoad) {
    onValidate_FFLEXT__FFLDES(null, null, null, isOnLoad);
    onValidate_FFLEXT__FFLLOI(null, null, null, isOnLoad);
    onValidate_FFLEXT__FFLR(null, null, null, isOnLoad);
    onValidate_FFLEXT__FFLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id746f5fe35aaf49468fb4871cb9c89fcb" class="general-layout-container">
...
<div id="id2b4b1d94cabe4fc6880d0ed8e29982f1" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="FFLEXT" 
		data-property-name="FFLDES" 
		 
		
		 
		id="pb-container-text-FFLEXT-FFLDES">

		
		<asp:Label ID="lblFFLEXT_FFLDES" runat="server" AssociatedControlID="FFLEXT__FFLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="FFLEXT__FFLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valFFLEXT_FFLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_FFLEXT__FFLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FFLEXT" 
		data-property-name="FFLLOI" 
		id="pb-container-currency-FFLEXT-FFLLOI">
		<asp:Label ID="lblFFLEXT_FFLLOI" runat="server" AssociatedControlID="FFLEXT__FFLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FFLEXT__FFLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFFLEXT_FFLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_FFLEXT__FFLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="FFLEXT" 
		data-property-name="FFLR" 
		id="pb-container-percentage-FFLEXT-FFLR">
		<asp:Label ID="lblFFLEXT_FFLR" runat="server" AssociatedControlID="FFLEXT__FFLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="FFLEXT__FFLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valFFLEXT_FFLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_FFLEXT__FFLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-FFLEXT-FFLP">
		<asp:Label ID="lblFFLEXT_FFLP" runat="server" AssociatedControlID="FFLEXT__FFLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="FFLEXT__FFLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valFFLEXT_FFLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_FFLEXT__FFLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2b4b1d94cabe4fc6880d0ed8e29982f1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2b4b1d94cabe4fc6880d0ed8e29982f1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2b4b1d94cabe4fc6880d0ed8e29982f1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2b4b1d94cabe4fc6880d0ed8e29982f1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2b4b1d94cabe4fc6880d0ed8e29982f1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b4b1d94cabe4fc6880d0ed8e29982f1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b4b1d94cabe4fc6880d0ed8e29982f1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2b4b1d94cabe4fc6880d0ed8e29982f1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2b4b1d94cabe4fc6880d0ed8e29982f1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2b4b1d94cabe4fc6880d0ed8e29982f1 input{text-align:left;}"; break;
		}
	}
