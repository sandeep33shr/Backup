<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CONEXT_Charterers_Liability.aspx.vb" Inherits="Nexus.PB2_CONEXT_Charterers_Liability" %>
...
function onValidate_CONEXT__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONEXT", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONEXT.CLDES");
        			window.setControlWidth(field, "0.8", "CONEXT", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONEXT_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONEXT__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONEXT__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONEXT", "CLDES");
        		}
...
function onValidate_CONEXT__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONEXT", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONEXT.CLLOI");
        			window.setControlWidth(field, "0.8", "CONEXT", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONEXT", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONEXT_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONEXT__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONEXT__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CONEXT__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONEXT", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONEXT.CLR");
        			window.setControlWidth(field, "0.8", "CONEXT", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONEXT_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONEXT__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONEXT__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONEXT", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_CONEXT__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CONEXT", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CONEXT.CLP");
        			window.setControlWidth(field, "0.8", "CONEXT", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCONEXT_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CONEXT__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CONEXT__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CONEXT", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_CONEXT__CLDES(null, null, null, isOnLoad);
    onValidate_CONEXT__CLLOI(null, null, null, isOnLoad);
    onValidate_CONEXT__CLR(null, null, null, isOnLoad);
    onValidate_CONEXT__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id9715b7a78b9d4123b2997a5dc041fece" class="general-layout-container">
...
<div id="idc780c5ba93bb489dbf9ac745007ba8da" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CONEXT-CLDES">

		
		<asp:Label ID="lblCONEXT_CLDES" runat="server" AssociatedControlID="CONEXT__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CONEXT__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCONEXT_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_CONEXT__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CONEXT-CLLOI">
		<asp:Label ID="lblCONEXT_CLLOI" runat="server" AssociatedControlID="CONEXT__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CONEXT__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCONEXT_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_CONEXT__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-CONEXT-CLR">
		<asp:Label ID="lblCONEXT_CLR" runat="server" AssociatedControlID="CONEXT__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="CONEXT__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valCONEXT_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_CONEXT__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-CONEXT-CLP">
		<asp:Label ID="lblCONEXT_CLP" runat="server" AssociatedControlID="CONEXT__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="CONEXT__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valCONEXT_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_CONEXT__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc780c5ba93bb489dbf9ac745007ba8da div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc780c5ba93bb489dbf9ac745007ba8da div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc780c5ba93bb489dbf9ac745007ba8da div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc780c5ba93bb489dbf9ac745007ba8da label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc780c5ba93bb489dbf9ac745007ba8da label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc780c5ba93bb489dbf9ac745007ba8da label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc780c5ba93bb489dbf9ac745007ba8da label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc780c5ba93bb489dbf9ac745007ba8da input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc780c5ba93bb489dbf9ac745007ba8da input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc780c5ba93bb489dbf9ac745007ba8da input{text-align:left;}"; break;
		}
	}
