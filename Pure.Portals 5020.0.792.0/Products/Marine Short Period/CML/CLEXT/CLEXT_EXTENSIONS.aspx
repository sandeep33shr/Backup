<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLEXT_EXTENSIONS.aspx.vb" Inherits="Nexus.PB2_CLEXT_EXTENSIONS" %>
...
function onValidate_EXTEN_S__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTEN_S", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXTEN_S.CLDES");
        			window.setControlWidth(field, "0.8", "EXTEN_S", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEXTEN_S_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_EXTEN_S__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EXTEN_S__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTEN_S", "CLDES");
        		}
...
function onValidate_EXTEN_S__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTEN_S", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXTEN_S.CLLOI");
        			window.setControlWidth(field, "0.8", "EXTEN_S", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTEN_S", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEXTEN_S_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_EXTEN_S__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EXTEN_S__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_EXTEN_S__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTEN_S", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXTEN_S.CLR");
        			window.setControlWidth(field, "0.8", "EXTEN_S", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEXTEN_S_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_EXTEN_S__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EXTEN_S__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTEN_S", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_EXTEN_S__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EXTEN_S", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("EXTEN_S.CLP");
        			window.setControlWidth(field, "0.8", "EXTEN_S", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblEXTEN_S_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_EXTEN_S__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_EXTEN_S__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("EXTEN_S", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_EXTEN_S__CLDES(null, null, null, isOnLoad);
    onValidate_EXTEN_S__CLLOI(null, null, null, isOnLoad);
    onValidate_EXTEN_S__CLR(null, null, null, isOnLoad);
    onValidate_EXTEN_S__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="ida0a3fa0b763d4b10b0280db1fc671bc9" class="general-layout-container">
...
<div id="id34a1686f7ee548a2b07a87dc6f18529f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Extensions" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="EXTEN_S" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-EXTEN_S-CLDES">

		
		<asp:Label ID="lblEXTEN_S_CLDES" runat="server" AssociatedControlID="EXTEN_S__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="EXTEN_S__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valEXTEN_S_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_EXTEN_S__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EXTEN_S-CLLOI">
		<asp:Label ID="lblEXTEN_S_CLLOI" runat="server" AssociatedControlID="EXTEN_S__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EXTEN_S__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEXTEN_S_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_EXTEN_S__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-EXTEN_S-CLR">
		<asp:Label ID="lblEXTEN_S_CLR" runat="server" AssociatedControlID="EXTEN_S__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="EXTEN_S__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valEXTEN_S_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_EXTEN_S__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-EXTEN_S-CLP">
		<asp:Label ID="lblEXTEN_S_CLP" runat="server" AssociatedControlID="EXTEN_S__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="EXTEN_S__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valEXTEN_S_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_EXTEN_S__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id34a1686f7ee548a2b07a87dc6f18529f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id34a1686f7ee548a2b07a87dc6f18529f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id34a1686f7ee548a2b07a87dc6f18529f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id34a1686f7ee548a2b07a87dc6f18529f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id34a1686f7ee548a2b07a87dc6f18529f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id34a1686f7ee548a2b07a87dc6f18529f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id34a1686f7ee548a2b07a87dc6f18529f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id34a1686f7ee548a2b07a87dc6f18529f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id34a1686f7ee548a2b07a87dc6f18529f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id34a1686f7ee548a2b07a87dc6f18529f input{text-align:left;}"; break;
		}
	}
