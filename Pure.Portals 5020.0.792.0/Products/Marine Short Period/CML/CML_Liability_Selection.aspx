<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CML_Liability_Selection.aspx.vb" Inherits="Nexus.PB2_CML_Liability_Selection" %>
...
function onValidate_COVER__IS_CL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_CL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_CL");
        		}
...
function onValidate_COVER__IS_CLL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_CLL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_CLL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_COVER__IS_CONL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_CONL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_CONL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_COVER__IS_MOL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_MOL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_MOL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_COVER__IS_SRL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_SRL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_SRL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_COVER__IS_SBL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_SBL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_SBL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_COVER__IS_SL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_SL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_SL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_COVER__IS_PRL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_PRL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_PRL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_COVER__IS_FFL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVER", "IS_FFL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("COVER", "IS_FFL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_COVER__IS_CL(null, null, null, isOnLoad);
    onValidate_COVER__IS_CLL(null, null, null, isOnLoad);
    onValidate_COVER__IS_CONL(null, null, null, isOnLoad);
    onValidate_COVER__IS_MOL(null, null, null, isOnLoad);
    onValidate_COVER__IS_SRL(null, null, null, isOnLoad);
    onValidate_COVER__IS_SBL(null, null, null, isOnLoad);
    onValidate_COVER__IS_SL(null, null, null, isOnLoad);
    onValidate_COVER__IS_PRL(null, null, null, isOnLoad);
    onValidate_COVER__IS_FFL(null, null, null, isOnLoad);
}
</script>
...
<div id="id17fadedbba4441a7b49c4f8b2c9c79fd" class="general-layout-container">
...
<div id="id5d4c8c3e629945a497719baa5d3a2d9c" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5d4c8c3e629945a497719baa5d3a2d9c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5d4c8c3e629945a497719baa5d3a2d9c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5d4c8c3e629945a497719baa5d3a2d9c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5d4c8c3e629945a497719baa5d3a2d9c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5d4c8c3e629945a497719baa5d3a2d9c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d4c8c3e629945a497719baa5d3a2d9c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d4c8c3e629945a497719baa5d3a2d9c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5d4c8c3e629945a497719baa5d3a2d9c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d4c8c3e629945a497719baa5d3a2d9c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d4c8c3e629945a497719baa5d3a2d9c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id684c7b4127754325bea788c0ad24a9f3" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id684c7b4127754325bea788c0ad24a9f3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id684c7b4127754325bea788c0ad24a9f3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id684c7b4127754325bea788c0ad24a9f3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id684c7b4127754325bea788c0ad24a9f3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id684c7b4127754325bea788c0ad24a9f3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id684c7b4127754325bea788c0ad24a9f3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id684c7b4127754325bea788c0ad24a9f3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id684c7b4127754325bea788c0ad24a9f3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id684c7b4127754325bea788c0ad24a9f3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id684c7b4127754325bea788c0ad24a9f3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8c50069455624a8db334f505773dd7f1" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8c50069455624a8db334f505773dd7f1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8c50069455624a8db334f505773dd7f1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8c50069455624a8db334f505773dd7f1 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8c50069455624a8db334f505773dd7f1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8c50069455624a8db334f505773dd7f1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8c50069455624a8db334f505773dd7f1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8c50069455624a8db334f505773dd7f1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8c50069455624a8db334f505773dd7f1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8c50069455624a8db334f505773dd7f1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8c50069455624a8db334f505773dd7f1 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc24806442f12423dbc958bb59044e532" class="column-layout-container,no-border  ">
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_CL" for="ctl00_cntMainBody_COVER__IS_CL" class="col-md-4 col-sm-3 control-label">
		Charterers Liability</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="COVER" 
		data-property-name="IS_CL" 
		id="pb-container-checkbox-COVER-IS_CL">	
		
		<asp:TextBox ID="COVER__IS_CL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_CL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Charterers Liability"
			ClientValidationFunction="onValidate_COVER__IS_CL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_CLL" for="ctl00_cntMainBody_COVER__IS_CLL" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-COVER-IS_CLL">	
		
		<asp:TextBox ID="COVER__IS_CLL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_CLL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Carriers Legal Liability"
			ClientValidationFunction="onValidate_COVER__IS_CLL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_CONL" for="ctl00_cntMainBody_COVER__IS_CONL" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-COVER-IS_CONL">	
		
		<asp:TextBox ID="COVER__IS_CONL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_CONL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Containers Liability"
			ClientValidationFunction="onValidate_COVER__IS_CONL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_MOL" for="ctl00_cntMainBody_COVER__IS_MOL" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-COVER-IS_MOL">	
		
		<asp:TextBox ID="COVER__IS_MOL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_MOL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Marine Operators Liability"
			ClientValidationFunction="onValidate_COVER__IS_MOL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_SRL" for="ctl00_cntMainBody_COVER__IS_SRL" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-COVER-IS_SRL">	
		
		<asp:TextBox ID="COVER__IS_SRL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_SRL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Ship Repairers Liability"
			ClientValidationFunction="onValidate_COVER__IS_SRL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_SBL" for="ctl00_cntMainBody_COVER__IS_SBL" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-COVER-IS_SBL">	
		
		<asp:TextBox ID="COVER__IS_SBL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_SBL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Ship Builders Liability"
			ClientValidationFunction="onValidate_COVER__IS_SBL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_SL" for="ctl00_cntMainBody_COVER__IS_SL" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-COVER-IS_SL">	
		
		<asp:TextBox ID="COVER__IS_SL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_SL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Stevedore's Liability"
			ClientValidationFunction="onValidate_COVER__IS_SL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_PRL" for="ctl00_cntMainBody_COVER__IS_PRL" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-COVER-IS_PRL">	
		
		<asp:TextBox ID="COVER__IS_PRL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_PRL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Port Risks Liability"
			ClientValidationFunction="onValidate_COVER__IS_PRL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVER_IS_FFL" for="ctl00_cntMainBody_COVER__IS_FFL" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-COVER-IS_FFL">	
		
		<asp:TextBox ID="COVER__IS_FFL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVER_IS_FFL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Freight Forwarders Liability"
			ClientValidationFunction="onValidate_COVER__IS_FFL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc24806442f12423dbc958bb59044e532 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc24806442f12423dbc958bb59044e532 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc24806442f12423dbc958bb59044e532 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc24806442f12423dbc958bb59044e532 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc24806442f12423dbc958bb59044e532 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc24806442f12423dbc958bb59044e532 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc24806442f12423dbc958bb59044e532 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc24806442f12423dbc958bb59044e532 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc24806442f12423dbc958bb59044e532 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc24806442f12423dbc958bb59044e532 input{text-align:left;}"; break;
		}
	}
