<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PRLDEDED_Port_Risk_Liability.aspx.vb" Inherits="Nexus.PB2_PRLDEDED_Port_Risk_Liability" %>
...
function onValidate_PRLDEDUCT__PRLDDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLDEDUCT", "PRLDDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLDEDUCT_PRLDDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLDEDUCT__PRLDDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLDEDUCT__PRLDDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLDEDUCT", "PRLDDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRLDEDUCT", "PRLDDES");
...
function onValidate_PRLDEDUCT__PRLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLDEDUCT", "PRLP", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLDEDUCT", "PRLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLDEDUCT_PRLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLDEDUCT__PRLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLDEDUCT__PRLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRLDEDUCT", "PRLP");
...
function onValidate_PRLDEDUCT__PRLMIN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLDEDUCT", "PRLMIN", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLDEDUCT_PRLMIN");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLDEDUCT__PRLMIN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLDEDUCT__PRLMIN_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLDEDUCT", "PRLMIN");
        		}
...
function onValidate_PRLDEDUCT__PRLMAX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLDEDUCT", "PRLMAX", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLDEDUCT_PRLMAX");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLDEDUCT__PRLMAX');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLDEDUCT__PRLMAX_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLDEDUCT", "PRLMAX");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_PRLDEDUCT__PRLBOE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLDEDUCT", "PRLBOE", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLDEDUCT_PRLBOE");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLDEDUCT__PRLBOE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLDEDUCT__PRLBOE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLDEDUCT", "PRLBOE");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRLDEDUCT", "PRLBOE");
...
function DoLogic(isOnLoad) {
    onValidate_PRLDEDUCT__PRLDDES(null, null, null, isOnLoad);
    onValidate_PRLDEDUCT__PRLP(null, null, null, isOnLoad);
    onValidate_PRLDEDUCT__PRLMIN(null, null, null, isOnLoad);
    onValidate_PRLDEDUCT__PRLMAX(null, null, null, isOnLoad);
    onValidate_PRLDEDUCT__PRLBOE(null, null, null, isOnLoad);
}
</script>
...
<div id="id911c7821ee934e838b77ca5446d58fed" class="general-layout-container">
...
<div id="idb27b346313c840db8508ed500bb8a566" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-property-name="PRLDDES" 
		 
		
		 
		id="pb-container-text-PRLDEDUCT-PRLDDES">

		
		<asp:Label ID="lblPRLDEDUCT_PRLDDES" runat="server" AssociatedControlID="PRLDEDUCT__PRLDDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PRLDEDUCT__PRLDDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPRLDEDUCT_PRLDDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_PRLDEDUCT__PRLDDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-PRLDEDUCT-PRLP">
		<asp:Label ID="lblPRLDEDUCT_PRLP" runat="server" AssociatedControlID="PRLDEDUCT__PRLP" 
			Text="Deductible %" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PRLDEDUCT__PRLP" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPRLDEDUCT_PRLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible %"
			ClientValidationFunction="onValidate_PRLDEDUCT__PRLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="PRLDEDUCT" 
		data-property-name="PRLMIN" 
		id="pb-container-currency-PRLDEDUCT-PRLMIN">
		<asp:Label ID="lblPRLDEDUCT_PRLMIN" runat="server" AssociatedControlID="PRLDEDUCT__PRLMIN" 
			Text="Deductible Min Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLDEDUCT__PRLMIN" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLDEDUCT_PRLMIN" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible Min Amount"
			ClientValidationFunction="onValidate_PRLDEDUCT__PRLMIN" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="PRLDEDUCT" 
		data-property-name="PRLMAX" 
		id="pb-container-currency-PRLDEDUCT-PRLMAX">
		<asp:Label ID="lblPRLDEDUCT_PRLMAX" runat="server" AssociatedControlID="PRLDEDUCT__PRLMAX" 
			Text="Deductible Max Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLDEDUCT__PRLMAX" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLDEDUCT_PRLMAX" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Deductible Max Amount"
			ClientValidationFunction="onValidate_PRLDEDUCT__PRLMAX" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="PRLDEDUCT" 
		data-property-name="PRLBOE" 
		id="pb-container-currency-PRLDEDUCT-PRLBOE">
		<asp:Label ID="lblPRLDEDUCT_PRLBOE" runat="server" AssociatedControlID="PRLDEDUCT__PRLBOE" 
			Text="Basis of Deductible" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLDEDUCT__PRLBOE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLDEDUCT_PRLBOE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Basis of Deductible"
			ClientValidationFunction="onValidate_PRLDEDUCT__PRLBOE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb27b346313c840db8508ed500bb8a566 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb27b346313c840db8508ed500bb8a566 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb27b346313c840db8508ed500bb8a566 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb27b346313c840db8508ed500bb8a566 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb27b346313c840db8508ed500bb8a566 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb27b346313c840db8508ed500bb8a566 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb27b346313c840db8508ed500bb8a566 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb27b346313c840db8508ed500bb8a566 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb27b346313c840db8508ed500bb8a566 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb27b346313c840db8508ed500bb8a566 input{text-align:left;}"; break;
		}
	}
