<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SRLEXT_Charterers_Liability.aspx.vb" Inherits="Nexus.PB2_SRLEXT_Charterers_Liability" %>
...
function onValidate_SRLEXTS__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLEXTS", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SRLEXTS.CLDES");
        			window.setControlWidth(field, "0.8", "SRLEXTS", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLEXTS_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLEXTS__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLEXTS__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLEXTS", "CLDES");
        		}
...
function onValidate_SRLEXTS__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLEXTS", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SRLEXTS.CLLOI");
        			window.setControlWidth(field, "0.8", "SRLEXTS", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLEXTS", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLEXTS_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLEXTS__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLEXTS__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_SRLEXTS__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLEXTS", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SRLEXTS.CLR");
        			window.setControlWidth(field, "0.8", "SRLEXTS", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLEXTS_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLEXTS__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLEXTS__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLEXTS", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_SRLEXTS__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLEXTS", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SRLEXTS.CLP");
        			window.setControlWidth(field, "0.8", "SRLEXTS", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLEXTS_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLEXTS__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLEXTS__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLEXTS", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_SRLEXTS__CLDES(null, null, null, isOnLoad);
    onValidate_SRLEXTS__CLLOI(null, null, null, isOnLoad);
    onValidate_SRLEXTS__CLR(null, null, null, isOnLoad);
    onValidate_SRLEXTS__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idb26de6a3ce884de39023a93e1712758a" class="general-layout-container">
...
<div id="idefe84f24e0b14b4693e143da80553a43" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SRLEXTS" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-SRLEXTS-CLDES">

		
		<asp:Label ID="lblSRLEXTS_CLDES" runat="server" AssociatedControlID="SRLEXTS__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SRLEXTS__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSRLEXTS_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SRLEXTS__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SRLEXTS-CLLOI">
		<asp:Label ID="lblSRLEXTS_CLLOI" runat="server" AssociatedControlID="SRLEXTS__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLEXTS__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLEXTS_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SRLEXTS__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SRLEXTS-CLR">
		<asp:Label ID="lblSRLEXTS_CLR" runat="server" AssociatedControlID="SRLEXTS__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SRLEXTS__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSRLEXTS_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SRLEXTS__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SRLEXTS-CLP">
		<asp:Label ID="lblSRLEXTS_CLP" runat="server" AssociatedControlID="SRLEXTS__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLEXTS__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLEXTS_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SRLEXTS__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idefe84f24e0b14b4693e143da80553a43 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idefe84f24e0b14b4693e143da80553a43 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idefe84f24e0b14b4693e143da80553a43 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idefe84f24e0b14b4693e143da80553a43 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idefe84f24e0b14b4693e143da80553a43 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idefe84f24e0b14b4693e143da80553a43 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idefe84f24e0b14b4693e143da80553a43 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idefe84f24e0b14b4693e143da80553a43 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idefe84f24e0b14b4693e143da80553a43 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idefe84f24e0b14b4693e143da80553a43 input{text-align:left;}"; break;
		}
	}
