<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SRLEXT_Ship_Repairers_Liability.aspx.vb" Inherits="Nexus.PB2_SRLEXT_Ship_Repairers_Liability" %>
...
function onValidate_SRLEXT__SRLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLEXT", "SRLDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLEXT_SRLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLEXT__SRLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLEXT__SRLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLEXT", "SRLDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRLEXT", "SRLDES");
...
function onValidate_SRLEXT__SRLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLEXT", "SRLLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLEXT", "SRLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLEXT_SRLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLEXT__SRLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLEXT__SRLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRLEXT", "SRLLOI");
...
function onValidate_SRLEXT__SRLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLEXT", "SRLR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLEXT_SRLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLEXT__SRLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLEXT__SRLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLEXT", "SRLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRLEXT", "SRLR");
...
function onValidate_SRLEXT__SRLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SRLEXT", "SRLP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSRLEXT_SRLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SRLEXT__SRLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SRLEXT__SRLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SRLEXT", "SRLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SRLEXT", "SRLP");
...
function DoLogic(isOnLoad) {
    onValidate_SRLEXT__SRLDES(null, null, null, isOnLoad);
    onValidate_SRLEXT__SRLLOI(null, null, null, isOnLoad);
    onValidate_SRLEXT__SRLR(null, null, null, isOnLoad);
    onValidate_SRLEXT__SRLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id6a9ccb74915745d1bfe5b23c9f457235" class="general-layout-container">
...
<div id="idcc7798ffb7a141db83a756b90f5b503c" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SRLEXT" 
		data-property-name="SRLDES" 
		 
		
		 
		id="pb-container-text-SRLEXT-SRLDES">

		
		<asp:Label ID="lblSRLEXT_SRLDES" runat="server" AssociatedControlID="SRLEXT__SRLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SRLEXT__SRLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSRLEXT_SRLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SRLEXT__SRLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SRLEXT-SRLLOI">
		<asp:Label ID="lblSRLEXT_SRLLOI" runat="server" AssociatedControlID="SRLEXT__SRLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLEXT__SRLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLEXT_SRLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SRLEXT__SRLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SRLEXT-SRLR">
		<asp:Label ID="lblSRLEXT_SRLR" runat="server" AssociatedControlID="SRLEXT__SRLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SRLEXT__SRLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSRLEXT_SRLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SRLEXT__SRLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SRLEXT-SRLP">
		<asp:Label ID="lblSRLEXT_SRLP" runat="server" AssociatedControlID="SRLEXT__SRLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SRLEXT__SRLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSRLEXT_SRLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SRLEXT__SRLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idcc7798ffb7a141db83a756b90f5b503c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcc7798ffb7a141db83a756b90f5b503c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcc7798ffb7a141db83a756b90f5b503c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idcc7798ffb7a141db83a756b90f5b503c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcc7798ffb7a141db83a756b90f5b503c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcc7798ffb7a141db83a756b90f5b503c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcc7798ffb7a141db83a756b90f5b503c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcc7798ffb7a141db83a756b90f5b503c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcc7798ffb7a141db83a756b90f5b503c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcc7798ffb7a141db83a756b90f5b503c input{text-align:left;}"; break;
		}
	}
