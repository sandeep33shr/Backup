<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLLNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_CLLNOTE_Note_Details" %>
...
<div id="id9a4a4cbf3a6c4ac6949c7d7ae5fdba78" class="general-layout-container">
...
<div id="id8f0a12944f664ad8957d8e6bd1ee3dfb" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8f0a12944f664ad8957d8e6bd1ee3dfb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8f0a12944f664ad8957d8e6bd1ee3dfb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8f0a12944f664ad8957d8e6bd1ee3dfb div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8f0a12944f664ad8957d8e6bd1ee3dfb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8f0a12944f664ad8957d8e6bd1ee3dfb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8f0a12944f664ad8957d8e6bd1ee3dfb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8f0a12944f664ad8957d8e6bd1ee3dfb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8f0a12944f664ad8957d8e6bd1ee3dfb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8f0a12944f664ad8957d8e6bd1ee3dfb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8f0a12944f664ad8957d8e6bd1ee3dfb input{text-align:left;}"; break;
		}
	}
