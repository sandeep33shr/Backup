<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SLEXT_Stevedore's_Liability.aspx.vb" Inherits="Nexus.PB2_SLEXT_Stevedore's_Liability" %>
...
function onValidate_SLEXT__SLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SLEXT", "SLDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSLEXT_SLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_SLEXT__SLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SLEXT__SLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SLEXT", "SLDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SLEXT", "SLDES");
...
function onValidate_SLEXT__SLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SLEXT", "SLLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SLEXT", "SLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSLEXT_SLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_SLEXT__SLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SLEXT__SLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SLEXT", "SLLOI");
...
function onValidate_SLEXT__SLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SLEXT", "SLR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSLEXT_SLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_SLEXT__SLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SLEXT__SLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SLEXT", "SLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SLEXT", "SLR");
...
function onValidate_SLEXT__SLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SLEXT", "SLP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSLEXT_SLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_SLEXT__SLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SLEXT__SLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SLEXT", "SLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("SLEXT", "SLP");
...
function DoLogic(isOnLoad) {
    onValidate_SLEXT__SLDES(null, null, null, isOnLoad);
    onValidate_SLEXT__SLLOI(null, null, null, isOnLoad);
    onValidate_SLEXT__SLR(null, null, null, isOnLoad);
    onValidate_SLEXT__SLP(null, null, null, isOnLoad);
}
</script>
...
<div id="idd16dc8cd07044691a03194dd103854c0" class="general-layout-container">
...
<div id="id8d39d20f77274a3f9a50a704ccb04c37" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SLEXT" 
		data-property-name="SLDES" 
		 
		
		 
		id="pb-container-text-SLEXT-SLDES">

		
		<asp:Label ID="lblSLEXT_SLDES" runat="server" AssociatedControlID="SLEXT__SLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SLEXT__SLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSLEXT_SLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_SLEXT__SLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SLEXT-SLLOI">
		<asp:Label ID="lblSLEXT_SLLOI" runat="server" AssociatedControlID="SLEXT__SLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SLEXT__SLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSLEXT_SLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_SLEXT__SLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-SLEXT-SLR">
		<asp:Label ID="lblSLEXT_SLR" runat="server" AssociatedControlID="SLEXT__SLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SLEXT__SLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSLEXT_SLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_SLEXT__SLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-SLEXT-SLP">
		<asp:Label ID="lblSLEXT_SLP" runat="server" AssociatedControlID="SLEXT__SLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SLEXT__SLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSLEXT_SLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_SLEXT__SLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8d39d20f77274a3f9a50a704ccb04c37 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8d39d20f77274a3f9a50a704ccb04c37 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8d39d20f77274a3f9a50a704ccb04c37 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8d39d20f77274a3f9a50a704ccb04c37 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8d39d20f77274a3f9a50a704ccb04c37 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8d39d20f77274a3f9a50a704ccb04c37 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8d39d20f77274a3f9a50a704ccb04c37 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8d39d20f77274a3f9a50a704ccb04c37 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8d39d20f77274a3f9a50a704ccb04c37 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8d39d20f77274a3f9a50a704ccb04c37 input{text-align:left;}"; break;
		}
	}
