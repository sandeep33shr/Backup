<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="STVEXT_Charterers_Liability.aspx.vb" Inherits="Nexus.PB2_STVEXT_Charterers_Liability" %>
...
function onValidate_STVLEXTS__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STVLEXTS", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("STVLEXTS.CLDES");
        			window.setControlWidth(field, "0.8", "STVLEXTS", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSTVLEXTS_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_STVLEXTS__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_STVLEXTS__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("STVLEXTS", "CLDES");
        		}
...
function onValidate_STVLEXTS__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STVLEXTS", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("STVLEXTS.CLLOI");
        			window.setControlWidth(field, "0.8", "STVLEXTS", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("STVLEXTS", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSTVLEXTS_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_STVLEXTS__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_STVLEXTS__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_STVLEXTS__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STVLEXTS", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("STVLEXTS.CLR");
        			window.setControlWidth(field, "0.8", "STVLEXTS", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSTVLEXTS_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_STVLEXTS__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_STVLEXTS__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("STVLEXTS", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_STVLEXTS__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STVLEXTS", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("STVLEXTS.CLP");
        			window.setControlWidth(field, "0.8", "STVLEXTS", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSTVLEXTS_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_STVLEXTS__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_STVLEXTS__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("STVLEXTS", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_STVLEXTS__CLDES(null, null, null, isOnLoad);
    onValidate_STVLEXTS__CLLOI(null, null, null, isOnLoad);
    onValidate_STVLEXTS__CLR(null, null, null, isOnLoad);
    onValidate_STVLEXTS__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id629e3749131a4cdb884d0e16fce7874f" class="general-layout-container">
...
<div id="idf78faab739b04c28b7dff7458e95bec7" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading82" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="STVLEXTS" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-STVLEXTS-CLDES">

		
		<asp:Label ID="lblSTVLEXTS_CLDES" runat="server" AssociatedControlID="STVLEXTS__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="STVLEXTS__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSTVLEXTS_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_STVLEXTS__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-STVLEXTS-CLLOI">
		<asp:Label ID="lblSTVLEXTS_CLLOI" runat="server" AssociatedControlID="STVLEXTS__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="STVLEXTS__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSTVLEXTS_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_STVLEXTS__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-STVLEXTS-CLR">
		<asp:Label ID="lblSTVLEXTS_CLR" runat="server" AssociatedControlID="STVLEXTS__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="STVLEXTS__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSTVLEXTS_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_STVLEXTS__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-STVLEXTS-CLP">
		<asp:Label ID="lblSTVLEXTS_CLP" runat="server" AssociatedControlID="STVLEXTS__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="STVLEXTS__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSTVLEXTS_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_STVLEXTS__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf78faab739b04c28b7dff7458e95bec7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf78faab739b04c28b7dff7458e95bec7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf78faab739b04c28b7dff7458e95bec7 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf78faab739b04c28b7dff7458e95bec7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf78faab739b04c28b7dff7458e95bec7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf78faab739b04c28b7dff7458e95bec7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf78faab739b04c28b7dff7458e95bec7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf78faab739b04c28b7dff7458e95bec7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf78faab739b04c28b7dff7458e95bec7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf78faab739b04c28b7dff7458e95bec7 input{text-align:left;}"; break;
		}
	}
