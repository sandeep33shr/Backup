<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PRLEXT_Charterers_Liability.aspx.vb" Inherits="Nexus.PB2_PRLEXT_Charterers_Liability" %>
...
function onValidate_PRLEXTS__CLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLEXTS", "CLDES", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PRLEXTS.CLDES");
        			window.setControlWidth(field, "0.8", "PRLEXTS", "CLDES");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLEXTS_CLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLEXTS__CLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLEXTS__CLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLEXTS", "CLDES");
        		}
...
function onValidate_PRLEXTS__CLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLEXTS", "CLLOI", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PRLEXTS.CLLOI");
        			window.setControlWidth(field, "0.8", "PRLEXTS", "CLLOI");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLEXTS", "CLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLEXTS_CLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLEXTS__CLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLEXTS__CLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_PRLEXTS__CLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLEXTS", "CLR", "Percentage");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PRLEXTS.CLR");
        			window.setControlWidth(field, "0.8", "PRLEXTS", "CLR");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLEXTS_CLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLEXTS__CLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLEXTS__CLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLEXTS", "CLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_PRLEXTS__CLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLEXTS", "CLP", "Currency");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PRLEXTS.CLP");
        			window.setControlWidth(field, "0.8", "PRLEXTS", "CLP");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLEXTS_CLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLEXTS__CLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLEXTS__CLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLEXTS", "CLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function DoLogic(isOnLoad) {
    onValidate_PRLEXTS__CLDES(null, null, null, isOnLoad);
    onValidate_PRLEXTS__CLLOI(null, null, null, isOnLoad);
    onValidate_PRLEXTS__CLR(null, null, null, isOnLoad);
    onValidate_PRLEXTS__CLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id1987be30027b44b5952858edfaa50f61" class="general-layout-container">
...
<div id="id6ed7d5b307304d3fb4806b8037fa987e" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PRLEXTS" 
		data-property-name="CLDES" 
		 
		
		 
		id="pb-container-text-PRLEXTS-CLDES">

		
		<asp:Label ID="lblPRLEXTS_CLDES" runat="server" AssociatedControlID="PRLEXTS__CLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PRLEXTS__CLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPRLEXTS_CLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_PRLEXTS__CLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PRLEXTS-CLLOI">
		<asp:Label ID="lblPRLEXTS_CLLOI" runat="server" AssociatedControlID="PRLEXTS__CLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLEXTS__CLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLEXTS_CLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_PRLEXTS__CLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-PRLEXTS-CLR">
		<asp:Label ID="lblPRLEXTS_CLR" runat="server" AssociatedControlID="PRLEXTS__CLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PRLEXTS__CLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPRLEXTS_CLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_PRLEXTS__CLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PRLEXTS-CLP">
		<asp:Label ID="lblPRLEXTS_CLP" runat="server" AssociatedControlID="PRLEXTS__CLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLEXTS__CLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLEXTS_CLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PRLEXTS__CLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6ed7d5b307304d3fb4806b8037fa987e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6ed7d5b307304d3fb4806b8037fa987e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6ed7d5b307304d3fb4806b8037fa987e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6ed7d5b307304d3fb4806b8037fa987e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6ed7d5b307304d3fb4806b8037fa987e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6ed7d5b307304d3fb4806b8037fa987e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6ed7d5b307304d3fb4806b8037fa987e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6ed7d5b307304d3fb4806b8037fa987e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6ed7d5b307304d3fb4806b8037fa987e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6ed7d5b307304d3fb4806b8037fa987e input{text-align:left;}"; break;
		}
	}
