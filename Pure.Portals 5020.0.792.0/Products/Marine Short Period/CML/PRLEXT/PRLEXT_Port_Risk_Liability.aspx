<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PRLEXT_Port_Risk_Liability.aspx.vb" Inherits="Nexus.PB2_PRLEXT_Port_Risk_Liability" %>
...
function onValidate_PRLEXT__PRLDES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLEXT", "PRLDES", "Text");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLEXT_PRLDES");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLEXT__PRLDES');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLEXT__PRLDES_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLEXT", "PRLDES");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRLEXT", "PRLDES");
...
function onValidate_PRLEXT__PRLLOI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLEXT", "PRLLOI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLEXT", "PRLLOI");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLEXT_PRLLOI");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLEXT__PRLLOI');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLEXT__PRLLOI_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRLEXT", "PRLLOI");
...
function onValidate_PRLEXT__PRLR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLEXT", "PRLR", "Percentage");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLEXT_PRLR");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLEXT__PRLR');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLEXT__PRLR_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLEXT", "PRLR");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRLEXT", "PRLR");
...
function onValidate_PRLEXT__PRLP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PRLEXT", "PRLP", "Currency");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPRLEXT_PRLP");
        			    var ele = document.getElementById('ctl00_cntMainBody_PRLEXT__PRLP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PRLEXT__PRLP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PRLEXT", "PRLP");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var field = Field.getInstance("PRLEXT", "PRLP");
...
function DoLogic(isOnLoad) {
    onValidate_PRLEXT__PRLDES(null, null, null, isOnLoad);
    onValidate_PRLEXT__PRLLOI(null, null, null, isOnLoad);
    onValidate_PRLEXT__PRLR(null, null, null, isOnLoad);
    onValidate_PRLEXT__PRLP(null, null, null, isOnLoad);
}
</script>
...
<div id="id0cb37402ebba4e25a4665238ac90ea9f" class="general-layout-container">
...
<div id="id3875c4bd578b421785752a539dcb3c09" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PRLEXT" 
		data-property-name="PRLDES" 
		 
		
		 
		id="pb-container-text-PRLEXT-PRLDES">

		
		<asp:Label ID="lblPRLEXT_PRLDES" runat="server" AssociatedControlID="PRLEXT__PRLDES" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PRLEXT__PRLDES" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPRLEXT_PRLDES" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Description"
					ClientValidationFunction="onValidate_PRLEXT__PRLDES"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PRLEXT-PRLLOI">
		<asp:Label ID="lblPRLEXT_PRLLOI" runat="server" AssociatedControlID="PRLEXT__PRLLOI" 
			Text="Limit Of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLEXT__PRLLOI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLEXT_PRLLOI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit Of Indemnity"
			ClientValidationFunction="onValidate_PRLEXT__PRLLOI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-PRLEXT-PRLR">
		<asp:Label ID="lblPRLEXT_PRLR" runat="server" AssociatedControlID="PRLEXT__PRLR" 
			Text="Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="PRLEXT__PRLR" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valPRLEXT_PRLR" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rate"
			ClientValidationFunction="onValidate_PRLEXT__PRLR" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PRLEXT-PRLP">
		<asp:Label ID="lblPRLEXT_PRLP" runat="server" AssociatedControlID="PRLEXT__PRLP" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PRLEXT__PRLP" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPRLEXT_PRLP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PRLEXT__PRLP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3875c4bd578b421785752a539dcb3c09 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3875c4bd578b421785752a539dcb3c09 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3875c4bd578b421785752a539dcb3c09 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3875c4bd578b421785752a539dcb3c09 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3875c4bd578b421785752a539dcb3c09 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3875c4bd578b421785752a539dcb3c09 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3875c4bd578b421785752a539dcb3c09 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3875c4bd578b421785752a539dcb3c09 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3875c4bd578b421785752a539dcb3c09 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3875c4bd578b421785752a539dcb3c09 input{text-align:left;}"; break;
		}
	}
