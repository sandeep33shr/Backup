...
Namespace Nexus
    Partial Class PB2_MONPNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_MON_PNOTES_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If MON_PNOTES_DETAILS__Date_Created.Text.ToString = "" Then
        		MON_PNOTES_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		MON_PNOTES_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_MON_PNOTES_DETAILS__NOTE_DETAILS()
End Sub
