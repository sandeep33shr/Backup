<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SLDEDED_Deductibles.aspx.vb" Inherits="Nexus.PB2_SLDEDED_Deductibles" %>
...
<div id="id0c05a2d6bbf64da487426f4f3a4bfd1d" class="general-layout-container">
...
<div id="id01f58ca6811e4a948ad7c4fdcb1d83a9" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id01f58ca6811e4a948ad7c4fdcb1d83a9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id01f58ca6811e4a948ad7c4fdcb1d83a9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id01f58ca6811e4a948ad7c4fdcb1d83a9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id01f58ca6811e4a948ad7c4fdcb1d83a9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id01f58ca6811e4a948ad7c4fdcb1d83a9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id01f58ca6811e4a948ad7c4fdcb1d83a9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id01f58ca6811e4a948ad7c4fdcb1d83a9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id01f58ca6811e4a948ad7c4fdcb1d83a9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id01f58ca6811e4a948ad7c4fdcb1d83a9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id01f58ca6811e4a948ad7c4fdcb1d83a9 input{text-align:left;}"; break;
		}
	}
