<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMPH_Pleasure_Craft.aspx.vb" Inherits="Nexus.PB2_CMPH_Pleasure_Craft" %>
...
function onValidate_PC_VESSELS__VRAFT_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "VRAFT_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
...
function onValidate_PC_VESSELS__TVMOTOR(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "TVMOTOR", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function onValidate_PC_VESSELS__TYPE_USE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "TYPE_USE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function onValidate_PC_VESSELS__VUSE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PC_VESSELS", "VUSE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
...
function onValidate_MPC_VESSELS__SUMINSURED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPC_VESSELS", "SUMINSURED", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MPC_VESSELS", "SUMINSURED");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MPC_VESSELS.SUMINSURED");
        			window.setControlWidth(field, "0.8", "MPC_VESSELS", "SUMINSURED");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMPC_VESSELS_SUMINSURED");
        			    var ele = document.getElementById('ctl00_cntMainBody_MPC_VESSELS__SUMINSURED');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MPC_VESSELS__SUMINSURED_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MPC_VESSELS__RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPC_VESSELS", "RATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MPC_VESSELS", "RATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MPC_VESSELS.RATE");
        			window.setControlWidth(field, "0.8", "MPC_VESSELS", "RATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMPC_VESSELS_RATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_MPC_VESSELS__RATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MPC_VESSELS__RATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "MPC_VESSELS".toUpperCase() + "__" + "RATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "MPC_VESSELS".toUpperCase() + "_" + "RATE");
        				}
        				if (node != null){
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=MPC_VESSELS&propertyName=RATE&name={name}");
...
function onValidate_MPC_VESSELS__PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPC_VESSELS", "PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MPC_VESSELS", "PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MPC_VESSELS.PREM");
        			window.setControlWidth(field, "0.8", "MPC_VESSELS", "PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMPC_VESSELS_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MPC_VESSELS__PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MPC_VESSELS__PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MPC_VESSELS&propertyName=PREM&name={name}");
...
function onValidate_MPC_VESSELS__POST_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPC_VESSELS", "POST_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MPC_VESSELS", "POST_PREM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MPC_VESSELS.POST_PREM");
        			window.setControlWidth(field, "0.8", "MPC_VESSELS", "POST_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMPC_VESSELS_POST_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MPC_VESSELS__POST_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MPC_VESSELS__POST_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MPC_VESSELS&propertyName=POST_PREM&name={name}");
...
function onValidate_MPC_VESSELS__FAP_PERC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPC_VESSELS", "FAP_PERC", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MPC_VESSELS", "FAP_PERC");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MPC_VESSELS.FAP_PERC");
        			window.setControlWidth(field, "0.8", "MPC_VESSELS", "FAP_PERC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMPC_VESSELS_FAP_PERC");
        			    var ele = document.getElementById('ctl00_cntMainBody_MPC_VESSELS__FAP_PERC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MPC_VESSELS__FAP_PERC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "MPC_VESSELS".toUpperCase() + "__" + "FAP_PERC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "MPC_VESSELS".toUpperCase() + "_" + "FAP_PERC");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Percentage&objectName=MPC_VESSELS&propertyName=FAP_PERC&name={name}");
...
function onValidate_MPC_VESSELS__MIN_AMNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPC_VESSELS", "MIN_AMNT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MPC_VESSELS", "MIN_AMNT");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MPC_VESSELS.MIN_AMNT");
        			window.setControlWidth(field, "0.8", "MPC_VESSELS", "MIN_AMNT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMPC_VESSELS_MIN_AMNT");
        			    var ele = document.getElementById('ctl00_cntMainBody_MPC_VESSELS__MIN_AMNT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MPC_VESSELS__MIN_AMNT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=MPC_VESSELS&propertyName=MIN_AMNT&name={name}");
...
function onValidate_PCEX_VESSELS__IS_NASRIA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PCEX_VESSELS", "IS_NASRIA", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PCEX_VESSELS", "IS_NASRIA");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_PCEX_VESSELS__NASRIA_LIMIT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PCEX_VESSELS", "NASRIA_LIMIT", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("PCEX_VESSELS", "NASRIA_LIMIT");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PCEX_VESSELS.NASRIA_LIMIT");
        			window.setControlWidth(field, "0.4", "PCEX_VESSELS", "NASRIA_LIMIT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPCEX_VESSELS_NASRIA_LIMIT");
        			    var ele = document.getElementById('ctl00_cntMainBody_PCEX_VESSELS__NASRIA_LIMIT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PCEX_VESSELS__NASRIA_LIMIT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=PCEX_VESSELS&propertyName=NASRIA_LIMIT&name={name}");
...
function onValidate_IPPC_VESSELS__INTPARTY_NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "IPPC_VESSELS", "INTPARTY_NAME", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("IPPC_VESSELS", "INTPARTY_NAME");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("IPPC_VESSELS.INTPARTY_NAME");
        			window.setControlWidth(field, "0.8", "IPPC_VESSELS", "INTPARTY_NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblIPPC_VESSELS_INTPARTY_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_IPPC_VESSELS__INTPARTY_NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_IPPC_VESSELS__INTPARTY_NAME_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_IPPC_VESSELS__INTPARTY_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "IPPC_VESSELS", "INTPARTY_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("IPPC_VESSELS", "INTPARTY_DATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("IPPC_VESSELS.INTPARTY_DATE");
        			window.setControlWidth(field, "0.3", "IPPC_VESSELS", "INTPARTY_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblIPPC_VESSELS_INTPARTY_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_IPPC_VESSELS__INTPARTY_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_IPPC_VESSELS__INTPARTY_DATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "IPPC_VESSELS".toUpperCase() + "__" + "INTPARTY_DATE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "IPPC_VESSELS".toUpperCase() + "_" + "INTPARTY_DATE");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
...
function onValidate_IPPC_VESSELS__INCEP_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "IPPC_VESSELS", "INCEP_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("IPPC_VESSELS", "INCEP_DATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("IPPC_VESSELS", "INCEP_DATE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MPC_VESSELS__SUMINSURED(null, null, null, isOnLoad);
    onValidate_MPC_VESSELS__RATE(null, null, null, isOnLoad);
    onValidate_MPC_VESSELS__PREM(null, null, null, isOnLoad);
    onValidate_MPC_VESSELS__POST_PREM(null, null, null, isOnLoad);
    onValidate_MPC_VESSELS__FAP_PERC(null, null, null, isOnLoad);
    onValidate_MPC_VESSELS__MIN_AMNT(null, null, null, isOnLoad);
    onValidate_PCEX_VESSELS__IS_NASRIA(null, null, null, isOnLoad);
    onValidate_PCEX_VESSELS__NASRIA_LIMIT(null, null, null, isOnLoad);
    onValidate_IPPC_VESSELS__INTPARTY_NAME(null, null, null, isOnLoad);
    onValidate_IPPC_VESSELS__INTPARTY_DATE(null, null, null, isOnLoad);
    onValidate_IPPC_VESSELS__INCEP_DATE(null, null, null, isOnLoad);
...
<div id="id55fda5c7ba9a4778a2dd6fc36a013c29" class="general-layout-container">
...
<div id="id9c9203fc29994892819cc27c9e039b14" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9c9203fc29994892819cc27c9e039b14 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9c9203fc29994892819cc27c9e039b14 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9c9203fc29994892819cc27c9e039b14 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9c9203fc29994892819cc27c9e039b14 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9c9203fc29994892819cc27c9e039b14 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9c9203fc29994892819cc27c9e039b14 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9c9203fc29994892819cc27c9e039b14 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9c9203fc29994892819cc27c9e039b14 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9c9203fc29994892819cc27c9e039b14 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9c9203fc29994892819cc27c9e039b14 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6c7a1a1a73fd477a950430a2fa67a0a2" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6c7a1a1a73fd477a950430a2fa67a0a2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6c7a1a1a73fd477a950430a2fa67a0a2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6c7a1a1a73fd477a950430a2fa67a0a2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6c7a1a1a73fd477a950430a2fa67a0a2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6c7a1a1a73fd477a950430a2fa67a0a2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c7a1a1a73fd477a950430a2fa67a0a2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c7a1a1a73fd477a950430a2fa67a0a2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6c7a1a1a73fd477a950430a2fa67a0a2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c7a1a1a73fd477a950430a2fa67a0a2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c7a1a1a73fd477a950430a2fa67a0a2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id534b8c36ed7f48d6856ea77949fe731a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id534b8c36ed7f48d6856ea77949fe731a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id534b8c36ed7f48d6856ea77949fe731a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id534b8c36ed7f48d6856ea77949fe731a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id534b8c36ed7f48d6856ea77949fe731a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id534b8c36ed7f48d6856ea77949fe731a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id534b8c36ed7f48d6856ea77949fe731a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id534b8c36ed7f48d6856ea77949fe731a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id534b8c36ed7f48d6856ea77949fe731a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id534b8c36ed7f48d6856ea77949fe731a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id534b8c36ed7f48d6856ea77949fe731a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd561f5f8094c480bb6a2ff0bbecd57a6" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PC_VESSELS-VRAFT_TYPE">
		...
		<asp:Label ID="lblPC_VESSELS_VRAFT_TYPE" runat="server" AssociatedControlID="PC_VESSELS__VRAFT_TYPE" 
			Text="Craft Type " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PC_VESSELS__VRAFT_TYPE" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PC_VESSELS-TVMOTOR">
		...
		<asp:Label ID="lblPC_VESSELS_TVMOTOR" runat="server" AssociatedControlID="PC_VESSELS__TVMOTOR" 
			Text="Type of Motor " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PC_VESSELS__TVMOTOR" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PC_VESSELS-TYPE_USE">
		...
		<asp:Label ID="lblPC_VESSELS_TYPE_USE" runat="server" AssociatedControlID="PC_VESSELS__TYPE_USE" 
			Text="Type of Use" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PC_VESSELS__TYPE_USE" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PC_VESSELS-VUSE">
		...
		<asp:Label ID="lblPC_VESSELS_VUSE" runat="server" AssociatedControlID="PC_VESSELS__VUSE" 
			Text="Use" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PC_VESSELS__VUSE" runat="server" CssClass="form-control" data-type="Text" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd561f5f8094c480bb6a2ff0bbecd57a6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd561f5f8094c480bb6a2ff0bbecd57a6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd561f5f8094c480bb6a2ff0bbecd57a6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd561f5f8094c480bb6a2ff0bbecd57a6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd561f5f8094c480bb6a2ff0bbecd57a6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd561f5f8094c480bb6a2ff0bbecd57a6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd561f5f8094c480bb6a2ff0bbecd57a6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd561f5f8094c480bb6a2ff0bbecd57a6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd561f5f8094c480bb6a2ff0bbecd57a6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd561f5f8094c480bb6a2ff0bbecd57a6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id94616dacf2d0488c9af5371fd6120235" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="MPC_VESSELS" 
		data-property-name="SUMINSURED" 
		id="pb-container-currency-MPC_VESSELS-SUMINSURED">
		<asp:Label ID="lblMPC_VESSELS_SUMINSURED" runat="server" AssociatedControlID="MPC_VESSELS__SUMINSURED" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MPC_VESSELS__SUMINSURED" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMPC_VESSELS_SUMINSURED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MPC_VESSELS.SUMINSURED"
			ClientValidationFunction="onValidate_MPC_VESSELS__SUMINSURED" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-MPC_VESSELS-RATE">
		<asp:Label ID="lblMPC_VESSELS_RATE" runat="server" AssociatedControlID="MPC_VESSELS__RATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MPC_VESSELS__RATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMPC_VESSELS_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MPC_VESSELS.RATE"
			ClientValidationFunction="onValidate_MPC_VESSELS__RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MPC_VESSELS-PREM">
		<asp:Label ID="lblMPC_VESSELS_PREM" runat="server" AssociatedControlID="MPC_VESSELS__PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MPC_VESSELS__PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMPC_VESSELS_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MPC_VESSELS.PREM"
			ClientValidationFunction="onValidate_MPC_VESSELS__PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MPC_VESSELS-POST_PREM">
		<asp:Label ID="lblMPC_VESSELS_POST_PREM" runat="server" AssociatedControlID="MPC_VESSELS__POST_PREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MPC_VESSELS__POST_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMPC_VESSELS_POST_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MPC_VESSELS.POST_PREM"
			ClientValidationFunction="onValidate_MPC_VESSELS__POST_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-MPC_VESSELS-FAP_PERC">
		<asp:Label ID="lblMPC_VESSELS_FAP_PERC" runat="server" AssociatedControlID="MPC_VESSELS__FAP_PERC" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="MPC_VESSELS__FAP_PERC" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valMPC_VESSELS_FAP_PERC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MPC_VESSELS.FAP_PERC"
			ClientValidationFunction="onValidate_MPC_VESSELS__FAP_PERC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MPC_VESSELS-MIN_AMNT">
		<asp:Label ID="lblMPC_VESSELS_MIN_AMNT" runat="server" AssociatedControlID="MPC_VESSELS__MIN_AMNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MPC_VESSELS__MIN_AMNT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMPC_VESSELS_MIN_AMNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MPC_VESSELS.MIN_AMNT"
			ClientValidationFunction="onValidate_MPC_VESSELS__MIN_AMNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id94616dacf2d0488c9af5371fd6120235 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id94616dacf2d0488c9af5371fd6120235 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id94616dacf2d0488c9af5371fd6120235 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id94616dacf2d0488c9af5371fd6120235 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id94616dacf2d0488c9af5371fd6120235 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id94616dacf2d0488c9af5371fd6120235 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id94616dacf2d0488c9af5371fd6120235 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id94616dacf2d0488c9af5371fd6120235 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id94616dacf2d0488c9af5371fd6120235 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id94616dacf2d0488c9af5371fd6120235 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id462c9a3c103145cba6670596630bc3d5" class="column-layout-container,no-border  ">
...
<!-- /Label -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblPCEX_VESSELS_IS_NASRIA" for="ctl00_cntMainBody_PCEX_VESSELS__IS_NASRIA" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="PCEX_VESSELS" 
		data-property-name="IS_NASRIA" 
		id="pb-container-checkbox-PCEX_VESSELS-IS_NASRIA">	
		
		<asp:TextBox ID="PCEX_VESSELS__IS_NASRIA" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valPCEX_VESSELS_IS_NASRIA" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for PCEX_VESSELS.IS_NASRIA"
			ClientValidationFunction="onValidate_PCEX_VESSELS__IS_NASRIA" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PCEX_VESSELS-NASRIA_LIMIT">
		<asp:Label ID="lblPCEX_VESSELS_NASRIA_LIMIT" runat="server" AssociatedControlID="PCEX_VESSELS__NASRIA_LIMIT" 
			Text="Limit of Indemnity" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PCEX_VESSELS__NASRIA_LIMIT" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPCEX_VESSELS_NASRIA_LIMIT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Limit of Indemnity"
			ClientValidationFunction="onValidate_PCEX_VESSELS__NASRIA_LIMIT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id462c9a3c103145cba6670596630bc3d5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id462c9a3c103145cba6670596630bc3d5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id462c9a3c103145cba6670596630bc3d5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id462c9a3c103145cba6670596630bc3d5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id462c9a3c103145cba6670596630bc3d5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id462c9a3c103145cba6670596630bc3d5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id462c9a3c103145cba6670596630bc3d5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id462c9a3c103145cba6670596630bc3d5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id462c9a3c103145cba6670596630bc3d5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id462c9a3c103145cba6670596630bc3d5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id38d6bbb8af3b4b85aced95102579874d" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="IPPC_VESSELS" 
		data-property-name="INTPARTY_NAME" 
		 
		
		 
		id="pb-container-text-IPPC_VESSELS-INTPARTY_NAME">

		
		<asp:Label ID="lblIPPC_VESSELS_INTPARTY_NAME" runat="server" AssociatedControlID="IPPC_VESSELS__INTPARTY_NAME" 
			Text="Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="IPPC_VESSELS__INTPARTY_NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valIPPC_VESSELS_INTPARTY_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Name"
					ClientValidationFunction="onValidate_IPPC_VESSELS__INTPARTY_NAME"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /Text -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-IPPC_VESSELS-INTPARTY_DATE">
		<asp:Label ID="lblIPPC_VESSELS_INTPARTY_DATE" runat="server" AssociatedControlID="IPPC_VESSELS__INTPARTY_DATE" 
			Text="Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="IPPC_VESSELS__INTPARTY_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calIPPC_VESSELS__INTPARTY_DATE" runat="server" LinkedControl="IPPC_VESSELS__INTPARTY_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valIPPC_VESSELS_INTPARTY_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date"
			ClientValidationFunction="onValidate_IPPC_VESSELS__INTPARTY_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-IPPC_VESSELS-INCEP_DATE">
		<asp:Label ID="lblIPPC_VESSELS_INCEP_DATE" runat="server" AssociatedControlID="IPPC_VESSELS__INCEP_DATE" 
			Text="Inception Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="IPPC_VESSELS__INCEP_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calIPPC_VESSELS__INCEP_DATE" runat="server" LinkedControl="IPPC_VESSELS__INCEP_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valIPPC_VESSELS_INCEP_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Inception Date"
			ClientValidationFunction="onValidate_IPPC_VESSELS__INCEP_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id38d6bbb8af3b4b85aced95102579874d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id38d6bbb8af3b4b85aced95102579874d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id38d6bbb8af3b4b85aced95102579874d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id38d6bbb8af3b4b85aced95102579874d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id38d6bbb8af3b4b85aced95102579874d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38d6bbb8af3b4b85aced95102579874d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38d6bbb8af3b4b85aced95102579874d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id38d6bbb8af3b4b85aced95102579874d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38d6bbb8af3b4b85aced95102579874d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38d6bbb8af3b4b85aced95102579874d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idbcad471e5a604d8890b46ddddef9a526" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idbcad471e5a604d8890b46ddddef9a526 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbcad471e5a604d8890b46ddddef9a526 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbcad471e5a604d8890b46ddddef9a526 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idbcad471e5a604d8890b46ddddef9a526 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbcad471e5a604d8890b46ddddef9a526 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbcad471e5a604d8890b46ddddef9a526 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbcad471e5a604d8890b46ddddef9a526 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbcad471e5a604d8890b46ddddef9a526 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbcad471e5a604d8890b46ddddef9a526 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbcad471e5a604d8890b46ddddef9a526 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida3032ad5f8a8467c93c95d00b6d06b54" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida3032ad5f8a8467c93c95d00b6d06b54 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida3032ad5f8a8467c93c95d00b6d06b54 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida3032ad5f8a8467c93c95d00b6d06b54 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida3032ad5f8a8467c93c95d00b6d06b54 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida3032ad5f8a8467c93c95d00b6d06b54 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida3032ad5f8a8467c93c95d00b6d06b54 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida3032ad5f8a8467c93c95d00b6d06b54 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida3032ad5f8a8467c93c95d00b6d06b54 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida3032ad5f8a8467c93c95d00b6d06b54 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida3032ad5f8a8467c93c95d00b6d06b54 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1d3d951d34c14a46900ec142a36bc78d" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id1d3d951d34c14a46900ec142a36bc78d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1d3d951d34c14a46900ec142a36bc78d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1d3d951d34c14a46900ec142a36bc78d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1d3d951d34c14a46900ec142a36bc78d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1d3d951d34c14a46900ec142a36bc78d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1d3d951d34c14a46900ec142a36bc78d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1d3d951d34c14a46900ec142a36bc78d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1d3d951d34c14a46900ec142a36bc78d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1d3d951d34c14a46900ec142a36bc78d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1d3d951d34c14a46900ec142a36bc78d input{text-align:left;}"; break;
		}
	}
