<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMPHMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_CMPHMTA_MTA_Reason_Details" %>
...
<div id="id42fa75642f994f39815ca554d7d77c77" class="general-layout-container">
...
<div id="idf0932a4a6822472baed564fff6a7a515" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf0932a4a6822472baed564fff6a7a515 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf0932a4a6822472baed564fff6a7a515 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf0932a4a6822472baed564fff6a7a515 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf0932a4a6822472baed564fff6a7a515 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf0932a4a6822472baed564fff6a7a515 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf0932a4a6822472baed564fff6a7a515 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf0932a4a6822472baed564fff6a7a515 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf0932a4a6822472baed564fff6a7a515 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf0932a4a6822472baed564fff6a7a515 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf0932a4a6822472baed564fff6a7a515 input{text-align:left;}"; break;
		}
	}
