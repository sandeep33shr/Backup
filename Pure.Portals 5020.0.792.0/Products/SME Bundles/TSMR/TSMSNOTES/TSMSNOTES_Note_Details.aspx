<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TSMSNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_TSMSNOTES_Note_Details" %>
...
function onValidate_TAMSNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMSNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMSNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMSNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "TAMSNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=TAMSNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_TAMSNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMSNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMSNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMSNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "TAMSNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_TAMSNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMSNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMSNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMSNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "TAMSNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=TAMSNOTES&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'SME Bundles'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_TAMSNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMSNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMSNOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMSNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "TAMSNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_TAMSNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMSNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TAMSNOTES", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMSNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "TAMSNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=TAMSNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_TAMSNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_TAMSNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_TAMSNOTES__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMSNOTES", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TAMSNOTES", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_TAMSNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_TAMSNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_TAMSNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_TAMSNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_TAMSNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_TAMSNOTES__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id8e86bc05a6114d759d3e474617743266" class="general-layout-container">
...
<div id="idbec74db5ff6d40ca89f17be2b6ab4ac1" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TAMSNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-TAMSNOTES-DATE_CREATED">
		<asp:Label ID="lblTAMSNOTES_DATE_CREATED" runat="server" AssociatedControlID="TAMSNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TAMSNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTAMSNOTES__DATE_CREATED" runat="server" LinkedControl="TAMSNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTAMSNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_TAMSNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAMSNOTES-CREATED_BY">

		
		<asp:Label ID="lblTAMSNOTES_CREATED_BY" runat="server" AssociatedControlID="TAMSNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAMSNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAMSNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_TAMSNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAMSNOTES-COVER_TYPE">

		
		<asp:Label ID="lblTAMSNOTES_COVER_TYPE" runat="server" AssociatedControlID="TAMSNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAMSNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAMSNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_TAMSNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAMSNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblTAMSNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="TAMSNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAMSNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAMSNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_TAMSNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-TAMSNOTES-NOTE_DETAILS">
		<asp:Label ID="lblTAMSNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="TAMSNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="TAMSNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valTAMSNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_TAMSNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblTAMSNOTES_NoteCheck" for="ctl00_cntMainBody_TAMSNOTES__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-TAMSNOTES-NoteCheck">	
		
		<asp:TextBox ID="TAMSNOTES__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valTAMSNOTES_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_TAMSNOTES__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idbec74db5ff6d40ca89f17be2b6ab4ac1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbec74db5ff6d40ca89f17be2b6ab4ac1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbec74db5ff6d40ca89f17be2b6ab4ac1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idbec74db5ff6d40ca89f17be2b6ab4ac1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbec74db5ff6d40ca89f17be2b6ab4ac1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbec74db5ff6d40ca89f17be2b6ab4ac1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbec74db5ff6d40ca89f17be2b6ab4ac1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbec74db5ff6d40ca89f17be2b6ab4ac1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbec74db5ff6d40ca89f17be2b6ab4ac1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbec74db5ff6d40ca89f17be2b6ab4ac1 input{text-align:left;}"; break;
		}
	}
