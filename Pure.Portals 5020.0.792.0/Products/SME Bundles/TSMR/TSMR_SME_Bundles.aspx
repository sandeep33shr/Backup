<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TSMR_SME_Bundles.aspx.vb" Inherits="Nexus.PB2_TSMR_SME_Bundles" %>
...
function onValidate_TSMR__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR", "RISK_ATTACH_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TSMR", "RISK_ATTACH_DATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMR.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.4", "TSMR", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMR_RISK_ATTACH_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMR__RISK_ATTACH_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMR__RISK_ATTACH_DATE_lblFindParty");
        			    }
        			}
...
function onValidate_TSMR__EFFECTIVEDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR", "EFFECTIVEDATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TSMR", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMR.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.4", "TSMR", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMR_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMR__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMR__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__TSMRMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "TSMRMTA", "ChildScreen");
        })();
}
function onValidate_TSMR__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR", "NAME", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TSMR", "NAME");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMR.NAME");
        			window.setControlWidth(field, "0.8", "TSMR", "NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMR_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMR__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMR__NAME_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_TSMR__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TSMR", "TOT_PREM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMR.TOT_PREM");
        			window.setControlWidth(field, "0.8", "TSMR", "TOT_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMR_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMR__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMR__TOT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_TSMR__TOT_PREM_END(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR", "TOT_PREM_END", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("TSMR", "TOT_PREM_END");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMR.TOT_PREM_END");
        			window.setControlWidth(field, "0.4", "TSMR", "TOT_PREM_END");
        		})();
        	}
        })();
         ...
         /**
          * @fileoverview GetColumn
          * @param TSMR The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "TSMR".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_TSMR__TSMENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR", "TSMENDOS", "ChildScreen");
        })();
}
function onValidate_TSMR__TSMNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR", "TSMNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TSMR", "TSMNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_TSMR__TSMNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TSMR", "TSMNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TSMR' and property 'TSMNOTES'.");
        			error.display();
...
function onValidate_TSMR__TSMSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR", "TSMSNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    ...
    onValidate_TSMR__RISK_ATTACH_DATE(null, null, null, isOnLoad);
    onValidate_TSMR__EFFECTIVEDATE(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__TSMRMTA(null, null, null, isOnLoad);
    onValidate_TSMR__NAME(null, null, null, isOnLoad);
    onValidate_TSMR__TOT_PREM(null, null, null, isOnLoad);
    onValidate_TSMR__TOT_PREM_END(null, null, null, isOnLoad);
    onValidate_TSMR__TSMENDOS(null, null, null, isOnLoad);
    onValidate_TSMR__TSMNOTES(null, null, null, isOnLoad);
    onValidate_TSMR__TSMSNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="idb45d152826694ab988a7f1c451d38dd3" class="general-layout-container">
...
<div id="idc4401320b7a8408c93b5298f0122567b" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc4401320b7a8408c93b5298f0122567b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc4401320b7a8408c93b5298f0122567b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc4401320b7a8408c93b5298f0122567b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc4401320b7a8408c93b5298f0122567b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc4401320b7a8408c93b5298f0122567b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc4401320b7a8408c93b5298f0122567b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc4401320b7a8408c93b5298f0122567b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc4401320b7a8408c93b5298f0122567b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc4401320b7a8408c93b5298f0122567b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc4401320b7a8408c93b5298f0122567b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id85f67927b30e4294802e29d72a5f9f2d" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Date" 
		data-object-name="TSMR" 
		data-property-name="RISK_ATTACH_DATE" 
		id="pb-container-datejquerycompatible-TSMR-RISK_ATTACH_DATE">
		<asp:Label ID="lblTSMR_RISK_ATTACH_DATE" runat="server" AssociatedControlID="TSMR__RISK_ATTACH_DATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TSMR__RISK_ATTACH_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTSMR__RISK_ATTACH_DATE" runat="server" LinkedControl="TSMR__RISK_ATTACH_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTSMR_RISK_ATTACH_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_TSMR__RISK_ATTACH_DATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-TSMR-EFFECTIVEDATE">
		<asp:Label ID="lblTSMR_EFFECTIVEDATE" runat="server" AssociatedControlID="TSMR__EFFECTIVEDATE" 
			Text="Effective Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TSMR__EFFECTIVEDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTSMR__EFFECTIVEDATE" runat="server" LinkedControl="TSMR__EFFECTIVEDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTSMR_EFFECTIVEDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective Date"
			ClientValidationFunction="onValidate_TSMR__EFFECTIVEDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id85f67927b30e4294802e29d72a5f9f2d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id85f67927b30e4294802e29d72a5f9f2d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id85f67927b30e4294802e29d72a5f9f2d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id85f67927b30e4294802e29d72a5f9f2d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id85f67927b30e4294802e29d72a5f9f2d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id85f67927b30e4294802e29d72a5f9f2d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id85f67927b30e4294802e29d72a5f9f2d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id85f67927b30e4294802e29d72a5f9f2d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id85f67927b30e4294802e29d72a5f9f2d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id85f67927b30e4294802e29d72a5f9f2d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb5bde9f8cf4b4a92b39577f55cb52e27" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb5bde9f8cf4b4a92b39577f55cb52e27 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb5bde9f8cf4b4a92b39577f55cb52e27 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb5bde9f8cf4b4a92b39577f55cb52e27 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb5bde9f8cf4b4a92b39577f55cb52e27 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb5bde9f8cf4b4a92b39577f55cb52e27 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb5bde9f8cf4b4a92b39577f55cb52e27 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb5bde9f8cf4b4a92b39577f55cb52e27 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb5bde9f8cf4b4a92b39577f55cb52e27 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb5bde9f8cf4b4a92b39577f55cb52e27 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb5bde9f8cf4b4a92b39577f55cb52e27 input{text-align:left;}"; break;
		}
	}
...
<div id="frmMTAReason" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Mid-Term Adjustment Reason" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__TSMRMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="TSMRMTA" 
		id="pb-container-childscreen-GENERAL-TSMRMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="TSMRMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSMRMTA/TSMRMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_TSMRMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.TSMRMTA"
						ClientValidationFunction="onValidate_GENERAL__TSMRMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ided09fbc8b73e46e4a96716006e0624df" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Risk Details" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-TSMR-NAME">
		<asp:Label ID="lblTSMR_NAME" runat="server" AssociatedControlID="TSMR__NAME" 
			Text="Number of Policy Holders" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="TSMR__NAME" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valTSMR_NAME" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Number of Policy Holders"
			ClientValidationFunction="onValidate_TSMR__NAME" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TSMR-TOT_PREM">
		<asp:Label ID="lblTSMR_TOT_PREM" runat="server" AssociatedControlID="TSMR__TOT_PREM" 
			Text="Total Premium " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TSMR__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTSMR_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium "
			ClientValidationFunction="onValidate_TSMR__TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ided09fbc8b73e46e4a96716006e0624df div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ided09fbc8b73e46e4a96716006e0624df div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ided09fbc8b73e46e4a96716006e0624df div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ided09fbc8b73e46e4a96716006e0624df label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ided09fbc8b73e46e4a96716006e0624df label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided09fbc8b73e46e4a96716006e0624df label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided09fbc8b73e46e4a96716006e0624df label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ided09fbc8b73e46e4a96716006e0624df input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided09fbc8b73e46e4a96716006e0624df input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided09fbc8b73e46e4a96716006e0624df input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb83d4fbd2c9c401198912f2aa459cfef" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblTSMR_REFERRAL_CLAUSES" runat="server" AssociatedControlID="TSMR__REFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="TSMR__REFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TSMR-TOT_PREM_END">
		<asp:Label ID="lblTSMR_TOT_PREM_END" runat="server" AssociatedControlID="TSMR__TOT_PREM_END" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TSMR__TOT_PREM_END" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTSMR_TOT_PREM_END" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_TSMR__TOT_PREM_END" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TSMR__TSMENDOS"
		data-field-type="Child" 
		data-object-name="TSMR" 
		data-property-name="TSMENDOS" 
		id="pb-container-childscreen-TSMR-TSMENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TSMR__TSMR_END" runat="server" ScreenCode="TSMENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSMENDOS/TSMENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valTSMR_TSMENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TSMR.TSMENDOS"
						ClientValidationFunction="onValidate_TSMR__TSMENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb83d4fbd2c9c401198912f2aa459cfef div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb83d4fbd2c9c401198912f2aa459cfef div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb83d4fbd2c9c401198912f2aa459cfef div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb83d4fbd2c9c401198912f2aa459cfef label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb83d4fbd2c9c401198912f2aa459cfef label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb83d4fbd2c9c401198912f2aa459cfef label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb83d4fbd2c9c401198912f2aa459cfef label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb83d4fbd2c9c401198912f2aa459cfef input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb83d4fbd2c9c401198912f2aa459cfef input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb83d4fbd2c9c401198912f2aa459cfef input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2cc73e7a08a54f77b8e309b44da8519d" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TSMR__TSMNOTES"
		data-field-type="Child" 
		data-object-name="TSMR" 
		data-property-name="TSMNOTES" 
		id="pb-container-childscreen-TSMR-TSMNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TSMR__TAMNOTES" runat="server" ScreenCode="TSMNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSMNOTES/TSMNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTSMR_TSMNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TSMR.TSMNOTES"
						ClientValidationFunction="onValidate_TSMR__TSMNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2cc73e7a08a54f77b8e309b44da8519d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2cc73e7a08a54f77b8e309b44da8519d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2cc73e7a08a54f77b8e309b44da8519d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2cc73e7a08a54f77b8e309b44da8519d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2cc73e7a08a54f77b8e309b44da8519d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2cc73e7a08a54f77b8e309b44da8519d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2cc73e7a08a54f77b8e309b44da8519d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2cc73e7a08a54f77b8e309b44da8519d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2cc73e7a08a54f77b8e309b44da8519d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2cc73e7a08a54f77b8e309b44da8519d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id630734a43da14f848df108c19e52b3e7" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TSMR__TSMSNOTES"
		data-field-type="Child" 
		data-object-name="TSMR" 
		data-property-name="TSMSNOTES" 
		id="pb-container-childscreen-TSMR-TSMSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TSMR__TAMSNOTES" runat="server" ScreenCode="TSMSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSMSNOTES/TSMSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTSMR_TSMSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TSMR.TSMSNOTES"
						ClientValidationFunction="onValidate_TSMR__TSMSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id630734a43da14f848df108c19e52b3e7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id630734a43da14f848df108c19e52b3e7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id630734a43da14f848df108c19e52b3e7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id630734a43da14f848df108c19e52b3e7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id630734a43da14f848df108c19e52b3e7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id630734a43da14f848df108c19e52b3e7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id630734a43da14f848df108c19e52b3e7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id630734a43da14f848df108c19e52b3e7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id630734a43da14f848df108c19e52b3e7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id630734a43da14f848df108c19e52b3e7 input{text-align:left;}"; break;
		}
	}
