...
Namespace Nexus
    Partial Class PB2_TSMR_SME_Bundles : Inherits BaseRisk
...
Protected Sub onValidate_GENERAL__TRANSTYPE()
        ...
        End If
End Sub
Protected Sub onValidate_TSMR__RISK_ATTACH_DATE()
        
End Sub
Protected Sub onValidate_TSMR__EFFECTIVEDATE()
...
Protected Sub CallRuleScripts()
    ...
    onValidate_TSMR__RISK_ATTACH_DATE()
    onValidate_TSMR__EFFECTIVEDATE()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If TSMR__RISK_ATTACH_DATE.Text = "" or TSMR__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			TSMR__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			TSMR__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (TSMR__RISK_ATTACH_DATE.Text <> "" Or TSMR__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		TSMR__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		TSMR__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		TSMR__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
