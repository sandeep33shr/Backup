<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TSMENDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_TSMENDOS_Endorsement_Premium" %>
...
function onValidate_TSMR_END__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR_END", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TSMR_END", "ENDORSE_ID");
        		}
...
function onValidate_TSMR_END__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR_END", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TSMR_END", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMR_END.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "TSMR_END", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMR_END_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMR_END__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMR_END__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_TSMR_END__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR_END", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TSMR_END", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=TSMR_END&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(TSMR_END.ENDORSE_DESC)"), 
...
function onValidate_TSMR_END__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMR_END", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TSMR_END", "PREMIUM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMR_END.PREMIUM");
        			window.setControlWidth(field, "0.4", "TSMR_END", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMR_END_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMR_END__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMR_END__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_TSMR_END__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_TSMR_END__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_TSMR_END__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_TSMR_END__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id81a42a865f014a86878bce30caf0c4f8" class="general-layout-container">
...
<div id="ida366693f50a647cf96e76de7a5007aa3" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TSMR_END" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-TSMR_END-ENDORSE_ID">
		<asp:Label ID="lblTSMR_END_ENDORSE_ID" runat="server" AssociatedControlID="TSMR_END__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="TSMR_END__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valTSMR_END_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_TSMR_END__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-TSMR_END-ENDORSE_DESC">
		<asp:Label ID="lblTSMR_END_ENDORSE_DESC" runat="server" AssociatedControlID="TSMR_END__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="TSMR_END__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_TSMR_END__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valTSMR_END_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_TSMR_END__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TSMR_END-ENDORSE_CAP">

		
		<asp:Label ID="lblTSMR_END_ENDORSE_CAP" runat="server" AssociatedControlID="TSMR_END__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TSMR_END__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTSMR_END_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_TSMR_END__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TSMR_END-PREMIUM">
		<asp:Label ID="lblTSMR_END_PREMIUM" runat="server" AssociatedControlID="TSMR_END__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TSMR_END__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTSMR_END_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_TSMR_END__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TSMR_END-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="TSMR_END__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida366693f50a647cf96e76de7a5007aa3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida366693f50a647cf96e76de7a5007aa3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida366693f50a647cf96e76de7a5007aa3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida366693f50a647cf96e76de7a5007aa3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida366693f50a647cf96e76de7a5007aa3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida366693f50a647cf96e76de7a5007aa3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida366693f50a647cf96e76de7a5007aa3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida366693f50a647cf96e76de7a5007aa3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida366693f50a647cf96e76de7a5007aa3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida366693f50a647cf96e76de7a5007aa3 input{text-align:left;}"; break;
		}
	}
