<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="STAMPDUTY_Stamp_Duty.aspx.vb" Inherits="Nexus.PB2_STAMPDUTY_Stamp_Duty" %>
...
function onValidate_STAMPDUTY__IS_MTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STAMPDUTY", "IS_MTA", "Checkbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("STAMPDUTY", "IS_MTA");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_STAMPDUTY__IS_MTA_DELETE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STAMPDUTY", "IS_MTA_DELETE", "Checkbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("STAMPDUTY", "IS_MTA_DELETE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_STAMPDUTY__IS_MTA_ADD(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STAMPDUTY", "IS_MTA_ADD", "Checkbox");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("STAMPDUTY", "IS_MTA_ADD");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_STAMPDUTY__IS_MTA(null, null, null, isOnLoad);
    onValidate_STAMPDUTY__IS_MTA_DELETE(null, null, null, isOnLoad);
    onValidate_STAMPDUTY__IS_MTA_ADD(null, null, null, isOnLoad);
}
</script>
...
<div id="id370957ddfa3249718b2feec2f62faf4e" class="general-layout-container">
...
<div id="frmStampDuty" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading1" runat="server" Text="StampDuty" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblSTAMPDUTY_STAMP_DUTY_SI" runat="server" AssociatedControlID="STAMPDUTY__STAMP_DUTY_SI" 
			Text="Stamp Duty" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		...
		<asp:CustomValidator ID="valSTAMPDUTY_STAMP_DUTY_SI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Stamp Duty"
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSTAMPDUTY_IS_MTA" for="ctl00_cntMainBody_STAMPDUTY__IS_MTA" class="col-md-4 col-sm-3 control-label">
		mta</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="STAMPDUTY" 
		data-property-name="IS_MTA" 
		id="pb-container-checkbox-STAMPDUTY-IS_MTA">	
		
		<asp:TextBox ID="STAMPDUTY__IS_MTA" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSTAMPDUTY_IS_MTA" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for mta"
			ClientValidationFunction="onValidate_STAMPDUTY__IS_MTA" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSTAMPDUTY_IS_MTA_DELETE" for="ctl00_cntMainBody_STAMPDUTY__IS_MTA_DELETE" class="col-md-4 col-sm-3 control-label">
		mta delete</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="STAMPDUTY" 
		data-property-name="IS_MTA_DELETE" 
		id="pb-container-checkbox-STAMPDUTY-IS_MTA_DELETE">	
		
		<asp:TextBox ID="STAMPDUTY__IS_MTA_DELETE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSTAMPDUTY_IS_MTA_DELETE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for mta delete"
			ClientValidationFunction="onValidate_STAMPDUTY__IS_MTA_DELETE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSTAMPDUTY_IS_MTA_ADD" for="ctl00_cntMainBody_STAMPDUTY__IS_MTA_ADD" class="col-md-4 col-sm-3 control-label">
		mta add</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="STAMPDUTY" 
		data-property-name="IS_MTA_ADD" 
		id="pb-container-checkbox-STAMPDUTY-IS_MTA_ADD">	
		
		<asp:TextBox ID="STAMPDUTY__IS_MTA_ADD" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSTAMPDUTY_IS_MTA_ADD" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for mta add"
			ClientValidationFunction="onValidate_STAMPDUTY__IS_MTA_ADD" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	var liFirstEleHeight = 0;
	var liHeight = 0;
	var liMaxHeight = 0;
	$(document).ready(function(){
		$("#frmStampDuty div ul li").each(function(){
		  if (liFirstEleHeight == 0)
		  {
		    liFirstEleHeight = $(this).height();
		  }
		...
		if (liFirstEleHeight != liMaxHeight){ 
			$("#frmStampDuty div ul li").each(function(){
			  $(this).height(liMaxHeight);	  
			});
		}
	});	
