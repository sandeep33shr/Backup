...
Namespace Nexus
    Partial Class PB2_TOPUMOTRSK_Top_Up_Motor : Inherits BaseRisk
...
End Sub
Protected Sub onValidate_TOPUPMOTOR__QUOTEDATE()
        
End Sub
Protected Sub onValidate_TOPUPMOTOR__COVER()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_Custom_btnTUButton()
    onValidate_TOPUPMOTOR__QUOTEDATE()
    onValidate_TOPUPMOTOR__COVER()
End Sub
        ...
        Protected Sub btnTUSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            If IsPostBack Then
                ...
                Try
                    Dim sMakeModel As String = TOPUPMOTOR__MMDESCRIPT.Text
                    Dim sMMCode As String = TOPUPMOTOR__MAKECODE.Text
                    Dim sMYear As String = TOPUPMOTOR__MAN_YEAR.Text
                    Dim dQuoteDate As Date = TOPUPMOTOR__QUOTEDATE.Text
                    Dim sListOption = TOPUPMOTOR__VEHCODE.Text
                    If sListOption IsNot Nothing AND Not sListOption = "" Then
                        If sListOption = "3" Then
        ...
        Protected Sub btnTUClear_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        	If IsPostBack Then
        		TOPUPMOTOR__MAKECODE.Text = ""
        		TOPUPMOTOR__MMDESCRIPT.Text = ""
        		TOPUPMOTOR__MAN_YEAR.Text = ""
                TOPUPMOTOR__MAKE.Text = ""
        	End If
        End Sub
        ...
        Protected Shadows Sub LoadCoverStart(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If transactionValue = "NB" Then
                If isTrueMonthly Then
                    TOPUPMOTOR__QUOTEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
                Else
                    TOPUPMOTOR__QUOTEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
                End If
            Else
                If TOPUPMOTOR__QUOTEDATE.Text = "" Or TOPUPMOTOR__QUOTEDATE.Text Is Nothing Then
                    If isTrueMonthly Then
                        TOPUPMOTOR__QUOTEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
                    Else
                        TOPUPMOTOR__QUOTEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        ...
        Protected Shadows Sub Page_Load_ClientInfo(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If transactionValue = "NB" Then
                If isTrueMonthly Then
                    TOPUPMOTOR__COVER.Text = RTrim(LTrim(oQuote.InceptionDate))
                Else
                    TOPUPMOTOR__COVER.Text = RTrim(LTrim(oQuote.InceptionTPI))
                End If
            Else
                If TOPUPMOTOR__COVER.Text = "" Or TOPUPMOTOR__COVER.Text Is Nothing Then
                    If isTrueMonthly Then
                        TOPUPMOTOR__COVER.Text = RTrim(LTrim(oQuote.InceptionDate))
                    Else
                        TOPUPMOTOR__COVER.Text = RTrim(LTrim(oQuote.InceptionTPI))
