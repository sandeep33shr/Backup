<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TOPMOTMTA_MTA_Reason_Details.aspx.vb" Inherits="Nexus.PB2_TOPMOTMTA_MTA_Reason_Details" %>
...
function onValidate_MTA_REASON__MTA_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MTA_REASON.MTA_DESCRIPTION");
        			window.setControlWidth(field, "0.7", "MTA_REASON", "MTA_DESCRIPTION");
        		})();
        	}
        })();
}
...
<div id="idecaf902ae6db457cb15fbaca28023e8b" class="general-layout-container">
...
<div id="iddde7560cc1e54c1aa797404c9a6ee1ec" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddde7560cc1e54c1aa797404c9a6ee1ec div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddde7560cc1e54c1aa797404c9a6ee1ec div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddde7560cc1e54c1aa797404c9a6ee1ec div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddde7560cc1e54c1aa797404c9a6ee1ec label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddde7560cc1e54c1aa797404c9a6ee1ec label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddde7560cc1e54c1aa797404c9a6ee1ec label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddde7560cc1e54c1aa797404c9a6ee1ec label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddde7560cc1e54c1aa797404c9a6ee1ec input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddde7560cc1e54c1aa797404c9a6ee1ec input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddde7560cc1e54c1aa797404c9a6ee1ec input{text-align:left;}"; break;
		}
	}
