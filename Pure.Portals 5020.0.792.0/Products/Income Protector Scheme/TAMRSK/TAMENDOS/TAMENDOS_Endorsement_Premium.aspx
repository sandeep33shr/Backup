<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TAMENDOS_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_TAMENDOS_Endorsement_Premium" %>
...
function onValidate_TAMRSK_END__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK_END", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TAMRSK_END", "ENDORSE_ID");
        		}
...
function onValidate_TAMRSK_END__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK_END", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("TAMRSK_END", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK_END.ENDORSE_DESC");
        			window.setControlWidth(field, "0.7", "TAMRSK_END", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMRSK_END_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMRSK_END__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMRSK_END__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_TAMRSK_END__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK_END", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("TAMRSK_END", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=TAMRSK_END&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(TAMRSK_END.ENDORSE_DESC)"), 
...
function onValidate_TAMRSK_END__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK_END", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMRSK_END", "PREMIUM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK_END.PREMIUM");
        			window.setControlWidth(field, "0.7", "TAMRSK_END", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMRSK_END_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMRSK_END__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMRSK_END__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_TAMRSK_END__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_TAMRSK_END__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_TAMRSK_END__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_TAMRSK_END__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idda364cff841e4ab1abba61c1f3f0de8f" class="general-layout-container">
...
<div id="idd93c4b2908dd41a19093429545f64743" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TAMRSK_END" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-TAMRSK_END-ENDORSE_ID">
		<asp:Label ID="lblTAMRSK_END_ENDORSE_ID" runat="server" AssociatedControlID="TAMRSK_END__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="TAMRSK_END__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valTAMRSK_END_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_TAMRSK_END__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-TAMRSK_END-ENDORSE_DESC">
		<asp:Label ID="lblTAMRSK_END_ENDORSE_DESC" runat="server" AssociatedControlID="TAMRSK_END__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="TAMRSK_END__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_TAMRSK_END__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valTAMRSK_END_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_TAMRSK_END__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-TAMRSK_END-ENDORSE_CAP">

		
		<asp:Label ID="lblTAMRSK_END_ENDORSE_CAP" runat="server" AssociatedControlID="TAMRSK_END__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="TAMRSK_END__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valTAMRSK_END_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_TAMRSK_END__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TAMRSK_END-PREMIUM">
		<asp:Label ID="lblTAMRSK_END_PREMIUM" runat="server" AssociatedControlID="TAMRSK_END__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TAMRSK_END__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTAMRSK_END_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_TAMRSK_END__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd93c4b2908dd41a19093429545f64743 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd93c4b2908dd41a19093429545f64743 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd93c4b2908dd41a19093429545f64743 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd93c4b2908dd41a19093429545f64743 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd93c4b2908dd41a19093429545f64743 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd93c4b2908dd41a19093429545f64743 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd93c4b2908dd41a19093429545f64743 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd93c4b2908dd41a19093429545f64743 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd93c4b2908dd41a19093429545f64743 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd93c4b2908dd41a19093429545f64743 input{text-align:left;}"; break;
		}
	}
