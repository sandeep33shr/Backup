<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TAMCNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_TAMCNOTE_Note_Details" %>
...
function onValidate_CNOTE__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CNOTE", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("CNOTE", "DATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CNOTE.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "CNOTE", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=CNOTE&propertyName=DATE_CREATED&name={name}");
...
function onValidate_CNOTE__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CNOTE", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CNOTE", "CREATED_BY");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CNOTE.CREATED_BY");
        			window.setControlWidth(field, "0.5", "CNOTE", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_CNOTE__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CNOTE", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CNOTE", "COVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CNOTE.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "CNOTE", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CNOTE&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'TAM'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_CNOTE__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CNOTE", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CNOTE", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CNOTE.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "CNOTE", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CNOTE", "NOTE_DESCRIPTION");
        		var exp = new Expression("CNOTE.NoteCheck = 1");
...
function onValidate_CNOTE__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CNOTE", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CNOTE", "NOTE_DETAILS");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CNOTE.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "CNOTE", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=CNOTE&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_CNOTE__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_CNOTE_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_CNOTE__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CNOTE", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CNOTE", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_CNOTE__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_CNOTE__CREATED_BY(null, null, null, isOnLoad);
    onValidate_CNOTE__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_CNOTE__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_CNOTE__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_CNOTE__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="idcc97bb090fa0491a90e67e1919c89f9c" class="general-layout-container">
...
<div id="id77643207e39b46c0b3d4a30515fa502c" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="CNOTE" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-CNOTE-DATE_CREATED">
		<asp:Label ID="lblCNOTE_DATE_CREATED" runat="server" AssociatedControlID="CNOTE__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="CNOTE__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calCNOTE__DATE_CREATED" runat="server" LinkedControl="CNOTE__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valCNOTE_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_CNOTE__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CNOTE-CREATED_BY">

		
		<asp:Label ID="lblCNOTE_CREATED_BY" runat="server" AssociatedControlID="CNOTE__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CNOTE__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCNOTE_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_CNOTE__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CNOTE-COVER_TYPE">

		
		<asp:Label ID="lblCNOTE_COVER_TYPE" runat="server" AssociatedControlID="CNOTE__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CNOTE__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCNOTE_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_CNOTE__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CNOTE-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblCNOTE_NOTE_DESCRIPTION" runat="server" AssociatedControlID="CNOTE__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CNOTE__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCNOTE_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_CNOTE__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-CNOTE-NOTE_DETAILS">
		<asp:Label ID="lblCNOTE_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="CNOTE__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="CNOTE__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valCNOTE_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_CNOTE__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCNOTE_NoteCheck" for="ctl00_cntMainBody_CNOTE__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CNOTE-NoteCheck">	
		
		<asp:TextBox ID="CNOTE__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCNOTE_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_CNOTE__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id77643207e39b46c0b3d4a30515fa502c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id77643207e39b46c0b3d4a30515fa502c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id77643207e39b46c0b3d4a30515fa502c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id77643207e39b46c0b3d4a30515fa502c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id77643207e39b46c0b3d4a30515fa502c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77643207e39b46c0b3d4a30515fa502c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77643207e39b46c0b3d4a30515fa502c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id77643207e39b46c0b3d4a30515fa502c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77643207e39b46c0b3d4a30515fa502c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77643207e39b46c0b3d4a30515fa502c input{text-align:left;}"; break;
		}
	}
