<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TAMRSK_TAM_Income_Protector_Scheme.aspx.vb" Inherits="Nexus.PB2_TAMRSK_TAM_Income_Protector_Scheme" %>
...
function onValidate_TAMRSK__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "RISK_ATTACH_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMRSK", "RISK_ATTACH_DATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.4", "TAMRSK", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMRSK_RISK_ATTACH_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMRSK__RISK_ATTACH_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMRSK__RISK_ATTACH_DATE_lblFindParty");
        			    }
        			}
...
function onValidate_TAMRSK__EFFECTIVEDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "EFFECTIVEDATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMRSK", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.4", "TAMRSK", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMRSK_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMRSK__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMRSK__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__TAMRSKMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "TAMRSKMTA", "ChildScreen");
        })();
}
function onValidate_TAMRSK__PERSON(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "PERSON", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMRSK", "PERSON");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK.PERSON");
        			window.setControlWidth(field, "0.8", "TAMRSK", "PERSON");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMRSK_PERSON");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMRSK__PERSON');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMRSK__PERSON_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_TAMRSK__PREM_PERSON(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "PREM_PERSON", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMRSK", "PREM_PERSON");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK.PREM_PERSON");
        			window.setControlWidth(field, "0.8", "TAMRSK", "PREM_PERSON");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMRSK_PREM_PERSON");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMRSK__PREM_PERSON');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMRSK__PREM_PERSON_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_TAMRSK__TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TOT_PREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TAMRSK", "TOT_PREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK.TOT_PREM");
        			window.setControlWidth(field, "0.8", "TAMRSK", "TOT_PREM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMRSK_TOT_PREM");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMRSK__TOT_PREM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMRSK__TOT_PREM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Currency&objectName=TAMRSK&propertyName=TOT_PREM&name={name}");
        		
        		var value = new Expression("TAMRSK.PERSON * TAMRSK.PREM_PERSON"), 
...
function onValidate_TAMRSK__TOT_PREM_END(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TOT_PREM_END", "Currency");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("TAMRSK", "TOT_PREM_END");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMRSK.TOT_PREM_END");
        			window.setControlWidth(field, "0.4", "TAMRSK", "TOT_PREM_END");
        		})();
        	}
        })();
          ...
          * @param TAMRSK The Parent (Root) object name.
          * @param TAMRSK_END.PREMIUM The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "TAMRSK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "TAMRSK_END.PREMIUM";
...
function onValidate_TAMRSK__TAMENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TAMENDOS", "ChildScreen");
        })();
}
function onValidate_TAMRSK__TAMCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TAMCNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMRSK", "TAMCNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_TAMRSK__TAMCNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMRSK", "TAMCNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TAMRSK' and property 'TAMCNOTE'.");
        			error.display();
...
function onValidate_TAMRSK__TAMSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMRSK", "TAMSNOTE", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    onValidate_TAMRSK__RISK_ATTACH_DATE(null, null, null, isOnLoad);
    onValidate_TAMRSK__EFFECTIVEDATE(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__TAMRSKMTA(null, null, null, isOnLoad);
    onValidate_TAMRSK__PERSON(null, null, null, isOnLoad);
    onValidate_TAMRSK__PREM_PERSON(null, null, null, isOnLoad);
    onValidate_TAMRSK__TOT_PREM(null, null, null, isOnLoad);
    onValidate_TAMRSK__TOT_PREM_END(null, null, null, isOnLoad);
    onValidate_TAMRSK__TAMENDOS(null, null, null, isOnLoad);
    onValidate_TAMRSK__TAMCNOTE(null, null, null, isOnLoad);
    onValidate_TAMRSK__TAMSNOTE(null, null, null, isOnLoad);
...
<div id="id451b1596947949489ddd6a7dfae2846e" class="general-layout-container">
...
<div id="id3de6a9d18edc48ee92a321fe213d0fee" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TAMRSK" 
		data-property-name="RISK_ATTACH_DATE" 
		id="pb-container-datejquerycompatible-TAMRSK-RISK_ATTACH_DATE">
		<asp:Label ID="lblTAMRSK_RISK_ATTACH_DATE" runat="server" AssociatedControlID="TAMRSK__RISK_ATTACH_DATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TAMRSK__RISK_ATTACH_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTAMRSK__RISK_ATTACH_DATE" runat="server" LinkedControl="TAMRSK__RISK_ATTACH_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTAMRSK_RISK_ATTACH_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_TAMRSK__RISK_ATTACH_DATE" 
			ValidationGroup=""
			Display="None"
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-TAMRSK-EFFECTIVEDATE">
		<asp:Label ID="lblTAMRSK_EFFECTIVEDATE" runat="server" AssociatedControlID="TAMRSK__EFFECTIVEDATE" 
			Text="Effective Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TAMRSK__EFFECTIVEDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTAMRSK__EFFECTIVEDATE" runat="server" LinkedControl="TAMRSK__EFFECTIVEDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTAMRSK_EFFECTIVEDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective Date"
			ClientValidationFunction="onValidate_TAMRSK__EFFECTIVEDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3de6a9d18edc48ee92a321fe213d0fee div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3de6a9d18edc48ee92a321fe213d0fee div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3de6a9d18edc48ee92a321fe213d0fee div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3de6a9d18edc48ee92a321fe213d0fee label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3de6a9d18edc48ee92a321fe213d0fee label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3de6a9d18edc48ee92a321fe213d0fee label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3de6a9d18edc48ee92a321fe213d0fee label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3de6a9d18edc48ee92a321fe213d0fee input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3de6a9d18edc48ee92a321fe213d0fee input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3de6a9d18edc48ee92a321fe213d0fee input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0b6f4b06e670438b8d9bc7702d8ddc2c" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0b6f4b06e670438b8d9bc7702d8ddc2c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0b6f4b06e670438b8d9bc7702d8ddc2c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0b6f4b06e670438b8d9bc7702d8ddc2c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0b6f4b06e670438b8d9bc7702d8ddc2c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0b6f4b06e670438b8d9bc7702d8ddc2c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b6f4b06e670438b8d9bc7702d8ddc2c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b6f4b06e670438b8d9bc7702d8ddc2c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0b6f4b06e670438b8d9bc7702d8ddc2c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0b6f4b06e670438b8d9bc7702d8ddc2c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0b6f4b06e670438b8d9bc7702d8ddc2c input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__TAMRSKMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="TAMRSKMTA" 
		id="pb-container-childscreen-GENERAL-TAMRSKMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="TAMRSKMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TAMRSKMTA/TAMRSKMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_TAMRSKMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.TAMRSKMTA"
						ClientValidationFunction="onValidate_GENERAL__TAMRSKMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1d20c56a3c9f46cfa8e96792a18e8e87" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TAMRSK" 
		data-property-name="PERSON" 
		id="pb-container-integer-TAMRSK-PERSON">
		<asp:Label ID="lblTAMRSK_PERSON" runat="server" AssociatedControlID="TAMRSK__PERSON" 
			Text="Number of Persons Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="TAMRSK__PERSON" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valTAMRSK_PERSON" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Number of Persons Insured"
			ClientValidationFunction="onValidate_TAMRSK__PERSON" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TAMRSK" 
		data-property-name="PREM_PERSON" 
		id="pb-container-currency-TAMRSK-PREM_PERSON">
		<asp:Label ID="lblTAMRSK_PREM_PERSON" runat="server" AssociatedControlID="TAMRSK__PREM_PERSON" 
			Text="Premium Per Person" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TAMRSK__PREM_PERSON" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTAMRSK_PREM_PERSON" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium Per Person"
			ClientValidationFunction="onValidate_TAMRSK__PREM_PERSON" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TAMRSK-TOT_PREM">
		<asp:Label ID="lblTAMRSK_TOT_PREM" runat="server" AssociatedControlID="TAMRSK__TOT_PREM" 
			Text="Total Premium " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TAMRSK__TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTAMRSK_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Premium "
			ClientValidationFunction="onValidate_TAMRSK__TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id1d20c56a3c9f46cfa8e96792a18e8e87 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1d20c56a3c9f46cfa8e96792a18e8e87 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1d20c56a3c9f46cfa8e96792a18e8e87 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1d20c56a3c9f46cfa8e96792a18e8e87 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1d20c56a3c9f46cfa8e96792a18e8e87 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1d20c56a3c9f46cfa8e96792a18e8e87 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1d20c56a3c9f46cfa8e96792a18e8e87 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1d20c56a3c9f46cfa8e96792a18e8e87 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1d20c56a3c9f46cfa8e96792a18e8e87 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1d20c56a3c9f46cfa8e96792a18e8e87 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf6bc6fd5f62649bebc8582e77418e3e7" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblTAMRSK_REFFERRAL_CLAUSES" runat="server" AssociatedControlID="TAMRSK__REFFERRAL_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="TAMRSK__REFFERRAL_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-TAMRSK-TOT_PREM_END">
		<asp:Label ID="lblTAMRSK_TOT_PREM_END" runat="server" AssociatedControlID="TAMRSK__TOT_PREM_END" 
			Text="Total Endorsement Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="TAMRSK__TOT_PREM_END" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valTAMRSK_TOT_PREM_END" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Endorsement Premium"
			ClientValidationFunction="onValidate_TAMRSK__TOT_PREM_END" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMRSK__TAMENDOS"
		data-field-type="Child" 
		data-object-name="TAMRSK" 
		data-property-name="TAMENDOS" 
		id="pb-container-childscreen-TAMRSK-TAMENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMRSK__TAMRSK_END" runat="server" ScreenCode="TAMENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TAMENDOS/TAMENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valTAMRSK_TAMENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TAMRSK.TAMENDOS"
						ClientValidationFunction="onValidate_TAMRSK__TAMENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf6bc6fd5f62649bebc8582e77418e3e7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf6bc6fd5f62649bebc8582e77418e3e7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf6bc6fd5f62649bebc8582e77418e3e7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf6bc6fd5f62649bebc8582e77418e3e7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf6bc6fd5f62649bebc8582e77418e3e7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf6bc6fd5f62649bebc8582e77418e3e7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf6bc6fd5f62649bebc8582e77418e3e7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf6bc6fd5f62649bebc8582e77418e3e7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf6bc6fd5f62649bebc8582e77418e3e7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf6bc6fd5f62649bebc8582e77418e3e7 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4c8df735305a477899952bb041d5ce53" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading14" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMRSK__TAMCNOTE"
		data-field-type="Child" 
		data-object-name="TAMRSK" 
		data-property-name="TAMCNOTE" 
		id="pb-container-childscreen-TAMRSK-TAMCNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMRSK__CNOTE" runat="server" ScreenCode="TAMCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TAMCNOTE/TAMCNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTAMRSK_TAMCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TAMRSK.TAMCNOTE"
						ClientValidationFunction="onValidate_TAMRSK__TAMCNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4c8df735305a477899952bb041d5ce53 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4c8df735305a477899952bb041d5ce53 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4c8df735305a477899952bb041d5ce53 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4c8df735305a477899952bb041d5ce53 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4c8df735305a477899952bb041d5ce53 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4c8df735305a477899952bb041d5ce53 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4c8df735305a477899952bb041d5ce53 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4c8df735305a477899952bb041d5ce53 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4c8df735305a477899952bb041d5ce53 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4c8df735305a477899952bb041d5ce53 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1febe828061e4676b8a3dee3036e0174" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMRSK__TAMSNOTE"
		data-field-type="Child" 
		data-object-name="TAMRSK" 
		data-property-name="TAMSNOTE" 
		id="pb-container-childscreen-TAMRSK-TAMSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMRSK__SNOTE" runat="server" ScreenCode="TAMSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TAMSNOTE/TAMSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTAMRSK_TAMSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TAMRSK.TAMSNOTE"
						ClientValidationFunction="onValidate_TAMRSK__TAMSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id1febe828061e4676b8a3dee3036e0174 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1febe828061e4676b8a3dee3036e0174 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1febe828061e4676b8a3dee3036e0174 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1febe828061e4676b8a3dee3036e0174 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1febe828061e4676b8a3dee3036e0174 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1febe828061e4676b8a3dee3036e0174 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1febe828061e4676b8a3dee3036e0174 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1febe828061e4676b8a3dee3036e0174 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1febe828061e4676b8a3dee3036e0174 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1febe828061e4676b8a3dee3036e0174 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id02cbb484b0084af7a3c3ee93845ce088" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id02cbb484b0084af7a3c3ee93845ce088 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id02cbb484b0084af7a3c3ee93845ce088 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id02cbb484b0084af7a3c3ee93845ce088 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id02cbb484b0084af7a3c3ee93845ce088 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id02cbb484b0084af7a3c3ee93845ce088 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id02cbb484b0084af7a3c3ee93845ce088 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id02cbb484b0084af7a3c3ee93845ce088 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id02cbb484b0084af7a3c3ee93845ce088 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id02cbb484b0084af7a3c3ee93845ce088 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id02cbb484b0084af7a3c3ee93845ce088 input{text-align:left;}"; break;
		}
	}
