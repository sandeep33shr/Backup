<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TAMSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_TAMSNOTE_Note_Details" %>
...
function onValidate_SNOTE__DATE_CREATED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("SNOTE", "DATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SNOTE.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "SNOTE", "DATE_CREATED");
        		})();
        	}
        })();
        /**
...
function onValidate_SNOTE__CREATED_BY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SNOTE.CREATED_BY");
        			window.setControlWidth(field, "0.5", "SNOTE", "CREATED_BY");
        		})();
        	}
        })();
        /**
...
function onValidate_SNOTE__COVER_TYPE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SNOTE.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "SNOTE", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("SNOTE.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "SNOTE", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SNOTE", "NOTE_DETAILS");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("SNOTE.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "SNOTE", "NOTE_DETAILS");
        		})();
        	}
        })();
...
<div id="id139cbc835d9a4eae9cbcf7b2ed40be31" class="general-layout-container">
...
<div id="id2e9f248a7d3a4cfabcd9682e56012d16" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2e9f248a7d3a4cfabcd9682e56012d16 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2e9f248a7d3a4cfabcd9682e56012d16 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2e9f248a7d3a4cfabcd9682e56012d16 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2e9f248a7d3a4cfabcd9682e56012d16 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2e9f248a7d3a4cfabcd9682e56012d16 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2e9f248a7d3a4cfabcd9682e56012d16 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2e9f248a7d3a4cfabcd9682e56012d16 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2e9f248a7d3a4cfabcd9682e56012d16 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2e9f248a7d3a4cfabcd9682e56012d16 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2e9f248a7d3a4cfabcd9682e56012d16 input{text-align:left;}"; break;
		}
	}
