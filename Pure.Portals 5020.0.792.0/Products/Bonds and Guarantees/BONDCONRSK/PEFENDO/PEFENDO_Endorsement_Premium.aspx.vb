...
Namespace Nexus
    Partial Class PB2_PEFENDO_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_PERFORMGT_SEC_PEF__COUNTER_ID()
        
End Sub
Protected Sub onValidate_PERFORMGT_SEC_PEF__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PERFORMGT_SEC_PEF__COUNTER_ID()
    onValidate_PERFORMGT_SEC_PEF__ENDORSE_ID()
End Sub

		    
        'PERFORMANCE - Parent object
        'PERFORMGT_SEC_PEF - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "PERFORMANCE" & "/" & "PERFORMGT_SEC_PEF", sXMLDataset)
                            If sChildId <> "0" Then
                                PERFORMGT_SEC_PEF__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        'Parameters:
        'PERFORMANCE - Standard Wording Parent Object
        'PERFORMANCE_CLAUSES - Standard Wording Parent Property
        'PERFORMGT_SEC_PEF - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PERFORMANCE/SW.PERFORMANCE_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("PERFORMGT_SEC_PEF__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PERFORMANCE/PERFORMGT_SEC_PEF")
        
        	Dim CurrentSelected As String = PERFORMGT_SEC_PEF__ENDORSE_CAP.Text
