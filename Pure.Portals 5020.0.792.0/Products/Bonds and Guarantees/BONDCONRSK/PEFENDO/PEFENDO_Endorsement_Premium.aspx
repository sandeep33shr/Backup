<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PEFENDO_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_PEFENDO_Endorsement_Premium" %>
...
function onValidate_PERFORMGT_SEC_PEF__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PERFORMGT_SEC_PEF", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PERFORMGT_SEC_PEF", "COUNTER_ID");
        		}
...
function onValidate_PERFORMGT_SEC_PEF__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PERFORMGT_SEC_PEF", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PERFORMGT_SEC_PEF", "ENDORSE_ID");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_PERFORMGT_SEC_PEF__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PERFORMGT_SEC_PEF", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PERFORMGT_SEC_PEF", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PERFORMGT_SEC_PEF.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "PERFORMGT_SEC_PEF", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPERFORMGT_SEC_PEF_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_PERFORMGT_SEC_PEF__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PERFORMGT_SEC_PEF__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_PERFORMGT_SEC_PEF__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PERFORMGT_SEC_PEF", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PERFORMGT_SEC_PEF", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PERFORMGT_SEC_PEF.ENDORSE_CAP");
        			window.setControlWidth(field, "0.4", "PERFORMGT_SEC_PEF", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=PERFORMGT_SEC_PEF&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(PERFORMGT_SEC_PEF.ENDORSE_DESC)"), 
...
function onValidate_PERFORMGT_SEC_PEF__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PERFORMGT_SEC_PEF", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("PERFORMGT_SEC_PEF", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("PERFORMGT_SEC_PEF.PREMIUM");
        			window.setControlWidth(field, "0.4", "PERFORMGT_SEC_PEF", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblPERFORMGT_SEC_PEF_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_PERFORMGT_SEC_PEF__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_PERFORMGT_SEC_PEF__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_PERFORMGT_SEC_PEF__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_PERFORMGT_SEC_PEF__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_PERFORMGT_SEC_PEF__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_PERFORMGT_SEC_PEF__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_PERFORMGT_SEC_PEF__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="idc8506a6498f5424492c8b59041961bb3" class="general-layout-container">
...
<div id="idf56bb183be6d4449b3fb1792c50e6f53" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading53" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="PERFORMGT_SEC_PEF" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-PERFORMGT_SEC_PEF-COUNTER_ID">

		
		<asp:Label ID="lblPERFORMGT_SEC_PEF_COUNTER_ID" runat="server" AssociatedControlID="PERFORMGT_SEC_PEF__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PERFORMGT_SEC_PEF__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPERFORMGT_SEC_PEF_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_PERFORMGT_SEC_PEF__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-PERFORMGT_SEC_PEF-ENDORSE_ID">
		<asp:Label ID="lblPERFORMGT_SEC_PEF_ENDORSE_ID" runat="server" AssociatedControlID="PERFORMGT_SEC_PEF__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="PERFORMGT_SEC_PEF__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valPERFORMGT_SEC_PEF_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_PERFORMGT_SEC_PEF__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-PERFORMGT_SEC_PEF-ENDORSE_DESC">
		<asp:Label ID="lblPERFORMGT_SEC_PEF_ENDORSE_DESC" runat="server" AssociatedControlID="PERFORMGT_SEC_PEF__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="PERFORMGT_SEC_PEF__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_PERFORMGT_SEC_PEF__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valPERFORMGT_SEC_PEF_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_PERFORMGT_SEC_PEF__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PERFORMGT_SEC_PEF-ENDORSE_CAP">

		
		<asp:Label ID="lblPERFORMGT_SEC_PEF_ENDORSE_CAP" runat="server" AssociatedControlID="PERFORMGT_SEC_PEF__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="PERFORMGT_SEC_PEF__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valPERFORMGT_SEC_PEF_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_PERFORMGT_SEC_PEF__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-PERFORMGT_SEC_PEF-PREMIUM">
		<asp:Label ID="lblPERFORMGT_SEC_PEF_PREMIUM" runat="server" AssociatedControlID="PERFORMGT_SEC_PEF__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="PERFORMGT_SEC_PEF__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valPERFORMGT_SEC_PEF_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_PERFORMGT_SEC_PEF__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-PERFORMGT_SEC_PEF-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="PERFORMGT_SEC_PEF__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf56bb183be6d4449b3fb1792c50e6f53 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf56bb183be6d4449b3fb1792c50e6f53 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf56bb183be6d4449b3fb1792c50e6f53 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf56bb183be6d4449b3fb1792c50e6f53 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf56bb183be6d4449b3fb1792c50e6f53 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf56bb183be6d4449b3fb1792c50e6f53 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf56bb183be6d4449b3fb1792c50e6f53 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf56bb183be6d4449b3fb1792c50e6f53 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf56bb183be6d4449b3fb1792c50e6f53 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf56bb183be6d4449b3fb1792c50e6f53 input{text-align:left;}"; break;
		}
	}
