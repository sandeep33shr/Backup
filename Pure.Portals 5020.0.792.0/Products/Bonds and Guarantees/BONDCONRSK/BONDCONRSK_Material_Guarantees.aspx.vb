...
Namespace Nexus
    Partial Class PB2_BONDCONRSK_Material_Guarantees : Inherits BaseRisk
		...
		Protected Sub onValidate_MATERIAL__TOWN()
        
End Sub
Protected Sub onValidate_MATERIAL__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MATERIAL__TOWN()
    onValidate_MATERIAL__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("MATERIAL__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("MATERIAL__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("MATERIAL__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('MATERIAL', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('MATERIAL', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('MATERIAL', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('MATERIAL', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('MATERIAL', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('MATERIAL', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('MATERIAL', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('MATERIAL', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = MATERIAL__LINE1.Text
        	Dim Suburb as String = MATERIAL__SUBURB.Text
