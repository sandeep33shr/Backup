...
Namespace Nexus
    Partial Class PB2_APGENDO_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_ADVANC_PAY_SEC_APG__COUNTER_ID()
        
End Sub
Protected Sub onValidate_ADVANC_PAY_SEC_APG__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ADVANC_PAY_SEC_APG__COUNTER_ID()
    onValidate_ADVANC_PAY_SEC_APG__ENDORSE_ID()
End Sub

		    
        'ADVANCE - Parent object
        'ADVANC_PAY_SEC_APG - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "ADVANCE" & "/" & "ADVANC_PAY_SEC_APG", sXMLDataset)
                            If sChildId <> "0" Then
                                ADVANC_PAY_SEC_APG__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        'Parameters:
        'ADVANCE - Standard Wording Parent Object
        'ADVANCE_CLAUSES - Standard Wording Parent Property
        'ADVANC_PAY_SEC_APG - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/ADVANCE/SW.ADVANCE_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("ADVANC_PAY_SEC_APG__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/ADVANCE/ADVANC_PAY_SEC_APG")
        
        	Dim CurrentSelected As String = ADVANC_PAY_SEC_APG__ENDORSE_CAP.Text
