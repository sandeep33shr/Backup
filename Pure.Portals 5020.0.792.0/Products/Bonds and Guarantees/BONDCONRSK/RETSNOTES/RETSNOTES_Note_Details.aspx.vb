...
Namespace Nexus
    Partial Class PB2_RETSNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_RETS_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If RETS_DETAILS__Date_Created.Text.ToString = "" Then
        		RETS_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		RETS_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_RETS_DETAILS__NOTE_DETAILS()
End Sub
