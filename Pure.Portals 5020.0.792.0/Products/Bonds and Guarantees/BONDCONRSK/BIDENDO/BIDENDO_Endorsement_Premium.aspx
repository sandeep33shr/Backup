<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="BIDENDO_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_BIDENDO_Endorsement_Premium" %>
...
function onValidate_BID_BONDS_SEC_BID__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BID_BONDS_SEC_BID", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BID_BONDS_SEC_BID", "COUNTER_ID");
        		}
...
function onValidate_BID_BONDS_SEC_BID__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BID_BONDS_SEC_BID", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BID_BONDS_SEC_BID", "ENDORSE_ID");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_BID_BONDS_SEC_BID__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BID_BONDS_SEC_BID", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BID_BONDS_SEC_BID", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BID_BONDS_SEC_BID.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "BID_BONDS_SEC_BID", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBID_BONDS_SEC_BID_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_BID_BONDS_SEC_BID__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BID_BONDS_SEC_BID__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_BID_BONDS_SEC_BID__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BID_BONDS_SEC_BID", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("BID_BONDS_SEC_BID", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BID_BONDS_SEC_BID.ENDORSE_CAP");
        			window.setControlWidth(field, "0.4", "BID_BONDS_SEC_BID", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=BID_BONDS_SEC_BID&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(BID_BONDS_SEC_BID.ENDORSE_DESC)"), 
...
function onValidate_BID_BONDS_SEC_BID__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "BID_BONDS_SEC_BID", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("BID_BONDS_SEC_BID", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("BID_BONDS_SEC_BID.PREMIUM");
        			window.setControlWidth(field, "0.4", "BID_BONDS_SEC_BID", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblBID_BONDS_SEC_BID_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_BID_BONDS_SEC_BID__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_BID_BONDS_SEC_BID__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_BID_BONDS_SEC_BID__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_BID_BONDS_SEC_BID__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_BID_BONDS_SEC_BID__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_BID_BONDS_SEC_BID__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_BID_BONDS_SEC_BID__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id806d77dde51140e7a77dfe26066213d4" class="general-layout-container">
...
<div id="id84b15f2e419e40c5b2b1e58fb1348541" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="BID_BONDS_SEC_BID" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-BID_BONDS_SEC_BID-COUNTER_ID">

		
		<asp:Label ID="lblBID_BONDS_SEC_BID_COUNTER_ID" runat="server" AssociatedControlID="BID_BONDS_SEC_BID__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BID_BONDS_SEC_BID__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBID_BONDS_SEC_BID_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_BID_BONDS_SEC_BID__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-BID_BONDS_SEC_BID-ENDORSE_ID">
		<asp:Label ID="lblBID_BONDS_SEC_BID_ENDORSE_ID" runat="server" AssociatedControlID="BID_BONDS_SEC_BID__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="BID_BONDS_SEC_BID__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valBID_BONDS_SEC_BID_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_BID_BONDS_SEC_BID__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-BID_BONDS_SEC_BID-ENDORSE_DESC">
		<asp:Label ID="lblBID_BONDS_SEC_BID_ENDORSE_DESC" runat="server" AssociatedControlID="BID_BONDS_SEC_BID__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="BID_BONDS_SEC_BID__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_BID_BONDS_SEC_BID__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valBID_BONDS_SEC_BID_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_BID_BONDS_SEC_BID__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-BID_BONDS_SEC_BID-ENDORSE_CAP">

		
		<asp:Label ID="lblBID_BONDS_SEC_BID_ENDORSE_CAP" runat="server" AssociatedControlID="BID_BONDS_SEC_BID__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="BID_BONDS_SEC_BID__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valBID_BONDS_SEC_BID_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_BID_BONDS_SEC_BID__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-BID_BONDS_SEC_BID-PREMIUM">
		<asp:Label ID="lblBID_BONDS_SEC_BID_PREMIUM" runat="server" AssociatedControlID="BID_BONDS_SEC_BID__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="BID_BONDS_SEC_BID__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valBID_BONDS_SEC_BID_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_BID_BONDS_SEC_BID__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-BID_BONDS_SEC_BID-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="BID_BONDS_SEC_BID__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id84b15f2e419e40c5b2b1e58fb1348541 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id84b15f2e419e40c5b2b1e58fb1348541 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id84b15f2e419e40c5b2b1e58fb1348541 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id84b15f2e419e40c5b2b1e58fb1348541 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id84b15f2e419e40c5b2b1e58fb1348541 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id84b15f2e419e40c5b2b1e58fb1348541 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id84b15f2e419e40c5b2b1e58fb1348541 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id84b15f2e419e40c5b2b1e58fb1348541 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id84b15f2e419e40c5b2b1e58fb1348541 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id84b15f2e419e40c5b2b1e58fb1348541 input{text-align:left;}"; break;
		}
	}
