...
Namespace Nexus
    Partial Class PB2_BIDENDO_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_BID_BONDS_SEC_BID__COUNTER_ID()
        
End Sub
Protected Sub onValidate_BID_BONDS_SEC_BID__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BID_BONDS_SEC_BID__COUNTER_ID()
    onValidate_BID_BONDS_SEC_BID__ENDORSE_ID()
End Sub

		    
        'BID - Parent object
        'BID_BONDS_SEC_BID - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "BID" & "/" & "BID_BONDS_SEC_BID", sXMLDataset)
                            If sChildId <> "0" Then
                                BID_BONDS_SEC_BID__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        'Parameters:
        'BID - Standard Wording Parent Object
        'BID_CLAUSES - Standard Wording Parent Property
        'BID_BONDS_SEC_BID - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/BID/SW.BID_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("BID_BONDS_SEC_BID__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/BID/BID_BONDS_SEC_BID")
        
        	Dim CurrentSelected As String = BID_BONDS_SEC_BID__ENDORSE_CAP.Text
