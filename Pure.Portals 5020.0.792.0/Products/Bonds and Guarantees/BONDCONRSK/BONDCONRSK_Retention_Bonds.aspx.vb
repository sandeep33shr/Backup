...
Namespace Nexus
    Partial Class PB2_BONDCONRSK_Retention_Bonds : Inherits BaseRisk
		...
		Protected Sub onValidate_RETENTION__TOWN()
        
End Sub
Protected Sub onValidate_RETENTION__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RETENTION__TOWN()
    onValidate_RETENTION__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("RETENTION__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("RETENTION__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("RETENTION__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('RETENTION', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('RETENTION', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('RETENTION', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('RETENTION', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('RETENTION', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('RETENTION', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('RETENTION', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('RETENTION', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = RETENTION__LINE1.Text
        	Dim Suburb as String = RETENTION__SUBURB.Text
