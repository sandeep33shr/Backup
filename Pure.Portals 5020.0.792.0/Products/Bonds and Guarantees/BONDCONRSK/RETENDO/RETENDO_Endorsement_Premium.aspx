<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="RETENDO_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_RETENDO_Endorsement_Premium" %>
...
function onValidate_RETENTION_SEC_RET__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETENTION_SEC_RET", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RETENTION_SEC_RET", "COUNTER_ID");
        		}
...
function onValidate_RETENTION_SEC_RET__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETENTION_SEC_RET", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RETENTION_SEC_RET", "ENDORSE_ID");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_RETENTION_SEC_RET__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETENTION_SEC_RET", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("RETENTION_SEC_RET", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RETENTION_SEC_RET.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "RETENTION_SEC_RET", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRETENTION_SEC_RET_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_RETENTION_SEC_RET__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RETENTION_SEC_RET__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_RETENTION_SEC_RET__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETENTION_SEC_RET", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("RETENTION_SEC_RET", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RETENTION_SEC_RET.ENDORSE_CAP");
        			window.setControlWidth(field, "0.4", "RETENTION_SEC_RET", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=RETENTION_SEC_RET&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(RETENTION_SEC_RET.ENDORSE_DESC)"), 
...
function onValidate_RETENTION_SEC_RET__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RETENTION_SEC_RET", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("RETENTION_SEC_RET", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("RETENTION_SEC_RET.PREMIUM");
        			window.setControlWidth(field, "0.4", "RETENTION_SEC_RET", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblRETENTION_SEC_RET_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_RETENTION_SEC_RET__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_RETENTION_SEC_RET__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_RETENTION_SEC_RET__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_RETENTION_SEC_RET__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_RETENTION_SEC_RET__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_RETENTION_SEC_RET__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_RETENTION_SEC_RET__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id5ec6768b2dfb4e5aa7b1ffaa7b05ed3b" class="general-layout-container">
...
<div id="ida5ede1396f07490c97aedec4bd318d4e" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="RETENTION_SEC_RET" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-RETENTION_SEC_RET-COUNTER_ID">

		
		<asp:Label ID="lblRETENTION_SEC_RET_COUNTER_ID" runat="server" AssociatedControlID="RETENTION_SEC_RET__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="RETENTION_SEC_RET__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valRETENTION_SEC_RET_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_RETENTION_SEC_RET__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-RETENTION_SEC_RET-ENDORSE_ID">
		<asp:Label ID="lblRETENTION_SEC_RET_ENDORSE_ID" runat="server" AssociatedControlID="RETENTION_SEC_RET__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="RETENTION_SEC_RET__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valRETENTION_SEC_RET_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_RETENTION_SEC_RET__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-RETENTION_SEC_RET-ENDORSE_DESC">
		<asp:Label ID="lblRETENTION_SEC_RET_ENDORSE_DESC" runat="server" AssociatedControlID="RETENTION_SEC_RET__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="RETENTION_SEC_RET__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_RETENTION_SEC_RET__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valRETENTION_SEC_RET_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_RETENTION_SEC_RET__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-RETENTION_SEC_RET-ENDORSE_CAP">

		
		<asp:Label ID="lblRETENTION_SEC_RET_ENDORSE_CAP" runat="server" AssociatedControlID="RETENTION_SEC_RET__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="RETENTION_SEC_RET__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valRETENTION_SEC_RET_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_RETENTION_SEC_RET__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-RETENTION_SEC_RET-PREMIUM">
		<asp:Label ID="lblRETENTION_SEC_RET_PREMIUM" runat="server" AssociatedControlID="RETENTION_SEC_RET__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="RETENTION_SEC_RET__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valRETENTION_SEC_RET_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_RETENTION_SEC_RET__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-RETENTION_SEC_RET-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="RETENTION_SEC_RET__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida5ede1396f07490c97aedec4bd318d4e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida5ede1396f07490c97aedec4bd318d4e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida5ede1396f07490c97aedec4bd318d4e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida5ede1396f07490c97aedec4bd318d4e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida5ede1396f07490c97aedec4bd318d4e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5ede1396f07490c97aedec4bd318d4e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5ede1396f07490c97aedec4bd318d4e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida5ede1396f07490c97aedec4bd318d4e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5ede1396f07490c97aedec4bd318d4e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5ede1396f07490c97aedec4bd318d4e input{text-align:left;}"; break;
		}
	}
