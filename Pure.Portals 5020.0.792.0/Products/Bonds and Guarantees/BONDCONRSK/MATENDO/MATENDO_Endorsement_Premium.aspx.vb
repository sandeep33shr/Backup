...
Namespace Nexus
    Partial Class PB2_MATENDO_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_MATERIALGT_SEC_MAT__COUNTER_ID()
        
End Sub
Protected Sub onValidate_MATERIALGT_SEC_MAT__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MATERIALGT_SEC_MAT__COUNTER_ID()
    onValidate_MATERIALGT_SEC_MAT__ENDORSE_ID()
End Sub

		    
        'MATERIAL - Parent object
        'MATERIALGT_SEC_MAT - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "MATERIAL" & "/" & "MATERIALGT_SEC_MAT", sXMLDataset)
                            If sChildId <> "0" Then
                                MATERIALGT_SEC_MAT__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        'Parameters:
        'MATERIAL - Standard Wording Parent Object
        'MATERIAL_CLAUSES - Standard Wording Parent Property
        'MATERIALGT_SEC_MAT - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/MATERIAL/SW.MATERIAL_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("MATERIALGT_SEC_MAT__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/MATERIAL/MATERIALGT_SEC_MAT")
        
        	Dim CurrentSelected As String = MATERIALGT_SEC_MAT__ENDORSE_CAP.Text
