<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MATENDO_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_MATENDO_Endorsement_Premium" %>
...
function onValidate_MATERIALGT_SEC_MAT__COUNTER_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MATERIALGT_SEC_MAT", "COUNTER_ID", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MATERIALGT_SEC_MAT", "COUNTER_ID");
        		}
...
function onValidate_MATERIALGT_SEC_MAT__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MATERIALGT_SEC_MAT", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MATERIALGT_SEC_MAT", "ENDORSE_ID");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_MATERIALGT_SEC_MAT__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MATERIALGT_SEC_MAT", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MATERIALGT_SEC_MAT", "ENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MATERIALGT_SEC_MAT.ENDORSE_DESC");
        			window.setControlWidth(field, "0.4", "MATERIALGT_SEC_MAT", "ENDORSE_DESC");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMATERIALGT_SEC_MAT_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_MATERIALGT_SEC_MAT__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MATERIALGT_SEC_MAT__ENDORSE_DESC_lblFindParty");
        			    }
        			}
...
function onValidate_MATERIALGT_SEC_MAT__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MATERIALGT_SEC_MAT", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MATERIALGT_SEC_MAT", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MATERIALGT_SEC_MAT.ENDORSE_CAP");
        			window.setControlWidth(field, "0.4", "MATERIALGT_SEC_MAT", "ENDORSE_CAP");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MATERIALGT_SEC_MAT&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(MATERIALGT_SEC_MAT.ENDORSE_DESC)"), 
...
function onValidate_MATERIALGT_SEC_MAT__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MATERIALGT_SEC_MAT", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MATERIALGT_SEC_MAT", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MATERIALGT_SEC_MAT.PREMIUM");
        			window.setControlWidth(field, "0.4", "MATERIALGT_SEC_MAT", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMATERIALGT_SEC_MAT_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MATERIALGT_SEC_MAT__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MATERIALGT_SEC_MAT__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_MATERIALGT_SEC_MAT__COUNTER_ID(null, null, null, isOnLoad);
    onValidate_MATERIALGT_SEC_MAT__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_MATERIALGT_SEC_MAT__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_MATERIALGT_SEC_MAT__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_MATERIALGT_SEC_MAT__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="ida17820ca9f524f9aa2b8f8ce099c4dc3" class="general-layout-container">
...
<div id="id9235ad9115a741f180e07f6f9b400117" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading38" runat="server" Text="Endorsement Premium" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MATERIALGT_SEC_MAT" 
		data-property-name="COUNTER_ID" 
		 
		
		 
		id="pb-container-text-MATERIALGT_SEC_MAT-COUNTER_ID">

		
		<asp:Label ID="lblMATERIALGT_SEC_MAT_COUNTER_ID" runat="server" AssociatedControlID="MATERIALGT_SEC_MAT__COUNTER_ID" 
			Text="ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MATERIALGT_SEC_MAT__COUNTER_ID" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMATERIALGT_SEC_MAT_COUNTER_ID" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID"
					ClientValidationFunction="onValidate_MATERIALGT_SEC_MAT__COUNTER_ID"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-MATERIALGT_SEC_MAT-ENDORSE_ID">
		<asp:Label ID="lblMATERIALGT_SEC_MAT_ENDORSE_ID" runat="server" AssociatedControlID="MATERIALGT_SEC_MAT__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MATERIALGT_SEC_MAT__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMATERIALGT_SEC_MAT_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_MATERIALGT_SEC_MAT__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-MATERIALGT_SEC_MAT-ENDORSE_DESC">
		<asp:Label ID="lblMATERIALGT_SEC_MAT_ENDORSE_DESC" runat="server" AssociatedControlID="MATERIALGT_SEC_MAT__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="MATERIALGT_SEC_MAT__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_MATERIALGT_SEC_MAT__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valMATERIALGT_SEC_MAT_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_MATERIALGT_SEC_MAT__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MATERIALGT_SEC_MAT-ENDORSE_CAP">

		
		<asp:Label ID="lblMATERIALGT_SEC_MAT_ENDORSE_CAP" runat="server" AssociatedControlID="MATERIALGT_SEC_MAT__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MATERIALGT_SEC_MAT__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMATERIALGT_SEC_MAT_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_MATERIALGT_SEC_MAT__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MATERIALGT_SEC_MAT-PREMIUM">
		<asp:Label ID="lblMATERIALGT_SEC_MAT_PREMIUM" runat="server" AssociatedControlID="MATERIALGT_SEC_MAT__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MATERIALGT_SEC_MAT__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMATERIALGT_SEC_MAT_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_MATERIALGT_SEC_MAT__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MATERIALGT_SEC_MAT-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="MATERIALGT_SEC_MAT__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9235ad9115a741f180e07f6f9b400117 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9235ad9115a741f180e07f6f9b400117 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9235ad9115a741f180e07f6f9b400117 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9235ad9115a741f180e07f6f9b400117 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9235ad9115a741f180e07f6f9b400117 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9235ad9115a741f180e07f6f9b400117 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9235ad9115a741f180e07f6f9b400117 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9235ad9115a741f180e07f6f9b400117 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9235ad9115a741f180e07f6f9b400117 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9235ad9115a741f180e07f6f9b400117 input{text-align:left;}"; break;
		}
	}
