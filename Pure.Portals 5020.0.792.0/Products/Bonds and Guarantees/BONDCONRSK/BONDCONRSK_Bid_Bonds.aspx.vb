...
Namespace Nexus
    Partial Class PB2_BONDCONRSK_Bid_Bonds : Inherits BaseRisk
		...
		Protected Sub onValidate_BID__TOWN()
        
End Sub
Protected Sub onValidate_BID__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BID__TOWN()
    onValidate_BID__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("BID__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("BID__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("BID__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('BID', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('BID', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('BID', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('BID', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('BID', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('BID', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('BID', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('BID', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = BID__LINE1.Text
        	Dim Suburb as String = BID__SUBURB.Text
