<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="BONDCONRSK_Risk_Details.aspx.vb" Inherits="Nexus.PB2_BONDCONRSK_Risk_Details" %>
...
function onValidate_GENERAL__HNCGMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "HNCGMTA", "ChildScreen");
        })();
}
function onValidate_GENERAL__IS_ADVANCE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_ADVANCE", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_ADVANCE");
        		var exp = new Expression("GENERAL.IS_BID==1 || GENERAL.IS_MATERIAL==1 || GENERAL.IS_PERFORMANCE==1 || GENERAL.IS_RETENTION==1 ");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.IS_ADVANCE");
        			window.setControlWidth(field, "0.8", "GENERAL", "IS_ADVANCE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_ADVANCE");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_ADVANCE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_ADVANCE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_BID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_BID", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_BID");
        		var exp = new Expression("GENERAL.IS_ADVANCE==1 || GENERAL.IS_MATERIAL==1 || GENERAL.IS_PERFORMANCE==1 || GENERAL.IS_RETENTION==1 ");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.IS_BID");
        			window.setControlWidth(field, "0.8", "GENERAL", "IS_BID");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_BID");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_BID');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_BID_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_MATERIAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_MATERIAL", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_MATERIAL");
        		var exp = new Expression("GENERAL.IS_ADVANCE==1 || GENERAL.IS_BID==1 || GENERAL.IS_PERFORMANCE==1 || GENERAL.IS_RETENTION==1 ");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.IS_MATERIAL");
        			window.setControlWidth(field, "0.8", "GENERAL", "IS_MATERIAL");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_MATERIAL");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_MATERIAL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_MATERIAL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_PERFORMANCE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_PERFORMANCE", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_PERFORMANCE");
        		var exp = new Expression("GENERAL.IS_ADVANCE==1 || GENERAL.IS_BID==1 || GENERAL.IS_MATERIAL==1 || GENERAL.IS_RETENTION==1 ");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.IS_PERFORMANCE");
        			window.setControlWidth(field, "0.8", "GENERAL", "IS_PERFORMANCE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_PERFORMANCE");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_PERFORMANCE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_PERFORMANCE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_RETENTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_RETENTION", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_RETENTION");
        		var exp = new Expression("GENERAL.IS_ADVANCE==1 || GENERAL.IS_BID==1 || GENERAL.IS_MATERIAL==1 || GENERAL.IS_PERFORMANCE ==1 ");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.IS_RETENTION");
        			window.setControlWidth(field, "0.8", "GENERAL", "IS_RETENTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_RETENTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_RETENTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_RETENTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "IS_RETENTION");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "IS_RETENTION");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("GENERAL.IS_ADVANCE == 1 || GENERAL.IS_BID == 1 || GENERAL.IS_MATERIAL == 1 || GENERAL.IS_PERFORMANCE == 1 || IS_RETENTION == 1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__HNCGMTA(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_ADVANCE(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_BID(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_MATERIAL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_PERFORMANCE(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_RETENTION(null, null, null, isOnLoad);
...
<div id="id4d48f0d21214490c990794d1fa9400c3" class="general-layout-container">
...
<div id="id4f8895c80360488ab85396ddd37832b5" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4f8895c80360488ab85396ddd37832b5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4f8895c80360488ab85396ddd37832b5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4f8895c80360488ab85396ddd37832b5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4f8895c80360488ab85396ddd37832b5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4f8895c80360488ab85396ddd37832b5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4f8895c80360488ab85396ddd37832b5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4f8895c80360488ab85396ddd37832b5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4f8895c80360488ab85396ddd37832b5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4f8895c80360488ab85396ddd37832b5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4f8895c80360488ab85396ddd37832b5 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__HNCGMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="HNCGMTA" 
		id="pb-container-childscreen-GENERAL-HNCGMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="HNCGMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="HNCGMTA/HNCGMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_HNCGMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.HNCGMTA"
						ClientValidationFunction="onValidate_GENERAL__HNCGMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide6514ab9caaa4783880d2237b83d2daf" class="column-layout-container,no-border  ">
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_ADVANCE" for="ctl00_cntMainBody_GENERAL__IS_ADVANCE" class="col-md-4 col-sm-3 control-label">
		Advance Payment Gaurantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_ADVANCE" 
		id="pb-container-checkbox-GENERAL-IS_ADVANCE">	
		
		<asp:TextBox ID="GENERAL__IS_ADVANCE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_ADVANCE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Advance Payment Gaurantees"
			ClientValidationFunction="onValidate_GENERAL__IS_ADVANCE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_BID" for="ctl00_cntMainBody_GENERAL__IS_BID" class="col-md-4 col-sm-3 control-label">
		Bid Bonds</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_BID" 
		id="pb-container-checkbox-GENERAL-IS_BID">	
		
		<asp:TextBox ID="GENERAL__IS_BID" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_BID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Bid Bonds"
			ClientValidationFunction="onValidate_GENERAL__IS_BID" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_MATERIAL" for="ctl00_cntMainBody_GENERAL__IS_MATERIAL" class="col-md-4 col-sm-3 control-label">
		Material Guarantees (On or Off Site)</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_MATERIAL" 
		id="pb-container-checkbox-GENERAL-IS_MATERIAL">	
		
		<asp:TextBox ID="GENERAL__IS_MATERIAL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_MATERIAL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Material Guarantees (On or Off Site)"
			ClientValidationFunction="onValidate_GENERAL__IS_MATERIAL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_PERFORMANCE" for="ctl00_cntMainBody_GENERAL__IS_PERFORMANCE" class="col-md-4 col-sm-3 control-label">
		Performance Guarantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_PERFORMANCE" 
		id="pb-container-checkbox-GENERAL-IS_PERFORMANCE">	
		
		<asp:TextBox ID="GENERAL__IS_PERFORMANCE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_PERFORMANCE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Performance Guarantees"
			ClientValidationFunction="onValidate_GENERAL__IS_PERFORMANCE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_RETENTION" for="ctl00_cntMainBody_GENERAL__IS_RETENTION" class="col-md-4 col-sm-3 control-label">
		Retention Bonds</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_RETENTION" 
		id="pb-container-checkbox-GENERAL-IS_RETENTION">	
		
		<asp:TextBox ID="GENERAL__IS_RETENTION" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_RETENTION" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Retention Bonds"
			ClientValidationFunction="onValidate_GENERAL__IS_RETENTION" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide6514ab9caaa4783880d2237b83d2daf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide6514ab9caaa4783880d2237b83d2daf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide6514ab9caaa4783880d2237b83d2daf div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide6514ab9caaa4783880d2237b83d2daf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide6514ab9caaa4783880d2237b83d2daf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide6514ab9caaa4783880d2237b83d2daf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide6514ab9caaa4783880d2237b83d2daf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide6514ab9caaa4783880d2237b83d2daf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide6514ab9caaa4783880d2237b83d2daf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide6514ab9caaa4783880d2237b83d2daf input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf0e9370c5c304160b097f9e10c3ac681" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf0e9370c5c304160b097f9e10c3ac681 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf0e9370c5c304160b097f9e10c3ac681 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf0e9370c5c304160b097f9e10c3ac681 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf0e9370c5c304160b097f9e10c3ac681 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf0e9370c5c304160b097f9e10c3ac681 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf0e9370c5c304160b097f9e10c3ac681 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf0e9370c5c304160b097f9e10c3ac681 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf0e9370c5c304160b097f9e10c3ac681 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf0e9370c5c304160b097f9e10c3ac681 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf0e9370c5c304160b097f9e10c3ac681 input{text-align:left;}"; break;
		}
	}
