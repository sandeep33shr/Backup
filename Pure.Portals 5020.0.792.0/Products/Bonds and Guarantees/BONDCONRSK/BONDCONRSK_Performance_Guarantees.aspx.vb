...
Namespace Nexus
    Partial Class PB2_BONDCONRSK_Performance_Guarantees : Inherits BaseRisk
		...
		Protected Sub onValidate_PERFORMANCE__TOWN()
        
End Sub
Protected Sub onValidate_PERFORMANCE__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PERFORMANCE__TOWN()
    onValidate_PERFORMANCE__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("PERFORMANCE__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("PERFORMANCE__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("PERFORMANCE__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('PERFORMANCE', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('PERFORMANCE', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('PERFORMANCE', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('PERFORMANCE', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('PERFORMANCE', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('PERFORMANCE', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('PERFORMANCE', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('PERFORMANCE', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = PERFORMANCE__LINE1.Text
        	Dim Suburb as String = PERFORMANCE__SUBURB.Text
