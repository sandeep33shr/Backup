...
Namespace Nexus
    Partial Class PB2_BONDCONRSK_Advance_Payment_Guarantees : Inherits BaseRisk
		...
		Protected Sub onValidate_ADVANCE__TOWN()
        
End Sub
Protected Sub onValidate_ADVANCE__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ADVANCE__TOWN()
    onValidate_ADVANCE__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("ADVANCE__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("ADVANCE__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("ADVANCE__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('ADVANCE', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('ADVANCE', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('ADVANCE', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('ADVANCE', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('ADVANCE', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('ADVANCE', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('ADVANCE', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('ADVANCE', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = ADVANCE__LINE1.Text
        	Dim Suburb as String = ADVANCE__SUBURB.Text
