...
Namespace Nexus
    Partial Class PB2_MATSNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_MATS_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If MATS_DETAILS__Date_Created.Text.ToString = "" Then
        		MATS_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		MATS_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_MATS_DETAILS__NOTE_DETAILS()
End Sub
