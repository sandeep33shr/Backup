...
Namespace Nexus
    Partial Class PB2_BIDSNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_BIDS_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If BIDS_DETAILS__Date_Created.Text.ToString = "" Then
        		BIDS_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		BIDS_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_BIDS_DETAILS__NOTE_DETAILS()
End Sub
