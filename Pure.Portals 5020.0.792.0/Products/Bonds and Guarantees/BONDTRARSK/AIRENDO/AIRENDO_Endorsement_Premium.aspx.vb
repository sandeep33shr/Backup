...
Namespace Nexus
    Partial Class PB2_AIRENDO_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_AIRLINE_CLAUSEPREM__COUNTER_ID()
        
End Sub
Protected Sub onValidate_AIRLINE_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_AIRLINE_CLAUSEPREM__COUNTER_ID()
    onValidate_AIRLINE_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'AIRLINE - Parent object
        'AIRLINE_CLAUSEPREM - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "AIRLINE" & "/" & "AIRLINE_CLAUSEPREM", sXMLDataset)
                            If sChildId <> "0" Then
                                AIRLINE_CLAUSEPREM__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        'Parameters:
        'AIRLINE - Standard Wording Parent Object
        'AIRLINE_CLAUSES - Standard Wording Parent Property
        'AIRLINE_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/AIRLINE/SW.AIRLINE_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("AIRLINE_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/AIRLINE/AIRLINE_CLAUSEPREM")
        
        	Dim CurrentSelected As String = AIRLINE_CLAUSEPREM__ENDORSE_CAP.Text
