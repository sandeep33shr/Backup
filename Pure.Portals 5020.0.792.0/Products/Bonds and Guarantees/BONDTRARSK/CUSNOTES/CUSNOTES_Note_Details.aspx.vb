...
Namespace Nexus
    Partial Class PB2_CUSNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CUST_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CUST_DETAILS__Date_Created.Text.ToString = "" Then
        		CUST_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CUST_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_CUST_DETAILS__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CUST_DETAILS__NOTE_DETAILS()
    onValidate_CUST_DETAILS__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		CUST_DETAILS__NoteCheck.Text = 1
        	End If
        End Sub
