<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="NAMNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_NAMNOTES_Note_Details" %>
...
function onValidate_NAMP_DETAILS__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NAMP_DETAILS", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NAMP_DETAILS", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("NAMP_DETAILS", "DATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=NAMP_DETAILS&propertyName=DATE_CREATED&name={name}");
...
function onValidate_NAMP_DETAILS__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NAMP_DETAILS", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NAMP_DETAILS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("NAMP_DETAILS", "CREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_NAMP_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NAMP_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("NAMP_DETAILS", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NAMP_DETAILS.COVER_TYPE");
        			window.setControlWidth(field, "3", "NAMP_DETAILS", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=NAMP_DETAILS&propertyName=COVER_TYPE&name={name}");
        		
        		var value = new Expression("'Namport Guarantee'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_NAMP_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NAMP_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("NAMP_DETAILS", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NAMP_DETAILS.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "3", "NAMP_DETAILS", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("NAMP_DETAILS", "NOTE_DESCRIPTION");
        		var exp = new Expression("NAMP_DETAILS.NoteCheck = 1");
...
function onValidate_NAMP_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NAMP_DETAILS", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("NAMP_DETAILS", "NOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("NAMP_DETAILS.NOTE_DETAILS");
        			window.setControlWidth(field, "3", "NAMP_DETAILS", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=NAMP_DETAILS&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_NAMP_DETAILS__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_NAMP_DETAILS_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function onValidate_NAMP_DETAILS__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NAMP_DETAILS", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("NAMP_DETAILS", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_NAMP_DETAILS__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_NAMP_DETAILS__CREATED_BY(null, null, null, isOnLoad);
    onValidate_NAMP_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_NAMP_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_NAMP_DETAILS__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_NAMP_DETAILS__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="ida9e5c6c615124b9782cf871bcae1ce27" class="general-layout-container">
...
<div id="id4eb29b382f324d2eb91d4250408c3afa" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="NAMP_DETAILS" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-NAMP_DETAILS-DATE_CREATED">
		<asp:Label ID="lblNAMP_DETAILS_DATE_CREATED" runat="server" AssociatedControlID="NAMP_DETAILS__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="NAMP_DETAILS__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calNAMP_DETAILS__DATE_CREATED" runat="server" LinkedControl="NAMP_DETAILS__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valNAMP_DETAILS_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_NAMP_DETAILS__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-NAMP_DETAILS-CREATED_BY">

		
		<asp:Label ID="lblNAMP_DETAILS_CREATED_BY" runat="server" AssociatedControlID="NAMP_DETAILS__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="NAMP_DETAILS__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valNAMP_DETAILS_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_NAMP_DETAILS__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-NAMP_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblNAMP_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="NAMP_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="NAMP_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valNAMP_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_NAMP_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-NAMP_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblNAMP_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="NAMP_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="NAMP_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valNAMP_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_NAMP_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-NAMP_DETAILS-NOTE_DETAILS">
		<asp:Label ID="lblNAMP_DETAILS_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="NAMP_DETAILS__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="NAMP_DETAILS__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valNAMP_DETAILS_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_NAMP_DETAILS__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblNAMP_DETAILS_NoteCheck" for="ctl00_cntMainBody_NAMP_DETAILS__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-NAMP_DETAILS-NoteCheck">	
		
		<asp:TextBox ID="NAMP_DETAILS__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valNAMP_DETAILS_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_NAMP_DETAILS__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4eb29b382f324d2eb91d4250408c3afa div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4eb29b382f324d2eb91d4250408c3afa div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4eb29b382f324d2eb91d4250408c3afa div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4eb29b382f324d2eb91d4250408c3afa label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4eb29b382f324d2eb91d4250408c3afa label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4eb29b382f324d2eb91d4250408c3afa label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4eb29b382f324d2eb91d4250408c3afa label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4eb29b382f324d2eb91d4250408c3afa input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4eb29b382f324d2eb91d4250408c3afa input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4eb29b382f324d2eb91d4250408c3afa input{text-align:left;}"; break;
		}
	}
