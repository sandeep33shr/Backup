...
Namespace Nexus
    Partial Class PB2_AIRSNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_AIRS_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If AIRS_DETAILS__Date_Created.Text.ToString = "" Then
        		AIRS_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		AIRS_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_AIRS_DETAILS__NOTE_DETAILS()
End Sub
