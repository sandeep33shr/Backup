<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="BONDTRARSK_Risk_Details.aspx.vb" Inherits="Nexus.PB2_BONDTRARSK_Risk_Details" %>
...
function onValidate_GENERAL__HNTGMTA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "HNTGMTA", "ChildScreen");
        })();
}
function onValidate_GENERAL__IS_AIRLINE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_AIRLINE", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_AIRLINE");
        		var exp = new Expression("GENERAL.IS_CUSTOMS==1 || GENERAL.IS_FUEL==1 || GENERAL.IS_OTHER==1 || GENERAL.IS_RENTAL==1 || GENERAL.IS_NAMPORT==1 || GENERAL.IS_ELECTRIC==1");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_AIRLINE");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_AIRLINE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_AIRLINE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_CUSTOMS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_CUSTOMS", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_CUSTOMS");
        		var exp = new Expression("GENERAL.IS_AIRLINE==1 || GENERAL.IS_FUEL==1 || GENERAL.IS_OTHER==1 || GENERAL.IS_RENTAL==1 || GENERAL.IS_NAMPORT==1 || GENERAL.IS_ELECTRIC==1");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_CUSTOMS");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_CUSTOMS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_CUSTOMS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_FUEL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_FUEL", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_FUEL");
        		var exp = new Expression("GENERAL.IS_AIRLINE==1 || GENERAL.IS_CUSTOMS==1 || GENERAL.IS_OTHER==1 || GENERAL.IS_RENTAL==1 || GENERAL.IS_NAMPORT==1 || GENERAL.IS_ELECTRIC==1");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_FUEL");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_FUEL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_FUEL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_OTHER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_OTHER", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_OTHER");
        		var exp = new Expression("GENERAL.IS_AIRLINE==1 || GENERAL.IS_CUSTOMS==1 || GENERAL.IS_FUEL==1 || GENERAL.IS_RENTAL==1 || GENERAL.IS_NAMPORT==1 || GENERAL.IS_ELECTRIC==1");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_OTHER");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_OTHER');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_OTHER_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_RENTAL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_RENTAL", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_RENTAL");
        		var exp = new Expression("GENERAL.IS_AIRLINE==1 || GENERAL.IS_CUSTOMS==1 || GENERAL.IS_FUEL==1 || GENERAL.IS_OTHER==1 || GENERAL.IS_NAMPORT==1 || GENERAL.IS_ELECTRIC==1");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_RENTAL");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_RENTAL');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_RENTAL_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_NAMPORT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_NAMPORT", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_NAMPORT");
        		var exp = new Expression("GENERAL.IS_AIRLINE==1 || GENERAL.IS_CUSTOMS==1 || GENERAL.IS_FUEL==1 || GENERAL.IS_OTHER==1 || GENERAL.IS_RENTAL==1 || GENERAL.IS_ELECTRIC==1");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_NAMPORT");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_NAMPORT');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_NAMPORT_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__IS_ELECTRIC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "IS_ELECTRIC", "Checkbox");
        })();
        /**
         * @fileoverview
         * ReadOnlyWhen
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "IS_ELECTRIC");
        		var exp = new Expression("GENERAL.IS_AIRLINE==1 || GENERAL.IS_CUSTOMS==1 || GENERAL.IS_FUEL==1 || GENERAL.IS_OTHER==1 || GENERAL.IS_RENTAL==1 || GENERAL.IS_NAMPORT==1");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_IS_ELECTRIC");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__IS_ELECTRIC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__IS_ELECTRIC_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Please select a Guarantee to proceed")) ? "Please select a Guarantee to proceed" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "IS_ELECTRIC");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "IS_ELECTRIC");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("GENERAL.IS_AIRLINE == 1 || GENERAL.IS_CUSTOMS == 1 || GENERAL.IS_FUEL == 1 || GENERAL.IS_OTHER == 1 || GENERAL.IS_RENTAL == 1 || GENERAL.IS_NAMPORT == 1 || GENERAL.IS_ELECTRIC == 1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_GENERAL__MINPREM_INCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "MINPREM_INCL", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "MINPREM_INCL");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__CLIENT_CHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CLIENT_CHECK", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "CLIENT_CHECK");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__CAPACITY_AVAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CAPACITY_AVAIL", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "CAPACITY_AVAIL");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_GENERAL__FACILITY_RATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "FACILITY_RATE", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "FACILITY_RATE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__HNTGMTA(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_AIRLINE(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_CUSTOMS(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_FUEL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_OTHER(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_RENTAL(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_NAMPORT(null, null, null, isOnLoad);
    onValidate_GENERAL__IS_ELECTRIC(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__MINPREM_INCL(null, null, null, isOnLoad);
    onValidate_GENERAL__CLIENT_CHECK(null, null, null, isOnLoad);
    onValidate_GENERAL__CAPACITY_AVAIL(null, null, null, isOnLoad);
    onValidate_GENERAL__FACILITY_RATE(null, null, null, isOnLoad);
...
<div id="id4a86d81eca294480a2a2ec5353abd009" class="general-layout-container">
...
<div id="idcac515475065419192c5be5811f44ac6" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idcac515475065419192c5be5811f44ac6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcac515475065419192c5be5811f44ac6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcac515475065419192c5be5811f44ac6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idcac515475065419192c5be5811f44ac6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcac515475065419192c5be5811f44ac6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcac515475065419192c5be5811f44ac6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcac515475065419192c5be5811f44ac6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcac515475065419192c5be5811f44ac6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcac515475065419192c5be5811f44ac6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcac515475065419192c5be5811f44ac6 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__HNTGMTA"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="HNTGMTA" 
		id="pb-container-childscreen-GENERAL-HNTGMTA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="HNTGMTA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="HNTGMTA/HNTGMTA_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_HNTGMTA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.HNTGMTA"
						ClientValidationFunction="onValidate_GENERAL__HNTGMTA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id166e268d00004bf483fa3a2d0bb3a6d0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Cover Details " /></legend>
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_AIRLINE" for="ctl00_cntMainBody_GENERAL__IS_AIRLINE" class="col-md-4 col-sm-3 control-label">
		Airline Guarantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_AIRLINE" 
		id="pb-container-checkbox-GENERAL-IS_AIRLINE">	
		
		<asp:TextBox ID="GENERAL__IS_AIRLINE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_AIRLINE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Airline Guarantees"
			ClientValidationFunction="onValidate_GENERAL__IS_AIRLINE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_CUSTOMS" for="ctl00_cntMainBody_GENERAL__IS_CUSTOMS" class="col-md-4 col-sm-3 control-label">
		Customs Guarantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_CUSTOMS" 
		id="pb-container-checkbox-GENERAL-IS_CUSTOMS">	
		
		<asp:TextBox ID="GENERAL__IS_CUSTOMS" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_CUSTOMS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Customs Guarantees"
			ClientValidationFunction="onValidate_GENERAL__IS_CUSTOMS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_FUEL" for="ctl00_cntMainBody_GENERAL__IS_FUEL" class="col-md-4 col-sm-3 control-label">
		Fuel Guarantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_FUEL" 
		id="pb-container-checkbox-GENERAL-IS_FUEL">	
		
		<asp:TextBox ID="GENERAL__IS_FUEL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_FUEL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Fuel Guarantees"
			ClientValidationFunction="onValidate_GENERAL__IS_FUEL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_OTHER" for="ctl00_cntMainBody_GENERAL__IS_OTHER" class="col-md-4 col-sm-3 control-label">
		Other Guarantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_OTHER" 
		id="pb-container-checkbox-GENERAL-IS_OTHER">	
		
		<asp:TextBox ID="GENERAL__IS_OTHER" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_OTHER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Other Guarantees"
			ClientValidationFunction="onValidate_GENERAL__IS_OTHER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_RENTAL" for="ctl00_cntMainBody_GENERAL__IS_RENTAL" class="col-md-4 col-sm-3 control-label">
		Rental Guarantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_RENTAL" 
		id="pb-container-checkbox-GENERAL-IS_RENTAL">	
		
		<asp:TextBox ID="GENERAL__IS_RENTAL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_RENTAL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Rental Guarantees"
			ClientValidationFunction="onValidate_GENERAL__IS_RENTAL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_NAMPORT" for="ctl00_cntMainBody_GENERAL__IS_NAMPORT" class="col-md-4 col-sm-3 control-label">
		Namport Guarantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_NAMPORT" 
		id="pb-container-checkbox-GENERAL-IS_NAMPORT">	
		
		<asp:TextBox ID="GENERAL__IS_NAMPORT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_NAMPORT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Namport Guarantees"
			ClientValidationFunction="onValidate_GENERAL__IS_NAMPORT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblGENERAL_IS_ELECTRIC" for="ctl00_cntMainBody_GENERAL__IS_ELECTRIC" class="col-md-4 col-sm-3 control-label">
		Electricity Guarantees</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="GENERAL" 
		data-property-name="IS_ELECTRIC" 
		id="pb-container-checkbox-GENERAL-IS_ELECTRIC">	
		
		<asp:TextBox ID="GENERAL__IS_ELECTRIC" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valGENERAL_IS_ELECTRIC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Electricity Guarantees"
			ClientValidationFunction="onValidate_GENERAL__IS_ELECTRIC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id166e268d00004bf483fa3a2d0bb3a6d0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id166e268d00004bf483fa3a2d0bb3a6d0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id166e268d00004bf483fa3a2d0bb3a6d0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id166e268d00004bf483fa3a2d0bb3a6d0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id166e268d00004bf483fa3a2d0bb3a6d0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id166e268d00004bf483fa3a2d0bb3a6d0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id166e268d00004bf483fa3a2d0bb3a6d0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id166e268d00004bf483fa3a2d0bb3a6d0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id166e268d00004bf483fa3a2d0bb3a6d0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id166e268d00004bf483fa3a2d0bb3a6d0 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id55d553a744b047469ce86dd581faccc7" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="GENERAL" 
		data-property-name="MINPREM_INCL" 
		id="pb-container-currency-GENERAL-MINPREM_INCL">
		<asp:Label ID="lblGENERAL_MINPREM_INCL" runat="server" AssociatedControlID="GENERAL__MINPREM_INCL" 
			Text="Minimum Amount" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__MINPREM_INCL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGENERAL_MINPREM_INCL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Minimum Amount"
			ClientValidationFunction="onValidate_GENERAL__MINPREM_INCL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="GENERAL" 
		data-property-name="CLIENT_CHECK" 
		id="pb-container-integer-GENERAL-CLIENT_CHECK">
		<asp:Label ID="lblGENERAL_CLIENT_CHECK" runat="server" AssociatedControlID="GENERAL__CLIENT_CHECK" 
			Text="Check if details were added" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="GENERAL__CLIENT_CHECK" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valGENERAL_CLIENT_CHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check if details were added"
			ClientValidationFunction="onValidate_GENERAL__CLIENT_CHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="GENERAL" 
		data-property-name="CAPACITY_AVAIL" 
		id="pb-container-currency-GENERAL-CAPACITY_AVAIL">
		<asp:Label ID="lblGENERAL_CAPACITY_AVAIL" runat="server" AssociatedControlID="GENERAL__CAPACITY_AVAIL" 
			Text="Capacity Available" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__CAPACITY_AVAIL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGENERAL_CAPACITY_AVAIL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Capacity Available"
			ClientValidationFunction="onValidate_GENERAL__CAPACITY_AVAIL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-GENERAL-FACILITY_RATE">
		<asp:Label ID="lblGENERAL_FACILITY_RATE" runat="server" AssociatedControlID="GENERAL__FACILITY_RATE" 
			Text="Current Facility Rate" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="GENERAL__FACILITY_RATE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valGENERAL_FACILITY_RATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Current Facility Rate"
			ClientValidationFunction="onValidate_GENERAL__FACILITY_RATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id55d553a744b047469ce86dd581faccc7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id55d553a744b047469ce86dd581faccc7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id55d553a744b047469ce86dd581faccc7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id55d553a744b047469ce86dd581faccc7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id55d553a744b047469ce86dd581faccc7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id55d553a744b047469ce86dd581faccc7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id55d553a744b047469ce86dd581faccc7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id55d553a744b047469ce86dd581faccc7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id55d553a744b047469ce86dd581faccc7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id55d553a744b047469ce86dd581faccc7 input{text-align:left;}"; break;
		}
	}
