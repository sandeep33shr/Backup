...
Namespace Nexus
    Partial Class PB2_BONDTRARSK_Risk_Details : Inherits BaseRisk
...
Protected Sub onValidate_GENERAL__TRANSTYPE()
        ...
        End If
End Sub
Protected Sub onValidate_GENERAL__FACILITY_RATE()
...
Protected Sub CallRuleScripts()
    ...
    onValidate_GENERAL__FACILITY_RATE()
...
End Sub
        ...
        Protected Sub SetFacility()
            ...
            If oWebService.GetParty(oQuote.PartyKey).GetType.Name = "CorporateParty" Then
        		...
        		Dim Capacity As String = GetDatafromXML("//CCLIENT", "FACILITY_AVAIL", oParty.XMLDataset)
        		Dim Rate As String = GetDatafromXML("//CCLIENT", "FACILITY_RATE", oParty.XMLDataset)
        	End If
        	...
        	If oWebService.GetParty(oQuote.PartyKey).GetType.Name = "CorporateParty" Then
        		...
        		If Capacity <> "" Then
        			GENERAL__CAPACITY_AVAIL.Text = Capacity
        			GENERAL__FACILITY_RATE.Text = Rate
        			GENERAL__CLIENT_CHECK.Text = 1
        		Else
        			GENERAL__CLIENT_CHECK.Text = 0
        		End If
        	End If
        End Sub
