...
Namespace Nexus
    Partial Class PB2_BONDTRARSK_Electricity_Guarantees : Inherits BaseRisk
		...
		Protected Sub onValidate_ELECTRIC__TOWN()
        
End Sub
Protected Sub onValidate_ELECTRIC__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ELECTRIC__TOWN()
    onValidate_ELECTRIC__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("ELECTRIC__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("ELECTRIC__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("ELECTRIC__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('ELECTRIC', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('ELECTRIC', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('ELECTRIC', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('ELECTRIC', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('ELECTRIC', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('ELECTRIC', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('ELECTRIC', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('ELECTRIC', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = ELECTRIC__LINE1.Text
        	Dim Suburb as String = ELECTRIC__SUBURB.Text
