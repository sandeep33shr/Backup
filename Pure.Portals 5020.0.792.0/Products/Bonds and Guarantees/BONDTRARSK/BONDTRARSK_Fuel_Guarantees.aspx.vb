...
Namespace Nexus
    Partial Class PB2_BONDTRARSK_Fuel_Guarantees : Inherits BaseRisk
		...
		Protected Sub onValidate_FUEL__TOWN()
        
End Sub
Protected Sub onValidate_FUEL__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FUEL__TOWN()
    onValidate_FUEL__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("FUEL__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("FUEL__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("FUEL__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('FUEL', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('FUEL', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('FUEL', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('FUEL', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('FUEL', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('FUEL', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('FUEL', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('FUEL', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = FUEL__LINE1.Text
        	Dim Suburb as String = FUEL__SUBURB.Text
