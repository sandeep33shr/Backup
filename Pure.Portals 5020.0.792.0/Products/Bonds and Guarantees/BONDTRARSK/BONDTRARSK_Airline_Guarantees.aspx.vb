...
Namespace Nexus
    Partial Class PB2_BONDTRARSK_Airline_Guarantees : Inherits BaseRisk
		...
		Protected Sub onValidate_AIRLINE__TOWN()
        
End Sub
Protected Sub onValidate_AIRLINE__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_AIRLINE__TOWN()
    onValidate_AIRLINE__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("AIRLINE__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("AIRLINE__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("AIRLINE__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('AIRLINE', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('AIRLINE', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('AIRLINE', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('AIRLINE', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('AIRLINE', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('AIRLINE', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('AIRLINE', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('AIRLINE', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = AIRLINE__LINE1.Text
        	Dim Suburb as String = AIRLINE__SUBURB.Text
