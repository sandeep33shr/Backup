...
Namespace Nexus
    Partial Class PB2_CUSSNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_CUSTS_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CUSTS_DETAILS__Date_Created.Text.ToString = "" Then
        		CUSTS_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CUSTS_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_CUSTS_DETAILS__NOTE_DETAILS()
End Sub
