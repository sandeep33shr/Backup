...
Namespace Nexus
    Partial Class PB2_BONDTRARSK_Namport_Guarantees : Inherits BaseRisk
		...
		Protected Sub onValidate_NAMPORT__TOWN()
        
End Sub
Protected Sub onValidate_NAMPORT__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_NAMPORT__TOWN()
    onValidate_NAMPORT__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("NAMPORT__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("NAMPORT__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("NAMPORT__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('NAMPORT', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('NAMPORT', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('NAMPORT', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('NAMPORT', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('NAMPORT', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('NAMPORT', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('NAMPORT', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('NAMPORT', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = NAMPORT__LINE1.Text
        	Dim Suburb as String = NAMPORT__SUBURB.Text
