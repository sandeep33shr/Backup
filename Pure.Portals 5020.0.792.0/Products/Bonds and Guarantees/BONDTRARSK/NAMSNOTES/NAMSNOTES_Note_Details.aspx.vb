...
Namespace Nexus
    Partial Class PB2_NAMSNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_NAMPS_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If NAMPS_DETAILS__Date_Created.Text.ToString = "" Then
        		NAMPS_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		NAMPS_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_NAMPS_DETAILS__NOTE_DETAILS()
End Sub
