...
Namespace Nexus
    Partial Class PB2_CUSENDO_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_CUSTOM_CLAUSEPREM__COUNTER_ID()
        
End Sub
Protected Sub onValidate_CUSTOM_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CUSTOM_CLAUSEPREM__COUNTER_ID()
    onValidate_CUSTOM_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'CUSTOM - Parent object
        'CUSTOM_CLAUSEPREM - Child object
        		 ...
        		 Dim oQuote As NexusProvider.Quote = Session(CNQuote)
                    ...
                    If (transactionValue <> "VIEW") Then
                        ...
                        For index = 0 To oQuote.Risks.Count - 1
                            ...
                            Dim sChildId As String = GetAutoNumber("//" & "CUSTOM" & "/" & "CUSTOM_CLAUSEPREM", sXMLDataset)
                            If sChildId <> "0" Then
                                CUSTOM_CLAUSEPREM__COUNTER_ID.Text = "I" & sChildId
                            End If
                        Next
        ...
        'Parameters:
        'CUSTOM - Standard Wording Parent Object
        'CUSTOM_CLAUSES - Standard Wording Parent Property
        'CUSTOM_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/CUSTOM/SW.CUSTOM_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("CUSTOM_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/CUSTOM/CUSTOM_CLAUSEPREM")
        
        	Dim CurrentSelected As String = CUSTOM_CLAUSEPREM__ENDORSE_CAP.Text
