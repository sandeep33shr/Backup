<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="BONDTRARSK_Notes.aspx.vb" Inherits="Nexus.PB2_BONDTRARSK_Notes" %>
...
function onValidate_NOTES__BTRADNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "BTRADNOTES", "ChildScreen");
        })();
}
function onValidate_NOTES__TRADNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "TRADNOTES", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__BTRADNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__TRADNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="idb3d1c5834fb24a0299ed2c794bced950" class="general-layout-container">
...
<div id="ida8a59a894d754f039ad08ca936d69fd8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading102" runat="server" Text="Personal Computer Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__BTRADNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="BTRADNOTES" 
		id="pb-container-childscreen-NOTES-BTRADNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="BTRADNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="BTRADNOTES/BTRADNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_BTRADNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__BTRADNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida8a59a894d754f039ad08ca936d69fd8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida8a59a894d754f039ad08ca936d69fd8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida8a59a894d754f039ad08ca936d69fd8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida8a59a894d754f039ad08ca936d69fd8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida8a59a894d754f039ad08ca936d69fd8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida8a59a894d754f039ad08ca936d69fd8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida8a59a894d754f039ad08ca936d69fd8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida8a59a894d754f039ad08ca936d69fd8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida8a59a894d754f039ad08ca936d69fd8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida8a59a894d754f039ad08ca936d69fd8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4060da9d949e4377ade6be864c57c4d5" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading103" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__TRADNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="TRADNOTES" 
		id="pb-container-childscreen-NOTES-TRADNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__EXT_DETAILS" runat="server" ScreenCode="TRADNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRADNOTES/TRADNOTES_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_TRADNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__TRADNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4060da9d949e4377ade6be864c57c4d5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4060da9d949e4377ade6be864c57c4d5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4060da9d949e4377ade6be864c57c4d5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4060da9d949e4377ade6be864c57c4d5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4060da9d949e4377ade6be864c57c4d5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4060da9d949e4377ade6be864c57c4d5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4060da9d949e4377ade6be864c57c4d5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4060da9d949e4377ade6be864c57c4d5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4060da9d949e4377ade6be864c57c4d5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4060da9d949e4377ade6be864c57c4d5 input{text-align:left;}"; break;
		}
	}
