...
Namespace Nexus
    Partial Class PB2_BONDTRARSK_Rental_Guarantees : Inherits BaseRisk
		...
		Protected Sub onValidate_RENTAL__TOWN()
        
End Sub
Protected Sub onValidate_RENTAL__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RENTAL__TOWN()
    onValidate_RENTAL__COUNTRY()
End Sub
        ...
        Protected Sub LoadOtherAddressList()
        	...
        	Dim SiteAddressScheme As Object = oMaster.FindControl("RENTAL__SITEADDRESSLIST")
        	Dim HomeAddressScheme As Object = oMaster.FindControl("RENTAL__HOMEADDRESSLIST")
        	Dim BusinessAddressScheme As Object = oMaster.FindControl("RENTAL__B_ADDRESSLIST")
        ...
        Protected Sub addressASyncPostback(ByVal addressLine as String,ByVal suburb as String,ByVal town as String, ByVal postCode as String, byVal country as String, byVal region as String, byVal vRatingArea as String )
        	...
        	buildScript += "Field.getInstance('RENTAL', 'LINE1').setValue('"+ addressLine +"');"
        	buildScript += "Field.getInstance('RENTAL', 'SUBURB').setValue('"+ suburb +"');"
        	buildScript += "Field.getInstance('RENTAL', 'TOWN').setValue('"+ town +"');"
        	buildScript += "Field.getInstance('RENTAL', 'REGION').setValue('"+ region +"');"
        	buildScript += "Field.getInstance('RENTAL', 'POSTCODE').setValue('"+ postCode +"');"
        	buildScript += "Field.getInstance('RENTAL', 'AREACODE').setValue('"+ vRatingArea +"');"
        	buildScript += "Field.getInstance('RENTAL', 'COUNTRY').setByCode('"+ Trim(country) +"');"
        
        	If addressLine = "" Then
        		buildScript += "Field.getInstance('RENTAL', 'COUNTRY').setValue(3);"
        	End If
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = RENTAL__LINE1.Text
        	Dim Suburb as String = RENTAL__SUBURB.Text
