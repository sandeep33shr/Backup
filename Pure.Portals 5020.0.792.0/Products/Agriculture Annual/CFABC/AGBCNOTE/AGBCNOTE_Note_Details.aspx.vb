...
Namespace Nexus
    Partial Class PB2_AGBCNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_BC_NOTE_DETAILS__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If BC_NOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		BC_NOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		BC_NOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_BC_NOTE_DETAILS__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BC_NOTE_DETAILS__Note_Details()
    onValidate_BC_NOTE_DETAILS__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		BC_NOTE_DETAILS__NoteCheck.Text = 1
        	End If
        End Sub
