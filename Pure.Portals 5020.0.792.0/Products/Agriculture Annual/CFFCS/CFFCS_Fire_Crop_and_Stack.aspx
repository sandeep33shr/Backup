<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CFFCS_Fire_Crop_and_Stack.aspx.vb" Inherits="Nexus.PB2_CFFCS_Fire_Crop_and_Stack" %>
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("Code(CWIRISK.IS_VAT) = '' OR Code(CWIRISK.IS_VAT) = null")) ? new Expression("Code(CWIRISK.IS_VAT) = '' OR Code(CWIRISK.IS_VAT) = null") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_CPIRSK__RISKITEMS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "RISKITEMS", "ChildScreen");
        })();
}
...
function onValidate_CPIRSK__CFFENDOS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CFFENDOS", "ChildScreen");
        })();
}
function onValidate_CPIRSK__CFFSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CFFSNOTES", "ChildScreen");
        })();
}
function onValidate_CPIRSK__CFFNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPIRSK", "CFFNOTES", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CPIRSK__RISKITEMS(null, null, null, isOnLoad);
    ...
    onValidate_CPIRSK__CFFENDOS(null, null, null, isOnLoad);
    onValidate_CPIRSK__CFFSNOTES(null, null, null, isOnLoad);
    onValidate_CPIRSK__CFFNOTES(null, null, null, isOnLoad);
...
<div id="idf1e713f452a742ad99fa94d460754eff" class="general-layout-container">
...
<div id="id729dde4efc5845ba9a71c3775924405a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id729dde4efc5845ba9a71c3775924405a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id729dde4efc5845ba9a71c3775924405a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id729dde4efc5845ba9a71c3775924405a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id729dde4efc5845ba9a71c3775924405a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id729dde4efc5845ba9a71c3775924405a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id729dde4efc5845ba9a71c3775924405a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id729dde4efc5845ba9a71c3775924405a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id729dde4efc5845ba9a71c3775924405a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id729dde4efc5845ba9a71c3775924405a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id729dde4efc5845ba9a71c3775924405a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id16778cde631e4a0b8f7130669cfc9086" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Address" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id16778cde631e4a0b8f7130669cfc9086 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id16778cde631e4a0b8f7130669cfc9086 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id16778cde631e4a0b8f7130669cfc9086 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id16778cde631e4a0b8f7130669cfc9086 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id16778cde631e4a0b8f7130669cfc9086 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id16778cde631e4a0b8f7130669cfc9086 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id16778cde631e4a0b8f7130669cfc9086 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id16778cde631e4a0b8f7130669cfc9086 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id16778cde631e4a0b8f7130669cfc9086 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id16778cde631e4a0b8f7130669cfc9086 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida173b28c15854de5848f2821be691d3f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading21" runat="server" Text="Industry" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida173b28c15854de5848f2821be691d3f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida173b28c15854de5848f2821be691d3f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida173b28c15854de5848f2821be691d3f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida173b28c15854de5848f2821be691d3f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida173b28c15854de5848f2821be691d3f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida173b28c15854de5848f2821be691d3f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida173b28c15854de5848f2821be691d3f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida173b28c15854de5848f2821be691d3f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida173b28c15854de5848f2821be691d3f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida173b28c15854de5848f2821be691d3f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id65c46dfe047b453aa1ae61e264f97a50" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading22" runat="server" Text="Risk Items" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__RISKITEMS"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="RISKITEMS" 
		id="pb-container-childscreen-CPIRSK-RISKITEMS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__RISKDET" runat="server" ScreenCode="RISKITEMS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RISKITEMS/RISKITEMS_Risk_Item.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Added" DataField="DATE" DataFormatString="Y"/>
<Nexus:GISLookupField HeaderText="Type" ListType="PMLookup" ListCode="UDL_CS_TYPE" DataField="ITEM_TYPE" DataItemValue="key" />
<Nexus:RiskAttribute HeaderText="Description" DataField="DES" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Rainfall" ListType="PMLookup" ListCode="UDL_CS_RAINFALL" DataField="RAIN_FALL" DataItemValue="key" />
<Nexus:GISLookupField HeaderText="Period" ListType="PMLookup" ListCode="UDL_CS_PERIOD" DataField="PERIOD" DataItemValue="key" />
<Nexus:RiskAttribute HeaderText="Hectare" DataField="HECTARE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Sum Insured" DataField="RISKD_SI" DataFormatString="{0:N}"/>
<Nexus:RiskAttribute HeaderText="Rate" DataField="RISKD_RATE" DataFormatString="{0:0}%"/>
<Nexus:RiskAttribute HeaderText="Premium" DataField="RISKD_PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPIRSK_RISKITEMS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CPIRSK.RISKITEMS"
						ClientValidationFunction="onValidate_CPIRSK__RISKITEMS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id65c46dfe047b453aa1ae61e264f97a50 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id65c46dfe047b453aa1ae61e264f97a50 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id65c46dfe047b453aa1ae61e264f97a50 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id65c46dfe047b453aa1ae61e264f97a50 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id65c46dfe047b453aa1ae61e264f97a50 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65c46dfe047b453aa1ae61e264f97a50 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65c46dfe047b453aa1ae61e264f97a50 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id65c46dfe047b453aa1ae61e264f97a50 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id65c46dfe047b453aa1ae61e264f97a50 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id65c46dfe047b453aa1ae61e264f97a50 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3a21ff9bfc2448c49da6ddc1fafff916" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading23" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label6">
		<span class="label" id="label6">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label7">
		<span class="label" id="label7">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label8">
		<span class="label" id="label8">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label9">
		<span class="label" id="label9">Riot & Strike </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label10">
		<span class="label" id="label10">Transit </span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label12">
		<span class="label" id="label12">Total </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3a21ff9bfc2448c49da6ddc1fafff916 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3a21ff9bfc2448c49da6ddc1fafff916 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3a21ff9bfc2448c49da6ddc1fafff916 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3a21ff9bfc2448c49da6ddc1fafff916 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3a21ff9bfc2448c49da6ddc1fafff916 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3a21ff9bfc2448c49da6ddc1fafff916 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3a21ff9bfc2448c49da6ddc1fafff916 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3a21ff9bfc2448c49da6ddc1fafff916 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3a21ff9bfc2448c49da6ddc1fafff916 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3a21ff9bfc2448c49da6ddc1fafff916 input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading24" runat="server" Text="Endorsements" /></legend>
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__CFFENDOS"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="CFFENDOS" 
		id="pb-container-childscreen-CPIRSK-CFFENDOS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__CLAUSEPREM" runat="server" ScreenCode="CFFENDOS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CFFENDOS/CFFENDOS_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPIRSK_CFFENDOS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CPIRSK.CFFENDOS"
						ClientValidationFunction="onValidate_CPIRSK__CFFENDOS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idced8e299dc9747b6b929edbcd172b4a0" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__CFFSNOTES"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="CFFSNOTES" 
		id="pb-container-childscreen-CPIRSK-CFFSNOTES">
		
		    <legend>Notes (Not Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__CNOTE_DETAILS" runat="server" ScreenCode="CFFSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CFFSNOTES/CFFSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCPIRSK_CFFSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Not Printed on Schedule)"
						ClientValidationFunction="onValidate_CPIRSK__CFFSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idced8e299dc9747b6b929edbcd172b4a0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idced8e299dc9747b6b929edbcd172b4a0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idced8e299dc9747b6b929edbcd172b4a0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idced8e299dc9747b6b929edbcd172b4a0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idced8e299dc9747b6b929edbcd172b4a0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idced8e299dc9747b6b929edbcd172b4a0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idced8e299dc9747b6b929edbcd172b4a0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idced8e299dc9747b6b929edbcd172b4a0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idced8e299dc9747b6b929edbcd172b4a0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idced8e299dc9747b6b929edbcd172b4a0 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPIRSK__CFFNOTES"
		data-field-type="Child" 
		data-object-name="CPIRSK" 
		data-property-name="CFFNOTES" 
		id="pb-container-childscreen-CPIRSK-CFFNOTES">
		
		    <legend>Notes (Printed on Schedule)</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPIRSK__SCNOTE_DETAILS" runat="server" ScreenCode="CFFNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CFFNOTES/CFFNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCPIRSK_CFFNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes (Printed on Schedule)"
						ClientValidationFunction="onValidate_CPIRSK__CFFNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id32695271cce14d2a8ac887505effb984" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading27" runat="server" Text="Premium Breakdown" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id32695271cce14d2a8ac887505effb984 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id32695271cce14d2a8ac887505effb984 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id32695271cce14d2a8ac887505effb984 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id32695271cce14d2a8ac887505effb984 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id32695271cce14d2a8ac887505effb984 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id32695271cce14d2a8ac887505effb984 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id32695271cce14d2a8ac887505effb984 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id32695271cce14d2a8ac887505effb984 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id32695271cce14d2a8ac887505effb984 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id32695271cce14d2a8ac887505effb984 input{text-align:left;}"; break;
		}
	}
