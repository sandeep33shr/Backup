...
Namespace Nexus
    Partial Class PB2_PDWNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_PDWNOTE_DETAILS__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If PDWNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		PDWNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		PDWNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_PDWNOTE_DETAILS__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PDWNOTE_DETAILS__NOTE_DETAILS()
    onValidate_PDWNOTE_DETAILS__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnNextTop.Click, btnFinish.Click, btnFinishTop.Click
        	...
        	If NoteAddedCheck = 0 Then
        		PDWNOTE_DETAILS__NoteCheck.Text = 1
        	End If
        End Sub
