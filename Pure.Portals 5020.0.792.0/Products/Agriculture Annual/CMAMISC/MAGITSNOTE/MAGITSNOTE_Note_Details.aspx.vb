...
Namespace Nexus
    Partial Class PB2_MAGITSNOTE_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_GIT_SCNOTE_DETAILS__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If GIT_SCNOTE_DETAILS__Date_Created.Text.ToString = "" Then
        		GIT_SCNOTE_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		GIT_SCNOTE_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_GIT_SCNOTE_DETAILS__Note_Details()
End Sub
