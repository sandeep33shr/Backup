<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MMFLEET_Endorsements.aspx.vb" Inherits="Nexus.PB2_MMFLEET_Endorsements" %>
...
function onValidate_REFERRAL_CLAUSES__CMAMFEP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "REFERRAL_CLAUSES", "CMAMFEP", "ChildScreen");
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_REFERRAL_CLAUSES__CMAMFEP(null, null, null, isOnLoad);
...
<div id="id5159ad34a78d4bd88f7f383f3fd3201d" class="general-layout-container">
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_REFERRAL_CLAUSES__CMAMFEP"
		data-field-type="Child" 
		data-object-name="REFERRAL_CLAUSES" 
		data-property-name="CMAMFEP" 
		id="pb-container-childscreen-REFERRAL_CLAUSES-CMAMFEP">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="REFERRAL_CLAUSES__CLAUSEPREM" runat="server" ScreenCode="CMAMFEP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMAMFEP/CMAMFEP_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valREFERRAL_CLAUSES_CMAMFEP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for REFERRAL_CLAUSES.CMAMFEP"
						ClientValidationFunction="onValidate_REFERRAL_CLAUSES__CMAMFEP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
