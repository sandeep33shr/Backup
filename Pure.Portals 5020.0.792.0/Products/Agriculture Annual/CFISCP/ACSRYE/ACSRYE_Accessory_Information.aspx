<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ACSRYE_Accessory_Information.aspx.vb" Inherits="Nexus.PB2_ACSRYE_Accessory_Information" %>
...
function onValidate_ACCESSORIES__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("ACCESSORIES.DESCRIPTION");
        			window.setControlWidth(field, "0.5", "ACCESSORIES", "DESCRIPTION");
        		})();
        	}
        })();
}
...
<div id="idf7b7218b7c3c4710b30e84b45ee24ba1" class="general-layout-container">
...
<div id="id9c8ae732a89b4ff8ab6d45a1e108edeb" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id9c8ae732a89b4ff8ab6d45a1e108edeb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9c8ae732a89b4ff8ab6d45a1e108edeb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9c8ae732a89b4ff8ab6d45a1e108edeb div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id9c8ae732a89b4ff8ab6d45a1e108edeb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9c8ae732a89b4ff8ab6d45a1e108edeb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9c8ae732a89b4ff8ab6d45a1e108edeb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9c8ae732a89b4ff8ab6d45a1e108edeb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9c8ae732a89b4ff8ab6d45a1e108edeb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9c8ae732a89b4ff8ab6d45a1e108edeb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9c8ae732a89b4ff8ab6d45a1e108edeb input{text-align:left;}"; break;
		}
	}
