...
Namespace Nexus
    Partial Class PB2_APDWTPREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_APDL_CLAUSE__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_APDL_CLAUSE__ENDORSE_ID()
End Sub
        ...
        'BC_CLAUSES - Standard Wording Parent Property
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/BUILDCOM/SW.BC_CLAUSES")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim CurrentSelected As String = APDL_CLAUSE__ENDORSE_CAP.Text
