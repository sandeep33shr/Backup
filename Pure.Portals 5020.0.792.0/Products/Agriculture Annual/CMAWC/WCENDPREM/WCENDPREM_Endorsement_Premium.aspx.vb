...
Namespace Nexus
    Partial Class PB2_WCENDPREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_WC_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_WC_CLAUSEPREM__ENDORSE_ID()
End Sub
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim CurrentSelected As String = WC_CLAUSEPREM__ENDORSE_CAP.Text
