...
<div id="id18578b0ff0c04a68bbd3954a6f446122" class="general-layout-container">
...
<div id="idfd95c6dbefc34876b05c577ce3ecd85f" class="column-layout-container  ">
	...
	<span class="field-container" 
		...
		<asp:Label ID="lblAH_ENDOSE_ENDORSE_CAP" runat="server" AssociatedControlID="AH_ENDOSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AH_ENDOSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AH_ENDOSE-ENDORSE_DESCCode">
				...
				<asp:HiddenField ID="AH_ENDOSE__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfd95c6dbefc34876b05c577ce3ecd85f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfd95c6dbefc34876b05c577ce3ecd85f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfd95c6dbefc34876b05c577ce3ecd85f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfd95c6dbefc34876b05c577ce3ecd85f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfd95c6dbefc34876b05c577ce3ecd85f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfd95c6dbefc34876b05c577ce3ecd85f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfd95c6dbefc34876b05c577ce3ecd85f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfd95c6dbefc34876b05c577ce3ecd85f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfd95c6dbefc34876b05c577ce3ecd85f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfd95c6dbefc34876b05c577ce3ecd85f input{text-align:left;}"; break;
		}
	}
