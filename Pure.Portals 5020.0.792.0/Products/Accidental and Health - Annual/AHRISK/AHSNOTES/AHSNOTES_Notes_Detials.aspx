<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="AHSNOTES_Notes_Detials.aspx.vb" Inherits="Nexus.PB2_AHSNOTES_Notes_Detials" %>
...
function onValidate_AHNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "AHNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=AHNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_AHNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "AHNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_AHNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "AHNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=AHNOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_AHNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHNOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "AHNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_AHNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHNOTES", "NOTE_DETAILS");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "AHNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=AHNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_AHNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_AHNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_AHNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_AHNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_AHNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_AHNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_AHNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id32e2c2062d144aa9bcaf04ddd38c62f9" class="general-layout-container">
...
<div id="id0d8a78881e954c009eaccde39dad4147" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="AHNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-AHNOTES-DATE_CREATED">
		<asp:Label ID="lblAHNOTES_DATE_CREATED" runat="server" AssociatedControlID="AHNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="AHNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calAHNOTES__DATE_CREATED" runat="server" LinkedControl="AHNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valAHNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_AHNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AHNOTES-CREATED_BY">

		
		<asp:Label ID="lblAHNOTES_CREATED_BY" runat="server" AssociatedControlID="AHNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAHNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_AHNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AHNOTES-COVER_TYPE">

		
		<asp:Label ID="lblAHNOTES_COVER_TYPE" runat="server" AssociatedControlID="AHNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAHNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_AHNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AHNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblAHNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="AHNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAHNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_AHNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-AHNOTES-NOTE_DETAILS">
		<asp:Label ID="lblAHNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="AHNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="AHNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valAHNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_AHNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0d8a78881e954c009eaccde39dad4147 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0d8a78881e954c009eaccde39dad4147 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0d8a78881e954c009eaccde39dad4147 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0d8a78881e954c009eaccde39dad4147 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0d8a78881e954c009eaccde39dad4147 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d8a78881e954c009eaccde39dad4147 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d8a78881e954c009eaccde39dad4147 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0d8a78881e954c009eaccde39dad4147 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0d8a78881e954c009eaccde39dad4147 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0d8a78881e954c009eaccde39dad4147 input{text-align:left;}"; break;
		}
	}
