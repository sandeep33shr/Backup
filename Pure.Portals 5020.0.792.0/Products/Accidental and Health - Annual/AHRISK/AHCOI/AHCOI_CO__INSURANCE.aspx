<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="AHCOI_CO__INSURANCE.aspx.vb" Inherits="Nexus.PB2_AHCOI_CO__INSURANCE" %>
...
function onValidate_AHCOI__CO_INM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHCOI", "CO_INM", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHCOI", "CO_INM");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHCOI.CO_INM");
        			window.setControlWidth(field, "0.5", "AHCOI", "CO_INM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAHCOI_CO_INM");
        			    var ele = document.getElementById('ctl00_cntMainBody_AHCOI__CO_INM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AHCOI__CO_INM_lblFindParty");
        			    }
        			}
...
function onValidate_AHCOI__Per_SHARE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHCOI", "Per_SHARE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHCOI", "Per_SHARE");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHCOI.Per_SHARE");
        			window.setControlWidth(field, "0.5", "AHCOI", "Per_SHARE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblAHCOI_Per_SHARE");
        			    var ele = document.getElementById('ctl00_cntMainBody_AHCOI__Per_SHARE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_AHCOI__Per_SHARE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("% of Share Cannot exceed 100%")) ? "% of Share Cannot exceed 100%" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "AHCOI".toUpperCase() + "__" + "Per_SHARE");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "AHCOI".toUpperCase() + "_" + "Per_SHARE");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("AHCOI.Per_SHARE > 100");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function DoLogic(isOnLoad) {
    onValidate_AHCOI__CO_INM(null, null, null, isOnLoad);
    onValidate_AHCOI__Per_SHARE(null, null, null, isOnLoad);
}
</script>
...
<div id="id5954a8d2bd5d4f058f3400792e5dfd53" class="general-layout-container">
...
<div id="id7ee150e97cf144308e4da0b95fee104b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Co- Insurance" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="AHCOI" 
		data-property-name="CO_INM" 
		 
		
		 
		id="pb-container-text-AHCOI-CO_INM">

		
		<asp:Label ID="lblAHCOI_CO_INM" runat="server" AssociatedControlID="AHCOI__CO_INM" 
			Text="Co Insurance Name" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHCOI__CO_INM" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAHCOI_CO_INM" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Co Insurance Name"
					ClientValidationFunction="onValidate_AHCOI__CO_INM"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-percentage-AHCOI-Per_SHARE">
		<asp:Label ID="lblAHCOI_Per_SHARE" runat="server" AssociatedControlID="AHCOI__Per_SHARE" 
			Text="% of Share" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="AHCOI__Per_SHARE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valAHCOI_Per_SHARE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for % of Share"
			ClientValidationFunction="onValidate_AHCOI__Per_SHARE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7ee150e97cf144308e4da0b95fee104b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7ee150e97cf144308e4da0b95fee104b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7ee150e97cf144308e4da0b95fee104b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7ee150e97cf144308e4da0b95fee104b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7ee150e97cf144308e4da0b95fee104b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7ee150e97cf144308e4da0b95fee104b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7ee150e97cf144308e4da0b95fee104b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7ee150e97cf144308e4da0b95fee104b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7ee150e97cf144308e4da0b95fee104b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7ee150e97cf144308e4da0b95fee104b input{text-align:left;}"; break;
		}
	}
