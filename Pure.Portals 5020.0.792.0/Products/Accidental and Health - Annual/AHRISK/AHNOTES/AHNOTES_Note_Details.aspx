<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="AHNOTES_Note_Details.aspx.vb" Inherits="Nexus.PB2_AHNOTES_Note_Details" %>
...
function onValidate_AHSNOTES__DATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHSNOTES", "DATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHSNOTES", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHSNOTES.DATE_CREATED");
        			window.setControlWidth(field, "0.5", "AHSNOTES", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=AHSNOTES&propertyName=DATE_CREATED&name={name}");
...
function onValidate_AHSNOTES__CREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHSNOTES", "CREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHSNOTES", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHSNOTES.CREATED_BY");
        			window.setControlWidth(field, "0.5", "AHSNOTES", "CREATED_BY");
        		})();
        	}
        })();
}
function onValidate_AHSNOTES__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHSNOTES", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHSNOTES", "COVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHSNOTES.COVER_TYPE");
        			window.setControlWidth(field, "0.5", "AHSNOTES", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=AHSNOTES&propertyName=COVER_TYPE&name={name}");
...
function onValidate_AHSNOTES__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHSNOTES", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHSNOTES", "NOTE_DESCRIPTION");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHSNOTES.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "AHSNOTES", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
...
function onValidate_AHSNOTES__NOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHSNOTES", "NOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AHSNOTES", "NOTE_DETAILS");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("AHSNOTES.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "AHSNOTES", "NOTE_DETAILS");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=AHSNOTES&propertyName=NOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_AHSNOTES__NOTE_DETAILS');
        			if (ele){
        				var bounds = window.getBounds(ele);
        			...
        			// Check for text area also
        			var textarea = document.getElementById('ctl00_cntMainBody_AHSNOTES_NOTE_DETAILS_textarea');
        			if (textarea != null){
        				bounds = window.getBounds(textarea);
...
function DoLogic(isOnLoad) {
    onValidate_AHSNOTES__DATE_CREATED(null, null, null, isOnLoad);
    onValidate_AHSNOTES__CREATED_BY(null, null, null, isOnLoad);
    onValidate_AHSNOTES__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_AHSNOTES__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_AHSNOTES__NOTE_DETAILS(null, null, null, isOnLoad);
}
</script>
...
<div id="id86d5b140114347159c17c9ce84940771" class="general-layout-container">
...
<div id="iddacbd0f435864245acbb134d0317c735" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="AHSNOTES" 
		data-property-name="DATE_CREATED" 
		id="pb-container-datejquerycompatible-AHSNOTES-DATE_CREATED">
		<asp:Label ID="lblAHSNOTES_DATE_CREATED" runat="server" AssociatedControlID="AHSNOTES__DATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="AHSNOTES__DATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calAHSNOTES__DATE_CREATED" runat="server" LinkedControl="AHSNOTES__DATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valAHSNOTES_DATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_AHSNOTES__DATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AHSNOTES-CREATED_BY">

		
		<asp:Label ID="lblAHSNOTES_CREATED_BY" runat="server" AssociatedControlID="AHSNOTES__CREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHSNOTES__CREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAHSNOTES_CREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_AHSNOTES__CREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AHSNOTES-COVER_TYPE">

		
		<asp:Label ID="lblAHSNOTES_COVER_TYPE" runat="server" AssociatedControlID="AHSNOTES__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHSNOTES__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAHSNOTES_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_AHSNOTES__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-AHSNOTES-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblAHSNOTES_NOTE_DESCRIPTION" runat="server" AssociatedControlID="AHSNOTES__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="AHSNOTES__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valAHSNOTES_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_AHSNOTES__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-comment-AHSNOTES-NOTE_DETAILS">
		<asp:Label ID="lblAHSNOTES_NOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="AHSNOTES__NOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="AHSNOTES__NOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valAHSNOTES_NOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_AHSNOTES__NOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddacbd0f435864245acbb134d0317c735 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddacbd0f435864245acbb134d0317c735 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddacbd0f435864245acbb134d0317c735 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddacbd0f435864245acbb134d0317c735 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddacbd0f435864245acbb134d0317c735 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddacbd0f435864245acbb134d0317c735 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddacbd0f435864245acbb134d0317c735 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddacbd0f435864245acbb134d0317c735 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddacbd0f435864245acbb134d0317c735 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddacbd0f435864245acbb134d0317c735 input{text-align:left;}"; break;
		}
	}
