...
Namespace Nexus
    Partial Class PB2_AHNOTES_Note_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_AHSNOTES__NOTE_DETAILS()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If AHSNOTES__Date_Created.Text.ToString = "" Then
        		AHSNOTES__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		AHSNOTES__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub CallRuleScripts()
    onValidate_AHSNOTES__NOTE_DETAILS()
End Sub
