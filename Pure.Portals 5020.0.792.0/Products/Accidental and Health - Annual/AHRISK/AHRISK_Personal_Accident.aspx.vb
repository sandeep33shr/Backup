...
Namespace Nexus
    Partial Class PB2_AHRISK_Personal_Accident : Inherits BaseRisk
		...
		Protected Sub onValidate_EMPDE__RISK_ATTACH_DATE()
        
End Sub
Protected Sub onValidate_EMPDE__EFFECTIVEDATE()
...
Protected Sub CallRuleScripts()
    onValidate_EMPDE__RISK_ATTACH_DATE()
    onValidate_EMPDE__EFFECTIVEDATE()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If EMPDE__RISK_ATTACH_DATE.Text = "" or EMPDE__RISK_ATTACH_DATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			EMPDE__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			EMPDE__RISK_ATTACH_DATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (EMPDE__RISK_ATTACH_DATE.Text <> "" Or EMPDE__RISK_ATTACH_DATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		EMPDE__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		EMPDE__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		EMPDE__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
