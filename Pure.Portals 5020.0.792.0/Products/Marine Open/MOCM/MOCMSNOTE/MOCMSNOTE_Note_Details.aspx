<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOCMSNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_MOCMSNOTE_Note_Details" %>
...
function onValidate_MPCNOTE_DETAILS__MPDATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPCNOTE_DETAILS", "MPDATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MPCNOTE_DETAILS", "MPDATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("MPCNOTE_DETAILS", "MPDATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=MPCNOTE_DETAILS&propertyName=MPDATE_CREATED&name={name}");
...
function onValidate_MPCNOTE_DETAILS__MPCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPCNOTE_DETAILS", "MPCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MPCNOTE_DETAILS", "MPCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("MPCNOTE_DETAILS", "MPCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_MPCNOTE_DETAILS__MPCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPCNOTE_DETAILS", "MPCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("MPCNOTE_DETAILS", "MPCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("MPCNOTE_DETAILS", "MPCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MPCNOTE_DETAILS&propertyName=MPCOVER_TYPE&name={name}");
        		
        		var value = new Expression("'Marine Open'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_MPCNOTE_DETAILS__MPNOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPCNOTE_DETAILS", "MPNOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MPCNOTE_DETAILS", "MPNOTE_DESCRIPTION");
...
function onValidate_MPCNOTE_DETAILS__MPNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPCNOTE_DETAILS", "MPNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MPCNOTE_DETAILS", "MPNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=MPCNOTE_DETAILS&propertyName=MPNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_MPCNOTE_DETAILS__MPNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_MPCNOTE_DETAILS_MPNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_MPCNOTE_DETAILS__MPNOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MPCNOTE_DETAILS", "MPNOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MPCNOTE_DETAILS", "MPNOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_MPCNOTE_DETAILS__MPDATE_CREATED(null, null, null, isOnLoad);
    onValidate_MPCNOTE_DETAILS__MPCREATED_BY(null, null, null, isOnLoad);
    onValidate_MPCNOTE_DETAILS__MPCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_MPCNOTE_DETAILS__MPNOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_MPCNOTE_DETAILS__MPNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_MPCNOTE_DETAILS__MPNOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="idc2d392b7c2f14028b93da1c7cd9732e2" class="general-layout-container">
...
<div id="id1f4a2057e166494bb6d4c8168354b360" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Note Detail (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MPCNOTE_DETAILS" 
		data-property-name="MPDATE_CREATED" 
		id="pb-container-datejquerycompatible-MPCNOTE_DETAILS-MPDATE_CREATED">
		<asp:Label ID="lblMPCNOTE_DETAILS_MPDATE_CREATED" runat="server" AssociatedControlID="MPCNOTE_DETAILS__MPDATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="MPCNOTE_DETAILS__MPDATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calMPCNOTE_DETAILS__MPDATE_CREATED" runat="server" LinkedControl="MPCNOTE_DETAILS__MPDATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valMPCNOTE_DETAILS_MPDATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_MPCNOTE_DETAILS__MPDATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MPCNOTE_DETAILS" 
		data-property-name="MPCREATED_BY" 
		 
		
		 
		id="pb-container-text-MPCNOTE_DETAILS-MPCREATED_BY">

		
		<asp:Label ID="lblMPCNOTE_DETAILS_MPCREATED_BY" runat="server" AssociatedControlID="MPCNOTE_DETAILS__MPCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MPCNOTE_DETAILS__MPCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMPCNOTE_DETAILS_MPCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_MPCNOTE_DETAILS__MPCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MPCNOTE_DETAILS" 
		data-property-name="MPCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-MPCNOTE_DETAILS-MPCOVER_TYPE">

		
		<asp:Label ID="lblMPCNOTE_DETAILS_MPCOVER_TYPE" runat="server" AssociatedControlID="MPCNOTE_DETAILS__MPCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MPCNOTE_DETAILS__MPCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMPCNOTE_DETAILS_MPCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_MPCNOTE_DETAILS__MPCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MPCNOTE_DETAILS" 
		data-property-name="MPNOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-MPCNOTE_DETAILS-MPNOTE_DESCRIPTION">

		
		<asp:Label ID="lblMPCNOTE_DETAILS_MPNOTE_DESCRIPTION" runat="server" AssociatedControlID="MPCNOTE_DETAILS__MPNOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MPCNOTE_DETAILS__MPNOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMPCNOTE_DETAILS_MPNOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_MPCNOTE_DETAILS__MPNOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MPCNOTE_DETAILS" 
		data-property-name="MPNOTE_DETAILS" 
		id="pb-container-comment-MPCNOTE_DETAILS-MPNOTE_DETAILS">
		<asp:Label ID="lblMPCNOTE_DETAILS_MPNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="MPCNOTE_DETAILS__MPNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="MPCNOTE_DETAILS__MPNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valMPCNOTE_DETAILS_MPNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_MPCNOTE_DETAILS__MPNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblMPCNOTE_DETAILS_MPNOTECHECK" for="ctl00_cntMainBody_MPCNOTE_DETAILS__MPNOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="MPCNOTE_DETAILS" 
		data-property-name="MPNOTECHECK" 
		id="pb-container-checkbox-MPCNOTE_DETAILS-MPNOTECHECK">	
		
		<asp:TextBox ID="MPCNOTE_DETAILS__MPNOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valMPCNOTE_DETAILS_MPNOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_MPCNOTE_DETAILS__MPNOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1f4a2057e166494bb6d4c8168354b360 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1f4a2057e166494bb6d4c8168354b360 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1f4a2057e166494bb6d4c8168354b360 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1f4a2057e166494bb6d4c8168354b360 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1f4a2057e166494bb6d4c8168354b360 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1f4a2057e166494bb6d4c8168354b360 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1f4a2057e166494bb6d4c8168354b360 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1f4a2057e166494bb6d4c8168354b360 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1f4a2057e166494bb6d4c8168354b360 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1f4a2057e166494bb6d4c8168354b360 input{text-align:left;}"; break;
		}
	}
