<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOCAR_Overview.aspx.vb" Inherits="Nexus.PB2_MOCAR_Overview" %>
...
function onValidate_DLODESCL(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_SUBSECIMPTS__DSUBASICL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DSUBASICL", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DSUBASICL");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLOIRATECL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLOIRATECL", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLOIRATECL");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLOIPREMCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLOIPREMCL", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLOIPREMCL");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLDPREMCHCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLDPREMCHCL", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLDPREMCHCL");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLOIDEPPREMCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLOIDEPPREMCL", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLOIDEPPREMCL");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLOIPREMDUECL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLOIPREMDUECL", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLOIPREMDUECL");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_DLODESC(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_SUBSECIMPTS__DSUBASI(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DSUBASI", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DSUBASI");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLOIRATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLOIRATE", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLOIRATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLOIPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLOIPREM", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLOIPREM");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLDPREMCH(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLDPREMCH", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLDPREMCH");
        		}
        		//window.setProperty(field, "VE", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLOIDEPPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLOIDEPPREM", "Percentage");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLOIDEPPREM");
        		}
        		//window.setProperty(field, "VEM", "{1}", "{2}", "{3}");
...
function onValidate_SUBSECIMPTS__DLOIPREMDUE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SUBSECIMPTS", "DLOIPREMDUE", "Currency");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("SUBSECIMPTS", "DLOIPREMDUE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_label187(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label188(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label189(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label190(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label191(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function onValidate_label192(source, args, sender, isOnLoad) {
        /**
         * @fileoverview
         * Set property
         */
...
function DoLogic(isOnLoad) {
    ...
    onValidate_DLODESCL(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DSUBASICL(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLOIRATECL(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLOIPREMCL(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLDPREMCHCL(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLOIDEPPREMCL(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLOIPREMDUECL(null, null, null, isOnLoad);
    onValidate_DLODESC(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DSUBASI(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLOIRATE(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLOIPREM(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLDPREMCH(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLOIDEPPREM(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__DLOIPREMDUE(null, null, null, isOnLoad);
    ...
    onValidate_label187(null, null, null, isOnLoad);
    onValidate_SUBSECIMPTS__RILOIR(null, null, null, isOnLoad);
    onValidate_label188(null, null, null, isOnLoad);
    onValidate_label189(null, null, null, isOnLoad);
    onValidate_label190(null, null, null, isOnLoad);
    onValidate_label191(null, null, null, isOnLoad);
    onValidate_label192(null, null, null, isOnLoad);
}
</script>
...
<div id="id2c85c2c2400540ec955c11cfd4562e2e" class="general-layout-container">
...
<div id="idd651bbb3d1d049e6bf172f6e00861a01" class="column-layout-container,no-border  ">
	...
	<span id="pb-container-label-label152">
		<span class="label" id="label152">Cover Name</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label153">
		<span class="label" id="label153">Description</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label154">
		<span class="label" id="label154">LOI/RI Limit</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label155">
		<span class="label" id="label155">SI/Turnover</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label158">
		<span class="label" id="label158">Deposit Premium</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label159">
		<span class="label" id="label159">Deposit Premium %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label160">
		<span class="label" id="label160">Premium Due</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label161">
		<span class="label" id="label161">Sub Section A: Imports</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label162">
		<span class="label" id="label162">Sub Section B:Exports</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label163">
		<span class="label" id="label163">Sub Section C: Inland Transit</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label164">
		<span class="label" id="label164">Sub Section D: Container</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:14%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-DLODESCL">
		<span class="label" id="DLODESCL">Contingent Liability </span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DSUBASICL" 
		id="pb-container-currency-SUBSECIMPTS-DSUBASICL">
		<asp:Label ID="lblSUBSECIMPTS_DSUBASICL" runat="server" AssociatedControlID="SUBSECIMPTS__DSUBASICL" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SUBSECIMPTS__DSUBASICL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DSUBASICL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DSUBASICL"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DSUBASICL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLOIRATECL" 
		id="pb-container-percentage-SUBSECIMPTS-DLOIRATECL">
		<asp:Label ID="lblSUBSECIMPTS_DLOIRATECL" runat="server" AssociatedControlID="SUBSECIMPTS__DLOIRATECL" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SUBSECIMPTS__DLOIRATECL" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DLOIRATECL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLOIRATECL"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLOIRATECL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLOIPREMCL" 
		id="pb-container-currency-SUBSECIMPTS-DLOIPREMCL">
		<asp:Label ID="lblSUBSECIMPTS_DLOIPREMCL" runat="server" AssociatedControlID="SUBSECIMPTS__DLOIPREMCL" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SUBSECIMPTS__DLOIPREMCL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DLOIPREMCL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLOIPREMCL"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLOIPREMCL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSUBSECIMPTS_DLDPREMCHCL" for="ctl00_cntMainBody_SUBSECIMPTS__DLDPREMCHCL" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLDPREMCHCL" 
		id="pb-container-checkbox-SUBSECIMPTS-DLDPREMCHCL">	
		
		<asp:TextBox ID="SUBSECIMPTS__DLDPREMCHCL" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSUBSECIMPTS_DLDPREMCHCL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLDPREMCHCL"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLDPREMCHCL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLOIDEPPREMCL" 
		id="pb-container-percentage-SUBSECIMPTS-DLOIDEPPREMCL">
		<asp:Label ID="lblSUBSECIMPTS_DLOIDEPPREMCL" runat="server" AssociatedControlID="SUBSECIMPTS__DLOIDEPPREMCL" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SUBSECIMPTS__DLOIDEPPREMCL" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DLOIDEPPREMCL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLOIDEPPREMCL"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLOIDEPPREMCL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLOIPREMDUECL" 
		id="pb-container-currency-SUBSECIMPTS-DLOIPREMDUECL">
		<asp:Label ID="lblSUBSECIMPTS_DLOIPREMDUECL" runat="server" AssociatedControlID="SUBSECIMPTS__DLOIPREMDUECL" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SUBSECIMPTS__DLOIPREMDUECL" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DLOIPREMDUECL" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLOIPREMDUECL"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLOIPREMDUECL" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label166">
		<span class="label" id="label166">Sub Section D: Container</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:14%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-DLODESC">
		<span class="label" id="DLODESC">Container Physical Loss/Damage</span>
	</span>
<!-- /Label -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DSUBASI" 
		id="pb-container-currency-SUBSECIMPTS-DSUBASI">
		<asp:Label ID="lblSUBSECIMPTS_DSUBASI" runat="server" AssociatedControlID="SUBSECIMPTS__DSUBASI" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SUBSECIMPTS__DSUBASI" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DSUBASI" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DSUBASI"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DSUBASI" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLOIRATE" 
		id="pb-container-percentage-SUBSECIMPTS-DLOIRATE">
		<asp:Label ID="lblSUBSECIMPTS_DLOIRATE" runat="server" AssociatedControlID="SUBSECIMPTS__DLOIRATE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SUBSECIMPTS__DLOIRATE" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DLOIRATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLOIRATE"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLOIRATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLOIPREM" 
		id="pb-container-currency-SUBSECIMPTS-DLOIPREM">
		<asp:Label ID="lblSUBSECIMPTS_DLOIPREM" runat="server" AssociatedControlID="SUBSECIMPTS__DLOIPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SUBSECIMPTS__DLOIPREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DLOIPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLOIPREM"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLOIPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblSUBSECIMPTS_DLDPREMCH" for="ctl00_cntMainBody_SUBSECIMPTS__DLDPREMCH" class="col-md-4 col-sm-3 control-label">
		</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLDPREMCH" 
		id="pb-container-checkbox-SUBSECIMPTS-DLDPREMCH">	
		
		<asp:TextBox ID="SUBSECIMPTS__DLDPREMCH" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valSUBSECIMPTS_DLDPREMCH" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLDPREMCH"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLDPREMCH" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Percentage" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLOIDEPPREM" 
		id="pb-container-percentage-SUBSECIMPTS-DLOIDEPPREM">
		<asp:Label ID="lblSUBSECIMPTS_DLOIDEPPREM" runat="server" AssociatedControlID="SUBSECIMPTS__DLOIDEPPREM" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		        <asp:TextBox ID="SUBSECIMPTS__DLOIDEPPREM" runat="server" CssClass="form-control" />
		    </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DLOIDEPPREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLOIDEPPREM"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLOIDEPPREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="SUBSECIMPTS" 
		data-property-name="DLOIPREMDUE" 
		id="pb-container-currency-SUBSECIMPTS-DLOIPREMDUE">
		<asp:Label ID="lblSUBSECIMPTS_DLOIPREMDUE" runat="server" AssociatedControlID="SUBSECIMPTS__DLOIPREMDUE" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="SUBSECIMPTS__DLOIPREMDUE" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valSUBSECIMPTS_DLOIPREMDUE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SUBSECIMPTS.DLOIPREMDUE"
			ClientValidationFunction="onValidate_SUBSECIMPTS__DLOIPREMDUE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label168">
		<span class="label" id="label168">Extended Cover </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label170">
		<span class="label" id="label170">Extended Cover </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label172">
		<span class="label" id="label172">Extended Cover </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label174">
		<span class="label" id="label174">Extended Cover </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label176">
		<span class="label" id="label176">Extended Cover </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label178">
		<span class="label" id="label178">Extended Cover </span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label181">
		<span class="label" id="label181">Totals</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label186">
		<span class="label" id="label186">RI Exposure</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd651bbb3d1d049e6bf172f6e00861a01 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd651bbb3d1d049e6bf172f6e00861a01 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd651bbb3d1d049e6bf172f6e00861a01 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd651bbb3d1d049e6bf172f6e00861a01 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd651bbb3d1d049e6bf172f6e00861a01 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd651bbb3d1d049e6bf172f6e00861a01 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd651bbb3d1d049e6bf172f6e00861a01 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd651bbb3d1d049e6bf172f6e00861a01 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd651bbb3d1d049e6bf172f6e00861a01 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd651bbb3d1d049e6bf172f6e00861a01 input{text-align:left;}"; break;
		}
	}
