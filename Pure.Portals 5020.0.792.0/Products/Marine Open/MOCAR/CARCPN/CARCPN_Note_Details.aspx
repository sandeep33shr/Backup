<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARCPN_Note_Details.aspx.vb" Inherits="Nexus.PB2_CARCPN_Note_Details" %>
...
<div id="id9ed4c97566024ed29226f16995121175" class="general-layout-container">
...
<div id="idc6a69668c97d4dc9a4ec8a1c2b262b0d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading63" runat="server" Text="Sub Section C:Inland Transit Note Detail (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc6a69668c97d4dc9a4ec8a1c2b262b0d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc6a69668c97d4dc9a4ec8a1c2b262b0d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc6a69668c97d4dc9a4ec8a1c2b262b0d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc6a69668c97d4dc9a4ec8a1c2b262b0d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc6a69668c97d4dc9a4ec8a1c2b262b0d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc6a69668c97d4dc9a4ec8a1c2b262b0d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc6a69668c97d4dc9a4ec8a1c2b262b0d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc6a69668c97d4dc9a4ec8a1c2b262b0d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc6a69668c97d4dc9a4ec8a1c2b262b0d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc6a69668c97d4dc9a4ec8a1c2b262b0d input{text-align:left;}"; break;
		}
	}
