<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARBBMI_Subject_Matter_Inclusion.aspx.vb" Inherits="Nexus.PB2_CARBBMI_Subject_Matter_Inclusion" %>
...
<div id="id6c5405fccd9d40729c89614bbb6f972c" class="general-layout-container">
...
<div id="ided58e90d12bb4f2a94c854f045ca0d3a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ided58e90d12bb4f2a94c854f045ca0d3a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ided58e90d12bb4f2a94c854f045ca0d3a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ided58e90d12bb4f2a94c854f045ca0d3a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ided58e90d12bb4f2a94c854f045ca0d3a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ided58e90d12bb4f2a94c854f045ca0d3a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided58e90d12bb4f2a94c854f045ca0d3a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided58e90d12bb4f2a94c854f045ca0d3a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ided58e90d12bb4f2a94c854f045ca0d3a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ided58e90d12bb4f2a94c854f045ca0d3a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ided58e90d12bb4f2a94c854f045ca0d3a input{text-align:left;}"; break;
		}
	}
