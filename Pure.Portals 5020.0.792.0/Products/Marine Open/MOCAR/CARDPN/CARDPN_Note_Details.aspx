<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARDPN_Note_Details.aspx.vb" Inherits="Nexus.PB2_CARDPN_Note_Details" %>
...
function onValidate_DPNOTE_DETAILS__DPDATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DPNOTE_DETAILS", "DPDATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DPNOTE_DETAILS", "DPDATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("DPNOTE_DETAILS", "DPDATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=DPNOTE_DETAILS&propertyName=DPDATE_CREATED&name={name}");
...
function onValidate_DPNOTE_DETAILS__DPCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DPNOTE_DETAILS", "DPCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DPNOTE_DETAILS", "DPCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("DPNOTE_DETAILS", "DPCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_DPNOTE_DETAILS__DPCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DPNOTE_DETAILS", "DPCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DPNOTE_DETAILS", "DPCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("DPNOTE_DETAILS", "DPCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=DPNOTE_DETAILS&propertyName=DPCOVER_TYPE&name={name}");
        		
        		var value = new Expression("'Sub Section D:Container'"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_DPNOTE_DETAILS__DPNOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DPNOTE_DETAILS", "DPNOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DPNOTE_DETAILS", "DPNOTE_DESCRIPTION");
...
function onValidate_DPNOTE_DETAILS__DPNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DPNOTE_DETAILS", "DPNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DPNOTE_DETAILS", "DPNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=DPNOTE_DETAILS&propertyName=DPNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_DPNOTE_DETAILS__DPNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_DPNOTE_DETAILS_DPNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_DPNOTE_DETAILS__DPNOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DPNOTE_DETAILS", "DPNOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("DPNOTE_DETAILS", "DPNOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_DPNOTE_DETAILS__DPDATE_CREATED(null, null, null, isOnLoad);
    onValidate_DPNOTE_DETAILS__DPCREATED_BY(null, null, null, isOnLoad);
    onValidate_DPNOTE_DETAILS__DPCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_DPNOTE_DETAILS__DPNOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_DPNOTE_DETAILS__DPNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_DPNOTE_DETAILS__DPNOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="idafa6de9cd7f447b0b7a63df528cf6088" class="general-layout-container">
...
<div id="id482ecea7278b458188c63d2f468a91f2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading87" runat="server" Text="Sub Section D:Container Note Detail (Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="DPNOTE_DETAILS" 
		data-property-name="DPDATE_CREATED" 
		id="pb-container-datejquerycompatible-DPNOTE_DETAILS-DPDATE_CREATED">
		<asp:Label ID="lblDPNOTE_DETAILS_DPDATE_CREATED" runat="server" AssociatedControlID="DPNOTE_DETAILS__DPDATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="DPNOTE_DETAILS__DPDATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calDPNOTE_DETAILS__DPDATE_CREATED" runat="server" LinkedControl="DPNOTE_DETAILS__DPDATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valDPNOTE_DETAILS_DPDATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_DPNOTE_DETAILS__DPDATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DPNOTE_DETAILS" 
		data-property-name="DPCREATED_BY" 
		 
		
		 
		id="pb-container-text-DPNOTE_DETAILS-DPCREATED_BY">

		
		<asp:Label ID="lblDPNOTE_DETAILS_DPCREATED_BY" runat="server" AssociatedControlID="DPNOTE_DETAILS__DPCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DPNOTE_DETAILS__DPCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDPNOTE_DETAILS_DPCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_DPNOTE_DETAILS__DPCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DPNOTE_DETAILS" 
		data-property-name="DPCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-DPNOTE_DETAILS-DPCOVER_TYPE">

		
		<asp:Label ID="lblDPNOTE_DETAILS_DPCOVER_TYPE" runat="server" AssociatedControlID="DPNOTE_DETAILS__DPCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DPNOTE_DETAILS__DPCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDPNOTE_DETAILS_DPCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_DPNOTE_DETAILS__DPCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DPNOTE_DETAILS" 
		data-property-name="DPNOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-DPNOTE_DETAILS-DPNOTE_DESCRIPTION">

		
		<asp:Label ID="lblDPNOTE_DETAILS_DPNOTE_DESCRIPTION" runat="server" AssociatedControlID="DPNOTE_DETAILS__DPNOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DPNOTE_DETAILS__DPNOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDPNOTE_DETAILS_DPNOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_DPNOTE_DETAILS__DPNOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="DPNOTE_DETAILS" 
		data-property-name="DPNOTE_DETAILS" 
		id="pb-container-comment-DPNOTE_DETAILS-DPNOTE_DETAILS">
		<asp:Label ID="lblDPNOTE_DETAILS_DPNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="DPNOTE_DETAILS__DPNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="DPNOTE_DETAILS__DPNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valDPNOTE_DETAILS_DPNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_DPNOTE_DETAILS__DPNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblDPNOTE_DETAILS_DPNOTECHECK" for="ctl00_cntMainBody_DPNOTE_DETAILS__DPNOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="DPNOTE_DETAILS" 
		data-property-name="DPNOTECHECK" 
		id="pb-container-checkbox-DPNOTE_DETAILS-DPNOTECHECK">	
		
		<asp:TextBox ID="DPNOTE_DETAILS__DPNOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valDPNOTE_DETAILS_DPNOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_DPNOTE_DETAILS__DPNOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id482ecea7278b458188c63d2f468a91f2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id482ecea7278b458188c63d2f468a91f2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id482ecea7278b458188c63d2f468a91f2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id482ecea7278b458188c63d2f468a91f2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id482ecea7278b458188c63d2f468a91f2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id482ecea7278b458188c63d2f468a91f2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id482ecea7278b458188c63d2f468a91f2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id482ecea7278b458188c63d2f468a91f2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id482ecea7278b458188c63d2f468a91f2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id482ecea7278b458188c63d2f468a91f2 input{text-align:left;}"; break;
		}
	}
