<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARDENDP_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_CARDENDP_Endorsement_Premium" %>
...
function onValidate_D_CLAUSEPREM__DENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "D_CLAUSEPREM", "DENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("D_CLAUSEPREM", "DENDORSE_ID");
        		}
...
function onValidate_D_CLAUSEPREM__DENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "D_CLAUSEPREM", "DENDORSE_DESC", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("D_CLAUSEPREM", "DENDORSE_DESC");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("D_CLAUSEPREM.DENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "D_CLAUSEPREM", "DENDORSE_DESC");
        		})();
        	}
        })();
...
function onValidate_D_CLAUSEPREM__DENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "D_CLAUSEPREM", "DENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("D_CLAUSEPREM", "DENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_D_CLAUSEPREM__DPREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "D_CLAUSEPREM", "DPREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("D_CLAUSEPREM", "DPREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("D_CLAUSEPREM.DPREMIUM");
        			window.setControlWidth(field, "0.5", "D_CLAUSEPREM", "DPREMIUM");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    onValidate_D_CLAUSEPREM__DENDORSE_ID(null, null, null, isOnLoad);
    onValidate_D_CLAUSEPREM__DENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_D_CLAUSEPREM__DENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_D_CLAUSEPREM__DPREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id3363b520b9fb43e782be7214f890fd49" class="general-layout-container">
...
<div id="idbd83e1f0bf14466fa2cd3e19ac68e5ee" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="D_CLAUSEPREM" 
		data-property-name="DENDORSE_ID" 
		id="pb-container-integer-D_CLAUSEPREM-DENDORSE_ID">
		<asp:Label ID="lblD_CLAUSEPREM_DENDORSE_ID" runat="server" AssociatedControlID="D_CLAUSEPREM__DENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="D_CLAUSEPREM__DENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valD_CLAUSEPREM_DENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_D_CLAUSEPREM__DENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="D_CLAUSEPREM" 
		data-property-name="DENDORSE_DESC" 
		 
		
		 
		id="pb-container-text-D_CLAUSEPREM-DENDORSE_DESC">

		
		<asp:Label ID="lblD_CLAUSEPREM_DENDORSE_DESC" runat="server" AssociatedControlID="D_CLAUSEPREM__DENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="D_CLAUSEPREM__DENDORSE_DESC" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valD_CLAUSEPREM_DENDORSE_DESC" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_D_CLAUSEPREM__DENDORSE_DESC"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="D_CLAUSEPREM" 
		data-property-name="DENDORSE_CAP" 
		 
		
		 
		id="pb-container-text-D_CLAUSEPREM-DENDORSE_CAP">

		
		<asp:Label ID="lblD_CLAUSEPREM_DENDORSE_CAP" runat="server" AssociatedControlID="D_CLAUSEPREM__DENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="D_CLAUSEPREM__DENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valD_CLAUSEPREM_DENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_D_CLAUSEPREM__DENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="D_CLAUSEPREM" 
		data-property-name="DPREMIUM" 
		id="pb-container-currency-D_CLAUSEPREM-DPREMIUM">
		<asp:Label ID="lblD_CLAUSEPREM_DPREMIUM" runat="server" AssociatedControlID="D_CLAUSEPREM__DPREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="D_CLAUSEPREM__DPREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valD_CLAUSEPREM_DPREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_D_CLAUSEPREM__DPREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idbd83e1f0bf14466fa2cd3e19ac68e5ee div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbd83e1f0bf14466fa2cd3e19ac68e5ee div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbd83e1f0bf14466fa2cd3e19ac68e5ee div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idbd83e1f0bf14466fa2cd3e19ac68e5ee label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbd83e1f0bf14466fa2cd3e19ac68e5ee label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbd83e1f0bf14466fa2cd3e19ac68e5ee label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbd83e1f0bf14466fa2cd3e19ac68e5ee label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbd83e1f0bf14466fa2cd3e19ac68e5ee input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbd83e1f0bf14466fa2cd3e19ac68e5ee input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbd83e1f0bf14466fa2cd3e19ac68e5ee input{text-align:left;}"; break;
		}
	}
