<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOCAR_Risk_Coverage.aspx.vb" Inherits="Nexus.PB2_MOCAR_Risk_Coverage" %>
...
function onValidate_COVERS__SUBSECTION_D(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COVERS", "SUBSECTION_D", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("COVERS.SUBSECTION_D");
        		var update = function(){
...
function DoLogic(isOnLoad) {
    ...
    onValidate_COVERS__SUBSECTION_D(null, null, null, isOnLoad);
}
</script>
...
<div id="id4beb97527f5d435c82c3ce9447ada0e2" class="general-layout-container">
...
<div id="ida428278c90884850b668ae4d27a465d9" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida428278c90884850b668ae4d27a465d9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida428278c90884850b668ae4d27a465d9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida428278c90884850b668ae4d27a465d9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida428278c90884850b668ae4d27a465d9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida428278c90884850b668ae4d27a465d9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida428278c90884850b668ae4d27a465d9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida428278c90884850b668ae4d27a465d9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida428278c90884850b668ae4d27a465d9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida428278c90884850b668ae4d27a465d9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida428278c90884850b668ae4d27a465d9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id538b74c8a260478db42051c2e8f3865c" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id538b74c8a260478db42051c2e8f3865c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id538b74c8a260478db42051c2e8f3865c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id538b74c8a260478db42051c2e8f3865c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id538b74c8a260478db42051c2e8f3865c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id538b74c8a260478db42051c2e8f3865c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id538b74c8a260478db42051c2e8f3865c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id538b74c8a260478db42051c2e8f3865c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id538b74c8a260478db42051c2e8f3865c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id538b74c8a260478db42051c2e8f3865c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id538b74c8a260478db42051c2e8f3865c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5543793bb7854924b5b519e772e7d03f" class="column-layout-container,no-border  ">
...
<!-- /Currency -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCOVERS_SUBSECTION_D" for="ctl00_cntMainBody_COVERS__SUBSECTION_D" class="col-md-4 col-sm-3 control-label">
		Sub Section D: Container</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="COVERS" 
		data-property-name="SUBSECTION_D" 
		id="pb-container-checkbox-COVERS-SUBSECTION_D">	
		
		<asp:TextBox ID="COVERS__SUBSECTION_D" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCOVERS_SUBSECTION_D" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Sub Section D: Container"
			ClientValidationFunction="onValidate_COVERS__SUBSECTION_D" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5543793bb7854924b5b519e772e7d03f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5543793bb7854924b5b519e772e7d03f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5543793bb7854924b5b519e772e7d03f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5543793bb7854924b5b519e772e7d03f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5543793bb7854924b5b519e772e7d03f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5543793bb7854924b5b519e772e7d03f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5543793bb7854924b5b519e772e7d03f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5543793bb7854924b5b519e772e7d03f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5543793bb7854924b5b519e772e7d03f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5543793bb7854924b5b519e772e7d03f input{text-align:left;}"; break;
		}
	}
