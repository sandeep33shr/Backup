<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CARDNP_Note_Details.aspx.vb" Inherits="Nexus.PB2_CARDNP_Note_Details" %>
...
function onValidate_DNOTE_DETAILS__DDATE_CREATED(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOTE_DETAILS", "DDATE_CREATED", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DNOTE_DETAILS", "DDATE_CREATED");
        		}
        ...
        (function(){
        	...
        	var field = Field.getInstance("DNOTE_DETAILS", "DDATE_CREATED");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Date&objectName=DNOTE_DETAILS&propertyName=DDATE_CREATED&name={name}");
...
function onValidate_DNOTE_DETAILS__DCREATED_BY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOTE_DETAILS", "DCREATED_BY", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DNOTE_DETAILS", "DCREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("DNOTE_DETAILS", "DCREATED_BY");
        	field.setReadOnly(true);
        })();
}
function onValidate_DNOTE_DETAILS__DCOVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOTE_DETAILS", "DCOVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("DNOTE_DETAILS", "DCOVER_TYPE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	var field = Field.getInstance("DNOTE_DETAILS", "DCOVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=DNOTE_DETAILS&propertyName=DCOVER_TYPE&name={name}");
...
function onValidate_DNOTE_DETAILS__DNOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOTE_DETAILS", "DNOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DNOTE_DETAILS", "DNOTE_DESCRIPTION");
...
function onValidate_DNOTE_DETAILS__DNOTE_DETAILS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOTE_DETAILS", "DNOTE_DETAILS", "Comment");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DNOTE_DETAILS", "DNOTE_DETAILS");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
        			...
        			var instance = Field.getWithQuery("type=Comment&objectName=DNOTE_DETAILS&propertyName=DNOTE_DETAILS&name={name}");
        			...
        			var ele = document.getElementById('ctl00_cntMainBody_DNOTE_DETAILS__DNOTE_DETAILS');
        			if (ele){
        			...
        			var textarea = document.getElementById('ctl00_cntMainBody_DNOTE_DETAILS_DNOTE_DETAILS_textarea');
        			if (textarea != null){
...
function onValidate_DNOTE_DETAILS__DNOTECHECK(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOTE_DETAILS", "DNOTECHECK", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("DNOTE_DETAILS", "DNOTECHECK");
        		}
...
function DoLogic(isOnLoad) {
    onValidate_DNOTE_DETAILS__DDATE_CREATED(null, null, null, isOnLoad);
    onValidate_DNOTE_DETAILS__DCREATED_BY(null, null, null, isOnLoad);
    onValidate_DNOTE_DETAILS__DCOVER_TYPE(null, null, null, isOnLoad);
    onValidate_DNOTE_DETAILS__DNOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_DNOTE_DETAILS__DNOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_DNOTE_DETAILS__DNOTECHECK(null, null, null, isOnLoad);
}
</script>
...
<div id="id2cfaf3d375144560b26b4b8f6ed96882" class="general-layout-container">
...
<div id="id15172d6639a844868385cc7f2f6e5732" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading85" runat="server" Text="Sub Section D:Container Note Detail  (Not Printed on Schedule)" /></legend>
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="DNOTE_DETAILS" 
		data-property-name="DDATE_CREATED" 
		id="pb-container-datejquerycompatible-DNOTE_DETAILS-DDATE_CREATED">
		<asp:Label ID="lblDNOTE_DETAILS_DDATE_CREATED" runat="server" AssociatedControlID="DNOTE_DETAILS__DDATE_CREATED" 
			Text="Date Created" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="DNOTE_DETAILS__DDATE_CREATED" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calDNOTE_DETAILS__DDATE_CREATED" runat="server" LinkedControl="DNOTE_DETAILS__DDATE_CREATED" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valDNOTE_DETAILS_DDATE_CREATED" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Date Created"
			ClientValidationFunction="onValidate_DNOTE_DETAILS__DDATE_CREATED" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DNOTE_DETAILS" 
		data-property-name="DCREATED_BY" 
		 
		
		 
		id="pb-container-text-DNOTE_DETAILS-DCREATED_BY">

		
		<asp:Label ID="lblDNOTE_DETAILS_DCREATED_BY" runat="server" AssociatedControlID="DNOTE_DETAILS__DCREATED_BY" 
			Text="Created by" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DNOTE_DETAILS__DCREATED_BY" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDNOTE_DETAILS_DCREATED_BY" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Created by"
					ClientValidationFunction="onValidate_DNOTE_DETAILS__DCREATED_BY"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DNOTE_DETAILS" 
		data-property-name="DCOVER_TYPE" 
		 
		
		 
		id="pb-container-text-DNOTE_DETAILS-DCOVER_TYPE">

		
		<asp:Label ID="lblDNOTE_DETAILS_DCOVER_TYPE" runat="server" AssociatedControlID="DNOTE_DETAILS__DCOVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DNOTE_DETAILS__DCOVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDNOTE_DETAILS_DCOVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_DNOTE_DETAILS__DCOVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DNOTE_DETAILS" 
		data-property-name="DNOTE_DESCRIPTION" 
		 
		
		 
		id="pb-container-text-DNOTE_DETAILS-DNOTE_DESCRIPTION">

		
		<asp:Label ID="lblDNOTE_DETAILS_DNOTE_DESCRIPTION" runat="server" AssociatedControlID="DNOTE_DETAILS__DNOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DNOTE_DETAILS__DNOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDNOTE_DETAILS_DNOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_DNOTE_DETAILS__DNOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="DNOTE_DETAILS" 
		data-property-name="DNOTE_DETAILS" 
		id="pb-container-comment-DNOTE_DETAILS-DNOTE_DETAILS">
		<asp:Label ID="lblDNOTE_DETAILS_DNOTE_DETAILS" runat="server" class="col-md-4 col-sm-3 control-label" AssociatedControlID="DNOTE_DETAILS__DNOTE_DETAILS" 
			Text="Details"></asp:Label>
		
		 <div class="col-md-8 col-sm-9">
	        <asp:HiddenField ID="DNOTE_DETAILS__DNOTE_DETAILS" runat="server" />
		
		<asp:CustomValidator ID="valDNOTE_DETAILS_DNOTE_DETAILS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Details"
			ClientValidationFunction="onValidate_DNOTE_DETAILS__DNOTE_DETAILS"
			ValidationGroup="" 
			Display="None"
			EnableClientScript="true"/>
         </div>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblDNOTE_DETAILS_DNOTECHECK" for="ctl00_cntMainBody_DNOTE_DETAILS__DNOTECHECK" class="col-md-4 col-sm-3 control-label">
		Check If Note should be editable</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="DNOTE_DETAILS" 
		data-property-name="DNOTECHECK" 
		id="pb-container-checkbox-DNOTE_DETAILS-DNOTECHECK">	
		
		<asp:TextBox ID="DNOTE_DETAILS__DNOTECHECK" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valDNOTE_DETAILS_DNOTECHECK" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_DNOTE_DETAILS__DNOTECHECK" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id15172d6639a844868385cc7f2f6e5732 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id15172d6639a844868385cc7f2f6e5732 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id15172d6639a844868385cc7f2f6e5732 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id15172d6639a844868385cc7f2f6e5732 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id15172d6639a844868385cc7f2f6e5732 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15172d6639a844868385cc7f2f6e5732 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15172d6639a844868385cc7f2f6e5732 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id15172d6639a844868385cc7f2f6e5732 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15172d6639a844868385cc7f2f6e5732 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15172d6639a844868385cc7f2f6e5732 input{text-align:left;}"; break;
		}
	}
