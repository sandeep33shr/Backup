<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="NPADOM_Notes.aspx.vb" Inherits="Nexus.PB2_NPADOM_Notes" %>
...
function onValidate_NOTES__DOMNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "DOMNOTES", "ChildScreen");
        })();
}
function onValidate_NOTES__DOMEXTRN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "NOTES", "DOMEXTRN", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_NOTES__DOMNOTES(null, null, null, isOnLoad);
    onValidate_NOTES__DOMEXTRN(null, null, null, isOnLoad);
}
</script>
...
<div id="idf182450394f2493e99129953179026ed" class="general-layout-container">
...
<div id="idfbf88e4224dd4e70840fdcf50195aeba" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading43" runat="server" Text="Domestic Risk Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__DOMNOTES"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="DOMNOTES" 
		id="pb-container-childscreen-NOTES-DOMNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__CNOTE_DETAILS" runat="server" ScreenCode="DOMNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DOMNOTES/DOMNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_DOMNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__DOMNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfbf88e4224dd4e70840fdcf50195aeba div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfbf88e4224dd4e70840fdcf50195aeba div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfbf88e4224dd4e70840fdcf50195aeba div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfbf88e4224dd4e70840fdcf50195aeba label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfbf88e4224dd4e70840fdcf50195aeba label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfbf88e4224dd4e70840fdcf50195aeba label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfbf88e4224dd4e70840fdcf50195aeba label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfbf88e4224dd4e70840fdcf50195aeba input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfbf88e4224dd4e70840fdcf50195aeba input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfbf88e4224dd4e70840fdcf50195aeba input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6c2e8a297c88453299472285374e77af" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading44" runat="server" Text="Subjectivities (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_NOTES__DOMEXTRN"
		data-field-type="Child" 
		data-object-name="NOTES" 
		data-property-name="DOMEXTRN" 
		id="pb-container-childscreen-NOTES-DOMEXTRN">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="NOTES__EXT_DETAILS" runat="server" ScreenCode="DOMEXTRN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DOMEXTRN/DOMEXTRN_Subjectivities_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valNOTES_DOMEXTRN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_NOTES__DOMEXTRN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6c2e8a297c88453299472285374e77af div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6c2e8a297c88453299472285374e77af div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6c2e8a297c88453299472285374e77af div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6c2e8a297c88453299472285374e77af label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6c2e8a297c88453299472285374e77af label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c2e8a297c88453299472285374e77af label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c2e8a297c88453299472285374e77af label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6c2e8a297c88453299472285374e77af input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c2e8a297c88453299472285374e77af input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c2e8a297c88453299472285374e77af input{text-align:left;}"; break;
		}
	}
