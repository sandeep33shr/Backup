...
Namespace Nexus
    Partial Class PB2_SAENDORSE_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_SEC_A__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_SEC_A__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'EXTENSIONS - Standard Wording Parent Object
        'REFFERRAL_CLAUSES - Standard Wording Parent Property
        'SEC_A - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/EXTENSIONS/SW.REFFERRAL_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("SEC_A__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/EXTENSIONS/SEC_A")
        
        	Dim CurrentSelected As String = SEC_A__ENDORSE_CAP.Text
