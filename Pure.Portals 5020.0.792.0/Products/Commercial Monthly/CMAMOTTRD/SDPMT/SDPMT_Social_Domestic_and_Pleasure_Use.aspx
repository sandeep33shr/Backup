<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SDPMT_Social_Domestic_and_Pleasure_Use.aspx.vb" Inherits="Nexus.PB2_SDPMT_Social_Domestic_and_Pleasure_Use" %>
...
function onValidate_SDPMT_CHILD__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SDPMT_CHILD", "NAME", "Text");
        })();
        /**
         * Set the control width
         */
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("SDPMT_CHILD.NAME");
        			window.setControlWidth(field, "0.8", "SDPMT_CHILD", "NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblSDPMT_CHILD_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_SDPMT_CHILD__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_SDPMT_CHILD__NAME_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("SDPMT_CHILD", "NAME");
        		var errorMessage = "Please enter Name and Surname";
...
function DoLogic(isOnLoad) {
    onValidate_SDPMT_CHILD__NAME(null, null, null, isOnLoad);
}
</script>
...
<div id="idf1b0c1c14ece4891afa0e2ba7e1ab718" class="general-layout-container">
...
<div id="id6d416d5b283e41dc9f59db27cf6d629f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="Social, Domestic and Pleasure Use" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="SDPMT_CHILD" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-SDPMT_CHILD-NAME">

		
		<asp:Label ID="lblSDPMT_CHILD_NAME" runat="server" AssociatedControlID="SDPMT_CHILD__NAME" 
			Text="Driver Name and Surname" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SDPMT_CHILD__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSDPMT_CHILD_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Driver Name and Surname"
					ClientValidationFunction="onValidate_SDPMT_CHILD__NAME"
					ValidationGroup=""
					Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6d416d5b283e41dc9f59db27cf6d629f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6d416d5b283e41dc9f59db27cf6d629f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6d416d5b283e41dc9f59db27cf6d629f div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6d416d5b283e41dc9f59db27cf6d629f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6d416d5b283e41dc9f59db27cf6d629f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d416d5b283e41dc9f59db27cf6d629f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d416d5b283e41dc9f59db27cf6d629f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6d416d5b283e41dc9f59db27cf6d629f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d416d5b283e41dc9f59db27cf6d629f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d416d5b283e41dc9f59db27cf6d629f input{text-align:left;}"; break;
		}
	}
