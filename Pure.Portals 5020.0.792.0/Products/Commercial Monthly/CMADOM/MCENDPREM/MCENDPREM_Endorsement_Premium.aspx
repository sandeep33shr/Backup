<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MCENDPREM_Endorsement_Premium.aspx.vb" Inherits="Nexus.PB2_MCENDPREM_Endorsement_Premium" %>
...
function onValidate_MC_CLAUSE__ENDORSE_ID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MC_CLAUSE", "ENDORSE_ID", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MC_CLAUSE", "ENDORSE_ID");
        		}
...
function onValidate_MC_CLAUSE__ENDORSE_DESC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MC_CLAUSE", "ENDORSE_DESC", "List");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MC_CLAUSE", "ENDORSE_DESC");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMC_CLAUSE_ENDORSE_DESC");
        			    var ele = document.getElementById('ctl00_cntMainBody_MC_CLAUSE__ENDORSE_DESC');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MC_CLAUSE__ENDORSE_DESC_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MC_CLAUSE.ENDORSE_DESC");
        			window.setControlWidth(field, "0.5", "MC_CLAUSE", "ENDORSE_DESC");
        		})();
        	}
        })();
}
function onValidate_MC_CLAUSE__ENDORSE_CAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MC_CLAUSE", "ENDORSE_CAP", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MC_CLAUSE", "ENDORSE_CAP");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=MC_CLAUSE&propertyName=ENDORSE_CAP&name={name}");
        		
        		var value = new Expression("Caption(MC_CLAUSE.ENDORSE_DESC)"), 
...
function onValidate_MC_CLAUSE__PREMIUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MC_CLAUSE", "PREMIUM", "Currency");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("MC_CLAUSE", "PREMIUM");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MC_CLAUSE.PREMIUM");
        			window.setControlWidth(field, "0.3", "MC_CLAUSE", "PREMIUM");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMC_CLAUSE_PREMIUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_MC_CLAUSE__PREMIUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MC_CLAUSE__PREMIUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function DoLogic(isOnLoad) {
    onValidate_MC_CLAUSE__ENDORSE_ID(null, null, null, isOnLoad);
    onValidate_MC_CLAUSE__ENDORSE_DESC(null, null, null, isOnLoad);
    onValidate_MC_CLAUSE__ENDORSE_CAP(null, null, null, isOnLoad);
    onValidate_MC_CLAUSE__PREMIUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id445828ada31148748c2244861065725b" class="general-layout-container">
...
<div id="id27eb86ee51144ef9bd15081f6654eaf4" class="column-layout-container  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="MC_CLAUSE" 
		data-property-name="ENDORSE_ID" 
		id="pb-container-integer-MC_CLAUSE-ENDORSE_ID">
		<asp:Label ID="lblMC_CLAUSE_ENDORSE_ID" runat="server" AssociatedControlID="MC_CLAUSE__ENDORSE_ID" 
			Text="Endorsement ID" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MC_CLAUSE__ENDORSE_ID" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMC_CLAUSE_ENDORSE_ID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement ID"
			ClientValidationFunction="onValidate_MC_CLAUSE__ENDORSE_ID" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-list-MC_CLAUSE-ENDORSE_DESC">
		<asp:Label ID="lblMC_CLAUSE_ENDORSE_DESC" runat="server" AssociatedControlID="MC_CLAUSE__ENDORSE_DESC" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="MC_CLAUSE__ENDORSE_DESC" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ENDORSEPREM" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_MC_CLAUSE__ENDORSE_DESC(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valMC_CLAUSE_ENDORSE_DESC" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Endorsement"
			ClientValidationFunction="onValidate_MC_CLAUSE__ENDORSE_DESC" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MC_CLAUSE-ENDORSE_CAP">

		
		<asp:Label ID="lblMC_CLAUSE_ENDORSE_CAP" runat="server" AssociatedControlID="MC_CLAUSE__ENDORSE_CAP" 
			Text="Endorsement" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MC_CLAUSE__ENDORSE_CAP" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valMC_CLAUSE_ENDORSE_CAP" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Endorsement"
					ClientValidationFunction="onValidate_MC_CLAUSE__ENDORSE_CAP"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-MC_CLAUSE-PREMIUM">
		<asp:Label ID="lblMC_CLAUSE_PREMIUM" runat="server" AssociatedControlID="MC_CLAUSE__PREMIUM" 
			Text="Premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MC_CLAUSE__PREMIUM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMC_CLAUSE_PREMIUM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Premium"
			ClientValidationFunction="onValidate_MC_CLAUSE__PREMIUM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MC_CLAUSE-ENDORSE_DESCCode">

		
		
			
		
				<asp:HiddenField ID="MC_CLAUSE__ENDORSE_DESCCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id27eb86ee51144ef9bd15081f6654eaf4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id27eb86ee51144ef9bd15081f6654eaf4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id27eb86ee51144ef9bd15081f6654eaf4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id27eb86ee51144ef9bd15081f6654eaf4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id27eb86ee51144ef9bd15081f6654eaf4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27eb86ee51144ef9bd15081f6654eaf4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27eb86ee51144ef9bd15081f6654eaf4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id27eb86ee51144ef9bd15081f6654eaf4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id27eb86ee51144ef9bd15081f6654eaf4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id27eb86ee51144ef9bd15081f6654eaf4 input{text-align:left;}"; break;
		}
	}
