...
Namespace Nexus
    Partial Class PB2_BLDENDPREM_Endorsement_Premium : Inherits BaseRisk
...
End Sub
        ...
        'Parameters:
        'BUILDINGS - Standard Wording Parent Object
        'BLD_CLAUSES - Standard Wording Parent Property
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/BUILDINGS/SW.BLD_CLAUSES")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/BUILDINGS/MB_CLAUSE")
