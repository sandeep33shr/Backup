...
Namespace Nexus
    Partial Class PB2_CMADOM_Buildings : Inherits BaseRisk
		...
		Protected Sub onValidate_BUILDINGS__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_BUILDINGS__EFFECTIVEDATE()
...
Protected Sub CallRuleScripts()
    onValidate_BUILDINGS__ATTACHMENTDATE()
    onValidate_BUILDINGS__EFFECTIVEDATE()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If BUILDINGS__ATTACHMENTDATE.Text = "" or BUILDINGS__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			BUILDINGS__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			BUILDINGS__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (BUILDINGS__ATTACHMENTDATE.Text <> "" Or BUILDINGS__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		BUILDINGS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		BUILDINGS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		BUILDINGS__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
