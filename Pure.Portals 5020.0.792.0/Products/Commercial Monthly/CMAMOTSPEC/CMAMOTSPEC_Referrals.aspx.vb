...
Namespace Nexus
    Partial Class PB2_CMAMOTSPEC_Referrals : Inherits BaseRisk
		...
		Protected Sub onValidate_REFERRALS__CMAMSREFER()
...
Protected Sub CallRuleScripts()
    onValidate_REFERRALS__CMAMSREFER()
                ...
                Private Sub RequestApproval(ByVal sGroupCode As String)
                    ...
                    Try
                        ...
                        If sGroupCode <> "" Then
                            ...
                            're-assigning the RequestorComment field with the current value from the screen
                            If objDataSet.Risk.Item("REFERRALS").Item("RequestorComment").Value IsNot Nothing Then
                                objDataSet.Risk.Item("REFERRALS").Item("RequestorComment").Value = REFERRALS__RequestorComment.Value
                            End If
