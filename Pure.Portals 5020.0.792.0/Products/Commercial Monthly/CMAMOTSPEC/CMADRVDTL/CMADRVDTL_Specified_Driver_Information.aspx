<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMADRVDTL_Specified_Driver_Information.aspx.vb" Inherits="Nexus.PB2_CMADRVDTL_Specified_Driver_Information" %>
...
function onValidate_DRIVER_DET__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DRIVER_DET", "NAME", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DRIVER_DET", "NAME");
        		var errorMessage = "Driver Name & Surname is mandatory and must be entered";
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblDRIVER_DET_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_DRIVER_DET__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_DRIVER_DET__NAME_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DRIVER_DET.NAME");
        			window.setControlWidth(field, "0.8", "DRIVER_DET", "NAME");
        		})();
        	}
        })();
...
function onValidate_DRIVER_DET__ID_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DRIVER_DET", "ID_TYPE", "List");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DRIVER_DET", "ID_TYPE");
        		var errorMessage = "ID Type is mandatory and an option must be selected";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblDRIVER_DET_ID_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_DRIVER_DET__ID_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_DRIVER_DET__ID_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DRIVER_DET.ID_TYPE");
        			window.setControlWidth(field, "0.8", "DRIVER_DET", "ID_TYPE");
        		})();
        	}
        })();
...
function onValidate_DRIVER_DET__ID_NUM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DRIVER_DET", "ID_NUM", "Text");
        })();
        /**
         * @fileoverview
         * Check if a mandatory field has been left empty.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DRIVER_DET", "ID_NUM");
        		var errorMessage = "ID Number is mandatory and must be entered";
        		field.setMandatory(true, (Expression.isValidParameter(errorMessage)) ? errorMessage : undefined);
        	};
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblDRIVER_DET_ID_NUM");
        			    var ele = document.getElementById('ctl00_cntMainBody_DRIVER_DET__ID_NUM');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_DRIVER_DET__ID_NUM_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DRIVER_DET.ID_NUM");
        			window.setControlWidth(field, "0.8", "DRIVER_DET", "ID_NUM");
        		})();
        	}
        })();
...
function DoLogic(isOnLoad) {
    onValidate_DRIVER_DET__NAME(null, null, null, isOnLoad);
    onValidate_DRIVER_DET__ID_TYPE(null, null, null, isOnLoad);
    onValidate_DRIVER_DET__ID_NUM(null, null, null, isOnLoad);
}
</script>
...
<div id="id154a921b52134c9fa0a3abf59da0cee0" class="general-layout-container">
...
<div id="frmDriver" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading18" runat="server" Text="Driver Information" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DRIVER_DET" 
		data-property-name="NAME" 
		 
		
		 
		id="pb-container-text-DRIVER_DET-NAME">

		
		<asp:Label ID="lblDRIVER_DET_NAME" runat="server" AssociatedControlID="DRIVER_DET__NAME" 
			Text="Driver Name & Surname" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DRIVER_DET__NAME" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDRIVER_DET_NAME" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Driver Name & Surname"
					ClientValidationFunction="onValidate_DRIVER_DET__NAME"
					ValidationGroup=""
					Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="DRIVER_DET" 
		data-property-name="ID_TYPE" 
		id="pb-container-list-DRIVER_DET-ID_TYPE">
		<asp:Label ID="lblDRIVER_DET_ID_TYPE" runat="server" AssociatedControlID="DRIVER_DET__ID_TYPE" 
			Text="ID Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="DRIVER_DET__ID_TYPE" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_ID_TYPE" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_DRIVER_DET__ID_TYPE(null, null, this);" data-type="List" />
			<asp:CustomValidator ID="valDRIVER_DET_ID_TYPE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for ID Type"
			ClientValidationFunction="onValidate_DRIVER_DET__ID_TYPE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DRIVER_DET" 
		data-property-name="ID_NUM" 
		 
		
		 
		id="pb-container-text-DRIVER_DET-ID_NUM">

		
		<asp:Label ID="lblDRIVER_DET_ID_NUM" runat="server" AssociatedControlID="DRIVER_DET__ID_NUM" 
			Text="ID Number " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DRIVER_DET__ID_NUM" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDRIVER_DET_ID_NUM" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for ID Number "
					ClientValidationFunction="onValidate_DRIVER_DET__ID_NUM"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="DRIVER_DET" 
		data-property-name="ID_TYPECode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-DRIVER_DET-ID_TYPECode">

		
		
			
		
				<asp:HiddenField ID="DRIVER_DET__ID_TYPECode" runat="server" />
