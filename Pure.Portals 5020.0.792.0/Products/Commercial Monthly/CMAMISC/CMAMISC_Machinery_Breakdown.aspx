<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISC_Machinery_Breakdown.aspx.vb" Inherits="Nexus.PB2_CMAMISC_Machinery_Breakdown" %>
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "MBREAK" && field.getPropertyName() == "ATTACHMENTDATE")
...
function onValidate_MBREAK__TOTAL_PREM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("MBREAK.MB_TOTPREM + MBREAK.MB_TOTENDPREM + MBREAK.OTH_TOT_PREM + MBREAK.POST_TOTAL + MBREAK.TOT_PREM "), 
...
function onValidate_SEQCNT_MB__SEQ_COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEQCNT_MB", "SEQ_COUNT", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SEQCNT_MB", "SEQ_COUNT");
        		}
          ...
          * @fileoverview GetColumn
          * @param MBREAK The Parent (Root) object name.
          * @param MB_ITEM.INCR The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MBREAK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MB_ITEM.INCR";
        		//count, average, total, min, max
...
function onValidate_SEQCNT_MB__COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "SEQCNT_MB", "COUNT", "Text");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("SEQCNT_MB", "COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_MBREAK__MBITEM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBITEM", "ChildScreen");
        })();
}
function onValidate_MBREAK__MB_COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MB_COUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MBREAK", "MB_COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param MBREAK The Parent (Root) object name.
          * @param MB_ITEM.COUNTER_ID The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MBREAK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MB_ITEM.COUNTER_ID";
        		//count, average, total, min, max
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Add at least Machinery Breakdown Item")) ? "Add at least Machinery Breakdown Item" : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "MBREAK".toUpperCase() + "__" + "MB_COUNT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "MBREAK".toUpperCase() + "_" + "MB_COUNT");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("MBREAK.MB_COUNT < 1");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_MBREAK__ACPC_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "MBREAK.IS_ACPC= 1", "V", "Additional Claims Preparation Costs Limit of Indemnity is mandatory and an amount must be entered");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("MBREAK.ACPC_POST_PREMIUM.setValue(MBREAK.ACPC_SUMINSURED * MBREAK.ACPC_RATE / 100)");
        		var whenExp = (Expression.isValidParameter("(MBREAK.ACPC_SUMINSURED <> '' AND MBREAK.ACPC_SUMINSURED <> null) AND (MBREAK.ACPC_RATE <> '' AND MBREAK.ACPC_RATE <> null) AND MBREAK.IS_ACPC = 1")) ? new Expression("(MBREAK.ACPC_SUMINSURED <> '' AND MBREAK.ACPC_SUMINSURED <> null) AND (MBREAK.ACPC_RATE <> '' AND MBREAK.ACPC_RATE <> null) AND MBREAK.IS_ACPC = 1") : null;
...
function onValidate_MBREAK__ACPC_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Additional Claims Preparations Costs Rate cannot be more than 100%")) ? "Additional Claims Preparations Costs Rate cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_MBREAK__ACPC_POST_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "MBREAK.IS_ACPC= 1", "V", "Additional Claims Preparation Costs Posting Premium is mandatory and an amount must be entered");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("MBREAK.ACPC_RATE.setValue(MBREAK.ACPC_POST_PREMIUM/MBREAK.ACPC_SUMINSURED * 100)");
        		var whenExp = (Expression.isValidParameter("(MBREAK.ACPC_SUMINSURED <> '' AND MBREAK.ACPC_SUMINSURED <> null) AND (MBREAK.ACPC_RATE <> '' AND MBREAK.ACPC_RATE <> null) AND MBREAK.IS_ACPC = 1")) ? new Expression("(MBREAK.ACPC_SUMINSURED <> '' AND MBREAK.ACPC_SUMINSURED <> null) AND (MBREAK.ACPC_RATE <> '' AND MBREAK.ACPC_RATE <> null) AND MBREAK.IS_ACPC = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_MBREAK__EDO_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "MBREAK.IS_EDO = 1", "V", "Express Delivery and Overtime Limit of Indemnity is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "MBREAK.IS_EDO = 1",
            paramElseValue = "V",
            paramValidationMessage = "Express Delivery and Overtime Limit of Indemnity is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("MBREAK.EDO_POST_PREMIUM.setValue(MBREAK.EDO_SUMINSURED * MBREAK.EDO_RATE / 100)");
        		var whenExp = (Expression.isValidParameter("(MBREAK.EDO_SUMINSURED <> '' AND MBREAK.EDO_SUMINSURED <> null) AND (MBREAK.EDO_RATE <> '' AND MBREAK.EDO_RATE <> null) AND MBREAK.IS_EDO = 1")) ? new Expression("(MBREAK.EDO_SUMINSURED <> '' AND MBREAK.EDO_SUMINSURED <> null) AND (MBREAK.EDO_RATE <> '' AND MBREAK.EDO_RATE <> null) AND MBREAK.IS_EDO = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_MBREAK__EDO_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Express Delivery and Overtime Rate cannot be more than 100%")) ? "Express Delivery and Overtime Rate cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_MBREAK__EDO_POST_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "MBREAK.IS_EDO = 1", "V", "Express Delivery and Overtime Posting Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "MBREAK.IS_EDO = 1",
            paramElseValue = "V",
            paramValidationMessage = "Express Delivery and Overtime Posting Premium is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("MBREAK.EDO_RATE.setValue(MBREAK.EDO_POST_PREMIUM / MBREAK.EDO_SUMINSURED * 100)");
        		var whenExp = (Expression.isValidParameter("(MBREAK.EDO_SUMINSURED <> '' AND MBREAK.EDO_SUMINSURED <> null) AND (MBREAK.EDO_RATE <> '' AND MBREAK.EDO_RATE <> null) AND MBREAK.IS_EDO = 1")) ? new Expression("(MBREAK.EDO_SUMINSURED <> '' AND MBREAK.EDO_SUMINSURED <> null) AND (MBREAK.EDO_RATE <> '' AND MBREAK.EDO_RATE <> null) AND MBREAK.IS_EDO = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_MBREAK__EDO_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Express Delivery and Overtime FAP % cannot be more than 100%")) ? "Express Delivery and Overtime FAP % cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_MBREAK__FMR_SUMINSURED(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "MBREAK.IS_FMR = 1", "V", "Foundations and Masonry Refractories Limit of Indemnity is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "MBREAK.IS_FMR = 1",
            paramElseValue = "V",
            paramValidationMessage = "Foundations and Masonry Refractories Limit of Indemnity is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("MBREAK.FMR_POST_PREMIUM.setValue(MBREAK.FMR_SUMINSURED * MBREAK.FMR_RATE / 100)");
        		var whenExp = (Expression.isValidParameter("(MBREAK.FMR_SUMINSURED <> '' AND MBREAK.FMR_SUMINSURED <> null) AND (MBREAK.FMR_RATE <> '' AND MBREAK.FMR_RATE <> null) AND MBREAK.IS_FMR = 1")) ? new Expression("(MBREAK.FMR_SUMINSURED <> '' AND MBREAK.FMR_SUMINSURED <> null) AND (MBREAK.FMR_RATE <> '' AND MBREAK.FMR_RATE <> null) AND MBREAK.IS_FMR = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_MBREAK__FMR_RATE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Foundations and Masonry Refractories Rate cannot be more than 100%")) ? "Foundations and Masonry Refractories Rate cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_MBREAK__FMR_POST_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "MBREAK.IS_FMR = 1", "V", "Foundations and Masonry Refractories Posting Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "MBREAK.IS_FMR = 1",
            paramElseValue = "V",
            paramValidationMessage = "Foundations and Masonry Refractories Posting Premium is mandatory and an amount must be entered";
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("MBREAK.FMR_RATE.setValue(MBREAK.FMR_POST_PREMIUM / MBREAK.FMR_SUMINSURED * 100)");
        		var whenExp = (Expression.isValidParameter("(MBREAK.FMR_SUMINSURED <> '' AND MBREAK.FMR_SUMINSURED <> null) AND (MBREAK.FMR_RATE <> '' AND MBREAK.FMR_RATE <> null) AND MBREAK.IS_FMR = 1")) ? new Expression("(MBREAK.FMR_SUMINSURED <> '' AND MBREAK.FMR_SUMINSURED <> null) AND (MBREAK.FMR_RATE <> '' AND MBREAK.FMR_RATE <> null) AND MBREAK.IS_FMR = 1") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_MBREAK__FMR_FAP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Foundations and Masonry Refractories FAP % cannot be more than 100%")) ? "Foundations and Masonry Refractories FAP % cannot be more than 100%" : null;
        			args.IsValid = false;
        			if (message != null){
...
function onValidate_MBREAK__RIOT_POST_PREMIUM(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		//window.setProperty(field, "VEM", "MBREAK.IS_RIOT = 1", "V", "Riot and Strike Posting Premium is mandatory and an amount must be entered");
        
            var paramValue = "VEM",
            paramCondition = "MBREAK.IS_RIOT = 1",
            paramElseValue = "V",
            paramValidationMessage = "Riot and Strike Posting Premium is mandatory and an amount must be entered";
...
function onValidate_MBREAK__MBOTHEX(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBOTHEX", "ChildScreen");
        })();
}
function onValidate_MBREAK__OTH_TOT_PREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "OTH_TOT_PREM", "Currency");
        })();
        
         /**
          * @fileoverview GetColumn
          * @param MBREAK The Parent (Root) object name.
          * @param MB_OEXTENSIONS.POST_PREMIUM The object.property to sum the totals of.
          * @param TOTAL The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MBREAK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MB_OEXTENSIONS.POST_PREMIUM";
        		//count, average, total, min, max
        		var type = "TOTAL".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
        		...
        		var field = Field.getInstance("MBREAK", "OTH_TOT_PREM");
        		try {
...
function onValidate_MBREAK__MB_OTH_COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MB_OTH_COUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MBREAK", "MB_OTH_COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param MBREAK The Parent (Root) object name.
          * @param MB_OEXTENSIONS.COUNTER_ID The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MBREAK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MB_OEXTENSIONS.COUNTER_ID";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_MBREAK__MB_FAP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MB_FAP", "ChildScreen");
        })();
}
function onValidate_MBREAK__MB_FAP_COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MB_FAP_COUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MBREAK", "MB_FAP_COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param MBREAK The Parent (Root) object name.
          * @param MB_FAP.COUNTER_ID The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MBREAK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MB_FAP.COUNTER_ID";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function onValidate_MBREAK__MBEDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBEDPREM", "ChildScreen");
        })();
}
function onValidate_MBREAK__MB_END_COUNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MB_END_COUNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MBREAK", "MB_END_COUNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_MBREAK__MBNTS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBNTS", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MBREAK", "MBNTS");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_MBREAK__MBNTS table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MBREAK", "MBNTS");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MBREAK' and property 'MBNTS'.");
        			error.display();
...
function onValidate_MBREAK__MBSNTS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBSNTS", "ChildScreen");
        })();
}
function onValidate_MBREAK__MB_NTS_CNT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MB_NTS_CNT", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MBREAK", "MB_NTS_CNT");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @fileoverview GetColumn
          * @param MBREAK The Parent (Root) object name.
          * @param MB_SNOTES.DATE_CREATED The object.property to sum the totals of.
          * @param COUNT The type of query to do. Accepts TOTAL, COUNT, MIN, MAX, AVERAGE
          * @param {3} Deprecated, The condition for each child row, in the child row context
          */ 
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MBREAK".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "MB_SNOTES.DATE_CREATED";
        		//count, average, total, min, max
        		var type = "COUNT".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var condition = (Expression.isValidParameter("{3}")) ? ("{3}") : ("true");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_SEQCNT_MB__SEQ_COUNT(null, null, null, isOnLoad);
    onValidate_SEQCNT_MB__COUNT(null, null, null, isOnLoad);
    onValidate_MBREAK__MBITEM(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_COUNT(null, null, null, isOnLoad);
    ...
    onValidate_MBREAK__MBOTHEX(null, null, null, isOnLoad);
    onValidate_MBREAK__OTH_TOT_PREM(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_OTH_COUNT(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_FAP(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_FAP_COUNT(null, null, null, isOnLoad);
    onValidate_MBREAK__TOT_PREM(null, null, null, isOnLoad);
    onValidate_MBREAK__MBEDPREM(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_END_COUNT(null, null, null, isOnLoad);
    onValidate_MBREAK__MBNTS(null, null, null, isOnLoad);
    onValidate_MBREAK__MBSNTS(null, null, null, isOnLoad);
    onValidate_MBREAK__MB_NTS_CNT(null, null, null, isOnLoad);
}
</script>
...
<div id="id6977b26ef7c041b596385d90bb6cb1b0" class="general-layout-container">
...
<div id="idccaacc1e9f4b4c4484034a81c7b36a1c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading240" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idccaacc1e9f4b4c4484034a81c7b36a1c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idccaacc1e9f4b4c4484034a81c7b36a1c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idccaacc1e9f4b4c4484034a81c7b36a1c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idccaacc1e9f4b4c4484034a81c7b36a1c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idccaacc1e9f4b4c4484034a81c7b36a1c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idccaacc1e9f4b4c4484034a81c7b36a1c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idccaacc1e9f4b4c4484034a81c7b36a1c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idccaacc1e9f4b4c4484034a81c7b36a1c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idccaacc1e9f4b4c4484034a81c7b36a1c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idccaacc1e9f4b4c4484034a81c7b36a1c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id2f5be63a313547a3b7d10e87b38fe557" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading241" runat="server" Text="Machinery Breakdown" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id2f5be63a313547a3b7d10e87b38fe557 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2f5be63a313547a3b7d10e87b38fe557 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2f5be63a313547a3b7d10e87b38fe557 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id2f5be63a313547a3b7d10e87b38fe557 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2f5be63a313547a3b7d10e87b38fe557 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2f5be63a313547a3b7d10e87b38fe557 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2f5be63a313547a3b7d10e87b38fe557 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2f5be63a313547a3b7d10e87b38fe557 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2f5be63a313547a3b7d10e87b38fe557 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2f5be63a313547a3b7d10e87b38fe557 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="iddbfb53f101cc4a0ab331e83f93eac4a4" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading242" runat="server" Text="" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="SEQCNT_MB" 
		data-property-name="SEQ_COUNT" 
		id="pb-container-integer-SEQCNT_MB-SEQ_COUNT">
		<asp:Label ID="lblSEQCNT_MB_SEQ_COUNT" runat="server" AssociatedControlID="SEQCNT_MB__SEQ_COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="SEQCNT_MB__SEQ_COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valSEQCNT_MB_SEQ_COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for SEQCNT_MB.SEQ_COUNT"
			ClientValidationFunction="onValidate_SEQCNT_MB__SEQ_COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-SEQCNT_MB-COUNT">

		
		<asp:Label ID="lblSEQCNT_MB_COUNT" runat="server" AssociatedControlID="SEQCNT_MB__COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="SEQCNT_MB__COUNT" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valSEQCNT_MB_COUNT" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for SEQCNT_MB.COUNT"
					ClientValidationFunction="onValidate_SEQCNT_MB__COUNT"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /Text -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBITEM"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBITEM" 
		id="pb-container-childscreen-MBREAK-MBITEM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_ITEM" runat="server" ScreenCode="MBITEM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITEM/MBITEM_Machinery_Breakdown.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:GISLookupField HeaderText="Basis of Deductible " ListType="PMLookup" ListCode="UDL_CMA_MBCL_BOD" DataField="BASEDEDUCT" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valMBREAK_MBITEM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBITEM"
						ClientValidationFunction="onValidate_MBREAK__MBITEM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MBREAK" 
		data-property-name="MB_COUNT" 
		id="pb-container-integer-MBREAK-MB_COUNT">
		<asp:Label ID="lblMBREAK_MB_COUNT" runat="server" AssociatedControlID="MBREAK__MB_COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MBREAK__MB_COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMBREAK_MB_COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MBREAK.MB_COUNT"
			ClientValidationFunction="onValidate_MBREAK__MB_COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#iddbfb53f101cc4a0ab331e83f93eac4a4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddbfb53f101cc4a0ab331e83f93eac4a4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddbfb53f101cc4a0ab331e83f93eac4a4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#iddbfb53f101cc4a0ab331e83f93eac4a4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddbfb53f101cc4a0ab331e83f93eac4a4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddbfb53f101cc4a0ab331e83f93eac4a4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddbfb53f101cc4a0ab331e83f93eac4a4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddbfb53f101cc4a0ab331e83f93eac4a4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddbfb53f101cc4a0ab331e83f93eac4a4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddbfb53f101cc4a0ab331e83f93eac4a4 input{text-align:left;}"; break;
		}
	}
...
<div id="frmMBE" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading243" runat="server" Text="Extensions" /></legend>
				...
				<div data-column-count="7" data-column-ratio="4:22:16:13:16:13:16" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:4%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label611">
		<span class="label" id="label611"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:22%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label612">
		<span class="label" id="label612"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label613">
		<span class="label" id="label613">Limit of Indemnity</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:13%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label614">
		<span class="label" id="label614">Rate</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label615">
		<span class="label" id="label615">Posting Premium </span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:13%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label616">
		<span class="label" id="label616">FAP %</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label617">
		<span class="label" id="label617">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
									...
									<li class="co-cell"  style="width:22%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label618">
		<span class="label" id="label618">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:13%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label619">
		<span class="label" id="label619"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label620">
		<span class="label" id="label620"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
									...
									<li class="co-cell"  style="width:22%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label621">
		<span class="label" id="label621">Express Delivery and Overtime</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
									...
									<li class="co-cell"  style="width:22%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label622">
		<span class="label" id="label622">Foundations and Masonry Refractories</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
									...
									<li class="co-cell"  style="width:22%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label623">
		<span class="label" id="label623">Riot and Strike </span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label624">
		<span class="label" id="label624"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:13%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label625">
		<span class="label" id="label625"></span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:4%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label626">
		<span class="label" id="label626"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:22%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label627">
		<span class="label" id="label627">Total</span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:16%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label628">
		<span class="label" id="label628"></span>
	</span>
<!-- /Label -->
									...
									<li class="co-cell"  style="width:13%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label629">
		<span class="label" id="label629"></span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:13%;" >
										...
										<!-- Label -->
	<span id="pb-container-label-label630">
		<span class="label" id="label630"></span>
	</span>
<!-- /Label -->
...
<div id="frmMBEChild" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading244" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBOTHEX"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBOTHEX" 
		id="pb-container-childscreen-MBREAK-MBOTHEX">
		
		    <legend>Other Machinery Breakdown Extensions</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_OEXTENSIONS" runat="server" ScreenCode="MBOTHEX" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBOTHEX/MBOTHEX_Other_Machinery_Breakdown_Extensions.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MBOTHEX" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Other Machinery Breakdown Extensions"
						ClientValidationFunction="onValidate_MBREAK__MBOTHEX" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Currency" 
		data-object-name="MBREAK" 
		data-property-name="OTH_TOT_PREM" 
		id="pb-container-currency-MBREAK-OTH_TOT_PREM">
		<asp:Label ID="lblMBREAK_OTH_TOT_PREM" runat="server" AssociatedControlID="MBREAK__OTH_TOT_PREM" 
			Text="Other extension total premium" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="MBREAK__OTH_TOT_PREM" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valMBREAK_OTH_TOT_PREM" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Other extension total premium"
			ClientValidationFunction="onValidate_MBREAK__OTH_TOT_PREM" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MBREAK" 
		data-property-name="MB_OTH_COUNT" 
		id="pb-container-integer-MBREAK-MB_OTH_COUNT">
		<asp:Label ID="lblMBREAK_MB_OTH_COUNT" runat="server" AssociatedControlID="MBREAK__MB_OTH_COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MBREAK__MB_OTH_COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMBREAK_MB_OTH_COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MBREAK.MB_OTH_COUNT"
			ClientValidationFunction="onValidate_MBREAK__MB_OTH_COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1c498f87ca06472db8011e6c9f63e3b4" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading245" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MB_FAP"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MB_FAP" 
		id="pb-container-childscreen-MBREAK-MB_FAP">
		
		    <legend>First Amount Payable </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_FAP" runat="server" ScreenCode="MB_FAP" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MB_FAP/MB_FAP_First_Amount_Payable.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="FAPCHILD_MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MB_FAP" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for First Amount Payable "
						ClientValidationFunction="onValidate_MBREAK__MB_FAP" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MBREAK" 
		data-property-name="MB_FAP_COUNT" 
		id="pb-container-integer-MBREAK-MB_FAP_COUNT">
		<asp:Label ID="lblMBREAK_MB_FAP_COUNT" runat="server" AssociatedControlID="MBREAK__MB_FAP_COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MBREAK__MB_FAP_COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMBREAK_MB_FAP_COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MBREAK.MB_FAP_COUNT"
			ClientValidationFunction="onValidate_MBREAK__MB_FAP_COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id1c498f87ca06472db8011e6c9f63e3b4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1c498f87ca06472db8011e6c9f63e3b4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1c498f87ca06472db8011e6c9f63e3b4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1c498f87ca06472db8011e6c9f63e3b4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1c498f87ca06472db8011e6c9f63e3b4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1c498f87ca06472db8011e6c9f63e3b4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1c498f87ca06472db8011e6c9f63e3b4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1c498f87ca06472db8011e6c9f63e3b4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1c498f87ca06472db8011e6c9f63e3b4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1c498f87ca06472db8011e6c9f63e3b4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id81cbfe1285b64d1687ad0fa6fc7922be" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading246" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- StandardWording -->
	<asp:Label ID="lblMBREAK_MBREAK_CLAUSES" runat="server" AssociatedControlID="MBREAK__MBREAK_CLAUSES" Text="<!-- &LabelCaption -->"></asp:Label>

	

	
		<uc7:SW ID="MBREAK__MBREAK_CLAUSES" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="true" />
...
<!-- /Currency -->
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBEDPREM"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBEDPREM" 
		id="pb-container-childscreen-MBREAK-MBEDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_CLAUSEPREM" runat="server" ScreenCode="MBEDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBEDPREM/MBEDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Premium" DataField="PREMIUM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MBEDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBEDPREM"
						ClientValidationFunction="onValidate_MBREAK__MBEDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MBREAK" 
		data-property-name="MB_END_COUNT" 
		id="pb-container-integer-MBREAK-MB_END_COUNT">
		<asp:Label ID="lblMBREAK_MB_END_COUNT" runat="server" AssociatedControlID="MBREAK__MB_END_COUNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MBREAK__MB_END_COUNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMBREAK_MB_END_COUNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MBREAK.MB_END_COUNT"
			ClientValidationFunction="onValidate_MBREAK__MB_END_COUNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id81cbfe1285b64d1687ad0fa6fc7922be div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id81cbfe1285b64d1687ad0fa6fc7922be div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id81cbfe1285b64d1687ad0fa6fc7922be div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id81cbfe1285b64d1687ad0fa6fc7922be label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id81cbfe1285b64d1687ad0fa6fc7922be label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id81cbfe1285b64d1687ad0fa6fc7922be label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id81cbfe1285b64d1687ad0fa6fc7922be label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id81cbfe1285b64d1687ad0fa6fc7922be input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id81cbfe1285b64d1687ad0fa6fc7922be input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id81cbfe1285b64d1687ad0fa6fc7922be input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idcb92faf921eb44ad87f8772b17f8dd9d" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading247" runat="server" Text="Machinery Breakdown Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBNTS"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBNTS" 
		id="pb-container-childscreen-MBREAK-MBNTS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_NOTES" runat="server" ScreenCode="MBNTS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBNTS/MBNTS_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_MBNTS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBNTS"
						ClientValidationFunction="onValidate_MBREAK__MBNTS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idcb92faf921eb44ad87f8772b17f8dd9d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcb92faf921eb44ad87f8772b17f8dd9d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcb92faf921eb44ad87f8772b17f8dd9d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idcb92faf921eb44ad87f8772b17f8dd9d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcb92faf921eb44ad87f8772b17f8dd9d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcb92faf921eb44ad87f8772b17f8dd9d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcb92faf921eb44ad87f8772b17f8dd9d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcb92faf921eb44ad87f8772b17f8dd9d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcb92faf921eb44ad87f8772b17f8dd9d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcb92faf921eb44ad87f8772b17f8dd9d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idcbb54629879e425bbb8105630a1ed2dc" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading248" runat="server" Text="Machinery Breakdown Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBSNTS"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBSNTS" 
		id="pb-container-childscreen-MBREAK-MBSNTS">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_SNOTES" runat="server" ScreenCode="MBSNTS" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBSNTS/MBSNTS_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_MBSNTS" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBSNTS"
						ClientValidationFunction="onValidate_MBREAK__MBSNTS" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="MBREAK" 
		data-property-name="MB_NTS_CNT" 
		id="pb-container-integer-MBREAK-MB_NTS_CNT">
		<asp:Label ID="lblMBREAK_MB_NTS_CNT" runat="server" AssociatedControlID="MBREAK__MB_NTS_CNT" 
			Text="" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MBREAK__MB_NTS_CNT" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMBREAK_MB_NTS_CNT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for MBREAK.MB_NTS_CNT"
			ClientValidationFunction="onValidate_MBREAK__MB_NTS_CNT" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idcbb54629879e425bbb8105630a1ed2dc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcbb54629879e425bbb8105630a1ed2dc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcbb54629879e425bbb8105630a1ed2dc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idcbb54629879e425bbb8105630a1ed2dc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcbb54629879e425bbb8105630a1ed2dc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcbb54629879e425bbb8105630a1ed2dc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcbb54629879e425bbb8105630a1ed2dc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcbb54629879e425bbb8105630a1ed2dc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcbb54629879e425bbb8105630a1ed2dc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcbb54629879e425bbb8105630a1ed2dc input{text-align:left;}"; break;
		}
	}
