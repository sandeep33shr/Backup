...
function onValidate_GENERAL__CHECK_BAR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Business All Risk Cover cannot be viewed/deleted. Please add the cover first.")) ? "Business All Risk Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_BAR");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_BAR");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_BARCode == 'DELETE' ||GENERAL.CHECK_BARCode == 'VIEW') && (GENERAL.IS_BAR == 0 && GENERAL.BARMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_BAR.setValue(GENERAL.BARMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_BAR = 0 && GENERAL.BARMTA = 1 && GENERAL.CHECK_BARCode <> 'DELETE'")) ? new Expression("GENERAL.IS_BAR = 0 && GENERAL.BARMTA = 1 && GENERAL.CHECK_BARCode <> 'DELETE'") : null;
...
function onValidate_GENERAL__CHECK_GLASS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Glass Cover cannot be viewed/deleted. Please add the cover first.")) ? "Glass Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_GLASS");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_GLASS");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_GLASSCode == 'DELETE' ||GENERAL.CHECK_GLASSCode == 'VIEW') && (GENERAL.IS_GLASS == 0 && GENERAL.GLASSMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_GLASS.setValue(GENERAL.GLASSMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_GLASS = 0 && GENERAL.GLASSMTA = 1 && GENERAL.CHECK_GLASSCode <> 'DELETE'")) ? new Expression("GENERAL.IS_GLASS = 0 && GENERAL.GLASSMTA = 1 && GENERAL.CHECK_GLASSCode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__CHECK_THFT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Theft Cover cannot be viewed/deleted. Please add the cover first.")) ? "Theft Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_THFT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_THFT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_THFTCode == 'DELETE' ||GENERAL.CHECK_THFTCode == 'VIEW') && (GENERAL.IS_THEFT == 0 && GENERAL.THEFTMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_THEFT.setValue(GENERAL.THEFTMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_THEFT = 0 && GENERAL.THEFTMTA = 1 && GENERAL.CHECK_THFTCode <> 'DELETE'")) ? new Expression("GENERAL.IS_THEFT = 0 && GENERAL.THEFTMTA = 1 && GENERAL.CHECK_THFTCode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__CHECK_MONEY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Money Cover cannot be viewed/deleted. Please add the cover first.")) ? "Money Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_MONEY");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_MONEY");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_MONEYCode == 'DELETE' ||GENERAL.CHECK_MONEYCode == 'VIEW') && (GENERAL.IS_MONEY == 0 && GENERAL.MONEYMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_MONEY.setValue(GENERAL.MONEYMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_MONEY = 0 && GENERAL.MONEYMTA = 1 && GENERAL.CHECK_MONEYCode <> 'DELETE'")) ? new Expression("GENERAL.IS_MONEY = 0 && GENERAL.MONEYMTA = 1 && GENERAL.CHECK_MONEYCode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__CHECK_GIT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Goods In Transit Cover cannot be viewed/deleted. Please add the cover first.")) ? "Goods In Transit Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_GIT");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_GIT");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_GITCode == 'DELETE' ||GENERAL.CHECK_GITCode == 'VIEW') && (GENERAL.IS_GIT == 0 && GENERAL.GITMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_GIT.setValue(GENERAL.GITMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_GIT = 0 && GENERAL.GITMTA = 1 && GENERAL.CHECK_GITCode <> 'DELETE'")) ? new Expression("GENERAL.IS_GIT = 0 && GENERAL.GITMTA = 1 && GENERAL.CHECK_GITCode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__CHECK_PA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Group Personal Accident Cover cannot be viewed/deleted. Please add the cover first.")) ? "Group Personal Accident Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_PA");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_PA");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_PACode == 'DELETE' ||GENERAL.CHECK_PACode == 'VIEW') && (GENERAL.IS_PA == 0 && GENERAL.PAMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_PA.setValue(GENERAL.PAMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_PA = 0 && GENERAL.PAMTA = 1 && GENERAL.CHECK_PACode <> 'DELETE'")) ? new Expression("GENERAL.IS_PA = 0 && GENERAL.PAMTA = 1 && GENERAL.CHECK_PACode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__CHECK_SB(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Stated Benefits Cover cannot be viewed/deleted. Please add the cover first.")) ? "Stated Benefits Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_SB");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_SB");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_SBCode == 'DELETE' ||GENERAL.CHECK_SBCode == 'VIEW') && (GENERAL.IS_SB == 0 && GENERAL.SBMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_SB.setValue(GENERAL.SBMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_SB = 0 && GENERAL.SBMTA = 1 && GENERAL.CHECK_SBCode <> 'DELETE'")) ? new Expression("GENERAL.IS_SB = 0 && GENERAL.SBMTA = 1 && GENERAL.CHECK_SBCode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__CHECK_FG(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Fidelity Cover cannot be viewed/deleted. Please add the cover first.")) ? "Fidelity Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_FG");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_FG");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_FGCode == 'DELETE' ||GENERAL.CHECK_FGCode == 'VIEW') && (GENERAL.IS_FIDELITY == 0 && GENERAL.FIDELITYMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_FIDELITY.setValue(GENERAL.FIDELITYMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_FIDELITY = 0 && GENERAL.FIDELITYMTA = 1 && GENERAL.CHECK_FGCode <> 'DELETE'")) ? new Expression("GENERAL.IS_FIDELITY = 0 && GENERAL.FIDELITYMTA = 1 && GENERAL.CHECK_FGCode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__CHECK_ELECEQ(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Electronic Equipment Cover cannot be viewed/deleted. Please add the cover first.")) ? "Electronic Equipment Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_ELECEQCode == 'DELETE' ||GENERAL.CHECK_ELECEQCode == 'VIEW') && (GENERAL.IS_ELECEQUIP == 0 && GENERAL.ELECEQUIPMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_ELECEQUIP.setValue(GENERAL.ELECEQUIPMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_ELECEQUIP = 0 && GENERAL.ELECEQUIPMTA = 1 && GENERAL.CHECK_ELECEQCode <> 'DELETE'")) ? new Expression("GENERAL.IS_ELECEQUIP = 0 && GENERAL.ELECEQUIPMTA = 1 && GENERAL.CHECK_ELECEQCode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__CHECK_MBRK(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			var message = (Expression.isValidParameter("Machinery Breakdown/consequential loss Cover cannot be viewed/deleted. Please add the cover first.")) ? "Machinery Breakdown/consequential loss Cover cannot be viewed/deleted. Please add the cover first." : null;
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "__" + "CHECK_MBRK");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "GENERAL".toUpperCase() + "_" + "CHECK_MBRK");
        				}
        				if (node != null){
        					node.errormessage = message;
        				}
        		...
        		var exp;
        		try {
        			exp = new Expression("(GENERAL.CHECK_MBRKCode == 'DELETE' ||GENERAL.CHECK_MBRKCode == 'VIEW') && (GENERAL.IS_MACHINERY == 0 && GENERAL.MACHINERYMTA == 0)");
        		} catch (e){
        			setInvalid();
        			return;
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var valueExp = new Expression("GENERAL.IS_MACHINERY.setValue(GENERAL.MACHINERYMTA)");
        		var whenExp = (Expression.isValidParameter("GENERAL.IS_MACHINERY = 0 && GENERAL.MACHINERYMTA = 1 && GENERAL.CHECK_MBRKCode <> 'DELETE'")) ? new Expression("GENERAL.IS_MACHINERY = 0 && GENERAL.MACHINERYMTA = 1 && GENERAL.CHECK_MBRKCode <> 'DELETE'") : null;
        		var elseExp = Expression.isValidParameter("{2}") ? new Expression("{2}") : null;
...
function onValidate_GENERAL__BARMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_BAR"), 
        			condition = (Expression.isValidParameter("GENERAL.BARMTA = null && (GENERAL.CHECK_BARCode == '' || GENERAL.CHECK_BARCode == null)")) ? new Expression("GENERAL.BARMTA = null && (GENERAL.CHECK_BARCode == '' || GENERAL.CHECK_BARCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.BARMTA = null && GENERAL.CHECK_BARCode == 'DELETE' ")) ? new Expression("GENERAL.BARMTA = null && GENERAL.CHECK_BARCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__GLASSMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_GLASS"), 
        			condition = (Expression.isValidParameter("GENERAL.GLASSMTA = null && (GENERAL.CHECK_GLASSCode == '' || GENERAL.CHECK_GLASSCode == null)")) ? new Expression("GENERAL.GLASSMTA = null && (GENERAL.CHECK_GLASSCode == '' || GENERAL.CHECK_GLASSCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.GLASSMTA = null && GENERAL.CHECK_GLASSCode == 'DELETE' ")) ? new Expression("GENERAL.GLASSMTA = null && GENERAL.CHECK_GLASSCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__THEFTMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_THEFT"), 
        			condition = (Expression.isValidParameter("GENERAL.THEFTMTA = null  && (GENERAL.CHECK_THFTCode == '' || GENERAL.CHECK_THFTCode == null)")) ? new Expression("GENERAL.THEFTMTA = null  && (GENERAL.CHECK_THFTCode == '' || GENERAL.CHECK_THFTCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.THEFTMTA = null && GENERAL.CHECK_THFTCode == 'DELETE' ")) ? new Expression("GENERAL.THEFTMTA = null && GENERAL.CHECK_THFTCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__MONEYMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_MONEY"), 
        			condition = (Expression.isValidParameter("GENERAL.MONEYMTA = null && (GENERAL.CHECK_MONEYCode == '' || GENERAL.CHECK_MONEYCode == null)")) ? new Expression("GENERAL.MONEYMTA = null && (GENERAL.CHECK_MONEYCode == '' || GENERAL.CHECK_MONEYCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.MONEYMTA = null && GENERAL.CHECK_MONEYCode == 'DELETE' ")) ? new Expression("GENERAL.MONEYMTA = null && GENERAL.CHECK_MONEYCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__GITMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_GIT"), 
        			condition = (Expression.isValidParameter("GENERAL.GITMTA = null && (GENERAL.CHECK_GITCode == '' || GENERAL.CHECK_GITCode == null)")) ? new Expression("GENERAL.GITMTA = null && (GENERAL.CHECK_GITCode == '' || GENERAL.CHECK_GITCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.GITMTA = null && GENERAL.CHECK_GITCode == 'DELETE' ")) ? new Expression("GENERAL.GITMTA = null && GENERAL.CHECK_GITCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__PAMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_PA"), 
        			condition = (Expression.isValidParameter("GENERAL.PAMTA = null && (GENERAL.CHECK_PACode == '' || GENERAL.CHECK_PACode == null)")) ? new Expression("GENERAL.PAMTA = null && (GENERAL.CHECK_PACode == '' || GENERAL.CHECK_PACode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.PAMTA = null && GENERAL.CHECK_PACode == 'DELETE' ")) ? new Expression("GENERAL.PAMTA = null && GENERAL.CHECK_PACode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__SBMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_SB"), 
        			condition = (Expression.isValidParameter("GENERAL.SBMTA = null && (GENERAL.CHECK_SBCode == '' || GENERAL.CHECK_SBCode == null)")) ? new Expression("GENERAL.SBMTA = null && (GENERAL.CHECK_SBCode == '' || GENERAL.CHECK_SBCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.SBMTA = null && GENERAL.CHECK_SBCode == 'DELETE' ")) ? new Expression("GENERAL.SBMTA = null && GENERAL.CHECK_SBCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__FIDELITYMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_FIDELITY"), 
        			condition = (Expression.isValidParameter("GENERAL.FIDELITYMTA = null && (GENERAL.CHECK_FGCode == '' || GENERAL.CHECK_FGCode == null)")) ? new Expression("GENERAL.FIDELITYMTA = null && (GENERAL.CHECK_FGCode == '' || GENERAL.CHECK_FGCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.FIDELITYMTA = null && GENERAL.CHECK_FGCode == 'DELETE' ")) ? new Expression("GENERAL.FIDELITYMTA = null && GENERAL.CHECK_FGCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__ELECEQUIPMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_ELECEQUIP"), 
        			condition = (Expression.isValidParameter("GENERAL.ELECEQUIPMTA = null && (GENERAL.CHECK_ELECEQCode == '' || GENERAL.CHECK_ELECEQCode == null)")) ? new Expression("GENERAL.ELECEQUIPMTA = null && (GENERAL.CHECK_ELECEQCode == '' || GENERAL.CHECK_ELECEQCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.ELECEQUIPMTA = null && GENERAL.CHECK_ELECEQCode == 'DELETE' ")) ? new Expression("GENERAL.ELECEQUIPMTA = null && GENERAL.CHECK_ELECEQCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__MACHINERYMTA(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("GENERAL.IS_MACHINERY"), 
        			condition = (Expression.isValidParameter("GENERAL.MACHINERYMTA = null && (GENERAL.CHECK_MBRKCode == '' || GENERAL.CHECK_MBRKCode == null)")) ? new Expression("GENERAL.MACHINERYMTA = null && (GENERAL.CHECK_MBRKCode == '' || GENERAL.CHECK_MBRKCode == null)") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("1"), 
        			condition = (Expression.isValidParameter("GENERAL.MACHINERYMTA = null && GENERAL.CHECK_MBRKCode == 'DELETE' ")) ? new Expression("GENERAL.MACHINERYMTA = null && GENERAL.CHECK_MBRKCode == 'DELETE' ") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
<div id="id885b7a8813664bc294d1ea0ebf1cf132" class="general-layout-container">
...
<div id="iddb84d30fcaeb476c8799ea8930eb2c21" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddb84d30fcaeb476c8799ea8930eb2c21 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddb84d30fcaeb476c8799ea8930eb2c21 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddb84d30fcaeb476c8799ea8930eb2c21 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddb84d30fcaeb476c8799ea8930eb2c21 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddb84d30fcaeb476c8799ea8930eb2c21 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddb84d30fcaeb476c8799ea8930eb2c21 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddb84d30fcaeb476c8799ea8930eb2c21 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddb84d30fcaeb476c8799ea8930eb2c21 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddb84d30fcaeb476c8799ea8930eb2c21 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddb84d30fcaeb476c8799ea8930eb2c21 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- ColumnLayoutContainer -->
<div id="idc78e747467f040edb6e68024276b446d" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc78e747467f040edb6e68024276b446d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc78e747467f040edb6e68024276b446d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc78e747467f040edb6e68024276b446d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc78e747467f040edb6e68024276b446d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc78e747467f040edb6e68024276b446d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc78e747467f040edb6e68024276b446d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc78e747467f040edb6e68024276b446d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc78e747467f040edb6e68024276b446d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc78e747467f040edb6e68024276b446d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc78e747467f040edb6e68024276b446d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf9c9d63f65024c65a9ebf8417a85e9ea" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf9c9d63f65024c65a9ebf8417a85e9ea div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf9c9d63f65024c65a9ebf8417a85e9ea div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf9c9d63f65024c65a9ebf8417a85e9ea div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf9c9d63f65024c65a9ebf8417a85e9ea label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf9c9d63f65024c65a9ebf8417a85e9ea label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9c9d63f65024c65a9ebf8417a85e9ea label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9c9d63f65024c65a9ebf8417a85e9ea label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf9c9d63f65024c65a9ebf8417a85e9ea input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9c9d63f65024c65a9ebf8417a85e9ea input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9c9d63f65024c65a9ebf8417a85e9ea input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8db6981203c841b09921c7af678dcf4b" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8db6981203c841b09921c7af678dcf4b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8db6981203c841b09921c7af678dcf4b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8db6981203c841b09921c7af678dcf4b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8db6981203c841b09921c7af678dcf4b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8db6981203c841b09921c7af678dcf4b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8db6981203c841b09921c7af678dcf4b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8db6981203c841b09921c7af678dcf4b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8db6981203c841b09921c7af678dcf4b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8db6981203c841b09921c7af678dcf4b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8db6981203c841b09921c7af678dcf4b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6a26549a24db437c81bedb31fe762a26" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6a26549a24db437c81bedb31fe762a26 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6a26549a24db437c81bedb31fe762a26 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6a26549a24db437c81bedb31fe762a26 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6a26549a24db437c81bedb31fe762a26 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6a26549a24db437c81bedb31fe762a26 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6a26549a24db437c81bedb31fe762a26 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6a26549a24db437c81bedb31fe762a26 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6a26549a24db437c81bedb31fe762a26 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6a26549a24db437c81bedb31fe762a26 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6a26549a24db437c81bedb31fe762a26 input{text-align:left;}"; break;
		}
	}
