...
<div id="id83341b7ea01a496a95049e604ff30b73" class="general-layout-container">
...
<div id="id02ebed10ee214d05a4b7b8d4d3c894f0" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id02ebed10ee214d05a4b7b8d4d3c894f0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id02ebed10ee214d05a4b7b8d4d3c894f0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id02ebed10ee214d05a4b7b8d4d3c894f0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id02ebed10ee214d05a4b7b8d4d3c894f0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id02ebed10ee214d05a4b7b8d4d3c894f0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id02ebed10ee214d05a4b7b8d4d3c894f0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id02ebed10ee214d05a4b7b8d4d3c894f0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id02ebed10ee214d05a4b7b8d4d3c894f0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id02ebed10ee214d05a4b7b8d4d3c894f0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id02ebed10ee214d05a4b7b8d4d3c894f0 input{text-align:left;}"; break;
		}
	}
