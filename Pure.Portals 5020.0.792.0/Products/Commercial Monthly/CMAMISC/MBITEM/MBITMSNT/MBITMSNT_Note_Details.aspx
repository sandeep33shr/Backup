<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBITMSNT_Note_Details.aspx.vb" Inherits="Nexus.PB2_MBITMSNT_Note_Details" %>
...
function onValidate_MBITEM_SCNOTE__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_SCNOTE.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.5", "MBITEM_SCNOTE", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITEM_SCNOTE_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITEM_SCNOTE__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITEM_SCNOTE__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_MBITEM_SCNOTE__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("MBITEM_SCNOTE.NOTE_DETAILS");
        			window.setControlWidth(field, "0.5", "MBITEM_SCNOTE", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblMBITEM_SCNOTE_NOTE_DETAILS");
        			    var ele = document.getElementById('ctl00_cntMainBody_MBITEM_SCNOTE__NOTE_DETAILS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_MBITEM_SCNOTE__NOTE_DETAILS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
<div id="id8cad94e87ccd4bf28b92227c091b19d3" class="general-layout-container">
...
<div id="id08010bf4a5194d829c14e1f1f23f8b9a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading223" runat="server" Text="Note Details (Printed on Schedule)" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id08010bf4a5194d829c14e1f1f23f8b9a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id08010bf4a5194d829c14e1f1f23f8b9a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id08010bf4a5194d829c14e1f1f23f8b9a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id08010bf4a5194d829c14e1f1f23f8b9a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id08010bf4a5194d829c14e1f1f23f8b9a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id08010bf4a5194d829c14e1f1f23f8b9a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id08010bf4a5194d829c14e1f1f23f8b9a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id08010bf4a5194d829c14e1f1f23f8b9a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id08010bf4a5194d829c14e1f1f23f8b9a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id08010bf4a5194d829c14e1f1f23f8b9a input{text-align:left;}"; break;
		}
	}
