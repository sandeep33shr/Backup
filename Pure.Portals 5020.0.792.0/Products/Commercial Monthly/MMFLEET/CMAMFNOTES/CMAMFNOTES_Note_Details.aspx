...
<div id="idec27a354ebeb4320873f023c29c5453a" class="general-layout-container">
...
<div id="id011a0aaacbc64806a8f592a77a1bc41a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id011a0aaacbc64806a8f592a77a1bc41a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id011a0aaacbc64806a8f592a77a1bc41a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id011a0aaacbc64806a8f592a77a1bc41a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id011a0aaacbc64806a8f592a77a1bc41a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id011a0aaacbc64806a8f592a77a1bc41a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id011a0aaacbc64806a8f592a77a1bc41a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id011a0aaacbc64806a8f592a77a1bc41a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id011a0aaacbc64806a8f592a77a1bc41a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id011a0aaacbc64806a8f592a77a1bc41a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id011a0aaacbc64806a8f592a77a1bc41a input{text-align:left;}"; break;
		}
	}
