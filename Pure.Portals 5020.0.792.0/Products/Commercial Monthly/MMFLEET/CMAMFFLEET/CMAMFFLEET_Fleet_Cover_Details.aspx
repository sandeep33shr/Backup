        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("FLEET_DETAILS.PREM_UNIT * FLEET_DETAILS.NO_UNITS"), 
        			condition = (Expression.isValidParameter("FLEET_DETAILS.PREM_UNIT <> null AND FLEET_DETAILS.PREM_UNIT <> ''")) ? new Expression("FLEET_DETAILS.PREM_UNIT <> null AND FLEET_DETAILS.PREM_UNIT <> ''") : null, 
...
<div id="id737405799a214e7d80f980ecc70c2fba" class="general-layout-container">
...
<div id="id647f3d932d614a91acad93605f311f1c" class="column-layout-container  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id647f3d932d614a91acad93605f311f1c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id647f3d932d614a91acad93605f311f1c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id647f3d932d614a91acad93605f311f1c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id647f3d932d614a91acad93605f311f1c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id647f3d932d614a91acad93605f311f1c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id647f3d932d614a91acad93605f311f1c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id647f3d932d614a91acad93605f311f1c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id647f3d932d614a91acad93605f311f1c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id647f3d932d614a91acad93605f311f1c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id647f3d932d614a91acad93605f311f1c input{text-align:left;}"; break;
		}
	}
