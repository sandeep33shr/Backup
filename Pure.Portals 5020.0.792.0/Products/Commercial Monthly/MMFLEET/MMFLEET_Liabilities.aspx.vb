...
Namespace Nexus
    Partial Class PB2_MMFLEET_Liabilities : Inherits BaseRisk
		...
		Protected Sub onValidate_FLEET_LIABILITY__TP_NONFARE_LIMIT()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FLEET_LIABILITY__TP_NONFARE_LIMIT()
End Sub
