...
Namespace Nexus
    Partial Class PB2_MMFLEET_Premises_Insured : Inherits BaseRisk
		...
		Protected Sub onValidate_GENERAL__RISKATTACHDATE()
...
Protected Sub CallRuleScripts()
    onValidate_GENERAL__RISKATTACHDATE()
...
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If GENERAL__RISKATTACHDATE.Text = "" or GENERAL__RISKATTACHDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			GENERAL__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			GENERAL__RISKATTACHDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
