...
Namespace Nexus
    Partial Class PB2_TPRENDPREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_PR_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PR_CLAUSEPREM__ENDORSE_ID()
End Sub

		    
        'Script to add premium per selected Endorsement
        'Parameters:
        'PUBLIABPD - Standard Wording Parent Object
        'PROD_PUBLIABPD_CLAUSES - Standard Wording Parent Property
        'PR_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PUBLIABPD/SW.PROD_PUBLIABPD_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("PR_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PUBLIABPD/PR_CLAUSEPREM")
        
        	Dim CurrentSelected As String = PR_CLAUSEPREM__ENDORSE_CAP.Text
