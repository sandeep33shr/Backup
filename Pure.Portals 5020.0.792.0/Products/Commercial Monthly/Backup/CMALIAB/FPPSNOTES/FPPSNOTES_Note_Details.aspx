...
<div id="id7b98930bc84e4622a9632dac821c25c0" class="general-layout-container">
...
<div id="id8a9613e8f6bb4d33be91221bda1bdc40" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8a9613e8f6bb4d33be91221bda1bdc40 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8a9613e8f6bb4d33be91221bda1bdc40 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8a9613e8f6bb4d33be91221bda1bdc40 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8a9613e8f6bb4d33be91221bda1bdc40 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8a9613e8f6bb4d33be91221bda1bdc40 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8a9613e8f6bb4d33be91221bda1bdc40 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8a9613e8f6bb4d33be91221bda1bdc40 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8a9613e8f6bb4d33be91221bda1bdc40 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8a9613e8f6bb4d33be91221bda1bdc40 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8a9613e8f6bb4d33be91221bda1bdc40 input{text-align:left;}"; break;
		}
	}
