...
Namespace Nexus
    Partial Class PB2_PUBPREM_Endorsement_Premium : Inherits BaseRisk
		...
		Protected Sub onValidate_GT_CLAUSEPREM__ENDORSE_ID()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GT_CLAUSEPREM__ENDORSE_ID()
End Sub
        ...
        'GT_PUBLIAB_CLAUSES - Standard Wording Parent Property
        'GT_CLAUSEPREM - Child Screen Object
        ...
        Protected Shadows Sub Page_Load_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PUBLIAB/SW.GT_PUBLIAB_CLAUSES")
        	Dim EndorsementScheme As Object = oMaster.FindControl("GT_CLAUSEPREM__ENDORSE_DESC")
        ...
        Protected Shadows Sub btnNextFinish_SelectedEndorsements(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click, btnFinish.Click, btnNextTop.Click, btnFinishTop.Click
        	...
        	Dim Doc As New XmlDocument
        	Doc.Load(xmlTR)
        	Dim xmlLocations As XmlNodeList = Doc.SelectNodes("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PUBLIAB/GT_CLAUSEPREM")
        
        	Dim CurrentSelected As String = GT_CLAUSEPREM__ENDORSE_CAP.Text
