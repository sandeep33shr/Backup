...
Namespace Nexus
    Partial Class PB2_CMALIAB_Cyber_Insurance : Inherits BaseRisk
		...
		Protected Sub onValidate_CYBER__ATTACHMENTDATE()
        
End Sub
Protected Sub onValidate_CYBER__EFFECTIVEDATE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CYBER__ATTACHMENTDATE()
    onValidate_CYBER__EFFECTIVEDATE()
End Sub
        ...
        Protected Shadows Sub Page_Load_AttachmentDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If CYBER__ATTACHMENTDATE.Text = "" or CYBER__ATTACHMENTDATE.Text Is Nothing Then
        		If transactionValue = "NB" Then
        			CYBER__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        		Else
        			CYBER__ATTACHMENTDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        		End If
        	End If
        	
        	If oQuote.Risks(Session(CNCurrentRiskKey)).RiskInceptionDate <> oQuote.InceptionDate And (CYBER__ATTACHMENTDATE.Text <> "" Or CYBER__ATTACHMENTDATE.Text IsNot Nothing) Then
        		If transactionValue <> "NB" Then
        ...
        Protected Shadows Sub Page_Load_EffectiveDate(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        	...
        	If transactionValue = "NB" Then
        		CYBER__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionDate))
        	End If
        	
        	If transactionValue = "MTA" Then
        		CYBER__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.CoverStartDate))
        	End If
        	
        	If transactionValue = "REN" Then
        		CYBER__EFFECTIVEDATE.Text = RTrim(LTrim(oQuote.InceptionTPI))
        	End If
