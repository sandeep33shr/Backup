...
Namespace Nexus
    Partial Class PB2_MULTIPREM_Multiple_Premises_Details : Inherits BaseRisk
		...
		Protected Sub onValidate_PREMISES_DETAILS__SITEADDRESSLIST()
        
End Sub
Protected Sub onValidate_PREMISES_DETAILS__COUNTRY()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PREMISES_DETAILS__SITEADDRESSLIST()
    onValidate_PREMISES_DETAILS__COUNTRY()
End Sub
        ...
        Protected Sub ValidateAddress()
        	...
        	Dim Line1 as String = PREMISES_DETAILS__LINE1.Text
        	Dim Suburb as String = PREMISES_DETAILS__SUBURB.Text
