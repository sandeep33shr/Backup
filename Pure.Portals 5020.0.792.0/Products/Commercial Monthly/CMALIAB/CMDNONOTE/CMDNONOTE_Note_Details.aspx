<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMDNONOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_CMDNONOTE_Note_Details" %>
        		...
        		var disablePage = function(disable){
        			...
        			for (var type in pb.fields.FieldType){
        				...
        				for (var key in fields){
        					...
        					if (field.getObjectName() == "DNO_CNOTE_DETAILS" && field.getPropertyName() == "Date_Created")
...
function onValidate_DNO_CNOTE_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNO_CNOTE_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("DNO_CNOTE_DETAILS", "COVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DNO_CNOTE_DETAILS.COVER_TYPE");
        			window.setControlWidth(field, "3", "DNO_CNOTE_DETAILS", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=DNO_CNOTE_DETAILS&propertyName=COVER_TYPE&name={name}");
...
function onValidate_DNO_CNOTE_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNO_CNOTE_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DNO_CNOTE_DETAILS", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DNO_CNOTE_DETAILS.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "3", "DNO_CNOTE_DETAILS", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("DNO_CNOTE_DETAILS", "NOTE_DESCRIPTION");
        		var exp = new Expression("DNO_CNOTE_DETAILS.NoteCheck = 1");
...
function onValidate_DNO_CNOTE_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("DNO_CNOTE_DETAILS.NOTE_DETAILS");
        			window.setControlWidth(field, "3", "DNO_CNOTE_DETAILS", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
...
function onValidate_DNO_CNOTE_DETAILS__NoteCheck(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNO_CNOTE_DETAILS", "NoteCheck", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("DNO_CNOTE_DETAILS", "NoteCheck");
        		}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_DNO_CNOTE_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_DNO_CNOTE_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
    onValidate_DNO_CNOTE_DETAILS__NOTE_DETAILS(null, null, null, isOnLoad);
    onValidate_DNO_CNOTE_DETAILS__NoteCheck(null, null, null, isOnLoad);
}
</script>
...
<div id="id62820dc2e42f46679d3f5a6fa169a2e5" class="general-layout-container">
...
<div id="idf87b2c299e9a468da73a0fec4a2e62de" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading69" runat="server" Text="Note Detail (Not Printed on Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-DNO_CNOTE_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblDNO_CNOTE_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="DNO_CNOTE_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DNO_CNOTE_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDNO_CNOTE_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_DNO_CNOTE_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-DNO_CNOTE_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblDNO_CNOTE_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="DNO_CNOTE_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="DNO_CNOTE_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valDNO_CNOTE_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_DNO_CNOTE_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /Comment -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblDNO_CNOTE_DETAILS_NoteCheck" for="ctl00_cntMainBody_DNO_CNOTE_DETAILS__NoteCheck" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-DNO_CNOTE_DETAILS-NoteCheck">	
		
		<asp:TextBox ID="DNO_CNOTE_DETAILS__NoteCheck" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valDNO_CNOTE_DETAILS_NoteCheck" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Check If Note should be editable"
			ClientValidationFunction="onValidate_DNO_CNOTE_DETAILS__NoteCheck" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf87b2c299e9a468da73a0fec4a2e62de div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf87b2c299e9a468da73a0fec4a2e62de div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf87b2c299e9a468da73a0fec4a2e62de div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf87b2c299e9a468da73a0fec4a2e62de label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf87b2c299e9a468da73a0fec4a2e62de label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf87b2c299e9a468da73a0fec4a2e62de label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf87b2c299e9a468da73a0fec4a2e62de label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf87b2c299e9a468da73a0fec4a2e62de input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf87b2c299e9a468da73a0fec4a2e62de input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf87b2c299e9a468da73a0fec4a2e62de input{text-align:left;}"; break;
		}
	}
