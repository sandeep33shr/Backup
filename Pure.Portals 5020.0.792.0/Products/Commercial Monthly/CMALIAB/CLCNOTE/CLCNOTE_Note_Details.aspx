<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLCNOTE_Note_Details.aspx.vb" Inherits="Nexus.PB2_CLCNOTE_Note_Details" %>
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CNOTE_DETAILS", "DATE_CREATED");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CNOTE_DETAILS.DATE_CREATED");
        			window.setControlWidth(field, "0.7", "CNOTE_DETAILS", "DATE_CREATED");
        		})();
        	}
        })();
        /**
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CNOTE_DETAILS", "CREATED_BY");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
              ...
              var field = Field.getInstance("CNOTE_DETAILS.CREATED_BY");
        			window.setControlWidth(field, "0.7", "CNOTE_DETAILS", "CREATED_BY");
        		})();
        	}
        })();
        /**
...
function onValidate_CNOTE_DETAILS__COVER_TYPE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CNOTE_DETAILS", "COVER_TYPE", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CNOTE_DETAILS", "COVER_TYPE");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CNOTE_DETAILS.COVER_TYPE");
        			window.setControlWidth(field, "0.7", "CNOTE_DETAILS", "COVER_TYPE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCNOTE_DETAILS_COVER_TYPE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CNOTE_DETAILS__COVER_TYPE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CNOTE_DETAILS__COVER_TYPE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Text&objectName=CNOTE_DETAILS&propertyName=COVER_TYPE&name={name}");
...
function onValidate_CNOTE_DETAILS__NOTE_DESCRIPTION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CNOTE_DETAILS", "NOTE_DESCRIPTION", "Text");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CNOTE_DETAILS", "NOTE_DESCRIPTION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CNOTE_DETAILS.NOTE_DESCRIPTION");
        			window.setControlWidth(field, "0.7", "CNOTE_DETAILS", "NOTE_DESCRIPTION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCNOTE_DETAILS_NOTE_DESCRIPTION");
        			    var ele = document.getElementById('ctl00_cntMainBody_CNOTE_DETAILS__NOTE_DESCRIPTION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CNOTE_DETAILS__NOTE_DESCRIPTION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CNOTE_DETAILS__NOTE_DETAILS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CNOTE_DETAILS.NOTE_DETAILS");
        			window.setControlWidth(field, "0.7", "CNOTE_DETAILS", "NOTE_DETAILS");
        		})();
        	}
        })();
        /**
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CNOTE_DETAILS__COVER_TYPE(null, null, null, isOnLoad);
    onValidate_CNOTE_DETAILS__NOTE_DESCRIPTION(null, null, null, isOnLoad);
...
<div id="id804821f6de754cf58b8af481cfdd13f4" class="general-layout-container">
...
<div id="id0e23afa3437c4eed8176feaa5e824cfc" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading42" runat="server" Text="Note Details  (Not Printed on Schedule)" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CNOTE_DETAILS-COVER_TYPE">

		
		<asp:Label ID="lblCNOTE_DETAILS_COVER_TYPE" runat="server" AssociatedControlID="CNOTE_DETAILS__COVER_TYPE" 
			Text="Cover Type" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CNOTE_DETAILS__COVER_TYPE" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCNOTE_DETAILS_COVER_TYPE" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Cover Type"
					ClientValidationFunction="onValidate_CNOTE_DETAILS__COVER_TYPE"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CNOTE_DETAILS-NOTE_DESCRIPTION">

		
		<asp:Label ID="lblCNOTE_DETAILS_NOTE_DESCRIPTION" runat="server" AssociatedControlID="CNOTE_DETAILS__NOTE_DESCRIPTION" 
			Text="Note Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CNOTE_DETAILS__NOTE_DESCRIPTION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCNOTE_DETAILS_NOTE_DESCRIPTION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Note Description"
					ClientValidationFunction="onValidate_CNOTE_DETAILS__NOTE_DESCRIPTION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id0e23afa3437c4eed8176feaa5e824cfc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0e23afa3437c4eed8176feaa5e824cfc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0e23afa3437c4eed8176feaa5e824cfc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0e23afa3437c4eed8176feaa5e824cfc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0e23afa3437c4eed8176feaa5e824cfc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0e23afa3437c4eed8176feaa5e824cfc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0e23afa3437c4eed8176feaa5e824cfc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0e23afa3437c4eed8176feaa5e824cfc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0e23afa3437c4eed8176feaa5e824cfc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0e23afa3437c4eed8176feaa5e824cfc input{text-align:left;}"; break;
		}
	}
