...
Namespace Nexus
    Partial Class PB2_SDNASRIA_NASRIA_Personal_Lines_and_Stamp_Duty : Inherits BaseRisk
		...
		Protected Sub onValidate_NASRIA__MD_DOM_NASRIA_PREMIUM()
...
Protected Sub CallRuleScripts()
    onValidate_NASRIA__MD_DOM_NASRIA_PREMIUM()
End Sub
        ...
        Sub RunRatingRuleAndRefreshValues()
        	Try
        		...
        		End If
        		'MD
        		NASRIA__MD_DOM_ACCUMULATED_SI.Text = GetValue("NASRIA", "MD_DOM_ACCUMULATED_SI")
        		NASRIA__MD_DOM_NASRIA_PREMIUM.Text = GetValue("NASRIA", "MD_DOM_NASRIA_PREMIUM")
        
        		'MOTOR
        		NASRIA__MOTOR_ACCUMULATED_SI.Text = GetValue("NASRIA", "MOTOR_ACCUMULATED_SI")
        		NASRIA__MOTOR_NASRIA_PREMIUM.Text = GetValue("NASRIA", "MOTOR_NASRIA_PREMIUM")
        
        		'PC
        		NASRIA__PC_ACCUMULATED_SI.Text = GetValue("NASRIA", "PC_ACCUMULATED_SI")
        		NASRIA__PC_NASRIA_PREMIUM.Text = GetValue("NASRIA", "PC_NASRIA_PREMIUM")
        		
        		'FC - First Capital Home Loan
        		NASRIA__FC_ACCUMULATED_SI.Text = GetValue("NASRIA", "FC_ACCUMULATED_SI")
        		NASRIA__FC_NASRIA_PREMIUM.Text = GetValue("NASRIA", "FC_NASRIA_PREMIUM")
        		...
        		If Session("Refresh") = "1" Then
        			Dim sUrl As String = "/Products/First%20Capital%20Home%20Loan%20Monthly/SDNASRIA/SDNASRIA_NASRIA_Personal_Lines_and_Stamp_Duty.aspx"
