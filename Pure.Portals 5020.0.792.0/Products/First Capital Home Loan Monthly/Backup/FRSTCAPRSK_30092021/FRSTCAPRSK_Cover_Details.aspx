<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FRSTCAPRSK_Cover_Details.aspx.vb" Inherits="Nexus.PB2_FRSTCAPRSK_Cover_Details" %>
...
function onValidate_GENERAL__DESCRIPTION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {		
        		...
        		var value = new Expression("'First Capital Home Loan - ' + ADDRESS.LINE1"), 
...
function onValidate_GENERAL__MONTHS_DIFFERENCE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "MONTHS_DIFFERENCE", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("GENERAL", "MONTHS_DIFFERENCE");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
        ...
        (function(){
        	if (isOnLoad) {		
        		// Get the field
        		var field = Field.getWithQuery("type=Integer&objectName=GENERAL&propertyName=MONTHS_DIFFERENCE&name={name}");
        		
        		var value = new Expression("MonthDiff(GENERAL.QUOTEDATE,GENERAL.COVER_END_DATE)"), 
        			condition = (Expression.isValidParameter("{1}")) ? new Expression("{1}") : null, 
        			elseValue = (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null;
...
function onValidate_GENERAL__FRSMTARSN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "FRSMTARSN", "ChildScreen");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "FRSMTARSN");
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblGENERAL_FRSMTARSN");
        			    var ele = document.getElementById('ctl00_cntMainBody_GENERAL__FRSMTARSN');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_GENERAL__FRSMTARSN_lblFindParty");
        			    }
        			}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("GENERAL.FRSMTARSN");
        			window.setControlWidth(field, "0.7", "GENERAL", "FRSMTARSN");
        		})();
        	}
        })();
}
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__MONTHS_DIFFERENCE(null, null, null, isOnLoad);
    onValidate_GENERAL__FRSMTARSN(null, null, null, isOnLoad);
...
<div id="iddbe5f1a5ab5b4fe8b5ca30cea463fd96" class="general-layout-container">
...
<div id="id77c52935c53345b187b319b8f8efad47" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading3" runat="server" Text="First Capital Home Loan" /></legend>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		data-field-type="Integer" 
		data-object-name="GENERAL" 
		data-property-name="MONTHS_DIFFERENCE" 
		id="pb-container-integer-GENERAL-MONTHS_DIFFERENCE">
		<asp:Label ID="lblGENERAL_MONTHS_DIFFERENCE" runat="server" AssociatedControlID="GENERAL__MONTHS_DIFFERENCE" 
			Text="Months Difference" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="GENERAL__MONTHS_DIFFERENCE" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valGENERAL_MONTHS_DIFFERENCE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Months Difference"
			ClientValidationFunction="onValidate_GENERAL__MONTHS_DIFFERENCE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id77c52935c53345b187b319b8f8efad47 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id77c52935c53345b187b319b8f8efad47 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id77c52935c53345b187b319b8f8efad47 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id77c52935c53345b187b319b8f8efad47 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id77c52935c53345b187b319b8f8efad47 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77c52935c53345b187b319b8f8efad47 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77c52935c53345b187b319b8f8efad47 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id77c52935c53345b187b319b8f8efad47 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77c52935c53345b187b319b8f8efad47 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77c52935c53345b187b319b8f8efad47 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__FRSMTARSN"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="FRSMTARSN" 
		id="pb-container-childscreen-GENERAL-FRSMTARSN">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__MTA_REASON" runat="server" ScreenCode="FRSMTARSN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="FRSMTARSN/FRSMTARSN_MTA_Reason_Details.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valGENERAL_FRSMTARSN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.FRSMTARSN"
						ClientValidationFunction="onValidate_GENERAL__FRSMTARSN" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf22f7a221b574174a15c4bd66c7b0135" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf22f7a221b574174a15c4bd66c7b0135 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf22f7a221b574174a15c4bd66c7b0135 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf22f7a221b574174a15c4bd66c7b0135 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf22f7a221b574174a15c4bd66c7b0135 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf22f7a221b574174a15c4bd66c7b0135 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf22f7a221b574174a15c4bd66c7b0135 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf22f7a221b574174a15c4bd66c7b0135 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf22f7a221b574174a15c4bd66c7b0135 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf22f7a221b574174a15c4bd66c7b0135 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf22f7a221b574174a15c4bd66c7b0135 input{text-align:left;}"; break;
		}
	}
