...
Namespace Nexus
    Partial Class PB2_FRSTCAPRSK_Risk_Details : Inherits BaseRisk
...
End Sub
Protected Sub onValidate_FIRSTCAP__TOT_PREMIUM()
...
Protected Sub CallRuleScripts()
    ...
    onValidate_FIRSTCAP__TOT_PREMIUM()
...
End Sub
        ...
        Private Sub PremiumValidator()
        	...
        	If (FIRSTCAP__TOT_PREMIUM.Text = "") And (FIRSTCAP__TOT_PREMIUM.Text = Nothing) Then
        ...
        Private Sub btnCalculatePremium_Click(sender As Object, e As EventArgs) Handles btnCalculatePrem.Click
