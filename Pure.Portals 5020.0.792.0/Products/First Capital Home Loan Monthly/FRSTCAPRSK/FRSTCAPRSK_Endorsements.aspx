<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FRSTCAPRSK_Endorsements.aspx.vb" Inherits="Nexus.PB2_FRSTCAPRSK_Endorsements" %>
...
function onValidate_ENDORSCHLD__FRSTPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENDORSCHLD", "FRSTPREM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_ENDORSCHLD__FRSTPREM(null, null, null, isOnLoad);
}
</script>
...
<div id="id9f572b73f1fc4a96ac4abb29c091e42a" class="general-layout-container">
...
<div id="iddee2019e05304442a10ed4b267f107e2" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENDORSCHLD__FRSTPREM"
		data-field-type="Child" 
		data-object-name="ENDORSCHLD" 
		data-property-name="FRSTPREM" 
		id="pb-container-childscreen-ENDORSCHLD-FRSTPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENDORSCHLD__PREMENDORS" runat="server" ScreenCode="FRSTPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="FRSTPREM/FRSTPREM_Premium_Endorsements.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valENDORSCHLD_FRSTPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ENDORSCHLD.FRSTPREM"
						ClientValidationFunction="onValidate_ENDORSCHLD__FRSTPREM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#iddee2019e05304442a10ed4b267f107e2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddee2019e05304442a10ed4b267f107e2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddee2019e05304442a10ed4b267f107e2 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#iddee2019e05304442a10ed4b267f107e2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddee2019e05304442a10ed4b267f107e2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddee2019e05304442a10ed4b267f107e2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddee2019e05304442a10ed4b267f107e2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddee2019e05304442a10ed4b267f107e2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddee2019e05304442a10ed4b267f107e2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddee2019e05304442a10ed4b267f107e2 input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Endorsements" /></legend>
