<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CWORKCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_CWORKCLM_Third_Party" %>
...
function onValidate_CWORKCLAIM__CWORKPRTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWORKCLAIM", "CWORKPRTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CWORKCLAIM__CWORKPRTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idb3b4892ffd8e43c58bcaf95021b7cd86" class="general-layout-container">
...
<div id="id587a4dd208694b629a9282e9df084d03" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWORKCLAIM__CWORKPRTY"
		data-field-type="Child" 
		data-object-name="CWORKCLAIM" 
		data-property-name="CWORKPRTY" 
		id="pb-container-childscreen-CWORKCLAIM-CWORKPRTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWORKCLAIM__CWORKTHIRD" runat="server" ScreenCode="CWORKPRTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CWORKPRTY/CWORKPRTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCWORKCLAIM_CWORKPRTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CWORKCLAIM.CWORKPRTY"
						ClientValidationFunction="onValidate_CWORKCLAIM__CWORKPRTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id587a4dd208694b629a9282e9df084d03 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id587a4dd208694b629a9282e9df084d03 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id587a4dd208694b629a9282e9df084d03 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id587a4dd208694b629a9282e9df084d03 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id587a4dd208694b629a9282e9df084d03 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id587a4dd208694b629a9282e9df084d03 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id587a4dd208694b629a9282e9df084d03 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id587a4dd208694b629a9282e9df084d03 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id587a4dd208694b629a9282e9df084d03 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id587a4dd208694b629a9282e9df084d03 input{text-align:left;}"; break;
		}
	}
