<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CWORKCLM_Reserves.aspx.vb" Inherits="Nexus.PB2_CWORKCLM_Reserves" %>
...
function onValidate_CWORKCLAIM__CWRKSOLSCN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWORKCLAIM", "CWRKSOLSCN", "ChildScreen");
        })();
}
function onValidate_CWORKCLAIM__SOL_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWORKCLAIM", "SOL_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CWORKCLAIM", "SOL_COUNTER");
        		}
          ...
          * @param CWORKCLAIM The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "CWORKCLAIM".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_CWORKCLAIM__CWRKRCVRSC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWORKCLAIM", "CWRKRCVRSC", "ChildScreen");
        })();
}
function onValidate_CWORKCLAIM__RECO_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWORKCLAIM", "RECO_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CWORKCLAIM", "RECO_COUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_CWORKCLAIM__CWRKSOLSCN(null, null, null, isOnLoad);
    onValidate_CWORKCLAIM__SOL_COUNTER(null, null, null, isOnLoad);
    onValidate_CWORKCLAIM__CWRKRCVRSC(null, null, null, isOnLoad);
    onValidate_CWORKCLAIM__RECO_COUNTER(null, null, null, isOnLoad);
}
</script>
...
<div id="id706be17fa3da4daa857114a8bcd88241" class="general-layout-container">
...
<div id="id03b82351f9694a518db141182a82aef9" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading69" runat="server" Text="Claim Reserves" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWORKCLAIM__CWRKSOLSCN"
		data-field-type="Child" 
		data-object-name="CWORKCLAIM" 
		data-property-name="CWRKSOLSCN" 
		id="pb-container-childscreen-CWORKCLAIM-CWRKSOLSCN">
		
		    <legend>Schedule of Loss</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWORKCLAIM__SCHEDULE_LOSS" runat="server" ScreenCode="CWRKSOLSCN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CWRKSOLSCN/CWRKSOLSCN_Schedule_of_Loss.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_CONWORK_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Payment Amount" DataField="PAYMENT_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCWORKCLAIM_CWRKSOLSCN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Schedule of Loss"
						ClientValidationFunction="onValidate_CWORKCLAIM__CWRKSOLSCN" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-CWORKCLAIM-SOL_COUNTER">
		<asp:Label ID="lblCWORKCLAIM_SOL_COUNTER" runat="server" AssociatedControlID="CWORKCLAIM__SOL_COUNTER" 
			Text="Schedule Item Counter " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CWORKCLAIM__SOL_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCWORKCLAIM_SOL_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Schedule Item Counter "
			ClientValidationFunction="onValidate_CWORKCLAIM__SOL_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id03b82351f9694a518db141182a82aef9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id03b82351f9694a518db141182a82aef9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id03b82351f9694a518db141182a82aef9 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id03b82351f9694a518db141182a82aef9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id03b82351f9694a518db141182a82aef9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id03b82351f9694a518db141182a82aef9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id03b82351f9694a518db141182a82aef9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id03b82351f9694a518db141182a82aef9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id03b82351f9694a518db141182a82aef9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id03b82351f9694a518db141182a82aef9 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0ce64981ad8e480aa57845c512e5e595" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading70" runat="server" Text="Claim Recoveries" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWORKCLAIM__CWRKRCVRSC"
		data-field-type="Child" 
		data-object-name="CWORKCLAIM" 
		data-property-name="CWRKRCVRSC" 
		id="pb-container-childscreen-CWORKCLAIM-CWRKRCVRSC">
		
		    <legend>Recoveries</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWORKCLAIM__RECOVERIES" runat="server" ScreenCode="CWRKRCVRSC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CWRKRCVRSC/CWRKRCVRSC_Recovery.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_CONWORK_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Negotiated Amount" DataField="NEGOTIATED_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCWORKCLAIM_CWRKRCVRSC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Recoveries"
						ClientValidationFunction="onValidate_CWORKCLAIM__CWRKRCVRSC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-CWORKCLAIM-RECO_COUNTER">
		<asp:Label ID="lblCWORKCLAIM_RECO_COUNTER" runat="server" AssociatedControlID="CWORKCLAIM__RECO_COUNTER" 
			Text="Recoveries counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CWORKCLAIM__RECO_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCWORKCLAIM_RECO_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recoveries counter"
			ClientValidationFunction="onValidate_CWORKCLAIM__RECO_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0ce64981ad8e480aa57845c512e5e595 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0ce64981ad8e480aa57845c512e5e595 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0ce64981ad8e480aa57845c512e5e595 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	  
			  if (liElementHeight > liMaxHeight)
			  {
				  liMaxHeight = liElementHeight;			  
	...
	if (labelWidth != ""){
		...
		styleString += "#id0ce64981ad8e480aa57845c512e5e595 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0ce64981ad8e480aa57845c512e5e595 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0ce64981ad8e480aa57845c512e5e595 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0ce64981ad8e480aa57845c512e5e595 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0ce64981ad8e480aa57845c512e5e595 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0ce64981ad8e480aa57845c512e5e595 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0ce64981ad8e480aa57845c512e5e595 input{text-align:left;}"; break;
		}
	}
