...
Namespace Nexus
    Partial Class PB2_CWORKCLM_Construction_Pubic_Liability : Inherits BaseClaim
		...
		Protected Sub onValidate_CONEXTCLM__ADDCPLCLM()
        
End Sub
Protected Sub onValidate_CONEXTCLM__OTHRCPLCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CONEXTCLM__ADDCPLCLM()
    onValidate_CONEXTCLM__OTHRCPLCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CONEXTCLM = The parent object name of child screen
        ' CONADDCLM = The child screen object name
        
        Protected Sub CONEXTCLM__CONADDCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CONEXTCLM__CONADDCLM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CONEXTCLM = The parent object name of child screen
        ' CONCEXTCLM = The child screen object name
        
        Protected Sub CONEXTCLM__CONCEXTCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CONEXTCLM__CONCEXTCLM.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
