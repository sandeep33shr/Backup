<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CWORKCLM_Value_Band_Deductibles.aspx.vb" Inherits="Nexus.PB2_CWORKCLM_Value_Band_Deductibles" %>
...
function onValidate_RISKDETCLM__DEDECLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RISKDETCLM", "DEDECLM", "ChildScreen");
        })();
        /** 
         ...
         * @parma CONTRVALCLM The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=RISKDETCLM__CONTRVALCLM.ClientID %>').find('table').find('tr').each(function () {
...
function DoLogic(isOnLoad) {
    onValidate_RISKDETCLM__DEDECLM(null, null, null, isOnLoad);
}
</script>
...
<div id="idf674399052364b56870c19e3a18668e7" class="general-layout-container">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RISKDETCLM__DEDECLM"
		data-field-type="Child" 
		data-object-name="RISKDETCLM" 
		data-property-name="DEDECLM" 
		id="pb-container-childscreen-RISKDETCLM-DEDECLM">
		
		    <legend>Deductibles</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RISKDETCLM__CONTRVALCLM" runat="server" ScreenCode="DEDECLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DEDECLM/DEDECLM_Contract_Value_Bands.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Contract Not Exceeding" DataField="CONT_NOT_EX" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valRISKDETCLM_DEDECLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Deductibles"
						ClientValidationFunction="onValidate_RISKDETCLM__DEDECLM" 
						Display="None"
