...
Namespace Nexus
    Partial Class PB2_CWORKCLM_Extensions : Inherits BaseClaim
		...
		Protected Sub onValidate_EXT_ADDITCLM__OEXTLIMCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_EXT_ADDITCLM__OEXTLIMCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' EXT_ADDITCLM = The parent object name of child screen
        ' OTHEREXT_CLM = The child screen object name
        
        Protected Sub EXT_ADDITCLM__OTHEREXT_CLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles EXT_ADDITCLM__OTHEREXT_CLM.RowDataBound
