...
Namespace Nexus
    Partial Class PB2_CWORKCLM_Value_Band_Deductibles : Inherits BaseClaim
		...
		Protected Sub onValidate_RISKDETCLM__DEDECLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RISKDETCLM__DEDECLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RISKDETCLM = The parent object name of child screen
        ' CONTRVALCLM = The child screen object name
        
        Protected Sub RISKDETCLM__CONTRVALCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISKDETCLM__CONTRVALCLM.RowDataBound
