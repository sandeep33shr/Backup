<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CWORKCLM_Ex_Gratia.aspx.vb" Inherits="Nexus.PB2_CWORKCLM_Ex_Gratia" %>
...
function onValidate_CWORKCLAIM__CWORKGRDTL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWORKCLAIM", "CWORKGRDTL", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CWORKCLAIM__CWORKGRDTL(null, null, null, isOnLoad);
}
</script>
...
<div id="id0c67c25b493a4e8e895fe872ced605be" class="general-layout-container">
...
<div id="frmExGratia" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading52" runat="server" Text="Ex Gratia" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWORKCLAIM__CWORKGRDTL"
		data-field-type="Child" 
		data-object-name="CWORKCLAIM" 
		data-property-name="CWORKGRDTL" 
		id="pb-container-childscreen-CWORKCLAIM-CWORKGRDTL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWORKCLAIM__AUTH_DETAILS" runat="server" ScreenCode="CWORKGRDTL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CWORKGRDTL/CWORKGRDTL_Ex_Gratia.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Reason" DataField="R_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCWORKCLAIM_CWORKGRDTL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CWORKCLAIM.CWORKGRDTL"
						ClientValidationFunction="onValidate_CWORKCLAIM__CWORKGRDTL" 
						Display="None"
