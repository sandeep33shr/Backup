...
Namespace Nexus
    Partial Class PB2_CWORKCLM_Co_Reinsurance_Inwards : Inherits BaseClaim
		...
		Protected Sub onValidate_RISKDETCLM__CREINSCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RISKDETCLM__CREINSCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RISKDETCLM = The parent object name of child screen
        ' CONTESTCLM = The child screen object name
        
        Protected Sub RISKDETCLM__CONTESTCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISKDETCLM__CONTESTCLM.RowDataBound
