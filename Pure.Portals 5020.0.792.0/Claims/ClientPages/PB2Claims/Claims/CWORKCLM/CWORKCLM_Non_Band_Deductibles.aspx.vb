...
Namespace Nexus
    Partial Class PB2_CWORKCLM_Non_Band_Deductibles : Inherits BaseClaim
		...
		Protected Sub onValidate_NONBANDCLM__NONDEDCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_NONBANDCLM__NONDEDCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' NONBANDCLM = The parent object name of child screen
        ' NONDCLM = The child screen object name
        
        Protected Sub NONBANDCLM__NONDCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles NONBANDCLM__NONDCLM.RowDataBound
