...
Namespace Nexus
    Partial Class PB2_TSMRCLM_SME_Bundles : Inherits BaseClaim
...
End Sub
Protected Sub onValidate_GENERAL__TSMRTRAIL()
        
        
End Sub
Protected Sub onValidate_TSMRCLM__TSMENDOSCL()
        
End Sub
Protected Sub onValidate_TSMRCLM__TSMNOTES()
        
End Sub
Protected Sub onValidate_TSMRCLM__TSMSNOTES()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GENERAL__TRANSACTION_TYPE()
    onValidate_GENERAL__TSMRTRAIL()
    onValidate_TSMRCLM__TSMENDOSCL()
    onValidate_TSMRCLM__TSMNOTES()
    onValidate_TSMRCLM__TSMSNOTES()
End Sub
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' TSMRCLM = The parent object name of child screen
        ' TSMR_END = The child screen object name
        
        Protected Sub TSMRCLM__TSMR_END_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles TSMRCLM__TSMR_END.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' TSMRCLM = The parent object name of child screen
        ' TAMNOTES = The child screen object name
        
        Protected Sub TSMRCLM__TAMNOTES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles TSMRCLM__TAMNOTES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' TSMRCLM = The parent object name of child screen
        ' TAMSNOTES = The child screen object name
        
        Protected Sub TSMRCLM__TAMSNOTES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles TSMRCLM__TAMSNOTES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
