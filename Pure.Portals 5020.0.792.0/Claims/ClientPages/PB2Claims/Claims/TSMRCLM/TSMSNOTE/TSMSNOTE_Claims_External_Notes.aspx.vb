...
Namespace Nexus
    Partial Class PB2_TSMSNOTE_Claims_External_Notes : Inherits BaseClaim
		...
		Protected Sub onValidate_TSMSNOTE_DETAILS__Note_Details()
...
Protected Sub CallRuleScripts()
    onValidate_TSMSNOTE_DETAILS__Note_Details()
End Sub
