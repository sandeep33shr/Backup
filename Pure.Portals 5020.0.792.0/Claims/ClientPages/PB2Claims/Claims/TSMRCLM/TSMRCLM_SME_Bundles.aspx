<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TSMRCLM_SME_Bundles.aspx.vb" Inherits="Nexus.PB2_TSMRCLM_SME_Bundles" %>
...
function onValidate_TSMRCLM__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMRCLM", "RISK_ATTACH_DATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TSMRCLM", "RISK_ATTACH_DATE");
        		}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMRCLM.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.4", "TSMRCLM", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMRCLM_RISK_ATTACH_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMRCLM__RISK_ATTACH_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMRCLM__RISK_ATTACH_DATE_lblFindParty");
        			    }
        			}
...
function onValidate_TSMRCLM__EFFECTIVEDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMRCLM", "EFFECTIVEDATE", "Date");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TSMRCLM", "EFFECTIVEDATE");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMRCLM.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.4", "TSMRCLM", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMRCLM_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMRCLM__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMRCLM__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__TSMRTRAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "TSMRTRAIL", "ChildScreen");
        })();
        /** 
...
function onValidate_TSMRCLM__NAME(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMRCLM", "NAME", "Integer");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("TSMRCLM", "NAME");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TSMRCLM.NAME");
        			window.setControlWidth(field, "0.8", "TSMRCLM", "NAME");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTSMRCLM_NAME");
        			    var ele = document.getElementById('ctl00_cntMainBody_TSMRCLM__NAME');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TSMRCLM__NAME_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_TSMRCLM__TSMENDOSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMRCLM", "TSMENDOSCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param TSMRCLM The object name of the control to set.
         * @parma TSMR_END The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=TSMRCLM__TSMR_END.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_TSMRCLM__TSMNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMRCLM", "TSMNOTES", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param TSMRCLM The object name of the control to set.
         * @parma TAMNOTES The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=TSMRCLM__TAMNOTES.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_TSMRCLM__TSMSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMRCLM", "TSMSNOTES", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param TSMRCLM The object name of the control to set.
         * @parma TAMSNOTES The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=TSMRCLM__TAMSNOTES.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function DoLogic(isOnLoad) {
    onValidate_TSMRCLM__RISK_ATTACH_DATE(null, null, null, isOnLoad);
    onValidate_TSMRCLM__EFFECTIVEDATE(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__TSMRTRAIL(null, null, null, isOnLoad);
    ...
    onValidate_TSMRCLM__NAME(null, null, null, isOnLoad);
    onValidate_TSMRCLM__TSMENDOSCL(null, null, null, isOnLoad);
    onValidate_TSMRCLM__TSMNOTES(null, null, null, isOnLoad);
    onValidate_TSMRCLM__TSMSNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id196dcd840dd049db815204b6a9f143d6" class="general-layout-container">
...
<div id="idfed344b17c9748b482087a3c7f850ac3" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-TSMRCLM-RISK_ATTACH_DATE">
		<asp:Label ID="lblTSMRCLM_RISK_ATTACH_DATE" runat="server" AssociatedControlID="TSMRCLM__RISK_ATTACH_DATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TSMRCLM__RISK_ATTACH_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTSMRCLM__RISK_ATTACH_DATE" runat="server" LinkedControl="TSMRCLM__RISK_ATTACH_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTSMRCLM_RISK_ATTACH_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_TSMRCLM__RISK_ATTACH_DATE" 
			ValidationGroup=""
			Display="None"
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-TSMRCLM-EFFECTIVEDATE">
		<asp:Label ID="lblTSMRCLM_EFFECTIVEDATE" runat="server" AssociatedControlID="TSMRCLM__EFFECTIVEDATE" 
			Text="Effective Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TSMRCLM__EFFECTIVEDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTSMRCLM__EFFECTIVEDATE" runat="server" LinkedControl="TSMRCLM__EFFECTIVEDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTSMRCLM_EFFECTIVEDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective Date"
			ClientValidationFunction="onValidate_TSMRCLM__EFFECTIVEDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfed344b17c9748b482087a3c7f850ac3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfed344b17c9748b482087a3c7f850ac3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfed344b17c9748b482087a3c7f850ac3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfed344b17c9748b482087a3c7f850ac3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfed344b17c9748b482087a3c7f850ac3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfed344b17c9748b482087a3c7f850ac3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfed344b17c9748b482087a3c7f850ac3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfed344b17c9748b482087a3c7f850ac3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfed344b17c9748b482087a3c7f850ac3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfed344b17c9748b482087a3c7f850ac3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id677ca86a5ab34e65802a8b1e78d36e75" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id677ca86a5ab34e65802a8b1e78d36e75 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id677ca86a5ab34e65802a8b1e78d36e75 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id677ca86a5ab34e65802a8b1e78d36e75 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id677ca86a5ab34e65802a8b1e78d36e75 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id677ca86a5ab34e65802a8b1e78d36e75 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id677ca86a5ab34e65802a8b1e78d36e75 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id677ca86a5ab34e65802a8b1e78d36e75 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id677ca86a5ab34e65802a8b1e78d36e75 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id677ca86a5ab34e65802a8b1e78d36e75 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id677ca86a5ab34e65802a8b1e78d36e75 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb2df93b07b024d99be4dcef7f549c320" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__TSMRTRAIL"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="TSMRTRAIL" 
		id="pb-container-childscreen-GENERAL-TSMRTRAIL">
		
		    <legend>Audit Trail</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__AUDIT" runat="server" ScreenCode="TSMRTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSMRTRAIL/TSMRTRAIL_Audit_Trail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Changed By" DataField="CHANGED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_TSMRTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Audit Trail"
						ClientValidationFunction="onValidate_GENERAL__TSMRTRAIL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb2df93b07b024d99be4dcef7f549c320 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb2df93b07b024d99be4dcef7f549c320 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb2df93b07b024d99be4dcef7f549c320 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb2df93b07b024d99be4dcef7f549c320 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb2df93b07b024d99be4dcef7f549c320 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb2df93b07b024d99be4dcef7f549c320 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb2df93b07b024d99be4dcef7f549c320 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb2df93b07b024d99be4dcef7f549c320 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb2df93b07b024d99be4dcef7f549c320 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb2df93b07b024d99be4dcef7f549c320 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id39460f6e79234e1bbe2b782a7012c00d" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id39460f6e79234e1bbe2b782a7012c00d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id39460f6e79234e1bbe2b782a7012c00d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id39460f6e79234e1bbe2b782a7012c00d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id39460f6e79234e1bbe2b782a7012c00d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id39460f6e79234e1bbe2b782a7012c00d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id39460f6e79234e1bbe2b782a7012c00d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id39460f6e79234e1bbe2b782a7012c00d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id39460f6e79234e1bbe2b782a7012c00d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id39460f6e79234e1bbe2b782a7012c00d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id39460f6e79234e1bbe2b782a7012c00d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd3f38e2f12cd4f9aadfe9ee1c04e53d0" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-TSMRCLM-NAME">
		<asp:Label ID="lblTSMRCLM_NAME" runat="server" AssociatedControlID="TSMRCLM__NAME" 
			Text="Number of Policy Holders" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="TSMRCLM__NAME" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valTSMRCLM_NAME" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Number of Policy Holders"
			ClientValidationFunction="onValidate_TSMRCLM__NAME" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd3f38e2f12cd4f9aadfe9ee1c04e53d0 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida15d0e04371b4d0d86b8b96bbc821520" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TSMRCLM__TSMENDOSCL"
		data-field-type="Child" 
		data-object-name="TSMRCLM" 
		data-property-name="TSMENDOSCL" 
		id="pb-container-childscreen-TSMRCLM-TSMENDOSCL">
		
		    <legend>Endorsements</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TSMRCLM__TSMR_END" runat="server" ScreenCode="TSMENDOSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSMENDOSCL/TSMENDOSCL_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valTSMRCLM_TSMENDOSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Endorsements"
						ClientValidationFunction="onValidate_TSMRCLM__TSMENDOSCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida15d0e04371b4d0d86b8b96bbc821520 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida15d0e04371b4d0d86b8b96bbc821520 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida15d0e04371b4d0d86b8b96bbc821520 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida15d0e04371b4d0d86b8b96bbc821520 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida15d0e04371b4d0d86b8b96bbc821520 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida15d0e04371b4d0d86b8b96bbc821520 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida15d0e04371b4d0d86b8b96bbc821520 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida15d0e04371b4d0d86b8b96bbc821520 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida15d0e04371b4d0d86b8b96bbc821520 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida15d0e04371b4d0d86b8b96bbc821520 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9d417504ddd94f2f83c0f2114b5325e4" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TSMRCLM__TSMNOTES"
		data-field-type="Child" 
		data-object-name="TSMRCLM" 
		data-property-name="TSMNOTES" 
		id="pb-container-childscreen-TSMRCLM-TSMNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TSMRCLM__TAMNOTES" runat="server" ScreenCode="TSMNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTSMRCLM_TSMNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TSMRCLM.TSMNOTES"
						ClientValidationFunction="onValidate_TSMRCLM__TSMNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9d417504ddd94f2f83c0f2114b5325e4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9d417504ddd94f2f83c0f2114b5325e4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9d417504ddd94f2f83c0f2114b5325e4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9d417504ddd94f2f83c0f2114b5325e4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9d417504ddd94f2f83c0f2114b5325e4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9d417504ddd94f2f83c0f2114b5325e4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9d417504ddd94f2f83c0f2114b5325e4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9d417504ddd94f2f83c0f2114b5325e4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9d417504ddd94f2f83c0f2114b5325e4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9d417504ddd94f2f83c0f2114b5325e4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id593b3c20055c4994b32fc8ca2903d5d2" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TSMRCLM__TSMSNOTES"
		data-field-type="Child" 
		data-object-name="TSMRCLM" 
		data-property-name="TSMSNOTES" 
		id="pb-container-childscreen-TSMRCLM-TSMSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TSMRCLM__TAMSNOTES" runat="server" ScreenCode="TSMSNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTSMRCLM_TSMSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TSMRCLM.TSMSNOTES"
						ClientValidationFunction="onValidate_TSMRCLM__TSMSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id593b3c20055c4994b32fc8ca2903d5d2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id593b3c20055c4994b32fc8ca2903d5d2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id593b3c20055c4994b32fc8ca2903d5d2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id593b3c20055c4994b32fc8ca2903d5d2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id593b3c20055c4994b32fc8ca2903d5d2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id593b3c20055c4994b32fc8ca2903d5d2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id593b3c20055c4994b32fc8ca2903d5d2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id593b3c20055c4994b32fc8ca2903d5d2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id593b3c20055c4994b32fc8ca2903d5d2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id593b3c20055c4994b32fc8ca2903d5d2 input{text-align:left;}"; break;
		}
	}
