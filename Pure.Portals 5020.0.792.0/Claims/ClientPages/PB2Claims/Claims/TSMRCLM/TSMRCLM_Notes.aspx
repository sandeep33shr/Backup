<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TSMRCLM_Notes.aspx.vb" Inherits="Nexus.PB2_TSMRCLM_Notes" %>
...
function onValidate_TSMRCLM__TSMCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMRCLM", "TSMCNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TSMRCLM", "TSMCNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_TSMRCLM__TSMCNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TSMRCLM", "TSMCNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TSMRCLM' and property 'TSMCNOTE'.");
        			error.display();
...
function onValidate_TSMRCLM__TSMSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TSMRCLM", "TSMSNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TSMRCLM__TSMCNOTE(null, null, null, isOnLoad);
    onValidate_TSMRCLM__TSMSNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id6b9349b3d8004a54a454bce4c17b66b4" class="general-layout-container">
...
<div id="id31cd866cd6564665a87387920db319fc" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TSMRCLM__TSMCNOTE"
		data-field-type="Child" 
		data-object-name="TSMRCLM" 
		data-property-name="TSMCNOTE" 
		id="pb-container-childscreen-TSMRCLM-TSMCNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TSMRCLM__TSMCNOTE_DETAILS" runat="server" ScreenCode="TSMCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSMCNOTE/TSMCNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTSMRCLM_TSMCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_TSMRCLM__TSMCNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id31cd866cd6564665a87387920db319fc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id31cd866cd6564665a87387920db319fc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id31cd866cd6564665a87387920db319fc div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id31cd866cd6564665a87387920db319fc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id31cd866cd6564665a87387920db319fc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id31cd866cd6564665a87387920db319fc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id31cd866cd6564665a87387920db319fc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id31cd866cd6564665a87387920db319fc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id31cd866cd6564665a87387920db319fc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id31cd866cd6564665a87387920db319fc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idea0947aeb7ab4962bc71f0e46e6ad387" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading33" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TSMRCLM__TSMSNOTE"
		data-field-type="Child" 
		data-object-name="TSMRCLM" 
		data-property-name="TSMSNOTE" 
		id="pb-container-childscreen-TSMRCLM-TSMSNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TSMRCLM__TSMSNOTE_DETAILS" runat="server" ScreenCode="TSMSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TSMSNOTE/TSMSNOTE_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTSMRCLM_TSMSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_TSMRCLM__TSMSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idea0947aeb7ab4962bc71f0e46e6ad387 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idea0947aeb7ab4962bc71f0e46e6ad387 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idea0947aeb7ab4962bc71f0e46e6ad387 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idea0947aeb7ab4962bc71f0e46e6ad387 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idea0947aeb7ab4962bc71f0e46e6ad387 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idea0947aeb7ab4962bc71f0e46e6ad387 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idea0947aeb7ab4962bc71f0e46e6ad387 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idea0947aeb7ab4962bc71f0e46e6ad387 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idea0947aeb7ab4962bc71f0e46e6ad387 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idea0947aeb7ab4962bc71f0e46e6ad387 input{text-align:left;}"; break;
		}
	}
