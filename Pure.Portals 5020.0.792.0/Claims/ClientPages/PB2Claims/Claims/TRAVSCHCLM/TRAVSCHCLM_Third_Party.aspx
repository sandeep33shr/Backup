<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TRAVSCHCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_TRAVSCHCLM_Third_Party" %>
...
function onValidate_TRAVCLAIM__TRAVTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRAVCLAIM", "TRAVTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TRAVCLAIM__TRAVTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id57b31b2ca0494e9ebe022986ba66112c" class="general-layout-container">
...
<div id="id38e142ff24734fdd97423521e238fec3" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TRAVCLAIM__TRAVTPARTY"
		data-field-type="Child" 
		data-object-name="TRAVCLAIM" 
		data-property-name="TRAVTPARTY" 
		id="pb-container-childscreen-TRAVCLAIM-TRAVTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TRAVCLAIM__TRAVTHIRD" runat="server" ScreenCode="TRAVTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRAVTPARTY/TRAVTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTRAVCLAIM_TRAVTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TRAVCLAIM.TRAVTPARTY"
						ClientValidationFunction="onValidate_TRAVCLAIM__TRAVTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id38e142ff24734fdd97423521e238fec3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id38e142ff24734fdd97423521e238fec3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id38e142ff24734fdd97423521e238fec3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id38e142ff24734fdd97423521e238fec3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id38e142ff24734fdd97423521e238fec3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38e142ff24734fdd97423521e238fec3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38e142ff24734fdd97423521e238fec3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id38e142ff24734fdd97423521e238fec3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id38e142ff24734fdd97423521e238fec3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id38e142ff24734fdd97423521e238fec3 input{text-align:left;}"; break;
		}
	}
