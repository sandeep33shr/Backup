...
Namespace Nexus
    Partial Class PB2_CMTRADCLM_Motor_Traders : Inherits BaseClaim
		...
		Protected Sub onValidate_EXTENSIONS__SDPMTCLM()
        
End Sub
Protected Sub onValidate_TRADERSCLAIM__MTENDCLM()
        
End Sub
Protected Sub onValidate_TRADERSCLAIM__MTNOTESCLM()
        
End Sub
Protected Sub onValidate_TRADERSCLAIM__MTSNOTECLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_EXTENSIONS__SDPMTCLM()
    onValidate_TRADERSCLAIM__MTENDCLM()
    onValidate_TRADERSCLAIM__MTNOTESCLM()
    onValidate_TRADERSCLAIM__MTSNOTECLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' EXTENSIONS = The parent object name of child screen
        ' SDPMT_CHILD = The child screen object name
        
        Protected Sub EXTENSIONS__SDPMT_CHILD_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles EXTENSIONS__SDPMT_CHILD.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' TRADERSCLAIM = The parent object name of child screen
        ' SEC_A = The child screen object name
        
        Protected Sub TRADERSCLAIM__SEC_A_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles TRADERSCLAIM__SEC_A.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' TRADERSCLAIM = The parent object name of child screen
        ' MTNOTE_DETAILS = The child screen object name
        
        Protected Sub TRADERSCLAIM__MTNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles TRADERSCLAIM__MTNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' TRADERSCLAIM = The parent object name of child screen
        ' MTSNOTE_DETAILS = The child screen object name
        
        Protected Sub TRADERSCLAIM__MTSNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles TRADERSCLAIM__MTSNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
