...
Namespace Nexus
    Partial Class PB2_TRADNOTES_Claims_Internal_Notes : Inherits BaseClaim
		...
		Protected Sub onValidate_CNOTE_DETAILS__Note_Details()
                If eLifecycleEvent = LifecycleEvent.Page_Load Then
                    ...
                    End If
End Sub
Protected Sub onValidate_CNOTE_DETAILS__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CNOTE_DETAILS__Note_Details()
    onValidate_CNOTE_DETAILS__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded()
        	Dim NoteAddedCheck As Integer =Cint(CNOTE_DETAILS__NoteCheck.Text)
        	
        	If NoteAddedCheck = 0 Then
        		CNOTE_DETAILS__NoteCheck.Text = 1
        	End If
        End Sub
