<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMTRADCLM_Notes.aspx.vb" Inherits="Nexus.PB2_CMTRADCLM_Notes" %>
...
function onValidate_TRADERSCLAIM__TRADNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRADERSCLAIM", "TRADNOTES", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TRADERSCLAIM", "TRADNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_TRADERSCLAIM__TRADNOTES table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TRADERSCLAIM", "TRADNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TRADERSCLAIM' and property 'TRADNOTES'.");
        			error.display();
...
function onValidate_TRADERSCLAIM__TRADXNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRADERSCLAIM", "TRADXNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TRADERSCLAIM__TRADNOTES(null, null, null, isOnLoad);
    onValidate_TRADERSCLAIM__TRADXNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id840ecc7e29244fd5bf867fa66dbfc71e" class="general-layout-container">
...
<div id="id3f3bb06a92d74424aa885a20e02b843d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading42" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TRADERSCLAIM__TRADNOTES"
		data-field-type="Child" 
		data-object-name="TRADERSCLAIM" 
		data-property-name="TRADNOTES" 
		id="pb-container-childscreen-TRADERSCLAIM-TRADNOTES">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TRADERSCLAIM__CNOTE_DETAILS" runat="server" ScreenCode="TRADNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRADNOTES/TRADNOTES_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTRADERSCLAIM_TRADNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_TRADERSCLAIM__TRADNOTES" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id3f3bb06a92d74424aa885a20e02b843d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3f3bb06a92d74424aa885a20e02b843d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3f3bb06a92d74424aa885a20e02b843d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id3f3bb06a92d74424aa885a20e02b843d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3f3bb06a92d74424aa885a20e02b843d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3f3bb06a92d74424aa885a20e02b843d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3f3bb06a92d74424aa885a20e02b843d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3f3bb06a92d74424aa885a20e02b843d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3f3bb06a92d74424aa885a20e02b843d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3f3bb06a92d74424aa885a20e02b843d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9a826b47f3924a17824b17f817d01dca" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading43" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TRADERSCLAIM__TRADXNOTE"
		data-field-type="Child" 
		data-object-name="TRADERSCLAIM" 
		data-property-name="TRADXNOTE" 
		id="pb-container-childscreen-TRADERSCLAIM-TRADXNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TRADERSCLAIM__EXT_DETAILS" runat="server" ScreenCode="TRADXNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRADXNOTE/TRADXNOTE_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTRADERSCLAIM_TRADXNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_TRADERSCLAIM__TRADXNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9a826b47f3924a17824b17f817d01dca div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9a826b47f3924a17824b17f817d01dca div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9a826b47f3924a17824b17f817d01dca div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9a826b47f3924a17824b17f817d01dca label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9a826b47f3924a17824b17f817d01dca label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9a826b47f3924a17824b17f817d01dca label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9a826b47f3924a17824b17f817d01dca label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9a826b47f3924a17824b17f817d01dca input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9a826b47f3924a17824b17f817d01dca input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9a826b47f3924a17824b17f817d01dca input{text-align:left;}"; break;
		}
	}
