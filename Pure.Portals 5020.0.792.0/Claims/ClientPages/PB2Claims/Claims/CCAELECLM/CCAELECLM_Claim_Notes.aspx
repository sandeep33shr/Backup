<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAELECLM_Claim_Notes.aspx.vb" Inherits="Nexus.PB2_CCAELECLM_Claim_Notes" %>
...
function onValidate_GENERAL__CCAMECNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CCAMECNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GENERAL", "CCAMECNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_GENERAL__CCAMECNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GENERAL", "CCAMECNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'GENERAL' and property 'CCAMECNOTE'.");
        			error.display();
...
function onValidate_GENERAL__CCAMESNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CCAMESNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_GENERAL__CCAMECNOTE(null, null, null, isOnLoad);
    onValidate_GENERAL__CCAMESNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id6bc5091832dd4254adaa406585cf3d0b" class="general-layout-container">
...
<div id="id015a9d2520984461a1139919ff48eafe" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading60" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CCAMECNOTE"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CCAMECNOTE" 
		id="pb-container-childscreen-GENERAL-CCAMECNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__INT_DETAILS" runat="server" ScreenCode="CCAMECNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CCAMECNOTE/CCAMECNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_CCAMECNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_GENERAL__CCAMECNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id015a9d2520984461a1139919ff48eafe div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id015a9d2520984461a1139919ff48eafe div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id015a9d2520984461a1139919ff48eafe div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id015a9d2520984461a1139919ff48eafe label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id015a9d2520984461a1139919ff48eafe label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id015a9d2520984461a1139919ff48eafe label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id015a9d2520984461a1139919ff48eafe label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id015a9d2520984461a1139919ff48eafe input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id015a9d2520984461a1139919ff48eafe input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id015a9d2520984461a1139919ff48eafe input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idab2d9733f28e4a3689413ff2d13e1be2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading61" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CCAMESNOTE"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CCAMESNOTE" 
		id="pb-container-childscreen-GENERAL-CCAMESNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__EXT_DETAILS" runat="server" ScreenCode="CCAMESNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CCAMESNOTE/CCAMESNOTE_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_CCAMESNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_GENERAL__CCAMESNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idab2d9733f28e4a3689413ff2d13e1be2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idab2d9733f28e4a3689413ff2d13e1be2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idab2d9733f28e4a3689413ff2d13e1be2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idab2d9733f28e4a3689413ff2d13e1be2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idab2d9733f28e4a3689413ff2d13e1be2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idab2d9733f28e4a3689413ff2d13e1be2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idab2d9733f28e4a3689413ff2d13e1be2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idab2d9733f28e4a3689413ff2d13e1be2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idab2d9733f28e4a3689413ff2d13e1be2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idab2d9733f28e4a3689413ff2d13e1be2 input{text-align:left;}"; break;
		}
	}
