...
Namespace Nexus
    Partial Class PB2_CCAELECLM_Electronic_Equipment : Inherits BaseClaim
		...
		Protected Sub onValidate_ELECTEQUIP__EELECCHILD()
        
End Sub
Protected Sub onValidate_ELECTEQUIP__EELEECMP()
        
End Sub
Protected Sub onValidate_ELECTEQUIP__EELECNDPRE()
        
End Sub
Protected Sub onValidate_ELECTEQUIP__ELECNTE()
        
End Sub
Protected Sub onValidate_ELECTEQUIP__ELECSNOTES()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ELECTEQUIP__EELECCHILD()
    onValidate_ELECTEQUIP__EELEECMP()
    onValidate_ELECTEQUIP__EELECNDPRE()
    onValidate_ELECTEQUIP__ELECNTE()
    onValidate_ELECTEQUIP__ELECSNOTES()
End Sub
