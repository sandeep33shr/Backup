...
Namespace Nexus
    Partial Class PB2_EELECCHILD_Electric_Equipment_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_ELECTEQ__EELECCLDEP()
        
End Sub
Protected Sub onValidate_ELECTEQ__EELECNOTE()
        
End Sub
Protected Sub onValidate_ELECTEQ__EELESCNOTE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ELECTEQ__EELECCLDEP()
    onValidate_ELECTEQ__EELECNOTE()
    onValidate_ELECTEQ__EELESCNOTE()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' ELECTEQ = The parent object name of child screen
        ' EE_CLAUSEPREM = The child screen object name
        
        Protected Sub ELECTEQ__EE_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles ELECTEQ__EE_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' ELECTEQ = The parent object name of child screen
        ' EE_CNOTE_DETAILS = The child screen object name
        
        Protected Sub ELECTEQ__EE_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles ELECTEQ__EE_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' ELECTEQ = The parent object name of child screen
        ' EE_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub ELECTEQ__EE_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles ELECTEQ__EE_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
