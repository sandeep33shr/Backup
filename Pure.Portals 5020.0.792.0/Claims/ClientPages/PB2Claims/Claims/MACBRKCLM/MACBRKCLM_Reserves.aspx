<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MACBRKCLM_Reserves.aspx.vb" Inherits="Nexus.PB2_MACBRKCLM_Reserves" %>
...
function onValidate_MACBRKCLAIM__CMBSOLSCRN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MACBRKCLAIM", "CMBSOLSCRN", "ChildScreen");
        })();
}
function onValidate_MACBRKCLAIM__SOL_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MACBRKCLAIM", "SOL_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MACBRKCLAIM", "SOL_COUNTER");
        		}
          ...
          * @param MACBRKCLAIM The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "MACBRKCLAIM".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_MACBRKCLAIM__CMBRCVRSC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MACBRKCLAIM", "CMBRCVRSC", "ChildScreen");
        })();
}
function onValidate_MACBRKCLAIM__RECO_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MACBRKCLAIM", "RECO_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("MACBRKCLAIM", "RECO_COUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_MACBRKCLAIM__CMBSOLSCRN(null, null, null, isOnLoad);
    onValidate_MACBRKCLAIM__SOL_COUNTER(null, null, null, isOnLoad);
    onValidate_MACBRKCLAIM__CMBRCVRSC(null, null, null, isOnLoad);
    onValidate_MACBRKCLAIM__RECO_COUNTER(null, null, null, isOnLoad);
}
</script>
...
<div id="id548e8750e2e84c0a9b191fa9d9e4fafc" class="general-layout-container">
...
<div id="idd552ace1bd124886b667ce9247c1443c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading49" runat="server" Text="Claim Reserves" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MACBRKCLAIM__CMBSOLSCRN"
		data-field-type="Child" 
		data-object-name="MACBRKCLAIM" 
		data-property-name="CMBSOLSCRN" 
		id="pb-container-childscreen-MACBRKCLAIM-CMBSOLSCRN">
		
		    <legend>Schedule of Loss</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MACBRKCLAIM__SCHEDULE_LOSS" runat="server" ScreenCode="CMBSOLSCRN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMBSOLSCRN/CMBSOLSCRN_Schedule_of_Loss.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_CONMACBRK_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Payment Amount" DataField="PAYMENT_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMACBRKCLAIM_CMBSOLSCRN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Schedule of Loss"
						ClientValidationFunction="onValidate_MACBRKCLAIM__CMBSOLSCRN" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-MACBRKCLAIM-SOL_COUNTER">
		<asp:Label ID="lblMACBRKCLAIM_SOL_COUNTER" runat="server" AssociatedControlID="MACBRKCLAIM__SOL_COUNTER" 
			Text="Schedule Item Counter " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MACBRKCLAIM__SOL_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMACBRKCLAIM_SOL_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Schedule Item Counter "
			ClientValidationFunction="onValidate_MACBRKCLAIM__SOL_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd552ace1bd124886b667ce9247c1443c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd552ace1bd124886b667ce9247c1443c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd552ace1bd124886b667ce9247c1443c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd552ace1bd124886b667ce9247c1443c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd552ace1bd124886b667ce9247c1443c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd552ace1bd124886b667ce9247c1443c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd552ace1bd124886b667ce9247c1443c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd552ace1bd124886b667ce9247c1443c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd552ace1bd124886b667ce9247c1443c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd552ace1bd124886b667ce9247c1443c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide147f9381f1a42ab9ea4c75cc9674241" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading50" runat="server" Text="Claim Recoveries" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MACBRKCLAIM__CMBRCVRSC"
		data-field-type="Child" 
		data-object-name="MACBRKCLAIM" 
		data-property-name="CMBRCVRSC" 
		id="pb-container-childscreen-MACBRKCLAIM-CMBRCVRSC">
		
		    <legend>Recoveries</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MACBRKCLAIM__RECOVERIES" runat="server" ScreenCode="CMBRCVRSC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMBRCVRSC/CMBRCVRSC_Recovery.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_CONMACBRK_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Negotiated Amount" DataField="NEGOTIATED_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMACBRKCLAIM_CMBRCVRSC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Recoveries"
						ClientValidationFunction="onValidate_MACBRKCLAIM__CMBRCVRSC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-MACBRKCLAIM-RECO_COUNTER">
		<asp:Label ID="lblMACBRKCLAIM_RECO_COUNTER" runat="server" AssociatedControlID="MACBRKCLAIM__RECO_COUNTER" 
			Text="Recoveries counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="MACBRKCLAIM__RECO_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valMACBRKCLAIM_RECO_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recoveries counter"
			ClientValidationFunction="onValidate_MACBRKCLAIM__RECO_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide147f9381f1a42ab9ea4c75cc9674241 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide147f9381f1a42ab9ea4c75cc9674241 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide147f9381f1a42ab9ea4c75cc9674241 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	  
			  if (liElementHeight > liMaxHeight)
			  {
				  liMaxHeight = liElementHeight;			  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide147f9381f1a42ab9ea4c75cc9674241 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide147f9381f1a42ab9ea4c75cc9674241 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide147f9381f1a42ab9ea4c75cc9674241 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide147f9381f1a42ab9ea4c75cc9674241 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide147f9381f1a42ab9ea4c75cc9674241 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide147f9381f1a42ab9ea4c75cc9674241 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide147f9381f1a42ab9ea4c75cc9674241 input{text-align:left;}"; break;
		}
	}
