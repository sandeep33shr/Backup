<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MACBRKCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_MACBRKCLM_Third_Party" %>
...
function onValidate_MACBRKCLAIM__CMBTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MACBRKCLAIM", "CMBTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MACBRKCLAIM__CMBTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id269eb510c1a049c08ac9872f2739c382" class="general-layout-container">
...
<div id="idd0251b32d5944541b9558db6a5324cf3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading28" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MACBRKCLAIM__CMBTPARTY"
		data-field-type="Child" 
		data-object-name="MACBRKCLAIM" 
		data-property-name="CMBTPARTY" 
		id="pb-container-childscreen-MACBRKCLAIM-CMBTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MACBRKCLAIM__MACBRKTHIRD" runat="server" ScreenCode="CMBTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMBTPARTY/CMBTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMACBRKCLAIM_CMBTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MACBRKCLAIM.CMBTPARTY"
						ClientValidationFunction="onValidate_MACBRKCLAIM__CMBTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd0251b32d5944541b9558db6a5324cf3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd0251b32d5944541b9558db6a5324cf3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd0251b32d5944541b9558db6a5324cf3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd0251b32d5944541b9558db6a5324cf3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd0251b32d5944541b9558db6a5324cf3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd0251b32d5944541b9558db6a5324cf3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd0251b32d5944541b9558db6a5324cf3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd0251b32d5944541b9558db6a5324cf3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd0251b32d5944541b9558db6a5324cf3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd0251b32d5944541b9558db6a5324cf3 input{text-align:left;}"; break;
		}
	}
