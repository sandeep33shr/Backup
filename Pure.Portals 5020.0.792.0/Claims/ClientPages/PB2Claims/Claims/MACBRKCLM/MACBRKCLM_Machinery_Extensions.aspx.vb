...
Namespace Nexus
    Partial Class PB2_MACBRKCLM_Machinery_Extensions : Inherits BaseClaim
		...
		Protected Sub onValidate_MACBRKEXTCLM__CMBEXTCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MACBRKEXTCLM__CMBEXTCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MACBRKEXTCLM = The parent object name of child screen
        ' MEXTCLM = The child screen object name
        
        Protected Sub MACBRKEXTCLM__MEXTCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MACBRKEXTCLM__MEXTCLM.RowDataBound
