...
Namespace Nexus
    Partial Class PB2_MACBRKCLM_Consequential_Loss_Extensions : Inherits BaseClaim
		...
		Protected Sub onValidate_MACBRKCLEXTCLM__MBCLEXTCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MACBRKCLEXTCLM__MBCLEXTCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MACBRKCLEXTCLM = The parent object name of child screen
        ' CLEXTCLM = The child screen object name
        
        Protected Sub MACBRKCLEXTCLM__CLEXTCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MACBRKCLEXTCLM__CLEXTCLM.RowDataBound
