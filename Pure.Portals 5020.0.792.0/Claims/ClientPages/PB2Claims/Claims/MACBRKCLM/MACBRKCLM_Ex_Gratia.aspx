<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MACBRKCLM_Ex_Gratia.aspx.vb" Inherits="Nexus.PB2_MACBRKCLM_Ex_Gratia" %>
...
function onValidate_MACBRKCLAIM__CMBGRDTAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MACBRKCLAIM", "CMBGRDTAIL", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MACBRKCLAIM__CMBGRDTAIL(null, null, null, isOnLoad);
}
</script>
...
<div id="ida4758d76874a460183ec7b51594c687e" class="general-layout-container">
...
<div id="frmExGratia" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Ex Gratia" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MACBRKCLAIM__CMBGRDTAIL"
		data-field-type="Child" 
		data-object-name="MACBRKCLAIM" 
		data-property-name="CMBGRDTAIL" 
		id="pb-container-childscreen-MACBRKCLAIM-CMBGRDTAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MACBRKCLAIM__AUTH_DETAILS" runat="server" ScreenCode="CMBGRDTAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMBGRDTAIL/CMBGRDTAIL_Ex_Gratia.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Reason" DataField="R_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMACBRKCLAIM_CMBGRDTAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MACBRKCLAIM.CMBGRDTAIL"
						ClientValidationFunction="onValidate_MACBRKCLAIM__CMBGRDTAIL" 
						Display="None"
