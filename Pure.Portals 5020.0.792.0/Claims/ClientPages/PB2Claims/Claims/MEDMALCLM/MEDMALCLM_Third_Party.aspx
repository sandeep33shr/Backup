<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MEDMALCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_MEDMALCLM_Third_Party" %>
...
function onValidate_MEDMALCLAIM__MEDTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MEDMALCLAIM", "MEDTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MEDMALCLAIM__MEDTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id5d4d6d16433641958d6dc1ac884ec845" class="general-layout-container">
...
<div id="idcbbeed53783c4acbb0ce89c8ad1ff9ad" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MEDMALCLAIM__MEDTPARTY"
		data-field-type="Child" 
		data-object-name="MEDMALCLAIM" 
		data-property-name="MEDTPARTY" 
		id="pb-container-childscreen-MEDMALCLAIM-MEDTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MEDMALCLAIM__MEDMALTHIRD" runat="server" ScreenCode="MEDTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MEDTPARTY/MEDTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMEDMALCLAIM_MEDTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MEDMALCLAIM.MEDTPARTY"
						ClientValidationFunction="onValidate_MEDMALCLAIM__MEDTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idcbbeed53783c4acbb0ce89c8ad1ff9ad div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcbbeed53783c4acbb0ce89c8ad1ff9ad div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcbbeed53783c4acbb0ce89c8ad1ff9ad div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idcbbeed53783c4acbb0ce89c8ad1ff9ad label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcbbeed53783c4acbb0ce89c8ad1ff9ad label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcbbeed53783c4acbb0ce89c8ad1ff9ad label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcbbeed53783c4acbb0ce89c8ad1ff9ad label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcbbeed53783c4acbb0ce89c8ad1ff9ad input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcbbeed53783c4acbb0ce89c8ad1ff9ad input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcbbeed53783c4acbb0ce89c8ad1ff9ad input{text-align:left;}"; break;
		}
	}
