<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MEDMALCLM_Ex_Gratia.aspx.vb" Inherits="Nexus.PB2_MEDMALCLM_Ex_Gratia" %>
...
function onValidate_MEDMALCLAIM__MEDGRDTAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MEDMALCLAIM", "MEDGRDTAIL", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MEDMALCLAIM__MEDGRDTAIL(null, null, null, isOnLoad);
}
</script>
...
<div id="id9428621513e44cea88980cfb37eaa7e0" class="general-layout-container">
...
<div id="frmExGratia" class="column-layout-container fieldset-wrapper,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MEDMALCLAIM__MEDGRDTAIL"
		data-field-type="Child" 
		data-object-name="MEDMALCLAIM" 
		data-property-name="MEDGRDTAIL" 
		id="pb-container-childscreen-MEDMALCLAIM-MEDGRDTAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MEDMALCLAIM__AUTH_DETAILS" runat="server" ScreenCode="MEDGRDTAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MEDGRDTAIL/MEDGRDTAIL_Ex_Gratia.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Reason" DataField="R_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMEDMALCLAIM_MEDGRDTAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MEDMALCLAIM.MEDGRDTAIL"
						ClientValidationFunction="onValidate_MEDMALCLAIM__MEDGRDTAIL" 
						Display="None"
