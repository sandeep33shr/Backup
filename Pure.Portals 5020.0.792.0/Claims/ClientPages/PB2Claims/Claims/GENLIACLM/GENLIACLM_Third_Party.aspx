<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="GENLIACLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_GENLIACLM_Third_Party" %>
...
function onValidate_GENLIABCLAIM__GLTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENLIABCLAIM", "GLTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_GENLIABCLAIM__GLTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idb81dfa5f77f6422684427a294ff83224" class="general-layout-container">
...
<div id="id68078e25a9404c41b1953954a8d57914" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading16" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENLIABCLAIM__GLTPARTY"
		data-field-type="Child" 
		data-object-name="GENLIABCLAIM" 
		data-property-name="GLTPARTY" 
		id="pb-container-childscreen-GENLIABCLAIM-GLTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENLIABCLAIM__GLTHIRD" runat="server" ScreenCode="GLTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GLTPARTY/GLTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENLIABCLAIM_GLTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENLIABCLAIM.GLTPARTY"
						ClientValidationFunction="onValidate_GENLIABCLAIM__GLTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id68078e25a9404c41b1953954a8d57914 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id68078e25a9404c41b1953954a8d57914 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id68078e25a9404c41b1953954a8d57914 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id68078e25a9404c41b1953954a8d57914 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id68078e25a9404c41b1953954a8d57914 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id68078e25a9404c41b1953954a8d57914 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id68078e25a9404c41b1953954a8d57914 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id68078e25a9404c41b1953954a8d57914 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id68078e25a9404c41b1953954a8d57914 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id68078e25a9404c41b1953954a8d57914 input{text-align:left;}"; break;
		}
	}
