...
Namespace Nexus
    Partial Class PB2_GENLIACLM_Claim_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_GENLIABCLAIM__GLTRAIL()
        
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GENLIABCLAIM__GLTRAIL()
End Sub
        ...
        Protected Sub UpdateAuditTrail()
        	...
        	Dim salvage As String = GENLIABCLAIM__SALVAGESTAT.Text
        	Dim legal As String = GENLIABCLAIM__LEGALSTAT.Text
        	Dim decision As String = GENLIABCLAIM__CLMDECISION.Text
        	...
        	If (salvage_updatereq Or legal_updatereq Or decision_updatereq) Then
        		...
        		Session(CNDataSet) = oWebService.RunDefaultRulesEdit(GENLIABCLAIM__GLAUDIT.ScreenCode, Session(CNDataSet))
        	End If
        ...
        Protected Function AuditEntryRequired(ByVal propertyName As String, ByVal propertyValue As String, ByRef previousValue As String) As Boolean
        	...
        	For Each el As Linq.XElement In datamodelXML.DescendantNodes()
        		If (el.Name.ToString().ToUpper() = "GLAUDIT") Then
        ...
        Protected Sub LogAuditEntry(ByVal propertyName As String, ByVal propertyValue As String, ByVal previousValue As String)
        	...
        	Doc.LoadXml(strDS)
        	Dim xmlParent As XmlNode = Doc.SelectSingleNode("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/GENLIABCLAIM/GLAUDIT")
        	Dim v_sOI As String = Nothing
        	If xmlParent IsNot Nothing Then
        		v_sOI = xmlParent.Attributes("OI").Value
        	End If
        	Dim v_sScreenCode As String = GENLIABCLAIM__GLAUDIT.ScreenCode
        	Dim sParentElement, sChildElement As String
        	Dim sTmp() As String = Regex.Split(GENLIABCLAIM__GLAUDIT.ID, "__")
        	...
        	GENLIABCLAIM__GLAUDIT.DataSource = oXMLSource
        	GENLIABCLAIM__GLAUDIT.DataBind()
        ...
        ' GENLIABCLAIM = The parent object name of child screen
        ' GLAUDIT = The child screen object name
        
        Protected Sub GENLIABCLAIM__GLAUDIT_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GENLIABCLAIM__GLAUDIT.RowDataBound
