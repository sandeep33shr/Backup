<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MMGENCLM_Notes.aspx.vb" Inherits="Nexus.PB2_MMGENCLM_Notes" %>
...
function onValidate_MOTGEN__MGENNCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTGEN", "MGENNCLM", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MOTGEN", "MGENNCLM");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_MOTGEN__MGENNCLM table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("MOTGEN", "MGENNCLM");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'MOTGEN' and property 'MGENNCLM'.");
        			error.display();
...
function onValidate_MOTGEN__MGENENCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTGEN", "MGENENCLM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MOTGEN__MGENNCLM(null, null, null, isOnLoad);
    onValidate_MOTGEN__MGENENCLM(null, null, null, isOnLoad);
}
</script>
...
<div id="id92334db9b39d430393d2532e0942e2b8" class="general-layout-container">
...
<div id="id2c50b37309a7492cbc196a58a3a363a7" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading33" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MOTGEN__MGENNCLM"
		data-field-type="Child" 
		data-object-name="MOTGEN" 
		data-property-name="MGENNCLM" 
		id="pb-container-childscreen-MOTGEN-MGENNCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MOTGEN__CNOTE_DETAILS" runat="server" ScreenCode="MGENNCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGENNCLM/MGENNCLM_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMOTGEN_MGENNCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_MOTGEN__MGENNCLM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id2c50b37309a7492cbc196a58a3a363a7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id2c50b37309a7492cbc196a58a3a363a7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id2c50b37309a7492cbc196a58a3a363a7 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id2c50b37309a7492cbc196a58a3a363a7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id2c50b37309a7492cbc196a58a3a363a7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2c50b37309a7492cbc196a58a3a363a7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2c50b37309a7492cbc196a58a3a363a7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id2c50b37309a7492cbc196a58a3a363a7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id2c50b37309a7492cbc196a58a3a363a7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id2c50b37309a7492cbc196a58a3a363a7 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8b10ea4313ff420db11ab47fbcaaed8b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading34" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MOTGEN__MGENENCLM"
		data-field-type="Child" 
		data-object-name="MOTGEN" 
		data-property-name="MGENENCLM" 
		id="pb-container-childscreen-MOTGEN-MGENENCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MOTGEN__EXT_DETAILS" runat="server" ScreenCode="MGENENCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGENENCLM/MGENENCLM_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMOTGEN_MGENENCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_MOTGEN__MGENENCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8b10ea4313ff420db11ab47fbcaaed8b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8b10ea4313ff420db11ab47fbcaaed8b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8b10ea4313ff420db11ab47fbcaaed8b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8b10ea4313ff420db11ab47fbcaaed8b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8b10ea4313ff420db11ab47fbcaaed8b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8b10ea4313ff420db11ab47fbcaaed8b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8b10ea4313ff420db11ab47fbcaaed8b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8b10ea4313ff420db11ab47fbcaaed8b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8b10ea4313ff420db11ab47fbcaaed8b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8b10ea4313ff420db11ab47fbcaaed8b input{text-align:left;}"; break;
		}
	}
