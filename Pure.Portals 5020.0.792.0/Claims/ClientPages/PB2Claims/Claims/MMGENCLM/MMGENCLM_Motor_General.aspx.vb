...
Namespace Nexus
    Partial Class PB2_MMGENCLM_Motor_General : Inherits BaseClaim
		...
		Protected Sub onValidate_MOTGEN__MGENDCLM()
        
End Sub
Protected Sub onValidate_MOTGEN__MGNOTESCLM()
        
End Sub
Protected Sub onValidate_MOTGEN__MGSNOTECLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MOTGEN__MGENDCLM()
    onValidate_MOTGEN__MGNOTESCLM()
    onValidate_MOTGEN__MGSNOTECLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MOTGEN = The parent object name of child screen
        ' CLAUSEPREM = The child screen object name
        
        Protected Sub MOTGEN__CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MOTGEN__CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MOTGEN = The parent object name of child screen
        ' MGEN_CNOTE_DETAILS = The child screen object name
        
        Protected Sub MOTGEN__MGEN_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MOTGEN__MGEN_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MOTGEN = The parent object name of child screen
        ' MGEN_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub MOTGEN__MGEN_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MOTGEN__MGEN_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
