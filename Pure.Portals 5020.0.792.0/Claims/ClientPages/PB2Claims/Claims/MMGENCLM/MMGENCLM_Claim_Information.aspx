<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MMGENCLM_Claim_Information.aspx.vb" Inherits="Nexus.PB2_MMGENCLM_Claim_Information" %>
...
function onValidate_GENERAL__THIRDPARTY(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("GENERAL.THIRDPARTY");
        		var update = function(){
...
function onValidate_GENERAL__MGENTRAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "MGENTRAIL", "ChildScreen");
        })();
        /** 
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__MGENTRAIL(null, null, null, isOnLoad);
}
</script>
...
<div id="id922ac680eae64fa0ae6fca0fa3fcb06f" class="general-layout-container">
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3827e9f1e0544c959cd270bf1fe7fbc5" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__MGENTRAIL"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="MGENTRAIL" 
		id="pb-container-childscreen-GENERAL-MGENTRAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__AUDIT" runat="server" ScreenCode="MGENTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MGENTRAIL/MGENTRAIL_Audit_Trail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Changed By" DataField="CHANGED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_MGENTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.MGENTRAIL"
						ClientValidationFunction="onValidate_GENERAL__MGENTRAIL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3827e9f1e0544c959cd270bf1fe7fbc5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3827e9f1e0544c959cd270bf1fe7fbc5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3827e9f1e0544c959cd270bf1fe7fbc5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3827e9f1e0544c959cd270bf1fe7fbc5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3827e9f1e0544c959cd270bf1fe7fbc5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3827e9f1e0544c959cd270bf1fe7fbc5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3827e9f1e0544c959cd270bf1fe7fbc5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3827e9f1e0544c959cd270bf1fe7fbc5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3827e9f1e0544c959cd270bf1fe7fbc5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3827e9f1e0544c959cd270bf1fe7fbc5 input{text-align:left;}"; break;
		}
	}
