<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TUPMOTOCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_TUPMOTOCLM_Third_Party" %>
...
function onValidate_TMOTOCLAIM__TMOTTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TMOTOCLAIM", "TMOTTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TMOTOCLAIM__TMOTTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id03d81a0eb19446b7b76dd6b94c121a1d" class="general-layout-container">
...
<div id="id5b4af9bcc9e941d7a7f441fc44918172" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading12" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TMOTOCLAIM__TMOTTPARTY"
		data-field-type="Child" 
		data-object-name="TMOTOCLAIM" 
		data-property-name="TMOTTPARTY" 
		id="pb-container-childscreen-TMOTOCLAIM-TMOTTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TMOTOCLAIM__TMOTOTHIRD" runat="server" ScreenCode="TMOTTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TMOTTPARTY/TMOTTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTMOTOCLAIM_TMOTTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TMOTOCLAIM.TMOTTPARTY"
						ClientValidationFunction="onValidate_TMOTOCLAIM__TMOTTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5b4af9bcc9e941d7a7f441fc44918172 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5b4af9bcc9e941d7a7f441fc44918172 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5b4af9bcc9e941d7a7f441fc44918172 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5b4af9bcc9e941d7a7f441fc44918172 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5b4af9bcc9e941d7a7f441fc44918172 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5b4af9bcc9e941d7a7f441fc44918172 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5b4af9bcc9e941d7a7f441fc44918172 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5b4af9bcc9e941d7a7f441fc44918172 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5b4af9bcc9e941d7a7f441fc44918172 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5b4af9bcc9e941d7a7f441fc44918172 input{text-align:left;}"; break;
		}
	}
