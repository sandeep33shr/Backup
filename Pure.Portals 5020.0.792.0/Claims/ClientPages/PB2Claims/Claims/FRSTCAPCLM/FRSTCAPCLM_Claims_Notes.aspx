<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FRSTCAPCLM_Claims_Notes.aspx.vb" Inherits="Nexus.PB2_FRSTCAPCLM_Claims_Notes" %>
...
function onValidate_FCAPCLAIM__FCANOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCAPCLAIM", "FCANOTE", "ChildScreen");
        })();
}
function onValidate_FCAPCLAIM__FCAEXPA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCAPCLAIM", "FCAEXPA", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_FCAPCLAIM__FCANOTE(null, null, null, isOnLoad);
    onValidate_FCAPCLAIM__FCAEXPA(null, null, null, isOnLoad);
}
</script>
...
<div id="id219a001e1b4a44c08c417568f2990f14" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading18" runat="server" Text=" First Capital Home Loan Claims Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FCAPCLAIM__FCANOTE"
		data-field-type="Child" 
		data-object-name="FCAPCLAIM" 
		data-property-name="FCANOTE" 
		id="pb-container-childscreen-FCAPCLAIM-FCANOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FCAPCLAIM__CNOTE_DETAILS" runat="server" ScreenCode="FCANOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="FCANOTE/FCANOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFCAPCLAIM_FCANOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_FCAPCLAIM__FCANOTE" 
						Display="None"
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FCAPCLAIM__FCAEXPA"
		data-field-type="Child" 
		data-object-name="FCAPCLAIM" 
		data-property-name="FCAEXPA" 
		id="pb-container-childscreen-FCAPCLAIM-FCAEXPA">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FCAPCLAIM__EXT_DETAILS" runat="server" ScreenCode="FCAEXPA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="FCAEXPA/FCAEXPA_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFCAPCLAIM_FCAEXPA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_FCAPCLAIM__FCAEXPA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
