<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="FRSTCAPCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_FRSTCAPCLM_Third_Party" %>
...
function onValidate_FCAPCLAIM__FCAPTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "FCAPCLAIM", "FCAPTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_FCAPCLAIM__FCAPTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idff0bccae74584d2398217945c5bcf1b9" class="general-layout-container">
...
<div id="id73094850183741f185465c7c8dcab180" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_FCAPCLAIM__FCAPTPARTY"
		data-field-type="Child" 
		data-object-name="FCAPCLAIM" 
		data-property-name="FCAPTPARTY" 
		id="pb-container-childscreen-FCAPCLAIM-FCAPTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="FCAPCLAIM__FCAPTHIRD" runat="server" ScreenCode="FCAPTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="FCAPTPARTY/FCAPTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valFCAPCLAIM_FCAPTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for FCAPCLAIM.FCAPTPARTY"
						ClientValidationFunction="onValidate_FCAPCLAIM__FCAPTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id73094850183741f185465c7c8dcab180 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id73094850183741f185465c7c8dcab180 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id73094850183741f185465c7c8dcab180 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id73094850183741f185465c7c8dcab180 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id73094850183741f185465c7c8dcab180 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id73094850183741f185465c7c8dcab180 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id73094850183741f185465c7c8dcab180 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id73094850183741f185465c7c8dcab180 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id73094850183741f185465c7c8dcab180 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id73094850183741f185465c7c8dcab180 input{text-align:left;}"; break;
		}
	}
