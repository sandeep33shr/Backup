...
Namespace Nexus
    Partial Class PB2_GFIRECLM_Office_Contents : Inherits BaseClaim
		...
		Protected Sub onValidate_OFFCONTOV__COCNOTES()
        
End Sub
Protected Sub onValidate_OFFCONTOV__COCSNOTES()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_OFFCONTOV__COCNOTES()
    onValidate_OFFCONTOV__COCSNOTES()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' OFFCONTOV = The parent object name of child screen
        ' OC_CNOTE_DETAILS = The child screen object name
        
        Protected Sub OFFCONTOV__OC_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles OFFCONTOV__OC_CNOTE_DETAILS.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' OFFCONTOV = The parent object name of child screen
        ' OC_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub OFFCONTOV__OC_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles OFFCONTOV__OC_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
