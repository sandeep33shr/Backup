...
Namespace Nexus
    Partial Class PB2_CGFISNCLM_Claims_External_Notes : Inherits BaseClaim
		...
		Protected Sub onValidate_GF_SDETAILS__Note_Details()
...
Protected Sub CallRuleScripts()
    onValidate_GF_SDETAILS__Note_Details()
End Sub
