<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="GFIRECLM_Claim_Information.aspx.vb" Inherits="Nexus.PB2_GFIRECLM_Claim_Information" %>
...
function onValidate_GENERAL__IS_THRDTLS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	if (isOnLoad) {
        		...
        		var update = function(){
        			ToggleTabBasedOnClaim("10", field.getValue());	
        		};
        		events.listen(field, "change", update);
        		update();
        	}
...
function onValidate_GENERAL__NAMDECISION(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("GENERAL", "NAMDECISION");
        		var exp = new Expression("CPLCLM.IS_NAMAPP == true");
        		var errorMessage = "{1}";
        		var go = function(){
        			if (exp.getValue() == true){
...
function onValidate_GENERAL__GFTRAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "GFTRAIL", "ChildScreen");
        })();
        /** 
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__GFTRAIL(null, null, null, isOnLoad);
...
<div id="id6026b63f96944c3c82f5849e5cb43bd6" class="general-layout-container">
...
<div id="id4b13e20d75fd4fea99280f4f0725e1f6" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4b13e20d75fd4fea99280f4f0725e1f6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4b13e20d75fd4fea99280f4f0725e1f6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4b13e20d75fd4fea99280f4f0725e1f6 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4b13e20d75fd4fea99280f4f0725e1f6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4b13e20d75fd4fea99280f4f0725e1f6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4b13e20d75fd4fea99280f4f0725e1f6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4b13e20d75fd4fea99280f4f0725e1f6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4b13e20d75fd4fea99280f4f0725e1f6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4b13e20d75fd4fea99280f4f0725e1f6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4b13e20d75fd4fea99280f4f0725e1f6 input{text-align:left;}"; break;
		}
	}
...
<div id="frmClmTyp" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading5" runat="server" Text="Claim Details" /></legend>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id24da13739518400dae738b9c994e3466" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading6" runat="server" Text="Audit Trail" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__GFTRAIL"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="GFTRAIL" 
		id="pb-container-childscreen-GENERAL-GFTRAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__AUDIT" runat="server" ScreenCode="GFTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="GFTRAIL/GFTRAIL_Audit_Trail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Changed By" DataField="CHANGED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_GFTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.GFTRAIL"
						ClientValidationFunction="onValidate_GENERAL__GFTRAIL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id24da13739518400dae738b9c994e3466 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id24da13739518400dae738b9c994e3466 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id24da13739518400dae738b9c994e3466 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id24da13739518400dae738b9c994e3466 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id24da13739518400dae738b9c994e3466 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id24da13739518400dae738b9c994e3466 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id24da13739518400dae738b9c994e3466 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id24da13739518400dae738b9c994e3466 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id24da13739518400dae738b9c994e3466 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id24da13739518400dae738b9c994e3466 input{text-align:left;}"; break;
		}
	}
