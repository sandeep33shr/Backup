...
Namespace Nexus
    Partial Class PB2_GFIRECLM_Accidental_Damage : Inherits BaseClaim
		...
		Protected Sub onValidate_AD__CADENDPREM()
        
End Sub
Protected Sub onValidate_AD__ADCLMNOTES()
        
End Sub
Protected Sub onValidate_AD__ADCLMSNOTE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_AD__CADENDPREM()
    onValidate_AD__ADCLMNOTES()
    onValidate_AD__ADCLMSNOTE()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' AD = The parent object name of child screen
        ' AD_CLAUSE = The child screen object name
        
        Protected Sub AD__AD_CLAUSE_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles AD__AD_CLAUSE.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' AD = The parent object name of child screen
        ' AD_CNOTE_DETAILS = The child screen object name
        
        Protected Sub AD__AD_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles AD__AD_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' AD = The parent object name of child screen
        ' AD_SNOTE_DETAILS = The child screen object name
        
        Protected Sub AD__AD_SNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles AD__AD_SNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
