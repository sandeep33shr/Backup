...
Namespace Nexus
    Partial Class PB2_GFIRECLM_Accounts_Receivable : Inherits BaseClaim
		...
		Protected Sub onValidate_AR__CARNOTES()
        
End Sub
Protected Sub onValidate_AR__CARSNOTES()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_AR__CARNOTES()
    onValidate_AR__CARSNOTES()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' AR = The parent object name of child screen
        ' AR_CNOTE_DETAILS = The child screen object name
        
        Protected Sub AR__AR_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles AR__AR_CNOTE_DETAILS.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' AR = The parent object name of child screen
        ' AR_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub AR__AR_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles AR__AR_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
