<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="GFIRECLM_Notes.aspx.vb" Inherits="Nexus.PB2_GFIRECLM_Notes" %>
...
function onValidate_GENERAL__CGFINCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CGFINCLM", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GENERAL", "CGFINCLM");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_GENERAL__CGFINCLM table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GENERAL", "CGFINCLM");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'GENERAL' and property 'CGFINCLM'.");
        			error.display();
...
function onValidate_GENERAL__CGFISNCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CGFISNCLM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_GENERAL__CGFINCLM(null, null, null, isOnLoad);
    onValidate_GENERAL__CGFISNCLM(null, null, null, isOnLoad);
}
</script>
...
<div id="id18be75dc879c44809f2b2188fef4492f" class="general-layout-container">
...
<div id="id7b28265702f34d6c8e6a5fdd060174a8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading163" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CGFINCLM"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CGFINCLM" 
		id="pb-container-childscreen-GENERAL-CGFINCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__GF_DETAILS" runat="server" ScreenCode="CGFINCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CGFINCLM/CGFINCLM_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_CGFINCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_GENERAL__CGFINCLM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7b28265702f34d6c8e6a5fdd060174a8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7b28265702f34d6c8e6a5fdd060174a8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7b28265702f34d6c8e6a5fdd060174a8 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7b28265702f34d6c8e6a5fdd060174a8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7b28265702f34d6c8e6a5fdd060174a8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7b28265702f34d6c8e6a5fdd060174a8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7b28265702f34d6c8e6a5fdd060174a8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7b28265702f34d6c8e6a5fdd060174a8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7b28265702f34d6c8e6a5fdd060174a8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7b28265702f34d6c8e6a5fdd060174a8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id12bfd1e0410e4bd585ed90d4fa027b8c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading164" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CGFISNCLM"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CGFISNCLM" 
		id="pb-container-childscreen-GENERAL-CGFISNCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__GF_SDETAILS" runat="server" ScreenCode="CGFISNCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CGFISNCLM/CGFISNCLM_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_CGFISNCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_GENERAL__CGFISNCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id12bfd1e0410e4bd585ed90d4fa027b8c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id12bfd1e0410e4bd585ed90d4fa027b8c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id12bfd1e0410e4bd585ed90d4fa027b8c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id12bfd1e0410e4bd585ed90d4fa027b8c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id12bfd1e0410e4bd585ed90d4fa027b8c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id12bfd1e0410e4bd585ed90d4fa027b8c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id12bfd1e0410e4bd585ed90d4fa027b8c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id12bfd1e0410e4bd585ed90d4fa027b8c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id12bfd1e0410e4bd585ed90d4fa027b8c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id12bfd1e0410e4bd585ed90d4fa027b8c input{text-align:left;}"; break;
		}
	}
