...
Namespace Nexus
    Partial Class PB2_GFIRECLM_Risk_Selection : Inherits BaseClaim
		...
		Protected Sub onValidate_RISK_SELECTION__CBLCKSCRN()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RISK_SELECTION__CBLCKSCRN()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RISK_SELECTION = The parent object name of child screen
        ' BLCKR_ITEM = The child screen object name
        
        Protected Sub RISK_SELECTION__BLCKR_ITEM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISK_SELECTION__BLCKR_ITEM.RowDataBound
