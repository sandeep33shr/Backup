<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="GFIRECLM_Accounts_Receivable.aspx.vb" Inherits="Nexus.PB2_GFIRECLM_Accounts_Receivable" %>
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AR", "AGG_DESCRIPTION");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AR_EXTENSIONS", "IS_ACPC");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AR_EXTENSIONS", "IS_RIOT");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AR_EXTENSIONS", "IS_DUP_REC");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AR_EXTENSIONS", "IS_PROTECT");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("AR_EXTENSIONS", "IS_TRANSIT");
        		}
        		//window.setProperty(field, "V", "{1}", "{2}", "{3}");
...
function onValidate_AR__CARENDPREM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AR", "CARENDPREM", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("AR", "CARENDPREM");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'AR' and property 'CARENDPREM'.");
        			error.display();
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_AR__CARENDPREM table td a");
...
function onValidate_AR__CARNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AR", "CARNOTES", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param AR The object name of the control to set.
         * @parma AR_CNOTE_DETAILS The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=AR__AR_CNOTE_DETAILS.ClientID %>').find('table').find('tr').each(function () {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Select".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("AR", "CARNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_AR__CARNOTES table td a");
...
function onValidate_AR__CARSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AR", "CARSNOTES", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param AR The object name of the control to set.
         * @parma AR_SCNOTE_DETAILS The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=AR__AR_SCNOTE_DETAILS.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var oldLinkCaption = "Select".toLowerCase();
        		var newLinkCaption = "View";
        		var field = Field.getInstance("AR", "CARSNOTES");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_AR__CARSNOTES table td a");
...
function DoLogic(isOnLoad) {
    ...
    onValidate_AR__CARENDPREM(null, null, null, isOnLoad);
    onValidate_AR__CARNOTES(null, null, null, isOnLoad);
    onValidate_AR__CARSNOTES(null, null, null, isOnLoad);
...
<div id="id71ea32ba0c31459aa8a0718c31c118fb" class="general-layout-container">
...
<div id="id7d8a3b0be74f4967919462b4b94806d0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading125" runat="server" Text="" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7d8a3b0be74f4967919462b4b94806d0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7d8a3b0be74f4967919462b4b94806d0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7d8a3b0be74f4967919462b4b94806d0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7d8a3b0be74f4967919462b4b94806d0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7d8a3b0be74f4967919462b4b94806d0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7d8a3b0be74f4967919462b4b94806d0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7d8a3b0be74f4967919462b4b94806d0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7d8a3b0be74f4967919462b4b94806d0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7d8a3b0be74f4967919462b4b94806d0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7d8a3b0be74f4967919462b4b94806d0 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id60e3b6a72e8c49d4913b710c56d90fd2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading126" runat="server" Text="Aggregate" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id60e3b6a72e8c49d4913b710c56d90fd2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id60e3b6a72e8c49d4913b710c56d90fd2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id60e3b6a72e8c49d4913b710c56d90fd2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id60e3b6a72e8c49d4913b710c56d90fd2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id60e3b6a72e8c49d4913b710c56d90fd2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60e3b6a72e8c49d4913b710c56d90fd2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60e3b6a72e8c49d4913b710c56d90fd2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id60e3b6a72e8c49d4913b710c56d90fd2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id60e3b6a72e8c49d4913b710c56d90fd2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id60e3b6a72e8c49d4913b710c56d90fd2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id10252774849240b8a12adf831de5e0b6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading127" runat="server" Text="Outstanding Debit Balances" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id10252774849240b8a12adf831de5e0b6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id10252774849240b8a12adf831de5e0b6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id10252774849240b8a12adf831de5e0b6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id10252774849240b8a12adf831de5e0b6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id10252774849240b8a12adf831de5e0b6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id10252774849240b8a12adf831de5e0b6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id10252774849240b8a12adf831de5e0b6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id10252774849240b8a12adf831de5e0b6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id10252774849240b8a12adf831de5e0b6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id10252774849240b8a12adf831de5e0b6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id0f9377f642254eda8f59955c2f1062d2" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading128" runat="server" Text="First Amount Payable" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id0f9377f642254eda8f59955c2f1062d2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id0f9377f642254eda8f59955c2f1062d2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id0f9377f642254eda8f59955c2f1062d2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id0f9377f642254eda8f59955c2f1062d2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id0f9377f642254eda8f59955c2f1062d2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f9377f642254eda8f59955c2f1062d2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f9377f642254eda8f59955c2f1062d2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id0f9377f642254eda8f59955c2f1062d2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id0f9377f642254eda8f59955c2f1062d2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id0f9377f642254eda8f59955c2f1062d2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idbab4c5199a20494ab8409c54c75fb61c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading129" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label354">
		<span class="label" id="label354">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label355">
		<span class="label" id="label355">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label356">
		<span class="label" id="label356">Minimum Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label357">
		<span class="label" id="label357">Additonal Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label360">
		<span class="label" id="label360">Riot & Strike</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label362">
		<span class="label" id="label362">Duplicate Records</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label366">
		<span class="label" id="label366">Protections</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label370">
		<span class="label" id="label370">Transit</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idbab4c5199a20494ab8409c54c75fb61c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbab4c5199a20494ab8409c54c75fb61c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbab4c5199a20494ab8409c54c75fb61c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idbab4c5199a20494ab8409c54c75fb61c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbab4c5199a20494ab8409c54c75fb61c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbab4c5199a20494ab8409c54c75fb61c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbab4c5199a20494ab8409c54c75fb61c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbab4c5199a20494ab8409c54c75fb61c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbab4c5199a20494ab8409c54c75fb61c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbab4c5199a20494ab8409c54c75fb61c input{text-align:left;}"; break;
		}
	}
...
<div id="frmClauses" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading130" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_AR__CARENDPREM"
		data-field-type="Child" 
		data-object-name="AR" 
		data-property-name="CARENDPREM" 
		id="pb-container-childscreen-AR-CARENDPREM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AR__AR_CLAUSE" runat="server" ScreenCode="CARENDPREM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARENDPREM/CARENDPREM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valAR_CARENDPREM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for AR.CARENDPREM"
						ClientValidationFunction="onValidate_AR__CARENDPREM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6c495377e3584e338509cb7a5051be8b" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_AR__CARNOTES"
		data-field-type="Child" 
		data-object-name="AR" 
		data-property-name="CARNOTES" 
		id="pb-container-childscreen-AR-CARNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AR__AR_CNOTE_DETAILS" runat="server" ScreenCode="CARNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARNOTES/CARNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valAR_CARNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for AR.CARNOTES"
						ClientValidationFunction="onValidate_AR__CARNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6c495377e3584e338509cb7a5051be8b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6c495377e3584e338509cb7a5051be8b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6c495377e3584e338509cb7a5051be8b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6c495377e3584e338509cb7a5051be8b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6c495377e3584e338509cb7a5051be8b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c495377e3584e338509cb7a5051be8b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c495377e3584e338509cb7a5051be8b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6c495377e3584e338509cb7a5051be8b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6c495377e3584e338509cb7a5051be8b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6c495377e3584e338509cb7a5051be8b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf80259fdcbb84e8eb64bb9f1652a4447" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading132" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_AR__CARSNOTES"
		data-field-type="Child" 
		data-object-name="AR" 
		data-property-name="CARSNOTES" 
		id="pb-container-childscreen-AR-CARSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AR__AR_SCNOTE_DETAILS" runat="server" ScreenCode="CARSNOTES" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CARSNOTES/CARSNOTES_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valAR_CARSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for AR.CARSNOTES"
						ClientValidationFunction="onValidate_AR__CARSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf80259fdcbb84e8eb64bb9f1652a4447 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf80259fdcbb84e8eb64bb9f1652a4447 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf80259fdcbb84e8eb64bb9f1652a4447 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf80259fdcbb84e8eb64bb9f1652a4447 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf80259fdcbb84e8eb64bb9f1652a4447 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf80259fdcbb84e8eb64bb9f1652a4447 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf80259fdcbb84e8eb64bb9f1652a4447 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf80259fdcbb84e8eb64bb9f1652a4447 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf80259fdcbb84e8eb64bb9f1652a4447 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf80259fdcbb84e8eb64bb9f1652a4447 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1cfbfd3a1e05494c90471b971090f5b3" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading133" runat="server" Text="Reinsurance Exposure" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label375">
		<span class="label" id="label375">Total Sum Insured</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label376">
		<span class="label" id="label376">Target Risk SI</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label377">
		<span class="label" id="label377">MPL %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label378">
		<span class="label" id="label378">RI Exposure</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label379">
		<span class="label" id="label379">Outstanding Debit Balances</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label380">
		<span class="label" id="label380">Additional Claim Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Currency -->
	...
	<span id="pb-container-label-label381">
		<span class="label" id="label381">Total RI Exposure</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id1cfbfd3a1e05494c90471b971090f5b3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1cfbfd3a1e05494c90471b971090f5b3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1cfbfd3a1e05494c90471b971090f5b3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1cfbfd3a1e05494c90471b971090f5b3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1cfbfd3a1e05494c90471b971090f5b3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1cfbfd3a1e05494c90471b971090f5b3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1cfbfd3a1e05494c90471b971090f5b3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1cfbfd3a1e05494c90471b971090f5b3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1cfbfd3a1e05494c90471b971090f5b3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1cfbfd3a1e05494c90471b971090f5b3 input{text-align:left;}"; break;
		}
	}
