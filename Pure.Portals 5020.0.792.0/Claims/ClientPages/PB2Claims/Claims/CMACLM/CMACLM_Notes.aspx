<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMACLM_Notes.aspx.vb" Inherits="Nexus.PB2_CMACLM_Notes" %>
...
function onValidate_CMALIABCLM__CLNCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMALIABCLM", "CLNCLM", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CMALIABCLM", "CLNCLM");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_CMALIABCLM__CLNCLM table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CMALIABCLM", "CLNCLM");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CMALIABCLM' and property 'CLNCLM'.");
        			error.display();
...
function onValidate_CMALIABCLM__CLENCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMALIABCLM", "CLENCLM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CMALIABCLM__CLNCLM(null, null, null, isOnLoad);
    onValidate_CMALIABCLM__CLENCLM(null, null, null, isOnLoad);
}
</script>
...
<div id="id4b3442821c9741aca8c1ab2f5a084d0e" class="general-layout-container">
...
<div id="ida23340705c3a44f7a2098b9989e2f364" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading135" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CMALIABCLM__CLNCLM"
		data-field-type="Child" 
		data-object-name="CMALIABCLM" 
		data-property-name="CLNCLM" 
		id="pb-container-childscreen-CMALIABCLM-CLNCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CMALIABCLM__CNOTE_DETAILS" runat="server" ScreenCode="CLNCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLNCLM/CLNCLM_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCMALIABCLM_CLNCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_CMALIABCLM__CLNCLM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida23340705c3a44f7a2098b9989e2f364 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida23340705c3a44f7a2098b9989e2f364 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida23340705c3a44f7a2098b9989e2f364 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida23340705c3a44f7a2098b9989e2f364 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida23340705c3a44f7a2098b9989e2f364 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida23340705c3a44f7a2098b9989e2f364 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida23340705c3a44f7a2098b9989e2f364 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida23340705c3a44f7a2098b9989e2f364 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida23340705c3a44f7a2098b9989e2f364 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida23340705c3a44f7a2098b9989e2f364 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf51492afd4584114b17ac0ca3a5e6170" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading136" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CMALIABCLM__CLENCLM"
		data-field-type="Child" 
		data-object-name="CMALIABCLM" 
		data-property-name="CLENCLM" 
		id="pb-container-childscreen-CMALIABCLM-CLENCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CMALIABCLM__EXT_DETAILS" runat="server" ScreenCode="CLENCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLENCLM/CLENCLM_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCMALIABCLM_CLENCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_CMALIABCLM__CLENCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf51492afd4584114b17ac0ca3a5e6170 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf51492afd4584114b17ac0ca3a5e6170 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf51492afd4584114b17ac0ca3a5e6170 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf51492afd4584114b17ac0ca3a5e6170 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf51492afd4584114b17ac0ca3a5e6170 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf51492afd4584114b17ac0ca3a5e6170 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf51492afd4584114b17ac0ca3a5e6170 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf51492afd4584114b17ac0ca3a5e6170 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf51492afd4584114b17ac0ca3a5e6170 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf51492afd4584114b17ac0ca3a5e6170 input{text-align:left;}"; break;
		}
	}
