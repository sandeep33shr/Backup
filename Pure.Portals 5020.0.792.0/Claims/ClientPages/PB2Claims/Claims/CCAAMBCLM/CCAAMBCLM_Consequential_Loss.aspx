<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAAMBCLM_Consequential_Loss.aspx.vb" Inherits="Nexus.PB2_CCAAMBCLM_Consequential_Loss" %>
...
function onValidate_CLOSS__AMBCEPCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "AMBCEPCLM", "ChildScreen");
        })();
        /** 
...
function onValidate_CLOSS__AMBCLNTSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "AMBCLNTSCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param CLOSS The object name of the control to set.
...
function onValidate_CLOSS__AMBCLSNTSC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "AMBCLSNTSC", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param CLOSS The object name of the control to set.
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CLOSS__AMBCEPCLM(null, null, null, isOnLoad);
    onValidate_CLOSS__AMBCLNTSCL(null, null, null, isOnLoad);
    onValidate_CLOSS__AMBCLSNTSC(null, null, null, isOnLoad);
}
</script>
...
<div id="idc0d458fce99143ca807444f6b6961e0f" class="general-layout-container">
...
<div id="idb1c96898a4264deba5de64a651887b80" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb1c96898a4264deba5de64a651887b80 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb1c96898a4264deba5de64a651887b80 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb1c96898a4264deba5de64a651887b80 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb1c96898a4264deba5de64a651887b80 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb1c96898a4264deba5de64a651887b80 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb1c96898a4264deba5de64a651887b80 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb1c96898a4264deba5de64a651887b80 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb1c96898a4264deba5de64a651887b80 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb1c96898a4264deba5de64a651887b80 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb1c96898a4264deba5de64a651887b80 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide0adf49dff034aff8418803bc84eba30" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading49" runat="server" Text="Consequential Loss " /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide0adf49dff034aff8418803bc84eba30 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide0adf49dff034aff8418803bc84eba30 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide0adf49dff034aff8418803bc84eba30 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide0adf49dff034aff8418803bc84eba30 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide0adf49dff034aff8418803bc84eba30 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide0adf49dff034aff8418803bc84eba30 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide0adf49dff034aff8418803bc84eba30 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide0adf49dff034aff8418803bc84eba30 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide0adf49dff034aff8418803bc84eba30 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide0adf49dff034aff8418803bc84eba30 input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__AMBCEPCLM"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="AMBCEPCLM" 
		id="pb-container-childscreen-CLOSS-AMBCEPCLM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_CLAUSEPREM" runat="server" ScreenCode="AMBCEPCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="AMBCEPCLM/AMBCEPCLM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valCLOSS_AMBCEPCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.AMBCEPCLM"
						ClientValidationFunction="onValidate_CLOSS__AMBCEPCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div id="frmCLNotes" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading53" runat="server" Text="Consequential Loss Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__AMBCLNTSCL"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="AMBCLNTSCL" 
		id="pb-container-childscreen-CLOSS-AMBCLNTSCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_NOTES" runat="server" ScreenCode="AMBCLNTSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="AMBCLNTSCL/AMBCLNTSCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCLOSS_AMBCLNTSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.AMBCLNTSCL"
						ClientValidationFunction="onValidate_CLOSS__AMBCLNTSCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div id="frmCLSNotes" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading54" runat="server" Text="Consequential Loss Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__AMBCLSNTSC"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="AMBCLSNTSC" 
		id="pb-container-childscreen-CLOSS-AMBCLSNTSC">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_SNOTES" runat="server" ScreenCode="AMBCLSNTSC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="AMBCLSNTSC/AMBCLSNTSC_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCLOSS_AMBCLSNTSC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.AMBCLSNTSC"
						ClientValidationFunction="onValidate_CLOSS__AMBCLSNTSC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
