...
Namespace Nexus
    Partial Class PB2_CAMBITMCL_Machinery_Breakdown_Item_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_MB_ITEM__CAMBITMPC()
        
End Sub
Protected Sub onValidate_MB_ITEM__CAMBITMNTC()
        
End Sub
Protected Sub onValidate_MB_ITEM__CAMITMSNTC()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MB_ITEM__CAMBITMPC()
    onValidate_MB_ITEM__CAMBITMNTC()
    onValidate_MB_ITEM__CAMITMSNTC()
End Sub
