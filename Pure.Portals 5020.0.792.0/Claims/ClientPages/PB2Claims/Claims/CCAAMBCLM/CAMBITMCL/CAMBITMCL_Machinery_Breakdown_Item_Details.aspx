<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CAMBITMCL_Machinery_Breakdown_Item_Details.aspx.vb" Inherits="Nexus.PB2_CAMBITMCL_Machinery_Breakdown_Item_Details" %>
...
function onValidate_MB_ITEM__CAMBITMPC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "CAMBITMPC", "ChildScreen");
        })();
        /** 
...
function onValidate_MB_ITEM__CAMBITMNTC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "CAMBITMNTC", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MB_ITEM The object name of the control to set.
...
function onValidate_MB_ITEM__CAMITMSNTC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "CAMITMSNTC", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MB_ITEM The object name of the control to set.
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MB_ITEM__CAMBITMPC(null, null, null, isOnLoad);
    onValidate_MB_ITEM__CAMBITMNTC(null, null, null, isOnLoad);
    onValidate_MB_ITEM__CAMITMSNTC(null, null, null, isOnLoad);
}
</script>
...
<div id="idb656daba8f42428d967aad31674a79f1" class="general-layout-container">
...
<div id="id91f09cd63e3a46a688d6a588ba553eb4" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id91f09cd63e3a46a688d6a588ba553eb4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id91f09cd63e3a46a688d6a588ba553eb4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id91f09cd63e3a46a688d6a588ba553eb4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id91f09cd63e3a46a688d6a588ba553eb4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id91f09cd63e3a46a688d6a588ba553eb4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id91f09cd63e3a46a688d6a588ba553eb4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id91f09cd63e3a46a688d6a588ba553eb4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id91f09cd63e3a46a688d6a588ba553eb4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id91f09cd63e3a46a688d6a588ba553eb4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id91f09cd63e3a46a688d6a588ba553eb4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide0e217e5a2ac4e67824daa6eb71e4907" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__CAMBITMPC"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="CAMBITMPC" 
		id="pb-container-childscreen-MB_ITEM-CAMBITMPC">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_CLAUSEPREM" runat="server" ScreenCode="CAMBITMPC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMBITMPC/CAMBITMPC_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valMB_ITEM_CAMBITMPC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.CAMBITMPC"
						ClientValidationFunction="onValidate_MB_ITEM__CAMBITMPC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide0e217e5a2ac4e67824daa6eb71e4907 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide0e217e5a2ac4e67824daa6eb71e4907 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide0e217e5a2ac4e67824daa6eb71e4907 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide0e217e5a2ac4e67824daa6eb71e4907 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide0e217e5a2ac4e67824daa6eb71e4907 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide0e217e5a2ac4e67824daa6eb71e4907 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide0e217e5a2ac4e67824daa6eb71e4907 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide0e217e5a2ac4e67824daa6eb71e4907 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide0e217e5a2ac4e67824daa6eb71e4907 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide0e217e5a2ac4e67824daa6eb71e4907 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4185b411294f4d3bbbc77c284cce67cc" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__CAMBITMNTC"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="CAMBITMNTC" 
		id="pb-container-childscreen-MB_ITEM-CAMBITMNTC">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_CNOTE" runat="server" ScreenCode="CAMBITMNTC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMBITMNTC/CAMBITMNTC_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_CAMBITMNTC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.CAMBITMNTC"
						ClientValidationFunction="onValidate_MB_ITEM__CAMBITMNTC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4185b411294f4d3bbbc77c284cce67cc div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4185b411294f4d3bbbc77c284cce67cc div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4185b411294f4d3bbbc77c284cce67cc div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4185b411294f4d3bbbc77c284cce67cc label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4185b411294f4d3bbbc77c284cce67cc label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4185b411294f4d3bbbc77c284cce67cc label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4185b411294f4d3bbbc77c284cce67cc label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4185b411294f4d3bbbc77c284cce67cc input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4185b411294f4d3bbbc77c284cce67cc input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4185b411294f4d3bbbc77c284cce67cc input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd3dfe88fd9f7440fa3b6a4675b2598f1" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__CAMITMSNTC"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="CAMITMSNTC" 
		id="pb-container-childscreen-MB_ITEM-CAMITMSNTC">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_SCNOTE" runat="server" ScreenCode="CAMITMSNTC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMITMSNTC/CAMITMSNTC_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_CAMITMSNTC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.CAMITMSNTC"
						ClientValidationFunction="onValidate_MB_ITEM__CAMITMSNTC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd3dfe88fd9f7440fa3b6a4675b2598f1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd3dfe88fd9f7440fa3b6a4675b2598f1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd3dfe88fd9f7440fa3b6a4675b2598f1 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd3dfe88fd9f7440fa3b6a4675b2598f1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd3dfe88fd9f7440fa3b6a4675b2598f1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd3dfe88fd9f7440fa3b6a4675b2598f1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd3dfe88fd9f7440fa3b6a4675b2598f1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd3dfe88fd9f7440fa3b6a4675b2598f1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd3dfe88fd9f7440fa3b6a4675b2598f1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd3dfe88fd9f7440fa3b6a4675b2598f1 input{text-align:left;}"; break;
		}
	}
