<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAAMBCLM_Claim_Notes.aspx.vb" Inherits="Nexus.PB2_CCAAMBCLM_Claim_Notes" %>
...
function onValidate_GENERAL__CAAMCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CAAMCNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GENERAL", "CAAMCNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_GENERAL__CAAMCNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("GENERAL", "CAAMCNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'GENERAL' and property 'CAAMCNOTE'.");
        			error.display();
...
function onValidate_GENERAL__CAAMSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CAAMSNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_GENERAL__CAAMCNOTE(null, null, null, isOnLoad);
    onValidate_GENERAL__CAAMSNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id2cf9a7275f1643a68f8be0963c215e93" class="general-layout-container">
...
<div id="id1ad302470ce04f0384fd07fa2bdaa9d0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading96" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CAAMCNOTE"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CAAMCNOTE" 
		id="pb-container-childscreen-GENERAL-CAAMCNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__INT_DETAILS" runat="server" ScreenCode="CAAMCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAAMCNOTE/CAAMCNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_CAAMCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_GENERAL__CAAMCNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1ad302470ce04f0384fd07fa2bdaa9d0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1ad302470ce04f0384fd07fa2bdaa9d0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1ad302470ce04f0384fd07fa2bdaa9d0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1ad302470ce04f0384fd07fa2bdaa9d0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1ad302470ce04f0384fd07fa2bdaa9d0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1ad302470ce04f0384fd07fa2bdaa9d0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1ad302470ce04f0384fd07fa2bdaa9d0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1ad302470ce04f0384fd07fa2bdaa9d0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1ad302470ce04f0384fd07fa2bdaa9d0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1ad302470ce04f0384fd07fa2bdaa9d0 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id835000cb118f41adb2c93da5acc58fe8" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading97" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CAAMSNOTE"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CAAMSNOTE" 
		id="pb-container-childscreen-GENERAL-CAAMSNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__EXT_DETAILS" runat="server" ScreenCode="CAAMSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAAMSNOTE/CAAMSNOTE_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_CAAMSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_GENERAL__CAAMSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id835000cb118f41adb2c93da5acc58fe8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id835000cb118f41adb2c93da5acc58fe8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id835000cb118f41adb2c93da5acc58fe8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id835000cb118f41adb2c93da5acc58fe8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id835000cb118f41adb2c93da5acc58fe8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id835000cb118f41adb2c93da5acc58fe8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id835000cb118f41adb2c93da5acc58fe8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id835000cb118f41adb2c93da5acc58fe8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id835000cb118f41adb2c93da5acc58fe8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id835000cb118f41adb2c93da5acc58fe8 input{text-align:left;}"; break;
		}
	}
