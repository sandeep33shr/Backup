...
Namespace Nexus
    Partial Class PB2_CCAAMBCLM_Consequential_Loss : Inherits BaseClaim
		...
		Protected Sub onValidate_CLOSS__AMBCEPCLM()
        
End Sub
Protected Sub onValidate_CLOSS__AMBCLNTSCL()
        
End Sub
Protected Sub onValidate_CLOSS__AMBCLSNTSC()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CLOSS__AMBCEPCLM()
    onValidate_CLOSS__AMBCLNTSCL()
    onValidate_CLOSS__AMBCLSNTSC()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CLOSS = The parent object name of child screen
        ' CL_CLAUSEPREM = The child screen object name
        
        Protected Sub CLOSS__CL_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CLOSS__CL_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CLOSS = The parent object name of child screen
        ' CL_NOTES = The child screen object name
        
        Protected Sub CLOSS__CL_NOTES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CLOSS__CL_NOTES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CLOSS = The parent object name of child screen
        ' CL_SNOTES = The child screen object name
        
        Protected Sub CLOSS__CL_SNOTES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CLOSS__CL_SNOTES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
