<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAAMBCLM_Machinery_Breakdown.aspx.vb" Inherits="Nexus.PB2_CCAAMBCLM_Machinery_Breakdown" %>
...
function onValidate_MBREAK__CAMBITMCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CAMBITMCL", "ChildScreen");
        })();
        /** 
...
function onValidate_MBREAK__CAMBOTXTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CAMBOTXTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function onValidate_MBREAK__CAMBFAPCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CAMBFAPCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function onValidate_MBREAK__CAMBEPCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CAMBEPCLM", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function onValidate_MBREAK__CAMBNTSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CAMBNTSCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function onValidate_MBREAK__CAMBSNTSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "CAMBSNTSCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MBREAK__CAMBITMCL(null, null, null, isOnLoad);
    ...
    onValidate_MBREAK__CAMBOTXTCL(null, null, null, isOnLoad);
    onValidate_MBREAK__CAMBFAPCL(null, null, null, isOnLoad);
    onValidate_MBREAK__CAMBEPCLM(null, null, null, isOnLoad);
    onValidate_MBREAK__CAMBNTSCL(null, null, null, isOnLoad);
    onValidate_MBREAK__CAMBSNTSCL(null, null, null, isOnLoad);
}
</script>
...
<div id="id50ef4e92994d422c84de9fae0aa44057" class="general-layout-container">
...
<div id="idc29bd13e7b9c454488af03fd1eec3425" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc29bd13e7b9c454488af03fd1eec3425 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc29bd13e7b9c454488af03fd1eec3425 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc29bd13e7b9c454488af03fd1eec3425 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc29bd13e7b9c454488af03fd1eec3425 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc29bd13e7b9c454488af03fd1eec3425 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc29bd13e7b9c454488af03fd1eec3425 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc29bd13e7b9c454488af03fd1eec3425 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc29bd13e7b9c454488af03fd1eec3425 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc29bd13e7b9c454488af03fd1eec3425 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc29bd13e7b9c454488af03fd1eec3425 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id306aade4c39b45749c57b200000f3991" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading33" runat="server" Text="Machinery Breakdown" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id306aade4c39b45749c57b200000f3991 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id306aade4c39b45749c57b200000f3991 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id306aade4c39b45749c57b200000f3991 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id306aade4c39b45749c57b200000f3991 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id306aade4c39b45749c57b200000f3991 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id306aade4c39b45749c57b200000f3991 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id306aade4c39b45749c57b200000f3991 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id306aade4c39b45749c57b200000f3991 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id306aade4c39b45749c57b200000f3991 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id306aade4c39b45749c57b200000f3991 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id22cc2e7c28894f3bb7bb2c8591a4c92b" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CAMBITMCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CAMBITMCL" 
		id="pb-container-childscreen-MBREAK-CAMBITMCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_ITEM" runat="server" ScreenCode="CAMBITMCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMBITMCL/CAMBITMCL_Machinery_Breakdown_Item_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:GISLookupField HeaderText="Basis of Deductible " ListType="PMLookup" ListCode="UDL_CMA_MBCL_BOD" DataField="BASEDEDUCT" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valMBREAK_CAMBITMCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.CAMBITMCL"
						ClientValidationFunction="onValidate_MBREAK__CAMBITMCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id22cc2e7c28894f3bb7bb2c8591a4c92b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id22cc2e7c28894f3bb7bb2c8591a4c92b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id22cc2e7c28894f3bb7bb2c8591a4c92b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id22cc2e7c28894f3bb7bb2c8591a4c92b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id22cc2e7c28894f3bb7bb2c8591a4c92b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id22cc2e7c28894f3bb7bb2c8591a4c92b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id22cc2e7c28894f3bb7bb2c8591a4c92b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id22cc2e7c28894f3bb7bb2c8591a4c92b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id22cc2e7c28894f3bb7bb2c8591a4c92b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id22cc2e7c28894f3bb7bb2c8591a4c92b input{text-align:left;}"; break;
		}
	}
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CAMBOTXTCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CAMBOTXTCL" 
		id="pb-container-childscreen-MBREAK-CAMBOTXTCL">
		
		    <legend>Other Machinery Breakdown Extensions</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_OEXTENSIONS" runat="server" ScreenCode="CAMBOTXTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMBOTXTCL/CAMBOTXTCL_Other_Machinery_Breakdown_Extensions.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_CAMBOTXTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Other Machinery Breakdown Extensions"
						ClientValidationFunction="onValidate_MBREAK__CAMBOTXTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id402a5ee6b79449728bb3235645e940d8" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CAMBFAPCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CAMBFAPCL" 
		id="pb-container-childscreen-MBREAK-CAMBFAPCL">
		
		    <legend>First Amount Payable </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_FAP" runat="server" ScreenCode="CAMBFAPCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMBFAPCL/CAMBFAPCL_First_Amount_Payable.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="FAPCHILD_MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_CAMBFAPCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for First Amount Payable "
						ClientValidationFunction="onValidate_MBREAK__CAMBFAPCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id402a5ee6b79449728bb3235645e940d8 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id402a5ee6b79449728bb3235645e940d8 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id402a5ee6b79449728bb3235645e940d8 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id402a5ee6b79449728bb3235645e940d8 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id402a5ee6b79449728bb3235645e940d8 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id402a5ee6b79449728bb3235645e940d8 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id402a5ee6b79449728bb3235645e940d8 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id402a5ee6b79449728bb3235645e940d8 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id402a5ee6b79449728bb3235645e940d8 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id402a5ee6b79449728bb3235645e940d8 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id010090c05e8548a69cde27bb0af5229e" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CAMBEPCLM"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CAMBEPCLM" 
		id="pb-container-childscreen-MBREAK-CAMBEPCLM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_CLAUSEPREM" runat="server" ScreenCode="CAMBEPCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMBEPCLM/CAMBEPCLM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valMBREAK_CAMBEPCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.CAMBEPCLM"
						ClientValidationFunction="onValidate_MBREAK__CAMBEPCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id010090c05e8548a69cde27bb0af5229e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id010090c05e8548a69cde27bb0af5229e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id010090c05e8548a69cde27bb0af5229e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id010090c05e8548a69cde27bb0af5229e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id010090c05e8548a69cde27bb0af5229e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id010090c05e8548a69cde27bb0af5229e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id010090c05e8548a69cde27bb0af5229e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id010090c05e8548a69cde27bb0af5229e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id010090c05e8548a69cde27bb0af5229e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id010090c05e8548a69cde27bb0af5229e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading39" runat="server" Text="Machinery Breakdown Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CAMBNTSCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CAMBNTSCL" 
		id="pb-container-childscreen-MBREAK-CAMBNTSCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_NOTES" runat="server" ScreenCode="CAMBNTSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMBNTSCL/CAMBNTSCL_Machinery_Breakdown_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_CAMBNTSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.CAMBNTSCL"
						ClientValidationFunction="onValidate_MBREAK__CAMBNTSCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1c4fbaf10b0a4cd2b8f2fbd5e1bb52f4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id849780fd127b4c288325f2787d04178c" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading40" runat="server" Text="Machinery Breakdown Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__CAMBSNTSCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="CAMBSNTSCL" 
		id="pb-container-childscreen-MBREAK-CAMBSNTSCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_SNOTES" runat="server" ScreenCode="CAMBSNTSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CAMBSNTSCL/CAMBSNTSCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_CAMBSNTSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.CAMBSNTSCL"
						ClientValidationFunction="onValidate_MBREAK__CAMBSNTSCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id849780fd127b4c288325f2787d04178c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id849780fd127b4c288325f2787d04178c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id849780fd127b4c288325f2787d04178c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id849780fd127b4c288325f2787d04178c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id849780fd127b4c288325f2787d04178c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id849780fd127b4c288325f2787d04178c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id849780fd127b4c288325f2787d04178c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id849780fd127b4c288325f2787d04178c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id849780fd127b4c288325f2787d04178c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id849780fd127b4c288325f2787d04178c input{text-align:left;}"; break;
		}
	}
