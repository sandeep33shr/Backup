...
Namespace Nexus
    Partial Class PB2_CCAAMBCLM_Machinery_Breakdown : Inherits BaseClaim
		...
		Protected Sub onValidate_MBREAK__CAMBITMCL()
        
End Sub
Protected Sub onValidate_MBREAK__CAMBOTXTCL()
        
End Sub
Protected Sub onValidate_MBREAK__CAMBFAPCL()
        
End Sub
Protected Sub onValidate_MBREAK__CAMBEPCLM()
        
End Sub
Protected Sub onValidate_MBREAK__CAMBNTSCL()
        
End Sub
Protected Sub onValidate_MBREAK__CAMBSNTSCL()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MBREAK__CAMBITMCL()
    onValidate_MBREAK__CAMBOTXTCL()
    onValidate_MBREAK__CAMBFAPCL()
    onValidate_MBREAK__CAMBEPCLM()
    onValidate_MBREAK__CAMBNTSCL()
    onValidate_MBREAK__CAMBSNTSCL()
End Sub
