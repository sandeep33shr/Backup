...
Namespace Nexus
    Partial Class PB2_AMBDSITMCL_Deterioration_of_Stock_Items_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_DS_ITEM__AMBDSIEPC()
        
End Sub
Protected Sub onValidate_DS_ITEM__AMBDSINTSC()
        
End Sub
Protected Sub onValidate_DS_ITEM__ABDSISNTSC()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DS_ITEM__AMBDSIEPC()
    onValidate_DS_ITEM__AMBDSINTSC()
    onValidate_DS_ITEM__ABDSISNTSC()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' DS_ITEM = The parent object name of child screen
        ' DSITEM_CLAUSEPREM = The child screen object name
        
        Protected Sub DS_ITEM__DSITEM_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles DS_ITEM__DSITEM_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' DS_ITEM = The parent object name of child screen
        ' DSITEM_NOTES = The child screen object name
        
        Protected Sub DS_ITEM__DSITEM_NOTES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles DS_ITEM__DSITEM_NOTES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' DS_ITEM = The parent object name of child screen
        ' DSITEM_SNOTES = The child screen object name
        
        Protected Sub DS_ITEM__DSITEM_SNOTES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles DS_ITEM__DSITEM_SNOTES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
