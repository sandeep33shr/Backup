<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAAMBCLM_Claim_Information.aspx.vb" Inherits="Nexus.PB2_CCAAMBCLM_Claim_Information" %>
...
function onValidate_GENERAL__AMBTRAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "AMBTRAIL", "ChildScreen");
        })();
        /** 
...
function DoLogic(isOnLoad) {
    ...
    onValidate_GENERAL__AMBTRAIL(null, null, null, isOnLoad);
...
<div id="id1c34c391cb5f46349d8793d257ccc670" class="general-layout-container">
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf622d87c3a51460cbe0b2c23fc8a121c" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__AMBTRAIL"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="AMBTRAIL" 
		id="pb-container-childscreen-GENERAL-AMBTRAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__AUDIT" runat="server" ScreenCode="AMBTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="AMBTRAIL/AMBTRAIL_Audit_Trail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Changed By" DataField="CHANGED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_AMBTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.AMBTRAIL"
						ClientValidationFunction="onValidate_GENERAL__AMBTRAIL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf622d87c3a51460cbe0b2c23fc8a121c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf622d87c3a51460cbe0b2c23fc8a121c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf622d87c3a51460cbe0b2c23fc8a121c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf622d87c3a51460cbe0b2c23fc8a121c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf622d87c3a51460cbe0b2c23fc8a121c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf622d87c3a51460cbe0b2c23fc8a121c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf622d87c3a51460cbe0b2c23fc8a121c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf622d87c3a51460cbe0b2c23fc8a121c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf622d87c3a51460cbe0b2c23fc8a121c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf622d87c3a51460cbe0b2c23fc8a121c input{text-align:left;}"; break;
		}
	}
