...
Namespace Nexus
    Partial Class PB2_CCAAMBCLM_Deterioration_of_Stock : Inherits BaseClaim
		...
		Protected Sub onValidate_DSTOCK__AMBDSITMCL()
        
End Sub
Protected Sub onValidate_DSTOCK__AMBDSEPCLM()
        
End Sub
Protected Sub onValidate_DSTOCK__AMBDSNTSCL()
        
End Sub
Protected Sub onValidate_DSTOCK__AMBDSSNTSC()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DSTOCK__AMBDSITMCL()
    onValidate_DSTOCK__AMBDSEPCLM()
    onValidate_DSTOCK__AMBDSNTSCL()
    onValidate_DSTOCK__AMBDSSNTSC()
End Sub
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' DSTOCK = The parent object name of child screen
        ' DS_CLAUSEPREM = The child screen object name
        
        Protected Sub DSTOCK__DS_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles DSTOCK__DS_CLAUSEPREM.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
