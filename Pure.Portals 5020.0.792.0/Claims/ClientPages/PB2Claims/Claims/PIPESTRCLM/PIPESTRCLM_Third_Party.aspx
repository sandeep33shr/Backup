<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PIPESTRCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_PIPESTRCLM_Third_Party" %>
...
function onValidate_PIPESTRCLAIM__PIPETPRTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PIPESTRCLAIM", "PIPETPRTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_PIPESTRCLAIM__PIPETPRTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id694bbf3eb22341caa0e658058625f926" class="general-layout-container">
...
<div id="ide8ba265b4c38440abadb1ee2e00d8bfa" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PIPESTRCLAIM__PIPETPRTY"
		data-field-type="Child" 
		data-object-name="PIPESTRCLAIM" 
		data-property-name="PIPETPRTY" 
		id="pb-container-childscreen-PIPESTRCLAIM-PIPETPRTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PIPESTRCLAIM__PIPETHIRD" runat="server" ScreenCode="PIPETPRTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PIPETPRTY/PIPETPRTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valPIPESTRCLAIM_PIPETPRTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for PIPESTRCLAIM.PIPETPRTY"
						ClientValidationFunction="onValidate_PIPESTRCLAIM__PIPETPRTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide8ba265b4c38440abadb1ee2e00d8bfa div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide8ba265b4c38440abadb1ee2e00d8bfa div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide8ba265b4c38440abadb1ee2e00d8bfa div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide8ba265b4c38440abadb1ee2e00d8bfa label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide8ba265b4c38440abadb1ee2e00d8bfa label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide8ba265b4c38440abadb1ee2e00d8bfa label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide8ba265b4c38440abadb1ee2e00d8bfa label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide8ba265b4c38440abadb1ee2e00d8bfa input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide8ba265b4c38440abadb1ee2e00d8bfa input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide8ba265b4c38440abadb1ee2e00d8bfa input{text-align:left;}"; break;
		}
	}
