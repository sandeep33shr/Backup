<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PIPESTRCLM_Reserves.aspx.vb" Inherits="Nexus.PB2_PIPESTRCLM_Reserves" %>
...
function onValidate_PIPESTRCLAIM__PIPESOLSCN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PIPESTRCLAIM", "PIPESOLSCN", "ChildScreen");
        })();
}
function onValidate_PIPESTRCLAIM__SOL_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PIPESTRCLAIM", "SOL_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PIPESTRCLAIM", "SOL_COUNTER");
        		}
          ...
          * @param PIPESTRCLAIM The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "PIPESTRCLAIM".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_PIPESTRCLAIM__PIPERCVRSC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PIPESTRCLAIM", "PIPERCVRSC", "ChildScreen");
        })();
}
function onValidate_PIPESTRCLAIM__RECO_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PIPESTRCLAIM", "RECO_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("PIPESTRCLAIM", "RECO_COUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_PIPESTRCLAIM__PIPESOLSCN(null, null, null, isOnLoad);
    onValidate_PIPESTRCLAIM__SOL_COUNTER(null, null, null, isOnLoad);
    onValidate_PIPESTRCLAIM__PIPERCVRSC(null, null, null, isOnLoad);
    onValidate_PIPESTRCLAIM__RECO_COUNTER(null, null, null, isOnLoad);
}
</script>
...
<div id="id959c7442ce4a4892a4f43571e7ad8538" class="general-layout-container">
...
<div id="ide171b1384cdd4210b617457e9a91e6e4" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading44" runat="server" Text="Claim Reserves" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PIPESTRCLAIM__PIPESOLSCN"
		data-field-type="Child" 
		data-object-name="PIPESTRCLAIM" 
		data-property-name="PIPESOLSCN" 
		id="pb-container-childscreen-PIPESTRCLAIM-PIPESOLSCN">
		
		    <legend>Schedule of Loss</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PIPESTRCLAIM__SCHEDULE_LOSS" runat="server" ScreenCode="PIPESOLSCN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PIPESOLSCN/PIPESOLSCN_Schedule_of_Loss.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_ENVPIPE_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Payment Amount" DataField="PAYMENT_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valPIPESTRCLAIM_PIPESOLSCN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Schedule of Loss"
						ClientValidationFunction="onValidate_PIPESTRCLAIM__PIPESOLSCN" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-PIPESTRCLAIM-SOL_COUNTER">
		<asp:Label ID="lblPIPESTRCLAIM_SOL_COUNTER" runat="server" AssociatedControlID="PIPESTRCLAIM__SOL_COUNTER" 
			Text="Schedule Item Counter " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="PIPESTRCLAIM__SOL_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valPIPESTRCLAIM_SOL_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Schedule Item Counter "
			ClientValidationFunction="onValidate_PIPESTRCLAIM__SOL_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide171b1384cdd4210b617457e9a91e6e4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide171b1384cdd4210b617457e9a91e6e4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide171b1384cdd4210b617457e9a91e6e4 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide171b1384cdd4210b617457e9a91e6e4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide171b1384cdd4210b617457e9a91e6e4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide171b1384cdd4210b617457e9a91e6e4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide171b1384cdd4210b617457e9a91e6e4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide171b1384cdd4210b617457e9a91e6e4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide171b1384cdd4210b617457e9a91e6e4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide171b1384cdd4210b617457e9a91e6e4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id20b7c60a0a004706ad48a8dce1d46fa1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading45" runat="server" Text="Claim Recoveries" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PIPESTRCLAIM__PIPERCVRSC"
		data-field-type="Child" 
		data-object-name="PIPESTRCLAIM" 
		data-property-name="PIPERCVRSC" 
		id="pb-container-childscreen-PIPESTRCLAIM-PIPERCVRSC">
		
		    <legend>Recoveries</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PIPESTRCLAIM__RECOVERIES" runat="server" ScreenCode="PIPERCVRSC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PIPERCVRSC/PIPERCVRSC_Recovery.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_ENVPIPE_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Negotiated Amount" DataField="NEGOTIATED_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valPIPESTRCLAIM_PIPERCVRSC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Recoveries"
						ClientValidationFunction="onValidate_PIPESTRCLAIM__PIPERCVRSC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-PIPESTRCLAIM-RECO_COUNTER">
		<asp:Label ID="lblPIPESTRCLAIM_RECO_COUNTER" runat="server" AssociatedControlID="PIPESTRCLAIM__RECO_COUNTER" 
			Text="Recoveries counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="PIPESTRCLAIM__RECO_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valPIPESTRCLAIM_RECO_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recoveries counter"
			ClientValidationFunction="onValidate_PIPESTRCLAIM__RECO_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id20b7c60a0a004706ad48a8dce1d46fa1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id20b7c60a0a004706ad48a8dce1d46fa1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id20b7c60a0a004706ad48a8dce1d46fa1 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	  
			  if (liElementHeight > liMaxHeight)
			  {
				  liMaxHeight = liElementHeight;			  
	...
	if (labelWidth != ""){
		...
		styleString += "#id20b7c60a0a004706ad48a8dce1d46fa1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id20b7c60a0a004706ad48a8dce1d46fa1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id20b7c60a0a004706ad48a8dce1d46fa1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id20b7c60a0a004706ad48a8dce1d46fa1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id20b7c60a0a004706ad48a8dce1d46fa1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id20b7c60a0a004706ad48a8dce1d46fa1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id20b7c60a0a004706ad48a8dce1d46fa1 input{text-align:left;}"; break;
		}
	}
