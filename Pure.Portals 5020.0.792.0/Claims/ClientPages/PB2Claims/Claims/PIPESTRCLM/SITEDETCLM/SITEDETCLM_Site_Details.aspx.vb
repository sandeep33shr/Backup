...
Namespace Nexus
    Partial Class PB2_SITEDETCLM_Site_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_SITECLAIM__TANKDETCLM()
        
End Sub
Protected Sub onValidate_SITECLAIM__PIPEDETCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_SITECLAIM__TANKDETCLM()
    onValidate_SITECLAIM__PIPEDETCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' SITECLAIM = The parent object name of child screen
        ' TANKDETSCLM = The child screen object name
        
        Protected Sub SITECLAIM__TANKDETSCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles SITECLAIM__TANKDETSCLM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' SITECLAIM = The parent object name of child screen
        ' PIPEDETSCLM = The child screen object name
        
        Protected Sub SITECLAIM__PIPEDETSCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles SITECLAIM__PIPEDETSCLM.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
