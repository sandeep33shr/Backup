<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PIPESTRCLM_Ex_Gratia.aspx.vb" Inherits="Nexus.PB2_PIPESTRCLM_Ex_Gratia" %>
...
function onValidate_PIPESTRCLAIM__PIPEGRATIA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PIPESTRCLAIM", "PIPEGRATIA", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_PIPESTRCLAIM__PIPEGRATIA(null, null, null, isOnLoad);
}
</script>
...
<div id="id55af242cc0224579a6705169672bfe65" class="general-layout-container">
...
<div id="frmExGratia" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading27" runat="server" Text="Ex Gratia" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PIPESTRCLAIM__PIPEGRATIA"
		data-field-type="Child" 
		data-object-name="PIPESTRCLAIM" 
		data-property-name="PIPEGRATIA" 
		id="pb-container-childscreen-PIPESTRCLAIM-PIPEGRATIA">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PIPESTRCLAIM__AUTH_DETAILS" runat="server" ScreenCode="PIPEGRATIA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PIPEGRATIA/PIPEGRATIA_Ex_Gratia.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Reason" DataField="R_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valPIPESTRCLAIM_PIPEGRATIA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for PIPESTRCLAIM.PIPEGRATIA"
						ClientValidationFunction="onValidate_PIPESTRCLAIM__PIPEGRATIA" 
						Display="None"
