<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ELECEQCLM_Reserves.aspx.vb" Inherits="Nexus.PB2_ELECEQCLM_Reserves" %>
...
function onValidate_ELECEQUIPCLAIM__CEESOLSCRN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECEQUIPCLAIM", "CEESOLSCRN", "ChildScreen");
        })();
}
function onValidate_ELECEQUIPCLAIM__SOL_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECEQUIPCLAIM", "SOL_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("ELECEQUIPCLAIM", "SOL_COUNTER");
        		}
...
function onValidate_ELECEQUIPCLAIM__CEERCVRSC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECEQUIPCLAIM", "CEERCVRSC", "ChildScreen");
        })();
}
function onValidate_ELECEQUIPCLAIM__RECO_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECEQUIPCLAIM", "RECO_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("ELECEQUIPCLAIM", "RECO_COUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_ELECEQUIPCLAIM__CEESOLSCRN(null, null, null, isOnLoad);
    onValidate_ELECEQUIPCLAIM__SOL_COUNTER(null, null, null, isOnLoad);
    onValidate_ELECEQUIPCLAIM__CEERCVRSC(null, null, null, isOnLoad);
    onValidate_ELECEQUIPCLAIM__RECO_COUNTER(null, null, null, isOnLoad);
}
</script>
...
<div id="ida2a4ab4b7eae4a63aec828d57bda09ae" class="general-layout-container">
...
<div id="ide276878a77b64a20b8ccceeab67fc1e3" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECEQUIPCLAIM__CEESOLSCRN"
		data-field-type="Child" 
		data-object-name="ELECEQUIPCLAIM" 
		data-property-name="CEESOLSCRN" 
		id="pb-container-childscreen-ELECEQUIPCLAIM-CEESOLSCRN">
		
		    <legend>Schedule of Loss</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECEQUIPCLAIM__SCHEDULE_LOSS" runat="server" ScreenCode="CEESOLSCRN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CEESOLSCRN/CEESOLSCRN_Schedule_of_Loss.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Payment Amount" DataField="PAYMENT_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECEQUIPCLAIM_CEESOLSCRN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Schedule of Loss"
						ClientValidationFunction="onValidate_ELECEQUIPCLAIM__CEESOLSCRN" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-ELECEQUIPCLAIM-SOL_COUNTER">
		<asp:Label ID="lblELECEQUIPCLAIM_SOL_COUNTER" runat="server" AssociatedControlID="ELECEQUIPCLAIM__SOL_COUNTER" 
			Text="Schedule Item Counter " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ELECEQUIPCLAIM__SOL_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valELECEQUIPCLAIM_SOL_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Schedule Item Counter "
			ClientValidationFunction="onValidate_ELECEQUIPCLAIM__SOL_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide276878a77b64a20b8ccceeab67fc1e3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide276878a77b64a20b8ccceeab67fc1e3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide276878a77b64a20b8ccceeab67fc1e3 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide276878a77b64a20b8ccceeab67fc1e3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide276878a77b64a20b8ccceeab67fc1e3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide276878a77b64a20b8ccceeab67fc1e3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide276878a77b64a20b8ccceeab67fc1e3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide276878a77b64a20b8ccceeab67fc1e3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide276878a77b64a20b8ccceeab67fc1e3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide276878a77b64a20b8ccceeab67fc1e3 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide19b809ce68b439dbbab7de87d63d95c" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECEQUIPCLAIM__CEERCVRSC"
		data-field-type="Child" 
		data-object-name="ELECEQUIPCLAIM" 
		data-property-name="CEERCVRSC" 
		id="pb-container-childscreen-ELECEQUIPCLAIM-CEERCVRSC">
		
		    <legend>Recoveries</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECEQUIPCLAIM__RECOVERIES" runat="server" ScreenCode="CEERCVRSC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CEERCVRSC/CEERCVRSC_Recovery.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Peril" DataField="PERIL" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Negotiated Amount" DataField="NEGOTIATED_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valELECEQUIPCLAIM_CEERCVRSC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Recoveries"
						ClientValidationFunction="onValidate_ELECEQUIPCLAIM__CEERCVRSC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-ELECEQUIPCLAIM-RECO_COUNTER">
		<asp:Label ID="lblELECEQUIPCLAIM_RECO_COUNTER" runat="server" AssociatedControlID="ELECEQUIPCLAIM__RECO_COUNTER" 
			Text="Recoveries counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ELECEQUIPCLAIM__RECO_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valELECEQUIPCLAIM_RECO_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recoveries counter"
			ClientValidationFunction="onValidate_ELECEQUIPCLAIM__RECO_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide19b809ce68b439dbbab7de87d63d95c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide19b809ce68b439dbbab7de87d63d95c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide19b809ce68b439dbbab7de87d63d95c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	  
			  if (liElementHeight > liMaxHeight)
			  {
				  liMaxHeight = liElementHeight;			  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide19b809ce68b439dbbab7de87d63d95c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide19b809ce68b439dbbab7de87d63d95c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide19b809ce68b439dbbab7de87d63d95c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide19b809ce68b439dbbab7de87d63d95c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide19b809ce68b439dbbab7de87d63d95c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide19b809ce68b439dbbab7de87d63d95c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide19b809ce68b439dbbab7de87d63d95c input{text-align:left;}"; break;
		}
	}
