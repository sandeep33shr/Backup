<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ELECEQCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_ELECEQCLM_Third_Party" %>
...
function onValidate_ELECEQUIPCLAIM__CEETPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ELECEQUIPCLAIM", "CEETPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_ELECEQUIPCLAIM__CEETPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id137b15b9ac0c425eb2f4b4e627bede53" class="general-layout-container">
...
<div id="id88c17f1f5809410dafa03c7153611b14" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ELECEQUIPCLAIM__CEETPARTY"
		data-field-type="Child" 
		data-object-name="ELECEQUIPCLAIM" 
		data-property-name="CEETPARTY" 
		id="pb-container-childscreen-ELECEQUIPCLAIM-CEETPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ELECEQUIPCLAIM__ELECEQUIPTHIRD" runat="server" ScreenCode="CEETPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CEETPARTY/CEETPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valELECEQUIPCLAIM_CEETPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ELECEQUIPCLAIM.CEETPARTY"
						ClientValidationFunction="onValidate_ELECEQUIPCLAIM__CEETPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id88c17f1f5809410dafa03c7153611b14 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id88c17f1f5809410dafa03c7153611b14 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id88c17f1f5809410dafa03c7153611b14 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id88c17f1f5809410dafa03c7153611b14 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id88c17f1f5809410dafa03c7153611b14 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id88c17f1f5809410dafa03c7153611b14 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id88c17f1f5809410dafa03c7153611b14 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id88c17f1f5809410dafa03c7153611b14 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id88c17f1f5809410dafa03c7153611b14 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id88c17f1f5809410dafa03c7153611b14 input{text-align:left;}"; break;
		}
	}
