...
Namespace Nexus
    Partial Class PB2_ELECEQCLM_Claim_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_ELECEQUIPCLAIM__CEETRAIL()
        
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ELECEQUIPCLAIM__CEETRAIL()
End Sub
        ...
        Protected Sub UpdateAuditTrail()
        	...
        	Dim salvage As String = ELECEQUIPCLAIM__SALVAGESTAT.Text
        	Dim legal As String = ELECEQUIPCLAIM__LEGALSTAT.Text
        	Dim decision As String = ELECEQUIPCLAIM__CLMDECISION.Text
        	...
        	If (salvage_updatereq Or legal_updatereq Or decision_updatereq) Then
        		...
        		Session(CNDataSet) = oWebService.RunDefaultRulesEdit(ELECEQUIPCLAIM__ELECEQUIPAUDIT.ScreenCode, Session(CNDataSet))
        	End If
        ...
        Protected Function AuditEntryRequired(ByVal propertyName As String, ByVal propertyValue As String, ByRef previousValue As String) As Boolean
        	...
        	For Each el As Linq.XElement In datamodelXML.DescendantNodes()
        		If (el.Name.ToString().ToUpper() = "ELECEQUIPAUDIT") Then
        ...
        Protected Sub LogAuditEntry(ByVal propertyName As String, ByVal propertyValue As String, ByVal previousValue As String)
        	...
        	Doc.LoadXml(strDS)
        	Dim xmlParent As XmlNode = Doc.SelectSingleNode("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/ELECEQUIPCLAIM/ELECEQUIPAUDIT")
        	Dim v_sOI As String = Nothing
        	If xmlParent IsNot Nothing Then
        		v_sOI = xmlParent.Attributes("OI").Value
        	End If
        	Dim v_sScreenCode As String = ELECEQUIPCLAIM__ELECEQUIPAUDIT.ScreenCode
        	Dim sParentElement, sChildElement As String
        	Dim sTmp() As String = Regex.Split(ELECEQUIPCLAIM__ELECEQUIPAUDIT.ID, "__")
        	...
        	ELECEQUIPCLAIM__ELECEQUIPAUDIT.DataSource = oXMLSource
        	ELECEQUIPCLAIM__ELECEQUIPAUDIT.DataBind()
        ...
        ' ELECEQUIPAUDIT = The child screen object name
        
        Protected Sub ELECEQUIPCLAIM__ELECEQUIPAUDIT_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles ELECEQUIPCLAIM__ELECEQUIPAUDIT.RowDataBound
