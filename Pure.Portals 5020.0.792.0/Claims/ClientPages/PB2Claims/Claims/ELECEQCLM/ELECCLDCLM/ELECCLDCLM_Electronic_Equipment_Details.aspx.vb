...
Namespace Nexus
    Partial Class PB2_ELECCLDCLM_Electronic_Equipment_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_ELECEQUIPCLM__EEINTPART()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ELECEQUIPCLM__EEINTPART()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' ELECEQUIPCLM = The parent object name of child screen
        ' ELECEQPCHLDCLM = The child screen object name
        
        Protected Sub ELECEQUIPCLM__ELECEQPCHLDCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles ELECEQUIPCLM__ELECEQPCHLDCLM.RowDataBound
