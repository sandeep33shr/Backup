<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPROCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_CPROCLM_Third_Party" %>
...
function onValidate_CPROCLAIM__CPROTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPROCLAIM", "CPROTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CPROCLAIM__CPROTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id5f0e45a306d4425baa68e8e13b6a976b" class="general-layout-container">
...
<div id="idcb527032b23f41ff89b113f6a34f4c36" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPROCLAIM__CPROTPARTY"
		data-field-type="Child" 
		data-object-name="CPROCLAIM" 
		data-property-name="CPROTPARTY" 
		id="pb-container-childscreen-CPROCLAIM-CPROTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPROCLAIM__CPROTHIRD" runat="server" ScreenCode="CPROTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPROTPARTY/CPROTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCPROCLAIM_CPROTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CPROCLAIM.CPROTPARTY"
						ClientValidationFunction="onValidate_CPROCLAIM__CPROTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idcb527032b23f41ff89b113f6a34f4c36 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcb527032b23f41ff89b113f6a34f4c36 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcb527032b23f41ff89b113f6a34f4c36 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idcb527032b23f41ff89b113f6a34f4c36 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcb527032b23f41ff89b113f6a34f4c36 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcb527032b23f41ff89b113f6a34f4c36 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcb527032b23f41ff89b113f6a34f4c36 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcb527032b23f41ff89b113f6a34f4c36 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcb527032b23f41ff89b113f6a34f4c36 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcb527032b23f41ff89b113f6a34f4c36 input{text-align:left;}"; break;
		}
	}
