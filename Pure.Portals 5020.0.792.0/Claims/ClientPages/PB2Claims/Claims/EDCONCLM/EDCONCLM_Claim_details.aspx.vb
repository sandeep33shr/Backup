...
Namespace Nexus
    Partial Class PB2_EDCONCLM_Claim_details : Inherits BaseClaim
...
End Sub
Protected Sub onValidate_GENERAL__RTATRAIL()
        
        
End Sub
Protected Sub onValidate_RTACLM__RTAENDO()
        
End Sub
Protected Sub onValidate_RTACLM__RTANOTES()
        
End Sub
Protected Sub onValidate_RTACLM__RTASNOTES()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GENERAL__TRANSACTION_TYPE()
    onValidate_GENERAL__RTATRAIL()
    onValidate_RTACLM__RTAENDO()
    onValidate_RTACLM__RTANOTES()
    onValidate_RTACLM__RTASNOTES()
End Sub
        ...
        'GENERAL Represent the Claims Status Object (Salvage Status, Legal Status, Claim Decision)
        'AUDIT Represent the Claim's Child screen object 
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RTACLM = The parent object name of child screen
        ' RTA_ENDORSE = The child screen object name
        
        Protected Sub RTACLM__RTA_ENDORSE_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RTACLM__RTA_ENDORSE.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        Protected Sub RTACLM__CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RTACLM__CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RTACLM = The parent object name of child screen
        ' SNOTE_DETAILS = The child screen object name
        
        Protected Sub RTACLM__SNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RTACLM__SNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
