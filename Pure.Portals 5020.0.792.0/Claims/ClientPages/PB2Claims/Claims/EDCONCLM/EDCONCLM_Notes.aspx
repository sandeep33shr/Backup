<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EDCONCLM_Notes.aspx.vb" Inherits="Nexus.PB2_EDCONCLM_Notes" %>
...
function onValidate_RTACLM__RTCCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTACLM", "RTCCNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("RTACLM", "RTCCNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_RTACLM__RTCCNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("RTACLM", "RTCCNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'RTACLM' and property 'RTCCNOTE'.");
        			error.display();
...
function onValidate_RTACLM__RTCSCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "RTACLM", "RTCSCNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_RTACLM__RTCCNOTE(null, null, null, isOnLoad);
    onValidate_RTACLM__RTCSCNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id8cfa70c21f924ee680596a2b50fcec90" class="general-layout-container">
...
<div id="idc1b7a1ed87e54a72acb9fe7bd3e7a30c" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RTACLM__RTCCNOTE"
		data-field-type="Child" 
		data-object-name="RTACLM" 
		data-property-name="RTCCNOTE" 
		id="pb-container-childscreen-RTACLM-RTCCNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RTACLM__ED_CNOTE_DETAILS" runat="server" ScreenCode="RTCCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RTCCNOTE/RTCCNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valRTACLM_RTCCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_RTACLM__RTCCNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idc1b7a1ed87e54a72acb9fe7bd3e7a30c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc1b7a1ed87e54a72acb9fe7bd3e7a30c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc1b7a1ed87e54a72acb9fe7bd3e7a30c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idc1b7a1ed87e54a72acb9fe7bd3e7a30c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc1b7a1ed87e54a72acb9fe7bd3e7a30c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc1b7a1ed87e54a72acb9fe7bd3e7a30c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc1b7a1ed87e54a72acb9fe7bd3e7a30c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc1b7a1ed87e54a72acb9fe7bd3e7a30c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc1b7a1ed87e54a72acb9fe7bd3e7a30c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc1b7a1ed87e54a72acb9fe7bd3e7a30c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id47f84e5aa6d14547938450cdc4385075" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_RTACLM__RTCSCNOTE"
		data-field-type="Child" 
		data-object-name="RTACLM" 
		data-property-name="RTCSCNOTE" 
		id="pb-container-childscreen-RTACLM-RTCSCNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="RTACLM__EXT_DETAILS" runat="server" ScreenCode="RTCSCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="RTCSCNOTE/RTCSCNOTE_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valRTACLM_RTCSCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_RTACLM__RTCSCNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id47f84e5aa6d14547938450cdc4385075 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id47f84e5aa6d14547938450cdc4385075 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id47f84e5aa6d14547938450cdc4385075 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id47f84e5aa6d14547938450cdc4385075 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id47f84e5aa6d14547938450cdc4385075 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id47f84e5aa6d14547938450cdc4385075 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id47f84e5aa6d14547938450cdc4385075 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id47f84e5aa6d14547938450cdc4385075 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id47f84e5aa6d14547938450cdc4385075 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id47f84e5aa6d14547938450cdc4385075 input{text-align:left;}"; break;
		}
	}
