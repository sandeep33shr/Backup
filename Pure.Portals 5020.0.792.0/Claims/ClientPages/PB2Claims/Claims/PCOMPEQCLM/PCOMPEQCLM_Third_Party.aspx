<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PCOMPEQCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_PCOMPEQCLM_Third_Party" %>
...
function onValidate_COMPECLAIM__PCTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "COMPECLAIM", "PCTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_COMPECLAIM__PCTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idb82618408f3e4292a311b4b7ae0ba822" class="general-layout-container">
...
<div id="id54f67ee642f74df1924353c33a98631c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading15" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_COMPECLAIM__PCTPARTY"
		data-field-type="Child" 
		data-object-name="COMPECLAIM" 
		data-property-name="PCTPARTY" 
		id="pb-container-childscreen-COMPECLAIM-PCTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="COMPECLAIM__PCTHIRD" runat="server" ScreenCode="PCTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PCTPARTY/PCTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCOMPECLAIM_PCTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for COMPECLAIM.PCTPARTY"
						ClientValidationFunction="onValidate_COMPECLAIM__PCTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id54f67ee642f74df1924353c33a98631c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id54f67ee642f74df1924353c33a98631c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id54f67ee642f74df1924353c33a98631c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id54f67ee642f74df1924353c33a98631c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id54f67ee642f74df1924353c33a98631c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54f67ee642f74df1924353c33a98631c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54f67ee642f74df1924353c33a98631c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id54f67ee642f74df1924353c33a98631c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id54f67ee642f74df1924353c33a98631c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id54f67ee642f74df1924353c33a98631c input{text-align:left;}"; break;
		}
	}
