...
Namespace Nexus
    Partial Class PB2_PCOMPEQCLM_Underwriting_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_COMPEQ__PCOMPCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_COMPEQ__PCOMPCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' COMPEQ = The parent object name of child screen
        ' COMPEQ_DET = The child screen object name
        
        Protected Sub COMPEQ__COMPEQ_DET_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles COMPEQ__COMPEQ_DET.RowDataBound
