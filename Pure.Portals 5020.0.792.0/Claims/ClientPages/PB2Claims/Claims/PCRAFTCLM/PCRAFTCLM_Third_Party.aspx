<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PCRAFTCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_PCRAFTCLM_Third_Party" %>
...
function onValidate_PCRAFTCLAIM__PCRTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PCRAFTCLAIM", "PCRTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_PCRAFTCLAIM__PCRTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idcb7a51a41051425b9e0804b76454239c" class="general-layout-container">
...
<div id="id8b2d60cec7ce4d1ab52184b0ed106081" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading11" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PCRAFTCLAIM__PCRTPARTY"
		data-field-type="Child" 
		data-object-name="PCRAFTCLAIM" 
		data-property-name="PCRTPARTY" 
		id="pb-container-childscreen-PCRAFTCLAIM-PCRTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PCRAFTCLAIM__PCRAFTTHIRD" runat="server" ScreenCode="PCRTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PCRTPARTY/PCRTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valPCRAFTCLAIM_PCRTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for PCRAFTCLAIM.PCRTPARTY"
						ClientValidationFunction="onValidate_PCRAFTCLAIM__PCRTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id8b2d60cec7ce4d1ab52184b0ed106081 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8b2d60cec7ce4d1ab52184b0ed106081 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8b2d60cec7ce4d1ab52184b0ed106081 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id8b2d60cec7ce4d1ab52184b0ed106081 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8b2d60cec7ce4d1ab52184b0ed106081 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8b2d60cec7ce4d1ab52184b0ed106081 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8b2d60cec7ce4d1ab52184b0ed106081 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8b2d60cec7ce4d1ab52184b0ed106081 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8b2d60cec7ce4d1ab52184b0ed106081 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8b2d60cec7ce4d1ab52184b0ed106081 input{text-align:left;}"; break;
		}
	}
