...
Namespace Nexus
    Partial Class PB2_PCRAFTCLM_Claim_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_PCRAFTCLAIM__PCRTRAIL()
        
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PCRAFTCLAIM__PCRTRAIL()
End Sub
        ...
        Protected Sub UpdateAuditTrail()
        	...
        	Dim salvage As String = PCRAFTCLAIM__SALVAGESTAT.Text
        	Dim legal As String = PCRAFTCLAIM__LEGALSTAT.Text
        	Dim decision As String = PCRAFTCLAIM__CLMDECISION.Text
        	...
        	If (salvage_updatereq Or legal_updatereq Or decision_updatereq) Then
        		...
        		Session(CNDataSet) = oWebService.RunDefaultRulesEdit(PCRAFTCLAIM__PCRAFTAUDIT.ScreenCode, Session(CNDataSet))
        	End If
        ...
        Protected Function AuditEntryRequired(ByVal propertyName As String, ByVal propertyValue As String, ByRef previousValue As String) As Boolean
        	...
        	For Each el As Linq.XElement In datamodelXML.DescendantNodes()
        		If (el.Name.ToString().ToUpper() = "PCRAFTAUDIT") Then
        ...
        Protected Sub LogAuditEntry(ByVal propertyName As String, ByVal propertyValue As String, ByVal previousValue As String)
        	...
        	Doc.LoadXml(strDS)
        	Dim xmlParent As XmlNode = Doc.SelectSingleNode("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/PCRAFTCLAIM/PCRAFTAUDIT")
        	Dim v_sOI As String = Nothing
        	If xmlParent IsNot Nothing Then
        		v_sOI = xmlParent.Attributes("OI").Value
        	End If
        	Dim v_sScreenCode As String = PCRAFTCLAIM__PCRAFTAUDIT.ScreenCode
        	Dim sParentElement, sChildElement As String
        	Dim sTmp() As String = Regex.Split(PCRAFTCLAIM__PCRAFTAUDIT.ID, "__")
        	...
        	PCRAFTCLAIM__PCRAFTAUDIT.DataSource = oXMLSource
        	PCRAFTCLAIM__PCRAFTAUDIT.DataBind()
        ...
        ' PCRAFTCLAIM = The parent object name of child screen
        ' PCRAFTAUDIT = The child screen object name
        
        Protected Sub PCRAFTCLAIM__PCRAFTAUDIT_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles PCRAFTCLAIM__PCRAFTAUDIT.RowDataBound
