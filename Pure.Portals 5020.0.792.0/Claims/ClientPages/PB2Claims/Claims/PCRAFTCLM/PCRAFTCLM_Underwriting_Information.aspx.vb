...
Namespace Nexus
    Partial Class PB2_PCRAFTCLM_Underwriting_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_PCRAFTCLAIM__VATNUMBER()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PCRAFTCLAIM__VATNUMBER()
End Sub
        ...
        If Session("vatNumber") IsNot Nothing Then
        		PCRAFTCLAIM__VATNUMBER.Text = Session("vatNumber")
         End If
