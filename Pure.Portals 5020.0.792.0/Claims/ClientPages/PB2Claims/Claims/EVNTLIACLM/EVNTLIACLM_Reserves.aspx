<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EVNTLIACLM_Reserves.aspx.vb" Inherits="Nexus.PB2_EVNTLIACLM_Reserves" %>
...
function onValidate_EVENTLIABCLAIM__ELSOLSCRN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EVENTLIABCLAIM", "ELSOLSCRN", "ChildScreen");
        })();
}
function onValidate_EVENTLIABCLAIM__SOL_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EVENTLIABCLAIM", "SOL_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("EVENTLIABCLAIM", "SOL_COUNTER");
        		}
          ...
          * @param EVENTLIABCLAIM The Parent (Root) object name.
          * @param SCHEDULE_LOSS.PAYEE_TYPE The object.property to sum the totals of.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "EVENTLIABCLAIM".toUpperCase().replace(/^\s+|\s+$/g, '');
        		var childFieldStr = "SCHEDULE_LOSS.PAYEE_TYPE";
...
function onValidate_EVENTLIABCLAIM__ELRCVRSC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EVENTLIABCLAIM", "ELRCVRSC", "ChildScreen");
        })();
}
function onValidate_EVENTLIABCLAIM__RECO_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EVENTLIABCLAIM", "RECO_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("EVENTLIABCLAIM", "RECO_COUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_EVENTLIABCLAIM__ELSOLSCRN(null, null, null, isOnLoad);
    onValidate_EVENTLIABCLAIM__SOL_COUNTER(null, null, null, isOnLoad);
    onValidate_EVENTLIABCLAIM__ELRCVRSC(null, null, null, isOnLoad);
    onValidate_EVENTLIABCLAIM__RECO_COUNTER(null, null, null, isOnLoad);
}
</script>
...
<div id="idc681ebeafd824153ba9d3282e435dcde" class="general-layout-container">
...
<div id="idb80d9692acc542ffb08bccd0f8f42675" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading38" runat="server" Text="Claim Reserves" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EVENTLIABCLAIM__ELSOLSCRN"
		data-field-type="Child" 
		data-object-name="EVENTLIABCLAIM" 
		data-property-name="ELSOLSCRN" 
		id="pb-container-childscreen-EVENTLIABCLAIM-ELSOLSCRN">
		
		    <legend>Schedule of Loss</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EVENTLIABCLAIM__SCHEDULE_LOSS" runat="server" ScreenCode="ELSOLSCRN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ELSOLSCRN/ELSOLSCRN_Schedule_of_Loss.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_EVENTLIAB_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
<Nexus:GISLookupField HeaderText="Payment Method" ListType="PMLookup" ListCode="UDL_[MediaType]" DataField="PAYMENT_TYPE" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="This Reserve" DataField="THIS_RESERVE" DataFormatString="{0:N}"/>
...
<Nexus:RiskAttribute HeaderText="Payment Amount" DataField="PAYMENT_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valEVENTLIABCLAIM_ELSOLSCRN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Schedule of Loss"
						ClientValidationFunction="onValidate_EVENTLIABCLAIM__ELSOLSCRN" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-EVENTLIABCLAIM-SOL_COUNTER">
		<asp:Label ID="lblEVENTLIABCLAIM_SOL_COUNTER" runat="server" AssociatedControlID="EVENTLIABCLAIM__SOL_COUNTER" 
			Text="Schedule Item Counter " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="EVENTLIABCLAIM__SOL_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valEVENTLIABCLAIM_SOL_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Schedule Item Counter "
			ClientValidationFunction="onValidate_EVENTLIABCLAIM__SOL_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idb80d9692acc542ffb08bccd0f8f42675 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb80d9692acc542ffb08bccd0f8f42675 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb80d9692acc542ffb08bccd0f8f42675 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idb80d9692acc542ffb08bccd0f8f42675 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb80d9692acc542ffb08bccd0f8f42675 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb80d9692acc542ffb08bccd0f8f42675 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb80d9692acc542ffb08bccd0f8f42675 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb80d9692acc542ffb08bccd0f8f42675 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb80d9692acc542ffb08bccd0f8f42675 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb80d9692acc542ffb08bccd0f8f42675 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id50cad3ecb5794aa5977f5e2e8a21280b" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading39" runat="server" Text="Claim Recoveries" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EVENTLIABCLAIM__ELRCVRSC"
		data-field-type="Child" 
		data-object-name="EVENTLIABCLAIM" 
		data-property-name="ELRCVRSC" 
		id="pb-container-childscreen-EVENTLIABCLAIM-ELRCVRSC">
		
		    <legend>Recoveries</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EVENTLIABCLAIM__RECOVERIES" runat="server" ScreenCode="ELRCVRSC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ELRCVRSC/ELRCVRSC_Recovery.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_EVENTLIAB_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Negotiated Amount" DataField="NEGOTIATED_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valEVENTLIABCLAIM_ELRCVRSC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Recoveries"
						ClientValidationFunction="onValidate_EVENTLIABCLAIM__ELRCVRSC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-EVENTLIABCLAIM-RECO_COUNTER">
		<asp:Label ID="lblEVENTLIABCLAIM_RECO_COUNTER" runat="server" AssociatedControlID="EVENTLIABCLAIM__RECO_COUNTER" 
			Text="Recoveries counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="EVENTLIABCLAIM__RECO_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valEVENTLIABCLAIM_RECO_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recoveries counter"
			ClientValidationFunction="onValidate_EVENTLIABCLAIM__RECO_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id50cad3ecb5794aa5977f5e2e8a21280b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id50cad3ecb5794aa5977f5e2e8a21280b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id50cad3ecb5794aa5977f5e2e8a21280b div ul li").each(function(){		  
			  liElementHeight = $(this).height();	  
			  if (liElementHeight > liMaxHeight)
			  {
				  liMaxHeight = liElementHeight;			  
	...
	if (labelWidth != ""){
		...
		styleString += "#id50cad3ecb5794aa5977f5e2e8a21280b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id50cad3ecb5794aa5977f5e2e8a21280b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id50cad3ecb5794aa5977f5e2e8a21280b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id50cad3ecb5794aa5977f5e2e8a21280b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id50cad3ecb5794aa5977f5e2e8a21280b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id50cad3ecb5794aa5977f5e2e8a21280b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id50cad3ecb5794aa5977f5e2e8a21280b input{text-align:left;}"; break;
		}
	}
