<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EVNTLIACLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_EVNTLIACLM_Third_Party" %>
...
function onValidate_EVENTLIABCLAIM__ELTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EVENTLIABCLAIM", "ELTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_EVENTLIABCLAIM__ELTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idf4b87c24c1ff4b21aaeac16bdcb5754c" class="general-layout-container">
...
<div id="id5d0828c3ec424a0cbb16ebfc06096280" class="column-layout-container fieldset-wrapper,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading17" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EVENTLIABCLAIM__ELTPARTY"
		data-field-type="Child" 
		data-object-name="EVENTLIABCLAIM" 
		data-property-name="ELTPARTY" 
		id="pb-container-childscreen-EVENTLIABCLAIM-ELTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EVENTLIABCLAIM__GLTHIRD" runat="server" ScreenCode="ELTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ELTPARTY/ELTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEVENTLIABCLAIM_ELTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for EVENTLIABCLAIM.ELTPARTY"
						ClientValidationFunction="onValidate_EVENTLIABCLAIM__ELTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if ($("#id5d0828c3ec424a0cbb16ebfc06096280 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5d0828c3ec424a0cbb16ebfc06096280 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5d0828c3ec424a0cbb16ebfc06096280 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5d0828c3ec424a0cbb16ebfc06096280 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5d0828c3ec424a0cbb16ebfc06096280 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d0828c3ec424a0cbb16ebfc06096280 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d0828c3ec424a0cbb16ebfc06096280 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5d0828c3ec424a0cbb16ebfc06096280 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5d0828c3ec424a0cbb16ebfc06096280 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5d0828c3ec424a0cbb16ebfc06096280 input{text-align:left;}"; break;
		}
	}
