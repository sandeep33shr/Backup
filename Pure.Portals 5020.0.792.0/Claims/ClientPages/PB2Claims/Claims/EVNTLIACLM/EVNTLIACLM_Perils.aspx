<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EVNTLIACLM_Perils.aspx.vb" Inherits="Nexus.PB2_EVNTLIACLM_Perils" %>

<%@ Register Src="~/controls/Perils.ascx" TagName="Peril" TagPrefix="NexusControl" %>
...
function onValidate_WORK_CLAIM__WorkClaimPeril(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WORK_CLAIM", "EVNTLIAPER", "WorkClaimPeril");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_WORK_CLAIM__WorkClaimPeril(null, null, null, isOnLoad);
}
</script>
...
<div id="perilContainer" class="general-layout-container">
...
<!-- PerilDetails -->
	<NexusControl:Peril ID="Work_Claim_Peril" runat="server" />
<!-- /PerilDetails -->
