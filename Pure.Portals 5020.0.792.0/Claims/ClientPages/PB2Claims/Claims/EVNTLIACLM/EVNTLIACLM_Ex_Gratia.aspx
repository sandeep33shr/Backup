<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EVNTLIACLM_Ex_Gratia.aspx.vb" Inherits="Nexus.PB2_EVNTLIACLM_Ex_Gratia" %>
...
function onValidate_EVENTLIABCLAIM__ELGRDTAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "EVENTLIABCLAIM", "ELGRDTAIL", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_EVENTLIABCLAIM__ELGRDTAIL(null, null, null, isOnLoad);
}
</script>
...
<div id="id0cbad331c0b44c2ab078bf7b96cb4315" class="general-layout-container">
...
<div id="frmExGratia" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading21" runat="server" Text="Ex Gratia" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_EVENTLIABCLAIM__ELGRDTAIL"
		data-field-type="Child" 
		data-object-name="EVENTLIABCLAIM" 
		data-property-name="ELGRDTAIL" 
		id="pb-container-childscreen-EVENTLIABCLAIM-ELGRDTAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="EVENTLIABCLAIM__AUTH_DETAILS" runat="server" ScreenCode="ELGRDTAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ELGRDTAIL/ELGRDTAIL_Ex_Gratia.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Authorised" DataField="Auth_Date" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Ex Gratia Authorised By " DataField="Auth_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Reason" DataField="R_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valEVENTLIABCLAIM_ELGRDTAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for EVENTLIABCLAIM.ELGRDTAIL"
						ClientValidationFunction="onValidate_EVENTLIABCLAIM__ELGRDTAIL" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#frmExGratia div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#frmExGratia div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#frmExGratia div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#frmExGratia label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#frmExGratia label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmExGratia label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmExGratia label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#frmExGratia input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#frmExGratia input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#frmExGratia input{text-align:left;}"; break;
		}
	}
