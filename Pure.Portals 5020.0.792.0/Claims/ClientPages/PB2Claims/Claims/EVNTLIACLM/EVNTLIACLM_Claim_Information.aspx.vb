...
Namespace Nexus
    Partial Class PB2_EVNTLIACLM_Claim_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_EVENTLIABCLAIM__EVNTLTRAIL()
        
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_EVENTLIABCLAIM__EVNTLTRAIL()
End Sub
        ...
        Protected Sub UpdateAuditTrail()
        	...
        	Dim salvage As String = EVENTLIABCLAIM__SALVAGESTAT.Text
        	Dim legal As String = EVENTLIABCLAIM__LEGALSTAT.Text
        	Dim decision As String = EVENTLIABCLAIM__CLMDECISION.Text
        	...
        	If (salvage_updatereq Or legal_updatereq Or decision_updatereq) Then
        		...
        		Session(CNDataSet) = oWebService.RunDefaultRulesEdit(EVENTLIABCLAIM__EVENTLIABAUDIT.ScreenCode, Session(CNDataSet))
        	End If
        ...
        Protected Function AuditEntryRequired(ByVal propertyName As String, ByVal propertyValue As String, ByRef previousValue As String) As Boolean
        	...
        	For Each el As Linq.XElement In datamodelXML.DescendantNodes()
        		If (el.Name.ToString().ToUpper() = "EVENTLIABAUDIT") Then
        ...
        Protected Sub LogAuditEntry(ByVal propertyName As String, ByVal propertyValue As String, ByVal previousValue As String)
        	...
        	Doc.LoadXml(strDS)
        	Dim xmlParent As XmlNode = Doc.SelectSingleNode("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/EVENTLIABCLAIM/EVENTLIABAUDIT")
        	Dim v_sOI As String = Nothing
        	If xmlParent IsNot Nothing Then
        		v_sOI = xmlParent.Attributes("OI").Value
        	End If
        	Dim v_sScreenCode As String = EVENTLIABCLAIM__EVENTLIABAUDIT.ScreenCode
        	Dim sParentElement, sChildElement As String
        	Dim sTmp() As String = Regex.Split(EVENTLIABCLAIM__EVENTLIABAUDIT.ID, "__")
        	...
        	EVENTLIABCLAIM__EVENTLIABAUDIT.DataSource = oXMLSource
        	EVENTLIABCLAIM__EVENTLIABAUDIT.DataBind()
        ...
        ' EVENTLIABCLAIM = The parent object name of child screen
        ' EVENTLIABAUDIT = The child screen object name
        
        Protected Sub EVENTLIABCLAIM__EVENTLIABAUDIT_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles EVENTLIABCLAIM__EVENTLIABAUDIT.RowDataBound
