<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAWCCLM_Claim_Information.aspx.vb" Inherits="Nexus.PB2_CMAWCCLM_Claim_Information" %>
...
function onValidate_CWCLAIM__THIRDPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWCLAIM", "THIRDPARTY", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWCLAIM_THIRDPARTY");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWCLAIM__THIRDPARTY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWCLAIM__THIRDPARTY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWCLAIM__SALVAGE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWCLAIM", "SALVAGE", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWCLAIM_SALVAGE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWCLAIM__SALVAGE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWCLAIM__SALVAGE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWCLAIM__RECOVERY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWCLAIM", "RECOVERY", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWCLAIM_RECOVERY");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWCLAIM__RECOVERY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWCLAIM__RECOVERY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWCLAIM__IS_THRDTLS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWCLAIM", "IS_THRDTLS", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CWCLAIM.IS_THRDTLS");
        		var update = function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWCLAIM_IS_THRDTLS");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWCLAIM__IS_THRDTLS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWCLAIM__IS_THRDTLS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWCLAIM__IS_NAMAPP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWCLAIM", "IS_NAMAPP", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWCLAIM", "IS_NAMAPP");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWCLAIM_IS_NAMAPP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWCLAIM__IS_NAMAPP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWCLAIM__IS_NAMAPP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CWCLAIM__NAMDECISION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWCLAIM", "NAMDECISION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CWCLAIM", "NAMDECISION");
        		}
        		//window.setProperty(field, "VE", "Code(GENERAL.CLMDECISION) == 2", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CWCLAIM", "NAMDECISION");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CWCLAIM.NAMDECISION");
        			window.setControlWidth(field, "0.8", "CWCLAIM", "NAMDECISION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCWCLAIM_NAMDECISION");
        			    var ele = document.getElementById('ctl00_cntMainBody_CWCLAIM__NAMDECISION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CWCLAIM__NAMDECISION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__CWTRAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "CWTRAIL", "ChildScreen");
        })();
        /** 
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CWCLAIM__THIRDPARTY(null, null, null, isOnLoad);
    onValidate_CWCLAIM__SALVAGE(null, null, null, isOnLoad);
    onValidate_CWCLAIM__RECOVERY(null, null, null, isOnLoad);
    onValidate_CWCLAIM__IS_THRDTLS(null, null, null, isOnLoad);
    onValidate_CWCLAIM__IS_NAMAPP(null, null, null, isOnLoad);
    onValidate_CWCLAIM__NAMDECISION(null, null, null, isOnLoad);
    onValidate_GENERAL__CWTRAIL(null, null, null, isOnLoad);
...
<div id="idb3889e562db6433bb42a1604b0654630" class="general-layout-container">
...
<div id="frmClmTyp" class="column-layout-container,no-border  ">
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWCLAIM_THIRDPARTY" for="ctl00_cntMainBody_CWCLAIM__THIRDPARTY" class="col-md-4 col-sm-3 control-label">
		Third Party</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CWCLAIM" 
		data-property-name="THIRDPARTY" 
		id="pb-container-checkbox-CWCLAIM-THIRDPARTY">	
		
		<asp:TextBox ID="CWCLAIM__THIRDPARTY" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWCLAIM_THIRDPARTY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Third Party"
			ClientValidationFunction="onValidate_CWCLAIM__THIRDPARTY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWCLAIM_SALVAGE" for="ctl00_cntMainBody_CWCLAIM__SALVAGE" class="col-md-4 col-sm-3 control-label">
		Salvage</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWCLAIM-SALVAGE">	
		
		<asp:TextBox ID="CWCLAIM__SALVAGE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWCLAIM_SALVAGE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Salvage"
			ClientValidationFunction="onValidate_CWCLAIM__SALVAGE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWCLAIM_RECOVERY" for="ctl00_cntMainBody_CWCLAIM__RECOVERY" class="col-md-4 col-sm-3 control-label">
		Recovery</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CWCLAIM-RECOVERY">	
		
		<asp:TextBox ID="CWCLAIM__RECOVERY" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWCLAIM_RECOVERY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recovery"
			ClientValidationFunction="onValidate_CWCLAIM__RECOVERY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWCLAIM_IS_THRDTLS" for="ctl00_cntMainBody_CWCLAIM__IS_THRDTLS" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CWCLAIM-IS_THRDTLS">	
		
		<asp:TextBox ID="CWCLAIM__IS_THRDTLS" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWCLAIM_IS_THRDTLS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Third Party Details"
			ClientValidationFunction="onValidate_CWCLAIM__IS_THRDTLS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCWCLAIM_IS_NAMAPP" for="ctl00_cntMainBody_CWCLAIM__IS_NAMAPP" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CWCLAIM-IS_NAMAPP">	
		
		<asp:TextBox ID="CWCLAIM__IS_NAMAPP" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCWCLAIM_IS_NAMAPP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NAMFISA Approached"
			ClientValidationFunction="onValidate_CWCLAIM__IS_NAMAPP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CWCLAIM-NAMDECISION">

		
		<asp:Label ID="lblCWCLAIM_NAMDECISION" runat="server" AssociatedControlID="CWCLAIM__NAMDECISION" 
			Text="NAMFISA Decision" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CWCLAIM__NAMDECISION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCWCLAIM_NAMDECISION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for NAMFISA Decision"
					ClientValidationFunction="onValidate_CWCLAIM__NAMDECISION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id9680c7edf4e74e45b323050252f5d9e3" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__CWTRAIL"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="CWTRAIL" 
		id="pb-container-childscreen-GENERAL-CWTRAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__AUDIT" runat="server" ScreenCode="CWTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CWTRAIL/CWTRAIL_Audit_Trail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Changed By" DataField="CHANGED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_CWTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for GENERAL.CWTRAIL"
						ClientValidationFunction="onValidate_GENERAL__CWTRAIL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id9680c7edf4e74e45b323050252f5d9e3 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id9680c7edf4e74e45b323050252f5d9e3 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id9680c7edf4e74e45b323050252f5d9e3 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id9680c7edf4e74e45b323050252f5d9e3 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id9680c7edf4e74e45b323050252f5d9e3 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9680c7edf4e74e45b323050252f5d9e3 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9680c7edf4e74e45b323050252f5d9e3 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id9680c7edf4e74e45b323050252f5d9e3 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id9680c7edf4e74e45b323050252f5d9e3 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id9680c7edf4e74e45b323050252f5d9e3 input{text-align:left;}"; break;
		}
	}
