...
Namespace Nexus
    Partial Class PB2_CMAWCCLM_Watercraft_Risk : Inherits BaseClaim
		...
		Protected Sub onValidate_WC_VESSELS__CLMWCEND()
        
End Sub
Protected Sub onValidate_WC_VESSELS__WCNTS()
        
End Sub
Protected Sub onValidate_WC_VESSELS__WCSNTS()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_WC_VESSELS__CLMWCEND()
    onValidate_WC_VESSELS__WCNTS()
    onValidate_WC_VESSELS__WCSNTS()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' WC_VESSELS = The parent object name of child screen
        ' WC_CLAUSEPREM = The child screen object name
        
        Protected Sub WC_VESSELS__WC_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles WC_VESSELS__WC_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' WC_VESSELS = The parent object name of child screen
        ' WC_CNOTE_DETAILS = The child screen object name
        
        Protected Sub WC_VESSELS__WC_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles WC_VESSELS__WC_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' WC_VESSELS = The parent object name of child screen
        ' WC_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub WC_VESSELS__WC_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles WC_VESSELS__WC_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
