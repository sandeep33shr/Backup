<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAWCCLM_Notes.aspx.vb" Inherits="Nexus.PB2_CMAWCCLM_Notes" %>
...
function onValidate_CWCLAIM__CWNCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWCLAIM", "CWNCLM", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CWCLAIM", "CWNCLM");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_CWCLAIM__CWNCLM table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CWCLAIM", "CWNCLM");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CWCLAIM' and property 'CWNCLM'.");
        			error.display();
...
function onValidate_CWCLAIM__CWENCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CWCLAIM", "CWENCLM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CWCLAIM__CWNCLM(null, null, null, isOnLoad);
    onValidate_CWCLAIM__CWENCLM(null, null, null, isOnLoad);
}
</script>
...
<div id="idef350911b16e456caa7514737421c3f7" class="general-layout-container">
...
<div id="id5b1ad1ea387247e580727c98ab87b65d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading38" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWCLAIM__CWNCLM"
		data-field-type="Child" 
		data-object-name="CWCLAIM" 
		data-property-name="CWNCLM" 
		id="pb-container-childscreen-CWCLAIM-CWNCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWCLAIM__CNOTE_DETAILS" runat="server" ScreenCode="CWNCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CWNCLM/CWNCLM_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCWCLAIM_CWNCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_CWCLAIM__CWNCLM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id5b1ad1ea387247e580727c98ab87b65d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5b1ad1ea387247e580727c98ab87b65d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5b1ad1ea387247e580727c98ab87b65d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id5b1ad1ea387247e580727c98ab87b65d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5b1ad1ea387247e580727c98ab87b65d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5b1ad1ea387247e580727c98ab87b65d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5b1ad1ea387247e580727c98ab87b65d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5b1ad1ea387247e580727c98ab87b65d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5b1ad1ea387247e580727c98ab87b65d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5b1ad1ea387247e580727c98ab87b65d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3f4eae0f8b1b4b65a9e5d4d60c242374" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading39" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CWCLAIM__CWENCLM"
		data-field-type="Child" 
		data-object-name="CWCLAIM" 
		data-property-name="CWENCLM" 
		id="pb-container-childscreen-CWCLAIM-CWENCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CWCLAIM__EXT_DETAILS" runat="server" ScreenCode="CWENCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CWENCLM/CWENCLM_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCWCLAIM_CWENCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_CWCLAIM__CWENCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3f4eae0f8b1b4b65a9e5d4d60c242374 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3f4eae0f8b1b4b65a9e5d4d60c242374 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3f4eae0f8b1b4b65a9e5d4d60c242374 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3f4eae0f8b1b4b65a9e5d4d60c242374 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3f4eae0f8b1b4b65a9e5d4d60c242374 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3f4eae0f8b1b4b65a9e5d4d60c242374 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3f4eae0f8b1b4b65a9e5d4d60c242374 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3f4eae0f8b1b4b65a9e5d4d60c242374 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3f4eae0f8b1b4b65a9e5d4d60c242374 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3f4eae0f8b1b4b65a9e5d4d60c242374 input{text-align:left;}"; break;
		}
	}
