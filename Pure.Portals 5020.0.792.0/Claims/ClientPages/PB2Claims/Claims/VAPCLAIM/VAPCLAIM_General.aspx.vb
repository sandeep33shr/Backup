...
Namespace Nexus
    Partial Class PB2_VAPCLAIM_General : Inherits BaseClaim
		...
		Protected Sub onValidate_VAPCLAIM__VAPTRAIL()
        
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_VAPCLAIM__VAPTRAIL()
End Sub
        ...
        Protected Sub UpdateAuditTrail()
        	...
        	Dim salvage As String = VAPCLAIM__SALVAGESTAT.Text
        	Dim legal As String = VAPCLAIM__LEGALSTAT.Text
        	Dim decision As String = VAPCLAIM__CLMDECISION.Text
        	...
        	If (salvage_updatereq Or legal_updatereq Or decision_updatereq) Then
        		...
        		Session(CNDataSet) = oWebService.RunDefaultRulesEdit(VAPCLAIM__VAPAUDT.ScreenCode, Session(CNDataSet))
        	End If
        ...
        Protected Function AuditEntryRequired(ByVal propertyName As String, ByVal propertyValue As String, ByRef previousValue As String) As Boolean
        	...
        	For Each el As Linq.XElement In datamodelXML.DescendantNodes()
        		If (el.Name.ToString().ToUpper() = "VAPAUDT") Then
        ...
        Protected Sub LogAuditEntry(ByVal propertyName As String, ByVal propertyValue As String, ByVal previousValue As String)
        	...
        	End If
        	Dim v_sScreenCode As String = VAPCLAIM__VAPAUDT.ScreenCode
        	Dim sParentElement, sChildElement As String
        	Dim sTmp() As String = Regex.Split(VAPCLAIM__VAPAUDT.ID, "__")
        	...
        	VAPCLAIM__VAPAUDT.DataSource = oXMLSource
        	VAPCLAIM__VAPAUDT.DataBind()
        ...
        ' VAPCLAIM = The parent object name of child screen
        ' VAPAUDT = The child screen object name
        
        Protected Sub VAPCLAIM__VAPAUDT_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles VAPCLAIM__VAPAUDT.RowDataBound
