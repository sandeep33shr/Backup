<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="VAPCLAIM_Claims_Notes.aspx.vb" Inherits="Nexus.PB2_VAPCLAIM_Claims_Notes" %>
...
function onValidate_VAPCLAIM__VAPNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VAPCLAIM", "VAPNOTE", "ChildScreen");
        })();
}
function onValidate_VAPCLAIM__VAPEXPA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VAPCLAIM", "VAPEXPA", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_VAPCLAIM__VAPNOTE(null, null, null, isOnLoad);
    onValidate_VAPCLAIM__VAPEXPA(null, null, null, isOnLoad);
}
</script>
...
<div id="id52673f519d5246d79e9994ef3864961e" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading23" runat="server" Text="Value Added Products Claims Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_VAPCLAIM__VAPNOTE"
		data-field-type="Child" 
		data-object-name="VAPCLAIM" 
		data-property-name="VAPNOTE" 
		id="pb-container-childscreen-VAPCLAIM-VAPNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="VAPCLAIM__CNOTE_DETAILS" runat="server" ScreenCode="VAPNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="VAPNOTE/VAPNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valVAPCLAIM_VAPNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_VAPCLAIM__VAPNOTE" 
						Display="None"
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading24" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_VAPCLAIM__VAPEXPA"
		data-field-type="Child" 
		data-object-name="VAPCLAIM" 
		data-property-name="VAPEXPA" 
		id="pb-container-childscreen-VAPCLAIM-VAPEXPA">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="VAPCLAIM__EXT_DETAILS" runat="server" ScreenCode="VAPEXPA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="VAPEXPA/VAPEXPA_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valVAPCLAIM_VAPEXPA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_VAPCLAIM__VAPEXPA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
