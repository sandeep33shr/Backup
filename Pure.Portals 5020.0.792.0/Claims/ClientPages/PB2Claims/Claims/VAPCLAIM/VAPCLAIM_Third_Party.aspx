<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="VAPCLAIM_Third_Party.aspx.vb" Inherits="Nexus.PB2_VAPCLAIM_Third_Party" %>
...
function onValidate_VAPCLAIM__VAPPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "VAPCLAIM", "VAPPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_VAPCLAIM__VAPPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id8e59bdd4a3544fe4a3ac1e63af2e6b7f" class="general-layout-container">
...
<div id="idfb5e07df1f944f77bff59140067c9553" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_VAPCLAIM__VAPPARTY"
		data-field-type="Child" 
		data-object-name="VAPCLAIM" 
		data-property-name="VAPPARTY" 
		id="pb-container-childscreen-VAPCLAIM-VAPPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="VAPCLAIM__VAPTHIRD" runat="server" ScreenCode="VAPPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="VAPPARTY/VAPPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valVAPCLAIM_VAPPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for VAPCLAIM.VAPPARTY"
						ClientValidationFunction="onValidate_VAPCLAIM__VAPPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idfb5e07df1f944f77bff59140067c9553 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idfb5e07df1f944f77bff59140067c9553 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idfb5e07df1f944f77bff59140067c9553 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idfb5e07df1f944f77bff59140067c9553 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idfb5e07df1f944f77bff59140067c9553 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfb5e07df1f944f77bff59140067c9553 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfb5e07df1f944f77bff59140067c9553 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idfb5e07df1f944f77bff59140067c9553 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idfb5e07df1f944f77bff59140067c9553 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idfb5e07df1f944f77bff59140067c9553 input{text-align:left;}"; break;
		}
	}
