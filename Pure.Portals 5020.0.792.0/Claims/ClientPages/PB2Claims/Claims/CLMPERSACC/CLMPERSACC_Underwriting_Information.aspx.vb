...
Namespace Nexus
    Partial Class PB2_CLMPERSACC_Underwriting_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_PSACC__VATNUMBER()
        
End Sub
Protected Sub onValidate_PSACC__PERSCHCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PSACC__VATNUMBER()
    onValidate_PSACC__PERSCHCLM()
End Sub
        ...
        If Session("vatNumber") IsNot Nothing Then
        		PSACC__VATNUMBER.Text = Session("vatNumber")
         End If
        		 
        End Sub
     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' PSACC = The parent object name of child screen
        ' PSINSURED = The child screen object name
        
        Protected Sub PSACC__PSINSURED_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles PSACC__PSINSURED.RowDataBound
