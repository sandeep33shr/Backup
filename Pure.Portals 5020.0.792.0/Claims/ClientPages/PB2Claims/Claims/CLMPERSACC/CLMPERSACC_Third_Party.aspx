<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLMPERSACC_Third_Party.aspx.vb" Inherits="Nexus.PB2_CLMPERSACC_Third_Party" %>
...
function onValidate_PSACLAIM__PAPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACLAIM", "PAPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_PSACLAIM__PAPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id77af13562e1446768b8fa5bb65b784a0" class="general-layout-container">
...
<div id="id46d8d1ab80494f81a85caea89b4c7220" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PSACLAIM__PAPARTY"
		data-field-type="Child" 
		data-object-name="PSACLAIM" 
		data-property-name="PAPARTY" 
		id="pb-container-childscreen-PSACLAIM-PAPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PSACLAIM__PSATHIRD" runat="server" ScreenCode="PAPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PAPARTY/PAPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valPSACLAIM_PAPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for PSACLAIM.PAPARTY"
						ClientValidationFunction="onValidate_PSACLAIM__PAPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id46d8d1ab80494f81a85caea89b4c7220 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id46d8d1ab80494f81a85caea89b4c7220 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id46d8d1ab80494f81a85caea89b4c7220 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id46d8d1ab80494f81a85caea89b4c7220 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id46d8d1ab80494f81a85caea89b4c7220 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id46d8d1ab80494f81a85caea89b4c7220 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id46d8d1ab80494f81a85caea89b4c7220 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id46d8d1ab80494f81a85caea89b4c7220 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id46d8d1ab80494f81a85caea89b4c7220 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id46d8d1ab80494f81a85caea89b4c7220 input{text-align:left;}"; break;
		}
	}
