<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLMPERSACC_Claims_Notes.aspx.vb" Inherits="Nexus.PB2_CLMPERSACC_Claims_Notes" %>
...
function onValidate_PSACLAIM__PSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACLAIM", "PSNOTE", "ChildScreen");
        })();
}
function onValidate_PSACLAIM__CLMEXPA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "PSACLAIM", "CLMEXPA", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_PSACLAIM__PSNOTE(null, null, null, isOnLoad);
    onValidate_PSACLAIM__CLMEXPA(null, null, null, isOnLoad);
}
</script>
...
<div id="idade6c2b2a2ad4ff4afb44255cec92ad4" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading21" runat="server" Text="Personal Accident Claims Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PSACLAIM__PSNOTE"
		data-field-type="Child" 
		data-object-name="PSACLAIM" 
		data-property-name="PSNOTE" 
		id="pb-container-childscreen-PSACLAIM-PSNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PSACLAIM__CNOTE_DETAILS" runat="server" ScreenCode="PSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="PSNOTE/PSNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valPSACLAIM_PSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_PSACLAIM__PSNOTE" 
						Display="None"
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_PSACLAIM__CLMEXPA"
		data-field-type="Child" 
		data-object-name="PSACLAIM" 
		data-property-name="CLMEXPA" 
		id="pb-container-childscreen-PSACLAIM-CLMEXPA">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="PSACLAIM__EXT_DETAILS" runat="server" ScreenCode="CLMEXPA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLMEXPA/CLMEXPA_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valPSACLAIM_CLMEXPA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_PSACLAIM__CLMEXPA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
