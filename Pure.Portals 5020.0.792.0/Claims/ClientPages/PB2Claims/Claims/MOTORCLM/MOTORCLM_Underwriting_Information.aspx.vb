...
Namespace Nexus
    Partial Class PB2_MOTORCLM_Underwriting_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_MOTORCLAIM__MEXTRACLM()
        
End Sub
Protected Sub onValidate_MOTORCLAIM__MRADIOCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MOTORCLAIM__MEXTRACLM()
    onValidate_MOTORCLAIM__MRADIOCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MOTORCLAIM = The parent object name of child screen
        ' MOTORCLM_EXTRA = The child screen object name
        
        Protected Sub MOTORCLAIM__MOTORCLM_EXTRA_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MOTORCLAIM__MOTORCLM_EXTRA.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MOTORCLAIM = The parent object name of child screen
        ' MOTORCLM_RADIO = The child screen object name
        
        Protected Sub MOTORCLAIM__MOTORCLM_RADIO_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MOTORCLAIM__MOTORCLM_RADIO.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
