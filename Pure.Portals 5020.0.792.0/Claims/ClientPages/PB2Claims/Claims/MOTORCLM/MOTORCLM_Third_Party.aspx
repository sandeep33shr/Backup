<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MOTORCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_MOTORCLM_Third_Party" %>
...
function onValidate_MOTORCLAIM__MOTTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MOTORCLAIM", "MOTTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_MOTORCLAIM__MOTTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idb2142137647b4d528530a7585b8d6eb1" class="general-layout-container">
...
<div id="id29e7a4b706154b568d4e9ff90f46be7a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading26" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MOTORCLAIM__MOTTPARTY"
		data-field-type="Child" 
		data-object-name="MOTORCLAIM" 
		data-property-name="MOTTPARTY" 
		id="pb-container-childscreen-MOTORCLAIM-MOTTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MOTORCLAIM__THIRD" runat="server" ScreenCode="MOTTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MOTTPARTY/MOTTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMOTORCLAIM_MOTTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MOTORCLAIM.MOTTPARTY"
						ClientValidationFunction="onValidate_MOTORCLAIM__MOTTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id29e7a4b706154b568d4e9ff90f46be7a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id29e7a4b706154b568d4e9ff90f46be7a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id29e7a4b706154b568d4e9ff90f46be7a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id29e7a4b706154b568d4e9ff90f46be7a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id29e7a4b706154b568d4e9ff90f46be7a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id29e7a4b706154b568d4e9ff90f46be7a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id29e7a4b706154b568d4e9ff90f46be7a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id29e7a4b706154b568d4e9ff90f46be7a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id29e7a4b706154b568d4e9ff90f46be7a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id29e7a4b706154b568d4e9ff90f46be7a input{text-align:left;}"; break;
		}
	}
