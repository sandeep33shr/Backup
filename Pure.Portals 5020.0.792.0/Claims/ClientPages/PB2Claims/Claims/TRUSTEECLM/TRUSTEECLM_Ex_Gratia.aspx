<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TRUSTEECLM_Ex_Gratia.aspx.vb" Inherits="Nexus.PB2_TRUSTEECLM_Ex_Gratia" %>
...
function onValidate_TRUSTEECLAIM__TRSTGDTAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRUSTEECLAIM", "TRSTGDTAIL", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TRUSTEECLAIM__TRSTGDTAIL(null, null, null, isOnLoad);
}
</script>
...
<div id="id938bd29a670b4e8e8b5dcf62a3b4d14b" class="general-layout-container">
...
<div id="frmExGratia" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading24" runat="server" Text="Ex Gratia" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TRUSTEECLAIM__TRSTGDTAIL"
		data-field-type="Child" 
		data-object-name="TRUSTEECLAIM" 
		data-property-name="TRSTGDTAIL" 
		id="pb-container-childscreen-TRUSTEECLAIM-TRSTGDTAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TRUSTEECLAIM__AUTH_DETAILS" runat="server" ScreenCode="TRSTGDTAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRSTGDTAIL/TRSTGDTAIL_Ex_Gratia.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Reason" DataField="R_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTRUSTEECLAIM_TRSTGDTAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TRUSTEECLAIM.TRSTGDTAIL"
						ClientValidationFunction="onValidate_TRUSTEECLAIM__TRSTGDTAIL" 
						Display="None"
