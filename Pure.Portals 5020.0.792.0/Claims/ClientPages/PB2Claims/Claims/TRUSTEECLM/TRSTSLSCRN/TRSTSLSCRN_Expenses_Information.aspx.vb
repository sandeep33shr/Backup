...
Namespace Nexus
    Partial Class PB2_TRSTSLSCRN_Expenses_Information : Inherits BaseClaim
...
End Sub
Protected Sub onValidate_SCHEDULE_LOSS__BASEPARTYKEY()
          
End Sub
Protected Sub onValidate_SCHEDULE_LOSS__BANKLIST()
              
End Sub
Protected Sub onValidate_SCHEDULE_LOSS__Comments()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_SCHEDULE_LOSS__ITEM_NUMBER()
    onValidate_SCHEDULE_LOSS__BASEPARTYKEY()
    onValidate_SCHEDULE_LOSS__BANKLIST()
    onValidate_SCHEDULE_LOSS__Comments()
End Sub
          ...
          Protected Shadows Sub Page_Load1(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
                    ...
                    If (sTransactionType <> "PAYCLAIM") Then
                        ...
                        Dim sReserveId As String = GetAutoNumber("//TRUSTEECLAIM/SCHEDULE_LOSS", sXMLDataset)
                        If sReserveId <> "0" Then
                            SCHEDULE_LOSS__ITEM_NUMBER.Text = "E" & sReserveId
                        End If
                                    ...
                                    If oLastNode.Attributes("ITEM_NUMBER") Is Nothing Then
                                        ...
                                        If oNode IsNot Nothing Then
                                            If oNode.Attributes("ITEM_NUMBER") IsNot Nothing Then
                                                Dim nLossIdValue = CInt(oNode.Attributes("ITEM_NUMBER").Value.Replace("E", "")) + 1
        ...
        Protected Shadows Sub Page_Load2(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
                    ...
                    End If
                    SCHEDULE_LOSS__BASEPARTYKEY.Text = partyKey.ToString
        End Sub
                ...
                Protected Shadows Sub LoadPartyKey(ByVal partyKey As Int32)
                    ...
                    Dim lScheme As Object = oMaster.FindControl("SCHEDULE_LOSS__BANKLIST")
                ...
                Public Function jsFormat(ByVal propertyName As String, ByVal result As String) As String
                    ...
                    Return "Field.getInstance('SCHEDULE_LOSS', '" + propertyName + "').setValue('" + result + "');"
        
                End Function
    
        
        Protected Shadows Sub btnNextTop_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNextTop.Click
        	Dim PaymentMethod As String = SCHEDULE_LOSS__PAYMENT_TYPE.Text
        ...
        Protected Sub ValidateBank()
        	...
        	Dim sAccountNumber As String = SCHEDULE_LOSS__Branch_Code.Text & "|" & SCHEDULE_LOSS__Bank_Account_No.Text & "|" & SCHEDULE_LOSS__Account_Type.Text
        	Dim oWebService As NexusProvider.ProviderBase = New NexusProvider.ProviderManager().Provider
        	Dim sBank As String = SCHEDULE_LOSS__Bank_Name.Text
