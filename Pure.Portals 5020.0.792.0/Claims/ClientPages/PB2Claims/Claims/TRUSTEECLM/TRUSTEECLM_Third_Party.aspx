<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="TRUSTEECLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_TRUSTEECLM_Third_Party" %>
...
function onValidate_TRUSTEECLAIM__TRSTTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TRUSTEECLAIM", "TRSTTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TRUSTEECLAIM__TRSTTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="ida3938483c58b4240a1edcb604a2bdc99" class="general-layout-container">
...
<div id="id7be4b41098bb4600a0126873ed0924af" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TRUSTEECLAIM__TRSTTPARTY"
		data-field-type="Child" 
		data-object-name="TRUSTEECLAIM" 
		data-property-name="TRSTTPARTY" 
		id="pb-container-childscreen-TRUSTEECLAIM-TRSTTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TRUSTEECLAIM__TRUSTEETHIRD" runat="server" ScreenCode="TRSTTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TRSTTPARTY/TRSTTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTRUSTEECLAIM_TRSTTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TRUSTEECLAIM.TRSTTPARTY"
						ClientValidationFunction="onValidate_TRUSTEECLAIM__TRSTTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7be4b41098bb4600a0126873ed0924af div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7be4b41098bb4600a0126873ed0924af div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7be4b41098bb4600a0126873ed0924af div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7be4b41098bb4600a0126873ed0924af label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7be4b41098bb4600a0126873ed0924af label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7be4b41098bb4600a0126873ed0924af label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7be4b41098bb4600a0126873ed0924af label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7be4b41098bb4600a0126873ed0924af input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7be4b41098bb4600a0126873ed0924af input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7be4b41098bb4600a0126873ed0924af input{text-align:left;}"; break;
		}
	}
