<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBITMCL_Machinery_Breakdown_Item_Details.aspx.vb" Inherits="Nexus.PB2_MBITMCL_Machinery_Breakdown_Item_Details" %>
...
function onValidate_MB_ITEM__DESCRIPTN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "DESCRIPTN", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
...
function onValidate_MB_ITEM__MBITMPCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMPCLM", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MB_ITEM The object name of the control to set.
         * @parma MBITEM_CLAUSEPREM The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MB_ITEM__MBITEM_CLAUSEPREM.ClientID %>').find('table').find('tr').each(function () {
...
function onValidate_MB_ITEM__MBITMNTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMNTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MB_ITEM The object name of the control to set.
         * @parma MBITEM_CNOTE The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MB_ITEM__MBITEM_CNOTE.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_MB_ITEM__MBITMSNTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBITMSNTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MB_ITEM The object name of the control to set.
         * @parma MBITEM_SCNOTE The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MB_ITEM__MBITEM_SCNOTE.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MB_ITEM__MBITMPCLM(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBITMNTCL(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBITMSNTCL(null, null, null, isOnLoad);
}
</script>
...
<div id="id5e1d24d45d6645bdb46056c0887c3c36" class="general-layout-container">
...
<div id="id51fd895d0eef4cfdb0544d877f6a0cf5" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_ITEM-DESCRIPTN">

		
		<asp:Label ID="lblMB_ITEM_DESCRIPTN" runat="server" AssociatedControlID="MB_ITEM__DESCRIPTN" 
			Text="Description" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="MB_ITEM__DESCRIPTN" runat="server" CssClass="form-control" data-type="Text" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id51fd895d0eef4cfdb0544d877f6a0cf5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id51fd895d0eef4cfdb0544d877f6a0cf5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id51fd895d0eef4cfdb0544d877f6a0cf5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id51fd895d0eef4cfdb0544d877f6a0cf5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id51fd895d0eef4cfdb0544d877f6a0cf5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id51fd895d0eef4cfdb0544d877f6a0cf5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id51fd895d0eef4cfdb0544d877f6a0cf5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id51fd895d0eef4cfdb0544d877f6a0cf5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id51fd895d0eef4cfdb0544d877f6a0cf5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id51fd895d0eef4cfdb0544d877f6a0cf5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id718a677974cf4729b9b2ddf20278a50c" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading212" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMPCLM"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMPCLM" 
		id="pb-container-childscreen-MB_ITEM-MBITMPCLM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_CLAUSEPREM" runat="server" ScreenCode="MBITMPCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMPCLM/MBITMPCLM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMPCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMPCLM"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMPCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id718a677974cf4729b9b2ddf20278a50c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id718a677974cf4729b9b2ddf20278a50c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id718a677974cf4729b9b2ddf20278a50c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id718a677974cf4729b9b2ddf20278a50c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id718a677974cf4729b9b2ddf20278a50c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id718a677974cf4729b9b2ddf20278a50c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id718a677974cf4729b9b2ddf20278a50c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id718a677974cf4729b9b2ddf20278a50c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id718a677974cf4729b9b2ddf20278a50c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id718a677974cf4729b9b2ddf20278a50c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="iddc60384495934e3788544cbd37a670d4" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading213" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMNTCL"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMNTCL" 
		id="pb-container-childscreen-MB_ITEM-MBITMNTCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_CNOTE" runat="server" ScreenCode="MBITMNTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMNTCL/MBITMNTCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMNTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMNTCL"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMNTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#iddc60384495934e3788544cbd37a670d4 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#iddc60384495934e3788544cbd37a670d4 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#iddc60384495934e3788544cbd37a670d4 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#iddc60384495934e3788544cbd37a670d4 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#iddc60384495934e3788544cbd37a670d4 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddc60384495934e3788544cbd37a670d4 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddc60384495934e3788544cbd37a670d4 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#iddc60384495934e3788544cbd37a670d4 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#iddc60384495934e3788544cbd37a670d4 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#iddc60384495934e3788544cbd37a670d4 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idad649a72f5b747728d4b615a473a0a6e" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading214" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBITMSNTCL"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBITMSNTCL" 
		id="pb-container-childscreen-MB_ITEM-MBITMSNTCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_SCNOTE" runat="server" ScreenCode="MBITMSNTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMSNTCL/MBITMSNTCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBITMSNTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBITMSNTCL"
						ClientValidationFunction="onValidate_MB_ITEM__MBITMSNTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idad649a72f5b747728d4b615a473a0a6e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idad649a72f5b747728d4b615a473a0a6e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idad649a72f5b747728d4b615a473a0a6e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idad649a72f5b747728d4b615a473a0a6e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idad649a72f5b747728d4b615a473a0a6e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idad649a72f5b747728d4b615a473a0a6e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idad649a72f5b747728d4b615a473a0a6e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idad649a72f5b747728d4b615a473a0a6e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idad649a72f5b747728d4b615a473a0a6e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idad649a72f5b747728d4b615a473a0a6e input{text-align:left;}"; break;
		}
	}
