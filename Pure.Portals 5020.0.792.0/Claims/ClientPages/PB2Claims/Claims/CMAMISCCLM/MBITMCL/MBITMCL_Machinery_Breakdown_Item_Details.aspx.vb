...
Namespace Nexus
    Partial Class PB2_MBITMCL_Machinery_Breakdown_Item_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_MB_ITEM__MBITMPCLM()
        
End Sub
Protected Sub onValidate_MB_ITEM__MBITMNTCL()
        
End Sub
Protected Sub onValidate_MB_ITEM__MBITMSNTCL()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MB_ITEM__MBITMPCLM()
    onValidate_MB_ITEM__MBITMNTCL()
    onValidate_MB_ITEM__MBITMSNTCL()
End Sub
