...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Deterioration_of_Stock : Inherits BaseClaim
		...
		Protected Sub onValidate_DSTOCK__DSITMCL()
        
End Sub
Protected Sub onValidate_DSTOCK__DSEPCLM()
        
End Sub
Protected Sub onValidate_DSTOCK__DSNTSCL()
        
End Sub
Protected Sub onValidate_DSTOCK__DSSNTSCL()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DSTOCK__DSITMCL()
    onValidate_DSTOCK__DSEPCLM()
    onValidate_DSTOCK__DSNTSCL()
    onValidate_DSTOCK__DSSNTSCL()
End Sub
