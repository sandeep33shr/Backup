<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISCCLM_Stated_Benefits.aspx.vb" Inherits="Nexus.PB2_CMAMISCCLM_Stated_Benefits" %>
...
function onValidate_STATED_COVER__IS_DEATH(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_COVER", "IS_DEATH");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_COVER__IS_PDTP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_COVER", "IS_PDTP");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_COVER__IS_DISTOT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_COVER", "IS_DISTOT");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_COVER__IS_DISPAR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_COVER", "IS_DISPAR");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_COVER__IS_MEDEXP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_COVER", "IS_MEDEXP");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_EXTENSIONS__IS_HIVAE(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_EXTENSIONS", "IS_HIVAE");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_EXTENSIONS__IS_HOSP(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_EXTENSIONS", "IS_HOSP");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_EXTENSIONS__IS_SILL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_EXTENSIONS", "IS_SILL");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_EXTENSIONS__IS_TTDSICK(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_EXTENSIONS", "IS_TTDSICK");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_EXTENSIONS__IS_WAR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_EXTENSIONS", "IS_WAR");
        	field.setReadOnly(true);
        })();
}
function onValidate_STATED_SERVICES__IS_HIV(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_SERVICES", "IS_HIV");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED_SERVICES__IS_ACC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("STATED_SERVICES", "IS_ACC");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_STATED__CLMSBEND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STATED", "CLMSBEND", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param STATED The object name of the control to set.
         * @parma STATED_CLAUSEPREM The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=STATED__STATED_CLAUSEPREM.ClientID %>').find('table').find('tr').each(function () {
...
function onValidate_STATED__CLMSBNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STATED", "CLMSBNOTE", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param STATED The object name of the control to set.
         * @parma STATED_CNOTES_DETAILS The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=STATED__STATED_CNOTES_DETAILS.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_STATED__CLMSBSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STATED", "CLMSBSNOTE", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param STATED The object name of the control to set.
         * @parma STATED_SCNOTES_DETAILS The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=STATED__STATED_SCNOTES_DETAILS.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function DoLogic(isOnLoad) {
    ...
    onValidate_STATED__CLMSBEND(null, null, null, isOnLoad);
    onValidate_STATED__CLMSBNOTE(null, null, null, isOnLoad);
    onValidate_STATED__CLMSBSNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="idd51b2687369f4107a5e156adc13ea60c" class="general-layout-container">
...
<div id="id157bce9baa1c423fa9c981c50fe96d19" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id157bce9baa1c423fa9c981c50fe96d19 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id157bce9baa1c423fa9c981c50fe96d19 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id157bce9baa1c423fa9c981c50fe96d19 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id157bce9baa1c423fa9c981c50fe96d19 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id157bce9baa1c423fa9c981c50fe96d19 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id157bce9baa1c423fa9c981c50fe96d19 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id157bce9baa1c423fa9c981c50fe96d19 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id157bce9baa1c423fa9c981c50fe96d19 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id157bce9baa1c423fa9c981c50fe96d19 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id157bce9baa1c423fa9c981c50fe96d19 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id8bb4c65fb5c54daf9ada32566da8ee7e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading136" runat="server" Text="Stated Benefits" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id8bb4c65fb5c54daf9ada32566da8ee7e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id8bb4c65fb5c54daf9ada32566da8ee7e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id8bb4c65fb5c54daf9ada32566da8ee7e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id8bb4c65fb5c54daf9ada32566da8ee7e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id8bb4c65fb5c54daf9ada32566da8ee7e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8bb4c65fb5c54daf9ada32566da8ee7e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8bb4c65fb5c54daf9ada32566da8ee7e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id8bb4c65fb5c54daf9ada32566da8ee7e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id8bb4c65fb5c54daf9ada32566da8ee7e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id8bb4c65fb5c54daf9ada32566da8ee7e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id390bdb7b810f46ba91d8f2fac71e29fb" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading137" runat="server" Text="Employee Details" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id390bdb7b810f46ba91d8f2fac71e29fb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id390bdb7b810f46ba91d8f2fac71e29fb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id390bdb7b810f46ba91d8f2fac71e29fb div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id390bdb7b810f46ba91d8f2fac71e29fb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id390bdb7b810f46ba91d8f2fac71e29fb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id390bdb7b810f46ba91d8f2fac71e29fb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id390bdb7b810f46ba91d8f2fac71e29fb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id390bdb7b810f46ba91d8f2fac71e29fb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id390bdb7b810f46ba91d8f2fac71e29fb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id390bdb7b810f46ba91d8f2fac71e29fb input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id348be96f73c64675aa13a380ecd47b7f" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading138" runat="server" Text="Cover Details" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label280">
		<span class="label" id="label280">No of Years</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label281">
		<span class="label" id="label281">No of Weeks</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label282">
		<span class="label" id="label282">Sum Insured/Limit</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label283">
		<span class="label" id="label283">Death </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label286">
		<span class="label" id="label286">Permanent Disability Total/Partial</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label289">
		<span class="label" id="label289">Temporary Disability : Total</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label292">
		<span class="label" id="label292">Temporary  Disability: Partial </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label295">
		<span class="label" id="label295">Medical Expenses </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id348be96f73c64675aa13a380ecd47b7f div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id348be96f73c64675aa13a380ecd47b7f div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id348be96f73c64675aa13a380ecd47b7f div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id348be96f73c64675aa13a380ecd47b7f label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id348be96f73c64675aa13a380ecd47b7f label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id348be96f73c64675aa13a380ecd47b7f label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id348be96f73c64675aa13a380ecd47b7f label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id348be96f73c64675aa13a380ecd47b7f input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id348be96f73c64675aa13a380ecd47b7f input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id348be96f73c64675aa13a380ecd47b7f input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id97c8061a59f24476a28d2052fdadd99a" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading139" runat="server" Text="First Amount Payable" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label300">
		<span class="label" id="label300">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label301">
		<span class="label" id="label301">Min Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label302">
		<span class="label" id="label302">Time Excess (days)</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label304">
		<span class="label" id="label304">Medical Expenses</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label307">
		<span class="label" id="label307">Temporary Disability</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id97c8061a59f24476a28d2052fdadd99a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id97c8061a59f24476a28d2052fdadd99a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id97c8061a59f24476a28d2052fdadd99a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id97c8061a59f24476a28d2052fdadd99a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id97c8061a59f24476a28d2052fdadd99a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id97c8061a59f24476a28d2052fdadd99a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id97c8061a59f24476a28d2052fdadd99a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id97c8061a59f24476a28d2052fdadd99a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id97c8061a59f24476a28d2052fdadd99a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id97c8061a59f24476a28d2052fdadd99a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id4216dca2191149159be0683364697807" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading140" runat="server" Text="Extensions" /></legend>
				
				
				<div data-column-count="7" data-column-ratio="5:22:14:17:14:14:14" data-layout="" class="clearfix form-horizontal">
...
<!-- /Label -->
	...
	<span id="pb-container-label-label312">
		<span class="label" id="label312">Time Excess</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label313">
		<span class="label" id="label313">Hospitalisation Period</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label314">
		<span class="label" id="label314">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label315">
		<span class="label" id="label315">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label316">
		<span class="label" id="label316">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label317">
		<span class="label" id="label317">HIV Accidental Exposure </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label322">
		<span class="label" id="label322">Hospitalisation </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label325">
		<span class="label" id="label325">Serious Illness</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label327">
		<span class="label" id="label327">Temporary Total Disablement - Sickness </span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label329">
		<span class="label" id="label329">War Risk </span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id4216dca2191149159be0683364697807 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4216dca2191149159be0683364697807 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4216dca2191149159be0683364697807 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id4216dca2191149159be0683364697807 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4216dca2191149159be0683364697807 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4216dca2191149159be0683364697807 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4216dca2191149159be0683364697807 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4216dca2191149159be0683364697807 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4216dca2191149159be0683364697807 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4216dca2191149159be0683364697807 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide9d23f8b49334a94959a687ec16a7b23" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading141" runat="server" Text="Assistance Services" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label337">
		<span class="label" id="label337">No of Employees</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label341">
		<span class="label" id="label341">HIV/Aids Assistance</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label344">
		<span class="label" id="label344"></span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label345">
		<span class="label" id="label345">Accidental Expert Assistance</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide9d23f8b49334a94959a687ec16a7b23 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide9d23f8b49334a94959a687ec16a7b23 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide9d23f8b49334a94959a687ec16a7b23 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide9d23f8b49334a94959a687ec16a7b23 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide9d23f8b49334a94959a687ec16a7b23 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide9d23f8b49334a94959a687ec16a7b23 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide9d23f8b49334a94959a687ec16a7b23 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide9d23f8b49334a94959a687ec16a7b23 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide9d23f8b49334a94959a687ec16a7b23 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide9d23f8b49334a94959a687ec16a7b23 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id439606dd9e254bd0bfa537a3e19ede8d" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STATED__CLMSBEND"
		data-field-type="Child" 
		data-object-name="STATED" 
		data-property-name="CLMSBEND" 
		id="pb-container-childscreen-STATED-CLMSBEND">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STATED__STATED_CLAUSEPREM" runat="server" ScreenCode="CLMSBEND" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLMSBEND/CLMSBEND_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valSTATED_CLMSBEND" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for STATED.CLMSBEND"
						ClientValidationFunction="onValidate_STATED__CLMSBEND" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id439606dd9e254bd0bfa537a3e19ede8d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id439606dd9e254bd0bfa537a3e19ede8d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id439606dd9e254bd0bfa537a3e19ede8d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id439606dd9e254bd0bfa537a3e19ede8d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id439606dd9e254bd0bfa537a3e19ede8d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id439606dd9e254bd0bfa537a3e19ede8d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id439606dd9e254bd0bfa537a3e19ede8d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id439606dd9e254bd0bfa537a3e19ede8d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id439606dd9e254bd0bfa537a3e19ede8d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id439606dd9e254bd0bfa537a3e19ede8d input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idca7940f73a304383b8323bd35dd6993a" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading143" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STATED__CLMSBNOTE"
		data-field-type="Child" 
		data-object-name="STATED" 
		data-property-name="CLMSBNOTE" 
		id="pb-container-childscreen-STATED-CLMSBNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STATED__STATED_CNOTES_DETAILS" runat="server" ScreenCode="CLMSBNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLMSBNOTE/CLMSBNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valSTATED_CLMSBNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for STATED.CLMSBNOTE"
						ClientValidationFunction="onValidate_STATED__CLMSBNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idca7940f73a304383b8323bd35dd6993a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idca7940f73a304383b8323bd35dd6993a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idca7940f73a304383b8323bd35dd6993a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idca7940f73a304383b8323bd35dd6993a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idca7940f73a304383b8323bd35dd6993a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idca7940f73a304383b8323bd35dd6993a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idca7940f73a304383b8323bd35dd6993a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idca7940f73a304383b8323bd35dd6993a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idca7940f73a304383b8323bd35dd6993a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idca7940f73a304383b8323bd35dd6993a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id5525d55cb7fa42f08281f77fb8b0bf8e" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STATED__CLMSBSNOTE"
		data-field-type="Child" 
		data-object-name="STATED" 
		data-property-name="CLMSBSNOTE" 
		id="pb-container-childscreen-STATED-CLMSBSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STATED__STATED_SCNOTES_DETAILS" runat="server" ScreenCode="CLMSBSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLMSBSNOTE/CLMSBSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valSTATED_CLMSBSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for STATED.CLMSBSNOTE"
						ClientValidationFunction="onValidate_STATED__CLMSBSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id5525d55cb7fa42f08281f77fb8b0bf8e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id5525d55cb7fa42f08281f77fb8b0bf8e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id5525d55cb7fa42f08281f77fb8b0bf8e div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id5525d55cb7fa42f08281f77fb8b0bf8e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id5525d55cb7fa42f08281f77fb8b0bf8e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5525d55cb7fa42f08281f77fb8b0bf8e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5525d55cb7fa42f08281f77fb8b0bf8e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id5525d55cb7fa42f08281f77fb8b0bf8e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id5525d55cb7fa42f08281f77fb8b0bf8e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id5525d55cb7fa42f08281f77fb8b0bf8e input{text-align:left;}"; break;
		}
	}
