<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISCCLM_Consequential_Loss.aspx.vb" Inherits="Nexus.PB2_CMAMISCCLM_Consequential_Loss" %>
...
function onValidate_CLOSS__CEPCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CEPCLM", "ChildScreen");
        })();
        /** 
...
function onValidate_CLOSS__CLNTSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CLNTSCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param CLOSS The object name of the control to set.
...
function onValidate_CLOSS__CLSNTSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CLOSS", "CLSNTSCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param CLOSS The object name of the control to set.
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CLOSS__CEPCLM(null, null, null, isOnLoad);
    onValidate_CLOSS__CLNTSCL(null, null, null, isOnLoad);
    onValidate_CLOSS__CLSNTSCL(null, null, null, isOnLoad);
}
</script>
...
<div id="id10ee3de8b6e946e0b30eb9d4d64237c2" class="general-layout-container">
...
<div id="id7c9a39589d9f43408857be75d4d7f12a" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id7c9a39589d9f43408857be75d4d7f12a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7c9a39589d9f43408857be75d4d7f12a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7c9a39589d9f43408857be75d4d7f12a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7c9a39589d9f43408857be75d4d7f12a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7c9a39589d9f43408857be75d4d7f12a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7c9a39589d9f43408857be75d4d7f12a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7c9a39589d9f43408857be75d4d7f12a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7c9a39589d9f43408857be75d4d7f12a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7c9a39589d9f43408857be75d4d7f12a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7c9a39589d9f43408857be75d4d7f12a input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id31169eb04bf2405d882478be72bfd218" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading243" runat="server" Text="Consequential Loss " /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id31169eb04bf2405d882478be72bfd218 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id31169eb04bf2405d882478be72bfd218 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id31169eb04bf2405d882478be72bfd218 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id31169eb04bf2405d882478be72bfd218 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id31169eb04bf2405d882478be72bfd218 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id31169eb04bf2405d882478be72bfd218 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id31169eb04bf2405d882478be72bfd218 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id31169eb04bf2405d882478be72bfd218 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id31169eb04bf2405d882478be72bfd218 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id31169eb04bf2405d882478be72bfd218 input{text-align:left;}"; break;
		}
	}
...
<div id="frmCLEXT" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading245" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label461">
		<span class="label" id="label461">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label462">
		<span class="label" id="label462">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label463">
		<span class="label" id="label463">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label464">
		<span class="label" id="label464">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label467">
		<span class="label" id="label467">Additional Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label468">
		<span class="label" id="label468">Increase Cost of Working</span>
	</span>
<!-- /Label -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="frmCLEnd" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CEPCLM"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CEPCLM" 
		id="pb-container-childscreen-CLOSS-CEPCLM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_CLAUSEPREM" runat="server" ScreenCode="CEPCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CEPCLM/CEPCLM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valCLOSS_CEPCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CEPCLM"
						ClientValidationFunction="onValidate_CLOSS__CEPCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div id="frmCLNotes" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading247" runat="server" Text="Consequential Loss Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CLNTSCL"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CLNTSCL" 
		id="pb-container-childscreen-CLOSS-CLNTSCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_NOTES" runat="server" ScreenCode="CLNTSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLNTSCL/CLNTSCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCLOSS_CLNTSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CLNTSCL"
						ClientValidationFunction="onValidate_CLOSS__CLNTSCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div id="frmCLSNotes" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading248" runat="server" Text="Consequential Loss Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CLOSS__CLSNTSCL"
		data-field-type="Child" 
		data-object-name="CLOSS" 
		data-property-name="CLSNTSCL" 
		id="pb-container-childscreen-CLOSS-CLSNTSCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CLOSS__CL_SNOTES" runat="server" ScreenCode="CLSNTSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLSNTSCL/CLSNTSCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCLOSS_CLSNTSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CLOSS.CLSNTSCL"
						ClientValidationFunction="onValidate_CLOSS__CLSNTSCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
