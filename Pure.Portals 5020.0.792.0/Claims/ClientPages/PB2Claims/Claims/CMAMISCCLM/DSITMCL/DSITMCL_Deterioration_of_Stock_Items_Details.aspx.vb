...
Namespace Nexus
    Partial Class PB2_DSITMCL_Deterioration_of_Stock_Items_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_DS_ITEM__DSIEPCLM()
        
End Sub
Protected Sub onValidate_DS_ITEM__DSINTSCL()
        
End Sub
Protected Sub onValidate_DS_ITEM__DSISNTSCL()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DS_ITEM__DSIEPCLM()
    onValidate_DS_ITEM__DSINTSCL()
    onValidate_DS_ITEM__DSISNTSCL()
End Sub
