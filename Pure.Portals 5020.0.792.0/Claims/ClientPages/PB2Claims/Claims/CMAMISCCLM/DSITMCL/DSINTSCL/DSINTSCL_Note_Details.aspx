<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DSINTSCL_Note_Details.aspx.vb" Inherits="Nexus.PB2_DSINTSCL_Note_Details" %>
...
<div id="id144df7b479144bd09d5ad50128dbd8dc" class="general-layout-container">
...
<div id="ide1d8bc8b2a9a4528be7c574353f33ac1" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ide1d8bc8b2a9a4528be7c574353f33ac1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide1d8bc8b2a9a4528be7c574353f33ac1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide1d8bc8b2a9a4528be7c574353f33ac1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ide1d8bc8b2a9a4528be7c574353f33ac1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide1d8bc8b2a9a4528be7c574353f33ac1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide1d8bc8b2a9a4528be7c574353f33ac1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide1d8bc8b2a9a4528be7c574353f33ac1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide1d8bc8b2a9a4528be7c574353f33ac1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide1d8bc8b2a9a4528be7c574353f33ac1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide1d8bc8b2a9a4528be7c574353f33ac1 input{text-align:left;}"; break;
		}
	}
