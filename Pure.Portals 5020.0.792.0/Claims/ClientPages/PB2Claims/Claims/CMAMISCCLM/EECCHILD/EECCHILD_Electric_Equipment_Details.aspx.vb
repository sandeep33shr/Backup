...
Namespace Nexus
    Partial Class PB2_EECCHILD_Electric_Equipment_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_ELECTEQ__EECCHLDEP()
        
End Sub
Protected Sub onValidate_ELECTEQ__EECNOTES()
        
End Sub
Protected Sub onValidate_ELECTEQ__EESCNOTES()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ELECTEQ__EECCHLDEP()
    onValidate_ELECTEQ__EECNOTES()
    onValidate_ELECTEQ__EESCNOTES()
End Sub
