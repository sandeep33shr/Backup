<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CLMMNYSAFE_Type_of_Safe.aspx.vb" Inherits="Nexus.PB2_CLMMNYSAFE_Type_of_Safe" %>
...
<div id="id59c68c5c62d6421fb153050038704206" class="general-layout-container">
...
<div id="idf1ec714412344b5fae34d0624e6bedfe" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading70" runat="server" Text="Type of Safe" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf1ec714412344b5fae34d0624e6bedfe div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf1ec714412344b5fae34d0624e6bedfe div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf1ec714412344b5fae34d0624e6bedfe div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf1ec714412344b5fae34d0624e6bedfe label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf1ec714412344b5fae34d0624e6bedfe label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf1ec714412344b5fae34d0624e6bedfe label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf1ec714412344b5fae34d0624e6bedfe label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf1ec714412344b5fae34d0624e6bedfe input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf1ec714412344b5fae34d0624e6bedfe input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf1ec714412344b5fae34d0624e6bedfe input{text-align:left;}"; break;
		}
	}
