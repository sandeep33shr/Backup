<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="EECMP_Multiple_Premises.aspx.vb" Inherits="Nexus.PB2_EECMP_Multiple_Premises" %>
...
<div id="id58dfe405919545ce90bdf690a0a203cd" class="general-layout-container">
...
<div id="id4ddad1ace0ad416caf2f494f6f89bd45" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading180" runat="server" Text="Multiple Premises" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id4ddad1ace0ad416caf2f494f6f89bd45 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id4ddad1ace0ad416caf2f494f6f89bd45 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id4ddad1ace0ad416caf2f494f6f89bd45 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id4ddad1ace0ad416caf2f494f6f89bd45 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id4ddad1ace0ad416caf2f494f6f89bd45 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4ddad1ace0ad416caf2f494f6f89bd45 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4ddad1ace0ad416caf2f494f6f89bd45 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id4ddad1ace0ad416caf2f494f6f89bd45 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id4ddad1ace0ad416caf2f494f6f89bd45 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id4ddad1ace0ad416caf2f494f6f89bd45 input{text-align:left;}"; break;
		}
	}
