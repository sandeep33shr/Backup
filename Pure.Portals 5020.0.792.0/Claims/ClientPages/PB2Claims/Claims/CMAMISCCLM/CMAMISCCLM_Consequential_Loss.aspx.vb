...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Consequential_Loss : Inherits BaseClaim
		...
		Protected Sub onValidate_CLOSS__CEPCLM()
        
End Sub
Protected Sub onValidate_CLOSS__CLNTSCL()
        
End Sub
Protected Sub onValidate_CLOSS__CLSNTSCL()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CLOSS__CEPCLM()
    onValidate_CLOSS__CLNTSCL()
    onValidate_CLOSS__CLSNTSCL()
End Sub
