<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISCCLM_Machinery_Breakdown.aspx.vb" Inherits="Nexus.PB2_CMAMISCCLM_Machinery_Breakdown" %>
...
function onValidate_MBREAK__MBITMCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBITMCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
         * @parma MB_ITEM The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MBREAK__MB_ITEM.ClientID %>').find('table').find('tr').each(function () {
...
function onValidate_MBREAK__IS_ACPC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("MBREAK", "IS_ACPC");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_MBREAK__IS_EDO(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("MBREAK", "IS_EDO");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_MBREAK__IS_FMR(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("MBREAK", "IS_FMR");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_MBREAK__IS_RIOT(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("MBREAK", "IS_RIOT");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_MBREAK__MBOTXTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBOTXTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
         * @parma MB_OEXTENSIONS The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MBREAK__MB_OEXTENSIONS.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_MBREAK__MBFAPCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBFAPCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
         * @parma MB_FAP The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MBREAK__MB_FAP.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_MBREAK__MBEPCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBEPCLM", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
         * @parma MB_CLAUSEPREM The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MBREAK__MB_CLAUSEPREM.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_MBREAK__MBNTSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBNTSCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
         * @parma MB_NOTES The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MBREAK__MB_NOTES.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_MBREAK__MBSNTSCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBSNTSCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
         * @parma MB_SNOTES The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=MBREAK__MB_SNOTES.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MBREAK__MBITMCL(null, null, null, isOnLoad);
    ...
    onValidate_MBREAK__MBOTXTCL(null, null, null, isOnLoad);
    onValidate_MBREAK__MBFAPCL(null, null, null, isOnLoad);
    onValidate_MBREAK__MBEPCLM(null, null, null, isOnLoad);
    onValidate_MBREAK__MBNTSCL(null, null, null, isOnLoad);
    onValidate_MBREAK__MBSNTSCL(null, null, null, isOnLoad);
}
</script>
...
<div id="id2619dc7c3abc428bbc4fa4cb87e4969f" class="general-layout-container">
...
<div id="id1a5ad326d78c41659ad376f742f4ae08" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1a5ad326d78c41659ad376f742f4ae08 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1a5ad326d78c41659ad376f742f4ae08 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1a5ad326d78c41659ad376f742f4ae08 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1a5ad326d78c41659ad376f742f4ae08 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1a5ad326d78c41659ad376f742f4ae08 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1a5ad326d78c41659ad376f742f4ae08 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1a5ad326d78c41659ad376f742f4ae08 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1a5ad326d78c41659ad376f742f4ae08 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1a5ad326d78c41659ad376f742f4ae08 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1a5ad326d78c41659ad376f742f4ae08 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id48bf4a702844491c877acd534b9e44ca" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading227" runat="server" Text="Machinery Breakdown" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id48bf4a702844491c877acd534b9e44ca div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id48bf4a702844491c877acd534b9e44ca div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id48bf4a702844491c877acd534b9e44ca div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id48bf4a702844491c877acd534b9e44ca label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id48bf4a702844491c877acd534b9e44ca label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id48bf4a702844491c877acd534b9e44ca label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id48bf4a702844491c877acd534b9e44ca label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id48bf4a702844491c877acd534b9e44ca input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id48bf4a702844491c877acd534b9e44ca input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id48bf4a702844491c877acd534b9e44ca input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idad8ecc0bf8d34baf9db307c43983fb7d" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBITMCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBITMCL" 
		id="pb-container-childscreen-MBREAK-MBITMCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_ITEM" runat="server" ScreenCode="MBITMCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBITMCL/MBITMCL_Machinery_Breakdown_Item_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:GISLookupField HeaderText="Basis of Deductible " ListType="PMLookup" ListCode="UDL_CMA_MBCL_BOD" DataField="BASEDEDUCT" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valMBREAK_MBITMCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBITMCL"
						ClientValidationFunction="onValidate_MBREAK__MBITMCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idad8ecc0bf8d34baf9db307c43983fb7d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idad8ecc0bf8d34baf9db307c43983fb7d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idad8ecc0bf8d34baf9db307c43983fb7d div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idad8ecc0bf8d34baf9db307c43983fb7d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idad8ecc0bf8d34baf9db307c43983fb7d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idad8ecc0bf8d34baf9db307c43983fb7d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idad8ecc0bf8d34baf9db307c43983fb7d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idad8ecc0bf8d34baf9db307c43983fb7d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idad8ecc0bf8d34baf9db307c43983fb7d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idad8ecc0bf8d34baf9db307c43983fb7d input{text-align:left;}"; break;
		}
	}
...
<div id="frmMBE" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading229" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label449">
		<span class="label" id="label449">Limit of Indemnity</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label450">
		<span class="label" id="label450">FAP %</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label451">
		<span class="label" id="label451">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label452">
		<span class="label" id="label452">Additional Claims Preparation Costs</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label455">
		<span class="label" id="label455">Express Delivery and Overtime</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label456">
		<span class="label" id="label456">Foundations and Masonry Refractories</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label457">
		<span class="label" id="label457">Riot and Strike </span>
	</span>
<!-- /Label -->
...
<div id="frmMBEChild" class="column-layout-container  ">
	              ...
	              <legend><asp:Label ID="lblHeading230" runat="server" Text="" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBOTXTCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBOTXTCL" 
		id="pb-container-childscreen-MBREAK-MBOTXTCL">
		
		    <legend>Other Machinery Breakdown Extensions</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_OEXTENSIONS" runat="server" ScreenCode="MBOTXTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBOTXTCL/MBOTXTCL_Other_Machinery_Breakdown_Extensions.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MBOTXTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Other Machinery Breakdown Extensions"
						ClientValidationFunction="onValidate_MBREAK__MBOTXTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ide7ec1a016a4d47b0a8ba354fdc94789c" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBFAPCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBFAPCL" 
		id="pb-container-childscreen-MBREAK-MBFAPCL">
		
		    <legend>First Amount Payable </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_FAP" runat="server" ScreenCode="MBFAPCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBFAPCL/MBFAPCL_First_Amount_Payable.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="FAPCHILD_MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MBFAPCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for First Amount Payable "
						ClientValidationFunction="onValidate_MBREAK__MBFAPCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ide7ec1a016a4d47b0a8ba354fdc94789c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ide7ec1a016a4d47b0a8ba354fdc94789c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ide7ec1a016a4d47b0a8ba354fdc94789c div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ide7ec1a016a4d47b0a8ba354fdc94789c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ide7ec1a016a4d47b0a8ba354fdc94789c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide7ec1a016a4d47b0a8ba354fdc94789c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide7ec1a016a4d47b0a8ba354fdc94789c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ide7ec1a016a4d47b0a8ba354fdc94789c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ide7ec1a016a4d47b0a8ba354fdc94789c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ide7ec1a016a4d47b0a8ba354fdc94789c input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb54ea01790c9456d8a31658362118783" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading232" runat="server" Text="Endorsements" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBEPCLM"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBEPCLM" 
		id="pb-container-childscreen-MBREAK-MBEPCLM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_CLAUSEPREM" runat="server" ScreenCode="MBEPCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBEPCLM/MBEPCLM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valMBREAK_MBEPCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBEPCLM"
						ClientValidationFunction="onValidate_MBREAK__MBEPCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb54ea01790c9456d8a31658362118783 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb54ea01790c9456d8a31658362118783 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb54ea01790c9456d8a31658362118783 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb54ea01790c9456d8a31658362118783 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb54ea01790c9456d8a31658362118783 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb54ea01790c9456d8a31658362118783 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb54ea01790c9456d8a31658362118783 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb54ea01790c9456d8a31658362118783 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb54ea01790c9456d8a31658362118783 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb54ea01790c9456d8a31658362118783 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc79f3555ff1f4d7b858225e41f9777e5" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBNTSCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBNTSCL" 
		id="pb-container-childscreen-MBREAK-MBNTSCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_NOTES" runat="server" ScreenCode="MBNTSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBNTSCL/MBNTSCL_Machinery_Breakdown_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_MBNTSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBNTSCL"
						ClientValidationFunction="onValidate_MBREAK__MBNTSCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc79f3555ff1f4d7b858225e41f9777e5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc79f3555ff1f4d7b858225e41f9777e5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc79f3555ff1f4d7b858225e41f9777e5 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc79f3555ff1f4d7b858225e41f9777e5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc79f3555ff1f4d7b858225e41f9777e5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc79f3555ff1f4d7b858225e41f9777e5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc79f3555ff1f4d7b858225e41f9777e5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc79f3555ff1f4d7b858225e41f9777e5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc79f3555ff1f4d7b858225e41f9777e5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc79f3555ff1f4d7b858225e41f9777e5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idaa17fdec4e464f608c32591928455fb9" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBSNTSCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBSNTSCL" 
		id="pb-container-childscreen-MBREAK-MBSNTSCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_SNOTES" runat="server" ScreenCode="MBSNTSCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBSNTSCL/MBSNTSCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_MBSNTSCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBSNTSCL"
						ClientValidationFunction="onValidate_MBREAK__MBSNTSCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idaa17fdec4e464f608c32591928455fb9 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idaa17fdec4e464f608c32591928455fb9 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idaa17fdec4e464f608c32591928455fb9 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idaa17fdec4e464f608c32591928455fb9 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idaa17fdec4e464f608c32591928455fb9 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaa17fdec4e464f608c32591928455fb9 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaa17fdec4e464f608c32591928455fb9 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idaa17fdec4e464f608c32591928455fb9 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idaa17fdec4e464f608c32591928455fb9 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idaa17fdec4e464f608c32591928455fb9 input{text-align:left;}"; break;
		}
	}
