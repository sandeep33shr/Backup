...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Business_All_Risk : Inherits BaseClaim
		...
		Protected Sub onValidate_BAR__BUSALLRSK()
        
End Sub
Protected Sub onValidate_BAR__BARENDPREM()
        
End Sub
Protected Sub onValidate_BAR__BARNOTES()
        
End Sub
Protected Sub onValidate_BAR__BARSNOTES()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BAR__BUSALLRSK()
    onValidate_BAR__BARENDPREM()
    onValidate_BAR__BARNOTES()
    onValidate_BAR__BARSNOTES()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' BAR = The parent object name of child screen
        ' BALLRISK = The child screen object name
        
        Protected Sub BAR__BALLRISK_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles BAR__BALLRISK.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' BAR = The parent object name of child screen
        ' BAR_CLAUSEPREM = The child screen object name
        
        Protected Sub BAR__BAR_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles BAR__BAR_CLAUSEPREM.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' BAR = The parent object name of child screen
        ' BAR_CNOTE_DETAILS = The child screen object name
        
        Protected Sub BAR__BAR_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles BAR__BAR_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' BAR = The parent object name of child screen
        ' BAR_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub BAR__BAR_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles BAR__BAR_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
