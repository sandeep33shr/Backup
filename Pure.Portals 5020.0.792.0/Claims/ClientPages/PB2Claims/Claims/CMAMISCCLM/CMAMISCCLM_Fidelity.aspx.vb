...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Fidelity : Inherits BaseClaim
		...
		Protected Sub onValidate_FIDGUAR__NCATBASISC()
        
End Sub
Protected Sub onValidate_FIDGUAR__FIDGENDSC()
        
End Sub
Protected Sub onValidate_FIDGUAR__FIDCNOTESC()
        
End Sub
Protected Sub onValidate_FIDGUAR__FIDGNOTESC()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FIDGUAR__NCATBASISC()
    onValidate_FIDGUAR__FIDGENDSC()
    onValidate_FIDGUAR__FIDCNOTESC()
    onValidate_FIDGUAR__FIDGNOTESC()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' FIDGUAR = The parent object name of child screen
        ' GUAR = The child screen object name
        
        Protected Sub FIDGUAR__GUAR_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FIDGUAR__GUAR.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' FIDGUAR = The parent object name of child screen
        ' GEN_CLAUSEPREM = The child screen object name
        
        Protected Sub FIDGUAR__GEN_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FIDGUAR__GEN_CLAUSEPREM.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' FIDGUAR = The parent object name of child screen
        ' FIDGCNOTES = The child screen object name
        
        Protected Sub FIDGUAR__FIDGCNOTES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FIDGUAR__FIDGCNOTES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' FIDGUAR = The parent object name of child screen
        ' FIDGNOTES = The child screen object name
        
        Protected Sub FIDGUAR__FIDGNOTES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FIDGUAR__FIDGNOTES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
