...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Goods_In_Transit : Inherits BaseClaim
		...
		Protected Sub onValidate_GIT__GITENDCLM()
        
End Sub
Protected Sub onValidate_GIT__GITNOTECLM()
        
End Sub
Protected Sub onValidate_GIT__GITSNOTCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GIT__GITENDCLM()
    onValidate_GIT__GITNOTECLM()
    onValidate_GIT__GITSNOTCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' GIT = The parent object name of child screen
        ' GIT_CLAUSEPREM = The child screen object name
        
        Protected Sub GIT__GIT_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GIT__GIT_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' GIT = The parent object name of child screen
        ' GIT_CNOTE_DETAILS = The child screen object name
        
        Protected Sub GIT__GIT_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GIT__GIT_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' GIT = The parent object name of child screen
        ' GIT_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub GIT__GIT_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GIT__GIT_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
