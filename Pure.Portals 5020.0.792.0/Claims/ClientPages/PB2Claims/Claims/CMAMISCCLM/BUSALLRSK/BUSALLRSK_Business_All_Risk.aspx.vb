...
Namespace Nexus
    Partial Class PB2_BUSALLRSK_Business_All_Risk : Inherits BaseClaim
		...
		Protected Sub onValidate_BALLRISK__BARCHLDEP()
        
End Sub
Protected Sub onValidate_BALLRISK__BANOTES()
        
End Sub
Protected Sub onValidate_BALLRISK__BASNOTES()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_BALLRISK__BARCHLDEP()
    onValidate_BALLRISK__BANOTES()
    onValidate_BALLRISK__BASNOTES()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' BALLRISK = The parent object name of child screen
        ' BALLRISK_CLAUSEPREM = The child screen object name
        
        Protected Sub BALLRISK__BALLRISK_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles BALLRISK__BALLRISK_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' BALLRISK = The parent object name of child screen
        ' BALLRISK_CNOTE_DETAILS = The child screen object name
        
        Protected Sub BALLRISK__BALLRISK_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles BALLRISK__BALLRISK_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' BALLRISK = The parent object name of child screen
        ' BALLRISK_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub BALLRISK__BALLRISK_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles BALLRISK__BALLRISK_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
