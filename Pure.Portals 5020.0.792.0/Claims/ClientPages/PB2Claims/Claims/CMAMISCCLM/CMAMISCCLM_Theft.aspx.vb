...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Theft : Inherits BaseClaim
		...
		Protected Sub onValidate_THEFT__CLMTFTEND()
        
End Sub
Protected Sub onValidate_THEFT__CLMTFTNOTE()
        
End Sub
Protected Sub onValidate_THEFT__CLMTFSNOTE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_THEFT__CLMTFTEND()
    onValidate_THEFT__CLMTFTNOTE()
    onValidate_THEFT__CLMTFSNOTE()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' THEFT = The parent object name of child screen
        ' THEFT_CLAUSEPREM = The child screen object name
        
        Protected Sub THEFT__THEFT_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles THEFT__THEFT_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' THEFT = The parent object name of child screen
        ' THEFT_CNOTES_DETAILS = The child screen object name
        
        Protected Sub THEFT__THEFT_CNOTES_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles THEFT__THEFT_CNOTES_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' THEFT = The parent object name of child screen
        ' THEFT_SCNOTES_DETAILS = The child screen object name
        
        Protected Sub THEFT__THEFT_SCNOTES_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles THEFT__THEFT_SCNOTES_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
