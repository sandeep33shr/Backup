...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Money : Inherits BaseClaim
		...
		Protected Sub onValidate_MONEY__CLMMNYSAFE()
        
End Sub
Protected Sub onValidate_MONEY__CLMMNYEND()
        
End Sub
Protected Sub onValidate_MONEY__CLMMNYNOTE()
        
End Sub
Protected Sub onValidate_MONEY__CLMMNSNOTE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MONEY__CLMMNYSAFE()
    onValidate_MONEY__CLMMNYEND()
    onValidate_MONEY__CLMMNYNOTE()
    onValidate_MONEY__CLMMNSNOTE()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MONEY = The parent object name of child screen
        ' MONEY_SAFE = The child screen object name
        
        Protected Sub MONEY__MONEY_SAFE_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MONEY__MONEY_SAFE.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MONEY = The parent object name of child screen
        ' MONEY_CLAUSEPREM = The child screen object name
        
        Protected Sub MONEY__MONEY_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MONEY__MONEY_CLAUSEPREM.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MONEY = The parent object name of child screen
        ' MONEY_CNOTE_DETAILS = The child screen object name
        
        Protected Sub MONEY__MONEY_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MONEY__MONEY_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' MONEY = The parent object name of child screen
        ' MONEY_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub MONEY__MONEY_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles MONEY__MONEY_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
