...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Stated_Benefits : Inherits BaseClaim
		...
		Protected Sub onValidate_STATED__CLMSBEND()
        
End Sub
Protected Sub onValidate_STATED__CLMSBNOTE()
        
End Sub
Protected Sub onValidate_STATED__CLMSBSNOTE()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_STATED__CLMSBEND()
    onValidate_STATED__CLMSBNOTE()
    onValidate_STATED__CLMSBSNOTE()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' STATED = The parent object name of child screen
        ' STATED_CLAUSEPREM = The child screen object name
        
        Protected Sub STATED__STATED_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles STATED__STATED_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' STATED = The parent object name of child screen
        ' STATED_CNOTES_DETAILS = The child screen object name
        
        Protected Sub STATED__STATED_CNOTES_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles STATED__STATED_CNOTES_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' STATED = The parent object name of child screen
        ' STATED_SCNOTES_DETAILS = The child screen object name
        
        Protected Sub STATED__STATED_SCNOTES_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles STATED__STATED_SCNOTES_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
