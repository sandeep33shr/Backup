...
Namespace Nexus
    Partial Class PB2_CMAMISCCLM_Glass : Inherits BaseClaim
		...
		Protected Sub onValidate_GLASS__GSCLMEND()
        
End Sub
Protected Sub onValidate_GLASS__GNTS()
        
End Sub
Protected Sub onValidate_GLASS__GSNTS()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_GLASS__GSCLMEND()
    onValidate_GLASS__GNTS()
    onValidate_GLASS__GSNTS()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' GLASS = The parent object name of child screen
        ' GLASS_CLAUSEPREM = The child screen object name
        
        Protected Sub GLASS__GLASS_CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GLASS__GLASS_CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' GLASS = The parent object name of child screen
        ' GLASS_CNOTE_DETAILS = The child screen object name
        
        Protected Sub GLASS__GLASS_CNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GLASS__GLASS_CNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' GLASS = The parent object name of child screen
        ' GLASS_SCNOTE_DETAILS = The child screen object name
        
        Protected Sub GLASS__GLASS_SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GLASS__GLASS_SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
