<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMISCCLM_Theft.aspx.vb" Inherits="Nexus.PB2_CMAMISCCLM_Theft" %>
...
function onValidate_THEFT__INDCONST(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		var valueWhen = new ValueWhenHelper(new Expression("'Group 3 locks on external doors, Hinges protected on doors that open outwards, Flat iron bars fitted to opening sections of windows, Security fencing provided, Approved alarm installation, Strongpoint to be provided for high valued clients'"), (Expression.isValidParameter("THEFT.INDCONSTCode = 3")) ? new Expression("THEFT.INDCONSTCode = 3") : null, (Expression.isValidParameter("{2}")) ? new Expression("{2}") : null);
...
function onValidate_THEFT_EXTENSIONS__IS_ACPC(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("THEFT_EXTENSIONS", "IS_ACPC");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_THEFT_EXTENSIONS__IS_ADB(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("THEFT_EXTENSIONS", "IS_ADB");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_THEFT_EXTENSIONS__IS_LOSS(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("THEFT_EXTENSIONS", "IS_LOSS");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_THEFT_EXTENSIONS__IS_MD(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("THEFT_EXTENSIONS", "IS_MD");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_THEFT_EXTENSIONS__IS_PETROL(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	var field = Field.getInstance("THEFT_EXTENSIONS", "IS_PETROL");
        	field.setReadOnly(true);
        })();
}
...
function onValidate_THEFT__CLMTFTEND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "THEFT", "CLMTFTEND", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param THEFT The object name of the control to set.
         * @parma THEFT_CLAUSEPREM The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=THEFT__THEFT_CLAUSEPREM.ClientID %>').find('table').find('tr').each(function () {
...
function onValidate_THEFT__CLMTFTNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "THEFT", "CLMTFTNOTE", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param THEFT The object name of the control to set.
         * @parma THEFT_CNOTES_DETAILS The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=THEFT__THEFT_CNOTES_DETAILS.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function onValidate_THEFT__CLMTFSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "THEFT", "CLMTFSNOTE", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param THEFT The object name of the control to set.
         * @parma THEFT_SCNOTES_DETAILS The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=THEFT__THEFT_SCNOTES_DETAILS.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function DoLogic(isOnLoad) {
    ...
    onValidate_THEFT__CLMTFTEND(null, null, null, isOnLoad);
    onValidate_THEFT__CLMTFTNOTE(null, null, null, isOnLoad);
    onValidate_THEFT__CLMTFSNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id4e9f285f71dd411381a347f2a3eed165" class="general-layout-container">
...
<div id="idedd3f1c94dfa40ceb7ab292ff3911205" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idedd3f1c94dfa40ceb7ab292ff3911205 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idedd3f1c94dfa40ceb7ab292ff3911205 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idedd3f1c94dfa40ceb7ab292ff3911205 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idedd3f1c94dfa40ceb7ab292ff3911205 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idedd3f1c94dfa40ceb7ab292ff3911205 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idedd3f1c94dfa40ceb7ab292ff3911205 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idedd3f1c94dfa40ceb7ab292ff3911205 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idedd3f1c94dfa40ceb7ab292ff3911205 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idedd3f1c94dfa40ceb7ab292ff3911205 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idedd3f1c94dfa40ceb7ab292ff3911205 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idbfbbdff37aa141fb93787e129d924c68" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading61" runat="server" Text="Malicious Damage Following Theft" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idbfbbdff37aa141fb93787e129d924c68 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idbfbbdff37aa141fb93787e129d924c68 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idbfbbdff37aa141fb93787e129d924c68 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idbfbbdff37aa141fb93787e129d924c68 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idbfbbdff37aa141fb93787e129d924c68 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbfbbdff37aa141fb93787e129d924c68 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbfbbdff37aa141fb93787e129d924c68 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idbfbbdff37aa141fb93787e129d924c68 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idbfbbdff37aa141fb93787e129d924c68 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idbfbbdff37aa141fb93787e129d924c68 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc6b58cb1c03a44bc988ce806dae048ae" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading62" runat="server" Text="Theft" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc6b58cb1c03a44bc988ce806dae048ae div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc6b58cb1c03a44bc988ce806dae048ae div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc6b58cb1c03a44bc988ce806dae048ae div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc6b58cb1c03a44bc988ce806dae048ae label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc6b58cb1c03a44bc988ce806dae048ae label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc6b58cb1c03a44bc988ce806dae048ae label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc6b58cb1c03a44bc988ce806dae048ae label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc6b58cb1c03a44bc988ce806dae048ae input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc6b58cb1c03a44bc988ce806dae048ae input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc6b58cb1c03a44bc988ce806dae048ae input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id85570c07ef8a4ecfa890190569d135c6" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading63" runat="server" Text="Past Claims Count" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label61">
		<span class="label" id="label61">0-12 Months</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label62">
		<span class="label" id="label62">Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label63">
		<span class="label" id="label63">13-24 Months</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label64">
		<span class="label" id="label64">Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label65">
		<span class="label" id="label65">25-36 Months</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label66">
		<span class="label" id="label66">Amount</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label67">
		<span class="label" id="label67">Goods in Transit</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id85570c07ef8a4ecfa890190569d135c6 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id85570c07ef8a4ecfa890190569d135c6 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id85570c07ef8a4ecfa890190569d135c6 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id85570c07ef8a4ecfa890190569d135c6 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id85570c07ef8a4ecfa890190569d135c6 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id85570c07ef8a4ecfa890190569d135c6 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id85570c07ef8a4ecfa890190569d135c6 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id85570c07ef8a4ecfa890190569d135c6 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id85570c07ef8a4ecfa890190569d135c6 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id85570c07ef8a4ecfa890190569d135c6 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ida5db146e34c14cbfbbc4a0be9138fa18" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading64" runat="server" Text="All Contents" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label70">
		<span class="label" id="label70">Sum Insured</span>
	</span>
<!-- /Label -->
...
<!-- /Label -->
	...
	<span id="pb-container-label-label72">
		<span class="label" id="label72">Min Amount</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ida5db146e34c14cbfbbc4a0be9138fa18 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida5db146e34c14cbfbbc4a0be9138fa18 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida5db146e34c14cbfbbc4a0be9138fa18 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ida5db146e34c14cbfbbc4a0be9138fa18 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida5db146e34c14cbfbbc4a0be9138fa18 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5db146e34c14cbfbbc4a0be9138fa18 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5db146e34c14cbfbbc4a0be9138fa18 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida5db146e34c14cbfbbc4a0be9138fa18 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida5db146e34c14cbfbbc4a0be9138fa18 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida5db146e34c14cbfbbc4a0be9138fa18 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id963b10918400458bb5a855229c79ea43" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading65" runat="server" Text="Extensions" /></legend>
...
<!-- /Label -->
	...
	<span id="pb-container-label-label78">
		<span class="label" id="label78">FAP%</span>
	</span>
<!-- /Label -->
	...
	<span id="pb-container-label-label79">
		<span class="label" id="label79">Min Amount</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label83">
		<span class="label" id="label83">Additional Damage to Building</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label86">
		<span class="label" id="label86">Losses in the Open at the Insured Premises</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label87">
		<span class="label" id="label87">Malicious Damage</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label90">
		<span class="label" id="label90">Petrol in Underground Tanks</span>
	</span>
<!-- /Label -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id963b10918400458bb5a855229c79ea43 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id963b10918400458bb5a855229c79ea43 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id963b10918400458bb5a855229c79ea43 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id963b10918400458bb5a855229c79ea43 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id963b10918400458bb5a855229c79ea43 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id963b10918400458bb5a855229c79ea43 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id963b10918400458bb5a855229c79ea43 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id963b10918400458bb5a855229c79ea43 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id963b10918400458bb5a855229c79ea43 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id963b10918400458bb5a855229c79ea43 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id66ca758916b74df7b8b14268524db371" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_THEFT__CLMTFTEND"
		data-field-type="Child" 
		data-object-name="THEFT" 
		data-property-name="CLMTFTEND" 
		id="pb-container-childscreen-THEFT-CLMTFTEND">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="THEFT__THEFT_CLAUSEPREM" runat="server" ScreenCode="CLMTFTEND" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLMTFTEND/CLMTFTEND_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valTHEFT_CLMTFTEND" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for THEFT.CLMTFTEND"
						ClientValidationFunction="onValidate_THEFT__CLMTFTEND" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id66ca758916b74df7b8b14268524db371 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id66ca758916b74df7b8b14268524db371 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id66ca758916b74df7b8b14268524db371 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id66ca758916b74df7b8b14268524db371 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id66ca758916b74df7b8b14268524db371 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id66ca758916b74df7b8b14268524db371 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id66ca758916b74df7b8b14268524db371 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id66ca758916b74df7b8b14268524db371 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id66ca758916b74df7b8b14268524db371 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id66ca758916b74df7b8b14268524db371 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idd41f24fc69f34340918eb0242fc20440" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading67" runat="server" Text="Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_THEFT__CLMTFTNOTE"
		data-field-type="Child" 
		data-object-name="THEFT" 
		data-property-name="CLMTFTNOTE" 
		id="pb-container-childscreen-THEFT-CLMTFTNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="THEFT__THEFT_CNOTES_DETAILS" runat="server" ScreenCode="CLMTFTNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLMTFTNOTE/CLMTFTNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTHEFT_CLMTFTNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for THEFT.CLMTFTNOTE"
						ClientValidationFunction="onValidate_THEFT__CLMTFTNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idd41f24fc69f34340918eb0242fc20440 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd41f24fc69f34340918eb0242fc20440 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd41f24fc69f34340918eb0242fc20440 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idd41f24fc69f34340918eb0242fc20440 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd41f24fc69f34340918eb0242fc20440 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd41f24fc69f34340918eb0242fc20440 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd41f24fc69f34340918eb0242fc20440 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd41f24fc69f34340918eb0242fc20440 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd41f24fc69f34340918eb0242fc20440 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd41f24fc69f34340918eb0242fc20440 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id15ff7964efbc4e9295d1c4121454d3ff" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading68" runat="server" Text="Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_THEFT__CLMTFSNOTE"
		data-field-type="Child" 
		data-object-name="THEFT" 
		data-property-name="CLMTFSNOTE" 
		id="pb-container-childscreen-THEFT-CLMTFSNOTE">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="THEFT__THEFT_SCNOTES_DETAILS" runat="server" ScreenCode="CLMTFSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CLMTFSNOTE/CLMTFSNOTE_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTHEFT_CLMTFSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for THEFT.CLMTFSNOTE"
						ClientValidationFunction="onValidate_THEFT__CLMTFSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id15ff7964efbc4e9295d1c4121454d3ff div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id15ff7964efbc4e9295d1c4121454d3ff div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id15ff7964efbc4e9295d1c4121454d3ff div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id15ff7964efbc4e9295d1c4121454d3ff label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id15ff7964efbc4e9295d1c4121454d3ff label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15ff7964efbc4e9295d1c4121454d3ff label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15ff7964efbc4e9295d1c4121454d3ff label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id15ff7964efbc4e9295d1c4121454d3ff input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15ff7964efbc4e9295d1c4121454d3ff input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15ff7964efbc4e9295d1c4121454d3ff input{text-align:left;}"; break;
		}
	}
