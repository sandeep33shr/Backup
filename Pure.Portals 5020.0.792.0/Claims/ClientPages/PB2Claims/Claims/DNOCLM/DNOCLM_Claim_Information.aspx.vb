...
Namespace Nexus
    Partial Class PB2_DNOCLM_Claim_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_DNOLBCLAIM__DNOTRAIL()
        
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DNOLBCLAIM__DNOTRAIL()
End Sub
        ...
        Protected Sub UpdateAuditTrail()
        	...
        	Dim salvage As String = DNOLBCLAIM__SALVAGESTAT.Text
        	Dim legal As String = DNOLBCLAIM__LEGALSTAT.Text
        	Dim decision As String = DNOLBCLAIM__CLMDECISION.Text
        	...
        	If (salvage_updatereq Or legal_updatereq Or decision_updatereq) Then
        		...
        		Session(CNDataSet) = oWebService.RunDefaultRulesEdit(DNOLBCLAIM__DNOAUDIT.ScreenCode, Session(CNDataSet))
        	End If
        ...
        Protected Function AuditEntryRequired(ByVal propertyName As String, ByVal propertyValue As String, ByRef previousValue As String) As Boolean
        	...
        	For Each el As Linq.XElement In datamodelXML.DescendantNodes()
        		If (el.Name.ToString().ToUpper() = "DNOAUDIT") Then
        ...
        Protected Sub LogAuditEntry(ByVal propertyName As String, ByVal propertyValue As String, ByVal previousValue As String)
        	...
        	Doc.LoadXml(strDS)
        	Dim xmlParent As XmlNode = Doc.SelectSingleNode("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/DNOLBCLAIM/DNOAUDIT")
        	Dim v_sOI As String = Nothing
        	If xmlParent IsNot Nothing Then
        		v_sOI = xmlParent.Attributes("OI").Value
        	End If
        	Dim v_sScreenCode As String = DNOLBCLAIM__DNOAUDIT.ScreenCode
        	Dim sParentElement, sChildElement As String
        	Dim sTmp() As String = Regex.Split(DNOLBCLAIM__DNOAUDIT.ID, "__")
        	...
        	DNOLBCLAIM__DNOAUDIT.DataSource = oXMLSource
        	DNOLBCLAIM__DNOAUDIT.DataBind()
        ...
        ' DNOLBCLAIM = The parent object name of child screen
        ' DNOAUDIT = The child screen object name
        
        Protected Sub DNOLBCLAIM__DNOAUDIT_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles DNOLBCLAIM__DNOAUDIT.RowDataBound
