<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DNOCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_DNOCLM_Third_Party" %>
...
function onValidate_DNOLBCLAIM__DNOTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOLBCLAIM", "DNOTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_DNOLBCLAIM__DNOTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idc559cbecac5a4109abf5dc3602686486" class="general-layout-container">
...
<div id="id06f052250a1b41a98bc88be8b37b9713" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_DNOLBCLAIM__DNOTPARTY"
		data-field-type="Child" 
		data-object-name="DNOLBCLAIM" 
		data-property-name="DNOTPARTY" 
		id="pb-container-childscreen-DNOLBCLAIM-DNOTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="DNOLBCLAIM__DNOTHIRD" runat="server" ScreenCode="DNOTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DNOTPARTY/DNOTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valDNOLBCLAIM_DNOTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for DNOLBCLAIM.DNOTPARTY"
						ClientValidationFunction="onValidate_DNOLBCLAIM__DNOTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id06f052250a1b41a98bc88be8b37b9713 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id06f052250a1b41a98bc88be8b37b9713 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id06f052250a1b41a98bc88be8b37b9713 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id06f052250a1b41a98bc88be8b37b9713 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id06f052250a1b41a98bc88be8b37b9713 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id06f052250a1b41a98bc88be8b37b9713 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id06f052250a1b41a98bc88be8b37b9713 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id06f052250a1b41a98bc88be8b37b9713 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id06f052250a1b41a98bc88be8b37b9713 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id06f052250a1b41a98bc88be8b37b9713 input{text-align:left;}"; break;
		}
	}
