...
Namespace Nexus
    Partial Class PB2_DNOCLM_Schedule_Of_Loss : Inherits BaseClaim
		...
		Protected Sub onValidate_DNOLBCLAIM__OWNDSCRN()
...
End Sub
Protected Sub onValidate_DNOLBCLAIM__SOLSCREEN()
                    If eLifecycleEvent = LifecycleEvent.Page_Load Then
                        If Not Page.IsPostBack Then
                            GetClaimDetails(CType(Session.Item(CNClaim), NexusProvider.ClaimOpen).ClaimKey, Nothing)
                            SetScriptPayment()
...
Protected Sub CallRuleScripts()
    onValidate_DNOLBCLAIM__OWNDSCRN()
    onValidate_DNOLBCLAIM__TransactionType()
    onValidate_DNOLBCLAIM__SOLSCREEN()
End Sub
        ...
        Private Sub ProcessPayment()
                     If (Not String.IsNullOrEmpty(Session(CNDataSet)) AndAlso CType(Session.Item(CNMode), Mode) = Mode.PayClaim) Then
                        ...
                        xmlDoc.Load(xmlTR)
                        xmlTR.Close()
                        Dim oNodelist As XmlNodeList = xmlDoc.SelectNodes("//DNOLBCLAIM/OWNDCLAIM")
                        For Each oNode As XmlNode In oNodelist
                            If oNode IsNot Nothing Then
                                ...
                                If (dThisPayment > 0) Then ' AndAlso (sStatusCode = "NP" OrElse sStatusCode = "AUTH")) Then
                                    ...
                                    ' htPaymentDetails.Add("POSTCODE", sPostCode)
                                     ...
                                     Dim oPaymentNodelist As XmlNodeList = xmlDoc.SelectNodes("//DNOLBCLAIM/OWNDCLAIM")
                                    ...
                                    If (bIsPaymentProcessed And cPaymentCollection IsNot Nothing) Then
                                        ...
                                        oNodelist = xmlDoc.SelectNodes("//DNOLBCLAIM/OWNDCLAIM")
                                        ...
                                        For Each oPaymentNode As XmlNode In oNodelist
                                            ...
                                            UpdateClaimXML("DNOLBCLAIM/OWNDCLAIM", "OUT_PAYMENT", sNetTotalOutstandingAmount, True, sReseveOI)
                                            UpdateClaimXML("DNOLBCLAIM/OWNDCLAIM", "TOTAL_PAID", sNetTotalPaymentAmount, True, sReseveOI)
                                        Next
        ...
        Protected Sub RunDefaultRule()
            ...
            Dim sScreenCode As String = "OWNDSCRN"
                                ...
                                If (dThisPayment > 0) Then ' AndAlso (sStatusCode = "NP" OrElse sStatusCode = "AUTH")) Then
                                    ...
                                    If (bIsPaymentProcessed And cExpensesPaymentCollection IsNot Nothing) Then
                                        ...
                                        For Each oPaymentNode As XmlNode In oNodelist
                                            ...
                                            UpdateClaimXML("DNOLBCLAIM/SCHEDULE_LOSS", "OUT_PAYMENT", sNetTotalOutstandingAmount, True, sReseveOI)
                                            UpdateClaimXML("DNOLBCLAIM/SCHEDULE_LOSS", "TOTAL_PAID", sNetTotalPaymentAmount, True, sReseveOI)
                                        Next
        ...
        Protected Sub RunExpensesDefaultRule()
            ...
            Dim oWebService As NexusProvider.ProviderBase = New NexusProvider.ProviderManager().Provider
            Dim v_bSkipSaveToDB As Boolean = False
            Dim sScreenCode As String = "SOLSCREEN"
            Dim sTransactionType As String = ""
