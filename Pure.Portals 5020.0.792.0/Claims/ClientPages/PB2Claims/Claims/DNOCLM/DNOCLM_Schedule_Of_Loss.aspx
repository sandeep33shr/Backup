<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DNOCLM_Schedule_Of_Loss.aspx.vb" Inherits="Nexus.PB2_DNOCLM_Schedule_Of_Loss" %>
...
function onValidate_DNOLBCLAIM__OWNDSCRN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOLBCLAIM", "OWNDSCRN", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var whenCondition = Expression.isValidParameter("DNOLBCLAIM.TransactionType = 'PAYCLAIM' ") ? (new Expression("DNOLBCLAIM.TransactionType = 'PAYCLAIM' ")) : null;
        		var oldLinkCaption = "Edit".toLowerCase();
        		var newLinkCaption = "Pay";
        		var field = Field.getInstance("DNOLBCLAIM", "OWNDSCRN");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_DNOLBCLAIM__OWNDSCRN table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var whenCondition = Expression.isValidParameter("DNOLBCLAIM.TransactionType = 'PAYCLAIM' ||DNOLBCLAIM.TransactionType = 'TPRECOVERY' || DNOLBCLAIM.TransactionType = 'SALVAGECLAIM'") ? (new Expression("DNOLBCLAIM.TransactionType = 'PAYCLAIM' ||DNOLBCLAIM.TransactionType = 'TPRECOVERY' || DNOLBCLAIM.TransactionType = 'SALVAGECLAIM'")) : null;
        		...
        		var field = Field.getInstance("DNOLBCLAIM", "OWNDSCRN");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'DNOLBCLAIM' and property 'OWNDSCRN'.");
        			error.display();
...
function onValidate_DNOLBCLAIM__TransactionType(source, args, sender, isOnLoad) {
        ...
        $(function () {
        	...
        	//Tab IDs
        	var GeneralTabId = "2"
        	var UnderwritingTabId = "3"
        	var ThirdPartyTabId = "4"
        	var AssessmentTabId = "5"
        	
        	//Get current transaction type
        	var TransactionType = Field.getInstance ("DNOLBCLAIM","TransactionType");
...
function onValidate_DNOLBCLAIM__OWNDCOUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOLBCLAIM", "OWNDCOUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("DNOLBCLAIM", "OWNDCOUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
          ...
          * @param DNOLBCLAIM The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "DNOLBCLAIM".toUpperCase().replace(/^\s+|\s+$/g, '');
        ...
        (function(){
        	...
        	if (args && args.IsValid == true){
        		...
        		var setInvalid = function(){
        			...
        			args.IsValid = false;
        			if (message != null){
        				var node = document.getElementById("ctl00_cntMainBody_val" + "DNOLBCLAIM".toUpperCase() + "__" + "OWNDCOUNTER");
        				if (node == null){
        					// Try slightly different format with only one underscore
        					node = document.getElementById("ctl00_cntMainBody_val" + "DNOLBCLAIM".toUpperCase() + "_" + "OWNDCOUNTER");
        				}
        				if (node != null){
        		...
        		var exp;
        		try {
        			exp = new Expression("DNOLBCLAIM.OWNDCOUNTER > 0 ||DNOLBCLAIM.SOL_COUNTER > 0");
        		} catch (e){
        			setInvalid();
        			return;
        		}
...
function onValidate_DNOLBCLAIM__TOTALPAID(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DNOLBCLAIM", "TOTALPAID", "Currency");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("DNOLBCLAIM", "TOTALPAID");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function onValidate_DNOLBCLAIM__SOLSCREEN(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("DNOLBCLAIM", "SOLSCREEN");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'DNOLBCLAIM' and property 'SOLSCREEN'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
...
function onValidate_DNOLBCLAIM__RCVRSCREEN(source, args, sender, isOnLoad) {
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("DNOLBCLAIM", "RCVRSCREEN");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'DNOLBCLAIM' and property 'RCVRSCREEN'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_DNOLBCLAIM__RCVRSCREEN table td a");
...
function DoLogic(isOnLoad) {
    onValidate_DNOLBCLAIM__OWNDSCRN(null, null, null, isOnLoad);
    onValidate_DNOLBCLAIM__TransactionType(null, null, null, isOnLoad);
    onValidate_DNOLBCLAIM__OWNDCOUNTER(null, null, null, isOnLoad);
    onValidate_DNOLBCLAIM__TOTALPAID(null, null, null, isOnLoad);
...
<div id="id21dd77ee0b024b03a610c36cad793bf2" class="general-layout-container">
...
<div id="idf34b26d37fc64242ac6c0d5533f1d14b" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_DNOLBCLAIM__OWNDSCRN"
		data-field-type="Child" 
		data-object-name="DNOLBCLAIM" 
		data-property-name="OWNDSCRN" 
		id="pb-container-childscreen-DNOLBCLAIM-OWNDSCRN">
		
		    <legend>Indemnity Information</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="DNOLBCLAIM__OWNDCLAIM" runat="server" ScreenCode="OWNDSCRN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="OWNDSCRN/OWNDSCRN_Own_Damage_Information.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Ex-Gratia" DataField="IS_EXGRATIA" DataFormatString="{0:Yes;;No}"/>
					...
					<asp:CustomValidator ID="valDNOLBCLAIM_OWNDSCRN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Indemnity Information"
						ClientValidationFunction="onValidate_DNOLBCLAIM__OWNDSCRN" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-DNOLBCLAIM-OWNDCOUNTER">
		<asp:Label ID="lblDNOLBCLAIM_OWNDCOUNTER" runat="server" AssociatedControlID="DNOLBCLAIM__OWNDCOUNTER" 
			Text="Own Damage " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="DNOLBCLAIM__OWNDCOUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valDNOLBCLAIM_OWNDCOUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Own Damage "
			ClientValidationFunction="onValidate_DNOLBCLAIM__OWNDCOUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-currency-DNOLBCLAIM-TOTALPAID">
		<asp:Label ID="lblDNOLBCLAIM_TOTALPAID" runat="server" AssociatedControlID="DNOLBCLAIM__TOTALPAID" 
			Text="Total Payment" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		   <div class="col-md-8 col-sm-9">
		     <asp:TextBox ID="DNOLBCLAIM__TOTALPAID" runat="server" CssClass="form-control" />
		   </div>
		<asp:CustomValidator ID="valDNOLBCLAIM_TOTALPAID" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Total Payment"
			ClientValidationFunction="onValidate_DNOLBCLAIM__TOTALPAID" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
	</span>
		    ...
		    <legend>Claims Expenses</legend>
			        ...
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="DNOLBCLAIM__SCHEDULE_LOSS" runat="server" ScreenCode="SOLSCREEN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="SOLSCREEN/SOLSCREEN_Expenses_Information.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_DNO_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idf34b26d37fc64242ac6c0d5533f1d14b div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf34b26d37fc64242ac6c0d5533f1d14b div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf34b26d37fc64242ac6c0d5533f1d14b div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idf34b26d37fc64242ac6c0d5533f1d14b label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf34b26d37fc64242ac6c0d5533f1d14b label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf34b26d37fc64242ac6c0d5533f1d14b label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf34b26d37fc64242ac6c0d5533f1d14b label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf34b26d37fc64242ac6c0d5533f1d14b input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf34b26d37fc64242ac6c0d5533f1d14b input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf34b26d37fc64242ac6c0d5533f1d14b input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id20faba75507c40a2ac14b511a91b1418" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading36" runat="server" Text="Claims Recoveries" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id20faba75507c40a2ac14b511a91b1418 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id20faba75507c40a2ac14b511a91b1418 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id20faba75507c40a2ac14b511a91b1418 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id20faba75507c40a2ac14b511a91b1418 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id20faba75507c40a2ac14b511a91b1418 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id20faba75507c40a2ac14b511a91b1418 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id20faba75507c40a2ac14b511a91b1418 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id20faba75507c40a2ac14b511a91b1418 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id20faba75507c40a2ac14b511a91b1418 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id20faba75507c40a2ac14b511a91b1418 input{text-align:left;}"; break;
		}
	}
