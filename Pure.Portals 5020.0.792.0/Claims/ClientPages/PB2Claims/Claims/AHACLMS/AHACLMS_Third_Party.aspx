<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="AHACLMS_Third_Party.aspx.vb" Inherits="Nexus.PB2_AHACLMS_Third_Party" %>
...
function onValidate_AHACLM__AHAPRTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "AHACLM", "AHAPRTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_AHACLM__AHAPRTY(null, null, null, isOnLoad);
}
</script>
...
<div id="ida093d29265674d1b83a183c92cedfda8" class="general-layout-container">
...
<div id="idef2613660f314d519bf49936f07e2c6c" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading30" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_AHACLM__AHAPRTY"
		data-field-type="Child" 
		data-object-name="AHACLM" 
		data-property-name="AHAPRTY" 
		id="pb-container-childscreen-AHACLM-AHAPRTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="AHACLM__AHATHRD" runat="server" ScreenCode="AHAPRTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="AHAPRTY/AHAPRTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valAHACLM_AHAPRTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for AHACLM.AHAPRTY"
						ClientValidationFunction="onValidate_AHACLM__AHAPRTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idef2613660f314d519bf49936f07e2c6c div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idef2613660f314d519bf49936f07e2c6c div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idef2613660f314d519bf49936f07e2c6c div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idef2613660f314d519bf49936f07e2c6c label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idef2613660f314d519bf49936f07e2c6c label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idef2613660f314d519bf49936f07e2c6c label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idef2613660f314d519bf49936f07e2c6c label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idef2613660f314d519bf49936f07e2c6c input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idef2613660f314d519bf49936f07e2c6c input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idef2613660f314d519bf49936f07e2c6c input{text-align:left;}"; break;
		}
	}
