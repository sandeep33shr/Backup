<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="STBKHLCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_STBKHLCLM_Third_Party" %>
...
function onValidate_STBCLAIM__STBPTPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STBCLAIM", "STBPTPARTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_STBCLAIM__STBPTPARTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id5e5319c3c2b54ca6be720538abc653fd" class="general-layout-container">
...
<div id="id69a067e8902b417499a2eccad646ba77" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading13" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STBCLAIM__STBPTPARTY"
		data-field-type="Child" 
		data-object-name="STBCLAIM" 
		data-property-name="STBPTPARTY" 
		id="pb-container-childscreen-STBCLAIM-STBPTPARTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STBCLAIM__STBPTHIRD" runat="server" ScreenCode="STBPTPARTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="STBPTPARTY/STBPTPARTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valSTBCLAIM_STBPTPARTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for STBCLAIM.STBPTPARTY"
						ClientValidationFunction="onValidate_STBCLAIM__STBPTPARTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id69a067e8902b417499a2eccad646ba77 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id69a067e8902b417499a2eccad646ba77 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id69a067e8902b417499a2eccad646ba77 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id69a067e8902b417499a2eccad646ba77 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id69a067e8902b417499a2eccad646ba77 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id69a067e8902b417499a2eccad646ba77 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id69a067e8902b417499a2eccad646ba77 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id69a067e8902b417499a2eccad646ba77 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id69a067e8902b417499a2eccad646ba77 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id69a067e8902b417499a2eccad646ba77 input{text-align:left;}"; break;
		}
	}
