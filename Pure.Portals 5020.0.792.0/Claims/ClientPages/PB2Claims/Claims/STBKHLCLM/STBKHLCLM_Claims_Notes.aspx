<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="STBKHLCLM_Claims_Notes.aspx.vb" Inherits="Nexus.PB2_STBKHLCLM_Claims_Notes" %>
...
function onValidate_STBCLAIM__STBNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STBCLAIM", "STBNOTE", "ChildScreen");
        })();
}
function onValidate_STBCLAIM__STBEXPA(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "STBCLAIM", "STBEXPA", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_STBCLAIM__STBNOTE(null, null, null, isOnLoad);
    onValidate_STBCLAIM__STBEXPA(null, null, null, isOnLoad);
}
</script>
...
<div id="id08575f9294634594ac963e8c2ca5617f" class="general-layout-container">
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading19" runat="server" Text=" Standard Bank Home loan Claims Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STBCLAIM__STBNOTE"
		data-field-type="Child" 
		data-object-name="STBCLAIM" 
		data-property-name="STBNOTE" 
		id="pb-container-childscreen-STBCLAIM-STBNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STBCLAIM__CNOTE_DETAILS" runat="server" ScreenCode="STBNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="STBNOTE/STBNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valSTBCLAIM_STBNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_STBCLAIM__STBNOTE" 
						Display="None"
...
<div id="frmNotes" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading20" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_STBCLAIM__STBEXPA"
		data-field-type="Child" 
		data-object-name="STBCLAIM" 
		data-property-name="STBEXPA" 
		id="pb-container-childscreen-STBCLAIM-STBEXPA">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="STBCLAIM__EXT_DETAILS" runat="server" ScreenCode="STBEXPA" AutoGenerateColumns="false"
							GridLines="None" ChildPage="STBEXPA/STBEXPA_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valSTBCLAIM_STBEXPA" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_STBCLAIM__STBEXPA" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
