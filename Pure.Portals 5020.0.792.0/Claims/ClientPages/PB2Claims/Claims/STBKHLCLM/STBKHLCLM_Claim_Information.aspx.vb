...
Namespace Nexus
    Partial Class PB2_STBKHLCLM_Claim_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_STBCLAIM__STBPTRAIL()
        
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_STBCLAIM__STBPTRAIL()
End Sub
        ...
        Protected Sub UpdateAuditTrail()
        	...
        	Dim salvage As String = STBCLAIM__SALVAGESTAT.Text
        	Dim legal As String = STBCLAIM__LEGALSTAT.Text
        	Dim decision As String = STBCLAIM__CLMDECISION.Text
        	...
        	If (salvage_updatereq Or legal_updatereq Or decision_updatereq) Then
        		...
        		Session(CNDataSet) = oWebService.RunDefaultRulesEdit(STBCLAIM__STBPAUDT.ScreenCode, Session(CNDataSet))
        	End If
        ...
        Protected Function AuditEntryRequired(ByVal propertyName As String, ByVal propertyValue As String, ByRef previousValue As String) As Boolean
        	...
        	For Each el As Linq.XElement In datamodelXML.DescendantNodes()
        		If (el.Name.ToString().ToUpper() = "STBPAUDIT") Then
        ...
        Protected Sub LogAuditEntry(ByVal propertyName As String, ByVal propertyValue As String, ByVal previousValue As String)
        	...
        	Doc.LoadXml(strDS)
        	Dim xmlParent As XmlNode = Doc.SelectSingleNode("//" & Session.Item(CNDataModelCode) & "_POLICY_BINDER/STBCLAIM/STBPAUDT")
        	Dim v_sOI As String = Nothing
        	If xmlParent IsNot Nothing Then
        		v_sOI = xmlParent.Attributes("OI").Value
        	End If
        	Dim v_sScreenCode As String = STBCLAIM__STBPAUDT.ScreenCode
        	Dim sParentElement, sChildElement As String
        	Dim sTmp() As String = Regex.Split(STBCLAIM__STBPAUDT.ID, "__")
        	...
        	STBCLAIM__STBPAUDT.DataSource = oXMLSource
        	STBCLAIM__STBPAUDT.DataBind()
        ...
        ' STBCLAIM = The parent object name of child screen
        ' STBPAUDT = The child screen object name
        
        Protected Sub STBCLAIM__STBPAUDT_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles STBCLAIM__STBPAUDT.RowDataBound
