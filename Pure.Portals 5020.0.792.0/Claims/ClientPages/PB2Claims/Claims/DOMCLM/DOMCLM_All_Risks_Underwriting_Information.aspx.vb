...
Namespace Nexus
    Partial Class PB2_DOMCLM_All_Risks_Underwriting_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_label2()
...
End Sub
        ...
        ' ALLRISKCLM = The parent object name of child screen
        ' ALLRISKCHLD = The child screen object name
        
        Protected Sub ALLRISKCLM__ALLRISKCHLD_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles ALLRISKCLM__ALLRISKCHLD.RowDataBound
