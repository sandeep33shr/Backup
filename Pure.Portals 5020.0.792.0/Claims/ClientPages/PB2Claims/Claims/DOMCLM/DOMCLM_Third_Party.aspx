<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="DOMCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_DOMCLM_Third_Party" %>
...
function onValidate_DOMCLAIM__DOMTPRTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "DOMCLAIM", "DOMTPRTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_DOMCLAIM__DOMTPRTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idbd86d61673e149738584750e61c920d1" class="general-layout-container">
...
<div id="id17641433593c4b7c9be21de32f4f380a" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_DOMCLAIM__DOMTPRTY"
		data-field-type="Child" 
		data-object-name="DOMCLAIM" 
		data-property-name="DOMTPRTY" 
		id="pb-container-childscreen-DOMCLAIM-DOMTPRTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="DOMCLAIM__DOMTHIRD" runat="server" ScreenCode="DOMTPRTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DOMTPRTY/DOMTPRTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valDOMCLAIM_DOMTPRTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for DOMCLAIM.DOMTPRTY"
						ClientValidationFunction="onValidate_DOMCLAIM__DOMTPRTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id17641433593c4b7c9be21de32f4f380a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id17641433593c4b7c9be21de32f4f380a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id17641433593c4b7c9be21de32f4f380a div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id17641433593c4b7c9be21de32f4f380a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id17641433593c4b7c9be21de32f4f380a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id17641433593c4b7c9be21de32f4f380a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id17641433593c4b7c9be21de32f4f380a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id17641433593c4b7c9be21de32f4f380a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id17641433593c4b7c9be21de32f4f380a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id17641433593c4b7c9be21de32f4f380a input{text-align:left;}"; break;
		}
	}
