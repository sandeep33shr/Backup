<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SIBCLM_Claim_details.aspx.vb" Inherits="Nexus.PB2_SIBCLM_Claim_details" %>
...
function onValidate_TAMCLM__RISK_ATTACH_DATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMCLM", "RISK_ATTACH_DATE", "Date");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("TAMCLM", "RISK_ATTACH_DATE");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMCLM.RISK_ATTACH_DATE");
        			window.setControlWidth(field, "0.4", "TAMCLM", "RISK_ATTACH_DATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMCLM_RISK_ATTACH_DATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMCLM__RISK_ATTACH_DATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMCLM__RISK_ATTACH_DATE_lblFindParty");
        			    }
        			}
...
function onValidate_TAMCLM__EFFECTIVEDATE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMCLM", "EFFECTIVEDATE", "Date");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("TAMCLM", "EFFECTIVEDATE");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMCLM.EFFECTIVEDATE");
        			window.setControlWidth(field, "0.4", "TAMCLM", "EFFECTIVEDATE");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMCLM_EFFECTIVEDATE");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMCLM__EFFECTIVEDATE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMCLM__EFFECTIVEDATE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_GENERAL__TAMTRAIL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "GENERAL", "TAMTRAIL", "ChildScreen");
        })();
        /** 
...
function onValidate_TAMCLM__PERSON(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMCLM", "PERSON", "Integer");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("TAMCLM", "PERSON");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("TAMCLM.PERSON");
        			window.setControlWidth(field, "0.8", "TAMCLM", "PERSON");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblTAMCLM_PERSON");
        			    var ele = document.getElementById('ctl00_cntMainBody_TAMCLM__PERSON');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_TAMCLM__PERSON_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_TAMCLM__TAMCLMEND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMCLM", "TAMCLMEND", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var whenCondition = Expression.isValidParameter("Edit") ? (new Expression("Edit")) : null;
        		...
        		var field = Field.getInstance("TAMCLM", "TAMCLMEND");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TAMCLM' and property 'TAMCLMEND'.");
        			error.display();
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_TAMCLM__TAMCLMEND table td a");
...
function onValidate_TAMCLM__TAMNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMCLM", "TAMNOTES", "ChildScreen");
        })();
        /**
         * @fileoverview Hides all the links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMCLM", "TAMNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TAMCLM' and property 'TAMNOTES'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_TAMCLM__TAMNOTES table td a");
...
function onValidate_TAMCLM__TAMSNOTES(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMCLM", "TAMSNOTES", "ChildScreen");
        })();
        /**
         * @fileoverview Hides all the links found within an element.
         * @param 0 {Expression} Optional when condition, hide is only applied when this is true. If omitted all links are hid.
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMCLM", "TAMSNOTES");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TAMCLM' and property 'TAMSNOTES'.");
        			error.display();
        			// Don't throw the error as we will let everything else carry on loading.
        			return;
        		}*/
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				// Remove the options from the table
        				links = goog.dom.query("#ctl00_cntMainBody_TAMCLM__TAMSNOTES table td a");
...
function DoLogic(isOnLoad) {
    onValidate_TAMCLM__RISK_ATTACH_DATE(null, null, null, isOnLoad);
    onValidate_TAMCLM__EFFECTIVEDATE(null, null, null, isOnLoad);
    ...
    onValidate_GENERAL__TAMTRAIL(null, null, null, isOnLoad);
    onValidate_label0(null, null, null, isOnLoad);
    onValidate_TAMCLM__PERSON(null, null, null, isOnLoad);
    onValidate_TAMCLM__TAMCLMEND(null, null, null, isOnLoad);
    onValidate_TAMCLM__TAMNOTES(null, null, null, isOnLoad);
    onValidate_TAMCLM__TAMSNOTES(null, null, null, isOnLoad);
}
</script>
...
<div id="id71d9c36b5f604191bd61a3d21f9c4c6a" class="general-layout-container">
...
<div id="idd36a846f34714d79bf1805059963c16e" class="column-layout-container,no-border  ">
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		data-object-name="TAMCLM" 
		data-property-name="RISK_ATTACH_DATE" 
		id="pb-container-datejquerycompatible-TAMCLM-RISK_ATTACH_DATE">
		<asp:Label ID="lblTAMCLM_RISK_ATTACH_DATE" runat="server" AssociatedControlID="TAMCLM__RISK_ATTACH_DATE" 
			Text="Attachment Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TAMCLM__RISK_ATTACH_DATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTAMCLM__RISK_ATTACH_DATE" runat="server" LinkedControl="TAMCLM__RISK_ATTACH_DATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTAMCLM_RISK_ATTACH_DATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Attachment Date"
			ClientValidationFunction="onValidate_TAMCLM__RISK_ATTACH_DATE" 
			ValidationGroup=""
			Display="None"
...
<!-- /Date -->
 ...
 <div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-datejquerycompatible-TAMCLM-EFFECTIVEDATE">
		<asp:Label ID="lblTAMCLM_EFFECTIVEDATE" runat="server" AssociatedControlID="TAMCLM__EFFECTIVEDATE" 
			Text="Effective Date" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			 <div class="col-md-8 col-sm-9">
			  <div class="input-group">
				<asp:TextBox ID="TAMCLM__EFFECTIVEDATE" runat="server" CssClass="form-control" data-type="Date" />
				<uc1:CalendarLookup ID="calTAMCLM__EFFECTIVEDATE" runat="server" LinkedControl="TAMCLM__EFFECTIVEDATE" HLevel="1" />
		     </div>
			 <asp:CustomValidator ID="valTAMCLM_EFFECTIVEDATE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Effective Date"
			ClientValidationFunction="onValidate_TAMCLM__EFFECTIVEDATE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idd36a846f34714d79bf1805059963c16e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idd36a846f34714d79bf1805059963c16e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idd36a846f34714d79bf1805059963c16e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idd36a846f34714d79bf1805059963c16e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idd36a846f34714d79bf1805059963c16e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd36a846f34714d79bf1805059963c16e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd36a846f34714d79bf1805059963c16e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idd36a846f34714d79bf1805059963c16e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idd36a846f34714d79bf1805059963c16e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idd36a846f34714d79bf1805059963c16e input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idcd0441bbd1374b2e9b3174bc2ee80979" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading10" runat="server" Text="Claim Details" /></legend>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idcd0441bbd1374b2e9b3174bc2ee80979 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idcd0441bbd1374b2e9b3174bc2ee80979 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idcd0441bbd1374b2e9b3174bc2ee80979 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idcd0441bbd1374b2e9b3174bc2ee80979 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idcd0441bbd1374b2e9b3174bc2ee80979 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcd0441bbd1374b2e9b3174bc2ee80979 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcd0441bbd1374b2e9b3174bc2ee80979 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idcd0441bbd1374b2e9b3174bc2ee80979 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idcd0441bbd1374b2e9b3174bc2ee80979 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idcd0441bbd1374b2e9b3174bc2ee80979 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6a0dfdde2c2147a9b5b7a95e7bf8fb35" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_GENERAL__TAMTRAIL"
		data-field-type="Child" 
		data-object-name="GENERAL" 
		data-property-name="TAMTRAIL" 
		id="pb-container-childscreen-GENERAL-TAMTRAIL">
		
		    <legend>Audit Trail</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="GENERAL__AUDIT" runat="server" ScreenCode="TAMTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TAMTRAIL/TAMTRAIL_Audit_Trail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Changed By" DataField="CHANGED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valGENERAL_TAMTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Audit Trail"
						ClientValidationFunction="onValidate_GENERAL__TAMTRAIL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6a0dfdde2c2147a9b5b7a95e7bf8fb35 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id107460c66bb84c4da53c634b780188ec" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-TAMCLM-PERSON">
		<asp:Label ID="lblTAMCLM_PERSON" runat="server" AssociatedControlID="TAMCLM__PERSON" 
			Text="Number of Persons Insured" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="TAMCLM__PERSON" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valTAMCLM_PERSON" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Number of Persons Insured"
			ClientValidationFunction="onValidate_TAMCLM__PERSON" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id107460c66bb84c4da53c634b780188ec div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id107460c66bb84c4da53c634b780188ec div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id107460c66bb84c4da53c634b780188ec div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id107460c66bb84c4da53c634b780188ec label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id107460c66bb84c4da53c634b780188ec label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id107460c66bb84c4da53c634b780188ec label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id107460c66bb84c4da53c634b780188ec label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id107460c66bb84c4da53c634b780188ec input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id107460c66bb84c4da53c634b780188ec input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id107460c66bb84c4da53c634b780188ec input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6cc0b75aa18e4f85a29950c45b432369" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMCLM__TAMCLMEND"
		data-field-type="Child" 
		data-object-name="TAMCLM" 
		data-property-name="TAMCLMEND" 
		id="pb-container-childscreen-TAMCLM-TAMCLMEND">
		
		    <legend>Endorsements</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMCLM__TAMRSK_END" runat="server" ScreenCode="TAMCLMEND" AutoGenerateColumns="false"
							GridLines="None" ChildPage="TAMCLMEND/TAMCLMEND_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valTAMCLM_TAMCLMEND" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Endorsements"
						ClientValidationFunction="onValidate_TAMCLM__TAMCLMEND" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6cc0b75aa18e4f85a29950c45b432369 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6cc0b75aa18e4f85a29950c45b432369 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6cc0b75aa18e4f85a29950c45b432369 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6cc0b75aa18e4f85a29950c45b432369 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6cc0b75aa18e4f85a29950c45b432369 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6cc0b75aa18e4f85a29950c45b432369 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6cc0b75aa18e4f85a29950c45b432369 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6cc0b75aa18e4f85a29950c45b432369 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6cc0b75aa18e4f85a29950c45b432369 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6cc0b75aa18e4f85a29950c45b432369 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="ideebe4bb8937c44bfa0c3b5a565bcc138" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMCLM__TAMNOTES"
		data-field-type="Child" 
		data-object-name="TAMCLM" 
		data-property-name="TAMNOTES" 
		id="pb-container-childscreen-TAMCLM-TAMNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMCLM__CNOTE" runat="server" ScreenCode="TAMNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTAMCLM_TAMNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TAMCLM.TAMNOTES"
						ClientValidationFunction="onValidate_TAMCLM__TAMNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#ideebe4bb8937c44bfa0c3b5a565bcc138 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ideebe4bb8937c44bfa0c3b5a565bcc138 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ideebe4bb8937c44bfa0c3b5a565bcc138 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#ideebe4bb8937c44bfa0c3b5a565bcc138 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ideebe4bb8937c44bfa0c3b5a565bcc138 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ideebe4bb8937c44bfa0c3b5a565bcc138 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ideebe4bb8937c44bfa0c3b5a565bcc138 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ideebe4bb8937c44bfa0c3b5a565bcc138 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ideebe4bb8937c44bfa0c3b5a565bcc138 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ideebe4bb8937c44bfa0c3b5a565bcc138 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6d03b12c14ae4114a00aa82e9e9e4f40" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMCLM__TAMSNOTES"
		data-field-type="Child" 
		data-object-name="TAMCLM" 
		data-property-name="TAMSNOTES" 
		id="pb-container-childscreen-TAMCLM-TAMSNOTES">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMCLM__SNOTE" runat="server" ScreenCode="TAMSNOTES" AutoGenerateColumns="false"
...
<Nexus:RiskAttribute HeaderText="Details" DataField="NOTE_DETAILS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTAMCLM_TAMSNOTES" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for TAMCLM.TAMSNOTES"
						ClientValidationFunction="onValidate_TAMCLM__TAMSNOTES" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6d03b12c14ae4114a00aa82e9e9e4f40 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6d03b12c14ae4114a00aa82e9e9e4f40 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6d03b12c14ae4114a00aa82e9e9e4f40 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6d03b12c14ae4114a00aa82e9e9e4f40 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6d03b12c14ae4114a00aa82e9e9e4f40 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d03b12c14ae4114a00aa82e9e9e4f40 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d03b12c14ae4114a00aa82e9e9e4f40 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6d03b12c14ae4114a00aa82e9e9e4f40 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d03b12c14ae4114a00aa82e9e9e4f40 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d03b12c14ae4114a00aa82e9e9e4f40 input{text-align:left;}"; break;
		}
	}
