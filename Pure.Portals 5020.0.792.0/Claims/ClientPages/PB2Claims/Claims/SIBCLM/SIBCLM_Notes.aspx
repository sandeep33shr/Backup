<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="SIBCLM_Notes.aspx.vb" Inherits="Nexus.PB2_SIBCLM_Notes" %>
...
function onValidate_TAMCLM__IPCCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMCLM", "IPCCNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMCLM", "IPCCNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_TAMCLM__IPCCNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("TAMCLM", "IPCCNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'TAMCLM' and property 'IPCCNOTE'.");
        			error.display();
...
function onValidate_TAMCLM__IPCSCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "TAMCLM", "IPCSCNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_TAMCLM__IPCCNOTE(null, null, null, isOnLoad);
    onValidate_TAMCLM__IPCSCNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id5bf538807c8347408af4d05a2881d4a9" class="general-layout-container">
...
<div id="id6d724121367b4a8da27773edbd2bc0d5" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading31" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMCLM__IPCCNOTE"
		data-field-type="Child" 
		data-object-name="TAMCLM" 
		data-property-name="IPCCNOTE" 
		id="pb-container-childscreen-TAMCLM-IPCCNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMCLM__CNOTE_DETAILS" runat="server" ScreenCode="IPCCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="IPCCNOTE/IPCCNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTAMCLM_IPCCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_TAMCLM__IPCCNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6d724121367b4a8da27773edbd2bc0d5 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6d724121367b4a8da27773edbd2bc0d5 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6d724121367b4a8da27773edbd2bc0d5 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6d724121367b4a8da27773edbd2bc0d5 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6d724121367b4a8da27773edbd2bc0d5 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d724121367b4a8da27773edbd2bc0d5 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d724121367b4a8da27773edbd2bc0d5 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6d724121367b4a8da27773edbd2bc0d5 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d724121367b4a8da27773edbd2bc0d5 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d724121367b4a8da27773edbd2bc0d5 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id3e6d25c89f5a4f87a2dc35825dc0a435" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading32" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_TAMCLM__IPCSCNOTE"
		data-field-type="Child" 
		data-object-name="TAMCLM" 
		data-property-name="IPCSCNOTE" 
		id="pb-container-childscreen-TAMCLM-IPCSCNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="TAMCLM__EXT_DETAILS" runat="server" ScreenCode="IPCSCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="IPCSCNOTE/IPCSCNOTE_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valTAMCLM_IPCSCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_TAMCLM__IPCSCNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id3e6d25c89f5a4f87a2dc35825dc0a435 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id3e6d25c89f5a4f87a2dc35825dc0a435 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id3e6d25c89f5a4f87a2dc35825dc0a435 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id3e6d25c89f5a4f87a2dc35825dc0a435 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id3e6d25c89f5a4f87a2dc35825dc0a435 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3e6d25c89f5a4f87a2dc35825dc0a435 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3e6d25c89f5a4f87a2dc35825dc0a435 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id3e6d25c89f5a4f87a2dc35825dc0a435 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id3e6d25c89f5a4f87a2dc35825dc0a435 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id3e6d25c89f5a4f87a2dc35825dc0a435 input{text-align:left;}"; break;
		}
	}
