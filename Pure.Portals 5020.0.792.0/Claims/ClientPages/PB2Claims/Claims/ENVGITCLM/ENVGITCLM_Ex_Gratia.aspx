<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENVGITCLM_Ex_Gratia.aspx.vb" Inherits="Nexus.PB2_ENVGITCLM_Ex_Gratia" %>
...
function onValidate_ENVGITCLAIM__ENVGITGRAT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENVGITCLAIM", "ENVGITGRAT", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_ENVGITCLAIM__ENVGITGRAT(null, null, null, isOnLoad);
}
</script>
...
<div id="id9938d86460154830b31d0bcd669e5a14" class="general-layout-container">
...
<div id="frmExGratia" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading22" runat="server" Text="Ex Gratia" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENVGITCLAIM__ENVGITGRAT"
		data-field-type="Child" 
		data-object-name="ENVGITCLAIM" 
		data-property-name="ENVGITGRAT" 
		id="pb-container-childscreen-ENVGITCLAIM-ENVGITGRAT">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENVGITCLAIM__AUTH_DETAILS" runat="server" ScreenCode="ENVGITGRAT" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ENVGITGRAT/ENVGITGRAT_Ex_Gratia.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Reason" DataField="R_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valENVGITCLAIM_ENVGITGRAT" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ENVGITCLAIM.ENVGITGRAT"
						ClientValidationFunction="onValidate_ENVGITCLAIM__ENVGITGRAT" 
						Display="None"
