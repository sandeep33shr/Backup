...
Namespace Nexus
    Partial Class PB2_ENVGITCLM_Underwriting_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_ENVGITCLAIM__IS_FAC()
        
End Sub
Protected Sub onValidate_ENVGITCLAIM__SPECVBCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_ENVGITCLAIM__IS_FAC()
    onValidate_ENVGITCLAIM__SPECVBCLM()
End Sub
        ...
        Protected Shadows Sub Page_Load_ClientInfo(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Session(CNParty) IsNot Nothing Then
                If TypeOf Session(CNParty) Is NexusProvider.CorporateParty Then
                    ...
                    ENVGITCLAIM__INSURED.Text = DirectCast(oParty, NexusProvider.CorporateParty).CompanyName
                End If
                ...
                If TypeOf Session(CNParty) Is NexusProvider.PersonalParty Then
                    ...
                    ENVGITCLAIM__INSURED.Text = (firstName + " " + LastName).ToString
                    ENVGITCLAIM__CONTACTNUM.Text = Trim(MobileNo).ToString
                End If
            ...
            If Session(CNClaimQuote) IsNot Nothing Then
                ENVGITCLAIM__POLNUMBER.Text = RTrim(LTrim(oClaimQuote.InsuranceFileRef))
                ENVGITCLAIM__ALTERPOLICY.Text = RTrim(LTrim(oClaimQuote.AlternativeRef))
                ENVGITCLAIM__CVR_STARTDATE.Text = RTrim(LTrim(oClaimQuote.CoverStartDate))
                ENVGITCLAIM__CVR_ENDDATE.Text = RTrim(LTrim(oClaimQuote.CoverEndDate))
                ENVGITCLAIM__INCEPT_DATE.Text = RTrim(LTrim(oClaimQuote.InceptionDate))
        		...
        		For nIndex = 0 To Cnt
        			...
        			End If
        		Next
        		ENVGITCLAIM__IS_FAC.Text = FAC.ToString
        ...
        ' ENVGITCLAIM = The parent object name of child screen
        ' SVBASISCLM = The child screen object name
        
        Protected Sub ENVGITCLAIM__SVBASISCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles ENVGITCLAIM__SVBASISCLM.RowDataBound
