<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENVGITCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_ENVGITCLM_Third_Party" %>
...
function onValidate_ENVGITCLAIM__ENVGITPRTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENVGITCLAIM", "ENVGITPRTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_ENVGITCLAIM__ENVGITPRTY(null, null, null, isOnLoad);
}
</script>
...
<div id="idac45a462a1ca482c8874ec17210c4cd5" class="general-layout-container">
...
<div id="idba97a2b6cd41462a8d09aa2c461e788e" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading18" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENVGITCLAIM__ENVGITPRTY"
		data-field-type="Child" 
		data-object-name="ENVGITCLAIM" 
		data-property-name="ENVGITPRTY" 
		id="pb-container-childscreen-ENVGITCLAIM-ENVGITPRTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENVGITCLAIM__ENVGITTHIRD" runat="server" ScreenCode="ENVGITPRTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ENVGITPRTY/ENVGITPRTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valENVGITCLAIM_ENVGITPRTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for ENVGITCLAIM.ENVGITPRTY"
						ClientValidationFunction="onValidate_ENVGITCLAIM__ENVGITPRTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#idba97a2b6cd41462a8d09aa2c461e788e div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idba97a2b6cd41462a8d09aa2c461e788e div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idba97a2b6cd41462a8d09aa2c461e788e div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#idba97a2b6cd41462a8d09aa2c461e788e label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idba97a2b6cd41462a8d09aa2c461e788e label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idba97a2b6cd41462a8d09aa2c461e788e label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idba97a2b6cd41462a8d09aa2c461e788e label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idba97a2b6cd41462a8d09aa2c461e788e input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idba97a2b6cd41462a8d09aa2c461e788e input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idba97a2b6cd41462a8d09aa2c461e788e input{text-align:left;}"; break;
		}
	}
