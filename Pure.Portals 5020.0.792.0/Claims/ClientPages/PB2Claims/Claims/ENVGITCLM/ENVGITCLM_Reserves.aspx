<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="ENVGITCLM_Reserves.aspx.vb" Inherits="Nexus.PB2_ENVGITCLM_Reserves" %>
...
function onValidate_ENVGITCLAIM__ENVGTSLSCN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENVGITCLAIM", "ENVGTSLSCN", "ChildScreen");
        })();
}
function onValidate_ENVGITCLAIM__SOL_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENVGITCLAIM", "SOL_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("ENVGITCLAIM", "SOL_COUNTER");
        		}
          ...
          * @param ENVGITCLAIM The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "ENVGITCLAIM".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_ENVGITCLAIM__ENVGRCVRSC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENVGITCLAIM", "ENVGRCVRSC", "ChildScreen");
        })();
}
function onValidate_ENVGITCLAIM__RECO_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "ENVGITCLAIM", "RECO_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("ENVGITCLAIM", "RECO_COUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_ENVGITCLAIM__ENVGTSLSCN(null, null, null, isOnLoad);
    onValidate_ENVGITCLAIM__SOL_COUNTER(null, null, null, isOnLoad);
    onValidate_ENVGITCLAIM__ENVGRCVRSC(null, null, null, isOnLoad);
    onValidate_ENVGITCLAIM__RECO_COUNTER(null, null, null, isOnLoad);
}
</script>
...
<div id="idfc385151e1ae4f1886d4fc435c817d6e" class="general-layout-container">
...
<div id="id6e67b0a99eb04a4cb839f886ec268757" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading39" runat="server" Text="Claim Reserves" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENVGITCLAIM__ENVGTSLSCN"
		data-field-type="Child" 
		data-object-name="ENVGITCLAIM" 
		data-property-name="ENVGTSLSCN" 
		id="pb-container-childscreen-ENVGITCLAIM-ENVGTSLSCN">
		
		    <legend>Schedule of Loss</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENVGITCLAIM__SCHEDULE_LOSS" runat="server" ScreenCode="ENVGTSLSCN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ENVGTSLSCN/ENVGTSLSCN_Schedule_of_Loss.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_ENVGIT_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Payment Amount" DataField="PAYMENT_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valENVGITCLAIM_ENVGTSLSCN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Schedule of Loss"
						ClientValidationFunction="onValidate_ENVGITCLAIM__ENVGTSLSCN" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-ENVGITCLAIM-SOL_COUNTER">
		<asp:Label ID="lblENVGITCLAIM_SOL_COUNTER" runat="server" AssociatedControlID="ENVGITCLAIM__SOL_COUNTER" 
			Text="Schedule Item Counter " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ENVGITCLAIM__SOL_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valENVGITCLAIM_SOL_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Schedule Item Counter "
			ClientValidationFunction="onValidate_ENVGITCLAIM__SOL_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id6e67b0a99eb04a4cb839f886ec268757 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6e67b0a99eb04a4cb839f886ec268757 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6e67b0a99eb04a4cb839f886ec268757 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id6e67b0a99eb04a4cb839f886ec268757 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6e67b0a99eb04a4cb839f886ec268757 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6e67b0a99eb04a4cb839f886ec268757 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6e67b0a99eb04a4cb839f886ec268757 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6e67b0a99eb04a4cb839f886ec268757 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6e67b0a99eb04a4cb839f886ec268757 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6e67b0a99eb04a4cb839f886ec268757 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id94c0f7b674c145fe8bf9cb9bec37ba97" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_ENVGITCLAIM__ENVGRCVRSC"
		data-field-type="Child" 
		data-object-name="ENVGITCLAIM" 
		data-property-name="ENVGRCVRSC" 
		id="pb-container-childscreen-ENVGITCLAIM-ENVGRCVRSC">
		
		    <legend>Recoveries</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="ENVGITCLAIM__RECOVERIES" runat="server" ScreenCode="ENVGRCVRSC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="ENVGRCVRSC/ENVGRCVRSC_Recovery.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_ENVGIT_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Negotiated Amount" DataField="NEGOTIATED_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valENVGITCLAIM_ENVGRCVRSC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Recoveries"
						ClientValidationFunction="onValidate_ENVGITCLAIM__ENVGRCVRSC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-ENVGITCLAIM-RECO_COUNTER">
		<asp:Label ID="lblENVGITCLAIM_RECO_COUNTER" runat="server" AssociatedControlID="ENVGITCLAIM__RECO_COUNTER" 
			Text="Recoveries counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="ENVGITCLAIM__RECO_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valENVGITCLAIM_RECO_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recoveries counter"
			ClientValidationFunction="onValidate_ENVGITCLAIM__RECO_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id94c0f7b674c145fe8bf9cb9bec37ba97 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id94c0f7b674c145fe8bf9cb9bec37ba97 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id94c0f7b674c145fe8bf9cb9bec37ba97 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	  
			  if (liElementHeight > liMaxHeight)
			  {
				  liMaxHeight = liElementHeight;			  
	...
	if (labelWidth != ""){
		...
		styleString += "#id94c0f7b674c145fe8bf9cb9bec37ba97 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id94c0f7b674c145fe8bf9cb9bec37ba97 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id94c0f7b674c145fe8bf9cb9bec37ba97 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id94c0f7b674c145fe8bf9cb9bec37ba97 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id94c0f7b674c145fe8bf9cb9bec37ba97 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id94c0f7b674c145fe8bf9cb9bec37ba97 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id94c0f7b674c145fe8bf9cb9bec37ba97 input{text-align:left;}"; break;
		}
	}
