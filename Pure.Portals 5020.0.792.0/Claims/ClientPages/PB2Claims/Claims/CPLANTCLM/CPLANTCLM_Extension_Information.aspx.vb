...
Namespace Nexus
    Partial Class PB2_CPLANTCLM_Extension_Information : Inherits BaseClaim
		...
		Protected Sub onValidate_EXTCLM__ADDEXTCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_EXTCLM__ADDEXTCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' EXTCLM = The parent object name of child screen
        ' ADDEXTCLM = The child screen object name
        
        Protected Sub EXTCLM__ADDEXTCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles EXTCLM__ADDEXTCLM.RowDataBound
