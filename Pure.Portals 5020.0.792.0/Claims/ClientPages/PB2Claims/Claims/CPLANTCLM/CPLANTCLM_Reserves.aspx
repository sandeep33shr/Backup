<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPLANTCLM_Reserves.aspx.vb" Inherits="Nexus.PB2_CPLANTCLM_Reserves" %>
...
function onValidate_CPLANTCLAIM__CPLNSOLSCN(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANTCLAIM", "CPLNSOLSCN", "ChildScreen");
        })();
}
function onValidate_CPLANTCLAIM__SOL_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANTCLAIM", "SOL_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CPLANTCLAIM", "SOL_COUNTER");
        		}
          ...
          * @param CPLANTCLAIM The Parent (Root) object name.
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		...
        		var screenObjectStr = "CPLANTCLAIM".toUpperCase().replace(/^\s+|\s+$/g, '');
...
function onValidate_CPLANTCLAIM__CPLNRCVRSC(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANTCLAIM", "CPLNRCVRSC", "ChildScreen");
        })();
}
function onValidate_CPLANTCLAIM__RECO_COUNTER(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANTCLAIM", "RECO_COUNTER", "Integer");
        })();
        /**
         * @fileoverview
         * NotOnPage. Set field to hidden, hidden doesn't take up space in the document.
        ...
        (function(){
        	if (isOnLoad) {		
        		if ("{name}" != ("{na" + "me}")){
        			...
        			var field = Field.getInstance("CPLANTCLAIM", "RECO_COUNTER");
        		}
        		var exp = Expression.isValidParameter("{0}") ? new Expression("{0}") : true;
...
function DoLogic(isOnLoad) {
    onValidate_CPLANTCLAIM__CPLNSOLSCN(null, null, null, isOnLoad);
    onValidate_CPLANTCLAIM__SOL_COUNTER(null, null, null, isOnLoad);
    onValidate_CPLANTCLAIM__CPLNRCVRSC(null, null, null, isOnLoad);
    onValidate_CPLANTCLAIM__RECO_COUNTER(null, null, null, isOnLoad);
}
</script>
...
<div id="id9f8b2b36e6364ec2b946fecb737286bc" class="general-layout-container">
...
<div id="id15967c49eec947a099130eaaff6b9bd0" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading75" runat="server" Text="Claim Reserves" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPLANTCLAIM__CPLNSOLSCN"
		data-field-type="Child" 
		data-object-name="CPLANTCLAIM" 
		data-property-name="CPLNSOLSCN" 
		id="pb-container-childscreen-CPLANTCLAIM-CPLNSOLSCN">
		
		    <legend>Schedule of Loss</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPLANTCLAIM__SCHEDULE_LOSS" runat="server" ScreenCode="CPLNSOLSCN" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPLNSOLSCN/CPLNSOLSCN_Schedule_of_Loss.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_CONPLANT_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Payment Amount" DataField="PAYMENT_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPLANTCLAIM_CPLNSOLSCN" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Schedule of Loss"
						ClientValidationFunction="onValidate_CPLANTCLAIM__CPLNSOLSCN" 
						Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-CPLANTCLAIM-SOL_COUNTER">
		<asp:Label ID="lblCPLANTCLAIM_SOL_COUNTER" runat="server" AssociatedControlID="CPLANTCLAIM__SOL_COUNTER" 
			Text="Schedule Item Counter " CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CPLANTCLAIM__SOL_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCPLANTCLAIM_SOL_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Schedule Item Counter "
			ClientValidationFunction="onValidate_CPLANTCLAIM__SOL_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id15967c49eec947a099130eaaff6b9bd0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id15967c49eec947a099130eaaff6b9bd0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id15967c49eec947a099130eaaff6b9bd0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id15967c49eec947a099130eaaff6b9bd0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id15967c49eec947a099130eaaff6b9bd0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15967c49eec947a099130eaaff6b9bd0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15967c49eec947a099130eaaff6b9bd0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id15967c49eec947a099130eaaff6b9bd0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id15967c49eec947a099130eaaff6b9bd0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id15967c49eec947a099130eaaff6b9bd0 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id7783499293ef4b1ba8d8fc7659f78ebe" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading76" runat="server" Text="Claim Recoveries" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPLANTCLAIM__CPLNRCVRSC"
		data-field-type="Child" 
		data-object-name="CPLANTCLAIM" 
		data-property-name="CPLNRCVRSC" 
		id="pb-container-childscreen-CPLANTCLAIM-CPLNRCVRSC">
		
		    <legend>Recoveries</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPLANTCLAIM__RECOVERIES" runat="server" ScreenCode="CPLNRCVRSC" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPLNRCVRSC/CPLNRCVRSC_Recovery.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Item Number" DataField="ITEM_NUMBER" DataFormatString=""/>
<Nexus:GISLookupField HeaderText="Peril" ListType="PMLookup" ListCode="UDL_CONPLANT_PERIL_TYPE" DataField="PERIL" DataItemValue="key" />
...
<Nexus:RiskAttribute HeaderText="Negotiated Amount" DataField="NEGOTIATED_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPLANTCLAIM_CPLNRCVRSC" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Recoveries"
						ClientValidationFunction="onValidate_CPLANTCLAIM__CPLNRCVRSC" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		id="pb-container-integer-CPLANTCLAIM-RECO_COUNTER">
		<asp:Label ID="lblCPLANTCLAIM_RECO_COUNTER" runat="server" AssociatedControlID="CPLANTCLAIM__RECO_COUNTER" 
			Text="Recoveries counter" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
			<div class="col-md-8 col-sm-9">
		       <asp:TextBox ID="CPLANTCLAIM__RECO_COUNTER" runat="server" CssClass="form-control" />
			   <asp:CustomValidator ID="valCPLANTCLAIM_RECO_COUNTER" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recoveries counter"
			ClientValidationFunction="onValidate_CPLANTCLAIM__RECO_COUNTER" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
		    </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id7783499293ef4b1ba8d8fc7659f78ebe div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id7783499293ef4b1ba8d8fc7659f78ebe div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id7783499293ef4b1ba8d8fc7659f78ebe div ul li").each(function(){		  
			  liElementHeight = $(this).height();	  
			  if (liElementHeight > liMaxHeight)
			  {
				  liMaxHeight = liElementHeight;			  
	...
	if (labelWidth != ""){
		...
		styleString += "#id7783499293ef4b1ba8d8fc7659f78ebe label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id7783499293ef4b1ba8d8fc7659f78ebe label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7783499293ef4b1ba8d8fc7659f78ebe label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7783499293ef4b1ba8d8fc7659f78ebe label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id7783499293ef4b1ba8d8fc7659f78ebe input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id7783499293ef4b1ba8d8fc7659f78ebe input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id7783499293ef4b1ba8d8fc7659f78ebe input{text-align:left;}"; break;
		}
	}
