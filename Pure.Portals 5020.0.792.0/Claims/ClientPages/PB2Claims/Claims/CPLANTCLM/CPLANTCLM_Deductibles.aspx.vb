...
Namespace Nexus
    Partial Class PB2_CPLANTCLM_Deductibles : Inherits BaseClaim
		...
		Protected Sub onValidate_CPDEDUCCLM__NBDEDCLM()
        
End Sub
Protected Sub onValidate_CPDEDUCCLM__DEDCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CPDEDUCCLM__NBDEDCLM()
    onValidate_CPDEDUCCLM__DEDCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CPDEDUCCLM = The parent object name of child screen
        ' NONBAND_CPCLM = The child screen object name
        
        Protected Sub CPDEDUCCLM__NONBAND_CPCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CPDEDUCCLM__NONBAND_CPCLM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CPDEDUCCLM = The parent object name of child screen
        ' DED_CPCLM = The child screen object name
        
        Protected Sub CPDEDUCCLM__DED_CPCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CPDEDUCCLM__DED_CPCLM.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
