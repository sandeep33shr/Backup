<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPLANTCLM_Ex_Gratia.aspx.vb" Inherits="Nexus.PB2_CPLANTCLM_Ex_Gratia" %>
...
function onValidate_CPLANTCLAIM__CPLANGRDTL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANTCLAIM", "CPLANGRDTL", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CPLANTCLAIM__CPLANGRDTL(null, null, null, isOnLoad);
}
</script>
...
<div id="ida097281cb00c4cfe96e370ecabed751d" class="general-layout-container">
...
<div id="frmExGratia" class="column-layout-container,no-border  ">
	              ...
	              <legend><asp:Label ID="lblHeading58" runat="server" Text="Ex Gratia" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPLANTCLAIM__CPLANGRDTL"
		data-field-type="Child" 
		data-object-name="CPLANTCLAIM" 
		data-property-name="CPLANGRDTL" 
		id="pb-container-childscreen-CPLANTCLAIM-CPLANGRDTL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPLANTCLAIM__AUTH_DETAILS" runat="server" ScreenCode="CPLANGRDTL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPLANGRDTL/CPLANGRDTL_Ex_Gratia.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Reason" DataField="R_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCPLANTCLAIM_CPLANGRDTL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CPLANTCLAIM.CPLANGRDTL"
						ClientValidationFunction="onValidate_CPLANTCLAIM__CPLANGRDTL" 
						Display="None"
