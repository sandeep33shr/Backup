...
Namespace Nexus
    Partial Class PB2_CPLANTCLM_Construction_Public_Liability : Inherits BaseClaim
		...
		Protected Sub onValidate_CPLDEDCLM__CPLDCLM()
        
End Sub
Protected Sub onValidate_CPLDEDCLM__PLEXCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CPLDEDCLM__CPLDCLM()
    onValidate_CPLDEDCLM__PLEXCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CPLDEDCLM = The parent object name of child screen
        ' INSCLM = The child screen object name
        
        Protected Sub CPLDEDCLM__INSCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CPLDEDCLM__INSCLM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CPLDEDCLM = The parent object name of child screen
        ' EXTCLAIM = The child screen object name
        
        Protected Sub CPLDEDCLM__EXTCLAIM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CPLDEDCLM__EXTCLAIM.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
