...
Namespace Nexus
    Partial Class PB2_CPLANTCLM_Hired_in_Plant : Inherits BaseClaim
		...
		Protected Sub onValidate_HIPCPLANTCLM__ADDHIP()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_HIPCPLANTCLM__ADDHIP()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' HIPCPLANTCLM = The parent object name of child screen
        ' HIPADDITEMS = The child screen object name
        
        Protected Sub HIPCPLANTCLM__HIPADDITEMS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles HIPCPLANTCLM__HIPADDITEMS.RowDataBound
