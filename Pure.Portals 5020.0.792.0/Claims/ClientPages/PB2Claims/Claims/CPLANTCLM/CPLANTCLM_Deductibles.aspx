<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPLANTCLM_Deductibles.aspx.vb" Inherits="Nexus.PB2_CPLANTCLM_Deductibles" %>
...
function onValidate_CPDEDUCCLM__AGGDEDUCT(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPDEDUCCLM", "AGGDEDUCT", "Checkbox");
        })();
        /**
         * @fileoverview
        ...
        (function(){
        	...
        	var field = Field.getInstance("CPDEDUCCLM", "AGGDEDUCT");
        ...
        (function(){
        	...
        	if (isOnLoad) {
        		...
        		events.listen(Field.getInstance("CPDEDUCCLM", "AGGDEDUCT"), "change", update);
        		update();
        	}
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPDEDUCCLM.AGGDEDUCT");
        			window.setControlWidth(field, "0.8", "CPDEDUCCLM", "AGGDEDUCT");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblCPDEDUCCLM_AGGDEDUCT");
        			}
...
function onValidate_CPDEDUCCLM__DEDUCTFUND(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPDEDUCCLM", "DEDUCTFUND", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CPDEDUCCLM", "DEDUCTFUND");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPDEDUCCLM.DEDUCTFUND");
        			window.setControlWidth(field, "0.8", "CPDEDUCCLM", "DEDUCTFUND");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblCPDEDUCCLM_DEDUCTFUND");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
...
function onValidate_CPDEDUCCLM__STOPLOSS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPDEDUCCLM", "STOPLOSS", "Text");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
        ...
        (function(){
        	...
        	var field = Field.getInstance("CPDEDUCCLM", "STOPLOSS");
        	field.setReadOnly(true);
        })();
        /**
         * Set the control width
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CPDEDUCCLM.STOPLOSS");
        			window.setControlWidth(field, "0.8", "CPDEDUCCLM", "STOPLOSS");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        				...
        				var label = document.getElementById("ctl00_cntMainBody_lblCPDEDUCCLM_STOPLOSS");
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        				//standardWidth = bounds.width;
...
function onValidate_CPDEDUCCLM__NBDEDCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPDEDUCCLM", "NBDEDCLM", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param CPDEDUCCLM The object name of the control to set.
         * @parma NONBAND_CPCLM The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=CPDEDUCCLM__NONBAND_CPCLM.ClientID %>').find('table').find('tr').each(function () {
...
function onValidate_CPDEDUCCLM__DEDCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPDEDUCCLM", "DEDCLM", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param CPDEDUCCLM The object name of the control to set.
         * @parma DED_CPCLM The property name of the control to set to the result of the calculated premium.
         */
        (function(){
        	if (isOnLoad) {
        		$('#<%=CPDEDUCCLM__DED_CPCLM.ClientID %>').find('table').find('tr').each(function () {
        			$(this).find('td:last').find('a').each(function () {
        				var linkVal = $.trim($(this).text());
        				if (linkVal.toUpperCase() == 'EDIT') {
        					$(this).text('Select');
...
function DoLogic(isOnLoad) {
    onValidate_CPDEDUCCLM__AGGDEDUCT(null, null, null, isOnLoad);
    onValidate_CPDEDUCCLM__DEDUCTFUND(null, null, null, isOnLoad);
    onValidate_CPDEDUCCLM__STOPLOSS(null, null, null, isOnLoad);
    onValidate_CPDEDUCCLM__NBDEDCLM(null, null, null, isOnLoad);
    onValidate_CPDEDUCCLM__DEDCLM(null, null, null, isOnLoad);
}
</script>
...
<div id="idb58b032a66704bc9bda2fd338ee7645b" class="general-layout-container">
...
<label id="ctl00_cntMainBody_lblCPDEDUCCLM_AGGDEDUCT" for="ctl00_cntMainBody_CPDEDUCCLM__AGGDEDUCT" class="col-md-4 col-sm-3 control-label">
		Aggregate Deductibles</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CPDEDUCCLM" 
		data-property-name="AGGDEDUCT" 
		id="pb-container-checkbox-CPDEDUCCLM-AGGDEDUCT">	
		
		<asp:TextBox ID="CPDEDUCCLM__AGGDEDUCT" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCPDEDUCCLM_AGGDEDUCT" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Aggregate Deductibles"
			ClientValidationFunction="onValidate_CPDEDUCCLM__AGGDEDUCT" 
			ValidationGroup=""
			Display="None"
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CPDEDUCCLM-DEDUCTFUND">

		
		<asp:Label ID="lblCPDEDUCCLM_DEDUCTFUND" runat="server" AssociatedControlID="CPDEDUCCLM__DEDUCTFUND" 
			Text="Aggregate Deductible Fund" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CPDEDUCCLM__DEDUCTFUND" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCPDEDUCCLM_DEDUCTFUND" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Aggregate Deductible Fund"
					ClientValidationFunction="onValidate_CPDEDUCCLM__DEDUCTFUND"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CPDEDUCCLM-STOPLOSS">

		
		<asp:Label ID="lblCPDEDUCCLM_STOPLOSS" runat="server" AssociatedControlID="CPDEDUCCLM__STOPLOSS" 
			Text="Stop Loss" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CPDEDUCCLM__STOPLOSS" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCPDEDUCCLM_STOPLOSS" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for Stop Loss"
					ClientValidationFunction="onValidate_CPDEDUCCLM__STOPLOSS"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPDEDUCCLM__NBDEDCLM"
		data-field-type="Child" 
		data-object-name="CPDEDUCCLM" 
		data-property-name="NBDEDCLM" 
		id="pb-container-childscreen-CPDEDUCCLM-NBDEDCLM">
		
		    <legend>Non Band Deductibles</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPDEDUCCLM__NONBAND_CPCLM" runat="server" ScreenCode="NBDEDCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="NBDEDCLM/NBDEDCLM_Non_Band_Deductibles.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Maximum Amount" DataField="MAXIMUM_AM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPDEDUCCLM_NBDEDCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Non Band Deductibles"
						ClientValidationFunction="onValidate_CPDEDUCCLM__NBDEDCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPDEDUCCLM__DEDCLM"
		data-field-type="Child" 
		data-object-name="CPDEDUCCLM" 
		data-property-name="DEDCLM" 
		id="pb-container-childscreen-CPDEDUCCLM-DEDCLM">
		
		    <legend>Deductibles</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPDEDUCCLM__DED_CPCLM" runat="server" ScreenCode="DEDCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="DEDCLM/DEDCLM_Deductibles.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Description" DataField="DESCRIPTION" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Maximum Amount" DataField="MAXIMUM_AM" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valCPDEDUCCLM_DEDCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Deductibles"
						ClientValidationFunction="onValidate_CPDEDUCCLM__DEDCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
