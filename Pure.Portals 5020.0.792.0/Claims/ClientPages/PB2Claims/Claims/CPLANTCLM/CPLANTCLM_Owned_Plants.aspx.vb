...
Namespace Nexus
    Partial Class PB2_CPLANTCLM_Owned_Plants : Inherits BaseClaim
		...
		Protected Sub onValidate_CPLANTCLAIM__OPDTLS()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CPLANTCLAIM__OPDTLS()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' CPLANTCLAIM = The parent object name of child screen
        ' PLANTDETCLM = The child screen object name
        
        Protected Sub CPLANTCLAIM__PLANTDETCLM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles CPLANTCLAIM__PLANTDETCLM.RowDataBound
