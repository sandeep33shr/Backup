<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CPLANTCLM_Third_Party.aspx.vb" Inherits="Nexus.PB2_CPLANTCLM_Third_Party" %>
...
function onValidate_CPLANTCLAIM__CPLANTPRTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CPLANTCLAIM", "CPLANTPRTY", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CPLANTCLAIM__CPLANTPRTY(null, null, null, isOnLoad);
}
</script>
...
<div id="id1c4cab28ff4f4b9ca93c509272e829fd" class="general-layout-container">
...
<div id="id654ae6aa5bc4483ea032fa5d1498eb0d" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading54" runat="server" Text="Third Party" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CPLANTCLAIM__CPLANTPRTY"
		data-field-type="Child" 
		data-object-name="CPLANTCLAIM" 
		data-property-name="CPLANTPRTY" 
		id="pb-container-childscreen-CPLANTCLAIM-CPLANTPRTY">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CPLANTCLAIM__CPLANTTHIRD" runat="server" ScreenCode="CPLANTPRTY" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CPLANTPRTY/CPLANTPRTY_Third_Party_Recoveries.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Status" DataField="DESC_STATUS" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCPLANTCLAIM_CPLANTPRTY" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CPLANTCLAIM.CPLANTPRTY"
						ClientValidationFunction="onValidate_CPLANTCLAIM__CPLANTPRTY" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id654ae6aa5bc4483ea032fa5d1498eb0d div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id654ae6aa5bc4483ea032fa5d1498eb0d div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id654ae6aa5bc4483ea032fa5d1498eb0d div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id654ae6aa5bc4483ea032fa5d1498eb0d label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id654ae6aa5bc4483ea032fa5d1498eb0d label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id654ae6aa5bc4483ea032fa5d1498eb0d label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id654ae6aa5bc4483ea032fa5d1498eb0d label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id654ae6aa5bc4483ea032fa5d1498eb0d input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id654ae6aa5bc4483ea032fa5d1498eb0d input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id654ae6aa5bc4483ea032fa5d1498eb0d input{text-align:left;}"; break;
		}
	}
