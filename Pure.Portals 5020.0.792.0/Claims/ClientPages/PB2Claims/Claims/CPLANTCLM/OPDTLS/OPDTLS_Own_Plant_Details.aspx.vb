...
Namespace Nexus
    Partial Class PB2_OPDTLS_Own_Plant_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_PLANTDETCLM__OPNOVALCLM()
        
End Sub
Protected Sub onValidate_PLANTDETCLM__OPVALCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_PLANTDETCLM__OPNOVALCLM()
    onValidate_PLANTDETCLM__OPVALCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' PLANTDETCLM = The parent object name of child screen
        ' OPNON_VALBD = The child screen object name
        
        Protected Sub PLANTDETCLM__OPNON_VALBD_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles PLANTDETCLM__OPNON_VALBD.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' PLANTDETCLM = The parent object name of child screen
        ' OPVALBD = The child screen object name
        
        Protected Sub PLANTDETCLM__OPVALBD_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles PLANTDETCLM__OPVALBD.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
