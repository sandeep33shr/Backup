...
Namespace Nexus
    Partial Class PB2_CMAMFCLM_Premises_Insured : Inherits BaseClaim
		...
		Protected Sub onValidate_FLEET__CMFDETCLM()
        
End Sub
Protected Sub onValidate_FLEET__CMFVDCLM()
        
End Sub
Protected Sub onValidate_FLEET__CMFSSECLM()
        
End Sub
Protected Sub onValidate_FLEET__CMFIPCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FLEET__CMFDETCLM()
    onValidate_FLEET__CMFVDCLM()
    onValidate_FLEET__CMFSSECLM()
    onValidate_FLEET__CMFIPCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' FLEET = The parent object name of child screen
        ' FLEET_DETAILS = The child screen object name
        
        Protected Sub FLEET__FLEET_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FLEET__FLEET_DETAILS.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' FLEET = The parent object name of child screen
        ' VEHICLE_DETAILS = The child screen object name
        
        Protected Sub FLEET__VEHICLE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FLEET__VEHICLE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' FLEET = The parent object name of child screen
        ' SOUND_EQUIPMENT = The child screen object name
        
        Protected Sub FLEET__SOUND_EQUIPMENT_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FLEET__SOUND_EQUIPMENT.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' FLEET = The parent object name of child screen
        ' INT_PARTIES = The child screen object name
        
        Protected Sub FLEET__INT_PARTIES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FLEET__INT_PARTIES.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
