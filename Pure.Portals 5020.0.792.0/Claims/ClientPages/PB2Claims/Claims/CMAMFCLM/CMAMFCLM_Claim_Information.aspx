<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMFCLM_Claim_Information.aspx.vb" Inherits="Nexus.PB2_CMAMFCLM_Claim_Information" %>
...
function onValidate_CMAMFCLAIM__THIRDPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMFCLAIM", "THIRDPARTY", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMFCLAIM_THIRDPARTY");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMFCLAIM__THIRDPARTY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMFCLAIM__THIRDPARTY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMFCLAIM__SALVAGE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMFCLAIM", "SALVAGE", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMFCLAIM_SALVAGE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMFCLAIM__SALVAGE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMFCLAIM__SALVAGE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMFCLAIM__RECOVERY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMFCLAIM", "RECOVERY", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMFCLAIM_RECOVERY");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMFCLAIM__RECOVERY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMFCLAIM__RECOVERY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMFCLAIM__IS_THRDTLS(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMFCLAIM", "IS_THRDTLS", "Checkbox");
        })();
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CMAMFCLAIM.IS_THRDTLS");
        		var update = function(){
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMFCLAIM_IS_THRDTLS");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMFCLAIM__IS_THRDTLS');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMFCLAIM__IS_THRDTLS_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMFCLAIM__IS_NAMAPP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMFCLAIM", "IS_NAMAPP", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CMAMFCLAIM", "IS_NAMAPP");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMFCLAIM_IS_NAMAPP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMFCLAIM__IS_NAMAPP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMFCLAIM__IS_NAMAPP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMFCLAIM__NAMDECISION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMFCLAIM", "NAMDECISION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CMAMFCLAIM", "NAMDECISION");
        		}
        		//window.setProperty(field, "VE", "GENERAL.CLMDECISIONCODE == 2", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CMAMFCLAIM", "NAMDECISION");
        		var exp = new Expression("CMAMFCLAIM.IS_NAMAPP == true");
        		var errorMessage = "{1}";
        		var go = function(){
        			if (exp.getValue() == true){
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CMAMFCLAIM.NAMDECISION");
        			window.setControlWidth(field, "0.8", "CMAMFCLAIM", "NAMDECISION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMFCLAIM_NAMDECISION");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMFCLAIM__NAMDECISION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMFCLAIM__NAMDECISION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMFCLAIM__CMFTRAIL(source, args, sender, isOnLoad) {
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CMAMFCLAIM__THIRDPARTY(null, null, null, isOnLoad);
    onValidate_CMAMFCLAIM__SALVAGE(null, null, null, isOnLoad);
    onValidate_CMAMFCLAIM__RECOVERY(null, null, null, isOnLoad);
    onValidate_CMAMFCLAIM__IS_THRDTLS(null, null, null, isOnLoad);
    onValidate_CMAMFCLAIM__IS_NAMAPP(null, null, null, isOnLoad);
    onValidate_CMAMFCLAIM__NAMDECISION(null, null, null, isOnLoad);
    onValidate_CMAMFCLAIM__CMFTRAIL(null, null, null, isOnLoad);
...
<div id="idc959cc92278e4fbe9e89228623c2474c" class="general-layout-container">
...
<div id="frmClmTyp" class="column-layout-container,no-border  ">
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMFCLAIM_THIRDPARTY" for="ctl00_cntMainBody_CMAMFCLAIM__THIRDPARTY" class="col-md-4 col-sm-3 control-label">
		Third Party</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CMAMFCLAIM-THIRDPARTY">	
		
		<asp:TextBox ID="CMAMFCLAIM__THIRDPARTY" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMFCLAIM_THIRDPARTY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Third Party"
			ClientValidationFunction="onValidate_CMAMFCLAIM__THIRDPARTY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMFCLAIM_SALVAGE" for="ctl00_cntMainBody_CMAMFCLAIM__SALVAGE" class="col-md-4 col-sm-3 control-label">
		Salvage</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CMAMFCLAIM-SALVAGE">	
		
		<asp:TextBox ID="CMAMFCLAIM__SALVAGE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMFCLAIM_SALVAGE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Salvage"
			ClientValidationFunction="onValidate_CMAMFCLAIM__SALVAGE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMFCLAIM_RECOVERY" for="ctl00_cntMainBody_CMAMFCLAIM__RECOVERY" class="col-md-4 col-sm-3 control-label">
		Recovery</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CMAMFCLAIM-RECOVERY">	
		
		<asp:TextBox ID="CMAMFCLAIM__RECOVERY" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMFCLAIM_RECOVERY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recovery"
			ClientValidationFunction="onValidate_CMAMFCLAIM__RECOVERY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMFCLAIM_IS_THRDTLS" for="ctl00_cntMainBody_CMAMFCLAIM__IS_THRDTLS" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CMAMFCLAIM-IS_THRDTLS">	
		
		<asp:TextBox ID="CMAMFCLAIM__IS_THRDTLS" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMFCLAIM_IS_THRDTLS" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Third Party Details"
			ClientValidationFunction="onValidate_CMAMFCLAIM__IS_THRDTLS" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMFCLAIM_IS_NAMAPP" for="ctl00_cntMainBody_CMAMFCLAIM__IS_NAMAPP" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CMAMFCLAIM-IS_NAMAPP">	
		
		<asp:TextBox ID="CMAMFCLAIM__IS_NAMAPP" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMFCLAIM_IS_NAMAPP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NAMFISA Approached"
			ClientValidationFunction="onValidate_CMAMFCLAIM__IS_NAMAPP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CMAMFCLAIM-NAMDECISION">

		
		<asp:Label ID="lblCMAMFCLAIM_NAMDECISION" runat="server" AssociatedControlID="CMAMFCLAIM__NAMDECISION" 
			Text="NAMFISA Decision" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CMAMFCLAIM__NAMDECISION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCMAMFCLAIM_NAMDECISION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for NAMFISA Decision"
					ClientValidationFunction="onValidate_CMAMFCLAIM__NAMDECISION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idb3dd51f60be5413da0866b2b49fbb3a0" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CMAMFCLAIM__CMFTRAIL"
		data-field-type="Child" 
		data-object-name="CMAMFCLAIM" 
		data-property-name="CMFTRAIL" 
		id="pb-container-childscreen-CMAMFCLAIM-CMFTRAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CMAMFCLAIM__AUDIT" runat="server" ScreenCode="CMFTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMFTRAIL/CMFTRAIL_Audit_Trail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Changed By" DataField="CHANGED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCMAMFCLAIM_CMFTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CMAMFCLAIM.CMFTRAIL"
						ClientValidationFunction="onValidate_CMAMFCLAIM__CMFTRAIL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idb3dd51f60be5413da0866b2b49fbb3a0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idb3dd51f60be5413da0866b2b49fbb3a0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idb3dd51f60be5413da0866b2b49fbb3a0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idb3dd51f60be5413da0866b2b49fbb3a0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idb3dd51f60be5413da0866b2b49fbb3a0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb3dd51f60be5413da0866b2b49fbb3a0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb3dd51f60be5413da0866b2b49fbb3a0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idb3dd51f60be5413da0866b2b49fbb3a0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idb3dd51f60be5413da0866b2b49fbb3a0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idb3dd51f60be5413da0866b2b49fbb3a0 input{text-align:left;}"; break;
		}
	}
