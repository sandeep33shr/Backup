...
Namespace Nexus
    Partial Class PB2_CMAMFCLM_Endorsements_and_Notes : Inherits BaseClaim
		...
		Protected Sub onValidate_FLEET__CMAMFEPCLM()
        
End Sub
Protected Sub onValidate_FLEET__MFNOTESCLM()
        
End Sub
Protected Sub onValidate_FLEET__MFSNOTESCM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_FLEET__CMAMFEPCLM()
    onValidate_FLEET__MFNOTESCLM()
    onValidate_FLEET__MFSNOTESCM()
End Sub
        ...
        Protected Sub FLEET__CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FLEET__CLAUSEPREM.RowDataBound
        ...
        Protected Sub FLEET__CNOTE_DETAIL_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FLEET__CNOTE_DETAIL.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        Protected Sub FLEET__SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles FLEET__SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
