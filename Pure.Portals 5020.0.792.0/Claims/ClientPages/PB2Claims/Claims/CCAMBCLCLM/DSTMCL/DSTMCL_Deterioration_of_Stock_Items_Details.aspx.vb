...
Namespace Nexus
    Partial Class PB2_DSTMCL_Deterioration_of_Stock_Items_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_DS_ITEM__DSNTSCL()
        
End Sub
Protected Sub onValidate_DS_ITEM__DSSNTSCL()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_DS_ITEM__DSNTSCL()
    onValidate_DS_ITEM__DSSNTSCL()
End Sub
