<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="MBTMCL_Machinery_Breakdown_Item_Details.aspx.vb" Inherits="Nexus.PB2_MBTMCL_Machinery_Breakdown_Item_Details" %>
...
function onValidate_MB_ITEM__CATEG(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "CATEG", "List");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
...
function onValidate_MB_ITEM__SUB_CATEG(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "SUB_CATEG", "List");
        })();
        /**
         * @fileoverview
         * Read Only, make the field Read Only
...
function onValidate_MB_ITEM__MBTMPCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBTMPCLM", "ChildScreen");
        })();
        /** 
...
function onValidate_MB_ITEM__MBTMNTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBTMNTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MB_ITEM The object name of the control to set.
...
function onValidate_MB_ITEM__MBTMSNTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MB_ITEM", "MBTMSNTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MB_ITEM The object name of the control to set.
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MB_ITEM__MBTMPCLM(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBTMNTCL(null, null, null, isOnLoad);
    onValidate_MB_ITEM__MBTMSNTCL(null, null, null, isOnLoad);
}
</script>
...
<div id="ideec695cfcb184674ac5c84f22afc6d4d" class="general-layout-container">
...
<div id="id32b8cede88b948be83eaaf5f70bee3d0" class="column-layout-container,no-border  ">
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMB_ITEM_CATEG" runat="server" AssociatedControlID="MB_ITEM__CATEG" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="MB_ITEM__CATEG" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_MBCL_CAT" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_MB_ITEM__CATEG(null, null, this);" data-type="List" />
...
<div class="form-group form-group-sm">
	<span class="field-container"
		...
		<asp:Label ID="lblMB_ITEM_SUB_CATEG" runat="server" AssociatedControlID="MB_ITEM__SUB_CATEG" 
			...
			<div class="col-md-8 col-sm-9">
				<NexusProvider:LookupListV2 ID="MB_ITEM__SUB_CATEG" runat="server" CssClass="form-control" ListType="PMLookup" ListCode="UDL_CMA_MBCL_SUBCAT" ParentLookupListID="" DataItemValue="Code" DataItemText="Description" DefaultText="--Please Select--" onChange="onValidate_MB_ITEM__SUB_CATEG(null, null, this);" data-type="List" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-MB_ITEM-CATEGCode">

		
		
			
		
				<asp:HiddenField ID="MB_ITEM__CATEGCode" runat="server" />
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		data-object-name="MB_ITEM" 
		data-property-name="SUB_CATEGCode" 
		data-dre="true" 
		
		data-suffix-none="true" 
		id="pb-container-text-MB_ITEM-SUB_CATEGCode">

		
		
			
		
				<asp:HiddenField ID="MB_ITEM__SUB_CATEGCode" runat="server" />
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id32b8cede88b948be83eaaf5f70bee3d0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id32b8cede88b948be83eaaf5f70bee3d0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id32b8cede88b948be83eaaf5f70bee3d0 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id32b8cede88b948be83eaaf5f70bee3d0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id32b8cede88b948be83eaaf5f70bee3d0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id32b8cede88b948be83eaaf5f70bee3d0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id32b8cede88b948be83eaaf5f70bee3d0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id32b8cede88b948be83eaaf5f70bee3d0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id32b8cede88b948be83eaaf5f70bee3d0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id32b8cede88b948be83eaaf5f70bee3d0 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id813f9af1bcd14cbaa7eec9aee20cb872" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBTMPCLM"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBTMPCLM" 
		id="pb-container-childscreen-MB_ITEM-MBTMPCLM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_CLAUSEPREM" runat="server" ScreenCode="MBTMPCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBTMPCLM/MBTMPCLM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBTMPCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBTMPCLM"
						ClientValidationFunction="onValidate_MB_ITEM__MBTMPCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id813f9af1bcd14cbaa7eec9aee20cb872 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id813f9af1bcd14cbaa7eec9aee20cb872 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id813f9af1bcd14cbaa7eec9aee20cb872 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id813f9af1bcd14cbaa7eec9aee20cb872 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id813f9af1bcd14cbaa7eec9aee20cb872 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id813f9af1bcd14cbaa7eec9aee20cb872 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id813f9af1bcd14cbaa7eec9aee20cb872 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id813f9af1bcd14cbaa7eec9aee20cb872 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id813f9af1bcd14cbaa7eec9aee20cb872 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id813f9af1bcd14cbaa7eec9aee20cb872 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id77f989aedea74eb28358785a542d3df2" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBTMNTCL"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBTMNTCL" 
		id="pb-container-childscreen-MB_ITEM-MBTMNTCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_CNOTE" runat="server" ScreenCode="MBTMNTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBTMNTCL/MBTMNTCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBTMNTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBTMNTCL"
						ClientValidationFunction="onValidate_MB_ITEM__MBTMNTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id77f989aedea74eb28358785a542d3df2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id77f989aedea74eb28358785a542d3df2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id77f989aedea74eb28358785a542d3df2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id77f989aedea74eb28358785a542d3df2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id77f989aedea74eb28358785a542d3df2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77f989aedea74eb28358785a542d3df2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77f989aedea74eb28358785a542d3df2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id77f989aedea74eb28358785a542d3df2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id77f989aedea74eb28358785a542d3df2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id77f989aedea74eb28358785a542d3df2 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idf9e9867b482a412681f589dcd511c760" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MB_ITEM__MBTMSNTCL"
		data-field-type="Child" 
		data-object-name="MB_ITEM" 
		data-property-name="MBTMSNTCL" 
		id="pb-container-childscreen-MB_ITEM-MBTMSNTCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MB_ITEM__MBITEM_SCNOTE" runat="server" ScreenCode="MBTMSNTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBTMSNTCL/MBTMSNTCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMB_ITEM_MBTMSNTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MB_ITEM.MBTMSNTCL"
						ClientValidationFunction="onValidate_MB_ITEM__MBTMSNTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idf9e9867b482a412681f589dcd511c760 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idf9e9867b482a412681f589dcd511c760 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idf9e9867b482a412681f589dcd511c760 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idf9e9867b482a412681f589dcd511c760 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idf9e9867b482a412681f589dcd511c760 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9e9867b482a412681f589dcd511c760 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9e9867b482a412681f589dcd511c760 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idf9e9867b482a412681f589dcd511c760 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idf9e9867b482a412681f589dcd511c760 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idf9e9867b482a412681f589dcd511c760 input{text-align:left;}"; break;
		}
	}
