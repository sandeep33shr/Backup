<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CCAMBCLCLM_Machinery_Breakdown.aspx.vb" Inherits="Nexus.PB2_CCAMBCLCLM_Machinery_Breakdown" %>
...
function onValidate_MBREAK__MBTMCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBTMCL", "ChildScreen");
        })();
        /** 
...
function onValidate_MBREAK__MBOXTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBOXTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function onValidate_MBREAK__MBFPCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBFPCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function onValidate_MBREAK__MBECLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBECLM", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function onValidate_MBREAK__MBNTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBNTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function onValidate_MBREAK__MBSNTCL(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "MBREAK", "MBSNTCL", "ChildScreen");
        })();
        /** 
         * Note: This script removes the 'Delete' linkbutton in every row of the childscreen grid. It also renames 'Edit' to 'Select'
         * @param MBREAK The object name of the control to set.
...
function DoLogic(isOnLoad) {
    ...
    onValidate_MBREAK__MBTMCL(null, null, null, isOnLoad);
    ...
    onValidate_MBREAK__MBOXTCL(null, null, null, isOnLoad);
    onValidate_MBREAK__MBFPCL(null, null, null, isOnLoad);
    onValidate_MBREAK__MBECLM(null, null, null, isOnLoad);
    onValidate_MBREAK__MBNTCL(null, null, null, isOnLoad);
    onValidate_MBREAK__MBSNTCL(null, null, null, isOnLoad);
}
</script>
...
<div id="idfcbf3f4c73204f7ebb862d53681e931f" class="general-layout-container">
...
<div id="id629cc77c091e4f88892891c9b44a66da" class="column-layout-container,no-border  ">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id629cc77c091e4f88892891c9b44a66da div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id629cc77c091e4f88892891c9b44a66da div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id629cc77c091e4f88892891c9b44a66da div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id629cc77c091e4f88892891c9b44a66da label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id629cc77c091e4f88892891c9b44a66da label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id629cc77c091e4f88892891c9b44a66da label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id629cc77c091e4f88892891c9b44a66da label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id629cc77c091e4f88892891c9b44a66da input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id629cc77c091e4f88892891c9b44a66da input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id629cc77c091e4f88892891c9b44a66da input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id87657550d1df4bda8e51b98e12f174d7" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBTMCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBTMCL" 
		id="pb-container-childscreen-MBREAK-MBTMCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_ITEM" runat="server" ScreenCode="MBTMCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBTMCL/MBTMCL_Machinery_Breakdown_Item_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Added" DataField="DATEADDED" DataFormatString="{0:d}"/>
<Nexus:GISLookupField HeaderText="Category" ListType="PMLookup" ListCode="UDL_CMA_MBCL_CAT" DataField="CATEG" DataItemValue="key" />
<Nexus:GISLookupField HeaderText="Sub-Category" ListType="PMLookup" ListCode="UDL_CMA_MBCL_SUBCAT" DataField="SUB_CATEG" DataItemValue="key" />
...
<Nexus:GISLookupField HeaderText="Basis of Deductible " ListType="PMLookup" ListCode="UDL_CMA_MBCL_BOD" DataField="BASEDEDUCT" DataItemValue="key" />
					...
					<asp:CustomValidator ID="valMBREAK_MBTMCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBTMCL"
						ClientValidationFunction="onValidate_MBREAK__MBTMCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id87657550d1df4bda8e51b98e12f174d7 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id87657550d1df4bda8e51b98e12f174d7 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id87657550d1df4bda8e51b98e12f174d7 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id87657550d1df4bda8e51b98e12f174d7 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id87657550d1df4bda8e51b98e12f174d7 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id87657550d1df4bda8e51b98e12f174d7 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id87657550d1df4bda8e51b98e12f174d7 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id87657550d1df4bda8e51b98e12f174d7 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id87657550d1df4bda8e51b98e12f174d7 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id87657550d1df4bda8e51b98e12f174d7 input{text-align:left;}"; break;
		}
	}
...
<!-- /Label -->
	...
	<span id="pb-container-label-label4">
		<span class="label" id="label4">Limit of Indemnity</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label11">
		<span class="label" id="label11">Express Delivery and Overtime</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label12">
		<span class="label" id="label12">Foundations and Masonry Refractories</span>
	</span>
<!-- /Label -->
...
<!-- /Checkbox -->
	...
	<span id="pb-container-label-label13">
		<span class="label" id="label13">Riot and Strike </span>
	</span>
<!-- /Label -->
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBOXTCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBOXTCL" 
		id="pb-container-childscreen-MBREAK-MBOXTCL">
		
		    <legend>Other Machinery Breakdown Extensions</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_OEXTENSIONS" runat="server" ScreenCode="MBOXTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBOXTCL/MBOXTCL_Other_Machinery_Breakdown_Extensions.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MBOXTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Other Machinery Breakdown Extensions"
						ClientValidationFunction="onValidate_MBREAK__MBOXTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id88c3d07fd2094ad8acac002719d93403" class="column-layout-container  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBFPCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBFPCL" 
		id="pb-container-childscreen-MBREAK-MBFPCL">
		
		    <legend>First Amount Payable </legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_FAP" runat="server" ScreenCode="MBFPCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBFPCL/MBFPCL_First_Amount_Payable.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Min Amount" DataField="FAPCHILD_MIN_AMOUNT" DataFormatString="{0:N}"/>
					...
					<asp:CustomValidator ID="valMBREAK_MBFPCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for First Amount Payable "
						ClientValidationFunction="onValidate_MBREAK__MBFPCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id88c3d07fd2094ad8acac002719d93403 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id88c3d07fd2094ad8acac002719d93403 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id88c3d07fd2094ad8acac002719d93403 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id88c3d07fd2094ad8acac002719d93403 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id88c3d07fd2094ad8acac002719d93403 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id88c3d07fd2094ad8acac002719d93403 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id88c3d07fd2094ad8acac002719d93403 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id88c3d07fd2094ad8acac002719d93403 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id88c3d07fd2094ad8acac002719d93403 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id88c3d07fd2094ad8acac002719d93403 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id533d824c13b8478abfb0573501d142cf" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBECLM"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBECLM" 
		id="pb-container-childscreen-MBREAK-MBECLM">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_CLAUSEPREM" runat="server" ScreenCode="MBECLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBECLM/MBECLM_Endorsement_Premium.aspx" emptydatatext="sac">
							<columns>
					...
					<asp:CustomValidator ID="valMBREAK_MBECLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBECLM"
						ClientValidationFunction="onValidate_MBREAK__MBECLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id533d824c13b8478abfb0573501d142cf div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id533d824c13b8478abfb0573501d142cf div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id533d824c13b8478abfb0573501d142cf div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id533d824c13b8478abfb0573501d142cf label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id533d824c13b8478abfb0573501d142cf label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id533d824c13b8478abfb0573501d142cf label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id533d824c13b8478abfb0573501d142cf label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id533d824c13b8478abfb0573501d142cf input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id533d824c13b8478abfb0573501d142cf input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id533d824c13b8478abfb0573501d142cf input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idac73c75f6c0241ed90a89026fa507e88" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading36" runat="server" Text="Machinery Breakdown Notes (Not Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBNTCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBNTCL" 
		id="pb-container-childscreen-MBREAK-MBNTCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_NOTES" runat="server" ScreenCode="MBNTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBNTCL/MBNTCL_Machinery_Breakdown_Note_Details.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_MBNTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBNTCL"
						ClientValidationFunction="onValidate_MBREAK__MBNTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idac73c75f6c0241ed90a89026fa507e88 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idac73c75f6c0241ed90a89026fa507e88 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idac73c75f6c0241ed90a89026fa507e88 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idac73c75f6c0241ed90a89026fa507e88 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idac73c75f6c0241ed90a89026fa507e88 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idac73c75f6c0241ed90a89026fa507e88 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idac73c75f6c0241ed90a89026fa507e88 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idac73c75f6c0241ed90a89026fa507e88 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idac73c75f6c0241ed90a89026fa507e88 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idac73c75f6c0241ed90a89026fa507e88 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id691de8408a5b47f9a2b0ab79dead6cd2" class="column-layout-container  ">
		
				
	              <legend><asp:Label ID="lblHeading37" runat="server" Text="Machinery Breakdown Notes (Printed on Schedule)" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_MBREAK__MBSNTCL"
		data-field-type="Child" 
		data-object-name="MBREAK" 
		data-property-name="MBSNTCL" 
		id="pb-container-childscreen-MBREAK-MBSNTCL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="MBREAK__MB_SNOTES" runat="server" ScreenCode="MBSNTCL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="MBSNTCL/MBSNTCL_Note_Details.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="DATE_CREATED" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="CREATED_BY" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="COVER_TYPE" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="NOTE_DESCRIPTION" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valMBREAK_MBSNTCL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for MBREAK.MBSNTCL"
						ClientValidationFunction="onValidate_MBREAK__MBSNTCL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id691de8408a5b47f9a2b0ab79dead6cd2 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id691de8408a5b47f9a2b0ab79dead6cd2 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id691de8408a5b47f9a2b0ab79dead6cd2 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id691de8408a5b47f9a2b0ab79dead6cd2 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id691de8408a5b47f9a2b0ab79dead6cd2 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id691de8408a5b47f9a2b0ab79dead6cd2 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id691de8408a5b47f9a2b0ab79dead6cd2 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id691de8408a5b47f9a2b0ab79dead6cd2 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id691de8408a5b47f9a2b0ab79dead6cd2 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id691de8408a5b47f9a2b0ab79dead6cd2 input{text-align:left;}"; break;
		}
	}
