...
Namespace Nexus
    Partial Class PB2_CCAMBCLCLM_Consequential_Loss : Inherits BaseClaim
		...
		Protected Sub onValidate_CLOSS__CCEPCLM()
        
End Sub
Protected Sub onValidate_CLOSS__CCLNTSCL()
        
End Sub
Protected Sub onValidate_CLOSS__CCLSNTSCL()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CLOSS__CCEPCLM()
    onValidate_CLOSS__CCLNTSCL()
    onValidate_CLOSS__CCLSNTSCL()
End Sub
