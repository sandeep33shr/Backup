...
Namespace Nexus
    Partial Class PB2_CCAMBCLCLM_Machinery_Breakdown : Inherits BaseClaim
		...
		Protected Sub onValidate_MBREAK__MBTMCL()
        
End Sub
Protected Sub onValidate_MBREAK__MBOXTCL()
        
End Sub
Protected Sub onValidate_MBREAK__MBFPCL()
        
End Sub
Protected Sub onValidate_MBREAK__MBECLM()
        
End Sub
Protected Sub onValidate_MBREAK__MBNTCL()
        
End Sub
Protected Sub onValidate_MBREAK__MBSNTCL()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_MBREAK__MBTMCL()
    onValidate_MBREAK__MBOXTCL()
    onValidate_MBREAK__MBFPCL()
    onValidate_MBREAK__MBECLM()
    onValidate_MBREAK__MBNTCL()
    onValidate_MBREAK__MBSNTCL()
End Sub
