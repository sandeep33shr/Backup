...
Namespace Nexus
    Partial Class PB2_CMAMSCLM_Endorsements_and_Notes : Inherits BaseClaim
		...
		Protected Sub onValidate_RISK_DETAILS__MSENDCLM()
        
End Sub
Protected Sub onValidate_RISK_DETAILS__MSNOTECLM()
        
End Sub
Protected Sub onValidate_RISK_DETAILS__MSSNOTECLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RISK_DETAILS__MSENDCLM()
    onValidate_RISK_DETAILS__MSNOTECLM()
    onValidate_RISK_DETAILS__MSSNOTECLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RISK_DETAILS = The parent object name of child screen
        ' CLAUSEPREM = The child screen object name
        
        Protected Sub RISK_DETAILS__CLAUSEPREM_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISK_DETAILS__CLAUSEPREM.RowDataBound
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RISK_DETAILS = The parent object name of child screen
        ' CNOTE_DETAIL = The child screen object name
        
        Protected Sub RISK_DETAILS__CNOTE_DETAIL_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISK_DETAILS__CNOTE_DETAIL.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        Protected Sub RISK_DETAILS__SCNOTE_DETAILS_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISK_DETAILS__SCNOTE_DETAILS.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
