...
Namespace Nexus
    Partial Class PB2_CMAMSCLM_Vehicle_Details : Inherits BaseClaim
		...
		Protected Sub onValidate_RISK_DETAILS__MSACSRYCLM()
        
End Sub
Protected Sub onValidate_EXTENSIONS__MSSNDCLM()
        
End Sub
Protected Sub onValidate_RISK_DETAILS__MSDDTLCLM()
        
End Sub
Protected Sub onValidate_RISK_DETAILS__MSADFAPCLM()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_RISK_DETAILS__MSACSRYCLM()
    onValidate_EXTENSIONS__MSSNDCLM()
    onValidate_RISK_DETAILS__MSDDTLCLM()
    onValidate_RISK_DETAILS__MSADFAPCLM()
End Sub

		     
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RISK_DETAILS = The parent object name of child screen
        ' ACCESSORIES = The child screen object name
        
        Protected Sub RISK_DETAILS__ACCESSORIES_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISK_DETAILS__ACCESSORIES.RowDataBound
        ...
        ' SOUND = The child screen object name
        
        Protected Sub EXTENSIONS__SOUND_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles EXTENSIONS__SOUND.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RISK_DETAILS = The parent object name of child screen
        ' DRIVER_DET = The child screen object name
        
        Protected Sub RISK_DETAILS__DRIVER_DET_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISK_DETAILS__DRIVER_DET.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
        ...
        ' Note: This rule removes the "Add" button row of a child-screen grid
        ' RISK_DETAILS = The parent object name of child screen
        ' ADD_COMP_CHILD = The child screen object name
        
        Protected Sub RISK_DETAILS__ADD_COMP_CHILD_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles RISK_DETAILS__ADD_COMP_CHILD.RowDataBound
        	If e.Row.RowType = DataControlRowType.Footer Then
        		e.Row.Visible = False
        	End If
