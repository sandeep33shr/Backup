<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMSCLM_Claim_Information.aspx.vb" Inherits="Nexus.PB2_CMAMSCLM_Claim_Information" %>
...
function onValidate_CMAMSCLAIM__THIRDPARTY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMSCLAIM", "THIRDPARTY", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMSCLAIM_THIRDPARTY");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMSCLAIM__THIRDPARTY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMSCLAIM__THIRDPARTY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
        ...
        (function(){
        	if (isOnLoad) {
        		var field = Field.getInstance("CMAMSCLAIM.THIRDPARTY");
        		var update = function(){
...
function onValidate_CMAMSCLAIM__SALVAGE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMSCLAIM", "SALVAGE", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMSCLAIM_SALVAGE");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMSCLAIM__SALVAGE');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMSCLAIM__SALVAGE_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMSCLAIM__RECOVERY(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMSCLAIM", "RECOVERY", "Checkbox");
        })();
        /**
         * Set the label width
         */
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMSCLAIM_RECOVERY");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMSCLAIM__RECOVERY');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMSCLAIM__RECOVERY_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMSCLAIM__IS_NAMAPP(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMSCLAIM", "IS_NAMAPP", "Checkbox");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CMAMSCLAIM", "IS_NAMAPP");
        		}
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMSCLAIM_IS_NAMAPP");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMSCLAIM__IS_NAMAPP');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMSCLAIM__IS_NAMAPP_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMSCLAIM__NAMDECISION(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMSCLAIM", "NAMDECISION", "Text");
        })();
        /**
         * @fileoverview
         * Set property
        ...
        (function(){
        	if (isOnLoad) {	
        		...
        		if ("{name}" != "{na" + "me}"){
        			...
        			field = Field.getInstance("CMAMSCLAIM", "NAMDECISION");
        		}
        		//window.setProperty(field, "VE", "GENERAL.CLMDECISIONCODE == 2", "R", "{3}");
        ...
        (function(){
        	...
        	if (isOnLoad) {		
        		var field = Field.getInstance("CMAMSCLAIM", "NAMDECISION");
        		var exp = new Expression("CMAMSCLAIM.IS_NAMAPP == true");
        		var errorMessage = "{1}";
        		var go = function(){
        			if (exp.getValue() == true){
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		(function(){
              var field = Field.getInstance("CMAMSCLAIM.NAMDECISION");
        			window.setControlWidth(field, "0.8", "CMAMSCLAIM", "NAMDECISION");
        		})();
        	}
        })();
        /**
        	...
        	if (isOnLoad) {	
        		window.setTimeout(function(){
        			...
        			if ("{name}" != "{na" + "me}"){
        			    ...
        			    var label = document.getElementById("ctl00_cntMainBody_lblCMAMSCLAIM_NAMDECISION");
        			    var ele = document.getElementById('ctl00_cntMainBody_CMAMSCLAIM__NAMDECISION');
        			    if (ele.firstElementChild != null && ele.firstElementChild.id == 'Controls_FindParty') {
        			        label = document.getElementById("ctl00_cntMainBody_CMAMSCLAIM__NAMDECISION_lblFindParty");
        			    }
        			}
        			var bounds = goog.style.getBounds(label);
        			//if (bounds.width != 0)
...
function onValidate_CMAMSCLAIM__CMSTRAIL(source, args, sender, isOnLoad) {
...
function DoLogic(isOnLoad) {
    ...
    onValidate_CMAMSCLAIM__THIRDPARTY(null, null, null, isOnLoad);
    onValidate_CMAMSCLAIM__SALVAGE(null, null, null, isOnLoad);
    onValidate_CMAMSCLAIM__RECOVERY(null, null, null, isOnLoad);
    onValidate_CMAMSCLAIM__IS_NAMAPP(null, null, null, isOnLoad);
    onValidate_CMAMSCLAIM__NAMDECISION(null, null, null, isOnLoad);
    onValidate_CMAMSCLAIM__CMSTRAIL(null, null, null, isOnLoad);
}
</script>
...
<div id="ida99435eee97447248db42ad66c08eaa0" class="general-layout-container">
...
<div id="frmClmTyp" class="column-layout-container,no-border  ">
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMSCLAIM_THIRDPARTY" for="ctl00_cntMainBody_CMAMSCLAIM__THIRDPARTY" class="col-md-4 col-sm-3 control-label">
		Third Party</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		data-object-name="CMAMSCLAIM" 
		data-property-name="THIRDPARTY" 
		id="pb-container-checkbox-CMAMSCLAIM-THIRDPARTY">	
		
		<asp:TextBox ID="CMAMSCLAIM__THIRDPARTY" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMSCLAIM_THIRDPARTY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Third Party"
			ClientValidationFunction="onValidate_CMAMSCLAIM__THIRDPARTY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMSCLAIM_SALVAGE" for="ctl00_cntMainBody_CMAMSCLAIM__SALVAGE" class="col-md-4 col-sm-3 control-label">
		Salvage</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CMAMSCLAIM-SALVAGE">	
		
		<asp:TextBox ID="CMAMSCLAIM__SALVAGE" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMSCLAIM_SALVAGE" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Salvage"
			ClientValidationFunction="onValidate_CMAMSCLAIM__SALVAGE" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMSCLAIM_RECOVERY" for="ctl00_cntMainBody_CMAMSCLAIM__RECOVERY" class="col-md-4 col-sm-3 control-label">
		Recovery</label>
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		data-field-type="Checkbox" 
		...
		id="pb-container-checkbox-CMAMSCLAIM-RECOVERY">	
		
		<asp:TextBox ID="CMAMSCLAIM__RECOVERY" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMSCLAIM_RECOVERY" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for Recovery"
			ClientValidationFunction="onValidate_CMAMSCLAIM__RECOVERY" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<!-- /Checkbox -->
 ...
 <!-- Checkbox -->
<div class="form-group form-group-sm">
<label id="ctl00_cntMainBody_lblCMAMSCLAIM_IS_NAMAPP" for="ctl00_cntMainBody_CMAMSCLAIM__IS_NAMAPP" class="col-md-4 col-sm-3 control-label">
...
<div class="col-md-8 col-sm-9">
	<span class="field-container asp-check" 
		...
		id="pb-container-checkbox-CMAMSCLAIM-IS_NAMAPP">	
		
		<asp:TextBox ID="CMAMSCLAIM__IS_NAMAPP" runat="server" CssClass="form-control hidden" />
		<asp:CustomValidator ID="valCMAMSCLAIM_IS_NAMAPP" 
			runat="server" 
			Text="*" 
			ErrorMessage="A validation error occurred for NAMFISA Approached"
			ClientValidationFunction="onValidate_CMAMSCLAIM__IS_NAMAPP" 
			ValidationGroup=""
			Display="None"
			EnableClientScript="true"/>
...
<div class="form-group form-group-sm">
	<span class="field-container" 
		...
		id="pb-container-text-CMAMSCLAIM-NAMDECISION">

		
		<asp:Label ID="lblCMAMSCLAIM_NAMDECISION" runat="server" AssociatedControlID="CMAMSCLAIM__NAMDECISION" 
			Text="NAMFISA Decision" CssClass="col-md-4 col-sm-3 control-label"></asp:Label>
		         ...
		         <div class="col-md-8 col-sm-9">
					<asp:TextBox ID="CMAMSCLAIM__NAMDECISION" runat="server" CssClass="form-control" data-type="Text" />
					<asp:CustomValidator ID="valCMAMSCLAIM_NAMDECISION" 
					runat="server" 
					Text="*" 
					ErrorMessage="A validation error occurred for NAMFISA Decision"
					ClientValidationFunction="onValidate_CMAMSCLAIM__NAMDECISION"
					ValidationGroup=""
					Display="None"
					EnableClientScript="true"
					/>
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id59f0e2ebfc7a41ed931e78033915af0a" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CMAMSCLAIM__CMSTRAIL"
		data-field-type="Child" 
		data-object-name="CMAMSCLAIM" 
		data-property-name="CMSTRAIL" 
		id="pb-container-childscreen-CMAMSCLAIM-CMSTRAIL">
		
		    <legend></legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CMAMSCLAIM__AUDIT" runat="server" ScreenCode="CMSTRAIL" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMSTRAIL/CMSTRAIL_Audit_Trail.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Changed By" DataField="CHANGED_BY" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCMAMSCLAIM_CMSTRAIL" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for CMAMSCLAIM.CMSTRAIL"
						ClientValidationFunction="onValidate_CMAMSCLAIM__CMSTRAIL" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id59f0e2ebfc7a41ed931e78033915af0a div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id59f0e2ebfc7a41ed931e78033915af0a div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id59f0e2ebfc7a41ed931e78033915af0a div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id59f0e2ebfc7a41ed931e78033915af0a label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id59f0e2ebfc7a41ed931e78033915af0a label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id59f0e2ebfc7a41ed931e78033915af0a label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id59f0e2ebfc7a41ed931e78033915af0a label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id59f0e2ebfc7a41ed931e78033915af0a input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id59f0e2ebfc7a41ed931e78033915af0a input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id59f0e2ebfc7a41ed931e78033915af0a input{text-align:left;}"; break;
		}
	}
