<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CMAMSCLM_Notes.aspx.vb" Inherits="Nexus.PB2_CMAMSCLM_Notes" %>
...
function onValidate_CMAMSCLAIM__CMSCNCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMSCLAIM", "CMSCNCLM", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CMAMSCLAIM", "CMSCNCLM");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_CMAMSCLAIM__CMSCNCLM table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CMAMSCLAIM", "CMSCNCLM");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CMAMSCLAIM' and property 'CMSCNCLM'.");
        			error.display();
...
function onValidate_CMAMSCLAIM__CMSEXCLM(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMAMSCLAIM", "CMSEXCLM", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CMAMSCLAIM__CMSCNCLM(null, null, null, isOnLoad);
    onValidate_CMAMSCLAIM__CMSEXCLM(null, null, null, isOnLoad);
}
</script>
...
<div id="id08518855c28d4e09a327dfd9468f7b81" class="general-layout-container">
...
<div id="ida507161c5dcc4f6d8c5533e777a372d1" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading64" runat="server" Text="Claims Internal Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CMAMSCLAIM__CMSCNCLM"
		data-field-type="Child" 
		data-object-name="CMAMSCLAIM" 
		data-property-name="CMSCNCLM" 
		id="pb-container-childscreen-CMAMSCLAIM-CMSCNCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CMAMSCLAIM__CNOTE_DETAILS" runat="server" ScreenCode="CMSCNCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMSCNCLM/CMSCNCLM_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCMAMSCLAIM_CMSCNCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_CMAMSCLAIM__CMSCNCLM" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#ida507161c5dcc4f6d8c5533e777a372d1 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#ida507161c5dcc4f6d8c5533e777a372d1 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#ida507161c5dcc4f6d8c5533e777a372d1 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#ida507161c5dcc4f6d8c5533e777a372d1 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#ida507161c5dcc4f6d8c5533e777a372d1 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida507161c5dcc4f6d8c5533e777a372d1 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida507161c5dcc4f6d8c5533e777a372d1 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#ida507161c5dcc4f6d8c5533e777a372d1 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#ida507161c5dcc4f6d8c5533e777a372d1 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#ida507161c5dcc4f6d8c5533e777a372d1 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="id6d8adb3773314c31a219ee2f08b8e5cb" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading65" runat="server" Text="Claims External Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CMAMSCLAIM__CMSEXCLM"
		data-field-type="Child" 
		data-object-name="CMAMSCLAIM" 
		data-property-name="CMSEXCLM" 
		id="pb-container-childscreen-CMAMSCLAIM-CMSEXCLM">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CMAMSCLAIM__EXT_DETAILS" runat="server" ScreenCode="CMSEXCLM" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CMSEXCLM/CMSEXCLM_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Note Description" DataField="Note_Subject" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCMAMSCLAIM_CMSEXCLM" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_CMAMSCLAIM__CMSEXCLM" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#id6d8adb3773314c31a219ee2f08b8e5cb div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id6d8adb3773314c31a219ee2f08b8e5cb div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id6d8adb3773314c31a219ee2f08b8e5cb div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#id6d8adb3773314c31a219ee2f08b8e5cb label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id6d8adb3773314c31a219ee2f08b8e5cb label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d8adb3773314c31a219ee2f08b8e5cb label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d8adb3773314c31a219ee2f08b8e5cb label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id6d8adb3773314c31a219ee2f08b8e5cb input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id6d8adb3773314c31a219ee2f08b8e5cb input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id6d8adb3773314c31a219ee2f08b8e5cb input{text-align:left;}"; break;
		}
	}
