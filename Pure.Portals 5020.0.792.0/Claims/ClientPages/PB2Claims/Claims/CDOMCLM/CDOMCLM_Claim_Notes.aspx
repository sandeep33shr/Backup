<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="CDOMCLM_Claim_Notes.aspx.vb" Inherits="Nexus.PB2_CDOMCLM_Claim_Notes" %>
...
function onValidate_CMDOMCLM__CDOMCNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMDOMCLM", "CDOMCNOTE", "ChildScreen");
        })();
        /**
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CMDOMCLM", "CDOMCNOTE");
        		...
        		var update = function(){
        			...
        			if (field.getType() == "child_screen"){
        				...
        				links = goog.dom.query("#ctl00_cntMainBody_CMDOMCLM__CDOMCNOTE table td a");
        ...
        (function(){
        	...
        	if (isOnLoad) {	
        		...
        		var field = Field.getInstance("CMDOMCLM", "CDOMCNOTE");
        		/*if (field.getType() != "child_screen"){
        			var error = new Error("HideTableLinks rule used on field which is not a child screen. Offending field has the object 'CMDOMCLM' and property 'CDOMCNOTE'.");
        			error.display();
...
function onValidate_CMDOMCLM__CDOMCSNOTE(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "CMDOMCLM", "CDOMCSNOTE", "ChildScreen");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_CMDOMCLM__CDOMCNOTE(null, null, null, isOnLoad);
    onValidate_CMDOMCLM__CDOMCSNOTE(null, null, null, isOnLoad);
}
</script>
...
<div id="id1270cfc8b3d649d9923f2ca22e89b084" class="general-layout-container">
...
<div id="id1467acf759c441ef895c7d9bbc165919" class="column-layout-container,no-border  ">
		
				
	              <legend><asp:Label ID="lblHeading64" runat="server" Text="Domestic Claims Notes" /></legend>
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CMDOMCLM__CDOMCNOTE"
		data-field-type="Child" 
		data-object-name="CMDOMCLM" 
		data-property-name="CDOMCNOTE" 
		id="pb-container-childscreen-CMDOMCLM-CDOMCNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CMDOMCLM__CMDMS_DETAILS" runat="server" ScreenCode="CDOMCNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CDOMCNOTE/CDOMCNOTE_Claims_Internal_Notes.aspx" emptydatatext="sac">
							<columns>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCMDOMCLM_CDOMCNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_CMDOMCLM__CDOMCNOTE" 
						Display="None"
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var arrayCount = 0;
		if ($("#id1467acf759c441ef895c7d9bbc165919 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#id1467acf759c441ef895c7d9bbc165919 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#id1467acf759c441ef895c7d9bbc165919 div ul li").each(function(){		  
	...
	if (labelWidth != ""){
		...
		styleString += "#id1467acf759c441ef895c7d9bbc165919 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#id1467acf759c441ef895c7d9bbc165919 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1467acf759c441ef895c7d9bbc165919 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1467acf759c441ef895c7d9bbc165919 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#id1467acf759c441ef895c7d9bbc165919 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#id1467acf759c441ef895c7d9bbc165919 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#id1467acf759c441ef895c7d9bbc165919 input{text-align:left;}"; break;
		}
	}
...
<!-- /ColumnLayoutContainer -->	
							...
							<div class="clearfix p-xs">
								...
								<!-- ColumnLayoutContainer -->
<div id="idc82266aea90c42abb235e56ad10a91f0" class="column-layout-container,no-border  ">
				...
				<div data-column-count="1" data-column-ratio="" data-layout="" class="clearfix form-horizontal">
					...
					<ul class="column-content">
									...
									<li class="co-cell"  style="width:100%;" >
										...
										<!-- Child -->
	<div class="child-card" id="ctl00_cntMainBody_CMDOMCLM__CDOMCSNOTE"
		data-field-type="Child" 
		data-object-name="CMDOMCLM" 
		data-property-name="CDOMCSNOTE" 
		id="pb-container-childscreen-CMDOMCLM-CDOMCSNOTE">
		
		    <legend>Notes</legend>
		 
			        <div class="grid-card table-responsive no-margin">
						<nexus:ItemGrid ID="CMDOMCLM__CMDM_DETAILS" runat="server" ScreenCode="CDOMCSNOTE" AutoGenerateColumns="false"
							GridLines="None" ChildPage="CDOMCSNOTE/CDOMCSNOTE_Claims_External_Notes.aspx" emptydatatext="sac">
							<columns>
						<Nexus:RiskAttribute HeaderText="Date Created" DataField="Date_Created" DataFormatString="{0:d}"/>
<Nexus:RiskAttribute HeaderText="Created by" DataField="Created_By" DataFormatString=""/>
<Nexus:RiskAttribute HeaderText="Cover Type" DataField="Risk_Cover" DataFormatString=""/>
...
<Nexus:RiskAttribute HeaderText="Details" DataField="Note_Details" DataFormatString=""/>
					...
					<asp:CustomValidator ID="valCMDOMCLM_CDOMCSNOTE" 
						runat="server" 
						Text="*" 
						ErrorMessage="A validation error occurred for Notes"
						ClientValidationFunction="onValidate_CMDOMCLM__CDOMCSNOTE" 
						Display="None"
						EnableClientScript="true"/>
	</div>
<!-- /Child -->
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var recordArray = new Array();
		var arrayCount = 0;
		if ($("#idc82266aea90c42abb235e56ad10a91f0 div").attr("data-column-count") != "undefined")
		{
			columnCount = $("#idc82266aea90c42abb235e56ad10a91f0 div").attr("data-column-count");		
		}
		
		if (columnCount > 1)
		{
			$("#idc82266aea90c42abb235e56ad10a91f0 div ul li").each(function(){		  
			  liElementHeight = $(this).height();	
	...
	if (labelWidth != ""){
		...
		styleString += "#idc82266aea90c42abb235e56ad10a91f0 label{width: " + labelWidth + ";}";
	}
	if (labelAlign != ""){
		switch (labelAlign.toLowerCase()){
			case "right": styleString += "#idc82266aea90c42abb235e56ad10a91f0 label{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc82266aea90c42abb235e56ad10a91f0 label{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc82266aea90c42abb235e56ad10a91f0 label{text-align:left;}"; break;
		}
	}
	if (textAlign != ""){
		switch (textAlign.toLowerCase()){
			case "right": styleString += "#idc82266aea90c42abb235e56ad10a91f0 input{text-align:right;}"; break;
			case "centre":
			case "center":
			case "middle": styleString += "#idc82266aea90c42abb235e56ad10a91f0 input{text-align:center;}"; break;
			case "left": 
			default: styleString += "#idc82266aea90c42abb235e56ad10a91f0 input{text-align:left;}"; break;
		}
	}
