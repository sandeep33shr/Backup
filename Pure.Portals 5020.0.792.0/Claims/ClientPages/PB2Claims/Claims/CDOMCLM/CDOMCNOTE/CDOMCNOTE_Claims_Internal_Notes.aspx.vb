...
Namespace Nexus
    Partial Class PB2_CDOMCNOTE_Claims_Internal_Notes : Inherits BaseClaim
		...
		Protected Sub onValidate_CMDMS_DETAILS__Note_Details()
        If eLifecycleEvent = LifecycleEvent.Page_Load Then
        	If CMDMS_DETAILS__Date_Created.Text.ToString = "" Then
        		CMDMS_DETAILS__Date_Created.Text = String.Format("{0:dd/MM/yyyy}", DateTime.Now)
        		CMDMS_DETAILS__Created_By.Text = Session(CNLoginName).ToString
        	End If
        End If
End Sub
Protected Sub onValidate_CMDMS_DETAILS__NoteCheck()
        
End Sub
Protected Sub CallRuleScripts()
    onValidate_CMDMS_DETAILS__Note_Details()
    onValidate_CMDMS_DETAILS__NoteCheck()
End Sub
        ...
        Protected Sub NotesAdded()
        	Dim NoteAddedCheck As Integer =Cint(CMDMS_DETAILS__NoteCheck.Text)
        	
        	If NoteAddedCheck = 0 Then
        		CMDMS_DETAILS__NoteCheck.Text = 1
        	End If
        End Sub
