<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Default.master"
    CodeFile="PCRAFTPER_Reserves.aspx.vb" Inherits="Nexus.PB2_PCRAFTPER_Reserves" %>

<%@ Register Src="~/controls/ReserveAndRecovery.ascx" TagName="ReserveARecovery" TagPrefix="uc" %>
<%@ Register Src="~/controls/PayClaim.ascx" TagName="PayClaim" TagPrefix="uc" %>
...
function onValidate_WORK_CLAIM_PERIL__Payment_details(source, args, sender, isOnLoad) {
         ...
         */
        (function(){
        	GeneralValidationHandler.Validate(isOnLoad, args, "WORK_CLAIM_PERIL", "Payment_details", "ClaimPayment");
        })();
}
function DoLogic(isOnLoad) {
    onValidate_WORK_CLAIM_PERIL__Reserve_details(null, null, null, isOnLoad);
    onValidate_WORK_CLAIM_PERIL__Payment_details(null, null, null, isOnLoad);
}
</script>
...
<div id="id023c496562264921af9551ba75ac2c41" class="general-layout-container">
							...
							<div class="clearfix p-xs">
								...
								<!-- GeneralLayoutContainer -->
<div id="idb5a7230cf4d5445db349539994c6f238" class="general-layout-container">
...
<!-- /GeneralLayoutContainer -->
							...
							<div class="clearfix p-xs">
								...
								<!-- GeneralLayoutContainer -->
<div id="id5d25c0bb44744aada2069d82befa1947" class="general-layout-container">
...
<!-- Payment -->
<li>
	<uc:PayClaim ID="PayClaim" runat="server" />
</li>
<!-- Payment -->
