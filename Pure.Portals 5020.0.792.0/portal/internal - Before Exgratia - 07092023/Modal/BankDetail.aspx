            ...
            <div class="card-body clearfix">
                <div class="form-horizontal">
                    ...
                    <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="col-md-8 col-sm-9">
                            <NexusProvider:LookupList ID="GISLookup_BankList" runat="server" DataItemText="Description" DataItemValue="Code" DefaultText="<%$ Resources:lbl_DefaultText %>" ListCode="CashListItem_Bank" ListType="PMLookup" CssClass="field-medium field-mandatory form-control" AutoPostBack ="true"></NexusProvider:LookupList>
                        </div>
