                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div id="liFileCode" runat="server" visible="false" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                                        <asp:Label ID="lblFileCode" runat="server" AssociatedControlID="txtFileCode" class="col-md-4 col-sm-3 control-label">
										 ...
										 <asp:RequiredFieldValidator ID="vldFileCode" runat="server" Display="none" ControlToValidate="txtFileCode" ErrorMessage="Please enter the Company Registration Number" SetFocusOnError="True"></asp:RequiredFieldValidator>
                                    </div>
...
<div id="id00613aa7cdf24ba29bc204712701052e" class="general-layout-container">
