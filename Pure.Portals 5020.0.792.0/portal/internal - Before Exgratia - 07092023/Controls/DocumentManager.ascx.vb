        ...
        If Me.Visible = True Then
            ...
            Else
                ...
                If CType(Session(CNIsBackDatedMTA), Boolean) = True OrElse Session(CNBackDatedReinstatement) = True Then
                    ...
                    Else
                        oBackDatedVersions = CType(Session(CNBackDatedVersions), NexusProvider.PolicyCollection)
                    End If
                    If (oBackDatedVersions IsNot Nothing AndAlso oBackDatedVersions.Count > 0) Then
                        ...
                        For Each oPolicyVersion As NexusProvider.Policy In oBackDatedVersions
                            If oPolicyVersion.InsuranceFileKey > nInsuranceFileKey Then
                                nInsuranceFileKey = oPolicyVersion.InsuranceFileKey
                            End If
                        Next
