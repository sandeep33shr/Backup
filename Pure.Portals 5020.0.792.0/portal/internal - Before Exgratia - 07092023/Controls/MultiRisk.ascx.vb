...
Namespace Nexus
    ...
    Partial Class Controls_MultiRisk : Inherits System.Web.UI.UserControl
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            'Added 27/09/2021 - PGA/PGM only allows one risk to be added per policy
            Dim sProdCode As String

            sProdCode = oQuote.ProductCode.ToUpper()
            If sProdCode = "PGA" Or sProdCode = "PGM" Then
                Dim lRiskCount As Integer

                If oQuote.Risks.Count >= 2 Then
                    btnAddRisk.Enabled = False
                End If
            End If
        ...
        Protected Sub grdvRisk_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdvRisk.RowDataBound
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                Dim sProdCode = oQuote.ProductCode.ToUpper()
                If sProdCode = "PGA" Or sProdCode = "PGM" Then
                    If oQuote.Risks.Count >= 2 Then
                        DisableLinkButton(lnkbtnCopy)
                    End If
            ...
            Try
                ...
                For Each row As GridViewRow In grdvRisk.Rows
                    If row.Cells(6).Text.ToUpper.Trim() = "UNQUOTED" Then
						...
						If oQuote.Risks(nCurrentRiskCounter).RiskTypeCode.Trim <> "CMANASRIA" Then
