...
Namespace Nexus
    Partial Class Claims_PerilDetails
            ...
            If Session(CNMode) = Mode.SalvageClaim Or Session(CNMode) = Mode.TPRecovery Then
                ...
                If sReturnCode IsNot Nothing AndAlso sReturnCode.OptionValue IsNot Nothing Then
                    If sReturnCode.OptionValue = "1" Then
                        Dim sMediaTypeValue As String = CType(CType(CType(PayClaim_ctrl, portal_internal_controls_payclaim_ascx).FindControl("GISLookup_MediaType"), NexusProvider.LookupList), NexusProvider.LookupList).Value
        ...
        End Function
        Protected Function GetClaimDecision() As Integer
