...
<asp:Content ID="cntMainBody" ContentPlaceHolderID="cntMainBody" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        //Enable and disable Strike Date and Bank fields
        function DOPaymentTermProcess_BusinessTypeBtn(iFieldOption) {
            $('#<%= POLICYHEADER__STRIKEDATE.ClientID%>').removeClass('field-mandatory');
            $('#<%= POLICYHEADER__STRIKEDATE.ClientID%>').attr("disabled", false);

            if (iFieldOption == "1") {
                $('#<%= POLICYHEADER__STRIKEDATE.ClientID%>').attr("disabled", false);
                $('#<%= POLICYHEADER__STRIKEDATE.ClientID%>').addClass('field-mandatory');
            }
            ...
            if (iFieldOption == "3") {
                $('#<%= POLICYHEADER__STRIKEDATE.ClientID%>').attr("disabled", true);
                $('#<%= POLICYHEADER__STRIKEDATE.ClientID%>').attr("value", null);
            }
        ...
        <asp:Panel ID="pageContainerDiv" runat="server">
            <div class="card-body clearfix no-padding">
                <div class="form-horizontal">
					...
					<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        <asp:Label ID="lblBusinessDesc" runat="server" AssociatedControlID="POLICYHEADER__BUSINESSDESC" Text="<%$ Resources:lblBusinessDesc %>" class="col-md-4 col-sm-3 control-label"></asp:Label>
                        <div class="col-md-8 col-sm-9">
                            <asp:TextBox ID="POLICYHEADER__BUSINESSDESC" runat="server" CssClass=" field-mandatory form-control"></asp:TextBox>
                        </div>
						<asp:RequiredFieldValidator ID="vldrqdBusinessDesc" runat="server" ControlToValidate="POLICYHEADER__BUSINESSDESC" ErrorMessage="<%$ Resources:lbl_vldBusinessDesc %>" Display="None" SetFocusOnError="true" Enabled="true"></asp:RequiredFieldValidator>
					</div>
                    <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        ...
                        <asp:UpdatePanel ID="updPaymentMethod" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <div class="col-md-8 col-sm-9">
                                        <NexusProvider:LookupList ID="POLICYHEADER__PAYMENTTERM" runat="server" DataItemValue="Key" DataItemText="Description" Sort="ASC" ListType="PMLookup" ListCode="DOPaymentTerms" CssClass=" form-control" DefaultText="<%$ Resources:lblDefaultText %>" AutoPostBack="true"></NexusProvider:LookupList>
                                    </div>
								...
								<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                                    <asp:Label ID="lblStrikeDate" runat="server" AssociatedControlID="POLICYHEADER__STRIKEDATE" Text="<%$ Resources:lblStrikeDate %>" class="col-md-4 col-sm-3 control-label"></asp:Label>
                                    <div class="col-md-8 col-sm-9">
                                        <NexusProvider:LookupList ID="POLICYHEADER__STRIKEDATE" runat="server" DataItemValue="Key" DataItemText="Description" Sort="ASC" ListType="PMLookup" ListCode="UDL_DOStrikeDate" CssClass="form-control" DefaultText="<%$ Resources:lblDefaultText %>"></NexusProvider:LookupList>
                                    </div>
                                    <asp:RequiredFieldValidator ID="rfvStrikeDate" runat="server" ErrorMessage="<%$ Resources:vld_StrikeDate %>" SetFocusOnError="true" Enabled="false" Display="None" ControlToValidate="POLICYHEADER__STRIKEDATE"></asp:RequiredFieldValidator>
                                </div>
								
								<div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                                    <asp:Label ID="lblDOBank" runat="server" AssociatedControlID="POLICYHEADER__DOBank" Text="<%$ Resources:lblDOBank %>" class="col-md-4 col-sm-3 control-label"></asp:Label>
                                    <div class="col-md-8 col-sm-9">
									<asp:DropDownList ID="POLICYHEADER__DOBank" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                    </div>
                                    <asp:RequiredFieldValidator ID="rfvDOBank" runat="server" ErrorMessage="<%$ Resources:vld_DOBank %>" SetFocusOnError="true" Enabled="false" Display="None" ControlToValidate="POLICYHEADER__DOBank"></asp:RequiredFieldValidator>
                                </div>
				...
				<!-- StandardWording -->
				<legend>
					<asp:Label ID="lblStandardWordingHeading" runat="server" Text="Policy Standard Wordings" />
				</legend>
				<uc7:SW ID="POLICY__STANDARDWORDING" runat="server" AllowAdd="true" AllowEdit="true" AllowPreview="true" SupportRiskLevel="false" />
