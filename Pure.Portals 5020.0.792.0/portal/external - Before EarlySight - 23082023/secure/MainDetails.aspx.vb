    ...
    Partial Class secure_MainDetails : Inherits Frontend.clsCMSPage
        ...
        Protected Shadows Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            End If
                ...
                If oQuote IsNot Nothing AndAlso (Session(CNMTAType) IsNot Nothing Or CType(Session(CNRenewal), Boolean) = True) Then
            ...
            If Not Page.IsPostBack AndAlso Session(CNMode) Is Nothing Then
