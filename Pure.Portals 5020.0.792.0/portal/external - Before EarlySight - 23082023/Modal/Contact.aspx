<%@ page language="VB" autoeventwireup="false" inherits="Nexus.Controls_Contact" CodeFile="Contact.aspx.vb" masterpagefile="~/default.master" enableEventValidation="false" %>
            ...
            <div class="card-body clearfix">
                <div class="form-horizontal">
                    ...
                    <div id="liAreaCode" runat="server" class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
                        ...
                        <div class="col-md-8 col-sm-9">
                            <asp:TextBox ID="txtAreaCode" runat="server" CssClass="form-control" readonly="true"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group form-group-sm col-lg-6 col-md-6 col-sm-12">
