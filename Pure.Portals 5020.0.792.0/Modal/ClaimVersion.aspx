                ...
                <asp:UpdatePanel ID="updClaimVersion" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="True">
                    <ContentTemplate>
                        <div class="grid-card table-responsive">
                            <asp:GridView ID="grdvClaims" runat="server" Width="98%" GridLines="None" AutoGenerateColumns="false" DataKeyNames="ClaimKey" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdvClaims_PageIndexChanging" AllowSorting="True" EmptyDataRowStyle-CssClass="noData" EmptyDataText="<%$ Resources:ErrorMessage %>">
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <div class="rowMenu">
